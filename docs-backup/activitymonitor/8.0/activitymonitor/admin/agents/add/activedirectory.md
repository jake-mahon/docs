...
[AD Agent Server Requirements](/docs/activitymonitor/8.0/activitymonitor/requirements/adagent.md) have been met. To effectively
...
monitored. See the [Monitored Domains Tab](/docs/activitymonitor/8.0/activitymonitor/admin/monitoreddomains/overview.md) section for
