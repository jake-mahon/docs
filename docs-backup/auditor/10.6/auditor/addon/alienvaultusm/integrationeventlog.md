...
[Reference for Creating Activity Records](/docs/auditor/10.6/auditor/api/activityrecordreference.md)topic.
...
See the [Define Parameters](/docs/auditor/10.6/auditor/addon/alienvaultusm/parameters.md)
