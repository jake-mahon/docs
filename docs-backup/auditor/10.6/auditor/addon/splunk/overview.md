...
See [CIM Data Model Mapping](/docs/auditor/10.6/auditor/addon/splunk/datamodelmap.md) for
details.
...
[Activity Records](/docs/auditor/10.6/auditor/api/postdata/activityrecords.md) topic for
