...
[Configuration](/docs/auditor/10.6/auditor/addon/siem/configure.md) topic for additional
information.
...
[Configure a Response Action for Alert](/docs/auditor/10.6/auditor/admin/alertsettings/responseaction.md)
