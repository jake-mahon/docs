...
[Notifications](/docs/auditor/10.6/auditor/admin/settings/notifications.md) settings.
...
![email](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/admin/settings/email.webp)
