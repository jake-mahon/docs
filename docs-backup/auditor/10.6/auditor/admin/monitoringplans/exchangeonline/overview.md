...
| Configure audit settings                           | See the [Exchange Online](/docs/auditor/10.6/auditor/configuration/microsoft365/exchangeonline/overview.md) configuration topic for additional information about audit settings required to collect comprehensive audit data and the instructions on how to configure them.      |
...
**Step 5 –** See the
[Exchange Online Monitoring Scope](/docs/auditor/10.6/auditor/admin/monitoringplans/exchangeonline/scope.md)
topic for additional information.
