...
[Notifications](/docs/auditor/10.6/auditor/admin/settings/notifications.md) topic for
additional information.
...
[Activity Summary Email](/docs/auditor/10.6/auditor/admin/monitoringplans/activitysummaryemail.md)
on changes in the monitored infrastructure, and
[Health Summary Email](/docs/auditor/10.6/auditor/admin/healthstatus/summaryemail.md) on
