...
- Back up files and directories. See the
   [Configure the Back up Files and Directories Policy](/docs/auditor/10.6/auditor/configuration/fileservers/windows/configuration.md)
...
- Manage auditing and security log. See the
  [Configure the Manage Auditing and Security Log Policy](/docs/auditor/10.6/auditor/configuration/activedirectory/permissions.md#configure-the-manage-auditing-and-security-log-policy)
  topic for additional information.
...
See the
[Assign Permission To Read the Registry Key](/docs/auditor/10.6/auditor/configuration/windowsserver/permissions.md#assign-permission-to-read-the-registry-key)
