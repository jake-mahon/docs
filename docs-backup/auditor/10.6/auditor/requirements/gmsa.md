...
- If you are going to use a gMSA as a data collecting account in Auditor, add this account to the
  ...
  - [Permissions for Group Policy Auditing ](/docs/auditor/10.6/auditor/configuration/grouppolicy/permissions.md)
  - [Permissions for Logon Activity Auditing ](/docs/auditor/10.6/auditor/configuration/logonactivity/permissions.md)
  - [Permissions for Windows File Server Auditing](/docs/auditor/10.6/auditor/configuration/fileservers/windows/permissions.md)
  - [Permissions for SharePoint Auditing](/docs/auditor/10.6/auditor/configuration/sharepoint/permissions.md)
  - [Permissions for SQL Server Auditing ](/docs/auditor/10.6/auditor/configuration/sqlserver/permissions.md)
  - [Permissions for Windows Server Auditing ](/docs/auditor/10.6/auditor/configuration/windowsserver/permissions.md)
...
See the
[Add Items for Monitoring](/docs/auditor/10.6/auditor/admin/monitoringplans/datasources.md#add-items-for-monitoring) topic
