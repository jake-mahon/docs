...
- For the existing monitoring plan, modify data collection settings for Active Directory data
  ...
  See the [Manage Data Sources](/docs/auditor/10.7/auditor/admin/monitoringplans/datasources.md) and
  [Active Directory](/docs/auditor/10.7/auditor/admin/monitoringplans/activedirectory/overview.md) topics for additional
  information.
...
[Active Directory](/docs/auditor/10.7/auditor/configuration/activedirectory/overview.md) topic.
...
- [Active Directory: Manual Configuration](/docs/auditor/10.7/auditor/configuration/activedirectory/manual.md)
