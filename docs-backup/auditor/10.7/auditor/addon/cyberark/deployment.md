...
[Add-On Parameters](/docs/auditor/10.7/auditor/addon/cyberark/parameters.md) topic for additional information.
...
- **SyslogMessageCodeFilter** - IDs of events to forward. The add-on will only collect and process
  ...
  [Monitored Events](/docs/auditor/10.7/auditor/addon/cyberark/monitoredevents.md). Use comma as a separator.
