...
Auditor Integration API, refer to [Integration API](/docs/auditor/10.7/auditor/api/overview.md).
...
1. The administrator enables and configured response action for selected alert, as described in the
   following topic:
   [Configure a Response Action for Alert](/docs/auditor/10.7/auditor/admin/alertsettings/responseaction.md). Make sure
...
See the [Configure a Response Action for Alert](/docs/auditor/10.7/auditor/admin/alertsettings/responseaction.md)
