...
and [View and Search Collected Data](/docs/auditor/10.7/auditor/admin/search/overview.md) topic for detailed instruction on
...
Search parameters file. See the [Search Parameters](/docs/auditor/10.7/auditor/api/postdata/searchparameters.md) topic for more
...
[Search Parameters](/docs/auditor/10.7/auditor/api/postdata/searchparameters.md) topic for more information.

| Method | Endpoint                                                                                  | POST Data                                                                        |
| ------ | ----------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| `POST` | `https://{host:port}/netwrix/api/v1/activity_records/search{?format=json}{&count=Number}` | [Search Parameters](/docs/auditor/10.7/auditor/api/postdata/searchparameters.md) |
...
[Continuation Mark](/docs/auditor/10.7/auditor/api/postdata/continuationmark.md)
