...
and [View and Search Collected Data](../admin/search/overview.md) topic for detailed instruction on
...
Search parameters file. See the [Search Parameters](postdata/searchparameters.md) topic for more
...
[Search Parameters](postdata/searchparameters.md) topic for more information.
...
[Continuation Mark](postdata/continuationmark.md)
