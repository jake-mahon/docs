...
[View Reports](/docs/auditor/10.7/auditor/admin/reports/view.md) topic for additional information.

**Step 4 –** After browsing your data, navigate to Tools to use the search results as intended. See
the [View and Search Collected Data](/docs/auditor/10.7/auditor/admin/search/overview.md) topic for additional information.
