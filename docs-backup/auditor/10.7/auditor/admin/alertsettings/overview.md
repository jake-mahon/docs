...
- See the[Manage Alerts](/docs/auditor/10.7/auditor/admin/alertsettings/manage.md) topic for additional information on how to edit and enable
  existing predefined alerts, and create new alerts based on the predefined ones.
- See the [Create Alerts](/docs/auditor/10.7/auditor/admin/alertsettings/create.md) topic for additional information on how to create custom alerts
  with your personal filters.
- If you need to be alerted on specific events in your Event Logs or non-owner mailbox access
  attempts, see the [Create Alerts for Event Log](/docs/auditor/10.7/auditor/admin/alertsettings/createeventlog.md) and
  [Create Alerts for Non-Owner Mailbox Access Events](/docs/auditor/10.7/auditor/admin/alertsettings/createmailboxaccess.md) topics for additional
  information.
...
General tab. See the [Create Alerts](/docs/auditor/10.7/auditor/admin/alertsettings/create.md) topic to receive information about tags applying.
