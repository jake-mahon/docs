...
![auditorarchitecture_thumb_0_0](../../../../static/img/product_docs/auditor/auditor/requirements/auditorarchitecture_thumb_0_0.webp)
...
- Netwrix Auditor collects audit data from the specified data source (application, server, storage
  system, and so on).
    ...
    - To provide a coherent picture of changes that occurred in the audited systems, the product can
      ...
      Integration API.
    - See the [Integration API](../api/overview.md) topic for additional information on custom data
