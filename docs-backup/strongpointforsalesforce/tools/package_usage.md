...
cost savings. Used in conjunction with the existing [User Activity](user_activity.md) tool, it
...
[licenses](../installing_strongpoint/features_by_license_type.md).
...
3. Click **Package Usage Tool** in the menu.
    ...
    ![Package Usage tool](../../../static/img/product_docs/strongpointforsalesforce/tools/package_usage.webp)
