...
**NOTE:** See [Install software with SMB (standard share)](/docs/endpointpolicymanager/endpointpolicymanager/video/remoteworkdelivery/smb.md)for an
...
**NOTE:** If you use theEndpoint Policy Manager Cloud service, you can deliver Group Policy settings
