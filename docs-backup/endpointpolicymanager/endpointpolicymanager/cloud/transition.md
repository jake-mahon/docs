...
[Endpoint Policy Manager Cloud: QuickStart](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/quickstart.md) topic for additional
information.
...
![941_1_image-20230521113923-1_950x502](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_1_image-20230521113923-1_950x502.webp)

You can export a Collection like this:

![941_2_image-20230521113923-2_950x589](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_2_image-20230521113923-2_950x589.webp)

Or you can export a whole category like this:

![941_3_image-20230521113923-3](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_3_image-20230521113923-3.webp)
...
![941_4_image-20230521113923-4_950x326](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_4_image-20230521113923-4_950x326.webp)
...
See the
[Endpoint Policy ManagerCloud: How to deploy Endpoint Policy Manager specific settings (using in-cloud editors and exporting from on-prem)](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/deploy/endpointpolicymanagersettings.md) topic
...
![941_5_image-20230521113923-5_950x386](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_5_image-20230521113923-5_950x386.webp)
...
See the [How to import GPOs to Endpoint Policy Manager Cloud](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/import.md) topic for
...
![941_6_image-20230521113923-6_950x448](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_6_image-20230521113923-6_950x448.webp)
...
See the
[Use Endpoint Policy Manager Cloud to deploy PP Least Privilege Manager rules](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/cloudrules.md) topic
for additional information.
...
Getting Started with Cloud > [Knowledge Base](/docs/endpointpolicymanager/endpointpolicymanager/cloud/overview/knowledgebase.md).
...
See the [Working with Groups](/docs/endpointpolicymanager/endpointpolicymanager/cloud/interface/computergroups/workingwith.md) topic for additional
information.
...
![941_8_image-20230521113923-8_950x503](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_8_image-20230521113923-8_950x503.webp)
...
![941_9_image-20230521113923-9_950x491](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_9_image-20230521113923-9_950x491.jpeg)

Then Azure groups will appear at the same level as Company Groups and you can link XML to those
Azure groups.

![941_10_image-20230521113923-10_950x286](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_10_image-20230521113923-10_950x286.jpeg)
...
![941_11_image-20230521113923-11_950x295](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_11_image-20230521113923-11_950x295.jpeg)
...
![941_12_image-20230521113923-12_950x461](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_12_image-20230521113923-12_950x461.webp)
...
![941_13_image-20230521113923-13_950x691](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_13_image-20230521113923-13_950x691.webp)
...
- [Endpoint Policy Manager Cloud: Automatically Join Groups with JOINTOKEN](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/jointoken.md)
- [Endpoint Policy Manager Cloud + MDM Services: Install Cloud Client + automatically join PPC Groups and get policy.](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/mdm.md)
...
silently. See the
[How do I deploy the Endpoint Policy Manager Cloud Client via command line silently?](/docs/endpointpolicymanager/endpointpolicymanager/install/cloud/clientsilent.md) topic
for additional information.
...
- For SCCM and MDM/Intune, perform an uninstall of the wrapped up XMLs / MSIs. You can also verify
  ...
  the
  [What is the processing order of all policies and how are conflicts resolved (and how can I see the final RsOP) of those policies (between GPO, Cloud, XML, etc)?](/docs/endpointpolicymanager/endpointpolicymanager/troubleshooting/conflictresolved.md) topic
  for additional information.
...
See the [Endpoint Policy Manager Cloud Reporting Demo](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/reports.md) topic for
additional information.
...
![941_16_image-20230521113923-16_950x529](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/941_16_image-20230521113923-16_950x529.webp)
...
See the
[Using Rings to Test and Update the Endpoint Policy Manager Client-Side Extension and/or Cloud Client (And How to Stay Supported)](/docs/endpointpolicymanager/endpointpolicymanager/install/rings.md) topic
for additional information on the Microsoft Ring methodology, which aligns to Endpoint Policy
Manager best practices.

See the
[Endpoint Policy Manager Cloud Groups CSE and Cloud Client Small-Scale Testing and Updates](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/groups.md) topic
