...
correctly.[Endpoint Policy Manager GP Compliance Reporter: Using an Existing GPO as a test](/docs/endpointpolicymanager/endpointpolicymanager/video/gpocompilancereporter/existinggpos.md)
on that process.
...
and [Endpoint Policy Manager and Microsoft Intune](/docs/endpointpolicymanager/endpointpolicymanager/video/mdm/microsoftintune.md).
