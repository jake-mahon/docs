...
[Using Endpoint Policy Manager with MDM and UEM Tools](/docs/endpointpolicymanager/endpointpolicymanager/mdm/uemtools.md) to deploy your
directives.
...
**NOTE:** See this video
[Use Endpoint Policy Manager Cloud to choose which version of Java for what website](/docs/endpointpolicymanager/endpointpolicymanager/video/javaenterpriserules/cloud.md) for
...
- Export policies or collections as XML files for use with PolicyPak Exporter and PolicyPak Cloud.
  See [Exporting Collections](/docs/endpointpolicymanager/endpointpolicymanager/javaenterpriserules/exportcollections.md) for additional information.
