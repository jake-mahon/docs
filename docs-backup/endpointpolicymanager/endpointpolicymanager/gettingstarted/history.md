...
- Least Privilege Manager: SecureRun(TM) blocks Ransomware
  [Events](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/events.md)
...
- Least Privilege Manager Block PowerShell Malware
  attacks:[Block PowerShell in General, Open up for specific items](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/bestpractices/powershellblock.md)
...
- Browser Router - New Edge Support / IE In Edge Mode
  [Manage Internet Explorer 11 and Edge Compatibility, Enterprise Modes and IE-in-Edge Mode](/docs/endpointpolicymanager/endpointpolicymanager/video/browserrouter/ie.md)
- Browser Router Apply Once then Drift
  [Endpoint Policy Manager Browser Router: Set the Windows 10 Default Browser (once) then drift](/docs/endpointpolicymanager/endpointpolicymanager/video/browserrouter/defaultwindows10.md)
...
- Added Email method for PPLPM Admin Approval
  [Using Email / Long Codes](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/longcodes.md)
