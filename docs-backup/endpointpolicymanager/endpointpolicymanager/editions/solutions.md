...
video:[Knowledge Base](/docs/endpointpolicymanager/endpointpolicymanager/grouppolicy/overview/knowledgebase.md) > Group Policy
...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Microsoft AGPM (Advanced Group Policy Management) | [Endpoint Policy Manager and AGPM](/docs/endpointpolicymanager/endpointpolicymanager/video/changemanagementutilities/advancedgrouppolicymanagement.md)                                     |
| Quest GPO Administrator                           | [Endpoint Policy Manager and Quest's GPOADmin Tool](/docs/endpointpolicymanager/endpointpolicymanager/video/changemanagementutilities/gpoadmintool.md)                                     |
| Quest Active Administrator                        | [Endpoint Policy Manager and Quest (ScriptLogic) ActiveAdministrator](/docs/endpointpolicymanager/endpointpolicymanager/video/changemanagementutilities/scriptlogicactiveadministrator.md) |
| NetIQ Group Policy Administrator                  | [Endpoint Policy Manager Integrates with NetIQ GPA](/docs/endpointpolicymanager/endpointpolicymanager/video/changemanagementutilities/netiq.md)                                            |
...
**Note**: For more information on this topic, please see this
video:[Video Learning Center](/docs/endpointpolicymanager/endpointpolicymanager/mdm/overview/videolearningcenter.md) > Started with MDM.
...
[Using Endpoint Policy Manager with MDM and UEM Tools](/docs/endpointpolicymanager/endpointpolicymanager/mdm/uemtools.md)Using with MDM and UEM
Tools.
...
Policy Manager [Setup, Download, Install, and Verify](/docs/endpointpolicymanager/endpointpolicymanager/cloud/quickstart.md).
...
[Setup, Download, Install, and Verify](/docs/endpointpolicymanager/endpointpolicymanager/cloud/quickstart.md)
...
[Knowledge Base](/docs/endpointpolicymanager/endpointpolicymanager/license/overview/knowledgebase.md) > All Things Licensing.
