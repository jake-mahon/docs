...
[Ribbon](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/operation_and_setup/ribbon/ribbon.md). A record marked as a favourite is indicated with a star in list view.
...
about both the password quality and the [Tags](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/operation_and_setup/tags/tags.md) used. Mouseover tooltips provide
...
[Client Module](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/clientmodule/client_module.md)
