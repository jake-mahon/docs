...
[Ribbon](../ribbon/ribbon.md). A record marked as a favourite is indicated with a star in list view.
...
about both the password quality and the [Tags](../tags/tags.md) used. Mouseover tooltips provide
...
[Client Module](../../clientmodule/client_module.md)
