...
In addition to the already described [Filter](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/operation_and_setup/filter/filter.md), it is possible to switch to structure
...
There are three relevant [User settings](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/mainmenu/user_settings/user_settings.md)
