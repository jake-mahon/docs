...
You can configure user settings similarly to [User rights](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/mainmenu/user_rights/user_rights.md). Here too,
...
Global settings are configured as usual in the [Main menu](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/mainmenu/main_menu_fc.md). The organisational
...
[Search](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/operation_and_setup/search/search.md) mechanisms.
...
The [User rights](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/mainmenu/user_rights/user_rights.md) define who has the required permissions to change
