...
![all passwords in mobile app](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/mobiledevices/tabs/all-passwords-ma-en.webp)
...
With a click on
![three-points-en](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/mobiledevices/tabs/three-points-en.webp)
the action menu is opened.

![actions mobile app](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/mobiledevices/tabs/actions-ma-en.webp)
...
![manage tabs](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/mobiledevices/tabs/all-passwords-ma-2-en.webp)

By clicking on the plus sign there is a possibility to add more tabs.

![add tabs](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/mobiledevices/tabs/add-tabs-ma.webp)
