...
8. In the **Visibility Level** drop-down list, select a security role. The tab would be visible to
   ...
   reports) if they fall in a lower priority role. See [Priority](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md).
...
9. In the **Access Level** drop-down list, select a security role. Users of this role and roles with
   ...
   their respective groups/direct reports. See [Priority](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md).
...
10. In the **Display Type** drop-down list, select the display type to use for rendering this field
    ...
    Types** page. See the [Display Type Categories](/docs/directorymanager/11.1/directorymanager/admincenter/portal/displaytype/categories.md) topic.
11. In the **Visibility Level** drop-down list, select a security role. The tab would be visible to
    ...
    visible to group owners (for their respective groups) and user managers (for their direct
    reports) if they fall under a lower priority role. See [Priority](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md).
...
12. In the **Access Level** drop-down list, select a security role. Users of this role and roles
    ...
    field for their respective groups/direct reports. See [Priority](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md).
...
20. Select the **Filter Bad Words** check box to ensure that users do not enter any bad word in this
    ...
    page. Matched values cannot be saved. See the [Manage the Bad Words List](/docs/directorymanager/11.1/directorymanager/admincenter/portal/design/badwords.md) topic.
