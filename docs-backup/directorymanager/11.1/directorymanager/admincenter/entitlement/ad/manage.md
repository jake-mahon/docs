...
4. In the **Included File Servers** area on the **Entitlement** page, click the ellipsis button for
   ...
   - The name of the [GroupID Entitlement Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlement.md) that computes
...
- [Manage SharePoint Sites](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/entraid/manage.md)
