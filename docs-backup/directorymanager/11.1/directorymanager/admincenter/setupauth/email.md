...
identity store. See the [Configure an SMTP Server](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/smtpserver.md) topic.
...
- [Customize Notifications](/docs/directorymanager/11.1/directorymanager/admincenter/notification/customize.md)
