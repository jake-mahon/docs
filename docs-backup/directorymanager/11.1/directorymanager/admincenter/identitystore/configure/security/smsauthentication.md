...
See the [Manage SMS Gateway Accounts](/docs/directorymanager/11.1/directorymanager/admincenter/smsgateway/manage.md) topic for creating and managing
...
[Authentication Policy for Security Roles](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/authentication.md) topic.
...
- [Manage SMS Gateway Accounts](/docs/directorymanager/11.1/directorymanager/admincenter/smsgateway/manage.md)
