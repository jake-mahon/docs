...
- **Notifications** - Directory Manager generates notifications when users are temporarily added or
  ...
  [Manage Membership Life Cycle Notifications](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/smtpserver.md#manage-membership-life-cycle-notifications)
  topic.
