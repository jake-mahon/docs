...
- **When changes are made to an identity store’s configurations** - Directory Manager enables you to
  ...
  See the [Identity Store History](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/view.md) topic to view the tracked history data.
...
[History Retention Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/historyretention.md) topic.
