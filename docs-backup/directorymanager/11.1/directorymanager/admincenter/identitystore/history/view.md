...
- [History in Directory Manager](/docs/directorymanager/11.1/directorymanager/admincenter/history.md)
- [Event Logging](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/eventlogging.md)
