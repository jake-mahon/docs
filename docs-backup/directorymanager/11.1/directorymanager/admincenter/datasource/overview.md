...
source to another. See the [Synchronize](/docs/directorymanager/11.1/directorymanager/portal/synchronize/overview.md) topic for additional
information.
...
[Query Based Advanced Search](/docs/directorymanager/11.1/directorymanager/portal/search/querysearch.md) topic for additional information.
...
[Query Designer - Database tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/database.md) topic for additional
information.
...
the [Query Based Advanced Search](/docs/directorymanager/11.1/directorymanager/portal/search/querysearch.md) topic for additional
information.
