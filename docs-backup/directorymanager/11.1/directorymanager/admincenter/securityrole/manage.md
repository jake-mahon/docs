...
5. On the **Edit Security Role** page, the **Criteria** area displays the role criteria. Click **Add
   ...
   [Security Role – Criteria](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/criteria.md) topic for details.
6. Click **Update Security Role**.
7. On the **Security Roles** page, click **Save**.
...
6. On the **Add Permissions** dialog box, select **Allow** for a permission to assign it to the
   ...
   permissions, see the [Security Role – Permissions](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/permissions.md) topic.
...
To define policies for a security role, see the [Security Role Policies](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/overview.md) topic.
