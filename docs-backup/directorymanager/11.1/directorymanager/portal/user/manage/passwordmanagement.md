...
- Helpdesk – Can reset passwords and unlock accounts for users after authentication. See the
  [Reset Passwords](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/operation/resetpassword.md) topic for detailed
  information.
- Users – Can reset their own passwords and their own accounts after passing multifactor
  ...
  - Directory Manager portal – Using it, they can:
    ...
    - reset their forgotten passwords. See the
      [Reset Passwords](/docs/directorymanager/11.1/directorymanager/portal/user/authentication/passwordreset.md) topic for further information on how
      to reset forgotten passwords.
    - change their account passwords. See the [ Change your password](/docs/directorymanager/11.1/directorymanager/portal/user/manage/changepassword.md) topic
    ...
    - reset their own password or password of any other user. See the
      [Reset your password](/docs/directorymanager/11.1/directorymanager/portal/user/manage/resetpassword.md) topic for additional information.
    - unlock their identity store account. See the [Unlock your accounts](/docs/directorymanager/11.1/directorymanager/portal/user/manage/unlockaccount.md)
  ...
  - Client Software and Web Access
    ...
    [ Credential Provider](/docs/directorymanager/11.1/directorymanager/portal/user/manage/credentialprovider.md) and available for distribution using various
    IT enabled distribution methods such as group policy and Microsoft System Center
    Configuration Manager (SCCM). See the [Install Credential Provider](/docs/directorymanager/11.1/directorymanager/portal/user/manage/installcp.md) topic for
