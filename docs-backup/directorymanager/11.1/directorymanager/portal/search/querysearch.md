...
[Query Designer](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/overview.md) dialog box similar to the query designer dialog
...
Step 4 – Select an option from the [Query Designer - General tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/general.md)
...
1. **General tab**: lets you select object categories that you want the query to search in. The
   ...
   [Query Designer - General tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/general.md) topic for additional
   information.
2. **Storage tab**: lets you filter the mailboxes to return. See the
   [Query Designer - Storage tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/storage.md) topic for additional
   information.
3. **Filter Criteria tab**: lets you add additional filter criteria. For example, you can add
   ...
   [Query Designer - Filter Criteria tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/filtercriteria.md) topic for
...
4. **Include/Exclude tab:** lets you include or exclude objects regardless of whether they are
   ...
   [Query Designer - Include/Exclude tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/includeexclude.md) topic for
   additional information.
5. **Database tab**: enables you to combine an external data source with the directory to search
   directory objects. See the [Query Designer - Database tab](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/database.md)
