...
[Query Based Advanced Search](/docs/directorymanager/11.1/directorymanager/portal/search/querysearch.md) topic.
...
You can perform multiple actions on objects. See the [Toolbar](/docs/directorymanager/11.1/directorymanager/portal/toolbar.md) topic for additional
information.
