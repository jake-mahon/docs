...
4. On the Data Source page, select the data source that contains the objects to import to the group
   ...
   - **External Data Source**
     ...
     1. On the **Providers** page, select [Query Designer](/docs/directorymanager/11.1/directorymanager/portal/group/querydesigner/overview.md) to
...
2. Click the **Search Groups** button; the [Find Dialog Box](/docs/directorymanager/11.1/directorymanager/portal/search/find.md) is displayed,
