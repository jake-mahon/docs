...
See the [Directory Manager as a Service Provider](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/overview.md) topic for
...
[Directory Manager as an Identity Provider](/docs/directorymanager/11.1/directorymanager/authenticate/asidentityprovider/overview.md) topic for additional
information.
