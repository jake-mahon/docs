...
[Configure Relaying Party Trust in AD FS](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/adfs/configurerelayingpartytrust.md) topic). In our example, we
