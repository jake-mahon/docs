...
- Generate the consumer URL and audience URL for the Directory Manager client with which you want to
  configure Microsoft Entra ID SSO. See the[Generate URLs](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/entrasso/generateurls.md) topic for additional
  information.
...
[Sign In Using Microsoft Entra ID SSO](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/entrasso/signin.md) topic for additional information.
