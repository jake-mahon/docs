...
To generate the consumer URL, see the [Generate URLs](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/adfs/generateurls.md) topic. Replace
