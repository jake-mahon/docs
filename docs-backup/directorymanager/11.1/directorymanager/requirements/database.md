...
[SQL Certificate for Windows Authentication](/docs/directorymanager/11.1/directorymanager/requirements/sqlcertificate.md) topic for additional information.
