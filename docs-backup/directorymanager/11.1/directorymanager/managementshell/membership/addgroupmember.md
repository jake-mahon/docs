...
[Set the $Credentials Environment Variable](/docs/directorymanager/11.1/directorymanager/managementshell/parameters/setthecredential.md) topic for setting
...
see [Get-Object](/docs/directorymanager/11.1/directorymanager/managementshell/membership/getobject.md). The OUT-NULL commandlet is used here to restrict the retrieved users
