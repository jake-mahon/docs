...
select [Configure a New Directory Manager Server with a New or an Existing Database](/docs/directorymanager/11.1/directorymanager/install/configure/gidserver.md)
option. See Step 3 on the [Configuration Tool](/docs/directorymanager/11.1/directorymanager/install/configure/configure.md) topic.
...
- SQL Server Authentication - To set SQL Server to work with Directory Manager using an SQL Server
  account. See the [Authentication Modes](/docs/directorymanager/11.1/directorymanager/requirements/setupauthentication.md) topic for
...
[Update Signing Key](/docs/directorymanager/11.1/directorymanager/install/configure/signingkeyinfo.md) topic for information how Configuration Tool will update
