...
- [Approve a request](/docs/directorymanager/11.0/directorymanager/portal/request/allrequest.md#approve-a-request).
- [Deny a request](/docs/directorymanager/11.0/directorymanager/portal/request/allrequest.md#deny-a-request).
- [Filter requests](/docs/directorymanager/11.0/directorymanager/portal/request/allrequest.md#filter-requests).

**See Also**

- [Requests](/docs/directorymanager/11.0/directorymanager/portal/request/overview.md)
- [All Requests](/docs/directorymanager/11.0/directorymanager/portal/request/allrequest.md)
