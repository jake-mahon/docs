...
- The [My History](/docs/directorymanager/11.0/directorymanager/portal/history/myhistory.md) page.  
...
- The
  ...
  user.
- The [My Groups' History](/docs/directorymanager/11.0/directorymanager/portal/history/mydirectorygroup.md)
  page.  
