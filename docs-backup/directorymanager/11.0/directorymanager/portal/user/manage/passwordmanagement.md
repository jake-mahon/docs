...
- **Users**: can reset their own passwords and their own accounts after passing multifactor
  ...
  - **GroupID portal**: Using it, they can:
    ...
    - reset their forgotten passwords. See the
      [Reset Passwords](/docs/directorymanager/11.0/directorymanager/portal/user/authentication/passwordreset.md)
  ...
  - **Client Software and Web Access**
    ...
    [ GroupID Credential Provider](/docs/directorymanager/11.0/directorymanager/portal/user/manage/credentialprovider.md)
    ...
    [Install GroupID Credential Provider](/docs/directorymanager/11.0/directorymanager/portal/user/manage/installcp.md)
  ...
  - **Passwordless Authentication with QR Code**
    ...
    [With QR Code](/docs/directorymanager/11.0/directorymanager/admincenter/signin.md#with-qr-code)
    section in the
    [Access Admin Center](/docs/directorymanager/11.0/directorymanager/admincenter/signin.md) topic.
