...
select the [Expired Groups](/docs/directorymanager/11.0/directorymanager/portal/group/allexpiredgroups.md)
or [Deleted Groups](/docs/directorymanager/11.0/directorymanager/portal/group/recyclebin/overview.md)
respectively.
...
[Filter All Groups](/docs/directorymanager/11.0/directorymanager/portal/group/allgroups.md#filter-all-groups)
