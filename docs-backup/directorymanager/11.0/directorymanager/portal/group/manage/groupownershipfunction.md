...
4. On the
   ...
   [Find Dialog Box](/docs/directorymanager/11.0/directorymanager/portal/search/find.md), where you can
...
5. Enter a search string to locate the object to add as an additional owner, or click **Advanced**
   to use the [Find Dialog Box](/docs/directorymanager/11.0/directorymanager/portal/search/find.md) for
   performing a search.
...
1. In GroupID portal, click **Groups** in the left navigation pane, select **My Groups**.
   ...
   [Directory Search](/docs/directorymanager/11.0/directorymanager/portal/search/search.md) a group to
...
4. See
   [Import Additional Owners](/docs/directorymanager/11.0/directorymanager/portal/group/properties/importadditionalowners.md)
