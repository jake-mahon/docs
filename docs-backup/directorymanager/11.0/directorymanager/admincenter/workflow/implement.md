...
9. The **Approver Acceleration** check box applies if approver acceleration is enabled for the
   ...
   [Apply Approver Acceleration](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/approveracceleration.md#apply-approver-acceleration)
   topic.
...
[Trigger a Flow from GroupID](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/integrate.md#trigger-a-flow-from-groupid)
topic.
...
6. To link this workflow to a Power Automate flow, click **Power Automate Settings** in the top
   ...
   in the
   [Link an Identity Store Workflow to a Flow](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/integrate.md#link-an-identity-store-workflow-to-a-flow)
...
- [Workflows](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/overview.md)
- [Manage Advanced Workflow Settings](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/advancedsettings.md)
- [Workflow Approver Acceleration](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/approveracceleration.md)
- [Integrate with Power Automate](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/integrate.md)
