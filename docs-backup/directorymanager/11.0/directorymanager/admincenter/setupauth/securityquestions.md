...
See the
[Manage the Global Question Pool ](/docs/directorymanager/11.0/directorymanager/admincenter/general/globalpool.md)topic.

## Modify the Local Question Pool

See the
[Manage the Local Question Pool](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/security/securityquestions.md)
topic.
...
See the
[Define Security Question Settings for a Security Role](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/password.md#define-security-question-settings-for-a-security-role) topic.
