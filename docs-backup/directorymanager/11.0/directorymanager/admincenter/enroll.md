...
- For multifactor authentication, a user may have to enroll with more than one authentication type,
  ...
  the[Enforce Authentication Types for Multifactor Authentication](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/authentication.md#enforce-authentication-types-for-multifactor-authentication)
  topic.
...
[Define Security Question Settings for a Security Role](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/password.md#define-security-question-settings-for-a-security-role)
topic.
...
2. On signing in, unenrolled users are redirected to the **Your Enrollments** page. Tabs on this
   ...
   the
   [Enroll your Account](/docs/directorymanager/11.0/directorymanager/admincenter/general/accessapplications.md#enroll-your-account)
   topic.
...
[Link an SMS Gateway Account to an Identity Store](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/security/smsauthentication.md#link-an-sms-gateway-account-to-an-identity-store)
topic.
...
[Modify the Email Template](/docs/directorymanager/11.0/directorymanager/admincenter/setupauth/email.md#modify-the-email-template)
topic.
...
- [Authentication Policy](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/authpolicy.md)
- [Enable Authentication Types](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/authtypes.md)
- [Authentication Policy for Security Roles](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/authentication.md)
- [Authenticate with Authentication Types](/docs/directorymanager/11.0/directorymanager/admincenter/authenticate.md)
