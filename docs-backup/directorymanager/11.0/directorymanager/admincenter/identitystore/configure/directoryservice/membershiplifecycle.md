...
- **Notifications** - GroupID generates notifications when users are temporarily added or removed
  ...
  [Manage Membership Life Cycle Notifications](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/smtpserver.md#manage-membership-life-cycle-notifications)
  topic.
