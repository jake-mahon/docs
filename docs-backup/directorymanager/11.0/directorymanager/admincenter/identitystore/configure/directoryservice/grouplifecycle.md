...
[Group Expiration Policy](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/moreinfo/advsentraid.md#group-expiration-policy)
section in the
[Microsoft Entra ID vs. Active Directory Identity Stores](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/moreinfo/advsentraid.md)
topic.
