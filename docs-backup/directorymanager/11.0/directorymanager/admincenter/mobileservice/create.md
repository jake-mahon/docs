...
[Prerequisites for Deployments in Remote IIS](/docs/directorymanager/11.0/directorymanager/admincenter/portal/remoteiisprerequisites.md)
topic.
...
7. To enter information for **API URL**, **Access Token**, **Username**, **Password**, **IIS
   ...
   [Create a Portal in Remote IIS](/docs/directorymanager/11.0/directorymanager/admincenter/portal/create.md#create-a-portal-in-remote-iis)
...
[Prerequisites for Deployments in Docker](/docs/directorymanager/11.0/directorymanager/admincenter/portal/dockerprerequisites.md)
topic.
...
7. To enter information for **Port**, **Service URL**, and **Container Name**, refer to steps 7-9 in
   the
   [Create a Portal in Docker](/docs/directorymanager/11.0/directorymanager/admincenter/portal/create.md#create-a-portal-in-docker)
   topic. Replace any reference to the portal with the Mobile service.
8. To enter information in the **Service Endpoints** and **Select Identity Stores** areas, refer to
   steps 9-10 in the [Create a Mobile Service in Native IIS](#create-a-mobile-service-in-native-iis)
   topic.
...
[Deploy Multiple Instances of a Portal](/docs/directorymanager/11.0/directorymanager/admincenter/portal/create.md#deploy-multiple-instances-of-a-portal)
topic.
...
[Configure the App](/docs/directorymanager/11.0/directorymanager/admincenter/mobileservice/phonesetup.md#configure-the-app)
topic.
...
[View the Launch URL for an Instance](/docs/directorymanager/11.0/directorymanager/admincenter/mobileservice/server/deployment.md#view-the-launch-url-for-an-instance)
topic.
