...
- **As source and destination in Synchronize jobs** - Synchronize jobs enable you to provision
  ...
  [Synchronize](/docs/directorymanager/11.0/directorymanager/portal/synchronize/overview.md) topic.
...
- [Create a Data Source](/docs/directorymanager/11.0/directorymanager/admincenter/datasource/create.md)
- [Manage a Data Source](/docs/directorymanager/11.0/directorymanager/admincenter/datasource/manage.md)
