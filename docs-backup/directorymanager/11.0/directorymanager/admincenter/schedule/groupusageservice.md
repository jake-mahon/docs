...
12. Click **Add Authentication** in the **Authentication** area to specify an account for running
    ...
    [Schedules for Microsoft Entra ID Identity Store](/docs/directorymanager/11.0/directorymanager/admincenter/schedule/overview.md#schedules-for-microsoft-entra-id-identity-store)
    section of the
    [Schedules](/docs/directorymanager/11.0/directorymanager/admincenter/schedule/overview.md) topic for
