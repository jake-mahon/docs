...
As discussed in the
[Assign Distinct Roles to a User in Different GroupID Clients](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/overview.md#assign-distinct-roles-to-a-user-in-different-groupid-clients)
