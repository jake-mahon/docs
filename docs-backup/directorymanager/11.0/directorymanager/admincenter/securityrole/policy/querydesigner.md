...
[ Specify Smart Group Query Attributes](/docs/directorymanager/11.0/directorymanager/admincenter/portal/design/queryattributes.md)
topic.
...
8. You can also create an advanced query by adding more rows and applying the **AND** or **OR**
   ...
   [Designate a Criterion for the Search Scope](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/search.md#designate-a-criterion-for-the-search-scope)
   topic.  
