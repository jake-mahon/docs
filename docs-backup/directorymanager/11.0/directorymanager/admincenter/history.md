...
[Retain Complete History Data](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/historytracking.md#retain-complete-history-data)
and
[Retain History for a Specific Period](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/historytracking.md#retain-history-for-a-specific-period)
...
[Event Logging](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/history/eventlogging.md)
topic.

**See Also**

- [Admin Center History](/docs/directorymanager/11.0/directorymanager/admincenter/general/history.md)
- [History in Helpdesk](/docs/directorymanager/11.0/directorymanager/admincenter/helpdesk/history.md)
...
- [History](/docs/directorymanager/11.0/directorymanager/portal/history/overview.md) (for directory objects)
