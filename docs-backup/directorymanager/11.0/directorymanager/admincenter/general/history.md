...
3. The **Add Note** button is available if you performed this action. See
   [Annotate History Items](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/history/details.md#annotate-history-items)
   to manage notes.
4. Click **Close**.
...
page. Refer to the
[Filter History Data](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/history/view.md#filter-history-data)
...
[Navigate Through History Items](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/history/view.md#navigate-through-history-items)
topic for help.
...
- [History in GroupID](/docs/directorymanager/11.0/directorymanager/admincenter/history.md)
