...
2. Click the AD FS button or image; you will be redirected to the AD FS authentication page with the
   ...
   [Provide IDP Login URL](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/adfs/configureadfsindirectorymanager.md#provide-idp-login-url)
   topic).
