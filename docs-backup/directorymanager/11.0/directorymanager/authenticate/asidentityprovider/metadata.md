...
2. On the **Settings** page, the **Base URL** box displays the default Issuer URL, which is
   ...
   [GroupID Metadata for Service Provider Configurations](/docs/directorymanager/11.0/directorymanager/authenticate/asidentityprovider/register.md#groupid-metadata-for-service-provider-configurations)
   topic.  
