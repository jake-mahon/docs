...
- [SQL_SensitiveData Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/sql/sensitivedata/sql_sensitivedata.md)
...
- [SQL_SensitiveDataPermissions Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/sql/sensitivedata/sql_sensitivedatapermissions.md)
