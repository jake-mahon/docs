...
- [AD_DirectMembership Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_directmembership.md)
...
- [AD_DuplicateUsers Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_duplicateusers.md)
  ...
  account.
- [AD_OrphanedUsers Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_orphanedusers.md)
...
- [AD_PasswordStatus Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_passwordstatus.md)
  – Highlights potential issues with user password settings that may exploited or compromised if not
  addressed
- [AD_ServiceAccounts Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_serviceaccounts.md)
...
- [AD_SIDHistory Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_sidhistory.md)
...
- [AD_StaleUsers Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_staleusers.md)
...
- [AD_UserAttributeCompletion Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_userattributecompletion.md)
...
- [AD_UserDelegation Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_userdelegation.md)
...
- [AD_UserToken Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_usertoken.md)
...
- [AD_WeakPasswords Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/users/ad_weakpasswords.md)
