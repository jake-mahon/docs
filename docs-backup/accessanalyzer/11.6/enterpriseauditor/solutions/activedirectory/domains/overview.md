...
- [0.Collection Job Group](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/domains/collection/overview.md)
  – Collects the data which will be further analyzed in order to provide details on domains, sites,
  and trusts.
- [AD_DCSummary Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/domains/ad_dcsummary.md)
...
- [AD_DomainInfo Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/domains/ad_domaininfo.md)
...
- [AD_DSRMSettings Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/activedirectory/domains/ad_dsrmsettings.md)
