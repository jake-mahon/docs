...
- [FS_EmptyResources Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/content/sizing/fs_emptyresources.md)
  – Designed to report on empty resources from targeted file servers
- [FS_LargestResources Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/content/sizing/fs_largestresources.md)
  – Designed to report on the largest resources from targeted file servers
- [FS_SmallestResources Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/content/sizing/fs_smallestresources.md)
