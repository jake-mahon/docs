...
![Host Discovery page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/hostdiscovery.webp)
...
![Log level options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/hostdiscoveryloglevels.webp)
...
![Host Discovery Log under Host Discovery node](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/hostdiscoverylog.webp)
