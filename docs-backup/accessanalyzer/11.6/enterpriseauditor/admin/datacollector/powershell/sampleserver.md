...
![PowerShell Data Collector Wizard Select Server page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/powershell/selectserver.webp)
