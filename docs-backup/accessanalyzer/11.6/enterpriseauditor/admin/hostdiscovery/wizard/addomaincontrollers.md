...
![Host Discovey Wizard Source page for AD Domain Controllers query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/source.webp)
...
![Host Discovey Wizard Query page for AD Domain Controllers query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/nis/query.webp)
...
![Host Discovey Wizard Domains & Sites page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/domainssites.webp)
...
![Host Discovey Wizard Options page for AD Domain Controllers query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/options.webp)
...
![Host Discovey Wizard Inventory page for AD Domain Controllers query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/inventory.webp)
...
![Host Discovey Wizard Summary page for AD Domain Controllers query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adinventory/summary.webp)
