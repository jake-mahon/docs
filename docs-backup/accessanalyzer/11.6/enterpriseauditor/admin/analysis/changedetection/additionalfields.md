...
![Change Detection Data Analysis Module wizard Additional Fields page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/changedetection/additionalfields.webp)
