...
![Host Inventory Settings page](../../../../../static/img/product_docs/accessanalyzer/admin/settings/hostinventory.webp)
...
- Only refresh inventory items older than [time selected] – Indicates the time that needs to pass
  before the host inventory process is automatically refreshed
    ...
    - This setting affects the Inventory page options on the Host Discovery Wizard. See the
      [Host Discovery Wizard](../hostdiscovery/wizard/overview.md) topic for additional information.
...
![AD Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/ad.webp)
...
![ALL WINDOWS HOSTS Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/allwindowshosts.webp)
...
![DG Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/dg.webp)
...
![EXCHANGE Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/exchange.webp)
...
![SQL Servers Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/sqlservers.webp)
...
![Windows Server Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/windowsserver.webp)
...
![Work Station Host List](../../../../../static/img/product_docs/accessanalyzer/admin/settings/workstation.webp)
