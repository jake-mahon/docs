...
[0.Collection > AD_ActivityCollection Job](ad_activitycollection.md) in order to connect to either
...
[0.Collection > AD_ActivityCollection Job](ad_activitycollection.md).
...
See the [Active Directory Solution](../../../requirements/solutions/activedirectory.md) topic for
