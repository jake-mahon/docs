...
information, refer to [Hardware Requirements](/docs/dataclassification/5.7/ndc/requirements/hardwarerequirements.md).
...
[Requirements to Install Netwrix Data Classification](/docs/dataclassification/5.7/ndc/requirements/overview.md). Virtual
...
[See Configuring NDC Servers Cluster and Load Balancing with DQS Mode for more information.](/docs/dataclassification/5.7/ndc/requirements/dqsmode.md)
