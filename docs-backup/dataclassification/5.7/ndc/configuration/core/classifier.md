...
- [General Options](/docs/dataclassification/5.7/ndc/configuration/core/generaloptions.md)
- [You can decrease the Classifier load, targeting it at monitored content only. This means that you can schedule content to be automatically re-classified only when a specific condition or set of conditions are met, or with a minimum time period between runs.](/docs/dataclassification/5.7/ndc/configuration/core/monitoredcontent.md)
- [conceptClassifier App Options](/docs/dataclassification/5.7/ndc/configuration/core/conceptclassifier.md) (advanced settings)
- [Engine Options](/docs/dataclassification/5.7/ndc/configuration/core/engineoptions.md)
...
- Run Cleaner—Run built-in tool to automate maintenance operations.
  [See Index Maintenance for more information.](/docs/dataclassification/5.7/ndc/admin/utilities/indexmaintenance.md)
