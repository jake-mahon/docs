...
[Password Reset Client](password_reset_client.md) topic for additional information. Both server
...
![installing_npr](../../../../../static/img/product_docs/passwordreset/passwordreset/evaluation/installing_npr.webp)
...
the [Securing Password Reset](../administration/securing_password_reset.md) topic of the Password
