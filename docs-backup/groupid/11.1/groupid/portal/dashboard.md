...
![dashboard](../../../../static/img/product_docs/groupid/groupid/portal/dashboard.webp)
...
display information for objects. See the [Directory Search](search/search.md) topic.
