...
[Miscellaneous](../../admincenter/securityrole/permissions.md#miscellaneous) section of the
[Security Role – Permissions](../../admincenter/securityrole/permissions.md) topic.
