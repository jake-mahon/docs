...
2. Click **Next**.
    ...
    ![database settings](/img/versioned_docs/groupid_11.0/groupid/install/configure/databasesettings.webp)
...
7. Click **Next**.
    ...
    ![License page](/img/versioned_docs/groupid_11.0/groupid/install/configure/license_w_existing_db_option.webp)
...
9. Click **Next**.
    ...
    ![GroupID Service Configurations](/img/versioned_docs/groupid_11.0/groupid/install/configure/servicesconfiguration.webp)
...
11. Click **Next**.
    ...
    ![Elasticsearch Settings page](/img/versioned_docs/groupid_11.0/groupid/install/configure/elasticsearchsettings.webp)
...
13. Click **Next**.
    ...
    ![Service Account Settings page](/img/versioned_docs/groupid_11.0/groupid/install/configure/service_account_settings_w_existing_db.webp)
...
17. Click **Configure**.
    ...
    ![Configuring GroupID ](/img/versioned_docs/groupid_11.0/groupid/install/configure/configuring.webp)

18. The next page displays the progress while a GroupID server is configured on the machine.

    ![GroupID Configured successfully](/img/versioned_docs/groupid_11.0/groupid/install/configure/configuresuccess.webp)
