...
4. The Global Script Editor allows the script author to extend the functionality of Synchronize by
   ...
   verified by compiling the script. Click on **Edit Global Script,**and follow these steps:
    ...
    7. The toolbar displays various actions that you can perform on your script:
        ...
        | Icon                                                                                          | Description                                            |
        | --------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
        | ![undo](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/undo.webp)             | Reverses the last change.                              |
        | ![redo](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/redo.webp)             | Re-applies a change reversed using the Undo action.    |
        | ![indent](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/indent.webp)         | Increases the indenting of the current text selection. |
        | ![outdent](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/outdent.webp)       | Decreases the indenting of the current text selection. |
        | ![comment](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/comment.webp)       | Comments the current text selection.                   |
        | ![uncomment](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/uncomment.webp)   | Uncomments the current text selection.                 |
        | ![uppercase](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/uppercase.webp)   | Converts the current text selection to uppercase.      |
        | ![lowercase](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/lowercase.webp)   | Converts the current text selection to lowercase.      |
        | ![darktheme](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/darktheme.webp)   | Switch the theme of the script editor to dark.         |
        | ![lighttheme](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/lighttheme.webp) | Switch the theme of the script editor to light.        |
        | ![selectall](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/selectall.webp)   | Selects all the text in the editor.                    |
