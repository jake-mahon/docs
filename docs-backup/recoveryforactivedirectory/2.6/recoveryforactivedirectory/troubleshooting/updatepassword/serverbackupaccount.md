...
[Add Backup Configurations for a Domain Controller](/docs/recoveryforactivedirectory/2.6/recoveryforactivedirectory/admin/forest/forest.md#add-backup-configurations-for-a-domain-controller)
