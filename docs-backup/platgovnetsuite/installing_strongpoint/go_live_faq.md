...
[Creating a Change Request](/docs/platgovnetsuite/change_management/creating_change_request.md) for details.
...
Refer to [Setting Up the AutoSpider and Alerts](/docs/platgovnetsuite/installing_strongpoint/running_the_spider.md) for details.
...
If your site uses [Opportunistic Clearance](/docs/platgovnetsuite/change_management/opportunistic_clearance.md), the
...
[License Manager](/docs/platgovnetsuite/installing_strongpoint/license_manager.md) topic.
