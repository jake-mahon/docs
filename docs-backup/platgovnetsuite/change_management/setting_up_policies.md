...
- **User Offboarding**: Available when [Enhanced User Provisioning](/docs/platgovnetsuite/change_management/user_provisioning.md) is
  enabled.
- **User Onboarding**: Available when [Enhanced User Provisioning](/docs/platgovnetsuite/change_management/user_provisioning.md) is enabled.
