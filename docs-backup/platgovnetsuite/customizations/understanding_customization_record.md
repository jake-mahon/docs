...
- **Detailed Metadata**: Details about the customization including Fields, Values, Bundle / SuiteApp
  information, [Date Last Used](/docs/platgovnetsuite/clean_up/date_last_used.md), Last Used Status, and who uses the
...
on the
[Managed Bundle/App Updates](/docs/platgovnetsuite/change_management/change_management_reports.md#managed-bundleapp-updates)
report.
