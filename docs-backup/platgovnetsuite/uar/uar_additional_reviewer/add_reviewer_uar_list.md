...
- **Name** is a link. For a **global** review, the link opens the Review list showing all of the
  associated reviews. For a **single** review the [Membership](/docs/platgovnetsuite/uar/uar_additional_reviewer/add_reviewer_membership_reviews.md)
  or [Permission ](/docs/platgovnetsuite/uar/uar_owner/owner_permission_reviews.md)**Review** tab is opened. Reviews can
...
- **Extract Permission Detail**creates a CSV file (_Permission_Report.csv_) of the permission
  details for the reviews.
- **Review Name** is a link to the [Membership](/docs/platgovnetsuite/uar/uar_additional_reviewer/add_reviewer_membership_reviews.md) **Review** tab.
...
[Membership](/docs/platgovnetsuite/uar/uar_additional_reviewer/add_reviewer_membership_reviews.md) reviews.
