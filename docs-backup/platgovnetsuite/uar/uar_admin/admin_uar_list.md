...
[UAR History](/docs/platgovnetsuite/uar/uar_history.md).
...
Owners are assigned on the administrator's [Owner's List](/docs/platgovnetsuite/uar/uar_admin/admin_owner_list.md), available on your
menu.
...
- **Review Name** is a link to the [Membership](/docs/platgovnetsuite/uar/uar_owner/owner_membership_reviews.md) or
  [Permission ](/docs/platgovnetsuite/uar/uar_owner/owner_permission_reviews.md)**Review** tab. Reviews can also be opened
