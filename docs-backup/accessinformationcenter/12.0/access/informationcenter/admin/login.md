...
[Alias Server Host Name](/docs/accessinformationcenter/12.0/access/informationcenter/admin/additionalconfig/aliasserver.md) topic for additional information.
...
upon the assigned role or lack of assigned role. See the [User Landing Page](/docs/accessinformationcenter/12.0/access/informationcenter/admin/userlanding.md) topic
...
depends upon the assigned role or lack of assigned role. See the [User Landing Page](/docs/accessinformationcenter/12.0/access/informationcenter/admin/userlanding.md)
