...
the [Search Features](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/navigate/search.md) topic for additional information. It contains three panes in all
...
breadcrumb. See the [Sensitive Content Reports](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/sensitivecontent/overview.md) topic for
