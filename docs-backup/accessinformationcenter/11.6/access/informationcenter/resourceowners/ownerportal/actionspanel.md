...
- Reviews — Opens the Reviews page. If any of your resources have pending reviews, a count of
  ...
  [Owners & Resource Reviews](/docs/accessinformationcenter/11.6/access/informationcenter/resourcereviews/pendingreviews.md)
...
- Access Requests — Opens the Access Requests page. If any of your resources have pending access
  ...
  [Owners & Access Requests](/docs/accessinformationcenter/11.6/access/informationcenter/accessrequests/owners/overview.md)
  topic for additional information.
