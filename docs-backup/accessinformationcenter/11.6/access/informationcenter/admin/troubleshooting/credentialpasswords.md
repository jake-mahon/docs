...
[Update the Database Service Account Password](/docs/accessinformationcenter/11.6/access/informationcenter/admin/configuration/database.md#update-the-database-service-account-password)
...
[Update the Active Directory Service Account Password](/docs/accessinformationcenter/11.6/access/informationcenter/admin/configuration/activedirectory.md#update-the-active-directory-service-account-password)
topic for instructions.
...
interface. See the
[Configure SMTP Server Settings](/docs/accessinformationcenter/11.6/access/informationcenter/admin/configuration/notifications.md#configure-smtp-server-settings)
topic for instructions.
