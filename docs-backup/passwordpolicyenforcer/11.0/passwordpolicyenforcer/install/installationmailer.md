...
[Notifications](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/administration/configconsole.md#notifications) topic for additional information.
...
Follow the procedure in [Install Password Policy Enforcer on a Server](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/install/installationserver.md),
