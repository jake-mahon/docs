...
Opens the Notification settings. See the [Configuration Console](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/administration/configconsole.md) topic for
additional details.
