...
[Similarity Rule](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/administration/similarity_rule.md) can not be enforced. Users only see the default Windows error
