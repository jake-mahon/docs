...
![Allows you to make complete system backups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/listofsystembackups.webp)
...
**CAUTION:** Once deleted, a backup cannot be recovered.
...
**CAUTION:** When using the Restore Backup feature, we recommend requesting assistance from customer
support.

![Allows you to make complete system backups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/createsystembackup.webp)
...
**NOTE:** The System Backup will not contain nor preserve the IP Address, File Shadowing copies or
...
![System Backup Status](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/systembackupstatus.webp)
...
**_RECOMMENDED:_** Endpoint Protector Backup Files (.eppb) larger than 200 MB can only be uploaded
...
![Upload System Backup](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/uploadsystembackup.webp)
...
**_RECOMMENDED:_** A scheduled routine is recommended in order to prevent unwanted loss.

![Schedule an automatic backup routine](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/availablebackups.webp)
...
![Endpoint Protector offers the option to revert the system to a previous state from the administrative console on which the initial conﬁguration occurs.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/administrativeconsole.webp)
...
![An administrator will need to provide the system a valid FTP IP address and the path inside its ﬁlesystem to the .eppb ﬁle](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/ftpconnectiondetails.webp)
...
**NOTE:** This feature is not intended as a replacement for the System Backup functionality but
...
![Migrate the database (entities, rights, settings, policies, conﬁgurations, etc.) from an older Endpoint Protector Server to a newer one.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/listofsystembackups.webp)
...
![Creating a System Backup v2 (Migration)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/createsystembackupone.webp)

**NOTE:** For security purposes, the System Backup Key will not be stored by the Endpoint Protector.
Before proceeding, make sure it is properly saved.

![Creating a System Backup v2 (Migration)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/createsystembackuptwo.webp)
...
**NOTE:** If needed, previous System Backups or Audit Log Backups should be downloaded prior to this
...
![Importing and Restore (Migrate)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/importingrestore.webp)
