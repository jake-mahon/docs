...
![Retrieve, organize and clean-up ﬁles used by the Endpoint Protector Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/filemaintenance.webp)
...
![View the list of exported entities, download or delete them, and view the scheduled export in the system and reschedule them accordingly](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/listofentities.webp)
...
![Initiate the manual generation of the scheduled export from the Device Control](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/listofdevices.webp)

![Manual generation of the scheduled export from the Device Control](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/dcscheduleexport.webp)
...
![The System Snapshots module allows you to save all device control rights and settings in the system and restore them later if needed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/systemsnapshots.webp)
...
![Restore a previously created snapshot](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/restoresnapshot.webp)
...
![Allows old logs to be saved and exported](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/auditlogbackup.webp)
...
![Audit Log Backup Scheduler](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/scheduledbackup.webp)
...
![Externalize ﬁles generated by Endpoint Protector to a particular storage disk from the network](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/externalstorage.webp)
...
![Conﬁgure an FTP Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/ftpserver.webp)
...
![Conﬁgure an SFTP Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/sftpserver.webp)
...
![Conﬁgure a Samba / Network Share Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemmaintenance/sambastorage.webp)
