...
[Directory Services](/docs/endpointprotector/5.9.4.2/endpointprotector/admin/directoryservices/overview.md) topic.
...
[Exported Entities](/docs/endpointprotector/5.9.4.2/endpointprotector/admin/systemmaintenance/overview.md#exported-entities) topic to view the Deep
...
[Directory Services](/docs/endpointprotector/5.9.4.2/endpointprotector/admin/directoryservices/overview.md) topic. You can also assign the computers to
the following for a better organization:

- Devices and Computers e.g., several computers within the same oﬃce
- [System Configuration](/docs/endpointprotector/5.9.4.2/endpointprotector/admin/systemconfiguration/overview.md) an alternative organization to Groups
