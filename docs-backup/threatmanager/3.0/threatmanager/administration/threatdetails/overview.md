...
selecting the threat from the list on the [Threats Page](/docs/threatmanager/3.0/threatmanager/administration/threats.md) and clicking View Details.
...
In the Threat Activity Diagram, click the user to view the [User Details Page](/docs/threatmanager/3.0/threatmanager/administration/threatdetails/user.md) page. Click
the host to view the [Host Details Page](/docs/threatmanager/3.0/threatmanager/administration/threatdetails/host.md) page.
