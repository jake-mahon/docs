...
![Policy window - Active Directory Lockdown Event Type](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adlockdown.webp)
...
![Policy window - AD Objects and Containers filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adobjectsandcontainers.webp)
...
![Policy window - AD Classes And Attributes filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adclassesattributes.webp)
...
![Policy window - User Account Control (UAC) filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/useraccountcontrol.webp)
