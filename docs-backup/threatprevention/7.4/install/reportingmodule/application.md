...
![Netwrix Threat Mannager Reporting Setup wizard on the Completed page](/img/versioned_docs/accessanalyzer_11.6/accessanalyzer/install/sensitivedatadiscovery/completed.webp)
