...
**Step 2 –** If desired, on the [General Tab](/docs/threatprevention/7.5/admin/policies/general.md) select the Active At Specified
...
**Step 3 –** On the [Event Type Tab](/docs/threatprevention/7.5/admin/policies/eventtype/overview.md), configure the Event Filters
...
**Step 4 –** If desired, on the [Actions Tab](/docs/threatprevention/7.5/admin/policies/actions/overview.md) assign any actions to
be a part of this policy.

**Step 5 –** Return to the [General Tab](/docs/threatprevention/7.5/admin/policies/general.md) and check the **Enabled** box to
