...
- Windows Server can be physical or virtual. See the
  [Virtual Environment Recommendations](application.md#virtual-environment-recommendations)topic for
...
Prevention. See the [Database Maintenance Feature Requirements](/docs/threatprevention/7.5/requirements/dbmaintenance.md) topic for
additional information.
