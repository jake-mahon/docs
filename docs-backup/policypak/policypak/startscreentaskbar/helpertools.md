...
[Endpoint Policy Manager Least Priv Manager Tools Setup](../video/leastprivilege/toolssetup.md), and
...
- General Tab
    ...
    - Target Path: Click "…" and browse to "C:\Program Files\PolicyPak\Least Privilege
      ...
      Privilege Manager\Tools\PolicyPak.Tools.NetworkConnections.exe)
