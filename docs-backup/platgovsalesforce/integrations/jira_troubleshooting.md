...
Refer to [Credentials](/docs/platgovsalesforce/installing_strongpoint/config_and_stats.md#credentials) for more
...
Refer to [Status Mapping](/docs/platgovsalesforce/installing_strongpoint/config_and_stats.md#status-mapping) for more
