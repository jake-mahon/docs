...
[Jira Field Mapping](/docs/platgovsalesforce/integrations/jira_field_map.md) for details.
...
**Next Step:** [Jira Walkthrough Example](/docs/platgovsalesforce/integrations/jira_walkthrough_example.md)
