...
[Configure Device Discovery](/docs/changetracker/8.1/changetracker/integration/itsm/syncserviceadmin.md#configure-device-discovery) section in
[Sync Service Administration](/docs/changetracker/8.1/changetracker/integration/itsm/syncserviceadmin.md) topic for additional information.
