...
- Edit — Opens the Edit a Managed Account window. See the
  [Edit a Managed Account Window](/docs/privilegesecure/4.2/privilegesecure/accessmanagement/admin/policy/window/resources/editamanagedaccount.md) topic for
