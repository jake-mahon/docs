...
- Adding a sudo user:
  ...
  - [Linux: Add Sudo User to Ubuntu System](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/systemmanagement/linuxaddsudouser.md)
...
- Postman program (used for individual system registration) -
  [Postman Linux Registration](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/systemmanagement/postmanlinuxregistration.md)
