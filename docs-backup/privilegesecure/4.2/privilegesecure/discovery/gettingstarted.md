...
[Virtual Machines](/docs/privilegesecure/4.2/privilegesecure/discovery/requirements/virtualmachines.md)  
Allow
...
[Dashboard Guide](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/reporting/dashboardguide.md)
...
[Add a User or Group to a Systems' Administrator Account Inventory](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/systemmanagement/adduserorgroup.md)  
Before
...
[Linux Registrations Prerequisites](/docs/privilegesecure/4.2/privilegesecure/discovery/linuxregistrationsprerequisites.md)
...
- [Postman: Installing and Configuring ](/docs/privilegesecure/4.2/privilegesecure/discovery/postman_-_installing_and_configuring_.md)
...
- [Offline Access Management (OAM) - Extended](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/systemmanagement/oamextended.md)
