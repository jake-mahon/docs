...
- Add — Opens the Add Resources window. See the
  [Add Resources Window for Protected Policy](/docs/privilegesecure/4.1/privilegesecure/accessmanagement/admin/policy/window/protectionpolicies/addresources.md)
