...
Let's read some
[use case stories](/docs/identitymanager/6.1/identitymanager/introduction-guide/overview/use-cases/index.md).

## Learn More

[Learn more on governance](/docs/identitymanager/6.1/identitymanager/integration-guide/governance/index.md).

[Learn more on reporting](/docs/identitymanager/6.1/identitymanager/user-guide/administrate/reporting/index.md).

[Learn more on access certification](/docs/identitymanager/6.1/identitymanager/user-guide/administrate/access-certification/index.md).

[Learn more on risk management](/docs/identitymanager/6.1/identitymanager/user-guide/optimize/risk-management/index.md).
