...
[Integration Guide](/docs/identitymanager/6.1/identitymanager/integration-guide/index.md)'s or the
[User Guide](/docs/identitymanager/6.1/identitymanager/user-guide/index.md)'s contents.
...
[overview of IGA and Usercube](/docs/identitymanager/6.1/identitymanager/introduction-guide/overview/index.md).
