...
- needing to encrypt the requests from/to end-users on the one hand, and on the other hand to be
  ...
  ![Proxy Purposes: Encryption](/img/versioned_docs/identitymanager_6.1/identitymanager/installation-guide/reverse-proxy/proxy_purpose_encryption.webp)
...
- installing Usercube with an integrated agent on a network isolated from the users' browsers, in
  ...
  ![Proxy Installation Example](/img/versioned_docs/identitymanager_6.1/identitymanager/installation-guide/reverse-proxy/proxy_example.webp)
...
- using several Usercube's server instances for load-balancing purposes.
  ...
  ![Proxy Purposes: Load Balancing](/img/versioned_docs/identitymanager_6.1/identitymanager/installation-guide/reverse-proxy/proxy_purpose_loadbalancing.webp)
...
- [TempFolderPath](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/agent-configuration/appsettings/index.md)
- [WorkFolderPath](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/agent-configuration/appsettings/index.md)
