...
[following the starting process](/docs/identitymanager/6.1/identitymanager/user-guide/global-process/howto-start/index.md)
and creating the workforce directory, you can come back at any time and complete the directory that
you started,
[updating identity data](/docs/identitymanager/6.1/identitymanager/user-guide/maintain/identity-data-modification/index.md).
