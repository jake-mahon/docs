...
3. Observe the result and adjust manually the data model if needed, by clicking on the properties.
   ...
   [Modifications can be performed](/docs/identitymanager/6.1/identitymanager/user-guide/optimize/identity-datamodel-modification/index.md)
