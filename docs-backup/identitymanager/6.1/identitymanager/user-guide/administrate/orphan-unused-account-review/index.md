...
[reporting module](/docs/identitymanager/6.1/identitymanager/user-guide/administrate/reporting/index.md)
...
| Input                                                                                                            | Output                               |
| ---------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| [Categorization](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/categorization/index.md) (required) | Removed orphaned and unused accounts |
...
5. Answer the following questions in order to understand the situation.
   ...
   [certified](/docs/identitymanager/6.1/identitymanager/user-guide/administrate/access-certification/index.md).
