...
a navigation rule.
[See more details on roles and navigation rules](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/single-roles-catalog-creation/index.md).
...
2. In the UI,
   [create a single role](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md#create-a-single-role).
...
3. [Create one navigation rule](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md)
...
[request manually](/docs/identitymanager/6.1/identitymanager/user-guide/administrate/manual-assignment-request/index.md)
