...
push the
[automation wall](/docs/identitymanager/6.1/identitymanager/user-guide/optimize/assignment-automation/index.md)
further.
...
[See more details about role mining](/docs/identitymanager/6.1/identitymanager/integration-guide/role-mining/index.md).
...
| Input                                                                                                                         | Output            |
| ----------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [Role catalog](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/single-roles-catalog-creation/index.md) (required) | Single role rules |
...
2. Click on the addition button at the top right and fill in the fields.
   ...
   - `Category`:
     [category](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/single-roles-catalog-creation/category-creation/index.md)
...
4. Click on **Simulate** to perfom role mining in a
   [simulation](/docs/identitymanager/6.1/identitymanager/user-guide/optimize/simulation/index.md).
