...
[indirect permissions](/docs/identitymanager/6.1/identitymanager/integration-guide/role-assignment/indirectpermissions/index.md).
...
After running a [Compute Role Model](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) task, Indirect Permissions should now appear for your test user.
