...
[ Architecture ](/docs/identitymanager/6.1/identitymanager/integration-guide/architecture/index.md)
...
See
the[ Connection to the Database ](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/server-configuration/database-connection/index.md),
...
and
[ Application Settings ](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/server-configuration/general-purpose/index.md)
