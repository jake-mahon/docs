...
[See more details](/docs/identitymanager/6.1/identitymanager/integration-guide/notifications/native/index.md).
...
1. Among the
   [list of all native notifications](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/notifications/notificationtemplate/index.md),
