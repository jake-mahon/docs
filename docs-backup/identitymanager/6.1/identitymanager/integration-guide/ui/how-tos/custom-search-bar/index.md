...
[Read more about searchbars](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/user-interface/searchbar/index.md).
...
[criterion](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/user-interface/searchbar/index.md):
...
[Create Menu Item for Workflow in Resource Entity List](/docs/identitymanager/6.1/identitymanager/integration-guide/ui/how-tos/create-menu-items/index.md).
