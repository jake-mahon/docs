...
[SQL connector using the procedure given in the example](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-connectors/sql/index.md).
