...
[Fulfill-RobotFramework](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-connectors/robotframework/index.md).
...
- `Generate Password`: This keyword expects a file that contains the
  [password reset settings](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/connectors/passwordresetsettings/index.md)
...
- `Open Telnet Connection`: opens the Telnet connection to the external system using the login and
  ...
  [**Options**](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-connectors/robotframework/index.md)
