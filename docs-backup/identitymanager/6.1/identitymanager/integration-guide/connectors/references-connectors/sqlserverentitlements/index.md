...
This page is about
[Database/Microsoft SQL Server Entitlements](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-packages/sql-server-entitlements/index.md).
