...
> [entity property expressions](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/metadata/entitypropertyexpression/index.md)
> and
> [scalar rules](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md).
...
[built-in function](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/expressions/predefined-functions/index.md)
or as a full-fledged `C#` expression. See the list of available
[C# utility functions](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/expressions/csharp-utility-functions/index.md)
and
[functions predefined by Usercube](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/expressions/predefined-functions/index.md).
...
>
> ![Property Path and Expression](/img/versioned_docs/identitymanager_6.1/identitymanager/integration-guide/toolkit/expressions/expression-propertypath_v602.webp)
...
[predefined simple transformations](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/expressions/predefined-functions/index.md).
...
> names:
>
> ![Property Path Example](/img/versioned_docs/identitymanager_6.1/identitymanager/integration-guide/toolkit/expressions/expression-propertypath-example1_v602.webp)
>
> ![Expression Example](/img/versioned_docs/identitymanager_6.1/identitymanager/integration-guide/toolkit/expressions/expression-propertypath-example2_v602.webp)
...
[`QueryRule`](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md)
and
...
[`EntityProperty`](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md)`Type`
...
[`QueryRule`](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md)`TargetExpression`
