...
can be found in the
[Data model part of this documentation](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/index.md).

For exemple, structure of the `<Connector>` element wil be found
[here](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/connectors/index.md).
