...
2. [`ReviewWithFeedback`](/docs/identitymanager/6.1/identitymanager/integration-guide/workflows/activity-templates/index.md#reviewwithfeedback):
   reviews the update request with the possibility of getting feedback from another user.
3. [`Persist`](/docs/identitymanager/6.1/identitymanager/integration-guide/workflows/activity-templates/index.md#persist):
