...
5. Recompute all property expressions and correlation keys by using the
   [`Update-EntityPropertyExpressions`](/docs/identitymanager/6.1/identitymanager/integration-guide/executables/references/update-entitypropertyexpressions/index.md)
   and
   [`Compute-CorrelationKeys`](/docs/identitymanager/6.1/identitymanager/integration-guide/executables/references/compute-correlationkeys/index.md)
...
- [5.0 to 5.1](/docs/identitymanager/6.1/identitymanager/migration-guide/5.0.x-to-5.1/index.md)
