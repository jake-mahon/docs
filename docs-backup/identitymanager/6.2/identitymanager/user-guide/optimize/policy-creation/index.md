...
[Policy](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/policy/index.md) topic
...
[ Create Roles in the Role Catalog ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/single-roles-catalog-creation/index.md) and
[ Conforming Assignments ](/docs/identitymanager/6.2/identitymanager/integration-guide/role-assignment/conformingassignmentcomputation/index.md)topics
for additional information.
...
See the [ Create a Resource Type ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/categorization/resource-type-creation/index.md)
