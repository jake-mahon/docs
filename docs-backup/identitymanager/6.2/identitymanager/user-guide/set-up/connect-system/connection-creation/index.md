...
to[ Synchronize Data ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/synchronization/index.md)and one connection for
...
See the [ Create the Connector ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/connect-system/connector-declaration/index.md) and
...
- Do we need [Provision](/docs/identitymanager/6.2/identitymanager/user-guide/administrate/provisioning/index.md)? If so, should provisioning be
...
1. click on **Check Connection** to ensure that Identity Manager can reach the managed system;
   ...
   [ Jobs ](/docs/identitymanager/6.2/identitymanager/integration-guide/tasks-jobs/jobs/index.md)topic for additional
