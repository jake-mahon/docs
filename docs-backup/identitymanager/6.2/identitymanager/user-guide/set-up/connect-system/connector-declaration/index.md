...
2. Click on the addition icon and fill in the information fields.
   ...
   - `Complete Job`: [ Jobs ](/docs/identitymanager/6.2/identitymanager/integration-guide/tasks-jobs/jobs/index.md) scheduled to
   ...
   - `Incremental Job`: [ Jobs ](/docs/identitymanager/6.2/identitymanager/integration-guide/tasks-jobs/jobs/index.md) scheduled
