...
4. Fill said template with the data you collected.
   ...
   [Template Description](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/initial-identities-loading/template-description/index.md)**. Below are the minimum recommended
...
- Create reports with indicators on the number of workers per type or per organization for example
  ...
  See the [ Generate Reports ](/docs/identitymanager/6.2/identitymanager/user-guide/administrate/reporting/index.md) topic for additional
  information.
