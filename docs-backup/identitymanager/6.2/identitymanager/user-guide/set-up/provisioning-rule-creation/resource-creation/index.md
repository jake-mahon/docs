...
[Provision](/docs/identitymanager/6.2/identitymanager/user-guide/administrate/provisioning/index.md) these resources, i.e. write them to the
managed system.
...
4. See the new account in the user's **View Permissions** tab.
   ...
   related to a [ Compute a Navigation Property ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/index.md).
