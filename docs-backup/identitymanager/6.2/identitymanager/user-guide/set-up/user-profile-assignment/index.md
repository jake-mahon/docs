...
and [References: Permissions](/docs/identitymanager/6.2/identitymanager/integration-guide/profiles-permissions/permissions/index.md)
...
See the [ Configure a User Profile ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/user-profile-configuration/index.md) topic for additional
information.
