...
Let's read some [ Use Case Stories ](/docs/identitymanager/6.2/identitymanager/introduction-guide/overview/use-cases/index.md).

## Learn More

Learn more on [Governance](/docs/identitymanager/6.2/identitymanager/integration-guide/governance/index.md).

Learn more on how to [ Generate Reports ](/docs/identitymanager/6.2/identitymanager/user-guide/administrate/reporting/index.md).
...
Learn more on how to [ Manage Risks ](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/risk-management/index.md).
