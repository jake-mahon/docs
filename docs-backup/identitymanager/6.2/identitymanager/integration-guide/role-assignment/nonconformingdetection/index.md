...
[ Conforming Assignments ](/docs/identitymanager/6.2/identitymanager/integration-guide/role-assignment/conformingassignmentcomputation/index.md). This list (list `A`)
...
the[ Existing Assignments ](/docs/identitymanager/6.2/identitymanager/integration-guide/role-assignment/existingassignmentsdeduction/index.md) every synced resource can be
