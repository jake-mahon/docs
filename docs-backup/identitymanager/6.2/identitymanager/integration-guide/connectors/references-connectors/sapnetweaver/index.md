...
This page is about [ SAP S/4 HANA ](/docs/identitymanager/6.2/identitymanager/integration-guide/connectors/references-packages/saphana/index.md).
...
[ Connection ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) folder the
following CSV files:
