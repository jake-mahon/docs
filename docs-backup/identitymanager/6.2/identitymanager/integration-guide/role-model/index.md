...
[ Entitlement Management ](/docs/identitymanager/6.2/identitymanager/introduction-guide/overview/entitlement-management/index.md) topic
...
- helping build the rules that define the assignment policy, i.e. the expected entitlement
  ...
  the[ Perform Role Mining ](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/assignment-automation/role-mining/index.md);
