...
- Assignments presenting a certain level of risk. See the
  [ Manage Risks ](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/risk-management/index.md) topic for additional
  information.
...
UI. See the [Access Certification](/docs/identitymanager/6.2/identitymanager/integration-guide/governance/accesscertification/index.md) topic for additional information.
