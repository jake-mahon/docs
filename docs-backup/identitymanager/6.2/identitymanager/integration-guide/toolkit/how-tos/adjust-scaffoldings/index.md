...
[Scaffoldings](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/index.md).
...
2.  Write an XML element whose identifier is the same as the one generated by the scaffolding.
    ...
    [Scaffoldings](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/index.md) topic, in the
...
4.  [ Usercube-Deploy Configuration](/docs/identitymanager/6.2/identitymanager/integration-guide/executables/references/deploy-configuration/index.md)
    again.
