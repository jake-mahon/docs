...
[OpenIdClient](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/access-control/openidclient/index.md) linked to
...
3. Configure an `OpenIdClient`, both on agent side in `appsettings.agent.json` with the non-hashed
   ...
   executable. See the
   [ OpenIdClient ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/access-control/openidclient/index.md) for
