...
the[ Create Menu Items ](/docs/identitymanager/saas/identitymanager/integration-guide/ui/how-tos/create-menu-items/index.md) topic for
...
[ Generate Reports ](/docs/identitymanager/saas/identitymanager/user-guide/administrate/reporting/index.md) topic for additional information. Choose to display
...
| Input                                                                                                                     | Output                               |
| ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| [ Categorize Resources ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/categorization/index.md) (required) | Removed orphaned and unused accounts |
...
[ Perform Access Certification ](/docs/identitymanager/saas/identitymanager/user-guide/administrate/access-certification/index.md) topic for additional information.
