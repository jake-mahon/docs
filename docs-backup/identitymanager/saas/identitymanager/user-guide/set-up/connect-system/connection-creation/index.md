...
to[ Synchronize Data ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/synchronization/index.md)and one connection for
...
See the [ Create the Connector ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/connect-system/connector-declaration/index.md) and
...
- Do we need [Provision](/docs/identitymanager/saas/identitymanager/user-guide/administrate/provisioning/index.md)? If so, should provisioning be
...
1. click on **Check Connection** to ensure that Identity Manager can reach the managed system;
   ...
   [ Jobs ](/docs/identitymanager/saas/identitymanager/integration-guide/tasks-jobs/jobs/index.md)topic for additional
