...
2. Click on the addition icon and fill in the information fields.
   ...
   - `Complete Job`: [ Jobs ](/docs/identitymanager/saas/identitymanager/integration-guide/tasks-jobs/jobs/index.md) scheduled to
   ...
   - `Incremental Job`: [ Jobs ](/docs/identitymanager/saas/identitymanager/integration-guide/tasks-jobs/jobs/index.md) scheduled
