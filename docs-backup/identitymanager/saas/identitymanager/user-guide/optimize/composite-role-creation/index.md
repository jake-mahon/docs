...
and [ Create Roles in the Role Catalog ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/single-roles-catalog-creation/index.md)topics
...
dimensions. See the [ Perform Role Mining ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/assignment-automation/role-mining/index.md) topic for
