...
To continue, [ Set the Working Directory's Permissions ](/docs/identitymanager/saas/identitymanager/user-guide/deploy/production-agent-installation/directory-permissions/index.md).
