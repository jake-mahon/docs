...
the[Database](/docs/identitymanager/saas/identitymanager/installation-guide/requirements/database-requirements/index.md)topic for additional information.
