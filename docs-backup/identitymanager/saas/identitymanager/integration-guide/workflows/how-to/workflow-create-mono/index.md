...
[ Workflow ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/workflows/workflow/index.md) to create a new
resource with a unique record.

## Declare a Workflow

This [ Workflow ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/workflows/workflow/index.md) is made of four
activities:
...
[ Position Change via Records ](/docs/identitymanager/saas/identitymanager/integration-guide/identity-management/joiners-movers-leavers/position-change/index.md)topic
...
users. See the [Workflows](/docs/identitymanager/saas/identitymanager/integration-guide/workflows/index.md) topic for additional information.
...
[ Menu Item ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/user-interface/menuitem/index.md)must be defined to
...
[ Configure a Homonym Detection ](/docs/identitymanager/saas/identitymanager/integration-guide/workflows/how-to/configure-homonym-test/index.md)topic for additional
information.
