...
See the [ References: Logs ](/docs/identitymanager/saas/identitymanager/integration-guide/monitoring/references/index.md) topic for additional information on the list of
existing logs.
...
See the [ Export Logs to a Log Management System ](/docs/identitymanager/saas/identitymanager/integration-guide/monitoring/how-tos/qradar-setting/index.md) topic to learn
