...
This file follows the exact same structure as the [Server Configuration](/docs/identitymanager/saas/identitymanager/integration-guide/network-configuration/server-configuration/index.md) files.
