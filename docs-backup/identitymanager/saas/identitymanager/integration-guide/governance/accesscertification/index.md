...
- Assignments presenting a certain level of risk. See the
  [ Manage Risks ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/risk-management/index.md) topic for additional
  information.
...
the
[ AccessCertificationCampaignPolicy ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/access-certification/accesscertificationcampaignpolicy/index.md)
topic for additional information.
