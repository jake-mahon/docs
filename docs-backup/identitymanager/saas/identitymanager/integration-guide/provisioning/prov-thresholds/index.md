...
[Resource Type](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md) to count the
...
Distinct [ Thresholds ](/docs/identitymanager/saas/identitymanager/integration-guide/synchronization/synchro-thresholds/index.md) are configurable for
synchronization.
