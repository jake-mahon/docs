...
Repository**. See the [ Upward Data Synchronization ](/docs/identitymanager/saas/identitymanager/integration-guide/synchronization/upward-data-sync/index.md)
...
3. Load data from a CSV file. This is how data from managed systems are loaded most of the time. See
   the [ Upward Data Synchronization ](/docs/identitymanager/saas/identitymanager/integration-guide/synchronization/upward-data-sync/index.md) topic for
