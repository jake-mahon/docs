...
Make sure to also read our updated [**MDX and React**](/reference-docs/docusaurus/guides/markdown-features/markdown-features-react.mdx) documentation page.
...
{
  "version-v1.0.0/docs": ["version-v1.0.0/introduction", "version-v1.0.0/prerequisites"]
}
```
...
If you use Docusaurus to render [Math Equations](/reference-docs/docusaurus/guides/markdown-features/markdown-features-math-equations.mdx), you should upgrade the MDX plugins.
