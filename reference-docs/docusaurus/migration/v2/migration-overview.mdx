...
The [migration CLI](/reference-docs/docusaurus/migration/v2/migration-automated.mdx) will handle many things of the migration for you.
...
The [manual migration guide](/reference-docs/docusaurus/migration/v2/migration-manual.mdx) will give you all the manual steps.
