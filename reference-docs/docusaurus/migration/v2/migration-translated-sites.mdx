...
- Get familiar with the [new i18n system of Docusaurus v2](/reference-docs/docusaurus/i18n/i18n-introduction.mdx) an
- Make Crowdin work for your v2 site, using a new and untranslated Crowdin project and the [Crowdin tutorial](/reference-docs/docusaurus/i18n/i18n-crowdin.mdx)
