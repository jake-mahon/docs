...
This feature is only useful for [versioned documentation](/reference-docs/docusaurus/guides/docs/versioning.mdx). It is recommended to be familiar with docs versioning before reading this page. If you just want [multiple sidebars](/reference-docs/docusaurus/guides/docs/sidebar/multiple-sidebars.mdx), you can do so within one plugin.
