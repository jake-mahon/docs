...
Check the [Docs Plugin API Reference documentation](/reference-docs/docusaurus/api/plugins/plugin-content-docs.mdx) for an exhaustive list of options.
...
The guide will introduce them in that order: starting from [how individual pages can be configured](/reference-docs/docusaurus/guides/docs/docs-create-doc.mdx), to [how to create a sidebar or multiple ones](/reference-docs/docusaurus/guides/docs/sidebar/index.mdx), to [how to create and manage versions](/reference-docs/docusaurus/guides/docs/versioning.mdx), to [how to use multiple docs plugin instances](/reference-docs/docusaurus/guides/docs/docs-multi-instance.mdx).
