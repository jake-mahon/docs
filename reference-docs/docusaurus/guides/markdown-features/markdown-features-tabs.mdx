...
Docusaurus provides the `<Tabs>` component that you can use in Markdown thanks to [MDX](/reference-docs/docusaurus/guides/markdown-features/markdown-features-react.mdx):
