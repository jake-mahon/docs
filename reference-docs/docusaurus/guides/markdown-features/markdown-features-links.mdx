...
Relative file paths are resolved against the current file's directory. Absolute file paths, on the other hand, are resolved relative to the **content root**, usually `docs/`, `blog/`, or [localized ones](/reference-docs/docusaurus/i18n/i18n-tutorial.mdx) like `i18n/zh-Hans/plugin-content-docs/current`.
...
- A [versioned doc](/reference-docs/docusaurus/guides/docs/versioning.mdx) will link to another doc of the exact same version
