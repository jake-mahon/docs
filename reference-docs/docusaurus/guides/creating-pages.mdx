...
Pages do not have sidebars, only [docs](/reference-docs/docusaurus/guides/docs/docs-introduction.mdx) do.

:::

:::info

Check the [Pages Plugin API Reference documentation](/reference-docs/docusaurus/api/plugins/plugin-content-pages.mdx) for an exhaustive list of options.
