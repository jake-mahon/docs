...
This configuration applies to all [main themes](/reference-docs/docusaurus/api/themes/overview.mdx).
...
Our [main themes](/reference-docs/docusaurus/api/themes/overview.mdx) offer additional theme configuration options for Docusaurus core content plugins.
...
If you use the [i18n feature](/reference-docs/docusaurus/i18n/i18n-introduction.mdx), this special navbar item type will render a dropdown with all your site's available locales.
...
If you use the [search](/reference-docs/docusaurus/search.mdx), the search bar will be the rightmost element in the navbar.
...
Read the [i18n introduction](/reference-docs/docusaurus/i18n/i18n-introduction.mdx) first.
