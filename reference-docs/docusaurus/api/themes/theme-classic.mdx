...
You can refer to the [theme configuration page](/reference-docs/docusaurus/api/themes/theme-configuration.mdx) for more details on the configuration.
...
Most configuration for the theme is done in `themeConfig`, which can be found in [theme configuration](/reference-docs/docusaurus/api/themes/theme-configuration.mdx).
