...
Ensures that the `@theme/Heading` theme component provided by Docusaurus [`theme-classic`](/reference-docs/docusaurus/api/themes/theme-classic.mdx) is used instead of `<hn>` tags for headings.
