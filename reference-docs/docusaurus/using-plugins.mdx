...
**The Docusaurus core doesn't provide any feature of its own.** All features are delegated to individual plugins: the [docs](/reference-docs/docusaurus/guides/docs/docs-introduction.mdx) feature provided by the [docs plugin](/reference-docs/docusaurus/api/plugins/plugin-content-docs.mdx); the [blog](/reference-docs/docusaurus/blog.mdx) feature provided by the [blog plugin](/reference-docs/docusaurus/api/plugins/plugin-content-blog.mdx); or individual [pages](/reference-docs/docusaurus/guides/creating-pages.mdx) provided by the [pages plugin](/reference-docs/docusaurus/api/plugins/plugin-content-pages.mdx). If there are no plugins installed, the site won't contain any routes.
...
We maintain a [list of official plugins](/reference-docs/docusaurus/api/plugins/overview.mdx), but the community has also created some [unofficial plugins](/community/resources#community-plugins). If you want to add any feature: autogenerating doc pages, executing custom scripts, integrating other services... be sure to check out the list: someone may have implemented it for you!

If you are feeling energetic, you can also read [the plugin guide](/reference-docs/docusaurus/advanced/plugins.mdx) or [plugin method references](/reference-docs/docusaurus/api/plugin-methods/README.mdx) for how to make a plugin yourself.
...
- [`@docusaurus/theme-classic`](/reference-docs/docusaurus/api/themes/theme-configuration.mdx)
...
- [`@docusaurus/plugin-google-analytics`](/reference-docs/docusaurus/api/plugins/plugin-google-analytics.mdx) (**deprecated**)
...
| `sitemap`                 | [`@docusaurus/plugin-sitemap`](/reference-docs/docusaurus/api/plugins/plugin-sitemap.mdx) |
