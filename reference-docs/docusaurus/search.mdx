...
If you prefer to edit the Algolia search React component, [swizzle](/reference-docs/docusaurus/swizzling.mdx) the `SearchBar` component in `@docusaurus/theme-search-algolia`:
