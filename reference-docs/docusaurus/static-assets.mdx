...
- for site `baseUrl: '/'`, the image `/img/docusaurus.png` will be served at `/img/docusaurus.png`.
- for site `baseUrl: '/subpath/'`, the image `/img/docusaurus.png` will be served at `/subpath/img/docusaurus.png`.
...
import DocusaurusImageUrl from '@site/img/docusaurus.png';
<img src={DocusaurusImageUrl} />;
```

```jsx title="MyComponent.js"
<img src={require('@site/img/docusaurus.png').default} />
```
...
```jsx title="MyComponent.js"
import DocusaurusLogoWithKeytar from '@site/img/docusaurus_keytar.svg';
<DocusaurusLogoWithKeytar title="Docusaurus Logo" className="logo" />;
```

### In Markdown {#in-markdown}

In Markdown, you can stick to using absolute paths when writing links or images **in Markdown syntax** because Docusaurus handles them as `require` calls instead of URLs when parsing the Markdown. See [Markdown static assets](/reference-docs/docusaurus/guides/markdown-features/markdown-features-assets.mdx).
