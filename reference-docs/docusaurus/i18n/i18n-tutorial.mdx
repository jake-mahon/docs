...
You can now [deploy](/reference-docs/docusaurus/deployment.mdx) the `build` folder to the static hosting solution of your choice.
...
On your [static hosting provider](/reference-docs/docusaurus/deployment.mdx):
...
We will share two common translation collaboration strategies: [**using git**](/reference-docs/docusaurus/i18n/i18n-git.mdx) and [**using Crowdin**](/reference-docs/docusaurus/i18n/i18n-crowdin.mdx).
