...
[Swizzle](/reference-docs/docusaurus/swizzling.mdx) a theme component to customize it.
...
The swizzle CLI is interactive and will guide you through the whole [swizzle process](/reference-docs/docusaurus/swizzling.mdx).
