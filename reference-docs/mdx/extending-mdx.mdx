...
This article explains how to extend MDX content—specifically, how to _transform_
...
<Note type="info">
  **Note**: have another component that *specifically* works with MDX? Please send a PR to add it
  here!
</Note>
...
<Note type="info">
  **Note**: have another unified plugin that *specifically* works with MDX? Please send a PR to add
  it here!
</Note>
