...
Checklist Item 2:
[Provision ONTAP Account](/versioned_docs/enterpriseauditor_11.6/config/netappcmode/provisionactivity.md)
...
Checklist Item 3:
[Configure Network](/versioned_docs/enterpriseauditor_11.6/config/netappcmode/configurefirewall.md)
