...
Additionally, it is necessary to generate an API Access Key for Nasuni activity monitoring. See the [Nasuni Edge Appliance Activity Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/nasuni/activity.md) topic for instructions.
