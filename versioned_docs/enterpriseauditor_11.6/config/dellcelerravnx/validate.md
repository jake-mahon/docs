...
__NOTE:__ See the [Configure Dell Registry Key Settings](/versioned_docs/enterpriseauditor_11.6/config/dellunity/installcee.md#configure-dell-registry-key-settings) topic for information on manually setting the registry key.
