...
Checklist Item 2: [Install Dell CEE](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/installcee.md)
...
- Select method:
  ...
  - [Manually Configure Auditing in OneFS](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/manualconfiguration.md)
...
Checklist Item 4: Configure Dell CEE to Forward Events to the Activity Agent. See the [Validate Setup](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/validate.md) topic for additional information.
