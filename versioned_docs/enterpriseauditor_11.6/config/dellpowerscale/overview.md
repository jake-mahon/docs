...
The Enterprise Auditor server IP needs to be added to the following fields in each NFS export's settings, in the OneFS UI under __Protocols__ > __UNIX sharing (NFS)__ > __View/Edit__ > __Edit export__ (per NFS export):
...
See the [Dell Isilon/PowerScale Activity Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/activity.md) topic for instructions.
