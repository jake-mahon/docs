...
Netwrix Enterprise Auditor can execute Access Auditing (SPAA) and Sensitive Data Discovery Auditing scans on SharePoint Online. The Netwrix Activity Monitor can be configured to monitor activity on SharePoint Online and make the event data available for Enterprise Auditor Activity Auditing (SPAC) scans.
...
See the [SharePoint Online Activity Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/sharepointonline/activity.md) topic for instructions.
