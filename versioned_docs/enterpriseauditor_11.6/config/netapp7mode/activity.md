...
Checklist Item 2: [Provision FPolicy Account](/versioned_docs/enterpriseauditor_11.6/config/netapp7mode/provisionactivity.md)
...
- See the [Enable HTTP or HTTPS](/versioned_docs/enterpriseauditor_11.6/config/netapp7mode/enablehttp.md) topic for instructions.

Checklist Item 4: [Configure FPolicy](/versioned_docs/enterpriseauditor_11.6/config/netapp7mode/configurefpolicy.md)
