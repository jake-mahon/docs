...
See the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/netapp7mode/activity.md) topic for instructions.
