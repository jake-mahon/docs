...
Checklist Item 2: [Install Dell CEE](/versioned_docs/enterpriseauditor_11.6/config/dellunity/installcee.md)
...
- Configure initial setup for a Unity device
  ...
  - [Unity Initial Setup with Unisphere](/versioned_docs/enterpriseauditor_11.6/config/dellunity/setupunisphere.md)
...
- See the [Validate Setup](/versioned_docs/enterpriseauditor_11.6/config/dellunity/validate.md) topic for instructions.
