...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/nutanix/access.md) topic for additional information.
...
The Netwrix Activity Monitor can be configured to monitor activity on Nutanix devices. See the [Nutanix Activity Auditing Configuration](/versioned_docs/enterpriseauditor_11.6/config/nutanix/activity.md) topic for instructions.
