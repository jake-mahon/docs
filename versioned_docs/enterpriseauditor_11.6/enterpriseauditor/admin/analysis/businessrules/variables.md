...
![Edit Rules window Variables tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/businessrules/variables.png)
...
- To delete a variable, select it and click __Delete__
  ...
  ![JobVariables TSV file](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/businessrules/jobvariablestsv.png)
