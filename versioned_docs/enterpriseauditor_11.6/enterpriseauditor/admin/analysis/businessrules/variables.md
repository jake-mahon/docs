...
![Edit Rules window Variables tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/businessrules/variables.webp)
...
- To delete a variable, select it and click **Delete**
    ...
    ![JobVariables TSV file](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/businessrules/jobvariablestsv.webp)
