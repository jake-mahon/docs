...
__NOTE:__ The Actions node can also automatically execute actions. See the [Action Modules](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/overview.md) topic for additional information.
...
![Select Action Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/autoaction.png)
