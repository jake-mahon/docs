...
![View and Table Creation Analysis Module wizard Input Source page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/unix/input.webp)
