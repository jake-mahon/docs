...
__NOTE:__ Host list names can also be changed using the __Edit List__ option, see the [Edit List](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/editlist.md) topic for additional information.
