...
![Search Methods - Data Grid](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality.webp)
...
![Data Grid Functionality](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality1.webp)
...
![Customization Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality2.webp)

To open the Customization window, select Field Chooser from the column header right-click menu.

![Customization Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality3.webp)
...
![Footer Option](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality4.webp)

To enable the footer, right-click in a column header and select Footer from the right-click menu.

![Footer display](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality5.webp)
...
![Footer options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality6.webp)
...
![Sort Order](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality7.webp)
...
| ![Default Group By View](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality8.webp) | ![Organized by Column Header](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality9.webp) |
| -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
...
![Expand Group View](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality10.webp)
...
![Column Header](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality11.webp)
...
![Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality12.webp)
...
![Custom Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality13.webp)
...
![Creating a Custom Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality14.webp)
...
![Selected Filter Criteria](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality15.webp)
...
![Filtration Dialog](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality16.webp)
...
![Advanced Search](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality17.webp)
