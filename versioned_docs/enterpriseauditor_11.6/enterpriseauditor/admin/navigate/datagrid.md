...
All data grids within the Enterprise Auditor Console have functions and features that allow Enterprise Auditor users to group by, filter, and sort via the filtration dialog through the data.

![Search Methods - Data Grid](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality.png)
...
![Data Grid Functionality](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality1.png)
...
![Customization Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality2.png)

To open the Customization window, select Field Chooser from the column header right-click menu.

![Customization Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality3.png)
...
![Footer Option](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality4.png)

To enable the footer, right-click in a column header and select Footer from the right-click menu.

![Footer display](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality5.png)
...
![Footer options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality6.png)
...
![Sort Order](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality7.png)
...
| ![Default Group By View](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality8.png) | ![Organized by Column Header](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality9.png) |
| --- | --- |
...
![Expand Group View](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality10.png)
...
![Column Header](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality11.png)
...
![Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality12.png)
...
![Custom Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality13.png)
...
![Creating a Custom Filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality14.png)
...
![Filtration Dialog](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality16.png)
...
![Advanced Search](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/datagridfunctionality17.png)
