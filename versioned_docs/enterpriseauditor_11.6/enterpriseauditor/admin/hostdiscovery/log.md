...
![Discovery Log](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/discoverylog.png)

The Discovery Log logging level is configured within the __Settings__ > __Host Discovery__ node. See the [Host Discovery](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/hostdiscovery.md) topic for additional information.
