...
![Activities pane](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/activities.png)
...
- Schedule – Opens the Schedule wizard to schedule query execution
  ...
  - See the [Schedule](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/schedule.md) topic for additional information on the Schedule wizard
- View Host List – Opens the [Host Management](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/overview.md) node directly to the selected query’s generated host list
