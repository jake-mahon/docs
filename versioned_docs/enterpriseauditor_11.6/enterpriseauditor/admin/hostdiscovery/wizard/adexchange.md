...
![Host Discovery Wizard Source page for AD Exchange](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/source.png)
...
![Host Discovery Wizard Query page for AD Exchange](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/nis/query.png)
...
![Host Discovery Wizard Exchange Server Query page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/exchangeserver.png)
...
Leave this page unchanged. If you must modify this page, see the [Query an Active Directory Server (General)](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/adgeneral.md) topic for instructions. Click __Next__.

![Host Discovery Wizard Options page for AD Exchange](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/options.png)
...
![Host Discovery Wizard Inventory page for AD Exchange](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/inventory.png)
...
![Host Discovery Wizard Summary page for AD Exchange](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adinventory/summary.png)
