...
![Host Discovery Wizard Source page for database import](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/source.png)
...
![Host Discovery Wizard Query page for database import](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/nis/query.png)
...
![Host Discovery Wizard Database Import page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/databaseimport.png)
...
- Data source – Identify the database. Click the ellipsis (__…__) to open the Data Link Properties window. Then provide the required information on the Connection tab.
  ...
  ![Data Link Properties window Connection tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/datalinkproperties.png)
  ...
  - Credentials – Select the credentials to use to log on to the server:
    ...
    - Use Windows NT Integrated security – This option applies the credentials used to run the Enterprise Auditor application
    ...
    ![Test connection succeeded confirmation window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/datalinkpropertiestestconnection.png)
  ...
  - The other tabs in the Data Link Properties window should not be modified
    ...
    - Provider tab – The database connector, dictated by the source of the data and the data sources that are available on the Enterprise Auditor Console server. This is set by default to the __Microsoft OLE DB Provider for SQL Server__.
...
![Host Discovery Wizard Options page for database import](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/options.png)
...
![Host Discovery Wizard Inventory page for database import](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/inventory.png)
...
![Host Discovery Wizard Summary page for database import](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adinventory/summary.png)
