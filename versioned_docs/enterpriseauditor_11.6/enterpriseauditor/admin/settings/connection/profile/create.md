...
![Connection - Add Connection Profile](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/connectionprofilename.png)
...
![Add User Credential](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/addusercredential.png)
...
![User Credentials](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/activedirectoryaccount.png)
...
![Error Message for Password](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/passworddifferserror.png)
...
![User Credentials](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/usercredentialslist.png)
...
![Arrange Priority](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/moveupdown.png)

There are Move Up and Move Down buttons for arranging priority within the User Credentials list.

![Apply local login credentials](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/usewindowsaccountoption.png)

__Step 6 –__ (Optional): At the bottom of the Connection view, is the Use the Windows account that Enterprise Auditor runs with before trying the user credentials above option. This option is per Connection Profile. If checked, Enterprise Auditor applies the local login credentials prior to any of the credentials saved to the Connection Profile.
...
![Edit Connection Profile](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/editusercredentials.png)
...
![User Credentials](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/selectaccounttype.png)
...
![Delete User Credentials](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/deleteusercredentials.png)

__Step 1 –__ Select the Connection Profile to be modified from the Profile list. Remember, changing the Connection Profile name results in breaking job groups or jobs that are assigned this profile.

__Step 2 –__ Select the user credential to be edited from the User Credentials list. Click Delete.

![Confirmation message for deletion](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/deleteusercredentialsconfirm.png)
...
![defaultconnectionprofile](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/defaultconnectionprofile.png)

Follow the steps to set a new default Connection Profile.

![Set a Default Connection Profile](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/setasdefaultconnectionprofile.png)
...
![Delete a Connection Profile](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/deleteconnectionprofile.png)

__Step 1 –__ Select the profile from the Connection Profile list and click Delete.

![Confirmation message for deletion](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/deleteconnectionprofileconfirm.png)
