...
| ![User Credentials - Task (Local)](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/tasklocal.png) | ![User Credentials - Task (Domain)](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/taskdomain.png) |
| --- | --- |
