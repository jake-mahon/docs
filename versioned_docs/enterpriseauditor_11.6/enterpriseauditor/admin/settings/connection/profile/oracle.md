...
![User Credentials - Oracle](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/connection/profile/oracle.png)
...
- Domain – Field options are dependent upon the additional account type option selected:
  ...
  - Windows account that Enterprise Auditor is run with – (Domain is not a field for this type of credential)
...
- User name – Type the user name
  - This is not a field for the additional account type of Windows account that Enterprise Auditor is run with is selected
...
- Password – Type the password
  - This is not a field for the additional account type of Windows account that Enterprise Auditor is run with
...
- Additional Account type – Select radio button of the secondary account type from the list at the bottom of the window:
  ...
  - Windows account that Enterprise Auditor is run with – Use the account that launched the Enterprise Auditor application through the run-as security context
