...
![Exchange - Set up the connection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_1.png)

The Exchange node is grayed-out by default. In order for these settings to be enabled, it is necessary to install both Enterprise Auditor MAPI CDO and Microsoft Exchange MAPI CDO on the Enterprise Auditor Console server. See the [StealthAUDIT MAPI CDO Installation](/versioned_docs/enterpriseauditor_11.6/stealthaudit/install_guides/mapi_cdo_install/stealthaudit_mapi_cdo_installation.md) topic for additional information.

![exchange_2](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_2.png)
...
![Set up the connection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_3.png)
...
- Click the Test Exchange settings link.
  ...
  ![Test Exchange Connection Setting](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_4.png)
...
![exchange_6](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_6.png)
