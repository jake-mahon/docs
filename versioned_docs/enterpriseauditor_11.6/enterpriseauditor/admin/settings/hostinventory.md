...
- Only refresh inventory items older than [time selected] – Indicates the time that needs to pass before the host inventory process is automatically refreshed
  ...
  - The drop-down menu includes the time-units of:
    ...
    - Weeks
    - Months
  - This setting affects the Inventory page options on the Host Discovery Wizard. See the [Host Discovery Wizard](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostdiscovery/wizard/overview.md) topic for additional information.
