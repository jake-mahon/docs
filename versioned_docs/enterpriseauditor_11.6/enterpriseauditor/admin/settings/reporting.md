...
![Website URL on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/websiteurl.png)
...
![Publish Option on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/publish.png)

Select the __Publish reports__ option to publish all Enterprise Auditor reports or select __Do not publish reports__ to disable the publishing. The inheritance of this setting can be broken at the job group, job, or report levels.

### Email Report Options

Configure email reports sent out by Enterprise Auditor using the Email Report options.

![Email options on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/email.png)
...
__NOTE:__ Email reports does not work unless Enterprise Auditor has been configured to send email notifications through the __Notification__ node. See the [Notification](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/notification.md) topic for additional information.
...
![javascriptsitepermissions](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/javascriptsitepermissions.png)

__Step 2 –__ Go to the __Cookies and site permissions__ settings page, and click __JavaScript__ under All permissions.

![javascriptsettings](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/javascriptsettings.png)
