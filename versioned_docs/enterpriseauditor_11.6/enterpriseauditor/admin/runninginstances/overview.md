...
![Running Instances node Overview page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/overviewpage.webp)
...
![Overview page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/overview.webp)
...
![Number of jobs running on bottom bar](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/overviewbottombar.webp)
...
![Host list link](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/viewhost.webp)

Click the host list link to display the hosts assigned to the running job.

![Host list in Host Management node](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/viewhostlist.webp)
...
![Process ID link](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/processid.webp)
...
![View Details link](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/viewdetails.webp)
...
![View Log link](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/viewlog.webp)

Click **View Log** to display the current job log. The View Log link is only enabled while a job is
running.

![Log file in Notepad](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/logfile.webp)
...
![View Schedule link](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/viewschedule.webp)
...
![Stop button](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/stop.webp)
