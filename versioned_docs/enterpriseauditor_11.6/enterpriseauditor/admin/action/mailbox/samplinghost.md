...
![New Mailbox Action Wizard Sampling Host page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/samplinghost.png)
...
- Use the mailbox associated with the Windows account that Enterprise Auditor is run with – Uses either the account logged into the Enterprise Auditor Console server or the account set to run the Enterprise Auditor application to access the Exchange mailbox
