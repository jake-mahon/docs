...
![New Mailbox Action Wizard Mailbox Message Conditions page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/ewsmailbox/filterwizard/messageconditions.png)
...
![MessageClasses Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/messageclasseswindow.png)

Modify message classes using the following options:

- Click __Add__ to populate a field to add a message class

  ![New class added in MessageClasses Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/messageclasseswindownew.png)
...
![Data Range Selection Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/datarangeselectionwindow.png)
...
![Values Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/valueswindow.png)
