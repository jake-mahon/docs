...
![Active Directory Action Module Wizard Clear/Set SID History page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/activedirectory/operations/sidhistory.png)
...
- SID History – This box is enabled by selecting the Overwrite or Append radio buttons. The SID history is overwritten or appended to with the inserted fields, depending on the selected radio button. Populate the SID History box using either of the following methods:
  ...
  - Click the __ellipsis (…)__ to access the Select Users or Groups window to populate this field
