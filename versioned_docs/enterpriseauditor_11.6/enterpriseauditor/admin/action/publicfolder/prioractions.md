...
![Public Folder Action Module Wizard Prior Actions page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/filesystem/prioractions.png)
