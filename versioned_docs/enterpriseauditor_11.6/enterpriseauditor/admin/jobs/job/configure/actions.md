...
The Actions node uses Enterprise Auditor action modules to take action on collected and analyzed data. Action can be taken on objects leveraging collected data or analyzed data, for example from a listing of locked-out accounts, an action can be executed to unlock those accounts.

__NOTE:__ Action modules are available with a special Enterprise Auditor license.
...
![Options at the top of the Action Selection page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/actionselectionoptions.png)
...
![Buttons at the bottom of Action Selection page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/actionselectiontablebuttons.png)
...
![Actions Right-Click Menu](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/actionsrightclickmenu.png)
