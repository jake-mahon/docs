...
The Analysis node uses Enterprise Auditor analysis modules to run analysis tasks on collected data. There are two basic types of analysis modules. Most analysis modules correlate, format, and transform collected data into powerful data views for end-stage reports and graphs.
...
![Analysis Selection page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/analysisselection.png)
...
![Option at the top of the Analysis Section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/analysisbuttonstop.png)
...
![Buttons at the bottom of the Analysis Selection page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/analysisbuttonsbottom.png)
...
![Analysis Selection page right-click menu](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/job/configure/analysisrightclickmenu.png)
