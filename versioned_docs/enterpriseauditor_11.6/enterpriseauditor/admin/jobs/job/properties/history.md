...
![History tab of the Job Properties](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/history.png)

By default, all jobs are set to inherit the Data Retention Period and Log Retention Period settings, the __Use Default Setting__ option. Deselect the __Use Default Settings__ option to configure custom settings for the job. Then provide the desired Data Retention Period and Log Retention Period settings. See the [History](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/history.md) topic for additional information.
