...
By default, all job groups are set to inherit __Use Default Setting__ option from the global level (__Settings__ > __History__) or a parent job group. See the [History](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/history.md) topic for additional information.
