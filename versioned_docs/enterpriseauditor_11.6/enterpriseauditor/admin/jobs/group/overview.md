...
![Example of Job Group Structure](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/jobgroupstructure.webp)
...
| ![Job Group Description page for a pre-configured job group](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/descriptionpage.webp) | ![Job Group Description page for a user-created job group](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/descriptionpagenewgroup.webp) |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![Job Group Description page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/descriptionpage.webp)
...
- Job Group Settings Shortcuts – These pages can also be accessed through the job group Settings
  ...
  [Job Groups Settings Node](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/settings.md)
...
![Overview section of Job Group description page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/descriptionpageoverview.webp)
...
![Show Inherited Settings on Job Overview page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/showinheritedsettings.webp)
...
| Data Retention Period | The tooltip shows the current value for the data retention period (by default, **Never retain previous job data**). Clicking the button opens the parent History settings for the selected job group. See the [History Node](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/history.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
