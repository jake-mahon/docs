...
![Job group settings in the Jobs Tree](/img/versioned_docs/activitymonitor_7.1/config/dellpowerscale/settings.png)

These settings inherit the global settings down by default unless inheritance is broken at a job group or a job level.

- [Connection Node](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/jobs/group/connection.md) – Use the default Connection Profile or break inheritance to select the Connection Profile needed for the assigned host lists for this job group
