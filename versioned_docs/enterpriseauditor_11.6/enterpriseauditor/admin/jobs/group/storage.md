...
At the job group level, the Storage node identifies the Storage Profile assigned for the job group. All Storage Profiles are created at the global level (__Settings__ > __Storage__). See the [Storage](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/storage/overview.md) topic for additional information.
