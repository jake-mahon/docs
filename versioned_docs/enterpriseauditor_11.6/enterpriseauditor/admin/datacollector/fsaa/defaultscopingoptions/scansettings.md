...
![FSAA Data Collector Wizard Default Scoping Options page Scan Settings tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scansettings.png)
...
![Action on failure to enable LAT preservation dropdown options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/defaultscopingoptions/actionlatpreservationfailure.png)
...
![Action on changed LAT after scan dropdown options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/defaultscopingoptions/actionchangedlat.png)
