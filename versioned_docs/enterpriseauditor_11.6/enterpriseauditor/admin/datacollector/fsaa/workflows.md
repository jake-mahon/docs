...
Follow the [Upgrade Proxy Service Procedure](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/filesystemproxy/upgrade.md) and use the FS\_UpdateProxy Job.
