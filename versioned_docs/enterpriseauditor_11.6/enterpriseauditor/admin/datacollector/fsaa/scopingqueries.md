...
![FSAA Data Collector Wizard Scoping Queries page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scopingqueries.png)
...
![FSAA Data Collector Wizard Scoping Options page Open shares configuration](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scopingoptionsopenshares.png)

The Scoping Queries page should be configured as shown:

![FSAA Data Collector Wizard Scoping Queries page Open shares configuration](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scopingqueriesopenshares.png)

See the [FSAA: Scoping Options](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scopingoptions.md) topic for additional information and common scoping scenarios.
...
![Scoping Query Configuration window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/scopingqueryconfiguration.png)
...
![Advanced Scoping Options Query Configuration window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/advancedscopingoptionsqueryconfiguration.png)
...
__NOTE:__ The target tables must reside within the Enterprise Auditor database and the result must return at least the following columns:
