...
- User Criteria – Lists user-defined criteria
  ...
  Use the Sensitive Data Criteria Editor in the __Settings__ > __Sensitive Data__ to create and edit user-defined criteria. See the [Sensitive Data Discovery Add-On Installation](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/sensitivedatadiscovery/overview.md) topic for additional information.
