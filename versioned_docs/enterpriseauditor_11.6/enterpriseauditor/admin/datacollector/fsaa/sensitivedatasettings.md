...
![FSAA Data Collector Wizard Sensitive Data Settings page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/upgrade/sensitivedata.png)
...
_Remember,_ the sensitive data discovery options require the Sensitive Data Discovery Add-On to be been installed on the Enterprise Auditor Console.
