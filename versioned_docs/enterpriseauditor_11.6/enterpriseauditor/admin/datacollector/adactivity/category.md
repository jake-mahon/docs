...
![Active Directory Activity DC wizard Category page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adinventory/category.webp)
...
- Remove Tables – Removes all tables and views from SQL Server database. This option is designed for
  ...
  [Clear ADActivity Tables](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adactivity/cleartables.md)
