...
- ID – Query GUID generated by Enterprise Auditor for this query task.
  ...
  - When using the __SMARTLog__ Data Collector or the __ExchangeMetrics__ Data Collector, the ```state``` file for the query’s Persist log state feature can be found in the SA_CommonData folder in the Enterprise Auditor installation directory:
