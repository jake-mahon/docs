...
![Disk Info wizard Target Disks page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/diskinfo/targetdisks.png)
...
Clicking the browse button on the Target Disks wizard page opens the Enterprise Auditor Registry Browser. Use this page to find registry keys and values that exist on a target host in the environment.

![Registry Browser](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/diskinfo/registrybrowser.png)
