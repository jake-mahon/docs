...
![NIS Data Collector Wizard NIS Settings page](/img/versioned_docs/activitymonitor_7.1/config/dellpowerscale/settings.png)
...
- (Optional) Sample NIS Server – Enter the host name or IP address of a NIS server for the above domain to use for testing. This system should be running the ```ypserv``` process and be accessible from the Enterprise Auditor Console. Then, click __Test__.
