...
![Unix Data Collector Wizard Settings page](/img/versioned_docs/activitymonitor_7.1/config/dellpowerscale/settings.png)
...
- Pre-Execution File Copy
  ...
  The Unix Data Collector can use SCP to copy a file from the Enterprise Auditor console to the target system before running the script command.
