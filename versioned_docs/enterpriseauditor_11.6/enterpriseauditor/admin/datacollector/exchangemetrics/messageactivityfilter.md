...
![Exchange Metrics Data Collector Wizard Message Activity Filter page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/exchangemetrics/messageactivityfilter.png)
...
The columns in the entry tables can be sorted and or filtered, using the same sorting and filtering methods of Enterprise Auditor data grids. The __Remove__ option will delete a selected filter.
