...
![Exchange Metrics Data Collector Wizard Collect Mode page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/exchangemetrics/collectmode.png)
...
- Process Exchange Tracking Logs and Query Summary Data – In this mode, the applet processes missing summary data and returns it to the Enterprise Auditor Console. This mode includes an additional setting for __Summary data path__. Choose between:
