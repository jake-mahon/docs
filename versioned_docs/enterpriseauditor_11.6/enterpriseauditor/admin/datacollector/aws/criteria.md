...
User-defined criteria is created in the Criteria Editor, accessed through the __Global Settings__ >  __Sensitive Data__ node. See the [Sensitive Data Discovery Add-On](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/sensitivedatadiscovery/overview.md) topic for additional information.
