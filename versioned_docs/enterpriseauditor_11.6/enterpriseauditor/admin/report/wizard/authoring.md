...
You can add tags to reports to describe the content and use cases of the report (see the [Tags](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/tags.md) topic for additional information). The Tag Editor allows you to select the tags for a report, including creating new ones to select.
