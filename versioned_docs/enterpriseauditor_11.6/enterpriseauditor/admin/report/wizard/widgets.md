...
![Widgets page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgets.webp)
...
![Configure widgets](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetsconfigure.webp)
...
![Table with configured widgets](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetsconfigured.webp)
...
![Grid configuration window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetgrid.webp)

### Options

The Options section allows you to configure the title and data source for the Grid element.

![Options section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetgridoptions.webp)
...
![Table Properties section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetgridtableproperties.webp)
...
![Data display](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetgriddata.webp)
...
![Chart configuration window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchart.webp)

### Options

The Options section allows you to configure the title and data source for the Chart element.

![Chart Options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchartoptions.webp)
...
![Chart Properties](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchartproperties.webp)
...
![Link Published Reports Tree](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchartlink.webp)
...
![Data table](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchartdata.webp)
...
![Chart Preview](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgetchartpreview.webp)
...
![Text Editor selection window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/texteditorselection.webp)
...
![Basic Text Editor](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/basictexteditor.webp)
...
| Icon                                                                                                                | Description                                                   |
| ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| ![Undo](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/undo.webp)                  | Undo a change to the text                                     |
| ![Redo](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/redo.webp)                  | Redo a change to the text                                     |
| ![Paste](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/paste.webp)                     | Paste the contents of the clipboard                           |
| ![Paste Special](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/pastespecial.webp) | Paste as either formatted text, unformatted text, or metafile |
| ![Cut](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/navigate/cut.webp)                         | Cut the selected text and put it on the clipboard             |
| ![Find](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/find.webp)                  | Find and replace specified text                               |
| ![Font](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/font.webp)                  | Change the font face                                          |
| ![Font Size](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/fontsize.webp)         | Change the font size                                          |

### Advanced Text Editor

![Advanced Text Editor](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/advancedtexteditor.webp)
...
| Icon                                                                                                                    | Description                                                     |
| ----------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| ![Bold](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/bold.webp)                      | Makes the selected text bold                                    |
| ![Italic](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/italic.webp)                  | Italicize the selected text                                     |
| ![Decrease Indent](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/decreaseindent.webp) | Decrease the indent level of the paragraph                      |
| ![Increase Indent](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/increaseindent.webp) | Increase the indent level of the paragraph                      |
| ![Hyperlink](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/hyperlink.webp)            | Create a link to a Web page, picture, email address, or program |
| ![Multilevel List](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/multilevel.webp)     | Start a multilevel list                                         |
| ![Numbering](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/numbering.webp)            | Start a numbered list                                           |
| ![Bullets](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/bullets.webp)                | Start a bulleted list                                           |
| ![Table](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/table.webp)                    | Insert a table                                                  |
