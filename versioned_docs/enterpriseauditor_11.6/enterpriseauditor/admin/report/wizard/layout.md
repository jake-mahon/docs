...
The layout for the report has been selected. Each box on the selected tile corresponds to a separate widget that you next need to configure on the [Widgets Page](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgets.md) page of the Report Configuration wizard.
