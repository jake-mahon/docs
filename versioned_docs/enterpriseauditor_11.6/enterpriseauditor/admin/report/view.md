...
![Report in the Results node](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/viewresultsnode.webp)

Select the desired report to be viewed. The report displays in the Results pane of the console.

![Access report from configure page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/viewconfigure.webp)
...
Console, see the
[Log into the Web Console](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/overview.md#log-into-the-web-console)
topic.
...
![Web Console .Active Directory Inventory](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/webconsolesolutioninventory.webp)
