...
The report is now created. To access the new report, see the [Viewing Generated Reports](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/view.md) topic.
...
__Step 3 –__ (Optional) Click the __Configure__ button next to the report. Use the Report Configuration wizard to modify the reports settings. See the [Report Configuration Wizard](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/overview.md) topic for instructions.
