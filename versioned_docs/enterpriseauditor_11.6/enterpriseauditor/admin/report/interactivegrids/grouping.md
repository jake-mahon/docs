...
The following example shows an interactive grid in which grouping has been enabled. See the [Grid](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/widgets.md#Grid) topic for additional information.
