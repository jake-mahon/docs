...
__Step 3 –__ Use the Report Configuration wizard to make any required changes. See the [Report Configuration Wizard](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/wizard/overview.md) topic for instructions.
...
Your configuration updates have been saved. To view the updated report you need to first generate the report or run it's associated job. See the [Viewing Generated Reports](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/view.md) topic for additional information.
