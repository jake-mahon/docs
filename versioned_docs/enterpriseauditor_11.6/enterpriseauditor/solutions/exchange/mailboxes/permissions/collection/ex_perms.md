...
- Exchange Mailbox Permissions – Returns Exchange mailbox folder permissions
  ...
  - See the [EWSMailbox Data Collector](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/ewsmailbox/overview.md) topic for additional information
