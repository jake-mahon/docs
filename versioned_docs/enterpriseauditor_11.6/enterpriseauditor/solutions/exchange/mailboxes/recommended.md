...
- Exchange Access Auditing is enabled in the Exchange environment
    ...
    - This is required for the Logons Job Group. See the
      [Enable Exchange Mailbox Access Auditing](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/solutions/exchange/powershell.md#enable-exchange-mailbox-access-auditing)
...
[Exchange Custom Connection Profile & Host List](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/exchangeps/configurejob.md)
topic for additional information.
