...
The EX_Mailflow_Domain job provides information about which domain’s mail-flow is going to and coming from. This job is set to analyze the last 30 days.
...
See the [Analysis Tasks for the EX_Mailflow_Domain Job](#analysis-tasks-for-the-ex_mailflow_domain-job) topic for additional information.

## Analysis Tasks for the EX_Mailflow_Domain Job

View the analysis task by navigating to the __Exchange__ > __8. Exchange Online__ > __EX_Mailflow_Domain__ > __Configure__ node and select __Analysis__.

__CAUTION:__ Do not modify or deselect the selected analysis task. The analysis task is preconfigured for this job.

![Analysis Tasks for the EX_Mailflow_Domain Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/exchange/online/mailflow/mailflowdomainanalysis.png)
