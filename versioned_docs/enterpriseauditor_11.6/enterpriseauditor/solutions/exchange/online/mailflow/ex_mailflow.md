...
- LocalDomains – Collects domains local to the Office 365 environment
  ...
  - See the [ExchangePS Data Collector](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/exchangeps/overview.md) topic for additional information
...
![Analysis Tasks for the EX_Mailflow Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/exchange/online/mailflow/mailflowanalysis.png)
