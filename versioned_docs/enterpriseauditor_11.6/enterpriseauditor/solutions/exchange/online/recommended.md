...
- Custom Host List for Exchange Online
    ...
    - The host list should include the tenant name of the Microsoft Entra tenant used to connect to
      ...
      [Exchange Online Host List](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/exchangeps/configurejob.md#exchange-online-host-list)
