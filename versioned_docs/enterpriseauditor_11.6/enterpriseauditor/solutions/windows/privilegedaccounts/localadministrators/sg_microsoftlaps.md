...
![Queries for the SG_MicrosoftLAPS Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/privilegedaccounts/localadministrators/microsoftlapsquery.png)
...
Navigate to the __Windows__ > __Privileged Accounts__ > __Local Administrators__ > __SG_MicrosoftLAPS__ > __Configure__ node and select __Analysis__ to view the analysis tasks.

__CAUTION:__ Do not modify or deselect the selected analysis task. The analysis task is preconfigured for this job.

![Analysis Tasks for the SG_MicrosoftLAPS Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/privilegedaccounts/localadministrators/microsoftlapsanalysis.png)

The default analysis task is:

- List LAPS details – Creates the SG_MicrosoftLAPS_Details table accessible under the job’s Results node

In addition to the tables created by the analysis tasks, the SG_MicrosoftLAPS job produces the following pre-configured report.
