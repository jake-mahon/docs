...
![Smart Log Data Collector Wizard Criteria page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/smartlogdcwizardcriteria.png)
...
![Analysis Tasks for the SG_PowerShellCommands Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/powershellcommandsanalysis.png)
...
![Notification Data Analysis Module wizard SMTP properties page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/powershellcommandsnotifysmtp.png)

**Step 3 –** Use the **Next** button to navigate to the SMTP page. Do not make changes to the
preceding pages.

![Recipients section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/powershellcommandsnotifyrecipients.png)
...
![Message section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/powershellcommandsnotifymessage.png)
