...
- [0.Collection Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/collection/overview.md)
  – Scans the targeted Dropbox site and generates the standard reference tables and views
- [1.Access > Dropbox_Access Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/dropbox_access.md)
  – Reports on effective access to Dropbox resources in the targeted environment
- [2.Sharing > Dropbox_Sharing Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/dropbox_sharing.md)
  – Reports on the sharing of Dropbox resources in the targeted environment
- [3.Group Membership > Dropbox_GroupMembership Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/dropbox_groupmembership.md)
...
- [5.Sensitive Data > Dropbox_SensitiveData Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/dropbox_sensitivedata.md)
