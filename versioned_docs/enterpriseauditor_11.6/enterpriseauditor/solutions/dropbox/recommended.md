...
This solution can be run with the default query configurations. The Scoping page of the Dropbox Access Auditor Data Collector Wizard can be customized to target specific user accounts. See the [DropboxAccess: Scoping](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/dropboxaccess/scoping.md) topic for additional information.
...
- Stale content set to default of 365 days
  ...
  - See the [4.Content > Dropbox\_Content Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/dropbox/dropbox_content.md) topic for additional information
