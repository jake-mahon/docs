...
- Permissions vary based on the Scan Mode selected and target environment. See the [SharePoint Support](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/target/sharepoint.md) topic for additional information.
...
_Remember,_ if employing the Enterprise Auditor SharePoint Agent, it is also necessary for the Sensitive Data Discovery Add-on to be installed on the server where the agent is installed.
...
See the [Recommended Configuration for the SharePoint Solution](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/recommended.md) topic for additional information on frequency and job group settings.
