...
This job is responsible for retrieving the Tier 2 SPDLP database information and importing it to the SQL Server where Enterprise Auditor stores data.
...
![Query Selection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/spseekbulkimportquery.png)
...
Navigate to the __Jobs__ > __SharePoint__ > __0.Collection__ > __4-SPSEEK_BulkImport__ > __Configure__ node and select __Analysis__ to view the analysis tasks.

__CAUTION:__ The analysis tasks are preconfigured for this job. Never modify or deselect the selected analysis tasks.

![Analysis Selection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/spseekbulkimportanalysis.png)
