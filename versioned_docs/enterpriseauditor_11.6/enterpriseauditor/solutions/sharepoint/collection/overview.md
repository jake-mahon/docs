...
- [1-SPSEEK_SystemScans Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/1-spseek_systemscans.md)
...
- [2-SPAA_SystemScans Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/2-spaa_systemscans.md)
...
- [3-SPAC_SystemScans Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/3-spac_systemscans.md)
...
- [4-SPSEEK_BulkImport Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/4-spseek_bulkimport.md)
...
- [5-SPAA_BulkImport Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/5-spaa_bulkimport.md)
  – Responsible for retrieving the SPAA Tier 2 Database information and importing it to the
  Enterprise Auditor SQL database
- [6-SPAC_BulkImport Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/6-spac_bulkimport.md)
  – Responsible for retrieving the SPAC Tier 2 Database information and importing it to the
  Enterprise Auditor SQL database
- [7-SPAA_Exceptions Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/collection/7-spaa_exceptions.md)
...
and[SP_Overview Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/sp_overview.md)
...
See the
[Recommended Configuration for the SharePoint Solution](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/recommended.md)
...
[SP_Overview Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/sp_overview.md)
and
[7.Activity Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/activity/overview.md)
...
[SharePoint Sensitive Data Discovery Auditing Tables & Views](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/spaa/standardtables.md)
topic for additional information on the data collected.
