...
![Queries for the SP_TrusteeAccess Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/effectiveaccessaudits/trusteeaccessquery.png)
...
![UserScoping.csv in the SP_TrusteeAccess Job folder in File Explorer](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/effectiveaccessaudits/userscopingfileexplorer.png)

**Step 2 –** Open the `UserScoping.csv` file with a text editor, for example Notepad.

![UserScoping.csv file in Notepad](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/sharepoint/effectiveaccessaudits/userscopingnotepad.png)
