...
View the analysis tasks by navigating to the __FileSystem__ > __2.Direct Permissions__ > __FS_HighRiskACLs__ > __Configure__ node and select __Analysis__.

__CAUTION:__ Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the FS_HighRiskACLs Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/directpermissions/highriskaclsanalysis.png)

The following analysis tasks are selected by default:

- 1. High Risk ACL Details – Creates the SA_FS_HighRiskACLs_Details table accessible under the job’s Results node
