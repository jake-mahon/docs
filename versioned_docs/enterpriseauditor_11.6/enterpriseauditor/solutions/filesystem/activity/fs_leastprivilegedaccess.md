...
![Analysis Tasks for the FS_LeastPrivilegedAccess Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/activity/leastprivilegedaccessanalysis.png)
