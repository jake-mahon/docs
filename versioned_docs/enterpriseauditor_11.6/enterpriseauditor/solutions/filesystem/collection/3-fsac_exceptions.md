...
![Analysis Tasks for the 3-FSAC Exceptions Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/collection/fsacexceptionsanalysis.png)
...
- Show view – Displays the SA\_FSAC\_ExceptionsView within the Results node of the Enterprise Auditor Console
- Show users view – Displays the SA\_FSAC\_UserExceptionsView within the Results node of the Enterprise Auditor Console
