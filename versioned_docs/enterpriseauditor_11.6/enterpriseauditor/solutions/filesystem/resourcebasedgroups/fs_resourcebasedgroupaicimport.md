...
__CAUTION:__ It is important to run the .Active Directory Inventory Job Group and __File System__ > __0. Collection__ Job Group again so that the AD and permissions changes are captured by Enterprise Auditor.
