...
__NOTE:__ If a host list is not configured, this job will analyze and commit actions on every File System server known to Enterprise Auditor. To scope the actions to target specific servers, configure a host list at the job level to target only those servers.
...
![FS_TraverseGroups analysis tasks](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/resourcebasedgroups/traverseanalysis.png)
...
For instructions on configuring analysis parameters, see the [SQLscripting Analysis Module](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/sqlscripting.md) topic.
...
![FS_TraverseGroups action tasks](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/resourcebasedgroups/traverseactions.png)
...
![AD Action Module Wizard Create Groups page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/activedirectory/operations/creategroups.png)
