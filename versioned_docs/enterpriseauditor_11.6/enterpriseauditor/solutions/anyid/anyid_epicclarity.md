...
![AnyID_EpicClarity Job in the Jobs Tree](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/anyid/epicclarityjoblocation.png)
...
![Queries for the AnyID_EpicClarity Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/anyid/epicclarityqueries.png)
...
![Edit Query Page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/anyid/epicclarityqueryeditquery.png)

__Step 4 –__ Navigate to the Edit Query page. Click the __Parameters__ tab on the right-hand side of the page to expand the Parameters window. See the [PowerShell: Edit Query](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/powershell/editquery.md) topic for additional information. Configure the following attributes as needed:
...
![Analysis Tasks for the AnyID_EpicClarity Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/anyid/epicclarityanalyses.png)
