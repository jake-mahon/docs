...
![Analysis Tasks for the AWS_StaleUsers Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/users/staleusersanalysis.png)
