...
![Queries for the 1.AWS_OrgScan Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/orgscanqueries.png)
...
__Step 1 –__ Navigate to the __AWS__ > __0.Collection__ > __1.AWS_OrgScan__ > __Configure__ node and select the __Queries__ node.
