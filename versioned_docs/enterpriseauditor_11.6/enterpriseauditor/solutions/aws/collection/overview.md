...
- [3.AWS_IAMScan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/3.aws_iamscan.md)
  – Collects details about users, groups, policies, roles and other IAM related identities
- [4.AWS_S3SDDScan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/4.aws_s3sddscan.md)
