...
- [1.AWS\_OrgScan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/1.aws_orgscan.md)
- [2.AWS\_S3Scan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/2.aws_s3scan.md)
- [3.AWS\_IAMScan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/3.aws_iamscan.md)

The following queries in the 0.Collection job group can be modified to limit the depth of the scan:

- [2.AWS\_S3Scan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/2.aws_s3scan.md)
- [4.AWS\_S3SDDScan Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/collection/4.aws_s3sddscan.md)
