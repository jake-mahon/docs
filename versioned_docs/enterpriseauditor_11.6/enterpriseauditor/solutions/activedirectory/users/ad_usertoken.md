...
![Analysis Task for the AD_UserToken Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/users/usertokenanalysis.png)
