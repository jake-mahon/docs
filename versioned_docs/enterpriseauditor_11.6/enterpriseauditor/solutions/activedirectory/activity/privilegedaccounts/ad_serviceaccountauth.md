...
![Analysis Task for the AD_ServiceAccountAuth Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/activity/privilegedaccounts/serviceaccountauthanalysis.png)
