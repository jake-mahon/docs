...
The AD\_GroupStamping Job updates the Notes attribute for all security groups to show where the group is provisioned inside the environment. This overwrites the notes field with data from Enterprise Auditor.
...
![Analysis Tasks for the AD_GroupStamping Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/cleanup/groups/stamping/groupstampinganalysis.png)
...
![Action Tasks for the AD_GroupStamping Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/cleanup/groups/stamping/groupstampingaction.png)
