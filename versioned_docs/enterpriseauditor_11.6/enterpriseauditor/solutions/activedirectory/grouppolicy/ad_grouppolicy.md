...
![Queries for the AD_GroupPolicy Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/grouppolicy/grouppolicyquery.png)

The queries for this job are:

- Link Status – Targets the default domain controller known to Enterprise Auditor to retrieve a GPO's list for the domain
- Settings – Targets the default domain controller known to Enterprise Auditor to return the state for domain policies for all GPOs. See the [GroupPolicy Data Collector](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/grouppolicy/overview.md) topic for additional information.
...
![Analysis Tasks for the AD_GroupPolicy Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/grouppolicy/grouppolicyanalysis.png)
