...
![Query for the AD_CPassword Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/activedirectory/grouppolicy/cpasswordquery.png)

The queries for this job are:

- Sysvol – Targets one domain controller per domain known to Enterprise Auditor to determine CPassword security
...
In addition to the tables created by the data collector, the AD_CPassword Job produces the following pre-configured report:
