...
![Regular Expression window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/sensitivedatadiscovery/criteriaeditor/criteriatype/regularexpression.png)
...
- Validation – Select a validation method from the Validation drop-down. The default value is __No validation required__.
  ...
  __NOTE:__ See the [Sensitive Data System Criteria](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/sensitivedatadiscovery/systemcriteria.md) topic for additional information on validation methods.
