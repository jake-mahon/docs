...
The CDSA job depends upon several Enterprise Auditor solutions for data collection. See the [Requirements](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/overview.md) topic for installation and database requirements.
...
Additionally, the Sensitive Data Discovery Add-On also contributes to the CDSA presentations. See the [Sensitive Data Discovery Add-On](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/sensitivedatadiscovery/overview.md) topic for additional information.
