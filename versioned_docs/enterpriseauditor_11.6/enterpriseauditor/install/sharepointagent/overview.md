...
For information on the required prerequisites and permissions, see the [SharePoint Agent Permissions](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/solutions/sharepoint/agentpermissions.md) topic.

The version of the SharePoint Agent must also match the major version of Enterprise Auditor. See the [What's New](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/whatsnew.md) topic for additional information.

## Supported Platforms

The SharePoint Agent for the Enterprise Auditor SharePoint & SharePoint Online Solution can be installed on the following SharePoint versions as targeted environments:
