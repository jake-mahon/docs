...
![Disclaimer.txt file added to the Web folder](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/disclaimertxt.webp)
...
![File Explorer WebServer.exe.config](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webserverexeconfigfile.webp)

**Step 3 –** Locate the `WebServer.exe.config` file and open it.

![WebServer.exe.config file in Notepad](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webserverexeconfigdisclaimer.webp)
...
![Web Console login page with disclaimer message](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webconsolelogindisclaimer.webp)
