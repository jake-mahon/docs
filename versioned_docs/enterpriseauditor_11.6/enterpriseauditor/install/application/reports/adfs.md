...
- On the Configure URL page, do not select any options and click **Next**.
    ...
    ![Identifier added on the Configure Identifiers page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/relyingpartytrustwizardidentifier.webp)
...
![Add an Endpoint window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/addanendpointwindow.webp)
...
- On the Choose Rule Type page of the Add Transform Claim Rule Wizard, select **Send LDAP Attributes
  as Claims** as the Claim rule template. Click **Next**.
    ...
    ![Configure Claim Rule page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/claimrulenameadfsconfig.webp)
...
![Configure Claim Rule SID Properties](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/claimrulenamesidproperties.webp)

**Step 6 –** Navigate to the Enterprise Auditor installation directory and open the
`WebServer.exe.config` file in a text editor.

![WebServer.exe.config file in Notepad](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webserverexeconfigadfs.webp)
...
- `WsFederationRealm` – Replace the value text with the URL entered for the Relying Party Trust in
  Step 3:
    ...
    ![URL required for WsFederationRealm attribute](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/wsfederationrealmurl.webp)
...
- `WsFederationReply` – Replace the value text with the Trusted URL entered for the Endpoint in Step
  4:
    ...
    ![URL required for WsFederationReply attribute](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/wsfederationreplyurl.webp)
...
![Published Reports desktop shortcut properties](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/publishedreportsproperties.webp)
