...
![Claims configured](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/entraidssoclaims.png)
...
_Remember,_ Enabling Entra ID SSO requires SSL to already have been enabled for the web server. See the [Securing the Web Console](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/secure.md) topic for additional information.
...
![Parameters in the web server config file](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webserverexeconfigfileentrasso.png)
...
__Step 4 –__ Navigate to Services (```services.msc```). Restart the Netwrix Enterprise Auditor Web Server service.
