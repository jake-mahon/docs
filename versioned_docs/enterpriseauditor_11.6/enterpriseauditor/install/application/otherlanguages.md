...
Enterprise Auditor does not support case sensitive collation settings. Case insensitive collations are notated by having __CI__ in the collation, for example __Latin1_General_CI_AS__.
