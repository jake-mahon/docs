...
See the [Active Directory Domain Target Requirements](/versioned_docs/enterpriseauditor_11.6/config/activedirectory/overview.md) topic for target environment requirements.
