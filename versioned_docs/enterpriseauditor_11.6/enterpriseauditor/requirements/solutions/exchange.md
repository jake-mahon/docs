...
The following are additional requirements for the Enterprise Auditor Console server specific to running the Exchange Solution:

- Outlook should not be installed
- StealthAUDIT MAPI CDO installed (for MAPI- based data collectors). See the [StealthAUDIT MAPI CDO Installation](/versioned_docs/enterpriseauditor_11.6/stealthaudit/install_guides/mapi_cdo_install/stealthaudit_mapi_cdo_installation.md) topic for additional information.
- Exchange MAPI CDO installed (for MAPI- based data collectors)
- For targeting Exchange 2010 – Exchange Management Tools 2010 installed on the Enterprise Auditor Console server
