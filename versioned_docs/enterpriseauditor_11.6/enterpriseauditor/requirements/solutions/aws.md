...
See the [Target Amazon Web Service Requirements, Permissions, and Ports](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/target/aws.md) topic for target environment requirements.
