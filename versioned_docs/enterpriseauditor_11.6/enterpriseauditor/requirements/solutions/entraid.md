...
See the [Microsoft Entra ID Tenant Target Requirements](/versioned_docs/enterpriseauditor_11.6/config/entraid/overview.md) topic for target environment requirements.
