...
__NOTE:__ For SQL Server 2012+, it is necessary to restrict the maximum server memory value to 60-70% of the total physical RAM to avoid a situation where SQL Server will starve other applications of memory. See the [Restrict SQL Server Maximum Server Memory](/versioned_docs/threatprevention_7.4/threatprevention/troubleshooting/sqlserver.md) topic for additional information.
...
Additional permissions are required for the optional Database Maintenance feature in Threat Prevention. See the [Database Maintenance Feature Requirements](/versioned_docs/threatprevention_7.4/threatprevention/requirements/dbmaintenance.md) topic for additional information.
