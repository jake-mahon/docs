...
___RECOMMENDED:___ For large environments with Analytics, a physical machine is strongly recommended.

__NOTE:__ The disk space calculation formula is: Enterprise Manager GBs + 2(RAM size):
...
- .NET 4.7.x or .NET 4.8.x installed. If the installer does not find it already installed, it will install .NET Framework 4.7.
