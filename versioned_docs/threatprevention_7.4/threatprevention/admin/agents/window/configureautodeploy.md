...
![Configure Auto Deploy window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/agents/window/autodeploy.png)
...
- Agent Deploy Destination Options – Configure the following settings:
  ...
  - Safe Mode – If selected, the Agent checks LSASS versions on start up. Any changes in LSASS since the previous start prevents the Windows AD Events monitoring module from loading. See the [Agent Safe Mode](/versioned_docs/threatprevention_7.4/threatprevention/admin/agents/safemode.md) topic for additional information.
