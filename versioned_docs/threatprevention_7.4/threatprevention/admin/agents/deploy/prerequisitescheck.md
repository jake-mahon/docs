...
- Success – Click __Next__ to install the Agent
- If some but not all items fail, you can click __Next__ to deploy the Agent on those where access verification was successful
...
See the [Installing Window ](/versioned_docs/threatprevention_7.4/threatprevention/admin/agents/deploy/installing.md)topic for the next step.
