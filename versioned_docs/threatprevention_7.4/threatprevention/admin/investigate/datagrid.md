...
The archive database is part of the Threat Prevention Database Maintenance feature and it can only be queried from the Administration Console. See the [Archive Data](/versioned_docs/threatprevention_7.4/threatprevention/admin/configuration/databasemaintenance/archive.md) topic for additional information.
...
To export the data displayed in the grid to a CSV file, see the [Export Data](/versioned_docs/threatprevention_7.4/threatprevention/admin/navigation/datagrid.md#export-data) topic.
