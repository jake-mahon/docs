...
![Bad User ID (by User) Analytic Type - Settings tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/baduseridsettings.png)
...
![Bad User ID (by User) Analytic Type - Policy tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/policytab.png)
...
![Bad User ID (by User) Analytic Type  window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/baduseriduser.png)
