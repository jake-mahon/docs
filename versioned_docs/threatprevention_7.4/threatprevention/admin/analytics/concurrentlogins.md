...
![Concurrent Logins Analytic Type - Settings tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/concurrentloginssettings.png)
...
![Concurrent Logins Analytic Type - Policy tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/policytab.png)
...
![Concurrent Logins Analytic Type window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/concurrentlogins.png)
