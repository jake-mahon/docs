...
![Threat Prevention Architecture Diagram](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/systemdiagram.png)
...
A Threat Prevention Policy has many attributes which define the activities and objects it monitors, where on a network that policy applies, and when it is active. See the [Policy Configuration](/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/configuration.md) topic for additional information.
...
See the [Pre-Created Templates](/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/folder/overview.md) and [Template Configuration](/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/configuration.md) topics for additional information.
...
Both these databases are created during the installation process of the Threat Prevention Enterprise Manager. See the [Application Server Install](/versioned_docs/threatprevention_7.4/threatprevention/install/application.md) topic for additional information.
