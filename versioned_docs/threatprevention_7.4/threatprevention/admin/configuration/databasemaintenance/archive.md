...
![Database Maintenance window - Archive DB tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/configuration/databasemaintenance/archivedb.webp)
