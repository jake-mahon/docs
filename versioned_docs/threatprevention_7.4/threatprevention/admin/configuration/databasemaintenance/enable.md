...
![Database Maintenance window - Event Type tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/configuration/databasemaintenance/enablesettings.png)
...
- The Move operation requires the Archive DB tab to be configured. See the [Archive Data](/versioned_docs/threatprevention_7.4/threatprevention/admin/configuration/databasemaintenance/archive.md) topic for additional information.
