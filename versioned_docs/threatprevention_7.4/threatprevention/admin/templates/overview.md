...
![Templates Interface](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/templates.webp)
...
[Pre-Created Templates](/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/folder/overview.md)
topic for additional information.

- Click a template to open it and view its configurations. See the
  [Template Configuration](/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/configuration.md)
  topic for additional information.
...
- You can also drag a template into a folder under the Policies node. This would be a Copy action,
  ...
  [Use a Template to Create a Policy](/versioned_docs/threatprevention_7.4/threatprevention/admin/templates/createpolicy.md)
  topic for additional information.
...
![Templates interface - Right-Click Menu](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/agents/rightclickmenu.webp)
