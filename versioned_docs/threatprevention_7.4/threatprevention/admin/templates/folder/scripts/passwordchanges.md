...
The following C# script sends an email notification to the specified user when their Active Directory password has changed.
...
In the Templates > Actions folder in the Navigation pane, the _AD Changes: Notify user that his password changed_ template is preconfigured to use this action script.
