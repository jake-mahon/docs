...
![INTERCEPT Offenses in QRadar](/img/versioned_docs/threatprevention_7.4/threatprevention/siemdashboard/qradar/offenses.png)

While the [Authentication Attacks Dashboard](/versioned_docs/threatprevention_7.4/threatprevention/siemdashboard/qradar/dashboard/authenticationattacks.md) reports on incidents monitored by Threat Prevention Authentication Analytics, these incidents also generate offenses.
