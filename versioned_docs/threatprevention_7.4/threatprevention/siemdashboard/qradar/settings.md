...
![Settings interface](/img/versioned_docs/activitymonitor_7.1/config/dellpowerscale/settings.png)
...
Authentication activity by a honey account will generate an INTERCEPT: Honey Accounts Offense. See the [INTERCEPT Offenses in QRadar](/versioned_docs/threatprevention_7.4/threatprevention/siemdashboard/qradar/offenses.md) topic for additional information.
