...
___RECOMMENDED:___ Deploy the Agent to a server using the Deploy Agents wizard. See the [Deploy Agents](/versioned_docs/threatprevention_7.4/threatprevention/admin/agents/deploy/overview.md) topic for additional information.
