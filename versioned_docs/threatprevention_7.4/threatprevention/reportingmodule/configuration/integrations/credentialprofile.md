...
![Integrations interface on the Credential Profile page](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/systemsettings/page.png)
...
See the [Reporting Module Server Requirements](/versioned_docs/threatprevention_7.4/threatprevention/requirements/reportingserver.md) topic for a list of permission requirements for each type of task.
...
![Add New Integration window with Credential Profile type selected](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/credentialprofile.png)
...
__Step 7 –__ On the Integrations interface, click __Credential Profile__ in the navigation pane to view a list of the already created Credential Profiles, if any.

__Step 8 –__ Select a Credential Profile from the table or the navigation pane to view its details.

![Integrations interface displaying the details for a Credenital Profile](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/details.png)
...
__Step 9 –__ Use the gear icon in the upper right corner of the console to open the Configuration menu. Then select __Integrations__ to open the Integrations interface.

__Step 10 –__ On the Integrations interface, click __Credential Profile__ in the navigation pane to view a list of the already created Credential Profiles, if any.

__Step 11 –__ Select a Credential Profile from the table or the navigation pane.

__Step 12 –__ Click the __Edit__ button in the upper right corner of the name and description box.

![Name and Description box for a Credential Profile in Edit mode](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/editprofile.png)

__Step 13 –__ To modify the profile name, type in the top field.

__Step 14 –__ To modify the profile description, type in the bottom field.

__Step 15 –__ Click the __Save__ button.
...
![Credential Settings window](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/credentialsettingswindow.png)
