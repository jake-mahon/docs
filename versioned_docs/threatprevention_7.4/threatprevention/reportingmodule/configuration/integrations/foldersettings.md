...
Click __Folder Settings__ in the navigation pane.

![Integrations interface on the Folder Settings page](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/systemsettings/page.png)
...
![Shared Folder table on the Folders Settings page](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/sharedfoldertable.png)
...
![Shared Folder table on the Folders Settings page showing additional options](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/additionaloptions.png)
...
![Local Folder settings on the Folder Settings page](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/localfolder.png)
...
__NOTE:__  Prior to adding a shared folder, you must first configure a Credential Profile with Write access to the shared folder. See the [Credential Profile Page](/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/credentialprofile.md) topic for creating a profile.
...
![Add New Shared Folder window](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/addnewsharedfolderwindow.png)
