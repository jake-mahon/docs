...
![Integrations interface displaying the details for an OpenID authneication provider](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/authenticationprovider/openid.png)
...
![Configuration tab for an OpenID authneication provider](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/integrations/authenticationprovider/configurationopenid.png)
...
- Client Id – The ID assigned to an application that allows it to request authentication and interact with the identity provider
...
- User Source – The source type to use to validate the user from the token. Use the drop-down menu to select one of the following: Introspection, User Info, Token Parse, or Id Token Parse
