...
In addition to the Virtual Environments mentioned above, the Endpoint Protector Virtual Appliance can also be run on older versions of the virtualization software. This makes testing and implementation as easy as possible. Additional information can be found in the following topics.
...
__NOTE:__ The most commonly used format is OVF (Open Virtualization Format) as it is compatible with the majority of the virtualization software.
