...
![ Creating a storage account](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/configuration/azure/createstorage.png)
...
![Naming the container ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/configuration/azure/createcontainer.png)
...
![Configuring the SAS token](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/configuration/azure/accesstokens.png)
