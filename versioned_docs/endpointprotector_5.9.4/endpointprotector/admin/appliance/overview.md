...
![View general information about the Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/serverinformation.webp)
...
![ Set up a preferential time zone and NTP synchronization server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/servermaintenance.webp)
...
![Set a preferential time zone and/or sync the appliance to an NTP source](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/timezone.webp)
...
![ Change the network settings for the appliance to communicate correctly in your network](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/ipconfg.webp)

### DNS Conﬁguration

In this section you can modify or add a DNS server address and then Save your changes.

![Modify or add a DNS server address and then Save your changes](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/dnsconfg.webp)
...
![Register and then verify the Endpoint Protector Client certiﬁcate signature](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/clientregcert.webp)
...
![Perform appliance operations such as Reboot or Shutdown](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/applianceoperations.webp)
...
![Manage user access to the Appliance through the SSH protocol](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/sshserver.webp)
...
![Add, edit or delete an existing SIEM Server integration](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/siemserverintegration.webp)
...
![SIEM Intergration - Adding a New Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/appliance/siemintegrationnewserver.webp)
