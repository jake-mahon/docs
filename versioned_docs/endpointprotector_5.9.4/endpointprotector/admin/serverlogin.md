...
After provisioning the Endpoint Protector Server, you can configure the feature modules. To manage policies in preparation for agent deployment, follow these steps to access the web user interface set up during the server installation:

__Step 1 –__ Access the Web Interface: Enter the server's address in your web browser's address bar. This address may be a static IP or a namespace.

__Step 2 –__ Log In: You will be prompted to enter your credentials. Use your assigned username and password. If you are logging in for the first time, use the default credentials:
...
![ Input your assigned username and password to log in to the Server](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/serverlogin.png)
