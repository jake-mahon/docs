...
- Personal Identiﬁable Information (PII) – social security numbers (SSN), driving license numbers, E-mail addresses, passport numbers, phone numbers, addresses, dates, etc.
...
- Conﬁdential ﬁles – sales and marketing reports, technical documents, accounting documents, customer databases, etc.
...
__NOTE:__  Any details provided will only be used to ensure the Live Update Server is conﬁgured correctly and that the eDiscovery module was enabled successfully.
...
![eDiscovery Activation](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/activation.png)
...
__NOTE:__ Once the eDiscovery Policies are created, select the type of eDiscovery Scan.

eDiscovery Scans are sets of rules for Policies, deﬁning when to start the data discovery. There are several types of scans:
...
![eDiscovery Automatic Scanning](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/automaticscanning.png)
...
__NOTE:__ Use Global Stop and Clear in situations where all the eDiscovery Scans need to be stopped and all the Logs cleared.
...
![Creating an eDiscovery Policy and Scan](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/policiesscans.png)
...
![Creating a new Policy](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/newpolicy.png)
...
For detailed information on Denylists and Allowlist, refer to the [Denylists and Allowlists](/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/denylistsallowlists/overview.md) chapter.
...
![eDiscovery Scan Result and Actions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/scanresults.png)
...
![eDiscovery Scan Result and Actions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/ediscoveryscans.png)
...
![Viewing Scan Results and Taking Actions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/ediscoveryactions.png)
