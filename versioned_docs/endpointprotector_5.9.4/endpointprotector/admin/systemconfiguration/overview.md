...
![Download and install the Endpoint Protector Client corresponding to your operating system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/clientsoftware.webp)
...
![Client Software Upgrade](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/clientsoftwareupgrade.webp)
...
![Create New Upgrade Job](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/createnewupgradejob.webp)
...
![Select the groups and/or computers to perform or exclude from the upgrade](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/selectendpointsupgrade.webp)
...
![Edit the default job title, add a description and conﬁrm the upgrade job details](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/upgradejobdetails.webp)
...
![Manage Upgrade Jobs](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/manageupgradejobs.webp)
...
![Client Uninstall](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/clientuninstall.webp)
