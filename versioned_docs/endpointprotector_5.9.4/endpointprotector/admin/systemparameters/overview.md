...
![Manage device types and notiﬁcations](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/devicetypesnotif.png)
...
![List of Device Types and Notiﬁcations](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/devicetypesnotiftwo.png)
...
![Enable/disable a message from the list of Default Notiﬁcations or edit the custom notiﬁcations translations](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/listdefaultnotif.png)
...
![Custom Device Control User Remediation Notiﬁcations](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/userremediationnotif.png)
...
![Creating the XML](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/contextualdetectionone.png)

![Creating the XML](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/contextualdetectiontwo.png)
...
![Advanced Scanning Detection](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/advancedscanningexceptions.png)

## Rights

This subsection displays a list with all access rights that can be assigned to devices.

![Displays a list with all access rights that can be assigned to devices](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/rights.png)
...
![View, manage and export the events list logged by Netwrix Endpoint Protector](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/listofevents.png)
...
![Allows the end-users to apply a justiﬁcation and self-remediate a policy violation or a restricted-access device](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/userremediation.png)
...
![User Remediation Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/userremediationsettings.png)
...
![These are device types that apply in General](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/devicetypes.png)
...
![User Remediation Usage](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/dcselfremediate.png)
...
![Self Remediate section](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/selfremediatesection.png)
...
![ Stopping the device remediation session](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemparameters/revokeremediation.png)
