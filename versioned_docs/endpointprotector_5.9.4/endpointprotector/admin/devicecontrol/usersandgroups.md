...
![Managing all the users in the system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/listofusers.png)
...
For detailed information on Active Directory, refer to the [Directory Services](/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/directoryservices/overview.md) chapter.
...
![ Allows Administrator to specify what Device Types and also what Speciﬁc Devices can be accessible](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/userrights.png)

### User Settings

From this section, you can edit the settings for each user.

![You can edit the settings for each user.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/groupsettings.png)
...
![Displays the Logs Report page ﬁltered for the respective user](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/logsreport.png)
...
![Manages the list of groups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/listofgroups.png)
...
![ Membership can be deﬁned based on element name patterns](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/smartgroups.png)
...
![Adding users to smart groups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/groupinformation.png)
...
![Editing Group Information](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/groupinfoedit.png)

__Step 4 –__ Delete a Smart Group from the Actions column or select the group from the list and then click __Delete__.

![Deleting A smart group](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/smartgroupdelete.png)
...
![Enabling Default Groups for Computers and Users from System Conﬁguration](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/enablesmartgroups.png)
...
![Manage all the groups in the system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/listofgroups.png)
...
![Managing information about groups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/syncgroupinformation.png)
...
![Allowlists on Computer Groups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/allowlist.png)
...
![Specify what Device Types and also what Speciﬁc Devices can be accessible.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/devicetypes.png)

### Group Settings

From this section, you can edit the settings for each group.

![groupsettings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/groupsettings.png)
