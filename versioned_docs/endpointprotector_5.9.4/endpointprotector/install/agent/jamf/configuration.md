...
![Creating a New configuration Profile](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/configurationprofile.png)
...
![Enabling Deep Packet Inspection Certificate and then downloading Client CA Certificate](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpicertificate.png)
...
![Entering the required information on New macOS Configuration Profile](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/macosconfiguration.png)
...
![Configuring Privacy Peferences Policy Control](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/privacypreferences.png)
...
![Configuring EPPNotifier Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/eppnotifer.png)
...
![Configuring Enforced Encryption settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/enforcedencryption.png)
...
![Allowing System Extensions ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/systemextensions.png)
...
![Adding a new policy that will allow the removing of system extensions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/removeableextensions.png)
...
![First section to configuring VPN settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/vpnsettings.png)

![Second section to configuring VPN settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/vpnconfiguration.png)
...
![Optional Notifiaction Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/notificationsettings.png)
