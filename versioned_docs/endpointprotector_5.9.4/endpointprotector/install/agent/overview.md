...
![The Agent enforces the Rights and Settings received from the Endpoint Protector Server on the protected endpoints (Windows, Mac, and Linux)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setupagent.png)

![The Agent enforces the Rights and Settings received from the Endpoint Protector Server on the protected endpoints (Windows, Mac, and Linux)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setupagenttwo.png)
...
![Installation on macOS with Deep Packet Inspection and VPN Traﬃc Intercept Active](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/clientinstallationios.png)
...
![Grant permission to the Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/eppagentpermisions.png)
...
![Activating Deep Packet Inspection](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpion.png)
...
![Download the Client CA Certiﬁcates](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpicertificate.png)

**Step 8 –** Open the **Keychain Access** application from your macOS and select **System**.

![Open the Keychain Access application from your macOS and select System](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/keychainaccess.png)
...
![Select cacert.pem ﬁle and drag and drop it on Keychain Access, System](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/clientcerts.png)

**Step 11 –** Double-click the **X** on the newly added certiﬁcate and on the Trust section, select
**Always Trust**.

![On the newly added certiﬁcate and on the Trust section, select Always Trust.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/keychainaccesstwo.png)
...
![Activate Intercept VPN Traﬃc](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/interceptvpntraffic.png)
...
![System Extension is blocked and needs to be allowed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/systemextensionblocked.png)
...
![select the General tab and allow the Endpoint Protector Client Extension](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/generaltabios.png)

**Step 18 –** **Allow** the Endpoint Protector Proxy Conﬁguration from the pop-up window.

![proxypop-up](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/proxypop-up.png)
...
![Debian Based Distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/debianbaseddistributions.png)
...
![RedHat based distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/redhatbaseddistributions.png)
...
![RedHat based distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/redhatbaseddistributionstwo.png)
...
![Setting the Endpoint Protector Server IP](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setserverip.png)

![Setting the Endpoint Protector Server IP](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setserveriptwo.png)
