...
- Imports PPE/Web V6.x configuration settings. See the [Upgrading from PPW/Web V6.x](/versioned_docs/passwordpolicyenforcer_10.2/password_policy_enforcer/web/installation.md#Upgrading-from-PPWWeb-V6x) topic for additional information.
