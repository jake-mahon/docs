...
__CAUTION:__ Do not use Password Policy Enforcer/Web on a production network without SSL encryption.
...
- Windows 2012 & 2008
  ...
  - See the [Configure Server Certificates in IIS 7](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732230(v=ws.10)?redirectedfrom=MSDN) Microsoft knowledge base article for additional information.
- Windows 2003

  - Configure Server Certificates in IIS 6.0. See the [Certificates (IIS 6.0)](http://www.microsoft.com/technet/prodtechnol/WindowsServer2003/Library/IIS/89c7ef2f-f7d6-483c-8b08-ae0c6584dd4d.mspx) Microsoft knowledge base article for additional information.
