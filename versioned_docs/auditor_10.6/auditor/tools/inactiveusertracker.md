...
| Move to a specific OU after | - Specify account inactivity period, after which the account will be moved to a specified organizational unit. - OU name—Specify OU name or select an AD container using ![select_button](/img/versioned_docs/auditor_10.6/auditor/tools/select_button.png) button. |
...
![inactiveusersactivedirectory](/img/versioned_docs/auditor_10.6/auditor/tools/inactiveusersactivedirectory.png)
