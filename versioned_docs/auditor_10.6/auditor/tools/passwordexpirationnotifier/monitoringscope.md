...
__Step 1 –__ Navigate to the _%Netwrix Auditor installation folder%\Password Expiration Alerting_folder.

__Step 2 –__ Edit the omitoulist.txt file, based on the following guidelines:
