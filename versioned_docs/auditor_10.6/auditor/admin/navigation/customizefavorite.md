...
| View | Opens the Preview Report page. There, you can modify report options (such as the timeframe) if desired, and then click View Report to see the resulting report. See the [View Reports](/versioned_docs/auditor_10.6/auditor/admin/reports/view.md) topic for additional information. |
| Subscribe | Opens the Add Subscription to Report page. See the [Create Subscriptions](/versioned_docs/auditor_10.6/auditor/admin/subscriptions/create.md) topic for additional information. |
