...
| Remove an alert | Select an alert from the list and click ![delete](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/delete.png) in the right pane. |
