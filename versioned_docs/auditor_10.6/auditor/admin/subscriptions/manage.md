...
![subscription](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/investigations/options/subscription.png)
...
| Remove subscriptions            | Click ![delete](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/delete.png) icon next to the selected subscription.           |
