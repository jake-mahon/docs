...
- [User Activity](/versioned_docs/auditor_10.6/auditor/configuration/useractivity/overview.md) – Configure data source as required to be monitored
...
- In the Title filter enter "_Document1.txt - Notepad_":
  ...
  ![uavr_source_example_1](/img/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/useractivity/uavr_source_example_1.png)
- In the Description filter, enter the corresponding value, here it will be "_Notepad_".

[![uavr_source_example_2](/img/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/useractivity/uavr_source_example_2.png)](/versioned_docs/auditor_10.6/resources/images/auditor/monitoringplans/uavr_source_example_2.png)
