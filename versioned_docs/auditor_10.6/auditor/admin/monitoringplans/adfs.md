...
- [AD FS](/versioned_docs/auditor_10.6/auditor/configuration/activedirectoryfederatedservices/overview.md) – Configure data source as required to be monitored
