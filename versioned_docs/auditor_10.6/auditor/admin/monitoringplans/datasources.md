...
[![Data source settings](/img/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/mp_edit_data_source.png)](/versioned_docs/auditor_10.6/resources/images/auditor/monitoringplans/mp_edit_data_source.png)
...
| As a Auditor Administrator I want to exclude shared _PublicList_ from read audit. | [](/versioned_docs/auditor_10.6/auditor/solutions/items/sharepointfarm.md)[SharePoint Farm](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/sharepoint/overview.md#SharePoint-Farm) |
| Windows Server |  |
