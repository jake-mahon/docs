...
| I want to exclude specific computers within an IP range from the Netwrix auditing scope. | [File Servers](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/fileservers/overview.md) |
| __SQL Server__ |  |
