...
- [Group Policy](/versioned_docs/auditor_10.6/auditor/configuration/grouppolicy/overview.md) – Configure data source as required to be monitored
...
| Prerequisites | Netwrix Auditor will automatically look up additional system components and prompt you to install those that are missing. In case all required components have been already installed, this section will be omitted. See the [Other Components](/versioned_docs/auditor_10.6/auditor/requirements/software.md#other-components) topic for additional information. |
...
See the [Permissions for Group Policy Auditing
](/versioned_docs/auditor_10.6/auditor/configuration/grouppolicy/permissions.md) topic for additional information.
