...
- [Exchange](/versioned_docs/auditor_10.6/auditor/configuration/exchange/overview.md) – Configure data source as required to be monitored
...
See the [Permissions for Exchange Auditing](/versioned_docs/auditor_10.6/auditor/configuration/exchange/permissions.md) topic for additional information.
