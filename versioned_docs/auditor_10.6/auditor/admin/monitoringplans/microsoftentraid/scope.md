...
__NOTE:__ Omitting user accounts does not decrease the license consumption count for Microsoft Entra ID.

Follow the steps to exclude data from the Microsoft Entra ID monitoring scope:

__Step 1 –__ Navigate to the _%Netwrix Auditor installation folder%\Entra ID Auditing_ folder.
