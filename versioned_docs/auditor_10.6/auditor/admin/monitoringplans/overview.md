...
- [Supported Data Sources](/versioned_docs/auditor_10.6/auditor/requirements/supporteddatasources.md) – Configure data source as required to be monitored
...
__Step 1 –__ Create a monitoring plan with the wizard. Select the data source when you start the monitoring plan wizard, and its initial settings are configured at the wizard steps. See the [Create a New Monitoring Plan](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/create.md) topic for additional information.
...
For many data sources, you can instruct Netwrix Auditor to collect state-in-time data along with event data. For that, Netwrix Auditor uses state-in-time snapshots of the relevant system (for example, see [VMware](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/vmware/overview.md)).
...
See the [Role-Based Access and Delegation](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/delegation.md) topic for additional information.
