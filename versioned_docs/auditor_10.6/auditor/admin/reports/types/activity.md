...
| --- | --- |
| Active Directory | __Active Directory__ → __Active Directory Changes__ |
| Active Directory Federation Services | __Active Directory Federation Services (AD__ __FS)__ |
...
| Logon Activity | __Active Directory__ → __Logon Activity__ |
