...
- The report will not show the ALTER (SERVER_ROLE) capability for the privileged users in SQL Server 2008 R2 due to that SQL Server version implementation.
