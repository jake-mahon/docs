...
- The report will not show the __ALTER (SERVER_ROLE)__ capability for the privileged users in SQL Server 2008 R2 due to that SQL Server version implementation.
