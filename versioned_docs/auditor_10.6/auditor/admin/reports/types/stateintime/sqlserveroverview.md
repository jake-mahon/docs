...
- [Account Permissions in SQL
  Server](/versioned_docs/auditor_10.6/auditor/admin/reports/types/stateintime/sqlaccountpermissions.md)
- [Object Permissions in SQL
  Server](/versioned_docs/auditor_10.6/auditor/admin/reports/types/stateintime/sqlobjectpermissions.md)
