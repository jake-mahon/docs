...
- The Database statistics widget—Helps you to estimate database capacity on the default SQL Server
  ...
  [Database Statistics](/versioned_docs/auditor_10.6/auditor/admin/healthstatus/dashboard/databasestatistics.md)
  topic for additional information.
...
[Notifications](/versioned_docs/auditor_10.6/auditor/admin/settings/notifications.md) topic.
