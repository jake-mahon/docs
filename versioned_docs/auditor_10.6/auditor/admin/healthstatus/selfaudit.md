...
[![selfaudit](/img/versioned_docs/auditor_10.6/auditor/admin/healthstatus/selfaudit.png)](/versioned_docs/auditor_10.6/resources/images/auditor/settings/selfaudit.png)
...
__Step 4 –__ After browsing your data, navigate to Tools to use the search results as intended. See the [View and Search Collected Data](/versioned_docs/auditor_10.6/auditor/admin/search/overview.md) topic for additional information.
...
![selfaudit_report](/img/versioned_docs/auditor_10.6/auditor/admin/healthstatus/selfaudit_report.png)
