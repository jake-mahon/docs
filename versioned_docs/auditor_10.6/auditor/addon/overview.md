...
Refer to [Security](/versioned_docs/auditor_10.6/auditor/api/security.md) for detailed instructions on how to assign a new certificate and enable trust on remote computers.
