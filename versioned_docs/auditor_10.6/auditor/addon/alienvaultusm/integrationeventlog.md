...
| --- | --- | --- |
| Source | __NA____`{Data Source Name}`__  -OR-  __Netwrix_Auditor_Integration_API__ | Depending on _SetDataSourceAsEventSource_ in-script parameter. |
...
See the [Define Parameters](/versioned_docs/auditor_10.6/auditor/addon/alienvaultusm/parameters.md) topic for additional information.
