...
[Reference for Creating Activity Records](/versioned_docs/auditor_10.6/auditor/api/activityrecordreference.md)topic.
...
See the [Define Parameters](/versioned_docs/auditor_10.6/auditor/addon/alienvaultusm/parameters.md)
