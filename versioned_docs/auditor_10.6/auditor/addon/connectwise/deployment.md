...
1. In the Auditor settings, enable Integration API and specify connection port. See the [Integrations](/versioned_docs/auditor_10.6/auditor/admin/settings/integrations.md) topic for additional information.
2. Make sure your monitoring plans set up in Auditor are using Audit Databases to store collected data. See the [Audit Database](/versioned_docs/auditor_10.6/auditor/admin/settings/auditdatabase.md) topic for additional information.
...
__Step 5 –__ Run the ConfigureConnection.exe and follow the steps of the wizard to configure connection and ticketing settings for ConectWise Manage. See the [Configure ConnectWise ](/versioned_docs/auditor_10.6/auditor/addon/connectwise/configure.md)topic for additional information.

__Step 6 –__ (optional) To adjust the add-on operation and data flow settings, edit the ITSMSettings.xml file. See the [Operational Settings](/versioned_docs/auditor_10.6/auditor/addon/connectwise/operationalsettings.md) topic for additional information.
