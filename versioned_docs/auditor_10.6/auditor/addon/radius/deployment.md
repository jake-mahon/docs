...
Depending on the execution scenario you choose, you have to define a different set of script parameters. See the [Define Parameters](/versioned_docs/auditor_10.6/auditor/addon/radius/parameters.md) topic for additional information.
