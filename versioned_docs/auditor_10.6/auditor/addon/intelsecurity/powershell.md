...
By default, the Netwrix Auditor __Integration__ event log size is set to 1GB, and retention is set to "_Overwrite events as needed_". See the [Integration Event Log Fields](/versioned_docs/auditor_10.6/auditor/addon/intelsecurity/integrationeventlog.md) topic for additional information.
