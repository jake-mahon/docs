...
For more information on the structure of the Activity Record and the capabilities of the Integration API, refer to the [Integration API](/versioned_docs/auditor_10.6/auditor/api/overview.md) topic.
