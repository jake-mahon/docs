...
See the [Prerequisites](/versioned_docs/auditor_10.6/auditor/api/prerequisites.md) topic for additional information.
...
In such scenario, you will need to specify this monitoring plan in the _NetwrixAuditorPlan_ and _NetwrixAuditorPlanItem_ parameters in the __settings.xml__ file. See the [Add-On Parameters](/versioned_docs/auditor_10.6/auditor/addon/hyperv/parameters.md) topic for additional information.
...
See the [Add-On Parameters](/versioned_docs/auditor_10.6/auditor/addon/hyperv/parameters.md)topic for the full list of configuration parameters.
...
For the full list of parameters, see the [Add-On Parameters](/versioned_docs/auditor_10.6/auditor/addon/hyperv/parameters.md) topic for additional information.
