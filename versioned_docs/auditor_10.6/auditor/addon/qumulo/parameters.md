...
After you modify parameters in the __settings.xml__ file, remember to save the changes and then restart (Undefined variable: Add-on.Addon_Qumulo) service (__SyslogService.exe__) for them to take effect.
