...
__Step 2 –__ In the left pane, navigate to __Forest: `<forest_name>` → Domain → `<domain_name>`, right-click `<OU_name>`__ and select __Create a GPO in this domain and Link it here__.
...
![add_msi](/img/versioned_docs/auditor_10.6/auditor/install/add_msi.png)
...
![winserver2016_advanced_deployment_options](/img/versioned_docs/auditor_10.6/auditor/install/winserver2016_advanced_deployment_options.png)
