...
1. Navigate to the Netwrix Auditor client installation directory and locate the AuditIntelligence.exe file (default location is _C:\Program Files (x86)\Netwrix Auditor\Audit Intelligence\AuditIntelligence.exe)._
