...
- For auditing cloud-based applications (Microsoft Entra ID, Exhange Online, SharePoint Online, and
  ...
  more information about required rights and permissions:
    ...
    - [Permissions for SharePoint Online Auditing ](/versioned_docs/auditor_10.6/auditor/configuration/microsoft365/sharepointonline/permissions.md)
...
- Netwrix Auditor for Oracle Database. If you use the following combination of the audit settings:
  ...
  and
  [Verify Your Oracle Database Audit Settings](/versioned_docs/auditor_10.6/auditor/configuration/oracle/verifysettings.md)
...
[Installation](/versioned_docs/auditor_10.6/auditor/install/overview.md) topic for additional
information.
