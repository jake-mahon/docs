...
__Step 1 –__ For __Windows Server__, the EULA will be displayed in the License terms page; read and accept the agreement.

__Step 2 –__ Next, specify a password for the built-in administrator account. Then re-enter your password. Click Finish.

__Step 3 –__ Log in to the virtual machine.

__Step 4 –__ The Windows PowerShell opens and automatically runs the script. Press any key to read the license agreement and then press ```Y``` to accept it.

__Step 5 –__  Then you will be prompted to configure the virtual machine. Press Enter to start.
...
![appliance_script](/img/versioned_docs/auditor_10.6/auditor/install/virtualappliance/appliance_script.png)

__Step 6 –__ 
When the script execution completes, you will be prompted to reboot the virtual machine for the changes to take effect.

__Step 7 –__ After reboot, log in to the virtual machine using the domain administrator credentials (for appliances joined to domain) or local administrator credentials (for appliances joined to workgroup).
...
| --- | --- | --- |
| - See a list of audit settings - See a list of rights and permissions required for data collecting account | — | - [Supported Data Sources](/versioned_docs/auditor_10.6/auditor/requirements/supporteddatasources.md) - [Data Collecting Account](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/dataaccounts.md) |
| - Create a monitoring plan - Review data collection status - Configure the Long-Term Archive and the Audit Database settings - Assign roles and delegate control | Auditor Client | - [Monitoring Plans](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/overview.md) - [Netwrix Auditor Settings](/versioned_docs/auditor_10.6/auditor/admin/settings/overview.md) - [Role-Based Access and Delegation](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/delegation.md) |
| - Browse data with interactive search - Review diagrams - Generate reports - Configure report subscriptions - Create alerts | Auditor Client | - [Reports](/versioned_docs/auditor_10.6/auditor/admin/reports/overview.md) - [Subscriptions](/versioned_docs/auditor_10.6/auditor/admin/subscriptions/overview.md) - [Alerts](/versioned_docs/auditor_10.6/auditor/admin/alertsettings/overview.md) |
| See the data collected by Auditor | Auditor Client | - [Access Reviews](/versioned_docs/auditor_10.6/auditor/accessreviews.md) |

__NOTE:__ If any errors occur, please contact [Netwrix technical support](https://www.netwrix.com/support.html).
