...
- If you are going to use a gMSA as a data collecting account in Auditor, add this account to the
  ...
  depending on the data source you want to collect data from:
    ...
    - [Permissions for Group Policy Auditing ](/versioned_docs/auditor_10.6/auditor/configuration/grouppolicy/permissions.md)
    - [Permissions for Logon Activity Auditing ](/versioned_docs/auditor_10.6/auditor/configuration/logonactivity/permissions.md)
    ...
    - [Permissions for SQL Server Auditing ](/versioned_docs/auditor_10.6/auditor/configuration/sqlserver/permissions.md)
    - [Permissions for Windows Server Auditing ](/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/permissions.md)
...
See the
[Add Items for Monitoring](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/datasources.md#add-items-for-monitoring) topic
