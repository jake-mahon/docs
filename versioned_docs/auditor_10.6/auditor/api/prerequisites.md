...
Refer to the [Security](/versioned_docs/auditor_10.6/auditor/api/security.md) topic for detailed
...
Refer to the [Audit Database](/versioned_docs/auditor_10.6/auditor/admin/settings/auditdatabase.md)
