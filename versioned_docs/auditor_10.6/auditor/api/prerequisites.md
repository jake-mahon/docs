...
Refer to the [Security](/versioned_docs/auditor_10.6/auditor/api/security.md) topic for detailed instructions on how
...
Refer to the [Audit Database](/versioned_docs/auditor_10.6/auditor/admin/settings/auditdatabase.md) topic for detailed instructions on how to configure SQL Server settings.
