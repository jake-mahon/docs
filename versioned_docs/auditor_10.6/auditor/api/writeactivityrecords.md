...
| --- | --- | --- |
| ```POST``` | ```https://{host:port}/netwrix/api/v1/activity_records/{?format=json}``` | [Activity Records](/versioned_docs/auditor_10.6/auditor/api/postdata/activityrecords.md) |
...
| Error | The header status code is an error code. Depending on the error code, the response body may contain an error object. [See Response Status Codes for more information.](/versioned_docs/auditor_10.6/auditor/api/responsecodes.md) |

## Usage Example—Write Data

This example describes how to feed Activity Records to the Audit Database.

__Step 1 –__ Send a POST request containing Activity Records. [Activity Records](/versioned_docs/auditor_10.6/auditor/api/postdata/activityrecords.md) For example:
...
![apiactivitydetails](/img/versioned_docs/auditor_10.6/auditor/api/apiactivitydetails.png)
