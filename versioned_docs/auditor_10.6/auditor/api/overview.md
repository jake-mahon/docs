...
[![diagram](/img/versioned_docs/auditor_10.6/auditor/addon/cyberark/diagram.png)](/versioned_docs/auditor_10.6/resources/images/auditor/api/diagram.png)
...
Make sure Integration API is enabled. To check it, navigate to Settings → Integrations tab. See [Integrations](/versioned_docs/auditor_10.6/auditor/admin/settings/integrations.md) for more information.
