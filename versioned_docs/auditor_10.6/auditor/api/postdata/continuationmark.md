...
| --- | --- | --- |
| POST | [/netwrix/api/v1/activity\_records/enum ](/versioned_docs/auditor_10.6/auditor/api/retrieveactivityrecords.md) | Returns next Activity Records. |
| POST | [/netwrix/api/v1/activity\_records/search](/versioned_docs/auditor_10.6/auditor/api/searchactivityrecords.md) | Returns next Activity Records matching a filter criteria. |
...
If you want to retrieve next Activity Records for your search, include the Continuation mark to your Search parameters file. [Search Parameters](/versioned_docs/auditor_10.6/auditor/api/postdata/searchparameters.md)
