...
- Configure Data Collecting Account. See the [Permissions for Oracle Database Auditing](/versioned_docs/auditor_10.6/auditor/configuration/oracle/permissions.md) topic for additional information.
- Configure ports. See the [Oracle Database Ports](/versioned_docs/auditor_10.6/auditor/configuration/oracle/ports.md) topic for additional information about ports and protocols required for auditing.
