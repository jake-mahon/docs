...
If you are using Oracle Database 12c or later, make sure you have Unified auditing mode enabled. Otherwise, Netwrix Auditor may not operate properly. See the [Migrate to Unified Audit](/versioned_docs/auditor_10.6/auditor/configuration/oracle/unified.md) topic for additional information.

See the [Software Requirements](/versioned_docs/auditor_10.6/auditor/requirements/software.md) topic for additional information.

## Configuration

If you are using Oracle Wallet to connect to your database, see the [Create and Configure Oracle Wallet](/versioned_docs/auditor_10.6/auditor/configuration/oracle/wallet.md) topic for configuration details.

Oracle Wallet is not supported for Oracle 11g. If you are unsure of your audit settings, refer to the [Verify Your Oracle Database Audit Settings](/versioned_docs/auditor_10.6/auditor/configuration/oracle/verifysettings.md)

Follow the steps for proper configuration.

__Step 1 –__ Configure Data Collecting Account, as described in the [Permissions for Oracle Database Auditing](/versioned_docs/auditor_10.6/auditor/configuration/oracle/permissions.md) topic.

__Step 2 –__ Configure required protocols and ports, as described in the [Oracle Database Ports](/versioned_docs/auditor_10.6/auditor/configuration/oracle/ports.md) topic.
