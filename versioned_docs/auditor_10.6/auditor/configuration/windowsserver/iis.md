...
To be able to process Internet Information Services (IIS) events, you must enable the Remote Registry service on the target computers. [Windows Server](/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/overview.md)
