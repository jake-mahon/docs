...
6. Apply settings to your Auditing Entries depending on actions that you want to audit. If you want
   ...
   contain limited data and warning messages. Review the following for additional information:
    ...
    - Failed change attempts | Auditing Entry | | | --- | --- | | Successful reads | | | The
      ...
      ![manualconfig_fileserver_auditingentry_1_2016](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/netappcmode/manualconfig_fileserver_auditingentry_1_2016.png) -
      ...
      ![manualconfig_fileserver_auditingentry_2_2016](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/netappcmode/manualconfig_fileserver_auditingentry_2_2016.png) -
      ...
      ![manualconfig_fileserver_auditingentry_3_2016](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/netappcmode/manualconfig_fileserver_auditingentry_3_2016.png) -
      ...
      change attempts:
      ![manualconfig_fileserver_auditingentry_4_2016](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/netappcmode/manualconfig_fileserver_auditingentry_4_2016.png) -
      Type—Set to*"Fail"*. - Applies to—Set to*"This folder, subfolders and files"*. - Advanced
      permissions: - Create files / write data - Create folders / append data - Write extended
      attributes - Delete subfolders and files - Delete - Change permissions - Take ownership - Make
      sure that theOnly apply these auditing settings to objects and/or containers within this
