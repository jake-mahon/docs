...
__Step 3 –__ In the __Advanced Security Settings for <Share\_Name>__ dialog, navigate to the __Auditing__ tab.
...
__Step 5 –__  In the Auditing Entry for <Folder\_Name> dialog, click the Select a principal link and specify Everyone.
