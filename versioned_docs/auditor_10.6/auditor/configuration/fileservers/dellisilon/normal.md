...
- Using the configure\_ifs.sh shell script that comes with Netwrix Auditor. See the [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode via Shell Script](#Configure-Dell-IsilonPowerScale-Cluster-in-Normal-or-Enterprise-Mode-via-Shell-Script) topic for additional information.
