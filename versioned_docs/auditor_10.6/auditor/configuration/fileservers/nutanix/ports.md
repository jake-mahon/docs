...
Later, you can specify any custom TCP port when editing your Nutanix Files monitoring plan. See the [File Servers](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/fileservers/overview.md) (Nutanix section) for more information.
