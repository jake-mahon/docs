...
5. Under the Select Events to Log, select the following (minimal requirement, select other events if needed):
   ...
   ![manual_config_pulse_1](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/manual_config_pulse_1.png)
...
17. Navigate to your monitoring plan for Network Devices. See [Monitoring Plans](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/overview.md)
18. Provide the IP address of the interface you specified on the step 14 as the Computer item for your monitoring plan. See [Active Directory](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/activedirectory/overview.md)
