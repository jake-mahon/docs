...
2. Execute the following commands:
   ...
   ```<port number>``` is the name of the UDP port used to listen to network devices (514 port used by default). [Network Devices](/versioned_docs/auditor_10.6/auditor/admin/monitoringplans/networkdevices.md)
