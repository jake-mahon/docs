...
- [To configure HPE Aruba devices via Command Line Interface](#To-configure-HPE-Aruba-devices-via-Command-Line-Interface)
...
3. Navigate to Configuration → System → Logging and click + to add a new Syslog Server.
   ...
   ![nand_aruba_logging](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/nand_aruba_logging.png)
...
9. If the configuration is correct, you will see the following wizard:
   ...
   ![nand_aruba_status](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/nand_aruba_status.png)
