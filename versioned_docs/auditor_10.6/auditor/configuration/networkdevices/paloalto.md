...
__Step 3 –__ Click __Add__ and specify profile name, for example, _"SyslogProf1"_.

__Step 4 –__ Specify syslog server parameters:
...
__Step 1 –__ In the Web Interface, navigate to __Device__ > __Log Settings__.

__Step 2 –__ For System, Config, and User ID logs, click Add and enter unique name of your syslog server.

__Step 3 –__ On the syslog panel, click Add and select the syslog profile you created above.

__Step 4 –__ Click __Commit__ and review the logs on the syslog server.

__NOTE:__ After configuring the monitoring plan, Netwrix Auditor will listen to the logs forwarded by the Palo Alto device.
