...
__Step 1 –__ Install the Netwrix Auditor Access Reviews application on the same server where the Netwrix Access Information Center was installed. See the [Install](/versioned_docs/auditor_10.6/access/reviews/installation/install.md) topic for additional information. On the SQL Server Connection page:
...
__Step 2 –__ Launch the application and reset the Builtin Administrator password. See the [First Launch](/versioned_docs/auditor_10.6/access/reviews/admin/firstlaunch.md) topic for additional information.

__Step 3 –__ It will be necessary to add your Console Users again. See the [Console Access Page](/versioned_docs/auditor_10.6/access/reviews/admin/configuration/consoleaccess.md) topic for additional information.

__Step 4 –__ It will be necessary to configure the Notification settings. See the [Notifications Page](/versioned_docs/auditor_10.6/access/reviews/admin/configuration/notifications.md) topic for additional information.
