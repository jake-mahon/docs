...
![processing_modes](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/processing_modes.png)
...
Proceed with configuring processing settings. See [Processing Settings](/versioned_docs/dataclassification_5.6.2/ndc/deployment/initial_config_processing-settings.md) next.
