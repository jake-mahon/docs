...
| Setting | Description |
| --- | --- |
| Would you like to configure Health Reporting? | Select Setup now if you want to receive health alerts. You can do it later in the communication settings area. [See System Health for more information.](/versioned_docs/dataclassification_5.6.2/ndc/dashboards.md#See-System-Health-for-more-information) |
