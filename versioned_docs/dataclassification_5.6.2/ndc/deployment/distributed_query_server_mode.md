...
1. Install and configure the first Netwrix Data Classification Server as described in the [Install Netwrix Data Classification](/versioned_docs/dataclassification_5.6.2/ndc/deployment/installation.md) section.
...
5. On the DQS tab, click Add to add servers you prepared, one by one.
   ...
   [![dqs_mode_page_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_mode_page_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/dqs_mode_page.png)
...
7. Prepare to install other Netwrix Data Classification Server instances, assuming each server requires a dedicated machine.
   Make sure they meet the [Hardware Requirements](/versioned_docs/dataclassification_5.6.2/ndc/deployment/hardware_requirements.md) and general [Software Requirements](/versioned_docs/dataclassification_5.6.2/ndc/deployment/software_requirements.md)
8. On each server, follow the installation steps as described in the [Install Netwrix Data Classification](/versioned_docs/dataclassification_5.6.2/ndc/deployment/installation.md) section until SQL Database configuration.
...
[![dqs_servers_list_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_servers_list_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/dqs_servers_list.png)
...
To review system health and check your configuration, use the product dashboards. [See Operations and Health Dashboards for more information.](/versioned_docs/dataclassification_5.6.2/ndc/dashboards.md)
