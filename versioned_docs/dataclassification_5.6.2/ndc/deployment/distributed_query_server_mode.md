...
5. On the DQS tab, click Add to add servers you prepared, one by one.
   ...
   ![dqs_mode_page_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_mode_page_thumb_0_0.png)
...
![dqs_servers_list_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_servers_list_thumb_0_0.png)
