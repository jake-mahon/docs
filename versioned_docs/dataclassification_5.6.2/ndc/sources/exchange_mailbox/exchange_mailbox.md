...
2. Select __Exchange Mailbox__ source type and in the properties window specify the necessary settings.
...
| --- | --- | --- |
| Email Address / Password | __Administrator__ account that has been assigned both:   1. __Impersonation__ right 2. __Discovery Management__ role | See [Configure Microsoft Exchange for Crawling and Classification](/versioned_docs/dataclassification_5.6.2/ndc/config_infrastructure/configure_exchange.md) for details on the rights assignment. |
