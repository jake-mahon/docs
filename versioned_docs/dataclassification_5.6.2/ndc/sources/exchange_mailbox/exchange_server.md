...
1. In Netwrix Data Classification management console, open the __Sources__ view and click __Add__.
2. Select __Exchange__ source type and in the properties window specify the necessary settings.
3. Remember to click the "wrench" icon next to __Settings__ in the bottom-left corner to display all settings.

## Authentication type: Modern authentication

__NOTE:__  For Email Address / Password, the Administrator account that has been assigned the right of the Discovery Management role and be given the Mailbox Search and MailboxSearchApplication permissions.
...
[![exchangeonline_cfg_modern_auth_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/sources/exchange_mailbox/exchangeonline_cfg_modern_auth_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/sources/exchangeonline_cfg_modern_auth.png)
...
| Option | Description |
| --- | --- |
| Email Address / Password | Administrator account that has been assigned the right of Impersonation as well as the Discovery Management role.  See [Configure Microsoft Exchange for Crawling and Classification](/versioned_docs/dataclassification_5.6.2/ndc/config_infrastructure/configure_exchange.md) for details on the rights assignment. |
...
Having specified all the necessary settings, click the __Save__ button.
