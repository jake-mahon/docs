...
Microsoft OneDrive is the default document library in a user's MySite in SharePoint Server or in Microsoft 365. The contents of this library can optionally be synchronized with one or more of the user's computers or devices.
...
[![addsharepointonline_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/sources/sharepoint/addsharepointonline_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/addsharepointonline.png)
