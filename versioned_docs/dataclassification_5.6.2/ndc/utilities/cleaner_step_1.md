...
__NOTE:__ This option is recommended after setting up DQS configuration.

- Delete Index—Delete all content from both the search index and the NDC SQL database.

![cleaner_step_1](/img/versioned_docs/dataclassification_5.6.2/ndc/utilities/cleaner_step_1.png)
