...
__NOTE:__ To manage the search requests, users require sufficient access rights that are assigned by the __Super User__ (DSAR Administrator). See [DSAR Roles](/versioned_docs/dataclassification_5.6.2/ndc/dsar/dsar_roles.md) for details on the available roles, their rights and permissions.
...
- Completed – shows all completed requests. Review the [View Search Query Results](/versioned_docs/dataclassification_5.6.2/ndc/dsar/dsar_view_search_results.md) section for instructions on how to complete your request.
...
In addition to filtering capabilities, you can sort search request by any column, e.g., _Percentage Complete_, _Updated Date_, etc.
