...
- Deleted Manually—Items removed manually by an end-user via the administration console
  ...
  [![dashboard_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/dashboard_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/dashboard.png)
...
1. Click Dismiss at the bottom.
   ...
   ![health_config_notifications](/img/versioned_docs/dataclassification_5.6.2/ndc/health_config_notifications.png)
