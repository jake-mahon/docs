...
1. Add SharePoint Online source as described in the [SharePoint Online](/versioned_docs/dataclassification_5.6.2/ndc/sources/sharepoint/sharepoint_online.md) section.
