...
You can apply the MIP labels to the file share and ShareЗoint sources. Specify this information using the [Create a Workflow using Add Workflow Wizard](/versioned_docs/dataclassification_5.6.2/ndc/workflows/workflow_add_workflow_wizard.md). Review the following for additional information:
