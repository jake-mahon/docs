...
To configure these actions, use the Advanced UI dialog window. See Configure a Workflow using Advanced dialog for details on how to invoke it.

## Delete Email

This action will remove an email from Exchange mailbox.

[![action_exchange_delete_email_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/workflows/advanced_window/action_exchange_delete_email_thumb_0_0.png)](/img/versioned_docs/dataclassification_5.6.2/ndc/workflows/action_exchange_delete_email.png)
