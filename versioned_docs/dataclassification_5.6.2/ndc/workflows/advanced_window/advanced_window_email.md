...
| **SMTP Config**         | Choose a preconfigured SMTP server to use when sending the email. This also defines who the email will show as being sent from. For more information, see [Email Alert](/versioned_docs/dataclassification_5.6.2/ndc/workflows/actions/workflows_email.md) section. |
