...
__NOTE:__ Ensure the Hub's requirements are met and that the server has had any OS updates applied and has been restarted. See the [Hub Installation for Windows](/versioned_docs/changetracker_8.0/changetracker/requirements/windowsserver.md) topic for additional information.
