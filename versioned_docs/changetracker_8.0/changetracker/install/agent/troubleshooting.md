...
If you experience problem with the Express Agent then please sent the express agent log files found in ```/var/nnt/expressagent``` to [Netwrix Support](https://www.netwrix.com/support.html).
