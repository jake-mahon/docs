...
This page lists the platforms and use cases that Netwrix has verified. However, the Express Agent may work on other platforms that have gcc (4.8+) compiler available.
...
__NOTE:__ Support for CentOS 7, RHEL 7, Fedora 39 and Oracle Linux 7 is only possible with v7.1.4 of the agent, later versions are not supported on these legacy OS releases.
