...
![Software Requirements](/img/versioned_docs/changetracker_8.0/changetracker/requirements/performancecheckbox.png)
...
- See the [Installation](/versioned_docs/changetracker_8.0/changetracker/install/overview.md) topic for additional information on the installation process.
