...
![PolicyTemplateRegistry](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/policytemplateregistry.png)
...
Use the __Advanced Options__ to create and edit new Definitions. See the[Registry Inclusion/Exclusion Match Rules ](/versioned_docs/changetracker_8.0/changetracker/admin/matchrules/registryrules.md) topic for additional information.

![PolicyTemplateRegistryExclude](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/policytemplateregistryexclude.png)
