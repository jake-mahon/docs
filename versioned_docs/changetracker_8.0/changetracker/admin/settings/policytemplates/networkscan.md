...
![NetworkScan](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/networkscan.png)
...
![EditNetwork](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/editnetwork.png)
...
![EditNetworkCredentialName](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/editnetworkcredentialname.png)
...
![page_guide_53](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/page_guide_53.png)

**Step 3 –** Once the initial poll has completed the duration will be required as a communications
Event.

![page_guide_54](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/page_guide_54.png)
...
![EventDetailsNetwork](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/policytemplates/eventdetailsnetwork.png)
