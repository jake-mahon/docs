...
File change events can be viewed from the [Events Tab](/versioned_docs/changetracker_8.0/changetracker/admin/tabs/events.md). See the [Dashboard Tab](/versioned_docs/changetracker_8.0/changetracker/admin/tabs/dashboardoverview.md) topic for additional information on how to view FIM change events.
