...
![PlannedChangesTab](/img/versioned_docs/changetracker_8.0/changetracker/admin/tabs/plannedchangestab.png)

For more detail on Planned Change Schedule and Rule setup, see the [Planned Changes Administration](/versioned_docs/changetracker_8.0/changetracker/admin/tabs/plannedchangeadministration.md) topic for additional information.
