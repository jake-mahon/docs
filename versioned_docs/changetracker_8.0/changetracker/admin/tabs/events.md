...
__Step 4 –__ The __Query/Report__ button can be used to specify events to include in a scheduled report or re-useable query for users. See the [Reports Tab](/versioned_docs/changetracker_8.0/changetracker/admin/tabs/reportstab.md) topic for additional information.
