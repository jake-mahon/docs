...
![Credential based resource Activities tab](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/tab/policycredentials/activitiestabcredentials.png)
