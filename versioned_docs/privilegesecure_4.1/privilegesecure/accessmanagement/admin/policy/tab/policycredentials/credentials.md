...
![Credential based policy credential tab](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/tab/policycredentials/accesspolicycredentialstab.png)

The Credentials table has the following features:

- Add — Opens the Add Credentials window. See the [Add Credentials Window](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/window/accesspolicy/addcredentials.md) topic for additional information.
