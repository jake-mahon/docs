...
The URLs tab for Microsoft Entra ID (formerly Azure AD) shows information about the URLs associated to the selected resource.

![URLs Tab for Azure AD](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/tab/resources/urlsazuread.png)

The URLs tab has the following features:

- Add — Opens the Add Website URL window. See the [Add Website URL Window](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/window/resources/addwebsiteurl.md) topic for additional information.
