...
__Step 4 –__ Click Save to create the new activity group.

__Step 5 –__ With the new activity group selected, configure the following settings:

- Add activities to the activity group. See the [Add Activities Window](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/window/activities/addactivities.md) topic for additional information.
