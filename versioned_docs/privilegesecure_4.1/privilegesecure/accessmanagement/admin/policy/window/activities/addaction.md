...
![addactionwindow](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/actions/addactionwindow.png)
...
See the [Action Types](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/activityactiontypes.md) section for detailed descriptions of the fields.
