...
The SAML Configuration wizard is opened with the __Configuration Wizard__ button in the Configuration > [Authentication Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/page/authentication.md) for an SAML Authentication Connector Type.
...
![SAML Configuration wizard, Test Login page](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigtestlogin.png)
...
![SAML Configuration Wizard, Retrieved Data](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigidmapping.png)
...
![SAML Configuration wizard, Map Id](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigidmapping2.png)
...
![SAML Configuration wizard, Test Logout page](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigtestlogout.png)
...
![SAML Configuration updating connector settings](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigupdateconnector.png)
