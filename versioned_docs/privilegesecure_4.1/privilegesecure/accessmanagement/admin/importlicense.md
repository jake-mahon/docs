...
![Dashboard interface showing an expiration banner and pointint to the User Options menu with the About page](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/expirationbanner.png)
...
![About page showing trial license details](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/triallicensedetails.png)
...
![About page showing successful upload of a license](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/licenseimportsuccess.png)

A message indicates the license file uploaded successfully. The license information displays at the top of the page, and the expiration banner disappears from the top. See the [About Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/aboutpage.md) topic for additional details available on this page.
