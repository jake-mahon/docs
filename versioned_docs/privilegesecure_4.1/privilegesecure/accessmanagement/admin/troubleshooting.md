...
The Toolkit is available to download as a .zip file from the Privilege Secure installer's Extras folder. See the [Install Components & Methods](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/install/components.md) topic for additional information.
...
__Step 6 –__ Paste this thumbprint in the Certificate Thumbprint field of the Netwrix Privilege Secure console.
