...
__Step 1 –__ In the browser extension interface, select either the __Activities__ or __Current__ tab.

__Step 2 –__ Click a __Resource__ to expand it and show associated Activities.

__Step 3 –__ Click an __Activity__ in the list to start an Activity Session.

![Browser Extension Activity Session](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/browserextension/browserextensionactivitysession.png)
...
![Browser Extension Starting a Web Session](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/browserextension/browserextensionstartsession.png)
