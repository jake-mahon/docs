...
![IIS installation](/img/versioned_docs/passwordsecure_9.1/passwordsecure/installation/installation_web_application/installation-webclient-3-en.png)
...
![IIS-creating page](/img/versioned_docs/passwordsecure_9.1/passwordsecure/installation/installation_web_application/installation-webclient-4-en.png)
...
![IIS](/img/versioned_docs/passwordsecure_9.1/passwordsecure/installation/installation_web_application/installation-webclient-5-en.png)

Select the https entry and open it for editing. The SSL certificate is then selected here.

![IIS](/img/versioned_docs/passwordsecure_9.1/passwordsecure/installation/installation_web_application/installation-webclient-6-en.png)
