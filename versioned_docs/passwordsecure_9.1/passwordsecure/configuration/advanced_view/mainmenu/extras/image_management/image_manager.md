...
![Icon/logos in NPS](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/advanced_view/mainmenu/extras/image_management/installation_with_parameters_106-en.png)
...
In the main menu in [Extras](/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/advanced_view/mainmenu/extras/extras.md) you can find the image management. Here, you have the possibility to store icons and logos manually.

![Image management](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/advanced_view/mainmenu/extras/image_management/installation_with_parameters_107-en.png)

Click on the + symbol to open the mask for creating images.

![add image](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/advanced_view/mainmenu/extras/image_management/installation_with_parameters_108-en.png)
...
- ![icon_open_folder](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/advanced_view/mainmenu/extras/image_management/icon_open_folder.png) This symbol can be used to upload locally saved icons and logos.
