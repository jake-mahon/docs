...
![License settings](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/main_menu/installation_with_parameters_262-en.png)

## Licenses

__CAUTION:__ Version 7 licenses cannot be used for Netwrix Password Secure Version 8. “Please contact us”: http: //www.passwordsafe.de to obtain a version 8 license.
...
5. Click Upload license file.
   ...
   ![license_file_tab](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/main_menu/license_file_tab.png)
6. Select the file from this email and then click Open.

   ![activated_license](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/main_menu/activated_license.png)
