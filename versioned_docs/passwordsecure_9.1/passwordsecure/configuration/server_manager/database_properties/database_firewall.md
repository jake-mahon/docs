...
![database firewall](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/installation_with_parameters_226-en.png)

Access to the firewall is blocked after it has been activated. Login attempts are directly blocked.

![installation_with_parameters_227](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/installation_with_parameters_227.png)

#### Firewall rules

The rules already set are displayed in the section on the right. The icons ![+](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/+.png) and ![-](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/-.png) can be used to add or also delete rules. Rules can be edited by double clicking on them.

![firewall rule](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/installation_with_parameters_230-en.png)
...
![defined firewall rules](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/database_properties/installation_with_parameters_231-en.png)
