...
The __Web Application__ is based both optically and also in its operation on the Netwrix Password Secure client. As usual, users can only access the data for which they also have permissions. The installation is described in the section [Installation Web Application](/versioned_docs/passwordsecure_9.1/passwordsecure/installation/installation_web_application/installation_web_application.md)
