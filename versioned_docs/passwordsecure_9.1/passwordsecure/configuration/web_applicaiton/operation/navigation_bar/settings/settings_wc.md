...
![image management](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/web_applicaiton/operation/navigation_bar/settings/installation_with_parameters_179-en.png)
...
![save new image](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/web_applicaiton/operation/navigation_bar/settings/installation_with_parameters_181-en.png)

Edit / Delete icons and logos

If an icon and/or logo is outdated, you can edit or even delete the stored icons/logos.

![manage image](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/web_applicaiton/operation/navigation_bar/settings/installation_with_parameters_182-en.png)
