...
![downloadextension](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/downloadextension.png)
...
![getextension](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/getextension.png)

Step 3 – After confirming a security question, it is installed, and an icon appears in the menu bar
to "add the extension".

![addextension](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/addextension.png)
...
![extensionadded](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/extensionadded.png)
...
![nodatabaseprofile](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/nodatabaseprofile.png)
