...
![selectou](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/selectou.png)

- Choose a permission template to define who else can see your password.

![permissionstemplate](/img/versioned_docs/passwordsecure_9.1/passwordsecure/enduser/permissionstemplate.png)

- Set a description for your stored password.

![description](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/servicenow/description.png)
...
![websiteurl](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/websiteurl.png)
