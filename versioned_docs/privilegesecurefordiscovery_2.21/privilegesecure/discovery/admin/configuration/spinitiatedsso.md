...
This article explains how to configure SP Initiated flow for Privilege Secure. SSO configuration now includes a setting for changing to an SP initiated flow. This is available under the server configuration:
