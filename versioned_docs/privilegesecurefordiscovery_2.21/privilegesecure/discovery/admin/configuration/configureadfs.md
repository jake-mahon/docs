...
- On the “Identifiers” section, add Identifier to match the URL of your website (Ex: `https://s1.<company>.com`)
...
- On the “Endpoints” tab, create a SAML POST binding pointing towards the login URL (Ex: `https://s1.<company>.com/api/login`)
...
If you are using ADFS as an authentication source and receive a "SAML Assertion Not Yet Valid" while trying to log in, please see:  the ADFS configuration steps above
