...
See the
[Add a Certificate Authority to the Ubuntu Trusted Authorities Repository](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/admin/configuration/addcertificateauthority.md)
