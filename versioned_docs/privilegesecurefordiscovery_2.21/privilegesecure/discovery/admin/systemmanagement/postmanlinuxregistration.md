...
Linux registration
prerequisites: [Linux Registrations Prerequisites](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/linuxregistrationsprerequisites.md)
