...
![Screen_Shot_2019-04-19_at_1.13.51_PM.png](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/360021493614_screen_shot_2019-04-19_at_1.13.51_pm_293x206.png)
...
This service performs the baseline sync which takes place with Active Directory (AD).  An initial sync with AD has essentially 5 stages which are clearly visible in the `svc-ldap.log` file:
