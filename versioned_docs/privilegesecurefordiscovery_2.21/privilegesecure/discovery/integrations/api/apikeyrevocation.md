...
![Screen_Shot_2019-05-11_at_12.26.44_PM.png](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360022795274_screen_shot_2019-05-11_at_12.26.44_pm_671x61.png)
...
![Screen_Shot_2019-05-11_at_12.27.47_PM.png](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360022795274_screen_shot_2019-05-11_at_12.27.47_pm_515x76.png)

__NOTE:__ Despite the command using a DELETE route, the actual deletion of API keys is intentionally __not__ available via API routes.
