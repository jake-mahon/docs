...
The ___id__ value is the __unique Mongo ID__of the endpoint to be used in the following query:
...
Take the __unique Mongo ID__ of the User or Group identified above, and add this to the ___id__ "Value" field.  Once both the __endpoint Mongo ID__ is in the Post line and the User/Group Mongo ID is in the ___id__ "Value" field, select the blue "Send" button to submit the request.  Example full submission:
