...
![Delegation of Control wizard showing the Users or Groups page](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/troubleshooting/delegatecontrolwizarduser.png)

__Step 2 –__ Navigate to the Users or Groups page. Click __Add__. Enter the Active Directory service account. Click __Next__.

![Delegation of Control wizard showing the Tasks to Delegate page](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/troubleshooting/delegatecontrolwizardtask.png)
