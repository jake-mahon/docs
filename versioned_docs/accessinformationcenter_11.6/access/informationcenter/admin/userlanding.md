...
Administrators are the only ones with access to the Configuration interface through the __Configure Console__ link. The Manage Your Resources link is available if the logged in user is also assigned ownership of a resource. The Manage Your Access link is available if the Self-Service Access Requests workflow has been enabled.

### Security Team Role

Users granted the Security Team role are directed to the Home page upon login.

![Home page for Security Team role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homesecurityteam.png)
...
![Home page for Reader role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homereader.png)
...
![Home page for Data Privacy role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homedataprivacy.png)
...
![Home page for User Access Administrator role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeuseraccessadmin.png)
...
![Home page for Resource Owner with no assigned role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeresourceowner.png)
...
![Home page for user with no User Role or Resource Ownership](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeyouraccess.png)
