...
It is necessary for Netwrix Enterprise Auditor and the Access Information Center to have compatible versions. Therefore, when the Netwrix Enterprise Auditor core application and corresponding solutions have been upgraded, the Access Information Center must also be upgraded.

To upgrade the Access Information Center application to a newer version, simply run the new ```AccessInformationCenter.msi``` executable. You do not need to uninstall the existing version. See the [Install the Access Information Center](/versioned_docs/accessinformationcenter_11.6/access/informationcenter/installation/install.md) topic for additional information.
