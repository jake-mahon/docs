...
In order to view populated Content reports, it is necessary to enable the __Store discovered sensitive data__ option within Enterprise Auditor. This is a setting configured within the solutions’ collection query:
