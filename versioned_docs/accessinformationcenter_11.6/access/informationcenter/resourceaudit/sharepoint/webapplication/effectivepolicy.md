...
To view the granular rights granted through SharePoint permission levels (SharePoint Roles), see the __Roles__ column in the [Permissions Report](/versioned_docs/accessinformationcenter_11.6/access/informationcenter/resourceaudit/sharepoint/sitecollections/permissions.md). For additional detail on what permissions each SharePoint Role grants, see the __Permission Mask__ column in the [Site Collection Roles Report](/versioned_docs/accessinformationcenter_11.6/access/informationcenter/resourceaudit/sharepoint/sitecollections/sitecollectionroles.md).
