...
Using this API you can get Scheduler Service logs. See the [Scheduler Service](/versioned_docs/groupid_11.0/groupid/admincenter/service/schedulerservice.md)topic for additional information on Scheduler service.
