...
When the [Preparation Tool](/versioned_docs/groupid_11.0/groupid/install/installer/preparationtool.md) runs, it installs the following software and Windows features:

| Software | Comments |
| --- | --- |
| __Required by all modules of GroupID__ |  |
