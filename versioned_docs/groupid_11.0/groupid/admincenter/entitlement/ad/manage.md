...
- **RC Status**: Displays the replication status for the server with respect to the replication
  performed by the GroupID Entitlement schedule. Different statuses are:
    ...
    - **Request
      ![rc_request](/img/versioned_docs/groupid_11.0/groupid/admincenter/entitlement/ad/rc_request.png):**
      permission data for the file server has never been replicated to Elasticsearch.
    - **Success
      ![rc_success](/img/versioned_docs/groupid_11.0/groupid/admincenter/entitlement/ad/rc_success.png):**
      permission data for the file server was successfully replicated when the GroupID Entitlement
      schedule last ran.
    - **Fail
      ![rc_fail](/img/versioned_docs/groupid_11.0/groupid/admincenter/entitlement/ad/rc_fail.png):**
      replication failed for the server due to an error.
    - **Running
      ![rc_running](/img/versioned_docs/groupid_11.0/groupid/admincenter/entitlement/ad/rc_running.png):**
