...
2. The __Helpdesk__ page opens to the __Helpdesk Operations__ tab. It lists all users from all identity stores in GroupID (notice that _All_ is displayed in the __Identity store__ box).
