...
6. The __Name Preview__ box displays the schedule name prefixed with _OrphanGroupUpdater\__; the schedule is displayed with this name in email notifications.
