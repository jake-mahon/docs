...
The search box is displayed at the top. Use it to perform a quick search and directly navigate to different pages of the application. You can search for GroupID settings and configurations, and directly navigate to your required pages.
...
1. In Admin Center, enter a search string in the Search box at the top of the page.  
   ...
   ![quick_search](/img/versioned_docs/groupid_11.0/groupid/admincenter/general/quick_search.png)
