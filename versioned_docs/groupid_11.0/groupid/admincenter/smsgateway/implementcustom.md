...
You can integrate with additional SMS gateways using the Custom Gateway API. After creating a gateway, you can add an account for it. See the [Create an SMS Gateway Account](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/manage.md#Create-an-SMS-Gateway-Account) topic.
...
1. Define a class that implements the __ISMSGateway interface__ which is defined in the __Imanami.PublicInterfaces__ namespace (_Imanami.PublicInterfaces.dll_).
   ...
   The DLLs for both the namespaces are available at the GroupID installation directory. A list of __ISMSGateway members__ that you must implement are discussed in
   the following table:

   | Member | Description |
   | --- | --- |
   | [ISmsGateway.SendShortMessage](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/sendshortmessage.md) method | Takes as input the [ShortMessage class](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/shortmessage/class.md) object, which defines elements of the text message, sends messages to the target recipients, and returns the [SendSmsMessageResult class](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/sendsmsmessageresult/class.md) object, which contains  message delivery status and exception details |
   | [ISmsGateway.TestCredentials](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/testcredentials.md) method | Returns a boolean value indicating whether the credentials for communicating with the SMS gateway are valid. |
   | [ISmsGateway.TestConnection](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/testconnection.md) method | Returns a boolean value indicating whether the connection with the SMS gateway is established successfully. |
   | [ISmsGateway.TestProxy](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/testproxy.md) method | Returns a boolean value informing whether the given proxy setting are valid. |
   | [ISmsGateway.Clone](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/clone.md) method | Returns the member-wise clone of the ISMSGateway interface. |
   | [ISmsGateway.AccountId](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/accountid.md) property | Gets or sets the account ID for connecting to the SMS gateway. |
   | [ISmsGateway.Password](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/password.md) property | Gets or sets the password of the user name assigned by the SMS gateway provider. |
   | [ISmsGateway.Url](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/url.md) property | Gets or sets the URL that the SMS gateway provides for sending messages. |
   | [ISmsGateway.UserId](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/userid.md) property | Gets or sets the user name assigned to you by the SMS gateway provider. |
   | [ISmsGateway.ProxyHostName](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/proxyhostname.md) property | Gets or sets the host name of the proxy server. |
   | [ISmsGateway.ProxyPort](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/proxyport.md) property | Gets or sets the port number used by the proxy server. |
   | [ISmsGateway.ProxyUsername](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/proxyusername.md) property | Gets or set the user name for connecting to the proxy server. |
   | [ISmsGateway.ProxyPassword](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/proxypassword.md) property | Gets or sets the password of the user account that will be used for connecting to the proxy server. |
   | [ISmsGateway.ProxyDomain](/versioned_docs/groupid_11.0/groupid/admincenter/smsgateway/custom/proxydomain.md) property | Gets or sets the domain name or IP address of the proxy server. |
