...
2. On the __SMS Gateways__ page, do either of the following:
   ...
   - Click __Setup SMS Gateway__ - This button is displayed when no gateway account exists in GroupID.
   - Click __Create SMS Gateway__ - This button is displayed when one or more gateway accounts have been created in GroupID.
...
1. In Admin Center, click __SMS Gateway__ at the bottom of the left navigation pane.  
   The __SMS Gateways__ page is displayed with a list of the SMS gateway accounts that you have created.
2. Click __Test Connection__ for a gateway to test whether GroupID can successfully send text messages through it.
