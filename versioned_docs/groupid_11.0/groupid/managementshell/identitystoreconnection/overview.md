...
- [Connect-IdentityStore](/versioned_docs/groupid_11.0/groupid/managementshell/identitystoreconnection/connectidentitystore.md): connects to an identity store using the authentication mode mentioned.
- [Get-Token](/versioned_docs/groupid_11.0/groupid/managementshell/identitystoreconnection/gettoken.md): gets a token from the GroupID Security service.
