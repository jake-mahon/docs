...
The commandlet __Remove-Schedule__ removes a schedule (by its name or ID) from the identity store connected to the current instance of the Management Shell.
