...
The following command sets the __$Credentials__ environment variable to the credentials of the user, John Smith, which exists on the same domain you are logged-on to.
...
The following command shows how to use the __$Credentials__ environment variable with commandlets.
