...
- [My Requests](/versioned_docs/groupid_11.0/groupid/portal/request/myrequest.md) lists workflow
  requests that you have generated. It displays both pending and processed requests.
- [Request Inbox](/versioned_docs/groupid_11.0/groupid/portal/request/pending.md) lists the workflow
  requests for which you are the approver. You can view, approve, deny, or reroute these requests.
- [All Requests](/versioned_docs/groupid_11.0/groupid/portal/request/allrequest.md) lists all
