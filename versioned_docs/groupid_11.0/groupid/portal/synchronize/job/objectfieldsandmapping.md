...
4. The Global Script Editor allows the script author to extend the functionality of Synchronize by authoring scripts in Visual Basic .NET and Python. Before saving a script, the code must be verified by compiling the script. Click on __Edit Global Script,__and follow these steps:
   ...
   7. The toolbar displays various actions that you can perform on your script:
      ...
      | Icon | Description |
      | --- | --- |
      | ![undo](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/undo.jpg) | Reverses the last change. |
      | ![redo](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/redo.jpg) | Re-applies a change reversed using the Undo action. |
      | ![indent](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/indent.jpg) | Increases the indenting of the current text selection. |
      | ![outdent](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/outdent.jpg) | Decreases the indenting of the current text selection. |
      | ![comment](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/comment.jpg) | Comments the current text selection. |
      | ![uncomment](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/uncomment.jpg) | Uncomments the current text selection. |
      | ![uppercase](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/uppercase.jpg) | Converts the current text selection to uppercase. |
      | ![lowercase](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/lowercase.jpg) | Converts the current text selection to lowercase. |
      | ![darktheme](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/darktheme.jpg) | Switch the theme of the script editor to dark. |
      | ![lighttheme](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/lighttheme.jpg) | Switch the theme of the script editor to light. |
      | ![selectall](/img/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/selectall.jpg) | Selects all the text in the editor. |
   8. Click __Save__ to save the changes made to the script.
5. On the [Selected Fields for object types](/versioned_docs/groupid_11.0/groupid/portal/synchronize/job/selectedfield.md) type section, click __Add/Edit Fields__.
...
6. Use the __Map Field__ section to map the source and destination fields and to apply transformations:
   ...
   1. In the __Key__ column, select at least one field to be a unique identifier.
      ...
      - __Apply a [Transform](/versioned_docs/groupid_11.0/groupid/portal/synchronize/transformation/overview.md)__
