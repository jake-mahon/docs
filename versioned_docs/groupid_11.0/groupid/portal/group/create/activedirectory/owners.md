...
- The __Owner__ box displays your name as the primary owner of the group.
  ...
  To change the primary owner, click __Browse__ next to the __Owner__ box to launch the [Find Dialog Box](/versioned_docs/groupid_11.0/groupid/portal/search/find.md), where you can search and select a primary owner.
