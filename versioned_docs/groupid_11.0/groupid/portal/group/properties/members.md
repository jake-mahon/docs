...
To add member(s) to the group, click __Add__. Enter a search string to locate the object to add as a member, or click __Advance__ to use the [Find Dialog Box](/versioned_docs/groupid_11.0/groupid/portal/search/find.md) for performing
a search.
