...
To modify the query, click the __Query Designer__ button. This launches the [Query Designer](/versioned_docs/groupid_11.0/groupid/portal/group/querydesigner/overview.md) dialog box, where you can modify the query.
