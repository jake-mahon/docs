...
3. On the [General page](/versioned_docs/groupid_11.0/groupid/portal/group/create/activedirectory/general.md), specify basic information about the Dynasty.
...
4. On the [Dynasty Options page (Managerial Dynasty)](/versioned_docs/groupid_11.0/groupid/portal/group/dynasty/dynastyoptionsmanagerial.md), specify a structure for the Dynasty and click __Next__.
   ...
   By default, GroupID constructs a managerial Dynasty structure by first creating a Smart Group for all direct reports of the selected top-level manager and then continues down the Dynasty structure, creating separate Smart Groups for the direct
...
5. The [Query Designer](/versioned_docs/groupid_11.0/groupid/portal/group/querydesigner/overview.md) page displays the default query that GroupID will use to determine the Dynasty membership. This query returns all users with Exchange mailboxes, along with users and contacts
