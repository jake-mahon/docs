...
When you create a Dynasty, you specify a query and a field, referred to as the _group-by_ field. The group-by field is used to divide the query results into groups.
...
Depending on the inheritance option selected for the parent Dynasty on the [Group properties - Dynasty Options tab](/versioned_docs/groupid_11.0/groupid/portal/group/properties/dynastyoptions.md) in group properties, the modified values of inherited attributes may or may not
persist.
