...
GroupID portal enables you to manage directory groups, that includes both static groups and Smart Groups. You can:
...
GroupID portal updates Smart Groups and Dynasties on the basis of user-defined queries. When directory information changes, GroupID portal automatically updates the appropriate groups, thus ensuring that groups are never out of date.

This allows administrators to easily maintain large groups without having to manually add and remove members.

NOTE: You must [Sign In](/versioned_docs/groupid_11.0/groupid/portal/login.md#Sign-In) before using it for group management.
