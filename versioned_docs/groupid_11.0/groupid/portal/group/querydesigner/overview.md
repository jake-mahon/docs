...
- [Query Designer - Password Expiry Options tab](/versioned_docs/groupid_11.0/groupid/portal/group/querydesigner/passwordexpiryoptions.md)[Query Designer - Password Expiry Options tab](/versioned_docs/groupid_11.0/groupid/portal/group/querydesigner/passwordexpiryoptions.md) (only available for Smart Groups with a password expiry condition)
