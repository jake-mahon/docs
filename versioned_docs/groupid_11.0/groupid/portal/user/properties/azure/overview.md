...
You can view and manipulate the properties of directory objects (users and mailboxes) in Microsoft Entra ID, depending on the permissions the GroupID administrator has granted you.
...
- [Object properties - Email tab](/versioned_docs/groupid_11.0/groupid/portal/user/properties/activedirectory/email.md) (for mailbox only)
