...
2. On the __Account__ page, specify basic account info, such as the user's first name, last name, login ID and the UPN suffix.
3. On the __Password__ page, provide a password for the user account and set other password-specific options.
4. Use the __Directory Roles__ page to assign a role and role privileges to the user on the Microsoft Entra Admin Center portal.
