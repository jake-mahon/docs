...
Click any of the report template from the list to [Generate Reports](/versioned_docs/groupid_11.0/groupid/portal/report/generate.md).
...
| Owners and objects they own  Listed in [Group Reports](/versioned_docs/groupid_11.0/groupid/portal/report/group.md) category as well. | Provides a list of owners and their direct reports. |
...
| Users and contacts with a phone number  Listed in [Contact Reports](/versioned_docs/groupid_11.0/groupid/portal/report/contact.md) category as well. | Provides a phone list of accounts within an organization. |
