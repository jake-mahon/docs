...
![disabledsites](/img/versioned_docs/groupid_11.0/groupid/portal/entitlement/disabledsites.jpg)
...
GroupID Entitlement displays folders and files on which the user/group has the specific access type with respect to the specified permission(s).
