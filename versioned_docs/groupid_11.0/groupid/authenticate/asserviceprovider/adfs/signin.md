...
We configured the ADS FS provider with a GroupID client, that is the GroupID portal _Wizard_ in our example. For single sign-on using AD FS, we can choose any of the following ways:
...
1. Launch the ADF FS portal using the URL provided by your organization and sign in. The AD FS dashboard will be displayed.
2. From the __Sign in to one of the following sites__ list, select a relying party trust.  
   This list contains the relying party trusts configured with AD FS for single sign-on.
3. Click __Sign in__; you will be redirected to it. Authentication will not be required.
