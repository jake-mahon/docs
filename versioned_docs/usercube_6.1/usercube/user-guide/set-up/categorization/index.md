...
![Classification Schema](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_classifschema.webp)
...
![Correlation Schema](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_correlschema.webp)
...
>
> ![Example - Basic Users in Usercube](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_examplebasicuser.webp)
>
> For basic users, we have in the AD:
>
> ![Example - Basic Users in AD](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_examplebasicad.webp)
>
...
>
> ![Example - Basic Users in Usercube](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_exampleadminuser.webp)
>
> For administrators, we have in the AD:
>
> ![Example - Admin Users in AD](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_exampleadminad.webp)
>
> Thus our example could induce the following rules: | Classification Rules | Correlation Rules | |
...
![Categorization Schema](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/categorization/categorization_categschema.webp)
