...
All tabs contain a column ```Command``` only used at a later stage to [modify (massively) identity data](/versioned_docs/usercube_6.1/usercube/user-guide/maintain/identity-data-modification/mass-update/index.md).
