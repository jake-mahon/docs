...
When a same change is needed by a high number of users, then Usercube provides a UI workflow to perform this change for all selected identities simultaneously.
