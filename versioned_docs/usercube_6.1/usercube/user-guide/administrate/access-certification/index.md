...
Certification campaigns can be [configured with XML](/versioned_docs/usercube_6.1/usercube/integration-guide/governance/accesscertification/index.md) but the UI described in this guide can be enough on its own.
