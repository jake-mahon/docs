...
These entity type pages can be [configured via XML](/versioned_docs/usercube_6.1/usercube/integration-guide/ui/how-tos/index.md) to customize all displayed columns and available filters, especially the __Orphan__ filter that spots uncorrelated resources, and the __Owner / Resource Type__ column that shows the owner of each resource.
...
1. Get to the __Resource Reconciliation__ page, accessible from the corresponding section on the home page.
