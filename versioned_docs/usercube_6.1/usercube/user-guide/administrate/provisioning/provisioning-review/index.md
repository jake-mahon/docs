...
Provisioning review can also be triggered when a [fulfillment](/versioned_docs/usercube_6.1/usercube/introduction-guide/overview/identity-management/index.md) error occurs.
...
2. Follow the [manual assignment workflow](/versioned_docs/usercube_6.1/usercube/user-guide/administrate/manual-assignment-request/index.md) to make a change in one of their permissions, which involves provisioning review.
