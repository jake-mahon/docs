...
![Process of Change Management](/img/versioned_docs/usercube_6.1/usercube/user-guide/deploy/change-management/changemanagement_process.webp)
...
![Actors of Change Management](/img/versioned_docs/usercube_6.1/usercube/user-guide/deploy/change-management/changemanagement_actors.webp)
...
1. Identify the populations impacted by change. Below is an example of impacted populations that can
   vary enormously.
    ...
    ![Usual Populations](/img/versioned_docs/usercube_6.1/usercube/user-guide/deploy/change-management/changemanagement_populations.webp)
