...
4. Migrate the database
    ...
    2. Create a temporary folder accessible by the Usercube server. Example:
       `C:/UsercubeExamplePath/AppSettingsFolder`
...
5. Move File Locations
    ...
    1. Optional: If you don't want to locate the Temp and Work folders in the default location
       (example: C:/UsercubeExamplePath"), add the following arguments to the original
    ...
    3. Run the move files utility.
        ...
        certificate:`./Usercube-Upgrade-Files.exe --version "5.1.7" --migrate-agent --file-cert-file "certificateFile" --file-cert-password "certificatePassword"`or```
        ./Usercube-Upgrade-Files.exe --version "5.1.7" --migrate-agent --file-cert-thumbprint
...
9. Optional: Migrate the configuration (This allows new features to be taken into account.)
    ...
    3. Run the utility to migrate the configuration.  
       Example 1:`./Usercube-Upgrade-ConfigurationVersion.exe --version "5.1.7" --xml-path "C:/UsercubeExamplePath/ConfOld/" --output "C:/UsercubeExamplePath/Conf/" --appsettings-path "C:/UsercubeExamplePath/AppSettingsFolder/appsettings.agent.json"`Example
       2:``` ./Usercube-Upgrade-ConfigurationVersion.exe --version "5.1.7" --xml-path
...
4. Migrate the Database
    ...
    6. Start the database upgrade utility:  
       Example 1:`./Usercube-Upgrade-DatabaseVersion.exe --connection-string "data source=.;Database=Usercube;Integrated Security=SSPI;Min Pool Size=10;" --appsettings-path "C:/UsercubeExamplePath/AppSettingsFolder/appsettings.agent.json"`Example
       2:``` ./Usercube-Upgrade-DatabaseVersion.exe --connection-string "data
...
5. Move File Locations
    ...
    3. Run the move files utility.
        ...
        Example:``` ./Usercube-Upgrade-Files.exe --version "5.1.7"
...
5. Prepare appsettings migration
    ...
    5. Run the appsettings preparation tool to create a new files named "520.json" and "522.json"
       ...
       Example 1:``` ./Usercube-Prepare-UpgradeAppsettings.exe --version "5.1.7" --output-path
       "C:/UsercubeExamplePath/AppSettingsFolder"
