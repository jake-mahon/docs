...
This guide shows how to deploy the XML configuration, in order to build and use the Usercube application.
...
Deploy a local XML configuration by using the [```Deploy-Configuration``` executable](/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/deploy-configuration/index.md) and declaring at least:
...
4. Deploy the configuration by using the [```Deploy-Configuration``` executable](/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/deploy-configuration/index.md) and declaring at least:
