...
1. When working via the UI, start by [exporting UI configuration elements](/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/export-configuration/index.md).
