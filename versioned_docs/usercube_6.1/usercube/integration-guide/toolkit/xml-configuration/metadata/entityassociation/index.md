...
An entity association is used to model an association in Usercube's metadata. See the [example of a whole connector](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md) with its entity properties and associations.
