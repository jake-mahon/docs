...
| Identifier required     | **Type** String **Description** Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [reserved identifier](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/reservedidentifiers/index.md).        |
