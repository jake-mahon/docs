...
OpenIdClient declares an Open Id Connect clientId/secret to call the Usercube API.
...
The tool [Usercube-New-OpenIDSecret](/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/new-openidsecret/index.md) can be used to generate secrets and their hashes.
