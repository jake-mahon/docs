...
Profile defines a user profile linked to permissions in Usercube. Profiles work with Access Control Rule and Profile Rule to describe who can do what.
...
| Property | Details |
| --- | --- |
| DisplayName_L1   optional | __Type__    String   __Description__   Display name of the profile in language 1 (up to 16). |
