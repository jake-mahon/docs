...
In this example the homonym is linked to a [Control](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/index.md) and it will be applied for the [Binding](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/metadata/binding/index.md) included in the [Control](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/index.md) where the homonym is located. Read more about [how to configure homonym filters](/versioned_docs/usercube_6.1/usercube/integration-guide/workflows/workflowhomonym/index.md).
