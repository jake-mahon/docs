...
| TargetExpression   optional | __Type__    String   __Description__   Defines the C# expression used to classify the resources. [See more details on C# expressions](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/expressions/index.md). |
