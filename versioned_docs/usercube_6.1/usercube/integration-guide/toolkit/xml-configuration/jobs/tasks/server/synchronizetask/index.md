...
[prepare-synchronization](/versioned_docs/usercube_6.1/usercube/integration-guide/synchronization/upward-data-sync/index.md)
to insert the data into the Usercube database.

For more information on how the Synchronization works, see
[Sync Up](/versioned_docs/usercube_6.1/usercube/integration-guide/synchronization/upward-data-sync/index.md).
