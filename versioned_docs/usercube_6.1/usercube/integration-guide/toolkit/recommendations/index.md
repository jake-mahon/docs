...
[Visual Studio Code](https://code.visualstudio.com/) is the recommended editor for configuration. Its extensions can highly benefit the configuration experience. NETWRIX recommends the following extensions:
...
![Auto-complete](/img/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/recommendations/autocomplete.png)
...
Some folders in the XML configuration contain files that are generated by Usercube and that must not be modified manually:
...
- ___Connector.xml___ file containing the definition of the Connector, the EntityTypes,the EntityAssociations and their mappings.
- ___Administrator.xml___ file containing all the ACE for the administrator profile.
- ___Role Model.xml___ file containing the role model configuration.
- ___UI.xml___ file containing the User Interface configuration.
...
![Recommendation](/img/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/recommendations/recommendation.png)
