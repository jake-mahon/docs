...
Synchronizing means reading the data of the external file, output of the preparation step, and taking it to Usercube.
...
When at least one [synchronization threshold](/versioned_docs/usercube_6.1/usercube/integration-guide/synchronization/synchro-thresholds/index.md) is exceeded, the change list can be seen in the __Synchronization Changes__ tab, accessible from the job progress screen.
