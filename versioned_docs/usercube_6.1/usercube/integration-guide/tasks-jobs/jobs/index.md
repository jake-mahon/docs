...
- once manually, through the __Job Execution__ screen;
- once manually, using [```Usercube-Invoke-Job.exe```](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/jobs/index.md);
