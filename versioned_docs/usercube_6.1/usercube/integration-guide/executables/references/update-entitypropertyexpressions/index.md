...
| --resource-identity-property   optional | __Type__    String   __Description__ Property used to override the resource identity property set in [```SelectUserByIdentityQueryHandler```](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/metadata/settings/selectuserbyidentityqueryhandlersetting/index.md#selectuserbyidentityqueryhandler). |
|  |  |
| --- | --- |
