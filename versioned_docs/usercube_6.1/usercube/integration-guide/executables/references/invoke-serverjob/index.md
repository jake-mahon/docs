...
To know the task launch orders in job use the following exe: [Usercube-Get-JobSteps.exe](/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/get-jobsteps/index.md)
