...
![Schema - Export Process](/img/versioned_docs/usercube_6.1/usercube/integration-guide/executables/references/export-configuration/usercube-export-configuration.webp)
...
[See how to export a SaaS configuration](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/how-tos/export-configuration/index.md)
for the first time.
