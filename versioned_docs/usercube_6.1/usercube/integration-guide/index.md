...
A basic knowledge of Identity and Access Management (IAM) and more precisely of Identity and Governance Administration (IGA) is required to really understand, implement and use Usercube's features.

NETWRIX strongly recommends starting from the [Introduction Guide](/versioned_docs/usercube_6.1/usercube/introduction-guide/index.md) to fully benefit from the Integration Guide's content.
