...
This page is about [File/CSV](/versioned_docs/usercube_6.1/usercube/integration-guide/connectors/references-packages/csv/index.md).
...
This export copies the information found in a CSV file and transforms it into a new CSV file in the Usercube's format.
