...
![Package: Storage/SharePoint](/img/versioned_docs/usercube_6.1/usercube/integration-guide/connectors/references-connectors/sharepoint/packages_sharepoint_v603.png)
...
The following example scans the example.sharepoint.com SharePoint at the more detailed level (ListItem) with the account [account.example@usercube.com](mailto:account.example@usercube.com):
