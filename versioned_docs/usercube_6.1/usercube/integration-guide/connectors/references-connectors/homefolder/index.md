...
This page is about [Storage/Home Folders](/versioned_docs/usercube_6.1/usercube/integration-guide/connectors/references-packages/home-folders/index.md).
...
- an account with at least the special permission __Read__ on all home folders in order to be able to export them.
...
- a [CyberArk Vault](/versioned_docs/usercube_6.1/usercube/integration-guide/network-configuration/agent-configuration/cyberark-application-access-manager-credential-providers/index.md) able to store Home Folder's ```Login``` and ```Password```.
