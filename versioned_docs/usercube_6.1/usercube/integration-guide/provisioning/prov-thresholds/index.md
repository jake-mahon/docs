...
Distinct [thresholds are configurable for synchronization](/versioned_docs/usercube_6.1/usercube/integration-guide/synchronization/synchro-thresholds/index.md).
