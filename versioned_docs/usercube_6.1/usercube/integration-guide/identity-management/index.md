...
Identities in Usercube are mostly humans, both internal and external workers, but can also be applications, bots, service accounts, or anything.

Identities are stored in the database as [resources](/versioned_docs/usercube_6.1/usercube/integration-guide/resources/index.md), which helps with Usercube's internal mechanisms, for example to [modelize identities with entity types](/versioned_docs/usercube_6.1/usercube/integration-guide/entity-model/index.md).

Additional interesting parts of identity management are:

- the synchronization of identity changes through several repositories, for example both Usercube and the AD;
- the provisioning of identity properties directly to the connected systems, based on the computation of the [role model](/versioned_docs/usercube_6.1/usercube/integration-guide/role-model/index.md).
