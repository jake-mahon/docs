...
This topic shows how to import product translations into Usercube. A product translation means a translation of a Usercube's component, for example a button display message, not the translation of a configured component.

## JSON Translation File

The translations are given to Usercube in a JSON file, through the configuration deployment tool. This section first explains how to write the JSON file, then how to use it with the deployment tool.
...
A translation key is an identifier for a given translation: Usercube uses those keys to find the translation it needs in the interface.
...
For languages other than french and English (US), when you do not override a given translation, Usercube uses the English (US) one.
...
If you need to export the custom product translations of your languages, export your configuration as usual but add the --product-translation argument to your command line.
