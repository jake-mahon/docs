...
The __entity model__ is enhanced with __records__ to handle positions and movements of staff. Details can be found [here](/versioned_docs/usercube_6.1/usercube/integration-guide/identity-management/index.md#here).
