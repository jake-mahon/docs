...
| EncryptionCertificate   required | __Type__    [EncryptionCertificate]    __Description__ Settings to configure the encryption of specific files. |
...
The logs sent to AppInsights are configured through the [Logger properties](/versioned_docs/usercube_6.1/usercube/integration-guide/monitoring/index.md).
