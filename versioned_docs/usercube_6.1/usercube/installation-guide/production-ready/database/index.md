...
Please make sure that the [database requirements](/versioned_docs/usercube_6.1/usercube/installation-guide/requirements/database-requirements/index.md) are met before going further.
