...
Checklist Item 2:
[Install Dell CEE](/versioned_docs/activitymonitor_7.1/config/dellunity/installcee.md)
...
- See the [Validate Setup](/versioned_docs/activitymonitor_7.1/config/dellunity/validate.md) topic
  for instructions.
