...
The debug log is stored in ```/opt/CEEPack/emc_cee_svc.log``` file. To enable verbose logging set Debug and Verbose parameters under __Configuration__ to 255 and restart the CEE.
