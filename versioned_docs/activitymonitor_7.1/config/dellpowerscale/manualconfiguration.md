...
![settings](/img/versioned_docs/activitymonitor_7.1/config/dellpowerscale/settings.png)
...
__NOTE:__ To use the Activity Monitor with Enterprise Auditor for Activity Auditing (FSAC) scans, the name entered here must exactly match what is used for Enterprise Auditor as a target host.
