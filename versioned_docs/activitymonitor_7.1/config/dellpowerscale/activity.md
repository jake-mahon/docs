...
Checklist Item 2: [Install Dell CEE](/versioned_docs/activitymonitor_7.1/config/dellpowerscale/installcee.md)
...
Checklist Item 4: Configure Dell CEE to Forward Events to the Activity Agent. See the [Validate Setup](/versioned_docs/activitymonitor_7.1/config/dellpowerscale/validate.md) topic for additional information.
