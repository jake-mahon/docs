...
- Open Offenses – Number of ransomware offenses detected within QRadar from the file activity event data
  ...
  - The value for this card is a hyperlink to the [Ransomware Dashboard](/versioned_docs/activitymonitor_7.1/activitymonitor/siem/qradar/dashboard/ransomware.md).
