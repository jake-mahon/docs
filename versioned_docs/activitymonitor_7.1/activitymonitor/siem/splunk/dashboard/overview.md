...
![Overview Dashboard for Stealthbits Activivty Monitor App for Splunk](/img/versioned_docs/activitymonitor_7.1/activitymonitor/siem/splunk/dashboard/overviewdashboard.png)
