...
Current customers can log in to the Netwrix Customer Portal to download software binaries and license keys for purchased products. See the [Customer Portal Access](https://helpcenter.netwrix.com/bundle/NetwrixCustomerPortalAccess/page/Customer_Portal_Access.html) topic for information on how to register for a Customer Portal account. Navigate to the Netwrix Threat Prevention Download section for the 7.4. Download the Threat Prevention Agent binary.
...
![Update Agent Installer](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/updateagentinstaller.png)

__Step 2 –__ Navigate to the location of the latest AD Agent installation package. Select the installer and click __Open__.

![Confirmation Window](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/updateagentinstallerpopup.png)
