...
![pscp Command](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/screen1.png)
...
![Install Linux Agent RPM Package on the Linux server](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/screen2.png)
...
![Generate the Activity Monitor Agent Client Certificate](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/screen3.png)
...
Before deploying the Activity agent in a Linux environment, ensure all Prerequisites have been met. To effectively monitor activity on a Linux host, it is necessary to deploy an agent to the host. Follow the steps to deploy the agent to the Linux host. See the [Linux Agent Server Requirements](/versioned_docs/activitymonitor_7.1/activitymonitor/requirements/linuxagent.md) topic for additional information.
...
![Specify Agent Port](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/specifyagentport.png)

__Step 4 –__ Specify the port to be used for the agent. Click __Next__.

![Credentials to Connect to Server.](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/credentials.png)
...
![Server Properties](/img/versioned_docs/activitymonitor_7.1/activitymonitor/install/agent/properties.png)
