...
![Message Template window](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/outputs/window/syslogmessagetemplate.png)
...
- Splunk – Use this template for Splunk integration. See the Configure the [File Activity Monitor App for Splunk](/versioned_docs/activitymonitor_7.1/activitymonitor/siem/splunk/overview.md) topic for additional information.
