...
- License information – Identifies the organization associated with the license. See the [Install Application](/versioned_docs/activitymonitor_7.1/activitymonitor/install/application.md) topic for additional information.
- Trace Level – Creates Trace Logs to provide troubleshooting information. See the [Trace Logs](/versioned_docs/activitymonitor_7.1/activitymonitor/troubleshooting/tracelogs.md) topic for additional information.
