...
Prior to adding a Nutanix files host to the Activity Monitor, the prerequisites for the target environment must be met. See [Nutanix Activity Auditing Configuration](/versioned_docs/activitymonitor_7.1/config/nutanix/activity.md) for more information.
...
![nutanixnetworkadapter](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixnetworkadapter.png)

The agent registers the IP address of the network adapter in the Nutanix auditing configuration for activity delivery. Nutanix Files server connects to the agent using the TCP port 4501. See the [Network Tab](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/network.md) topic for additional information.
...
![Choose Agent](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addagent01.png)

__Step 2 –__ On the Choose Agent page, select the Agent to monitor the file server from the drop-down list. Click __Next__.

![Add Host](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addhost02.png)

__Step 3 –__ On the Add Host page, select the __Nutanix Files__ radio button and enter the file server name. Click __Next__.

![Nutanix Options](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_04.png)
...
![Configure Operations](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_05.png)

__Step 5 –__ On the Configure Operations page, select the File Operations and Directory Operations to be monitored.

Click __Next__.

![Configure Operations](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_06.png)
...
![Where to log the activity](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_07.png)
...
![File Output](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_08.png)
...
![Syslog Output](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_09.png)
...
![nutanixoptions_10](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_10.png)

The added Nutanix host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/output.md) topic for additional information.
