...
Prior to adding a Qumulo host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Qumulo Activity Auditing Configuration](/versioned_docs/activitymonitor_7.1/config/qumulo/activity.md) topic for additional information.
...
![addhostqumulo01](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addhostqumulo01.png)

__Step 3 –__ On the Add Host page, select the __Qumulo__ radio button and enter the file server name. Click __Next__.

![addhostqumulo02](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addhostqumulo02.png)
...
![nutanixoptions_07](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_07.png)
...
![addhostqumulo04](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addhostqumulo04.png)
...
![nutanixoptions_09](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/nutanixoptions_09.png)
...
![addhostqumulo06](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/add/addhostqumulo06.png)

The added Qumulo host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/output.md) topic for additional information.
...
- [Qumulo Tab](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/properties/qumulo.md)
