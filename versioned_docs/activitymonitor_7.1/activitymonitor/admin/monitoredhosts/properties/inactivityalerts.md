...
![inactivityalertstab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/properties/inactivityalertstab.png)
...
![Syslog Alerts Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/properties/syslogalertstab.png)
...
- Syslog message template – Click the ellipsis (…) to open the Syslog Message Template window. The following Syslog templates have been provided:
  ...
  - LogRhythm
  - McAfee
  - QRadar – Use this template for IBM QRadar integration. See the [Netwrix File Activity Monitor App for QRadar](/versioned_docs/activitymonitor_7.1/activitymonitor/siem/qradar/overview.md) topic for additional information.
  - Splunk – Use this template for Splunk integration. See the [File Activity Monitor App for Splunk](/versioned_docs/activitymonitor_7.1/activitymonitor/siem/splunk/overview.md) section for additional information.
...
![Email Alerts Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoredhosts/properties/emailalertstab.png)
