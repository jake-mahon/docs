...
![Search Query - Entra ID](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/searchquery.png)
...
![Search Query - General Filter](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/generalfilters.png)
...
![Search Query - User](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/userfilters.png)
...
![Search Query - Audit Events](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/auditeventsfilters.png)
...
![Search Query - Target Resource](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/targetresourcefilters.png)
...
![Search Query - Sign-in Events](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/signinevents.png)
...
![Search Query - Location](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/locationfilters.png)
