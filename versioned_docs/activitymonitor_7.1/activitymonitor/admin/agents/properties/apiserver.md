...
![API Server Tab for Agent Properties](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/apiservertab.png)
...
![Add or Edit API Client popup window](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/addoreditapiclient.png)
