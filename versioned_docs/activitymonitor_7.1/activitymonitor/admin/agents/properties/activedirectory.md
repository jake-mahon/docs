...
![Agent Properties - Active Directory Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/mainimage.png)
...
__Step 1 –__ Configure the File, Syslog, or Threat Manager outputs on the Monitored Domains Tab in the Activity Monitor Console. See the [Output for Monitored Domains](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/output.md) topic for additional information.
