...
![Archiving Tab for Agent Properties](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/archiving_tab.png)
...
![Popup window for Configure a network share on this computer option](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/agents/properties/archivingtabconfigure.png)
...
The options below the __Configure__ button are:
...
__NOTE:__ Linux agents move activity logs to a set local path. Remote storage can be mounted to use this path for archiving.
