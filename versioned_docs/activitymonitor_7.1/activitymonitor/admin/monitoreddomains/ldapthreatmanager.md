...
![Activity Monitor with SD Only](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/actiivtymonitordomainsdonly.png)

**Step 1 –** In the Activity Monitor, click on the **Monitored Domains** tab.

**Step 2 –** Select a domain and click **Edit**.

![LDAP Monitoring Configuration for Threat Manager](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/sdldapmonitoring.png)
