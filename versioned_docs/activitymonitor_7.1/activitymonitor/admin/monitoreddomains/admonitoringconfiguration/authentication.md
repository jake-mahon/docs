...
![AD Monitoring Configuration - Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/operationstab.png)
...
![AD Monitoring Configuration - Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/forgedpac.png)
...
![Host (From) Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostfrom.png)
...
![Host (To) Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostto.png)
...
![IP Addresses (From) Tab in the Authenticatoin Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesfrom.png)
...
![IP Addresses (To) Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesto.png)
...
![Operations Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/operationstab.png)
...
![Servers Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/serverstab.png)
...
![Users Tab in the Authentication Tab](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/userstab.png)
