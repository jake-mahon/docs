...
The REST-style API is exposed via TLS v1.2, with a self-signed certificate by default. The port is customizable, 4494 by default. The IP list can be used to restrict access to the port.
...
__Use a client library that is secure and fully implements the OAuth 2.0 protocol.__ The sample below shows just a piece of OAuth 2 interaction.
