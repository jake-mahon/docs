...
See the [Forest Page](Forest "Forest Page") topic for additional information.
...
* **Step 1 –** Prepare an isolated environment to restore the forest to.
  ...
  See the [Target Server Considerations](../../Requirements/TargetServer "Target Server Considerations") topic to understand the requirements for a target environment and target servers for restoring domain controllers.
...
![Add to Recovery Playbook wizard - Domain Controller page](../../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/Wizard/RecoveryPlaybook/DomainController.png "Add to Recovery Playbook wizard - Domain Controller page")
...
See the [Target Server and Operating System Requirements](../../Requirements/TargetServer#Target "Target Server and Operating System Requirements") topic for additional information.

**Step 5 –** Click **Next**.

![Add to Recovery Playbook wizard - Options page](../../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/Wizard/RecoveryPlaybook/Options.png "Add to Recovery Playbook wizard - Options page")
...
![Add to Recovery Playbook wizard - Confirm page](../../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/Wizard/RecoveryPlaybook/Confirm.png "Add to Recovery Playbook wizard - Confirm page")
...
![Recovery Playbook created on the Forest Page](../../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/Wizard/RecoveryPlaybook/RecoveryPlaybook.png "Recovery Playbook created on the Forest Page")
...
![Forest page showing a restored forest](../../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/Wizard/RecoveryPlaybook/ForestRecovered.png "Forest page showing a restored forest")
