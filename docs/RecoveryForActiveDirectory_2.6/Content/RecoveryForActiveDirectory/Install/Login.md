...
![Recovery Desktop Icon](../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/ActivityMonitor/Install/DesktopIcon.png "Recovery Desktop Icon")
...
**NOTE:** If the port number and web protocol was changed from default during the installation process, use the port and protocol configured from the install.
...
On [First Launch](FirstLaunch "First Launch") of the Recovery Console, the administrator must add users who can sign into the application and use it.
...
**Step 2 –** Enter your credentials in the Username and Password fields. The username must be in the following format:
...
![MFA at Login](../../../../../static/images/RecoveryForActiveDirectory_2.6/Content/Resources/Images/RecoveryForActiveDirectory/Console/LoginMFA.png "MFA at Login")

**Step 4 –** Launch the Authenticator app on your phone to get the verification code generated for the Recovery application account.
