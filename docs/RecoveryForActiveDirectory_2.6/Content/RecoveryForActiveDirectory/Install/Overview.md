...
* [Install the Application](Application "Install the Application")
* [Configuration Utility](ConfigurationUtility "Configuration Utility")
* [Install the RSAT Extension](../RSATExtension/Installation "Install the RSAT Extension")

Prior to installing, ensure that all prerequisites have been met, as described in the [Requirements](../Requirements/Overview "Requirements") topic.
...
See the [Licensing Page](../Admin/Configuration/Licensing "Licensing Page") topic
