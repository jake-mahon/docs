...
2. Open the **Profiles & Permission Sets** tab.
   ...
   ![](../Resources/Images/export_profile_ui.PNG)
...
7. Click **Download XLS**. The file *ProfileExport.xls* is created.
...
![](../../../../static/images/enus 2/Content/Resources/Images/export_profile_summary.png)

The **Profile** tabs contain all of the requested information for each profile.

![](../../../../static/images/enus 2/Content/Resources/Images/export_profile_profile.png)