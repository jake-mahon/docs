...
> **Export Objects**: exports objects, profiles and permissions, and users to an Excel file.
>
> **Environment Comparison**: enables you to compare objects in two different Salesforce instances (such as Sandbox and Production).
>
> **Permissions Comparison**: enables you to compare profile and permission sets.
>
> **Access Review Assistant**: enables you to easily search for an object, apply filters, and get exactly the information you need.
>
> **User Activity**: displays all activity for a specific user or all users. This tool is used before you can deactivate a user.
>
