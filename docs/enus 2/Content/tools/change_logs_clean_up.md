...
The **Change Logs Clean Up** tool enables you to schedule an automatic clean up of old Change Logs. Cleaning up these old logs helps keep your orgs efficient and organized.
...
1. Open **Netwrix Dashboard** > **Tools** > **Change Logs Clean Up**
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/change_logs_clean_up.png "Open the Change Logs Clean Up Tool")
2. Set up the schedule to run the tool:
   ...
   * **Time** specifies the time to run the Clean Up. Format is *hh*:*mm* *AM*/*PM*
   * **Months to Retain** specifies the number of months before a Change Log becomes a Clean Up candidate.
