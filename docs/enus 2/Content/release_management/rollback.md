...
> [Create the Rollback Record](#Create)
>
> [Execute and Validate the Rollback](#Execute)
...
2. Click **Rollback**
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/rollback_button.png "Rollback button is only available for Completed Deployment Records")
3. Click **Test Connection** to ensure your credentials are working. If your credentials are not correct, you can click on **Save Credentials** and edit.
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/rollback_selected.png "Rollback selected customizations")
...
5. Click **Rollback Selected Customizations**. The **Rollback Confirmation** is displayed.
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/rollback_confirmation.png "Rollback confirmation")
...
4. When the rollback is complete, click **Validate Rollback**.
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/rollback_validation.png "Validate the Rollback")
5. Open **Netwrix Dashboard** > **Reports** > **Release and Deployment** > **Rollback Logs**  
   You can use **Customize** to add the **Status** column to your report. Here is an example of a failed rollback [deployment log](deployment_logs).

   ![](../../../../static/images/enus 2/Content/Resources/Images/rollback_log.png "Review the Rollback log")
