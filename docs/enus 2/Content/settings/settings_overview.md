...
* **SP Credentials/Test Connection** sets up the credentials for the connected app. Required to run Scanners. Tests the connection to help troubleshoot connectivity issues.
