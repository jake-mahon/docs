...
![](../../../../static/images/enus 2/Content/Resources/Images/config_stats_overview.png "Configuration and Stats report")
...
> >
> > [Change Log Creation](#Change) (sandbox option)
>
> [Jira Configuration](#Jira "Jira Configuration")
>
...
This section displays the current status of the documentation Platform Governance for Salesforce has created for your account. The statistics included the total number of customization, and the various **junctions** created to track the relationships between customizations. **junctions** represent critical relationship information to help you determine if it is safe to delete or change something, and how it affects other items. Click **Download PDF** to export a copy of the report.

![Configuration and Stats - Documentation Stats](../../../../static/images/enus 2/Content/Resources/Images/config_doc_stats.png "Configuration and Stats - Documentation Stats")
...
![Configuration and Stats - Scanner Logs](../../../../static/images/enus 2/Content/Resources/Images/config_scanner_logs.png "Configuration and Stats - Scanner Logs")
...
![Configuration and Stas - Scanner Additional Information](../Resources/Images/config_scan_add_info.PNG "Configuration and Stas - Scanner Additional Information")

### Change Log Creation

If you are in a sandbox, you can control whether change logs are created. Due to Salesforce space limits on different [sandbox accounts](https://help.salesforce.com/articleView?id=data_sandbox_environments.htmandtype=5 "https://help.salesforce.com/articleView?id=data_sandbox_environments.htm&type=5"), you may want to disable change logs to save space.

![](../../../../static/images/enus 2/Content/Resources/Images/config_stats_enable_change_log.png "Control Change Log Creation in Sandbox")
...
* [Status Mapping](#JiraStatusMapping "Status Mapping")
* [Jira Field Mapping](../integrations/jira_field_map "Jira Field Mapping") (separate topic)
...
2. Open the **Orgs** Credentials tab.
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/orgs_credentials.png "Orgs Credentials")
3. Click **New** to enter new credentials. For existing credentials, you can click **Edit** to modify the credential, **Delete** to remove it, or the **credential name** to sync your credentials.

   ![](../../../../static/images/enus 2/Content/Resources/Images/orgs_credentials_new.png "New org credentials")
4. Click **Save**.