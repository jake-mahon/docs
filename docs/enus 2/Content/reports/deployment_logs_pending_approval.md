...
This built-in report is available from **Reports** > **Release and Deployment** > **Deployments pending approval**
...
>
> **Time Frame**: Select the **Date Field** to be used for the report, the **Range**, and adjust the **From** and **To** fields as needed. The default **Date Field** is **Deployment Date**, **Range** is **Custom** and **From/To** is blank. Date format is *dd/mm/yyyy*.
>
...
>
> **Change Request: Created Date**: The created date of the change request. Format is *dd/mm/yyyy*
>
...
![](../../../../static/images/enus 2/Content/Resources/Images/report_deploy_pend_approval.png)