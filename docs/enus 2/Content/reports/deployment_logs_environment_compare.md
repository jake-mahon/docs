...
This built-in report is available from **Reports** > **Release and Deployment** > **Environment Compare Logs**
...
>
> **Time Frame**: Select the **Date Field** to be used for the report, the **Range**, and adjust the **From** and **To** fields as needed. The default **Date Field** is **Completed Date**, **Range** is **Custom** and **From/To** is blank. Date format is *dd/mm/yyyy*.
>
...
>
> **Printable View**: Creates the file *report###.xls*.
>
> **Export Details**: Opens the **Export Report** options. Select the encoding and format (xls or csv) for the exported file. Click **Export** to generate the *report###* file. Click **Done** to return to the report.
>
...
>
> **Created Date**: Date of the environment compare. Format is *dd/mm/yyyy*

![](../../../../static/images/enus 2/Content/Resources/Images/report_deploy_env_compare.png "Environment Compare Log Report")

## Sample Environment Compare Log

Click on a **Log Name** link to open the log.

![](../../../../static/images/enus 2/Content/Resources/Images/deploy_compare_env_log.png "Example Environment Compare Log")