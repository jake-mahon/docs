...
This built-in report is available from **Reports** > **Release and Deployment** > **Deployments with Failures**
...
>
> **Start Date** ; The date and time of the deployment. Format is *dd/mm/yyyy hh:mm*
>
...
![](../../../../static/images/enus 2/Content/Resources/Images/report_deploy_failures.png "Deployment Log  Report with Failures")