...
![](../../../../static/images/enus 2/Content/Resources/Images/improvementtab.png)
...
5. Select fields to display:
   ...
   * **Clean Up Status**
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/createlist_view_for_cleanup.png)
...
8. Once your list view has been created, you can multi-select customizations for clean up by checking the box beside **Action**.
   ...
   ![](../../../../static/images/enus 2/Content/Resources/Images/multi_select_cleanup.png)
...
13. Click **Save**.
    ...
    ![](../../../../static/images/enus 2/Content/Resources/Images/flagging_mass_customizations.png)