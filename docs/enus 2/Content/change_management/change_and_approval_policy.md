...
1. **Detect the Change**: [Automated Scanner](../installing_strongpoint/setting_up_initial_scan) must be enabled forPlatform Governance for Salesforce to detect a change.
...
6. **Change Reporting and Resolution**: Platform Governance for Salesforce provides predefined [reports](change_management_reports "Open Change Management Reports topic") you can review as part of your regular Change Management Process.