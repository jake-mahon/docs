...
The **Compliant Changes** and **Unresolved Non-Compliant** reports are the primary reports for managing changes in your system. They display all changes in the system that are compliant and those that are not compliant. An additional report called **What Changed?** shows all changes that have happened.
