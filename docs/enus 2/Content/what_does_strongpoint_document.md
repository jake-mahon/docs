...
Platform Governance for Salesforce documents over 120 Salesforce metadata types. Metadata is organized into eight categories and 18 subcategories. Policies are set and applied at the subcategory level. Open [Documented Metadata Types](change_management/documented_metadata_types "Open Documented Metadata Types topic") for a complete list of Metadata sorted by **Type** and by **Category**.
...
![](../../../static/images/enus 2/Content/Resources/Images/metadata_categories.png "Metadata Categories documented by Strongpoint")