...
**NOTE:** For the latest SaaS versions, if you are using the administrator scaffolding the necessary permissions for the update are added to the administrator scaffolding and they will be taken into account the next time the configuration is deployed.

## General Upgrade Instructions for the Server with Integrated Agent

**Step 1 –** Download the `usercube-server-runtime` from the expected version from [[Netwrix Portal](https://www.netwrix.com/sign_in.html?rf=my_products.html "Netwrix Portal")](https://extranet.usercube.com/).
...
**Step 1 –** Download the `usercube-agent-runtime` from the expected version from [[Netwrix Portal](https://www.netwrix.com/sign_in.html?rf=my_products.html "Netwrix Portal")](https://extranet.usercube.com/).
