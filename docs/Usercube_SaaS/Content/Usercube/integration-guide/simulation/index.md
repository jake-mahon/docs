...
A simulation can also be created by the role mining tool for the automation of role assignments. See the [Perform Role Mining](../../user-guide/optimize/assignment-automation/role-mining/index "Perform Role Mining") topic for additional information.
