...
:::warning
These methods require an X.509 public key certificate (the same for the encrypted appsettings file and the tools).
:::
...
This file follows the exact same structure as the [Server Configuration](../index) files.
