...
```
{  
    "accessCertificationReview.recommendation.manuallyAuthorized": "",  
    "app.common.button.create.label": "",  
    "app.common.labels.whenCreated": ""  
}
```
...
To find these keys, go on [Netwrix Portal](https://www.netwrix.com/sign_in.html?rf=my_products.html "Netwrix Portal") , download the SDK of your product version and unzip the folder.
...
```
A translation file must be named: translation..json.
