...
Evaluate Policy is the core algorithm of the assignment policy. See the [Assignment Policy](../../role-model/role-model-rules/index "Assignment Policy") topic for additional information.
...
See the [Risk Management](../../governance/risks/index "Risk Management") topic for additional information.

## Overview

![Evaluate Policy Overview](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/evaluate-policy-1.png)
...
See the [Connectors](../../connectors/index "Connectors"), [Compute Role Model Task](../../toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index "ComputeRoleModelTask"), and [Jobs](../../tasks-jobs/jobs/index "Jobs") topics for additional information.
...
* Assignments updated by an automation rule. See the [Automation Rule](../../toolkit/xml-configuration/provisioning/automationrule/index "AutomationRule") topic for additional information.

To build the list, the algorithm first goes through composite role rules, single role rules, resource type rules, navigation rules, and applies them in that order. See the [Composite Role Rule](../../toolkit/xml-configuration/provisioning/compositerolerule/index "CompositeRoleRule"), [Single Role Rule](../../toolkit/xml-configuration/provisioning/singlerolerule/index "SingleRoleRule"), and [Resource Type](../../toolkit/xml-configuration/provisioning/resourcetype/index "Resource Type") topics for additional information. This takes care of automatic assignments. Every step influences the following one: single roles can be inferred from composite roles that have just been assigned by a reviewer or an automation rule for example.
...
Dimensions are really the basis of an assignment process. See the [Entitlement Management](../../../introduction-guide/overview/entitlement-management/index "Entitlement Management") topic for additional information.
...
![Computing Context For Input Resource](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/enforce-context.png)

Computing expected role assignments

Role assignments, on the other hand, are the outcome of the assignment process. See the [Entitlement Management](../../../introduction-guide/overview/entitlement-management/index "Entitlement Management") topic for additional information.
...
![Computing Expected Role Assignments](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/compute-expected-1.png)

Enforcing composite role rules

The first rules that are enforced are the composite role rules. See the [Composite Role Rule](../../toolkit/xml-configuration/provisioning/compositerolerule/index "CompositeRoleRule")topic for additional information.
...
Then automation rules are enforced on assigned composite roles. See the [Automation Rule](../../toolkit/xml-configuration/provisioning/automationrule/index "AutomationRule") topic for additional information.
...
Fulfillment is just the consequence of the role assignment process. See the [Entitlement Management](../../../introduction-guide/overview/entitlement-management/index "Entitlement Management") topic for additional information.
...
![Computing Expected Provisioning Assignments](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/compute-expected-2.png)
...
![Computing Expected Provisioning Assignments](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/compute-find-matching.png)
...
![Computing Expected Provisioning Assignments](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/correlation.png)
...
| 1—Non-conforming | The assignment is not supported by a rule.  Workflow State: Non-conforming |
...
| 3—Pre-existing | The assignment is not supported by a rule, and it existed before the production launch.  Workflow State: Pre-existing |
| 4—Requested | The assignment is requested via a workflow, but not yet added.  **NOTE:** Usually displayed in workflows' summaries.  Workflow State: Pending Approval - Requested |
| 5—Calculated - Missing Parameters | The assignment was done by a rule which does not specify at least one required parameter for the role.  Workflow State: Calculated - Missing Parameters |
| 8—Pending Approval | The assignment must be reviewed manually by a knowledgeable user.  Workflow State: Pending Approval |
...
| 16—Approved | The assignment has completed all approval steps.  Workflow State: Approved |
| 17—Declined | The assignment is explicitly declined during one of the approval steps. |
| 20—Cancellation | The assignment is inferred by a role that was declined.  Workflow State: Cancellation |
...
* **Redundant Assignments** displays `Approved` assigned roles and assigned resource types tagged as eligible to be turned into `Calculated`.
