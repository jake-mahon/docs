...
![Group Membership Schema](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/IndirectPermissionsADExample.png)
...
![Single Role Configuration Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/SRConf_5.2.1.png)

We will also create a test Composite Role to showcase indirect Composite Roles. We will name it `TestCRoleAB`:

![Composite Role Configuration](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/CRConf_5.2.1.png)
...
![Navigation Rule Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/NavRule_5.2.1.png)

And finally, we need to add Single Role Rules to link our two previously created Single Roles to the new Composite Role:

![Single Role Rule Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/SRRule_5.2.1.png)
...
![View Permissions Simplified](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ViewPermissionsSimplified_5.2.1.png)

To display Indirect Permissions, you need to switch over to the `Advanced view`. `TestRoleA` and `TestRoleB` should then appear:

![View Permissions Advanced](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ViewPermissionsAdvanced_5.2.1.png)
...
![AD Assigned Resource Navigations](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ADAssignedNavigations_5.2.1.png)
