...
A connection represents a link between a [Connector](../connector/index "Connector") and a connection package.
...
```
Details about these settings can be found in Identity Manager's [References: Connectors](../../../../connectors/references-connectors/index "References: Connectors").
...
| DisplayName\_L1 required | **Type**  String  **Description** Display name of the connection in language 1 (up to 16). |
...
A connection transformation is optional, but can be needed to adjust the Excel files, output of [Export Task](../../jobs/tasks/agent/exporttask/index "Export Task") from Excel export connections, before [Prepare Synchronization Task](../../jobs/tasks/agent/preparesynchronizationtask/index "Prepare Synchronization Task"). The following operations are possible:
