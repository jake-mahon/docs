...
```
In this example the homonym is linked to a control [Form](../../user-interface/form/index "Form") and it will be applied for the [Binding](../../metadata/binding/index) included in the Control where the homonym is located. Read more about how to configure [Workflow Homonym](../../../../workflows/workflowhomonym/index).
