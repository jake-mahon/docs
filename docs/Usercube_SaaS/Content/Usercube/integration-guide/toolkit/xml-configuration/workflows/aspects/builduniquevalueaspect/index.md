...
| Message\_L1 default value: | **Type**  String  **Description** Message in language 1 (up to 16) to be displayed when the value generation failed, i.e. when `IterationsCount` is exceeded. |
...
The comparison performed by these rules to check unicity can be configured in SQL instead of C# via the `SqlCheckExpression` property of the aspect. See the [Build Unique Value Aspect](# "Build Unique Value Aspect") topic for additional information.
...
![Schema: Unicity Check](../../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Aspects_unicityCheck.png)
