...
In this example, authentication has been set up using [End-User Authentication](../../../../../network-configuration/server-configuration/end-users-authentication/index). In that case, the login used by the end-user is in the form `DOMAIN/userName`.
