...
![Access Permissions](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Form_hideRoles_V603.png)

Adjust the request type

When `WorkflowRequestType` is set to `Self`, then the finalization step looks like:

![WorkflowRequestType = Self](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Form_requestTypeSelf_V603.png)

When `WorkflowRequestType` is set to `Helpdesk`, then the finalization step looks like:

![WorkflowRequestType = Helpdesk](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Form_requestTypeHelpdesk_V603.png)

Display records in a table

![RecordTable Example](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Form_recordTable_V603.png)
...
![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeAttachment.png)

* Attachment — represents a control for adding an attachment
* Auto — takes by default the type of the EntityType property

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeCheckbox.png)
* Checkbox — a boolean control which supports one of the two states

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeCombobox.png)
* Combobox — a dropdown which supports single selection

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeComboboxMultiSelection.png)
* ComboboxMultiSelection — a dropdown which supports multiple selection

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeDate.png)
* Date — Date control
* Hidden — Hides the input

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeImage.png)
...
* Inherited —Control to get the InputType of the associated display entity property (when nothing is specified in a Control of a Form, it's the default value).
  ...
  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypePicker.png)
* Picker — Opens a grid to select a resource

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeText.png)
* Text — Displays a single-line of text

  ![](../../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InputTypeTextArea.png)
