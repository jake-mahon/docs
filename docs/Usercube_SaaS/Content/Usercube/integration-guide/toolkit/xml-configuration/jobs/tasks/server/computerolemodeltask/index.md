...
This task applies all rules in the role model of all [Resource Type](../../../../provisioning/resourcetype/index "Resource Type") whose source entity types are specified as child elements of the task.
