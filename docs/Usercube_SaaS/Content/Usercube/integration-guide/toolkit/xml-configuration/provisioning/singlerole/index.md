...
Roles can be requested manually, or they can be configured to be assigned automatically via [Single Role Rule](../singlerolerule/index "Single Role Rule") depending on identities' attributes.
...
| D0 optional | Int64 | Value that will be set for the dimension 0 (up to 3V following the [Base32 Parameter Names](../../../parameter-names/index "Base32 Parameter Names")) for all users with the role. |
...
| R0 default value: false | Boolean | `true` to set the dimension 0 (up to 3V following the [Base32 Parameter Names](../../../parameter-names/index "Base32 Parameter Names")) as a required parameter when assigning the role. |
