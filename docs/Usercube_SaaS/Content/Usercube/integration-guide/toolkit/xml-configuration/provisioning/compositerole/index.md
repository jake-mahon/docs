...
Roles can be requested manually, or they can be configured to be assigned automatically via a [Composite Role Rule](../compositerolerule/index "Composite Role Rule").
