...
The tool [Usercube-New-OpenIDSecret](../../../../executables/references/new-openidsecret/index "Usercube-New-OpenIDSecret") can be used to generate secrets and their hashes.
...
| DisplayName\_L1 required | **Type**  String  **Description** Name that will be Displayed on the screen |
