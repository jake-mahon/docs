...
Deploy a local XML configuration by using the [Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index "Identity Manager-Deploy Configuration") executable and declaring at least:
...
1. Log in for configuration deployment/export with the [Usercube-Login](../../../executables/references/login/index) executable.
...
4. Deploy the configuration by using the [Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index "Identity Manager-Deploy Configuration") executable and declaring at least:
