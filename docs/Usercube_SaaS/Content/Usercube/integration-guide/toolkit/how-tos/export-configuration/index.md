...
See the [Usercube-Export-Configuration](../../../executables/references/export-configuration/index "Usercube-Export-Configuration") topic for additional information.

## Export the Configuration Locally

Export your configuration by using the [Usercube-Export-Configuration](../../../executables/references/export-configuration/index "Usercube-Export-Configuration") executable and declaring at least:
...
1. Log in for configuration deployment/export with the [Usercube-Login](../../../executables/references/login/index "Usercube-Login") executable.
...
2. Log in to the IDP to be redirected back to this screen:
   ...
   ![Usercube-Login.exe Success Screen](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Usercube-Login_Success_v602.png)
...
4. Export the configuration by using the [Usercube-Export-Configuration](../../../executables/references/export-configuration/index "Identity Manager-Export-Configuration") and declaring at least:
