...
It can create either a job for each connector and for each agent (see the [Create Connector Synchro Complete](../../../toolkit/xml-configuration/configuration/scaffoldings/jobs/createconnectorsynchrocomplete/index "Create Connector Synchro Complete") topic for additional information) or a job for all connectors for each agent (see the [Create Agent Synchro Complete](../../../toolkit/xml-configuration/configuration/scaffoldings/jobs/createagentsynchrocomplete/index "Create Agent Synchro Complete") topic for additional information).
...
```
See the [Prepare Synchronization Task](../../../toolkit/xml-configuration/jobs/tasks/agent/preparesynchronizationtask/index "PrepareSynchronizationTask") for additional information on the PrepareSynchronization task configuration.
...
```
The Synchronization Validation Task is not needed , since it is managed by the [Jobs](../../jobs/index) state machine.
