...
Identity Manager's calculations for entitlement assignments rely on heuristics, through identities' key properties called [Entitlement Management](../../../../introduction-guide/overview/entitlement-management/index).
...
![Records Origin - Three-Entity Model](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RecordsOrigin_firstModel.png)
...
> ```
>
> C#:user:return user.PersonalDatas.Where(personalData => personalData.Start  DateTime.Now).Select(personalData => personalData.FirstName + ' ' + personalData.LastName).FirstOrDefault();
>
> ```
>
> Now a more complex example: let's write a C# expression to compute users' departments based on their organization's display names, but also their employee identifiers in parenthesis:
>
> ```
>
> C#:user:return user.Positions.Where(position => position.Start  DateTime.Now).Select(position => position.Organization.DisplayName).FirstOrDefault() + " (" + user.PersonalDatas.Where(personalData => personalData.Start  DateTime.Now).Select(personalData => personalData.EmployeeId).FirstOrDefault() + ")";
>
> ```
...
>
> ![User Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RecordsOrigin_userExample.png)
>
> Over time, the three entities are as follows:
>
> ![Example - Timelines](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RecordsOrigin_timelines.png)
>
...
>
> ![Example - Contexts](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RecordsOrigin_contexts.png)
...
![Records Origin - Final Model](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RecordsOrigin_thirdModel.png)
...
This identity model can be implemented by configuring a [Context Rule](../../../toolkit/xml-configuration/provisioning/contextrule/index) and [Record Section](../../../toolkit/xml-configuration/provisioning/recordsection/index "RecordSection"):
