...
![Package: Ticket/ServiceNow](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Packages_servicenowticket_V603.png)
...
This section focuses on ServiceNow ticket creation for the fulfillment of resources that can't or shouldn't be performed with an existing fulfill. To learn about how to manage entities, see [ServiceNow](../servicenowentitymanagement/index "ServiceNow")Entity Management.
...
When the ticket is closed or canceled, Identity Manager updates the provisioning state of the resource accordingly. See the [Entitlement Assignment](../../../role-assignment/assignments-of-entitlements/index "Entitlement Assignment") topic for additional information.
