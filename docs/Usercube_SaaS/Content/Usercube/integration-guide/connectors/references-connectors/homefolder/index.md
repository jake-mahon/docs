...
![Package: Storage/Home Folders](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Packages_homefolders_V603.png)
...
This connector is meant to generate a CSV file, named `.csv`,to the [Application Settings](../../../network-configuration/agent-configuration/appsettings/index "Application Settings")Export Output folder, with the following columns:
