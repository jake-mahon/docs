...
See an example on how to register [For Microsoft Entra ID](azuread/index "Register for Microsoft Entra ID").
...
:::tip
The entity model is configured by entity type and entity association containing scalar and navigation properties. See the Entity Model
Entity Association
, and
Entity Type
...
![Menu Item - Connectors](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_entityTypes_V602.png)
