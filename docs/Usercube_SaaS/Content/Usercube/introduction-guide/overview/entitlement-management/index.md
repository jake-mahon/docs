...
![Role Catalog and Users](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_RoleCatalogUsers.png)
...
![Role Model](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_RoleModel.png)
...
![Single Roles](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/SingleRolesCatalog_schemaRole.png)
...
![Composite Roles](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_compositeRoles.png)
...
Just like identities, accounts are represented in Identity Manager by an [Identity Management](../identity-management/index "Identity Management") entity-relationship model. So Identity Manager manages entitlements as resources' attribute values.
...
![Provisioning Rules](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_provisioningRules.png)
...
![Assignment Rules](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_assignmentRules.png)
...
![Categorization Rules](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_categorizationRules.png)
...
![Dimensions - 1D](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_dimension1.png)

#### 1D

![Dimensions - 2D](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_dimension2.png)

#### 2D

![Dimensions - 3D](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Entitlements_dimension3.png)

## Next Steps

See the [Governance](../governance/index "Governance") topic for additional information.

## Learn More

Learn more on the [Role Model](../../../integration-guide/role-model/index "Role Model").

Learn how to [Create Roles in the Role Catalog](../../../user-guide/set-up/single-roles-catalog-creation/index "Create Roles in the Role Catalog").

Learn more on hoe to [Create a Composite Role](../../../user-guide/optimize/composite-role-creation/index "Create a Composite Role").

Learn more on [Role Assignment](../../../integration-guide/role-assignment/index "Role Assignment").

Learn more on [Create a Provisioning Rule](../../../user-guide/set-up/provisioning-rule-creation/index "Create a Provisioning Rule").

Learn more on [Automate Role Assignments](../../../user-guide/optimize/assignment-automation/automate-role-assignment/index "Automate Role Assignments") rules.

Learn more on the rules of [Categorize Resources](../../../user-guide/set-up/categorization/index "Categorize Resources").