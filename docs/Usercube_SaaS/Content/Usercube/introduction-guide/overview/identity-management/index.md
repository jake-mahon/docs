...
![Usercube's Repository](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Identities_repository.png)
...
![](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/quadratic-linear-complexity.png)
...
![Entity Type - Schema](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/EntityTypeCreation_schema.png)
...
While Identity Manager provides a predefined model that should fit most organizations, it can still be adjusted to your exact needs.
Thus, Identity Manager provides a customizable model to organize a company's data according to its IGA-related needs, which is also most reliable because it is kept up-to-date.
...
![Synchronization](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Overview_synchronization.png)
...
![Provisioning](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Overview_provisioning.png)
...
See the [Entitlement Management](../entitlement-management/index "Entitlement Management") topic for additional information.

## Next Steps

Let's learn about [Entitlement Management](../entitlement-management/index "Entitlement Management").

## Learn More

Learn more on [Identity Management](# "Identity Management").

See how to [Create the Workforce Repository](../../../user-guide/set-up/initial-identities-loading/index "Create the Workforce Repository").

Learn more on [Connectors](../../../integration-guide/connectors/index "Connectors").

See how to create a [Connect to a Managed System](../../../user-guide/set-up/connect-system/index).

Learn more on [Synchronization](../../../integration-guide/synchronization/index "Synchronization").

Learn more on [Workflows](../../../integration-guide/workflows/index "Workflows").