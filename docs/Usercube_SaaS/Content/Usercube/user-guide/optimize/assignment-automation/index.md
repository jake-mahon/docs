...
1. Automation of the creation of the role model, i.e. both roles and navigation rules that represent entitlements in the managed systems, through [Create Roles in Bulk](../../set-up/single-roles-catalog-creation/role-naming-rule-creation/index) based on resources' naming conventions in the managed systems.
2. Automation of entitlement assignment through assignment rules, which use identity criteria (called dimensions, like identities' department or work location, etc.) to decide what entitlements to assign automatically to identities. See the [Conforming Assignments](../../../integration-guide/role-assignment/conformingassignmentcomputation/index) topic for additional information.
3. Automation of the creation of said assignment rules through [Perform Role Mining](role-mining/index), based on existing data analysis.

![Automation Concept](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_schema.png)
...
* Delay can happen: on the day a worker joins an organization, they rely on a manual action to get all the entitlements required for them to start working. Even with roles aiming to help managers to understand actual entitlements, delay happens. See the[Create Roles in the Role Catalog](../../set-up/single-roles-catalog-creation/index) topic for additional information.Errors can happen: human mistakes are expected in role distribution, even though largely mitigated by the role
  review process and [Perform Access Certification](../../administrate/access-certification/index). See the [Reconcile a Role](../../administrate/non-conforming-assignment-review/role-reconciliation/index) topic for additional information.
...
![Optimal Cost Chart - Manual Assignments](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost_manual.png)
...
![Optimal Cost Chart - Automation Benefits](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost_automationBenefits.png)
...
![Optimal Cost Chart - Automation Limits](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost_automationLimits.png)
...
![Optimal Cost Chart](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost.png)
...
1. [Perform Role Mining](role-mining/index) to approach the automation wall.
   ...
   ![Optimal Cost Chart - Role Mining](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost_roleMining.png)
...
Enlarge the number of managed entitlements by tolerating errors:
   ...
   :::
2. [Generate Reports](../../administrate/reporting/index)and analyze them with tools like Power BI to assess the automation wall and identify improvement areas.
   ...
   >
   > ![Data Quality Example](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_dataQuality_ex.png)
   ...
   >
   > ![Data Quantity Example](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_dataQuality_ex2.png)
   ...
   >
   > ![Data Quality Example](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_dataQuality_ex3.png)
   ...
   >
   > ![Data Quality Example](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_dataQuality_ex4.png)
3. Improve data quality and quantity to move the automation wall.
   ...
   ![Optimal Cost Chart - Improved Data](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Automation_optimalCost_data.png)
   ...
   Moreover, focus must be directed on actual and correct entitlements, using Identity Manager's [Perform Access Certification](../../administrate/access-certification/index).
