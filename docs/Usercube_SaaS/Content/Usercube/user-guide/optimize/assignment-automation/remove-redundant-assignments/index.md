...
How to remove redundant assignments, i.e. manual assignments of roles and resource types that are assigned by a rule too. See the [Entitlement Assignment](../../../../integration-guide/role-assignment/assignments-of-entitlements/index "Entitlement Assignment") topic for additional information.

## Overview

Assignment rules can sometimes give to users an entitlement that they had already received manually. Hence, new assignment rules can imply redundancies between the entitlements assigned manually and approved, and those calculated by a rule and assigned automatically. See the [Automate Role Assignments](../automate-role-assignment/index "Automate Role Assignments") topic for additional information.
...
* When assigning an entitlement to a user manually, the start and end dates are specified explicitly unless the end date is locked. See the [Create a Role Manually](../../../set-up/single-roles-catalog-creation/role-manual-creation/index "Create a Role Manually") topic for additional information.
...
![Schema - Compute Role Model](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RedundantAssignments_exampleWithout.png)
...
![Schema - Redundant Assignment Analysis](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RedundantAssignments_exampleWith.png)
...
See the [Create Roles in the Role Catalog](../../../set-up/single-roles-catalog-creation/index "Create Roles in the Role Catalog"), [Automate Role Assignments](../automate-role-assignment/index "Automate Role Assignments"), and [Perform Role Mining](../role-mining/index "Perform Role Mining") topics for additional information.

## Remove Redundant Assignments

Remove redundant assignments by proceeding as follows:

![Home Page - Redundant Assignments](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_redundantAssignments_V602.png)

**Step 1 –** Click on **Redundant Assignments** on the home page in the **Administration** section.

![Redundant Assignments - Buttons](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RedundantAssignments_buttons_V602.png)
...
![Redundant Assignments - Report Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RedundantAssignments_reportExample_V602.png)
...
![Redundant Assignments - Result](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/RedundantAssignments_reportExampleVerif_V602.png)
