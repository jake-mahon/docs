...
1. On the home page, click on **Settings** in the **Configuration** section.
   ...
   ![Home Page - Configuration](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_settings_V523.png)
2. On the **Workforce** > **Data Model** page, click on the following icon to adjust the data model to your specific situation.

   ![Scan Data Model](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/iconScanDatamodel_V602.svg)

   ![Scan Data Model](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_scanDatamodel_V60.png)
   ...
   * Non-empty attributes are quantified (e.g. small, large, etc.) to be displayed in the UI's forms optimally (e.g. dropdown list, search tool, etc.).
   ...
   ![Scan Data Model - Result](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_scanDatamodel-result_V523.png)
...
4. Click on the Save icon at the top.
   ...
   ![Save Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/iconSave_V602.svg)
5. Click on the **Reload** button to apply the recent changes to the application.

   ![Reload Button](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Reload_V603.png)
...
1. Choose a test field and note its displaying mode.
   ...
   >
   > ![Scan Data Model - Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_scan-example_V523.png)
2. Navigate within Identity Manager to find a workflow using the test field. Observe the displaying mode in the UI.
   ...
   >
   > ![Scan Data Model - Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_scan-example2_V523.png)
   >
   > ![Scan Data Model - Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_scan-example3_V523.png)
