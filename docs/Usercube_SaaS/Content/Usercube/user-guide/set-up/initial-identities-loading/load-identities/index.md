...
![Template Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_templateExample_V602.png)
...
2. On the **Workforce** > **Data Upload** page, download the empty Excel template.
   ...
   ![Upload Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/iconDownload_V602.svg)
...
4. Fill said template with the data you collected.
   ...
   ![Template Recommendations](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_templateReco_V600.png)
...
5. Back on the **Workforce** > **Data Upload** page, upload the filled Excel file to the server in order to feed the data back to Identity Manager.
   ...
   ![Upload Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/iconUpload_V602.svg)
...
6. Click on **Verify and Synchronize** to check the file's consistency and import its data into Identity Manager.
   ...
   ![Verify and Synchronize](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_dataUpload-synchronize_V602.png)

   Now you are able to view users' pages in the directory.

   ![Directory - Users](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/InitialLoad_directoryUsers_V602.png)
