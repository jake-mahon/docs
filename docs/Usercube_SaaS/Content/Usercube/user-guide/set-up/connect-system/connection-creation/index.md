...
How to create a [Connection](../../../../integration-guide/toolkit/xml-configuration/connectors/connection/index "Connection") inside a [Connector](../../../../integration-guide/toolkit/xml-configuration/connectors/connector/index) and choose the appropriate package.

## Overview

A connection is the information that allows to connect to a managed system, which includes credentials and path.

There is a minimum of one connection per connector. In many cases, there is one connection to[Synchronize Data](../../synchronization/index)and one connection for [Provision](../../../administrate/provisioning/index).
...
See the [Create the Connector](../connector-declaration/index) and [Model the Data](../connector-modeling/index) topics for additional information.
...
1. Click on the addition button in the **Connections** frame on the connector's summary page.
   ...
   ![Add a New Connection](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Connection_newConnection_V602.png)
2. Fill in the connection information fields on the left, then select a package (AD, CSV, etc.) and fill the associated agent settings on the right.
   ...
   ![Connection Creation](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ConnectionCreation_connectionCreation_V602.png)
...
Each type of package needs its own settings, and secured options can be used to store sensitive connection information. See the [Connections](../../../../integration-guide/connectors/configuration-details/connections/index) topic for additional information.
...
1. click on **Check Connection** to ensure that Identity Manager can reach the managed system;
   ...
   ![Check Connection](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ConnectionCreation_checkConnection_V602.png)

   :::note
Some connectors have both incremental and complete setting modes. See the
   Jobs
   topic for additional information. They are relatively independent so they both need to be tested.
   :::
2. check that the connection appears in the **Connections** frame with the right options, and without the Failed icon.

![Decline Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/CertifCampaign_iconDecline_V522.svg)
...
![Schema Not Recovered](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Connection_notRecovered_V523.png)
