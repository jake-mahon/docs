...
How to define [Resource Classification Rule](../../../../integration-guide/toolkit/xml-configuration/provisioning/resourceclassificationrule/index) in order to classify remaining uncorrelated resources, assigning them resource types. See the [Create a Resource Type](../resource-type-creation/index) topic for additional information.

## Overview

### Classification purpose

Classification is the process of putting on an existing resource a label called resource type, to show its intent and/or purpose within the managed system. See the [Entitlement Management](../../../../introduction-guide/overview/entitlement-management/index) topic for additional information.
...
* on the **Provisioning Review** page when the owned resource is allowed by the role model, i.e. requested manually or assigned automatically by a resource type rule;
  ...
  ![Correlation Review - Provisioning Review Screen](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Categorization_reviewsProvisioningReview_V603.png)
* on the **Resource Reconciliation** page when the owned resource is not allowed by the role model, i.e. not requested manually nor assigned by a resource type rule. For example, the creation of a correlation rule without a resource type rule triggers unauthorized accounts on the **Resource Reconciliation** page.
  ...
  ![Correlation Review - Resource Reconciliation Screen](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Categorization_reviewsResourceReconciliation_V603.png)
...
| Input | Output |
| --- | --- |
| [Create a Resource Type](../resource-type-creation/index) (required) [Synchronize Data](../../synchronization/index) (required) [Correlate Resources](../correlation/index) (recommended) | Classification rules |
...
1. On the relevant resource type's page, click on **Classification Rules** and the addition icon.
   ...
   ![New Classification Rule](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ResourceType_newClassifRule_V602.png)
...
2. Fill in the fields.
   ...
   ![New Classification Rule Fields](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ResourceType_newClassifRuleFields_V602.png)

   * **Target Object** > `Expression`: C# expression based on the resource that needs to be classified.
   * `Confidence Rate`: rate expressing the rule's reliability, and its priority order..
   > Our overview example would look like:
   >
   > ![Classification Rule Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Classification_example_V602.png)
3. Click on **Create** and see a line added on the rules page.
4. On the connector dashboard and in the **Resource Types** frame, click on **Jobs** > **Classify Resource Types** to apply the new classification rules.
...
Simulations are available in order to anticipate the changes induced by a creation/modification/deletion in classification rules. See the [Perform a Simulation](../../../optimize/simulation/index) topic for additional information.
...
![Test Entity Type](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/EntityTypeCreation_test_V602.png)
...
![Owner / Resource Type Column](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Classification_test_V522.png)
...
![Unclassified Resource](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Classification_unclassified_V600.png)
