...
![Review Permissions](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Workflows_reviewPermissions_V601.png)

When a review is needed, a notification appears on the **MY TASKS** tab at the top.

![My Tasks Tab](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_topBar_V601.png)
...
1. On the home page, click on **Settings** in the **Configuration** section, then on **Workforce** > **Onboarding Workflows** in the left menu.
   ...
   ![Home - Settings](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_settings_V523.png)
2. For each workflow, choose whether a review step is required.

   ![Workflows Review Steps](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Workflows_reviewSteps_V601.png)
...
3. Configure the homonym detection.
   ...
   ![Workflows Homonym Detection](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Workflows_homonyms_V601.png)
...
3. Make sure that the homonym detection works in accordance with the specified options.
   ...
   >
   > ![Workflows Homonym Detection](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Workflows_verifyHomonyms_V601.png)
