...
![Synchronization Schema](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_schema.png)
...
1. Access the list of connectors by clicking on **Connectors** on the home page in the **Configuration** section.
   ...
   ![Home - Connectors](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_connectors_V602.png)
...
Notice that some connectors, depending on their connections and packages, can't be synchronized in incremental mode. As a consequence, when clicking on the Jobs button, you wouldn't have a choice between Complete and Incremental. See below this note.
   ...
   ![Synchronize Job (Only Complete)](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_executionJobs-complete_V602.png)
...
![Edit button](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_edit_V600.png)
...
You should first look for configuration validation, and only later validation of the actual data being synchronized.
   ...
   >
   > ![SAB Example - Home Page](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_exampleSAB_V522.png)
   >
   > Clicking on `SAB - Users` displays the list of all synchronized resources.
   >
   > ![SAB Example - Data List](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_exampleSAB2_V602.png)
   >
   > Clicking on any resource displays its detailed attributes, for example `Abbott Mark`:
   >
   > ![SAB Example - Resource Attributes](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_exampleSAB3_V602.png)
   >
...
![Test Entity Type](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_entityTypes_V602.png)
...
![Threshold warning](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_threshold_V603.png)
...
2. Study synchronization counters and the list of all synchronization changes. These tools help you make a decision about whether to bypass synchronization thresholds.
   ...
   ![Job progress](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_thresholdLog_V603.png)
...
Be cautious, check twice for mistakes before resuming.
   ...
   ![Resumed Job](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Synchro_thresholdResumed_V602.png)
...
* If you manually typed the source column of a property in the entity types, then make sure that the source column exists in the corresponding managed system.
  ...
  ![Source Column](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/EntityType_sourceColumn_V602.png)
...
![Property Format](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/EntityType_format_V523.png)
