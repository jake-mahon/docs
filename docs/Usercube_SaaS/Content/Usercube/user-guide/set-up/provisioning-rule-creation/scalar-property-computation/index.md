...
How to define scalar rules to compute and provision the values of scalar properties for target resources based on source resources. See the [Resource Type](../../../../integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index "Resource Type") topic for additional information.
...
![Schema - Scalar Rule](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvRules_schemaScalar.png)
...
The application of a scalar rule can depend on the assignment of a single role. See the [Create Roles in the Role Catalog](../../single-roles-catalog-creation/index "Create Roles in the Role Catalog") topic for additional information.
...
For example, consider the situation where we want the login  for users with the single role , and the login  for the others. In this case, we can write two distinct scalar rules where the first one has the role  as a criterion. This rule will be applied before the other.
...
See the [Categorize Resources](../../categorization/index "Categorize Resources") topic for additional information.
...
![](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/iconAdd_V602.png)

**Step 3 –** Click on the **Scalars** tab and on the addition button at the top right corner.

![Create Scalar Rule](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvRules_scalarRule_V522.png)

**Step 4 –** Fill in the fields.

![Scalar Rule Fields](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvRules_scalarRuleFields_V602.png)
...
![Scalar Rule Example](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvRules_exampleScalar_V522.png)
...
Simulations are available in order to anticipate the changes induced by a creation/modification/deletion in scalar rules. See the [Perform a Simulation](../../../optimize/simulation/index "Perform a Simulation") topic for additional information.
...
**Step 2 –** Review unreconciled properties on the **Resource Reconciliation** screen to help check scalar rules: if there are numerous properties to be reconciled following the same pattern, then there may be a rule that needs to be changed. See the [Reconcile a Property](../../../administrate/non-conforming-assignment-review/property-reconciliation/index) topic for additional information.
