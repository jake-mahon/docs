...
![Provisioning State Schema](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvManual_states_V523.png)
...
| Input | Output |
| --- | --- |
| [Review Provisioning](../provisioning-review/index) (required) Manual provisioning through [Create a Connection](../../../set-up/connect-system/connection-creation/index) (required) | Updated managed systems |
...
1. Ensure that the task to compute or generate provisioning orders was launched after the request (or the provisioning review, if any), through the complete job in the **Job Execution** page.
   ...
   ![Manual Provisioning Screen](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvManual_page_V603.png)
...
4. Creation, edition and deletion orders follow the same process: read Identity Manager's suggestions and create, edit or delete the appropriate resource directly in the managed system (outside Identity Manager).
   ...
   ![Creation Provisioning Order](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvManual_createResource_V522.png)

   ![Creation Provisioning Order](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvManual_editResource_V522.png)
...
![Bulk Provisioning](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvManual_bulk_V603.png)
...
2. Follow the workflow through [Request Entitlement Assignment](../../manual-assignment-request/index "Request Entitlement Assignment") to make a change in one of their permissions, which involves manual provisioning.
