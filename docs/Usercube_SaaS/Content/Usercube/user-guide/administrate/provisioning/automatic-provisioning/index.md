...
![Provisioning State Schema](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProvAuto_states_V523.png)
...
| Input | Output |
| --- | --- |
| [Review Provisioning](../provisioning-review/index) (required) Automated provisioning to [Create a Connection](../../../set-up/connect-system/connection-creation/index) (required) | Updated managed systems |
...
2. Follow the manual assignment workflow through [Request Entitlement Assignment](../../manual-assignment-request/index "Request Entitlement Assignment") to make a change in one of their permissions, which involves automated provisioning.
