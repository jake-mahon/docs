...
5. Click on the line of an account with an owner.
   ...
   ![Select Decision](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Unauth_reviewUnauthorized_V602.png)
...
The displayed confidence rate means that a rule actually assigned the account to the identity, but with a confidence rate too low to imply full automatic assignment. Approval will be required. See the
   ...
   ![Edit Button](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Unauth_updateProp_V522.png)
...
8. Trigger the [Provision](../../provisioning/index "Provision") by launching, on the appropriate connector's overview page, **Jobs** > **Generate Provisioning Orders**, then, after this first task is done, **Jobs** > **Fulfill**.
