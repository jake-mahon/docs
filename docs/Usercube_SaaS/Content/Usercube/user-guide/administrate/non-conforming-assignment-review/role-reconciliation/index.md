...
>
> ![Example - Role Reconciliation](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ReviewRole_exampleRole_V602.png)
>
> ![Example - Resource Reconciliation](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ReviewRole_exampleResource_V602.png)
>
> ![Example - Resource Reconciliation - Properties](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ReviewRole_exampleResourceProp_V602.png)
...
| Input | Output |
| --- | --- |
| [Provision](../../provisioning/index "Provision") (required) | Complying roles |
...
1. Ensure that the [Compute Role Model Task](../../../../integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index "Compute Role Model Task") was launched recently, through the complete job on the **Job Execution** page
   ...
   ![Home Page - Job Execution](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_jobExecution_V602.png)
...
2. On the home page, click on the entity type that you want to manage in the **Role Reconciliation** section, to get to the non-conforming permissions page.
   ...
   ![Home Page - Role Reconciliation](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_roleReconciliation_V523.png)

   ![Role Reconciliation Page](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ReviewRole_roleReconciliation_V603.png)

   Each non-conforming permission can be commented by clicking on the corresponding icon.

   ![Comment Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/CertifCampaign_iconComment_V522.svg)
...
Contrary to resources, reviewed roles are then displayed on the Role Review page accessible from the home page, and can be reviewed again.
   ...
   * Either click on the approval icon to keep the non-conforming permission.
   ...
   ![Approval Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Orphan_iconApprove_V602.svg)

   * Or click on the decline icon to delete the non-conforming permission.

   ![Decline Icon](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Orphan_iconDecline_V522.svg)
4. Trigger provisioning by launching, on the appropriate connector's overview page, **Jobs** > **Generate Provisioning Orders**, then, after this first task is done, **Jobs** > **Fulfill**. See the [Provision](../../provisioning/index "Provision") topic for additional information.
...
![Bulk Reconcile Roles](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ReviewRole_roleReconciliationBulk_V603.png)
