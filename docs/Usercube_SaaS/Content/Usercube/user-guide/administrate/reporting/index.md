...
* the list of all requests that you are authorized to see in **Workflow Overview** accessible from the home page in the **Administration** section;
  ...
  ![Home - Workflow Overview](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_workflowOverview_V602.png)
* the list of [Review Orphaned and Unused Accounts](../orphan-unused-account-review/index).

  ![Orphaned Account List](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Orphan_entityType_V523.png)
...
1. Click on **Reports** on the left of the home page to access the list of predefined reports.
   ...
   ![Home Page - Reports](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_reports_V602.png)

   ![Reports](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Reporting_predefinedReports_V602.png)
...
1. Click on **Query** in the **Administration** section on the home page.
   ...
   ![Home Page - Query](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Home_query_V602.png)

   ![Query Page](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Reporting_queryPage_V602.png)
...
3. Click on **Fields to Display** and select the appropriate fields from among the database [Universe](../../../integration-guide/toolkit/xml-configuration/business-intelligence/universe/index) and click on **Confirm**.
   ...
   ![Fields to Display](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Reporting_fieldsToDisplay_V522.png)
...
4. Click on **Filters**, write the appropriate condition and click on **Confirm**.
   ...
   ![Filters](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/Reporting_filters_V602.png)
