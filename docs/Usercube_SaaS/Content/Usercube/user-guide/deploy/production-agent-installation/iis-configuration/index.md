...
1. Open IIS and remove the default site and pool.
   ...
   ![IIS: Step 1](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_IIS1.png)
2. Right-click on **Application Pools** to add a new pool named `Usercube`.

   ![IIS: Step 2](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_IIS2.png)
3. Right-click on **Sites** to add a new site named `Usercube`, make sure that the selected application pool is `Usercube` and set the `path` field to the `Runtime` folder.
   ...
   ![IIS: Step 3](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_IIS3.png)
4. Right-click on the application pool to open its advanced settings and make sure that the following parameters are set as such:
   ...
   ![IIS: Step 4](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_IIS4.png)

   ![IIS: Step 5](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_IIS5.png)
...
If the certificate is not ready yet, generate an auto-signed certificate.
   ...
   ![IIS Server Certificate: Step 1](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_ServerCertificate1.png)
   ...
   ![IIS Server Certificate: Step 2](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_ServerCertificate2.png)
6. Add the certificate's URL to the site by right-clicking on the site, selecting **Edit Bindings** and clicking on **Add**, then choosing `https` as type, `443` as port, specifying the server's URL (without the `https` part) as host name, and finally selecting the server certificate.
   ...
   ![IIS Server Certificate: Step 3](../../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/ProdAgent_ServerCertificate3.png)
