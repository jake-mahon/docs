...
The recommended naming convention is `C:/Usercube`, where `` is the name of the organization targeted by this installation.
...
* `appsettings.*.json`: [Network Configuration](../../../integration-guide/network-configuration/index "Network Configuration").

## What's Next?

Next section shows how to install the Identity Manager Database. See the [Install the Database](../database/index "Install the Database")topic for additional information.