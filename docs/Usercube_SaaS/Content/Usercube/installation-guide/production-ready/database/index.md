...
The recommended naming convention is `Usercube`, where `` is the name of the organization targeted by this installation.

> **FAQ**: [How to create a database in SQL Server?](https://docs.microsoft.com/en-us/sql/relational-databases/databases/create-a-database?view=sql-server-ver15)
...
The database scheme can be initialized by running the `Usercube.sql` script (found in the `SQL_.zip` archive) on the newly created database.
...
![Execute Query](../../../../../../../static/images/Usercube_SaaS/Content/Resources/Images/execute_query.png)
...
It will also show how to test the Identity Manager Database connection. See the [Install the Server](../server/index "Install the Server") topic for additional information.