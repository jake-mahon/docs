...
![blobid0.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid0_379x236.webp)

**Step 2 –** Then click **Edit** to the left, on the ‘Globals’ line:

![blobid1.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid1_760x393.webp)
...
![blobid2.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid2.webp)
...
![blobid3.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid3.webp)

**Step 6 –** Click on **Body** and copy-and-paste the userId that is authorized on the API key
entered in the global Variables.

![blobid4.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid4.webp)

**NOTE:** The \{\{api_key\}\} will pull the value from the global variable.

**Step 7 –** Click on **Tests**.

![blobid5.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid5_657x168.webp)
...
![blobid6.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid6_313x113.webp)

__Step 10 –__ Click __Send__, you should see an output at the botton like the example below:

![blobid7.webp](/img/product_docs/privilegesecure/4.2/discovery/integrations/api/360047844814_blobid7_738x228.webp)
