...
![blobid0.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid0.webp)
...
![blobid1.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid1_423x423.webp)
...
![blobid2.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid2_131x148.webp)

![blobid3.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid3.webp)

![blobid4.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid4.webp)

### Setting the Base URL Environment Variable

To set the base_url variable needs to be set. Click the “eyeball” symbol:

![blobid5.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid5_96x82.webp)

The following screen will display. Click the Edit button:

![blobid6.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid6.webp)

Enter the **baseUrl** variable for your specific environment:

Note:  Older collections use **base_url**.

![mceclip1.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_mceclip1.webp)

Click Save and then exit out of the screen below:

![blobid8.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid8_612x415.webp)
...
![blobid9.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid9.webp)
...
![blobid10.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid10_144x49.webp)
...
![blobid11.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid11_202x153.webp)
...
![blobid12.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid12_568x268.webp)
...
![mceclip3.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_mceclip3.webp)
...
![blobid15.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid15_260x456.webp)

Click the “Send” button

![blobid16.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid16.webp)

The result should be a list of users in a format similar to below:

![blobid17.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid17.webp)
...
![blobid18.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid18_456x141.webp)
...
![blobid19.webp](/img/product_docs/privilegesecure/4.2/discovery/360046209633_blobid19.webp)
