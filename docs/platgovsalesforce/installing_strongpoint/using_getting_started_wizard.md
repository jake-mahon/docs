...
the [basic installation](/docs/platgovsalesforce/installing_strongpoint/installing_strongpoint.md) and configuration.
...
**Next Step:** [Set Up the Initial Scan](/docs/platgovsalesforce/installing_strongpoint/setting_up_initial_scan.md)
