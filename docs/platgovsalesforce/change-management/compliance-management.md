...
The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/platgovsalesforce/change-management/change-tracking.md). You
...
1. Create a New [Change Request](/docs/platgovsalesforce/change-management/change-requests.md) or open an existing one.
