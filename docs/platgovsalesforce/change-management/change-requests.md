...
- **Customization** Change request is used for Metadata changes, such as
  [Customizations](/docs/platgovsalesforce/org-maintenance/customization-tracking.md).
- **Data Record** - Change request is used for Data Changes to Revenue Cloud/
  [CPQ](/docs/platgovsalesforce/change-management/cpq-support.md).
...
3. Change Request owner [Completes and Validates the Change Request](/docs/platgovsalesforce/change-management/change-requests.md).
...
4. Run **Netwrix Dashboard** > **Tools** > **Environment Comparison**. Validate the changes are what
   you expected. Refer to [Comparing Environments](/docs/platgovsalesforce/tools-and-utilities/comparison-tools.md) for details.
