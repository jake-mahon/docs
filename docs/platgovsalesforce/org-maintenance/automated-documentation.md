...
> [Running the Scanner](/docs/platgovsalesforce/administration/scanners-and-automation.md) topic or reach out to the
...
The [DRD](/docs/platgovsalesforce/tools-and-utilities/analysis-tools.md) is a graphical presentation of an object to help you visualize
the dependencies.
...
> **PRO TIPS**
>
> - Read more about the [Customization Record](/docs/platgovsalesforce/org-maintenance/customization-tracking.md).
...
_Enterprise Compliance_ [license](/docs/platgovsalesforce/getting-started/features-and-licensing.md)). Click
...
[Finder](/docs/platgovsalesforce/tools-and-utilities/analysis-tools.md) is another flexible tool for understanding dependencies across objects.
...
further research. Read more on [Exporting Objects](/docs/platgovsalesforce/tools-and-utilities/data-export-tools.md),
[Exporting Profiles](/docs/platgovsalesforce/tools-and-utilities/data-export-tools.md) and [Exporting Users](/docs/platgovsalesforce/tools-and-utilities/data-export-tools.md).
...
**Next Technical Debt Topic:** [Change Monitoring](/docs/platgovsalesforce/org-maintenance/technical-debt.md)
