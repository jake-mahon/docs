...
> [Running the Scanner](/docs/platgovsalesforce/installing_strongpoint/running_scanner.md) topic or reach out to the
...
_Enterprise Compliance_ [license](/docs/platgovsalesforce/installing_strongpoint/features_by_license_type.md)). Click
...
**Next Technical Debt Topic:** [Change Monitoring](/docs/platgovsalesforce/tech_debt/tech_debt_change_monitoring.md)
