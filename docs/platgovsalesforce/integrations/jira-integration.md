...
[Jira Field Mapping](/docs/platgovsalesforce/integrations/jira-configuration.md) for details.
...
**Next Step:** [Jira Walkthrough Example](/docs/platgovsalesforce/integrations/jira-configuration.md)
