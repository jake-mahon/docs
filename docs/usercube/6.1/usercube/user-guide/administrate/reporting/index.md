...
1. Click on **Reports** on the left of the home page to access the list of predefined reports.
    ...
    ![Home Page - Reports](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/reporting/home_reports_v602.webp)

    ![Reports](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/reporting/reporting_predefinedreports_v602.webp)
...
1. Click on **Query** in the **Administration** section on the home page.
    ...
    ![Home Page - Query](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/reporting/home_query_v602.webp)

    ![Query Page](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/reporting/reporting_querypage_v602.webp)
...
4. Click on **Filters**, write the appropriate condition and click on **Confirm**.
    ...
    ![Filters](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/reporting/reporting_filters_v602.webp)
