...
![Provisioning State Schema](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_states_v523.webp)
...
1. Ensure that the task to compute or generate provisioning orders was launched after the request
   (or the provisioning review, if any), through the complete job in the **Job Execution** page.
    ...
    ![Manual Provisioning Screen](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_page_v603.webp)
...
4. Creation, edition and deletion orders follow the same process: read Usercube's suggestions and
   ...
   Usercube).
    ...
    ![Creation Provisioning Order](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_createresource_v522.webp)

    ![Creation Provisioning Order](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_editresource_v522.webp)
...
![Bulk Provisioning](/img/versioned_docs/usercube_6.1/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_bulk_v603.webp)
