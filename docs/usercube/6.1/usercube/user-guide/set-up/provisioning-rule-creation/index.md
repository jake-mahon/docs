...
and/or
[query rules](/docs/usercube/6.1/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md)
...
[scalar and navigation properties](/docs/usercube/6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/index.md)
...
[configured to block provisioning](/docs/usercube/6.1/usercube/user-guide/set-up/categorization/resource-type-creation/index.md),
...
| Input                                                                                                        | Output                                    |
| ------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| [Categorization](/docs/usercube/6.1/usercube/user-guide/set-up/categorization/index.md) (required) | Scalar rules Navigation rules Query rules |

## Create Provisioning Rules

- [Create resource type rules](/docs/usercube/6.1/usercube/user-guide/set-up/provisioning-rule-creation/resource-creation/index.md)
  to automatically create resources.
- [Create scalar rules](/docs/usercube/6.1/usercube/user-guide/set-up/provisioning-rule-creation/scalar-property-computation/index.md)
  to compute scalar properties;
- [Create navigation and/or query rules](/docs/usercube/6.1/usercube/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/index.md)
...
[creating the single role catalog](/docs/usercube/6.1/usercube/user-guide/set-up/single-roles-catalog-creation/index.md).
