...
>
> ![Scalar Properties](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_scalarex_v600.webp)
...
2. In the entity type's **Properties** section, click on **Map scalar properties** to display
   ...
   type.
    ...
    ![Map from source](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_scalarpropertiesmap_v602.webp)
...
3. Fill in the information fields.
    ...
    ![Scalar properties](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_scalarproperties_v603.webp)
    ...
    - **EXTERNAL SYSTEM**: fields about the corresponding properties inside the connected system.
        ...
        - `Format`: for mapped properties, format used to convert a value during export and fulfill
          from Usercube to the connected system, whenever different from a string.
            ...
            > `1601 Date`.
            >
            > ![AD Entity Type - Scalar Properties](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_examplead2_v602.webp)
...
![Scalar properties](/img/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_scalarpropertieswithoutformat_v522.webp)
