...
[agent](/versioned_docs/usercube_6.1/usercube/introduction-guide/architecture/index.md)separated
from the server, for production environment.

## Overview

Like all [agents](/versioned_docs/usercube_6.1/usercube/introduction-guide/architecture/index.md),
...
[connector declaration](/versioned_docs/usercube_6.1/usercube/user-guide/set-up/connect-system/connector-declaration/index.md).
The appropriate agent has access to the managed system.

## Requirements

Ensure that all
[agent requirements](/versioned_docs/usercube_6.1/usercube/installation-guide/requirements/agent-requirements/index.md)
...
1. [Create the working directory](/versioned_docs/usercube_6.1/usercube/installation-guide/production-ready/working-directory/index.md)
   and make sure it contains the folders: `Mails`; `Sources`; `Temp`; `Work`.
2. [Configure the agent's application settings](/versioned_docs/usercube_6.1/usercube/user-guide/deploy/production-agent-installation/settings-files/index.md)
   via the `web.config`, `appsettings.json` and `appsettings.agent.json` files.
3. [Configure the local server to install IIS](/versioned_docs/usercube_6.1/usercube/user-guide/deploy/production-agent-installation/iis-installation/index.md)
   via Server Manager.
4. [Configure the application pool and website](/versioned_docs/usercube_6.1/usercube/user-guide/deploy/production-agent-installation/iis-configuration/index.md)
   via IIS.
