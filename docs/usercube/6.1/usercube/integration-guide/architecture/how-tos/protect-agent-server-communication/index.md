...
![Schema: Agent/Server Communication](/img/versioned_docs/usercube_6.1/usercube/integration-guide/architecture/how-tos/protect-agent-server-communication/agent-server-communication.webp)
