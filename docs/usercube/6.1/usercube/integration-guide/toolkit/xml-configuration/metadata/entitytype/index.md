...
| Identifier required     | **Type** String **Description** Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [reserved identifier](/docs/usercube/6.1/usercube/integration-guide/toolkit/reservedidentifiers/index.md).        |
