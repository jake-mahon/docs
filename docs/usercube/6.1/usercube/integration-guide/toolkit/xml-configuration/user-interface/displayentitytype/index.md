...
| D0IsActive default value: false     | **Type** Boolean **Description** Is dimension0 active for this entity type (D0IsActive to D3VIsActive following the [base32hex convention](/docs/usercube/6.1/usercube/integration-guide/toolkit/parameter-names/index.md).                                              |
