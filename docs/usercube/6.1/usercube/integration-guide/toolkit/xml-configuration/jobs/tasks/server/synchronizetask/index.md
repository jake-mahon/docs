...
[prepare-synchronization](/docs/usercube/6.1/usercube/integration-guide/synchronization/upward-data-sync/index.md)
to insert the data into the Usercube database.

For more information on how the Synchronization works, see
[Sync Up](/docs/usercube/6.1/usercube/integration-guide/synchronization/upward-data-sync/index.md).
