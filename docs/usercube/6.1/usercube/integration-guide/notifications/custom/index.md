...
given activity in a
[workflow](/docs/usercube/6.1/usercube/integration-guide/workflows/index.md).
...
[`NotificationAspect`](/docs/usercube/6.1/usercube/integration-guide/toolkit/xml-configuration/workflows/aspects/notificationaspect/index.md).
