...
given activity in a
[workflow](/versioned_docs/usercube_6.1/usercube/integration-guide/workflows/index.md).
...
through the
[`SendNotificationsTask`](/versioned_docs/usercube_6.1/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/sendnotificationstask/index.md)
as part of a job.
