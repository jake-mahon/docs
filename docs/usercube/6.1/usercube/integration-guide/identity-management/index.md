...
[See more information on the identity repository](/docs/usercube/6.1/usercube/integration-guide/identity-management/identity-repository/index.md).  
[See how Usercube handles the Joiners, Movers and Leavers (JML) process](/docs/usercube/6.1/usercube/integration-guide/identity-management/joiners-movers-leavers/index.md).
...
[resources](/docs/usercube/6.1/usercube/integration-guide/resources/index.md), which helps
with Usercube's internal mechanisms, for example to
[modelize identities with entity types](/docs/usercube/6.1/usercube/integration-guide/entity-model/index.md).
...
- the provisioning of identity properties directly to the connected systems, based on the
  computation of the
  [role model](/docs/usercube/6.1/usercube/integration-guide/role-model/index.md).

[See more information about synchronization](/docs/usercube/6.1/usercube/integration-guide/synchronization/index.md).  
[See more information about provisioning](/docs/usercube/6.1/usercube/integration-guide/provisioning/index.md).
