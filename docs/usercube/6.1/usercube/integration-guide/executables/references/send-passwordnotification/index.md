...
running.  
The [resource type mapping](/docs/usercube/6.1/usercube/integration-guide/toolkit/xml-configuration/connectors/resourcetypemappings/index.md)
should have an associated
[password reset setting](/docs/usercube/6.1/usercube/integration-guide/toolkit/xml-configuration/connectors/passwordresetsettings/index.md).  
For
