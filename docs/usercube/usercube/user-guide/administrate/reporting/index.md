...
](../../set-up/user-profile-configuration/index.md).
...
Classify Resources
](../../set-up/categorization/classification/index.md). This module offers the possibility to customize reports and download them.
