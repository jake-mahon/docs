...
| Input | Output |
| --- | --- |
| [ Schedule a Certification Campaign ](/docs/product_docs/usercube/usercube/user-guide/administrate/access-certification/certification-campaign-scheduling/index.md) (required) | Certified access |
