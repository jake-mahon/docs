...
[ Configure a User Profile ](../../../set-up/user-profile-configuration/index.md) accesses the
...
[ Create a Resource Type ](../../../set-up/categorization/resource-type-creation/index.md). You can
choose to:

- Set the number of required approvals by a
  [ Manage Role Officers ](../../../set-up/role-officer-management/index.md), via the
...
See the
[Entitlement Assignment](../../../../integration-guide/role-assignment/assignments-of-entitlements/index.md)
and [ Create a Provisioning Rule ](../../../set-up/provisioning-rule-creation/index.md) topics for
...
[ Classify Resources ](../../../set-up/categorization/classification/index.md)and all resource
...
- `Confidence rate of proposed resource`: rate expressing the confidence in this
  [ Correlate Resources ](../../../set-up/categorization/correlation/index.md).
- `Proposed Value`: value proposed by Identity Manager.
...
2. Follow the [ Request Entitlement Assignment ](../../manual-assignment-request/index.md) workflow
