...
![Provisioning State Schema](/static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/automatic-provisioning/provauto_states_v523.png)
...
2. Follow the [
   ...
   ](/docs/product_docs/usercube/usercube/user-guide/administrate/manual-assignment-request/index.md)to make a change in one of their permissions, which involves automated provisioning.
