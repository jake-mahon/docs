...
[ Create a Provisioning Rule ](../../../set-up/provisioning-rule-creation/index.md).
...
| Input                                               | Output               |
| --------------------------------------------------- | -------------------- |
| [Provision](../../provisioning/index.md) (required) | Complying properties |
...
3. Select `Unreconciled properties` as a `Workflow State`.
    ...
    ![Unreconciled Property](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/non-conforming-assignment-review/property-reconciliation/reviewprop_unreconciled_v522.webp)
...
5. Select a property to review.
    ...
    >
    > ![Unreconciled Property Example](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/non-conforming-assignment-review/property-reconciliation/reviewprop_example_v602.webp)
