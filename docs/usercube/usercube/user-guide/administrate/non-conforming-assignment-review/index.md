...
Non-conforming roles and unauthorized accounts can be mass reviewed through [Automate the Review of Non-conforming Assignments](../../optimize/non-conforming-assignment-review-automation/index.md).
