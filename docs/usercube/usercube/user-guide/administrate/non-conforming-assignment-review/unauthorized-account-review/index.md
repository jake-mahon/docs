...
| Input | Output |
| --- | --- |
| [Provision](/docs/usercube/usercube/user-guide/administrate/provisioning/index.md) (required) | Complying accounts |
...
1. Ensure that the [
   ...
   ](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) was launched recently, through the complete job on the __Job Execution__ page:
...
4. Choose the default resource view or the [
   Review an Unauthorized Account
   ](#Review-an-Unauthorized-Account) with the top right toggle.
...
8. Trigger [Provision](/docs/usercube/usercube/user-guide/administrate/provisioning/index.md) by launching, on the appropriate connector's overview page, __Jobs__ > __Generate Provisioning Orders__, then, after this first task is done, __Jobs__ > __Fulfill__.
