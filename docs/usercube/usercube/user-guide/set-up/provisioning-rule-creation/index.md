...
[ Categorize Resources ](../categorization/index.md) led to the grouping of resources into resource
...
[Provision](../../administrate/provisioning/index.md) these properties, i.e. write them to the
managed system.
...
[ Create a Resource Type ](../categorization/resource-type-creation/index.md) topic for additional
information.
...
See the [ Categorize Resources ](../categorization/index.md) topic for additional information.

## Create Provisioning Rules

- [ Create Resources ](resource-creation/index.md)type rules to automatically create resources.
...
to[ Create Roles in the Role Catalog ](../single-roles-catalog-creation/index.md).
