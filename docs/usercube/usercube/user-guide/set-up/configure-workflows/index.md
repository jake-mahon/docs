...
How to adjust the validation process and homonym detection of onboarding [Workflows](/docs/usercube/usercube/integration-guide/workflows/index.md).
...
](/docs/usercube/usercube/user-guide/maintain/identity-data-modification/individual-update/index.md)in Identity Manager.
...
See the [Workflows](/docs/usercube/usercube/integration-guide/workflows/index.md) topic for additional information.
