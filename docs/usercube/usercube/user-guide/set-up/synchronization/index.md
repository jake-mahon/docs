...
[Create an Entity Type](../connect-system/entity-type-creation/index.md) in order to synchronize it
...
The
[ Export Task ](../../../integration-guide/toolkit/xml-configuration/jobs/tasks/agent/exporttask/index.md)
...
[ References: Packages ](../../../integration-guide/connectors/references-packages/index.md).
...
The
[ Prepare Synchronization Task ](../../../integration-guide/toolkit/xml-configuration/jobs/tasks/agent/preparesynchronizationtask/index.md)performs
...
See the
[ Upward Data Synchronization ](../../../integration-guide/synchronization/upward-data-sync/index.md)
...
[Create an Entity Type](../connect-system/entity-type-creation/index.md) topic for additional
information.
...
[ Connector ](../../../integration-guide/toolkit/xml-configuration/connectors/connector/index.md)
attributes:
...
See the [ Connect to a Managed System ](../connect-system/index.md) topic for additional
information.
...
also part of scheduled [ Jobs ](../../../integration-guide/tasks-jobs/jobs/index.md) provided by
Identity Manager:
...
See the
[ Set Up Incremental Synchronization ](../../../integration-guide/tasks-jobs/how-tos/jobfast/index.md)
and
[ Set up Complete Synchronization ](../../../integration-guide/tasks-jobs/how-tos/jobdaily/index.md)
...
[Create an Entity Type](../connect-system/entity-type-creation/index.md):
