...
![Template Example](/static/img/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/load-identities/initialload_templateexample_v602.png)
...
See the [Install the Development Environment](/docs/product_docs/usercube/usercube/user-guide/set-up/development-environment-installation/index.md) topic for additional information
...
4. Fill said template with the data you collected.
   ...
   The Excel file contains several tabs which organize data, but not all tabs and columns are mandatory. You can find __more details about the [Template Description](/docs/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/template-description/index.md)__. Below are the minimum recommended attributes (mandatory in orange):

   ![Template Recommendations](/static/img/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/load-identities/initialload_templatereco_v600.png)

   [__Click here to download a template example__](/docs/product_docs/usercube/resources/directory_example_v602.xlsx).
...
6. Click on __Verify and Synchronize__ to check the file's consistency and import its data into Identity Manager.
   ...
   ![Verify and Synchronize](/static/img/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/load-identities/initialload_dataupload-synchronize_v602.png)

   Now you are able to view users' pages in the directory.

   ![Directory - Users](/static/img/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/load-identities/initialload_directoryusers_v602.png)
