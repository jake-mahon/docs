...
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourceclassificationrule/index.md) in order to classify remaining uncorrelated resources, assigning them resource types. See the [
...
| Input | Output |
| --- | --- |
| [ Create a Resource Type ](/docs/product_docs/usercube/usercube/user-guide/set-up/categorization/resource-type-creation/index.md) (required)   [ Synchronize Data ](/docs/product_docs/usercube/usercube/user-guide/set-up/synchronization/index.md) (required)   [ Correlate Resources ](/docs/product_docs/usercube/usercube/user-guide/set-up/categorization/correlation/index.md) (recommended) | Classification rules |
...
1. On the relevant resource type's page, click on __Classification Rules__ and the addition icon.
   ...
   ![New Classification Rule](/static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/resourcetype_newclassifrule_v602.png)
...
2. Fill in the fields.
   ...
   ![New Classification Rule Fields](/static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/resourcetype_newclassifrulefields_v602.png)
   ...
   >
   > ![Classification Rule Example](/static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/classification_example_v602.png)
...
![Owner / Resource Type Column](/static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/classification_test_v522.png)
...
![Unclassified Resource](/static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/classification_unclassified_v600.png)
