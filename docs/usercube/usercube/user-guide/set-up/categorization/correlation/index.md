...
How to define the
[ Resource Correlation Rule ](../../../../integration-guide/toolkit/xml-configuration/provisioning/resourcecorrelationrule/index.md)
...
See the [ Create the Workforce Repository ](../../initial-identities-loading/index.md) and
[ Create a Resource Type ](../resource-type-creation/index.md) topics for additional information.
