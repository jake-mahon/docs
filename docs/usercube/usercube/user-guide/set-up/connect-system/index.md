...
- a [
  Connector
  ](../../../integration-guide/toolkit/xml-configuration/connectors/connector/index.md) is linked to an agent which acts as the go-between for Identity Manager's server and the managed system;

  > Our ```AD``` connector uses the provided SaaS agent.
- a [
  Connection
  ](../../../integration-guide/toolkit/xml-configuration/connectors/connection/index.md) describes the technology used that enables data to flow back and forth between Identity Manager and the managed system;
...
- the shape of the extracted managed system's data is modeled by [
  Entity Type
  ](../../../integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) (we will use the term resource to refer to an entity type that has been instantiated);
...
- the intent of resources within the managed system is made clear by categorizing resources into [
  ...
  ](../categorization/resource-type-creation/index.md). See the [
...
See the [Install the Development Environment,](../development-environment-installation/index.md) [
Create the Workforce Repository
](../initial-identities-loading/index.md), and [
Configure a User Profile
](../user-profile-configuration/index.md) topics for additional information.
...
1. Outside Identity Manager, [
   Model the Data
   ](connector-modeling/index.md).
2. [
   Create the Connector
   ](connector-declaration/index.md) for said managed system.
3. Enable the technical transfer of data by creating and configuring [Create a Connection](connection-creation/index.md).
4. Set up [Create an Entity Type](entity-type-creation/index.md) to represent the data model decided upon in step 1.
