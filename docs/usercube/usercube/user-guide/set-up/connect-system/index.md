...
[ Architecture ](../../../introduction-guide/architecture/index.md) topic for additional
information.

Identity Manager provides demo applications
([Run the Banking Demo Application](../../../integration-guide/connectors/how-tos/demoapp-banking/index.md)
and
[Run the HR Demo Application](../../../integration-guide/connectors/how-tos/demoapp-hr/index.md)) to
...
> repository. See the [ Create the Workforce Repository ](../initial-identities-loading/index.md)
...
- the intent of resources within the managed system is made clear by categorizing resources into
  [ Create a Resource Type ](../categorization/resource-type-creation/index.md). See the
...
[ Create the Workforce Repository ](../initial-identities-loading/index.md), and
[ Configure a User Profile ](../user-profile-configuration/index.md) topics for additional
information.
...
1. Outside Identity Manager, [ Model the Data ](connector-modeling/index.md).
2. [ Create the Connector ](connector-declaration/index.md) for said managed system.
3. Enable the technical transfer of data by creating and configuring
   [Create a Connection](connection-creation/index.md).
4. Set up [Create an Entity Type](entity-type-creation/index.md) to represent the data model decided
   upon in step 1.
