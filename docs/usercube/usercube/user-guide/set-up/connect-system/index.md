...
How to create a new [
Connector
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md) using the provided SaaS agent. See the [
Architecture
](/docs/product_docs/usercube/usercube/introduction-guide/architecture/index.md) topic for additional information.

Identity Manager provides demo applications ([Run the Banking Demo Application](/docs/product_docs/usercube/usercube/integration-guide/connectors/how-tos/demoapp-banking/index.md) and [Run the HR Demo Application](/docs/product_docs/usercube/usercube/integration-guide/connectors/how-tos/demoapp-hr/index.md)) to help set up connectors, test them, and understand Identity Manager's abilities towards external systems.
...
- a [
  Connector
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md) is linked to an agent which acts as the go-between for Identity Manager's server and the managed system;

  > Our ```AD``` connector uses the provided SaaS agent.
- a [
  Connection
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) describes the technology used that enables data to flow back and forth between Identity Manager and the managed system;
...
- the shape of the extracted managed system's data is modeled by [
  Entity Type
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) (we will use the term resource to refer to an entity type that has been instantiated);
...
- the intent of resources within the managed system is made clear by categorizing resources into [
  ...
  ](/docs/product_docs/usercube/usercube/user-guide/set-up/categorization/resource-type-creation/index.md). See the [
...
__Local vs. Saas agents:__ To simplify things, Identity Manager has made it possible to start configuring connectors without installing a local agent in your organization's network. Instead, you can use the agent integrated with Identity Manager's server in the Cloud (SaaS agent).
...
See the [Install the Development Environment,](/docs/product_docs/usercube/usercube/user-guide/set-up/development-environment-installation/index.md) [
Create the Workforce Repository
](/docs/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/index.md), and [
Configure a User Profile
](/docs/product_docs/usercube/usercube/user-guide/set-up/user-profile-configuration/index.md) topics for additional information.
...
1. Outside Identity Manager, [
   Model the Data
   ](/docs/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/index.md).
2. [
   Create the Connector
   ](/docs/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-declaration/index.md) for said managed system.
3. Enable the technical transfer of data by creating and configuring [Create a Connection](/docs/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/index.md).
4. Set up [Create an Entity Type](/docs/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/index.md) to represent the data model decided upon in step 1.
...
Once the connector has been created, you can start to[
Synchronize Data
](/docs/product_docs/usercube/usercube/user-guide/set-up/synchronization/index.md).
