...
How to create a [
Connection
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) inside a [
Connector
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md) and choose the appropriate package.
...
Synchronize Data
](/docs/product_docs/usercube/usercube/user-guide/set-up/synchronization/index.md)and one connection for [Provision](/docs/product_docs/usercube/usercube/user-guide/administrate/provisioning/index.md).
...
](/docs/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-declaration/index.md) and [
Model the Data
...
1. Click on the addition button in the __Connections__ frame on the connector's summary page.
   ...
   ![Add a New Connection](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connection_newconnection_v602.png)
2. Fill in the connection information fields on the left, then select a package (AD, CSV, etc.) and fill the associated agent settings on the right.
   ...
   ![Connection Creation](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_connectioncreation_v602.png)
...
- Do we need [Provision](/docs/product_docs/usercube/usercube/user-guide/administrate/provisioning/index.md)? If so, should provisioning be performed manually or automatically by Identity Manager?
...
Each type of package needs its own settings, and secured options can be used to store sensitive connection information. See the [Connections](/docs/product_docs/usercube/usercube/integration-guide/connectors/configuration-details/connections/index.md) topic for additional information.
...
1. click on __Check Connection__ to ensure that Identity Manager can reach the managed system;
   ...
   ![Check Connection](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_checkconnection_v602.png)

   Some connectors have both incremental and complete setting modes. See the [
   Jobs
   ](/docs/product_docs/usercube/usercube/integration-guide/tasks-jobs/jobs/index.md)topic for additional information. They are relatively independent so they both need to be tested.
...
![Schema Not Recovered](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connection_notrecovered_v523.png)
