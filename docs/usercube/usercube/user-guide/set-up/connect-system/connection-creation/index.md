...
How to create a [
Connection
](../../../../integration-guide/toolkit/xml-configuration/connectors/connection/index.md) inside a [
Connector
](../../../../integration-guide/toolkit/xml-configuration/connectors/connector/index.md) and choose the appropriate package.
...
Synchronize Data
](../../synchronization/index.md)and one connection for [Provision](../../../administrate/provisioning/index.md).
...
](../connector-declaration/index.md) and [
Model the Data
](../connector-modeling/index.md) topics for additional information.
...
1. Click on the addition button in the __Connections__ frame on the connector's summary page.
   ...
   ![Add a New Connection](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connection_newconnection_v602.webp)
2. Fill in the connection information fields on the left, then select a package (AD, CSV, etc.) and fill the associated agent settings on the right.
   ...
   ![Connection Creation](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_connectioncreation_v602.webp)
...
- Do we need [Provision](../../../administrate/provisioning/index.md)? If so, should provisioning be performed manually or automatically by Identity Manager?
...
Each type of package needs its own settings, and secured options can be used to store sensitive connection information. See the [Connections](../../../../integration-guide/connectors/configuration-details/connections/index.md) topic for additional information.
...
- when clicking on __Refresh Schema__ on the connection's page: only the schema of the current connection is refreshed;
  ...
  ![Refresh Schema of One Connection](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_refreshschema_v522.webp)
- when clicking on __Refresh all schemas__ on the connector's page: all schemas of the connector are refreshed.

  ![Refresh all Schemas](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_refreshall_v602.webp)
...
![Failed Refresh Schemas](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_failedindicator_v602.webp)
...
![No Schema](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connectioncreation_noschema_v522.webp)
...
1. click on __Check Connection__ to ensure that Identity Manager can reach the managed system;
   ...
   Jobs
   ](../../../../integration-guide/tasks-jobs/jobs/index.md)topic for additional information. They are relatively independent so they both need to be tested.
...
![Schema Not Recovered](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connection-creation/connection_notrecovered_v523.webp)
