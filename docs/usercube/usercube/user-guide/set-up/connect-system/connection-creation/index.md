...
How to create a [
Connection
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) inside a [
Connector
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md) and choose the appropriate package.
...
Synchronize Data
](/docs/usercube/usercube/user-guide/set-up/synchronization/index.md)and one connection for [Provision](/docs/usercube/usercube/user-guide/administrate/provisioning/index.md).
...
](/docs/usercube/usercube/user-guide/set-up/connect-system/connector-declaration/index.md) and [
Model the Data
](/docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/index.md) topics for additional information.
...
- Do we need [Provision](/docs/usercube/usercube/user-guide/administrate/provisioning/index.md)? If so, should provisioning be performed manually or automatically by Identity Manager?
...
Each type of package needs its own settings, and secured options can be used to store sensitive connection information. See the [Connections](/docs/usercube/usercube/integration-guide/connectors/configuration-details/connections/index.md) topic for additional information.
...
1. click on __Check Connection__ to ensure that Identity Manager can reach the managed system;
   ...
   Jobs
   ](/docs/usercube/usercube/integration-guide/tasks-jobs/jobs/index.md)topic for additional information. They are relatively independent so they both need to be tested.
