...
![Process of Change Management](/static/img/product_docs/usercube/usercube/user-guide/deploy/change-management/changemanagement_process.png)
...
![Actors of Change Management](/static/img/product_docs/usercube/usercube/user-guide/deploy/change-management/changemanagement_actors.png)
...
1. Identify the populations impacted by change. Below is an example of impacted populations that can vary enormously.
   ...
   ![Usual Populations](/static/img/product_docs/usercube/usercube/user-guide/deploy/change-management/changemanagement_populations.png)
2. For all listed populations, estimate their size and the expected impact on them, through indicators like the frequency of their future use of the solution. Use [
   Plan Change Management
   ](#Plan-Change-Management) to represent key population members, such as VIP users that don't use the application much, or users not feeling comfortable with computers.
...
| [2](#2) | End-Users | 50 | High | Coffee corner: coffee break with the local support team offering tutorials and exercises on Identity Manager |
| [3a](#3a) | HR/Managers | 10 | High   (daily use) | Tutorials and exercises with a support team to get started quickly with Identity Manager |
