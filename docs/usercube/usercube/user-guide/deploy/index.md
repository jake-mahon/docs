...
- [
  ...
  ](/docs/usercube/usercube/user-guide/deploy/change-management/index.md)
...
- [
  ...
  ](/docs/usercube/usercube/user-guide/deploy/production-agent-installation/index.md)

  How to install a local agent for production environment.

- [
  Configure the Agent's Settings
  ](/docs/usercube/usercube/user-guide/deploy/production-agent-installation/settings-files/index.md)
...
- [
  ...
  ](/docs/usercube/usercube/user-guide/deploy/production-agent-installation/iis-configuration/index.md)
...
- [Set Up User Authentication](/docs/usercube/usercube/user-guide/deploy/authentication/index.md)

  How to allow end-users to authenticate and use the Identity Manager application.
- [Implement Identity Manager](/docs/usercube/usercube/user-guide/deploy/implementation/index.md)
