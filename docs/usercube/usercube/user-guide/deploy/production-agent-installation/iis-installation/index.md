...
](/docs/product_docs/usercube/usercube/user-guide/deploy/production-agent-installation/iis-configuration/index.md)the application pool and website via IIS.
