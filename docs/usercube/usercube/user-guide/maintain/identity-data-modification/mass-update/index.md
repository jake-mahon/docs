...
3. In the connection's settings, download the Excel template full of the data from your database.
   ...
   ![Download Full Template](/static/img/product_docs/usercube/usercube/user-guide/maintain/identity-data-modification/mass-update/datamodif_downloadtemplatedata_v602.png)
...
6. Click on __Upload__ and choose the file you modified with new data.
   ...
   ![Upload](/static/img/product_docs/usercube/usercube/user-guide/maintain/identity-data-modification/mass-update/connection_upload_v602.png)
...
3. In the connection's settings, download the empty Excel template.
   ...
   ![Download Full Template](/static/img/product_docs/usercube/usercube/user-guide/maintain/identity-data-modification/mass-update/datamodif_downloadtemplateempty_v602.png)
