...
Identity Management
](/docs/usercube/usercube/introduction-guide/overview/identity-management/index.md) entity-relationship model. So Identity Manager manages entitlements as resources' attribute values.
...
See the [Governance](/docs/usercube/usercube/introduction-guide/overview/governance/index.md) topic for additional information.
...
Learn more on hoe to [Create a Composite Role](/docs/usercube/usercube/user-guide/optimize/composite-role-creation/index.md).

Learn more on [Role Assignment](/docs/usercube/usercube/integration-guide/role-assignment/index.md).
...
](/docs/usercube/usercube/user-guide/optimize/assignment-automation/automate-role-assignment/index.md) rules.
