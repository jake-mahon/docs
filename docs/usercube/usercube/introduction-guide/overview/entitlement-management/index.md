...
The role model is a subset of a policy that also includes [Governance](/docs/product_docs/usercube/usercube/introduction-guide/overview/governance/index.md) data such as risk definition. So, at a higher level, distinct policies can be used to implement distinct behaviors.
...
Identity Management
](/docs/product_docs/usercube/usercube/introduction-guide/overview/identity-management/index.md) entity-relationship model. So Identity Manager manages entitlements as resources' attribute values.
...
See the [Governance](/docs/product_docs/usercube/usercube/introduction-guide/overview/governance/index.md) topic for additional information.

## Learn More

Learn more on the [
Role Model
](/docs/product_docs/usercube/usercube/integration-guide/role-model/index.md).
...
Learn more on hoe to [Create a Composite Role](/docs/product_docs/usercube/usercube/user-guide/optimize/composite-role-creation/index.md).

Learn more on [Role Assignment](/docs/product_docs/usercube/usercube/integration-guide/role-assignment/index.md).
...
](/docs/product_docs/usercube/usercube/user-guide/optimize/assignment-automation/automate-role-assignment/index.md) rules.
