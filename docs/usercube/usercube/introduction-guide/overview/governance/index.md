...
Learn more on how to [ Generate Reports ](../../../user-guide/administrate/reporting/index.md).

Learn more on
[ Perform Access Certification ](../../../user-guide/administrate/access-certification/index.md).

Learn more on how to [ Manage Risks ](../../../user-guide/optimize/risk-management/index.md).
