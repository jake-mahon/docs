...
The port used to access the database depends on the [database configuration](https://docs.microsoft.com/en-us/sql/database-engine/configure-windows/server-network-configuration?view=sql-server-ver15#database-configuration) and the [connectionString](https://learn.microsoft.com/en-us/dotnet/api/system.data.sqlclient.sqlconnection.connectionstring?view=dotnet-plat-ext-8.0) set in the technical configuration. See the [Network Configuration](/docs/usercube/usercube/integration-guide/network-configuration/index.md) topic for additional information.
...
- All end-users' __browsers__ require accessing the authentication providers. See the [Install the Server](/docs/usercube/usercube/installation-guide/production-ready/server/index.md) topic for additional information.
...
- The __On-Premise__ offering requires the Agent, the [Install the Server](/docs/usercube/usercube/installation-guide/production-ready/server/index.md), and the [
  Install the Database
  ](/docs/usercube/usercube/installation-guide/production-ready/database/index.md) to be installed.

See the [
Install the Agents](/docs/usercube/usercube/installation-guide/production-ready/agent/index.md) topics for additional information.
...
End-users will be able to access Identity Manager after authentication. Several authentication methods are available. See the [Install the Server](/docs/usercube/usercube/installation-guide/production-ready/server/index.md) topic for additional information.
...
Before you check out the installation steps, make sure that all the [Requirements](/docs/usercube/usercube/installation-guide/requirements/index.md) are met.
