...
- [Database](../requirements/database-requirements/index.md)-related specifications
...
![Extranet Artifacts](../../../../../static/img/product_docs/usercube/usercube/installation-guide/quick-start/extranet_v601.webp)
...
![Project Directory](../../../../../static/img/product_docs/usercube/usercube/installation-guide/quick-start/directory_v602.webp)
...
__Step 8 –__ Open a command prompt and deploy the configuration. See the[ Usercube-Deploy Configuration](../../integration-guide/executables/references/deploy-configuration/index.md) topic for additional information.
...
](../../integration-guide/executables/references/server/index.md) topic for additional information.
...
![Authentication Dialog](../../../../../static/img/product_docs/usercube/usercube/installation-guide/quick-start/authentication_v601.webp)
...
![Home Page - Settings](../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/user-profile-configuration/home_settings_v523.webp)

Then, Netwrix Identity Manager (formerly Usercube) recommends following the user guide to start the configuration of your IGA project from scratch. See the [User Guide](../../user-guide/index.md) topic for additional information.
