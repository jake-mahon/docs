...
the[ Create a Working Directory ](../../production-ready/working-directory/index.md) topic as:
...
See the [Database](../database-requirements/index.md) and
[Install the Server](../../production-ready/server/index.md) topics for additional information.
