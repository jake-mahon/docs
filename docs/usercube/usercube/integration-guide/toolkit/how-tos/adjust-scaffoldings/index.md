...
1. When working via the UI, start by exporting UI [
   ...
   ](../../../executables/references/export-configuration/index.md) elements.
...
4. [ Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index.md) again.
