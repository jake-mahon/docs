...
Deploy a local XML configuration by using the [ Usercube-Deploy Configuration](/docs/product_docs/usercube/usercube/integration-guide/executables/references/deploy-configuration/index.md) and declaring at least:
...
4. Deploy the configuration by using the[ Usercube-Deploy Configuration](/docs/product_docs/usercube/usercube/integration-guide/executables/references/deploy-configuration/index.md) and declaring at least:
