...
Entity Type
](../../xml-configuration/metadata/entitytype/index.md) and[Resource Type](../../xml-configuration/provisioning/resourcetype/index.md) topics for additional information.

Unlike C# expressions, Identity Manager's predefined functions do not need any prefix. They can be used as such. See the [
C# utility functions
](../csharp-utility-functions/index.md) topic for additional information.
