...
| D0   optional | __Type__    Int64   __Description__   Identifier of the dimension 0 (up to 3V in the [ Base32 Parameter Names ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/parameter-names/index.md)) that filters the owners targeted by the access certification campaign. |
