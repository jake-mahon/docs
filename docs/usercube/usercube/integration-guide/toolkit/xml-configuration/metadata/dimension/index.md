...
A dimension is an [
Entity Type
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) used to define an organizational filter for the Identity Manager role model.
