...
Connector
](../../connectors/connector/index.md)topic for additional information on how to configure define an EntityType.
...
| Identifier   required | __Type__    String   __Description__   Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [ Reserved identifiers ](../../../reservedidentifiers/index.md). |
...
See the [Expressions](../../../expressions/index.md) topic for additional information on how to configure/define an EntityProperty.
...
| Identifier   required | __Type__    String   __Description__   Unique identifier of the property. It must be unique to the parent entity type scope. Cannot be a [ Reserved identifiers ](../../../reservedidentifiers/index.md) and can only contain numbers (except the first character) and letters without accents.   __Note:__ cannot be "Id". |
