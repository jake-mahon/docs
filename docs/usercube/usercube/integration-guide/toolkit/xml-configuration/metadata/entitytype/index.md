...
Connector
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md)topic for additional information on how to configure define an EntityType.
...
| Identifier   required | __Type__    String   __Description__   Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [ Reserved identifiers ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/reservedidentifiers/index.md). |
...
See the [Expressions](/docs/product_docs/usercube/usercube/integration-guide/toolkit/expressions/index.md) topic for additional information on how to configure/define an EntityProperty.
...
All _Title_ instances will be replicated from a managed system. So, at configuration time, Identity Manager's internal primary key for this _Title_ is not known.
