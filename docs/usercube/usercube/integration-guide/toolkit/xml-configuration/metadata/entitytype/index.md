...
Connector
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connector/index.md)topic for additional information on how to configure define an EntityType.
...
| Identifier   required | __Type__    String   __Description__   Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [ Reserved identifiers ](/docs/usercube/usercube/integration-guide/toolkit/reservedidentifiers/index.md). |
