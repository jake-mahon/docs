...
See the [Configure Global Settings](/docs/product_docs/usercube/usercube/user-guide/set-up/configure-global-settings/index.md) topic for additional information.
