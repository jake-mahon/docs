...
- [Clean Database Job](cleandatabasejob/index.md)

  Creates the job to clean old tasks and jobs instances with state InProgress.
- [Create Access Certification Job](createaccesscertificationjob/index.md)

  Creates the AccessCertification Job.
- [Create Agent Synchro Complete](createagentsynchrocomplete/index.md)

  Creates for the given agent the synchronization job of all connectors present in the agent in Complete mode.
- [Create Agent Synchro Incremental](createagentsynchroincremental/index.md)
...
- [
  ...
  ](createconnectorsjobs/index.md)

  Creates all jobs by connector to launched task in the connector page.
- [Create Connector Synchro Complete](createconnectorsynchrocomplete/index.md)

  Creates for the given connector the synchronization in complete mode.
- [Create Connector Synchro Incremental](createconnectorsynchroincremental/index.md)

  Creates for the given connector the synchronization job in incremental mode.
- [Create Initialization Job](createinitializationjob/index.md)
