...
- [ Manage Setting Access Control Rule ](managesettingaccesscontrolrule/index.md)
...
- [ Report Access Control Rules ](reportaccesscontrolrules/index.md)

    Generates the permissions to access the report view.

- [ Target Resource Report Access Control Rules ](targetresourcereportaccesscontrolrules/index.md)

    Generates the permissions to apply a report for a profile on a given entity.

- [ Universe Access Control Rules ](universeaccesscontrolrules/index.md)
