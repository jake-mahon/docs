...
This page is about [
PowerShellProv
](/docs/usercube/usercube/integration-guide/connectors/references-packages/powershellprov/index.md).
...
](/docs/usercube/usercube/integration-guide/connectors/how-tos/write-fulfill-powershell-script/index.md)to allow provisioning with this connector.
...
- a [
  Connection
  ](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) able to store the attributes from the ```Options``` section that are compatible with CyberArk.
