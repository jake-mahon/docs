...
This page is about [
Home Folders
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-packages/home-folders/index.md).
...
Connection
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) folder, with the following columns:
...
- [
  Connection
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) able to store Home Folder's ```Login``` and ```Password```.
