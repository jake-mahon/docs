...
This page is about [ Microsoft Exchange ](../../references-packages/microsoft-exchange/index.md).
...
[ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) folder, and the
...
As it works via a PowerShell script. See the [ PowerShellProv ](../powershellprov/index.md) topic
for additional information.

Identity Manager's PowerShell script can be found in the SDK in
`Usercube.Demo/Scripts/Fulfill-Exchange.ps1`.

See the [ PowerShellProv ](../powershellprov/index.md) topic for additional information.
...
PowerShellProv connector. See the [ PowerShellProv ](../powershellprov/index.md) topic for
