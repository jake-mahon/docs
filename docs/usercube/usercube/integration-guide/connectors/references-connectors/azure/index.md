...
This page is about [
Azure
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-packages/azure/index.md).
...
This connector is meant to generate to the [Application Settings](/docs/product_docs/usercube/usercube/integration-guide/network-configuration/agent-configuration/appsettings/index.md) folder the following CSV files:
...
- A [CyberArk's AAM Credential Providers
  ](/docs/product_docs/usercube/usercube/integration-guide/network-configuration/agent-configuration/cyberark-application-access-manager-credential-providers/index.md) able to store Azure's ```ApplicationId``` and ```ApplicationKey```.
