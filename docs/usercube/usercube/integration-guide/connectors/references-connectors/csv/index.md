...
This page is about [
CSV
](../../references-packages/csv/index.md).

![Package: File/CSV](../../../../../../../static/img/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/csv/packages_csv_v603.webp)
...
This process is configured through a [](../../../toolkit/xml-configuration/connectors/connection/index.md)[
Connection
...
This connector is meant to generate a CSV file, named ```<connectionIdentifier>.csv```, to the [Application Settings](../../../network-configuration/agent-configuration/appsettings/index.md) folder.
