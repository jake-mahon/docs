...
This page is about [
Shared Folders
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-packages/shared-folders/index.md).
...
- a [
  Connection
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) able to store Active Directory's ```Login``` and ```Password```.
