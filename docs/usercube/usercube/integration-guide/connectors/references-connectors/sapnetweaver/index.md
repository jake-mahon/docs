...
This page is about [
SAP S/4 HANA
](/docs/usercube/usercube/integration-guide/connectors/references-packages/saphana/index.md).
...
When setting a password for an SAP user, the password attribute is defined by the password specified in the corresponding [Resource Type Mappings](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/resourcetypemappings/index.md).
...
- a [
  Connection
  ](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) able to store Active Directory's ```Login```, ```Password``` and ```Server```.
