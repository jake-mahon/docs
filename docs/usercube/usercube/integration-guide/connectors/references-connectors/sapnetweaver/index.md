...
This page is about [
SAP S/4 HANA
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-packages/saphana/index.md).
...
| Name | Details |
| --- | --- |
| Server   required | __Type__    String   __Description__ URL of the SAP server. |
| Login   required | __Type__    String   __Description__ Login to authenticate to the specified server. |
| Password   required | __Type__    String   __Description__ Password to authenticate to the specified server. |

### Output details

This connector is meant to generate to the [
Connection
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) folder the following CSV files:
...
When setting a password for an SAP user, the password attribute is defined by the password specified in the corresponding [Resource Type Mappings](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/resourcetypemappings/index.md).
...
- a [
  Connection
  ](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/connectors/connection/index.md) able to store Active Directory's ```Login```, ```Password``` and ```Server```.
