...
Connection
](../../../toolkit/xml-configuration/connectors/connection/index.md) folder one CSV file, named ```<connectionIdentifier>.csv``` whose columns correspond to the columns returned by the SQL query.
