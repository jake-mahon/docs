...
- Database/[ Generic SQL ](../../references-packages/generic-sql/index.md);
- Database/[ SQL Server ](../../references-packages/sql-server/index.md);
- Database/[ MySQL ](../../references-packages/mysql/index.md);
- Database/[ ODBC ](../../references-packages/odbc/index.md);
- Database[ Oracle Database ](../../references-packages/oracle-database/index.md);
- Database/[ PostgreSQL ](../../references-packages/postgresql/index.md);
- [ SAP ASE ](../../references-packages/sapase/index.md).
...
|                                               |                                                                                                                                                                                                                                                                                                                                                      |
| ---                                           | ---                                                                                                                                                                                                                                                                                                                                                  |
| SqlCommand optional                           | **Type** String **Description** SQL request to be executed. **Note:** when not specified and `SqlFile` neither, then all the[ Entity Type Mapping ](../../../toolkit/xml-configuration/connectors/entitytypemapping/index.md) of this connector will be exported.                                                                                    |
| SqlFile optional                              | **Type** String **Description** Path of the file containing the SQL request to be executed. **Note:** ignored when `SqlCommand` is specified. **Note:** when not specified and `SqlFile` neither, then all the [ Entity Type Mapping ](../../../toolkit/xml-configuration/connectors/entitytypemapping/index.md) of this connector will be exported. |
...
3. Get the value required for `ProviderClassFullName` and `ProviderDllName`:
    ...
    - for a DBMS handled by Identity Manager's packages, by accessing the
      [ References: Packages ](../../references-packages/index.md);
...
[ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) folder one CSV
