...
![Package: Custom/OData](../../../../../../../static/img/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/odata/packages_odata_v603.webp)
...
Connection
](../../../toolkit/xml-configuration/connectors/connection/index.md) folder one CSV file for each entity set provided in the connector's configuration.
...
> For example:
> \<EntityType Identifier="OData_People" DisplayName_L1="People"\>\<Property Identifier="UserName" DisplayName_L1="User name" Type="String" /\>\<Property Identifier="FamilyName" DisplayName_L1="Family name" Type="String" /\>\</EntityType\>
>
