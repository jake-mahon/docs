...
We define an [Entity Model](/docs/product_docs/usercube/usercube/integration-guide/entity-model/index.md) called ```u_startdate``` with the __Type__```DateTime``` to display it as a date in the UI.
