...
Connection
](../../../toolkit/xml-configuration/connectors/connection/index.md) which needs to be declared both in the XML configuration and in the [appsettings.agent](../../../network-configuration/agent-configuration/appsettings-agent/index.md) file to be used. The connection settings must be set in appsettings.agent.json > Connections > __connectionIdentifier__, where __connectionIdentifier__ is the identifier specified for the connection in the XML configuration.
...
See the [References: Connectors](../../references-connectors/index.md) topic for additional information.

## Connection Tables

A [
Connection Table
](../../../toolkit/xml-configuration/connectors/connectiontable/index.md) represents the potential output of the connection's [
Export Task
](../../../toolkit/xml-configuration/jobs/tasks/agent/exporttask/index.md), when the connection's package allows export. The export process generates CSV files (our connection tables) whose names start with the connection's identifier. The files' suffixes depend on the connector. See the [References: Connectors](../../references-connectors/index.md) topic for additional information.
...
](../../../toolkit/xml-configuration/connectors/entityassociationmapping/index.md) in order to link the connectors' properties to the source files and columns from the managed systems.
...
![connectiontables_ui_v60](../../../../../../../static/img/product_docs/usercube/usercube/integration-guide/connectors/configuration-details/connections/connectiontables_ui_v60.webp)
...
](../../how-tos/configure-secured-options/index.md) topic for additional information.
