...
PowerShellProv
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/powershellprov/index.md) connector.
...
The [
PowerShellProv
](/docs/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/powershellprov/index.md) isn't mandatory in the JSON file. If it isn't provided, don't perform this step.
