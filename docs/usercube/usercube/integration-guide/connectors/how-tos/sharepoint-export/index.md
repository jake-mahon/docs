...
This guide shows how to set up a [SharePoint](../../references-connectors/sharepoint/index.md)
...
This guide focuses on the[ Architecture ](../../../architecture/index.md) method. Remember that
settings can also be input through [ Architecture ](../../../architecture/index.md).
...
[ Upward Data Synchronization ](../../../synchronization/upward-data-sync/index.md) task.
...
In this example, `C:/Usercube/Temp/ExportOutput/SP_otherSites.csv` is the path of the exported CSV
...
[Toolkit for XML Configuration](../../../toolkit/index.md) topic for additional information.
...
the[ Create a Working Directory ](../../../../installation-guide/production-ready/working-directory/index.md)
...
- Use the [ Connector ](../../../toolkit/xml-configuration/connectors/connector/index.md)element to
...
[Entity Model](../../../entity-model/index.md). See
the[ Identity Management ](../../../../introduction-guide/overview/identity-management/index.md)topic
for additional information.

The [Entity Model](../../../entity-model/index.md) should match as closely as possible the structure
of the SharePoint data relevant for Identity Manager. It is designed by analyzing the SharePoint
data structure, and describing said data with [Entity Model](../../../entity-model/index.md)and
[ Entity Association ](../../../toolkit/xml-configuration/metadata/entityassociation/index.md).

Eventually, it is up to the integration team to design the
[Entity Model](../../../entity-model/index.md) that best serves the
[ Assignment Policy ](../../../role-model/role-model-rules/index.md)needs. It will be refined
...
The [Entity Model](../../../entity-model/index.md) for the SharePoint connector is written in the
applicative configuration. See the [Toolkit for XML Configuration](../../../toolkit/index.md) topic
...
Declaring an [Entity Model](../../../entity-model/index.md) is achieved with the `<EntityType>` tag
...
- **DisplayName_Li, i ? [1..16]** are used in the UI to identify this
  [Entity Model](../../../entity-model/index.md)for the end-user. **DisplayName_L1** is the name of
...
[Entity Model](../../../entity-model/index.md) types are associated through their navigation
properties with
[ Entity Association ](../../../toolkit/xml-configuration/metadata/entityassociation/index.md)
elements.
...
[ Entity Type Mapping ](../../../toolkit/xml-configuration/connectors/entitytypemapping/index.md)
...
A [ Menu Item ](../../../toolkit/xml-configuration/user-interface/menuitem/index.md) can be added to
...
The
[Display Entity Type](../../../toolkit/xml-configuration/user-interface/displayentitytype/index.md)
...
An `InternalDisplayName` can also be declared as an [Entity Model](../../../entity-model/index.md).
...
the[ Usercube-Invoke-Job ](../../../executables/references/invoke-job/index.md) uses:

- a [ Profile ](../../../toolkit/xml-configuration/access-control/profile/index.md) associated with
...
the[ Job Execution Access Control Rules ](../../../toolkit/xml-configuration/configuration/scaffoldings/templates/jobexecutionaccesscontrolrules/index.md)
scaffolding.
