...
[ Microsoft Entra ID](../../../references-connectors/microsoftentraid/index.md) connector (formerly
Microsoft Azure AD).
...
[ Set Up Incremental Synchronization ](../index.md) topic for additional information.
...
>                         ```
>
> ./Usercube-Invoke-Job.exe -j "AzureAD_Synchronization_Delta" --api-secret secret --api-client-id
