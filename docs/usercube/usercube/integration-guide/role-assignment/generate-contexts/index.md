...
Context Rule
](../../toolkit/xml-configuration/provisioning/contextrule/index.md) on the context rule.
...
The [property value copy](#extension-of-a-property) can be leveraged to extend a chosen position when for some time the identity does not have one.
