...
is written in the [Toolkit for XML Configuration](../toolkit/index.md) in the form of an
...
[](../toolkit/xml-configuration/metadata/entitytype/index.md)[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md)
...
[Entity Type](../toolkit/xml-configuration/metadata/entitytype/index.md) element allows the
...
using the [Expressions](../toolkit/expressions/index.md).
...
[Entity Type](../toolkit/xml-configuration/metadata/entitytype/index.md). Otherwise, a default value
...
[Entity Type](../toolkit/xml-configuration/metadata/entitytype/index.md) or
...
[Upward Data Synchronization](../synchronization/upward-data-sync/index.md)) and entity properties.
This information is provided by the
[Entity Type Mapping](../toolkit/xml-configuration/connectors/entitytypemapping/index.md), their
[Entity Type Mapping](../toolkit/xml-configuration/connectors/entitytypemapping/index.md)and
[Entity Association Mapping](../toolkit/xml-configuration/connectors/entityassociationmapping/index.md).

Every [Entity Type Mapping](../toolkit/xml-configuration/connectors/entitytypemapping/index.md)maps
a CSV column to a scalar [Entity Type](../toolkit/xml-configuration/metadata/entitytype/index.md).
...
[Entity Type Mapping](../toolkit/xml-configuration/connectors/entitytypemapping/index.md) using the
...
[Entity Type Mapping](../toolkit/xml-configuration/connectors/entitytypemapping/index.md). This
