...
The model for all resources (that means data from the managed system, reference data and identities) is written in the [Toolkit for XML Configuration](/docs/usercube/usercube/integration-guide/toolkit/index.md) in the form of an [Entity-Relationship model](https://en.wikipedia.org/wiki/Entity–relationship_model), called the __entity model__.
...
Every resource is assigned an [](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md)[
Entity Type
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) that describes its shape.
...
An [](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md)[
Entity Type
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) includes:

- One or more [](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md#)[
  Entity Type
  ](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md)
- Zero or more [
  Entity Association
...
An [
Entity Association
](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/metadata/entityassociation/index.md) describes a link between entity types. It connects a pair of navigation properties, from two __Entity Types__.
...
The __entity model__ is enhanced with __records__ to handle positions and movements of staff. See the [Identity Management](/docs/usercube/usercube/integration-guide/identity-management/index.md) topic for additional information.
