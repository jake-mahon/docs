...
- [Resource Type](../toolkit/xml-configuration/provisioning/resourcetype/index.md) and [Resource Type](../toolkit/xml-configuration/provisioning/resourcetype/index.md);
...
Perform Role Mining
](../../user-guide/optimize/assignment-automation/role-mining/index.md) for the automation of role assignments.
