...
](/docs/product_docs/usercube/usercube/user-guide/set-up/initial-identities-loading/index.md) topic to learn how to create the workforce repository.
  
Then [
Update Identities in Bulk
](/docs/product_docs/usercube/usercube/user-guide/maintain/identity-data-modification/mass-update/index.md) with the same kind of process, and [
Update an Individual Identity
](/docs/product_docs/usercube/usercube/user-guide/maintain/identity-data-modification/individual-update/index.md) via Identity Manager's workflows.
