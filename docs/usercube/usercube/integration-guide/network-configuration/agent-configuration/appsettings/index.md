...
| Serilog (optional)                                                    | Logger setting        | Settings to configure the logging service, complying to the Logger properties and structure. See the [ Monitoring ](../../../monitoring/index.md) topic for additional information. Example: `appsettings.json   {     "Serilog": {       "WriteTo": [ "Console" ],       "MinimumLevel": {         "Default": "Error",         "Override": {           "Usercube": "Information"           }         }       }   }                           `                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
discouraged. It should always be encrypted using the Usercube-Protect-CertificatePassword tool.
See[ Usercube-Protect-CertificatePassword ](../../../executables/references/protect-certificatepassword/index.md)
...
Vault connection. See the [Azure Key Vault](../azure-key-vault/index.md) topic for additional
information.
