...
Agent Configuration
](/docs/usercube/usercube/integration-guide/network-configuration/agent-configuration/index.md). This configuration is stored in the __appsettings.connection.json__ file, located inside the [Application Settings](/docs/usercube/usercube/integration-guide/network-configuration/agent-configuration/appsettings/index.md).

The __appsettings.connection.json__ file has the exact same structure as the other [appsettings.agent](/docs/usercube/usercube/integration-guide/network-configuration/agent-configuration/appsettings-agent/index.md) file.
