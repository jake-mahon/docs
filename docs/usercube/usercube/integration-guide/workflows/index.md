...
[ Activity Templates ](activity-templates/index.md)that defines how transitions occur from a
...
[ Menu Item ](../toolkit/xml-configuration/user-interface/menuitem/index.md) make workflows
...
See the [ Configure a Homonym Detection ](how-to/configure-homonym-test/index.md)topic for
