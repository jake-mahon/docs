...
A notification can be configured to be sent to one or several users right after the execution of a given activity in a [Workflows](/docs/product_docs/usercube/usercube/integration-guide/workflows/index.md).
...
The configuration is made through the XML tag [
Notification
](/docs/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/notifications/notification/index.md).
