...
A notification can be configured to be sent to one or several users right after the execution of a given activity in a [Workflows](../../workflows/index.md).
...
Notification Aspect
](../../toolkit/xml-configuration/workflows/aspects/notificationaspect/index.md).
...
](../../toolkit/xml-configuration/jobs/tasks/server/sendnotificationstask/index.md) as part of a job.
...
The configuration is made through the XML tag [
Notification
](../../toolkit/xml-configuration/notifications/notification/index.md).
