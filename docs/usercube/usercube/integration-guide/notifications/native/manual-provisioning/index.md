...
Manual Ticket
](../../../connectors/references-packages/manual-ticket/index.md) package.
...
The permission can be configured in an [Access Control Rule](../../../toolkit/xml-configuration/access-control/accesscontrolrule/index.md) so that notifications are disabled.
