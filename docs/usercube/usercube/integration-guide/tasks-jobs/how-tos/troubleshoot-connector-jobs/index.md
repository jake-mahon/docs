...
See the [
Usercube-Export-Configuration
](/docs/product_docs/usercube/usercube/integration-guide/executables/references/export-configuration/index.md) topic for additional information on how to prepare the synchronization executable ```Usercube-Prepare-Synchronization```.
...
Thresholds
](/docs/product_docs/usercube/usercube/integration-guide/synchronization/synchro-thresholds/index.md) is exceeded, the change list can be seen in the __Synchronization Changes__ tab, accessible from the job progress screen.
