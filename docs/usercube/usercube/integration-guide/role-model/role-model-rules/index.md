...
](../../../introduction-guide/overview/entitlement-management/index.md) and how it influences assigning entitlements to identities. Let's sum up the key principles here.
...
The integration team defines [Context Rule](../../toolkit/xml-configuration/provisioning/contextrule/index.md) and [Record Section](../../toolkit/xml-configuration/provisioning/recordsection/index.md)in the applicative configuration that assigns, for every identity, a context as a set of dimension-value pair.

The details of how contexts are generated can be found in [Generate Contexts](../../role-assignment/generate-contexts/index.md).
...
The role model is built iteratively, together with the [Entity Model](../../entity-model/index.md), as they closely influence one another.
...
For every [Single Role](../../toolkit/xml-configuration/provisioning/singlerole/index.md) assigned to an identity, fine-grained entitlements need to be granted. Those are the resource values in a managed system.
...
- [Resource Correlation Rule](../../toolkit/xml-configuration/provisioning/resourcecorrelationrule/index.md), that identify for an identity, the target resources to fulfill;
