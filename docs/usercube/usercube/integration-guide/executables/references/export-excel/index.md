...
| --- | --- |
| --not-incremental   optional | __Type__    No Value   __Description__ Specifies the synchronization mode, its presence meaning complete, its absence incremental. |
| --is-regex   optional | __Type__    No Value   __Description__ The file's name is a regex so we find the last generated corresponding file. |
|  |  |
| --- | --- |
