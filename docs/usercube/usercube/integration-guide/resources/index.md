...
](../synchronization/upward-data-sync/index.md) into Identity Manager's database. This persisted set of data, called _resources_, is stored in the __Resource Repository__.
...
1. Input data directly from the [Toolkit for XML Configuration](../toolkit/index.md). This is useful for a very limited amount of data. This is very often used for debugging or testing, less often in production.
