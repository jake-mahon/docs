...
See the [ References: Logs ](references/index.md) topic for additional information on the list of
existing logs.
...
- `Override` allows the user to set a different minimum log level for logs from a specific namespace
  (See the [ Monitoring ](index.md) topic for additional information.)
...
destination such as standard consoles, files and logging services. See the [ Monitoring ](index.md)
...
See the [ Export Logs to a Log Management System ](how-tos/qradar-setting/index.md) topic to learn
...
This example configures _Serilog_ to write log messages to the `../Temp/Server/usercube-log.txt`
file.
