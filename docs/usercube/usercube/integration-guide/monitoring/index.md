...
See the [
References: Logs
](/docs/product_docs/usercube/usercube/integration-guide/monitoring/references/index.md) topic for additional information on the list of existing logs.
...
](/docs/product_docs/usercube/usercube/integration-guide/monitoring/how-tos/qradar-setting/index.md) topic to learn how to send Identity Manager's logs to your QRadar system.
