...
See the [Search Bar](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/searchbar/index.md) topic for additional information.
...
To add a default filter, you must add both of the following properties to a [Search Bar](/docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/searchbar/index.md):
...
See the [
Create Menu Items
](/docs/usercube/usercube/integration-guide/ui/how-tos/create-menu-items/index.md)topic for additional information
