...
[Identity Manager](https://community.netwrix.com/c/usercube/announcements/150) area of our new
community.
...
[Review Assigned Roles](../user-guide/administrate/assigned-roles/index.md) topic for additional
information.
...
[Create a Role Manually](../user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md),
[Resource Type](../integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md)
and
[Remove Redundant Assignments](../user-guide/optimize/assignment-automation/remove-redundant-assignments/index.md)
...
[Configure Global Settings](../user-guide/set-up/configure-global-settings/index.md) topic for
...
[Usercube-Check-ExpressionsConsistency](../integration-guide/executables/references/check-expressionsconsistency/index.md)
topic for additional information.
...
[Usercube-Export-Bacpac](../integration-guide/executables/references/export-bacpac/index.md) topic
