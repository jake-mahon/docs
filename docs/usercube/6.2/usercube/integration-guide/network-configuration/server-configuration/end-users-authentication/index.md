...
the[Install the Server](../../../../installation-guide/production-ready/server/index.md)topic for
...
applicative configuration. See the [Various XML Settings](../../settings/index.md)topic for
additional information.
...
`<usercube-server-address>` is the address of your Identity ManagerServer such as
https://usercube.contoso.com.
...
[Select User by Identity Query Handler Setting](../../../toolkit/xml-configuration/metadata/settings/selectuserbyidentityqueryhandlersetting/index.md)
...
https://usercube.contoso.com and `<callback-path>` can be set up to any value chosen by the user
...
your Identity Manager Server such as `https://usercube.contoso.com`.
...
[Usercube-Protect-CertificatePasswor](../../../executables/references/protect-certificatepassword/index.md)
...
Vault connection. See the [Azure Key Vault](../../agent-configuration/azure-key-vault/index.md)
topic for additional information.
...
Identity Query Handler Setting element. See the [Various XML Settings](../../settings/index.md)
topic for additional information.
