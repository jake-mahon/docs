...
Identity Manager often needs to connect to [Connectors](../../../connectors/index.md) with
...
Any [Connectors](../../../connectors/index.md) using one of these attributes as key can retrieve the
associated value from CyberArk.

> For example,
> [Active Directory](../../../connectors/references-connectors/activedirectory/index.md) can
...
| SafeName required                       | **Type** String **Description** Name of the safe containing the [ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) used by Identity Manager.                                                               |
| ApplicationId required                  | **Type** String **Description** [CyberArk's AAM Credential Providers ](index.md) of the application that can access the safe.                                                                                                             |
...
Once [CyberArk's AAM Credential Providers ](index.md), Identity Manager retrieves the sensitive
