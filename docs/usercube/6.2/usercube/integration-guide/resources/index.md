...
[ Upward Data Synchronization ](../synchronization/upward-data-sync/index.md) into Identity
...
1. Input data directly from the [Toolkit for XML Configuration](../toolkit/index.md). This is useful
...
3. [ Upward Data Synchronization ](../synchronization/upward-data-sync/index.md) from a CSV file.
