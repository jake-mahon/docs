...
according the Usercube schema. The [ Recommendations ](recommendations/index.md) part of this
...
The
[ Deploy Configuration Task ](xml-configuration/jobs/tasks/server/deployconfigurationtask/index.md)tool
is used to **import** a new version of the configuration (from the XML files set).
The[ Usercube-Export-Configuration ](../executables/references/export-configuration/index.md) can be
