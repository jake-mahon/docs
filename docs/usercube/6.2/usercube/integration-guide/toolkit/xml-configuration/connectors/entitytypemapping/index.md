...
An entity type mapping links a given [ Entity Type ](../../metadata/entitytype/index.md)'s
properties with the source columns of the corresponding managed system. The entity type mapping
specifies the related [ Connector ](../connector/index.md) and the path to the CSV source file which
...
See the example of a whole [ Connector ](../connector/index.md) containing an entity type mapping.
...
Contains all the [ Entity Type ](../../metadata/entitytype/index.md) properties that can be
