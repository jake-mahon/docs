...
- #### [ConnectorResourceTypeAccessControl](connectorresourcetypeaccesscontrol/index.md)
    Gives the rights to create and update resource types, generate provisioning orders and fulfill
    from the connector screen.- ####
    [SettingsAccessControlRules](settingsaccesscontrolrules/index.md) Generates the permissions to
