...
[Single Role Rule](../singlerolerule/index.md) which will assign
[ Single Role ](../singlerole/index.md) to certain users matching given criteria.

The [ Build Role Model Task ](../../jobs/tasks/server/buildrolemodeltask/index.md) replaces the
