...
through the [ Send Notifications Task ](../../jobs/tasks/server/sendnotificationstask/index.md) as
part of a job.
...
| QueryFilterExpression optional    | **Type** String **Description** C# expression that returns a Identity Manager Squery in order to define the sending condition of the notification. The expression's variable type is defined in `OwnerEntityType`. See the [Expressions](../../../expressions/index.md) topic for additional information. |
...
| TitleExpression optional          | **Type** String **Description** C# expression that defines the email's subject. The expression's variable type is defined in `OwnerEntityType`. See the [Expressions](../../../expressions/index.md) topic for additional information.                                                                    |
