...
entity. See the [ Connector ](../../connectors/connector/index.md)topic for additional information
...
| Identifier required     | **Type** String **Description** Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [ Reserved identifiers ](../../../reservedidentifiers/index.md).                                                            |
...
[Expressions](../../../expressions/index.md) topic for additional information on how to
...
| Identifier required                   | **Type** String **Description** Unique identifier of the property. It must be unique to the parent entity type scope. Cannot be a [ Reserved identifiers ](../../../reservedidentifiers/index.md) and can only contain numbers (except the first character) and letters without accents. **Note:** cannot be "Id".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
