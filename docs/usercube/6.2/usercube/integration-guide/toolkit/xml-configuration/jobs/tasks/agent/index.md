...
- [ Activity Instance Actor Task ](activityinstanceactortask/index.md)

    Update the Actors for the workflows instances.

- [ Create Database Views Task ](createdatabaseviewstask/index.md)

    Generates entity model SQL views in the Identity Manager database.

- [ Export Task ](exporttask/index.md)
...
- [ Invoke Api Task ](invokeapitask/index.md)

    Tool to launch any Identity Manager API.

- [ Invoke Aspects Task ](invokeaspectstask/index.md)
...
- [ Prepare Synchronization Task ](preparesynchronizationtask/index.md)
