...
[ Conforming Assignments ](../conformingassignmentcomputation/index.md). This list (list `A`)
...
the[ Existing Assignments ](../existingassignmentsdeduction/index.md) every synced resource can be
