...
Identity Manager's [Entity Model](../../entity-model/index.md) and translates them into resources
...
are written to the
[Application Settings](../../network-configuration/agent-configuration/appsettings/index.md) waiting
...
[Application Settings](../../network-configuration/agent-configuration/appsettings/index.md). The
whole can be scheduled and orchestrated by a [ Jobs ](../../tasks-jobs/jobs/index.md).
