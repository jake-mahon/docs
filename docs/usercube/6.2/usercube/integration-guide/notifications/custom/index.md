...
given activity in a [Workflows](../../workflows/index.md).
...
[ Notification Aspect ](../../toolkit/xml-configuration/workflows/aspects/notificationaspect/index.md).

## Periodic Notifications

A notification can be configured to be sent to a given user on a regular basis at specified times,
through the
[ Send Notifications Task ](../../toolkit/xml-configuration/jobs/tasks/server/sendnotificationstask/index.md)
as part of a job.
...
The configuration is made through the XML tag
[ Notification ](../../toolkit/xml-configuration/notifications/notification/index.md).
