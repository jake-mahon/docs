...
A [ Risk ](../../toolkit/xml-configuration/provisioning/risk/index.md) describes a sensitive
...
scores are the priority of the next [Access Certification](../accesscertification/index.md)
campaign.

See the [ Manage Risks ](../../../user-guide/optimize/risk-management/index.md)topic for additional
information on how to use the risk management module to identify entitlement assignments that pose a
security risk.

## Risk Definition

A [ Risk ](../../toolkit/xml-configuration/provisioning/risk/index.md) is an object that describes a
...
- assigned to identities belonging to a specific entity type that was decided during the risk
  creation;
- organized inside a [ Risk Management ](index.md);
- linked to an [ Risk Management ](index.md).
...
[ Risk ](../../toolkit/xml-configuration/provisioning/risk/index.md) are assigned to resources
...
[ Risk ](../../toolkit/xml-configuration/provisioning/risk/index.md) rules. For each new
...
[Resource Type](../../toolkit/xml-configuration/provisioning/resourcetype/index.md) within Identity
Manager.
...
1. Choose an [ Entity Type ](../../toolkit/xml-configuration/metadata/entitytype/index.md) of which
...
Once [ Risk ](../../toolkit/xml-configuration/provisioning/risk/index.md) are assigned to
...
[Access Certification](../accesscertification/index.md) campaign. The identity with the highest risk
