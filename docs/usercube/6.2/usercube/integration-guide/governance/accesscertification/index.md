...
- Assignments presenting a certain level of risk. See the
  [ Manage Risks ](../../../user-guide/optimize/risk-management/index.md) topic for additional
  information.
...
See the
[ Access Review Administration Access Control Rules ](../../toolkit/xml-configuration/configuration/scaffoldings/accesscontrolrules/accessreviews/accessreviewadministrationaccesscontrolrules/index.md)
topic for additional information.

The administrator profile, created with CreateAdministratorProfile scaffolding, already has these
permissions. See the
[ Create Administrator Profile ](../../toolkit/xml-configuration/configuration/scaffoldings/templates/createadministratorprofile/index.md)
topic for additional information.
...
the
[ AccessCertificationCampaignPolicy ](../../toolkit/xml-configuration/access-certification/accesscertificationcampaignpolicy/index.md)
topic for additional information.
...
UI. See the [Access Certification](index.md) topic for additional information.
