...
See the [Access Certification](accesscertification/index.md) topic to learn how to configure
...
See the [ Risk Management ](risks/index.md) topic to learn how to configure risks.
