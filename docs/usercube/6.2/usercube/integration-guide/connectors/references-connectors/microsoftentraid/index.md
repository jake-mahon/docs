...
See the[ Microsoft Entra ID ](../../references-packages/azure-active-directory/index.md)topic for
...
See the[Register for Microsoft Entra ID](../../how-tos/azuread-register/index.md) topic on how to
...
the[ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md)topic for
additional information.
...
the[Evaluate Policy](../../../role-assignment/evaluate-policy/index.md)topic for additional
information.
...
See
the[appsettings.agent](../../../network-configuration/agent-configuration/appsettings-agent/index.md)
...
- An [Azure Key Vault](../../../network-configuration/agent-configuration/azure-key-vault/index.md)
  safe;
