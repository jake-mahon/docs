...
[ PowerShellProv ](../../references-connectors/powershellprov/index.md) connector to fulfill data in
...
attribute [ PowerShellProv ](../../references-connectors/powershellprov/index.md) and add required
...
[ PowerShellProv ](../../references-connectors/powershellprov/index.md) via Azure Key Vault or
...
the[Toolkit for XML Configuration](../../../toolkit/index.md) and linked to an Agent.
...
[ Assignment Policy ](../../../role-model/role-model-rules/index.md) needs. It will most likely be
...
- [Resource Type](../../../toolkit/xml-configuration/provisioning/resourcetype/index.md) which
...
the [ Fulfill Microsoft Exchange via PowerShell ](index.md) topic for additional information.
...
[DisplayEntityType](../../../toolkit/xml-configuration/user-interface/displayentitytype/index.md)
...
[ Entity Type ](../../../toolkit/xml-configuration/metadata/entitytype/index.md). The
...
connector[ Fulfill Microsoft Exchange via PowerShell ](index.md).
...
in[ Fulfill Microsoft Exchange via PowerShell ](index.md).
...
the[ Fulfill Microsoft Exchange via PowerShell ](index.md) settings in accordance with the
configuration.
