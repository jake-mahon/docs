...
[ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) which needs to be
...
See the [ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) topic for
...
See the [References: Connectors](../../references-connectors/index.md) topic for additional
information.

## Connection Tables

A [ Connection Table ](../../../toolkit/xml-configuration/connectors/connectiontable/index.md)
represents the potential output of the connection's
[ Export Task ](../../../toolkit/xml-configuration/jobs/tasks/agent/exporttask/index.md), when the
...
the [References: Connectors](../../references-connectors/index.md) topic for additional information.
...
See the [ Configure Secured Options ](../../how-tos/configure-secured-options/index.md) topic for
additional information.
