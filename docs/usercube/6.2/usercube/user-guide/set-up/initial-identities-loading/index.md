...
See the
[ Identity Repository ](../../../integration-guide/identity-management/identity-repository/index.md)
...
1. [ Configure Unique Property Generation ](generate-unique-properties/index.md) for all users,
   pre-existing and new, who do not have them yet.
2. [Load Identities to Identity Manager](load-identities/index.md) to Identity Manager based on the
   recommended attributes from the provided organizational model
   [Template Description](template-description/index.md).
3. [ Adjust the Workforce Data Model ](adjust-datamodel/index.md) following Identity Manager's
   suggestions.
...
the [ Configure a User Profile ](../user-profile-configuration/index.md) topic for additional
information.
