...
and [Load Identities to Identity Manager](../load-identities/index.md) topics for additional
information.
...
3. Observe the result and adjust manually the data model if needed, by clicking on the properties.
    ...
    [ Modify the Identity Data Model ](../../../optimize/identity-datamodel-modification/index.md)
