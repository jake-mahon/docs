...
1. Start by declaring the [ Create the Entity Type ](../entity-type-declaration/index.md).
    ...
    - **APPLICATION METADATA**: fields about the future display of the properties inside Identity
      Manager.
        ...
        - `Format`: format used for the property's display in Identity Manager, for search tools and
          ...
          [ References: Format for the EntityPropertyMapping ](../../../../../integration-guide/connectors/entitypropertymapping-format/index.md)
...
Before saving, you must first[ Select Primary Keys ](../key-selection/index.md)for the entity type.
