...
[ Entity Type Mapping ](../../../../../integration-guide/toolkit/xml-configuration/connectors/entitytypemapping/index.md)key
...
resource during the[ Synchronize Data ](../../../synchronization/index.md). It must be unique and
...
1. Start by defining the entity type's scalar properties. See the
   [ Define Scalar Properties ](../scalar-property-definition/index.md) topic for additional
   information.
...
[ Define Navigation Properties ](../navigation-property-definition/index.md) and/or
