...
[ Create a Resource Type ](resource-type-creation/index.md).
...
or below 100%. See the [ Correlate Resources ](correlation/index.md) topic for additional
information.
...
[Policy](../../../integration-guide/toolkit/xml-configuration/provisioning/policy/index.md) which
...
resource types. See the [Create a Policy](../../optimize/policy-creation/index.md) topic for
...
1. Create at least one [ Create a Resource Type ](resource-type-creation/index.md);
2. Create the appropriate [ Correlate Resources ](correlation/index.md);
3. Create the appropriate [ Classify Resources ](classification/index.md) for accounts that do not
   have an owner.

Netwrix Identity Manager (formerly Usercube) recommends creating/modifying/deleting correlation and
classification rules using [ Perform a Simulation ](../../optimize/simulation/index.md) in order to
