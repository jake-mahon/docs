...
- the required set of classification and/or correlation rules; See the
  [ Classify Resources ](../classification/index.md), and
  [ Correlate Resources ](../correlation/index.md) topics for additional information.
...
- the type of provisioning (manual or automatic). See the
  [Provision](../../../administrate/provisioning/index.md) topic for additional information.
...
provisioning. See the [Create an Entity Type](../../connect-system/entity-type-creation/index.md),
[ Correlate Resources ](../correlation/index.md),
and[Provision](../../../administrate/provisioning/index.md) topics for additional information.
...
See the
[ Create the Workforce Repository ](../../initial-identities-loading/index.md)[ Connect to a Managed System ](../../connect-system/index.md),
and [ Synchronize Data ](../../synchronization/index.md) topics for additional information.
...
2. Fill in the fields.
    ...
    - `Policy`: [policy](../../../optimize/policy-creation/index.md) in which the resource type
      exists.
    ...
    - `Category`: category assigned to the resource type. It can be chosen from among the existing
      categories or [created](../../single-roles-catalog-creation/index.md) directly from the
    ...
    - `Approve Role Implicitly`: relevant only for workflows with at least a simple approval
      ...
      [Create a Policy](../../../optimize/policy-creation/index.md) topic for additional
      information.
    ...
    - `Arguments Expression`: when using a connection for automatic provisioning, C# expression used
      ...
      [provisioning](../../../administrate/provisioning/index.md) orders, such as the identifier of
      the workflow to launch within Identity Manager, or the identifier of the user's record to
      copy. See the [Provision](../../../administrate/provisioning/index.md) topic for additional
      information.
    ...
    - `Require Provisioning Review`: forces an additional mandatory review of all provisioning
      ...
      [ Review Provisioning ](../../../administrate/provisioning/provisioning-review/index.md)
      screen).
