...
How to tweak the
[References: Permissions](../../../integration-guide/profiles-permissions/permissions/index.md) for
actions within Identity Manager, for a set of basic
[ Assigned Profile ](../../../integration-guide/toolkit/xml-configuration/access-control/assignedprofile/index.md).
...
- administration, which gives access to [Administrate](../../administrate/index.md) actions,
...
- reports, which gives access to Identity Manager's predefined reports about workforce. See the
  [ Generate Reports ](../../administrate/reporting/index.md) topic for additional information.
...
[Assign Users a Profile](../user-profile-assignment/index.md) topic for additional information.
...
See the [Assign Users a Profile](../user-profile-assignment/index.md) topic for additional
information.

## Next Steps

Once user profiles are configured, integrators can start configuring onboarding workflows. See the
[ Create the Workforce Repository ](../initial-identities-loading/index.md) topic for additional
information.
