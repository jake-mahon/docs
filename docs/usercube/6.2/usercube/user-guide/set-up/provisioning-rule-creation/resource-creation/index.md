...
[Provision](../../../administrate/provisioning/index.md) these resources, i.e. write them to the
managed system.
...
4. See the new account in the user's **View Permissions** tab.
    ...
    related to a [ Compute a Navigation Property ](../navigation-property-computation/index.md).
