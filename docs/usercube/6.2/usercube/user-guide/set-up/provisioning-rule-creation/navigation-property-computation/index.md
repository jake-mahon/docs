...
[Resource Type](../../../../integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md)
...
the[ Define Navigation Properties ](../../connect-system/entity-type-creation/navigation-property-definition/index.md)
topic for additional information. We are going to provision these properties, i.e. write them to the
managed system. See the [Provision](../../../administrate/provisioning/index.md) topic for
...
dimensions. See
the[ Create Roles in the Role Catalog ](../../single-roles-catalog-creation/index.md) topic for
additional information on the assignment of a single role and
[ Conforming Assignments ](../../../../integration-guide/role-assignment/conformingassignmentcomputation/index.md)
...
[ Classify Resources ](../../categorization/classification/index.md) topic for additional
information.
...
[ Categorize Resources ](../../categorization/index.md) topic for additional information.
...
- **Target Object**: property (or expression of properties) from the entity type pointed by the
  ...
  [Expressions](../../../../integration-guide/toolkit/expressions/index.md) topic for additional
  information.
...
- `Confidence Rate`: rate expressing the confidence in this link, and its priority order. See
  the[ Classify Resources ](../../categorization/classification/index.md) topic for additional
  information.
...
[ Perform a Simulation ](../../../optimize/simulation/index.md) topic for additional information.
...
See
the[ Review an Unauthorized Account ](../../../administrate/non-conforming-assignment-review/unauthorized-account-review/index.md)
and
the[ Reconcile a Role ](../../../administrate/non-conforming-assignment-review/role-reconciliation/index.md)
