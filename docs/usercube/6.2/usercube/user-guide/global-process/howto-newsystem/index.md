...
[ Update Identity Data ](../../maintain/identity-data-modification/index.md)in production
...
[ Perform Access Certification ](../../administrate/access-certification/index.md)access
certification and
...
1. [ Connect to a Managed System ](../../set-up/connect-system/index.md): create the appropriate
   connector with its connections and entity types.
2. [ Synchronize Data ](../../set-up/synchronization/index.md) into Identity Manager.
...
3. [ Categorize Resources ](../../set-up/categorization/index.md) in order to classify them
   according to their intent, and correlate these resources with their owners.
4. [ Create a Provisioning Rule ](../../set-up/provisioning-rule-creation/index.md) to write to the
   system in order to update the resources' properties directly in the system.
5. Adjust the rules by
   [ Reconcile a Property ](../../administrate/non-conforming-assignment-review/property-reconciliation/index.md)resources,
...
6. [ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) for
   applications managed by the system.
7. [ Automate Assignments ](../../optimize/assignment-automation/index.md) if needed: use Role
