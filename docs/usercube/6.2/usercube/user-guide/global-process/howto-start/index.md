...
[ Update Identity Data ](../../maintain/identity-data-modification/index.md) topic for additional
information.
...
you can also
[Review Orphaned and Unused Accounts](../../administrate/orphan-unused-account-review/index.md),
[Provision](../../administrate/provisioning/index.md) the AD,
[ Reconcile a Property ](../../administrate/non-conforming-assignment-review/property-reconciliation/index.md)properties,
and [ Generate Reports ](../../administrate/reporting/index.md), for example the list of profiles
assigned to users.
...
[ Reconcile a Role ](../../administrate/non-conforming-assignment-review/role-reconciliation/index.md),
[ Perform Access Certification ](../../administrate/access-certification/index.md) and
[ Request Entitlement Assignment ](../../administrate/manual-assignment-request/index.md), and also
[ Generate Reports ](../../administrate/reporting/index.md), for example the list of assigned single
roles.
...
2. [ Create the Workforce Repository ](../../set-up/initial-identities-loading/index.md): configure
...
3. Connect Identity Manager to the system by creating a connector. See the
   [ Connect to a Managed System ](../../set-up/connect-system/index.md) topic for additional
   information.
4. [ Synchronize Data ](../../set-up/synchronization/index.md)the system's data into Identity
   Manager.

    Based on this, you can [ Generate Reports ](../../administrate/reporting/index.md), for example
...
5. [ Categorize Resources ](../../set-up/categorization/index.md) in order to classify them
   according to their intent, and correlate these resources with their owners.
6. [ Create a Provisioning Rule ](../../set-up/provisioning-rule-creation/index.md) to write to the
...
7. Adjust the rules by reconciling resources, i.e. analyze the differences spotted between the
   ...
   [ Reconcile a Property ](../../administrate/non-conforming-assignment-review/property-reconciliation/index.md)
...
8. [ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) for
   applications managed by the system.
9. [ Automate Role Assignments ](../../optimize/assignment-automation/automate-role-assignment/index.md)
...
12. Define the authentication mode by configuring `SelectUserByIdentityQueryHandlerSetting` (only in
    XML configuration), and [Assign Users a Profile](../../set-up/user-profile-assignment/index.md)
