...
previously read the [Introduction Guide](../introduction-guide/index.md) in order to be aware of the
...
[Introduction Guide](../introduction-guide/index.md) to fully benefit from the User Guide's content.
...
[Integration Guide](../integration-guide/index.md).
...
[ Global Process ](global-process/index.md).
...
Start by studying the [ Global Process ](global-process/index.md). that details every activity in
