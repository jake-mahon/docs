...
the[ Connect to a Managed System ](../../set-up/connect-system/index.md)provisioning.
...
[ Create the Workforce Repository ](../../set-up/initial-identities-loading/index.md).
...
[InternalWorkflow](../../../integration-guide/connectors/references-connectors/internalworkflow/index.md)
...
1. Outside Identity Manager,
   [ Model the Data ](../../set-up/connect-system/connector-modeling/index.md)of your connector.
2. Declare an HR connector using your local agent. See the
   [ Create the Connector ](../../set-up/connect-system/connector-declaration/index.md) topic for
...
3. Create an Export CSV connection for each HR file to connect. See the
   [Create a Connection](../../set-up/connect-system/connection-creation/index.md) topic for
   additional information.
...
4. [Create an Entity Type](../../set-up/connect-system/entity-type-creation/index.md) corresponding
...
5. Don't forget to reload and [ Synchronize Data ](../../set-up/synchronization/index.md) to access
