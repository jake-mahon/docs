...
[ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) topic for
...
the [ Dimension ](../../../integration-guide/toolkit/xml-configuration/metadata/dimension/index.md)
...
[Create a Role Manually](../../set-up/single-roles-catalog-creation/role-manual-creation/index.md)
topic for additional information.
...
that users'
[context rule](../../../integration-guide/toolkit/xml-configuration/provisioning/contextrule/index.md)
...
[ Request Entitlement Assignment ](../../administrate/manual-assignment-request/index.md) topic for
additional information.
