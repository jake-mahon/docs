...
push the [ Automate Assignments ](../index.md) wall further.
...
Catalog. See
the[ Create Roles in the Role Catalog ](../../../set-up/single-roles-catalog-creation/index.md)
topic for additional information.

### Technical Principles

Role mining works through
[ Mining Rule ](../../../../integration-guide/toolkit/xml-configuration/provisioning/miningrule/index.md)
that Identity Manager applies with the
[ Get Role Mining Task ](../../../../integration-guide/toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index.md).
...
2. Click on the addition button at the top right and fill in the fields.
    ...
    - `Entity Type`:
      [Create an Entity Type](../../../set-up/connect-system/entity-type-creation/index.md) on which
      the mining rule is applied, i.e. the entity type targeted by role mining's entitlement
      analysis.
    - `Category`:
      [ Create a Category ](../../../set-up/single-roles-catalog-creation/category-creation/index.md)
    ...
    - `Rule Policy`: [Create a Policy](../../policy-creation/index.md) in which the single role
...
4. Click on **Simulate** to perfom role mining in a simulation. See
   the[ Perform a Simulation ](../../simulation/index.md) topic for additional information.
...
[Remove Redundant Assignments](../remove-redundant-assignments/index.md) after any assignment rule
