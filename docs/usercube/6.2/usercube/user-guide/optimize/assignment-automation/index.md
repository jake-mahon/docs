...
1. Automation of the creation of the role model, i.e. both roles and navigation rules that represent
   ...
   [ Create Roles in Bulk ](../../set-up/single-roles-catalog-creation/role-naming-rule-creation/index.md)
...
3. Automation of the creation of said assignment rules through
   [ Perform Role Mining ](role-mining/index.md), based on existing data analysis.
...
[Remove Redundant Assignments](remove-redundant-assignments/index.md) after any assignment rule is
created or updated.
...
- Delay can happen: on the day a worker joins an organization, they rely on a manual action to get
  ...
  the[ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) topic
  ...
  [ Perform Access Certification ](../../administrate/access-certification/index.md). See the
...
1. [ Perform Role Mining ](role-mining/index.md) to approach the automation wall.
...
2. [ Generate Reports ](../../administrate/reporting/index.md)and analyze them with tools like Power
...
3. Improve data quality and quantity to move the automation wall.
    ...
    [ Perform Access Certification ](../../administrate/access-certification/index.md).
