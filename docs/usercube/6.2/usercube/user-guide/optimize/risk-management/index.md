...
How to use the [ Risk Management ](../../../integration-guide/governance/risks/index.md) module to
identify entitlement assignments that pose a security risk, especially about segregation of duties
and high privileges.

## Overview

A [ Risk ](../../../integration-guide/toolkit/xml-configuration/provisioning/risk/index.md)
...
[ Risk Management ](../../../integration-guide/governance/risks/index.md) is essential to auditing.
...
- Schedule and [ Perform Access Certification ](../../administrate/access-certification/index.md)
  accordingly.
...
See the [ Create the Workforce Repository ](../../set-up/initial-identities-loading/index.md) and
[ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) topics for
...
3. Fill in the fields.
    ...
    - `Entity Type`:
      [Create an Entity Type](../../set-up/connect-system/entity-type-creation/index.md) targeted by
      the risk.
    ...
    - `Exemption Policy` See the
      [ Risk Management ](../../../integration-guide/governance/risks/index.md) topic for additional
      information.
    - `Type`
    ...
    [Create an Entity Type](../../set-up/connect-system/entity-type-creation/index.md) topic for
    additional information.
...
4. Choose the resource type to be targetted by the risk. See the
   [ Categorize Resources ](../../set-up/categorization/index.md) topic for additional information.
