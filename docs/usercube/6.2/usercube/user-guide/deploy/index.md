...
- [ Plan Change Management ](change-management/index.md)
...
- [ Install the Production Agent ](production-agent-installation/index.md)

    How to install a local agent for production environment.

- [ Configure the Agent's Settings ](production-agent-installation/settings-files/index.md)

    How to configure the agent's application settings via the `web.config`, `appsettings.json` and
    `appsettings.agent.json` files.

- [ Install IIS via Server Manager ](production-agent-installation/iis-installation/index.md)

    How to configure the local server to install IIS via Server Manager.

- [ Configure the Pool and Site ](production-agent-installation/iis-configuration/index.md)

    How to configure the application pool and website via IIS.

- [ Set the Working Directory's Permissions ](production-agent-installation/directory-permissions/index.md)

    How to assign to the pool the right permissions on the working directory.

- [ Finalize the Installation ](production-agent-installation/finalization/index.md)

    How to finalize the installation of the agent.

- [Set Up User Authentication](authentication/index.md)

    How to allow end-users to authenticate and use the Identity Manager application.

- [Implement Identity Manager](implementation/index.md)
