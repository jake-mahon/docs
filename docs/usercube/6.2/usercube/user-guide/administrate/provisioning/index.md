...
See the [ Model the Data ](../../set-up/connect-system/connector-modeling/index.md) and
[Create a Connection](../../set-up/connect-system/connection-creation/index.md) topics for
...
enforcement in external systems. See the [ Provision Manually ](manual-provisioning/index.md) and
[ Provision Automatically ](automatic-provisioning/index.md)topics for additional information.
...
and [ Review Provisioning ](provisioning-review/index.md) topics for additional information.
...
[ Classify Resources ](../../set-up/categorization/classification/index.md) topic for additional
information.
...
See the [ Model the Data ](../../set-up/connect-system/connector-modeling/index.md),
[ Classify Resources ](../../set-up/categorization/classification/index.md),
[ Create a Provisioning Rule ](../../set-up/provisioning-rule-creation/index.md), and
