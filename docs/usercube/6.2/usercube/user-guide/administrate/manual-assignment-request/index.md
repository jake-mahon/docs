...
| Input                                                                                                                                                                                                 | Output               |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| [ Create the Workforce Repository ](../../set-up/initial-identities-loading/index.md) (required) [ Create Roles in the Role Catalog ](../../set-up/single-roles-catalog-creation/index.md) (required) | Updated entitlements |
