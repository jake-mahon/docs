...
the[ Usercube-Deploy Configuration](../../integration-guide/executables/references/deploy-configuration/index.md)
...
[Usercube-Server ](../../integration-guide/executables/references/server/index.md) topic for
...
configuration of your IGA project from scratch. See the [User Guide](../../user-guide/index.md)
topic for additional information.
