...
**1.\_\_**Before proceeding\_\_, you should go through the [ Overview ](../overview/index.md) and
[Requirements](../requirements/index.md) sections to make fundamental decisions about Identity
...
the relevant [Network Configuration](../../integration-guide/network-configuration/index.md)
sections.
...
The first step consists in [ Create a Working Directory ](working-directory/index.md).
