...
Please make sure that the [Database](../../requirements/database-requirements/index.md) requirements
...
[Install the Server](../server/index.md) topic for additional information.
