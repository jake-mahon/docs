...
![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Install/GPM1.png "GPM installation")

**Step 4 –** Enter **Password Policy Enforcer** in the provided field, and then press **Enter**.

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Install/GPM2.png "GPM Install")
...
**NOTE:** You must enter a UNC path so that other computers can access this file over the network. For example: \\file server\distribution point share\Netwrix\_PPE\_*version*.msi

**Step 5 –** Click **Open**.

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/Installing PPE_2.png)
