...
Follow the procedure in [Install Password Policy Enforcer on a Server](InstallationServer "Install Mail Service"), selecting the **Mailer Service** feature. You can select the other features if appropriate for the server.
