...
![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/ageMax.png "Maximum Age rule")
...
Type the body of the email in the large text box. The email is sent as plain text unless the body includes the  tag. If sending email as HTML, you must include the complete HTML document starting with  and ending with

. If the body is too long to fit in the text box, type a path to a file like this:
...
Opens the Notification settings. See the [Configuration Console](ConfigConsole#Notifi "Notifications") topic for additional details.