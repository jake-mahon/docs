...
The Password Policy Client is self-configuring and does not require manual configuration in most cases. See the [Install Password Policy Enforcer Client](../Install/InstallationClient "Install the Client") topic for additional details. You may need to manually configure the Password Policy Client if:
...
**Step 2 –** Go to Password Policy Enforcer install directory (C:\Program Files or C:\Program Files (x86)\Password Policy Enforcer) and copy the **PPEClt.adml** and **PPEClt.admx** files (highlighted in yellow):

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration.png)

**Step 3 –** Go to C:\Windows\Policy Definitions and paste the .admx file in the root of this folder.

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration2.png)

**Step 4 –** Go to C:\Windows\Policy Definitions\en-US and paste the .adml file in the root of this folder.

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration1.png)
...
**Step 6 –** In the left pane, navigate to **Forest: ** > **Domain** > ****, right-click **** and select **Create a GPO** in this domain and Link it here.

Once the GPO is configured, this view is available:

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration3.png)
...
![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration4.png)

**Step 9 –** Click on **Netwrix Password Policy Client** to open a list of modification settings.

![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/PPC_Configuration5.png)
...
![](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PPE Admin Guide/The Password Policy Client_3.jpg)
