...
![Character (Granular) Rule](../../Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranular.png "Character (Granular) Rule")

All the Character rules work identically, but each has their own default character set. A character set is the collection of characters that each rule searches for when checking a password. You can use the Character rules with their default character sets, or define your own. By default, the Password Policy Enforcer selects the Password Policy Enforcer character on the [Set Priorities](Manage Policies#Set "Set Policy Priorities") page.
...
![Restricting Characters](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranularRestrict.png "Restricting Characters")
...
![Require a number in position 2](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranularRestrict2.png "Require a number in position 2")
...
![Set up custom character set](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranularVowel.png "Set up custom character set")
...
![Require a numeric value](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranularRestrict3.png "Require a numeric value")

Set **Characters (Granular)** to not contain numeric values in the first two positions.

![Don't allow numeric values in first two positions](../../../../../static/images/PasswordPolicyEnforcer_11.0/Content/Resources/Images/PasswordPolicyEnforcer/Admin/Policies/CharGranularRestrict4.png "Don't allow numeric values in first two positions")