...
Change Tracker will attempt to link existing Devices and Groups to a Planned Change where similar names are found to Configuration Items (CMDB items) in the ITSM system. See the [Planned Changes Tab](/docs/product_docs/changetracker/changetracker/admin/tabs/plannedchanges.md) topic for additional information.
