...
![NetworkScan](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/networkscan.png)
...
![EditNetwork](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/editnetwork.png)
...
![EditNetworkCredentialName](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/editnetworkcredentialname.png)
...
![page_guide_53](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/page_guide_53.png)

__Step 3 –__ Once the initial poll has completed the duration will be required as a communications Event.

![page_guide_54](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/page_guide_54.png)
...
![EventDetailsNetwork](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/eventdetailsnetwork.png)
