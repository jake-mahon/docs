...
![NetworkScan](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/networkscan.png)
...
![EditNetwork](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/editnetwork.png)
...
![EditNetworkCredentialName](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/editnetworkcredentialname.png)
...
![page_guide_53](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/page_guide_53.png)

__Step 3 –__ Once the initial poll has completed the duration will be required as a communications Event.

![page_guide_54](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/page_guide_54.png)
...
![EventDetailsNetwork](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/eventdetailsnetwork.png)
