...
![ConfigTemplatesFIMFiles](/static/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/configtemplatesfimfiles.png)
...
__NOTE:__ For Advanced Options: see [Appendix B](/docs/product_docs/changetracker/changetracker/admin/matchrules/filefolderrules.md#Appendix-B) for more information.
