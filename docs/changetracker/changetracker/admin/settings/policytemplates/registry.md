...
![PolicyTemplateRegistry](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/policytemplateregistry.png)
...
Use the __Advanced Options__ to create and edit new Definitions. See the[Registry Inclusion/Exclusion Match Rules ](/docs/changetracker/changetracker/admin/matchrules/registryrules.md) topic for additional information.

![PolicyTemplateRegistryExclude](/img/product_docs/changetracker/changetracker/admin/settings/policytemplates/policytemplateregistryexclude.png)
