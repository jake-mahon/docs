...
The local agent installed on the Netwrix Change Tracker host server will already be running and will have registered with the __Change Tracker Hub__. See the [Netwrix Change Tracker v8.1 Documentation](../../overview.md) topic for additional information.
