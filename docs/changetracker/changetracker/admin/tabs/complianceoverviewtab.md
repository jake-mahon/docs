...
- __Risk by Group__ – A Risk score can be assigned via the __Settings__ -> __Groups__ page, this provides an added dimension to prioritize focus on groups. See the [Device Groups](/docs/changetracker/changetracker/admin/settings/devicegroups.md) topic for additional information.
...
![ComplianceReportsTemplates](/img/product_docs/changetracker/changetracker/admin/tabs/compliancereportstemplates.webp)
...
![ComplianceReportsLayout](/img/product_docs/changetracker/changetracker/admin/tabs/compliancereportslayout.webp)
