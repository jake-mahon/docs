...
For any of the built-in reports, the __Query Settings__ are available for:
...
See the [Export Reports](/docs/product_docs/changetracker/changetracker/admin/tabs/eventsexportreports.md) topic for additional information.
...
![ReportTemplateQuerySettings](/static/img/product_docs/changetracker/changetracker/admin/tabs/reporttemplatequerysettings.png)
...
![ReportTemplateTOC](/static/img/product_docs/changetracker/changetracker/admin/tabs/reporttemplatetoc.png)
