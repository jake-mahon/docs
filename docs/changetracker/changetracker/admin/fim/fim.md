...
File change events can be viewed from the [Events Tab](/docs/product_docs/changetracker/changetracker/admin/tabs/events.md). See the [Dashboard Tab](/docs/product_docs/changetracker/changetracker/admin/tabs/dashboardoverview.md) topic for additional information on how to view FIM change events.
