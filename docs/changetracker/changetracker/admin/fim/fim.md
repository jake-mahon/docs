...
File change events can be viewed from the [Events Tab](../tabs/events.md). See the [Dashboard Tab](../tabs/dashboardoverview.md) topic for additional information on how to view FIM change events.
