...
![TechnicalOverview](/static/img/product_docs/changetracker/changetracker/technicaloverview.png)
...
- [Installing Gen 7 Agent for Windows](/docs/product_docs/changetracker/changetracker/install/agent/windows.md)
- [Installing Gen 7 Agent for Linux](/docs/product_docs/changetracker/changetracker/install/agent/linuxos.md)

![Architecture](/static/img/product_docs/changetracker/changetracker/architecture.png)

For a full list of supported operating systems see [OS Support Matrix](/docs/product_docs/changetracker/changetracker/requirements/ossupportmatrix.md).
