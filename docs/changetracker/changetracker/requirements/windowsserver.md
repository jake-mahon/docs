...
![Software Requirements](/static/img/product_docs/changetracker/changetracker/requirements/performancecheckbox.png)
...
- See the [Installation](/docs/product_docs/changetracker/changetracker/install/overview.md) topic for additional information on the installation process.
