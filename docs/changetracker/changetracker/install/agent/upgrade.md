...
![UpgradeAgentWindowsCommandPrompt](/static/img/product_docs/changetracker/changetracker/install/agent/upgradeagentwindowscommandprompt.png)

- __For Linux__ – Use: ```service nntagent stop```

__Step 5 –__ Install Gen 7 Agent. Review the following for additional information:

- __Windows__ – See the [Gen 7 Agent for Windows](/docs/product_docs/changetracker/changetracker/requirements/gen7agentwindows.md) topic for additional information.

- __Linux__ – See the [Installing Gen 7 Agent for Linux](/docs/product_docs/changetracker/changetracker/install/agent/linuxos.md) topic for additional information.
