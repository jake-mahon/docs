...
[First Run – HubDetails.xml File](../../admin/settings/devicegroups.md) topic for additional
information.
...
is located. See the [First Run – HubDetails.xml File](../../admin/settings/devicegroups.md) topic
