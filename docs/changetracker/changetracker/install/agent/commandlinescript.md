...
For more information on the __HubDetails.xml__ nodes and settings see the [First Run – HubDetails.xml File](../../admin/settings/devicegroups.md) topic for additional information.
