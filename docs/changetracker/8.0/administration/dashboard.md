...
[Netwrix Change Tracker v8.0 Documentation](/docs/changetracker/8.0/getting-started/overview.md) topic for additional information.

The auto-enrollment, or registration, process is described in more depth in the
[Agent Updates](/docs/changetracker/8.0/administration/device-management/agent-updates.md) topic. but depending on server speed the Local Agent
