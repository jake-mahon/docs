...
![page_guide_5](/img/versioned_docs/changetracker_8.0/changetracker/admin/tabs/page_guide_5.webp)

Query Settings

The Query option gives you an on-screen filter control panel like the pop-out Filter Panel.

![page_guide_6](/img/versioned_docs/changetracker_8.0/changetracker/admin/tabs/page_guide_6.webp)
...
![page_guide_7](/img/versioned_docs/changetracker_8.0/changetracker/admin/tabs/page_guide_7.webp)
