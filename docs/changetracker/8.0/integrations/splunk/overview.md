...
![group](/img/versioned_docs/directorymanager_11.0/directorymanager/configureentraid/register/group.webp)
...
[Configure Device Discovery](/docs/changetracker/8.0/integrations/itsm/sync-service-administration.md#configure-device-discovery)
section in
[Sync Service Administration](/docs/changetracker/8.0/integrations/itsm/sync-service-administration.md)
