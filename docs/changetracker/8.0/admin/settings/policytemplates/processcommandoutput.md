...
[Allowed Commands](/docs/changetracker/8.0/admin/settings/allowedcommands.md)
...
![ProcessCommandOutput](/img/product_docs/changetracker/8.0/admin/settings/policytemplates/processcommandoutput.webp)
...
![ProcessCommandOutputCredentials](/img/product_docs/changetracker/8.0/admin/settings/policytemplates/processcommandoutputcredentials.webp)
