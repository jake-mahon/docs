...
![page_guide_27](/img/product_docs/changetracker/8.0/admin/settings/page_guide_27.webp)
...
- Define the schedule for [Agent Updates](/docs/changetracker/8.0/admin/settings/agentupdates.md)

![page_guide_28](/img/product_docs/changetracker/8.0/admin/settings/page_guide_28.webp)
...
![page_guide_29](/img/product_docs/changetracker/8.0/admin/settings/page_guide_29.webp)
...
![page_guide_30](/img/product_docs/changetracker/8.0/admin/settings/page_guide_30.webp)
...
![page_guide_31](/img/product_docs/changetracker/8.0/admin/settings/page_guide_31.webp)
