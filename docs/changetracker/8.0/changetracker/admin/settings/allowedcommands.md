...
![allowedcommands](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/allowedcommands.webp)
...
![AllowedCommandsCategories](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/allowedcommandscategories.webp)
...
![AllowedCommandsTrustStatus](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/allowedcommandstruststatus.webp)

## Using the Allowed Commands Page

Navigate to **Settings** – **Allowed Commands**:

![AllowedCommandsPage](/img/versioned_docs/changetracker_8.0/changetracker/admin/settings/allowedcommandspage.webp)
