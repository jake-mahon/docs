...
[see earlier section](policywizard.md) regarding the Baseline Setup Wizard and the step where you
...
the [Rule Edit function](policywizard.md) back in the Setup tab if you want to remove an existing
