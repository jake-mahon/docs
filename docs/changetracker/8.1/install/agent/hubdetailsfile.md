...
![AgentHubDetailsFile](/img/product_docs/changetracker/8.1/install/agent/agenthubdetailsfile.webp)
...
**NOTE:** Where the Change Tracker Hub has been installed on a Windows/IIS platform then the Hub URL
