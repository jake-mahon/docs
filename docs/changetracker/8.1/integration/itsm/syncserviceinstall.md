...
![selectitsm](/img/product_docs/changetracker/8.1/integration/itsm/selectitsm.webp)

## Change Tracker Hub Connection

Enter the required configuration values:

![itsmurl](/img/product_docs/changetracker/8.1/integration/itsm/itsmurl.webp)
...
![authenticationtype](/img/product_docs/changetracker/8.1/integration/itsm/authenticationtype.webp)
...
![servicenowcredentials](/img/product_docs/changetracker/8.1/integration/itsm/servicenowcredentials.webp)
