...
and has been restarted. See the [Hub Installation for Windows](/docs/changetracker/8.1/reference/system-requirements/windows-server.md)
...
![eula](/img/product_docs/activitymonitor/activitymonitor/install/eula.webp)
