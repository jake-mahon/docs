...
- **Windows** – See the [Gen 7 Agent for Windows](/docs/changetracker/8.1/reference/system-requirements/gen7-agent-windows.md) topic for
  additional information.

- **Linux** – See the [Installing Gen 7 Agent for Linux](/docs/changetracker/8.1/installation-deployment/agent-installation/linux.md) topic for additional
  information.
