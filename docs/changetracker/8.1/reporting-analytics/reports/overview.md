...
DaysToKeepEventsFor system setting. See the [System Settings](/docs/changetracker/8.1/configuration/system-settings/overview.md) topic
...
See the [Overview Tab](/docs/changetracker/8.1/administration/compliance-management/compliance-overview.md) topic for additional information.
