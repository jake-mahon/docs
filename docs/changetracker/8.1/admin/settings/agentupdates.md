...
![agentupdatefiles](/img/product_docs/changetracker/8.1/admin/settings/agentupdatefiles.webp)
...
![uploadagentupdate](/img/product_docs/changetracker/8.1/admin/settings/uploadagentupdate.webp)
...
![agentupdateuploadscreen](/img/product_docs/changetracker/8.1/admin/settings/agentupdateuploadscreen.webp)

The resulting dialog facilitates the upload of the agent update files.

![agentupdateschedule](/img/product_docs/changetracker/8.1/admin/settings/agentupdateschedule.webp)
...
![devices](/img/product_docs/changetracker/8.1/admin/settings/devices.webp)
