...
![PolicyTemplateRegistry](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/policytemplateregistry.webp)
...
the[Registry Inclusion/Exclusion Match Rules ](/docs/changetracker/8.1/admin/matchrules/registryrules.md) topic for
additional information.

![PolicyTemplateRegistryExclude](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/policytemplateregistryexclude.webp)
