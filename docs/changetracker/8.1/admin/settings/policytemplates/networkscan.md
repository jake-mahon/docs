...
![NetworkScan](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/networkscan.webp)
...
![EditNetwork](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/editnetwork.webp)
...
![EditNetworkCredentialName](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/editnetworkcredentialname.webp)
...
![page_guide_53](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/page_guide_53.webp)

**Step 3 –** Once the initial poll has completed the duration will be required as a communications
Event.

![page_guide_54](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/page_guide_54.webp)
...
![EventDetailsNetwork](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/eventdetailsnetwork.webp)
