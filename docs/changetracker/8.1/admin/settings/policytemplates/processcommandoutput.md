...
commands these may require Admin approval. See the [Allowed Commands](/docs/changetracker/8.1/admin/settings/allowedcommands.md) topic
...
![ProcessCommandOutput](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/processcommandoutput.webp)
...
![ProcessCommandOutputCredentials](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/processcommandoutputcredentials.webp)
