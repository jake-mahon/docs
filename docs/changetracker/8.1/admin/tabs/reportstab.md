...
DaysToKeepEventsFor system setting. See the [System Settings](/docs/changetracker/8.1/admin/settings/systemsettings.md) topic
...
See the [Overview Tab](/docs/changetracker/8.1/admin/tabs/complianceoverviewtab.md) topic for additional information.
