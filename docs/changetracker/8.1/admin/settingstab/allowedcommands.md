...
![allowedcommands](/img/product_docs/changetracker/8.1/admin/settings/allowedcommands.webp)
...
![AllowedCommandsCategories](/img/product_docs/changetracker/8.1/admin/settings/allowedcommandscategories.webp)
...
![AllowedCommandsTrustStatus](/img/product_docs/changetracker/8.1/admin/settings/allowedcommandstruststatus.webp)

## Using the Allowed Commands Page

Navigate to **Settings** – **Allowed Commands**:

![AllowedCommandsPage](/img/product_docs/changetracker/8.1/admin/settings/allowedcommandspage.webp)
