...
![ConfigTemplatesFIMFiles](/img/product_docs/changetracker/8.1/admin/settings/policytemplates/configtemplatesfimfiles.webp)
...
**NOTE:** For Advanced Options: see [Appendix B](/docs/changetracker/8.1/admin/matchrulesoverview/filefolderrules.md) for more
information.
