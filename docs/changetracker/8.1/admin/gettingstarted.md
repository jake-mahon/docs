...
Next, use the [Planned Changes Tab](/docs/changetracker/8.1/admin/tabs/plannedchanges.md) manage change events and filter any
...
Change Tracker, review the [Settings Tab](/docs/changetracker/8.1/admin/settings/settingstab.md).
...
![2faconfiguration](/img/product_docs/changetracker/8.1/admin/2faconfiguration.webp)
