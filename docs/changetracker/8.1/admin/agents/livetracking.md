...
[Policy Templates: FIM File Integrity](/docs/changetracker/8.1/admin/settings/policytemplates/fimfiles.md) topic for additional
information.
...
![minifilter_767x740](/img/product_docs/changetracker/8.1/admin/agents/minifilter_767x740.webp)
