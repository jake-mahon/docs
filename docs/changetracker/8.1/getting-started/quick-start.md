...
Next, use the [Planned Changes Tab](/docs/changetracker/8.1/administration/planned-changes/overview.md) manage change events and filter any
...
Change Tracker, review the [Settings Tab](/docs/changetracker/8.1/configuration/system-settings/general-settings.md).
