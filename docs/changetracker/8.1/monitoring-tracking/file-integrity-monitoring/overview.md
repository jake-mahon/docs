...
File change events can be viewed from the [Events Tab](/docs/changetracker/8.1/reporting-analytics/events/overview.md). See the
[Dashboard Tab](/docs/changetracker/8.1/administration/dashboard.md) topic for additional information on how to view FIM
change events.
