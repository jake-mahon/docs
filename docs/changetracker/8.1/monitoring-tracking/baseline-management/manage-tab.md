...
[see earlier section](/docs/changetracker/8.1/monitoring-tracking/baseline-management/policy-wizard.md) regarding the Baseline Setup Wizard and the step where you
...
the [Rule Edit function](/docs/changetracker/8.1/monitoring-tracking/baseline-management/policy-wizard.md) back in the Setup tab if you want to remove an existing
