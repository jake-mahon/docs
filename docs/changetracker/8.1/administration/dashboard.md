...
[Netwrix Change Tracker v8.1 Documentation](/docs/changetracker/8.1/getting-started/overview.md) topic for additional information.

The auto-enrollment, or registration, process is described in more depth in the
[Agent Updates](/docs/changetracker/8.1/configuration/agent-configuration/agent-updates.md) topic. but depending on server speed the Local Agent
