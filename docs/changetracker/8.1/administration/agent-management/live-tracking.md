...
[Policy Templates: FIM File Integrity](/docs/changetracker/8.1/configuration/policy-templates/file-monitoring/file-integrity-monitoring.md) topic for additional
information.
