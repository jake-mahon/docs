...
[Change Management Reports](/docs/platgovnetsuite/change-management/reports.md).
...
![values_tab](/img/product_docs/platgovnetsuite/change_management/values_tab.webp)
...
1. Click on a linked **Customization** to open the Customization Record. **Strongpoint Return Jira
   ...
   ![Change Log Customization link](/img/product_docs/platgovnetsuite/change_management/change_log_customization_link.webp)

2. Click **Go to Record**
3. Open **System Notes**

![systemsnotes](/img/product_docs/platgovnetsuite/change_management/systemsnotes.webp)
