...
The [Setting Up Policies](/docs/platgovnetsuite/change-management/policies/setting-up-policies.md) topic has details on setting up the Change /
Approval Policies.
...
[Non-Material Changes report](/docs/platgovnetsuite/change-management/reports.md).
