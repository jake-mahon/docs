...
- **User Offboarding**: Available when [Enhanced User Provisioning](/docs/platgovnetsuite/security-and-compliance/user-management.md) is
  enabled.
- **User Onboarding**: Available when [Enhanced User Provisioning](/docs/platgovnetsuite/security-and-compliance/user-management.md) is enabled.
