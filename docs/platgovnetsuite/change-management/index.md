...
- Automatically define the change level required for compliance based on the appropriate
  [Change and Approval Policy](/docs/platgovnetsuite/change-management/concepts/change-approval-policies.md).
- Identify impacts on other customizations.
- Attach and manage test scripts.
- Manage and record Pre and Post-Deployment [Environment Comparisons](/docs/platgovnetsuite/change-management/working-with-changes/comparing-environments.md).
- Archive fields.
