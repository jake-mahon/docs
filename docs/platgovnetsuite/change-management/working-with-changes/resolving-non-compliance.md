...
1. Open **Strongpoint** > **Change Management Reports** > **Open NonCompliant Changes**  
   The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/platgovnetsuite/change-management/concepts/change-logs.md). You
...
2. A noncompliant change means something got changed without the required approvals. **View** each
   ...
   1. Create a New [Change Request](/docs/platgovnetsuite/change-management/working-with-changes/creating-change-requests.md) or open an existing one.
