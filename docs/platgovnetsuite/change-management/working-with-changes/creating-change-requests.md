...
If
[Enable Case to Change Request Workflow](/docs/platgovnetsuite/installation-and-setup/initial-configuration.md)
...
[Case to Change Request Field Mapping](/docs/platgovnetsuite/installation-and-setup/initial-configuration.md)
...
[Change Request](/docs/platgovnetsuite/change-management/working-with-changes/change-request-forms.md) form. Refer to
[Setting Preferred Forms](/docs/platgovnetsuite/customization-management/templates-and-forms.md) for information on
...
2. Enter information in the **Main** and **Scope** sections:
   ...
   - **Lookup Customization** launches a window where you can search for customizations in the
     ...
     - Click **Change Account** to log into another account or sandbox and look up
       ...
       [Comparing Environments](/docs/platgovnetsuite/change-management/working-with-changes/comparing-environments.md) to save your credentials for each
       environment you use.
   ...
   - **Do Not ReSpider Automatically**: when unchecked, an Automatic ReSpider occurs when the
     ...
     [Configuration and Stats Change Management](/docs/platgovnetsuite/installation-and-setup/initial-configuration.md)
     tab.
...
4. **Save** the Change Request. New sections and tabs are available once you save:
   ...
   1. **Push to Jira** button is available if the
      [Jira integration](/docs/platgovnetsuite/integrations/jira/index.md) is available, and
      [Allow NS to Push to Jira](/docs/platgovnetsuite/integrations/jira/index.md) is enabled. When prompted,
