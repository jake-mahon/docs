...
[Creating a Change Request](/docs/platgovnetsuite/change-management/working-with-changes/creating-change-requests.md) for the new form. Refer to
...
2. Fill in the following fields in the **Main** section of the change request:
   ...
   ![changerequestmain1](/img/product_docs/platgovnetsuite/change_management/changerequestmain1.webp)
...
3. Fill in the following fields in the **Scope** section of the change request:
   ...
   ![scope-1](/img/product_docs/platgovnetsuite/change_management/scope-1.webp)

   ![scope-3](/img/product_docs/platgovnetsuite/change_management/scope-3.webp)
