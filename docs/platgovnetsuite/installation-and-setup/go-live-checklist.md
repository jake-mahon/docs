...
[Creating a Change Request](/docs/platgovnetsuite/change-management/working-with-changes/creating-change-requests.md) for details.
...
Refer to [Setting Up the AutoSpider and Alerts](/docs/platgovnetsuite/installation-and-setup/running-the-spider.md) for details.
...
If your site uses [Opportunistic Clearance](/docs/platgovnetsuite/change-management/working-with-changes/approving-changes.md), the
...
[License Manager](/docs/platgovnetsuite/getting-started/requirements-and-licensing.md) topic.
