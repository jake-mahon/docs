...
- **Enable Case to Change Request Workflow**: enables the workflow
  [Create Change Request from Case](/docs/platgovnetsuite/change-management/working-with-changes/creating-change-requests.md),
...
- **Do Not ReSpider Automatically**: sets the default condition for the **Do Not ReSpider
  ...
  [ITGC Change Request](/docs/platgovnetsuite/change-management/working-with-changes/creating-change-requests.md). The default is
  unchecked.  
...
- **Enhanced User Provisioning**: enables access management for onboarding/offboarding and access
  change using the **[User Access Change Request](/docs/platgovnetsuite/security-and-compliance/user-management.md)**.
...
- **CR Email Template**: if you customize your **SoD Exemption Approval** or **SoD Rule Change
  ...
  installed. Refer to [Advanced PDF / HTML Templates](/docs/platgovnetsuite/customization-management/templates-and-forms.md).  
...
Refer to [Jira Integration](/docs/platgovnetsuite/integrations/jira/index.md) for more information.

### ServiceNow Integration

Specifies the ServiceNow credentials to use when ServiceNow and Platform Governance for NetSuite are
integrated. Refer to [ServiceNow Integration](/docs/platgovnetsuite/integrations/servicenow/index.md) for more
information.

### Menu Management

Enables hiding menu items you do not use, to improve navigation. Refer to
[Managing Menus](/docs/platgovnetsuite/installation-and-setup/menus-and-navigation.md) for more information.
