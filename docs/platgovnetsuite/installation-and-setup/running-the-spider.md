...
roles. Refer to [Setting Access and Permissions](/docs/platgovnetsuite/installation-and-setup/permissions-and-access.md) for more
information.
...
**Next Step:** [ Setting Up the AutoSpider and Alerts](/docs/platgovnetsuite/installation-and-setup/auto-spider-alerts.md)
