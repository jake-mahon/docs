...
4. [Run the spider](/docs/platgovnetsuite/installation-and-setup/running-the-spider.md). The spider scans your account in a standardized manner. A
...
field, refer to
[Cannot Change the Number of Rows in List Segments](/docs/platgovnetsuite/troubleshooting/list_segments_not_editable)
...
**Next Step:** [Running the Spider](/docs/platgovnetsuite/installation-and-setup/running-the-spider.md)
