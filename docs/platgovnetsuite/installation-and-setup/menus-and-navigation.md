...
3. Open the **Menu Management tab**. You only see the categories available for your license type.
   ...
   ![Default Setting for Documentation and Optimization Optional Menus](/img/product_docs/platgovnetsuite/installing_strongpoint/menu_mgmt.webp)  
   ![Default Setting for Intellgient Change Management Optional Menus](/img/product_docs/platgovnetsuite/installing_strongpoint/menu_mgmt_cm.webp)  
   ![Default Setting for Enterprise Compliance Optional Menus](/img/product_docs/platgovnetsuite/installing_strongpoint/menu_mgmt_ec.webp)
