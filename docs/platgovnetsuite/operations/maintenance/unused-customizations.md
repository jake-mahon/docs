...
[Inactive](/docs/platgovnetsuite/security-and-compliance/user-management.md). The report criteria excludes Customization
...
2. Enter filtering information to streamline your search. Searching on all unused customizations can
   ...
   ![Enter criteria prior to searching for unused customizations](/img/product_docs/platgovnetsuite/clean_up/customizations_cleanup_unused_filters.webp)

3. Click **Search**.  
    The results are coded with a flag in the first column and the text either blue (Inactive owner)
   or black.  
   ![Cleanup Key](/img/product_docs/platgovnetsuite/clean_up/customizations_cleanup_key.webp)  
   ...
   ![customizations_cleanup_list](/img/product_docs/platgovnetsuite/clean_up/customizations_cleanup_list.webp)
...
4. Click **View** next to each Customization to investigate. You can right-click on **View** and
   ...
   ![View the Customization Record](/img/product_docs/platgovnetsuite/clean_up/customizations_cleanup_view_record.webp)
...
![cleanupimpactanalysis](/img/product_docs/platgovnetsuite/clean_up/cleanupimpactanalysis.webp)
...
![archive](/img/product_docs/platgovnetsuite/clean_up/archive.webp)
