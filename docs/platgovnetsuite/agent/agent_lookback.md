...
3. Open the **Controls** tab.
    ...
    ![New Agent Lookback](/img/product_docs/platgovnetsuite/financial_controls/agent_lookback.webp)
...
![Schedule or initiate a Lookback run.](/img/product_docs/platgovnetsuite/financial_controls/lookback_run.webp)
...
![View the Lookback Run history.](/img/product_docs/platgovnetsuite/financial_controls/lookback_run_history.webp)
...
![Filter Incident Results on Lookback Run](/img/product_docs/platgovnetsuite/financial_controls/lookback_run_incidents.webp)
