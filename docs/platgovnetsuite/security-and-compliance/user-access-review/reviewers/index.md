...
in the email, or login to NetSuite and open [User Access Review](/docs/platgovnetsuite/security-and-compliance/user-access-review/index.md) to access the
dashboard.
...
- **UAR List** is your **[User Access Reviews List](/docs/platgovnetsuite/security-and-compliance/user-access-review/reviewers/additional-reviews.md)**.
