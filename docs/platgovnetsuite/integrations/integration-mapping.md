...
![int_map_csv_template](/img/product_docs/platgovnetsuite/integrations/int_map_csv_template.webp)
...
the [Managing Menus](/docs/platgovnetsuite/installation-and-setup/menus-and-navigation.md) topic for information on making it
available.
...
1. Select an existing External System from the list if you created it during Step 1, or Enter a new
   ...
   ![int_map_ext_sys](/img/product_docs/platgovnetsuite/integrations/int_map_ext_sys.webp)
...
1. Click **Choose File**.
   ...
   ![int_map_upload_csv](/img/product_docs/platgovnetsuite/integrations/int_map_upload_csv.webp)
...
1. Review customization mappings. If you entered a **ScriptID** in your **.csv**, the associated
   **Link Object** is shown.
   ...
   ![int_map_map_cust](/img/product_docs/platgovnetsuite/integrations/int_map_map_cust.webp)

2. Click **Search** to open the search form and select or research additional **Link Objects**.

   ![int_map_search](/img/product_docs/platgovnetsuite/integrations/int_map_search.webp)
...
3. Search by all or part of a **Name**, **Type** or all or part of a **ScriptID**. For example,
   ...
   ![int_map_search_results](/img/product_docs/platgovnetsuite/integrations/int_map_search_results.webp)
...
1. Check the Summary for any **Import Errors**.
   ...
   ![int_map_summary](/img/product_docs/platgovnetsuite/integrations/int_map_summary.webp)
...
![int_mapping_ext_erd](/img/product_docs/platgovnetsuite/integrations/int_mapping_ext_erd.webp)
