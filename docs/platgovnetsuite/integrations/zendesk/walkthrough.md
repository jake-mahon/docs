...
[install and configure](/docs/platgovnetsuite/integrations/zendesk/index.md) the Zendesk integration, prior to using this
walkthrough.
...
[authorized to access the app](/docs/platgovnetsuite/integrations/zendesk/index.md).
...
group with the [Set up Approvals](/docs/platgovnetsuite/integrations/zendesk/index.md#set-up-approvals) permission.
...
[Entity Relationship Diagram](/docs/platgovnetsuite/customization-management/entity-relationship-diagrams.md) for the customization.
