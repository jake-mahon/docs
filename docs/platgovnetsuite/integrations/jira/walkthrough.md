...
[install and configure](/docs/platgovnetsuite/integrations/jira/index.md) the Jira integration, including setting up the
**[Jira Statuses](/docs/platgovnetsuite/integrations/jira/index.md)** prior to using this walkthrough.
...
3. Select your NetSuite **Account** and enter your **Consumer Key**/**Secret** and **Token
   ID**/**Secret**. If your account has an optional _[Integration User](/docs/platgovnetsuite/integrations/jira/index.md)_ role,
...
- **Push** creates the Change Request in NetSuite. **Push** is also used to manually update your
  Change Request if you are not using the [Automatic Synchronization](/docs/platgovnetsuite/integrations/jira/index.md) feature.
...
2. Click **Push** if you are not using [Automatic Synchronization](/docs/platgovnetsuite/integrations/jira/index.md) to push
...
3. Click **Push** if you are not using [Automatic Synchronization](/docs/platgovnetsuite/integrations/jira/index.md) to push
   status changes. A confirmation your Change Request was Created/Updated is displayed.
