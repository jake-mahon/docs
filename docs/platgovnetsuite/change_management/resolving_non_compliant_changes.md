...
1. Open **Strongpoint** > **Change Management Reports** > **Open NonCompliant Changes**  
   The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/platgovnetsuite/change_management/using_change_logs.md). You
...
2. A noncompliant change means something got changed without the required approvals. **View** each
   ...
   for the change to be compliant.
    ...
    1. Create a New [Change Request](/docs/platgovnetsuite/change_management/creating_change_request.md) or open an existing one.
