...
[User Access Review](/docs/platgovnetsuite/welcome/access_app.md) to access the dashboard.
...
- **Owner List** displays all reviews with an assigned owner. Option to view reviews with no
  ...
  Administrator's [Owner List](/docs/platgovnetsuite/welcome/adminoverview/admin_owner_list.md).
- **Global Access Reviews History** is the **[User Access Reviews History](/docs/platgovnetsuite/welcome/adminoverview/uar_history.md)**.
