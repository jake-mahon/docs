...
on your [License Type](/docs/platgovnetsuite/getting-started/requirements-and-licensing.md). In addition, menu items
can be hidden for each account through [Menu Management](/docs/platgovnetsuite/installation-and-setup/menus-and-navigation.md).
...
[Setting Tab Access](/docs/platgovnetsuite/installation-and-setup/permissions-and-access.md).
