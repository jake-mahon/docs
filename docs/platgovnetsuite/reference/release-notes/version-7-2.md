...
Strongpoint is excited to release an [Integration API](/docs/platgovnetsuite/api-reference/index.md) to enable your
...
- API commands are documented in the [Integration API](/docs/platgovnetsuite/api-reference/index.md) section of this
  guide.
