...
process: [Running the Spider](/docs/platgovnetsuite/installing_strongpoint/running_the_spider.md).
...
[Setting Up the AutoSpider and Alerts](/docs/platgovnetsuite/installing_strongpoint/setting_up_auto_spider_alerts.md).
