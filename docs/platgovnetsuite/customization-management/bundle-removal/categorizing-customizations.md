...
6. Click **Preview**.This step takes some time.Troubleshooting:
   [Saved Search Times Out](/docs/platgovnetsuite/troubleshooting/search-timeouts.md)
...
**Next Step:**
[](/docs/platgovnetsuite/customization-management/bundle-removal/mass-updates.md)[Creating Four Mass Updates](/docs/platgovnetsuite/customization-management/bundle-removal/mass-updates.md)
