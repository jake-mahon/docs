...
- **Detailed Metadata**: Details about the customization including Fields, Values, Bundle / SuiteApp
  information, [Date Last Used](/docs/platgovnetsuite/operations/maintenance/cleanup-strategies.md), Last Used Status, and who uses the
...
on the
[Managed Bundle/App Updates](/docs/platgovnetsuite/change-management/reports.md#managed-bundleapp-updates)
report.
