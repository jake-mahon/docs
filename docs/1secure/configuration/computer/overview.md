...
- Automatically - The current audit settings will be applied automatically. They will be periodically checked and adjusted if necessary. See[ Data Collecting Account](../../admin/datacollection/datacollectingaccount/overview.md) for additional information.
...
Follow the instructions in the [ Data Collecting Account](../../admin/datacollection/datacollectingaccount/overview.md) section.
