...
- On pre-Windows Server 2012 versions:
    ...
    2. In the **Audit Entry** dialog that opens, set the _"Successful"_ flag for all access entries
       ...
       Permissions_.
        ...
        ![manualconfig_objectlevel_entry2008](../../../../static/img/product_docs/1secure/configuration/ad/manualconfig_objectlevel_entry2008.webp)
...
[Install ADSI Edit](adsi.md) topic for additional information on how to install the ADSI Edit
utility.
