...
| Icon | Description |
| --- | --- |
| ![selfupdate_icon](/img/product_docs/1secure/admin/selfupdate_icon.png) | Bell icon. Click the Bell icon to look for the updates. |
...
![notifications](/img/product_docs/1secure/admin/notifications.png)

__Step 3 –__ Select __Fix__.

See the following topic for additional information:

- [Update Netwrix Cloud Agent](/docs/1secure/admin/updatenetwrixcloudagent.md)
