...
for secure access. See the [Log In](login.md#log-in) topic for additional information on
...
- Client Secret – A client secret value generated when a new client secret key is created for the
  ...
  [Generate Client Secret Value](../../configuration/entraid/registerconfig.md#generate-client-secret-value) topic
  for additional information.
