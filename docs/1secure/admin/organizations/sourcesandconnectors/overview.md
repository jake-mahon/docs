...
__NOTE:__ Before adding a data source, make sure its prerequisites are met. See the [Prerequisites for Data Sources](/docs/1secure/requirements/prerequisitesfordatasources.md) topic for additional information.
