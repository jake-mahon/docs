...
- File Server Activity – Toggle the __File Server Activity__ switch to ON to collect and monitor data for this connector. With this, you can generate activity reports on File Server data. See the [File Server](../../searchandreports/activity.md#file-server) topic for additional information.
