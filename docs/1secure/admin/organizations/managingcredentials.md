...
| Icon | Description |
| --- | --- |
| ![alert_icon](/img/product_docs/1secure/admin/organizations/alert_icon.png) | Alert Icon. Click the Alert Icon to notify that the credentials have expired or been lost after reinstallation of the Netwrix Cloud Agent and must be entered again before they can be used. |
