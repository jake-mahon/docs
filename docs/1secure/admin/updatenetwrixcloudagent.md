...
| Icon | Description |
| --- | --- |
| ![selfupdate_icon](/img/product_docs/1secure/admin/selfupdate_icon.png) | Bell Icon. Click the Bell Icon to look up for the available updates of the Netwrix Cloud Agent. |
...
![updateagents](/img/product_docs/1secure/admin/updateagents.png)
...
![editagentupdatesschedule2](/img/product_docs/1secure/admin/editagentupdatesschedule2.png)
...
![selfupdate_panel](/img/product_docs/1secure/admin/selfupdate_panel.png)
...
![editagentupdatesschedule](/img/product_docs/1secure/admin/editagentupdatesschedule.png)
...
- [Notifications ](/docs/1secure/admin/notifications.md)
