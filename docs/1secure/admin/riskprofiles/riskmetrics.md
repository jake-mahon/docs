...
__Step 3 –__ Click a risk profile. The risk metrics for the profile are displayed in a list. See the [Risk Metrics List](metrics_list.md) topic for a description of each risk metric.
