...
[Alerts](../alerts/alerts.md) topic for additional information on alerts.
...
Timeline page. See the [Alerts Timeline](alertstimeline.md) topic for additional information.
...
- Alerts – Displays the total number of alerts triggered for the organization. Click the value to
  navigate to the Alerts Timeline page. See the [Alerts Timeline](alertstimeline.md) topic for
