...
![Subscription to Report pane](/img/product_docs/1secure/admin/searchandreports/subscriptions.png)
...
![Email Delivery Settings](/img/product_docs/1secure/admin/searchandreports/subscriptionsemailsettings.png)
...
- Variables – Select variable(s) to customize the subject line of the email. To use multiple variables, select them one by one from the drop-down menu. The available options are: Report Name, Export Date, Frequency, Num Records, Managing Organization, and Managed Organization.
  ...
  ![Email Subject](/img/product_docs/1secure/admin/searchandreports/subscriptions_2.png)
...
![Organization Subscriptions Page](/img/product_docs/1secure/admin/searchandreports/subscriptions_3.png)
