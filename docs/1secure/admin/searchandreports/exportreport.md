...
__Step 3 –__ Define a filter criteria, then click __Search__ to generate the investigation results based on it. See the [Apply Filters](applyfilters.md) topic for additional information.
