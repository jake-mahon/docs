...
![Subscription to Report pane](/static/img/product_docs/1secure/1secure/admin/searchandreports/subscriptions.png)
...
__Step 8 –__ In the Attached File field, specify the name of the file the intended recipients will receive. The default name is: Report on {{Report\_Name}} {{Export\_Date}}. These variables will be replaced with the report's name and date. For example, Report on Accounts Deleted 01/10/2025 09:00:00.
...
![Email Delivery Settings](/static/img/product_docs/1secure/1secure/admin/searchandreports/subscriptionsemailsettings.png)
...
- Variables – Select variable(s) to customize the subject line of the email. To use multiple variables, select them one by one from the drop-down menu. The available options are: Report Name, Export Date, Frequency, Num Records, Managing Organization, and Managed Organization.
  ...
  ![Email Subject](/static/img/product_docs/1secure/1secure/admin/searchandreports/subscriptions_2.png)
...
__NOTE:__  If you encounter the message, Integration required, you must first configure your integration for SharePoint Online. See the [SharePoint Online](/docs/product_docs/1secure/1secure/integration/sharepointonline.md) topic for additional information.
...
![Organization Subscriptions Page](/static/img/product_docs/1secure/1secure/admin/searchandreports/subscriptions_3.png)

__Step 5 –__  Click the Edit icon for a subscription to modify it. The Subscription to <_name of the report_> pane is displayed.
