...
![statuses_chart](/img/product_docs/1secure/1secure/admin/statuses_chart.png)
...
You can also review the agent status while adding the organization. See the [Manage Organizations](/docs/1secure/1secure/admin/organizations/overview.md) topic for more information.
