...
2. If you are going to collect data using the network traffic compression (see the following section for more information: [Network Traffic Compression](/docs/1secure/1secure/configuration/networktrafficcompression.md)), provide the following:
...
To learn about the data collecting account, which collects data from the monitored items, go to[ Data Collecting Account](/docs/1secure/1secure/admin/datacollection/datacollectingaccount/overview.md) article.
