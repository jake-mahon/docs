...
| --- | --- | --- | --- |
| __Alerts Overview__ | Yes | Yes | Yes |
...
| Screen/Action | MSP | Business Viewer | Co-managing Administrator |
| --- | --- | --- | --- |
| __Organization Configuration__ | Yes | No | Yes |
| Sources | Yes | No | Yes |
| Sites | Yes | No | Yes |
...
| Screen/Action | MSP | Business Viewer | Co-managing Administrator |
| --- | --- | --- | --- |
| __View Organization Dashboard__ | Yes | Yes | Yes |
| Switch Organization | Yes | No | No |
...
| Screen/Action | MSP | Business Viewer | Co-managing Administrator |
| --- | --- | --- | --- |
| __Risk Assessment Dashboard__ | Yes | Yes | Yes |
| Switch Organization | Yes | No | No |
