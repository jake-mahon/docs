...
![Configure Source Details %28Step 2 of 3%29 pane](/img/product_docs/1secure/1secure/admin/organizations/sourcesandconnectors/entra_configsourcedetails%28step2of3%29.png)
...
![Choose New Connector %28Step 3 of 3%29 pane](/img/product_docs/1secure/1secure/admin/organizations/sourcesandconnectors/entra_connector%28step3of3%29.png)
...
- Entra ID Activity – Toggle the __Entra ID Activity__ switch to ON to collect and monitor data for this connector. With this, you can generate activity reports on Microsoft Entra ID data. See the [Microsoft Entra ID](/docs/1secure/1secure/admin/searchandreports/activity.md#Microsoft-Entra-ID) topic for additional information.
- Entra ID Logons – Toggle the __Entra ID Logons__ switch to ON to collect and monitor data for this connector. With this, you can generate logon reports on Microsoft Entra ID data. See the [Microsoft Entra ID](/docs/1secure/1secure/admin/searchandreports/activity.md#Microsoft-Entra-ID) topic for additional information.
...
- Entra ID State – Toggle the __Entra ID State__ switch to ON to collect and monitor data for this connector. With this, you can generate state-in-time reports on Microsoft Entra ID data. See the [State In Time Risks Reports](/docs/1secure/1secure/admin/searchandreports/stateintime.md) topic for additional information.
