...
![Configure Source Details (Step 2 of 3) pane](/static/img/product_docs/entra_configsourcedetails(step2of3).png)
...
![Choose New Connector (Step 3 of 3) pane](/static/img/product_docs/entra_connector(step3of3).png)
...
- Entra ID Activity – Toggle the __Entra ID Activity__ switch to ON to collect and monitor data for this connector. With this, you can generate activity reports on Microsoft Entra ID data. See the [Microsoft Entra ID](/docs/product_docs/1secure/1secure/admin/searchandreports/activity.md#Microsoft-Entra-ID) topic for additional information.
- Entra ID Logons – Toggle the __Entra ID Logons__ switch to ON to collect and monitor data for this connector. With this, you can generate logon reports on Microsoft Entra ID data. See the [Microsoft Entra ID](/docs/product_docs/1secure/1secure/admin/searchandreports/activity.md#Microsoft-Entra-ID) topic for additional information.
...
- Entra ID State – Toggle the __Entra ID State__ switch to ON to collect and monitor data for this connector. With this, you can generate state-in-time reports on Microsoft Entra ID data. See the [State In Time Risks Reports](/docs/product_docs/1secure/1secure/admin/searchandreports/stateintime.md) topic for additional information.
