...
![Configure Source Details (Step 2 of 3) pane](/static/img/product_docs/configsourcedetails(step2of3).png)
...
![Choose New Connector (Step 3 of 3) pane](/static/img/product_docs/1secure/1secure/admin/organizations/sourcesandconnectors/computer_chooseconnector.png)

__Step 9 –__ The Choose new connector pane (Step 3 of 3) lists one connector for computer. Specify the following:

- File Server Activity – Toggle the __File Server Activity__ switch to ON to collect and monitor data for this connector. With this, you can generate activity reports on File Server data. See the [File Server](/docs/product_docs/1secure/1secure/admin/searchandreports/activity.md#File-Server) topic for additional information.
