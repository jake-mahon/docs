...
Basic audit policies allow tracking changes to user accounts and groups and identifying originating workstations. You can configure advanced audit policies for the same purpose too. See the [Configure Advanced Audit Policies](/docs/1secure/1secure/configuration/ad/advancedpolicy.md) topic for additional information.
...
![manualconfig_ad_localpolicy_winserver2016](/img/product_docs/1secure/1secure/configuration/ad/manualconfig_ad_localpolicy_winserver2016.png)
