...
- [Configure Basic Domain Audit Policies](/docs/product_docs/1secure/1secure/configuration/ad/domainauditpolicies.md)
  or
  [Configure Advanced Audit Policies](/docs/product_docs/1secure/1secure/configuration/ad/advancedpolicy.md). Either local or advanced audit policies must be configured to track changes to accounts and groups, and to identify workstations where changes were made.
- [Configure Object-Level Auditing](/docs/product_docs/1secure/1secure/configuration/ad/objectlevel.md)
- Adjust Security Event Log Size and Retention Settings
- [Enable Secondary Logon Service](/docs/product_docs/1secure/1secure/configuration/ad/secondarylogonservice.md)
