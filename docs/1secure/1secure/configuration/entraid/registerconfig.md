...
- [Permissions to Audit Microsoft Entra ID](/docs/product_docs/1secure/1secure/configuration/entraid/permissions.md#Permissions-to-Audit-Microsoft-Entra-ID)
- [Permissions to Audit SharePoint Online](/docs/product_docs/1secure/1secure/configuration/entraid/permissions.md#Permissions-to-Audit-SharePoint-Online)
- [Permissions to Audit Exchange Online](/docs/product_docs/1secure/1secure/configuration/entraid/permissions.md#Permissions-to-Audit-Exchange-Online)
...
The client secret value is required while adding a data source in Netwrix 1Secure. See the [Sources and Connectors ](/docs/product_docs/1secure/1secure/admin/organizations/sourcesandconnectors/overview.md)topic for additional information on adding a data source.
