...
You can choose to configure local audit policies or advanced audit policies. See the [Configure Advanced Audit Policies](/docs/product_docs/1secure/1secure/configuration/computer/advancedpolicy.md) topic for additional information.
