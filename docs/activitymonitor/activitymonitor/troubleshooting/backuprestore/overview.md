...
- Activity Monitor Console - Controls configuration settings. See the [Administration](../../admin/overview.md)topic for additional information.
- Deployed Agents - Monitor targeted servers and domains. See the [Agent Information](../../install/agents.md) topic for additional information.
