...
![Update Agent Installer](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/updateagentinstaller.webp)

**Step 2 –** Navigate to the location of the latest AD Agent installation package. Select the
installer and click **Open**.

![Confirmation Window](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/updateagentinstallerpopup.webp)
