...
See the [CTERA Activity Auditing Configuration](../config/ctera/Activity.md) topic for additional information.
...
See the [Configure FPolicy](../config/netappcmode/configurefpolicy.md) topic for additional information.
