...
[AD Agent Server Requirements](../../../requirements/adagent.md) have been met. To effectively
...
monitored. See the [Monitored Domains Tab](../../monitoreddomains/overview.md) section for
