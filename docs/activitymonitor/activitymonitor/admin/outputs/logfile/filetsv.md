...
| 1) Sub-Operation  2) Old Attributes  3) New Attributes | Windows hosts only. These columns are filled with details about:   - Permission changes (the “Per” operation type) - Attribute Changes (the “Upd” operation type) - Read events from VSS shadow copies   See the [Sub-Operation, Old Attributes, and New Attributes Table](#Sub-Operation-Old-Attributes-and-New-Attributes-Table) section for additional details. |
