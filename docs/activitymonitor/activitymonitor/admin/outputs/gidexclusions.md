...
- Add – Opens the Add or Edit GID window to add a group for exclusion. See the [Add or Edit GID Window](/docs/activitymonitor/activitymonitor/admin/outputs/window/addeditgid.md) topic for additional information.
...
- Edit – Opens the Add or Edit GID window to edit a selected group for exclusion. See the [Add or Edit GID Window](/docs/activitymonitor/activitymonitor/admin/outputs/window/addeditgid.md) topic for additional information.
