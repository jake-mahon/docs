...
__NOTE:__ The ```api-fpolicy*``` command is required for automatic configuration of FPolicy. The ```cli-fpolicy*``` command is required to use the “Enable and connect FPolicy” option for a Monitored Host configuration.
