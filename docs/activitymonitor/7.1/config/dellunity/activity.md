...
Checklist Item 2:
[Install Dell CEE](/docs/activitymonitor/7.1/config/dellunity/installcee.md)
...
- See the [Validate Setup](/docs/activitymonitor/7.1/config/dellunity/validate.md) topic
  for instructions.
