...
![pscp Command](/img/product_docs/activitymonitor/7.1/install/agent/screen1.webp)
...
![Generate the Activity Monitor Agent Client Certificate](/img/product_docs/activitymonitor/7.1/install/agent/screen3.webp)
...
![Specify Agent Port](/img/product_docs/activitymonitor/7.1/install/agent/specifyagentport.webp)

**Step 4 –** Specify the port to be used for the agent. Click **Next**.

![Credentials to Connect to Server.](/img/product_docs/activitymonitor/7.1/install/agent/credentials.webp)
...
![Server Properties](/img/product_docs/activitymonitor/7.1/install/agent/properties.webp)
