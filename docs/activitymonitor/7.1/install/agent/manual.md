...
![Ready to install Netwrix Activity Monitor Agent 64-bit Page](/img/product_docs/activitymonitor/7.1/install/agent/readyinstall.webp)
...
![Install New Agent Page](/img/product_docs/activitymonitor/7.1/install/agent/installnew.webp)
...
![Agent Port Configuration](/img/product_docs/activitymonitor/7.1/install/agent/portdefault.webp)

**Step 4 –** Specify the port to be used for the agent. Click **Next**.

![Credentials to connect to servers](/img/product_docs/activitymonitor/7.1/install/agent/credentials.webp)
...
![Activity Monitor Agent Installed](/img/product_docs/activitymonitor/7.1/install/agent/consolewithagent.webp)
