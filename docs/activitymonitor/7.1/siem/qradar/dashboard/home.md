...
![Home Dashboard for Stealthbits Activivty Monitor App for QRadar](/img/product_docs/activitymonitor/7.1/siem/qradar/dashboard/homedashboard.webp)
...
- Open Offenses – Number of ransomware offenses detected within QRadar from the file activity event
  data
    ...
    - The value for this card is a hyperlink to the
      [Ransomware Dashboard](/docs/activitymonitor/7.1/siem/qradar/dashboard/ransomware.md).
...
- Latest Events – Tabular format of all file activity events which occurred over the specified time
  interval
    ...
    - See the
      [Table Card Features ](/docs/activitymonitor/7.1/siem/qradar/app.md#table-card-features)
