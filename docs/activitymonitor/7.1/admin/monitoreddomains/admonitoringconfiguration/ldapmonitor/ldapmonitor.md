...
![Operations Tab in the LDAP Monitor Tab](/img/product_docs/activitymonitor/7.1/admin/monitoreddomains/admonitoringconfiguration/operations.webp)
...
![Host (From) Tab in the LDAP Monitor Tab](/img/product_docs/activitymonitor/7.1/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![LDAP Tab in the LDAP Monitor Tab](/img/product_docs/activitymonitor/7.1/admin/monitoreddomains/admonitoringconfiguration/ldap.webp)
...
![Servers Tab in the LDAP Monitor Tab](/img/product_docs/activitymonitor/7.1/admin/monitoreddomains/admonitoringconfiguration/servers.webp)
...
![Users Tab in the LDAP Monitor Tab](/img/product_docs/activitymonitor/7.1/admin/monitoreddomains/admonitoringconfiguration/users.webp)
