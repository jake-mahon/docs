...
![Archiving Tab for Agent Properties](/img/product_docs/activitymonitor/7.1/admin/agents/properties/archiving_tab.webp)
...
![Popup window for Configure a network share on this computer option](/img/product_docs/activitymonitor/7.1/admin/agents/properties/archivingtabconfigure.webp)
