...
![SharePoint New Search Tab](/img/product_docs/activitymonitor/7.1/admin/search/query/sharepointnewsearchtab.webp)
...
![General Category - SharePoint](/img/product_docs/activitymonitor/7.1/admin/search/query/generalfilters.webp)
...
![SharePoint Search - Audit filter section](/img/product_docs/activitymonitor/7.1/admin/search/query/auditmask.webp)
...
![SharePoint Search Query - Move/Delete/Copy/Checkin Filters](/img/product_docs/activitymonitor/7.1/admin/search/query/movedeletecopycheckinfilters.webp)
...
![SharePoint Search Query - Delete FIlters](/img/product_docs/activitymonitor/7.1/admin/search/query/delete.webp)
...
![SharePoint Search Query - Search Filters](/img/product_docs/activitymonitor/7.1/admin/search/query/searchfilters.webp)
...
![SharePoint Search Query - Permissions Filters](/img/product_docs/activitymonitor/7.1/admin/search/query/permissionsfilters.webp)
