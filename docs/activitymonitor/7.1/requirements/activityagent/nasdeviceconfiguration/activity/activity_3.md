...
Checklist Item 2:
[Install Dell CEE](/docs/activitymonitor/7.1/requirements/activityagent/nasdeviceconfiguration/activity/installcee_3.md)
...
- Configure initial setup for a Unity device
    ...
    - [Unity Initial Setup with Unisphere](/docs/activitymonitor/7.1/requirements/activityagent/nasdeviceconfiguration/activity/setupunisphere.md)
...
- See the [Validate Setup](/docs/activitymonitor/7.1/requirements/activityagent/nasdeviceconfiguration/activity/validate_2.md) topic
  for instructions.
