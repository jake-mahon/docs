...
![Activity Monitor with location of trace logs](/img/product_docs/activitymonitor/7.1/troubleshooting/tracelogs.webp)
...
![Collect Logs button](/img/product_docs/activitymonitor/7.1/troubleshooting/collectlogsbutton.webp)
...
![Copying the log files popup window](/img/product_docs/activitymonitor/7.1/troubleshooting/collectlogswindow.webp)
