...
- New reporting for failed events offers deeper insights for quicker troubleshooting and
...
- Provides details on rights and trustees that were added or removed using detailed permission
  changes report .
- Provides more accurate reports by distinguishing between attribute and permission changes,
  ensuring clearer insights and more informed decision-making.

## Bug Fix List

See the
[Netwrix Activity Monitor v7.1 Bug Fix List](https://helpcenter.netwrix.com/bundle/ActivityMonitor_7.1_ReleaseNotes/resource/Netwrix_ActivityMonitor_7.1_BugFixList.pdf)
