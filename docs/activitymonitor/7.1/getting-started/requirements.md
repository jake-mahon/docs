...
See the
[Activity Agent Ports](/docs/activitymonitor/7.1/getting-started/requirements.md)
...
See the [Panzura CloudFS Monitoring](/docs/activitymonitor/7.1/configuration/storage-platforms/panzura.md)
topic for target environment requirements.
...
See the
[Active Directory Activity Auditing Configuration](/docs/activitymonitor/7.1/configuration/active-directory.md)
topic for target environment requirements.
