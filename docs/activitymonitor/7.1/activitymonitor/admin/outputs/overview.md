...
- [Log Files Tab](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/outputs/logfiles.md),
  File output only
- [Syslog Tab](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/outputs/syslog.md), Syslog
  output only
- [Threat Manager Tab](/versioned_docs/activitymonitor_7.1/activitymonitor/admin/outputs/threatmanager.md),
