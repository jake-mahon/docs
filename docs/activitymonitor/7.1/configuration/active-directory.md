...
description: Configure Activity Monitor for Active Directory domain activity using API Server or File Archive Repository methods for Enterprise Auditor integration.
---
