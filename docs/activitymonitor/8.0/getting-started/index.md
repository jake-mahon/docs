...
- Console server [Requirements ](/docs/activitymonitor/8.0/getting-started/requirements.md)
- [Activity Agent Server Requirements](/docs/activitymonitor/8.0/getting-started/requirements.md) for monitoring:
...
- [AD Agent Server Requirements](/docs/activitymonitor/8.0/getting-started/requirements.md) for monitoring Active Directory
- [Linux Agent Server Requirements](/docs/activitymonitor/8.0/getting-started/requirements.md) for monitoring Linux file servers
...
- [Install Application](/docs/activitymonitor/8.0/getting-started/installation.md)
- [Agent Information](/docs/activitymonitor/8.0/agents/index.md)
- [Import License Key](/docs/activitymonitor/8.0/getting-started/installation.md)
...
- [Monitored Domains Tab](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md) for Active Directory monitoring
- [Monitored Hosts Tab](/docs/activitymonitor/8.0/monitored-systems/index.md) for all other target environments.
...
[Search Feature](/docs/activitymonitor/8.0/search-and-analysis/index.md) topic for additional information.
