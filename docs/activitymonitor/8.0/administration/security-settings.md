...
See the [Connection Tab](/docs/activitymonitor/8.0/agents/configuration/connection-settings.md) topic for additional information.
...
See the [Archiving Tab](/docs/activitymonitor/8.0/agents/configuration/storage-and-archiving.md) topic for additional information.
...
See the [Panzura Tab](/docs/activitymonitor/8.0/monitored-systems/storage-systems/panzura.md) topic for additional information.
...
See the [Nutanix Tab](/docs/activitymonitor/8.0/monitored-systems/storage-systems/nutanix.md) topic for additional
information.
...
See the [Inactivity Alerts Tab](/docs/activitymonitor/8.0/agents/configuration/connection-settings.md) topic for additional
information.
...
See the [Inactivity Alerts Tab](/docs/activitymonitor/8.0/monitored-systems/hosts/windows.md) topic for
