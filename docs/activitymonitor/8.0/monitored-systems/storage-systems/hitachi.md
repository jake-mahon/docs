...
must be met. See the
[Hitachi Activity Auditing Configuration](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/hitachi-configuration.md) topic for
additional information.
...
- [Hitachi NAS Tab](/docs/activitymonitor/8.0/monitored-systems/storage-systems/hitachi.md)
