...
[SQL Server Activity Auditing Configuration](/docs/activitymonitor/8.0/platform-configuration/database-systems/sql-server.md) topic for
...
- [MS SQL Server Tab](/docs/activitymonitor/8.0/monitored-systems/hosts/sql-server.md)
- [Logon Trigger Tab](/docs/activitymonitor/8.0/monitored-systems/hosts/windows.md)
- [Tweak Options Tab](/docs/activitymonitor/8.0/monitored-systems/hosts/windows.md)
...
![MS SQL Server Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/mssqlservertab.webp)
