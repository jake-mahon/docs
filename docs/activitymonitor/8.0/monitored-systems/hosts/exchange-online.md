...
[Exchange Online Activity Auditing Configuration](/docs/activitymonitor/8.0/platform-configuration/cloud-platforms/exchange-online.md)
...
[Operations Tab](/docs/activitymonitor/8.0/data-collection/outputs/log-files.md) for additional information. Click **Next**.
...
for monitoring, configure the desired outputs. See the [Output for Monitored Hosts](/docs/activitymonitor/8.0/data-collection/outputs/log-files.md)
topic for additional information.
...
- [Connection Tab](/docs/activitymonitor/8.0/monitored-systems/hosts/windows.md)
