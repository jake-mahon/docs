...
![AD Monitoring Configuration - Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/operationstab.webp)
...
![AD Monitoring Configuration - Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/forgedpac.webp)
...
![Host (From) Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![Host (To) Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostto.webp)
...
![IP Addresses (From) Tab in the Authenticatoin Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesfrom.webp)
...
![IP Addresses (To) Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesto.webp)
...
![Operations Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/operationstab.webp)
...
![Servers Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/serverstab.webp)
...
![Users Tab in the Authentication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
...
![Operations Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/operationtab.webp)
...
![Attributes Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/attributestab.webp)
...
![Classes Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/classestab.webp)
...
![Context Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/contexttab.webp)
...
![Host (From) Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![IP Addresses (From) Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesfrom.webp)
...
![Servers Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/serverstab.webp)
...
![Users Tab in the Changes Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
...
![AD Monitoring Configuration - Global Filters Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/globalfilterstab.webp)
...
- [Global Filters Tab](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md)
- [Changes Tab](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md)
- [Authentication Tab](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md)
- [Replication Tab](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md)
- [LSASS Guardian Tab](/docs/activitymonitor/8.0/monitored-systems/domains/threat-detection.md)
- [LDAP Monitor Tab](/docs/activitymonitor/8.0/monitored-systems/domains/ldap-configuration.md)
...
![Servers Tab in the Replication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/serverstab.webp)
...
![Host (From) Tab in the Replication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![Users Tab in the Replication Tab](/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
...
- Add Output – Select an output from the Add Output dropdown. The outputs are: File, Syslog, and
  StealthDEFEND. See the [Output for Monitored Domains](/docs/activitymonitor/8.0/data-collection/outputs/log-files.md)
...
- Edit – Opens the selected AD Monitoring Configuration window to modify monitoring settings. See
  the [AD Monitoring Configuration Window](/docs/activitymonitor/8.0/monitored-systems/domains/active-directory.md) topic for
