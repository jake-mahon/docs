...
- [Activity Agent Server Requirements](/docs/activitymonitor/8.0/requirements/activityagent.md) for monitoring:
...
- [AD Agent Server Requirements](/docs/activitymonitor/8.0/requirements/adagent.md) for monitoring Active Directory
...
- [Agent Information](/docs/activitymonitor/8.0/install/agents.md)
