...
![Deletions Dashboard for Stealthbits Activivty Monitor App for QRadar](/img/product_docs/activitymonitor/activitymonitor/siem/qradar/dashboard/deletionsdashboard.webp)
...
- Latest Events – Tabular format of all deletion events which occurred over the specified time
  ...
  - See the [Table Card Features ](/docs/activitymonitor/8.0/integrations/siem/qradar.md#table-card-features) topic for additional
    information.
...
- Open Offenses – Number of ransomware offenses detected within QRadar from the file activity event
  ...
  - The value for this card is a hyperlink to the [Ransomware Dashboard](/docs/activitymonitor/8.0/integrations/siem/qradar.md).
...
![Permission Changes Dashboard for Stealthbits Activivty Monitor App for QRadar](/img/product_docs/activitymonitor/activitymonitor/siem/qradar/dashboard/permissionchangesdashboard.webp)
...
![User Investigation Dashboard for Stealthbits Activivty Monitor App for QRadar](/img/product_docs/activitymonitor/activitymonitor/siem/qradar/dashboard/userinvestigationdashboard.webp)
...
![Stealthbits Offenses in QRadar](/img/product_docs/activitymonitor/activitymonitor/siem/qradar/stealthbitsoffenses.webp)

While the [Ransomware Dashboard](/docs/activitymonitor/8.0/integrations/siem/qradar.md) reports on incidents of Ransomware attacks
...
[Settings](/docs/activitymonitor/8.0/integrations/siem/qradar.md) topic for additional information.
...
![Settings for Stealthbits Activivty Monitor App for QRadar](/img/product_docs/activitymonitor/config/dellpowerscale/settings.webp)
