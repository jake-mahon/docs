...
- [Security and Access Control](/docs/activitymonitor/8.0/integrations/rest-api/authentication.md)
- [Schema and Resources](/docs/activitymonitor/8.0/integrations/rest-api/api-reference.md)

  - [Agent](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md)
  - [Domain](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md)
  - [Host](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md)
  - [Output](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md)
...
- Agent – Represents an Activity Monitor Agent. API allows you to view existing agents and their
  ...
  See the [Agent](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md) topic for additional information.
...
- Host – Represents a host or platform monitored by the product (Windows, NetApp, SharePoint, SQL
  ...
  settings.  
  Children: Output  
  See the [Host](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md) topic for additional information.
...
- Domain – It is a Monitored Domain in the Console. The API provides summary information about each
  ...
  See the [Domain](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md) topic for additional information.
...
- Output – A log file or Syslog or AMQP (DEFEND) destination for the activity data. Typical
  ...
  See the [Output](/docs/activitymonitor/8.0/integrations/rest-api/endpoints.md) topic for additional information.
