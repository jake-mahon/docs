...
![Activity Monitor Agent Setup Wizard - Welcome Page](/img/product_docs/activitymonitor/8.0/install/welcome.webp)
...
![Completion Page](/img/product_docs/activitymonitor/8.0/install/complete.webp)
