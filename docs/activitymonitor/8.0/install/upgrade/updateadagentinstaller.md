...
![Update Agent Installer](/img/product_docs/activitymonitor/8.0/install/updateagentinstaller.webp)

**Step 2 –** Navigate to the location of the latest AD Agent installation package. Select the
installer and click **Open**.

![Confirmation Window](/img/product_docs/activitymonitor/8.0/install/updateagentinstallerpopup.webp)
