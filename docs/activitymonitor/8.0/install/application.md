...
![Activty Monitor Setup Wizard - Welcome Page](/img/product_docs/activitymonitor/8.0/install/welcome.webp)

**Step 2 –** On the Activity Monitor Setup Wizard welcome page, click **Next** .

![End-User License Agreement Page](/img/product_docs/activitymonitor/8.0/install/eula.webp)
...
![Ready to Install Netwrix Activity Monitor Page](/img/product_docs/activitymonitor/8.0/install/ready.webp)

**Step 5 –** Click **Install** to begin installation.

![Installation Netwrix Activity Monitor Progress Bar](/img/product_docs/activitymonitor/8.0/install/inprogress.webp)
...
![Installation Complete Page](/img/product_docs/activitymonitor/8.0/install/complete.webp)
