...
- [Manually Install the Activity Agent](/docs/activitymonitor/8.0/install/agent/manual.md)
- [ Manually Install the Linux Agent](/docs/activitymonitor/8.0/install/agent/manuallinux.md)
- [Manually Install the AD Module](/docs/activitymonitor/8.0/install/agent/manualad.md)
