...
![Add Host page with Dell Isilon selected](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/addhostemcisilon.webp)
...
![Isilon Options page](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/isilonoptions.webp)
...
![Protocols selection page](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/isilonprotocols.webp)
...
![Configure Basic Options](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/configurebasicoptions.webp)
...
![Where to Log the Activity Page Generic](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/wheretologgeneric.webp)
...
![Activity Monitor with Dell Isilon added](/img/product_docs/activitymonitor/8.0/admin/monitoredhosts/add/activitymonitoremcisilon.webp)
