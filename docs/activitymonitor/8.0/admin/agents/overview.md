...
![Image of Agents Home Page](/img/product_docs/activitymonitor/8.0/admin/agents/agentaddedfinalimage.webp)
...
- Add Agent – Opens the Add New Agent(s) window to deploy the activity/AD agent to a single server
  or to multiple servers at the same time. The following sections provide additional information:
    ...
    - [Single Activity Agent Deployment](/docs/activitymonitor/8.0/admin/agents/add/single.md)
    - [Multiple Activity Agents Deployment](/docs/activitymonitor/8.0/admin/agents/add/multiple.md)
    - [Active Directory Agent Deployment](/docs/activitymonitor/8.0/admin/agents/add/activedirectory.md)
    - [Linux Agent Deployment](/docs/activitymonitor/8.0/admin/agents/add/linux.md)
    - Remove – Opens the Remove Agents window where users can choose to remove the hosting server
      ...
      [Remove Agents](/docs/activitymonitor/8.0/install/removeagent.md) topic for additional information.
...
- Update Installer – Opens a browser window to select the newer AD agent installer. A confirmation
  ...
  [Update AD Agent Installer](/docs/activitymonitor/8.0/install/updateadagentinstaller.md) topic for additional
  information.
...
![Agent Messages](/img/product_docs/activitymonitor/8.0/admin/agents/agentmessages.webp)
...
[Agent Information](/docs/activitymonitor/8.0/install/agents.md) topic.
