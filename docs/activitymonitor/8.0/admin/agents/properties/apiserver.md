...
![API Server Tab for Agent Properties](/img/product_docs/activitymonitor/8.0/admin/agents/properties/apiservertab.webp)
...
![Add or Edit API Client popup window](/img/product_docs/activitymonitor/8.0/admin/agents/properties/addoreditapiclient.webp)
