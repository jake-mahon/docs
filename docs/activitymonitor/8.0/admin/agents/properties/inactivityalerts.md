...
![Inactivity Alerts Tab for Agent Properties](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalerts.webp)
...
![inactivityalertssyslogalerts](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalertssyslogalerts.webp)
...
![Message Template popup window for Syslog Alerts](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalertssyslogalertsmessagetemplate.webp)
...
![inactivityalertsemailalerts](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalertsemailalerts.webp)
...
![Email Alerts - Message Subject popup window](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalertsemailalertsmessagesubject.webp)
...
![Email Alerts - Message Body popup window](/img/product_docs/activitymonitor/8.0/admin/agents/properties/inactivityalertsemailalertsmessagebody.webp)
