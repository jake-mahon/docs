...
![Process Exclusions Tab](/img/product_docs/activitymonitor/8.0/admin/outputs/processexclusions.webp)
...
- Add – Opens the Add or Edit Process window to add a new process to the list. See the
  [Add or Edit Process Window](/docs/activitymonitor/8.0/admin/outputs/window/addeditprocess.md) topic for additional information.
