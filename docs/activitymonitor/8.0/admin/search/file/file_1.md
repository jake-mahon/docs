...
![File Search Results UI](/img/product_docs/activitymonitor/8.0/admin/search/results/filesearchresults.webp)
...
![Search Results with Permissions listed in the Operations Column](/img/product_docs/activitymonitor/8.0/admin/search/results/filesearchresultspermissionsimage.webp)
...
![File Search Results Permissions link popup window](/img/product_docs/activitymonitor/8.0/admin/search/results/permissionslpopupwindow.webp)
