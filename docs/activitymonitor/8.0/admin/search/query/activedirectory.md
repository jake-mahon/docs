...
![Search - Active Directory New Search Tab](/img/product_docs/activitymonitor/8.0/admin/search/query/activedirectorynewsearchtab.webp)
...
![Active Directory Search - General Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/generalfilters.webp)
...
![Object Changes Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/objectchangesfilters.webp)
...
![LSASS Guardian Filters](/img/product_docs/activitymonitor/8.0/admin/search/query/lsassguardianfilters.webp)
...
![LDAP Queries Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/ldapqueriesfilters.webp)
...
![Authentication Filters](/img/product_docs/activitymonitor/8.0/admin/search/query/authenticationfilters.webp)
