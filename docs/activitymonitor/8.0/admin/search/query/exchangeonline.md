...
![Exchange Online - Search Quary Bar](/img/product_docs/activitymonitor/8.0/admin/search/query/searchquerybar.webp)
...
![Exchange Online - General Category](/img/product_docs/activitymonitor/8.0/admin/search/query/general.webp)
...
![Exchange Online Search - User Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/user.webp)
...
![Exchange Online Search - Target Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/target.webp)
...
![Exchange Online Search - DLP Filter](/img/product_docs/activitymonitor/8.0/admin/search/query/dlp.webp)
