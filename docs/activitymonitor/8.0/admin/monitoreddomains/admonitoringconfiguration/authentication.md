...
![AD Monitoring Configuration - Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/operationstab.webp)
...
![AD Monitoring Configuration - Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/forgedpac.webp)
...
![Host (From) Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/hostfrom.webp)
...
![Host (To) Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/hostto.webp)
...
![IP Addresses (From) Tab in the Authenticatoin Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/ipaddressesfrom.webp)
...
![IP Addresses (To) Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/ipaddressesto.webp)
...
![Operations Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/operationstab.webp)
...
![Servers Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/serverstab.webp)
...
![Users Tab in the Authentication Tab](/img/product_docs/activitymonitor/8.0/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
