...
Checklist Item 2: [Provision FPolicy Account](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md)
...
- See the [Enable HTTP or HTTPS](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md) topic for instructions.

Checklist Item 4: [Configure FPolicy](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md)
...
- The Activity Monitor must register with the NetApp device as an FPolicy server. By default, it
  ...
  [Customize FPolicy Policy Name](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md) section for information on using a different
  policy name.
...
Checklist Item 2: [Provision ONTAP Account](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md)
...
Checklist Item 3: [Configure Network](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md)
...
configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md) topic for additional
information.
...
automatically configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/netapp-configuration.md) topic for
additional information.
