...
- See the [Install & Configure Dell CEE](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md) topic for instructions.

Checklist Item 3: Dell Device Configuration

- Configure the `cepp.conf` file on the Celerra VNX Cluster
- See the
  [Connect Data Movers to the Dell CEE Server](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md#connect-data-movers-to-the-dell-cee-server)
...
See the [CEE Debug Logs](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md#cee-debug-logs) section for information on
...
**NOTE:** See the
[Configure Dell Registry Key Settings](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md#configure-dell-registry-key-settings)
...
Checklist Item 2: [Install Dell CEE](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md)
...
- Select method:
  ...
  - [Manually Configure Auditing in OneFS](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md)
...
[Validate Setup](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md) topic for additional information.
...
[Dell CEE Debug Logs](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md#dell-cee-debug-logs) section for information on troubleshooting
...
- Enable auditing on the PowerStore device
  ...
  - See the [Enable Auditing for Dell PowerStore](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md) topic for additional information.
...
- Configure initial setup for a Unity device
  ...
  - [Unity Initial Setup with Unisphere](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md)
...
- Ensure the Dell CEE registry key has enabled set to 1 and has an EndPoint set to StealthAUDIT.
- Ensure the Dell CAVA service and the Dell CEE Monitor service are running.
- See the [Validate Setup](/docs/activitymonitor/8.0/platform-configuration/storage-platforms/dell-configuration.md) topic for instructions.
