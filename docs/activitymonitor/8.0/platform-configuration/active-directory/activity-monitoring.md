...
See the [File Archive Repository Option](/docs/activitymonitor/8.0/platform-configuration/active-directory/file-archiving.md) topic for additional information on that
option.
