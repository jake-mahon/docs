...
**NOTE:** See the
[Configure Dell Registry Key Settings](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/activity/installcee_1.md#configure-dell-registry-key-settings)
