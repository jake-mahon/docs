...
configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/activity/configurefpolicy_1.md) topic for additional
information.
...
automatically configure the FPolicy. See the [Configure FPolicy](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/activity/configurefpolicy_1.md) topic for
additional information.
