...
**NOTE:** See the
[Configure Dell Registry Key Settings](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/activity/installcee.md#configure-dell-registry-key-settings)
