...
Checklist Item 2: [Provision ONTAP Account](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/celerra-vnx-aac/provisionactivity_1.md)
...
Checklist Item 3: [Configure Network](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/celerra-vnx-aac/configurefirewall.md)
...
Checklist Item 4: [Configure FPolicy](/docs/activitymonitor/8.0/requirements/activityagent/nas-device-configuration/celerra-vnx-aac/configurefpolicy_1.md)
