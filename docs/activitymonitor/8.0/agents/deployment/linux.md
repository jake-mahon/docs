...
must be met. See the [Linux Agent Server Requirements](/docs/activitymonitor/8.0/getting-started/requirements.md) topic
...
See the [Host Properties Window](/docs/activitymonitor/8.0/monitored-systems/index.md) topic for additional
information.
