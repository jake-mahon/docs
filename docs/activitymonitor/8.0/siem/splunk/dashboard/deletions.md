...
![Deletions Dashboard for Stealthbits Activivty Monitor App for Splunk](/img/product_docs/activitymonitor/8.0/siem/qradar/dashboard/deletionsdashboard.webp)
