...
For more information on the **HubDetails.xml** nodes and settings see the [First Run – HubDetails.xml File](../../Admin/Settings/DeviceGroups#_First_Run_– "Groups: Device Group Administration") topic for additional information.