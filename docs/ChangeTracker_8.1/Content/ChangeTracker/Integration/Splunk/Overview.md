...
**Step 1 –** From the Settings menu select **Credentials** and scroll to the Splunk Credentials section.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SplunkCredentials.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SplunkSearch.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/AddSplunkPolicy.png)

**Step 3 –** Name it **Splunk**, set the Usage column to **Tracking**, and click **update**.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/Tracking.png)

**Step 4 –** Click the **tracking** button on the new Splunk policy and then scroll right to the Splunk Search Queries tab.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SPLQuery.png)

**Step 5 –** Click the **tick box** to add a query and then click **Add a Splunk Query**.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SPLQueryConfiguration.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/TemplateComplete.png)

### Devices and Groups

Follow the steps to add a group.

**Step 1 –** From the Settings menu, select **Groups** and click **Add** to add a new group called Splunk Tracker.
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/Group2.png)

Any device in this group of the type Splunk will execute the Splunk tracking policy created above.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/Group.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/ManualDeviceCreation.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/AddSplunkDevice.png)
...
To discover devices to match change events from Splunk, see the [Configure Device Discovery](../ITSM/SyncServiceAdmin#Configur "Configure Device Discovery") section in [Sync Service Administration](../ITSM/SyncServiceAdmin "Sync Service Administration") topic for additional information.
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SplunkEvents.png)
...
![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/SplunkEventBody.png)

Manual runs of the tracking policy can be executed from the Splunk device by clicking Start Tracker Poll.

![](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/Integrations/Splunk/StartTrackerPoll.png)