...
![CustomPathmatchDefinition](../../../../../../static/images/ChangeTracker_8.1/Content/Resources/Images/ChangeTracker/CustomPathmatchDefinition.png "CustomPathmatchDefinition")
...
**Step 3 –**  **FileMatchType** – options the same as for the 'foldermatchtype' (All, Exact, Wildcards, Regex);
