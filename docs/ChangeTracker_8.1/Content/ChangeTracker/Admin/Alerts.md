...
**NOTE:** Core system settings such as the Syslog Server and SMTP details will also need to be defined via **Settings** -> **System Settings** in the Change Tracker . See the [System Settings](Settings/SystemSettings "System Settings") topic for additional information.