...
How to create a
[ Connection ](../../../../integration-guide/toolkit/xml-configuration/connectors/connection/index.md)
inside a
...
to[ Synchronize Data ](../../synchronization/index.md)and one connection for
[Provision](../../../administrate/provisioning/index.md).
...
See the [ Create the Connector ](../connector-declaration/index.md) and
...
- Do we need [Provision](../../../administrate/provisioning/index.md)? If so, should provisioning be
...
[Connections](../../../../integration-guide/connectors/configuration-details/connections/index.md)
topic for additional information.
...
1. click on **Check Connection** to ensure that Identity Manager can reach the managed system;
    ...
    [ Jobs ](../../../../integration-guide/tasks-jobs/jobs/index.md)topic for additional
