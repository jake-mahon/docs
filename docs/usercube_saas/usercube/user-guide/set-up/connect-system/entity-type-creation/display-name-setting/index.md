...
4. Set the display name. As a display name, you can use either the value of an existing property, or compute [Expressions](/docs/usercube_saas/usercube/integration-guide/toolkit/expressions/index.md) based on existing properties.
...
5. Click on __Save & Close__.
   ...
   Synchronize Data
   ](/docs/usercube_saas/usercube/user-guide/set-up/synchronization/index.md). More specifically, changes in display names won't take effect until the next [
