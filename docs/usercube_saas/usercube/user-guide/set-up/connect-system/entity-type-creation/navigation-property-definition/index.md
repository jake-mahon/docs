...
Entity Type
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md)'s relationships to other entity types.
...
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/index.md) topic for additional information.
...
>
> ![Navigation Property - memberOf](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_memberof_v600.png)
>
...
>
> ![Navigation Property - member](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_member_v600.png)
...
>
> ![Navigation Property - Manager](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_manager_v600.png)
>
...
>
> ![Navigation Property - Managed Department](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_managerof_v600.png)
...
4. Fill in the information fields.
   ...
   ![Navigation Properties](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_navigationproperties_v602.png)
   ...
   - __APPLICATION METADATA__: fields about the display of the properties inside Identity Manager.
     ...
     - ```Storage Indicator```: describes the association that can be __mono-valued__ (meaning 1-to-1 or many-to-1) or __multi-valued__ (meaning 1-to-many or many-to-many).
       ...
       For one entity type, Identity Manager can store up to 25 optimized mono-valued navigation properties. For performance purposes, Netwrix Identity Manager (formerly Usercube) recommends choosing ```optimized mono-valued``` as a storage indicator as often as possible.
   ...
   >
   > ![AD Entity Type - Navigation Properties](/static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/navigation-property-definition/entitytypecreation_examplead3_v603.png)
5. Click on the Gear symbol to add advanced settings if needed.
   ...
   - __Source Expression__: expression that defines the property based on at least one source object. Can be defined by a property path and/or an [Expressions](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/expressions/index.md).
...
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/connect-system/entity-type-creation/display-name-setting/index.md).
