...
1. Start by declaring an [Entity Type](../entity-type-declaration/index.md).
...
5. Click the gear icon to access advanced settings:
    ...
    - **Source Expression**: Define using a property path or
      [expression](../../../../../integration-guide/toolkit/expressions/index.md)

        > Example: Scalar `isUnused` created by combining `accountExpires` and `lastLogonTimestamp`
        >
        > ![Source Expression Example](../../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/entitytypecreation_sourceexpressionexample_v60.webp)
