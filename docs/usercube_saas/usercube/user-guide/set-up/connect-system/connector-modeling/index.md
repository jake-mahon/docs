...
configuration: [Create an Entity Type](../entity-type-creation/index.md).
...
**Roles:** During
the[ Create Roles in the Role Catalog ](../../single-roles-catalog-creation/index.md)step for this
