...
![Schemas' Key](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_key.png)
...
![User Model](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_user.png)
...
![User Model - Canteen Badges Example](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-canteen.png)
...
![User Model - Mailboxes Example](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-mailbox.png)
...
![User-Group Model](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_usergroup.png)
...
![User-Group Example - SAB](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_sab.png)
...
![User-Group Example - RACF](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_racf.png)
...
![User-Group Example - TSS](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss.png)
...
](/docs/usercube_saas/usercube/user-guide/set-up/single-roles-catalog-creation/index.md)step for this connector you can build roles based on the group-membership system represented by users and profiles. Thus you will create navigation rules to represent the link between users and profiles.
...
![User-Group Example - SDGE](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_sdge.png)
...
![Account-Profile-Transaction Model](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiletransaction.png)
...
![Profiles Example](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiles.png)
...
![User-Group Example - TSS](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss-prof-trans.png)
...
![Star Model](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_star.png)
...
![Star Model Example](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_starmodel.png)
...
![AD Example - Step 1](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad-step1.png)

__Step 3: define useful data close to your reality.__

We shape these objects with the following attributes:

![AD Example - Step 2](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad.png)
...
>
> ![AD_Entry Example](/img/product_docs/usercube/usercube/user-guide/set-up/connect-system/connector-modeling/connectormodel_adentry.png)
