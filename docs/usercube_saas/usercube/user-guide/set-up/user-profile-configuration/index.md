...
How to tweak the [References: Permissions](/docs/product_docs/usercube_saas/usercube/integration-guide/profiles-permissions/permissions/index.md) for actions within Identity Manager, for a set of basic [
Assigned Profile
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/access-control/assignedprofile/index.md).
...
- administration, which gives access to [Administrate](/docs/product_docs/usercube_saas/usercube/user-guide/administrate/index.md) actions, accessible in the __Administration__ section on the home page;
...
The goal here is to create profiles and link specific permissions to the profiles, in order to build a set of typical profiles that will later be assigned to users. See the [Assign Users a Profile](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/user-profile-assignment/index.md) topic for additional information. Instead of assigning permissions one by one to users, you will assign them sets of permissions (i.e. profiles).
...
| Input | Output |
| --- | --- |
| [ Create the Workforce Repository ](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/index.md) (required) | User profiles |
...
See the [Assign Users a Profile](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/user-profile-assignment/index.md) topic for additional information.
