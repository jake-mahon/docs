...
How to tweak the [References: Permissions](/docs/usercube_saas/usercube/integration-guide/profiles-permissions/permissions/index.md) for actions within Identity Manager, for a set of basic [
Assigned Profile
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/access-control/assignedprofile/index.md).
...
- administration, which gives access to [Administrate](/docs/usercube_saas/usercube/user-guide/administrate/index.md) actions, accessible in the __Administration__ section on the home page;
...
| Input | Output |
| --- | --- |
| [ Create the Workforce Repository ](/docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/index.md) (required) | User profiles |
...
See the [Assign Users a Profile](/docs/usercube_saas/usercube/user-guide/set-up/user-profile-assignment/index.md) topic for additional information.
