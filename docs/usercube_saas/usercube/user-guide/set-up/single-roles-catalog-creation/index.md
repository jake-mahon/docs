...
How to define
[ Single Role ](../../../integration-guide/toolkit/xml-configuration/provisioning/singlerole/index.md)
...
[ Role Model ](../../../integration-guide/role-model/index.md) needed by the organization. Roles are
...
- roles need to be structured so categories are created to:
    ...
    [ Composite Role ](../../../integration-guide/toolkit/xml-configuration/provisioning/compositerole/index.md)
...
- to be effective, roles must be linked to actual entitlements in the managed systems. Technically
  ...
  type. See the [ Categorize Resources ](../categorization/index.md) topic for additional
  information.
...
[ Model the Data ](../connect-system/connector-modeling/index.md) established for a given system.
...
[Create a Role Manually](role-manual-creation/index.md) topic for additional information.
...
[ Create Roles in Bulk ](role-naming-rule-creation/index.md) topic for additional information.
...
1. Create as many single roles as possible (with their navigation rules and categories) via the
   [ Create Roles in Bulk ](role-naming-rule-creation/index.md) naming rules.
2. Complete the role catalog if needed by creating manually additional
   [ Create a Category ](category-creation/index.md) and single roles with their navigation rules.
3. Add [Create a Composite Role](../../optimize/composite-role-creation/index.md) to the single role
...
[ Perform a Simulation ](../../optimize/simulation/index.md) are available in order to anticipate
...
[ Manage Risks ](../../optimize/risk-management/index.md)management.
