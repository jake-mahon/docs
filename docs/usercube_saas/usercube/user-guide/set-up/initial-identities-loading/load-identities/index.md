...
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/development-environment-installation/index.md) topic for additional information
...
4. Fill said template with the data you collected.
   ...
   The Excel file contains several tabs which organize data, but not all tabs and columns are mandatory. You can find __more details about the [Template Description](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/template-description/index.md)__. Below are the minimum recommended attributes (mandatory in orange):
   ...
   [__Click here to download a template example__](/docs/product_docs/usercube_saas/resources/directory_example_v602.xlsx).
