...
1. [
   ...
   ](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/generate-unique-properties/index.md) for all users, pre-existing and new, who do not have them yet.
2. [Load Identities to Identity Manager](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/load-identities/index.md) to Identity Manager based on the recommended attributes from the provided organizational model [Template Description](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/template-description/index.md).
3. [
   Adjust the Workforce Data Model
   ](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/initial-identities-loading/adjust-datamodel/index.md) following Identity Manager's suggestions.
