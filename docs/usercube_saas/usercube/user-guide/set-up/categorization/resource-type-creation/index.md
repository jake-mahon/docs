...
2. Fill in the fields.
   ...
   - ```Category```: category assigned to the resource type. It can be chosen from among the existing categories or [created](/docs/usercube_saas/usercube/user-guide/set-up/single-roles-catalog-creation/index.md) directly from the categories list by clicking on the __+ Category__ button.
