...
](/docs/usercube_saas/usercube/user-guide/set-up/categorization/resource-type-creation/index.md).
...
![Classification Schema](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_classifschema.png)
...
![Correlation Schema](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_correlschema.png)
...
>
> ![Example - Basic Users in Usercube](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_examplebasicuser.png)
>
> For basic users, we have in the AD:
>
> ![Example - Basic Users in AD](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_examplebasicad.png)
>
...
>
> ![Example - Basic Users in Usercube](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_exampleadminuser.png)
>
> For administrators, we have in the AD:
>
> ![Example - Admin Users in AD](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_exampleadminad.png)
>
> Thus our example could induce the following rules:
> | Classification Rules | Correlation Rules |
> | --- | --- |
...
Correlate Resources
](/docs/usercube_saas/usercube/user-guide/set-up/categorization/correlation/index.md) topic for additional information.
...
![Categorization Schema](/img/product_docs/usercube/usercube/user-guide/set-up/categorization/categorization_categschema.png)
...
Entitlement Management
](/docs/usercube_saas/usercube/introduction-guide/overview/entitlement-management/index.md) topic for additional information. The role model contains all the roles and rules which drive the entitlement assignment logic inside Identity Manager.

A role model is made up of [Policy](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/policy/index.md) which contain roles, rules and resource types. Most often the default policy is enough. However, in more complex situations, additional policies can be created to separate groups of roles, rules and resource types. See the [Create a Policy](/docs/usercube_saas/usercube/user-guide/optimize/policy-creation/index.md) topic for additional information.
...
3. Create the appropriate [
   Classify Resources
   ](/docs/usercube_saas/usercube/user-guide/set-up/categorization/classification/index.md) for accounts that do not have an owner.
...
](/docs/usercube_saas/usercube/user-guide/optimize/simulation/index.md) in order to previsualize changes.
...
Categorization also enables the [Review Orphaned and Unused Accounts](/docs/usercube_saas/usercube/user-guide/administrate/orphan-unused-account-review/index.md).
