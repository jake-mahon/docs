...
![Synchronization Schema](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_schema.webp)

#### Export

The [
Export Task
](../../../integration-guide/toolkit/xml-configuration/jobs/tasks/agent/exporttask/index.md) creates extractions, a snapshot of the managed system's data, used to insert and/or refresh the data that is inside Identity Manager. Extractions are accessible when there is at least one connection with an export-enabled [
References: Packages
](../../../integration-guide/connectors/references-packages/index.md). Extracted data becomes meaningful when it is loaded into resources as specified by the entity type structure.
...
](../../../integration-guide/toolkit/xml-configuration/jobs/tasks/agent/preparesynchronizationtask/index.md)performs a preparatory data cleansing to spot errors and list them in a generated file in the ```/{InstallationFolder}/Work/Synchronization``` folder.
...
](../../../integration-guide/synchronization/upward-data-sync/index.md) topic for additional information.
...
Connector
](../../../integration-guide/toolkit/xml-configuration/connectors/connector/index.md) attributes:
...
](../connect-system/index.md) topic for additional information.
...
2. On the relevant connector page, in the __Entity Types__ frame, click on __Jobs__.
   ...
   ![Synchronize Job (Only Complete)](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_executionjobs-complete_v602.webp)
...
Jobs
](../../../integration-guide/tasks-jobs/jobs/index.md) provided by Identity Manager:
...
](../../../integration-guide/tasks-jobs/how-tos/jobfast/index.md) and [Set up Complete Synchronization](../../../integration-guide/tasks-jobs/how-tos/jobdaily/index.md) topics for additional information.
...
![Jobs Results Dashboard](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_dashboard_v522.webp)

You can fine-tune the synchronization and/or provisioning of the connector by clicking on the __Edit__ button.

![Edit button](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_edit_v600.webp)
...
![Home - Job Execution](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/home_jobexecution_v602.webp)

## Verify an Entity Type's Synchronization

In order to verify both the synchronization configuration and [Create an Entity Type](../connect-system/entity-type-creation/index.md):
...
4. Access the relevant entity types (from the menu items on the left of the home page) to check synchronized resources, by navigating in the UI from the accounts through a sample of associations, via the eye icon:
   ...
   >
   > ![SAB Example - Home Page](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_examplesab_v522.webp)
   >
   > Clicking on ```SAB - Users``` displays the list of all synchronized resources.
   >
   > ![SAB Example - Data List](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_examplesab2_v602.webp)
   >
   > Clicking on any resource displays its detailed attributes, for example ```Abbott Mark```:
   >
   > ![SAB Example - Resource Attributes](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_examplesab3_v602.webp)
   >
...
![Test Entity Type](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/home_entitytypes_v602.webp)
...
![Threshold warning](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_threshold_v603.webp)
...
2. Study synchronization counters and the list of all synchronization changes. These tools help you make a decision about whether to bypass synchronization thresholds.
   ...
   ![Job progress](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_thresholdlog_v603.webp)
...
3. If, after verifying, all changes are legitimate, click on the __Resume__ button at the top of the job progress page. This will restart the job and allow the changes to be synchronized.
   ...
   ![Resumed Job](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/synchro_thresholdresumed_v602.webp)
...
- If you manually typed the source column of a property in the entity types, then make sure that the source column exists in the corresponding managed system.
  ...
  ![Source Column](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/entitytype_sourcecolumn_v602.webp)
...
![Property Format](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/entitytype_format_v523.webp)
