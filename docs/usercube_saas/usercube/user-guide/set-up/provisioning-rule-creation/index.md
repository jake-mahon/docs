...
- [
  Create Resources
  ](/docs/usercube_saas/usercube/user-guide/set-up/provisioning-rule-creation/resource-creation/index.md)type rules to automatically create resources.
- [Compute a Scalar Property](/docs/usercube_saas/usercube/user-guide/set-up/provisioning-rule-creation/scalar-property-computation/index.md) to compute scalar properties;
