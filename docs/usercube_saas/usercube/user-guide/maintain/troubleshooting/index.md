...
](/docs/product_docs/usercube_saas/usercube/integration-guide/tasks-jobs/how-tos/troubleshoot-connector-jobs/index.md) troubleshooting instructions concerning connector jobs.
...
| Input | Output |
| --- | --- |
| [Implement Identity Manager](/docs/product_docs/usercube_saas/usercube/user-guide/deploy/implementation/index.md) (required) | Working environment |
...
See more details on [
Synchronize Data
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/synchronization/index.md) thresholds.
...
- the role model being computed through the [
  ...
  ](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) or the corresponding executable, with the block provisioning option;
