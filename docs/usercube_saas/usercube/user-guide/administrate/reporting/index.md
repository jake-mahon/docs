...
[ Configure a User Profile ](../../set-up/user-profile-configuration/index.md)topic for additional
information.
...
[API query grammar](../../../integration-guide/api/squery/index.md) topic for additional
information.
...
[ Synchronize Data ](../../set-up/synchronization/index.md) and
[ Classify Resources ](../../set-up/categorization/classification/index.md) topics for additional
...
[ Universe ](../../../integration-guide/toolkit/xml-configuration/business-intelligence/universe/index.md)
...
See the
[Connect Power BI to Identity Manager](../../../integration-guide/governance/reporting/how-tos/connect-powerbi/index.md)
