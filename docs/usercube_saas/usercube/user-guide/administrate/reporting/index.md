...
- the list of [Review Orphaned and Unused Accounts](/docs/product_docs/usercube_saas/usercube/user-guide/administrate/orphan-unused-account-review/index.md).
...
When facing frequent reporting requirements outside the scope of predefined reports, new reports can be configured with XML via ```Report Query``` and specific query grammar. See the [API query grammar](/docs/product_docs/usercube_saas/usercube/integration-guide/api/squery/index.md) topic for additional information.
...
Synchronize Data
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/synchronization/index.md) and [
Classify Resources
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/categorization/classification/index.md) topics for additional information. This module offers the possibility to customize reports and download them.

The Query module is based on predefined [
Universe
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/business-intelligence/universe/index.md) that can be adjusted later on in XML configuration, just like the list of available query models.
...
3. Click on __Fields to Display__ and select the appropriate fields from among the database [
   Universe
   ](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/business-intelligence/universe/index.md) and click on __Confirm__.
   ...
   Universe
   ](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/business-intelligence/universe/index.md) that you are working with. Perhaps the fields that you chose cannot be properly correlated.
...
See the [Connect Power BI to Identity Manager](/docs/product_docs/usercube_saas/usercube/integration-guide/governance/reporting/how-tos/connect-powerbi/index.md) topic for additional information on how to analyze Identity Manager's data with Power BI.
