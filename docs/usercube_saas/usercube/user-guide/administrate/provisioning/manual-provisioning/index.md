...
![Provisioning State Schema](/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_states_v523.png)
...
1. Ensure that the task to compute or generate provisioning orders was launched after the request (or the provisioning review, if any), through the complete job in the __Job Execution__ page.
   ...
   ![Manual Provisioning Screen](/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_page_v603.png)
...
4. Creation, edition and deletion orders follow the same process: read Identity Manager's suggestions and create, edit or delete the appropriate resource directly in the managed system (outside Identity Manager).
   ...
   ![Creation Provisioning Order](/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_createresource_v522.png)

   ![Creation Provisioning Order](/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_editresource_v522.png)
...
![Bulk Provisioning](/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/provmanual_bulk_v603.png)
