...
[ Manual Ticket ](../../../../integration-guide/connectors/references-packages/manual-ticket/index.md).
...
2. Follow the workflow through
   [ Request Entitlement Assignment ](../../manual-assignment-request/index.md) to make a change in
