...
2. Follow the manual assignment workflow through [
   ...
   ](/docs/product_docs/usercube_saas/usercube/user-guide/administrate/manual-assignment-request/index.md) to make a change in one of their permissions, which involves automated provisioning.
