...
[ Configure a User Profile ](../../../set-up/user-profile-configuration/index.md) topic for
...
you[ Create a Resource Type ](../../../set-up/categorization/resource-type-creation/index.md). You
can choose to:
