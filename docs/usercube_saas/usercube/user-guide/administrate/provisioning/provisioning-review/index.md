...
![Provisioning State Schema](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provreview_states_v523.webp)
...
| Input | Output |
| --- | --- |
| [ Create a Provisioning Rule ](../../../set-up/provisioning-rule-creation/index.md) (required)   [ Create Roles in the Role Catalog ](../../../set-up/single-roles-catalog-creation/index.md) (required) | Provisioning orders |
...
](../../../set-up/categorization/resource-type-creation/index.md). You can choose to:

- Set the number of required approvals by a [
  Manage Role Officers
  ](../../../set-up/role-officer-management/index.md), via the ```Approval Workflow``` option.
...
1. On the home page, click on the entity type that you want to manage in the __Provisioning Review__ section.
   ...
   ![Home Page - Provisioning Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/home_provisioningreview_v523.webp)

   ![Provisioning Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provmanual_provreview_v602.webp)
2. Click on a line to access details and handle addition, association, update or deletion orders.
   ...
   ![Fulfill Task](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/synchro_resourcetype_v602.webp)

### Handle an addition order

Identity Manager shows all the properties of the new resource to be created:

![Addition Order Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provmanual_reviewaddition_v602.webp)

- ```Proposed Value```: value proposed by Identity Manager.
- [Entitlement Assignment](../../../../integration-guide/role-assignment/assignments-of-entitlements/index.md)
...
See the [Entitlement Assignment](../../../../integration-guide/role-assignment/assignments-of-entitlements/index.md) and [
Create a Provisioning Rule
](../../../set-up/provisioning-rule-creation/index.md) topics for additional information.
...
Classify Resources
](../../../set-up/categorization/classification/index.md)and all resource properties to be verified:

![Association Order Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provmanual_reviewassociation_v602.webp)
...
![Edition Order Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provmanual_reviewedition_v602.webp)
...
![Deletion Order Review](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provmanual_reviewdeletion_v602.webp)
...
![Resource View](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provreview_resourceview_v603.webp)

In addition, using resource view enables bulk unblocking for provisioning orders with errors.

![Bulk Unblock](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provreview_bulkunblock_v603.webp)
...
![Property View](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/provisioning-review/provreview_propertyview_v603.webp)
...
2. Follow the [
   ...
   ](../../manual-assignment-request/index.md) workflow to make a change in one of their permissions, which involves provisioning review.
...
4. Click on __Jobs__ > __Fulfill__ on the corresponding connector's overview page, in the __Resource Types__ frame, to execute the provisioning orders.
   ...
   ![Home Page - Job Execution](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/categorization/classification/synchro_resourcetype_v602.webp)
...
![Home Page - Manual Provisioning](../../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/provisioning/manual-provisioning/home_manualprovisioning_v523.webp)
