...
1. Ensure that the
   [ Compute Role Model Task ](../../../../integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md)
...
5. Click on the line of an account with an owner.
    ...
    required. See the [ Classify Resources ](../../../set-up/categorization/classification/index.md)
    ...
    [ Reconcile a Property ](../property-reconciliation/index.md) topic for additional information.
...
7. Click on **Confirm Account Deletion** or **Authorize Account** according to the previous
   decision.
8. Trigger the [Provision](../../provisioning/index.md) by launching, on the appropriate connector's
