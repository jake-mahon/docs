...
![Home - Entity Types](../../../../../../static/img/product_docs/usercube/usercube/user-guide/set-up/synchronization/home_entitytypes_v602.webp)
...
Create Menu Items
](../../../integration-guide/ui/how-tos/create-menu-items/index.md) topic for additional information on customization.

![Owner / Resource Type Column](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/reporting/orphan_entitytype_v523.webp)
...
Generate Reports
](../reporting/index.md) topic for additional information. Choose to display __User__ and __AD User__ (nominative) with a filter on void user's display names.
...
Generate Reports
](../reporting/index.md) topic for additional information.
...
![Query of Unused Accounts](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_unusedquery_v602.webp)
...
| Input | Output |
| --- | --- |
| [ Categorize Resources ](../../set-up/categorization/index.md) (required) | Removed orphaned and unused accounts |

## Review an Orphaned Account

Review an orphaned account by proceeding as follows:

![Home Page - Resource Reconciliation](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/home_resourcereconciliation_v523.webp)

__Step 1 –__ Go to the __Resource Reconciliation__ page, accessible from the corresponding section on the home page.

![Resource Reconciliation Page](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/unauth_unauthorizedaccounts_v602.webp)
...
![Select Owner](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_revieworphans_v602.webp)
...
![Owners List](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_revieworphans-owners_v602.webp)
...
](../access-certification/index.md) topic for additional information. But a service account must not be linked to a person, for the departure of said person from the company may trigger the loss of the service account.   
...
![Schema - Service Accounts](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_serviceaccounts.webp)
...
![Resource View](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_resourceview_v523.webp)
...
![Property View](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_propertyview_v603.webp)
...
![Bulk Reconcile](../../../../../../static/img/product_docs/usercube/usercube/user-guide/administrate/orphan-unused-account-review/orphan_bulkreconcile_v603.webp)
