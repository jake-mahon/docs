...
- [
  ...
  ](production-agent-installation/index.md)

  How to install a local agent for production environment.

- [
  Configure the Agent's Settings
  ](production-agent-installation/settings-files/index.md)
