...
![Simple Role](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedroles_simplerole.webp)
...
> ![Role Matrix](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedroles_numerousroles.webp)
...
![With/Without Parameters](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedroles_parameters.webp)
...
Dimension
](../../../integration-guide/toolkit/xml-configuration/metadata/dimension/index.md) topic for additional information.
...
![Example - Role](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedrole_examplerole_v603.webp)

__Step 2 –__ Create a single role. See the [Create a Role Manually](../../set-up/single-roles-catalog-creation/role-manual-creation/index.md) topic for additional information.

__Step 3 –__ Create one navigation rule linked to the role for each available value of the parameter. See the [Create a Role Manually](../../set-up/single-roles-catalog-creation/role-manual-creation/index.md) topic for additional information.

Here we have three navigation rules, one for each distinct time slot (dimension A). For example:

![Example - Rule](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedrole_examplerule_v603.webp)
...
![Example - Role Parameter Required](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedrole_exampleroleparameter_v603.webp)

__Step 4 –__ Go back to the roles page to edit the single role from step 2, if needing to set the parameter required.

If you want Identity Manager to provide suggestions to set the parameter's value, then make sure that users' [context rule](../../../integration-guide/toolkit/xml-configuration/provisioning/contextrule/index.md) specifies the dimension.
...
](../../administrate/manual-assignment-request/index.md) topic for additional information.

In our example:

![Example - Step 1](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedroles_parameterexamplestep1_v603.webp)

![Example - Step 2](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedroles_parameterexamplestep2_v603.webp)

If the dimension is specified in the users' context rule, then Identity Manager will provide suggestions.

![Example - Suggestion](../../../../../../static/img/product_docs/usercube/usercube/user-guide/optimize/parameterized-role/parameterizedrole_examplerolesuggestion_v603.webp)
