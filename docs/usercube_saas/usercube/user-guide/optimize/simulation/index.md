...
How to assess the impact of a modification on the role model, including the role catalog, role assignment rules and resource correlation rules, using a dedicated [Create a Policy](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/policy-creation/index.md). See the [
...
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/automate-role-assignment/index.md)[
Correlate Resources
](/docs/product_docs/usercube_saas/usercube/user-guide/set-up/categorization/correlation/index.md), and [Create a Policy](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/policy-creation/index.md) topics for additional information.
...
- [Single Role Rule](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/singlerolerule/index.md) and [Composite Role Rule](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/compositerolerule/index.md).
...
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourceclassificationrule/index.md), and [Resource Type](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md) topics for additional information.

A simulation can also be created by the [
Perform Role Mining
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/role-mining/index.md) for the automation of role assignments.
...
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) to observe the actual changes in users' entitlements.
