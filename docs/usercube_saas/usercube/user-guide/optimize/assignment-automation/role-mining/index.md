...
](/docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/index.md) wall further.
...
> ](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) is able to assign single roles to users according to their existing group membership.
>
...
Mining Rule
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/miningrule/index.md) that Identity Manager applies with the [
Get Role Mining Task
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index.md).
...
1. On the home page in the __Configuration__ section, click on the __Role Mining__ button.
   ...
   ![Home page - Connectors](/img/product_docs/usercube/usercube/user-guide/optimize/assignment-automation/role-mining/home_rolemining_v60.png)
...
2. Click on the addition button at the top right and fill in the fields.
   ...
   ![New Mining Rule](/img/product_docs/usercube/usercube/user-guide/optimize/assignment-automation/role-mining/rolemining_miningrule_v602.png)

   - ```Policy```: [Create a Policy](/docs/usercube_saas/usercube/user-guide/optimize/policy-creation/index.md) in which the mining rule exists.
   - ```Entity Type```: [Create an Entity Type](/docs/usercube_saas/usercube/user-guide/set-up/connect-system/entity-type-creation/index.md) on which the mining rule is applied, i.e. the entity type targeted by role mining's entitlement analysis.
   - ```Category```: [
     Create a Category
     ](/docs/usercube_saas/usercube/user-guide/set-up/single-roles-catalog-creation/category-creation/index.md) containing the roles targeted by role mining's analysis.
   ...
   - ```Rule Policy```: [Create a Policy](/docs/usercube_saas/usercube/user-guide/optimize/policy-creation/index.md) in which the single role rules will be generated.
...
4. Click on __Simulate__ to perfom role mining in a simulation. See the[
   ...
   ![Role Mining Jobs](/img/product_docs/usercube/usercube/user-guide/optimize/assignment-automation/role-mining/rolemining_launchjob_v602.png)
