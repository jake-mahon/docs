...
[ Create a Working Directory ](../../production-ready/working-directory/index.md) topic as:
...
- _Read & Execute_ and _List folder contents_ on the `Runtime` directory, usually
  `C:/Usercube<Organization>/Runtime`, in order to run the agent executable;
...
See the [ Create a Working Directory ](../../production-ready/working-directory/index.md) and
[Application Settings](../../../integration-guide/network-configuration/agent-configuration/appsettings/index.md)
topics for additional information.
...
> [Install the Server](../../production-ready/server/index.md) topic for additional information.
...
- Service accounts with the necessary permissions for the agent to perform _Read_ and/or _Write_
  ...
  provisioning; See the [Connectors](../../../integration-guide/connectors/index.md) topic for
...
protected. See the
[appsettings.agent](../../../integration-guide/network-configuration/agent-configuration/appsettings-agent/index.md)
and [ Modules ](../../../integration-guide/modules/index.md) topics for additional information.
...
[ Send Notifications ](../../production-ready/email-server/index.md).
...
To start the installation, follow either the [ Quick Start Guide](../../quick-start/index.md) or the
[Production-Ready Installation](../../production-ready/index.md).
