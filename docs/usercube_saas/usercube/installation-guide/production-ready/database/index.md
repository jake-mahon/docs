...
Please make sure that the [Database](../../requirements/database-requirements/index.md) requirements are met before going further.
...
![Execute Query](../../../../../../static/img/product_docs/usercube/usercube/installation-guide/production-ready/database/execute_query.webp)
...
It will also show how to test the Identity Manager Database connection. See the [Install the Server](../server/index.md) topic for additional information.
