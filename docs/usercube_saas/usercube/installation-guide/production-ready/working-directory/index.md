...
- ```appsettings.*.json```: [Network Configuration](/docs/product_docs/usercube_saas/usercube/integration-guide/network-configuration/index.md).

## What's Next?

Next section shows how to install the Identity Manager Database. See the [
Install the Database
](/docs/product_docs/usercube_saas/usercube/installation-guide/production-ready/database/index.md)topic for additional information.
