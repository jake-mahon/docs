...
This feature is optional and must be activated by the Swagger settings section. See the [Application Settings](/docs/product_docs/usercube_saas/usercube/integration-guide/network-configuration/server-configuration/general-purpose/index.md) topic for additional information.
...
![Usercube server swagger page](/static/img/product_docs/usercube/usercube/integration-guide/api/swagger.png)
