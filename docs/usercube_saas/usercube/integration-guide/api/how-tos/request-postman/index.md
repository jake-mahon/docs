...
2. Create a new request by clicking on __+ New__ then __Request__.
   ...
   ![Postman: New Request](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_newrequest.webp)
3. Fill in the fields and click on __Save to Identity Manager__.

   ![Postman: New Request Fields](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_requestfields.webp)
4. Fill in the authentication information as follows:

   ![Postman: Authentication](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_authentication.webp)
...
5. Click on __Send__ and get the access token from the response body.
   ...
   ![Postman: Access Token](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_accesstoken.webp)
...
2. Fill in the authorization information as follows:
   ...
   ![Postman: Authorization](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_authorization.webp)
...
3. Click on __Send__ and get the result from the response body.
   ...
   ![Postman: Access Token Result](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_accesstokenresult.webp)
...
2. Fill in the authorization information as follows:
   ...
   ![Postman: Authorization (Combined Request)](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_authorizationcombined.webp)
...
3. Click on __Get New Access Token__ and fill in the fields as follows:
   ...
   ![Postman: New Access Token Fields (Combined Request)](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_newaccesstokencombined.webp)
...
4. Click on __Request Token__ to get the token.
   ...
   ![Postman: Get Token (Combined Request)](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_gettokencombined.webp)
5. Click on __Use Token__ and __Send__ and get the result from the response body.

   ![Postman: Access Token Result (Combined Request)](/img/product_docs/usercube/usercube/integration-guide/api/how-tos/request-postman/postman_accesstokenresult.webp)
