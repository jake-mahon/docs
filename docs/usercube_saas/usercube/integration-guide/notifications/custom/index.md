...
A notification can be configured to be sent to one or several users right after the execution of a given activity in [Workflows](/docs/usercube_saas/usercube/integration-guide/workflows/index.md).
...
Notification Aspect
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/workflows/aspects/notificationaspect/index.md).
...
The configuration is made through the XML tag [
Notification
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/notifications/notification/index.md).
