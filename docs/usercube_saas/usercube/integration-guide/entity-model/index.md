...
**entity model**. See the [Toolkit for XML Configuration](../toolkit/index.md) topic for additional
information.
...
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md),
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) and
[ Entity Association ](../toolkit/xml-configuration/metadata/entityassociation/index.md).

#### Entity types

Every resource is assigned an
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) that describes its shape.
...
An [ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) includes:

- One or more [ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md)
- Zero or more
  [ Entity Association ](../toolkit/xml-configuration/metadata/entityassociation/index.md)
...
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) properties.
...
An [ Entity Association ](../toolkit/xml-configuration/metadata/entityassociation/index.md)
...
[Languages](../toolkit/languages/index.md).

#### Computed property

A property can be calculated from other properties. The
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) property expression
...
given entity using the calculation [Expressions](../toolkit/expressions/index.md) syntax.
...
[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) properties or
[](../toolkit/xml-configuration/metadata/entityassociation/index.md)[ Entity Association ](../toolkit/xml-configuration/metadata/entityassociation/index.md).
...
[ Entity Type Mapping ](../toolkit/xml-configuration/connectors/entitytypemapping/index.md), their
[ Entity Type Mapping ](../toolkit/xml-configuration/connectors/entitytypemapping/index.md) and
...
[ Upward Data Synchronization ](../synchronization/upward-data-sync/index.md)) and entity
...
Every
[ Entity Type Mapping ](../toolkit/xml-configuration/connectors/entitytypemapping/index.md)maps a
CSV column to a scalar [ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md).
...
[ Entity Type Mapping ](../toolkit/xml-configuration/connectors/entitytypemapping/index.md) using
the
[ References: Format for the EntityPropertyMapping ](../connectors/entitypropertymapping-format/index.md)
...
When writing an
[ Entity Type Mapping ](../toolkit/xml-configuration/connectors/entitytypemapping/index.md), one of
...
[ Create Database Views Task ](../toolkit/xml-configuration/jobs/tasks/agent/createdatabaseviewstask/index.md).
...
the [Identity Management](../identity-management/index.md) topic for additional information.
