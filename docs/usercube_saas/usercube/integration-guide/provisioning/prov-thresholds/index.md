...
Distinct [
Thresholds
](/docs/product_docs/usercube_saas/usercube/integration-guide/synchronization/synchro-thresholds/index.md) are configurable for synchronization.
