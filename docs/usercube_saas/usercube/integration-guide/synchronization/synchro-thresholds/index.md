...
- [ Entity Type Mapping ](../../toolkit/xml-configuration/connectors/entitytypemapping/index.md) to
...
- [ Connector ](../../toolkit/xml-configuration/connectors/connector/index.md) to count the number
...
Distinct [ Thresholds ](../../provisioning/prov-thresholds/index.md) are configurable for
provisioning.
