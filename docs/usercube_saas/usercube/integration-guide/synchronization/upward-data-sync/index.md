...
Entity Model. See the [Entity Model](../../entity-model/index.md) topic for additional information.
...
- ascertains differences between the real managed system state and the
  [ Assignment Policy ](../../role-model/role-model-rules/index.md) theoretical state.
...
[ Tasks & Jobs ](../../tasks-jobs/index.md).
...
Identity Manager's [Connectors](../../connectors/index.md) provide native _Export_ tasks for the
...
[Connectors](../../connectors/index.md) section together with an exhaustive list of supported source
managed systems.

[Connectors](../../connectors/index.md)are Identity Manager's link to the managed system. They
...
[ Invoke Expression Task ](../../toolkit/xml-configuration/jobs/tasks/agent/invokeexpressiontask/index.md),
...
[ Invoke Expression Task ](../../toolkit/xml-configuration/jobs/tasks/agent/invokeexpressiontask/index.md)
or an
[ Invoke Sql Command Task ](../../toolkit/xml-configuration/jobs/tasks/server/invokesqlcommandtask/index.md).
See the
[ Invoke Expression Task ](../../toolkit/xml-configuration/jobs/tasks/agent/invokeexpressiontask/index.md)
...
format_, described in the [Connectors](../../connectors/index.md) section. Usually, two kinds of
...
The [Application Settings](../../network-configuration/agent-configuration/appsettings/index.md)
...
[ Export Task ](../../toolkit/xml-configuration/jobs/tasks/agent/exporttask/index.md) task within a
Job.
