...
See the [
SaaS Environment
](/docs/product_docs/usercube_saas/usercube/integration-guide/architecture/saas/index.md) topic for additional information on Netwrix Identity Manager (formerly Usercube) recommended architecture when working in a SaaS environment.

See the [
On-Premises Environment
](/docs/product_docs/usercube_saas/usercube/integration-guide/architecture/on-prem/index.md) topic for additional information on Netwrix Identity Manager (formerly Usercube)' recommended architecture when working in an on-premises environment.

See how to [
Protect Agent/Server Communication
](/docs/product_docs/usercube_saas/usercube/integration-guide/architecture/how-tos/protect-agent-server-communication/index.md).
