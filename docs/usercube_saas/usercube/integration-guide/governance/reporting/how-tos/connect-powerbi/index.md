...
5. In the opening window, enter the
   [ OpenIdClient ](../../../../toolkit/xml-configuration/access-control/openidclient/index.md)of
...
6. You can now access in the left panel the
   [ Universe ](../../../../toolkit/xml-configuration/business-intelligence/universe/index.md)from
