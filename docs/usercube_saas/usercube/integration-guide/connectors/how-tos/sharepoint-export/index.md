...
Architecture
](../../../architecture/index.md) method. Remember that settings can also be input through architecture.
...
The [Entity Model](../../../entity-model/index.md) should match as closely as possible the structure of the SharePoint data relevant for Identity Manager. It is designed by analyzing the SharePoint data structure, and describing said data with [Entity Model](../../../entity-model/index.md) and an [
Entity Association
