...
- [
  Active Directory
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/active-directory/index.md)
...
- [
  Apache Directory
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/apache-directory/index.md)
...
- [
  CyberArk
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/cyberark/index.md)

  Manages CyberArk entities, including user and group assignments.
- [
  EasyVista
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/easyvista/index.md)

  Manages users inside an EasyVista instance. This package supports incremental synchronization.
- [
  EasyVista Ticket
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/easyvistaticket/index.md)
...
- [
  Generic LDAP
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/generic-ldap/index.md)

  Manages entries in an LDAP compliant directory.
- [
  Generic SCIM
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/generic-scim/index.md)
...
- [
  Manual Ticket
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/manual-ticket/index.md)

  Opens manual provisioning tickets in Identity Manager.
- [
  Manual Ticket and CUD Resources
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/manual-ticket-and-cud-resources/index.md)

  Opens manual provisioning tickets in Identity Manager.
- [
  Microsoft Entra ID
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/azure-active-directory/index.md)
...
- [
  Open LDAP
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/open-ldap/index.md)
...
- [
  Oracle LDAP
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/oracle-ldap/index.md)
...
- [
  PowerShellSync
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/powershellsync/index.md)

  Create a CSV export from a Powershell Script.
- [
  RACF
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/racf/index.md)

  Exports the RACF users and profiles.
- [
  Red Hat Directory Server
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/red-hat-directory-server/index.md)
...
- [
  Salesforce
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/salesforce/index.md)
...
- [
  SAP ERP 6.0
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/saperp6/index.md)
...
- [
  SharePoint
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/sharepoint/index.md)

  Exports sites, folders, SharePoint groups and permissions.
- [
  Slack
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/slack/index.md)
...
- [
  Unplugged
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/unplugged/index.md)

  Manages an unplugged system with a completely custom data model.
- [Database](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/usercube-database/index.md)
...
- [
  Workday
  ](/docs/usercube_saas/usercube/integration-guide/connectors/references-packages/workday/index.md)
