...
This page is about [
SAP S/4 HANA
](../../references-packages/saphana/index.md).

![Package: ERP/SAP S/4 HANA](../../../../../../../static/img/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/sapnetweaver/packages_sap_v603.webp)
...
When setting a password for an SAP user, the password attribute is defined by the password specified in the corresponding [Resource Type Mappings](../../../toolkit/xml-configuration/connectors/resourcetypemappings/index.md).
...
- A [
  Connection
  ](../../../toolkit/xml-configuration/connectors/connection/index.md) able to store Active Directory's ```Login```, ```Password``` and ```Server```.
