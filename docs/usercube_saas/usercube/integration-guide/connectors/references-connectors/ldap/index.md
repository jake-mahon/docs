...
- [ Generic LDAP ](../../references-packages/generic-ldap/index.md);
- [ Oracle LDAP ](../../references-packages/oracle-ldap/index.md);
- [ Apache Directory ](../../references-packages/apache-directory/index.md);
- [ Red Hat Directory Server ](../../references-packages/red-hat-directory-server/index.md).
...
- [ Connection ](../../../toolkit/xml-configuration/connectors/connection/index.md) able to store
