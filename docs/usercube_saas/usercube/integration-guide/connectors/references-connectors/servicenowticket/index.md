...
![Package: Ticket/ServiceNow](../../../../../../../static/img/product_docs/usercube/usercube/integration-guide/connectors/references-connectors/servicenowticket/packages_servicenowticket_v603.webp)
...
ServiceNow
](../servicenowentitymanagement/index.md)Entity Management.
...
ServiceNow
](../servicenowentitymanagement/index.md)connector. Some entities cannot be exported.
...
When the ticket is closed or canceled, Identity Manager updates the provisioning state of the resource accordingly. See the [Entitlement Assignment](../../../role-assignment/assignments-of-entitlements/index.md) topic for additional information.

See the fulfill capabilities of the [
ServiceNow
](../servicenowentitymanagement/index.md)connector.
