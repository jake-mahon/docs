...
This page is about [
Shared Folders
](../../references-packages/shared-folders/index.md).
...
- A [
  Connection
  ](../../../toolkit/xml-configuration/connectors/connection/index.md) able to store Active Directory's ```Login``` and ```Password```.
