...
This connector is meant to generate a CSV file, named ```<connectionIdentifier>.csv```, to the Export Output folder. See the [Application Settings](../../../network-configuration/agent-configuration/appsettings/index.md)topic for additional information.
