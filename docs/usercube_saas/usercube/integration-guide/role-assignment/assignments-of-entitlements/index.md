...
assignment is simply role assignment. See the [ Role Model ](../../role-model/index.md)topic for
...
[Evaluate Policy](../evaluate-policy/index.md) topic for additional information. Automatic
assignments can:
...
[ Single Role ](../../toolkit/xml-configuration/provisioning/singlerole/index.md) topic for
additional information.
...
**Resource Reconciliation** screens. See the [Evaluate Policy](../evaluate-policy/index.md) topic
...
[Automate the Review of Non-conforming Assignments](../../../user-guide/optimize/non-conforming-assignment-review-automation/index.md)
...
- The categorization of the created resource, which means both the correlation of the resource to an
  ...
  [ Categorize Resources ](../../../user-guide/set-up/categorization/index.md) topic for additional
  information.
