...
Context Rule
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/contextrule/index.md) or the combination of a context rule and the [
Record Section
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/recordsection/index.md) if record sections are configured.
...
As described in the [Identity Management](/docs/product_docs/usercube_saas/usercube/integration-guide/identity-management/index.md), identities are complex to model. Records were introduced to tackle this complexity by allowing multiple positions for the same identity.

[
Record Section
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/recordsection/index.md) go further by modeling the relationship between positions.
...
Each computed context will be used to create a set of dimension-value pairs, thus having 3 sets for the [Evaluate Policy](/docs/product_docs/usercube_saas/usercube/integration-guide/role-assignment/evaluate-policy/index.md) algorithm.
...
See the [
Generate Contexts
](#Generate-Contexts) topic for additional information. The following configuration and the identity of ```Phoebe Buffay``` will be used to showcase a position extension.
