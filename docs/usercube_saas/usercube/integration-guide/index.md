...
Netwrix Identity Manager (formerly Usercube)strongly recommends starting from the [Introduction Guide](/docs/usercube_saas/usercube/introduction-guide/index.md) to fully benefit from the Integration Guide's content.
