...
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/index.md) topic for additional information.

## Overview

After the role catalog is established, the [
Compute Role Model Task
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index.md) is able to assign single roles to users according to their attributes which are used as assignment criteria.
...
](/docs/product_docs/usercube_saas/usercube/integration-guide/role-assignment/conformingassignmentcomputation/index.md)topic for additional information. It detects the most probable links between identities dimensions and their roles in order to suggest the appropriate entitlement assignment rules.
...
![Impact Example - Use Case 1](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_impact_usecase1.png)
...
![Impact Example - Use Case 2](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_impact_usecase2.png)
...
![Impact Example - Use Case 3](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_impact_usecase3.png)
...
![Impact Example - Use Case 4](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_impact_usecase4.png)
...
![Impact Example - Use Case 5](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_impact_usecase5.png)

## Perform Role Mining

See the [
Perform Role Mining
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/role-mining/index.md) for additional information.

### Simulation

Be aware that you can configure the [
Get Role Mining Task
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index.md) to generate role assignment rules either directly or in a [Simulation](/docs/product_docs/usercube_saas/usercube/integration-guide/simulation/index.md).
...
![Schema - Role Mining](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_simulation.png)

The simulation tool gives another point of view on the role model as it emphasizes the changes.

![Schema - Role Mining](/static/img/product_docs/usercube/usercube/integration-guide/role-mining/rolemining_simulationresults.png)
