...
See the [
Jobs
](jobs/index.md) topic for additional information.

See the [
Tasks
](../toolkit/xml-configuration/jobs/tasks/index.md) topic for additional information.
...
These building blocks are called [Tasks](tasks/index.md), and can be easily organized together and scheduled in [
Jobs
](jobs/index.md).
