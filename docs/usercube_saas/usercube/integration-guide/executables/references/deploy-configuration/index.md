...
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/how-tos/deploy-configuration/index.md) topic for additional information.
...
| --product-translation   optional | No Value | Path of the JSON file that contains the application's translations. See the [Import Product Translations into Identity Manager](/docs/product_docs/usercube_saas/usercube/integration-guide/ui/how-tos/producttranslations/index.md) topic for more details on how to import the product's translations. |
