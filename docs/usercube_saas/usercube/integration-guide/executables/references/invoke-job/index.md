...
[ Job ](../../../toolkit/xml-configuration/jobs/job/index.md) steps. All the job's tasks are grouped
...
[ Usercube-Get-JobSteps ](../get-jobsteps/index.md) executable.
...
| --api-secret required                              | **Type** String **Description** Password used to authenticate to the server. Every request from agent to server needs to be authenticated with an [ OpenIdClient ](../../../toolkit/xml-configuration/access-control/openidclient/index.md) Connect /Secret pair/Secret pair, linked to a profile with the relevant permissions. |
