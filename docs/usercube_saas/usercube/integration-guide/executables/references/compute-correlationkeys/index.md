...
| --resource-identity-property   optional | __Type__    String   __Description__ Property used to override the resource identity property set in [SelectUserByIdentityQueryHandler](../../../toolkit/xml-configuration/metadata/settings/selectuserbyidentityqueryhandlersetting/index.md). |
|  |  |
| --- | --- |
