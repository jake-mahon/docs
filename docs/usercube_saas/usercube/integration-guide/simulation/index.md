...
- [
  ...
  ](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcecorrelationrule/index.md) and [
...
- [Resource Type](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md) rules;
- [
  Single Role
...
See the [
Perform a Simulation
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/simulation/index.md) for additional information.
