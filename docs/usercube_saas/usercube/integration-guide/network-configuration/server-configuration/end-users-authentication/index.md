...
](../../settings/index.md)topic for additional information.
...
- Set the __IdentityServer__ > __AllowWindowsAuthentication__ attribute to ```true```.

- Set the __Authentication__ > __AllowLocalLogin__ attribute to ```false```.
...
](../../../toolkit/xml-configuration/metadata/settings/selectuserbyidentityqueryhandlersetting/index.md)
...
](../../../executables/references/protect-certificatepassword/index.md) topic for additional information.
