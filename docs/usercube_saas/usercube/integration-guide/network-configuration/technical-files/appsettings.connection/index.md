...
[ Agent Configuration ](../../agent-configuration/index.md). This configuration is stored in the
**appsettings.connection.json** file, located inside the
[Application Settings](../../agent-configuration/appsettings/index.md) work folder.

The **appsettings.connection.json** file has the exact same structure as the other
[appsettings.agent](../../agent-configuration/appsettings-agent/index.md) file.

This configuration file has the highest priority among others agent's configuration sources . See
the [ Agent Configuration ](../../agent-configuration/index.md) topic for additional information.
