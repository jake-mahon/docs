...
Settings
](../../toolkit/xml-configuration/metadata/settings/index.md) available in the applicative configuration. Those are mandatory.
...
![CustomLinksUserMenu.webp](../../../../../../static/img/product_docs/usercube/usercube/integration-guide/network-configuration/settings/customlinksusermenu_v523.webp)
...
![DashboardItemNumber.webp](../../../../../../static/img/product_docs/usercube/usercube/integration-guide/network-configuration/settings/dashboarditemnumber.webp)
...
Profiles
](../../toolkit/xml-configuration/configuration/scaffoldings/accesscontrolrules/profiles/index.md) to an identity-resource that stands for the end-user digital identity.
...
End-User Authentication](../server-configuration/end-users-authentication/index.md). In that case, the login used by the end-user is in the form ```DOMAIN/userName```.
