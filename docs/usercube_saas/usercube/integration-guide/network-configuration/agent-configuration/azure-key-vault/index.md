...
[appsettings.agent](../appsettings-agent/index.md) topic for additional information.

Check the examples in connectors' credential protection sections. See the
[ ServiceNow ](../../../connectors/references-connectors/servicenowentitymanagement/index.md) topic
