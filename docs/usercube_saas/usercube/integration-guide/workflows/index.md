...
In software business, a [Workflow](../toolkit/xml-configuration/workflows/workflow/index.md) is a
...
- A workflow is linked to
  one[ Entity Type ](../toolkit/xml-configuration/metadata/entitytype/index.md) and concerns only
...
[Activity Templates](activity-templates/index.md)that defines how transitions occur from a workflow
step to another.
...
Workflows use [Form](../toolkit/xml-configuration/user-interface/form/index.md) to collect input
data through the UI.
...
[Profile](../toolkit/xml-configuration/access-control/profile/index.md) so that said profiles are
...
[Workflow Access Control Rules](../toolkit/xml-configuration/configuration/scaffoldings/accesscontrolrules/workflows/workflowaccesscontrolrules/index.md)
scaffolding.
...
[Activity Templates](activity-templates/index.md) topic for additional information.
...
[Access Control Rule](../toolkit/xml-configuration/access-control/accesscontrolrule/index.md) and
...
[Menu Item](../toolkit/xml-configuration/user-interface/menuitem/index.md) make workflows accessible
from the UI.
...
An [Aspects](../toolkit/xml-configuration/workflows/aspects/index.md) definition allows an action to
be performed at a specific point in a workflow. Identity Manager provides a few
[Aspects](../toolkit/xml-configuration/workflows/aspects/index.md) templates that give the
...
See the [Configure a Homonym Detection](how-to/configure-homonym-test/index.md)topic for additional
information.
...
See the [Display Table](../toolkit/xml-configuration/user-interface/displaytable/index.md) topic for
