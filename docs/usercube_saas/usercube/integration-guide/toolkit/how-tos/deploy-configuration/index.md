...
Deploy a local XML configuration by using the[ Usercube-Deploy Configuration](/docs/usercube_saas/usercube/integration-guide/executables/references/deploy-configuration/index.md) executable and declaring at least:
...
1. Log in for configuration deployment/export with the [
   Usercube-Login
   ](/docs/usercube_saas/usercube/integration-guide/executables/references/login/index.md) executable.
...
4. Deploy the configuration by using the[ Usercube-Deploy Configuration](/docs/usercube_saas/usercube/integration-guide/executables/references/deploy-configuration/index.md) executable and declaring at least:
