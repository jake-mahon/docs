...
Usercube-Export-Configuration
](/docs/product_docs/usercube_saas/usercube/integration-guide/executables/references/export-configuration/index.md) executable and declaring at least:
...
4. Export the configuration by using the [
   Usercube-Export-Configuration
   ](/docs/product_docs/usercube_saas/usercube/integration-guide/executables/references/export-configuration/index.md) and declaring at least:
