...
- [
  Invoke Api Task
  ](agent/invokeapitask/index.md)

  Tool to launch any Identity Manager API.
- [
  Invoke Aspects Task
  ](agent/invokeaspectstask/index.md)

  Call specific api in Identity Manager.
- [
  Invoke Expression Task
  ](agent/invokeexpressiontask/index.md)
...
- [
  ...
  ](agent/preparesynchronizationtask/index.md)
...
- [
  ...
  ](server/buildrolemodeltask/index.md)
...
- [
  ...
  ](server/computecorrelationkeystask/index.md)
...
- [
  ...
  ](server/computeriskscorestask/index.md)

  Update risk score with the risk settings.
- [
  Compute Role Model Task
  ](server/computerolemodeltask/index.md)
...
- [
  ...
  ](server/getroleminingtask/index.md)
...
- [
  ...
  ](server/savepreexistingaccessrightstask/index.md)
...
- [
  ...
  ](server/sendaccesscertificationnotificationtask/index.md)
...
- [
  ...
  ](server/setaccesscertificationreviewertask/index.md)
...
- [
  ...
  ](server/setinternaluserprofilestask/index.md)
...
- [
  ...
  ](server/setrecentlymodifiedflagtask/index.md)
...
- [
  Synchronize Task
  ](server/synchronizetask/index.md)
...
- [
  ...
  ](server/updateentitypropertyexpressionstask/index.md)
