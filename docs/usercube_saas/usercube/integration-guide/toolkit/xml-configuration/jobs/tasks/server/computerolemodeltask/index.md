...
This task applies all rules in the role model of all [Resource Type](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md) whose source entity types are specified as child elements of the task.
...
| BlockProvisioning   default value: false | __Type__    Boolean   __Description__   ```true``` to block the provisioning policy orders. |
