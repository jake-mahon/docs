...
Build Unique Value Aspect
](#Build-Unique-Value-Aspect) topic for additional information.
...
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/jobs/tasks/server/computecorrelationkeystask/index.md) before applying the role model and launching workflows.
