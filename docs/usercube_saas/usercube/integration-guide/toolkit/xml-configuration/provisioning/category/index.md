...
A category is a classification of Composite Roles, Single Roles or/and [Resource Type](../resourcetype/index.md). It can be used to group multiple roles of the same context.
