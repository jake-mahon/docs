...
All ```ResourceType```, ```SingleRole```, ```CompositeRole``` and ```Category``` must belong to a Policy. This is done by specifying the ```Policy``` attribute. See the [Resource Type](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md), [
Single Role
...
Category
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/category/index.md) topics for additional information.
