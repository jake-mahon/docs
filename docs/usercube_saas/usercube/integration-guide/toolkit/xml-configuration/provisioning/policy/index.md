...
All ```ResourceType```, ```SingleRole```, ```CompositeRole``` and ```Category``` must belong to a Policy. This is done by specifying the ```Policy``` attribute. See the [Resource Type](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md), [
Single Role
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/singlerole/index.md), [
Composite Role
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/compositerole/index.md) and [
Category
](/docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/category/index.md) topics for additional information.
