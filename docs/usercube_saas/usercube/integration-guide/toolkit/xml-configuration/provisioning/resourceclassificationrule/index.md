...
| TargetExpression   optional | __Type__    String   __Description__   Defines the C# expression used to classify the resources. See the [Expressions](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/expressions/index.md) topic for additional information. |
