...
| --- | --- | --- |
| CompositeRole  optional | Int64 | Identifier of a [ Composite Role ](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/compositerole/index.md) that users must have to trigger the rule. |
