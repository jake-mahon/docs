...
expressions. See the [Expressions](../../../expressions/index.md) topic for additional information.
...
| Expression optional       | **Type** String **Description** References the C# or literal expression used to compute the result. See the [Expressions](../../../expressions/index.md) topic for additional information. |
