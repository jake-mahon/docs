...
| Identifier   required | __Type__    String   __Description__   Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be [ Reserved identifiers ](../../../reservedidentifiers/index.md). |
