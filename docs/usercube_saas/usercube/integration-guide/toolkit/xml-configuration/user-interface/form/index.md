...
![Access Permissions](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/form_hideroles_v603.png)

Adjust the request type

When ```WorkflowRequestType``` is set to ```Self```, then the finalization step looks like:

![WorkflowRequestType = Self](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/form_requesttypeself_v603.png)

When ```WorkflowRequestType``` is set to ```Helpdesk```, then the finalization step looks like:

![WorkflowRequestType = Helpdesk](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/form_requesttypehelpdesk_v603.png)

Display records in a table

![RecordTable Example](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/form_recordtable_v603.png)
...
![inputtypeattachment](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypeattachment.png)

- Attachment — represents a control for adding an attachment
- Auto — takes by default the type of the EntityType property

  ![inputtypecheckbox](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypecheckbox.png)
- Checkbox — a boolean control which supports one of the two states

  ![inputtypecombobox](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypecombobox.png)
- Combobox — a dropdown which supports single selection

  ![inputtypecomboboxmultiselection](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypecomboboxmultiselection.png)
- ComboboxMultiSelection — a dropdown which supports multiple selection

  ![inputtypedate](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypedate.png)
- Date — Date control
- Hidden — Hides the input

  ![inputtypeimage](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypeimage.png)
...
- Inherited —Control to get the InputType of the associated display entity property (when nothing is specified in a Control of a Form, it's the default value).
  ...
  ![inputtypepicker](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypepicker.png)
- Picker — Opens a grid to select a resource

  ![inputtypetext](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypetext.png)
- Text — Displays a single-line of text

  ![inputtypetextarea](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/inputtypetextarea.png)
