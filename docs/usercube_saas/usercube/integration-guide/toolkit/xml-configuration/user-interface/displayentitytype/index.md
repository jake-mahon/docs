...
![Change Selection](/static/img/product_docs/usercube/usercube/integration-guide/toolkit/xml-configuration/user-interface/displayentitytype/ui_displaypriorities_changeselection_v521beta.png)
...
| HideRoles   default value: false | Boolean | True to skip the __Access Permissions__ step (the one containing the roles) in the default forms for this entity type. |
...
| InputType   default value: Auto | Enumeration | Identifier of the input type. See the [Form](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/user-interface/form/index.md) topic for additional information. |
