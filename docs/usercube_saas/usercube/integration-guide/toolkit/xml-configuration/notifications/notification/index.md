...
](../../jobs/tasks/server/sendnotificationstask/index.md) as part of a job.
...
| TitleExpression   optional | __Type__    String   __Description__   C# expression that defines the email's subject. The expression's variable type is defined in ```OwnerEntityType```. See the [Expressions](../../../expressions/index.md) topic for additional information. |
