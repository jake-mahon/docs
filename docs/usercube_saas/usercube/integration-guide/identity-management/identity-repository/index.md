...
](../../../user-guide/maintain/identity-data-modification/mass-update/index.md) and [
Update an Individual Identity
](../../../user-guide/maintain/identity-data-modification/individual-update/index.md)topics for additional information.
