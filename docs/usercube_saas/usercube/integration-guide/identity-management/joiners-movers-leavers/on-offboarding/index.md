...
See the [Role Assignment](/docs/product_docs/usercube_saas/usercube/integration-guide/role-assignment/index.md) topic for additional information on entitlement assignment.
...
](/docs/product_docs/usercube_saas/usercube/user-guide/optimize/assignment-automation/index.md) topic for additional information about the assignment automation.
...
Record Section
](/docs/product_docs/usercube_saas/usercube/integration-guide/toolkit/xml-configuration/provisioning/recordsection/index.md) and [
Context Rule
