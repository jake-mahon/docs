...
controllers for performing a forest recovery. See the [Recover a Forest](/docs/recoveryforactivedirectory/2.6/forest-recovery/forest-recovery-procedures.md)
