...
[Update SQL Server Service Account Password](/docs/recoveryforactivedirectory/2.6/troubleshooting/password-updates/sql-service-account-passwords.md) topic for additional
information.
...
[Edit Domain Configuration](/docs/recoveryforactivedirectory/2.6/configuration/domain-configuration.md#edit-domain-configuration) topic for
...
Recovery Console. See the [Update Domain Controller Backup Account Password](/docs/recoveryforactivedirectory/2.6/troubleshooting/password-updates/backup-account-passwords.md)
