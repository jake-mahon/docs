...
![Server Backup Configuration Wizard - Server page](/img/product_docs/recoveryforactivedirectory/2.6/troubleshooting/updatepassword/server.webp)
...
![Server Backup Configuration has been Saved](/img/product_docs/recoveryforactivedirectory/2.6/troubleshooting/updatepassword/serverbackupconfiguration.webp)
