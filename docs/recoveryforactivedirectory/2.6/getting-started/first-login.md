...
On [First Launch](/docs/recoveryforactivedirectory/2.6/getting-started/initial-configuration.md) of the Recovery Console, the administrator must add users who can
