...
Threat Prevention for objects on the [Active Directory Page](/docs/recoveryforactivedirectory/2.6/domain-recovery/index.md).
...
[Integration with Threat Prevention](/docs/recoveryforactivedirectory/2.6/domain-recovery/index.md#integration-with-threat-prevention)
