...
Prior to installing, ensure that all prerequisites have been met, as described in the [Requirements ](../requirements/overview.md)topic.
...
See the [Licensing Page](../admin/configuration/licensing.md) topic
