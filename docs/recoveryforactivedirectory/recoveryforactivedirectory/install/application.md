...
![Recovery for Active Directory Setup wizard - Initial EULA page](/img/product_docs/activitymonitor/activitymonitor/install/eula.png)
...
![Installation Welcome Page](/img/product_docs/activitymonitor/activitymonitor/install/welcome.png)

__Step 3 –__ On the Welcome page of the Recovery for Active Directory Setup wizard, click Next to begin the installation.

![Installation Destination Folder Page](/img/product_docs/activitymonitor/activitymonitor/install/destinationfolder.png)
...
![Recovery for Active Directory Setup wizard - Change destination folder page](/img/product_docs/threatprevention/threatprevention/install/changedestinationfolder.png)
...
![Installation License File Page](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/licensefile.png)
...
![Installation SQL Server Configuration](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/sqlserverconfiguration.png)
...
![Installation SQL Server Database Name](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/sqlserverdatabase.png)
...
![serverconfiguration](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/serverconfiguration.png)
...
![Installation Admin Role Page](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/administratorrole.png)
...
![Installation Web Host Configuration](/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/webhost.png)
...
![Installation Certificates Window](/img/product_docs/threatprevention/threatprevention/install/agent/certificates.png)
...
![Installation Ready to Install](/img/product_docs/activitymonitor/activitymonitor/install/ready.png)
...
The installer does not automatically open the Recovery Console web page after installation. The Recovery Console icon is located on the desktop. See the [First Launch](/docs/recoveryforactivedirectory/recoveryforactivedirectory/install/firstlaunch.md) topic for the next step.
