...
![Recovery for Active Directory Setup wizard - Initial EULA page](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/eula.webp)
...
![Installation Welcome Page](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/welcome.webp)

__Step 3 –__ On the Welcome page of the Recovery for Active Directory Setup wizard, click Next to begin the installation.

![Installation Destination Folder Page](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/destinationfolder.webp)
...
![Recovery for Active Directory Setup wizard - Change destination folder page](../../../../static/img/product_docs/threatprevention/threatprevention/install/changedestinationfolder.webp)
...
![Installation License File Page](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/licensefile.webp)
...
![Installation SQL Server Configuration](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/sqlserverconfiguration.webp)
...
![Installation SQL Server Database Name](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/sqlserverdatabase.webp)
...
![serverconfiguration](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/serverconfiguration.webp)
...
![Installation Admin Role Page](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/administratorrole.webp)
...
![Installation Web Host Configuration](../../../../static/img/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/install/webhost.webp)
...
![Installation Certificates Window](../../../../static/img/product_docs/threatprevention/threatprevention/install/agent/certificates.webp)
...
![Installation Ready to Install](../../../../static/img/product_docs/activitymonitor/activitymonitor/install/ready.webp)
...
The installer does not automatically open the Recovery Console web page after installation. The Recovery Console icon is located on the desktop. See the [First Launch](firstlaunch.md) topic for the next step.
