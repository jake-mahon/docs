...
- __Step 1 –__ Prepare an isolated environment to restore the forest to.
  ...
  See the [Target Server Considerations](../../requirements/targetserver.md) topic to understand the requirements for a target environment and target servers for restoring domain controllers.
...
See the [Target Server and Operating System Requirements](../../requirements/targetserver.md#target-server-and-operating-system-requirements) topic for additional information.

__Step 5 –__ Click __Next__.

![Add to Recovery Playbook wizard - Options page](../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/install/application/options.webp)
