...
This topic lists the requirements for the target servers where you want to restore the domain controllers for performing a forest recovery. See the [Recover a Forest](/docs/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/admin/forest/recover.md) topic for additional information.
