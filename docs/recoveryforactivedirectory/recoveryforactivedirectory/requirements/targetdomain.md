...
Target domains include the Active Directory domains that can be added through the [Domains Page](/docs/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/admin/configuration/domain.md). You can rollback and recover objects in these domains through the [Active Directory Page](/docs/product_docs/recoveryforactivedirectory/recoveryforactivedirectory/admin/activedirectory/overview.md).
...
__CAUTION:__ Additional permissions may be necessary to allow Recovery for Active Directory to function properly in an organization’s environment.
