...
![](/img/changetracker/integration/UserNotifications_1122x481.png)
...
![](/img/changetracker/integration/AuditorSearch_1117x430.png)
...
![](/img/changetracker/integration/AuditorOperator_1115x182.png)

Search criteria, like the one above, can be saved to generate reports or alerts.

![](/img/changetracker/integration/AuditorSearchResults_1090x638.png)