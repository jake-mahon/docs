...
![](/img/changetracker/integration/ESXiCredentials.png)
...
![](/img/changetracker/integration/ESXiCredentialForm.png)
...
![](/img/changetracker/integration/DeviceDiscoveryGrid.png)
...
![](/img/changetracker/integration/DeviceDiscoveryForm.png)

Once configured a discovery job will automatically run and if successful, the devices will be visible in the grid.

![](/img/changetracker/integration/DeviceDiscoveryStarted.png)

![](/img/changetracker/integration/DeviceDiscoveryRunning.png)

![](/img/changetracker/integration/DeviceDiscoveryCompleted.png)
...
![](/img/changetracker/integration/ESXiComplianceReport.png)