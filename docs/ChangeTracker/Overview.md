...
![TechnicalOverview](/img/changetracker/TechnicalOverview.png "TechnicalOverview")
...
- [Installing Gen 7 Agent for Windows](Install/Agent/Windows.md "Installing Gen 7 Agent for Windows")
- [Installing Gen 7 Agent for Linux](Install/Agent/LinuxOS.md "Installing Gen 7 Agent for Linux")

![Architecture](/img/changetracker/Architecture.png "Architecture")

For a full list of supported operating systems see [OS Support Matrix](Requirements/OSSupportMatrix.md).
