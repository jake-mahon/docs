...
![UpgradeAgentWindowsCommandPrompt](/img/changetracker/install/UpgradeAgentWindowsCommandPrompt.png "UpgradeAgentWindowsCommandPrompt")

- **For Linux** – Use: `service nntagent stop`

**Step 5 –** Install Gen 7 Agent. Review the following for additional information:

- **Windows** – See the [Gen 7 Agent for Windows](/Requirements/Gen7AgentWindows.md "Gen 7 Agent for Windows") topic for additional information.

- **Linux** – See the [Installing Gen 7 Agent for Linux](LinuxOS.md "Installing Gen 7 Agent for Linux") topic for additional information.
