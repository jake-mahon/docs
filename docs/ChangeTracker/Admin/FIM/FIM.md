...
File change events can be viewed from the [Events Tab](/Admin/Tabs/Events.md "Events Tab"). See the [Dashboard Tab](/Admin/Tabs/DashboardOverview.md "Dashboard Tab") topic for additional information on how to view FIM change events.
