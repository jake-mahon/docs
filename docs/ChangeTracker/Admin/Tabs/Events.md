...
**Step 4 –** The **Query/Report** button can be used to specify events to include in a scheduled report or re-useable query for users. See the [Reports Tab](ReportsTab.md "Reports Tab") topic for additional information.
