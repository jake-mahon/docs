...
![create password](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/create-password-en.webp)
...
![create-password-light](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/create-password-light.webp)

Once these fields are filled in, the record is created.

![created record](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/apple-icon-en.webp)
...
![create new password](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/create-new-password-en.webp)

![create-light-client](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/create-light-client.webp)
...
![linked applications](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/linked-applications-en.webp)

Then the whole process is completed by clicking the "Finish" button.

![netwrix logo](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/netwrix-logo-en.webp)
...
![options record light client](/img/product_docs/passwordsecure/9.1/configuration/basic_view/password_management/options-en.webp)
