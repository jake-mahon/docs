...
![password-reset](/img/product_docs/passwordsecure/9.1/configuration/server_manager/certificates/password-reset.webp)
...
The section
[Certificates](/docs/passwordsecure/9.1/configuration/server_manager/certificates/certificates.md)explains
