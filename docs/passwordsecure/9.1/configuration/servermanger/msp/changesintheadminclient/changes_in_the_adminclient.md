...
![Modules in AdminClient](/img/product_docs/passwordsecure/9.1/configuration/server_manager/msp/changes_in_ac/module-ac-en_606x403.webp)

In the new MSP version these have been replaced by the modules Customers (1) and Cost Overview (2).

![AdminClient - MSP module](/img/product_docs/passwordsecure/9.1/configuration/server_manager/msp/changes_in_ac/module-msp-ac-en.webp)
