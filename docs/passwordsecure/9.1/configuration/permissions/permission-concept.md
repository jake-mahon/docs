...
in the chapter
[Multiple editing of permissions](/docs/passwordsecure/9.1/configuration/permissions/manual-permissions.md)

Alongside the definition of manual and automatic setting of permissions, the (optional) setting of
[Protective mechanisms](/docs/passwordsecure/9.1/configuration/permissions/protective-mechanisms/seals.md)
