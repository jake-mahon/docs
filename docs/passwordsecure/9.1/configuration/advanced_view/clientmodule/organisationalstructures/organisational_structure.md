...
- **New organisational unit/user**: New organisational units or new users can be added via the
  ...
  [User management](/docs/passwordsecure/9.1/configuration/web_applicaiton/functional_scope/organisational_structure/user_management/user_management.md)
...
- **Permissions**: The configuration of permissions within the organisational structure is important
  ...
  accordance with
  [Inheritance from organisational structures](/docs/passwordsecure/9.1/configuration/advanced_view/permissionconcept/automated_settings/inheritance_from_organisational_structures/inheritance_from_organizational.md).
  The benefits of
...
- **Reset password**: Administrators can reset the passwords with which users log in to Netwrix
  ...
  via[End-to-end encryption](/docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/organisationalstructures/directoryservices/activedirectorylink/end-to-end_encryption.md).
  In the alternative
  [Masterkey mode](/docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/organisationalstructures/directoryservices/activedirectorylink/masterkey_mode.md),
