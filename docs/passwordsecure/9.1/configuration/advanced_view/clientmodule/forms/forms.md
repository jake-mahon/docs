...
![form module](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_1-en.webp)
...
![forms](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_2-em.webp)
...
![Creating new forms](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_3-en.webp)
...
![Configuring the info field](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_4-en.webp)
...
![Configuring the info field](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_5-en.webp)
...
![preview form](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_6-en.webp)

The info field for the form is now updated. It is now possible to start the RDP session directly in
the RDP session.

![updated form](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_7-en.webp)

NOTE: The **forms module** is based on the
[Web Application](/docs/passwordsecure/9.1/configuration/web_applicaiton/web_application.md)
...
![settings form](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_8-en.webp)

### Via the form selection

![default form](/img/product_docs/passwordsecure/9.1/configuration/advanced_view/clientmodule/forms/forms_9-en.webp)
