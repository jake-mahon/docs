...
![create new password](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/create-new-password-ma-en.webp)

After that, select the required **form**.

![select form](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/select-form-ma-en.webp)
...
![new entry MobileApp](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/new-entry-ma-en.webp)

#### Editing passwords

To edit a password, click on the corresponding password and select the pencil icon.

![editing password](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/new-entry-ma-2-en.webp)
...
![edit passwordfield MobileApp](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/edit-passwordfield-ma-en.webp)

![edit passwordfield](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/edit-entry-ma-2-en.webp)
...
![MobileApp - Tags](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/edit-tag-ma-en.webp)
...
![Mobileapp - select/create tag](/img/product_docs/passwordsecure/9.1/configuration/mobiledevices/passwords/select-tag-ma-en.webp)
