...
[Functional scope](/docs/passwordsecure/9.1/configuration/web_applicaiton/functional_scope/functional_scope.md)
section.

![WebClient](/img/product_docs/passwordsecure/9.1/configuration/web_applicaiton/installation_with_parameters_159.webp)
