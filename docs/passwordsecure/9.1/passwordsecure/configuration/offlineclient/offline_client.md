...
([Setup and sync](/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/offlineclient/setup/setup_and_sync.md)),
...
[Operation and setup](/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/server_manager/operation_and_setup/operation_and_setup_admin_client.md).
