...
[Rollback](/docs/passwordsecure/9.1/user-guides/password-reset/rollback.md).
...
or directly in the
[Password settings](/docs/passwordsecure/9.1/user-guides/password-management/password-settings.md).
