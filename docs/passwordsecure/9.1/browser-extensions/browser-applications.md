...
![registration with and without application](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_142-en.webp)
...
possible via
[Browser Add-ons](/docs/passwordsecure/9.1/browser-extensions/browser-extensions-overview.md).
...
![create application](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_144-en.webp)

A modal window now opens. The actual application is now created here.

![modal application window](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_145-en.webp)
...
![choosed application field](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_146-en.webp)
...
![example for a application](/img/versioned_docs/passwordsecure_9.1/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_147-en.webp)
