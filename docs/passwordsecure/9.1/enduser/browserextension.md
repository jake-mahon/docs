...
![downloadextension](/img/product_docs/passwordsecure/9.1/enduser/downloadextension.webp)
...
![getextension](/img/product_docs/passwordsecure/9.1/enduser/getextension.webp)

Step 3 – After confirming a security question, it is installed, and an icon appears in the menu bar
to "add the extension".

![addextension](/img/product_docs/passwordsecure/9.1/enduser/addextension.webp)
...
![extensionadded](/img/product_docs/passwordsecure/9.1/enduser/extensionadded.webp)
...
![nodatabaseprofile](/img/product_docs/passwordsecure/9.1/enduser/nodatabaseprofile.webp)
