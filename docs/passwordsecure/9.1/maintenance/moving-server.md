...
[MSSQL Server](/docs/passwordsecure/9.1/installation/requirements/mssql-server.md)
for this process.
...
[Setup wizard](/docs/passwordsecure/9.1/configuration/server-manager/setup-wizard.md)
