...
([Setup and sync](/docs/passwordsecure/9.2/installation-setup/client-installation/offline-client-setup.md)), the local copy of the server database will be
...
[Operation and setup](/docs/passwordsecure/9.2/administration/server-management/server-manager-overview.md).
...
- The filter is not available. Records are found using the
  [Search](/docs/passwordsecure/9.2/user-interfaces/advanced-view/search-filter.md)
- The automatic login data entry can be performed via the
  [Autofill Add-on](/docs/passwordsecure/9.2/integrations/browser-extensions/autofill-addon.md), independently of the Offline Add-on
...
[Seals](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md)
...
sections:[ Creating databases](/docs/passwordsecure/9.2/installation-setup/server-installation/creating-databases.md) and
[Managing databases](/docs/passwordsecure/9.2/administration/server-management/database-management.md)
...
[User settings](/docs/passwordsecure/9.2/administration/user-management/user-settings.md). The synchronization is
