...
[Application server](/docs/passwordsecure/9.2/installation-setup/system-requirements/server-requirements.md) can be found in the corresponding
...
[Configuration of SAML](/docs/passwordsecure/9.2/core-features/applications/saml-configuration.md)
