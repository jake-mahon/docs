...
settings in the [User settings](/docs/passwordsecure/9.2/administration/user-management/user-settings.md) in the category:
...
Task**. The [Filter](/docs/passwordsecure/9.2/user-interfaces/advanced-view/search-filter.md) can be used to select which data
...
[Syslog](/docs/passwordsecure/9.2/administration/server-management/syslog-configuration.md) server. Further information on this
