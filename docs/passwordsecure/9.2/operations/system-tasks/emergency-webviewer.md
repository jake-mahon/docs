...
[Backup management](/docs/passwordsecure/9.2/administration/backup-recovery/backup-management.md).
...
**[System tasks](/docs/passwordsecure/9.2/operations/system-tasks/system-tasks-overview.md)** and this task can be used to guarantee a regular backup of
