...
- [Seals](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md): Requests
  to release sealed records are handled via the notification system
- [System tasks](/docs/passwordsecure/9.2/operations/system-tasks/system-tasks-overview.md)s: If reports are automatically
