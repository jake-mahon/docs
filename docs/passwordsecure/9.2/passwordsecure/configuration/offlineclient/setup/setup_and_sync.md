...
sections:[ Creating databases](../../server_manager/creatingdatabase/creating_databases.md) and
...
[User settings](../../advanced_view/mainmenu/user_settings/user_settings.md). The synchronization is
