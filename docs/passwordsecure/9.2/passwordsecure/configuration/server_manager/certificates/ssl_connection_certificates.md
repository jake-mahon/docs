...
[Basic configuration](/docs/passwordsecure/9.2/passwordsecure/configuration/server_manager/baseconfiguration/basic_configuration.md) in the AdminConsole. The
...
[Basic configuration](/docs/passwordsecure/9.2/passwordsecure/configuration/server_manager/baseconfiguration/basic_configuration.md). Please note that a server
