...
In the [Passwords](/docs/passwordsecure/9.2/passwordsecure/configuration/advanced_view/clientmodule/passwords/passwords.md), the newly created application can now be directly
