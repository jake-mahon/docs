...
[Settings](/docs/passwordsecure/9.2/passwordsecure/configuration/mobiledevices/settings/settings_mobileapp.md). A prerequisite for successful synchronization is that
...
The configuration is described in the chapter [Settings](/docs/passwordsecure/9.2/passwordsecure/configuration/mobiledevices/settings/settings_mobileapp.md)
