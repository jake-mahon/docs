...
[Password masking](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/password-masking.md).
...
[Functional scope](/docs/passwordsecure/9.2/user-interfaces/web-application/web-features.md) section.
