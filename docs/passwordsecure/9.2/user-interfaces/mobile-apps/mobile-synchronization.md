...
[Settings](/docs/passwordsecure/9.2/user-interfaces/mobile-apps/mobile-overview.md). A prerequisite for successful synchronization is that
...
The configuration is described in the chapter [Settings](/docs/passwordsecure/9.2/user-interfaces/mobile-apps/mobile-overview.md)
