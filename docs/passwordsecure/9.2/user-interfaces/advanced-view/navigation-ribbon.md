...
- [Extras](/docs/passwordsecure/9.2/operations/extras/image-management.md)
...
- [User rights](/docs/passwordsecure/9.2/administration/user-management/user-rights.md)
- [Administration](/docs/passwordsecure/9.2/administration/system-administration/advanced-settings.md)
- [Import](/docs/passwordsecure/9.2/administration/import-export/import-data.md)
- [Export](/docs/passwordsecure/9.2/administration/import-export/export-wizard.md)
...
[Main menu](/docs/passwordsecure/9.2/user-interfaces/advanced-view/navigation-ribbon.md):
...
[Reading pane](/docs/passwordsecure/9.2/user-interfaces/advanced-view/reading-pane.md) is opened (1), further tabs will be visible in the
...
Double-clicking on an object in the [List view](/docs/passwordsecure/9.2/user-interfaces/advanced-view/list-view.md) opens a new tab with its
