...
[List view](/docs/passwordsecure/9.2/user-interfaces/advanced-view/list-view.md).
...
Depending on which record you have selected in [List view](/docs/passwordsecure/9.2/user-interfaces/advanced-view/list-view.md), the
corresponding fields are displayed here. In the header, the assigned [Tags](/docs/passwordsecure/9.2/operations/tags/tags-overview.md), as
well as the
