...
Dashboards are available in almost all [Client Module](/docs/passwordsecure/9.2/user-interfaces/advanced-view/advanced-view-overview.md)s. A
...
widgets** is managed in the[User settings](/docs/passwordsecure/9.2/administration/user-management/user-settings.md).
