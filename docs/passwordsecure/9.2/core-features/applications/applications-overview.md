...
- Automatic logins to websites are covered by the
  [Autofill Add-on](/docs/passwordsecure/9.2/integrations/browser-extensions/autofill-addon.md).
...
opens in its own tab in the [Reading pane](/docs/passwordsecure/9.2/user-interfaces/advanced-view/reading-pane.md).
...
[Learning the applications](/docs/passwordsecure/9.2/core-features/applications/application-configuration.md). In contrast,
