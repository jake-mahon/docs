...
- **New organisational unit/user**: New organisational units or new users can be added via the
  ...
  [User management](/docs/passwordsecure/9.2/user-interfaces/web-application/web-features.md)
...
- **Permissions**: The configuration of permissions within the organisational structure is important
  ...
  The benefits of
  [Predefining rights](/docs/passwordsecure/9.2/security-permissions/permission-concept/rights-templates.md) are
  explained in a separate section.
- **Settings**: The settings can be configured for both users and also organisational units. More
  information on [User settings](/docs/passwordsecure/9.2/administration/user-management/user-settings.md)…
...
- **Reset password**: Administrators can reset the passwords with which users log in to Netwrix
  ...
  via[End-to-end encryption](/docs/passwordsecure/9.2/security-permissions/encryption/end-to-end-encryption.md). In the
  alternative [Masterkey mode](/docs/passwordsecure/9.2/security-permissions/encryption/masterkey-mode.md), the
