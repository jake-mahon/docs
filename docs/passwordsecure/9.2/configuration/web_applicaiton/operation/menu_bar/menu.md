...
![menu bar](/img/product_docs/passwordsecure/9.2/configuration/web_applicaiton/operation/menu_bar/installation_with_parameters_174-en.webp)
...
![Menu](/img/product_docs/passwordsecure/9.2/configuration/web_applicaiton/operation/menu_bar/installation_with_parameters_175-en.webp)
...
[Passwords](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/passwords/passwords.md)

7. Password Reset

The functions of the
[Password Reset](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/passwordreset/password_reset.md) can be found
here.
