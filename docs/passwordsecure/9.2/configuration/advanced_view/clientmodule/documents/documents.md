...
![Document modul](/img/product_docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/documents/documents_1-en.webp)
...
![New document](/img/product_docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/documents/documents_2-en.webp)
...
![searching document](/img/product_docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/documents/documents_3-en.webp)
...
be used in the same way as the [History](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/passwords/history.md). The interplay between the
