...
settings in the [User settings](/docs/passwordsecure/9.2/configuration/advanced_view/mainmenu/user_settings/user_settings.md) in the category:
...
Task**. The [Filter](/docs/passwordsecure/9.2/configuration/advanced_view/operation_and_setup/filter/filter.md) can be used to select which data
