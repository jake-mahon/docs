...
In the [Organisational structure](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/organisationalstructures/organisational_structure.md) module, you select the user and
...
in[Multifactor Authentication](/docs/passwordsecure/9.2/configuration/server_manager/managing_databases/database_settings/multifactor_authentication_ac.md).
