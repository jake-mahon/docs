...
1. Set up OTP
2. Create
   [HTML WebViewer export](/docs/passwordsecure/9.2/configuration/advanced_view/mainmenu/export/html_webviewer-export/html_webviewer_export.md)
...
[EmergencyWebViewer](/docs/passwordsecure/9.2/configuration/advanced_view/mainmenu/extras/system_tasks/emergency_webviewer/emergency_webviewer.md)
