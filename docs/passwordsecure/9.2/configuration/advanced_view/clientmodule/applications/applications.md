...
- Automatic logins to websites are covered by the
  [Autofill Add-on](/docs/passwordsecure/9.2/configuration/autofill_add-on/autofill_add-on.md).
...
opens in its own tab in the [Reading pane](/docs/passwordsecure/9.2/configuration/advanced_view/operation_and_setup/readingpane/reading_pane.md).
...
[Learning the applications](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/applications/learning_the_applications/learning_the_applications.md). In contrast,
