...
In the main menu in [Extras](/docs/passwordsecure/9.2/configuration/advanced_view/mainmenu/extras/extras.md) you can find the image management. Here, you have the
