...
[Notifications](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/notifications/notifications.md), reports also contain
...
[List view](/docs/passwordsecure/9.2/configuration/advanced_view/operation_and_setup/listview/list_view.md), there are currently three
