...
- Check in the [Database properties](/docs/passwordsecure/9.2/configuration/server_manager/database_properties/database_properties.md) if the **offline
...
![Certificates](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/certificates-ac-1-en.webp)

![Export certificates](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/certificates-ac-2-en.webp)
...
![start migration](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/start-migration-en.webp)
...
![select database](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/start-migration-2-en.webp)

You should see the message, that the selected databases are now in migration mode:

![start migration](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/start-migration-3-en.webp)
...
![migration progress](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/migration-progress-en.webp)

After each user has logged into the database and has been successfully migrated, the migration is
complete.

![migration finished](/img/product_docs/passwordsecure/9.2/configuration/server_manager/ecc_migration/migration-finished-en.webp)
