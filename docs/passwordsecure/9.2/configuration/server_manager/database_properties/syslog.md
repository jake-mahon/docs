...
**[Logbook](/docs/passwordsecure/9.2/configuration/advanced_view/clientmodule/logbook/logbook.md)** can be transferred to a Syslog
server. Double clicking on a database allows you to access its settings. The corresponding menu
items can be found there.

![installation_with_parameters_232](/img/product_docs/passwordsecure/9.2/configuration/server_manager/database_properties/installation_with_parameters_232.webp)
