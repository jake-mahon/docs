...
- [Syslog](/docs/passwordsecure/9.2/configuration/server_manager/database_properties/syslog.md)
- [Database firewall](/docs/passwordsecure/9.2/configuration/server_manager/database_properties/database_firewall.md)
