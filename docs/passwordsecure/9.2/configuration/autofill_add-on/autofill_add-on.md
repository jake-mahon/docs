...
![Automatic entries diagram](/img/product_docs/passwordsecure/9.2/configuration/autofill_add-on/installation_with_parameters_125-en.webp)

RDP and SSH
sessions(![1](/img/product_docs/passwordsecure/9.2/configuration/autofill_add-on/1.webp)
...
- Entering login data in Windows applications: Alongside the above-mentioned RDP and SSH sessions,
  ...
  (![2](/img/product_docs/passwordsecure/9.2/configuration/autofill_add-on/2.webp)).
