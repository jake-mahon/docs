...
![light-client-en](/img/product_docs/passwordsecure/9.2/configuration/basic_view/light-client-en.webp)
...
[To do for Administration](/docs/passwordsecure/9.2/configuration/basic_view/administration/to_do_for_administration.md).
...
chapter[Installation Client](/docs/passwordsecure/9.2/installation/installation_client/installation_client.md)
