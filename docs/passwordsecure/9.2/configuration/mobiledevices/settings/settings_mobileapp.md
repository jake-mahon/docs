...
![MobileApp - settings](/img/product_docs/passwordsecure/9.2/configuration/mobiledevices/settings/settings-ma-en.webp)
![MobileApp - settings](/img/product_docs/passwordsecure/9.2/configuration/mobiledevices/settings/settings-2-ma-en.webp)
...
[Synchronization](/docs/passwordsecure/9.2/configuration/mobiledevices/synchronization/synchronization.md).
