...
([Setup and sync](/docs/passwordsecure/9.2/configuration/offlineclient/setup/setup_and_sync.md)), the local copy of the server database will be
...
[Operation and setup](/docs/passwordsecure/9.2/configuration/server_manager/operation_and_setup/operation_and_setup_admin_client.md).
...
- The automatic login data entry can be performed via the
  [Autofill Add-on](/docs/passwordsecure/9.2/configuration/autofill_add-on/autofill_add-on.md), independently of the Offline Add-on
