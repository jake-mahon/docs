...
[Active Directory link](/docs/passwordsecure/9.2/core-features/organizational-structure/active-directory-integration.md) with active end-to-end encryption currently offers
