...
[Basic configuration](/docs/passwordsecure/9.2/installation-setup/server-installation/basic-configuration.md) in the AdminConsole. The
...
[Basic configuration](/docs/passwordsecure/9.2/installation-setup/server-installation/basic-configuration.md). Please note that a server
