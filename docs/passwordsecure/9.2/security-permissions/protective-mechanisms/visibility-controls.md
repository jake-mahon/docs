...
The use of a [Filter](/docs/passwordsecure/9.2/user-interfaces/advanced-view/search-filter.md) is generally the gateway to
...
consideration when handling records. [Tags](/docs/passwordsecure/9.2/operations/tags/tags-overview.md) are not
