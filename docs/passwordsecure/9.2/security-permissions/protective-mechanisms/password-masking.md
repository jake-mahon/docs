...
In the same way as for the [Seals](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md) configuration, the **authorize permission**
...
[Form field permissions](/docs/passwordsecure/9.2/security-permissions/permission-concept/manual-permissions.md). In the
[List view](/docs/passwordsecure/9.2/user-interfaces/advanced-view/list-view.md) of a record, there is a separate
