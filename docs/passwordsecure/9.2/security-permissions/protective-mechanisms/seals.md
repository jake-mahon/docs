...
[Notifications](/docs/passwordsecure/9.2/operations/notifications/notifications-overview.md), as well as in the Seal
overview.

## 2. Granting a release

The [Seal overview](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md) can be opened via the seal symbol in the
...
[Seal templates](/docs/passwordsecure/9.2/operations/extras/seal-templates.md). Optionally, you can
...
template. [Seal templates](/docs/passwordsecure/9.2/operations/extras/seal-templates.md) can be
...
[Seal overview](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md) allows all authorized persons to view the current
state of the seals. The section on the[Release mechanism](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md)
describes in detail the individual steps, from the initial release request to the final release.

- [Seal overview](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md)
- [Release mechanism](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md)
