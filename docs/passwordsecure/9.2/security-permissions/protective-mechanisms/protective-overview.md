...
- [Visibility](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/visibility-controls.md) is not separately configured but is instead directly
...
- By configuring [Temporary permissions](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/temporary-permissions.md), it is
  possible to grant users or roles temporary access to data.
- [Password masking](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/password-masking.md) enables access to the system without
...
- To link the release of highly sensitive access data to a double-check principle, it is possible to
  use [Seals](/docs/passwordsecure/9.2/security-permissions/protective-mechanisms/seals.md). The configuration of users or roles with the permissions to issue a
