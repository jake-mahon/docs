...
[Creating new passwords](/docs/passwordsecure/9.2/core-features/password-management/creating-passwords.md). Roles can be created via the
...
Just like the [Organisational structure](/docs/passwordsecure/9.2/core-features/organizational-structure/organizational-overview.md),
...
[Reading pane](/docs/passwordsecure/9.2/user-interfaces/advanced-view/reading-pane.md). All of the other users with
...
[Roles module](/docs/passwordsecure/9.2/user-interfaces/web-application/web-features.md) of the Web
