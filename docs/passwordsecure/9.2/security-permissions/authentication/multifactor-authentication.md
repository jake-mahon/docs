...
In the [Organisational structure](/docs/passwordsecure/9.2/core-features/organizational-structure/organizational-overview.md) module, you select the user and
...
in[Multifactor Authentication](/docs/passwordsecure/9.2/security-permissions/authentication/multifactor-authentication.md).
...
![Database settings](/img/product_docs/passwordsecure/passwordsecure/configuration/server_manager/managing_databases/database_settings/mfa-de.webp)
