...
[MSSQL Server](/docs/passwordsecure/9.2/installation-setup/system-requirements/database-requirements.md) for this process.

#### 2. Installing the server

The Netwrix Password Secure application server is installed next (see
[Application server](/docs/passwordsecure/9.2/installation-setup/system-requirements/server-requirements.md)). The installation itself
is described under
...
[Basic configuration](/docs/passwordsecure/9.2/installation-setup/server-installation/basic-configuration.md) is
...
under [License settings](/docs/passwordsecure/9.2/administration/system-administration/license-management.md). Now stop
...
[Certificates](/docs/passwordsecure/9.2/security-permissions/certificates/certificates-overview.md) are backed up.
...
the setup wizard. The [Setup wizard](/docs/passwordsecure/9.2/installation-setup/server-installation/setup-wizard.md) is
