...
- Check in the [Database properties](/docs/passwordsecure/9.2/administration/server-management/database-properties.md) if the **offline
...
![userdata_migration_finished_en](/img/product_docs/passwordsecure/passwordsecure/configuration/server_manager/ecc_migration/userdata_migration_finished_en.webp)
...
- [Admin Manual](/docs/passwordsecure/9.2/administration/system-administration/ecc-migration.md)
- [User Manual](/docs/passwordsecure/9.2/administration/system-administration/ecc-migration.md)
