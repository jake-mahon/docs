...
![installation_with_parameters_115](/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/mainmenu/user_rights/overview_user_rights/installation_with_parameters_115.webp)
...
includes both the visibility of individual [Client Module](/docs/passwordsecure/9.2/user-interfaces/advanced-view/advanced-view-overview.md), as
...
1. The **personal user right** only applies to a specific user. This is always configured via
   the[Organisational structure](/docs/passwordsecure/9.2/core-features/organizational-structure/organizational-overview.md).

**User rights to role**s apply to all members of a role and are specified in the
[Roles](/docs/passwordsecure/9.2/security-permissions/roles-management/roles-overview.md)
...
the basis for the configuration of the [User settings](/docs/passwordsecure/9.2/administration/user-management/user-settings.md).
