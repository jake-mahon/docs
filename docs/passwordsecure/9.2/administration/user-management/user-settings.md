...
[Managing users](/docs/passwordsecure/9.2/core-features/organizational-structure/managing-users.md).
...
You can configure user settings similarly to [User rights](/docs/passwordsecure/9.2/administration/user-management/user-rights.md). Here too,
...
Global settings are configured as usual in the [Main menu](/docs/passwordsecure/9.2/user-interfaces/advanced-view/navigation-ribbon.md). The organisational
...
[Search](/docs/passwordsecure/9.2/user-interfaces/advanced-view/search-filter.md) mechanisms.
...
The [User rights](/docs/passwordsecure/9.2/administration/user-management/user-rights.md) define who has the required permissions to change
