...
[HTML WebViewer export](/docs/passwordsecure/9.2/administration/import-export/html-export.md), the resulting file is
...
- **Starting via the ribbon:** The export can also be started via the
  [Ribbon](/docs/passwordsecure/9.2/user-interfaces/advanced-view/navigation-ribbon.md) in the
  [Passwords](/docs/passwordsecure/9.2/core-features/password-management/passwords-overview.md) module.
...
automated [System tasks](/docs/passwordsecure/9.2/operations/system-tasks/system-tasks-overview.md) can extract information from
...
[Export wizard](/docs/passwordsecure/9.2/administration/import-export/export-wizard.md) because the export result is not separately secured
by a password.
...
The [HTML WebViewer export](/docs/passwordsecure/9.2/administration/import-export/html-export.md) creates a HTML file
