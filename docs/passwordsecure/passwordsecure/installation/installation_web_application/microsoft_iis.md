...
![IIS installation](/static/img/product_docs/passwordsecure/passwordsecure/installation/installation_web_application/installation-webclient-3-en.png)
...
![IIS-creating page](/static/img/product_docs/passwordsecure/passwordsecure/installation/installation_web_application/installation-webclient-4-en.png)
...
![IIS](/static/img/product_docs/passwordsecure/passwordsecure/installation/installation_web_application/installation-webclient-5-en.png)

Select the https entry and open it for editing. The SSL certificate is then selected here.

![IIS](/static/img/product_docs/passwordsecure/passwordsecure/installation/installation_web_application/installation-webclient-6-en.png)
