...
![installation_with_parameters_154](/static/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/administration/installation_with_parameters_154.png)
...
Further information on this topic can be found in the chapter [Applications](/docs/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/applications.md).

![installation_with_parameters_155](/static/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/administration/installation_with_parameters_155.png)
...
__Default form__ Otherwise, no form can be assigned to the new password.
