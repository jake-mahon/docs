...
![tabs LightClient](/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/tab_system/tabs-lc-en.png)
...
![tabs](/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/tab_system/tab-lc-1-en.png)
...
![public tab](/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/tab_system/public-tab-en.png)

## Showing and hiding tabs

The public tabs can be shown and hidden as needed. The X closes the current tab.

![close tab](/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/tab_system/close-tab-en.png)

A public tab can be displayed again with a simple click on the +.

![select organisational unit](/img/product_docs/passwordsecure/passwordsecure/configuration/basic_view/tab_system/select-ou-en.png)
