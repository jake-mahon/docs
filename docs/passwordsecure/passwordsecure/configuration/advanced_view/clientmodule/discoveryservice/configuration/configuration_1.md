...
A **Discovery Service Task** is used to add a new [Discovery Service](../discovery_service.md) and
...
3. **Tags**: The use of tags is described in more detail in the section
   [Tag manager](../../../mainmenu/extras/tag_management/tag_manager.md). A special tag can be
