...
settings in the [User settings](../../../mainmenu/user_settings/user_settings.md) in the category:
...
Task**. The [Filter](../../../operation_and_setup/filter/filter.md) can be used to select which data
