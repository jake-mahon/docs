...
- [Seals](../../permissionconcept/predefining_rights/protective_mechanisms/seals/seals.md): Requests to release sealed records are handled via the notification system
- [System tasks](../../mainmenu/extras/system_tasks/system_tasks.md)s: If reports are automatically created via the system tasks, these are also made available in the form of a notification. If this type of notification is selected, it can be directly opened via the corresponding button that appears on the ribbon.
...
If desired, notifications can be automatically cleaned up. This option can be configured on the __Server Manager__. Further information can be found in the section [Managing databases](../../../server_manager/managing_databases/managing_databases.md).
