...
![form module](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_1-en.png)
...
![forms](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_2-em.png)

The associated preview for the form selected in [List view](/docs/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/operation_and_setup/listview/list_view.md) appears in the [Reading pane](/docs/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/operation_and_setup/readingpane/reading_pane.md). Both the field name and also the field type are visible.
...
![Creating new forms](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_3-en.png)

The following field settings thus appear for the field type "Password": "Mandatory field, reveal only with reason, check only generated passwords and password policy". These can now be defined as desired. (__Note__: It is possible to select [Password rules](/docs/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/mainmenu/extras/password_rules/password_rules.md) within the field settings; they are defined as part of the options in the main menu)
...
![Configuring the info field](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_4-en.png)
...
![Configuring the info field](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_5-en.png)
...
![preview form](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_6-en.png)

The info field for the form is now updated. It is now possible to start the RDP session directly in the RDP session.

![updated form](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_7-en.png)

NOTE: The __forms module__ is based on the [Web Application](/docs/product_docs/passwordsecure/passwordsecure/configuration/web_applicaiton/web_application.md) module of the same name. Both modules have a different scope and design but are almost identical to use.
...
![settings form](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_8-en.png)

### Via the form selection

![default form](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/forms/forms_9-en.png)
