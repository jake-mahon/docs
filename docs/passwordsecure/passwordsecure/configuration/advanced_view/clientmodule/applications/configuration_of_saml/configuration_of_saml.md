...
NOTE: Setup and configuration instructions for [SAML Application for Dropbox](../examples/saml_examples/saml_application_for_dropbox.md) and [SAML application for Postman](../examples/saml_examples/saml_application_for_postman.md)can be found in the corresponding chapters.
