...
![activating session recording](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/rdp_and_ssh_applications/recording_a_session/recording_a_session_2-en.png)

SSH

![activating session recording](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/rdp_and_ssh_applications/recording_a_session/recording_a_session_3-en.png)
...
![viewing session recording](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/rdp_and_ssh_applications/recording_a_session/recording_a_session_4-en.png)
...
![session records](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/rdp_and_ssh_applications/recording_a_session/recording_a_session_5-en.png)
...
![viewing a session recording](/static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/applications/rdp_and_ssh_applications/recording_a_session/recording_a_session_6-en.png)
...
If desired, recordings can be automatically cleaned up. This option can be configured on the __Server Manager__. Further information can be found in the section [Managing databases](/docs/product_docs/passwordsecure/passwordsecure/configuration/server_manager/managing_databases/managing_databases.md)s.
