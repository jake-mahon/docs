...
In the [Organisational structure](../organisational_structure.md) module, you select the user and the interface "Multifactor authentication" in the ribbon.
...
The configuration of multifactor authentication using Yubico One Time Password is described in[Multifactor Authentication](../../../../server_manager/managing_databases/database_settings/multifactor_authentication_ac.md).
