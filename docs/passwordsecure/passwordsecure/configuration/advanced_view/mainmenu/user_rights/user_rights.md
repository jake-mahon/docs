...
1. The __personal user right__ only applies to a specific user. This is always configured via the[Organisational structure](../../clientmodule/organisationalstructures/organisational_structure.md).

__User rights to role__s apply to all members of a role and are specified in the [Roles](../../clientmodule/roles/roles.md)
...
The __security level__ is an essential element that is also specified in the user rights. This is the basis for the configuration of the [User settings](../user_settings/user_settings.md).
...
Due to the large number of possible configurations, the search function helps you to quickly find the desired configuration. This process is based as usual on the List [Search](../../operation_and_setup/search/search.md).
