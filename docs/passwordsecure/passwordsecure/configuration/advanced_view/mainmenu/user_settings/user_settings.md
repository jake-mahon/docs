...
You can configure user settings similarly to [User rights](../user_rights/user_rights.md). Here too,
...
Global settings are configured as usual in the [Main menu](../main_menu_fc.md). The organisational
...
[Search](../../operation_and_setup/search/search.md) mechanisms.
...
The [User rights](../user_rights/user_rights.md) define who has the required permissions to change
