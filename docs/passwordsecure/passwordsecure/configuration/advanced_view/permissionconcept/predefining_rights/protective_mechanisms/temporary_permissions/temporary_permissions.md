...
When configuring the [Manual setting of permissions](../../../manual_settings/manual_setting_of_permissions.md), you can specify a temporary release for each role. The start date as well as the end date is selected here. You can start the configuration using the __Extras__ area in the ribbon.

![temporary permission](../../../../../../../../../static/img/product_docs/passwordsecure/passwordsecure/configuration/advanced_view/permissionconcept/predefining_rights/protective_mechanisms/temporary_permissions/temporary_permissions-en.webp)
...
- __Brown:__ The temporary permission is configured but is still inactive. The selected time period is still in the future.
- __Green:__ The temporary permission is active.
- __Red:__ The time period for the temporary permissions has already expired.
...
__CAUTION:__ There must always be one user who has the “authorize” right to a record, who does not only have temporary permissions.
