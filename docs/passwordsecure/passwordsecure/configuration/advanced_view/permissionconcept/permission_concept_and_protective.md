...
Similar to the previous section Permission concept and protective mechanisms for roles, the configuration of a role will be illustrated using two users. The configuration is performed in the [Roles](../clientmodule/roles/roles.md). By double-clicking on the role “IT-Consultants” in the [List view](../operation_and_setup/listview/list_view.md), you can open their detailed view.
