...
[Main menu](../../mainmenu/main_menu_fc.md):
...
[Reading pane](../readingpane/reading_pane.md) is opened (1), further tabs will be visible in the
...
Double-clicking on an object in the [List view](../listview/list_view.md) opens a new tab with its
