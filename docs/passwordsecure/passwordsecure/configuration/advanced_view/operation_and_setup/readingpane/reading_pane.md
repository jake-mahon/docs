...
Depending on which record you have selected in [List view](../listview/list_view.md), the corresponding fields are displayed here. In the header, the assigned [Tags](../tags/tags.md), as well as the [Organisational structure](../../clientmodule/organisationalstructures/organisational_structure.md) are displayed.
...
Visibility of the individual tabs within the footer section is secured via separate [User rights](../../mainmenu/user_rights/user_rights.md):
