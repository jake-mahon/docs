...
Dashboards are available in almost all [Client Module](../../clientmodule/client_module.md)s. A
...
widgets** is managed in the[User settings](../../mainmenu/user_settings/user_settings.md).
