...
First of all, it is important to note how the synchronization has been configured in the [Settings](/docs/product_docs/passwordsecure/passwordsecure/configuration/mobiledevices/settings/settings_mobileapp.md).
...
The configuration is described in the chapter [Settings](/docs/product_docs/passwordsecure/passwordsecure/configuration/mobiledevices/settings/settings_mobileapp.md)
