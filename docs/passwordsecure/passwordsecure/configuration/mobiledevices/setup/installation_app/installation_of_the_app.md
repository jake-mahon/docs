...
[Installation Web Application](../../../../installation/installation_web_application/installation_web_application.md)

**Port**: The connection is made via https port 443, which must be enabled on the server side.

[User rights](../../../advanced_view/mainmenu/user_rights/user_rights.md)**:** The users need the
right **Can synchronize with mobile devices.**

[Database properties](../../../server_manager/database_properties/database_properties.md): It must
