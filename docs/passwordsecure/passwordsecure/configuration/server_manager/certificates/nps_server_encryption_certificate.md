...
![NPS Server Encryption](/static/img/product_docs/passwordsecure/passwordsecure/configuration/server_manager/certificates/nps-server-encryption_1014x771.png)
...
RECOMMENDED: __Please export this certificate separately!!!__
