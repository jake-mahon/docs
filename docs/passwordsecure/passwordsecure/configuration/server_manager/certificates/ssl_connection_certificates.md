...
[Basic configuration](../baseconfiguration/basic_configuration.md) in the AdminConsole. The
...
[Basic configuration](../baseconfiguration/basic_configuration.md). Please note that a server
