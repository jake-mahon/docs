...
The rules already set are displayed in the section on the right. The icons ![+](../../../../../../static/img/product_docs/passwordsecure/passwordsecure/configuration/server_manager/database_properties/+.webp) and ![-](../../../../../../static/img/product_docs/passwordsecure/passwordsecure/configuration/server_manager/database_properties/-.webp) can be used to add or also delete rules. Rules can be edited by double clicking on them.
