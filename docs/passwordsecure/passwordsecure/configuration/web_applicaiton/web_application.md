...
![WebClient](../../../../../static/img/product_docs/passwordsecure/passwordsecure/configuration/web_applicaiton/installation_with_parameters_159.webp)
...
The __Web Application__ is based both optically and also in its operation on the Netwrix Password Secure client. As usual, users can only access the data for which they also have permissions. The installation is described in the section [Installation Web Application](../../installation/installation_web_application/installation_web_application.md)
