...
The Active Directory connection in the Web Application works similiar to the Client. In the chapter [Active Directory link](../../../advanced_view/clientmodule/organisationalstructures/directoryservices/activedirectorylink/active_directory_link.md) you can find further information.
...
You can reach the Radius server, if the import is in the Masterkey mode. The Radius server will be provided in the Active Directory profile and will therefore deliver the possible authentication methods in future. You will find further informations in the [RADIUS authentication](../../../advanced_view/clientmodule/organisationalstructures/directoryservices/activedirectorylink/radius_authentication.md) chapter.
...
To __predefine rights__ in the Web Application, the procedure is the same as in the Client. [Predefining rights](../../../advanced_view/permissionconcept/predefining_rights/predefining_rights.md))
