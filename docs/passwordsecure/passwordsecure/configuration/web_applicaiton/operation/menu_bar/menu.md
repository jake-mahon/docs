...
[Passwords](/docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/passwords/passwords.md)

7. Password Reset

The functions of the [Password Reset](/docs/passwordsecure/passwordsecure/configuration/advanced_view/clientmodule/passwordreset/password_reset.md) can be found here.
