...
The user who is currently logged in can be seen under account. You can log out by clicking on the account. It is also possible to call up the settings in [Account](../../../advanced_view/mainmenu/account/account.md).
