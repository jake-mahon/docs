...
__CAUTION:__ The user right Can add new web applications is required in order to create applications
...
![create application](/static/img/product_docs/passwordsecure/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_144-en.png)

A modal window now opens. The actual application is now created here.

![modal application window](/static/img/product_docs/passwordsecure/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_145-en.png)

The following options are available:

- __Advanced options__ allows you to define a delay separately for each field when entering the data. This is sensible when the process of entering the data would otherwise not run smoothly on sluggish websites.
- The __Move__ setting can be used to change the position of the modal window if it covers the login window
...
![choosed application field](/static/img/product_docs/passwordsecure/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_146-en.png)
...
![example for a application](/static/img/product_docs/passwordsecure/passwordsecure/configuration/browseradd-ons/applications/installation_with_parameters_147-en.png)
