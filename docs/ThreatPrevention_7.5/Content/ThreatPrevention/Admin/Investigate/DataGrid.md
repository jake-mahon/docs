...
![Investigate interface - Data Grid](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Investigate/DataGrid.png "Investigate interface - Data Grid")

**Step 3 –** Select the **Production** or **Archive** option button to view events from the respective database.

The archive database is part of the Threat Prevention Database Maintenance feature and it can only be queried from the Administration Console. See the [Archive Data](../Configuration/DatabaseMaintenance/Archive "Archive Data") topic for additional information.

**Step 4 –** Use the **Get Top [number] Events** box to specify the number of events to be displayed.
...
![Investigate Interface - Attributes area](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Investigate/Attributes.png "Investigate Interface - Attributes area")
...
To export the data displayed in the grid to a CSV file, see the [Export Data](../Navigation/DataGrid#_Export_Data "Export Data") topic.