...
![Policy window - Active Directory Changes Event Type](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/EventType/ADChanges.png "Policy window - Active Directory Changes Event Type")
...
![Policy window - AD Attributes filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/ADAttributes.png "Policy window - AD Attributes filter")
...
When an attribute is selected, it is added to the filter and a drop-down menu is displayed in the Operation column with **Any Value** selected. You can further scope the attributes to enable the policy to only capture events based on the new value. Use the Operation and Value columns of the Include Attributes and Exclude Attributes boxes to achieve this.
...
Select an **Operation** and type a value in the textbox. The value may include alphanumeric characters, string type, or dates. Only one value is supported; do not specify multiple values for the attribute. Also the Value field is not case sensitive.
...
**NOTE:** You cannot specify more than one value for an attribute and you cannot select the same attribute twice. To use the same attribute again, you have to add the same event type again to the policy, select that event type and then select a previously used attribute to include in the Add Attributes filter.

When the userAccountControl attribute is included or excluded in the filter, selecting the Any Value dropdown opens the [User Account Control Window](Window/UserAccountControl "Navigates to the User Account Control selection window. ") with additional UAC flags to add to the filter.
...
![AD Changes event type - Advanced Filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/AdvancedADChanges.png "AD Changes event type - Advanced Filter")
...
To add a filter (condition) to the filter statement or to start a new group of filters, click the **Add** (+) icon. Then select:
...
**NOTE:** The Value box only accepts a single string except when the “Attributes: New” or “Attributes: Old” option is selected in the Event Data drop-down menu.
...
![Example of an advanced filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/FilterStatement.png "Example of an advanced filter")
