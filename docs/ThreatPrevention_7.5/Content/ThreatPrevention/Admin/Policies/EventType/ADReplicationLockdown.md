...
![Policy window - AD Replication Lockdown Event Type](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/EventType/ADReplicationLockdown.png "Policy window - AD Replication Lockdown Event Type")
...
**NOTE:** The AD Replication Lockdown event type internally looks for use of the GetNCChanges() API and blocks the API call when it is invoked by a machine outside the scope of the policy filters.
...
![Policy window - Hosts (from) filter for the AD Replication Lockdown event type](../../../../Resources/Images/ThreatPrevention/Policies/Filters/ADReplicationHostsFrom.png "Policy window - Hosts (from) filter for the AD Replication Lockdown event type")
