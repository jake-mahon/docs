...
![Policy window - File System Changes Event Type](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/EventType/FileSystemChanges.png "Policy window - File System Changes Event Type")
...
![Policy window - File System filter for monitoring](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/FileSystem.png "Policy window - File System filter for monitoring")

Access Operations area

In the Access Operations area, check the **All** box at the top to include all operations or select specific operations:
...
In the Property Operations area, check the **All** box at the top to include all operations or select specific operations:
...
In the Share Operations area, check the **All** box at the top to include all operations or select specific operations:
...
In the I/O Type area, check the **All** box at the top to include all types or select specific types:
...
![Policy window - Paths filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/Paths.png "Policy window - Paths filter")
...
* The Path **Add** (+) button opens the [Select File System Objects Window](Window/SelectFileSystemObjects "Navigates to the Select File System Objects selection window. ").
...
![Paths filter - Sub Folder checkbox](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/SubFolder.png "Paths filter - Sub Folder checkbox")
...
![Policy window - Additional Agents filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/AdditionalAgents.png "Policy window - Additional Agents filter")
