...
The File System Enterprise Auditor event type is used to send File System activity to Netwrix Access Analyzer (formerly Enterprise Auditor).
...
![Policy window - File System Enterprise Auditor Event Type](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/EventType/FileSystemEnterpriseAuditor.png "Policy window - File System Enterprise Auditor Event Type")
...
This event type is specifically designed to capture Windows file system activity events for consumption by Netwrix Access Analyzer (formerly Enterprise Auditor), formerly StealthAUDIT.

These events are not captured in the Threat Prevention database, but are collected in a data file that can be read by the File System collection. See the File System Solution topic in the [Netwrix Access Analyzer Documentation](https://helpcenter.netwrix.com/category/accessanalyzer "Netwrix Access Analyzer Documentation") for information on this collection component.

Event data collected by the policies with either the [File System Changes Event Type](FileSystemChanges "File System Changes Event Type") or the [File System Lockdown Event Type](FileSystemLockdown "File System Lockdown Event Type") are also available for consumption by Netwrix Access Analyzer (formerly Enterprise Auditor) if the File System Enterprise Auditor event type is used by the same policy.
...
![Policy window - File System Enterprise Auditor filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/FileSystemEnterpriseAuditor.png "Policy window - File System Enterprise Auditor filter")
...
![Policy window - File System Agents filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/FileSystemAgents.png "Policy window - File System Agents filter")
...
**NOTE:** There must be at least one Agent in the Selected Agents/Domains list for policies using the File System Enterprise Auditor Event Type.
...
![Policy window - Processes and Configuration filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/ProcessesAndConfiguration.png "Policy window - Processes and Configuration filter")

* The **Record Read Operations** checkbox is checked by default. To configure the policy to ignore read operations, uncheck this option.
* In the [Number] **Days to Retain Log** box, specify a number to indicate the number of days the logs remain before Threat Prevention deletes them.
* In the Exclude Processes area, specify any processes that should be excluded from being monitored by this policy. Type the process in the Exclude Processes textbox. You must enter a process name exactly as is; for example, as it appears on the Details tab of Windows Task Manager. For example, to exclude the Windows Explorer actions like opening and closing of files, enter ‘explorer.exe’ in the textbox.
...
![Policy window - Perpetrators to Exclude filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/PerpetratorsToExclude.png "Policy window - Perpetrators to Exclude filter")
