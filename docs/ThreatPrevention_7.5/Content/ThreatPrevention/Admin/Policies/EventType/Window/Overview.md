...
![Selection Window - Connect to Agent/Server option](../../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/SelectionWindows/SelectAgent.png "Selection Window - Connect to Agent/Server option")
...
![Selection Window - Browse mode](../../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/SelectionWindows/ADPerpetrators.png "Selection Window - Browse mode")
...
![Selection Window - Search Mode](../../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/SelectionWindows/SearchMode.png "Selection Window - Search Mode")
...
* After selecting the desired options, click **Search Now**. The Results pane begins to populate with matching results.
* Choose between **Show [number] AD objects** and specify a value or **Show all**. Already selected objects for this filter that match the search are visible but grayed-out.
* Check the desired item(s) in the Results pane on the right and click **OK**.
