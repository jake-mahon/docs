...
![Policy window - AD Replication Monitoring Event Type](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/EventType/ADReplicationMonitoring.png "Policy window - AD Replication Monitoring Event Type")
...
**NOTE:** The AD Replication Monitoring event type internally looks for use of the GetNCChanges() API and reports an event when this API is invoked by a machine outside the scope of the policy filters.
...
![Policy window - Permissions  filter](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/Permissions.png "Policy window - Permissions  filter")
