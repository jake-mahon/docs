...
Based on policy rules, the File System Lockdown event type can prevent file activity on selected files, such as create/read/write/delete/rename or security descriptor changes done via NTFS or VSS access. An event is generated for each blocked activity.
...
![Policy window - File System filter for lockdown](../../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Policies/Filters/FileSystemLockdown.png "Policy window - File System filter for lockdown")
