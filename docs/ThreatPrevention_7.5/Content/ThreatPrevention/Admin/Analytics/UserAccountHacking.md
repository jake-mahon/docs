...
The **User Account Hacking** analytic type identifies multiple bad passwords provided for a given valid user account in the specified time interval.

***RECOMMENDED:*** Configure a subset of accounts to be monitored in order to avoid the excessive volume of event activity from monitoring all accounts.
...
See the [User Account Hacking Analytic Data Grid](#_User_Account_Hacking_2 "User Account Hacking Analytic Data Grid") topic for information on event data collected per incident.
...
![User Account Hacking Analytic Type - Settings tab](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/AccountHackingSettings.png "User Account Hacking Analytic Type - Settings tab")
...
![User Account Hacking Analytic Type - Policy tab](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/PolicyTab.png "User Account Hacking Analytic Type - Policy tab")
...
![User Account Hacking Analytic Type window](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/UserAccountHacking.png "User Account Hacking Analytic Type window")
