...
The **Horizontal Movement Attacks** analytic type identifies security principals that are accessing more than the threshold of resources during the specified time interval.
...
See the [Horizontal Movement Attacks Analytic Data Grid](#_Horizontal_Movement_Attacks "Horizontal Movement Attacks Analytic Data Grid") topic for information on event data collected per incident.
...
![Horizontal Movement Attacks Analytic Type - Settings tab](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/HorizontalAttacksSettings.png "Horizontal Movement Attacks Analytic Type - Settings tab")
...
![Horizontal Movement Attacks Analytic Type - Policy tab](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/PolicyTab.png "Horizontal Movement Attacks Analytic Type - Policy tab")
...
![Horizontal Movement Attacks Analytic Type window](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Analytics/HorizontalMovement.png "Horizontal Movement Attacks Analytic Type window")
