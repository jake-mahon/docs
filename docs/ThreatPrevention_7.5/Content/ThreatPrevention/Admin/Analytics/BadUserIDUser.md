...
See the [Bad User ID (by User) Analytic Data Grid](#_Bad_User_ID "Bas User ID (by User) Analytic Data Grid") topic for information on event data collected per incident.
...
![Bad User ID (by User) Analytic Type - Settings tab](../../../Resources/Images/ThreatPrevention/Analytics/BadUserIDSettings.png "Bad User ID (by User) Analytic Type - Settings tab")
...
![Bad User ID (by User) Analytic Type - Policy tab](../../../Resources/Images/ThreatPrevention/Analytics/PolicyTab.png "Bad User ID (by User) Analytic Type - Policy tab")
...
The data grid on the **Bad User ID (by user)** node lists one row per incident identified. These incidences are grouped per unique bad user name.

![Bad User ID (by User) Analytic Type  window](../../../Resources/Images/ThreatPrevention/Analytics/BadUserIDUser.png "Bad User ID (by User) Analytic Type  window")
