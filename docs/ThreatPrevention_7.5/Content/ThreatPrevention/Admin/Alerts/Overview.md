...
You can choose to view alerts related to analytics configuration and monitoring status on the Alerts interface. See the [Alerts Cleanup Window](Window/AlertsCleanup "Alerts Cleanup Window") topic for options to display this data.

Click **Alerts** in the left pane to launch the Alerts interface.

![Alerts interface](../../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/Alerts/AlertsInterface.png "Alerts interface")
...
* Component – The type of system event for which the alert is triggered:
  ...
  * Threat Prevention Configuration events
  ...
  For a list of the events that fall under each component, see the [System Alerting Window](../Configuration/SystemAlerting/Overview "System Alerting Window")
