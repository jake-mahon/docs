...
**CAUTION:** These events are permanently deleted and are not processed by the Enterprise Manager on reconnection. This option is for diagnostic and troubleshooting purposes only.
...
**Step 5 –** The Clear Agent Queue window displays the task in progress and then its status as either:
