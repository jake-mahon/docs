...
![Netwrix Threat Prevention DB Connection Manager wizard](../../../../../static/images/ThreatPrevention_7.5/Content/Resources/Images/ThreatPrevention/DBMaintenance/DBConnectionManager.png "Netwrix Threat Prevention DB Connection Manager wizard")
...
**Step 4 –** The system verifies the new connection string data for the desired SQL server. The **Ignore Errors** checkbox controls the behavior when the system encounters an error when attempting to connect:
