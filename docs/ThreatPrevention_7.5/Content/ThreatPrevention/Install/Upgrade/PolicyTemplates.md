...
*Remember,* use these steps when the Templates Update window option was selected as **No** during the [Upgrade Procedure](Overview "Upgrade Procedure") process.
...
**Step 3 –** To import all new templates, select the **SI\_Template\_All** XML file. Click **Open**.

**Step 4 –** The Import window displays information for the template(s). Click **Import**.

**Step 5 –** An Import Decision window opens when a duplicate collection or template is found. Choose between:
