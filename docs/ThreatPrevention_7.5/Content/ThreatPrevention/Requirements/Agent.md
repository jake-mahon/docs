...
You can also have the HIBP database deployed on some Agent servers, while other Agent servers work with the copy installed on the Enterprise Manager server. See the [EPE Settings Window](../Admin/Configuration/EPESettings "EPE Settings Window") topic for additional information.
