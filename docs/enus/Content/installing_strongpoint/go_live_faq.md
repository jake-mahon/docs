...
> *How To*: [Create a Change Request for Role Assignment](#Create2)
>
> *How To*: [Add New Customizations to a Change Request](#Add)
>
> *How To*:[Search for Customizations](#Search)
>
> *About*: [Prototype Customizations](#Prototyp)
>
> *About*: [Approval Overrides](#Approval)
>
> *Help*: [Change By Field Showing AutoSpider or Could Not Be Determined](#Change)
>
> *Help*: [New Script Deployments on Non-Compliant Changes Report](#New)
>
> *Help*: [Change Logs Attached to the Wrong Change Request](#Change2)
>
> *Help*: [Managed Bundle changes showing up as non-compliant changes?](#Managed)
>
> *Help*: [You do not have a Valid License Message](#You)
...
1. In the NetSuite **Search** box, enter **emp:** and start typing the employee's name. Click **Edit** by the employee in the Search results.
...
3. Select **Approved** from the **Approval Status** list.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/GoLive_approval_override.png "Change Status to Approved")

The Status bar is set to **Approved (Override)** and the administrator's name is displayed in the **Approval Override By** field.

## Change By Field Showing AutoSpider or Could Not Be Determined

If the AutoSpider is not run, your Change Logs will be missing the **Changed by** and **Actual Change Date** fields. When the Change Log is newly created, the fields contain **Pending AutoSpider**. If too many days go by, the fields change to **Could not be determined**.

Refer to [Setting Up the AutoSpider and Alerts](running_the_spider "Open the Setting Up the AutoSpider and Alerts topic") for details.
...
If your site uses [Opportunistic Clearance](../change_management/opportunistic_clearance "Open the Opportunistic Clearance topic"), the deployment record is handled automatically. You should make sure you understand all of the ramifications of Opportunistic Clearance prior to enabling it for your account.
...
If a user sees a License message, you need to grant them a license. Refer to the [License Manager](license_manager "Open the License Manager topic") topic.