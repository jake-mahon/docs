...
Users are managed through the **[**License Manager**](license_manager "Open the License Manager topic.")**.
...
**Next Step:**  [Setting Tab Access](setting_strongpoint_tab_access "Open Setting Access and Permissions topic.")