...
:::note
The AutoSpider portlet should be installed on all Administrator homepages. The AutoSpider triggers when the Administrator logs in. Ideally daily or every other day. Best practice is to wait for the portlet to load and see the Spider Triggered message before continuing.
:::
...
![](../../../../static/images/enus/Content/Resources/Images/auto-spider_portlet.png "Auto-Spider Portlet")
...
**Next Step:** [Managing Users](managing_users "Open Managing Users topic.")