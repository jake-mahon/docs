...
* [Documentation and Optimization](#doc_and_opt)
* [Intelligent Change Management](#int_chg_mgmt)
* [Enterprise](#ent_comp)
...
1 **Non-Material Object Changes** are changes detected in the object definition not caused by human intervention and do not have any functional impact. Examples include NetSuite internal IDs, object XML structure or JSON representation or reordering values in a list.

All of the Documentation and Optimization menu items are available to the Intelligent Change Management license.

## Enterprise

All of the Documentation and Optimization and Intelligent Change Management menu items are available to the Enterprise license.
