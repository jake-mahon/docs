...
1. [Create a Saved Search](#CreateSavedSearch)
2. [Create the Customization Record](#CreateCustomizationRecord)
3. [Designate the Customization as a Control](#DesignateControl)
...
5. Add filters on the **Criteria** tab:
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/agent_example1.png "Create the Saved Search for the Example")
...
6. Open the **Results** tab. You can Remove all to clear the defaults. Add the following fields:
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/agent_example2.png "Adding the Results columns")
7. **Save** the search.
...
2. Enter information in the required fields:
   ...
   * **Script ID**: Enter the **ID** from your Saved Search. For example, **customsearch5673**
     ...
     ![](../../../../static/images/enus/Content/Resources/Images/agent_example3.png "Create the Customization for the Example")
...
5. **Save** the record.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/agent_example4.png "Designating the customization as a control")
