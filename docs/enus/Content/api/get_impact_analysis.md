...
Returns the impact analysis data of the customizations attached to a Change Request. Customization impact analysis data are categorized as **Safe to modify**, **Not safe to modify** and **Inactive**.
...
URL
:   https://.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript\_flo\_int\_change\_request\_api&deploy=1&actionType=getImpactAnalysis
...
                            "link": "  
                            Strongpoint Agent Large Control Mailer (Scheduled Script)"  
                        }  
                    ]                  
                }  
            ],  
