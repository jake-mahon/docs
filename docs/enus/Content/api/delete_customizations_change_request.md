...
URL
:   https://.restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript\_flo\_int\_change\_request\_api&deploy=1
...
:::note
Request body names are case sensitive and mandatory. For the actionType parameter, it is always a constant value, in this case deleteCustomization.
:::
...
"Customizations / proposed customizations deleted successfully."
:   Successfully removed customizations and/or proposed customizations from the change request.

"No change detected."
:   Customizations/Proposed Customizations are already removed from the change request(for duplicate deletions).
