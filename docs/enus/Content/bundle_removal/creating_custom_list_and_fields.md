...
3. On the Values tab add these values:
   ...
   6. In bundle referenced by outside
      ...
      ![](../../../../static/images/enus/Content/Resources/Images/customlist.png "Create a Custom List")
...
**Next Step:** [Categorizing Customizations](categorizing_customizations "Open Categorizing Customizations topic.")