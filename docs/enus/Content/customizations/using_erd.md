...
The Entity Relationship Diagram, **ERD** is a visual representation of your Customizations where you can easily review the relationships and dependencies. The ERD is easily accessible:

* **Strongpoint** > **Customizations** > **ERD View**
* ERD Search, refer to [Enabling the ERD Search on the Dashboard](#Enabling)
...
![](../../../../static/images/enus/Content/Resources/Images/erdsearchform-1.png)
