...
With Platform Governance for NetSuite's integration of **NetSuite** and **ServiceNow**, you can use the **ServiceNow** tool while we automatically add and track the associated changes in your NetSuite account. The integration eliminates the need for double entry in the two systems.
...
![](../Resources/Images/ServiceNowFlow.PNG)
...
4. Click **Push Deployment Record** when complete. A Change Request is created using the changes in the ServiceNow ticket.
