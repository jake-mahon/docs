...
1. [Install the Netsuite Bundle](#Install "Install the NetSuite Bundle")
2. [Install the App](#Install2)
3. [Set up Approvals](#Setting)
...
3. Navigate to **Apps** > **Marketplace**.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/zendesk_admin_marketplace.png "Open the Zendesk Marketplace")
4. Search for **Strongpoint**.
5. Click **Strongpoint for NetSuite** when it is displayed.

   ![](../../../../static/images/enus/Content/Resources/Images/zendesk_strongpoint.png "Strongpoint for NetSuite app in the Marketplace")
...
8. Navigate to **Apps** > **Manage**.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/zendesk_configure_app.png "Configure the Strongpoint Zendesk app")
9. Hover on the **Strongpoint for NetSuite** tile to access the **Settings** menu.

   ![](../../../../static/images/enus/Content/Resources/Images/zendesk_configure_app_menu.png "Hover to access the Settings")
10. Click **Change settings**.

    ![](../../../../static/images/enus/Content/Resources/Images/zendesk_change_settings.png "Set up the Strongpoint for NetSuite Zendesk app")

    * **Title**: the name associated with the app. The default is **Strongpoint for NetSuite**.
    * Account ID: enter the NetSuite account ID. The **Account ID** must be a lowercase string. For example, **tstdrv1724328**.
...
Account ID must be entered in lower case.
    ...
    * **Consumer Secret**: Enter the Consumer Secret of the Integration Record from your NetSuite account.
...
1. Click the new **Strongpoint for NetSuite** icon in the left panel. The **Group Configurations** page opens.
2. Enter the group and approval information:
   ...
   * **Approval process** select the approval process to use. **Strongpoint Approval in Zendesk**, **Strongpoint Approval in NetSuite**, **No Appoval Needed**, or **Not set**.

**Next Step:**  [Zendesk Walkthrough Example](zendesk_walkthrough_example "Click to open the Jira Walkthrough Example.")