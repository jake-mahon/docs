...
Change Logs allow you to see the type of change, who made the change and view the system notes of the NetSuite record. Change Logs are accessed from the [Change Management Reports](change_management_reports "Open Change Management Reports topic").

:::note
Once a change request is complete, best practice is to change the status to Completed. If there are multiple open change requests referencing the same object, any changes to the object result in the change log being associated with the oldest of the approved change requests.
:::
...
![](../../../../static/images/enus/Content/Resources/Images/changelog-1.png)

If the **Actual Change Date** is empty or **Change By** is set to **Could Not Be Determined** or **Pending Autospider**, a **Refresh Changed By** button is available. When clicked, it populates **Actual Change Date** and **Change By** fields.

:::note
The button is only available for Object types where the Actual Change Date and Change By fields can be retrieved.
:::
...
**Actual Change Date**: Date of the system note entry reflecting the change date. There must be an available system note to display the date.
...
**Changed By**: User who made the change. There must be an available system note to display the user.
...
* When **Systemnotes.Type** is included as result column and one of the system note lines is **Created**, the Change Overview displays: ****created** **.
* When there are no system notes columns, **Change Overview** displays ****changed** **.
* Deleted records display ****deleted****
* For grouped results with multiple records, **Change Overview** displays **See Change Data Table for details.**
...
![](../../../../static/images/enus/Content/Resources/Images/values_tab.png)

## Finding Users Who Have Made Changes

When you want to find out who has made changes, you can run any of the Change Reports and view who made a change in the **Change By** column.

The **Change By** and **Actual Date** of the change logs are retrieved using System Notes Search for supported record types. If a System Note is not available, **Change By** displays **Could Not Be Determined** in the Report List.
...
1. Click on a linked **Customization** to open the Customization Record. **Strongpoint Return Jira Ticket Info (Suitelet Script)** in this example.

   ![](../../../../static/images/enus/Content/Resources/Images/change_log_customization_link.png "Change Log Customization link")
2. Click **Go to Record**
3. Open **System Notes**

![](../../../../static/images/enus/Content/Resources/Images/systemsnotes.png)