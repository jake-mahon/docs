...
2. Enter the **Name** and **Owner** for the process. For this example, the name is **Provision Multi-Stream Approval**.
3. **Custom Form** and **Step Type** should be set to **Process**.
4. Ctrl-Click to select one or more **Additional Approvers**. NOTE: Select the additional approvers in the order you want them to approve.

   ![](../../../../static/images/enus/Content/Resources/Images/multi_stream_new_process.png)
5. Click **Save**. Note the approvers are listed in the order selected, not the order they appeared in the list. If you need to reorder the approvers, **Edit** the record, de-select and re-select the additional approvers.

   ![](../../../../static/images/enus/Content/Resources/Images/multi_stream_new_process_save.png)

### Create a new Policy Record

1. Open **Strongpoint** > **Change Management Tools** > **Change / Approval Policy** > **New**
2. Enter a **Name** and **Owner** for the Policy. For this example the name is **Process Approvers Only**.
...
6. Click **Save**. Leave the new policy open and continue with the next steps.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/multi_stream_new_policy.png)
...
2. Select the **Process** you created. For this example, it is **Provision Multi-Stream Approval**.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/multi_stream_attach.png)
3. Click **Attach**. The process is now shown on the **Process Policies** tab.

   ![](../../../../static/images/enus/Content/Resources/Images/multi_stream_attach_result.png)

### Create a Change Request

1. Open **Strongpoint** > **Change Management Tools** > **New ITGC Change Request**
2. Enter a **Name** and **Change Overview** for the Change Request. For this example the name is **Sample Change Request - Multi-Stream Approval**.
