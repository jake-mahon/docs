...
11. Click **Push**.
![](../../../../static/images/enus/Content/Resources/Images/push_change_request.png)
...
* Attach **customizations created/updated**.
  ...
  ![](../../../../static/images/enus/Content/Resources/Images/multi_env_1.png)
* **Stage**: **Deployment Record**
* **Set Approval Status**: **Approved** (this is optional)

  ![](../../../../static/images/enus/Content/Resources/Images/multi_env_2.png)
...
4. Click the **Compare** button.  
   Refer to [Comparing Environments](comparing_environments "Open Comparing Environments topic") for more details.
...
5. Click **Edit** (deployment record).
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/multi_env_3.png)
