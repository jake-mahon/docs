---
sidebar_position: 1341
title: Clean Up Scripts with Default IDs
---

# Clean Up Scripts with Default IDs

Default IDs significantly increase the cost and risks associated with any development work, and are a critical clean up practice.
...
3. If you decide to change the **Script ID**, click or right click **Edit** to open the customization record.
...
6. **Create a Change Request** or **Add to Change Request** (there is a shortcut link to open the change request) to have all impacted customizations in the same change request and create a complete record of all changes implemented as a result of the ID change.
