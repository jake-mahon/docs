...
* **Forms/Scripts**: Depending on your requirements, you can move unused forms, scripts, fields and associated customizations to progress through your account
...
1. [Analyze Unused Customizations and Identify Dependencies](#Analyze)
2. [Create Change Requests](#Create)
3. [Archive Field Data](#Archive)
4. [Back Up Searches, Scripts and Workflows](#Back)
5. [Delete Customizations](#Delete)
6. [Close the Change Request](#Close)
...
2. Enter filtering information to streamline your search. Searching on all unused customizations can take a long time to load and can time out.
   ...
   ![](../../../../static/images/enus/Content/Resources/Images/customizations_cleanup_unused_filters.png "Enter criteria prior to searching for unused customizations")
3. Click **Search**.  
    The results are coded with a flag in the first column and the text either blue (Inactive owner) or black.   
   ![](../../../../static/images/enus/Content/Resources/Images/customizations_cleanup_key.png "Cleanup Key")  
    You can hover over the flag for more information. If the text is blue, **Inactive Owner** is displayed regardless of the flag color.

   ![](../../../../static/images/enus/Content/Resources/Images/customizations_cleanup_list.png)
4. Click **View** next to each Customization to investigate. You can right-click on **View** and select **Open in a new tab or window** to keep your results page available.

   ![](../../../../static/images/enus/Content/Resources/Images/customizations_cleanup_view_record.png "View the Customization Record")
5. Use the **ERD**, **Base Record** and **Related Objects** links to review the dependencies.  
   ...
   4. Return to your Results page and continue your investigations.
      ...
      If you have an **Intelligent Change Management** or **Enterprise** license, continue with these steps using the Change Management features.

## Create Change Requests

You can group the customizations you are considering to delete and create a change request that includes those customizations. You can do this by editing the **Create Customizations** or open an existing change request and add the customizations in the **Impacted Customizations** under **Scope**.

The Impact Analysis is available in the Advanced Change Management Module. This appears as **Clean Up** or **Impact Analysis** as a tab at the bottom of the Change Request. It provides specific warnings and status for each customization attached to the Change Request.

![](../../../../static/images/enus/Content/Resources/Images/cleanupimpactanalysis.png)

The **Impact Analysis** tab has the following elements:

**Can be safely deleted or modified**: A list of the customizations linked to the change request that do not trigger any of the warnings below.
...
Once a Change Request has been approved the **Archive Customizations** button is available. When clicked, any fields in the change request are archived and stored in the **File Cabinet**.

![](../../../../static/images/enus/Content/Resources/Images/archive.png)

The status of those fields changes to **Archived**. The customization moves to the **Can Be Safely Deleted or Modified** tab.
...
* **Searches**: All fields, filters, criteria and other search elements are documented in the Searches tab.
* **Scripts:** A script archive file is attached to the customization record.
* **Workflow:** Workflow actions, states, fields, conditions and other elements are documented in the Related Workflows tab.
...
* If you have the Advanced Change Management Module, you can use the go to the **Can be safely deleted or modified tab** at the bottom of the change request to delete the customizations.
