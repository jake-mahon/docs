...
This view makes it easy to identify roles without owners, and facilitates adding owners. Access your **Pending Role Assignments** from your menu bar. All changes are captured in the [UAR History](../uar_history "Open the UAR History topic").

Here is an example of the **Pending Role Assignments**:

![](../../../../../static/images/enus/Content/Resources/Images/pending_role_assignments.png "Pending role assignments")
...
* **Export** exports the list of selected reviews as either a **CSV** or **PDF** file. The exported file is named *Pending\_Role\_Assignments*.
...
2. Select a Related Review link.
   ...
   ![](../../../../../static/images/enus/Content/Resources/Images/related_review_link.png "Related review link")
3. Select a single review, or select the box in the table header to select all of the reviews.

   ![](../../../../../static/images/enus/Content/Resources/Images/assign_due_date.png "Assign due dates for reviews")
