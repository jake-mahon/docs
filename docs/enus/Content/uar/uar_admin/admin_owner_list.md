...
Access your **Owner List** from your menu bar. This is where Administrators can add or remove owners from reviews. All changes are captured in the [UAR History](../uar_history "Open the UAR History topic").
...
![](../../../../../static/images/enus/Content/Resources/Images/owner_list.png "Administrator Owner list")
...
* **Role Type of Review** Displays **Both**, **Custom** only, or **Standard** only roles in the list.
...
* **Export** exports the list of selected reviews as either a **CSV** or **PDF** file. The exported file is named *Owner\_List*.
...
2. Click **Add Owner** to add a new role.
   ...
   ![](../../../../../static/images/enus/Content/Resources/Images/add_owner.png "Add Owner")
3. **Select Role** from the drop down. From Bundle, Custom/Standard and Center Type are automatically added.
...
The **Owner Notes** tab displays the details for each change in the Owner List. Click the **Owner Notes** tab to access this detail. You can filter the Owner Notes by **Create Date**.

![](../../../../../static/images/enus/Content/Resources/Images/owner_notes.png "Owner notes")

1. Open **Owner List** from your menu bar.
2. Open the **Owner Notes** tab.
3. You can export the list as a CSV or PDF file. The file is named *Owner\_Notes*.
