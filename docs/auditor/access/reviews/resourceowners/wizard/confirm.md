...
The selected owners receive an email from the Access Reviews application asking if they are the owner of the assigned resource. See the [Ownership Confirmation Request Email](../email/confirmationrequest.md) topic for additional information.
