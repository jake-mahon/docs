...
- Add new owners — Click __Add__ to browse for a new owner. See the [Add Owner Window](/docs/product_docs/auditor/access/reviews/resourceowners/window/addowner.md) topic for additional information.
...
![Update resource wizard showing 3. Summary page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/summary.png)
...
![Update resource wizard with 3. Summary page showing action status 100% complete](/static/img/product_docs/auditor/access/reviews/resourceowners/wizard/summarytaskcompleted.png)
