...
![Add new resource wizard showing 1. Select Resources page](../../../../../../static/img/product_docs/accessinformationcenter/access/informationcenter/accessrequests/wizard/selectresource.webp)
...
__Step 3 –__ On the Select Owners page, click __Add__ to browse for an owner. Repeat this Step to add multiple owners. See the [Add Owner Window](../window/addowner.md) topic for additional information.
...
![Add new resource wizard showing 4. Summary page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/summary.webp)
...
![Add new resource wizard with 4. Summary page showing action status 100% completed](../../../../../../static/img/product_docs/auditor/access/reviews/resourceowners/wizard/summarytaskcompleted.webp)
