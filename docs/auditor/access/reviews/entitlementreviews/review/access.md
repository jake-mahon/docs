...
- Trustee Name — Name of the trustee with access to this resource. If the trustee is a group, click the hyperlink to open the Group Membership window. See the [Group Membership Window](/docs/product_docs/auditor/access/general/groupmembership.md) topic for additional information.
...
![Resource Reviews page showing an Access Review on 2 Review changes tab](/static/img/product_docs/auditor/access/reviews/entitlementreviews/review/reviewpageaccesstab2.png)
