...
![Email announcing a pending review](/static/img/product_docs/auditor/access/reviews/entitlementreviews/pendingreviewemail.png)
...
The My Reviews interface has two pages: Pending Reviews and Review History. See the [Review History Page](/docs/product_docs/auditor/access/reviews/entitlementreviews/reviewhistory.md) topic for additional information.

## Pending Reviews Page

The Pending Reviews page lists all of your resources included in pending reviews.

![My Reviews interface showing Pending Reviews page](/static/img/product_docs/auditor/access/reviews/entitlementreviews/pendingreivewspage.png)
...
![Resource Reviews page showing the 1 Make changes tab](/static/img/product_docs/accessinformationcenter/access/informationcenter/resourcereviews/reviewpageaccess.png)
...
- [Perform an Access Review](/docs/product_docs/auditor/access/reviews/entitlementreviews/review/access.md)
- [Perform a Membership Review](/docs/product_docs/auditor/access/reviews/entitlementreviews/review/membership.md)
