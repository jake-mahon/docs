...
To upgrade the Access Reviews application to a newer version, simply run the new ```AccessReviews.msi``` executable. It is not necessary to uninstall the existing version. See the [Install](/docs/product_docs/auditor/access/reviews/installation/install.md) topic for additional information.
...
__Step 1 –__ Install the Netwrix Auditor Access Reviews application on the same server where the Netwrix Access Information Center was installed. See the [Install](/docs/product_docs/auditor/access/reviews/installation/install.md) topic for additional information. On the SQL Server Connection page:
...
__Step 2 –__ Launch the application and reset the Builtin Administrator password. See the [First Launch](/docs/product_docs/auditor/access/reviews/admin/firstlaunch.md) topic for additional information.

__Step 3 –__ It will be necessary to add your Console Users again. See the [Console Access Page](/docs/product_docs/auditor/access/reviews/admin/configuration/consoleaccess.md) topic for additional information.

__Step 4 –__ It will be necessary to configure the Notification settings. See the [Notifications Page](/docs/product_docs/auditor/access/reviews/admin/configuration/notifications.md) topic for additional information.
