...
![Services Manager Console showing the Netwrix Access Information Center service and the right-click Menu](/img/product_docs/auditor/10.7/access/reviews/admin/troubleshooting/servicesmanager.webp)
...
![Netwrix Access Information Center service Properties window with Select User browser window](/img/product_docs/auditor/10.7/access/reviews/admin/troubleshooting/serviceproperties.webp)
