...
| ------ | --------------------------------------- | ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GET    | /netwrix/api/v1/activity_records/enum   | —                                                                                           | Returns Activity Records. [Retrieve Activity Records](/docs/auditor/10.7/api-reference/activity-records/retrieving-records.md)                                               |
| POST   | /netwrix/api/v1/activity_records/enum   | [Continuation Mark](/docs/auditor/10.7/api-reference/activity-records/searching-records.md) | Returns next 1,000 Activity Records. [Continuation Mark](/docs/auditor/10.7/api-reference/activity-records/searching-records.md)                                             |
| POST   | /netwrix/api/v1/activity_records/search | [Search Parameters](/docs/auditor/10.7/api-reference/activity-records/searching-records.md) | Returns Activity Records matching a criteria defined in search parameters. [Search Activity Records](/docs/auditor/10.7/api-reference/activity-records/searching-records.md) |
| POST   | /netwrix/api/v1/activity_records/       | [Activity Records](/docs/auditor/10.7/api-reference/activity-records/writing-records.md)    | Writes data to the Audit Database. [Write Activity Records](/docs/auditor/10.7/api-reference/activity-records/writing-records.md)                                            |
...
[Role-Based Access and Delegation](/docs/auditor/10.7/monitoring-plans/delegation-and-permissions.md)
