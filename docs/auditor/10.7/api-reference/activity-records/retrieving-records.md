...
| POST   | `https://{host:port}/netwrix/api/v1/activity_records/enum{?format=json}{&count=Number}` | [Continuation Mark](/docs/auditor/10.7/api-reference/activity-records/searching-records.md) |
...
mark to the same endpoint. See the [Continuation Mark](/docs/auditor/10.7/api-reference/activity-records/searching-records.md) topic for more
