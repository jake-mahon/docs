...
scripts and add-ons. [Compatibility Notice](/docs/auditor/10.7/api-reference/index.md)
...
- [Search Parameters](/docs/auditor/10.7/api-reference/activity-records/searching-records.md)
