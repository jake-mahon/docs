...
description: Auditor 10.7 documentation for sharepoint online with configuration details, usage instructions, and implementation guidance.
---
...
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Collect activity and state-in-time data | Any of the following role combinations: - Application Administrator & Privileged Role Administrator OR - Cloud Application Administrator & Privileged Role Administrator OR - _Global Admin_ (_Company Administrator_ in Microsoft Entra ID PowerShell terms)        | Prepare a **Cloud-only** user account and specify it in the monitored item properties. See the [SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md) topic for additional information. |
...
- For the clear installation of Netwrix Auditor, add roles as described in the
  [Using Modern Authentication with SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md) topic.
...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - Configure required protocols and ports, as described in the
    [SharePoint Online Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md) topic.
...
[Sensitive Data Discovery ](/docs/auditor/10.7/administration/system-settings/sensitive-data-discovery.md)topic for additional
...
- If Modern Authentication is used:
  - Microsoft Entra ID application should be created manually by user with administrative role and
    ...
    [Configuring Microsoft Entra ID App for Auditing SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md#configuring-microsoft-entra-id-app-for-auditing-sharepoint-online)
...
See the [Using Modern Authentication with SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md) topic for additional
information.
...
See the [Using Basic Authentication with SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md) topic for additional
information.
