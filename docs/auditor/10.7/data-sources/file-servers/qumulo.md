...
![Qumulo screen](/img/product_docs/auditor/auditor/addon/qumulo/qumulo_thumb_0_0.webp)
...
6. Using the Integration API, the add-on sends the activity records to Auditor Server that writes
   ...
   [Integration API](/docs/auditor/10.7/api-reference/index.md) topic.
...
3. Under the Configuration, provide the following:
   ...
   ![qumulo_web_ui](/img/product_docs/auditor/auditor/configuration/fileservers/qumulo/qumulo_web_ui.webp)
...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - The Remote Syslog Address and port number must be configured as described in the
    [Configure Core Audit for Qumulo File Servers](/docs/auditor/10.7/data-sources/file-servers/qumulo.md) topic.
