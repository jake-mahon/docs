...
description: Auditor 10.7 documentation for synology with configuration details, usage instructions, and implementation guidance.
---
...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - The log sending must be configured as described in the
    [Configure Synology File Servers for Audit](/docs/auditor/10.7/data-sources/file-servers/synology.md) topic.
