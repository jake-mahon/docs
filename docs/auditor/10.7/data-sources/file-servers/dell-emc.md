...
copying. See the [Dell Data Storage](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) topic for additional information.
...
[Configure Security Event Log Maximum Size](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) topic for additional information.
...
- Besides, monitoring and reporting of the Dell Data Storage systems may not provide the results you
  expect — due to native Dell audit peculiarities. See the [File Servers](/docs/auditor/10.7/data-sources/file-servers/index.md) topic for
  additional information.
...
**Step 1 –** [Configure Security Event Log Maximum Size](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) to avoid overwriting
...
**Step 3 –** [Configure Audit Object Access Policy](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md). Set the Audit object access
...
**Step 4 –** [Configure Audit Settings for CIFS File Shares on Dell Data Storage](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md)
...
- [Normal and Enterprise Modes for Clusters](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md)
- [Compliance Mode](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md)
...
- Automatic configuration: you can use a special shell script for configuring an audited Dell
  ...
  - [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode via Shell Script](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md#configure-dell-isilonpowerscale-cluster-in-normal-or-enterprise-mode-via-shell-script)
  - [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Via Shell Script](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md#configure-dell-isilonpowerscale-cluster-in-compliance-mode-via-shell-script)
- Manual configuration: you can grant all the necessary permissions to data collecting account
  ...
  - [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode Manually](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md#configure-dell-isilonpowerscale-cluster-in-normal-or-enterprise-mode-manually)
  - [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Manually](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md#configure-dell-isilonpowerscale-cluster-in-compliance-mode-manually)
...
See the [Normal and Enterprise Modes for Clusters](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) topic for additional information.
