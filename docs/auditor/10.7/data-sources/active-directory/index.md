...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - Configure the domain for auditing. See the
    [Audit Configuration Assistant](/docs/auditor/10.7/tools-and-utilities/audit-configuration-assistant.md) topic for
  ...
  - On the Auditor console computer:
    ...
    - If you have enabled automatic log backup for the Security log of your domain controller,
      ...
      **CleanAutoBackupLogs** registry key, as described in the
      [Active Directory Registry Key Configuration](/docs/auditor/10.7/data-sources/active-directory/advanced-settings.md) topic.

      **_RECOMMENDED:_** Adjust retention period for the backup files accordingly (default is
      **50** hours). See the [Adjust Security Event Log Size and Retention](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md)
      topic.
...
- To configure these settings automatically using Netwrix Auditor, refer to the
  [Active Directory: Automatic Configuration](/docs/auditor/10.7/data-sources/active-directory/automatic-configuration.md) topic.
- To configure them manually, refer to the [Configure Basic Domain Audit Policies](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md)
  or [Configure Advanced Audit Policies](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topics.
...
- You can configure these settings automatically using Netwrix Auditor, as described in the
  [Active Directory: Automatic Configuration](/docs/auditor/10.7/data-sources/active-directory/automatic-configuration.md) topic.
- To configure them manually, refer o the [Configure Object-Level Auditing](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topic.
...
- You can configure these settings automatically using Netwrix Auditor, as described in the
  [Active Directory: Automatic Configuration](/docs/auditor/10.7/data-sources/active-directory/automatic-configuration.md) topic.
- To configure them manually, refer to the [Configure Object-Level Auditing](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topic.
...
- To configure them manually, refer to the
  [Adjust Security Event Log Size and Retention](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topic.
...
- Configure the Exchange Administrator Audit Logging (AAL) settings, as described the
  [Exchange Administrator Audit Logging Settings](/docs/auditor/10.7/data-sources/infrastructure/exchange-server.md) topic.
...
- Configure Data Collecting Account, as described in the
  [Additional Configuration to Review Changes Made via Exchange Server](/docs/auditor/10.7/data-sources/active-directory/advanced-settings.md) topic.
- Configure required protocols and ports, as described in the [Active Directory Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
  topic.
- If you plan to restore deleted Active Directory objects and their attributes using the Netwrix
  ...
  the [Adjust Active Directory Tombstone Lifetime (optional)](/docs/auditor/10.7/data-sources/active-directory/advanced-settings.md) topic for additional
  information.
