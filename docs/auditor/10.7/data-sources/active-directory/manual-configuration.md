...
Policy). See the [Configure Basic Domain Audit Policies](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) or
[Configure Advanced Audit Policies](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topics for additional information.

**Step 2 –** Configure object-level auditing. See the
[Configure Object-Level Auditing](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md) topic for additional information.

**Step 3 –** Adjust the security event log size and retention settings. See the
[Adjust Security Event Log Size and Retention](/docs/auditor/10.7/data-sources/active-directory/audit-policies.md)topic for additional information.
...
[Adjust Active Directory Tombstone Lifetime (optional)](/docs/auditor/10.7/data-sources/active-directory/advanced-settings.md) topic for additional
information.
...
[Active Directory Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md) topic.
