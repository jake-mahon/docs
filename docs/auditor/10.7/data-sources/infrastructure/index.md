...
- Configure Data Collecting Account as described in the
  [Permissions for AD FS Auditing](/docs/auditor/10.7/data-sources/infrastructure/index.md) topic.
- Configure ports as described in the [AD FS Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md) topic.
