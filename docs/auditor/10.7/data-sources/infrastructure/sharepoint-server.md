...
[Install for SharePoint Core Service](/docs/auditor/10.7/installation-and-setup/installation/sharepoint-core-service.md) topic for additional
information.
...
[Use Group Managed Service Account (gMSA)](/docs/auditor/10.7/installation-and-setup/system-requirements/service-accounts.md)[Microsoft documentation](https://docs.microsoft.com/en-us/windows-server/security/group-managed-service-accounts/group-managed-service-accounts-overview).
...
1. On the SharePoint server where the Netwrix Auditor Core Service will be deployed: the account
   ...
   [Installation](/docs/auditor/10.7/installation-and-setup/installation/index.md) topic.
