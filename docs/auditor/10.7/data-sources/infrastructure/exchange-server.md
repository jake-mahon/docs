...
description: Auditor 10.7 documentation for exchange server with configuration details, usage instructions, and implementation guidance.
---
...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - In the Exchange environment:
    ...
    - The Administrator Audit Logging settings must be configured (only required for Exchange
      ...
      [Exchange Administrator Audit Logging Settings](/docs/auditor/10.7/data-sources/infrastructure/exchange-server.md) topic for additional
      information.
    ...
    - If you want to track non-owner access, configure mailbox monitoring. See the
      [Configure Exchange for Monitoring Mailbox Access](/docs/auditor/10.7/data-sources/infrastructure/exchange-server.md) topic for additional
      information.
...
2. Configure required protocols and ports, as described in the [Exchange Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md) topic.
