...
See the [Use Group Managed Service Account (gMSA)](/docs/auditor/10.7/installation-and-setup/system-requirements/service-accounts.md) topic and the
...
[Use Group Managed Service Account (gMSA)](/docs/auditor/10.7/installation-and-setup/system-requirements/service-accounts.md) topic and the following
Microsoft article:
[Group Managed Service Accounts Overview](https://docs.microsoft.com/en-us/windows-server/security/group-managed-service-accounts/group-managed-service-accounts-overview)
for additional information about gMSA.
...
- The combination of the following rights and permissions if you plan to disable network traffic
  ...
  **Domain Admins** group:
  ...
  - **Manage auditing and security log** policy must be defined for this account.  
    See the [Permissions for Active Directory Auditing](/docs/auditor/10.7/data-sources/active-directory/permissions-and-access.md) topic
