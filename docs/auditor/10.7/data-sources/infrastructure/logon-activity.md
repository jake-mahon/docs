...
description: Auditor 10.7 documentation for logon activity with configuration details, usage instructions, and implementation guidance.
---
...
the [Configure Advanced Audit Policies](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md) topic for additional information.
...
- Automatically through a monitoring plan – This is a recommended method. If you select to
  ...
  - For both new and existing monitoring plans, you can click **Launch Audit Configuration
    ...
    See the [Audit Configuration Assistant](/docs/auditor/10.7/tools-and-utilities/audit-configuration-assistant.md) topic for
...
- [Configure Basic Domain Audit Policies](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md)
- [Configure Advanced Audit Policies](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md)
- [Configure Security Event Log Size and Retention Settings](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md)
...
- Back up files and directories. See the
   [Configure the Back up Files and Directories Policy](/docs/auditor/10.7/data-sources/file-servers/windows-file-servers.md)
...
- Manage auditing and security log. See the
  [Configure the Manage Auditing and Security Log Policy](/docs/auditor/10.7/data-sources/active-directory/permissions-and-access.md#configure-the-manage-auditing-and-security-log-policy)
  topic for additional information.
...
See the
[Assign Permission To Read the Registry Key](/docs/auditor/10.7/data-sources/infrastructure/windows-servers.md#assign-permission-to-read-the-registry-key)
