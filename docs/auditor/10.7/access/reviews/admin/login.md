...
![Access Information Center Login page](/img/product_docs/auditor/10.7/access/reviews/admin/login.webp)
...
[Enable Console Users](/docs/auditor/10.7/accessreviews.md#enable-console-users) topic for additional
information.
...
![Resource Owners interface as the landing page for an Administrator user](/img/product_docs/auditor/10.7/access/reviews/admin/landingadmin.webp)
...
![Resource Owners interface as the landing page for a Security Team user](/img/product_docs/auditor/10.7/access/reviews/admin/landingsecurityteam.webp)
...
![My Reviews interface as the landing page for an Owner without a user role](/img/product_docs/auditor/10.7/access/reviews/admin/landingowner.webp)
