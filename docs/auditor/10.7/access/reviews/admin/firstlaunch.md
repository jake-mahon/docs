...
[Console Access Page](configuration/consoleaccess.md) and
[Notifications Page](configuration/notifications.md) topics for additional information.

The interfaces available to console users are controlled by the role assigned. Owners do not need to
be assigned console access. See the [URL & Login](login.md) topic for information on how users will
