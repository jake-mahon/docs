...
![Resource Reviews page showing a Membership Review on 1 Make changes tab](/img/product_docs/auditor/10.7/access/reviews/entitlementreviews/review/reviewpagemembership.webp)
...
- Trustee Name — Name of the trustee with group membership. If the trustee is a group, click the
  ...
  [Group Membership Window](/docs/auditor/10.7/access/general/groupmembership.md) topic for additional information.
