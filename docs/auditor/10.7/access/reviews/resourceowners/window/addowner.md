...
The Add Owner window opens from either the [Add New Resource Wizard](../wizard/add.md) of the
[Update Resource Wizard](../wizard/update.md). This window is used to search for a user account by
