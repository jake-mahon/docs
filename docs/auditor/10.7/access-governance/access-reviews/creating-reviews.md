...
See the [Manage Reviews Page](/docs/auditor/10.7/access-governance/access-reviews/managing-reviews.md#manage-reviews-page) topic for additional information.
...
- Select the desired resource(s) and click **Add**. The **View Selections** button indicates how
  ...
  [Selected Resources Window](/docs/auditor/10.7/access-governance/access-reviews/managing-reviews.md) topic for additional information.
