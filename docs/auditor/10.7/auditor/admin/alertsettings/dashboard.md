...
- Risk score by top 5 users – Shows potentially harmful users for the selected time period (7 days
  ...
  [Behavior Anomalies](/docs/auditor/10.7/auditor/admin/behavioranomalies/overview.md) topic for additional information.
...
[Review User Profiles and Process Anomalies](/docs/auditor/10.7/auditor/admin/behavioranomalies/userprofile.md) topic for
...
- Edit alerts settings – Click to modify settings of the selected alert. See the
  [Create Alerts](/docs/auditor/10.7/auditor/admin/alertsettings/create.md) topic for additional information.
...
the general alerts settings page clicking the Alert settings. See the [Manage Alerts](/docs/auditor/10.7/auditor/admin/alertsettings/manage.md)
