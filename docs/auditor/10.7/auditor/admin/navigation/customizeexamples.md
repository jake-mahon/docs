...
[Use Filters in Simple Mode](/docs/auditor/10.7/auditor/admin/search/filtersimple.md) topic for additional information.
...
[IT Risk Assessment Overview ](/docs/auditor/10.7/auditor/admin/riskassessment/overview.md) topic for additional information.
