...
- [Account Permissions in SQL Server](sqlaccountpermissions.md)
- [Object Permissions in SQL Server](sqlobjectpermissions.md)
- [SQL Server Databases](sqldatabases.md)
- [SQL Server Means Granted](sqlmeansgranted.md)
- [SQL Server-Level Roles](sqlroles.md)
...
the [Settings for Data Collection](../../../monitoringplans/create.md#settings-for-data-collection)
