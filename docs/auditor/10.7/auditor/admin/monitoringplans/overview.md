...
- [Supported Data Sources](/docs/auditor/10.7/auditor/requirements/supporteddatasources.md) – Configure data source as
...
example, see [VMware](/docs/auditor/10.7/auditor/admin/monitoringplans/vmware/overview.md)).
...
See the [Role-Based Access and Delegation](/docs/auditor/10.7/auditor/admin/monitoringplans/delegation.md) topic for additional information.
