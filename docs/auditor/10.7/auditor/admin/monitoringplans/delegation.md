...
| Revoke a role assignment | - Click ![delete](/img/product_docs/platgfornetsuite/integrations/delete.webp) next to the user. |
...
[SQL Server Reporting Services](/docs/auditor/10.7/auditor/requirements/sqlserverreportingservice.md) topic for
