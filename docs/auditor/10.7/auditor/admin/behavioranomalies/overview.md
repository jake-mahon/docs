...
1. You create alerts on threat patterns specific to your company. You include these alerts in
   ...
   [Risk Score](/docs/auditor/10.7/auditor/admin/alertsettings/create.md)how to set a risk score for an alert.
...
3. Every now and then, you review the Behavior Anomalies dashboard—the risk score timeline with
   ...
   [Review Behavior Anomalies Dashboard](/docs/auditor/10.7/auditor/admin/behavioranomalies/dashboard.md)
4. To learn more about user activity, you can drill-down to a user profile to review all alerts
   ...
   reduces. [Review User Profiles and Process Anomalies](/docs/auditor/10.7/auditor/admin/behavioranomalies/userprofile.md)
