...
[/netwrix/api/v1/activity_records/search](searchactivityrecords.md) and
[/netwrix/api/v1/activity_records/enum](retrieveactivityrecords.md) endpoints.
...
[Activity Records](postdata/activityrecords.md) For example:
