...
- Besides, monitoring and reporting of the Dell Data Storage systems may not provide the results you
  expect — due to native Dell audit peculiarities. See the [File Servers](../overview.md) topic for
...
**Step 1 –** [Configure Security Event Log Maximum Size](securityeventlog.md) to avoid overwriting
...
**Step 3 –** [Configure Audit Object Access Policy](objectaccess.md). Set the Audit object access
...
**Step 4 –** [Configure Audit Settings for CIFS File Shares on Dell Data Storage](cifss.md)
