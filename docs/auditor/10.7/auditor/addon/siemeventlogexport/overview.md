...
API, refer to the [Integration API](/docs/auditor/10.7/auditor/api/overview.md) topic.
...
[Integration API](/docs/auditor/10.7/auditor/api/overview.md) topic for additional information about schema updates.
