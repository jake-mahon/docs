...
[Monitoring Scope](/docs/auditor/10.7/auditor/addon/nutanixahv/monitoredevents.md) topic for additional information on the default list of
...
See the [Integration API](/docs/auditor/10.7/auditor/api/overview.md) topic for additional information on the Activity
...
[Deploy the Add-On](/docs/auditor/10.7/auditor/addon/nutanixahv/install.md)). User name and password for connection to Nutanix Prism server will
