...
[Monitoring Scope](monitoredevents.md) topic for additional information on the default list of
...
See the [Integration API](../../api/overview.md) topic for additional information on the Activity
...
[Deploy the Add-On](install.md)). User name and password for connection to Nutanix Prism server will
