...
See the [Using Basic Authentication with Microsoft Entra ID](/docs/auditor/10.7/configuration/microsoft365/microsoftentraid/basicauth.md) topic for additional
information.
...
- If Modern Authentication is used:
    - Microsoft Entra ID application should be created manually by user with administrative role and
      ...
      [Configuring Microsoft Entra ID App for Auditing Microsoft Entra ID](modernauth.md#configuring-microsoft-entra-id-app-for-auditing-microsoft-entra-id)
...
See the [Using Modern Authentication with Microsoft Entra ID](/docs/auditor/10.7/configuration/microsoft365/microsoftentraid/modernauth.md) topic for additional
information.
