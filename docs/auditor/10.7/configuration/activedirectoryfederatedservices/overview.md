...
![mp_adfs_listing_thumb_0_0](/img/product_docs/auditor/10.7/configuration/activedirectoryfederatedservices/mp_adfs_listing_thumb_0_0.webp)

**Step 2 –** In the **Configure audit settings** section, select **Adjust audit settings
automatically** check box.

![mp_data_source_ad_fs_thumb_0_0](/img/product_docs/auditor/10.7/configuration/activedirectoryfederatedservices/mp_data_source_ad_fs_thumb_0_0.webp)
