...
2. Download and install Netwrix Auditor on that machine. Deploy the required number of Netwrix
   ...
   [Automate Sign-in to the Client](/docs/auditor/10.7/installation-and-setup/installation/standard-installation.md) of Online Help.
...
2. Download and install Netwrix Auditor on that machine. Deploy the required number of Netwrix
   ...
   Client-server connection requires user sign-in. You can automate this process, as described in
   the [Automate Sign-in to the Client](/docs/auditor/10.7/installation-and-setup/installation/standard-installation.md) section of Online Help.
...
2. Download and install Netwrix Auditor on that machine. Deploy the required number of Netwrix
   ...
   Client-server connection requires user sign-in. You can automate this process, as described in
   the [Automate Sign-in to the Client](/docs/auditor/10.7/installation-and-setup/installation/standard-installation.md) section.
