...
[Data Discovery and Classification Reports](/docs/auditor/10.7/reporting/data-discovery/classification-reports.md).
...
- Use filtering capabilities to narrow your search results. See the
  [Use Filters in Advanced Mode](/docs/auditor/10.7/administration/navigation-and-ui/favorites-and-search.md) topic for additional information.
...
[Alerts](/docs/auditor/10.7/administration/alerts-and-notifications/index.md) topic for additional information.
