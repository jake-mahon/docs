...
[IT Risk Assessment Dashboard](/docs/auditor/10.7/administration/risk-assessment/risk-dashboard.md).

For details about metrics calculation, see [How Risk Levels Are Estimated ](/docs/auditor/10.7/administration/risk-assessment/risk-levels.md).
...
[Create a New Monitoring Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md) section. For the exising plan, refer to
the procedure below.
...
5. Select the data source you need (for example, Active Directory) and click Edit data source from
   ...
   ![edit_mp_open_ds_settings_thumb_0_0](/img/product_docs/auditor/auditor/admin/riskassessment/edit_mp_open_ds_settings_thumb_0_0.webp)
6. Make sure that:
