...
[Use Filters in Simple Mode](/docs/auditor/10.7/administration/navigation-and-ui/favorites-and-search.md) topic for additional information.
...
[IT Risk Assessment Overview ](/docs/auditor/10.7/administration/risk-assessment/index.md) topic for additional information.
...
[Create a New Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md) topic for additional information about plans
...
Auditor and see the [Create a New Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md) topic for additional
...
[State–in–Time Reports](/docs/auditor/10.7/reporting/report-types/state-in-time-reports.md) topic for additional information
...
[Manage Data Sources](/docs/auditor/10.7/monitoring-plans/index.md) topic for additional information.
...
[Health Summary Email](/docs/auditor/10.7/administration/alerts-and-notifications/email-notifications.md) topic for additional information.

Clicking the **Go to Notifications** button opens the Netwrix Auditor notifications settings page.
See the [Notifications](/docs/auditor/10.7/administration/alerts-and-notifications/email-notifications.md) topic for additional information.
...
the [Create a New Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md) topic for additional information about further
configuration.
...
[Manage Alerts](/docs/auditor/10.7/administration/alerts-and-notifications/index.md) topic for additional information.
