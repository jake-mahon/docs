...
[Connection and Ticketing Settings](/docs/auditor/10.7/integrations/ticketing-systems/connectwise.md) topic for additional
information.
...
1. In the Auditor settings, enable Integration API and specify connection port. See the
   [Integrations](/docs/auditor/10.7/administration/system-settings/index.md) topic for additional information.
2. Make sure your monitoring plans set up in Auditor are using Audit Databases to store collected
   data. See the [Audit Database](/docs/auditor/10.7/administration/system-settings/audit-database.md) topic for additional
   information.
...
[Configure ConnectWise ](/docs/auditor/10.7/integrations/ticketing-systems/connectwise.md)topic for additional information.

**Step 6 –** (optional) To adjust the add-on operation and data flow settings, edit the
ITSMSettings.xml file. See the [Operational Settings](/docs/auditor/10.7/integrations/ticketing-systems/connectwise.md) topic for additional
information.
...
![addon](/img/product_docs/auditor/auditor/addon/connectwise/addon.webp)
...
![serviceboard](/img/product_docs/auditor/auditor/addon/connectwise/serviceboard.webp)
...
![CW_workflow](/img/product_docs/auditor/auditor/addon/connectwise/diagramworkflow_thumb_0_0.webp)
