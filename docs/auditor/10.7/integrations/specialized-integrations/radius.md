...
description: Auditor 10.7 documentation for radius with configuration details, usage instructions, and implementation guidance.
---
...
![radius](/img/product_docs/auditor/auditor/addon/radius/radius.webp)
...
parameters. See the [Define Parameters](/docs/auditor/10.7/integrations/specialized-integrations/radius.md) topic for additional information.
...
[Choose Appropriate Execution Scenario](/docs/auditor/10.7/integrations/siem-integrations/logrhythm.md) topic for additional
information.
