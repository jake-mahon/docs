...
description: Auditor 10.7 documentation for hyperv with configuration details, usage instructions, and implementation guidance.
---
...
- You can also configure and receive alerts on the events you are interested in. See the
  [Administration](/docs/auditor/10.7/administration/index.md) topic for additional information.
...
![deployment_1](/img/product_docs/auditor/auditor/addon/hyperv/diagram1server.webp)

2. Add-on and SCVMM server (with Management Console) running on different machines:

![deployment_2](/img/product_docs/auditor/auditor/addon/hyperv/diagram2servers_thumb_0_0.webp)
...
![deployment_3](/img/product_docs/auditor/auditor/addon/hyperv/diagram3servers_thumb_0_0.webp)
...
the [Add-On Parameters](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md)topic for additional information.
...
[Add-On Parameters](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md) topic for additional information.
...
See the [Add-On Parameters](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md)topic for the full list of configuration parameters.
...
| DataCollectionUserName | (empty)       | Specify user account that will be used for data collection from SCVMM server. To use the account currently logged in, leave this parameter empty.s Make sure the account has administrative rights on that server (see the [Accounts and Rights](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md#accounts-and-rights) topic for additional information). |
...
For the full list of parameters, see the [Add-On Parameters](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md) topic for additional
information.
...
5. This script creates a Windows scheduled task that will run periodically (every 15 minutes) to
   ...
   See the [Monitoring Scope](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md) for additional information on the default list of
...
| DataCollectionUserName               | (empty)                                                  | Specify user account that will be used for data collection from SCVMM server. To use the account currently logged in, leave this parameter empty. Make sure the account has administrative rights on that server (see the [Accounts and Rights](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md#accounts-and-rights) topic for additional information).                                                                                                                                                                                    |
| DataCollectionPassword               |                                                          | Specify user account password.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ShortTermFolder                      | ShortTerm                                                | Specify path to the short-term archive (Netwrix Auditor working folder). You can use full or relative path.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
See the [Deployment Scenarios](/docs/auditor/10.7/integrations/specialized-integrations/hyperv.md)topic for additional information.
