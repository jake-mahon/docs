...
title: ctera
sidebar_label: ctera
description: Auditor 10.7 documentation for ctera with configuration details, usage instructions, and implementation guidance.
---
...
![ctera](/img/product_docs/auditor/auditor/addon/ctera/ctera.webp)
...
- If you are using Netwrix Auditor for Network Devices, the 514 UDP port may be already in use, and
  ...
  [Install Add-On](/docs/auditor/10.7/integrations/file-storage/ctera.md) and [Define Parameters](/docs/auditor/10.7/integrations/file-storage/ctera.md) topics for additional
