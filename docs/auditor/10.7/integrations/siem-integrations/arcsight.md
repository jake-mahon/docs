...
description: Auditor 10.7 documentation for arcsight with configuration details, usage instructions, and implementation guidance.
---
...
[Integration API](/docs/auditor/10.7/api-reference/index.md)topic for additional information.
...
scenario and security policies. See the[Choose Appropriate Execution Scenario](/docs/auditor/10.7/integrations/siem-integrations/arcsight.md) topic
for additional information.
