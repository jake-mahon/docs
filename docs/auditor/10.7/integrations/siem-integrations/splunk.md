...
See the
[Configure Integration API Settings](/docs/auditor/10.7/api-reference/getting-started.md#configure-integration-api-settings)[Audit Database](/docs/auditor/10.7/administration/system-settings/audit-database.md)topic
...
See [CIM Data Model Mapping](/docs/auditor/10.7/integrations/siem-integrations/splunk.md) for details.
...
[Activity Records](/docs/auditor/10.7/api-reference/activity-records/writing-records.md) topic for additional information.
