...
description: Auditor 10.7 documentation for azure files with configuration details, usage instructions, and implementation guidance.
---
...
Activity Records. See the [API Endpoints](/docs/auditor/10.7/api-reference/endpoints.md) topic for more information.
...
- [Deployment Procedure](/docs/auditor/10.7/integrations/cloud-platforms/azure-files.md)
- [Work with Collected Data](/docs/auditor/10.7/integrations/cloud-platforms/azure-files.md)
...
- Azure Files environment is configured for auditing. The connection of Azure file share to Windows
  ...
  account key). See the [Deployment Procedure](/docs/auditor/10.7/integrations/cloud-platforms/azure-files.md)topic for more information.
