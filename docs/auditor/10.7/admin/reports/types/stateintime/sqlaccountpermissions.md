...
![accountpermissionssqlserver_thumb_0_0](/img/product_docs/auditor/10.7/admin/reports/types/stateintime/accountpermissionssqlserver_thumb_0_0.webp)
...
- Clicking a Object permissions link opens the
  [Object Permissions in SQL Server](/docs/auditor/10.7/admin/reports/types/stateintime/sqlobjectpermissions.md) report.
- Clicking a Means granted link opens the **[SQL Server Means Granted](/docs/auditor/10.7/admin/reports/types/stateintime/sqlmeansgranted.md)** report.
