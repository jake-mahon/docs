...
![objectpermissionssqlserver_thumb_0_0](/img/product_docs/auditor/10.7/admin/reports/types/stateintime/objectpermissionssqlserver_thumb_0_0.webp)
...
- Clicking a User account link opens the
  [Account Permissions in SQL Server](/docs/auditor/10.7/admin/reports/types/stateintime/sqlaccountpermissions.md) report.
