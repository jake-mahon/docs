...
3. Go to the Audit Database section and make sure that Disable security intelligence ... checkbox is
   ...
   database:  
   ![edit_mp_store_data_to_db_thumb_0_0](/img/product_docs/auditor/10.7/admin/riskassessment/edit_mp_store_data_to_db_thumb_0_0.webp)
...
5. Select the data source you need (for example, Active Directory) and click Edit data source from
   ...
   ![edit_mp_open_ds_settings_thumb_0_0](/img/product_docs/auditor/10.7/admin/riskassessment/edit_mp_open_ds_settings_thumb_0_0.webp)
6. Make sure that:
...
![edit_data_source_sit](/img/product_docs/auditor/10.7/admin/riskassessment/edit_data_source_sit.webp)
