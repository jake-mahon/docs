...
![search_tile](/img/product_docs/auditor/10.7/admin/search/search_tile.webp)
on the left.
...
- To pre-configure your search query before you click Search, you can add filters. Then the search
  ...
  [Use Filters in Simple Mode](/docs/auditor/10.7/admin/search/filtersimple.md) for details.
    ...
    ![search_filter](/img/product_docs/auditor/10.7/admin/search/search_filter.webp)
...
![search_nofilter_1](/img/product_docs/auditor/10.7/admin/search/search_nofilter_1.webp)
