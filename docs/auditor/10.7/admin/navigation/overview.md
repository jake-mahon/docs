...
| ![hs_screen_default_report_1](/img/product_docs/auditor/10.7/admin/navigation/hs_screen_default_report_1.webp) | Opens the listed Auditor report. See the [Custom Search-Based Reports](/docs/auditor/10.7/admin/reports/custom.md) topic for additional information.                                                                                                                                                                                                                                                                                |
