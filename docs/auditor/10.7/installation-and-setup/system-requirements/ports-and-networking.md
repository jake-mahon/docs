...
[File Servers](/docs/auditor/10.7/monitoring-plans/monitoring-scope.md) (Nutanix section) for more
information.
...
- [Active Directory Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [AD FS Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Microsoft Entra ID Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Dell Data Storage Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Exchange Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Exchange Online Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Group Policy Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Integration API Ports](/docs/auditor/10.7/api-reference/getting-started.md)
- [ Logon Activity Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Nutanix Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Oracle Database Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Qumulo Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [SharePoint Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [SharePoint Online Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [SQL Server Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Synology Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Teams Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [User Activity Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [VMware Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Windows File Server Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
- [Windows Server Ports](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md)
