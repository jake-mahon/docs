...
See the [Active Directory](/docs/auditor/10.7/data-sources/active-directory/index.md) topic for additional
information.
...
See the [AD FS](/docs/auditor/10.7/data-sources/infrastructure/index.md) topic for additional
information.
...
See the [Exchange](/docs/auditor/10.7/data-sources/infrastructure/exchange-server.md) topic for additional information.
...
See the [Dell Data Storage](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) topic for
...
See the [Dell Isilon/PowerScale](/docs/auditor/10.7/data-sources/file-servers/dell-emc.md) topic for
additional information.
...
See the [NetApp Data ONTAP](/docs/auditor/10.7/data-sources/file-servers/netapp.md) topic for
additional information.
...
See the [Nutanix](/docs/auditor/10.7/data-sources/file-servers/nutanix.md) topic for additional
information.
...
See the [Qumulo](/docs/auditor/10.7/data-sources/file-servers/qumulo.md) topic for additional information.
...
See the [Synology](/docs/auditor/10.7/data-sources/file-servers/synology.md) topic for additional
information.
...
See the [Windows File Servers](/docs/auditor/10.7/data-sources/file-servers/windows-file-servers.md) topic for
additional information.
...
See the [Group Policy](/docs/auditor/10.7/data-sources/infrastructure/group-policy.md) topic for additional information.
...
See the [Logon Activity](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md) topic for additional
information.
...
See the [Exchange Online](/docs/auditor/10.7/data-sources/microsoft-365/exchange-online.md) topic for
additional information.
...
See the
[Microsoft Entra ID (formerly Azure AD)](/docs/auditor/10.7/data-sources/microsoft-365/azure-entra-id.md)
...
See the [MS Teams](/docs/auditor/10.7/data-sources/microsoft-365/microsoft-teams.md) topic for additional
information.
...
See the [SharePoint Online](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md) topic for
additional information.
...
See the [Configure Cisco ASA Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
See the [Configure Cisco IOS Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
See the [Cisco Meraki Dashboard ](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
See the [Configure Fortinet FortiGate Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md)
topic for additional information.
...
See the [Configure Pulse Secure Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
See the [Configure Juniper Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for additional
information.
...
See the [Configure PaloAlto Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
See the [Configure SonicWall Devices](/docs/auditor/10.7/data-sources/network-devices/supported-devices.md) topic for
additional information.
...
- Database 11g, limited support
  ...
  **NOTE:** See the
  [Considerations for Oracle Database 11g](/docs/auditor/10.7/data-sources/databases/oracle.md#considerations-for-oracle-database-11g)
  topic for additional information.

- Oracle Database Cloud Service (Enterprise Edition)

See the [Oracle Database](/docs/auditor/10.7/data-sources/databases/oracle.md) topic for additional information.
...
See the [SharePoint](/docs/auditor/10.7/data-sources/infrastructure/sharepoint-server.md) topic for additional information.
...
See the [SQL Server](/docs/auditor/10.7/data-sources/databases/sql-server.md) topic for additional information.
...
See the [User Activity](/docs/auditor/10.7/installation-and-setup/installation/sharepoint-core-service.md) topic for additional information.
...
See the [VMware](/docs/auditor/10.7/data-sources/infrastructure/vmware.md) topic for additional information.
...
See the [Windows Server](/docs/auditor/10.7/data-sources/infrastructure/windows-servers.md) topic for additional
information.
