...
- You can configure Netwrix Auditor to use an existing instance of SQL Server, or deploy a new
  instance, as described in the [Create a New Monitoring Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md)
  topic.
...
[Database Statistics](/docs/auditor/10.7/administration/health-monitoring/database-statistics.md) of the Health Status
...
- [SQL Server Reporting Services](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md)
...
Archive. See [File-Based Repository for Long-Term Archive](/docs/auditor/10.7/installation-and-setup/system-requirements/hardware-and-software.md) for additional
information.
...
- Consider that sufficient access rights will be required for the account that will write data to
  ...
  [Audit Database](/docs/auditor/10.7/administration/system-settings/audit-database.md) settings.
...
the table. See the [Database Statistics](/docs/auditor/10.7/administration/health-monitoring/database-statistics.md)
...
[SQL Server Reporting Services](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) topic for additional information.
