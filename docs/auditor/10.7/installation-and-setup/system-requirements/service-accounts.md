...
- As a data collecting account for the following data sources:
  ...
  See the [Data Collecting Account](/docs/auditor/10.7/monitoring-plans/data-collection-accounts.md) topic for additional
...
- As an account for accessing Long-Term archive. See the
  [File-Based Repository for Long-Term Archive](/docs/auditor/10.7/installation-and-setup/system-requirements/hardware-and-software.md) topic for additional
  information.
- As an account for accessing Audit Databases. See
  [Requirements for SQL Server to Store Audit Data](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) topic for additional information.
...
- If you are going to use a gMSA as a data collecting account in Auditor, add this account to the
  ...
  - [Permissions for Group Policy Auditing ](/docs/auditor/10.7/data-sources/infrastructure/group-policy.md)
  - [Permissions for Logon Activity Auditing ](/docs/auditor/10.7/data-sources/infrastructure/logon-activity.md)
  - [Permissions for Windows File Server Auditing](/docs/auditor/10.7/data-sources/file-servers/windows-file-servers.md)
  - [Permissions for SharePoint Auditing](/docs/auditor/10.7/data-sources/infrastructure/sharepoint-server.md)
  - [Permissions for SQL Server Auditing ](/docs/auditor/10.7/data-sources/databases/sql-server.md)
  - [Permissions for Windows Server Auditing ](/docs/auditor/10.7/data-sources/infrastructure/windows-servers.md)
...
- If you are going to use a gMSA to access Audit Database, assign the required roles:
  ...
  - [Requirements for SQL Server to Store Audit Data](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md)
...
- If you are going to use a gMSA as a data collection accoun for User Activity or User Activity
  ...
  - [Configure Video Recordings Playback Settings](/docs/auditor/10.7/installation-and-setup/installation/sharepoint-core-service.md)
...
See the
[Add Items for Monitoring](/docs/auditor/10.7/monitoring-plans/index.md#add-items-for-monitoring) topic
...
[Long-Term Archive](/docs/auditor/10.7/administration/system-settings/long-term-archive.md) topic for additional information.
...
the [Fine-Tune Your Plan and Edit Settings](/docs/auditor/10.7/monitoring-plans/fine-tuning.md) topic for
...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Account for data collection       | An account used by Netwrix Auditor to collect audit data from the target systems. **NOTE:** For the data collecting account, you should use a different account than the one Auditor is using to access the database. See [Data Collecting Account](/docs/auditor/10.7/monitoring-plans/data-collection-accounts.md) for additional information. |
| Audit Database service account    | An account used by Netwrix Auditor to write collected audit data to the Audit Database. See [Requirements for SQL Server to Store Audit Data](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) for additional information.                                                                              |
| SSRS service account              | An account used by Netwrix Auditor to upload data to the Report Server. See [SQL Server Reporting Services](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) for additional information.                                                                                                                |
| Long-Term Archive service account | An account used to write data to the Long-Term Archive and upload report subscriptions to shared folders. The LocalSystem account is selected by default. See [File-Based Repository for Long-Term Archive](/docs/auditor/10.7/installation-and-setup/system-requirements/hardware-and-software.md) for additional information.                  |
