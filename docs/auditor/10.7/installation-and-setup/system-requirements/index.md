...
- [Supported Data Sources](/docs/auditor/10.7/installation-and-setup/system-requirements/supported-data-sources.md)
- [Hardware Requirements](/docs/auditor/10.7/installation-and-setup/system-requirements/hardware-and-software.md)
- [Software Requirements](/docs/auditor/10.7/installation-and-setup/system-requirements/hardware-and-software.md)
...
- Netwrix Auditor collects audit data from the specified data source (application, server, storage
  ...
  - To provide a coherent picture of changes that occurred in the audited systems, the product can
    ...
    Integration API.
  - See the [Integration API](/docs/auditor/10.7/api-reference/index.md) topic for additional information on custom data
