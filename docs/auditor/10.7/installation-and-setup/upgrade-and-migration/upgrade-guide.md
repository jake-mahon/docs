...
- For auditing cloud-based applications (Microsoft Entra ID, Exhange Online, SharePoint Online, and
  ...
  - [Permissions for Microsoft Entra ID Auditing](/docs/auditor/10.7/data-sources/microsoft-365/azure-entra-id.md)
  - [Permissions for Exchange Online Auditing](/docs/auditor/10.7/data-sources/microsoft-365/exchange-online.md)
  - [Permissions for SharePoint Online Auditing ](/docs/auditor/10.7/data-sources/microsoft-365/sharepoint-online.md)
  - [Permissions for Teams Auditing](/docs/auditor/10.7/data-sources/microsoft-365/microsoft-teams.md)
...
- Netwrix Auditor for Oracle Database. If you use the following combination of the audit settings:
  ...
  [Supported Data Sources](/docs/auditor/10.7/installation-and-setup/system-requirements/supported-data-sources.md) and
  [Verify Your Oracle Database Audit Settings](/docs/auditor/10.7/data-sources/databases/oracle.md) topics for
...
[Installation](/docs/auditor/10.7/installation-and-setup/installation/index.md) topic for additional information.
