...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| - See a list of audit settings - See a list of rights and permissions required for data collecting account                                                       | —              | - [Supported Data Sources](/docs/auditor/10.7/installation-and-setup/system-requirements/supported-data-sources.md) - [Data Collecting Account](/docs/auditor/10.7/monitoring-plans/data-collection-accounts.md)                                                    |
| - Create a monitoring plan - Review data collection status - Configure the Long-Term Archive and the Audit Database settings - Assign roles and delegate control | Auditor Client | - [Monitoring Plans](/docs/auditor/10.7/monitoring-plans/index.md) - [Netwrix Auditor Settings](/docs/auditor/10.7/administration/system-settings/index.md) - [Role-Based Access and Delegation](/docs/auditor/10.7/monitoring-plans/delegation-and-permissions.md) |
| - Browse data with interactive search - Review diagrams - Generate reports - Configure report subscriptions - Create alerts                                      | Auditor Client | - [Reports](/docs/auditor/10.7/reporting/index.md) - [Subscriptions](/docs/auditor/10.7/reporting/report-management/report-subscriptions.md) - [Alerts](/docs/auditor/10.7/administration/alerts-and-notifications/index.md)                                        |
| See the data collected by Auditor                                                                                                                                | Auditor Client | - [Access Reviews](/docs/auditor/10.7/access-governance/access-reviews/index.md)                                                                                                                                                                                    |
...
- [Import Virtual Machine from Image to VMware](/docs/auditor/10.7/installation-and-setup/installation/virtual-appliance.md)
- [Import Virtual Machine from Image to Hyper-V ](/docs/auditor/10.7/installation-and-setup/installation/virtual-appliance.md)
...
[Requirements](/docs/auditor/10.7/installation-and-setup/system-requirements/index.md) topic for additional information.
