...
- [Install Client via Group Policy](/docs/auditor/10.7/installation-and-setup/installation/group-policy-deployment.md)
- [Install in Silent Mode](/docs/auditor/10.7/installation-and-setup/installation/silent-installation.md)

## Install Netwrix Auditor

For instructions on upgrade procedures, refer to [Upgrade to the Latest Version](/docs/auditor/10.7/installation-and-setup/upgrade-and-migration/upgrade-guide.md).
...
you use a third-party firewall, see [Protocols and Ports Required](/docs/auditor/10.7/installation-and-setup/system-requirements/ports-and-networking.md). Also,
...
[About Netwrix Auditor](/docs/auditor/10.7/administration/system-settings/general-settings.md) topic for additional information.

**Step 7 –** Click Install.

After a successful installation, Auditor shortcut will be added to the **Start** menu and screen and
the product will start. See the [First Launch](/docs/auditor/10.7/installation-and-setup/initial-configuration/first-launch.md) topic for additional information on
...
- [Install for SharePoint Core Service](/docs/auditor/10.7/installation-and-setup/installation/sharepoint-core-service.md)
- [Install for User Activity Core Service](/docs/auditor/10.7/installation-and-setup/installation/sharepoint-core-service.md)
