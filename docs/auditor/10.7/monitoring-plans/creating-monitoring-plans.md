---
title: creating monitoring plans
sidebar_label: creating-monitoring-plans
description: Auditor 10.7 documentation for creating monitoring plans with configuration details, usage instructions, and implementation guidance.
---
...
[Requirements for SQL Server to Store Audit Data](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) topic for
...
- Install a new instance of Microsoft SQL Server Express automatically — this option is available at
  ...
  [Requirements for SQL Server to Store Audit Data](/docs/auditor/10.7/installation-and-setup/system-requirements/sql-server-requirements.md) section.
...
you should provide them manually. See the [Notifications](/docs/auditor/10.7/administration/alerts-and-notifications/email-notifications.md) topic for
additional information.
...
Specify who will receive daily emails: [Activity Summary Email](/docs/auditor/10.7/administration/alerts-and-notifications/email-notifications.md) on changes
in the monitored infrastructure, and [Health Summary Email](/docs/auditor/10.7/administration/alerts-and-notifications/email-notifications.md) on
