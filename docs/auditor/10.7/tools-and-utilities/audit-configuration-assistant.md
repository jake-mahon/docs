...
- From [Create a New Monitoring Plan](/docs/auditor/10.7/monitoring-plans/creating-monitoring-plans.md) for Active Directory data
  source.
- From the [Active Directory](/docs/auditor/10.7/monitoring-plans/monitoring-scope.md) within the plan.
- From the [Logon Activity](/docs/auditor/10.7/monitoring-plans/monitoring-scope.md) source properties.
