...
- Enterprise Overview—A dashboard with a set of widgets that provide quick access to important
  ...
  [Enterprise Overview Dashboard](/docs/auditor/10.7/reporting/report-types/enterprise-reports.md) topic for additional information.
- Organization level reports—High-level reports that aggregate data from all data sources and
  ...
  provides a centralized overview. See the [ Organization Level Reports](/docs/auditor/10.7/reporting/report-types/enterprise-reports.md) topic
...
- Change and activity reports—System-specific reports that aggregate audit data for a specific data
  ...
  [Change and Activity Reports](/docs/auditor/10.7/reporting/report-types/activity-reports.md) topic for additional information.
...
- Changes with video reports—Windows server-based reports that provide video recordings of user
  activity on audited computers. See the [Reports with Video](/docs/auditor/10.7/reporting/report-management/viewing-reports.md) topic for additional
  information.
- Changes with review status reports—Both system-specific and overview reports that can be used in
  ...
  [Interactive Reports for Change Management Workflow](/docs/auditor/10.7/reporting/report-management/review-status-reports.md) topic for additional
  information.

Review the following for additional information:

- See the [View Reports](/docs/auditor/10.7/reporting/report-management/viewing-reports.md) topic for additional information on how to find the report you
  need and view reports in a web browser.
- See the [View Reports](/docs/auditor/10.7/reporting/report-management/viewing-reports.md) topic for additional information on how to apply filters to
  reports.
