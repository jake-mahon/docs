...
| Action | Filter data by action type (Added, Removed, etc.) Select an action type from the list (Added, Removed, Modified, Read). For additional actions, navigate to the Advanced mode. See the [Use Filters in Advanced Mode](/docs/auditor/10.6/features/search-and-filter/advanced-search.md) topic for additional information.                                                                                                                                                                         |
...
- Netwrix Data Classification. See
  [Sensitive Data Discovery ](/docs/auditor/10.6/administration/settings/general-settings.md)for
  more information.
...
Archive. See [Investigations](/docs/auditor/10.6/administration/settings/investigation-settings.md)
topic for additional information.
