...
must be assigned the _Global administrator_ or _Global reviewer_ role in the product.

To set up a response action, this account must also be a member of the local _Administrators_ group
on Auditor Server.

See the
[](https://helpcenter.netwrix.com/Roles/Role_Based_Access.html)[Role-Based Access and Delegation](/docs/auditor/10.6/monitoring-plans/delegation.md)
...
![configuration_tile](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/configuration_tile.webp)

See the [Navigation](/docs/auditor/10.6/administration/navigation/index.md) topic for
...
| Filters         | Apply a set of filters to narrow events that trigger a new alert. Alerts use the same interface and logic as search. - Filter—Select general type of filter (e.g., "_Who_", "_Data Source_", _"Monitoring plan_", etc.) - Operator—Configure match types for selected filter (e.g., "_Equals_", "_Does not contain_", etc.) - Value—Specify filter value. See the [View and Search Collected Data](/docs/auditor/10.6/features/search-and-filter/index.md) topic for additional information on how to create and modify filters. The Filters section contains required fields highlighted with red. Once you completed all filters, click Preview on the right pane to see search-based list of events that will trigger your alert. ![preview](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/preview.webp)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
![emailhealthstatusevent](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/emailhealthstatusevent.webp)
...
[Event Log Manager](/docs/auditor/10.6/tools/event-log-manager.md) topic for
additional information.
...
| Remove an alert                    | Select an alert from the list and click ![delete](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/search/query/delete.webp) in the right pane.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
