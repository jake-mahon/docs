...
- Risk score by top 5 users – Shows potentially harmful users for the selected time period (7 days
  ...
  [Behavior Anomalies](/docs/auditor/10.6/features/behavior-analytics/index.md)
...
![alerts_overview](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/alerts_overview.webp)
...
[Review User Profiles and Process Anomalies](/docs/auditor/10.6/features/behavior-analytics/user-profiles.md)
topic for additional information.
...
[Manage Alerts](/docs/auditor/10.6/features/alerts/alert-settings.md) topic for
additional information.
