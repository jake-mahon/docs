...
- See the[Manage Alerts](/docs/auditor/10.6/features/alerts/alert-settings.md) topic
...
- See the [Create Alerts](/docs/auditor/10.6/features/alerts/alert-settings.md) topic
...
- If you need to be alerted on specific events in your Event Logs or non-owner mailbox access
  attempts, see the
  [Create Alerts for Event Log](/docs/auditor/10.6/features/alerts/alert-settings.md)
  and
  [Create Alerts for Non-Owner Mailbox Access Events](/docs/auditor/10.6/features/alerts/alert-settings.md)
  topics for additional information.

The example alert is triggered when a new user is created in the monitored domain.

![ad_alert](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/ad_alert.webp)
...
![Manage tags list](/img/versioned_docs/auditor_10.6/auditor/admin/alertsettings/managetags.webp)
...
General tab. See the
[Create Alerts](/docs/auditor/10.6/features/alerts/alert-settings.md) topic to receive
