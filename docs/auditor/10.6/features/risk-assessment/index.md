...
[IT Risk Assessment Dashboard](/docs/auditor/10.6/features/risk-assessment/risk-dashboard.md).

For details about metrics calculation, see
[How Risk Levels Are Estimated ](/docs/auditor/10.6/features/risk-assessment/risk-levels.md).
