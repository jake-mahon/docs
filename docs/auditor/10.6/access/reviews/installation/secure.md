...
![AccessInformationCenter.Service.exe.Config file showing the BindingUrl key](/img/product_docs/auditor/10.6/access/reviews/installation/securebindingurlparameter.webp)
