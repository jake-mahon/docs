...
See the
[Permissions for Microsoft Entra ID Auditing](/docs/auditor/10.6/configuration/microsoft365/microsoftentraid/permissions.md#for-microsoft-entra-id-auditing)
