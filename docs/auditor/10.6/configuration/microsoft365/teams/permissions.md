...
- [Using Basic Authentication with MS Teams](/docs/auditor/10.6/configuration/microsoft365/teams/basicauth.md)
- [Using Modern Authentication with MS Teams](/docs/auditor/10.6/configuration/microsoft365/teams/modernauth.md)
