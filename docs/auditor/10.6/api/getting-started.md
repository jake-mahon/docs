...
Refer to the [Security](/docs/auditor/10.6/api/authentication.md) topic for detailed
...
Refer to the [Audit Database](/docs/auditor/10.6/administration/settings/database-settings.md)
