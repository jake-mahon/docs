...
Refer to the [Security](/docs/auditor/10.6/auditor/api/security.md) topic for detailed
...
Refer to the [Audit Database](/docs/auditor/10.6/auditor/admin/settings/auditdatabase.md)
