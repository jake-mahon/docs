...
- To report on _copy_ actions on remote file shares, make sure that audit of successful read
  ...
  [Configure Object-Level Access Auditing](/docs/auditor/10.6/auditor/configuration/fileservers/windows/objectlevel.md)
...
- **Manually.** To configure your Windows File Servers for monitoring manually, perform the
  following procedures:
    ...
    - [Configure Object-Level Access Auditing](/docs/auditor/10.6/auditor/configuration/fileservers/windows/objectlevel.md)
    - [Configure Local Audit Policies](/docs/auditor/10.6/auditor/configuration/fileservers/windows/localpolicy.md)
      or
      [Configure Advanced Audit Policies](/docs/auditor/10.6/auditor/configuration/fileservers/windows/advancedpolicy.md)
    - [Configure Event Log Size and Retention Settings](/docs/auditor/10.6/auditor/configuration/fileservers/windows/eventlog.md)
    - [Enable Remote Registry Service](/docs/auditor/10.6/auditor/configuration/fileservers/windows/remoteregistryservice.md)
