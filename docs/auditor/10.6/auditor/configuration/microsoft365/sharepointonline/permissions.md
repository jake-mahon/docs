...
- If Modern Authentication is used:
    - Microsoft Entra ID application should be created manually by user with administrative role and
      ...
      [Configuring Microsoft Entra ID App for Auditing SharePoint Online](/docs/auditor/10.6/auditor/configuration/microsoft365/sharepointonline/modernauth.md#configuring-microsoft-entra-id-app-for-auditing-sharepoint-online)
...
See the
[Using Basic Authentication with SharePoint Online](/docs/auditor/10.6/auditor/configuration/microsoft365/sharepointonline/basicauth.md)
topic for additional information.
