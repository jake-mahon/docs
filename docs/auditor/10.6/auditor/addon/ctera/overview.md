...
- If you are using Netwrix Auditor for Network Devices, the 514 UDP port may be already in use, and
  ...
  [Install Add-On](/versioned_docs/auditor_10.6/auditor/addon/ctera/install.md) and
  [Define Parameters](/versioned_docs/auditor_10.6/auditor/addon/ctera/parameters.md) topics for
