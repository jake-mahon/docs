...
API, refer to the [Integration API](/versioned_docs/auditor_10.6/auditor/api/overview.md) topic.
...
[Integration API](/versioned_docs/auditor_10.6/auditor/api/overview.md) topic for additional
