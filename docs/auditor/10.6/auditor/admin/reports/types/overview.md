...
- Enterprise Overview—A dashboard with a set of widgets that provide quick access to important
  ...
  [Enterprise Overview Dashboard](/versioned_docs/auditor_10.6/auditor/admin/reports/types/enterprise.md)
...
- Organization level reports—High-level reports that aggregate data from all data sources and
  ...
  [ Organization Level Reports](/versioned_docs/auditor_10.6/auditor/admin/reports/types/organizationlevel.md)
  topic for additional information.
...
- Change and activity reports—System-specific reports that aggregate audit data for a specific data
  ...
  [Change and Activity Reports](/versioned_docs/auditor_10.6/auditor/admin/reports/types/activity.md)
  topic for additional information.
- State-in-time reports—System-specific reports that aggregate data for a specific data source
  ...
  [State–In–Time Reports](/versioned_docs/auditor_10.6/auditor/admin/reports/types/stateintime/overview.md)
  topic for additional information.
- Changes with video reports—Windows server-based reports that provide video recordings of user
  ...
  [Reports with Video](/versioned_docs/auditor_10.6/auditor/admin/reports/video.md) topic for
...
- Changes with review status reports—Both system-specific and overview reports that can be used in
  ...
  [Interactive Reports for Change Management Workflow](/versioned_docs/auditor_10.6/auditor/admin/reports/reviewstatus.md)
  topic for additional information.
