...
- [VMware](/docs/auditor/10.6/auditor/configuration/vmware/overview.md) – Configure data
...
- Configures alerts related to VMware data source. Current version does not include predefined
  ...
  [Create Alerts](/docs/auditor/10.6/auditor/admin/alertsettings/create.md) to create and
