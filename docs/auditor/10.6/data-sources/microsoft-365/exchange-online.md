...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - Depending on authentication type (basic or modern) and deployment scenario, you will need to
    ...
    - Prepare a Data Collecting Account as described in the
      [Permissions for Exchange Online Auditing](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md)
      topic
...
[Create and Register a New App in Microsoft Entra ID](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md#create-and-register-a-new-app-in-microsoft-entra-id)
topic for additional information.
...
[Grant Required Permissions](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md#grant-required-permissions)
topic for additional information.

**Step 3 –** Grant required roles to that application. See the
[Grant Required Roles](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md#grant-required-roles)
topic for additional information.

**Step 4 –** Configure client secret for that application. See the
[Configure Client Secret](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md#configure-client-secret)
topic for additional information.

**Step 5 –** Obtain tenant ID – you will need it when configuring a monitored item (Office 365
tenant) settings. See the
[Obtain the Tenant Name](/docs/auditor/10.6/data-sources/microsoft-365/exchange-online.md#obtain-the-tenant-name)
topic for additional information.
