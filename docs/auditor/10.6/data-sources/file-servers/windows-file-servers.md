...
description: Auditor 10.6 documentation for windows file servers with configuration details, usage instructions, and implementation guidance.
---
...
[Configure Local Audit Policies](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md).
...
policies. See the
[Configure Advanced Audit Policies](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
...
- To report on _copy_ actions on remote file shares, make sure that audit of successful read
  ...
  [Configure Object-Level Access Auditing](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
...
- **Manually.** To configure your Windows File Servers for monitoring manually, perform the
  ...
  - [Configure Local Audit Policies](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
    or
    [Configure Advanced Audit Policies](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
  - [Configure Event Log Size and Retention Settings](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
  - [Enable Remote Registry Service](/docs/auditor/10.6/data-sources/file-servers/windows-file-servers.md)
