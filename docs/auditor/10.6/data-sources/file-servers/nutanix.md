...
description: Auditor 10.6 documentation for nutanix with configuration details, usage instructions, and implementation guidance.
---
...
2. In the **username** and **password** fields, enter the credentials of the
   [Create User Account to Access Nutanix REST API](/docs/auditor/10.6/data-sources/file-servers/nutanix.md)
   you have created.
3. Click **Explore**.
...
[Configure Partner Server](/docs/auditor/10.6/data-sources/file-servers/nutanix.md)
...
- Manually, as described in the corresponding topics:
  - [Configure Partner Server](/docs/auditor/10.6/data-sources/file-servers/nutanix.md)
  - [Create a Notification Policy](/docs/auditor/10.6/data-sources/file-servers/nutanix.md)
...
![api_partner_server_resquest](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/nutanix/api_partner_server_resquest.webp)ix/api_partner_server_resquest.webp)
...
![nutanix_item_restapi](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/nutanix/nutanix_item_restapi.webp)m_restapi.webp)
