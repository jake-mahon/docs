...
description: Auditor 10.6 documentation for sharepoint server with configuration details, usage instructions, and implementation guidance.
---
...
[Use Group Managed Service Account (gMSA)](/docs/auditor/10.6/administration/user-management/service-accounts.md)[Microsoft documentation](https://docs.microsoft.com/en-us/windows-server/security/group-managed-service-accounts/group-managed-service-accounts-overview).
...
1. On the SharePoint server where the Netwrix Auditor Core Service will be deployed: the account
   ...
   [Installation](/docs/auditor/10.6/installation/index.md) topic.
