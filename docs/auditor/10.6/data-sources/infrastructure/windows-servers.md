...
![manualconfig_fileserver_graudit_secpol2016](/img/versioned_docs/auditor_10.6/auditor/configuration/fileservers/windows/manualconfig_fileserver_graudit_secpol2016.webp)
...
3. Right-click the Operational log and select Properties.
   ...
   ![manual_config_dhcp_log](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/manual_config_dhcp_log.webp)
...
3. Right-click the Operational log and select Properties.
   ...
   ![manualconfig_iis2016](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/manualconfig_iis2016.webp)
...
[Configure Advanced Audit Policies](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
...
- Manually – Native audit settings must be adjusted manually to ensure collecting comprehensive and
  ...
  - The Remote Registry and the Windows Management Instrumentation (WMI) service must be started.
    See the
    [Enable Remote Registry and Windows Management Instrumentation Services](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
    topic and the
    [Configure Windows Registry Audit Settings](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
  ...
  - The following advanced audit policy settings must be configured:
    ...
    - See the
      [Configure Local Audit Policies](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
      topic and the
      [Configure Advanced Audit Policies](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
      topic for additional information.
  ...
  - The Enable Persistent Time Stamp local group policy must be enabled. This policy should be
    ...
    [Configure Enable Persistent Time Stamp Policy](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
    topic for additional information.
  - The Application, Security, and System event log maximum size must be set to 4 GB. The
    ...
    [Adjusting Event Log Size and Retention Settings](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
    topic for additional information.
  ...
  - For auditing DHCP, the Microsoft-Windows-Dhcp-Server/Operational event log must be enabled and
    ...
    [Adjust DHCP Server Operational Log Settings](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
    topic for additional information.
  ...
  - For auditing removable storage media, two Event Trace Session objects must be created. See the
    [Configure Removable Storage Media for Monitoring](/docs/auditor/10.6/data-sources/infrastructure/windows-servers.md)
    topic for additional information.
...
[Windows Server Registry Keys](#windows-server-registry-keys) section for additional information. If
you want Netwrix Auditor to audit custom registry keys, see the
[Monitoring Custom Registry Keys](#monitoring-custom-registry-keys)[Monitoring Custom Registry Keys](#monitoring-custom-registry-keys)topic
...
![customregistrykeyentry](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/customregistrykeyentry.webp)
...
![customregistrykey](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/customregistrykey.webp)
...
![ManualConfig_WS_AuditingEntry2008](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/manualconfig_ws_auditenrty2008.webp)
...
![Config_WS_AuditingEntry_2016](/img/versioned_docs/auditor_10.6/auditor/configuration/windowsserver/manualconfig_ws_auditenrty_2016.webp)
