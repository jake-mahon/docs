...
| Port      | Provide the port configured in your monitoring plan for Network Devices (514 by default). See the[Network Devices](/docs/auditor/10.6/monitoring-plans/data-sources-config.md) topic for additional information. |
...
3. Navigate to Configuration → System → Logging and click + to add a new Syslog Server.
   ...
   ![nand_aruba_logging](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/nand_aruba_logging.webp)
...
9. If the configuration is correct, you will see the following wizard:
   ...
   ![nand_aruba_status](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/nand_aruba_status.webp)
...
- [Configure Cisco Meraki Devices](/docs/auditor/10.6/data-sources/infrastructure/network-devices.md)
...
- [Configure HPE Aruba Devices](/docs/auditor/10.6/data-sources/infrastructure/network-devices.md)
...
| - Cisco Meraki                                                                                                    | See the [Configure Cisco Meraki Dashboard Account](/docs/auditor/10.6/data-sources/infrastructure/network-devices.md#configure-cisco-meraki-dashboard-account) section for additional information.                                             |
...
5. Under the Select Events to Log, select the following (minimal requirement, select other events if
   ...
   ![manual_config_pulse_1](/img/versioned_docs/auditor_10.6/auditor/configuration/networkdevices/manual_config_pulse_1.webp)
...
17. Navigate to your monitoring plan for Network Devices. See
    [Monitoring Plans](/docs/auditor/10.6/monitoring-plans/index.md)
