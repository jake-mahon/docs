...
[Assign Permission To Read the Registry Key](/docs/auditor/10.6/data-sources/active-directory/permissions.md)
topic.
...
- Membership in the **Organization Management** or **Records Management** group.
- The **Audit Logs** management role (see the
  [Configure Exchange Permissions](/docs/auditor/10.6/data-sources/infrastructure/exchange-server.md)
  topic for additional information).
...
console. See the
[Permissions for Group Policy Auditing ](/docs/auditor/10.6/data-sources/infrastructure/group-policy.md)topic
