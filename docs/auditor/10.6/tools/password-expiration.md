...
- [Password Expiration Notifier Ports](/docs/auditor/10.6/tools/password-expiration.md)
- [Password Expiration Monitoring Scope](/docs/auditor/10.6/tools/password-expiration.md)
...
| Option                                                                     | Description                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Specify account which will be used to collect data: - User name - Password | Enter the account which will be used for data collection. For a full list of the rights and permissions of this account, and instructions on how to configure them, refer to [Monitoring Plans](/docs/auditor/10.6/monitoring-plans/index.md).                                                                                                         |
...
![passwordexpiration](/img/versioned_docs/auditor_10.6/auditor/tools/passwordexpirationnotifier/passwordexpiration.webp)
