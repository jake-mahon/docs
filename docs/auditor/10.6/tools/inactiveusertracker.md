...
| Move to a specific OU after          | - Specify account inactivity period, after which the account will be moved to a specified organizational unit. - OU name—Specify OU name or select an AD container using ![select_button](/img/product_docs/auditor/10.6/tools/select_button.webp) button.                                                                                                                                                         |
...
![inactiveusersactivedirectory](/img/product_docs/auditor/10.6/tools/inactiveusersactivedirectory.webp)
