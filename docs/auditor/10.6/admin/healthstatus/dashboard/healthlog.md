...
![healthlog](/img/product_docs/auditor/10.6/admin/healthstatus/dashboard/healthlog.webp)
...
- Configure alerts triggered by specific events in the product's health log.
  [Create Alerts on Health Status](/docs/auditor/10.6/admin/alertsettings/createhealthstatus.md)
...
![healthlogfilters](/img/product_docs/auditor/10.6/admin/healthstatus/dashboard/healthlogfilters.webp)
