...
![hiw_diagram_oracle](/img/product_docs/auditor/10.6/admin/monitoringplans/oracle/hiw_diagram_oracle.webp)
...
2. Netwrix administrator does the following:
    ...
    - Configures alerts related to Oracle data source. Current version does not include predefined
      ...
      [Create Alerts](/docs/auditor/10.6/admin/alertsettings/create.md) section to
