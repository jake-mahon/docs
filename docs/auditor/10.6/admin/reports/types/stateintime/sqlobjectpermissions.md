...
![objectpermissionssqlserver](/img/product_docs/auditor/10.6/admin/reports/types/stateintime/objectpermissionssqlserver.webp)
...
- Clicking a Means granted link opens
  the[SQL Server Means Granted](/docs/auditor/10.6/admin/reports/types/stateintime/sqlmeansgranted.md)
  report.
