...
![scenario_reports_1](/img/product_docs/auditor/10.6/admin/navigation/scenario_reports_1.webp)
...
![scenario_reports_2](/img/product_docs/auditor/10.6/admin/navigation/scenario_reports_2.webp)
...
3. Search the group of risks you want to pin to the home page (in this case, the "_Permissions_"
   risks group):
    ...
    ![scenario_risks](/img/product_docs/auditor/10.6/admin/navigation/scenario_risks.webp)
