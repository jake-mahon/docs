...
![ctera](/img/versioned_docs/auditor_10.6/auditor/addon/ctera/ctera.webp)
...
- If you are using Netwrix Auditor for Network Devices, the 514 UDP port may be already in use, and
  ...
  [Install Add-On](/docs/auditor/10.6/add-ons/ctera.md) and
  [Define Parameters](/docs/auditor/10.6/add-ons/ctera.md) topics for
...
![configwizard](/img/versioned_docs/auditor_10.6/auditor/addon/privilegeduserlinux/configwizard.webp)
