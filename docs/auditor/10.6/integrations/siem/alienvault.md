...
[Define Parameters](/docs/auditor/10.6/integrations/siem/alienvault.md) topic
for additional information.
...
| -------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Source               | **NA\_\_**`{Data Source Name}`** -OR- **Netwrix_Auditor_Integration_API\_\_ | Depending on _SetDataSourceAsEventSource_ in-script parameter.                                                                                                      |
...
See the [Define Parameters](/docs/auditor/10.6/integrations/siem/alienvault.md)
...
[Choose Appropriate Execution Scenario](/docs/auditor/10.6/integrations/siem/alienvault.md)
topic for additional information.
...
(duplicates). See the
[Run the Add-On with PowerShell](/docs/auditor/10.6/integrations/siem/alienvault.md)
