...
![EventLog_Export_Example](/img/versioned_docs/auditor_10.6/auditor/addon/solarwinds/eventlogexportexample.webp)
...
[Define Parameters](/docs/auditor/10.6/integrations/siem/generic-siem.md) topic
for additional information.
...
[Reference for Creating Activity Records](/docs/auditor/10.6/api/activity-records.md)topic.
...
See the [Define Parameters](/docs/auditor/10.6/integrations/siem/generic-siem.md)
...
[Choose Appropriate Execution Scenario](/docs/auditor/10.6/integrations/siem/generic-siem.md)
topic for additional information.
...
(duplicates). See the
[Run the Add-On with PowerShell](/docs/auditor/10.6/integrations/siem/qradar.md)
...
[Integration Event Log Fields](/docs/auditor/10.6/integrations/siem/generic-siem.md)
topic for additional information.
...
[SIEM](/docs/auditor/10.6/integrations/siem/index.md) topic for additional
information.
...
run the add-on on the computer where Auditor is installed or on a remote server. Depending on the
execution scenario you choose, you have to define a different set of parameters. See the
[Configuration](/docs/auditor/10.6/integrations/siem/generic-siem.md) topic for additional
information.
...
See the [Configuration](/docs/auditor/10.6/integrations/siem/generic-siem.md) topic for
...
run the add-on on the computer where Auditor is installed or on a remote server. Depending on the
execution scenario you choose, you have to define a different set of parameters. See the
[Define Parameters](/docs/auditor/10.6/integrations/siem/generic-siem.md)
topic for additional information.
...
API, refer to the [Integration API](/docs/auditor/10.6/api/index.md) topic.
