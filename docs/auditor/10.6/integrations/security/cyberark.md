...
![AR from CyberArk in NA](/img/versioned_docs/auditor_10.6/auditor/addon/cyberark/cyberark.webp)
...
[Add-On Parameters](/docs/auditor/10.6/integrations/security/cyberark.md) topic for
additional information.
...
- **SyslogMessageCodeFilter** - IDs of events to forward. The add-on will only collect and process
  ...
  [Monitored Events](/docs/auditor/10.6/integrations/security/cyberark.md). Use
...
![HIW_CyberArch](/img/versioned_docs/auditor_10.6/auditor/addon/cyberark/diagram.webp)
...
2. On the CyberArk server, the administrator opens the **dbparam.ini** file and specifies the
   ...
   See the
   [Monitored Events](/docs/auditor/10.6/integrations/security/cyberark.md) topic
...
- If you are using Netwrix Auditor for Network Devices, the 514 UDP port may be already in use, and
  ...
  [Deploy the Add-On](/docs/auditor/10.6/integrations/security/cyberark.md) and
  [Add-On Parameters](/docs/auditor/10.6/integrations/security/cyberark.md) topics for
