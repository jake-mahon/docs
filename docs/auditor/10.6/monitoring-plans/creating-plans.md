...
[Notifications](/docs/auditor/10.6/administration/settings/notification-settings.md) topic for
additional information.
...
[Activity Summary Email](/docs/auditor/10.6/monitoring-plans/fine-tuning.md)
on changes in the monitored infrastructure, and
[Health Summary Email](/docs/auditor/10.6/features/health-monitoring/health-dashboard.md) on
