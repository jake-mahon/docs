...
**Step 3 –** In the Plan Settings page, review the tabs and modify settings.
...
| Use default SQL Server settings                                                  | Select this checkbox to write data to a SQL Server instance with connection parameters as shown in **Settings** > **Audit Database**. See the [Audit Database](/docs/auditor/10.6/administration/settings/database-settings.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                   |
