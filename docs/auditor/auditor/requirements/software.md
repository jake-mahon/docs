...
SQL Server Reporting Services are needed for this kind of reports. See the [Requirements for SQL Server to Store Audit Data](sqlserver.md) topic for additional information. If you plan to export or print such reports, check the requirements below.
...
See the [Virtual Deployment Overview](../install/virtualappliance/overview.md) topic for additional information.
...
![na_setup_select_type_thumb_0_0](../../../../static/img/product_docs/auditor/auditor/requirements/na_setup_select_type_thumb_0_0.webp)
