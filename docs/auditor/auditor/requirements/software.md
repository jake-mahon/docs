...
SQL Server Reporting Services are needed for this kind of reports. See the [Requirements for SQL Server to Store Audit Data](/docs/auditor/auditor/requirements/sqlserver.md) topic for additional information. If you plan to export or print such reports, check the requirements below.
...
See the [Virtual Deployment Overview](/docs/auditor/auditor/install/virtualappliance/overview.md) topic for additional information.
...
[![na_setup_select_type_thumb_0_0](/img/product_docs/auditor/auditor/requirements/na_setup_select_type_thumb_0_0.png)](/docs/auditor/resources/images/auditor/deploymentplan/na_setup_select_type.png)
