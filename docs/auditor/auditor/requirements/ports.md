...
- [Active Directory Ports](/docs/auditor/auditor/configuration/activedirectory/ports.md)
- [AD FS Ports](/docs/auditor/auditor/configuration/activedirectoryfederatedservices/ports.md)
- [Microsoft Entra ID Ports](/docs/auditor/auditor/configuration/microsoft365/microsoftentraid/ports.md)
- [Dell Data Storage Ports](/docs/auditor/auditor/configuration/fileservers/delldatastorage/ports.md)
- [Exchange Ports](/docs/auditor/auditor/configuration/exchange/ports.md)
- [Exchange Online Ports](/docs/auditor/auditor/configuration/microsoft365/exchangeonline/ports.md)
- [Group Policy Ports](/docs/auditor/auditor/configuration/grouppolicy/ports.md)
- [Integration API Ports](/docs/auditor/auditor/api/ports.md)
- [ Logon Activity Ports](/docs/auditor/auditor/configuration/logonactivity/ports.md)
- [Nutanix Ports](/docs/auditor/auditor/configuration/fileservers/nutanix/ports.md)
- [Oracle Database Ports](/docs/auditor/auditor/configuration/oracle/ports.md)
- [Qumulo Ports](/docs/auditor/auditor/configuration/fileservers/qumulo/ports.md)
- [SharePoint Ports](/docs/auditor/auditor/configuration/sharepoint/ports.md)
- [SharePoint Online Ports](/docs/auditor/auditor/configuration/microsoft365/sharepointonline/ports.md)
- [SQL Server Ports](/docs/auditor/auditor/configuration/sqlserver/ports.md)
- [Synology Ports](/docs/auditor/auditor/configuration/fileservers/synology/ports.md)
- [Teams Ports](/docs/auditor/auditor/configuration/microsoft365/teams/ports.md)
- [User Activity Ports](/docs/auditor/auditor/configuration/useractivity/ports.md)
- [VMware Ports](/docs/auditor/auditor/configuration/vmware/ports.md)
- [Windows File Server Ports](/docs/auditor/auditor/configuration/fileservers/windows/ports.md)
- [Windows Server Ports](/docs/auditor/auditor/configuration/windowsserver/ports.md)
