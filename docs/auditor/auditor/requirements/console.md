...
Auditor supports only Windows OS versions listed in the [Software Requirements](/docs/product_docs/auditor/auditor/requirements/software.md) topic.
...
\* — ARs stands for Activity Records, that is, Netwrix-compatible format for the audit data. See [Activity Records](/docs/product_docs/auditor/auditor/api/postdata/activityrecords.md)[Activity Records](/docs/product_docs/auditor/auditor/api/postdata/activityrecords.md) for more details.
...
- [Working Folder](/docs/product_docs/auditor/auditor/requirements/workingfolder.md)
...
__NOTE:__ In larger environments, SQL Server may become underprovisioned on resources. For troubleshooting such cases, refer to the [Sample Deployment Scenarios](/docs/product_docs/auditor/auditor/requirements/deploymentscenarios.md) topic.
...
If you have not already started using Netwrix Auditor, you can download the Resource Estimation Tool by clicking [the download link](https://releases.netwrix.com/products/auditor/10.7/auditor-resource-estimation-tool-1.2.39.zip).
