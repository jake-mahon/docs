...
![archive_modify_settings_thumb_0_0](../../../../static/img/product_docs/auditor/auditor/requirements/archive_modify_settings_thumb_0_0.webp)
...
To estimate the amount of activity records collected and stored to the repository day by day, use the [Activity Records Statistics](../admin/healthstatus/dashboard/activityrecordstatistics.md) widget. Click View details to see how many activity records were produced by each data source, collected and saved to the Long-Term Archive and to the database.
...
- On the file shares where report subscriptions are saved:
  ...
  Subscriptions created in the Auditor client  are uploaded to file servers under the Long-Term Archive service account as well. See the [Subscriptions](../admin/subscriptions/overview.md) topic for additional information.
...
To open the Long-Term Archive settings, click the corresponding link. Then you will be able to adjust the settings as necessary. See the [Long-Term Archive](../admin/settings/longtermarchive.md) topic for additional information.
