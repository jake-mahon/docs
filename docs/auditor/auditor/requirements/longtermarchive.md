...
the [Activity Records Statistics](../admin/healthstatus/dashboard/activityrecordstatistics.md)
...
- On the file shares where report subscriptions are saved:
    ...
    Archive service account as well. See the [Subscriptions](../admin/subscriptions/overview.md)
...
adjust the settings as necessary. See the [Long-Term Archive](../admin/settings/longtermarchive.md)
topic for additional information.
