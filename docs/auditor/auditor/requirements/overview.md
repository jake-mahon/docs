...
- [Supported Data Sources](supporteddatasources.md)
- [Hardware Requirements](console.md)
...
![auditorarchitecture_thumb_0_0](../../../../static/img/product_docs/auditor/auditor/requirements/auditorarchitecture_thumb_0_0.jpg)
...
- Netwrix Auditor collects audit data from the specified data source (application, server, storage system, and so on).
  ...
  - See the [Integration API](../api/overview.md) topic for additional information on custom data source processing workflow.
