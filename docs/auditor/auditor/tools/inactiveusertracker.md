...
__Step 1 –__ Navigate to Start > Netwrix Auditor > Netwrix Auditor Inactive Users Tracker.
...
__Step 4 –__ Navigate to the General tab and complete the following fields:

| Option | Description |
| --- | --- |
| Specify account which will be used to collect data:   - User name - Password | Enter the account which will be used for data collection.  See the[Data Collecting Account](../admin/monitoringplans/dataaccounts.md) topic for additional information about the full list of the rights and permissions for the account. |
...
__Step 5 –__ Navigate to the Actions tab and complete the following fields:
...
| Move to a specific OU after | - Specify account inactivity period, after which the account will be moved to a specified organizational unit. - OU name—Specify OU name or select an AD container using ![select_button](../../../../static/img/product_docs/auditor/auditor/tools/select_button.webp) button. |
...
__Step 6 –__ Navigate to the Advanced tab and complete the following fields:
...
__Step 7 –__ Navigate to the Notifications tab and complete the following fields:
...
![inactiveusersactivedirectory](../../../../static/img/product_docs/auditor/auditor/tools/inactiveusersactivedirectory.webp)
...
__Step 1 –__ Navigate to the ```%PROGRAMDATA%\Netwrix Auditor\Inactive Users Tracker``` folder.

__NOTE:__ This is default location. However, it may be changed because users can move this folder.
