...
| Move to a specific OU after | - Specify account inactivity period, after which the account will be moved to a specified organizational unit. - OU name—Specify OU name or select an AD container using ![select_button](/static/img/product_docs/auditor/auditor/tools/select_button.png) button. |
...
![inactiveusersactivedirectory](/static/img/product_docs/auditor/auditor/tools/inactiveusersactivedirectory.png)
