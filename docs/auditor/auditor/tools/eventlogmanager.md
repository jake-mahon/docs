...
configured in Netwrix Auditor Server. Refer to [Audit Database](../admin/settings/auditdatabase.md)
...
[Netwrix Auditor Health Log](../admin/healthstatus/dashboard/healthlog.md) for addditional
information
...
are configured properly, follow the [Audit Database](../admin/settings/auditdatabase.md)
