...
![ad_object_restore_1](/img/product_docs/auditor/auditor/tools/ad_object_restore_1.png)

__Step 4 –__ Double-click the searchFlags attribute and set its value to _"8"_.

![ad_object_restore_2](/img/product_docs/auditor/auditor/tools/ad_object_restore_2.png)
