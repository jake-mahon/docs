...
__Step 1 –__ Navigate to Start > Windows Administrative Tools > ADSI Edit.
...
![ad_object_restore_1](/static/img/product_docs/auditor/auditor/tools/ad_object_restore_1.png)

__Step 4 –__ Double-click the searchFlags attribute and set its value to _"8"_.

![ad_object_restore_2](/static/img/product_docs/auditor/auditor/tools/ad_object_restore_2.png)
...
__Step 1 –__ Navigate to Start > Netwrix Auditor > Netwrix Auditor Object Restore for Active Directory.

__Step 2 –__ On the Select Rollback Period step, specify the period of time when the changes that you want to revert occurred. You can either select a period between a specified date and the present date, or between two specified dates.

__Step 3 –__ On the Select Rollback Source step, specify the rollback source. The following restore options are available:
