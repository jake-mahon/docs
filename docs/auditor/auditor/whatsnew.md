...
The subject line of email alerts may include the who, what, or where details of an alerted activity. For example, the subject line of an email alert will be "_J.Doe has added M.Smith to Domain Admins_" instead of "_User has been added to a privileged group_".
