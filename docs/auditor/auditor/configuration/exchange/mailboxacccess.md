...
It is recommended to select __Adjust audit settings automatically__ option when setting up Exchange monitoring in Netwrix Auditor. See the [Create a New Monitoring Plan](../../admin/monitoringplans/create.md) topic for additional information.
