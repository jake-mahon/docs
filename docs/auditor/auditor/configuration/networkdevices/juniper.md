...
2. Execute the following commands:
   ...
   `<port number>` is the name of the UDP port used to listen to network devices (514 port used by default). [Network Devices](../../admin/monitoringplans/networkdevices.md)
