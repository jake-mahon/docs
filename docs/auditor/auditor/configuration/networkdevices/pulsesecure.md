...
5. Under the Select Events to Log, select the following (minimal requirement, select other events if needed):
   ...
   ![manual_config_pulse_1](/static/img/product_docs/auditor/auditor/configuration/networkdevices/manual_config_pulse_1.png)
...
17. Navigate to your monitoring plan for Network Devices. See [Monitoring Plans](/docs/product_docs/auditor/auditor/admin/monitoringplans/overview.md)
18. Provide the IP address of the interface you specified on the step 14 as the Computer item for your monitoring plan. See [Active Directory](/docs/product_docs/auditor/auditor/admin/monitoringplans/activedirectory/overview.md)
