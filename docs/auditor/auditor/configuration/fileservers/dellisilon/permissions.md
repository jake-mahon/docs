...
- Automatic configuration: you can use a special shell script for configuring an audited Dell Isilon/PowerScale cluster and granting necessary privileges to the account used to collect audit data. See the following topics for additional information:
  - [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode via Shell Script](/docs/product_docs/auditor/auditor/configuration/fileservers/dellisilon/normal.md#Configure-Dell-IsilonPowerScale-Cluster-in-Normal-or-Enterprise-Mode-via-Shell-Script)
  - [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Via Shell Script](/docs/product_docs/auditor/auditor/configuration/fileservers/dellisilon/compliance.md#Configure-Dell-IsilonPowerScale-Cluster-in-Compliance-Mode-Via-Shell-Script)
- Manual configuration: you can grant all the necessary permissions to data collecting account manually. See the following topics for additional information:
  - [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode Manually](/docs/product_docs/auditor/auditor/configuration/fileservers/dellisilon/normal.md#Configure-Dell-IsilonPowerScale-Cluster-in-Normal-or-Enterprise-Mode-Manually)
  - [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Manually](/docs/product_docs/auditor/auditor/configuration/fileservers/dellisilon/compliance.md#Configure-Dell-IsilonPowerScale-Cluster-in-Compliance-Mode-Manually)
...
See the [Normal and Enterprise Modes for Clusters](/docs/product_docs/auditor/auditor/configuration/fileservers/dellisilon/normal.md) topic for additional information.
