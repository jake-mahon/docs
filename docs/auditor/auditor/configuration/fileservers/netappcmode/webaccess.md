...
**Step 4 –** Review the [Permissions for NetApp Auditing](permissions.md) topic for additional
...
[Permissions for NetApp Auditing](permissions.md) topic for additional information.
