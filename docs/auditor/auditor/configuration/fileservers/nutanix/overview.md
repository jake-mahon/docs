...
__Step 1 –__ Create a user account to access the Nutanix REST API. See the [Create User Account to Access Nutanix REST API](useraccount.md) topic for additional information.

__Step 2 –__ Open a port for inbound connections. See the [Nutanix Ports](ports.md) topic for additional information.
...
- Automatically when creating a monitoring plan. For that, you should select the __Adjust audit settings automatically__ option in the monitoring plan wizard. See the [Settings for Data Collection](../../../admin/monitoringplans/create.md#settings-for-data-collection) topic for additional information.
- Manually, as described in the corresponding topics:
  - [Configure Partner Server](partnerserver.md)
  - [Create a Notification Policy](notificationpolicy.md)
