...
- The __Manage auditing and security log__ and Backup files and directories policies must be defined for this account. See the [Permissions for Active Directory Auditing](/docs/auditor/auditor/configuration/activedirectory/permissions.md) and topics for additional more information.
...
- [Use Group Managed Service Account (gMSA)](/docs/auditor/auditor/requirements/gmsa.md)
