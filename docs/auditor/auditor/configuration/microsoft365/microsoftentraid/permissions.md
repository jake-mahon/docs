...
See the [Using Basic Authentication with Microsoft Entra ID](/docs/product_docs/auditor/auditor/configuration/microsoft365/microsoftentraid/basicauth.md) topic for additional information.
...
See the [Using Modern Authentication with Microsoft Entra ID](/docs/product_docs/auditor/auditor/configuration/microsoft365/microsoftentraid/modernauth.md) topic for additional information.
