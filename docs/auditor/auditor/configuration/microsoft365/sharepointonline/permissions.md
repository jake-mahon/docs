...
See the [Using Modern Authentication with SharePoint Online](modernauth.md) topic for additional information.
...
See the [Using Basic Authentication with SharePoint Online](basicauth.md) topic for additional information.
