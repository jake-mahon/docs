...
Basic local audit policies allow tracking changes to user accounts and groups and identifying originating workstations. You can configure advanced audit policies for the same purpose too. See the [Configure Advanced Audit Policies](/docs/product_docs/auditor/auditor/configuration/logonactivity/advancedpolicy.md) topic for additional information.
