...
- Configure Data Collecting Account as described in
  [Permissions for Oracle Database Auditing](permissions.md) topic.
...
- Configure Data Collecting Account. See the
  [Permissions for Oracle Database Auditing](permissions.md) topic for additional information.
- Configure ports. See the [Oracle Database Ports](ports.md) topic for additional information about
