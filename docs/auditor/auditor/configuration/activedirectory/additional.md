...
- The Audit Logs management role (see the [Assign Management Roles](/docs/product_docs/auditor/auditor/configuration/exchange/permissions.md#Assign-Management-Roles) topic for additional information)
