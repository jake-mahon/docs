...
If the account selected for data collection is not a member of the Domain Admins group, see the [Assign Permission To Read the Registry Key](/docs/product_docs/auditor/auditor/configuration/activedirectory/permissionsregistrykeys.md) topic.
...
- The __Audit Logs__ management role (see the [Assign Management Roles](/docs/product_docs/auditor/auditor/configuration/exchange/permissions.md#Assign-Management-Roles) topic for additional information).

You will also need to configure Exchange Administrator Audit Logging (AAL) settings. See the [Exchange Administrator Audit Logging Settings](/docs/product_docs/auditor/auditor/configuration/exchange/auditlog.md) topic for additional information.
...
- Permissions to access the HKEY\_LOCAL\_MACHINE\System\CurrentControlSet\Services\EventLog\Security registry key on the domain controllers in the target domain. See the [Assign Permission To Read the Registry Key](/docs/product_docs/auditor/auditor/configuration/activedirectory/permissionsregistrykeys.md) topic for additional information.
...
- Permissions to access the _HKEY\_LOCAL\_MACHINE\System\CurrentControlSet\Services\EventLog\Security_ registry key on the domain controllers in the target domain. See the [Assign Permission To Read the Registry Key](/docs/product_docs/auditor/auditor/configuration/windowsserver/permissionsregistrykeys.md) topic for additional information.
...
- Membership in the __Organization Management__ or __Records Management__ group.
- The __Audit Logs__ management role (see the [Assigning Management Roles](/docs/product_docs/auditor/auditor/configuration/exchange/auditlogsrole.md) topic for additional information).
