...
1. On the audited server, open the __Local Group Policy Editor__ snap-in: navigate to __Start__ → Run and type _"gpedit.msc"_.
2. Navigate to Computer Configuration → Administrative Templates → System and locate the policy.

   | Policy Name | State |
   | --- | --- |
   | __Enable Persistent Time Stamp__ | _"Enabled"_ |
