...
You can also configure advanced audit policies for same purpose. See the [Configure Advanced Audit Policies](/docs/product_docs/auditor/auditor/configuration/windowsserver/advancedpolicy.md) topic for more information.
