...
![subscription](/static/img/product_docs/threatprevention/threatprevention/reportingmodule/investigations/options/subscription.png)
...
| Remove subscriptions | Click ![delete](/static/img/product_docs/strongpointfornetsuite/integrations/delete.png) icon next to the selected subscription. |
