...
- [Create Subscriptions](/docs/product_docs/auditor/auditor/admin/subscriptions/create.md)how to create new subscriptions.
- [Review and Manage Subscriptions](/docs/product_docs/auditor/auditor/admin/subscriptions/manage.md)how to manage subscriptions.
