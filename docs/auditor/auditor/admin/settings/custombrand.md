...
__Step 3 –__ Run SearchRebranding.ps1 considering the following:
...
__Step 4 –__ Generate any test subscription email or export a dashboard to pdf file to verify that rebranding applied.

To restore original look and feel, run the script and replace"_True_" with "_False_" in the "_enabled_" section.

## Customize Branding in Reports

By default, Netwrix Auditor reports look as follows:

[![All Logon Activity](/static/img/product_docs/auditor/auditor/admin/settings/report_rebranding_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/report_rebranding.png)
...
__Step 1 –__ On the computer where Auditor Server resides, navigate to _C:\Program Data\Netwrix Auditor\Rebranding_.

__Step 2 –__ Right-click the Rebranding.ps1 script and select Edit. Windows PowerShell ISE will start.

__Step 3 –__ Review the script and provide parameters.
...
[![report_rebranding_result_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/settings/report_rebranding_result_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/report_rebranding_result.png)

Follow the steps to restore original look.

__Step 1 –__ On the computer where Auditor Server resides, navigate to the script location.
