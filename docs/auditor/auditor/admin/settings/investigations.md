...
![investigate](/static/img/product_docs/auditor/auditor/admin/settings/investigate.png)

To import audit data with the Archive Data Investigation wizard

__NOTE:__ You must be assigned the Global administrator role to import investigation data. To view investigation data, you must be assigned the Global administrator or Global reviewer role. See [Assign Roles](/docs/product_docs/auditor/auditor/admin/monitoringplans/delegation.md#Assign-Roles) topic for more information.
