...
![Account specification](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/add.png)
...
![Filter](/static/img/product_docs/auditor/auditor/admin/search/addsuggestions.png)
...
| To... | Do... |
| --- | --- |
| Modify filter | Double-click the filter and type a new value.  ![Filter new value](/static/img/product_docs/auditor/auditor/admin/search/search_modify_filter.png)  If you need to modify the When filter, delete it and add a new value, or navigate to the Advanced mode (Simple mode does not support its modification). |
