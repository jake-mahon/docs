...
[![passwordreset_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/alertsettings/passwordreset_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/alerts/responseaction/passwordreset.png)

Response Action settings contain the following configuration options:

- Take action when alert occurs - Toggle this setting to __On__ to enable alert responses
...
- Command line preview – Showing a preview of the command line script. Click __Test run__ button to test its performance.

Follow the steps to configure the required settings in the Response Action tab of the alert properties.

__Step 1 –__ Turn the switch to On if you want a response action to be taken when the alert occurs.

__Step 2 –__ In the Run field, specify the path to the executable file (_.exe_, ._cmd_, _.bat_; for _.ps1_ files see step 3 below). The file must be located on the machine where Netwrix Auditor server runs.

__Step 3 –__ In the With parameters field, enter the parameters to be used by the executable file. Use space character as a separator.
...
[![command_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/alertsettings/command_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/alerts/responseaction/command.png)
...
[![powershell_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/alertsettings/powershell_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/alerts/responseaction/powershell.png)
...
- __0__ — the response action completed successfully
- Any other value — the response action was not a success

___RECOMMENDED:___ Apply similar logic if you plan to use custom exit codes in your response action script.
...
[![csvfile_thumb_0_48](/static/img/product_docs/auditor/auditor/admin/alertsettings/csvfile_thumb_0_48.png)](/docs/product_docs/auditor/resources/images/auditor/alerts/responseaction/csvfile.png)
