...
- See the[Manage Alerts](manage.md) topic for additional information on how to edit and enable
  existing predefined alerts, and create new alerts based on the predefined ones.
- See the [Create Alerts](create.md) topic for additional information on how to create custom alerts
  with your personal filters.
- If you need to be alerted on specific events in your Event Logs or non-owner mailbox access
  attempts, see the [Create Alerts for Event Log](createeventlog.md) and
  [Create Alerts for Non-Owner Mailbox Access Events](createmailboxaccess.md) topics for additional
  information.
...
General tab. See the [Create Alerts](create.md) topic to receive information about tags applying.
