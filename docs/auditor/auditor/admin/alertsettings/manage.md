...
| Remove an alert | Select an alert from the list and click ![delete](../../../../../static/img/product_docs/strongpointfornetsuite/integrations/delete.webp) in the right pane. |
