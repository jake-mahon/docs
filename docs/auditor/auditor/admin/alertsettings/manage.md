...
| Remove an alert | Select an alert from the list and click ![delete](/img/product_docs/strongpointfornetsuite/integrations/delete.png) in the right pane. |
