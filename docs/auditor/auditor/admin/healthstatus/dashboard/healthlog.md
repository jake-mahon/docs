...
Daily summary of the Netwrix Auditor health log is displayed in the Health log widget. The chart shows how many events with different severity levels were written to the product health log in the last 24 hours. To open the health log, click the __Open Health Log__ link in the Health Status dashboard.
...
![healthlog](/static/img/product_docs/auditor/auditor/admin/healthstatus/dashboard/healthlog.png)

## Netwrix Auditor System Health Log

When an error occurs, a system administrator or support engineer must determine what caused this error and prevent it from recurring. For your convenience, Auditor records important events in the proprietary Netwrix Auditor __System Health__ event log.
...
- Create a monitoring plan for this log using Event Log Manager too to collect activity data. [See the ](/docs/product_docs/auditor/auditor/admin/standalone_tools/event_log_manager/nasystem_health_configure_elm.md)[Monitoring Overview](/docs/product_docs/auditor/auditor/admin/healthstatus/monitoringoverview.md) topic for additional information.
- Configure alerts triggered by specific events in the product's health log. [Create Alerts on Health Status](/docs/product_docs/auditor/auditor/admin/alertsettings/createhealthstatus.md)

## Inspect Events in Health Log

Follow the steps o inspect events in Netwrix Auditor health log

__Step 1 –__ On the main Auditor page, select the Health status tile, then in the Health log dashboard widget click Open health log.

__Step 2 –__ Select an entry to review it in details. You can also copy event details. Select the event in the list and click Copy details at the bottom of the window.
...
__Step 1 –__ Select Filters in the upper part of the Netwrix Auditor Health Log window.

__Step 2 –__ Complete the following fields:
...
[![healthlogfilters_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/healthstatus/dashboard/healthlogfilters_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/health/healthlogfilters.png)
