...
![ad_activitity_summary_thumb_0_0](../../../../../static/img/product_docs/auditor/auditor/admin/monitoringplans/ad_activitity_summary_thumb_0_0.webp)
...
To disable Activity Summary Emails, you need to disable notifications in the settings. See the [Notifications](../settings/notifications.md) topic for additional information.
