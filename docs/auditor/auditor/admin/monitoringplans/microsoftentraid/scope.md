...
__Step 1 –__ Navigate to the _%Netwrix Auditor installation folder%\Azure AD Auditing_ folder.
...
| omitUPNlist.txt | Specify the user principal name for objects you want to exclude from Microsoft Entra ID search results, licenses, reports and SITs. | user@tenant.com  __NOTE:__ Wildcard \* is supported and can replace any number of characters. |
