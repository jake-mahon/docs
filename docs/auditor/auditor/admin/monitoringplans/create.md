...
[Role-Based Access and Delegation](delegation.md) topic for additional information.
...
[Requirements for SQL Server to Store Audit Data](../../requirements/sqlserver.md) topic for
...
- Install a new instance of Microsoft SQL Server Express automatically — this option is available at
  ...
  Services on the local machine. This SQL Server will be used as default host for Auditor databases.
    ...
    [Requirements for SQL Server to Store Audit Data](../../requirements/sqlserver.md) section.
...
[Audit Database](../settings/auditdatabase.md) topic for additional information.
...
you should provide them manually. See the [Notifications](../settings/notifications.md) topic for
additional information.
...
Specify who will receive daily emails: [Activity Summary Email](activitysummaryemail.md) on changes
in the monitored infrastructure, and [Health Summary Email](../healthstatus/summaryemail.md) on
