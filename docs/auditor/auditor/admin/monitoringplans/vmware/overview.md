...
- [VMware](../../../configuration/vmware/overview.md) – Configure data source as required to be monitored
...
![hiw_diagram_vma_thumb_0_0](../../../../../../static/img/product_docs/auditor/auditor/admin/monitoringplans/vmware/hiw_diagram_vma_thumb_0_0.webp)
...
- Configures alerts related to VMware data source. Current version does not include predefined alerts for that data source, so follow the [Create Alerts](../../alertsettings/create.md) to create and configure the necessary alerts.
