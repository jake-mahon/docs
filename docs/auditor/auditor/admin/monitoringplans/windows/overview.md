...
- [Windows Server](../../../configuration/windowsserver/overview.md) – Configure data source as required to be monitored
...
- User/password. The account must be granted the same permissions and access rights as the default account used for data collection. See the [Data Collecting Account](../dataaccounts.md) topic for additional information.
