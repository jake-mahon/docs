...
As a next step, click Add item to specify an object for monitoring. See the [Add Item to the SQL Server](/docs/auditor/auditor/admin/monitoringplans/sqlserver/items.md) topic for additional information.
