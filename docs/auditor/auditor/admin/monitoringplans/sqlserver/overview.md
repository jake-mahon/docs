...
- [SQL Server](/docs/auditor/auditor/configuration/sqlserver/overview.md) – Configure data source as required to be monitored
...
As a next step, click Add item to specify an object for monitoring. See the [Add Item to the SQL Server](/docs/auditor/auditor/admin/monitoringplans/sqlserver/items.md#Add-Item-to-the-SQL-Server) topic for additional information.
