...
- [SQL Server](../../../configuration/sqlserver/overview.md) – Configure data source as required to be monitored
...
As a next step, click Add item to specify an object for monitoring. See the [Add Item to the SQL Server](items.md) topic for additional information.
...
![data_source_sql_audit_select_thumb_0_0](../../../../../../static/img/product_docs/auditor/auditor/admin/monitoringplans/sqlserver/data_source_sql_audit_select_thumb_0_0.webp)
