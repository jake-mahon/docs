...
- [Group Policy](/docs/product_docs/auditor/auditor/configuration/grouppolicy/overview.md) – Configure data source as required to be monitored
...
| Prerequisites | Netwrix Auditor will automatically look up additional system components and prompt you to install those that are missing. In case all required components have been already installed, this section will be omitted. See the [Other Components](/docs/product_docs/auditor/auditor/requirements/software.md#Other-Components) topic for additional information. |
