...
- [AD FS](/docs/product_docs/auditor/auditor/configuration/activedirectoryfederatedservices/overview.md) – Configure data source as required to be monitored
