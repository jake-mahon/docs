...
- [Exchange Online](/docs/product_docs/auditor/auditor/configuration/microsoft365/exchangeonline/overview.md) – Configure data source as required to be monitored
...
| Configure audit settings | See the [Exchange Online](/docs/product_docs/auditor/auditor/configuration/microsoft365/exchangeonline/overview.md) configuration topic for additional information about audit settings required to collect comprehensive audit data and the instructions on how to configure them. |
...
See the [Office 365 Tenant](/docs/product_docs/auditor/auditor/solutions/items/overview.md) topic for additional information.
