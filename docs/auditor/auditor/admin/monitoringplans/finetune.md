...
| Use default SQL Server settings | Select this checkbox to write data to a SQL Server instance with connection parameters as shown in __Settings__ > __Audit Database__. See the [Audit Database](../settings/auditdatabase.md) topic for additional information. |
