...
__Step 3 –__ In the Plan Settings page, review the tabs and modify the settings.
...
| Use default SQL Server settings | Select this checkbox to write data to a SQL Server instance with connection parameters as shown in __Settings__ > __Audit Database__. See the [Audit Database](/docs/product_docs/auditor/auditor/admin/settings/auditdatabase.md) topic for additional information. |
