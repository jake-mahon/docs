...
- [Protocols and Ports Required](../../requirements/ports.md) – To ensure successful data collection
...
- [Supported Data Sources](../../requirements/supporteddatasources.md) – Configure data source as
...
[Create a New Monitoring Plan](create.md) topic for additional information.
...
example, see [VMware](vmware/overview.md)).
