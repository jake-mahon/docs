...
![rbac-01](/img/product_docs/auditor/auditor/admin/monitoringplans/rbac-01.png)
...
| Revoke a role assignment | - Click ![delete](/img/product_docs/strongpointfornetsuite/integrations/delete.png) next to the user. |
...
![Roles_Groups](/img/product_docs/auditor/auditor/admin/monitoringplans/roles_groups.png)
