...
- [Exchange](/docs/auditor/auditor/configuration/exchange/overview.md) – Configure data source as required to be monitored
...
See the [Permissions for Exchange Auditing](/docs/auditor/auditor/configuration/exchange/permissions.md) topic for additional information.
