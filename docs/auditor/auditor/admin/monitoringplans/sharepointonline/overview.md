...
- [SharePoint Online](/docs/product_docs/auditor/auditor/configuration/microsoft365/sharepointonline/overview.md) – Configure data source as required to be monitored
...
](/docs/product_docs/auditor/auditor/configuration/microsoft365/sharepointonline/permissions.md)topic for additional information.
