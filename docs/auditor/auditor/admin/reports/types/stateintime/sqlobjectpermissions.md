...
[![objectpermissionssqlserver_thumb_0_0](/static/img/product_docs/auditor/auditor/admin/reports/types/stateintime/objectpermissionssqlserver_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/report/sqlserver/objectpermissionssqlserver.png)
...
- __Snapshot date__ —select the date of state-in-time snapshot you want to report on. By default, the report includes data obtained during the latest data collection session (_Current Session_). To report on other snapshots, make sure they are available through import. For details, see __Manage historical snapshots__ option description in the [SQL Server](/docs/product_docs/auditor/auditor/admin/monitoringplans/sqlserver/overview.md) topic.
...
- Clicking a Means granted link opens the[SQL Server Means Granted](/docs/product_docs/auditor/auditor/admin/reports/types/stateintime/sqlmeansgranted.md) report.
