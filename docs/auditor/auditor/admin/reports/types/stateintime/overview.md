...
To provide data for state-in-time reports, remember to select the __Collect data for state-in-time reports__ option when you configure a monitoring plan for the selected data source. See the [Settings for Data Collection](../../../monitoringplans/create.md#settings-for-data-collection) topic for additional information.
...
__NOTE:__ Importing historical snapshots is not available for Office 365.
