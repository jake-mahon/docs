...
![accountpermissionssqlserver_thumb_0_0](../../../../../../../static/img/product_docs/auditor/auditor/admin/reports/types/stateintime/accountpermissionssqlserver_thumb_0_0.webp)
...
- __Snapshot date__ —select the date of state-in-time snapshot you want to report on. By default, the report includes data obtained during the latest data collection session (_Current Session_). To report on other snapshots, make sure they are available through import. For details, see __Manage historical snapshots__ option description in [SQL Server](../../../monitoringplans/sqlserver/overview.md)
...
- Clicking a Object permissions link opens the [Object Permissions in SQL
  Server](sqlobjectpermissions.md) report.
- Clicking a Means granted link opens the __[SQL Server Means Granted](sqlmeansgranted.md)__ report.
