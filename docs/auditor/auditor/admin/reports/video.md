...
[![ReportsWithVideo](/static/img/product_docs/auditor/auditor/admin/reports/alluseractivityvideo_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/report/alluseractivityvideo.png)
...
__Step 1 –__ Navigate to __Reports__ → __User Activity__. Select any report and click View.

__Step 2 –__ Click a link in the __When__ column.
