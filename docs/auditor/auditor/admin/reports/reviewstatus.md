...
![reviewstatus_thumb_0_0](/img/product_docs/auditor/auditor/admin/reports/reviewstatus_thumb_0_0.png)3. In the __Review status__ dialog for selected change, set its status to In Review and provide a reason.
