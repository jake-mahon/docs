...
3. Go to the Audit Database section and make sure that Disable security intelligence ... checkbox is cleared. This will instruct Netwrix Auditor to store data to both Long-Term Archive and audit database:  
   [![edit_mp_store_data_to_db_thumb_0_0](/img/product_docs/auditor/auditor/admin/riskassessment/edit_mp_store_data_to_db_thumb_0_0.png)](/docs/auditor/resources/images/auditor/riskassessment/edit_mp_store_data_to_db.png)
...
5. Select the data source you need (for example, Active Directory) and click Edit data source from the Data source section on the right. [![edit_mp_open_ds_settings_thumb_0_0](/img/product_docs/auditor/auditor/admin/riskassessment/edit_mp_open_ds_settings_thumb_0_0.png)](/docs/auditor/resources/images/auditor/riskassessment/edit_mp_open_ds_settings.png)
6. Make sure that:
