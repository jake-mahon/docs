...
![dashboard_thumb_0_0](../../../../../static/img/product_docs/dataclassification/ndc/admin/reporting/dashboard_thumb_0_0.webp)
...
__Step 2 –__ In the displayed dialog, specify new threshold values for risk levels.

__Step 3 –__ Click OK to save the settings and close the dialog.

![modify_thresholds_thumb_0_0](../../../../../static/img/product_docs/auditor/auditor/admin/riskassessment/modify_thresholds_thumb_0_0.webp)
...
You can create a subscription to periodically receive IT risk assessment results by email or using a file share. For that, in the dashboard window click Subscribe and configure the necessary settings. See the [Create Subscriptions](../subscriptions/create.md) topic for additional information.
