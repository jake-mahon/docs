...
1. You create alerts on threat patterns specific to your company. You include these alerts in Behavior Anomalies assessment and associate a risk score with each alert. The score, that is between 1 and 100 points, reflects how critical the action is for your organization. [Risk Score](/docs/auditor/auditor/admin/alertsettings/create.md)how to set a risk score for an alert.
