...
Navigate to the Netwrix website at [Netwrix Auditor Virtual Appliance](https://www.netwrix.com/virtual_appliances.html) and download the Virtual Appliance.
...
- [Import Virtual Machine from Image to VMware](/docs/product_docs/auditor/auditor/install/virtualappliance/importvmware.md)
- [Import Virtual Machine from Image to Hyper-V ](/docs/product_docs/auditor/auditor/install/virtualappliance/importhyperv.md)
...
The requirements below are sufficient for evaluation purposes only. See the [Requirements](/docs/product_docs/auditor/auditor/requirements/overview.md) topic for additional information.
