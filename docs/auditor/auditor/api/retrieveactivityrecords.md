...
| POST | ```https://{host:port}/netwrix/api/v1/activity_records/enum{?format=json}{&count=Number}``` | [Continuation Mark](/docs/product_docs/auditor/auditor/api/postdata/continuationmark.md) |
...
__Step 3 –__ Continue retrieving Activity Records. Send a POST request containing this Continuation mark to the same endpoint. See the [Continuation Mark](/docs/product_docs/auditor/auditor/api/postdata/continuationmark.md) topic for more information. For example:
