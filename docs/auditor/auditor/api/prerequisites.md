...
Refer to the [Security](security.md) topic for detailed instructions on how
...
Refer to the [Audit Database](../admin/settings/auditdatabase.md) topic for detailed instructions on how to configure SQL Server settings.
