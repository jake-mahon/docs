...
Refer to the [Security](security.md) topic for detailed instructions on how to disable HTTPS and
...
Refer to the [Audit Database](../admin/settings/auditdatabase.md) topic for detailed instructions on
