...
[![diagram_thumb_0_0](/static/img/product_docs/auditor/auditor/addon/cyberark/diagram_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/api/diagram.png)
...
Make sure Integration API is enabled. To check it, navigate to Settings → Integrations tab. See [Integrations](/docs/product_docs/auditor/auditor/admin/settings/integrations.md) for more information.
