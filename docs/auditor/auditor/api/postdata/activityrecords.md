...
To feed data from a custom audit source to Netwrix Auditor, send a POST request containing Activity Records. [Write Activity Records](/docs/product_docs/auditor/auditor/api/writeactivityrecords.md)
