...
In Netwrix Auditor 9.0, Netwrix has updated API schemas. Make sure to check and update your custom scripts and add-ons. [Compatibility Notice](/docs/auditor/auditor/api/compatibility.md)
...
- [Continuation Mark](/docs/auditor/auditor/api/postdata/continuationmark.md)
- [Search Parameters](/docs/auditor/auditor/api/postdata/searchparameters.md)
- [Activity Records](/docs/auditor/auditor/api/postdata/activityrecords.md)
