...
In Netwrix Auditor 9.0, Netwrix has updated API schemas. Make sure to check and update your custom scripts and add-ons. [Compatibility Notice](../compatibility.md)
...
- [Continuation Mark](continuationmark.md)
- [Search Parameters](searchparameters.md)
- [Activity Records](activityrecords.md)
