...
| --- | --- | --- |
| POST | [/netwrix/api/v1/activity\_records/enum ](/docs/product_docs/auditor/auditor/api/retrieveactivityrecords.md) | Returns next Activity Records. |
| POST | [/netwrix/api/v1/activity\_records/search](/docs/product_docs/auditor/auditor/api/searchactivityrecords.md) | Returns next Activity Records matching a filter criteria. |
...
If you want to retrieve next Activity Records for your search, include the Continuation mark to your Search parameters file. [Search Parameters](/docs/product_docs/auditor/auditor/api/postdata/searchparameters.md)
...
| --- |
| XML |
| [Retrieve Activity Records](/docs/product_docs/auditor/auditor/api/retrieveactivityrecords.md) |
...
| [Search Activity Records](/docs/product_docs/auditor/auditor/api/searchactivityrecords.md) |
