...
| --- | --- | --- |
| POST | [/netwrix/api/v1/activity_records/enum ](../retrieveactivityrecords.md) | Returns next Activity Records. |
| POST | [/netwrix/api/v1/activity_records/search](../searchactivityrecords.md) | Returns next Activity Records matching a filter criteria. |
...
If you want to retrieve next Activity Records for your search, include the Continuation mark to your Search parameters file. [Search Parameters](searchparameters.md)
...
| --- |
| XML |
| [Retrieve Activity Records](../retrieveactivityrecords.md) |
...
| [Search Activity Records](../searchactivityrecords.md) |
