...
[![certificatestore_thumb_0_0](/static/img/product_docs/auditor/auditor/api/certificatestore_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/api/certificatestore.png)
...
1. On the computer where Auditor Server resides, start the Command Prompt and run the tool. The tool is located in the _Netwrix Auditor installation folder_, inside the _Audit Core_ folder. For example:
