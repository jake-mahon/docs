...
To learn more about input and output Activity Record structure, refer to [Activity Records](/docs/product_docs/auditor/auditor/api/postdata/activityrecords.md).
