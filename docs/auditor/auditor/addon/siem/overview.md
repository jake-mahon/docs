...
Auditor Integration API, refer to [Integration API](../../api/overview.md).
...
1. The administrator enables and configured response action for selected alert, as described in the
   following topic:
   [Configure a Response Action for Alert](../../admin/alertsettings/responseaction.md). Make sure
...
See the [Configure a Response Action for Alert](../../admin/alertsettings/responseaction.md)
