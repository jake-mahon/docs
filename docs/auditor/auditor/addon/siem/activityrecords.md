...
By default, the Netwrix Auditor Integration event log size is set to _1GB_, and retention is set to _"Overwrite events as needed"_. See the [Integration Event Log Fields](/docs/product_docs/auditor/auditor/addon/siem/integrationeventlog.md) topic for additional information.
