...
See the [Choose Appropriate Execution Scenario](/docs/product_docs/auditor/auditor/addon/intelsecurity/deployment.md) topic for additional information.
