...
[![HIW](/static/img/product_docs/auditor/auditor/addon/cyberark/diagram_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/addon/hyperv/diagram.png)
...
5. This script creates a Windows scheduled task that will run periodically (every 15 minutes) to collect audit data from VMM server.
   ...
   See the [Monitoring Scope](/docs/product_docs/auditor/auditor/addon/hyperv/monitoredevents.md) for additional information on the default list of the events supported out-of-the box.
...
- __Contributor__ role in Auditor. See the [Role-Based Access and Delegation](/docs/product_docs/auditor/auditor/admin/monitoringplans/delegation.md) topic for additional information.
