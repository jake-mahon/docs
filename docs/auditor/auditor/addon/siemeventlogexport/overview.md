...
For more information on the structure of the Activity Record and the capabilities of the Integration API, refer to the [Integration API](/docs/product_docs/auditor/auditor/api/overview.md) topic.
