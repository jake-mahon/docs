...
In such scenario, you will need to specify this monitoring plan in the _naplan_ and _naplanitem_ attributes of the _<AcceptList> ® <Address>_ configuration parameters. See the [Add-On Parameters](/docs/product_docs/auditor/auditor/addon/cyberark/parameters.md) topic for additional information.
...
- __SyslogMessageCodeFilter__ - IDs of events to forward. The add-on will only collect and process events you specify in this parameter. For the full list of supported events, see [Monitored Events](/docs/product_docs/auditor/auditor/addon/cyberark/monitoredevents.md). Use comma as a separator.

[![dbparamfile_thumb_0_0](/static/img/product_docs/auditor/auditor/addon/cyberark/dbparamfile_thumb_0_0.png)](/docs/product_docs/auditor/resources/images/auditor/addon/cyberark/dbparamfile.png)
...
![ConfigurationWizard](/static/img/product_docs/auditor/auditor/addon/privilegeduserlinux/configwizard.png)
