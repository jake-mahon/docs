...
| --- | --- | --- |
| Source | __NA___`{Data Source Name}`__  -OR-  __Netwrix \_Auditor\_Integration\_API__ | Depending on _SetDataSourceAsEventSource_ in-script parameter. |
...
See the [Define Parameters](/docs/auditor/auditor/addon/alienvaultusm/parameters.md) topic for additional information.
