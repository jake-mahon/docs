...
By default, the Netwrix Auditor Integration event log size is set to 1GB, and retention is set to "_Overwrite events as needed_". For more information about event log fields, see the documentation.
