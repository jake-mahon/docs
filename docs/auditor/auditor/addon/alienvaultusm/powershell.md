...
By default, the Netwrix Auditor Integration event log size is set to 1GB, and retention is set to "_Overwrite events as needed_". See the [Appendix. Netwrix Auditor Integration Event Log Fields](/docs/auditor/auditor/addon/alienvaultusm/appendix.md) topic for additional information.
