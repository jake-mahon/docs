...
Depending on the execution scenario you choose, you have to define a different set of script parameters. See the [Define Parameters](parameters.md) topic for additional information.
