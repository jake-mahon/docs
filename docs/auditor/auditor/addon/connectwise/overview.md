...
![CW_workflow](../../../../../static/img/product_docs/auditor/auditor/addon/connectwise/diagramworkflow_thumb_0_0.webp)
...
For details on the alert response action, see the [Configure a Response Action for Alert](../../admin/alertsettings/responseaction.md) topic for additional information.
