...
If needed, you can edit the configuration file manually. See the [Connection and Ticketing Settings](connectionticketingsettings.md) topic for additional information.
