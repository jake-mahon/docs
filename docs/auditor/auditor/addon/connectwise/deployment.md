...
1. In the Auditor settings, enable Integration API and specify connection port. See the [Integrations](/docs/product_docs/auditor/auditor/admin/settings/integrations.md) topic for additional information.
2. Make sure your monitoring plans set up in Auditor are using Audit Databases to store collected data. See the [Audit Database](/docs/product_docs/auditor/auditor/admin/settings/auditdatabase.md) topic for additional information.
...
__Step 5 –__ Run the ConfigureConnection.exe and follow the steps of the wizard to configure connection and ticketing settings for ConectWise Manage. See the [Configure ConnectWise ](/docs/product_docs/auditor/auditor/addon/connectwise/configure.md)topic for additional information.

__Step 6 –__ (optional) To adjust the add-on operation and data flow settings, edit the ITSMSettings.xml file. See the [Operational Settings](/docs/product_docs/auditor/auditor/addon/connectwise/operationalsettings.md) topic for additional information.
