...
See [CIM Data Model Mapping](/docs/product_docs/auditor/auditor/addon/splunk/datamodelmap.md) for details.
...
To learn more about Netwrix Auditor activity records, see the [Activity Records](/docs/product_docs/auditor/auditor/api/postdata/activityrecords.md) topic for additional information.
