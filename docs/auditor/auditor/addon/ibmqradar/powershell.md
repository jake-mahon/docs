...
By default, the Netwrix Auditor __Integration__ event log size is set to __1GB__, and retention is set to "_Overwrite events as needed_". See the [Integration Event Log Fields](integrationeventlog.md) topic for additional information.
