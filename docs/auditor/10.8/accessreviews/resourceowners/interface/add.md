...
![Add new resource wizard showing 1. Select Resources page](/images/auditor/10.8/access/reviews/resourceowners/wizard/selectresource.webp)
...
![Add new resource wizard page showing 1. Select Resources page](/images/auditor/10.8/access/reviews/resourceowners/wizard/selectresource.webp)
...
![Add new resources wizard showing 2. Select Owners page](/images/auditor/10.8/access/reviews/resourceowners/wizard/selectowners_1.webp)
...
![Add new resources wizard with the 2. Select Owners page showing multiple owners selected](/images/auditor/10.8/access/reviews/resourceowners/wizard/selectownerswithowners.webp)
...
![Add new resource wizard showing 3. Description page](/images/auditor/10.8/access/reviews/resourceowners/wizard/description_1.webp)

**Step 5 –** On the Description page, optionally add a description for the resource in the textbox.
Then click **Next**.

![Add new resource wizard showing 4. Summary page](/images/auditor/10.8/access/reviews/resourceowners/wizard/summary_1.webp)
...
![Add new resource wizard with 4. Summary page showing action status 100% completed](/images/auditor/10.8/access/reviews/resourceowners/wizard/summarytaskcompleted.webp)
