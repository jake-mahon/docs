...
3. In the **Advanced Security Settings for `<Share_Name>`** dialog, navigate to the **Auditing**
   tab, click Edit.
    ...
    ![auditing_entries_netapp](/images/auditor/10.8/configuration/fileservers/netappcmode/auditing_entries_netapp.webp)
