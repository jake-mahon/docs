...
3. In the right-pane, right-click and select New → DWORD (32-bit Value).
    ...
    ![manualconfig_fileserver_netapp_createregistryvalue_2016](/images/auditor/10.8/configuration/fileservers/netappcmode/manualconfig_fileserver_netapp_createregistryvalue_2016.webp)
...
5. This value defines the time period (in hours) after which security event logs archives will be
   ...
   and click **OK** to save the changes.
    ...
    ![manualconfig_retentionperiodbackuplog_winserver2016](/images/auditor/10.8/configuration/fileservers/netappcmode/manualconfig_retentionperiodbackuplog_winserver2016.webp)
