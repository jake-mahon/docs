...
- [Deployment Procedure](/docs/auditor/10.8/addon/azurefiles/deployment.md)
- [Work with Collected Data](/docs/auditor/10.8/addon/azurefiles/collecteddata.md)
...
- Azure Files environment is configured for auditing. The connection of Azure file share to Windows
  ...
  account key). See the [Deployment Procedure](/docs/auditor/10.8/addon/azurefiles/deployment.md)topic for more information.
