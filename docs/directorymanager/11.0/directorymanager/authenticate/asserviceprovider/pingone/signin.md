...
1. Launch the GroupID portal _Wizard_.  
   ...
   [Configure the Provider in GroupID](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/pingone/configurepingoneindirectorymanager.md#configure-the-provider-in-groupid)
   topic).
...
3. Enter your credentials and sign in. You will be routed to the main page of the GroupID portal
   ...
   [Configure Users in PingOne](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/pingone/configureinpingone.md#configure-users-in-pingone)
   topic.
