...
10. Use the metadata file you generated for the _Wizard_ portal in GroupID to configure certain
    ...
    [Generate the Metadata File](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/pingone/generatemetadata.md#generate-the-metadata-file)
    topic.  
