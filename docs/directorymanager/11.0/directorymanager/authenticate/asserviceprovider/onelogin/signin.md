...
1. Launch the GroupID portal _Wizard_.  
   ...
   [Configure the Provider in GroupID](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/onelogin/configureoneloginindirectorymanager.md#configure-the-provider-in-groupid)
   topic).
...
3. Enter Leo Ferguson’s login name and password, and click **Login**. The user is successfully
   ...
   See the
   [Define Users in OneLogin](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/onelogin/configureinonelogin.md#define-users-in-onelogin)
   topic.
