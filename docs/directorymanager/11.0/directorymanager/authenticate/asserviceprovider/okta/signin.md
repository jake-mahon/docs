...
1. Launch the GroupID portal _Wizard_.  
   ...
   [Configure the Provider in GroupID](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/okta/configureoktaindirectorymanager.md#configure-the-provider-in-groupid)
   topic).
...
3. Enter your credentials and click **Sign In**. You will be routed to the main page of the GroupID
   ...
   the
   [Configure Users in Okta](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/okta/configureinokta.md#configure-users-in-okta)
   topic.
