...
5. While creating the GroupID application in Okta, we downloaded a metadata file. See the
   [Download the Okta Metadata File](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/okta/configureinokta.md#download-the-okta-metadata-file)
   topic.  
