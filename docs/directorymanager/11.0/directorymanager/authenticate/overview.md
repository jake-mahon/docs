...
- [GroupID as a Service Provider](/docs/directorymanager/11.0/directorymanager/authenticate/asserviceprovider/overview.md)
- [GroupID as an Identity Provider](/docs/directorymanager/11.0/directorymanager/authenticate/asidentityprovider/overview.md)
