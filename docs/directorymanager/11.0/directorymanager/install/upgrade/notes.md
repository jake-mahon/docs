...
2. To upgrade to GroupID 11 on a different box, the GroupID source version file system must be
   ...
   [Prerequisites for Upgrade](/docs/directorymanager/11.0/directorymanager/install/upgrade/overview.md#prerequisites-for-upgrade)
   topic.
    ...
    - When you create a new portal in GroupID 11, you can import the advanced settings and design
      ...
      [Create a Portal in Native IIS](/docs/directorymanager/11.0/directorymanager/admincenter/portal/create.md#create-a-portal-in-native-iis)
      topic.
...
- [Upgrade to GroupID 11](/docs/directorymanager/11.0/directorymanager/install/upgrade/upgrade.md)
