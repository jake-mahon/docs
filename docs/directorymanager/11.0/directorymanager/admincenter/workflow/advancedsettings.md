...
[ License GroupID](/docs/directorymanager/11.0/directorymanager/admincenter/general/licensing.md) topic.
...
- When approver acceleration is not enabled, the applicable rules are discussed in the
  [Workflow Approval Scenarios](/docs/directorymanager/11.0/directorymanager/admincenter/workflow/overview.md#workflow-approval-scenarios)
  topic.
