...
- Expires and logically delete groups according to their respective expiry policies (see the
  [ Group Expiry and Deletion](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/groupexpirydeletion.md)
  topic).
...
9. You can specify containers as targets for the schedule. To do so, follow step 9 in the
   ...
   the **Target(s)** area in keeping with the Group Lifecycle settings for the identity store.
    ...
    [Apply Policy on Specific Containers](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#apply-policy-on-specific-containers)
...
12. To set notifications for the schedule, click **Notifications**.
    ...
    1. On the **Notifications** dialog box, select the **Send group life extension notification**
       ...
       [Enable Group Usage Lifecycle](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#enable-group-usage-lifecycle)
       topic.
    2. Click **Save**.
...
14. On the **Schedules** page, click **Save**.  
    ...
    [View the Schedules in an Identity Store ](/docs/directorymanager/11.0/directorymanager/admincenter/schedule/manage.md#view-the-schedules-in-an-identity-store)
    topic for more info.
