...
- **AuditingHistory** - contains history data of all authentication actions performed in GroupID, as
  ...
  [History in Helpdesk](/docs/directorymanager/11.0/directorymanager/admincenter/helpdesk/history.md) topic.
...
- **AdminCenterHistory** - contains Admin Center history data. See the
  [Admin Center History](/docs/directorymanager/11.0/directorymanager/admincenter/general/history.md) topic.
