...
- [Enrollment Summary](/docs/directorymanager/11.0/directorymanager/admincenter/general/dashboard.md#enrollment-summary):
  displays the number of enrolled users in an identity store.
- [Auth Summary](/docs/directorymanager/11.0/directorymanager/admincenter/general/dashboard.md#auth-summary):
  displays information about failed and successful authentication attempts for each authentication
  type.
- [Activity Summary](/docs/directorymanager/11.0/directorymanager/admincenter/general/dashboard.md#activity-summary):
...
- [Helpdesk Operations](/docs/directorymanager/11.0/directorymanager/admincenter/helpdesk/operation/overview.md)
