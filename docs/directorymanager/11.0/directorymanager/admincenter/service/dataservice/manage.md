...
[File Logging](/docs/directorymanager/11.0/directorymanager/admincenter/portal/server/log.md#file-logging)
and
[Windows Logging](/docs/directorymanager/11.0/directorymanager/admincenter/portal/server/log.md#windows-logging)
...
6. In the **File Logging** area, select a logging level for the service in the **Log Events**
   ...
   the table in the
   [Change the File Logging Level for a Portal Instance](/docs/directorymanager/11.0/directorymanager/admincenter/portal/server/log.md#change-the-file-logging-level-for-a-portal-instance)topic
...
- [Create a Data Service](/docs/directorymanager/11.0/directorymanager/admincenter/service/dataservice/create.md)
- [Get Logs](/docs/directorymanager/11.0/directorymanager/admincenter/general/logs.md)
