...
- Consult the Replication service logs. They provide elaborate information about the object type in
  ...
  [Replication Service Logs](/docs/directorymanager/11.0/directorymanager/admincenter/replication/overview.md#replication-service-logs)
  topic.
...
- The status of the Elasticsearch service. See the
  [Elasticsearch Service](/docs/directorymanager/11.0/directorymanager/admincenter/general/dashboard.md#elasticsearch-service)
