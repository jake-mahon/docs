...
[Password Management](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/permissions.md#password-management)
in the
...
[Set up Authentication via Security Questions](/docs/directorymanager/11.0/directorymanager/admincenter/setupauth/securityquestions.md)
topic.
