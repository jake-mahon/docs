...
11. In the **Select Identity Stores** area, select the check boxes for the identity stores you want
    ...
    the
    [Linked Identity Stores and the GroupID Portal](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/link/overview.md#linked-identity-stores-and-the-groupid-portal)
...
13. A portal has certain advanced settings defined for it, as discussed in the
    [Manage Advanced Settings](/docs/directorymanager/11.0/directorymanager/admincenter/portal/server/advanced.md)
    topic.  
...
the[Prerequisites for Deployments in Remote IIS](/docs/directorymanager/11.0/directorymanager/admincenter/portal/remoteiisprerequisites.md)
topic.
...
2. On the **GroupID Portal** tab, click **Launch Application** on a portal’s card to launch it.
    ...
    [View the Launch URL for an Instance](/docs/directorymanager/11.0/directorymanager/admincenter/portal/server/nativeiis.md#view-the-launch-url-for-an-instance)
    topic.
...
- [Delete a Portal](/docs/directorymanager/11.0/directorymanager/admincenter/portal/delete.md)
