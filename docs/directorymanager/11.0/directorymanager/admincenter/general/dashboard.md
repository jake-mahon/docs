...
[Manage the Notification Queue](/docs/directorymanager/11.0/directorymanager/admincenter/notification/queue.md)
topic.
...
- Hover the mouse over a bar to view the number of users enrolled with the specific authentication
  ...
  [View Users' Information](/docs/directorymanager/11.0/directorymanager/admincenter/helpdesk/operation/search.md#view-users-information)
