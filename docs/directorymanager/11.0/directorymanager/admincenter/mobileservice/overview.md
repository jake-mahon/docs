...
[History in GroupID](/docs/directorymanager/11.0/directorymanager/admincenter/history.md) topic.
...
the [Host a Portal](/docs/directorymanager/11.0/directorymanager/admincenter/portal/create.md#host-a-portal)
topic.
...
[Install and Configure the GroupID App](/docs/directorymanager/11.0/directorymanager/admincenter/mobileservice/phonesetup.md)
topic.
