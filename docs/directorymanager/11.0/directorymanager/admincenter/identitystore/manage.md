...
| History                        | Indicates whether history tracking for the identity store is enabled or disabled. See the [Configure History Tracking](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/historytracking.md) topic to enable or disable history tracking.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
3. On the **Identity Store Details** page, update the required information on the **General** tab.  
   ...
   [Create an Identity Store](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/create.md)
...
[Elasticsearch and Replication ](/docs/directorymanager/11.0/directorymanager/admincenter/replication/overview.md)
topic.
...
- [Configure an Identity Store](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure.md)
