...
3. Click the **three vertical dots** icon of the job and select **Schedule** from the menu.
    ...
    [Create a Job](/docs/directorymanager/11.0/directorymanager/portal/synchronize/job/create.md). Update
    the schedule and click **Finish** to save the changes.

## Pin a Job

To pin a job to the
[Dashboard](/docs/directorymanager/11.0/directorymanager/portal/synchronize/dashboard.md) under the pinned
job card:
