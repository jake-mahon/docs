...
See the
[What Happens When a Group is Deleted](/docs/directorymanager/11.0/directorymanager/admincenter/identitystore/configure/directoryservice/groupexpirydeletion.md#what-happens-when-a-group-is-deleted)
