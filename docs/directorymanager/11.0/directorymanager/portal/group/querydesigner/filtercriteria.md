...
[Specify a Default Filter Criteria](/docs/directorymanager/11.0/directorymanager/admincenter/securityrole/policy/querydesigner.md#specify-a-default-filter-criteria)
section of the
...
- [Query Designer](/docs/directorymanager/11.0/directorymanager/portal/group/querydesigner/overview.md)
