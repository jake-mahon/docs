...
See the [Create a Job](/docs/directorymanager/11.0/portal/synchronize/job/create.md) topic
...
- [Synchronize Jobs APIs](/docs/directorymanager/11.0/api/syncjobs/jobsapis.md)
