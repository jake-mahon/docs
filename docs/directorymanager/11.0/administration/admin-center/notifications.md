...
description: Directory Manager 11.0 documentation for notifications with configuration details, usage instructions, and implementation guidance.
---
...
[Localization](/docs/directorymanager/11.0/getting-started/index.md#localization) topic.
...
1. In the Source Code view, click the **Dictionary** tile to view the recommended tags to replace
   ...
   ![tag_dictionary](/img/versioned_docs/directorymanager_11.0/directorymanager/admincenter/notification/tag_dictionary.webp)
...
- Users whose email addresses are specified in the **Send Notification to the following email IDs**
  ...
  [Create a Smart Group Update Schedule](/docs/directorymanager/11.0/administration/admin-center/system-settings.md#create-a-smart-group-update-schedule)
  topic.
- Users whose email addresses are specified in the **Send notification to the following email IDs**
  box in the notification settings of a Reports schedule. See step 11 in the
  [Create a Reports Schedule](/docs/directorymanager/11.0/administration/admin-center/system-settings.md#create-a-reports-schedule)
  topic.
