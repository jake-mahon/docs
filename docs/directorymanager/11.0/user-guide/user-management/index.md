...
- Automate user provisioning and deprovisioning in bulk. See the
  [Synchronize](/docs/directorymanager/11.0/user-guide/synchronization/index.md) section.
- Establish ownership by defining a clear managerial hierarchy with dotted line management. See the
  [Dotted line management](/docs/directorymanager/11.0/user-guide/user-management/user-properties-active-directory.md#dotted-line-management)
  section of the
...
- Delegate user management to end users by enabling them to:
  ...
  - Create and manage users, contacts, and mailboxes in the directory. See the
    [ Create User Objects](/docs/directorymanager/11.0/user-guide/user-management/create-users.md)
    topic.
...
- Link identical users in different directory services, such as Active Directory and Microsoft Entra
  ID. See the [Linked Accounts](/docs/directorymanager/11.0/user-guide/user-management/manage-users.md)
  topic.
