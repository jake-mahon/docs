...
[Generate Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md).
...
- [Generate Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [Manage Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [Group Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [User Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [Contact Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
...
- [Group Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [User Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
- [Computer Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md)
...
![reportsdashboard](/img/versioned_docs/directorymanager_11.0/directorymanager/portal/report/reportsdashboard.webp)
...
[Reports Schedule](/docs/directorymanager/11.0/administration/admin-center/system-settings.md)
...
| Owners and objects they own Listed in [User Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md) category as well. | Provides a list of managers and their direct reports.                                                                                                                                                |
...
3. Click the **Edit** icon next to the report and follow the steps in
   [Generate Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md). Make the
...
| Owners and objects they own Listed in [Group Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md) category as well.              | Provides a list of owners and their direct reports.                                                                                                                                                                     |
...
| Users and contacts with a phone number Listed in [Contact Reports](/docs/directorymanager/11.0/user-guide/reporting/built-in-reports.md) category as well. | Provides a phone list of accounts within an organization.                                                                                                                                                               |
