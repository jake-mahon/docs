...
- If you have already enrolled your identity store account in GroupID, the Authenticate window is
  ...
  authenticate your identity store account with one authentication type.
    ...
    See the
    [Authenticate Your Identity Store Account](/docs/directorymanager/11.0/portal/user/authentication/authenticateaccount.md)
    topic.
...
- [Reset Passwords](/docs/directorymanager/11.0/portal/user/authentication/passwordreset.md)
