...
[Create a Job](/docs/directorymanager/11.0/portal/synchronize/job/create.md) wizard.
...
3. Click the **three vertical dots** icon of the job and select **Schedule** from the menu.
    ...
    [Create a Job](/docs/directorymanager/11.0/portal/synchronize/job/create.md). Update
