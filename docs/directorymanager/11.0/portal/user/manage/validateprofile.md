...
[Disabled Users](/docs/directorymanager/11.0/portal/user/disableduser.md) page of the
portal.
...
the [Find Dialog Box](/docs/directorymanager/11.0/portal/search/find.md), where you can
...
- [Requests](/docs/directorymanager/11.0/portal/request/overview.md)
- [Disabled Users](/docs/directorymanager/11.0/portal/user/disableduser.md)
