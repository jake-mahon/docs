...
- **Users**: can reset their own passwords and their own accounts after passing multifactor
  ...
  as:
    ...
    - **Client Software and Web Access**
        ...
        [ GroupID Credential Provider](/docs/directorymanager/11.0/portal/user/manage/credentialprovider.md)
        ...
        [Install GroupID Credential Provider](/docs/directorymanager/11.0/portal/user/manage/installcp.md)
