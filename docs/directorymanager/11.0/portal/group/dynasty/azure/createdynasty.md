...
3. On the
   [General - Microsoft Entra ID](/docs/directorymanager/11.0/portal/group/dynasty/azure/general.md)page,
   specify basic information about the Dynasty.
4. On the
   [Dynasty Options page](/docs/directorymanager/11.0/portal/group/dynasty/dynastyoptionsorggeocus.md),
...
5. The [Query Designer](/docs/directorymanager/11.0/portal/group/querydesigner/overview.md)
   ...
   external email addresses, which are then grouped by the specified group-by attributes.
    ...
    For details, see the
    [ Smart Group page](/docs/directorymanager/11.0/portal/group/create/activedirectory/smartgroup.md).

6. On the
   [Owners page](/docs/directorymanager/11.0/portal/group/create/activedirectory/owners.md),
...
3. On the
   ...
   specify basic information about the Dynasty.
4. On the
   [Dynasty Options page (Managerial Dynasty)](/docs/directorymanager/11.0/portal/group/dynasty/dynastyoptionsmanagerial.md),
