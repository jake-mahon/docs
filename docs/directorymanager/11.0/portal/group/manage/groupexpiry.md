...
[Set a Default Expiry Policy for Groups](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#set-a-default-expiry-policy-for-groups)
topic.
...
[Set Group Expiry Notifications](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#set-group-expiry-notifications)
topic for additional information.

**See Also**

- [Working with Groups](/docs/directorymanager/11.0/portal/group/manage/workingwithgroups.md)
- [ Group Expiry and Deletion](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/groupexpirydeletion.md)
