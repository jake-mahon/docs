...
[My Deleted Groups](/docs/directorymanager/11.0/portal/group/mydeletedgroups.md) page with
...
See the
[What Happens When a Group is Deleted](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/groupexpirydeletion.md#what-happens-when-a-group-is-deleted)
