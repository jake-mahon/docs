...
1. On the left navigation bar, click **Groups** and then select the **My Groups**, **My
   Memberships**, or **My Expiring Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.0/portal/search/search.md)
...
- When you manually expire a group with an expiry policy other than ‘Never Expire’, the group
  ...
  [My Expired Groups](/docs/directorymanager/11.0/portal/group/myexpiredgroups.md) page.
...
to the [My Expired Groups](/docs/directorymanager/11.0/portal/group/myexpiredgroups.md)
page.
...
See
[Attest an Expiring Group](/docs/directorymanager/11.0/portal/group/manage/attestation.md).
