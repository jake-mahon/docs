...
1. [Directory Search](/docs/directorymanager/11.0/portal/search/search.md) the required
   objects.
2. Select these objects on the **Search Results** page and click **Add to Group** on the toolbar.
3. The [Find Dialog Box](/docs/directorymanager/11.0/portal/search/find.md) is displayed,
   where you can search and select the group(s) to add the objects to.

### Method 2:

1. [Directory Search](/docs/directorymanager/11.0/portal/search/search.md) the group you
...
4. Enter a search string to locate the objects to add as members, or click **Advanced** to use the
   [Find Dialog Box](/docs/directorymanager/11.0/portal/search/find.md) for performing a
   search.
5. Save the changes.
...
1. [Directory Search](/docs/directorymanager/11.0/portal/search/search.md) a group to
...
3. Select the group(s) to add to the membership of another group and click **Add to Group** on the
   toolbar.
4. On the [Find Dialog Box](/docs/directorymanager/11.0/portal/search/find.md), search and
...
1. In GroupID portal, click **Groups** in the left navigation pane, select Groups.
    ...
    [Directory Search](/docs/directorymanager/11.0/portal/search/search.md) the group you
