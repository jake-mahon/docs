...
- [GroupID as a Service Provider](/docs/directorymanager/11.0/configuration/authentication/groupid-as-service-provider.md)
- [GroupID as an Identity Provider](/docs/directorymanager/11.0/configuration/authentication/groupid-as-identity-provider.md)
