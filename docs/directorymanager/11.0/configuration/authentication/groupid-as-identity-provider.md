...
2. On the **Settings** page, the **Base URL** box displays the default Issuer URL, which is
   ...
   [GroupID Metadata for Service Provider Configurations](/docs/directorymanager/11.0/configuration/authentication/groupid-as-identity-provider.md#groupid-metadata-for-service-provider-configurations)
   topic.  
...
- [Authenticate](/docs/directorymanager/11.0/configuration/authentication/index.md)
...
- [Specify Default Metadata Values](/docs/directorymanager/11.0/configuration/authentication/groupid-as-identity-provider.md)
- [Sign In Using GroupID](/docs/directorymanager/11.0/configuration/authentication/groupid-as-identity-provider.md)
