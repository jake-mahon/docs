...
[Start or Stop an Instance](/docs/directorymanager/11.0/admincenter/portal/server/nativeiis.md#start-or-stop-an-instance)
topic.
...
[Manage Log Settings](/docs/directorymanager/11.0/admincenter/portal/server/log.md) topic.

## Delete an Instance

To delete a portal’s deployment instance, see the
[Delete a Deployment Instance for a Portal](/docs/directorymanager/11.0/admincenter/portal/delete.md#delete-a-deployment-instance-for-a-portal)
topic.

**See Also**

- [Server Settings](/docs/directorymanager/11.0/admincenter/portal/server/overview.md)
