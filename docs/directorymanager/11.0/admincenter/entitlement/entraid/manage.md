...
[File Server Details ](/docs/directorymanager/11.0/admincenter/entitlement/ad/manage.md#file-server-details)
...
store. Refer to the
[Search File Servers ](/docs/directorymanager/11.0/admincenter/entitlement/ad/manage.md#search-file-servers)
