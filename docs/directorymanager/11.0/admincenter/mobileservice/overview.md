...
[History in GroupID](/docs/directorymanager/11.0/admincenter/history.md) topic.
...
the [Host a Portal](/docs/directorymanager/11.0/admincenter/portal/create.md#host-a-portal)
topic.
...
- [Server Settings](/docs/directorymanager/11.0/admincenter/mobileservice/server/overview.md),
  that control deployment settings and file logging.
- [Design Settings](/docs/directorymanager/11.0/admincenter/mobileservice/design/overview.md),
...
[Install and Configure the GroupID App](/docs/directorymanager/11.0/admincenter/mobileservice/phonesetup.md)
topic.
