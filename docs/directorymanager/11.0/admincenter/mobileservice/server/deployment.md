...
shown in the
[Launch a Mobile Service or a Service Instance](/docs/directorymanager/11.0/admincenter/mobileservice/create.md#launch-a-mobile-service-or-a-service-instance)
topic.

## View the Data Service and Security Service Bound to an Instance

See the
[View the Data Service and Security Service Bound to an Instance](/docs/directorymanager/11.0/admincenter/portal/server/nativeiis.md#view-the-data-service-and-security-service-bound-to-an-instance)
