...
[Link an SMS Gateway Account to an Identity Store](/docs/directorymanager/11.0/admincenter/identitystore/configure/security/smsauthentication.md#link-an-sms-gateway-account-to-an-identity-store)
topic.
...
[Modify the Email Template](/docs/directorymanager/11.0/admincenter/setupauth/email.md#modify-the-email-template)
topic.
