...
[Retain Complete History Data](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/historytracking.md#retain-complete-history-data)
and
[Retain History for a Specific Period](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/historytracking.md#retain-history-for-a-specific-period)
...
[Event Logging](/docs/directorymanager/11.0/admincenter/identitystore/history/eventlogging.md)
topic.

**See Also**

- [Admin Center History](/docs/directorymanager/11.0/admincenter/general/history.md)
