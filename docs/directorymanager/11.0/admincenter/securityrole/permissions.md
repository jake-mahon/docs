...
[User Roles in Microsoft Entra ID and GroupID](/docs/directorymanager/11.0/admincenter/identitystore/moreinfo/advsentraid.md#user-roles-in-microsoft-entra-id-and-groupid)
topic.
