...
- [Set Up Authentication Types](/docs/directorymanager/11.0/admincenter/setupauth/overview.md)
...
- [Configure Multifactor Authentication](/docs/directorymanager/11.0/admincenter/setupauth/mfa.md)
- [Second Way Authentication - SWA](/docs/directorymanager/11.0/admincenter/identitystore/configure/security/secondwayauthentication.md)
