...
[Auto Delete Expired Groups](/docs/directorymanager/11.0/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#auto-delete-expired-groups)
topic.
