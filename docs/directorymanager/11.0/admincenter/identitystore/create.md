...
[Configure an Identity Store](/docs/directorymanager/11.0/admincenter/identitystore/configure.md)
topic.
...
- **For a service account:** The service account must have sufficient privileges on the provider to
  ...
  [Service Account for Active Directory and Exchange](/docs/directorymanager/11.0/admincenter/identitystore/moreinfo/adserviceaccount.md)
  topic.
- **For a gMSA:** If you provide a service account with
  ...
  [gMSA for Active Directory](/docs/directorymanager/11.0/admincenter/identitystore/moreinfo/gmsarequirements.md)
  topic.
...
- [Service Accounts](/docs/directorymanager/11.0/admincenter/identitystore/moreinfo/overview.md)
