...
See the
[Enable Second Factor Authentication](/docs/directorymanager/11.1/signin/securityrole/policy/authentication.md#enable-second-factor-authentication)
topic for details.

See Also

- [Authentication Policy](/docs/directorymanager/11.1/signin/authpolicy/authpolicy.md)
- [Configure Multifactor Authentication](/docs/directorymanager/11.1/signin/authpolicy/mfa.md)
