...
[Enable Group Attestation](/docs/directorymanager/11.1/signin/identitystore/configure/grouplifecycle.md#enable-group-attestation)
topic.
...
9. Use the **Display Type** drop-down list to specify the display type to use for rendering the
   ...
   [Display Type Categories](/docs/directorymanager/11.1/signin/applications/portal/categories/categories.md) topic.
10. In the **Visibility Level** drop-down list, select a security role. The field would be visible
    ...
    [Priority](/docs/directorymanager/11.1/signin/securityrole/manage.md).  
...
- [Configure User Profile Validation](/docs/directorymanager/11.1/signin/identitystore/configure/profilevalidation.md)
