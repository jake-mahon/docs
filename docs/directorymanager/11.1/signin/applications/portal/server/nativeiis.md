...
[Launch a Portal](/docs/directorymanager/11.1/signin/applications/portal/create.md#launch-a-portal) topic.
...
to access the instance. See the [Launch a Portal](/docs/directorymanager/11.1/signin/applications/portal/create.md#launch-a-portal) topic.
...
[Manage Log Settings](/docs/directorymanager/11.1/signin/applications/portal/server/log.md) topic.

## Delete an Instance

To delete a portal’s deployment instance, see the
[Delete a Deployment Instance for a Portal](/docs/directorymanager/11.1/signin/applications/portal/delete.md#delete-a-deployment-instance-for-a-portal)
topic.
