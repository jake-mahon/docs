...
- **Text box**
    ...
    type from this basic type. See the [Text Box Display Type](/docs/directorymanager/11.1/signin/applications/portal/categories/textbox.md) topic.
...
[Define Custom Display Types](/docs/directorymanager/11.1/signin/applications/portal/categories/custom.md) topic to add more display types as needed.
