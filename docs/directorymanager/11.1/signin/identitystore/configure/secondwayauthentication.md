...
4. On the **Second Way Authentication** page, use the toggle button for **Enable Second Way
   Authentication via Email** to enable it.
    ...
    server. See the [Configure an SMTP Server](/docs/directorymanager/11.1/signin/identitystore/configure/smtpserver.md) topic.
...
- [Configure an SMTP Server](/docs/directorymanager/11.1/signin/identitystore/configure/smtpserver.md)
