...
- **When changes are made to an identity store’s configurations** - Directory Manager enables you to
  track the changes made to an identity store’s configurations, which include the following:
    ...
    See the [Identity Store History](/docs/directorymanager/11.1/signin/identitystore/view/view.md) topic to view the tracked history data.
...
[History Retention Schedule](/docs/directorymanager/11.1/signin/schedule/historyretention.md) topic.
