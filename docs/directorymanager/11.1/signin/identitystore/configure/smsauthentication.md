...
See the [Manage SMS Gateway Accounts](/docs/directorymanager/11.1/signin/smsgateway/manage.md) topic for creating and managing
...
[Authentication Policy for Security Roles](/docs/directorymanager/11.1/signin/securityrole/policy/authentication.md) topic.
...
- [Manage SMS Gateway Accounts](/docs/directorymanager/11.1/signin/smsgateway/manage.md)
