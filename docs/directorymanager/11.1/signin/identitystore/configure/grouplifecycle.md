...
[Group Life Cycle Schedule](/docs/directorymanager/11.1/signin/schedule/grouplifecycle.md) topic.

NOTE: Before you specify a group life cycle policy for a Microsoft Entra ID identity store, see the
[Group Expiration Policy](/docs/directorymanager/11.1/signin/identitystore/advsentraid.md#group-expiration-policy) section in the
[Microsoft Entra ID vs. Active Directory Identity Stores](/docs/directorymanager/11.1/signin/identitystore/advsentraid.md) topic.
...
5. Select one of the following options:
    ...
    - **Reduce group life if not used in last x Days:** select this option button and specify x
      ...
      received any email in the last x number of days.
        ...
        [Specify a Default Approver](/docs/directorymanager/11.1/signin/workflow/advancedsettings.md#specify-a-default-approver)
        topic.
...
- [Schedules](/docs/directorymanager/11.1/signin/schedule/overview.md)
- [ Group Expiry and Deletion](/docs/directorymanager/11.1/signin/identitystore/configure/groupexpirydeletion.md)
