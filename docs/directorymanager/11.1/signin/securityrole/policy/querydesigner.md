...
[Query Designer - General tab](/docs/directorymanager/11.1/welcome/group/querydesigner/general.md) topic.
...
8. You can also create an advanced query by adding more rows and applying the **AND** or **OR**
   operator to group them. See steps 1-2 in the[Advanced Filter](/docs/directorymanager/11.1/signin/securityrole/policy/search.md) section of the
...
- [Security Role Policies](/docs/directorymanager/11.1/signin/securityrole/policy/overview.md)
