...
The timestamp is then used by the [Group Life Cycle Schedule](/docs/directorymanager/11.1/signin/schedule/grouplifecycle.md) to extend or reduce
the life of mail-enabled distribution groups based on their usage. See the
[Enable Group Usage Lifecycle](/docs/directorymanager/11.1/signin/identitystore/configure/grouplifecycle.md#enable-group-usage-lifecycle)
topic.
...
schedule, that, when met, starts the execution of the schedule. See the [Triggers](/docs/directorymanager/11.1/signin/schedule/triggers.md)
...
section of the [Schedules](/docs/directorymanager/11.1/signin/schedule/overview.md) topic for additional information.
