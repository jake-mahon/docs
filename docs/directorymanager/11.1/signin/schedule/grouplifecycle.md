...
[Manage Group Lifecycle Settings](/docs/directorymanager/11.1/signin/identitystore/configure/grouplifecycle.md)
...
[Apply Policy on Specific Containers](/docs/directorymanager/11.1/signin/identitystore/configure/grouplifecycle.md#apply-policy-on-specific-containers)
