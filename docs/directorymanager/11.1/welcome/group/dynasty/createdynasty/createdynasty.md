...
[Modify alias and display name templates](/docs/directorymanager/11.1/welcome/group/workingwithgroups/dynastyfunction.md#modify-alias-and-display-name-templates).
...
3. On the [General page](/docs/directorymanager/11.1/welcome/group/create/group/general.md), specify basic information about
   the Dynasty.
