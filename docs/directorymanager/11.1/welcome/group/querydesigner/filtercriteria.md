...
[Specify a Default Filter Criteria](/docs/directorymanager/11.1/signin/securityrole/policy/querydesigner.md#specify-a-default-filter-criteria)
section of the [ Query Designer Policy](/docs/directorymanager/11.1/signin/securityrole/policy/querydesigner.md)
topic.
