...
| User profile icon    | Displays your profile picture with your name and the identity store that Directory Manager portal is connected to. Click it to launch the menu that displays the option to [Sign Out](/docs/directorymanager/11.1/welcome/login.md#sign-out) of the portal.                                                                                                                            |
...
- [Job Templates](/docs/directorymanager/11.1/welcome/synchronize/manage/jobtemplate.md)
- [Job Collection Template](/docs/directorymanager/11.1/welcome/synchronize/manage/jobcollectiontemplate.md)
