...
pages i.e.[My History](/docs/directorymanager/11.1/welcome/history/myhistory.md), [My Direct Reports' History](/docs/directorymanager/11.1/welcome/history/mydirectreport.md) and My Groups'
History pages.
