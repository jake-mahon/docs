  ...
  as:
    ...
    - Directory Manager portal – Using it, they can:
        ...
        - reset their forgotten passwords. See the
          [Reset Passwords](/docs/directorymanager/11.1/portal/user/authentication/passwordreset.md) topic for further information on how
    ...
    - Client Software and Web Access
        ...
        [ Credential Provider](/docs/directorymanager/11.1/portal/user/manage/credentialprovider.md) and available for distribution using various
        IT enabled distribution methods such as group policy and Microsoft System Center
        Configuration Manager (SCCM). See the [Install Credential Provider](/docs/directorymanager/11.1/portal/user/manage/installcp.md) topic for
