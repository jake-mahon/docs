...
organizational hierarchy you want to view on the [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) dialog
box.
...
On the [Find Dialog Box](/docs/directorymanager/11.1/portal/search/find.md), search and select the required user and click
