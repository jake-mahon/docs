...
[Disabled Users](/docs/directorymanager/11.1/portal/user/disableduser.md) page of the portal.
...
the [Find Dialog Box](/docs/directorymanager/11.1/portal/search/find.md), where you can search and select your primary manager.
