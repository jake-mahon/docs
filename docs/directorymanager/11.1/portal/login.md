...
- Reset forgotten or lost passwords  
  See the [Reset Passwords](/docs/directorymanager/11.1/portal/user/authentication/passwordreset.md) topic for additional information
...
When [Second Factor Authentication](/docs/directorymanager/11.1/portal/user/authentication/secondfactorauthentication.md) is enabled
...
- If you have not enrolled your identity store account in Directory Manager, the Enroll Account
  ...
  authentication type. See the [Enroll your Identity Store Account](/docs/directorymanager/11.1/admincenter/enroll.md) topic
...
- If you have already enrolled your identity store account in Directory Manager, the Authenticate
  ...
  [Authenticate your Identity Store Account](/docs/directorymanager/11.1/admincenter/authenticate.md) topic for additional
  information.
