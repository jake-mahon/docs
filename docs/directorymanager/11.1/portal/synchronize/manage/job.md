...
virtually identical to the [Create a Job](/docs/directorymanager/11.1/portal/synchronize/job/create.md) wizard.
...
It will take you to the **Schedule and Job Notifications** page of [Create a Job](/docs/directorymanager/11.1/portal/synchronize/job/create.md).
