...
- Create New ([Create a Job](/docs/directorymanager/11.1/portal/synchronize/job/create.md) and [Create a Job Collection ](/docs/directorymanager/11.1/portal/synchronize/collection/create.md))
- Dashboard
