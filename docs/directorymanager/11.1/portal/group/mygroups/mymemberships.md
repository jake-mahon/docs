...
You can [Modify Search Directory](/docs/directorymanager/11.1/welcome/group/allgroups/allgroups.md#modify-search-directory) to search your memberships
and add [Filter All Groups](/docs/directorymanager/11.1/welcome/group/allgroups/allgroups.md#filter-all-groups)by clicking **My Memberships Grid
