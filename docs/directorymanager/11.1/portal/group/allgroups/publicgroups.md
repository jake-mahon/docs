...
select the [Expired Groups](/docs/directorymanager/11.1/welcome/group/allgroups/allexpiredgroups.md) or [Deleted Groups](/docs/directorymanager/11.1/welcome/group/recyclebin/overview.md)
respectively.
