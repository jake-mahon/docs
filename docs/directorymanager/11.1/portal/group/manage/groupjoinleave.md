...
1. [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) the group(s) you want to join.
...
1. In Directory Manager portal, click **Groups** in the left navigation pane, select Groups.
    ...
    [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) the group(s) you want to leave.
...
1. On the left navigation bar, click **Groups** and then select the **My Groups**, **My
   Memberships**, or **My Expiring Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) the group you want to join on behalf of
...
1. On the left navigation bar, click **Groups** and then select the **My Groups**, **My
   Memberships**, or **My Expiring Groups** tab.
    ...
    You can also [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) the group you want to leave on behalf of
    a direct report or peer.
