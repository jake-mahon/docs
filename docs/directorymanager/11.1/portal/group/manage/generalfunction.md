...
See [Directory Search](/docs/directorymanager/11.1/portal/search/search.md).

## View object properties

You can view and modify the properties of a mailbox, group, user and contact.

1. [Directory Search](/docs/directorymanager/11.1/portal/search/search.md) the required object.
