...
See the
[What Happens When a Group is Deleted](/docs/directorymanager/11.1/admincenter/identitystore/configure/directoryservice/groupexpirydeletion.md#what-happens-when-a-group-is-deleted)
