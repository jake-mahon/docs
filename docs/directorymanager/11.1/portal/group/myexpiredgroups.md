...
physically delete a group. See the [ Group Deletion](/docs/directorymanager/11.1/portal/group/manage/groupdeletion.md) topic for additional
information.
...
ownership in My Expired Groups** check box on the [Portal Settings](/docs/directorymanager/11.1/portal/setting/portal.md) panel.
