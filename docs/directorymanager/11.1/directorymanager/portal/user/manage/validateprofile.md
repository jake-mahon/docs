...
[Disabled Users](/docs/directorymanager/11.1/directorymanager/portal/user/disableduser.md) page of the portal.
...
the [Find Dialog Box](/docs/directorymanager/11.1/directorymanager/portal/search/find.md), where you can search and select your primary manager.
...
[Requests](/docs/directorymanager/11.1/directorymanager/portal/request/overview.md).
...
the flow changes accordingly. See [Requests](/docs/directorymanager/11.1/directorymanager/portal/request/overview.md).
