...
[Specify a Default Filter Criteria](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/querydesigner.md#specify-a-default-filter-criteria)
section of the [ Query Designer Policy](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/querydesigner.md)
topic.
