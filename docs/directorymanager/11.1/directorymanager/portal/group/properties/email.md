...
[Group properties - Owner tab](/docs/directorymanager/11.1/directorymanager/portal/group/properties/owner.md) in group properties.

- Click **Add** to add an Exchange additional owner. Enter a search string to locate the required
  object, or click **Advance** to use the [Find Dialog Box](/docs/directorymanager/11.1/directorymanager/portal/search/find.md) for performing a
  search.
