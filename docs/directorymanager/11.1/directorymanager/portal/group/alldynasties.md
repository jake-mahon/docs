...
A [Dynasty](/docs/directorymanager/11.1/directorymanager/portal/group/dynasty/overview.md)is a Smart Group that creates and manages other Smart Groups using
