...
10. On the **Configure SAML** tab of the **Create SAML Integration** page, provide the consumer URL
    ...
    [Generate URLs](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/okta/generateurls.md) topic.
...
_Wizard_ using Okta. See the [Sign In Using Okta](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/okta/signin.md) topic.
