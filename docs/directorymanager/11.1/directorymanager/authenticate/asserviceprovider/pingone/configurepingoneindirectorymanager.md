...
4. Make sure the **Client** box displays the name of the Directory Manager client for which you
   ...
   [Generate the Consumer URL and Metadata File](/docs/directorymanager/11.1/directorymanager/authenticate/asserviceprovider/pingone/generatemetadata.md) topic).  
