...
See the [Authentication Modes](/docs/directorymanager/11.1/directorymanager/requirements/setupauthentication.md) topic for information about the roles and
permissions the SQL server and database accounts must have for
[SQL Server Authentication](/docs/directorymanager/11.1/directorymanager/requirements/setupauthentication.md#sql-server-authentication) mode and for
[Windows Authentication](/docs/directorymanager/11.1/directorymanager/requirements/setupauthentication.md#windows-authentication) mode.

**See Also**

- [Create an Identity Store](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/create.md)
