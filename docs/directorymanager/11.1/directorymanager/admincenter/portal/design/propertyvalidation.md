...
[Enable Group Attestation](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#enable-group-attestation)
topic.
...
9. Use the **Display Type** drop-down list to specify the display type to use for rendering the
   ...
   [Display Type Categories](/docs/directorymanager/11.1/directorymanager/admincenter/portal/displaytype/categories.md) topic.
...
- [Configure User Profile Validation](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/profilevalidation.md)
