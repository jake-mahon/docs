...
[Launch a Portal](/docs/directorymanager/11.1/directorymanager/admincenter/portal/create.md#launch-a-portal) topic.
...
to access the instance. See the [Launch a Portal](/docs/directorymanager/11.1/directorymanager/admincenter/portal/create.md#launch-a-portal) topic.
