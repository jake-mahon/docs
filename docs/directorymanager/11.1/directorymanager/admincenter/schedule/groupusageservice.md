...
The timestamp is then used by the [Group Life Cycle Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/grouplifecycle.md) to extend or reduce
...
schedule, that, when met, starts the execution of the schedule. See the [Triggers](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/triggers.md)
