...
[Manage Group Lifecycle Settings](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md)
...
[Apply Policy on Specific Containers](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#apply-policy-on-specific-containers)
...
1. On the Notifications dialog box, select the **Send group life extension notification** check box
   ...
   settings, see the
   [Enable Group Usage Lifecycle](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#enable-group-usage-lifecycle)
   topic for additional information.
2. Click **Save**.
