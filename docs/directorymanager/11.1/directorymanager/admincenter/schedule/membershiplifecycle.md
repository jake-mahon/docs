...
- The Membership Life Cycle schedule executes the Membership Life Cycle policy for the identity
  store. See the
  [Manage Membership Life Cycle Policies](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/directoryservice/membershiplifecycle.md)
  topic.
