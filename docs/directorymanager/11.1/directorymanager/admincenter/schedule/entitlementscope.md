...
- A SharePoint site is added for permission analysis on the Entitlement page in a Microsoft Entra ID
  identity store. See the [Manage SharePoint Sites](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/entraid/manage.md) topic for
...
[GroupID Entitlement Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlement.md), as the latter replicates permissions from scratch.
...
- For file servers, the schedule runs in the context of the service account defined for the identity
  ...
  [Connect to a File Server Using a Different Account](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/ad/manage.md#connect-to-a-file-server-using-a-different-account)
...
- For a SharePoint site, the schedule runs in the context of the account you specified to connect to
  ...
  [Connect to a Site Using a Different Account](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/entraid/manage.md#connect-to-a-site-using-a-different-account)
  topic for additional information.
