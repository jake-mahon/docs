...
- The status of the Elasticsearch service. See the
  [Elasticsearch Service](/docs/directorymanager/11.1/directorymanager/admincenter/general/dashboard.md#elasticsearch-service) card on the Admin Center
  dashboard.
...
[Manage Local Replication Settings](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/replication.md) topic.
...
[Specify Notification Recipients](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/smtpserver.md#specify-notification-recipients)
topic.
...
- [Elasticsearch and Replication ](/docs/directorymanager/11.1/directorymanager/admincenter/replication/overview.md)
- [Manage Local Replication Settings](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/replication.md)
