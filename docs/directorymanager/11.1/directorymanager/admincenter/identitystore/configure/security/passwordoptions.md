...
[Directory Manage Password Policy ](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/password.md) topic.
   ...
   list.
    ...
    - **Regular Expression:** passwords that satisfy the regular expression you specify in the
      **Exception Value** box are not allowed. See the
      [What are Regular Expressions?](/docs/directorymanager/11.1/directorymanager/admincenter/portal/displaytype/textbox.md#what-are-regular-expressions)
