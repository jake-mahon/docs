...
- Public group owner for membership – To send email notifications to the primary and additional
  ...
  [Group Security Types](/docs/directorymanager/11.1/directorymanager/admincenter/general/concepts.md#group-security-types) topic.
...
- [Membership Life Cycle Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/membershiplifecycle.md)
- [Managed By Life Cycle Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/managedbylifecycle.md)
