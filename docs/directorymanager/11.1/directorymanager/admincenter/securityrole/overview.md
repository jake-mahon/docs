...
security roles. See the [Manage Security Roles](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md) and [Create a Security Role](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/create.md)
topics for additional information.

**View security role info**

To view information about a security role, see the
[View Security Roles](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md#view-security-roles) topic.
...
[Configure an Identity Store](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure.md)topic for additional information.
...
criteria. See the [Security Role – Criteria](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/criteria.md) topic.
...
[Priority](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/manage.md).

To view the highest priority role of a user with respect to a Directory Manager client, see the
[Check the Roles of a User](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/checkrole.md) topic.
