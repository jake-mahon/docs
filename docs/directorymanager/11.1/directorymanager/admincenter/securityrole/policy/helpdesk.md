...
[Password Management](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/permissions.md#password-management) in the
...
[Set up Authentication via Security Questions](/docs/directorymanager/11.1/directorymanager/admincenter/setupauth/securityquestions.md) topic.
...
the [Configure an SMTP Server](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/smtpserver.md) topic.
