...
- The Membership Object Type Enforcement policy may conflict with the [Search Policy](/docs/directorymanager/11.1/directorymanager/admincenter/securityrole/policy/search.md) you
...
- The Membership Object Type Enforcement policy may conflict with the static group properties you
  ...
  [Add a Field to a Tab](/docs/directorymanager/11.1/directorymanager/admincenter/portal/design/objectproperties.md#add-a-field-to-a-tab)topic). If the
...
7. Use the **Target(s)** area to specify the groups and/or containers the policy would apply to.
   ...
   groups, or to groups that reside in the specified container(s) and their sub-containers.
    ...
    2. To add groups as target, follow step 9b in the
       [Create a Smart Group Update Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/smartgroupupdate.md#create-a-smart-group-update-schedule)
