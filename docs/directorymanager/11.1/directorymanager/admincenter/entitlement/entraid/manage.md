...
[File Server Details ](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/ad/manage.md#file-server-details) topic for more info. Though in this
...
store. Refer to the [Search File Servers ](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/ad/manage.md#search-file-servers) topic for performing
a search.
...
- The name of the [GroupID Entitlement Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlement.md) that computes the
...
[GroupID Entitlement Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlement.md),
[Entitlement Scope Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlementscope.md), and
[Entitlement Temporary Permissions Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlementtemporarypermissions.md) run
...
The [GroupID Entitlement Schedule](/docs/directorymanager/11.1/directorymanager/admincenter/schedule/entitlement.md) runs on a set frequency to
...
- [Entitlement](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/overview.md)
- [Manage File Servers](/docs/directorymanager/11.1/directorymanager/admincenter/entitlement/ad/manage.md)
