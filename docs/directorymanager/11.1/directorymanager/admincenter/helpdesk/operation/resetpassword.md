...
[Helpdesk Policy ](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/overview.md#helpdesk-policy) topic.
...
2. The **Helpdesk** page opens to the **Helpdesk Operations** tab. Locate your required user. To
   search for a user, see the[Search Users](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/operation/search.md) topic.
3. Click the ellipsis button for the user and select **Reset Password**. For enrolled users, the
   **Reset Password** dialog box has two pages: **Authenticate** and **Reset**. Under the
   ...
   [History in Helpdesk](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/history.md) topic.
