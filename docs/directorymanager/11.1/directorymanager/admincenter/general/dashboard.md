...
notifications in detail. See the [Manage the Notification Queue](/docs/directorymanager/11.1/directorymanager/admincenter/notification/queue.md) topic.
...
![image38](/img/product_docs/directorymanager/directorymanager/admincenter/general/image38.webp)
...
- Hover the mouse over a bar to view the number of users enrolled with the specific authentication
  ...
  [View Users' Information](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/operation/search.md#view-users-information) topic for
...
- Click the arc for successful or failed attempts to view successful/failed authentication attempts
  ...
  **Helpdesk** page to view the logged history for the authentication attempts with the respective
  authentication type. See the [History in Helpdesk](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/history.md) topic.
...
See the [Authentication Policy](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/configure/authpolicy.md) topic for a list of
...
- To view a list of users who used a function on a particular date, click the relevant data point on
  ...
  See the [History in Helpdesk](/docs/directorymanager/11.1/directorymanager/admincenter/helpdesk/history.md) topic. (Notice that the **Filter(s)** dialog
