...
See the [History in Directory Manager](/docs/directorymanager/11.1/directorymanager/admincenter/history.md) and
[Event Logging](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/eventlogging.md) topics for additional information.
...
3. The **Add Note** button is available if you performed this action. See
   [Annotate History Items](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/details.md#annotate-history-items) to manage
   notes.
4. Click **Close**.
...
page. Refer to the [Filter History Data](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/view.md#filter-history-data) topic
...
[Navigate Through History Items](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/view.md#navigate-through-history-items)
topic for help.
...
2. On the **Admin Center History** page, click a history item and proceed to add a note. See the
   [Annotate History Items](/docs/directorymanager/11.1/directorymanager/admincenter/identitystore/history/details.md#annotate-history-items) topic for
   details.
