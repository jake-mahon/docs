...
query defined for a Smart Group can be updated any time using the [Set-SmartGroup](/docs/directorymanager/11.1/directorymanager/managementshell/smartgroup/setsmartgroup.md)
...
[Update-Group](/docs/directorymanager/11.1/directorymanager/managementshell/smartgroup/updategroup.md).
