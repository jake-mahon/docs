...
[Upgrade to Directory Manager 11](/docs/directorymanager/11.1/directorymanager/install/upgrade/upgrade.md) topic for additional information
on upgrade.
...
commandlet. See the [Parameters](/docs/directorymanager/11.1/directorymanager/managementshell/parameters/parameters.md) topic for additional information on
the supported parameters. See the [Parameters](/docs/directorymanager/11.1/directorymanager/managementshell/parameters/parameters.md) topic to get information
