...
[Get-AvailableMessagingServers](/docs/directorymanager/11.1/directorymanager/managementshell/identitystore/getavailablemessagingservers.md) commandlet can be used to retrieve
