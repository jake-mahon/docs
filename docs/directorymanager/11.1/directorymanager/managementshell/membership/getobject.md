...
the [Set the $Credentials Environment Variable](/docs/directorymanager/11.1/directorymanager/managementshell/parameters/setthecredential.md) topic for setting
