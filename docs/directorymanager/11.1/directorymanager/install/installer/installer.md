...
- **[Preparation Tool](/docs/directorymanager/11.1/directorymanager/install/installer/preparationtool.md)** - Detects and instals the prerequisite software and
  Windows features that Directory Manager requires.

- **[Installation Tool](/docs/directorymanager/11.1/directorymanager/install/installer/install.md)** - Installs Directory Manager.

- **[Configuration Tool](/docs/directorymanager/11.1/directorymanager/install/configure/configure.md)** - Configures Directory Manager services,
