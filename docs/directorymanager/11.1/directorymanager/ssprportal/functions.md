...
has enabled for enrollment. See the [Enroll your identity store account](/docs/directorymanager/11.1/directorymanager/admincenter/enroll.md)
topic for enrollment details, starting at step 3.

## Unlock your Account

Click the **Unlock** tile to unlock your account. See the
[Unlock your accounts](/docs/directorymanager/11.1/directorymanager/portal/user/manage/unlockaccount.md) topic for additional information.

## Reset your Account Password

Click the **Reset Password** tile to reset your identity store account password. See the
[Reset Passwords](/docs/directorymanager/11.1/directorymanager/portal/user/authentication/passwordreset.md) topic for additional information.
...
the[ Change your password](/docs/directorymanager/11.1/directorymanager/portal/user/manage/changepassword.md) topic for additional
information.
...
[Linked Accounts](/docs/directorymanager/11.1/directorymanager/portal/user/linkedaccounts.md) topic for additional information.
