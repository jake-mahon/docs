...
1. On the left navigation bar, click **Groups** and then select the **My Groups**, **My
   ...
   You can also [Directory Search](/docs/directorymanager/11.1/misc/directorymanager/portal/search/search.md) the group you want to expire.
...
- When you manually expire a group with an expiry policy other than ‘Never Expire’, the group
  expires and is moved it to the [My Expired Groups](/docs/directorymanager/11.1/group-management/myexpiredgroups.md) page.
...
Logically deleted groups are moved to the [My Deleted Groups](/docs/directorymanager/11.1/group-management/deleting-groups.md) page with the
...
to the [My Expired Groups](/docs/directorymanager/11.1/group-management/myexpiredgroups.md) page.

1. [Directory Search](/docs/directorymanager/11.1/misc/directorymanager/portal/search/search.md) the group you want to change the expiry policy for.
2. Select this group on the **Search Results** page and click **Properties** on the toolbar.

   The group's [Group Properties](/docs/directorymanager/11.1/group-management/overview.md) page is displayed with the **General**
   tab in view.
...
not take effect until verified by an approver. See [Requests](/docs/directorymanager/11.1/index.md).

## Attest an expiring group

See [Attest an Expiring Group](/docs/directorymanager/11.1/group-management/attestation.md).
