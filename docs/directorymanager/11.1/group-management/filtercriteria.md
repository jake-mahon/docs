...
[Specify a Default Filter Criteria](/docs/directorymanager/11.1/administration/security-policies.md#specify-a-default-filter-criteria)
section of the [ Query Designer Policy](/docs/directorymanager/11.1/administration/security-policies.md)
topic.
