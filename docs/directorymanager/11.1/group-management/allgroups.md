...
- [Private Groups](/docs/directorymanager/11.1/group-management/privategroups.md)
- [Semi Private Groups](/docs/directorymanager/11.1/group-management/semiprivategroups.md)
- [Public Groups](/docs/directorymanager/11.1/group-management/publicgroups.md)
- [Expired Groups](/docs/directorymanager/11.1/group-management/allexpiredgroups.md)
- [Expiring Groups](/docs/directorymanager/11.1/group-management/allexpiringgroups.md)
- [Smart Groups](/docs/directorymanager/11.1/group-management/allsmartgroups.md)
- [Dynasties](/docs/directorymanager/11.1/group-management/alldynasties.md)
- [Password Expiry Groups](/docs/directorymanager/11.1/group-management/passwordexpirygroups.md)
- [Teams](/docs/directorymanager/11.1/group-management/teams.md) (for Microsoft Entra ID based identity store)
...
- [Expire a group manually ](/docs/directorymanager/11.1/group-management/groupexpiryfunction.md#expire-a-group-manually). After expiring
...
results per page** setting on the [Portal Settings](/docs/directorymanager/11.1/misc/directorymanager/portal/setting/portal.md) panel.
