...
- [My Memberships](/docs/directorymanager/11.1/group-management/managing-members.md)
- [My Expired Groups](/docs/directorymanager/11.1/group-management/myexpiredgroups.md)
- [My Expiring Groups](/docs/directorymanager/11.1/group-management/myexpiringgroups.md)
- [My Deleted Groups](/docs/directorymanager/11.1/group-management/deleting-groups.md)
- [My Smart Groups](/docs/directorymanager/11.1/group-management/mysmartgroups.md)
- [My Dynasties](/docs/directorymanager/11.1/group-management/mydynasties.md)
- [My Teams](/docs/directorymanager/11.1/group-management/myteams.md) (for Microsoft Entra ID based identity store)
...
My Groups** check box on the [Portal Settings](/docs/directorymanager/11.1/misc/directorymanager/portal/setting/portal.md) panel. This tab lists active
groups only; expired and deleted groups are not displayed.

You can [Modify Search Directory](/docs/directorymanager/11.1/group-management/allgroups.md#modify-search-directory) to search your groups and
add [Filter All Groups](/docs/directorymanager/11.1/group-management/allgroups.md#filter-all-groups)by clicking **My Groups Grid Filters**. All
...
- View and modify the [Group Properties](/docs/directorymanager/11.1/group-management/overview.md) of a group.
...
- Join a group as a [Join a group temporarily](/docs/directorymanager/11.1/group-management/groupjoinleave.md#join-a-group-temporarily) or
...
- Join / leave a group
  [Join or leave a group on behalf of a direct report or peer](/docs/directorymanager/11.1/group-management/groupjoinleave.md#join-or-leave-a-group-on-behalf-of-a-direct-report-or-peer)a
...
- Manually [ Group Deletion](/docs/directorymanager/11.1/group-management/groupdeletion.md) any of your group.
...
page** setting on the [Portal Settings](/docs/directorymanager/11.1/misc/directorymanager/portal/setting/portal.md) panel.
...
You can find [Transfer Ownership](/docs/directorymanager/11.1/group-management/transferownership.md) option on the top right corner. Transfer
