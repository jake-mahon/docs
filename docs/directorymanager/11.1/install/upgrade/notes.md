...
- When you create a new portal in Directory Manager 11, you can import the advanced settings and
  ...
  [Create a Portal in Native IIS](/docs/directorymanager/11.1/signin/applications/portal/create.md#create-a-portal-in-native-iis)
  topic.
...
[Specify Log Settings for a Service](/docs/directorymanager/11.1/signin/service/dataservice/manage.md#specify-log-settings-for-a-service)
topic.
