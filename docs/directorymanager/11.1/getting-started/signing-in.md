...
- If you have not enrolled your identity store account in Directory Manager, the Enroll Account page
  ...
  [Enroll your Identity Store Account](/docs/directorymanager/11.1/getting-started/enrollment.md) topic.
- If you have already enrolled your identity store account in Directory Manager, the Authenticate
  ...
  [Authenticate your Identity Store Account](/docs/directorymanager/11.1/configuration/authentication/ldap-configuration.md) topic.
...
- [Getting Started](/docs/directorymanager/11.1/getting-started/quick-start.md)
