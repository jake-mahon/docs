...
[Authentication Policy](/docs/directorymanager/11.1/configuration/identity-stores.md) topic for a list of supported
...
- For multifactor authentication, a user may have to enroll with more than one authentication type,
  ...
  the[Enforce Authentication Types for Multifactor Authentication](/docs/directorymanager/11.1/configuration/authentication/ldap-configuration.md#enforce-authentication-types-for-multifactor-authentication)
  topic.
...
[Enroll your Account](/docs/directorymanager/11.1/administration/general-settings.md#enroll-your-account) topic for additional
information.
