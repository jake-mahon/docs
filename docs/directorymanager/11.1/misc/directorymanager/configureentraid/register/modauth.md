...
[Registration and Permissions Assignment](/docs/directorymanager/11.1/misc/directorymanager/configureentraid/register/appregister.md) topic.
...
- While creating a Microsoft Entra ID identity store (on the Identity Store Details page of new
  ...
  [Create an Identity Store for Microsoft Entra ID](/docs/directorymanager/11.1/configuration/identity-stores.md#create-an-identity-store-for-microsoft-entra-id)
  section of the [Create an Identity Store](/docs/directorymanager/11.1/configuration/identity-stores.md) topic.
