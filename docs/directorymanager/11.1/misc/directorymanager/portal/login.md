...
- Reset forgotten or lost passwords  
  See the [Reset Passwords](/docs/directorymanager/11.1/user-management/password-management.md) topic for additional information
  on how to reset password.
- Unlock your identity store account  
  See the [Unlock your accounts](/docs/directorymanager/11.1/user-management/unlockaccount.md) topic for additional information on
...
When [Second Factor Authentication](/docs/directorymanager/11.1/user-management/secondfactorauthentication.md) is enabled
...
- If you have not enrolled your identity store account in Directory Manager, the Enroll Account
  ...
  authentication type. See the [Enroll your Identity Store Account](/docs/directorymanager/11.1/getting-started/enrollment.md) topic
...
- If you have already enrolled your identity store account in Directory Manager, the Authenticate
  ...
  [Authenticate your Identity Store Account](/docs/directorymanager/11.1/configuration/authentication/ldap-configuration.md) topic for additional
  information.
