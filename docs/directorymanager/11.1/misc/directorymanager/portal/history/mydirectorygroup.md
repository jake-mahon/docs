...
pages i.e.[My History](/docs/directorymanager/11.1/misc/directorymanager/portal/history/myhistory.md), [My Direct Reports' History](/docs/directorymanager/11.1/misc/directorymanager/portal/history/mydirectreport.md) and My Groups'
History pages.
