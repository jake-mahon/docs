...
1. On the **Schedule Job and Notifications** page:
   ...
   2. In the **Schedule** section, the **Task name** drop down lists the Smart Group Update jobs
      ...
      [Synchronize Schedule](/docs/directorymanager/11.1/automation/synchronization.md)
...
12. Generated workflow request will be displayed in the [Requests](/docs/directorymanager/11.1/index.md)
