...
3. In the **Script Language** section, specify the scripting language you want to use. Select one of
   ...
   - [Visual Basic .NET for Directory Manager (formerly GroupID)](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/script/visualbasicnetbasic.md)
...
5. On the [Selected Fields for object types](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/job/selectedfield.md) type section, click **Add/Edit
...
6. Use the **Map Field** section to map the source and destination fields and to apply
   ...
   1. In the **Key** column, select at least one field to be a unique identifier.
      ...
      - [Map Fields](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/job/mappingfield.md)

        In the Source column of each destination item, select the source fields that contribute
        the data for the destination.

      - **Apply a [Transform](/docs/directorymanager/11.1/index.md)**
