...
2. In the **Schedule** section, the **Task name** drop down lists the Smart Group Update jobs
   ...
   collection. Visit [Synchronize Schedule](/docs/directorymanager/11.1/automation/synchronization.md)
...
Step 9 – Generated workflow request will be displayed in the [Requests](/docs/directorymanager/11.1/index.md)
