...
See the [Identity Stores](/docs/directorymanager/11.1/configuration/identity-stores.md) topic for additional
...
See the [ Data Sources](/docs/directorymanager/11.1/configuration/data-sources.md) topic for additional information
on Data Sources.
