...
Follow the steps to pin a job to the [Dashboard](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/dashboard.md) under the pinned job card.
