...
This will launch [Create a Job](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/job/create.md) wizard. Proceed to map the settings stored in the
