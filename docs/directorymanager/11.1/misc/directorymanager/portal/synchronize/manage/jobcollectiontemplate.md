...
Step 4 – This will launch [Create a Job Collection ](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/collection/create.md) wizard starting from
