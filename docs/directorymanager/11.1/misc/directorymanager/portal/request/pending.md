...
- [Approve a request](/docs/directorymanager/11.1/misc/directorymanager/portal/request/allrequest.md#approve-a-request).
- [Deny a request](/docs/directorymanager/11.1/misc/directorymanager/portal/request/allrequest.md#deny-a-request).
- [Filter requests](/docs/directorymanager/11.1/misc/directorymanager/portal/request/allrequest.md#filter-requests).
