...
[In Step 1 of generating a report:](/docs/directorymanager/11.1/misc/directorymanager/portal/report/generate.md). Make the relevant changes and click Finish to
generate the report.
