...
See the [Deleting a Job](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/manage/job.md#deleting-a-job) section of the
[Manage a Job](/docs/directorymanager/11.1/misc/directorymanager/portal/synchronize/manage/job.md) topic for additional information.
