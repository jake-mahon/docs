...
See the
[Create a Data Source for a Text/CSV File](/docs/directorymanager/11.1/configuration/data-sources.md#create-a-data-source-for-a-textcsv-file)
section of the [Create a Data Source](/docs/directorymanager/11.1/configuration/data-sources.md) topic to create a
