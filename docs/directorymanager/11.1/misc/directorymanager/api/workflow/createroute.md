...
See the [Create a New Workflow](/docs/directorymanager/11.1/workflows/implementation.md#create-a-new-workflow)
section of the [Implement Workflows](/docs/directorymanager/11.1/workflows/implementation.md) topic for additional
information.
