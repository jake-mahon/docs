...
[File Logging](/docs/directorymanager/11.1/admincenter/portal/server/log.md#file-logging) and
[Windows Logging](/docs/directorymanager/11.1/admincenter/portal/server/log.md#windows-logging) topics. Replace references to the
...
table in the
[Change the File Logging Level for a Portal Instance](/docs/directorymanager/11.1/admincenter/portal/server/log.md#change-the-file-logging-level-for-a-portal-instance)topic
