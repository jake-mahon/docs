...
- Admin Center - Actions performed in Admin Center, such as creating identity stores, SMS gateway
  ...
  [Admin Center History](/docs/directorymanager/11.1/admincenter/general/history.md) topic to view the history.
...
- Identity store configurations - Changes made to identity store configurations, including changes
  to security roles and workflows. See the [Identity Store History](/docs/directorymanager/11.1/admincenter/identitystore/history/view.md)
...
[Event Logging](/docs/directorymanager/11.1/admincenter/identitystore/history/eventlogging.md) topic.
