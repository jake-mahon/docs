...
See the [Manage the Local Question Pool](/docs/directorymanager/11.1/admincenter/identitystore/configure/security/securityquestions.md)
topic.
...
- [Manage the Local Question Pool](/docs/directorymanager/11.1/admincenter/identitystore/configure/security/securityquestions.md)
