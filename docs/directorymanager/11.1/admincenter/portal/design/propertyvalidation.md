...
[Enable Group Attestation](/docs/directorymanager/11.1/admincenter/identitystore/configure/directoryservice/grouplifecycle.md#enable-group-attestation)
topic.
...
9. Use the **Display Type** drop-down list to specify the display type to use for rendering the
   ...
   [Display Type Categories](/docs/directorymanager/11.1/admincenter/portal/displaytype/categories.md) topic.
...
16. Select the **Filter Bad Words** check box to ensure that users do not enter any bad word in this
    ...
    page. Matched values cannot be saved. See the [Manage the Bad Words List](/docs/directorymanager/11.1/admincenter/portal/design/badwords.md) topic.
...
- [Configure User Profile Validation](/docs/directorymanager/11.1/admincenter/identitystore/configure/directoryservice/profilevalidation.md)
