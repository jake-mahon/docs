...
See the [Design a Portal with Display Types](/docs/directorymanager/11.1/admincenter/portal/displaytype/overview.md) topic fr additional information.
...
- **Text box**
    ...
    type from this basic type. See the [Text Box Display Type](/docs/directorymanager/11.1/admincenter/portal/displaytype/textbox.md) topic.
...
- **Multi-value**
    ...
    ![multi-value_display_type](/img/product_docs/directorymanager/11.1/admincenter/portal/displaytype/multi-value_display_type.webp)
...
- **DN**
    ...
    ![dn](/img/product_docs/directorymanager/11.1/admincenter/portal/displaytype/dn.webp)
...
[Define Custom Display Types](/docs/directorymanager/11.1/admincenter/portal/displaytype/custom.md) topic to add more display types as needed.
