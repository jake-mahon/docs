...
security roles. See the [Manage Security Roles](/docs/directorymanager/11.1/signin/securityrole/manage.md) and [Create a Security Role](/docs/directorymanager/11.1/signin/securityrole/create.md)
...
[Configure an Identity Store](/docs/directorymanager/11.1/signin/identitystore/configure/configure.md)topic for additional information.
...
criteria. See the [Security Role – Criteria](/docs/directorymanager/11.1/signin/securityrole/criteria.md) topic.
...
[Check the Roles of a User](/docs/directorymanager/11.1/signin/securityrole/checkrole.md) topic.
