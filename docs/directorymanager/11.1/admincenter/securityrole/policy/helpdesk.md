...
[Set up Authentication via Security Questions](/docs/directorymanager/11.1/admincenter/setupauth/securityquestions.md) topic.
...
[Link an SMS Gateway Account to an Identity Store](/docs/directorymanager/11.1/admincenter/identitystore/configure/security/smsauthentication.md#link-an-sms-gateway-account-to-an-identity-store)
topic.  
