...
4. In the **Included File Servers** area on the **Entitlement** page, click the ellipsis button for
   a server and select **Edit**. On the **Edit Server** dialog box:
    ...
    - The name of the [GroupID Entitlement Schedule](/docs/directorymanager/11.1/signin/schedule/entitlement.md) that computes
...
- [Manage SharePoint Sites](/docs/directorymanager/11.1/signin/entitlement/manage_1.md)
