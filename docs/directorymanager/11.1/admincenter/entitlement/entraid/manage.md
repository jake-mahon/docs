...
[File Server Details ](/docs/directorymanager/11.1/admincenter/entitlement/ad/manage.md#file-server-details) topic for more info. Though in this
...
store. Refer to the [Search File Servers ](/docs/directorymanager/11.1/admincenter/entitlement/ad/manage.md#search-file-servers) topic for performing
a search.
...
- [Manage File Servers](/docs/directorymanager/11.1/admincenter/entitlement/ad/manage.md)
