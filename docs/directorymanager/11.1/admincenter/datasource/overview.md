...
[Query Based Advanced Search](/docs/directorymanager/11.1/portal/search/querysearch.md) topic for additional information.
...
the [Query Based Advanced Search](/docs/directorymanager/11.1/portal/search/querysearch.md) topic for additional
information.
