...
- [Manage the Global Question Pool ](/docs/directorymanager/11.1/admincenter/general/globalpool.md)
- [Set up Authentication via Security Questions](/docs/directorymanager/11.1/admincenter/setupauth/securityquestions.md)
