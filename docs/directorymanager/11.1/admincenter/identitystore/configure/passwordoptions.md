...
[Directory Manage Password Policy ](/docs/directorymanager/11.1/signin/securityrole/policy/password.md) topic.
   ...
   list.
    ...
    - **Regular Expression:** passwords that satisfy the regular expression you specify in the
      **Exception Value** box are not allowed. See the
      [What are Regular Expressions?](/docs/directorymanager/11.1/signin/applications/portal/categories/textbox.md#what-are-regular-expressions)
