...
3. After the restart, the Windows logon screen appears as follows:
   ...
   ![Windows Logon screen](/img/product_docs/directorymanager/directorymanager/portal/user/manage/windows_screen.webp)
...
2. Go to the MST Guide folder and run the _Orca-x86_en-us.msi_ application. The Orca console opens:
   ...
   ![Orca console](/img/product_docs/directorymanager/directorymanager/portal/user/manage/orca_console.webp)
...
3. In Orca, click **File** > **Open**. Browse to the Credential Provider folder and load the
   ...
   ![Credential Provider in Orca](/img/product_docs/directorymanager/directorymanager/portal/user/manage/cp_loaded.webp)

4. From the menu, select **Transform** > **New Transform**:

   ![New Transform option](/img/product_docs/directorymanager/directorymanager/portal/user/manage/new_transform.webp)

5. Click **Property** in the left pane, list of the properties are displayed in the **Property**
   main window:

   ![Property page](/img/product_docs/directorymanager/directorymanager/portal/user/manage/property.webp)
...
8. Provide the path of this newly created folder in the **SOURCEPATH** box.
   ...
   ![Property path](/img/product_docs/directorymanager/directorymanager/portal/user/manage/property_path.webp)

9. From the menu, select **Transform** > **Generate Transform**:

   ![Generate Transform option](/img/product_docs/directorymanager/directorymanager/portal/user/manage/generate_transform.webp)
...
1. Launch **Group Policy Management** console by typing _gpmc.msc_ in the **Run** box and clicking
   **OK**. The Group Policy Management Editor opens.
   ...
   ![Group Policy Management console](/img/product_docs/directorymanager/directorymanager/portal/user/manage/gp_policy.webp)
...
2. Right-click the domain or organizational unit for the computers that you want the Credential
   ...
   ![CCreate a GPO in this domain and link it here option](/img/product_docs/directorymanager/directorymanager/portal/user/manage/new_gpo.webp)

   Or

   Right-click the Select **Default Domain Policy** and select **Edit**:

   ![Edit Default Domain Policy option](/img/product_docs/directorymanager/directorymanager/portal/user/manage/edit_gpo.webp)
...
3. In the **Group Policy Management Editor**, click **Computer Configuration** > **Policies** >
   **Software Settings** > **Software installation** > **New** > **Package**.
   ...
   ![New Package option](/img/product_docs/directorymanager/directorymanager/portal/user/manage/software_installation.webp)
...
4. Browse to the shared folder. The folder must have the following files in it:
   ...
   ![Deploy Software ](/img/product_docs/directorymanager/directorymanager/portal/user/manage/deploy_cp.webp)

5. Select **Advanced** and click **Ok**. The following window opens:

   ![Modifications tab](/img/product_docs/directorymanager/directorymanager/portal/user/manage/modification_tab.webp)
