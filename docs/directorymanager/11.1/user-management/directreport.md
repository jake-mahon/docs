...
- Select a direct report and click **Add to Group** on the toolbar to the direct report to the
  membership of a group. The [Find Dialog Box](/docs/directorymanager/11.1/misc/directorymanager/portal/search/find.md) is displayed, where you can
...
[My Direct Reports' History](/docs/directorymanager/11.1/misc/directorymanager/portal/history/mydirectreport.md) topic for additional information.
