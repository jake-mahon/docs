...
description: Directory Manager 11.1 documentation for sms gateway with configuration details, usage instructions, and implementation guidance.
---
...
- [Implement and Deploy a Custom SMS Gateway](/docs/directorymanager/11.1/configuration/sms-gateway.md)
...
- [ISmsGateway.AccountId](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.Clone](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.Password](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.ProxyDomain](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.ProxyHostName](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.ProxyPassword](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.ProxyPort](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.ProxyUsername](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.SendShortMessage](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.TestConnection](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.TestCredentials](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.TestProxy](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.Url](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [ISmsGateway.UserId](/docs/directorymanager/11.1/configuration/sms-gateway.md)

- ShortMessage ([ShortMessage class](/docs/directorymanager/11.1/configuration/sms-gateway.md))

  - [ShortMessage.AccessCode](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [ShortMessage.MaxLength](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [ShortMessage.Message](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [ShortMessage.PhoneNumbers](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [ShortMessage.ReferenceId](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [ShortMessage.Validate](/docs/directorymanager/11.1/configuration/sms-gateway.md)

- SendSmsMessageResult ([SendSmsMessageResult class](/docs/directorymanager/11.1/configuration/sms-gateway.md))
  - [SendSmsMessageResult.ExceptionMessage](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [SendSmsMessageResult.Message](/docs/directorymanager/11.1/configuration/sms-gateway.md)
  - [SendSmsMessageResult.Success](/docs/directorymanager/11.1/configuration/sms-gateway.md)
...
- [ShortMessage class](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [SendSmsMessageResult class](/docs/directorymanager/11.1/configuration/sms-gateway.md)
- [Implement and Deploy a Custom SMS Gateway](/docs/directorymanager/11.1/configuration/sms-gateway.md)
...
| Message property          | Returns the [ShortMessage class](/docs/directorymanager/11.1/configuration/sms-gateway.md) object processed by the [ISmsGateway.SendShortMessage](/docs/directorymanager/11.1/configuration/sms-gateway.md) method. |
...
- [ISMSGateway Members](/docs/directorymanager/11.1/configuration/sms-gateway.md)
...
Returns the [ShortMessage class](/docs/directorymanager/11.1/configuration/sms-gateway.md) object processed by the
[ISmsGateway.SendShortMessage](/docs/directorymanager/11.1/configuration/sms-gateway.md) method.
...
| Member                                                                                         | Description                                                                                                                   |
| ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [ShortMessage.AccessCode](/docs/directorymanager/11.1/configuration/sms-gateway.md) property   | Gets or sets the confirmation code that will be sent to registered mobile phone users.                                        |
| [ShortMessage.MaxLength](/docs/directorymanager/11.1/configuration/sms-gateway.md) property    | Defines the maximum length of an SMS message.                                                                                 |
| [ShortMessage.Message](/docs/directorymanager/11.1/configuration/sms-gateway.md) property      | Gets or sets the supporting message text that will be sent to registered mobile phone users along with the confirmation code. |
| [ShortMessage.PhoneNumbers](/docs/directorymanager/11.1/configuration/sms-gateway.md) property | Gets or sets the list of phone numbers to send the message to.                                                                |
| [ShortMessage.ReferenceId](/docs/directorymanager/11.1/configuration/sms-gateway.md) property  | Gets or sets the reference ID for the text message.                                                                           |
| [ShortMessage.Validate](/docs/directorymanager/11.1/configuration/sms-gateway.md) method       | Validates various elements in an SMS message, such as message length and phone number.                                        |
...
[Create an SMS Gateway Account](/docs/directorymanager/11.1/configuration/sms-gateway.md#create-an-sms-gateway-account) topic.
...
1. Define a class that implements the **ISMSGateway interface** which is defined in the
   ...
   **Imanami.directorymanager.DataTransferObjects.DataContracts.SMS** namespace
   ...
   | Member                                                                                          | Description                                                                                                                                                                                                                                                                                                                                                                 |
   | ----------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
   | [ISmsGateway.SendShortMessage](/docs/directorymanager/11.1/configuration/sms-gateway.md) method | Takes as input the [ShortMessage class](/docs/directorymanager/11.1/configuration/sms-gateway.md) object, which defines elements of the text message, sends messages to the target recipients, and returns the [SendSmsMessageResult class](/docs/directorymanager/11.1/configuration/sms-gateway.md) object, which contains  message delivery status and exception details |
   | [ISmsGateway.TestCredentials](/docs/directorymanager/11.1/configuration/sms-gateway.md) method  | Returns a boolean value indicating whether the credentials for communicating with the SMS gateway are valid.                                                                                                                                                                                                                                                                |
   | [ISmsGateway.TestConnection](/docs/directorymanager/11.1/configuration/sms-gateway.md) method   | Returns a boolean value indicating whether the connection with the SMS gateway is established successfully.                                                                                                                                                                                                                                                                 |
   | [ISmsGateway.TestProxy](/docs/directorymanager/11.1/configuration/sms-gateway.md) method        | Returns a boolean value informing whether the given proxy setting are valid.                                                                                                                                                                                                                                                                                                |
   | [ISmsGateway.Clone](/docs/directorymanager/11.1/configuration/sms-gateway.md) method            | Returns the member-wise clone of the ISMSGateway interface.                                                                                                                                                                                                                                                                                                                 |
   | [ISmsGateway.AccountId](/docs/directorymanager/11.1/configuration/sms-gateway.md) property      | Gets or sets the account ID for connecting to the SMS gateway.                                                                                                                                                                                                                                                                                                              |
   | [ISmsGateway.Password](/docs/directorymanager/11.1/configuration/sms-gateway.md) property       | Gets or sets the password of the user name assigned by the SMS gateway provider.                                                                                                                                                                                                                                                                                            |
   | [ISmsGateway.Url](/docs/directorymanager/11.1/configuration/sms-gateway.md) property            | Gets or sets the URL that the SMS gateway provides for sending messages.                                                                                                                                                                                                                                                                                                    |
   | [ISmsGateway.UserId](/docs/directorymanager/11.1/configuration/sms-gateway.md) property         | Gets or sets the user name assigned to you by the SMS gateway provider.                                                                                                                                                                                                                                                                                                     |
   | [ISmsGateway.ProxyHostName](/docs/directorymanager/11.1/configuration/sms-gateway.md) property  | Gets or sets the host name of the proxy server.                                                                                                                                                                                                                                                                                                                             |
   | [ISmsGateway.ProxyPort](/docs/directorymanager/11.1/configuration/sms-gateway.md) property      | Gets or sets the port number used by the proxy server.                                                                                                                                                                                                                                                                                                                      |
   | [ISmsGateway.ProxyUsername](/docs/directorymanager/11.1/configuration/sms-gateway.md) property  | Gets or set the user name for connecting to the proxy server.                                                                                                                                                                                                                                                                                                               |
   | [ISmsGateway.ProxyPassword](/docs/directorymanager/11.1/configuration/sms-gateway.md) property  | Gets or sets the password of the user account that will be used for connecting to the proxy server.                                                                                                                                                                                                                                                                         |
   | [ISmsGateway.ProxyDomain](/docs/directorymanager/11.1/configuration/sms-gateway.md) property    | Gets or sets the domain name or IP address of the proxy server.                                                                                                                                                                                                                                                                                                             |
