...
![API permissions](/img/product_docs/directorymanager/directorymanager/admincenter/datasource/apipermissions.webp)
...
[Create a Data Source](/docs/directorymanager/11.1/configuration/data-sources.md) topic to modify the info.
...
source to another. See the [Synchronize](/docs/directorymanager/11.1/index.md) topic for additional
information.
...
[Query Based Advanced Search](/docs/directorymanager/11.1/misc/directorymanager/portal/search/querysearch.md) topic for additional information.
...
[Query Designer - Database tab](/docs/directorymanager/11.1/group-management/database.md) topic for additional
information.
...
the [Query Based Advanced Search](/docs/directorymanager/11.1/misc/directorymanager/portal/search/querysearch.md) topic for additional
information.
