...
[Workflow Acceleration Schedule](/docs/directorymanager/11.1/automation/workflow-automation.md) topic.
...
5. Use the **Approver Acceleration** toggle button to apply the approver acceleration settings and
   ...
   the [Modify a Workflow](/docs/directorymanager/11.1/workflows/implementation.md#modify-a-workflow) topic.
