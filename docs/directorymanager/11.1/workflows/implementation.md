...
9. The **Approver Acceleration** check box applies if approver acceleration is enabled for the
   ...
   [Apply Approver Acceleration](/docs/directorymanager/11.1/workflows/acceleration.md#apply-approver-acceleration) topic.
...
[Trigger a Flow from Directory Manager ](/docs/directorymanager/11.1/workflows/integration.md#trigger-a-flow-from-directory-manager) topic.
...
6. To link this workflow to a Power Automate flow, click **Power Automate Settings** in the top
   ...
   [6](/docs/directorymanager/11.1/workflows/integration.md) and onwards in the
   [Link an Identity Store Workflow to a Flow](/docs/directorymanager/11.1/workflows/integration.md#link-an-identity-store-workflow-to-a-flow)
