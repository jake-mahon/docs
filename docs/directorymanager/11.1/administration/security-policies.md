...
[Password Management](/docs/directorymanager/11.1/administration/permissions.md#password-management) in the
...
[Set up Authentication via Security Questions](/docs/directorymanager/11.1/configuration/authentication/authentication-methods.md) topic.
...
the [Configure an SMTP Server](/docs/directorymanager/11.1/configuration/identity-stores.md) topic.
...
- The Membership Object Type Enforcement policy may conflict with the [Search Policy](/docs/directorymanager/11.1/administration/security-policies.md) you
...
- The Membership Object Type Enforcement policy may conflict with the static group properties you
  ...
  [Add a Field to a Tab](/docs/directorymanager/11.1/configuration/portal-customization.md#add-a-field-to-a-tab)topic). If the
...
7. Use the **Target(s)** area to specify the groups and/or containers the policy would apply to.
   ...
   2. To add groups as target, follow step 9b in the
      [Create a Smart Group Update Schedule](/docs/directorymanager/11.1/automation/overview.md#create-a-smart-group-update-schedule)
...
- [Group Owners Policy](/docs/directorymanager/11.1/administration/security-policies.md)
- [Group Name Prefixes](/docs/directorymanager/11.1/administration/services/overview.md)
- [New Object Policy](/docs/directorymanager/11.1/administration/security-policies.md)
- [Search Policy](/docs/directorymanager/11.1/administration/security-policies.md)
- [Authentication Policy for Security Roles](/docs/directorymanager/11.1/configuration/authentication/ldap-configuration.md)
- [Directory Manage Password Policy ](/docs/directorymanager/11.1/administration/security-policies.md)
- [Netwrix Password Policy Enforcer Policies](/docs/directorymanager/11.1/administration/services/overview.md)
- [Helpdesk Policy](/docs/directorymanager/11.1/administration/security-policies.md)
- [Synchronize Policy](/docs/directorymanager/11.1/administration/security-policies.md)
- [Membership Object Type Enforcement Policy](/docs/directorymanager/11.1/administration/security-policies.md)

NOTE: For users with multiple roles, the policies specified for the highest priority role apply (see
[Priority](/docs/directorymanager/11.1/administration/security-roles.md)). The _[Search Policy](/docs/directorymanager/11.1/administration/security-policies.md)_, _[New Object Policy](/docs/directorymanager/11.1/administration/security-policies.md)_,
and _[Group Name Prefixes](/docs/directorymanager/11.1/administration/services/overview.md)_ policy,
...
See the [Configure Password Options](/docs/directorymanager/11.1/configuration/identity-stores.md)
topic.
...
[Query Designer - General tab](/docs/directorymanager/11.1/group-management/general.md) topic.
...
8. You can also create an advanced query by adding more rows and applying the **AND** or **OR**
   operator to group them. See steps 1-2 in the[Advanced Filter](/docs/directorymanager/11.1/administration/security-policies.md) section of the
   [Designate a Criterion for the Search Scope](/docs/directorymanager/11.1/administration/security-policies.md#designate-a-criterion-for-the-search-scope)
   topic.  
...
1. After defining two or more filter expressions, select two or more rows and apply one of these
   ...
   ![search_query](/img/product_docs/directorymanager/directorymanager/admincenter/securityrole/policy/search_query.webp)
