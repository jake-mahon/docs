...
[User Roles in Microsoft Entra ID and Directory Manager ](/docs/directorymanager/11.1/configuration/identity-stores.md#user-roles-in-microsoft-entra-id-and-directory-manager)
topic.
