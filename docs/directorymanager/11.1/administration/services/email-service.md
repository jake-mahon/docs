...
description: Directory Manager 11.1 documentation for email service with configuration details, usage instructions, and implementation guidance.
---
...
[Manage the Notification Queue](/docs/directorymanager/11.1/configuration/notifications.md) topic.
