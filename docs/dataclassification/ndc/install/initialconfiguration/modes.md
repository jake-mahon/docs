...
![processing_modes](/img/product_docs/dataclassification/ndc/install/initialconfiguration/processing_modes.png)
...
Proceed with configuring processing settings. See [Processing Settings](/docs/dataclassification/ndc/install/initialconfiguration/processingsettings.md) next.
