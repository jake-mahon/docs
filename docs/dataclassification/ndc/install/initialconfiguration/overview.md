...
- [Select Processing Mode](/docs/dataclassification/ndc/install/initialconfiguration/modes.md)
- [Processing Settings](/docs/dataclassification/ndc/install/initialconfiguration/processingsettings.md)
- [Add Taxonomy](/docs/dataclassification/ndc/install/initialconfiguration/taxonomies.md)
- [Security](/docs/dataclassification/ndc/install/initialconfiguration/security.md)
- [Configure Health Alerting](/docs/dataclassification/ndc/install/initialconfiguration/healthalert.md)
- [Review Your Configuration](/docs/dataclassification/ndc/install/initialconfiguration/reviewconfig.md)
