...
__NOTE:__ To configure advanced settings, your user account may need advanced privileges. [See Users and Security Settings for more information.](/docs/product_docs/dataclassification/ndc/security/users.md)

[![addbox_thumb_0_0](/static/img/product_docs/dataclassification/ndc/admin/sources/box/addbox_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/addbox.png)
...
| Write Classifications | Identifies whether classifications should be written back to the Box source documents. Classification results can either be written to classification templates or to the generic ‘tags’ property. This is specified using the __Write Configuration__ setting of the source. For more information, see [Use Tagging](/docs/product_docs/dataclassification/ndc/admin/sources/tagging.md) |
...
- [Configure Box for Crawling](/docs/product_docs/dataclassification/ndc/configuration/configinfrastructure/box.md)
- [Manage Sources and Control Data Processing](/docs/product_docs/dataclassification/ndc/admin/sources/manage.md)
