...
![addtogroup](/static/img/product_docs/dataclassification/ndc/admin/sources/sourcegroups/addtogroup.png)
...
![editgroup](/static/img/product_docs/dataclassification/ndc/admin/sources/sourcegroups/editgroup.png)
...
- Set the Re-index period, priority, and credentials for a single source in the group or configure these options for all sources in this group using the "Apply changes to all sources in Source Group" option.
  ...
  ![source_groups_settings](/static/img/product_docs/dataclassification/ndc/admin/sources/sourcegroups/source_groups_settings.png)
...
- [Dynamic Source Groups — Exchange](/docs/product_docs/dataclassification/ndc/admin/sources/sourcegroups/dynamicsourcegroups/exchange.md)
- [Dynamic Source Groups — File Servers](/docs/product_docs/dataclassification/ndc/admin/sources/sourcegroups/dynamicsourcegroups/file.md)
- [Dynamic Source Groups — Google Drive Organization](/docs/product_docs/dataclassification/ndc/admin/sources/sourcegroups/dynamicsourcegroups/googledrive.md)
- [Dynamic Source Groups — SharePoint Online](/docs/product_docs/dataclassification/ndc/admin/sources/sourcegroups/dynamicsourcegroups/sharepoint.md)
