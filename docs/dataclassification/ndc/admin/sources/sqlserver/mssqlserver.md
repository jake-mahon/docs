...
Once you choose to add SQL server source, you opt to add MS SQL server as a source. For more information, go to the main article[SQL Server ](/docs/dataclassification/ndc/admin/sources/sqlserver/addsqlserversource.md).
