...
Once you choose to add SQL server source, you opt to add Oracle server as a source. For more information, go to the main article[SQL Server ](addsqlserversource.md).
