...
The SharePoint dashboard is similar to the main reporting dashboard, with the results filtered to SharePoint types. See [Operations and Health Dashboards](../../reporting/dashboards.md) for more information on the reporting dashboard.
