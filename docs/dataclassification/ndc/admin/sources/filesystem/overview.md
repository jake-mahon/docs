...
[![add_source_wizard_thumb_0_0](/static/img/product_docs/dataclassification/ndc/admin/sources/add_source_wizard_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/sources/add_source_wizard.png)
...
__IMPORTANT!__ To add an NFS share, make sure you have configured it for crawling as described in [Configure NFS File Share for Crawling](/docs/product_docs/dataclassification/ndc/configuration/configinfrastructure/nfsfs.md)
...
__NOTE:__ To configure advanced settings, your user account will need advanced privileges. [See Users and Security Settings for more information.](/docs/product_docs/dataclassification/ndc/security/users.md)
...
| Write classifications | Select if you wish to write classifications directly into the document properties, i.e. use tagging. This applies to DOC/DOCX/XLS/XLSX/PPT/PPTX/PDF.  See also [Manage File System](/docs/product_docs/dataclassification/ndc/admin/sources/filesystem/managefilesystem.md). |
