...
2. Click __Add__.
   ...
   [![boxexclusions_thumb_0_0](/img/product_docs/dataclassification/ndc/admin/sources/dropbox/boxexclusions_thumb_0_0.png)](/docs/dataclassification/resources/images/boxexclusions.png)
