...
3. Select Browse.
   ...
   ![calculationscalculatoricon](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/calculationscalculatoricon.png)
4. On the classified file, click the Calculator icon. You shall see how the classification scores are calculated.

   ![calculations](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/calculations.png)
