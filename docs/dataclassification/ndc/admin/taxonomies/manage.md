...
![createsqltaxonomy](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/createsqltaxonomy.png)

## Import Taxonomies

To import an existing taxonomy go to the Global Settings tab, select __Add__, and then choose one of the import options:
...
SQL taxonomies also be easily merged / updated from the Global Settings page. Select the __Update__ link for the taxonomy that you wish to update to load the taxonomy merge wizard:
...
![mergesqltaxonomystage1](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/mergesqltaxonomystage1.png)

Custom clues can be retained by selecting the option __Retain custom clues__. When enabled, any clues not defined as Predefined will be retained. The Predefined flag can be viewed by selecting the __i__ (information) icon for a clue to display the following dialog:
...
![taxonomyglobalsettings](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/taxonomyglobalsettings.png)
...
1. On the Global Settings tab, go to Taxonomies, select the one you need and click __Compare__.
2. In the Compare dialog, select what taxonomy definition to compare to:
   ...
   - Otherwise, click __No__ and browse to the required comparison file, i.e. the one that current taxonomy definition will be compared to.
