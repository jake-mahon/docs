...
![termsettings](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/termsettings.png)

| Option | Description |
| --- | --- |
| Available for Tagging | Use to prevent any documents getting classified against a class. This would normally only be set to “No” when a class is being used to boost another class – see [Types of Clues](/docs/product_docs/dataclassification/ndc/admin/taxonomies/cluestypes.md#Types-of-Clues) topic for information on terms that use the “Term Boost” type clues. |
