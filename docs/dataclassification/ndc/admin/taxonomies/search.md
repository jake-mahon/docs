...
![searchtab](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/searchtab.png)
...
1. Set up the following properties that will be considered a basis for the search:
   ...
   __NOTE:__  [See Classification Rules (Clues) for more information.](/docs/product_docs/dataclassification/ndc/admin/taxonomies/clues.md)
...
![movementskey](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/movementskey.png)

OR

[![documentmovements_thumb_0_0](/static/img/product_docs/dataclassification/ndc/admin/taxonomies/documentmovements_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/documentmovements.png)
