...
__NOTE:__ To manage the search requests, users require sufficient access rights that are assigned by the __Super User__ (DSAR Administrator). See [DSAR Roles](roles.md) for details on the available roles, their rights and permissions.
...
- Completed – shows all completed requests. Review the [View Search Query Results](viewsearchresults.md) section for instructions on how to complete your request.
