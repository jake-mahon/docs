...
4. Click Filter to start browsing your documents. [See Browse for more information.](/docs/product_docs/dataclassification/ndc/admin/taxonomies/browse.md)
...
4. You can also export displayed page to .csv and .xlsx table or download the whole results.
   ...
   __TIP:__ Upon export, you will be prompted to include any associated document metadata to the report. It can be useful if you want to generate custom security reports. Specify metadata fields and click Export to download report.
