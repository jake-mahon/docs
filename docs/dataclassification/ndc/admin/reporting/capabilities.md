...
Selecting __Analysis__ → Reports in the management console helps a user extract a wealth of information from the NDC index.

The main __Dashboard__ has three high level graphs highlighting the current state of processing:
...
- [Content Distribution Map](/docs/product_docs/dataclassification/ndc/admin/reporting/contentdistributionmap.md)
- [Built-in Reports](/docs/product_docs/dataclassification/ndc/admin/reporting/builtinreportsoverview.md)
