...
To configure these actions, use the Advanced UI dialog window. See [Configure a Workflow using Advanced dialog](createworkflow.md) for details on how to invoke it.
