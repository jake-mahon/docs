...
[![action_migration_common_settings_thumb_0_0](/static/img/product_docs/dataclassification/ndc/admin/workflows/advancedwindow/action_migration_common_settings_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/workflows/action_migration_common_settings.png)
...
| __Redaction Plan__ | If redaction plans have been configured, specify the redaction plan to be applied to the document. See [Redaction](/docs/product_docs/dataclassification/ndc/configuration/redaction.md). | By default, this will be applied to the document at the destination. |
