...
| Import certificate in IIS | You can generate custom certificate in IIS which is enough for test and evaluation purposes. However, for production environments, Netwrix recommends importing certificate used by your company. Contact your security administrator to get the certificate.  __NOTE:__ This certificate need to be installed to the computer where Netwrix Data Classification and all its services run. |
