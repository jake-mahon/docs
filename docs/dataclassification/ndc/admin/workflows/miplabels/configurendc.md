...
2. Complete the MIP Configuration wizard. Review the following mapping table:
   ...
   | Certificate Thumbprint | Provide certificate thumbprint you copied and stored on this step: [Upload the .CER file to Azure](/docs/product_docs/dataclassification/ndc/admin/workflows/miplabels/configureinfrastructure.md#Upload-the-CER-file-to-Azure). |
...
__NOTE:__ If you have any problems applying MIP labels, reinstall C++ redistributable with current .exe file (https://aka.ms/vs/17/release/vc\_redist.x64.exe).
