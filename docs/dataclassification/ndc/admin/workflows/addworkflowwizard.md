...
![workflow_start_wizard_thumb_0_0](../../../../../static/img/product_docs/dataclassification/ndc/admin/workflows/workflow_start_wizard_thumb_0_0.webp)

See next:

- [Step 1. Select Content Type](step1selectcontenttype.md)
- [Step 2. Select Action](step2selectautomatedaction.md)
