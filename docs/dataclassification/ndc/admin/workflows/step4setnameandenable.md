...
3. If you want the documents to be processed immediately after you finish the wizard, select __Enabled__ option. Otherwise, you can select __Disabled__ and change this settings later on using the UI.
   ...
   [![workflow_step4_name_settings_thumb_0_0](/img/product_docs/dataclassification/ndc/admin/workflows/workflow_step4_name_settings_thumb_0_0.png)](/docs/dataclassification/resources/images/workflows/workflow_step4_name_settings.png)
4. When finished, click __Add__ to close the wizard. Your new workflow will be added to the list on the __Workflows__ tab:

   [![workflow_list_thumb_0_0](/img/product_docs/dataclassification/ndc/admin/workflows/workflow_list_thumb_0_0.png)](/docs/dataclassification/resources/images/workflows/workflow_list.png)
