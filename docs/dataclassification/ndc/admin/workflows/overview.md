...
Looking for real-life use cases and walk through examples? Check out Netwrix training materials. Go the[ Netwrix website](https://www.netwrix.com/data_remediation_workflows.html) to find out how you can easily reduce the exposure of your sensitive data.

See next:

- [Managing Workflows](/docs/product_docs/dataclassification/ndc/admin/workflows/manage.md)
- [Workflow Actions](/docs/product_docs/dataclassification/ndc/admin/workflows/actions/actions.md)
