...
![wizard_action_email_thumb_0_0](../../../../../../static/img/product_docs/dataclassification/ndc/admin/workflows/actions/wizard_action_email_thumb_0_0.webp)
...
![action_email_smtp_thumb_0_0](../../../../../../static/img/product_docs/dataclassification/ndc/admin/workflows/actions/action_email_smtp_thumb_0_0.webp)
...
To modify action settings for the certain workflow, select the workflow and use the Advanced UI window, as described in the [Modify Email Alert action settings](../advancedwindow/modifyemailalertaction.md) section.
