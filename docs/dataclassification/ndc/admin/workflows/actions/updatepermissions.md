...
To configure advanced actions or modify action settings, select the workflow and use the Advanced UI window. See [Advanced Actions for SharePoint](/docs/dataclassification/ndc/admin/workflows/advancedwindow/sharepoint.md).
