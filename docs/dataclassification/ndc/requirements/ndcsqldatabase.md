...
6. Go to Options page and make sure that the Recovery model parameter is set to "_Simple_".
   ...
   __NOTE:__ Netwrix recommends that you do not change the recovery model to avoid log files growth.
