...
- Run Cleaner—Runs built-in tool to automate maintenance operations. [See Index Maintenance for more information.](/docs/product_docs/dataclassification/ndc/admin/utilities/indexmaintenance.md)
