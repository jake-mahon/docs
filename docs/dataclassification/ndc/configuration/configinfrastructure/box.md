...
[![box_lic_plans_thumb_0_0](/static/img/product_docs/dataclassification/ndc/configuration/configinfrastructure/box_lic_plans_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/config_infrastructure/box_lic_plans.png)
...
This section describes steps 1 and 2 that are performed on the Box side. Steps 3 and 4 are performed on the Netwrix Data Classification side and described in the [Box](/docs/product_docs/dataclassification/ndc/admin/sources/box/addbox.md)section.
...
3. If you have not created an app before, you will see a screen similar to the one below:
   ...
   ![box_app](/static/img/product_docs/dataclassification/ndc/configuration/configinfrastructure/box_app.png)
...
11. Then you should create a public/private key pair to authenticate the JWT requests made by your app. Navigate to Add and Manage Public Keys and select Generate a Public/Private Keypair.
    ...
    ![box_keys](/static/img/product_docs/dataclassification/ndc/configuration/configinfrastructure/box_keys.png)
