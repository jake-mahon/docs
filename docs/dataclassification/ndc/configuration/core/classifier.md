...
[![core_thumb_0_0](/static/img/product_docs/dataclassification/ndc/configuration/core_thumb_0_0.png)](/docs/product_docs/dataclassification/resources/images/config_system/core.png)
...
- [General Options](/docs/product_docs/dataclassification/ndc/configuration/core/generaloptions.md)
- [You can decrease the Classifier load, targeting it at monitored content only. This means that you can schedule content to be automatically re-classified only when a specific condition or set of conditions are met, or with a minimum time period between runs.](/docs/product_docs/dataclassification/ndc/configuration/core/monitoredcontent.md)
- [conceptClassifier App Options](/docs/product_docs/dataclassification/ndc/configuration/core/conceptclassifier.md) (advanced settings)
- [Engine Options](/docs/product_docs/dataclassification/ndc/configuration/core/engineoptions.md)
...
- Run Cleaner—Run built-in tool to automate maintenance operations. [See Index Maintenance for more information.](/docs/product_docs/dataclassification/ndc/admin/utilities/indexmaintenance.md)
