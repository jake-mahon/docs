...
| Auto-Classification Change Logs | Enables a change log for auto-classification: each "Addition"/"Removal" of a classification against a document will be stored in the database as its classifications change. | Inactive by default. See also [Manage Reports](/docs/dataclassification/ndc/admin/reporting/manage.md) |
...
| [![core_classifier_general_tab_thumb_0_0](/img/product_docs/dataclassification/ndc/configuration/core/core_classifier_general_tab_thumb_0_0.png)](/docs/dataclassification/resources/images/config_system/core_classifier_general_tab.png) |  |  |
