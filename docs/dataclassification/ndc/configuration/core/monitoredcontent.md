...
![core_classifier_mc_terms_thumb_0_0](/img/product_docs/dataclassification/ndc/configuration/core/core_classifier_mc_terms_thumb_0_0.webp)4. When finished, click __Select__, then in the Classifier settings window click __Save__,
