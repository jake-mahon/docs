...
[Configure a Workflow using Advanced dialog](/docs/dataclassification/5.7/admin/workflows/advancedwindow/createworkflow.md) for details on how to invoke it.
