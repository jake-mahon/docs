...
- [Migrate Document](/docs/dataclassification/5.7/admin/workflows/actions/migratedocument.md) including copy and move operations
...
![action_advanced_sp_update_field_thumb_0_0](/img/product_docs/dataclassification/5.7/admin/workflows/advancedwindow/action_advanced_sp_update_field_thumb_0_0.webp)
