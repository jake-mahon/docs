...
- [Create a Workflow using Add Workflow Wizard](/docs/dataclassification/5.7/admin/workflows/addworkflowwizard.md)
- [Configure a Workflow using Advanced dialog](/docs/dataclassification/5.7/admin/workflows/advancedwindow/createworkflow.md)

## Modifying or Deleting a Workflow

To modify a workflow, follow the steps described in the [Edit Workflow settings](/docs/dataclassification/5.7/admin/workflows/editsettings.md)
section.

To delete a workflow, follow the steps described in the [Delete Workflow](/docs/dataclassification/5.7/admin/workflows/delete.md)section.
