...
**NOTE:** See [Index Maintenance](/docs/dataclassification/5.7/admin/utilities/indexmaintenance.md) for more information on these
operations.
...
- [View Results](/docs/dataclassification/5.7/admin/sources/viewcontent.md)
...
[See Users and Security Settings for more information.](/docs/dataclassification/5.7/security/users.md)
...
(i.e. "tagging") settings and apply source-specific parameters. See [Use Tagging](/docs/dataclassification/5.7/admin/sources/tagging.md) for
more information.

See also:

- [Database](/docs/dataclassification/5.7/admin/sources/database/managedatabase.md)
- [Exchange Mailbox](/docs/dataclassification/5.7/admin/sources/database/exchangemailbox.md)
- [Manage File System](/docs/dataclassification/5.7/admin/sources/filesystem/managefilesystem.md)
- [ Google Drive](/docs/dataclassification/5.7/admin/sources/googledrive/managegoogledrive.md)
- [SharePoint](/docs/dataclassification/5.7/admin/sources/sharepoint/introduction.md)
