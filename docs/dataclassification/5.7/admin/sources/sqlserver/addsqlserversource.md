...
2. Select **SQL Server**.
3. Specify [MS SQL Server](/docs/dataclassification/5.7/admin/sources/sqlserver/mssqlserver.md) or [Oracle Server](/docs/dataclassification/5.7/admin/sources/sqlserver/oracleserver.md).
...
![sqlserver_source2](/img/product_docs/dataclassification/5.7/admin/sources/sqlserver/sqlserver_source2.webp)
