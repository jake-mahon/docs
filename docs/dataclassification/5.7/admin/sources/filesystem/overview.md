...
[Configure NFS File Share for Crawling](/docs/dataclassification/5.7/configuration/configinfrastructure/nfsfs.md)
...
| Write classifications       | Select if you wish to write classifications directly into the document properties, i.e. use tagging. This applies to DOC/DOCX/XLS/XLSX/PPT/PPTX/PDF. See also [Manage File System](/docs/dataclassification/5.7/admin/sources/filesystem/managefilesystem.md).                                                                                                                                                                                          |
...
| Text Patterns               | [See Text Processing for more information.](/docs/dataclassification/5.7/configuration/texthandling.md)                                                                                                                                                                                                                                                                                                               |
