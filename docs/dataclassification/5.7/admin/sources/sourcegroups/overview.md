...
- Enable Text Extraction - Allows reading the documents and run classification rules against their
  ...
  to[Step 3. Specify Conditions for Processing](/docs/dataclassification/5.7/admin/workflows/step3specifyconditions.md) article.
...
- [Dynamic Source Groups — Exchange](/docs/dataclassification/5.7/admin/sources/sourcegroups/dynamicsourcegroups/exchange.md)
- [Dynamic Source Groups — File Servers](/docs/dataclassification/5.7/admin/sources/sourcegroups/dynamicsourcegroups/file.md)
- [Dynamic Source Groups — Google Drive Organization](/docs/dataclassification/5.7/admin/sources/sourcegroups/dynamicsourcegroups/googledrive.md)
- [Dynamic Source Groups — SharePoint Online](/docs/dataclassification/5.7/admin/sources/sourcegroups/dynamicsourcegroups/sharepoint.md)
