...
- [Accessing SharePoint Online Using Modern Authentication](/docs/dataclassification/5.7/configuration/configinfrastructure/spomodernauth.md)

![addsharepointonline_thumb_0_0](/img/product_docs/dataclassification/5.7/admin/sources/sharepoint/addsharepointonline_thumb_0_0.webp)
...
| Classification template | Specify the required Classification template for writing classifications. See the [Enable Write Classifications](/docs/dataclassification/5.7/admin/taxonomies/enablewriteclassifications.md) and [Working with SharePoint templates](/docs/dataclassification/5.7/admin/sources/sharepoint/workwithtemplates.md) topics for more information. |
