...
[Database Configuration Wizard](/docs/dataclassification/5.7/admin/sources/database/databaseconfigwizard.md) section.
...
[See Database Configuration Wizard for more information.](/docs/dataclassification/5.7/admin/sources/database/databaseconfigwizard.md)
