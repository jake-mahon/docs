...
the **Super User** (DSAR Administrator). See [DSAR Roles](/docs/dataclassification/5.7/admin/dsar/roles.md) for details on the available
...
- Completed – shows all completed requests. Review the
  [View Search Query Results](/docs/dataclassification/5.7/admin/dsar/viewsearchresults.md) section for instructions on how to complete your
  request.
