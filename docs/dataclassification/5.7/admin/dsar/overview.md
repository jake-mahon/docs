...
For more information, see [DSAR Settings](/docs/dataclassification/5.7/admin/dsar/settings.md).

See next:

- [DSAR Roles](/docs/dataclassification/5.7/admin/dsar/roles.md)
- [DSAR Settings](/docs/dataclassification/5.7/admin/dsar/settings.md)
- [Create Search Requests](/docs/dataclassification/5.7/admin/dsar/crestesearchrequests.md)
- [View Search Query Results](/docs/dataclassification/5.7/admin/dsar/viewsearchresults.md)
