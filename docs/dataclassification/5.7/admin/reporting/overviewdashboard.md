...
- [User Management](/docs/dataclassification/5.7/security/usermanagement.md)
- [Built-in Taxonomies Overview ](/docs/dataclassification/5.7/admin/taxonomies/builtintaxonomies.md)

The dashboard is the home page for the administrative web console.

![sensitive_dashboard_thumb_0_0](/img/product_docs/dataclassification/5.7/admin/reporting/sensitive_dashboard_thumb_0_0.webp)
...
- Locate the Data Analysis top level menu and select Reports:
    ...
    ![switch_dashboard](/img/product_docs/dataclassification/5.7/admin/reporting/switch_dashboard.webp)
...
- Sensitive Files – helps you identify how many files have been tagged at least once in any of
  ...
  Review the [Built-in Taxonomies Overview ](/docs/dataclassification/5.7/admin/taxonomies/builtintaxonomies.md) section for the
...
1. Select Custom view in the upper left corner of the dashboard.
    ...
    ![dashboard_filters_thumb_0_0](/img/product_docs/dataclassification/5.7/admin/reporting/dashboard_filters_thumb_0_0.webp)
