...
[Classification Rules (Clues)](/docs/dataclassification/5.7/admin/taxonomies/clues.md) for details.

- To create a taxonomy, go to the **Taxonomies** area of the web-based management console and follow
  the procedures described in [Add a Taxonomy](/docs/dataclassification/5.7/admin/taxonomies/add.md) section.
- To manage the taxonomies, follow the procedures described in [Manage Taxonomies](/docs/dataclassification/5.7/admin/taxonomies/manage.md)
  section.
...
- [Taxonomy Settings](/docs/dataclassification/5.7/admin/taxonomies/settings.md)
