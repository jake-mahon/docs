...
use. See the [User Management](/docs/dataclassification/5.7/security/usermanagement.md) section for more information on
users' permissions.
...
**Step 1 –** Add a new taxonomy. See the [Add a Taxonomy](/docs/dataclassification/5.7/admin/taxonomies/add.md) topic for additional information.
...
[Classification Reports](/docs/dataclassification/5.7/admin/reporting/classificationreports.md) topic for additional information.
