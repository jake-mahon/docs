...
[See Classification Rules (Clues) for more information.](/docs/dataclassification/5.7/admin/taxonomies/clues.md)
...
[Search Documents by Clue](/docs/dataclassification/5.7/admin/taxonomies/search.md).
