...
- [Import Virtual Machine from Image to VMware](/docs/dataclassification/5.7/virtualappliance/importvmfromimagetovmware.md)
- [Import Virtual Machine from Image to Hyper-V ](/docs/dataclassification/5.7/virtualappliance/importvmfromimagetohyperv.md)
