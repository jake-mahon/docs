...
![iis_thumb_0_0](/img/product_docs/dataclassification/5.7/security/iis_thumb_0_0.webp)
...
![adduser](/img/product_docs/dataclassification/5.7/security/adduser.webp)
...
![userpermissions_thumb_0_0](/img/product_docs/dataclassification/5.7/security/userpermissions_thumb_0_0.webp)

### Taxonomy Permissions Summary

The Permissions window lets you restruct permissions for a user.

![viewtaxonomypermissionssummary_thumb_0_0](/img/product_docs/dataclassification/5.7/security/viewtaxonomypermissionssummary_thumb_0_0.webp)

You can restrict permissions for a user to the following areas:

- Sources. See [Content Sources](/docs/dataclassification/5.7/admin/sources/introduction.md) for additional information.
- Taxonomies. See [Taxonomies](/docs/dataclassification/5.7/admin/taxonomies/introduction.md) for additional information.
- Workflows. See [Understanding Workflows](/docs/dataclassification/5.7/admin/workflows/overview.md) for additional
  information.
- Configuration options. See [Configuration Options](/docs/dataclassification/5.7/configuration/configuration.md) for
  additional information.
- Users. See [Users and Security Settings](/docs/dataclassification/5.7/security/users.md) for additional information.
- Reports. See [Reporting Capabilities](/docs/dataclassification/5.7/admin/reporting/capabilities.md) for additional
  information.
- DSARs. See [Data Subject Access Requests ](/docs/dataclassification/5.7/admin/dsar/overview.md) for additional information.
