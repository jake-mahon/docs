...
information, refer to [Hardware Requirements](/docs/dataclassification/5.7/requirements/hardwarerequirements.md).
...
[Software Requirements](/docs/dataclassification/5.7/requirements/softwarerequirements.md).
...
[Requirements to Deploy Virtual Appliance](/docs/dataclassification/5.7/virtualappliance/systemrequirements.md).

Remember that for production environments, your NDC Server and database server must meet the
[Requirements to Install Netwrix Data Classification](/docs/dataclassification/5.7/requirements/overview.md). Virtual
...
[See Configuring NDC Servers Cluster and Load Balancing with DQS Mode for more information.](/docs/dataclassification/5.7/requirements/dqsmode.md)
