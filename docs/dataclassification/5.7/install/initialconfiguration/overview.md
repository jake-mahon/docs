...
- [Select Processing Mode](/docs/dataclassification/5.7/install/initialconfiguration/modes.md)
- [Processing Settings](/docs/dataclassification/5.7/install/initialconfiguration/processingsettings.md)
- [Add Taxonomy](/docs/dataclassification/5.7/install/initialconfiguration/taxonomies.md)
- [Security](/docs/dataclassification/5.7/install/initialconfiguration/security.md)
- [Configure Health Alerting](/docs/dataclassification/5.7/install/initialconfiguration/healthalert.md)
- [Review Your Configuration](/docs/dataclassification/5.7/install/initialconfiguration/reviewconfig.md)
