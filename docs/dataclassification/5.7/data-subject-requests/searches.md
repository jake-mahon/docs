...
the **Super User** (DSAR Administrator). See [DSAR Roles](/docs/dataclassification/5.7/data-subject-requests/roles.md) for details on the available
...
- Completed – shows all completed requests. Review the
  [View Search Query Results](/docs/dataclassification/5.7/data-subject-requests/view-results.md) section for instructions on how to complete your
  request.
