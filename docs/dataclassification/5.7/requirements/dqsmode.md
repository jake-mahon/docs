...
1. Install and configure the first Netwrix Data Classification Server as described in the
   [Install Netwrix Data Classification](/docs/dataclassification/5.7/install/overview.md) section.
...
7. Prepare to install other Netwrix Data Classification Server instances, assuming each server
   ...
   [Hardware Requirements](/docs/dataclassification/5.7/requirements/hardwarerequirements.md) and general
...
8. On each server, follow the installation steps as described in the
   [Install Netwrix Data Classification](/docs/dataclassification/5.7/install/overview.md) section until SQL Database
   configuration.
...
[See Operations and Health Dashboards for more information.](/docs/dataclassification/5.7/admin/reporting/dashboards.md)
