...
[SQL Server ](/docs/dataclassification/5.7/admin/sources/sqlserver/addsqlserversource.md) topic for additional information.
...
new wizard. See the
[Step 3. Specify Conditions for Processing](/docs/dataclassification/5.7/admin/workflows/step3specifyconditions.md) topic for
...
[Types of Clues](/docs/dataclassification/5.7/admin/taxonomies/cluestypes.md) topic for additional information.
...
[Migrate Document](/docs/dataclassification/5.7/admin/workflows/actions/migratedocument.md) topic for additional information.
...
[Enable Write Classifications](/docs/dataclassification/5.7/admin/taxonomies/enablewriteclassifications.md) topic for
additional information.

## Bug Fix List

See the
[Netwrix Data Classification v5.7 Bug Fix List](https://helpcenter.netwrix.com/bundle/DataClassification_5.7_ReleaseNotes/resource/Netwrix_DataClassification_5.7_BugFixList.pdf)
