...
- [Step 1. Select Content Type](/docs/dataclassification/5.7/ndc/admin/workflows/step1selectcontenttype.md)
- [Step 2. Select Action](/docs/dataclassification/5.7/ndc/admin/workflows/step2selectautomatedaction.md)
- [Step 3. Specify Conditions for Processing](/docs/dataclassification/5.7/ndc/admin/workflows/step3specifyconditions.md)
- [Step 4. Enter Name and Review Settings](/docs/dataclassification/5.7/ndc/admin/workflows/step4setnameandenable.md)
...
**Advanced**. See [Configure a Workflow using Advanced dialog](/docs/dataclassification/5.7/ndc/admin/workflows/advancedwindow/createworkflow.md)
