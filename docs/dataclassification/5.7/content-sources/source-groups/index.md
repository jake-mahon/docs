...
- Enable Text Extraction - Allows reading the documents and run classification rules against their
  ...
  to[Step 3. Specify Conditions for Processing](/docs/dataclassification/5.7/workflows/create-workflow/specify-conditions.md) article.
...
- [Dynamic Source Groups — Exchange](/docs/dataclassification/5.7/content-sources/source-groups/dynamic-groups/exchange.md)
- [Dynamic Source Groups — File Servers](/docs/dataclassification/5.7/content-sources/source-groups/dynamic-groups/file.md)
- [Dynamic Source Groups — Google Drive Organization](/docs/dataclassification/5.7/content-sources/source-groups/dynamic-groups/google-drive.md)
- [Dynamic Source Groups — SharePoint Online](/docs/dataclassification/5.7/content-sources/source-groups/dynamic-groups/sharepoint.md)
