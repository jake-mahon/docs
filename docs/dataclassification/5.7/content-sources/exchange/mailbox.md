...
| Certificate thumbprint | Enter the certificate thumbprint you prepared at [Step 4: Configure Certificates & secrets](/docs/dataclassification/5.7/configuration/infrastructure/exchange/exchange-online-mfa.md#step-4-configure-certificates--secrets).                                                                                          |
