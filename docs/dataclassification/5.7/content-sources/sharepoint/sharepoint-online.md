...
- [Accessing SharePoint Online Using Modern Authentication](/docs/dataclassification/5.7/configuration/infrastructure/sharepoint/modern-auth.md)
...
| Classification template | Specify the required Classification template for writing classifications. See the [Enable Write Classifications](/docs/dataclassification/5.7/taxonomies/advanced/write-classifications.md) and [Working with SharePoint templates](/docs/dataclassification/5.7/content-sources/sharepoint/templates.md) topics for more information. |
