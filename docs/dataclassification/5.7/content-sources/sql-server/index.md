...
2. Select **SQL Server**.
3. Specify [MS SQL Server](/docs/dataclassification/5.7/content-sources/sql-server/mssql.md) or [Oracle Server](/docs/dataclassification/5.7/content-sources/sql-server/oracle.md).
