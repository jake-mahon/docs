...
[Database Configuration Wizard](/docs/dataclassification/5.7/content-sources/databases/configuration-wizard.md) section.
...
[See Database Configuration Wizard for more information.](/docs/dataclassification/5.7/content-sources/databases/configuration-wizard.md)
