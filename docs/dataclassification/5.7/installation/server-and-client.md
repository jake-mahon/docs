...
information, refer to [Hardware Requirements](/docs/dataclassification/5.7/getting-started/requirements/hardware.md).
...
[Requirements to Install Netwrix Data Classification](/docs/dataclassification/5.7/getting-started/requirements/index.md). Virtual
...
[See Configuring NDC Servers Cluster and Load Balancing with DQS Mode for more information.](/docs/dataclassification/5.7/getting-started/requirements/databases.md)
