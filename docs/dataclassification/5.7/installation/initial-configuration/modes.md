...
Proceed with configuring processing settings. See [Processing Settings](/docs/dataclassification/5.7/installation/initial-configuration/processing-settings.md) next.
