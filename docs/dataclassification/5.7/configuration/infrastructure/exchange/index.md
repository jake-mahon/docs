...
1. [Create Azure AD app for Modern Authentication](/docs/dataclassification/5.7/configuration/infrastructure/exchange/exchange-online-mfa.md)
2. Configure [Exchange Server](/docs/dataclassification/5.7/content-sources/exchange/server.md) source
   settings.
