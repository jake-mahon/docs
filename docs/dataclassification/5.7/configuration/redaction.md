...
![configredactionplans](/img/product_docs/dataclassification/5.7/configuration/configredactionplans.webp)

## Redaction Entity Groups

Entity Groups can be used to add redaction entities to specific groups.

![redactionentitygroups](/img/product_docs/dataclassification/5.7/configuration/redactionentitygroups.webp)
...
![configredactionentities](/img/product_docs/dataclassification/5.7/configuration/configredactionentities.webp)
