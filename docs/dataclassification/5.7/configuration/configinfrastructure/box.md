...
![box_lic_plans_thumb_0_0](/img/product_docs/dataclassification/5.7/configuration/configinfrastructure/box_lic_plans_thumb_0_0.webp)
...
[Box](/docs/dataclassification/5.7/admin/sources/box/addbox.md)section.
...
3. If you have not created an app before, you will see a screen similar to the one below:
    ...
    ![box_app](/img/product_docs/dataclassification/5.7/configuration/configinfrastructure/box_app.webp)
