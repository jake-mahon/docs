...
1. [Create Azure AD app for Modern Authentication](/docs/dataclassification/5.7/configuration/configinfrastructure/azureappexchangeonlinemfa.md)
2. Configure [Exchange Server](/docs/dataclassification/5.7/admin/sources/exchangemailbox/exchangeserver.md) source
   settings.
