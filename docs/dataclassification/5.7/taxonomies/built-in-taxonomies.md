...
sidebar_label: Built In Taxonomies
...
use. See the [User Management](/docs/dataclassification/5.7/configuration/security/user-management.md) section for more information on
users' permissions.
...
**Step 1 –** Add a new taxonomy. See the [Add a Taxonomy](/docs/dataclassification/5.7/taxonomies/create-taxonomy.md) topic for additional information.
...
[Classification Reports](/docs/dataclassification/5.7/reporting/built-in-reports/classification-reports.md) topic for additional information.
