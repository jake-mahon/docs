...
- [Step 1. Select Content Type](/docs/dataclassification/5.7/workflows/create-workflow/select-content-type.md)
- [Step 2. Select Action](/docs/dataclassification/5.7/workflows/create-workflow/select-action.md)
- [Step 3. Specify Conditions for Processing](/docs/dataclassification/5.7/workflows/create-workflow/specify-conditions.md)
- [Step 4. Enter Name and Review Settings](/docs/dataclassification/5.7/workflows/create-workflow/set-name-enable.md)
...
**Advanced**. See [Configure a Workflow using Advanced dialog](/docs/dataclassification/5.7/workflows/advanced-configuration/index.md)
