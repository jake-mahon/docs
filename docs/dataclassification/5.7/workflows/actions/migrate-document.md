...
sidebar_label: Migrate Document
...
[Configure destinations for Migration action](/docs/dataclassification/5.7/workflows/migration-destinations.md).
...
window. See [Modify Migration action settings](/docs/dataclassification/5.7/workflows/advanced-configuration/migration.md) for more information.
