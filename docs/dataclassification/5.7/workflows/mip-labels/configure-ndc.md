...
2. Complete the MIP Configuration wizard. Review the following mapping table:
   ...
   | Certificate Thumbprint      | Provide certificate thumbprint you copied and stored on this step: [Upload the .CER file to Azure](/docs/dataclassification/5.7/workflows/mip-labels/configure-infrastructure.md). |
