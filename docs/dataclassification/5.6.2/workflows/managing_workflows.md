...
[Edit Workflow settings](/docs/dataclassification/5.6.2/workflows/edit_workflow_settings.md)
section.

To delete a workflow, follow the steps described in the
[Delete Workflow](/docs/dataclassification/5.6.2/workflows/delete_workflow.md)section.
