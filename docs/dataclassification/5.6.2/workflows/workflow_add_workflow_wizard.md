...
![workflow_start_wizard_thumb_0_0](/img/product_docs/dataclassification/5.6.2/workflows/workflow_start_wizard_thumb_0_0.webp)

See next:

- [Step 1. Select Content Type](/docs/dataclassification/5.6.2/workflows/step_1_select_content_type.md)
- [Step 2. Select Action](/docs/dataclassification/5.6.2/workflows/step_2_select_automated_action.md)
- [Step 3. Specify Conditions for Processing](/docs/dataclassification/5.6.2/workflows/step_3_specify_conditions.md)
- [Step 4. Enter Name and Review Settings](/docs/dataclassification/5.6.2/workflows/step_4_set_name_and_enable.md)
