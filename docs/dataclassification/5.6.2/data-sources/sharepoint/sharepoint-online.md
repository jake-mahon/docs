...
- [Access SharePoint Online using modern authentication](/docs/dataclassification/5.6.2/configuration/infrastructure/sharepoint-configuration.md)
...
| Classification template | Specify the required Classification template for writing classifications. See the Enable Write Classifications and [Working with SharePoint templates](/docs/dataclassification/5.6.2/data-sources/sharepoint/sharepoint-templates.md) topics for more information. |
