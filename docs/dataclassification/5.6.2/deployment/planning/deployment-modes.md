...
[Requirements to Deploy Virtual Appliance](/docs/dataclassification/5.6.2/getting-started/requirements/system-requirements.md).
...
[See Configuring NDC Servers Cluster and Load Balancing with DQS Mode for more information.](/docs/dataclassification/5.6.2/deployment/planning/deployment-modes.md)
...
1. Install and configure the first Netwrix Data Classification Server as described in the
   [Install Netwrix Data Classification](/docs/dataclassification/5.6.2/deployment/installation/installation-guide.md)
   section.
...
5. On the DQS tab, click Add to add servers you prepared, one by one.
   ...
   ![dqs_mode_page_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_mode_page_thumb_0_0.webp)
...
![dqs_servers_list_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/deployment/dqs_servers_list_thumb_0_0.webp)
...
[See Operations and Health Dashboards for more information.](/docs/dataclassification/5.6.2/reporting-analytics/dashboards/overview-dashboard.md)
