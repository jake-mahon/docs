...
- [Import Virtual Machine from Image to VMware](/docs/dataclassification/5.6.2/deployment/appliance/deploy-vmware.md)
- [Import Virtual Machine from Image to Hyper-V ](/docs/dataclassification/5.6.2/deployment/appliance/deploy-hyperv.md)
