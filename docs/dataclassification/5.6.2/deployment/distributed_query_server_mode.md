...
1. Install and configure the first Netwrix Data Classification Server as described in the
   [Install Netwrix Data Classification](/docs/dataclassification/5.6.2/deployment/installation.md)
   section.
...
7. Prepare to install other Netwrix Data Classification Server instances, assuming each server
   ...
   [Hardware Requirements](/docs/dataclassification/5.6.2/deployment/hardware_requirements.md)
   and general
