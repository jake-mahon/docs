...
5. On the DQS tab, click Add to add servers you prepared, one by one.
    ...
    ![dqs_mode_page_thumb_0_0](/img/product_docs/dataclassification/5.6.2/deployment/dqs_mode_page_thumb_0_0.webp)
...
![dqs_servers_list_thumb_0_0](/img/product_docs/dataclassification/5.6.2/deployment/dqs_servers_list_thumb_0_0.webp)
