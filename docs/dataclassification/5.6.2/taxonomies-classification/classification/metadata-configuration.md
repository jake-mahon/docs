...
![configdocumentmetadatafields_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/configdocumentmetadatafields_thumb_0_0.webp)
...
![configmetadatafieldmappings_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/configmetadatafieldmappings_thumb_0_0.webp)

## Metadata Value Mappings

This list allows metadata values to be mapped from a source value to a new target value.

![configmetadatavaluemappings_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/configmetadatavaluemappings_thumb_0_0.webp)
...
clicking the![arrowup](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/arrowup.webp)
or ![arrowadown](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/arrowadown.webp)
arrows.

For example, if your document is owned or authored by you, but not modified or created, you may
choose this priority:

![owner_mapping_priorities_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/configuration/owner_mapping_priorities_thumb_0_0.webp)
