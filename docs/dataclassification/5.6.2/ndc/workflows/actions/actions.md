...
- Generic actions available for any type of document. These are:
    ...
    - [Email Alert](/docs/dataclassification/5.6.2/ndc/workflows/actions/workflows_email.md)
    - Migration
    - [Apply Additional Classification](/docs/dataclassification/5.6.2/ndc/workflows/advanced_window/advanced_actions_classification.md)
