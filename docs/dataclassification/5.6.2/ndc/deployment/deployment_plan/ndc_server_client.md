...
[Requirements to Install Netwrix Data Classification](/docs/dataclassification/5.6.2/ndc/deployment/requirements_intro.md).
...
[See Configuring NDC Servers Cluster and Load Balancing with DQS Mode for more information.](/docs/dataclassification/5.6.2/ndc/deployment/distributed_query_server_mode.md)
