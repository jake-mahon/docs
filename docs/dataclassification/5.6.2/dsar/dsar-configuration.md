...
[See DSAR Roles for more information.](/docs/dataclassification/5.6.2/security-administration/user-management/dsar-roles.md)
...
- [DSAR Roles](/docs/dataclassification/5.6.2/security-administration/user-management/dsar-roles.md)
- [Create Search Requests](/docs/dataclassification/5.6.2/dsar/dsar-searches.md)
