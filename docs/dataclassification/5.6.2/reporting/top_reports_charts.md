...
![reports_main_dashboard_thumb_0_0](/img/product_docs/dataclassification/5.6.2/reporting/reports_main_dashboard_thumb_0_0.webp)
...
- **Content Distribution** —Allows you to view the distribution of your content in several formats:
  ...
  [Content Distribution Map](/docs/dataclassification/5.6.2/reporting/content_distribution.md)
  for details.
...
![recent_document_processing_thumb_0_0](/img/product_docs/dataclassification/5.6.2/reporting/recent_document_processing_thumb_0_0.webp)
