...
- [General Options](/docs/dataclassification/5.6.2/configuration/core/classifier_general.md)
- [Monitored Content](/docs/dataclassification/5.6.2/configuration/core/classifier_monitored_content.md)
- [conceptClassifier App Options](/docs/dataclassification/5.6.2/configuration/core/classifier_app.md)
  (advanced settings)
- [Engine Options](/docs/dataclassification/5.6.2/configuration/core/classifier_engine.md)
...
- Run Cleaner—Run built-in tool to automate maintenance operations.
  [See Index Maintenance for more information.](/docs/dataclassification/5.6.2/utilities/utilities_cleaner.md)
