...
![configdocumentmetadatafields_thumb_0_0](/img/product_docs/dataclassification/5.6.2/configuration/configdocumentmetadatafields_thumb_0_0.webp)
...
![configmetadatafieldmappings_thumb_0_0](/img/product_docs/dataclassification/5.6.2/configuration/configmetadatafieldmappings_thumb_0_0.webp)

## Metadata Value Mappings

This list allows metadata values to be mapped from a source value to a new target value.

![configmetadatavaluemappings_thumb_0_0](/img/product_docs/dataclassification/5.6.2/configuration/configmetadatavaluemappings_thumb_0_0.webp)
...
clicking the![arrowup](/img/product_docs/dataclassification/5.6.2/configuration/arrowup.webp)
or ![arrowadown](/img/product_docs/dataclassification/5.6.2/configuration/arrowadown.webp)
arrows.

For example, if your document is owned or authored by you, but not modified or created, you may
choose this priority:

![owner_mapping_priorities_thumb_0_0](/img/product_docs/dataclassification/5.6.2/configuration/owner_mapping_priorities_thumb_0_0.webp)
