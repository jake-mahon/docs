...
[Database Configuration Wizard](/docs/dataclassification/5.6.2/sources/database/database_config_wizard.md)
section.
...
![add_database_thumb_0_0](/img/product_docs/dataclassification/5.6.2/sources/database/add_database_thumb_0_0.webp)
...
[See Database Configuration Wizard for more information.](/docs/dataclassification/5.6.2/sources/database/database_config_wizard.md)
