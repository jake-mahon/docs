...
[Configure NFS File Share for Crawling](/docs/dataclassification/5.6.2/config_infrastructure/config_nfs_fs.md)
...
| Write classifications       | Select if you wish to write classifications directly into the document properties, i.e. use tagging. This applies to DOC/DOCX/XLS/XLSX/PPT/PPTX/PDF. See also [File System](/docs/dataclassification/5.6.2/sources/file_system/manage_file_system.md).                                                                                                                                                                       |
...
| Text Patterns               | [See Text Processing for more information.](/docs/dataclassification/5.6.2/configuration/text_handling.md)                                                                                                                                                                                                                                                                                                                   |
...
![addfile](/img/product_docs/dataclassification/5.6.2/sources/file_system/addfile.webp)
