...
sidebar_label: Sharepoint Actions
...
- [Migrate Document](/docs/dataclassification/5.6.2/workflows-automation/workflow-actions/migration-actions.md)
...
![content_type_hubs_thumb_0_0](/img/versioned_docs/dataclassification_5.6.2/ndc/workflows/content_type_hubs_thumb_0_0.webp)
