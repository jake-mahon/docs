...
![Setup Wizard Change, Repair, or Remove Installation page](../../../../static/img/product_docs/accessanalyzer/install/application/change.webp)

**Step 4 –** On the Change, Repair, or Remove Installation page, click **Change**.

|                                                                                                                         |     |                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------- | --- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![License File page](../../../../static/img/product_docs/accessanalyzer/install/application/licensemapped.webp) |
...
![License Features page](../../../../static/img/product_docs/accessanalyzer/install/application/licensefeatures.webp)
