...
![Regular Expression window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/sensitivedatadiscovery/criteriaeditor/criteriatype/regularexpression.png)
...
- Validation – Select a validation method from the Validation drop-down. The default value is __No validation required__.
  ...
  __NOTE:__ See the [Sensitive Data System Criteria](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/sensitivedatadiscovery/systemcriteria.md) topic for additional information on validation methods.
