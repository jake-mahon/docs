...
See the [Active Directory Domain Target Requirements](/docs/product_docs/accessanalyzer/accessanalyzer/config/activedirectory/overview.md) topic for target environment requirements.
