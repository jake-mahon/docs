...
See the [Domain Target Requirements, Permissions, and Ports](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/activedirectorypermissionsanalyzer.md) topic for target environment requirements.
