...
- [Target Exchange Servers Requirements, Permissions, and Ports](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/exchange.md)
- [Target Exchange Online Requirements, Permissions, and Ports](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/exchangeonline.md)
...
- StealthAUDIT MAPI CDO installed (for MAPI- based data collectors). See the [StealthAUDIT MAPI CDO Installation](/docs/product_docs/accessanalyzer/accessanalyzer/stealthaudit/install_guides/mapi_cdo_install/stealthaudit_mapi_cdo_installation.md) topic for additional information.
