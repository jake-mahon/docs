...
See the [Target Windows Server and Desktop Requirements, Permissions, and Ports](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/windows.md) topic for target environment requirements.
