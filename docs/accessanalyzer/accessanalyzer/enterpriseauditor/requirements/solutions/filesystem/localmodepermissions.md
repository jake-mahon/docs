...
See the [Local Mode Port Requirements](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/solutions/filesystem/localmodeports.md) topic for firewall rule information.
