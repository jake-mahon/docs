...
See the [Proxy Mode as a Service Port Requirements](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/solutions/filesystem/proxymodeserviceports.md) topic for firewall rule information.
