...
See the [Target Dropbox Requirements, Permissions, and Ports](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/dropbox.md) topic for target environment requirements.
