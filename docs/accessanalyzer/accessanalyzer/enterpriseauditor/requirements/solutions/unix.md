...
See the [Target Unix Requirements, Permissions, and Ports](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/target/unix.md) topic for target environment requirements.
