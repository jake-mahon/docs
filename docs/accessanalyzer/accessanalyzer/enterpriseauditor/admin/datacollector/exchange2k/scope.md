...
![Exchange 2K+ Data Collector Wizard Scope page](/static/img/product_docs/activitymonitor/config/activedirectory/scope.png)

Select where to connect for the search and click __Connect__ to add the domain or server:
...
Click __Add__ to add the OUs highlighted in the top box to the scope. Click __Remove__ to remove the selected OU.
