...
This topic covers the configuration wizards that are unique to each data collector. See the [Jobs Tree](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/overview.md) topic for additional information on job configuration.

## Query Selection

The Access Analyzer data collectors can collect information from a wide range of environments. Data collection tasks are assigned to jobs at the __Configure__ > __Queries__ node level. See the [Queries Node](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/queries.md) topic for additional information.
...
![Libraries window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/addqueryfromlibrary.png)
...
![General tab of the Query Properties window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/querypropertiesgeneral.png)
...
When creating a new query, provide a unique, descriptive __Name__ and __Description__. This information displays in the table on the Query Selection view. See the [Queries Node](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/queries.md) topic for additional information.

#### Data Source Tab

Use the Data Source tab to configure the data collector and query.

| ![Data Source tab of Query Properties for new Query](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/querypropertiesdatasourcenew.png) | ![Data Source tab of Query Properties for existing Query](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/querypropertiesdatasourceexisting.png) |
| --- | --- |
...
| ![Filters tab of Query Properties window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/querypropertiesdatafilters.png) | ![Filters tab of Query Properties window with a new filter](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/querypropertiesdatafilterswithfilter.png) |
| --- | --- |
