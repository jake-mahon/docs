...
![Text Search Data Collector Wizard Advanced Criteria page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/textsearch/advancedcriteria.png)
...
- Customize – Click this button to open the Filter builder
  ...
  ![Filter builder window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/textsearch/filterbuilder.png)

  See the [Filtration Dialog](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/navigate/datagrid.md#Filtration-Dialog) topic for information on using the Filter builder.
