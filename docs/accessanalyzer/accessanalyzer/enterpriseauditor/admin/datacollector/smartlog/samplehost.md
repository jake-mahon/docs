...
![SMART Log DC Wizard Sample Host page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/wmicollector/samplehost.png)
...
![Select Computer window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/smartlog/selectcomputerwindow.png)
...
![Advanced Select Computer window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/smartlog/selectcomputerwindowadvanced.png)
...
- Click the __Columns__ button to open the Choose Columns window
  ...
  ![Choose Columns window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/smartlog/choosecolumnswindow.png)
