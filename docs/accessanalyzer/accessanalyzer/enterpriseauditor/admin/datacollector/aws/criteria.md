...
![AWS Query SDD Criteria](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/ewsmailbox/criteria.png)
...
User-defined criteria is created in the Criteria Editor, accessed through the __Global Settings__ >  __Sensitive Data__ node. See the [Sensitive Data Discovery](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/sensitivedatadiscovery/overview.md) topic for additional information.
