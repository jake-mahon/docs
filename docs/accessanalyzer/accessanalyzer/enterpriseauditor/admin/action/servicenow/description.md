...
![ServiceNow Action Module wizard Description page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/action/servicenow/description.png)
...
- Insert Field – Use the drop-down menu to select a field (column) from the source table
  ...
  - Click the file icon with the magnifying glass to preview the sourced table for values. The default is 1000 rows.
    ...
    ![Sample Source Data window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/action/servicenow/samplesourcedata.png)
...
- Load from Template – Displays preconfigured Short Description and Comments section by name of template
  ...
  - Click the __Save to Template__ link to preserve the Short Description and Comments sections for later use under a template name.
    ...
    ![Save ServiceNow Template window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/action/servicenow/savetemplate.png)
