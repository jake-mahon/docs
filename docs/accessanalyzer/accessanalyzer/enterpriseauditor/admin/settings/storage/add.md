...
![Add Storage profile option](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofile.png)

__Step 1 –__ Click __Add Storage profile__ at the top of the Storage view.

![New Storage profile added](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilename.png)
...
![Server Name field](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofileservername.png)
...
![Command timeout field](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofiletimeout.png)
...
![Authentication options](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofileauthentication.png)
...
| ![Good connection test](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilegoodconnection.png) | ![Bad connection test](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilebadconnection.png) |
| --- | --- |
...
![Database options](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofiledatabase.png)
...
![Connection report](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/connectionreport.png)
