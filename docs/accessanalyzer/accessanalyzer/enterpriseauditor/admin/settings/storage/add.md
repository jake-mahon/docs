...
![Add Storage profile option](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofile.png)

__Step 1 –__ Click __Add Storage profile__ at the top of the Storage view.

![New Storage profile added](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilename.png)
...
![Server Name field](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofileservername.png)
...
![Command timeout field](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofiletimeout.png)
...
![Authentication options](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofileauthentication.png)
...
| ![Good connection test](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilegoodconnection.png) | ![Bad connection test](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofilebadconnection.png) |
| --- | --- |
...
![Database options](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/addprofiledatabase.png)
...
![Connection report](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/connectionreport.png)
