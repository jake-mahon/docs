...
![Specify a new password below option on Storage page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/storage/updateauth.png)
