...
![Sensitive Data Criteria tab](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/criteriatab.png)
...
- Launch Editor – Opens the Sensitive Data Criteria Editor. See the [Sensitive Data Criteria Editor](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/sensitivedatadiscovery/criteriaeditor/overview.md) topic for additional information.
...
![Add criteria](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/addcriteria.png)

__Step 1 –__ Click __Add__ to open the Select Criteria window.

![Select Criteria window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/upgrade/selectcriteria.png)
