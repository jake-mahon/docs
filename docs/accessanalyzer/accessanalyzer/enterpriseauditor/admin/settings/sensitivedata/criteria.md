...
![Sensitive Data Criteria tab](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/criteriatab.png)
...
- Launch Editor – Opens the Sensitive Data Criteria Editor. See the [Sensitive Data Criteria Editor](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/sensitivedatadiscovery/criteriaeditor/overview.md) topic for additional information.
...
![Add criteria](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/addcriteria.png)

__Step 1 –__ Click __Add__ to open the Select Criteria window.

![Select Criteria window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/upgrade/selectcriteria.png)
...
__Step 3 –__ Click __OK__ to confirm changes. The Select Criteria window closes.
