...
![Edit Filter on False Positives tab](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/exclusions/editfilter.png)

__Step 1 –__ Click __Edit Filter__ to open the Edit False Positive Exclusion Filter window.

![Edit False Positive Exclusion Filter window](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/exclusions/editexclusionfilterwindow.png)
