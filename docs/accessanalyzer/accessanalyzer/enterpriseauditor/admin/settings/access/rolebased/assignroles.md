...
![NEAUsers group](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/neausersgroup.png)
...
![Edit Member Role](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/editmemberrole.png)

__Step 1 –__ On the Access page, select the desired user and click __Edit Member Role__.

![Edit Console Access wizard page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/consoleaccessedit.png)
...
![Delete Role Member](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/deleterolemember.png)
