...
![Options at the top of the Action Selection page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionselectionoptions.png)
...
- Action Properties – Opens the Action Properties window for the selected action task
  ...
  - See the [Action Properties Page](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/action/overview.md#Action-Properties-Page) topic for additional information
  - See the [Action Modules](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/action/overview.md) topic for additional information
...
![Buttons at the bottom of Action Selection page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionselectiontablebuttons.png)
...
![Actions Right-Click Menu](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionsrightclickmenu.png)
