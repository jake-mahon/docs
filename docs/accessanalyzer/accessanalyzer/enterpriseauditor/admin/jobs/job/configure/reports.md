...
![Reports page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/reports.png)
...
- Properties – Opens the [Job Properties](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/properties/overview.md) page for the job that the report is for
...
![Options on the Reports table header row](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/reportstableheaderoptions.png)
...
- Create – Creates a new report for the selected job
  ...
  - See the [Creating a Report](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/create.md) topic for additional information
...
![Reports table row options](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/reportstablerowoptions.png)
...
See the [Reporting](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/overview.md) topic for additional information.
