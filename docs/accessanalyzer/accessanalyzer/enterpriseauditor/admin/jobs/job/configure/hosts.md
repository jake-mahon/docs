...
![Host Selection page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostselection.png)
...
![Job's Configure > Hosts node](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostsnode.png)

__Step 1 –__ Navigate to the job’s __Configure__ > __Hosts__ node.

![Individual hosts section of the Host Selection view](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostselectionindividualhosts.png)
