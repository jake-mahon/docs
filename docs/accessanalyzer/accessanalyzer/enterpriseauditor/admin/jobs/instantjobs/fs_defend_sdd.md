...
![FS_DEFEND_SDD job in the Jobs tree](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostmanagement/jobstree.png)
...
- Target Hosts – Custom Host List
  ...
  - Format – [HOST]:8080
  - Assign host list at the __FS\_DEFEND\_SDD__ > __Configure__ > __Hosts__ (see the [Hosts Node](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hosts.md) topic for additional information)
...
See the [Application](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/settings/application/overview.md) topic for additional information.
