...
![Running Instances node Overview page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/overviewpage.png)
...
![Overview page](/img/product_docs/threatprevention/threatprevention/siemdashboard/qradar/dashboard/overview.png)
...
![Number of jobs running on bottom bar](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/overviewbottombar.png)
...
![Host list link](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/viewhost.png)

Click the host list link to display the hosts assigned to the running job.

![Host list in Host Management node](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/viewhostlist.png)
...
![Process ID link](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/processid.png)

Click the Process ID link for additional details of the job status and queue.

![Job details page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/jobdetails.png)

The Process ID link displays a page with three tabs of information with details about the running job. See the [Running Job Details](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/jobdetails.md) topic for additional information.

## View Details

Additional details on the status of the tasks the job is running are available.

![View Details link](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/viewdetails.png)

Click the __View Details__ link to display additional details of the job status and queue.

![Job details page](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/jobdetails.png)

The View Details link opens the running job's details with three tabs of information. See the [Running Job Details](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/jobdetails.md) topic for additional information.

## View Log

The log for this running job can be opened in a text editor, such as Notepad.

![View Log link](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/viewlog.png)

Click __View Log__ to display the current job log. The View Log link is only enabled while a job is running.

![Log file in Notepad](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/logfile.png)
...
![View Schedule link](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/viewschedule.png)
...
![Schedule wizard](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/schedulewizard.png)

The Schedule wizard for the running task opens. See the [Schedule Wizard](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/schedule/wizard.md) topic for additional information.

## Stop

The job execution can be stopped if needed.

![Stop button](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/runninginstances/stop.png)
