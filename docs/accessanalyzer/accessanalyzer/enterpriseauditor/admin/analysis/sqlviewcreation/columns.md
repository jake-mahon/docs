...
![View and Table Creation Analysis Module wizard Result Columns page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/analysis/sqlviewcreation/columns.png)
...
__NOTE:__ If at least one columns is sorted by value, the __With ties__ option is enabled on the Result Constraints page. See the [SQLViewCreation: Result Constraints](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/analysis/sqlviewcreation/resultconstraints.md) topic for additional information.
