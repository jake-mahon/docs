...
![Host Discovery Wizard Source page for database import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/source.png)
...
![Host Discovery Wizard Query page for database import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/nis/query.png)
...
![Host Discovery Wizard Database Import page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/databaseimport.png)
...
- Data source – Identify the database. Click the ellipsis (__…__) to open the Data Link Properties window. Then provide the required information on the Connection tab.
  ...
  ![Data Link Properties window Connection tab](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/datalinkproperties.png)
  ...
  - Credentials – Select the credentials to use to log on to the server:
    ...
    ![Test connection succeeded confirmation window](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/datalinkpropertiestestconnection.png)
...
![Host Discovery Wizard Options page for database import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/options.png)
...
![Host Discovery Wizard Inventory page for database import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/inventory.png)
...
![Host Discovery Wizard Summary page for database import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/summary.png)
