...
Follow the steps to create a Host Discovery query using the __Import from a CSV file__ source option.
...
![Host Discovery Wizard Source page for CSV import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/source.png)
...
![Host Discovery Wizard Query page for CSV import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/nis/query.png)

__Step 2 –__ On the Query page, name the query and select the credentials used to access the source.

__NOTE:__ The source in this case is the Access Analyzer Console server.
...
![Host Discovery Wizard CSV File Import page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/fileimport.png)
...
- File name – Identify the CSV file with the full file path. Use the ellipsis (__…__) to open a browser window.
...
![Host Discovery Wizard Options page for CSV import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/options.png)
...
![Host Discovery Wizard Inventory page for CSV import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/inventory.png)
...
![Host Discovery Wizard Summary page for CSV import](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/summary.png)
