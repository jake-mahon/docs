...
![Host Discovey Wizard Source page for IP network scan](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/source.png)

__Step 1 –__ Open the Host Discovery Wizard. On the Source page, select the __Scan your IP network__ option. Click __Next__.

![Host Discovey Wizard Query page for IP network scan](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/nis/query.png)
...
![Host Discovey Wizard IPSweep page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/ipsweep.png)
...
![Host Discovey Wizard Options page for IP network scan](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/application/options.png)
...
![Host Discovey Wizard Inventory page for IP network scan](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/inventory.png)
...
![Host Discovey Wizard Summary page for IP network scan](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/summary.png)
