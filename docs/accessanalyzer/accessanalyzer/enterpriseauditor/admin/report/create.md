...
![Generate report](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/generate.png)

__Step 4 –__ Click the vertical ellipsis menu next to the report and select Generate.

The report is now created. To access the new report, see the [Viewing Generated Reports](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/view.md) topic.
...
![Copy Report](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/navigate/copy.png)
...
![Paste Report](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/navigate/paste.png)
...
__Step 3 –__ (Optional) Click the __Configure__ button next to the report. Use the Report Configuration wizard to modify the reports settings. See the [Report Configuration Wizard](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/wizard/overview.md) topic for instructions.
