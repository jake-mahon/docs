...
![Chart Configuration wizard Chart Format page](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/chartwizard/chartformat.png)
...
Once you have configured the options as required, click __Next__ to proceed to the Data Source page. See the [Data Source](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/report/chartwizard/datasource.md) topic for additional information.
