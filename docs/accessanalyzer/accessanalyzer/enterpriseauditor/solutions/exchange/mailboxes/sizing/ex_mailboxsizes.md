...
![Analysis Tasks for the EX_Mailbox Sizes Job](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/solutions/exchange/mailboxes/sizing/mailboxsizesanalysis.png)
...
__CAUTION:__ Do not select the __00.Delete All Data__ option. This analysis task is for troubleshooting and cleanup only. Data will be deleted from the database:
