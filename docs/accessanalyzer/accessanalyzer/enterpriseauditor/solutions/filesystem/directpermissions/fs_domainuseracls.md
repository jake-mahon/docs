...
![Analysis Tasks for the FS_DomainUserACLs Job](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/solutions/filesystem/directpermissions/domainuseraclsanalysis.png)
