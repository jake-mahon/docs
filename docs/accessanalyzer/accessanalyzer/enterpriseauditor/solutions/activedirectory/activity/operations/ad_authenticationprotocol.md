...
![Analysis Tasks for the AD_AuthenticationProtocol Job](/static/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/solutions/activedirectory/activity/operations/authenticationprotocolanalysis.png)
