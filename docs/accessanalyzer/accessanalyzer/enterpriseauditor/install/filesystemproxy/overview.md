...
See the [File System Solution](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/requirements/solutions/filesystem.md) topic for information on the required prerequisites.
...
__CAUTION:__ The File System Proxy Service cannot be installed on the same server as Access Analyzer.
...
![Diagram of difference between an implementation with and without proxy servers](/img/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/install/filesystemproxy/fsaaproxyarchitecture.png)
