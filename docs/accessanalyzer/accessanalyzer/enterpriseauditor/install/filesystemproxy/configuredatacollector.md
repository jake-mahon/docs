...
See the [FSAA Query Configuration](/docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/overview.md#FSAA-Query-Configuration) topic for additional information.
