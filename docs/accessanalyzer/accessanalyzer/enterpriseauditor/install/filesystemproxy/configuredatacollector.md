...
See the [FSAA Query Configuration](/docs/product_docs/accessanalyzer/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/overview.md#FSAA-Query-Configuration) topic for additional information.
