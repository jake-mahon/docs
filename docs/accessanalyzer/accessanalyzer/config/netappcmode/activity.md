...
___RECOMMENDED:___ Create a tailored FPolicy which only collects the desired activity from the environment to limit the scope and impact.
...
___RECOMMENDED:___ Enable the Persistent Store feature and allow it to create a volume automatically.
...
- Gather the following information:
  ...
  - Desired functionality level:
    ...
    - _Enable and Connect FPolicy_. The product ensures that FPolicy stays enabled and connected all the time. RECOMMENDED.
    - _Configure FPolicy_. The product configures FPolicy automatically and ensures it stays enabled and connected all the time. RECOMMENDED.
...
Checklist Item 2: [Provision ONTAP Account](/docs/product_docs/accessanalyzer/accessanalyzer/config/netappcmode/provisionactivity.md)
...
Checklist Item 3: [Configure Network](/docs/product_docs/accessanalyzer/accessanalyzer/config/netappcmode/configurefirewall.md)
...
Checklist Item 4: [Configure FPolicy](/docs/product_docs/accessanalyzer/accessanalyzer/config/netappcmode/configurefpolicy.md)
...
- Select method:
  ...
  - Allow the Activity Monitor to create an FPolicy automatically
    ...
    - If using TLS, … authentication options, set authentication
    - This option is enabled using the __Configure FPolicy. Create or modify FPolicy objects if needed__ checkbox for each monitored SVM.
