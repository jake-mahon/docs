...
Additionally, it is necessary to generate an API Access Key for Nasuni activity monitoring. See the [Nasuni Edge Appliance Activity Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/nasuni/activity.md) topic for instructions.
