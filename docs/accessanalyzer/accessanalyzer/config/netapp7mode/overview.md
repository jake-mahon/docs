...
See the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/netapp7mode/activity.md) topic for instructions.
