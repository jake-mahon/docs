...
- Group membership in the role __Backup Admin: Backup Access Only__

See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](/docs/product_docs/accessanalyzer/accessanalyzer/config/nutanix/access.md) topic for additional information.
...
The Netwrix Activity Monitor can be configured to monitor activity on Nutanix devices. See the [Nutanix Files Activity Auditing Configuration](/docs/product_docs/accessanalyzer/accessanalyzer/config/nutanix/activity.md) topic for instructions.
