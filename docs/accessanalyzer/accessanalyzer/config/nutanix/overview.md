...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/nutanix/access.md) topic for additional information.
...
The Netwrix Activity Monitor can be configured to monitor activity on Nutanix devices. See the [Nutanix Files Activity Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/nutanix/activity.md) topic for instructions.
