...
See the [File Archive Repository Option](/docs/product_docs/accessanalyzer/accessanalyzer/config/activedirectory/filearchive.md) topic for additional information on that option.
