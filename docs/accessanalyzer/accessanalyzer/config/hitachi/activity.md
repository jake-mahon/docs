...
Checklist Item 1: [Configure Audit Logs on HNAS](/docs/accessanalyzer/accessanalyzer/config/hitachi/configurelogs.md)

Checklist Item 2: [Configure Access to HNAS Audit Logs on Activity Agent Server](/docs/accessanalyzer/accessanalyzer/config/hitachi/configureaccesstologs.md)
