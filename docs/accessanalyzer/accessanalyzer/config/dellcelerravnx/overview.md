...
See the [Dell Celerra & Dell VNX Activity Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/dellcelerravnx/activity.md) topic for instructions.
