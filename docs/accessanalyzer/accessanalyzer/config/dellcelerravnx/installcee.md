...
See the [CEE Debug Logs](/docs/product_docs/accessanalyzer/accessanalyzer/config/dellunity/validate.md#CEE-Debug-Logs) section for information on troubleshooting issues related to Dell CEE.
...
![registryeditor](/static/img/product_docs/activitymonitor/config/dellpowerstore/registryeditor.png)
...
__Step 1 –__ Log into the Dell Celerra or VNX server with an administrator account. The administrative account should have a $ character in the terminal.

__NOTE:__ Do not use a # charter.
