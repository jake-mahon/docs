...
![Groups tab](/img/product_docs/accessanalyzer/accessanalyzer/config/dellpowerscale/groupstab.png)
...
![One FS Dashboard](/img/product_docs/accessanalyzer/accessanalyzer/config/dellpowerscale/rolestab.png)

__Step 2 –__ On the Roles tab, select __View / Edit__ for the BackupAdmin role. The View Role Details window opens.

![One FS Role Details Window](/img/product_docs/accessanalyzer/accessanalyzer/config/dellpowerscale/viewroledetails.png)
...
See the [Dell Isilon/PowerScale Activity Auditing Configuration](/docs/accessanalyzer/accessanalyzer/config/dellpowerscale/activity.md) topic for instructions.
