...
Netwrix Activity Monitor requires an account with the Observers role to monitor a Qumulo cluster. See the [Qumulo Activity Auditing Configuration](/docs/product_docs/accessanalyzer/accessanalyzer/config/qumulo/activity.md) topic for instructions.
