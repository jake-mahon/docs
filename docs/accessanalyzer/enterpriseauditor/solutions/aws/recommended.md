...
- AWS Permissions must be configured on the target databases.
    ...
    - See the [Configure AWS for Scans](../../requirements/target/config/aws.md) topic for
...
[Amazon Web Services for User Credentials](../../admin/settings/connection/profile/aws.md) topic for
...
[Configure AWS for Scans](../../requirements/target/config/aws.md) topic for additional information.
