...
- [AWS_CustomManagedPolicies Job](aws_custommanagedpolicies.md) – Provides details on customer
  managed policies created in the AWS Organization
- [AWS_InlinePolicies Job](aws_inlinepolicies.md) – Provides details on customer managed policies
  that are directly assigned to a user or group
- [AWS_ManagedPolicies Job](aws_managedpolicies.md) – Provides details on policies managed by Amazon
  in the AWS Organization
- [AWS_SensitivePolicies Job](aws_sensitivepolicies.md) – Provides details on users, groups, and
  roles as well as the policies granting them sensitive permissions
- [AWS_UnusedManagedPolicies Job](aws_unusedmanagedpolicies.md) – Provides details on customer
...
- [AWS_UserPolicies Job](aws_userpolicies.md) – Provides details outlining user policy assignment.
