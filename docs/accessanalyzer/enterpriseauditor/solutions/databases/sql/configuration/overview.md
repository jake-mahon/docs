...
- [SQL_Authentication Job](sql_authentication.md) – This job identifies authentication settings on
...
- [SQL_BestPractices Job](sql_bestpractices.md) – This job is designed to analyze SQL and Azure SQL
...
- [SQL_CMDShell Job](sql_cmdshell.md) – This job is designed to report if the `xp_cmdshell `stored
...
- [SQL_DatabaseSizing Job](sql_databasesizing.md) – Provides details on database file sizes and
  overall database sizes
- [SQL_LinkedServers Job](sql_linkedservers.md) – Identifies Linked Servers or remote database
