...
See the [Target PostgreSQL Requirements, Permissions, and Ports](/docs/accessanalyzer/enterpriseauditor/requirements/target/databasepostgresql.md) topic for additional information.
