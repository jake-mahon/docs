...
- [PgSQL_Configuration Job](pgsql_configuration.md) - Designed to return additional configuration
  settings from PostgreSQL servers
- [PgSQL_SensitiveDataScan Job](pgsql_sensitivedatascan.md) - Designed to discover sensitive data in
  PostgreSQL databases based on pre-defined or user-defined search criteria
- [PgSQL_TablePrivileges Job](pgsql_tableprivileges.md) - Designed to collect PostgreSQL table
