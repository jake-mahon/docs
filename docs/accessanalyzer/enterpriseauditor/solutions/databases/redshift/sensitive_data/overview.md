...
- [Redshift_SensitiveData Job](redshift_sensitivedata.md) - Provides information on all the data
  that was discovered in the targeted Redshift database servers based on the selected scan criteria
- [Redshift_SensitiveDataPermissions Job](redshift_sensitivedatapermissions.md) - Designed to
