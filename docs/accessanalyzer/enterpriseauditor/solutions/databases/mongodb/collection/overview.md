...
- [MongoDB_Configuration Job](mongodb_configuration.md) — Collects MongoDB server instance and
  database configuration settings for use in the following analysis jobs and respective reports.
- [MongoDB_SensitiveDataScan Job](mongodb_sensitivedatascan.md) — Discovers sensitive data in
