...
- [Analysis Tasks for the MongoDB\_Database\_Sizing Job](/docs/accessanalyzer/enterpriseauditor/solutions/databases/mongodb/mongodb_databasesizing.md) — Provides insight into MongoDB server configuration settings
- [Sensitive Data > MongoDB\_SensitiveData Job](/docs/accessanalyzer/enterpriseauditor/solutions/databases/mongodb/mongodb_sensitivedata.md) — Provides insight into where sensitive data exists and who has access to it across all the targeted MongoDB databases
