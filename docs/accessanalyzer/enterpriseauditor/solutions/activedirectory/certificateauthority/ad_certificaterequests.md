...
Navigate to the __Active Directory__ > __7.Certificate Authority__ > __AD\_CertificateRequests__ > __Configure__ node and select __Analysis__ to view the analysis tasks.
