...
![Analysis Tasks for the AD_DomainControllerTraffic Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/activedirectory/activity/operations/dctrafficanalysis.png)
