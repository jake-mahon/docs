...
![Analysis Tasks for the AD_GroupModifications Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/activedirectory/activity/changes/groupmodificationsanalysis.png)
