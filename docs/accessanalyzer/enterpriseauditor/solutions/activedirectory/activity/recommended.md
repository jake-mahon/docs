...
Connection Profiles must be set directly on the [0.Collection > AD_ActivityCollection Job](ad_activitycollection.md) in order to connect to either the SAM API Server or the host with the network share housing the archived log files.

Access Token

Required for SAM API Server integration for the [0.Collection > AD_ActivityCollection Job](ad_activitycollection.md).
...
See the [Active Directory Solution](../../../requirements/solutions/activedirectory.md) topic for additional information.
