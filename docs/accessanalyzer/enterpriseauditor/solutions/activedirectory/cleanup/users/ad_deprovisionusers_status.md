...
![Analysis Tasks for the AD_DeprovisionUsers_Status Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/activedirectory/cleanup/users/deprovisionusersstatusanalysis.png)
