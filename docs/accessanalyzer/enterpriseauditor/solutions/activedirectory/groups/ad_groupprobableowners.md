...
![Analysis Tasks for the AD_GroupProbableOwners Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/activedirectory/groups/groupprobableownersanalysis.png)
