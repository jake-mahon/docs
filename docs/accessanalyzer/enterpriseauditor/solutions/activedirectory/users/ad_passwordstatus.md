...
![Analysis Tasks for the AD_PasswordStatus Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/activedirectory/users/passwordstatusanalysis.png)
