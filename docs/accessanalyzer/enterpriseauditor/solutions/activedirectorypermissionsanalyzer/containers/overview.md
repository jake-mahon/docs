...
- [AD_AdminSDHolder Job](ad_adminsdholder.md) – Reports on all non-default Active Directory
...
- [AD_ContainerPermissions Job](ad_containerpermissions.md) – Reports on all Active Directory
