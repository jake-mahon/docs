...
See the [Target Box Requirements, Permissions, and Ports](../../requirements/target/box.md) topic
...
- [0.Collection Job Group](collection/overview.md) – Collects the data which will be further
  ...
  and content
- [1.Activity Job Group](activity/overview.md) – Identifies long term trends of activity providing
...
- [2.Content Job Group](content/overview.md) – Analyzes and summarizes the content of the Box
  environment, highlighting users with the most content as well as what type of content exists
- [Box_Access Job](box_access.md) – Analyzes access granted to users and groups in an organization's
...
- [Box_GroupMembership Job](box_groupmembership.md) – Expands group membership in an organization's
  Box environment
