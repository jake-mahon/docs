...
- [Forensics Job Group](forensics/overview.md) – Provides details on the types of operations
  occurring within audited Box enterprises, including deletions, file downloads, permission changes,
  and more
- [Suspicious Activity Job Group](suspiciousactivity/overview.md) – Identifies areas and times of
...
- [Usage Statistics Job Group](usagestatistics/overview.md) – Identifies long-term trends of
