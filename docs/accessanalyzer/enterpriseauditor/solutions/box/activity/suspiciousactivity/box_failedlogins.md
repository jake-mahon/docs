...
![Analysis Tasks for the Box_FailedLogins Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/box/activity/suspiciousactivity/failedloginsanalysis.png)
