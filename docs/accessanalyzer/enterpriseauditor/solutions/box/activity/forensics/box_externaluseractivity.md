...
![Analysis for the Box_ExternalUserActivity Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/box/activity/forensics/externaluseractivityanalysis.png)
