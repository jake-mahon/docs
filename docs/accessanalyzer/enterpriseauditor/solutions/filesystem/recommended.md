...
__NOTE:__ If targeting Nasuni Edge Appliances, it is necessary to add the [0-FS\_Nasuni Job](/docs/accessanalyzer/enterpriseauditor/solutions/filesystem/collection/0-fs_nasuni.md) to the __0.Collection__ Job Group.
