...
Instant Job library. See the [Instant Job Wizard](../../../admin/jobs/instantjobs/overview.md) topic
...
- [FS_ResourceBasedGroups Job](fs_resourcebasedgroups.md) – This job will transform permission on
  specified folders to a resource based groups model
- [FS_TraverseGroups Job](fs_traversegroups.md) – (Optional) This job can be used to create and
...
- [FS_ResourceBasedGroupAICImport Job](fs_resourcebasedgroupaicimport.md) – (Optional) This job
...
[Schedule Jobs](../../../admin/schedule/overview.md#schedule-jobs) topic for additional information.
