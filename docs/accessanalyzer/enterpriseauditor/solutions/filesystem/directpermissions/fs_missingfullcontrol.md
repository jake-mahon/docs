...
![Analysis Tasks for the FS_MissingFullControl Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/filesystem/directpermissions/missingfullcontrolanalysis.png)
