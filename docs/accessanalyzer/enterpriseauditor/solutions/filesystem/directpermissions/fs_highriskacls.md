...
![Analysis Tasks for the FS_HighRiskACLs Job](/img/product_docs/accessanalyzer/enterpriseauditor/solutions/filesystem/directpermissions/highriskaclsanalysis.png)
