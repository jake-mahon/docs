...
The FS\_QuarantineData\_Status job is designed to report on the FS\_QuarantineData job. See the [FS\_QuarantineData Job](/docs/accessanalyzer/enterpriseauditor/solutions/filesystem/cleanup/quarantine/fs_quarantinedata.md) topic for additional information.
