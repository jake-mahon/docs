...
The FS_QuarantineData_Status job is designed to report on the FS_QuarantineData job. See the [FS_QuarantineData Job](fs_quarantinedata.md) topic for additional information.
...
![Analysis Tasks for the FS_QuarantineData_Status Job](../../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/solutions/filesystem/cleanup/quarantine/quarantinedatastatusanalysis.webp)
