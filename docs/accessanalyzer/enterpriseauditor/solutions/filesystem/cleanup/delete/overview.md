...
- [FS_DeleteFiles Job](fs_deletefiles.md) – Designed to delete resources from targeted file servers
  that were previously quarantined and can be deleted
- [FS_DeleteFiles_Status Job](fs_deletefiles_status.md) – Designed to report on deleted resources
