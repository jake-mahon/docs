...
The FS\_NotifyOwners\_Status job is comprised of analysis and reports that summarize the actions performed by the FS\_NotifyOwners job. See the [FS\_NotifyOwners Job](/docs/accessanalyzer/enterpriseauditor/solutions/filesystem/cleanup/notify/fs_notifyowners.md) topic for additional information.
