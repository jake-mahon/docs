...
Global Settings. See the [Notification](../../../../admin/settings/notification.md) topic for
...
- [FS_NotifyOwners Job](fs_notifyowners.md) – Designed to notify share owners that there is data
  within their share pending cleanup
- [FS_NotifyOwners_Status Job](fs_notifyowners_status.md) – Designed to summarize the actions taken
