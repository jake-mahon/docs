...
- [Features > EX_Features Job](ex_features.md) – Comprised of data collection and a report that
...
- [Logons Job Group](logons/overview.md) – Provides collection of Native Mailbox Access Auditing
  logs from Exchange to provide reporting around mailbox logon activity
- [Permissions Job Group](permissions/overview.md) – Comprised of data collection, analysis and
...
- [Sizing Job Group](sizing/overview.md) – Provides data collection, analyses, and reports which
