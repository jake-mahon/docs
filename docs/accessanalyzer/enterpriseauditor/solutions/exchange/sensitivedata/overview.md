...
- [0.Collection Job Group](collection/overview.md) – Locates sensitive data found in mailboxes and
  public folders in the Exchange environment
- [EX_SDDResults Job](ex_sddresults.md) – Contains analyses and reports to provide insight into the
...
the queries. See the [Exchange](../../../admin/settings/exchange.md) topic for additional
information.
