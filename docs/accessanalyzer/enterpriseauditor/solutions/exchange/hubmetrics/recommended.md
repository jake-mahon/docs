...
A Connection Profile must be set directly on the EX\_MetricsCollection Job and the EX\_MetricsDetails Job. See the [Exchange Mail-Flow Permissions](/docs/accessanalyzer/enterpriseauditor/requirements/solutions/exchange/mailflow.md) topic for required permissions.
