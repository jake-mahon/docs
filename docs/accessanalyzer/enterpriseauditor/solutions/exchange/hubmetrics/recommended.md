...
Job. See the [Exchange Mail-Flow Permissions](../../../requirements/solutions/exchange/mailflow.md)
...
- All queries in the 1.HUB Metrics Job Group that use the ExchangeMetrics Data Collector –
  ...
  See the [ExchangeMetrics: Options](../../../admin/datacollector/exchangemetrics/options.md) topic
