...
___RECOMMENDED:___ Run this job group at 5:00 AM.

Workflow

__Step 1 –__ Schedule the 6. Distribution Lists job group to run daily after the .Active Directory Inventory job group has successfully run.

__Step 2 –__ Review the reports generated by the jobs.
