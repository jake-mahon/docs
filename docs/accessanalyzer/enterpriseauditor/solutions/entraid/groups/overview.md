...
- [AAD_CircularNesting Job](aad_circularnesting.md) – Identifies circularly-nested groups within
...
- [AAD_DuplicateGroups Job](aad_duplicategroups.md) – Identifies duplicate groups within Microsoft
  Entra ID. Duplicate groups contain the same group membership as one another and are suitable
  candidates for cleanup
- [AAD_EmptyGroups Job](aad_emptygroups.md) – Identifies empty groups within Microsoft Entra ID
  which are suitable candidates for consolidation or cleanup
- [AAD_GroupDirSync Job](aad_groupdirsync.md) – Summarizes on-premises Active Directory syncing in
  the audited Microsoft Entra ID environment
- [AAD_LargestGroups Job](aad_largestgroups.md) – Identifies groups with large effective member
...
- [AAD_NestedGroups Job](aad_nestedgroups.md) – Identifies nested groups within Microsoft Entra ID
...
- [AAD_ProbableOwners Job](aad_probableowners.md) – Determines potential owners for Microsoft Entra
...
- [AAD_StaleGroups Job](aad_stalegroups.md)– Identifies Microsoft Entra ID groups that contain
