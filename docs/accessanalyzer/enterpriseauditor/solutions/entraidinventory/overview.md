...
- [1-AAD_Scan Job](1-aad_scan.md) – Provides essential Microsoft Entra ID User and Group membership
...
- [2-AAD_Exceptions Job](2-aad_exceptions.md) – Runs analysis on the collected data and identifies
