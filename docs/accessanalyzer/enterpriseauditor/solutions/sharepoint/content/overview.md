...
- [SP_LargestFiles Job](sp_largestfiles.md) – Identifies the largest files across SharePoint farms.
...
- [SP_StaleFiles Job](sp_stalefiles.md) – Identifies files that have been modified in at least a
