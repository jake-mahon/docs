...
See the [Recommended Configuration for the SharePoint Solution](recommended.md) topic for additional
...
- [0.Collection Job Group](collection/overview.md) – Designed to collect high level summary
...
- [1.Direct Permissions Job Group](directpermissions/overview.md) – Provides insight into how
...
- [2.High Risk Sites > SP_OpenAccess Job](sp_openaccess.md) – Provides insight into any high-risk
  ...
  exposure.
- [3.Broken Inheritance > SP_BrokenInheritance Job](sp_brokeninheritance.md) – Keeping track of
  ...
  membership.
- [4.Content Job Group](content/overview.md) – Provides insight into content stored across
...
- [5.Probable Owner > SP_ProbableOwner Job](sp_probableowner.md) – Provides reports about probable
...
- [6.Sensitive Data > SP_SensitiveData Job](sp_sensitivedata.md) – Highlights sensitive data
  identified across targeted SharePoint farms

    - Requires Sensitive Data Discovery

- [7.Activity Job Group](activity/overview.md)– Generates summary and detail reports of SharePoint
...
- [8.M365 Job Group](m365/overview.md) – Generates summary and detail reports of SharePoint Activity
  on the specified Teams sites. These reports can be used for identifying file, folder, and user
  related activity across your SharePoint environment.
- [Effective Access Audits Job Group](effectiveaccessaudits/overview.md) – Returns reports
...
- [SP_Overview Job](sp_overview.md) – Provides an overview of the SharePoint environment, providing
