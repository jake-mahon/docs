...
- [Local Administrators Job Group](localadministrators/overview.md) – This group identifies the
...
- [Logon Rights Job Group](logonrights/overview.md) – The jobs within this group collect local
  policy information to provide insight into privileged users within the environment
- [Service Accounts > SG_ServiceAccounts Job](sg_serviceaccounts.md) – This job indicates which
