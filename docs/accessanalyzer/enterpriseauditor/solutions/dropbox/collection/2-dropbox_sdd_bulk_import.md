...
The 2-Dropbox_SDD Bulk Import job imports the data collected by the 1-Dropbox_SDD Scan job to the Access Analyzer database for use by the analysis tasks.
...
There are no customization options available for this job. The Summary page of the Dropbox Access Auditor Data Collector wizard can be viewed at the __Jobs__ > __Dropbox__ > __0.Collection__ > __2-Dropbox_SDD Bulk Import__ > __Configure__ > __Queries__ node.
