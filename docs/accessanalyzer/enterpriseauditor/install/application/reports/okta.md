...
![Okta Browse App Integration Catalog](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktawsfedtemplate.webp)
...
![Okta Application copy link address](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktacopylinkaddress.webp)
...
![Okta application values in WebServer.exe.config file](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/webserverexeconfigokta.webp)
...
![oktaprofileeditor](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaprofileeditor.webp)
...
![Okta Add Attribute button](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaaddattribute.webp)

__Step 3 –__ Click __Add Attribute__ to open the Add Attribute window.

![Okta Add Atrribute window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaaddattributewindow.webp)
...
![To Okta option under the Directory Provisioning Tab](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktadirectoryprovisioningtookta.webp)

__Step 5 –__ Navigate to the __Directory__ menu and click on the __Provisioning__ tab. Click __To Okta__.

![Okta Show Unmapped Attributes](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktashowunmappedattributes.webp)
...
![Okta Unmapped Attribute configuration window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaunmappedattributeconfigscreen.webp)
...
![Okta Attribute Mappings Force Sync](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaattributemappingsforcesync.webp)
...
![Okta MFA App Sign on Rule window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktamfaappsignonrule.webp)
...
![Okta MFA App Sign on Rule window Access section](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktamfaappsignonruleaccess.webp)
