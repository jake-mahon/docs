...
![Okta Browse App Integration Catalog](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktawsfedtemplate.png)
...
![Okta Application copy link address](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktacopylinkaddress.png)
...
![Okta application values in WebServer.exe.config file](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/webserverexeconfigokta.png)
...
![oktaprofileeditor](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaprofileeditor.png)
...
![Okta Add Attribute button](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaaddattribute.png)

__Step 3 –__ Click __Add Attribute__ to open the Add Attribute window.

![Okta Add Atrribute window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaaddattributewindow.png)
...
![To Okta option under the Directory Provisioning Tab](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktadirectoryprovisioningtookta.png)

__Step 5 –__ Navigate to the __Directory__ menu and click on the __Provisioning__ tab. Click __To Okta__.

![Okta Show Unmapped Attributes](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktashowunmappedattributes.png)
...
![Okta Unmapped Attribute configuration window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaunmappedattributeconfigscreen.png)
...
![Okta Attribute Mappings Force Sync](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktaattributemappingsforcesync.png)
...
![Okta MFA App Sign on Rule window](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktamfaappsignonrule.png)
...
![Okta MFA App Sign on Rule window Access section](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/oktamfaappsignonruleaccess.png)
