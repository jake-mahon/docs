...
![Claims configured](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/entraidssoclaims.webp)
...
_Remember,_ Enabling Entra ID SSO requires SSL to already have been enabled for the web server. See the [Securing the Web Console](secure.md) topic for additional information.
...
![Parameters in the web server config file](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/install/application/reports/webserverexeconfigfileentrasso.webp)
