...
See the [File System Solution](/docs/accessanalyzer/enterpriseauditor/requirements/solutions/filesystem.md) topic for information on the required prerequisites.
