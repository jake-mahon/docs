...
See the [File System Solution](../../requirements/solutions/filesystem.md) topic for information on the required prerequisites.
...
![Diagram of difference between an implementation with and without proxy servers](../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/install/filesystemproxy/fsaaproxyarchitecture.webp)
