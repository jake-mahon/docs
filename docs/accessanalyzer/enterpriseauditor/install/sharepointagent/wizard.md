...
[SharePoint Scan Options](../../requirements/solutions/sharepoint/scanoptions.md) topic for detailed
...
[SharePoint Solution](../../solutions/sharepoint/overview.md) topic for instructions on enabling
