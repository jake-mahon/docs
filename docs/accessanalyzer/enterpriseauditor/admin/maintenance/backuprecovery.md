...
__Step 1 –__ Confirm the prerequisites have been met on the Access Analyzer Console Server. See the [Requirements](/docs/accessanalyzer/enterpriseauditor/requirements/overview.md) topic for specific prerequisites.
...
- See the [Role Based Access](/docs/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/overview.md) topic for more information
