...
__NOTE:__ The Actions node can also automatically execute actions. See the [Action Modules](../action/overview.md) topic for additional information.
...
![Select Action Window](../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/analysis/autoaction.webp)
