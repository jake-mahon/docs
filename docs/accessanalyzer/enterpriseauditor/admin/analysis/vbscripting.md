...
![VBScript Editor](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/script/vbscripteditor.webp)
...
When done using the editor, click __Save and Close__ to return to the Analysis Properties page. Make sure to save the analysis.
