...
![View and Table Creation Analysis Module wizard Result Columns page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/analysis/sqlviewcreation/columns.png)
