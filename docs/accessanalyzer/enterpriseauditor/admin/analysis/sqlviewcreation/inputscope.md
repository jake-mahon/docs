...
![View and Table Creation Analysis Module wizard Input Selection page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/analysis/sqlviewcreation/inputscope.webp)
