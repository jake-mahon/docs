...
![Host Selection page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostselection.webp)
...
![Job's Configure > Hosts node](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostsnode.webp)

__Step 1 –__ Navigate to the job’s __Configure__ > __Hosts__ node.

![Individual hosts section of the Host Selection view](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hostselectionindividualhosts.webp)
