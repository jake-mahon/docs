...
![Options at the top of the Action Selection page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionselectionoptions.webp)
...
- Action Properties – Opens the Action Properties window for the selected action task
  ...
  - See the [Action Properties Page](/docs/accessanalyzer/enterpriseauditor/admin/action/overview.md#action-properties-page) topic for additional information
  - See the [Action Modules](/docs/accessanalyzer/enterpriseauditor/admin/action/overview.md) topic for additional information
...
![Buttons at the bottom of Action Selection page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionselectiontablebuttons.webp)
...
![Actions Right-Click Menu](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/actionsrightclickmenu.webp)
