...
- Properties – Opens the [Job Properties](/docs/accessanalyzer/enterpriseauditor/admin/jobs/job/properties/overview.md) page for the job that the report is for
...
- Create – Creates a new report for the selected job
  ...
  - See the [Creating a Report](/docs/accessanalyzer/enterpriseauditor/admin/report/create.md) topic for additional information
