...
| ![View XML button on Job Properties window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/properties/viewxmlbutton.png) | ![XML Text window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/properties/viewxml.png) |
| --- | --- |
