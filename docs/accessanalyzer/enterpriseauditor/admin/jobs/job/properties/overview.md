...
![Open Job Properties from Jobs Tree](../../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/jobstree.webp)
...
You can click the __View XML__ button at the bottom of the window to open the job’s XML file. See the [View Job XML File](viewxml.md) for additional information.
