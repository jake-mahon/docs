...
![Connection tab of the Jop Properties](../../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/properties/viewxml.webp)

Select the desired option to identify the required Connection Profile for the job. See the [Connection Node](../../group/connection.md) topic for additional information for the three connection options.
