...
The new job is now ready to be configured. See the [Data Collectors](../../datacollector/overview.md), [Analysis Modules](../../analysis/overview.md), [Action Modules](../../action/overview.md), and [Reporting](../../report/overview.md) topics for additional information.
