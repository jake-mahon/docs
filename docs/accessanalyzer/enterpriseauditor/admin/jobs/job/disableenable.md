...
If the role based access feature is enabled, the ability to enable and disable jobs is limited by the assigned role. See the [Role Based Access](../../settings/access/rolebased/overview.md) topic for additional information.
...
![Disable Job from Jobs Tree](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/disablejob.webp)

__Step 2 –__ Right-click on the job group or job and select __Disable Job(s)__ from the menu.

![Disabled Job in the Jobs Tree](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/disabledjob.webp)
...
![Disabled Job Description page banner](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/disabledjob2.webp)
...
![Enable Job from Jobs Tree](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/job/enablejob.webp)
