...
![Job Group Host Lists Assignment](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/jobs/group/hostlistassignment.webp)

At a top-level job group, there is no host list to be inherited. The __Use Default Settings__ option is grayed-out. However, a sub-job group can inherit host lists from a parent job group. Host lists are configured through the __Host Management__ node. See the [Host Management](../../hostmanagement/overview.md) topic for additional information.
