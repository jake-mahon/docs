...
- Target Hosts – Custom Host List
  ...
  - Format – [HOST]:8080
  - Assign host list at the __FS\_DEFEND\_SDD__ > __Configure__ > __Hosts__ (see the [Hosts Node](/docs/accessanalyzer/enterpriseauditor/admin/jobs/job/configure/hosts.md) topic for additional information)
