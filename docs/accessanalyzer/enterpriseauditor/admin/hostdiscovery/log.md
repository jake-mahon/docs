...
![Discovery Log](../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/discoverylog.webp)

The Discovery Log logging level is configured within the __Settings__ > __Host Discovery__ node. See the [Host Discovery](../settings/hostdiscovery.md) topic for additional information.
