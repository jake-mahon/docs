...
![Host Discovery Queries Pane](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/queries.webp)
...
![Field Chooser option on context menu](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/queriesfieldchooser.webp)

__Step 2 –__ Select __Field Chooser__, which opens the Customization window.

![Customization window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/queriescustomizationwindow.webp)

__Step 3 –__ Select the __Columns__ tab.

![Drag hidden colum into table](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/queriesaddhiddencolumn.webp)

__Step 4 –__ Drag and drop the desired column between any header of the table.

![Host Discovery Queries table with column added](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/querieshiddencolumnadded.webp)
