...
![Activities pane](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/activities.webp)
...
- Schedule – Opens the Schedule wizard to schedule query execution
  ...
  - See the [Schedule](/docs/accessanalyzer/enterpriseauditor/admin/settings/schedule.md) topic for additional information on the Schedule wizard
- View Host List – Opens the [Host Management](/docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/overview.md) node directly to the selected query’s generated host list
