...
![Import Location option on Activities pane](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocation.png)

__Step 2 –__ Select the host list and click __Import Location__.

![Import Hosts window for importing location](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationwindow.png)
...
![Import Hosts window Location column selection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationcsv.png)
...
![Imported Location column data in the data grid](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationcomplete.png)
