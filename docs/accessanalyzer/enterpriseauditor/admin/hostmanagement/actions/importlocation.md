...
![Import Location option on Activities pane](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocation.webp)

__Step 2 –__ Select the host list and click __Import Location__.

![Import Hosts window for importing location](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationwindow.webp)
...
- Database
  ...
  - Data source – Identify the database. Click the ellipsis (__…__) to open the Data Link Properties window. Provide the required information on the Connection tab of the Data Link Properties window, and then click __OK__. See the [Import From a Database](/docs/accessanalyzer/enterpriseauditor/admin/hostdiscovery/wizard/database.md) topic for additional information.
...
![Import Hosts window Location column selection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationcsv.webp)
...
![Imported Location column data in the data grid](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/importlocationcomplete.webp)
