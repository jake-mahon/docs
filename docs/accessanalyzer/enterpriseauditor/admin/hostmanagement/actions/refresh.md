...
![Refresh Hosts option on Activities pane](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/refreshhosts.webp)

Select the hosts or host list to inventory and then click __Refresh Hosts__ in the Activities pane.

![Refresh Hosts Confirm dialog](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/refreshhostsconfirm.webp)
