...
![Confirm dialog box](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/confirmdeletelist.png)
...
![Confirm deletion of orphaned hosts from master host table dialog box](/img/product_docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/confirmdeletelistmaster.png)
