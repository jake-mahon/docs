...
__NOTE:__ Host list names can also be changed using the __Edit List__ option, see the [Edit List](/docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/editlist.md) topic for additional information.
