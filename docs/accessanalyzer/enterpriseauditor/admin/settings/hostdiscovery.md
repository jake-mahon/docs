...
![Host Discovery page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscovery.png)
...
![Log level options](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscoveryloglevels.png)
...
![Host Discovery Log under Host Discovery node](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscoverylog.png)
