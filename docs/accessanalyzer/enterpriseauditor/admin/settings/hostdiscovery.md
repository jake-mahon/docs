...
![Host Discovery page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscovery.webp)
...
![Log level options](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscoveryloglevels.webp)
...
![Host Discovery Log under Host Discovery node](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscoverylog.webp)
