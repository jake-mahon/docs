...
![Exchange - Set up the connection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_1.png)
...
![Set up the connection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_3.png)
...
- Click the Test Exchange settings link.
  ...
  ![Test Exchange Connection Setting](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_4.png)
...
![exchange_6](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_6.png)
