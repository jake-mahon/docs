...
![Exchange - Set up the connection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_1.webp)

The Exchange node is grayed-out by default. In order for these settings to be enabled, it is necessary to install both Access Analyzer MAPI CDO and Microsoft Exchange MAPI CDO on the Access Analyzer Console server. See the [StealthAUDIT MAPI CDO Installation](/docs/accessanalyzer/stealthaudit/install_guides/mapi_cdo_install/stealthaudit_mapi_cdo_installation.md) topic for additional information.
...
![Set up the connection](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_3.webp)
...
- Click the Test Exchange settings link.
  ...
  ![Test Exchange Connection Setting](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_4.webp)
...
![exchange_6](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange_6.webp)
