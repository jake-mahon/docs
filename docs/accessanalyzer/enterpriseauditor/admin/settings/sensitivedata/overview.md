...
- Criteria – Configure Search Criteria to be used in Sensitive Data scan jobs. See the [Criteria Tab](/docs/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/criteria.md) topic for additional information.
- False Positives – Configure False Positive exclusion filters. See the [False Positives Tab](/docs/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/exclusions/overview.md) topic for additional information.
