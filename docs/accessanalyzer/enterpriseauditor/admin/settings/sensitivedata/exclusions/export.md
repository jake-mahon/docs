...
![Export on False Positives tab](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/exclusions/exportfilter.webp)

__Step 1 –__ Select the false positive exclusion filters to export and click __Export__. The File Explorer opens.

![Select False Positive Exclusion filter file to export File Explorer window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/exclusions/exportfileexplorer.webp)
