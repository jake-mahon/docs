...
- [Access](/docs/accessanalyzer/enterpriseauditor/admin/settings/access/overview.md)
  ...
  - Configure REST API
- [Application](/docs/accessanalyzer/enterpriseauditor/admin/settings/application/overview.md)
...
- [Connection](/docs/accessanalyzer/enterpriseauditor/admin/settings/connection/overview.md)
...
- [Exchange](/docs/accessanalyzer/enterpriseauditor/admin/settings/exchange.md)
...
- [History](/docs/accessanalyzer/enterpriseauditor/admin/settings/history.md)
  - Configure job data retention period settings
  - Configure diagnostics retention period settings
- [Host Discovery](/docs/accessanalyzer/enterpriseauditor/admin/settings/hostdiscovery.md)
  - Configure host discovery settings
  - Configure discovery log settings
- [Host Inventory](/docs/accessanalyzer/enterpriseauditor/admin/settings/hostinventory.md)
  - Configure inventory items, performance tuning, and desired host list views
- [Notification](/docs/accessanalyzer/enterpriseauditor/admin/settings/notification.md)
...
- [Reporting](/docs/accessanalyzer/enterpriseauditor/admin/settings/reporting.md)
...
- [Schedule](/docs/accessanalyzer/enterpriseauditor/admin/settings/schedule.md)
...
- [Sensitive Data](/docs/accessanalyzer/enterpriseauditor/admin/settings/sensitivedata/overview.md)
...
- [ServiceNow](/docs/accessanalyzer/enterpriseauditor/admin/settings/servicenow.md)
...
- [Storage](/docs/accessanalyzer/enterpriseauditor/admin/settings/storage/overview.md)
...
See the [Getting Started](/docs/accessanalyzer/enterpriseauditor/gettingstarted.md) topic for additional information.
