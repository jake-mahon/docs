...
![Host Inventory Settings page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/hostinventory.png)
...
___RECOMMENDED:___ Leave the default setting of all the groups selected. Consult with [Netwrix Support](https://www.netwrix.com/support.html) prior to turning off any of these property groups.
...
The __Cancel__ and __Save__ buttons are in the lower-right corner of the Host Inventory view. These buttons become enabled when modifications are made to the Host Inventory global settings. Whenever changes are made at the global level, click __Save__ and then __OK__ to confirm the changes. Otherwise, click __Cancel__ if no changes were intended.
...
![AD Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/ad.png)
...
![ALL WINDOWS HOSTS Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/allwindowshosts.png)
...
![DG Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/dg.png)
...
![EXCHANGE Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/exchange.png)
...
![SQL Servers Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/sqlservers.png)
...
![Windows Server Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/windowsserver.png)
...
![Work Station Host List](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/workstation.png)
