...
__Step 1 –__ In the Access Analyzer directory, navigate to __PrivateAssemblies__ and edit the __rba-roles.conf__ file.  Add a new section for the custom role as shown in the following instructions:
