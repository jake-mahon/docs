...
![Add Access option on Access page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/access/rolebased/addaccess.webp)

__Step 1 –__ Navigate to __Settings__ > __Access__ and click __Add Access__. The Access Type wizard opens.

![Access Type page of the Access Role wizard](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/access/restapi/accesstypeapplication.webp)
...
![Application Access page of the Access Role Wizard](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/access/restapi/applicationaccess.webp)
...
![Select database objects window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/access/restapi/selectdatabaseobjects.webp)
...
![Application Details page of the Access Role Wizard](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/access/restapi/applicationdetails.webp)
