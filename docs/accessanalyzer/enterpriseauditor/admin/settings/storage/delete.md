...
![Delete Storage Profile option](/img/product_docs/strongpointfornetsuite/integrations/delete.png)

__Step 1 –__ Select the Storage Profile to be removed, and click __Delete__.

![Confirm delete selected profile dialog](/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/storage/deleteconfirm.png)
