...
- Access Token – Copy and paste the StealthDEFEND App Token after it has been generated within StealthDEFEND. See the [FS\_DEFEND\_SDD Job](/docs/accessanalyzer/enterpriseauditor/admin/jobs/instantjobs/fs_defend_sdd.md) topic for additional information.
