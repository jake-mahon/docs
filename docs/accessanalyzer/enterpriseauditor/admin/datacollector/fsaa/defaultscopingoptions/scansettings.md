...
![FSAA Data Collector Wizard Default Scoping Options page Scan Settings tab](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/scansettings.png)
...
![Action on failure to enable LAT preservation dropdown options](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/defaultscopingoptions/actionlatpreservationfailure.png)
...
![Action on changed LAT after scan dropdown options](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/defaultscopingoptions/actionchangedlat.png)
