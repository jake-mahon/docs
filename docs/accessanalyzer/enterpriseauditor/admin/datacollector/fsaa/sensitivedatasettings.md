...
![FSAA Data Collector Wizard Sensitive Data Settings page](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/upgrade/sensitivedata.png)
