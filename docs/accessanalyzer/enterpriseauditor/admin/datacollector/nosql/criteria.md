...
![NoSQL Data Collector Wizard Criteria page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/ewsmailbox/criteria.webp)

The options on the Criteria page are:

- Use Global Criteria Selection – Select this option to inherit sensitive data criteria settings from the __Settings__ > __Sensitive Data__ node. See the [Sensitive Data](../../settings/sensitivedata/overview.md) topic for additional information.
