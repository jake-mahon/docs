...
![Test Access page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/spaa/testaccess.png)
...
|  |  |
| --- | --- |
| ![Successful test example](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/spaa/testaccessgoodtest.png) | ![Unsuccessful test example](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/spaa/testaccessbadtest.png) |
