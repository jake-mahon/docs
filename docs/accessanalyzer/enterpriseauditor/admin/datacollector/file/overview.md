...
__NOTE:__ For enhanced file system data collections, use the [FileSystemAccess Data Collector](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/fsaa/overview.md).

Supported Platforms

This data collector can target the same servers supported for the FileSystemAccess Data Collector. See the [File System Supported Platforms](/docs/accessanalyzer/enterpriseauditor/requirements/target/filesystems.md) topic for a full list of supported platforms.
...
- Welcome
- [File: Category](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/file/category.md)
- [File: Target Files](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/file/targetfiles.md)
