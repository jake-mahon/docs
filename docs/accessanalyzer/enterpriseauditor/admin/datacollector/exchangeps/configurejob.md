...
- The host name must be the domain name of the tenant, for example ```company.onmicrosoft.com```. See the [Identify the Tenant's Name](/docs/accessanalyzer/config/exchangeonline/access.md#identify-the-tenants-name) topic for additional information.

See the [Add Hosts](/docs/accessanalyzer/enterpriseauditor/admin/hostmanagement/actions/add.md) topic for instructions on creating a custom host list.
