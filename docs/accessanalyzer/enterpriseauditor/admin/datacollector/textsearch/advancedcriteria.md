...
![Text Search Data Collector Wizard Advanced Criteria page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/textsearch/advancedcriteria.webp)
...
- Customize – Click this button to open the Filter builder
  ...
  ![Filter builder window](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/textsearch/filterbuilder.webp)

  See the [Filtration Dialog](../../navigate/datagrid.md#filtration-dialog) topic for information on using the Filter builder.
