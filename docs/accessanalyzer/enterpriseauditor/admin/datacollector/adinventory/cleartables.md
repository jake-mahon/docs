...
![Remove Tables task selected on Active Directory Inventory DC Wizard Category page ](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/adinventory/categoryremovetables.webp)
