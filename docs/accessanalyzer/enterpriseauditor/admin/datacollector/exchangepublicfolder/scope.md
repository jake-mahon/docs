...
![Scope page with Selected Public Folders option selected](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/scopeselectedpublicfolders.webp)
...
![Scope page with Selected Table option selected](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/scopeselectedtable.webp)

Configure the selected tables to be queried:

- Table Name – retrieves the list of selected public folders from a Access Analyzer database table. Click __Retrieve__ to populate the Table name box with all available tables within the database.
