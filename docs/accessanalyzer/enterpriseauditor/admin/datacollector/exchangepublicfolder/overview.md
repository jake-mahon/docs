...
The ExchangePublicFolder Data Collector audits an Exchange Public Folder, including contents, permissions, ownership, and replicas. This is a MAPI-based data collector which requires the __Settings > Exchange__ node to be enabled and configured. See the [Exchange](/docs/accessanalyzer/enterpriseauditor/admin/settings/exchange.md) topic for additional information.
...
- Welcome
- [ExchangePublicFolder: Category](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/category.md)
- [ExchangePublicFolder: Scope](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/scope.md)
- [ExchangePublicFolder: Properties](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/properties.md)
- [ExchangePublicFolder: Options](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/options.md)
- [ExchangePublicFolder: Probable Owner](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/probableowner.md)
- [ExchangePublicFolder: Summary](/docs/accessanalyzer/enterpriseauditor/admin/datacollector/exchangepublicfolder/summary.md)
...
See the [Exchange](/docs/accessanalyzer/enterpriseauditor/admin/settings/exchange.md) topic for additional information.
