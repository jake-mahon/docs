...
- Filter options
  ...
  - Only select database objects — Scope to specific databases
    ...
    - Click __Retrieve__ to display available server audits
- Available database objects — Displays known databases and instances for query scoping

  - Select from the available list and click __Add__
...
- Service Type— If applicable, select whether the service type is __Service__ or __SID__
...
![Add custom filter window](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/sql/addcustomfilter.webp)
