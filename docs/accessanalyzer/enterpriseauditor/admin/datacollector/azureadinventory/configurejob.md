...
[Microsoft Entra ID Auditing Configuration](../../../../config/entraid/access.md) for additional
information.
...
- The host name must be the domain name of the tenant, for example `company.onmicrosoft.com`. See
  the [Identify the Client ID](../../../../config/entraid/access.md#identify-the-client-id) topic
