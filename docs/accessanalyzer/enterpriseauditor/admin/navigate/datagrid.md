...
![Data Grid Functionality](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality1.png)
...
![Customization Window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality2.png)

To open the Customization window, select Field Chooser from the column header right-click menu.

![Customization Window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality3.png)
...
![Footer Option](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality4.png)

To enable the footer, right-click in a column header and select Footer from the right-click menu.

![Footer display](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality5.png)
...
![Footer options](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality6.png)
...
![Sort Order](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality7.png)
...
| ![Default Group By View](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality8.png) | ![Organized by Column Header](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality9.png) |
| --- | --- |
...
![Expand Group View](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality10.png)
...
![Column Header](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality11.png)
...
![Filter](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality12.png)
...
![Custom Filter](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality13.png)
...
![Creating a Custom Filter](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality14.png)
...
![Selected Filter Criteria](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality15.png)
...
![Filtration Dialog](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality16.png)
...
![Advanced Search](/img/product_docs/accessanalyzer/enterpriseauditor/admin/navigate/datagridfunctionality17.png)
