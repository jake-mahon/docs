...
Once you have selected the data source, click __Next__ to proceed to the Configure page. See the [Configure](/docs/accessanalyzer/enterpriseauditor/admin/report/chartwizard/configure.md) topic for additional information.
