...
![Publish Security page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/wizard/publishsecurity.png)
...
![Select User, Service Account, or Group window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/wizard/addreportviewer.png)

__Step 2 –__ On the Select User, Service Account or Group window, select the desired account and then click __OK__.

![Report Viewer user added in wizard](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/wizard/reportviewer.png)
