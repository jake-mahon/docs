...
__NOTE:__ In order for reports to be emailed, the SMTP server information must be configured in the __Settings__ > __Notification__ node. See the [Notification](/docs/accessanalyzer/enterpriseauditor/admin/settings/notification.md) topic for additional information.
