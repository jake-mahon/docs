...
![Report Configuration wizard E-mail page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/settings/email.webp)
...
__NOTE:__ In order for reports to be emailed, the SMTP server information must be configured in the __Settings__ > __Notification__ node. See the [Notification](../../settings/notification.md) topic for additional information.
...
![Settings configured to email the report](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/wizard/emailconfigured.webp)
