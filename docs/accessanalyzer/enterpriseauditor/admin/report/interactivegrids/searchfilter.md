...
The following example shows an interactive grid in which searching has been enabled. See the [Grid](/docs/accessanalyzer/enterpriseauditor/admin/report/wizard/widgets.md#grid) topic for additional information.
...
![Enumerated Table](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/enumerated.webp)
...
![Date column filter](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/datefilter.webp)
...
![Add and remove columns](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/addremovecolumns.webp)
