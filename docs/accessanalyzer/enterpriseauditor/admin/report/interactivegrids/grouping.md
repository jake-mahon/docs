...
The following example shows an interactive grid in which grouping has been enabled. See the [Grid](../wizard/widgets.md#grid) topic for additional information.

![Group by option](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/groupby.webp)
