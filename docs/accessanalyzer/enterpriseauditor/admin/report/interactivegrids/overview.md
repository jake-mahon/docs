...
![Interactive Grid actions bar](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/interactivegridoptions.webp)
...
- Download Data – Click to download all data to a CSV file. This option is displayed when the __Export table data as CSV__ checkbox has been selected for the report, see the [Grid](../wizard/widgets.md#grid) topic for additional information.
...
![Group by loading data](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/interactivegrids/groupbyloadingdata.webp)
