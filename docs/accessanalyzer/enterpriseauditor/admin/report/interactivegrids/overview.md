...
- Download Data – Click to download all data to a CSV file. This option is displayed when the __Export table data as CSV__ checkbox has been selected for the report, see the [Grid](/docs/accessanalyzer/enterpriseauditor/admin/report/wizard/widgets.md#grid) topic for additional information.
