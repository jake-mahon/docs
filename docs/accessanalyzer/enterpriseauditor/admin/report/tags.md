...
| ![Tags tab on Web Console homepage](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/tagstab.png) | ![Priviliged Accounts tag page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/privilegedaccountstag.png) |
| --- | --- |
...
![Job Group view in the Web Console](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/jobgroupview.png)
...
![Report header](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/reportheader.png)
