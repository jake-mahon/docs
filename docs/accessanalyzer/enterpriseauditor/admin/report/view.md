...
![Report in the Results node](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/viewresultsnode.png)

Select the desired report to be viewed. The report displays in the Results pane of the console.

![Access report from configure page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/viewconfigure.png)
...
![Web Console .Active Directory Inventory](/img/product_docs/accessanalyzer/enterpriseauditor/admin/report/webconsolesolutioninventory.png)
