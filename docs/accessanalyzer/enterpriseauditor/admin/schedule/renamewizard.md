...
![Rename Scheduled Task wizard Tasks page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/schedule/tasks.webp)
...
![Group with multiple sub-group credentials to be updated](/img/product_docs/accessanalyzer/enterpriseauditor/admin/schedule/taskssubgroups.webp)
...
![Set Account window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/schedule/setaccount.webp)

__Step 2 –__ On the Set Account window, click __Change User__.

![Schedule Custom Credentials window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/schedule/schedulecustomcredentials.webp)
...
![Tasks page after credentials updated](/img/product_docs/accessanalyzer/enterpriseauditor/admin/schedule/tasksupdated.webp)
...
![Rename Scheduled Task wizard Progress page](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/upgrade/progress.webp)
