...
![New Mailbox Action Wizard Folder Conditions page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/datacollector/ewsmailbox/filterwizard/folderconditions.png)
...
![Folder Inclusion/Exclusion Window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/action/mailbox/folderinclusionexclusionwindow.png)

Include/Exclude folders using the following options:

- Click __Add__ to populate a field to add a folder path

  ![New field added on Folder Inclusion/Exclusion window](/img/product_docs/accessanalyzer/enterpriseauditor/admin/action/mailbox/folderinclusionexclusionwindownew.png)
