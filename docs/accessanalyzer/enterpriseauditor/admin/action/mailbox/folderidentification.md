...
![New Mailbox Action Wizard Folder Identification page](../../../../../../static/img/product_docs/accessanalyzer/enterpriseauditor/admin/action/mailbox/folderidentification.webp)
...
- No, the query results do not contain a mailbox folder identification column – Selecting this enables the Folder Conditions page, used to identify specific folders to target. See the [Mailbox: Folder Conditions](folderconditions.md) topic for additional information.
