...
See the [Azure SQL Auditing Configuration](/docs/accessanalyzer/enterpriseauditor/requirements/target/config/azuresqlaccess.md) topic for additional information.
