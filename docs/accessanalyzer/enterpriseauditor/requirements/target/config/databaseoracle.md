...
When using a least privileged model for Oracle, __SYSDBA__ must be selected for the Role in the User Credentials window for the Oracle Connection Profile. See the [Oracle for User Credentials](/docs/accessanalyzer/enterpriseauditor/admin/settings/connection/profile/oracle.md) topic for additional information.
