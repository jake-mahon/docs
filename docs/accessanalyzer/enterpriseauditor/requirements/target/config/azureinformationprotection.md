...
6. Enable settings in FSAA Data Collector in Access Analyzer.
   ...
   - See the FileSystemAccess Data Collector section in the [File System Solution](../../../solutions/filesystem/overview.md) topic for additional information
...
See the FileSystemAccess Data Collector section in the [File System Solution](../../../solutions/filesystem/overview.md) topic for additional information on these scoping options.
