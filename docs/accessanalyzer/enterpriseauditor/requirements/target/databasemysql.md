...
The Access Analyzer for Databases Solution provides the ability to audit and monitor MySQL database environments to collect permissions and sensitive data. It scans:
...
- Windows (Access Analyzer host) -
  Windows Management Framework 3+ installed on the Access Analyzer Console server (Windows 2012 and later)
- Windows (MySQL host)
  - WinRM enabled
- MySQL
