...
![Configuration Settings](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationmenu.webp)
...
![Discovery Node options](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane1.webp)

The Discovery node right-click menu options are:

- Create Query – Opens the [Host Discovery Wizard](../hostdiscovery/wizard/overview.md)
...
![All Hosts Node options](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane2.webp)
...
![Host List Node options](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane3.webp)

The All Hosts > [Host List] node right-click menu options are:

- Edit List – Opens the [Add Hosts](../hostmanagement/actions/add.md) window for the selected list
...
See the [Jobs Tree](../jobs/overview.md) topic for additional information on these actions.
...
| ![Jobs Tree Primary Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane6.webp) |
| --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
...
- Properties – Opens the [Job Properties](../jobs/job/properties/overview.md) window

#### [Job] > Status Node

The [Job] > Status node has the following right-click menu items:

![Status Node](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane7.webp)
...
| ![Table/View Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane10.webp) |
| -------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
...
![Results Node](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane11.webp)
...
![Results-Table View Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane12.webp)
...
![Results-Report Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane13.webp)
...
![Configure Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane13.webp)
...
| ![Configure-Configuration Nodes](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane16.webp) |
| ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
...
![Configure-Reports Node](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane17.webp)
...
![Reports Configuration Node](../../../../static/img/product_docs/accessanalyzer/admin/navigate/navigationpane18.webp)
