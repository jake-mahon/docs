...
on the [FSAA: Scan Settings](scansettings.md) page to enable this page in the data collector wizard.
...
![FSAA Data Collector Wizard Azure Tenant Mapping page](../../../../../static/img/product_docs/accessanalyzer/admin/datacollector/fsaa/azuretenantmapping.webp)
