...
![User Credentials - Exchange Modern Authentication ](../../../../../../static/img/product_docs/accessanalyzer/admin/settings/connection/profile/exchangemodernauthentication.webp)
