...
![Survey Action Module Wizard Summary page](../../../../../static/img/product_docs/accessanalyzer/admin/datacollector/adinventory/summary.webp)

Click **Save Template** to access the Save Survey Template window.

![Save Survey Template window](../../../../../static/img/product_docs/accessanalyzer/admin/action/survey/savesurveytemplate.webp)
