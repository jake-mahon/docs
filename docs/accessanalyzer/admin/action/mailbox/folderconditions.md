...
![New Mailbox Action Wizard Folder Conditions page](../../../../../static/img/product_docs/accessanalyzer/admin/datacollector/ewsmailbox/filterwizard/folderconditions.webp)
...
![Folder Type Window](../../../../../static/img/product_docs/accessanalyzer/admin/datacollector/ewsmailbox/filterwizard/foldertypewindow.webp)
...
![Folder Inclusion/Exclusion Window](../../../../../static/img/product_docs/accessanalyzer/admin/action/mailbox/folderinclusionexclusionwindow.webp)

Include/Exclude folders using the following options:

- Click **Add** to populate a field to add a folder path

    ![New field added on Folder Inclusion/Exclusion window](../../../../../static/img/product_docs/accessanalyzer/admin/action/mailbox/folderinclusionexclusionwindownew.webp)
