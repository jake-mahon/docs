...
![Exchange Mailbox Data Collector Wizard Scope page](/img/product_docs/accessanalyzer/11.6/admin/datacollector/exchangemailbox/scope.webp)
...
- Selected table – Populates the **Available tables** list with tables from the Enterprise Auditor
  database
    ...
    ![Scope page with Selected table selected](/img/product_docs/accessanalyzer/11.6/admin/datacollector/exchangemailbox/scopeselectedtable.webp)
