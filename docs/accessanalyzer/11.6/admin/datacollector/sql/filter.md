...
![SQL Data Collector Wizard Filter page](/img/product_docs/accessanalyzer/11.6/admin/datacollector/sql/filter.webp)
...
![Manage Connections window](/img/product_docs/accessanalyzer/11.6/admin/datacollector/sql/manageconnections.webp)
