...
- [UX_MakeDirectory Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/unix/privilegedaccess/sudoers/collection/ux_makedirectory.md)
...
- [UX_ParseSudeors Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/unix/privilegedaccess/sudoers/collection/ux_parsesudeors.md)
