...
- [SG_GroupPolicy Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/windows/privilegedaccounts/logonrights/collection/sg_grouppolicy.md)
...
- [SG_LocalMembership Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/windows/privilegedaccounts/logonrights/collection/sg_localmembership.md)
  – This job collects local group membership details from all targeted servers
- [SG_LocalUsers Job](/docs/accessanalyzer/11.6/accessanalyzer/solutions/windows/privilegedaccounts/logonrights/collection/sg_localusers.md)
