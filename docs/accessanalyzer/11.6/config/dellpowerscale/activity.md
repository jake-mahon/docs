...
Checklist Item 2:
[Install Dell CEE](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/installcee.md)
...
[Validate Setup](/versioned_docs/enterpriseauditor_11.6/config/dellpowerscale/validate.md) topic for
