...
Checklist Item 2:
[Install Dell CEE](/versioned_docs/enterpriseauditor_11.6/config/dellunity/installcee.md)
...
- See the [Validate Setup](/versioned_docs/enterpriseauditor_11.6/config/dellunity/validate.md)
