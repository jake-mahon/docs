...
![Diagram of difference between an implementation with and without proxy servers](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/filesystemproxy/fsaaproxyarchitecture.webp)
