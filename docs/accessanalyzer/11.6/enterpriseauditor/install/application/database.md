...
![SQL Server Management Studio create New Database](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/createnewdatabase.webp)

**Step 1 –** Create a new database for use with Enterprise Auditor. Right-click on the **Databases**
node and choose **New Database**.

![SQL Server Management Studio New Database window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/newdatabase.webp)
...
![SQL Server Management Studio create New Login](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/newlogin.webp)
...
![SQL Server Management Studio new login with Windows authentication](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/loginwindows.webp)
...
![SQL Server Management Studio new login with SQL Server authentication](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/loginsql.webp)
...
![SQL Server Management Studio New Login User Mapping](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/loginusermapping.webp)
...
![Connection report window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/connectionreport.webp)
...
![Change storage profile dialog](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/changestorageprofile.webp)
