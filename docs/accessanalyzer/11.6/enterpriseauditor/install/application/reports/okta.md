...
![Okta Browse App Integration Catalog](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktawsfedtemplate.webp)
...
![Okta Application copy link address](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktacopylinkaddress.webp)
...
![Okta application values in WebServer.exe.config file](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/webserverexeconfigokta.webp)
...
![oktaprofileeditor](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktaprofileeditor.webp)
...
![Okta Add Attribute button](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktaaddattribute.webp)

**Step 3 –** Click **Add Attribute** to open the Add Attribute window.

![Okta Add Atrribute window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktaaddattributewindow.webp)
...
![To Okta option under the Directory Provisioning Tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktadirectoryprovisioningtookta.webp)

**Step 5 –** Navigate to the **Directory** menu and click on the **Provisioning** tab. Click **To
Okta**.

![Okta Show Unmapped Attributes](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktashowunmappedattributes.webp)
...
![Okta Unmapped Attribute configuration window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktaunmappedattributeconfigscreen.webp)
...
![Okta Attribute Mappings Force Sync](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktaattributemappingsforcesync.webp)
...
![Okta MFA App Sign on Rule window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktamfaappsignonrule.webp)
...
![Okta MFA App Sign on Rule window Access section](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/install/application/reports/oktamfaappsignonruleaccess.webp)
