...
![1. Cleanup Assessment > FS_CleanupAssessment Job in the Jobs Tree](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/jobstree.webp)
...
![Analysis Tasks for the FS_CleanupAssessment Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/cleanup/cleanupassessmentanalysis.webp)
...
![File Details tab of the FSAA Data Collector Wizard Default Scoping Options page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/fsaa/defaultscopingoptions/filedetails.webp)

**Step 4 –** Navigate to the **Default Scoping Options** page and click the **File Details** tab.

![Options to select on File Details tab](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/filesystem/cleanup/includemetadatatagoptions.webp)
