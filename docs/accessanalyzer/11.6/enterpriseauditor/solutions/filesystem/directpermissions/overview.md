...
- [FS_DomainUserACLs Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/directpermissions/fs_domainuseracls.md)
  – Reports on domain users that have been granted direct permissions on resources from targeted
  file servers
- [FS_HighRiskACLs Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/directpermissions/fs_highriskacls.md)
...
- [FS_LocalUsersAndGroups Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/directpermissions/fs_localusersandgroups.md)
  ...
  targeted file servers
- [FS_MissingFullControl Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/directpermissions/fs_missingfullcontrol.md)
...
- [FS_UnresolvedSIDs Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/filesystem/directpermissions/fs_unresolvedsids.md)
