...
- [Collection > PF_ContentScans Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/publicfolders/content/pf_contentscans.md)
  – Comprised of data collection that focuses on public folder content aging within each public
  folder
- [PF_Content Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/publicfolders/content/pf_content.md)
