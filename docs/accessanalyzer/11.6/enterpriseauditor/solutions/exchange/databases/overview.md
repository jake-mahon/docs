...
- [0.Collection Job Group](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/databases/collection/overview.md)
  – Comprised of data collection, analysis, and reports that focus on database sizing, growth, and
  trends
- [EX_DBSizing Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/databases/ex_dbsizing.md)
...
- [EX_DBTrending](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/databases/ex_dbtrending.md)
