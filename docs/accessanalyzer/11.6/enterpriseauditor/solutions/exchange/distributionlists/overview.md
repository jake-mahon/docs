...
- [Effective Membership > EX_GroupExpansion Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/distributionlists/ex_groupexpansion.md)
  – Expands the direct membership of distribution groups in the environment
- [Membership Analysis Job Group](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/distributionlists/membershipanalysis/overview.md)
...
- [EX_DLCleanup Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/exchange/distributionlists/ex_dlcleanup.md)
