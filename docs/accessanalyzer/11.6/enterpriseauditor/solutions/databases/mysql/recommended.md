...
[Configure the SensitiveDataScan Query](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/mysql/collection/mysql_sensitivedatascan.md#configure-the-sensitivedatascan-query)
