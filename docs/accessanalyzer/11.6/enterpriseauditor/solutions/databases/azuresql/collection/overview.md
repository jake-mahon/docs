...
- [3-AzureSQL_ActivityScan Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/azuresql/collection/3-azuresql_activityscan.md)
  — Captures user activity from all targeted Azure SQL instances and databases
- [4-AzureSQL_ServerSettings Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/azuresql/collection/4-azuresql_serversettings.md)
