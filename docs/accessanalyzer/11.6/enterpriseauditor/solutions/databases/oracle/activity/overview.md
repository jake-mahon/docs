...
- [Oracle_Activity Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_activity.md)
...
- [Oracle_Logons Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_logons.md)
...
- [Oracle_PermissionChanges Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_permissionchanges.md)
  ...
  database objects.
- [Oracle_SchemaChanges Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_schemachanges.md)
  – This job is designed to provide detailed information about the changes in permissions across all
  the database objects. Audited activities include granting, altering, and revoking permissions on
  database objects.
- [Oracle_SensitiveDataActivity Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_sensitivedataactivity.md)
...
- [Oracle_SuspiciousActivity Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_suspiciousactivity.md)
...
- [Oracle_UnusualActivity Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/databases/oracle/activity/oracle_unusualactivity.md)
