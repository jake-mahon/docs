...
- [1-Box_Access Scans Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/box/collection/1-box_access_scans.md)
...
- [1-Box_Activity Scans Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/box/collection/1-box_activity_scans.md)
  – Collects the data which will be further analyzed in order to provide visibility into user
  activity events within Box
- [2-Box_Import Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/box/collection/2-box_import.md)
