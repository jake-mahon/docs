...
![Analysis Task for the AWS_OpenBuckets Job](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/aws/s3permissions/openbucketsanalysis.webp)
