...
See the
[Target Windows Server and Desktop Requirements, Permissions, and Ports](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/requirements/target/windows.md)
...
![Windows Solution in the Jobs Tree](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/jobstree.webp)
...
![Windows Solution Overview page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/runninginstances/overviewpage.webp)

The jobs and job groups in the Windows Solution are:

- [Applications Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/applications/overview.md)
...
- [Authentication Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/authentication/overview.md)
...
- [Open Access Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/openaccess/overview.md)
...
- [Security Utilities Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/securityutilities/overview.md)
  – This group provides a series of security element checks across the audited environment
- [SG_SecurityAssessment Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/sg_securityassessment.md)
