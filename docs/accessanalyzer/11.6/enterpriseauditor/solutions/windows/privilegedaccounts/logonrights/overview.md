...
![Logon Rights Job Group in the Jobs Tree](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/jobstree.webp)

The jobs and job groups in the Logon Rights job group are:

- [Collection Job Group](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/privilegedaccounts/logonrights/collection/overview.md)
...
- [SG_AccountPrivileges Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/privilegedaccounts/logonrights/sg_accountprivileges.md)
...
- [SG_LocalPolicies Job](/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/solutions/windows/privilegedaccounts/logonrights/sg_localpolicies.md)
