...
- [SG_LSASettings Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/windows/authentication/sg_lsasettings.md)
...
- [SG_SecuritySupportProviders Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/windows/authentication/sg_securitysupportproviders.md)
  – This job identifies security support providers on all targeted hosts, highlighting potentially
  malicious SSPs
- [SG_WDigestSettings Job](/docs/accessanalyzer/11.6/enterpriseauditor/solutions/windows/authentication/sg_wdigestsettings.md)
