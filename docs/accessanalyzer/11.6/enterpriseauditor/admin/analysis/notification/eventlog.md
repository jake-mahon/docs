...
![Notification Data Analysis Module wizard Event Log properties page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/notification/eventlog.webp)
