...
![View and Table Creation Analysis Module wizard Result Sample page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/analysis/sqlviewcreation/resultsample.webp)
