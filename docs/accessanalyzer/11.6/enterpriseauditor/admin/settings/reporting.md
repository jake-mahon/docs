...
![Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/reporting.webp)
...
![Website URL on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/websiteurl.webp)
...
![Publish Option on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/publish.webp)
...
![Email options on Global Settings Reporting page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/email.webp)
...
![javascriptsitepermissions](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/javascriptsitepermissions.webp)

**Step 2 –** Go to the **Cookies and site permissions** settings page, and click **JavaScript**
under All permissions.

![javascriptsettings](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/javascriptsettings.webp)
