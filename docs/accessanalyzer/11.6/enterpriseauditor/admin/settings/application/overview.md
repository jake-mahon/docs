...
![Application](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/application.webp)
...
![Application Log](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/applicationlog.webp)
...
![Profile Security](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/profilesecurity.webp).
...
![Usage Statistics](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/usagestatistics.webp)
...
![Host Target Options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/hosttargetoptions.webp)
...
![Grid View Parameters](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/gridviewparameters.webp)
...
![Cleanup Options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/cleanup.webp)
...
![Application Exit Options](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/applicationexitoptions.webp)
...
![Confirm Exit](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/application/confirmexitwindow.webp)
