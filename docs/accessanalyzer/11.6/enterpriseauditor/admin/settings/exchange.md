...
![Exchange - Set up the connection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_1.webp)
...
![Set up the connection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_3.webp)
...
- Click the Test Exchange settings link.
    ...
    ![Test Exchange Connection Setting](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_4.webp)
...
![exchange_6](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/settings/exchange_6.webp)
