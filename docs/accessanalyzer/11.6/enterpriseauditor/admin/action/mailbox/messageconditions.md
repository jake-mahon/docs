...
![New Mailbox Action Wizard Mailbox Message Conditions page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/ewsmailbox/filterwizard/messageconditions.webp)
...
![MessageClasses Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/messageclasseswindow.webp)

Modify message classes using the following options:

- Click **Add** to populate a field to add a message class

    ![New class added in MessageClasses Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/messageclasseswindownew.webp)
...
![Data Range Selection Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/datarangeselectionwindow.webp)
...
![Values Window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/mailbox/valueswindow.webp)
