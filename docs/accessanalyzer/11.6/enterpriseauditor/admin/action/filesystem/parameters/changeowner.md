...
![File System Action Module Wizard Change Owner Parameters page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/action/filesystem/parameters/changeowner.webp)
