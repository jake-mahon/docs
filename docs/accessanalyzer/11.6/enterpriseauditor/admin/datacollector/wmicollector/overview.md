...
- Welcome
- [WMICollector: Sample Host](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/wmicollector/samplehost.md)
- [WMICollector: Classes](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/wmicollector/classes.md)
- [WMICollector: Properties](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/wmicollector/properties.md)
- [WMICollector: Summary (Results)](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/wmicollector/summary.md)
