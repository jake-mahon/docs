...
![Libraries window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/addqueryfromlibrary.webp)
...
![General tab of the Query Properties window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/querypropertiesgeneral.webp)
...
| ![Data Source tab of Query Properties for new Query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/querypropertiesdatasourcenew.webp) | ![Data Source tab of Query Properties for existing Query](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/querypropertiesdatasourceexisting.webp) |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ![Filters tab of Query Properties window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/querypropertiesdatafilters.webp) | ![Filters tab of Query Properties window with a new filter](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/querypropertiesdatafilterswithfilter.webp) |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
