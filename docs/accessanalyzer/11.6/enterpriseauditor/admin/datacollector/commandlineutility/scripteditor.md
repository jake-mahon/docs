...
![Command Line Utility Data Collector Wizard Script Editor page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/commandlineutility/scripteditor.webp)
