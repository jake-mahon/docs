...
![Password Security Data Collection Wizard Category page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/datacollector/adinventory/category.webp)
...
- WeakPasswordScan – Scans an Active Directory for weak passwords. Returns password information per
  ...
  options, see
  the[PasswordSecurity: Options](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/passwordsecurity/options.md)
  topic.
