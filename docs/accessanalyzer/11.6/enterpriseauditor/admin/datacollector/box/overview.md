...
- Welcome
- [Box: Category](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/category.md)
- [Box: Exclusions Page](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/exclusions.md)
- [Box: Scope by User Page](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/scopebyuser.md)
- [Box: Additional Scoping](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/additionalscoping.md)
- [Box: Activity Timeframe Scope](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/activitytimeframescope.md)
- [Box: Activity Operation Scope](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/activityoperationscope.md)
- [Box: Authenticate](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/authenticate.md)
- [Box: Results](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/results.md)
- [Box: Summary](/docs/accessanalyzer/11.6/enterpriseauditor/admin/datacollector/box/summary.md)
