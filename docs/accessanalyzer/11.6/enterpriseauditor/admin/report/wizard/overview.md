...
and
[Editing Existing Reports](/docs/accessanalyzer/11.6/enterpriseauditor/admin/report/edit.md)
...
[Authoring Page](/docs/accessanalyzer/11.6/enterpriseauditor/admin/report/wizard/authoring.md)
page. These include Name, Header information, and publish settings. Click **Next**.

**Step 3 –** On the
[E-mail Page](/docs/accessanalyzer/11.6/enterpriseauditor/admin/report/wizard/email.md)
...
**Step 5 –** On the
[Layout Page](/docs/accessanalyzer/11.6/enterpriseauditor/admin/report/wizard/layout.md)
