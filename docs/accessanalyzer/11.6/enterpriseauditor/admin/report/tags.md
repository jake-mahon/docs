...
| ![Tags tab on Web Console homepage](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/tagstab.webp) | ![Priviliged Accounts tag page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/privilegedaccountstag.webp) |
| -------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
...
![Job Group view in the Web Console](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/jobgroupview.webp)
...
![Report header](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/report/reportheader.webp)
