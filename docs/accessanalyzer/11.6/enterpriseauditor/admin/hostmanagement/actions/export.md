...
![Save As window](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/exportsaveas.webp)
...
![Example HTML File Export](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/exportexamplehtml.webp)

Example XML File Export

![Example XML File Export](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/exportexamplexml.webp)

Example CSV File Export

![Example CSV File Export](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/exportexamplecsv.webp)
