...
![Add Hosts option on Activities pane of the Host Management node](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/addhosts.webp)

**Step 1 –** Click **Add Hosts** to open the Host List Wizard in the Results pane.

![Host List Wizard Specify Manual Host Entry page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/hostlistwizardhostentry.webp)
...
![Host List Wizard Specify Host List Properties page](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/hostlistwizardproperties.webp)
