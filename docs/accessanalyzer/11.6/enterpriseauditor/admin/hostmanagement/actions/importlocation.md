...
![Import Location option on Activities pane](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/importlocation.webp)

**Step 2 –** Select the host list and click **Import Location**.

![Import Hosts window for importing location](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/importlocationwindow.webp)
...
![Import Hosts window Location column selection](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/importlocationcsv.webp)
...
![Imported Location column data in the data grid](/img/versioned_docs/enterpriseauditor_11.6/enterpriseauditor/admin/hostmanagement/actions/importlocationcomplete.webp)
