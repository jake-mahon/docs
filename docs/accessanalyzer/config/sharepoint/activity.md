...
__Step 1 –__ Select Settings > Site settings.

__Step 2 –__ Under Site Collection Administration, click Go to top level site settings.

__Step 3 –__ On the Site Settings page, under Site Collection Administration, select Site collection audit settings.

__Step 4 –__ On the Configure Audit Settings page, in the Documents and Items section select the events to be audited.

__Step 5 –__ Still on the Configure Audit Settings page, in the List, Libraries, and Site section select the events to be audited.

__Step 6 –__ Click OK to save the changes.
