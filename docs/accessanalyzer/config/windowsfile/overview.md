...
See the [Windows File Server Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/config/windowsfile/access.md) topic for instructions.
...
See the [Windows File Server Activity Auditing Configuration](/docs/accessanalyzer/config/windowsfile/activity.md) topic for instructions.
