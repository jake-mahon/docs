...
- Permissions vary based on the Scan Mode Option selected. See the [File System Supported Platforms](../../enterpriseauditor/requirements/target/filesystems.md) topic for additional information.

Windows File System Cluster Requirements

See the [Windows File Server Access & Sensitive Data Auditing Configuration](access.md) topic for instructions.
