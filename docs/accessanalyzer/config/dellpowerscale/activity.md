...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/config/dellpowerscale/installcee.md)
...
- Select method:
  ...
  - [Manually Configure Auditing in OneFS](/docs/accessanalyzer/config/dellpowerscale/manualconfiguration.md)
...
Checklist Item 4: Configure Dell CEE to Forward Events to the Activity Agent. See the [Validate Setup](/docs/accessanalyzer/config/dellpowerscale/validate.md) topic for additional information.
