...
__Step 1 –__ In the Microsoft Purview compliance portal at [https://purview.microsoft.com](https://purview.microsoft.com/), go to __Solutions__ > __Audit__. Or, to go directly to the Audit page at [https://purview.microsoft.com/audit/auditsearch](https://purview.microsoft.com/audit/auditsearch).
