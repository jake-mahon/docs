...
Checklist Item 2: [Provision FPolicy Account](/docs/accessanalyzer/config/netapp7mode/provisionactivity.md)
...
- See the [Enable HTTP or HTTPS](/docs/accessanalyzer/config/netapp7mode/enablehttp.md) topic for instructions.

Checklist Item 4: [Configure FPolicy](/docs/accessanalyzer/config/netapp7mode/configurefpolicy.md)
