...
[NetApp Data ONTAP 7-Mode Access & Sensitive Data Auditing Configuration](access.md) topic for
instructions.
...
See the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](activity.md) topic for
instructions.
