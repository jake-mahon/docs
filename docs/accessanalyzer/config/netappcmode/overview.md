...
See the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](/docs/accessanalyzer/config/netappcmode/activity.md) topic for instructions.
