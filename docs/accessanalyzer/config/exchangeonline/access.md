...
See the [EX_RegisterAzureAppAuth Job](../../enterpriseauditor/admin/jobs/instantjobs/ex_registerazureappauth.md) topic for additional information.
...
The Certificate Thumbprint of this uploaded certificate is needed for the Access Analyzer Connection Profile. See the [Exchange Modern Authentication for User Credentials](../../enterpriseauditor/admin/settings/connection/profile/exchangemodernauth.md) topic for additional information.
...
This is needed for the Access Analyzer Connection Profile. See the [Exchange Modern Authentication for User Credentials](../../enterpriseauditor/admin/settings/connection/profile/exchangemodernauth.md) topic for additional information. Next identify the application’s Client ID.
...
This is needed for the Access Analyzer Connection Profile. See the [Exchange Modern Authentication for User Credentials](../../enterpriseauditor/admin/settings/connection/profile/exchangemodernauth.md) topic for additional information.
