...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/config/dellunity/installcee.md)
...
- Configure initial setup for a Unity device
  ...
  - [Unity Initial Setup with Unisphere](/docs/accessanalyzer/config/dellunity/setupunisphere.md)
...
- See the [Validate Setup](/docs/accessanalyzer/config/dellunity/validate.md) topic for instructions.
