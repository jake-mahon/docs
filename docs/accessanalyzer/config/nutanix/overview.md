...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](access.md) topic for
...
[Nutanix Files Activity Auditing Configuration](activity.md) topic for instructions.
