...
[Dell Celerra & Dell VNX Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/dell-celerra-vnx/access.md) topic for
instructions.
...
See the [Dell Celerra & Dell VNX Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/dell-celerra-vnx/activity.md) topic for
instructions.
