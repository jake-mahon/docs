...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/12.0/configuration/dell-unity/install-cee.md)
...
- Configure initial setup for a Unity device
  ...
  - [Unity Initial Setup with Unisphere](/docs/accessanalyzer/12.0/configuration/dell-unity/setup-unisphere.md)
...
- See the [Validate Setup](/docs/accessanalyzer/12.0/configuration/dell-unity/validate.md) topic for instructions.
