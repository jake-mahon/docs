...
[Dell Unity Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/dell-unity/access.md) topic for instructions.
...
See the [Dell Unity Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/dell-unity/activity.md) topic for instructions.
