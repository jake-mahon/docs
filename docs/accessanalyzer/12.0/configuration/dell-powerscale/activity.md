...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/12.0/configuration/dell-powerscale/install-cee.md)
...
- Select method:
  ...
  - [Manually Configure Auditing in OneFS](/docs/accessanalyzer/12.0/configuration/dell-powerscale/manual-configuration.md)
...
[Validate Setup](/docs/accessanalyzer/12.0/configuration/dell-powerscale/validate.md) topic for additional information.
