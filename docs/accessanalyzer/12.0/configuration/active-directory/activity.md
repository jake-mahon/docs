...
See the [File Archive Repository Option](/docs/accessanalyzer/12.0/configuration/active-directory/file-archive.md) topic for additional information on that
option.
