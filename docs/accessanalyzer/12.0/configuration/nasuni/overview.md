...
[Nasuni Edge Appliance Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/nasuni/access.md) topic for
instructions.
...
[Nasuni Edge Appliance Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/nasuni/activity.md) topic for instructions.
