...
See the [Windows File Server Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/windows-file/access.md) topic for
instructions.
...
See the [Windows File Server Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/windows-file/activity.md) topic for instructions.
