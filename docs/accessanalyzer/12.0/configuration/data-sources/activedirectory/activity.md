...
See the [File Archive Repository Option](/docs/accessanalyzer/12.0/configuration/data-sources/activedirectory/filearchive.md) topic for additional information on that
option.
