...
See the [SharePoint Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/sharepoint/access.md) topic for
instructions.
...
See the [SharePoint On-Premise Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/sharepoint/activity.md) topic for instructions.
