...
[Configure Access to HNAS Audit Logs on Activity Agent Server](/docs/accessanalyzer/12.0/configuration/data-sources/hitachi/configureaccesstologs.md) topic for
