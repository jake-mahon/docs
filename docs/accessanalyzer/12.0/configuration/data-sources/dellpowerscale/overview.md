...
See the [Dell Isilon/PowerScale Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/dellpowerscale/activity.md) topic for
instructions.
