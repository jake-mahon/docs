...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/12.0/configuration/data-sources/dellpowerscale/installcee.md)
...
- Select method:
  ...
  - [Manually Configure Auditing in OneFS](/docs/accessanalyzer/12.0/configuration/data-sources/dellpowerscale/manualconfiguration.md)
...
[Validate Setup](/docs/accessanalyzer/12.0/configuration/data-sources/dellpowerscale/validate.md) topic for additional information.
