...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/nutanix/access.md) topic for
...
[Nutanix Files Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/nutanix/activity.md) topic for instructions.
