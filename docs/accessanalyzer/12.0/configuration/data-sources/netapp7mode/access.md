...
to the [Provision Account](/docs/accessanalyzer/12.0/configuration/data-sources/netapp7mode/provisionaccess.md) topic for instructions. If also running Activity
...
to the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/netapp7mode/activity.md) topic for
instructions.
