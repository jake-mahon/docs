...
[NetApp Data ONTAP 7-Mode Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/netapp7mode/access.md) topic for
instructions.
...
See the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/netapp7mode/activity.md) topic for
instructions.
