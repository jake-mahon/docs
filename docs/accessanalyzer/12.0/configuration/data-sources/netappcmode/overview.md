...
[NetApp Data ONTAP Cluster-Mode Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/netappcmode/access.md) topic for
instructions.
...
See the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/netappcmode/activity.md) topic for
instructions.
