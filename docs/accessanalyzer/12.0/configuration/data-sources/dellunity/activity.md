...
Checklist Item 2: [Install Dell CEE](/docs/accessanalyzer/12.0/configuration/data-sources/dellunity/installcee.md)
...
- Configure initial setup for a Unity device
  ...
  - [Unity Initial Setup with Unisphere](/docs/accessanalyzer/12.0/configuration/data-sources/dellunity/setupunisphere.md)
...
- See the [Validate Setup](/docs/accessanalyzer/12.0/configuration/data-sources/dellunity/validate.md) topic for instructions.
