...
- See the [Install & Configure Dell CEE](/docs/accessanalyzer/12.0/configuration/data-sources/dellcelerravnx/installcee.md) topic for instructions.

Checklist Item 3: Dell Device Configuration

- Configure the `cepp.conf` file on the Celerra VNX Cluster
- See the
  [Connect Data Movers to the Dell CEE Server](/docs/accessanalyzer/12.0/configuration/data-sources/dellcelerravnx/installcee.md#connect-data-movers-to-the-dell-cee-server)
