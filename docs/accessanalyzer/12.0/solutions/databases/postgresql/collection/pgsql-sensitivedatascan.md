...
- PostgreSQL — Scans the PostgreSQL database for sensitive data. For configuring the
  [SQL Data Collector](/docs/accessanalyzer/12.0/data-collection/sql/overview.md), see the SQL Data Collector
...
[SQL Data Collector](/docs/accessanalyzer/12.0/data-collection/sql/overview.md) page. Select the desired scan
options.
...
[SQL Data Collector](/docs/accessanalyzer/12.0/data-collection/sql/overview.md) page. By default, the
