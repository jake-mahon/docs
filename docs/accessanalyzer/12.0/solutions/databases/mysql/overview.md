...
See the
[Target MySQL Requirements, Permissions, and Ports](../../../requirements/target/databasemysql.md)
...
![MySQL Job Group Overview](../../../../../../static/img/product_docs/accessanalyzer/solutions/databases/mysql/mysqljobgroupoverview.webp)
...
- [Configuration > MySQL_DatabaseSizing Job](mysql_databasesizing.md) – Designed to provide insight
  into MySQL server configuration settings
- [MySQL_SensitiveData Job](sensitivedata/mysql_sensitivedata.md) – Designed to provide insight into
