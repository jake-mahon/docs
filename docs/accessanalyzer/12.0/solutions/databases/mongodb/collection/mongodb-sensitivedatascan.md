...
**Step 4 –** Navigate to the [NoSQL: Options](/docs/accessanalyzer/12.0/data-collection/nosql/options.md)
page.
...
**Step 6 –** Navigate to the [NoSQL: Criteria](/docs/accessanalyzer/12.0/data-collection/nosql/criteria.md)
page.
...
[NoSQL: Criteria](/docs/accessanalyzer/12.0/data-collection/nosql/criteria.md) page. By default, the Sensitive
...
**Step 8 –** Navigate to the [NoSQL: Filter](/docs/accessanalyzer/12.0/data-collection/nosql/filter.md) page.
...
[NoSQL: Filter](/docs/accessanalyzer/12.0/data-collection/nosql/filter.md) topic for additional information.
