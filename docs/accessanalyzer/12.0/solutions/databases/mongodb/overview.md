...
See the
[Target MongoDB Requirements, Permissions, and Ports](../../../requirements/target/databasemongodb.md)
...
![MongoDB Overview](../../../../../../static/img/product_docs/accessanalyzer/solutions/databases/mongodb/mongdbjobgroupoverview.webp)
...
- [Analysis Tasks for the MongoDB_Database_Sizing Job](mongodb_databasesizing.md) — Provides insight
  into MongoDB server configuration settings
- [Sensitive Data > MongoDB_SensitiveData Job](mongodb_sensitivedata.md) — Provides insight into
