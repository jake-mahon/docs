...
- For the AD_DeprovisionUsers Job, the target OU needs to be manually set in the Move Users Action
  ...
  [Action Tasks for the AD_DeprovisionUsers Job](/docs/accessanalyzer/12.0/solutions/activedirectory/cleanup/users/ad_deprovisionusers.md#action-tasks-for-the-ad_deprovisionusers-job)
