...
- For the **AD_WeakPassword** Job:
  ...
  - Requires the DSInternals PowerShell Module, which is a third-party package. See the
    [AD_WeakPasswords Job](/docs/accessanalyzer/12.0/solutions/active-directory/users/ad-weak-passwords.md) topic for additional information.
...
[Active Directory Auditing Configuration](/docs/accessanalyzer/12.0/configuration/active-directory/access.md) topic for
