...
[0.Collection > AD_ActivityCollection Job](/docs/accessanalyzer/12.0/solutions/active-directory/activity/ad_activitycollection.md) in order to connect to either
...
[0.Collection > AD_ActivityCollection Job](/docs/accessanalyzer/12.0/solutions/active-directory/activity/ad_activitycollection.md).
...
See the [Active Directory Solution](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/activedirectory.md) topic for
