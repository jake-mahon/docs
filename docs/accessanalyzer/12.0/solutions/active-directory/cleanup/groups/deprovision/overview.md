...
- [AD_DeprovisionGroups Job](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/groups/deprovision/ad-deprovision-groups.md) – This job provides an automated workflow to
  deprovision stale groups
- [AD_DeprovisionGroups_Status Job](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/groups/deprovision/ad-deprovision-groups-status.md) – This job tracks and reports on
