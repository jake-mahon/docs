...
[Parameter Configuration](/docs/accessanalyzer/12.0/administration/jobs/job/overview.md#parameter-configuration) topic
...
- Move Groups – Move groups to staging OU
  ...
  - The target staging OU must be set in the Move Groups Action Task prior to executing the action
    tasks. See the [Configure the Target OU](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/configuretargetou.md) topic for additional
    information.
