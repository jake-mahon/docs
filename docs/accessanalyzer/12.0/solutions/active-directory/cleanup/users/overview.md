...
- [AD_DeprovisionUsers Job](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/users/ad_deprovisionusers.md) – Provides a simple and automated workflow to
  deprovisions stale and unused user accounts
- [AD_DeprovisionUsers_Status Job](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/users/ad_deprovisionusers_status.md) – Tracks and reports all actions
...
- For the AD_DeprovisionUsers Job, the target OU needs to be manually set in the Move Users Action
  ...
  [Action Tasks for the AD_DeprovisionUsers Job](/docs/accessanalyzer/12.0/solutions/active-directory/cleanup/users/ad_deprovisionusers.md#action-tasks-for-the-ad_deprovisionusers-job)
