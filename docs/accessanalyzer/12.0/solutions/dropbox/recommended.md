...
[DropboxAccess: Scan Options](../../admin/datacollector/dropboxaccess/scanoptions.md) topic for
...
[Custom Dropbox Connection Profile & Host List](../../admin/datacollector/dropboxaccess/configurejob.md)
