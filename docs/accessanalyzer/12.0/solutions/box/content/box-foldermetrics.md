...
See the
[Configure the Customizable Parameters in an Analysis Task](/docs/accessanalyzer/12.0/administration/job-management/job/configure/analysis-customizable-parameters.md) topic
