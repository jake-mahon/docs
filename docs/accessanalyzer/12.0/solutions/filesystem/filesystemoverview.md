...
components and the components of the [0.Collection Job Group](collection/overview.md). It also
...
![FileSystemOverview Job in the Jobs Tree](../../../../../static/img/product_docs/accessanalyzer/solutions/filesystem/filesystemoverviewjobstree.webp)
...
![Analysis Tasks for the FileSystemOverview Job](../../../../../static/img/product_docs/accessanalyzer/solutions/filesystem/filesystemoverviewanalysis.webp)
