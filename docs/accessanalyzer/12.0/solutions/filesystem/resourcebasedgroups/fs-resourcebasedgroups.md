...
based groups. See the [FS_TraverseGroups Job](/docs/accessanalyzer/12.0/solutions/filesystem/resourcebasedgroups/fs-traversegroups.md) topic for additional
information.
...
[FS_ResourceBasedGroupAICImport Job](/docs/accessanalyzer/12.0/solutions/filesystem/resourcebasedgroups/fs-resourcebasedgroupaicimport.md) topic for additional
information.
...
[SQLscripting Analysis Module](/docs/accessanalyzer/12.0/analysis/sql-scripting.md) topic for additional
information.
