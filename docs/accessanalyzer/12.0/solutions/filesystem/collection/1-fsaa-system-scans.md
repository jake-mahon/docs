...
servers, see the [FSAA: Applet Settings](/docs/accessanalyzer/12.0/data-collection/fsaa/applet-settings.md) topic
...
the [FSAA: Scan Server Selection](/docs/accessanalyzer/12.0/data-collection/fsaa/scan-server-selection.md) topic
...
[FSAA: Scan Settings](/docs/accessanalyzer/12.0/data-collection/fsaa/scan-settings.md) topic for additional
information.
...
the [FSAA: Azure Tenant Mapping](/docs/accessanalyzer/12.0/data-collection/fsaa/azure-tenant-mapping.md) topic for
additional information.
...
See the [Scan Settings Tab](/docs/accessanalyzer/12.0/data-collection/fsaa/default-scoping-options/scan-settings.md)
...
scans. See the
[File Details Tab](/docs/accessanalyzer/12.0/data-collection/fsaa/default-scoping-options/file-details.md)
...
See the
[File Properties (Folder Summary) Tab](/docs/accessanalyzer/12.0/data-collection/fsaa/default-scoping-options/file-properties.md)
topic for additional information.
...
[FSAA: Scoping Options](/docs/accessanalyzer/12.0/data-collection/fsaa/scoping-options.md) topic for additional
information.
...
See the [FSAA: Scoping Queries](/docs/accessanalyzer/12.0/data-collection/fsaa/scoping-queries.md) topic for
additional information.
