...
- See the [AWS: Filter S3 Objects](/docs/accessanalyzer/12.0/administration/data-collectors/aws/filters3objects.md) topic for
...
- See
  the[Sensitive Data Criteria Editor](/docs/accessanalyzer/12.0/sensitive-data/criteriaeditor/overview.md)
