...
- [FS_ShareAudit Job](/docs/accessanalyzer/12.0/solutions/file-system/adhocaudits/fs_shareaudit.md) – Designed to report on shares from targeted file servers
  based on user input
- [FS_TrusteePermissions Job](/docs/accessanalyzer/12.0/solutions/file-system/adhocaudits/fs_trusteepermissions.md) – Designed to report on trustees from
