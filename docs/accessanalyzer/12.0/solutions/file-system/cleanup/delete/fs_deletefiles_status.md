...
that were deleted from the FS_DeleteFiles job. See the [FS_DeleteFiles Job](/docs/accessanalyzer/12.0/solutions/file-system/cleanup/delete/fs_deletefiles.md) topic
