...
performed by the FS_NotifyOwners job. See the [FS_NotifyOwners Job](/docs/accessanalyzer/12.0/solutions/file-system/cleanup/notify/fs_notifyowners.md) topic for
