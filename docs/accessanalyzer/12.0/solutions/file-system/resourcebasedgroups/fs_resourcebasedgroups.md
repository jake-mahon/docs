...
based groups. See the [FS_TraverseGroups Job](/docs/accessanalyzer/12.0/solutions/file-system/resourcebasedgroups/fs_traversegroups.md) topic for additional
information.
...
[FS_ResourceBasedGroupAICImport Job](/docs/accessanalyzer/12.0/solutions/file-system/resourcebasedgroups/fs_resourcebasedgroupaicimport.md) topic for additional
information.
...
[SQLscripting Analysis Module](/docs/accessanalyzer/12.0/administration/analysis/sqlscripting.md) topic for additional
information.
