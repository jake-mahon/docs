...
[FSAA: Applet Settings](/docs/accessanalyzer/12.0/administration/data-collectors/fsaa/appletsettings.md) page of the File System
...
may need to be updated manually. See the [Host Inventory](/docs/accessanalyzer/12.0/administration/settings/hostinventory.md)
...
[File System Scan Options](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/filesystem/scanoptions.md) topic and the
[File System Supported Platforms](/docs/accessanalyzer/12.0/getting-started/requirements/target/filesystems.md) topic for necessary
...
[0-FS_Nasuni Job](/docs/accessanalyzer/12.0/solutions/file-system/collection/0-fs_nasuni.md) to the **0.Collection** Job Group.
...
- Scan Server Selection page, set the type of mode the scans will run on
  ...
  - The mode configured must align with the provisioning of the credential and environment. See
    the [File System Scan Options](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/filesystem/scanoptions.md) topic
    and the [File System Supported Platforms](/docs/accessanalyzer/12.0/getting-started/requirements/target/filesystems.md) topic for
    additional information.
