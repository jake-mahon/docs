...
servers, see the [FSAA: Applet Settings](/docs/accessanalyzer/12.0/administration/data-collectors/fsaa/appletsettings.md) topic
...
the [FSAA: Scan Server Selection](/docs/accessanalyzer/12.0/administration/data-collectors/fsaa/scanserverselection.md) topic
...
the [FSAA: Azure Tenant Mapping](/docs/accessanalyzer/12.0/administration/data-collectors/fsaa/azuretenantmapping.md) topic for
additional information.
