...
[Microsoft Entra ID Tenant Target Requirements](/docs/accessanalyzer/12.0/configuration/entra-id/overview.md) topic for
...
- See the [AzureADInventory Data Collector](/docs/accessanalyzer/12.0/data-collection/azure-ad-inventory/overview.md)
