...
[1-AD_Scan Job](/docs/accessanalyzer/12.0/solutions/active-directory-inventory/1-ad_scan.md).
...
- Enable notification analysis tasks within the [2-AD_Changes Job](/docs/accessanalyzer/12.0/solutions/active-directory-inventory/2-ad_changes.md)
- Customize exception analysis parameters within the [3-AD_Exceptions Job](/docs/accessanalyzer/12.0/solutions/active-directory-inventory/3-ad_exceptions.md)
