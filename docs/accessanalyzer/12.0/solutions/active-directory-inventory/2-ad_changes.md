...
[Customize the 1-AD_Scan Query](/docs/accessanalyzer/12.0/solutions/active-directory-inventory/1-ad_scan.md#customize-the-1-ad_scan-query) topic for additional
information.
