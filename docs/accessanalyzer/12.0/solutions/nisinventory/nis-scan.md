...
[NIS: NIS Settings](/docs/accessanalyzer/12.0/data-collection/nis/settings.md) topic for additional information.
...
[NIS: SID Mappings](/docs/accessanalyzer/12.0/data-collection/nis/sid-mappings.md) topic for additional information.
