...
- [SG_AccountPrivileges Job](/docs/accessanalyzer/12.0/solutions/windows/privilegedaccounts/logonrights/sg-accountprivileges.md) – This job highlights account privileges
  across the audited environment, filtering out default privileges present on Windows servers
- [SG_LocalPolicies Job](/docs/accessanalyzer/12.0/solutions/windows/privilegedaccounts/logonrights/sg-localpolicies.md) – This job identifies privileged accounts across the
