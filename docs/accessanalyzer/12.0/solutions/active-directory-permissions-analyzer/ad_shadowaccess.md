...
[Recommended Configurations for AD Permissions Analyzer Solution](/docs/accessanalyzer/12.0/solutions/active-directory-permissions-analyzer/recommended.md) topic for
...
[Viewing Generated Reports](/docs/accessanalyzer/12.0/administration/reporting/view.md) topic for additional information.
