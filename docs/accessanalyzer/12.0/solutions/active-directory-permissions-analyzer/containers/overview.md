...
- [AD_AdminSDHolder Job](/docs/accessanalyzer/12.0/solutions/active-directory-permissions-analyzer/containers/ad_adminsdholder.md) – Reports on all non-default Active Directory
...
- [AD_ContainerPermissions Job](/docs/accessanalyzer/12.0/solutions/active-directory-permissions-analyzer/containers/ad_containerpermissions.md) – Reports on all Active Directory
