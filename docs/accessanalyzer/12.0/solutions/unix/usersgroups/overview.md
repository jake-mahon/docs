...
- [0.Collection > UX_UsersAndGroups Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-usersandgroups.md) – Collects user and group related
...
- [UX_DuplicateGroups Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-duplicategroups.md) – This job identifies duplicate groups within the
...
- [UX_EmptyGroups Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-emptygroups.md) – This job identifies empty groups found within the
  audited Unix or Linux environment. These are suitable candidates for consolidation or cleanup.
- [UX_LargeGroups Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-largegroups.md) – This job identifies groups with large member counts.
...
- [UX_LocalGroups Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-localgroups.md) – This job provides an overview of all local groups within
  the audited Unix and Linux environments
- [UX_LocalUsers Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-localusers.md) – This job provides an overview of all local users within
  the audited Unix and Linux environments
- [UX_PasswordSettings Job](/docs/accessanalyzer/12.0/solutions/unix/usersgroups/ux-passwordsettings.md) – This job provides visibility into user
