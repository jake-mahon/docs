...
- LocalDomains – Collects domains local to the Office 365 environment
  ...
  **CAUTION:** Do not modify this query. The query is preconfigured for this job.
  ...
  - See the [ExchangePS Data Collector](/docs/accessanalyzer/12.0/data-collection/exchange-ps/overview.md)
    topic for additional information
...
as desired. See the
[ExchangePS Data Collector](/docs/accessanalyzer/12.0/data-collection/exchange-ps/overview.md) topic for
additional information.
