---
title: exchange mailboxes ex features
sidebar_label: ex features
description: Solution guide for exchange mailboxes ex features including implementation steps, configuration, and best practices.
---
...
- User Mailbox Settings – Collects user mailbox settings
  ...
  **NOTE:** The ExchangePS Data Collector is capable of targeting Exchange Online as well as
  ...
  [Exchange PowerShell Permissions](/docs/accessanalyzer/12.0/getting-started/system-requirements/solutions/exchange/powershell.md) topic
