---
title: exchange sensitivedata collection ex publicfolder sdd
sidebar_label: ex publicfolder sdd
description: Solution guide for exchange sensitivedata collection ex publicfolder sdd including implementation steps, configuration, and best practices.
---
...
[EWSPublicFolder: SDD Options](/docs/accessanalyzer/12.0/data-collection/ews-public-folder/sdd-options.md) topic
...
See the [EWSPublicFolder: Critieria](/docs/accessanalyzer/12.0/data-collection/ews-public-folder/criteria.md)
topic for additional information.
...
[EWSPublicFolder: Filter](/docs/accessanalyzer/12.0/data-collection/ews-public-folder/filter.md) topic for
...
page.  See the
[EWSPublicFolder: Results](/docs/accessanalyzer/12.0/data-collection/ews-public-folder/results.md) topic for
additional information.
