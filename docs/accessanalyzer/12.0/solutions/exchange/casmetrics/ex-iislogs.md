...
[SMARTLog Data Collector](/docs/accessanalyzer/12.0/data-collection/smart-log/overview.md) topic for additional
information.
...
[SMARTLog: Target Log](/docs/accessanalyzer/12.0/data-collection/smart-log/target-log.md) topic for additional
information.
