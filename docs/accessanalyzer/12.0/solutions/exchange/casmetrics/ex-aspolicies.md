...
See the [ExchangePS: Scope](/docs/accessanalyzer/12.0/data-collection/exchange-ps/scope.md) topic for additional
information.
...
- Scope by Public Folder – Select the **Scope by Public Folder** option. Then, click **Next** and
  ...
  [ExchangePS: Scope by Public Folders](/docs/accessanalyzer/12.0/data-collection/exchange-ps/scope-public-folders.md) topic
  for additional information.
