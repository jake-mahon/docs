...
- 2. SET HISTORY RETENTION – Sets retention period in months
  ...
  - This retention period can be modified. See the
    [Exchange History Retention](/docs/accessanalyzer/12.0/solutions/exchange/hubmetrics/collection/ex-metricscollection.md#exchange-history-retention) topic for
