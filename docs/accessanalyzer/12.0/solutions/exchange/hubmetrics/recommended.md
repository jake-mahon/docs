...
Job. See the [Exchange Mail-Flow Permissions](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/exchange/mailflow.md)
...
- All queries in the 1.HUB Metrics Job Group that use the ExchangeMetrics Data Collector –
  ...
  See the [ExchangeMetrics: Options](/docs/accessanalyzer/12.0/administration/data-collectors/exchangemetrics/options.md) topic
