...
- [Effective Membership > EX_GroupExpansion Job](/docs/accessanalyzer/12.0/solutions/exchange/distributionlists/ex-groupexpansion.md) – Expands the direct
...
- [EX_DLCleanup Job](/docs/accessanalyzer/12.0/solutions/exchange/distributionlists/ex-dlcleanup.md) – Identifies potentially stale distribution groups based on
