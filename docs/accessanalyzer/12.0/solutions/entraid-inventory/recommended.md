...
make no changes to the [1-AAD_Scan Job](/docs/accessanalyzer/12.0/solutions/entraid-inventory/1-aad_scan.md), a possible modification might be to scope
...
[2-AAD_Exceptions Job](/docs/accessanalyzer/12.0/solutions/entraid-inventory/2-aad_exceptions.md).
