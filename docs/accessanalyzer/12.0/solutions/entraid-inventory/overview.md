...
- [1-AAD_Scan Job](/docs/accessanalyzer/12.0/solutions/entraid-inventory/1-aad_scan.md) – Provides essential Microsoft Entra ID User and Group membership
...
- [2-AAD_Exceptions Job](/docs/accessanalyzer/12.0/solutions/entraid-inventory/2-aad_exceptions.md) – Runs analysis on the collected data and identifies
