...
description: Scan file content for sensitive data criteria matches with pre-defined criteria customization and creation capabilities requiring special license.
---
