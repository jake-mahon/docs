...
- Add – Add a sub-criteria to the required matched criteria list. The three types of sub-criteria
  ...
  - [Keyword Criteria](/docs/accessanalyzer/12.0/sensitive-data-discovery/criteria-editor/criteria-type/keyword.md)
  - [Regular Expression (Pattern) Criteria](/docs/accessanalyzer/12.0/sensitive-data-discovery/criteria-editor/criteria-type/regular-expression.md)
  - [Summary Criteria](/docs/accessanalyzer/12.0/sensitive-data-discovery/criteria-editor/criteria-type/summary.md)
...
- Metadata for this criteria – Click the green plus (**+**) button to add a new metadata type for
  ...
  - For a list of available out-of-the-box metadata tags, see the
    [Default Metadata Tag Values](/docs/accessanalyzer/12.0/sensitive-data-discovery/metadata-tags.md) topic for additional information
