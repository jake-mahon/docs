...
[Static Host Lists](/docs/accessanalyzer/12.0/host-management/lists.md#static-host-lists) topic for additional information on static host
...
in the Host list box on the Manual Host Entry page. See the [Add Hosts](/docs/accessanalyzer/12.0/host-management/actions/add.md) topic for
