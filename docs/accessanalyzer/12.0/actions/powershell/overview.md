...
- Welcome
- [PowerShell Action: Script](/docs/accessanalyzer/12.0/actions/powershell/script.md)
- [PowerShell Action: Execution Options](/docs/accessanalyzer/12.0/actions/powershell/execution-options.md)
- [PowerShell Action: Summary](/docs/accessanalyzer/12.0/actions/powershell/summary.md)
