...
- To enter hosts manually, type the host name in the **Host name** textbox. Then click **Add**. The
  ...
  been entered.
- The **Import** option opens the Import Hosts window. See the [Import Hosts Option](/docs/accessanalyzer/12.0/administration/host-management/actions/importhost.md)
