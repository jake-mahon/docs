...
- [Host Discovery](/docs/accessanalyzer/12.0/administration/settings/host-discovery.md)
  - Configure host discovery settings
  - Configure discovery log settings
- [Host Inventory](/docs/accessanalyzer/12.0/administration/settings/host-inventory.md)
...
- [Sensitive Data](/docs/accessanalyzer/12.0/administration/settings/sensitive-data/overview.md)
...
- [ServiceNow](/docs/accessanalyzer/12.0/administration/settings/service-now.md)
