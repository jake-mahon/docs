...
[Use the Client Credentials to Grant a Refesh Token](/docs/accessanalyzer/12.0/administration/settings/access/rest-api/refresh-token.md) topic for additional
information.
