...
[Use the Client Credentials to Grant a Refesh Token](/docs/accessanalyzer/12.0/administration/settings/access/restapi/refreshtoken.md) topic for additional
information.
