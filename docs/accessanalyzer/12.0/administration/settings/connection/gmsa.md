...
[Create a Connection Profile](/docs/accessanalyzer/12.0/administration/settings/connection/profile/create.md) or
[Create a Schedule Service Account](/docs/accessanalyzer/12.0/administration/settings/schedule.md#create-a-schedule-service-account) topic for
