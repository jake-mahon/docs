...
at the job group or job level. See the [History Node](/docs/accessanalyzer/12.0/administration/jobs/group/history.md) and
[History Tab](/docs/accessanalyzer/12.0/administration/jobs/job/properties/history.md) topics for additional information.
...
- Job Statistics
  ...
  - This setting is only available at the global settings level. The default value is 100 days.
    This directly affects each job’s **Status** node. See the [Status Node](/docs/accessanalyzer/12.0/administration/jobs/job/status.md)
