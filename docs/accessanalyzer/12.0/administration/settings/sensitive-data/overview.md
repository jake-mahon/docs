...
- Criteria – Configure Search Criteria to be used in Sensitive Data scan jobs. See the
  [Criteria Tab](/docs/accessanalyzer/12.0/administration/settings/sensitive-data/criteria.md) topic for additional information.
- False Positives – Configure False Positive exclusion filters. See the
  [False Positives Tab](/docs/accessanalyzer/12.0/administration/settings/sensitive-data/exclusions/overview.md) topic for additional information.
