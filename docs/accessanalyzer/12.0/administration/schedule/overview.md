...
- Host Discovery Query – Schedule Host Discovery queries from the Host Discovery node. See the
  [Host Discovery Queries Activities Pane](/docs/accessanalyzer/12.0/administration/host-discovery/activities.md) topic for additional
  information.
- Host Inventory Query – Schedule Host Inventory queries from within the Host Management node. See
  the [Schedule (Activities Pane Option)](/docs/accessanalyzer/12.0/administration/host-management/actions/schedule.md) topic for
...
[Rename Scheduled Task Wizard](/docs/accessanalyzer/12.0/administration/schedule/renamewizard.md) topic for additional information.
...
See the [Schedule Wizard](/docs/accessanalyzer/12.0/administration/schedule/wizard.md) topic for additional information.
