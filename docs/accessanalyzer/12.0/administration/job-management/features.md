...
the selected Jobs tree, job group, or job node. See the [Changes Window](/docs/accessanalyzer/12.0/administration/job-management/overview.md#changes-window)
...
See the [Jobs Tree Right-click Menus](/docs/accessanalyzer/12.0/administration/navigation/pane.md#jobs-tree-right-click-menus) section for
additional features.
