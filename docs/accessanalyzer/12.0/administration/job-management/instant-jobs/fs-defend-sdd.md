...
under the File System library. See the [Instant Job Wizard](/docs/accessanalyzer/12.0/administration/job-management/instant-jobs/overview.md) topic for instructions to
...
- Target Hosts – Custom Host List
  ...
  - Assign host list at the **FS_DEFEND_SDD** > **Configure** > **Hosts** (see the
    [Hosts Node](/docs/accessanalyzer/12.0/administration/job-management/job/configure/hosts.md) topic for additional information)
...
See the [Application](/docs/accessanalyzer/12.0/administration/settings/application/overview.md) topic for additional information.
