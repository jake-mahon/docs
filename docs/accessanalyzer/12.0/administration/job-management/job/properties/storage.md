...
![Storage tab of the Job Properties](/img/product_docs/accessanalyzer/admin/settings/storage/storage.webp)
...
**Settings** > **Storage** node. See the [Storage](/docs/accessanalyzer/12.0/administration/settings/storage/overview.md) topic for
