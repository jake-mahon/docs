...
See the [Add Hosts](/docs/accessanalyzer/12.0/administration/host-management/actions/add.md) section for instruction on creating a
...
[SharePoint Online Access & Sensitive Data Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/sharepointonline/access.md)
