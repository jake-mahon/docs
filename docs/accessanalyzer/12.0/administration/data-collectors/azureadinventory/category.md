...
- Remove Tables – Removes all tables and views from SQL Server database. This option is designed for
  ...
  [Troubleshooting AzureADInventory Data Collector](/docs/accessanalyzer/12.0/administration/data-collectors/azureadinventory/troubleshooting.md) topic for more information.
