...
See the [Microsoft Entra ID Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/entraid/access.md) or the
[Microsoft Entra ID Connection Profile & Host List](/docs/accessanalyzer/12.0/administration/data-collectors/azureadinventory/configurejob.md) topics for additional
information.
