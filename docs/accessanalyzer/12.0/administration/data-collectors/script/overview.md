...
- Conversions – One of the most frequent uses of a scriptis for converting a value from one thing to
  ...
  [Script Example 1: Conversion of Data](/docs/accessanalyzer/12.0/administration/data-collectors/script/example1.md) topic for additional information.
- Compound Queries – This is a query that cannot be performed using a single query. See the
  [Script Example 2: Command Query](/docs/accessanalyzer/12.0/administration/data-collectors/script/example2.md) topic for additional information.
