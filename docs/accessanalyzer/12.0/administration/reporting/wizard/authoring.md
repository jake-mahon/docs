...
- Publish Report – Select an option to configure if the report should be published to the Web
  ...
  - Use default setting – Applies the Global report settings, or the settings configured at the
    ...
    [Publish Option](/docs/accessanalyzer/12.0/administration/settings/reporting.md#publish-option),
...
[Tags](/docs/accessanalyzer/12.0/administration/reporting/tags.md) topic for additional information). The Tag Editor allows you to select the tags
