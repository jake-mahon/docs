...
under the File System library. See the [Instant Job Wizard](/docs/accessanalyzer/12.0/administration/jobs/instantjobs/overview.md) topic for instructions to
...
- Target Hosts – Custom Host List
  ...
  - Assign host list at the **FS_DEFEND_SDD** > **Configure** > **Hosts** (see the
    [Hosts Node](/docs/accessanalyzer/12.0/administration/jobs/job/configure/hosts.md) topic for additional information)
