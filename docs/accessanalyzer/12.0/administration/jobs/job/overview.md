...
execute one or multiple tasks. See the [Configure Node](/docs/accessanalyzer/12.0/administration/jobs/job/configure/overview.md) topic for additional
information.
...
inheritance on global or job group settings. See the [Job Properties](/docs/accessanalyzer/12.0/administration/jobs/job/properties/overview.md) topic
...
accessible under the job’s Status and Results nodes. See the [Status Node](/docs/accessanalyzer/12.0/administration/jobs/job/status.md) and
[Results Node](/docs/accessanalyzer/12.0/administration/jobs/job/results.md) topics for additional information. Reports are also accessible through
the Web Console.
...
- Properties – Opens the Job Properties window. See the [Job Properties](/docs/accessanalyzer/12.0/administration/jobs/job/properties/overview.md)
  topic for additional information.
- Status – Opens the job Status page. See the [Status Node](/docs/accessanalyzer/12.0/administration/jobs/job/status.md) topic for additional
  information.
- Results – Opens the job Results page. See the [Results Node](/docs/accessanalyzer/12.0/administration/jobs/job/results.md) topic for additional
  information.
- Configure – Opens the job Configure page. See the [Configure Node](/docs/accessanalyzer/12.0/administration/jobs/job/configure/overview.md) topic
  for additional information.
...
under the job's Configure Node. See the [Analysis Node](/docs/accessanalyzer/12.0/administration/jobs/job/configure/analysis.md) topic for additional
information.
