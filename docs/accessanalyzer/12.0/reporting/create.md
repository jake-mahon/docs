...
the new report as required, see the [Report Configuration Wizard](/docs/accessanalyzer/12.0/reporting/wizard/overview.md) topic for
...
The report is now created. To access the new report, see the [Viewing Generated Reports](/docs/accessanalyzer/12.0/reporting/view.md)
topic.
