...
- For Proxy Mode as a Service – File System Proxy Service needs to be updated on the proxy servers.
  See the [Upgrade Proxy Service Procedure](/docs/accessanalyzer/12.0/getting-started/installation/filesystem-proxy/upgrade.md) topic for
  instructions.
- For Activity – Ensure the Netwrix Activity Monitor is a compatible version. See the Upgrade
  Instructions in the
  [Netwrix Activity Monitor Documentation](https://helpcenter.netwrix.com/category/activitymonitor)
...
- For SharePoint Agent – Access Analyzer SharePoint Agent needs to be updated on the SharePoint
  ...
  [Upgrade SharePoint Agent](/docs/accessanalyzer/12.0/getting-started/installation/sharepoint-agent/upgrade.md) section for instructions.
