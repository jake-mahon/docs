...
[Access Analyzer Console Upgrade](/docs/accessanalyzer/12.0/getting-started/installation/application/upgrade/overview.md) topic for additional information.
...
See the [Securing the Access Analyzer Database](/docs/accessanalyzer/12.0/getting-started/installation/application/database.md#securing-the-access-analyzer-database)
...
[Troubleshooting](/docs/accessanalyzer/12.0/administration/maintenance/troubleshooting.md) topic for more information about logs.
...
the [Getting Started](/docs/accessanalyzer/12.0/getting-started/index.md) topic for additional information.
