...
[Requirements](/docs/accessanalyzer/12.0/getting-started/system-requirements/overview.md) topics. These recommendations are based on
...
[Access Analyzer Core Installation](/docs/accessanalyzer/12.0/getting-started/installation/application/wizard.md) topic for instructions.
...
See the [Access Analyzer Initial Configuration](/docs/accessanalyzer/12.0/getting-started/installation/application/first-launch.md) topic to perform these steps during
