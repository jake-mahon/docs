...
- [FileSystemAccess Data Collector](/docs/accessanalyzer/12.0/administration/data-collectors/fsaa/overview.md)
...
See the [Windows File Server Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/windowsfile/overview.md) topic for
...
See the [Azure Files Target Requirements](/docs/accessanalyzer/12.0/getting-started/requirements/target/config/azurefiles.md) topic for additional information.
...
See the [Dell Celerra & Dell VNX Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/dellcelerravnx/overview.md)
...
See the [Dell Isilon/PowerScale Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/dellpowerscale/overview.md)
topic for target environment requirements.

Dell Unity

See the [Dell Unity Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/dellunity/overview.md) topic for target
...
See the [Hitachi Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/hitachi/overview.md) topic for target
environment requirements.
...
See the [Nasuni Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/nasuni/overview.md) topic for target
environment requirements.
...
- [NetApp Data ONTAP Cluster-Mode Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/netappcmode/overview.md)
- [NetApp Data ONTAP 7-Mode Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/netapp7mode/overview.md)

Nutanix

See the [Nutanix Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/nutanix/overview.md) topic for target
environment requirements.
...
See the [Qumulo Target Requirements](/docs/accessanalyzer/12.0/configuration/data-sources/qumulo/overview.md) topic for target
environment requirements.
