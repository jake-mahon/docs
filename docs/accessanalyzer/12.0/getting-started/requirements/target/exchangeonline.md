...
- [AzureADInventory Data Collector](/docs/accessanalyzer/12.0/administration/data-collectors/azureadinventory/overview.md)
...
See the [Microsoft Entra ID Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/entraid/access.md) topic for
...
See the [Exchange Online Auditing Configuration](/docs/accessanalyzer/12.0/configuration/data-sources/exchangeonline/access.md) topic for
additional information.
