...
SharePoint Agent. See the [SharePoint Agent Installation](/docs/accessanalyzer/12.0/installation/sharepointagent/overview.md)
...
- [SharePoint Support](/docs/accessanalyzer/12.0/getting-started/requirements/target/sharepoint.md)
