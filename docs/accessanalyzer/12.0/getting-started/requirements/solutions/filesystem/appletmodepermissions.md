...
See the [Applet Mode Port Requirements](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/filesystem/appletmodeports.md) topic for firewall rule information.
