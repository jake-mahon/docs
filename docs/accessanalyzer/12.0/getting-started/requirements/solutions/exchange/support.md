...
- [Exchange Mail-Flow Permissions](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/exchange/mailflow.md)
...
- [Exchange Web Services API Permissions](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/exchange/webservicesapi.md)

  - EWSMailbox Data Collector
  - EWSPublicFolder Data Collector
  - 7. Sensitive Data Job Group

- [MAPI-Based Data Collector Permissions](/docs/accessanalyzer/12.0/getting-started/requirements/solutions/exchange/mapi.md)
