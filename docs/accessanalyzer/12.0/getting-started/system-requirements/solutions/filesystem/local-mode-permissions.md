...
See the [Local Mode Port Requirements](/docs/accessanalyzer/12.0/getting-started/system-requirements/solutions/filesystem/local-mode-ports.md) topic for firewall rule information.
