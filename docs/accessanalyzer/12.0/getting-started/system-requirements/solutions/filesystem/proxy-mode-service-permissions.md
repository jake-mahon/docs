...
See the [Proxy Mode as a Service Port Requirements](/docs/accessanalyzer/12.0/getting-started/system-requirements/solutions/filesystem/proxy-mode-service-ports.md) topic for firewall
rule information.
