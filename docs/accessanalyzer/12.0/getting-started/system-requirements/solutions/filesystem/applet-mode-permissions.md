...
See the [Applet Mode Port Requirements](/docs/accessanalyzer/12.0/getting-started/system-requirements/solutions/filesystem/applet-mode-ports.md) topic for firewall rule information.
