...
- [Entra Data Collector](/docs/accessanalyzer/12.0/data-collection/entra/overview.md)
...
collector. See the
[Register a Microsoft Entra ID Application](/docs/accessanalyzer/12.0/configuration/entra-id/access.md#register-a-microsoft-entra-id-application)
