...
- 2. CAS Metrics
  ...
  - This job group also requires remote connection permissions for the SMARTLog Data Collector.
    See the [Exchange Remote Connections Permissions](/docs/accessanalyzer/12.0/getting-started/system-requirements/solutions/exchange/remote-connections.md) topic for additional
    information.
...
- 8. Exchange Online
  ...
  - This job group uses Modern Authentication to target Exchange Online. See the
    [Exchange Online Auditing Configuration](/docs/accessanalyzer/12.0/configuration/exchange-online/access.md) topic
...
[ExchangePS: Scope](/docs/accessanalyzer/12.0/data-collection/exchange-ps/scope.md) topic for additional
information.
...
[ExchangePS: Scope by DB](/docs/accessanalyzer/12.0/data-collection/exchange-ps/scope-databases.md) topic for
additional information.
...
[ExchangePS: Scope by Mailboxes](/docs/accessanalyzer/12.0/data-collection/exchange-ps/scope-mailboxes.md) topic
for additional information.
