...
See the
[Target Windows Server and Desktop Requirements, Permissions, and Ports](/docs/accessanalyzer/12.0/getting-started/system-requirements/target/windows.md) topic
