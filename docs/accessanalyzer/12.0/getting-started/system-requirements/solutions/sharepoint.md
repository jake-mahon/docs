...
SharePoint Agent. See the [SharePoint Agent Installation](/docs/accessanalyzer/12.0/getting-started/installation/sharepoint-agent/overview.md)
...
- [SharePoint Support](/docs/accessanalyzer/12.0/getting-started/system-requirements/target/sharepoint.md)
