...
[Oracle Target Least Privilege Model](/docs/accessanalyzer/12.0/getting-started/system-requirements/target/config/database-oracle.md) topic for additional information.
