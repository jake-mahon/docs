...
- [AzureADInventory Data Collector](/docs/accessanalyzer/12.0/data-collection/azure-ad-inventory/overview.md)
...
See the [Microsoft Entra ID Auditing Configuration](/docs/accessanalyzer/12.0/configuration/entra-id/access.md) topic for
...
See the [Exchange Online Auditing Configuration](/docs/accessanalyzer/12.0/configuration/exchange-online/access.md) topic for
additional information.
