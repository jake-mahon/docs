...
See the [Azure SQL Auditing Configuration](/docs/accessanalyzer/12.0/getting-started/system-requirements/target/config/azure-sql-access.md) topic for additional
information.
