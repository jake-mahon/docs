...
- Welcome
- [DNS: Category](/docs/accessanalyzer/12.0/data-collection/dns/category.md)
- [DNS: Results](/docs/accessanalyzer/12.0/data-collection/dns/results.md)
- [DNS: Summary](/docs/accessanalyzer/12.0/data-collection/dns/summary.md)
