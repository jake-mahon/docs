...
See the [Script Example 1: Conversion of Data](/docs/accessanalyzer/12.0/data-collection/script/example-1.md) and
[Script Example 2: Command Query](/docs/accessanalyzer/12.0/data-collection/script/example-2.md) topics for additional information.
