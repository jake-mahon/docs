...
![Entra ID Inventory DC Wizard Category page](../../../../../../static/img/product_docs/accessanalyzer/admin/datacollector/adinventory/category.webp)
...
- Remove Tables – Removes all tables and views from SQL Server database. This option is designed for
  ...
  [Troubleshooting AzureADInventory Data Collector](troubleshooting.md) topic for more information.
