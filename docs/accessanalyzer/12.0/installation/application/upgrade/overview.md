...
See the [What's New](/docs/accessanalyzer/12.0/whats-new.md) topic for release information.
...
Access Analyzer Console, see the [Update License Key](/docs/accessanalyzer/12.0/installation/application/updatelicense.md) topic for instructions.
...
See the [Update License Key](/docs/accessanalyzer/12.0/installation/application/updatelicense.md) section for instructions on updating the license
key.
