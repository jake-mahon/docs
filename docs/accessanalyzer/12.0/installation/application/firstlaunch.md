...
[Access Analyzer Console Upgrade](/docs/accessanalyzer/12.0/installation/application/upgrade/overview.md) topic for additional information.
...
See the [Securing the Access Analyzer Database](/docs/accessanalyzer/12.0/installation/application/database.md#securing-the-access-analyzer-database)
