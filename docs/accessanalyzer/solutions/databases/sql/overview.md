...
See the
[Target SQL Server Requirements, Permissions, and Ports](../../../requirements/target/databasesql.md)
...
![SQL Job Group](../../../../../static/img/product_docs/accessanalyzer/solutions/databases/sql/sqljobgroup.webp)

The SQL Job Group includes:

- Databases > 0.Collection > SQL > [0.Collection > SQL Job Group](collection/overview.md) – This job
...
- Databases > 0.Collection > AzureSQL >
  [0.Collection > Azure SQL Job Group](../azuresql/collection/overview.md) — This job group is
...
- [5.Sensitive Data Job Group](sensitivedata/overview.md)– This job group is designed to provide
  insight into where sensitive data exists and who has access to it across all the targeted SQL
  server databases
- [SQL_SecurityAssessment Job](sql_securityassessment.md) – This job is designed to summarize and
