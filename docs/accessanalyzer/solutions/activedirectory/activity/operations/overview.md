...
![Operations Job Group in the Jobs Tree](../../../../../../static/img/product_docs/accessanalyzer/admin/hostmanagement/jobstree.webp)
...
- [AD_AuthenticationProtocol Job](ad_authenticationprotocol.md) – Shows what protocols are being
...
- [AD_DomainControllerTraffic Job](ad_domaincontrollertraffic.md) – Provides a summary of the amount
...
- [AD_HardcodedDCs Job](ad_hardcodeddcs.md) – Highlight machines that have communicated with only
  one DC
- [AD_LoadBalancing Job](ad_loadbalancing.md) – Analyzes each domain controller's traffic to show
