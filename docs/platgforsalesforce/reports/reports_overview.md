...
![Enabling reports](/img/product_docs/platgforsalesforce/reports/access_reports_enabled.webp)
...
> Profiles.
>
> ![Permission by object](/img/product_docs/platgforsalesforce/reports/access_reports_permission_by_object.webp)
>
> **Object Permission by Profile/PermSet**: Displays the object permissions organized by Permission
> Set and Profile.
>
> ![Access report by PermissionSet/Profile](/img/product_docs/platgforsalesforce/reports/access_reports_permission_by_permset.webp)
>
...
> report.
>
> ![Users to Profile/PermissionSets](/img/product_docs/platgforsalesforce/reports/access_reports_users_to_profile.webp)
>
...
> Compliant.
>
> ![Access Report Profile Permissions Changes](/img/product_docs/platgforsalesforce/reports/access_reports_profile_changes.webp)
>
> **Changes to Users**: Displays the changes to tracked user data fields. Refer to
> [Enhanced CPQ Support](/docs/platgforsalesforce/change_management/enhanced_cpq_support.md) for more information on
> setting up tracking.
>
...
>
> ![Changes to Users](/img/product_docs/platgforsalesforce/reports/accses_reports_user_changes.webp)
>
> **Record Types and Page Layout Assignments**: Displays the objects, record types and assigned
> layouts organized by profile.
>
> ![Access Reports Record Types and Layouts](/img/product_docs/platgforsalesforce/reports/access_reports_record_types.webp)
>
...
>
> ![System Permissions](/img/product_docs/platgforsalesforce/reports/report_systems_permissions.webp)
>
...
>
> ![Field Permissions report](/img/product_docs/platgforsalesforce/reports/report_field_permissions.webp)
>
...
> [Default Clean Up List View](/docs/platgforsalesforce/clean_up/cleanup_reports.md#default-clean-up-list-view)
>
> [Open Clean Up Status](/docs/platgforsalesforce/clean_up/cleanup_reports.md#open-clean-up-status)
>
> [Clean Up Waiting for Info](/docs/platgforsalesforce/clean_up/cleanup_reports.md#clean-up-waiting-for-info)
>
> [Customizations Excluded from Clean Up](/docs/platgforsalesforce/clean_up/cleanup_reports.md#customizations-excluded-from-clean-up)
>
> [Unused Fields](/docs/platgforsalesforce/clean_up/cleanup_reports.md#unused-fields)
>
> [Unused Apex Code](/docs/platgforsalesforce/clean_up/cleanup_reports.md#unused-apex-code)
>
> [Unused Reports](/docs/platgforsalesforce/clean_up/cleanup_reports.md#unused-reports)
>
> [Customizations with Inactive Owners](/docs/platgforsalesforce/clean_up/cleanup_reports.md#customizations-with-inactive-owners)
>
> [Customizations without Related Processes](/docs/platgforsalesforce/clean_up/cleanup_reports.md#customizations-without-related-processes)
>
> [Custom Fields without Help Text](/docs/platgforsalesforce/clean_up/cleanup_reports.md#custom-fields-without-help-text)
>
> [Custom Fields without Description](/docs/platgforsalesforce/clean_up/cleanup_reports.md#custom-fields-without-description)
...
> [Success Deployments](/docs/platgforsalesforce/reports/deployment_logs_success.md)
>
> [Deployments with Failures](/docs/platgforsalesforce/reports/deployment_logs_failures.md)
>
> [Deployments Pending Approval](/docs/platgforsalesforce/reports/deployment_logs_pending_approval.md)
>
> [Rollback Logs](/docs/platgforsalesforce/reports/deployment_logs_rollback.md)
