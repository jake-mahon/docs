...
![Environment Compare Log Report](/img/product_docs/platgforsalesforce/reports/report_deploy_env_compare.webp)

## Sample Environment Compare Log

Click on a **Log Name** link to open the log.

![Example Environment Compare Log](/img/product_docs/platgforsalesforce/reports/deploy_compare_env_log.webp)
