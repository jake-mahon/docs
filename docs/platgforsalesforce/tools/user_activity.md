...
Compliance [licenses](/docs/platgforsalesforce/installing_strongpoint/features_by_license_type.md).
...
menu. Refer to [Package Usage](/docs/platgforsalesforce/tools/package_usage.md) for details on the Package Usage tool.
