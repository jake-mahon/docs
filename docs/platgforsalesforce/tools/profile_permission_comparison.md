...
1. Select **Tools** > **Permissions Comparison** from the Netwrix Dashboard page. Click the
   ...
   selected.
    ...
    ![Open the Profile / Permission Comparison](/img/product_docs/platgforsalesforce/tools/permission_comparison.webp)
...
2. Select at least two **Profile / Permission Sets**. For each item:
    ...
    ![Select a Profile or Permission Set to compare](/img/product_docs/platgforsalesforce/tools/permission_comparison_select.webp)

3. Select the **System Permissions Category**: **All**, **API**, **Create**, **Edit**, **Manage**,
   **Modify**, **User**, or **View**.

    ![System Permission Comparison](/img/product_docs/platgforsalesforce/tools/permission_comparison_display.webp)
...
3. Set the optional **Filter** for object permissions: **Create**, **Edit**, **Read**, **Delete**,
   **View All**, and **Modify All**. You can use the **Select All** and **Clear All** shortcuts to
   set the **Filter**.
    ...
    ![Object Permission Comparison](/img/product_docs/platgforsalesforce/tools/permission_comparison_display_object.webp)
