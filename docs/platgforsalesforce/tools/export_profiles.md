...
2. Open the **Profiles & Permission Sets** tab.
    ...
    ![export_profile_ui](/img/product_docs/platgforsalesforce/tools/export_profile_ui.webp)
...
![export_profile_profile](/img/product_docs/platgforsalesforce/tools/export_profile_profile.webp)
