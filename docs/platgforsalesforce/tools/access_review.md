...
Enterprise Compliance [licenses](/docs/platgforsalesforce/installing_strongpoint/features_by_license_type.md).
...
1. Select **Tools** > **Access Review Assistant** from the Netwrix Dashboard page. Click the
   ...
   is selected.
    ...
    ![Open the Access Review Assistant](/img/product_docs/platgforsalesforce/tools/access_review_assistant.webp)
...
5. Click **Search**.
    ...
    ![access_assistance](/img/product_docs/platgforsalesforce/tools/access_assistance.webp)

6. Click **View Details** to see **System Permissions** and **User Assignments** for the object.

    ![Details for the object](/img/product_docs/platgforsalesforce/tools/access_assist_view_details_permission.webp)

    ![Details for the object](/img/product_docs/platgforsalesforce/tools/access_assist_view_details_users.webp)
...
1. Select **Tools** > **Access Review Assistant** from the Netwrix Dashboard page. Click the
   ...
   selected.
    ...
    ![Search By User](/img/product_docs/platgforsalesforce/tools/access_assist_user.webp)

2. Start typing the user name. Pick from the completion list.
3. Click **Search**.

    ![Search by User](/img/product_docs/platgforsalesforce/tools/access_assist_user2.webp)
...
1. Select **Tools** > **Access Review Assistant** from the Netwrix Dashboard page. Click the
   ...
   Permission Set** is selected.
    ...
    ![Search by Profile / Permission Set](/img/product_docs/platgforsalesforce/tools/access_assist_profile.webp)

2. Start typing the Profile / Permission Set name. Pick from the completion list.
3. Click **Search**.

    ![Search by Profile / Permission Set](/img/product_docs/platgforsalesforce/tools/access_assist_profile2.webp)
