...
cost savings. Used in conjunction with the existing [User Activity](/docs/platgforsalesforce/tools/user_activity.md) tool, it
...
[licenses](/docs/platgforsalesforce/installing_strongpoint/features_by_license_type.md).
...
1. Select **Tools** > **User Activity** from the Netwrix Dashboard page.
    ...
    ![User Activity tool](/img/product_docs/platgforsalesforce/tools/user_activity.webp)

2. Click the arrow in the left margin to expand the menu pane.
3. Click **Package Usage Tool** in the menu.

    ![Package Usage tool](/img/product_docs/platgforsalesforce/tools/package_usage.webp)
