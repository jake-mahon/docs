...
![Example of the DLU status fields for a CustomField](/img/product_docs/platgforsalesforce/clean_up/dlu_status_example_customfield.webp)
...
The [Scheduler](/docs/platgforsalesforce/scanners/scheduler.md) is where you can add frequency, day and time for processes
