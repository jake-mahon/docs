...
![improvementtab](/img/product_docs/platgforsalesforce/clean_up/improvementtab.webp)
...
5. Select fields to display:
    ...
    ![createlist_view_for_cleanup](/img/product_docs/platgforsalesforce/clean_up/createlist_view_for_cleanup.webp)
...
8. Once your list view has been created, you can multi-select customizations for clean up by
   checking the box beside **Action**.
    ...
    ![multi_select_cleanup](/img/product_docs/platgforsalesforce/clean_up/multi_select_cleanup.webp)
...
13. Click **Save**.
    ...
    ![flagging_mass_customizations](/img/product_docs/platgforsalesforce/clean_up/flagging_mass_customizations.webp)
