...
2. Access to the Configuration app. You must have the **Strongpoint Administrator** and
   ...
   **Setup** > **Users** > **Permission Sets** > **Strongpoint Administrator** > **Manage
   Assignments**
    ...
    ![You must have these permissions to open the Configuration tool](/img/product_docs/platgforsalesforce/change_management/strongpoint_permissions.webp)
...
3. Select **Strongpoint Configuration**. The **Recommended Objects** list is displayed.
    ...
    ![Review the recommended objects for data tracking](/img/product_docs/platgforsalesforce/change_management/data_tracking_recommended.webp)
...
14. Wait until the **Deployment Status** is complete, then click **Done**.
    ...
    ![Wait for the Deployment Status to complete](/img/product_docs/platgforsalesforce/change_management/data_tracking_deployment.webp)
...
2. Enter **CustomField** in the **Search** box.
    ...
    ![Open CustomField Tracking](/img/product_docs/platgforsalesforce/change_management/data_tracking_customfield.webp)

3. Select **CustomField Tracking**.
4. Select a customization and edit the Data Change Tracking field.

    ![Edit the Data Change Tracking](/img/product_docs/platgforsalesforce/change_management/data_tracking_customfield3.webp)
...
5. Enter **(Data Records** in the Search Customization box.
    ...
    ![Select the customizations](/img/product_docs/platgfornetsuite/change_management/policy_add_customizations.webp)
...
![CPQ Change Log](/img/product_docs/platgforsalesforce/change_management/cpq_discount_change_log.webp)
