...
[Change Enablement Reports](/docs/platgforsalesforce/change_management/change_management_reports.md).
...
![changelog-1](/img/product_docs/platgfornetsuite/change_management/changelog-1.webp)

Here is an example change log for a **Profile** Metadata type.

![changelog_details](/img/product_docs/platgforsalesforce/change_management/changelog_details.webp)
...
![Diff Summary for data tracking](/img/product_docs/platgforsalesforce/change_management/diffsummary_data.webp)

Example Diff Summary for a Profile metadata type Change Log:

![Change Log Diff Summary](/img/product_docs/platgforsalesforce/change_management/changelog_diff.webp)
...
![changelog_values](/img/product_docs/platgforsalesforce/change_management/changelog_values.webp)
