...
The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/platgforsalesforce/change_management/using_change_logs.md). You
can filter the report or sort by the column heads.

![Non-Compliant Change Management Report](/img/product_docs/platgfornetsuite/change_management/changelog-1.webp)
...
1. Create a New [Change Request](/docs/platgforsalesforce/change_management/creating_change_request.md) or open an existing one.
