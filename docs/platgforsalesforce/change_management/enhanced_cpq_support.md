...
1. Ensure your org has been [scanned](/docs/platgforsalesforce/installing_strongpoint/running_scanner.md) at least once.
2. [Set up data tracking](/docs/platgforsalesforce/change_management/set_up_data_tracking.md) for each tracked customization.
3. [Add](/docs/platgforsalesforce/change_management/set_up_data_tracking.md) the tracked customizations to a policy.
