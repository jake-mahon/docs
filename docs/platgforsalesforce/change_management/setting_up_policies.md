...
![New Policy form](/img/product_docs/platgforsalesforce/change_management/policy_new1.webp)
...
![Code and Data Model Changes](/img/product_docs/platgforsalesforce/change_management/policy_new2.webp)

### Automation Changes

![Automation Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new3.webp)

### Sharing and Visibility Changes

![Sharing and Visbility Change Level](/img/product_docs/platgforsalesforce/change_management/policy_new4.webp)

### Integration Changes

![Integration Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new5.webp)

### Configuration Changes

![Configuration Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new6.webp)

### Display and UI Changes

![Display / UI Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new7.webp)

### Analytics Changes

![Analytics Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new8.webp)

### Control Changes

![Control Change Levels](/img/product_docs/platgforsalesforce/change_management/policy_new9.webp)
...
settings. There is a [Health Settings](/docs/platgforsalesforce/customizations/understanding_customization_record.md) tab
for the specific records on the customization record.

### Application Configuration Changes (Data)

![Application Configuration Changes (Data)](/img/product_docs/platgforsalesforce/change_management/policy_new16.webp)
...
Refer to [Set Up Data Tracking](/docs/platgforsalesforce/change_management/set_up_data_tracking.md) for more information on activating and
validating tracked fields.

### Health Check Changes

![Health Check Changes](/img/product_docs/platgforsalesforce/change_management/policy_new16_a.webp)
...
![Set IT Policies](/img/product_docs/platgforsalesforce/change_management/policy_new10.webp)
...
![Customization Policies](/img/product_docs/platgforsalesforce/change_management/policy_new12.webp)
...
![Set Management Policies](/img/product_docs/platgforsalesforce/change_management/policy_new13.webp)
...
![Change Enablement Defaults](/img/product_docs/platgforsalesforce/change_management/policy_new15.webp)
...
![Policy Related tab](/img/product_docs/platgforsalesforce/change_management/policy_related_tab.webp)
...
2. Click **Add Customizations**.
    ...
    ![Add customizations](/img/product_docs/platgfornetsuite/change_management/policy_add_customizations.webp)
...
5. Click to select a customization. Use Shift-click or click and drag to select multiple contiguous
   items or Ctrl-click to select multiple customizations.
    ...
    ![Selecting Customizations](/img/product_docs/platgforsalesforce/change_management/policy_add_customizations2.webp)
...
2. Click **Select Change Level by SF Type**. You can set the policy as the **Default** and toggle it
   as **Active** in the **Policy Details**.
    ...
    ![Adding customizations by Salesforce Type](/img/product_docs/platgforsalesforce/change_management/policy_change_by_sf_type.webp)
...
3. Set **Category** and **Sub-Category** filters if you want to narrow the list. Sub-categories are
   not available for all Categories.
    ...
    ![Set filters for Salesforce type](/img/product_docs/platgforsalesforce/change_management/policy_add_sf_type2.webp)
...
4. Click to select a **Salesforce Type** from the **Available Salesforce Type List**. Use
   ...
   multiple types.
    ...
    ![Add selections to the Selected Salesforce Type List](/img/product_docs/platgforsalesforce/change_management/policy_add_sf_type3.webp)
