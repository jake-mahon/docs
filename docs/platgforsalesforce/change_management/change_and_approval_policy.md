...
1. **Detect the Change**: [Automated Scanner](/docs/platgforsalesforce/installing_strongpoint/setting_up_initial_scan.md)
...
6. **Change Reporting and Resolution**: Platform Governance for Salesforce provides predefined
   [reports](/docs/platgforsalesforce/change_management/change_management_reports.md) you can review as part of your regular Change Management
   Process.
