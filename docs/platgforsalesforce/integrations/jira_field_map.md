...
![Identify fields to map](/img/product_docs/platgforsalesforce/integrations/field_map_id_fields.webp)
...
![Verify fields exist](/img/product_docs/platgforsalesforce/integrations/field_map_verify_fields.webp)
...
3. Select your layout. If your fields are not in the layout, add them. For this example, the
   **Strongpoint Version** and **SF Version Number** fields have been added to the **Customizations
   Layout**.
    ...
    ![Add to layouts](/img/product_docs/platgforsalesforce/integrations/field_map_layouts.webp)
...
5. Open your Record Page. This example shows the **Customizations Record** page. Make sure your
   fields are in the record page and set to visible.
    ...
    ![Check record page for fields and visibility](/img/product_docs/platgforsalesforce/integrations/field_map_record.webp)
...
![Update the values](/img/product_docs/platgforsalesforce/integrations/field_map_set_values.webp)
...
5. Click **Get Fields**.
    ...
    ![Get Fields for mapping](/img/product_docs/platgforsalesforce/integrations/field_map_get_fields.webp)
...
2. Navigate to **CR CustomFields Mapping**. It is added as a tab on the navigation bar. You can
   click on the down arrow on the tab and add it to your navigation bar.
    ...
    ![Launch CR CustomFields Mapping](/img/product_docs/platgforsalesforce/integrations/field_map_launcher.webp)

3. Click **New** to create the record.

    ![Create a new mapping record](/img/product_docs/platgforsalesforce/integrations/field_map_new_record.webp)
...
![Field Map complete](/img/product_docs/platgforsalesforce/integrations/field_map_complete.webp)
...
![Verify the Change Request](/img/product_docs/platgforsalesforce/integrations/field_map_change_request.webp)
