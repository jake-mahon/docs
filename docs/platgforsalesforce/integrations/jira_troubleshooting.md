...
Refer to [Credentials](/docs/platgforsalesforce/installing_strongpoint/config_and_stats.md#credentials) for more
...
Refer to [Status Mapping](/docs/platgforsalesforce/installing_strongpoint/config_and_stats.md#status-mapping) for more
