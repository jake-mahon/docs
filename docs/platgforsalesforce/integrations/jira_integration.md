...
[Jira Field Mapping](/docs/platgforsalesforce/integrations/jira_field_map.md) for details.
...
3. Search for **Strongpoint**.
    ...
    ![Strongpoint apps in the Jira Marketplace](/img/product_docs/platgforsalesforce/integrations/jira_marketplace.webp)
...
2. Open the Connected App:  
   **Setup** > **Apps** > **App Manager** > **Strongpoint** (where **App Type** = **Connected**)
    ...
    ![Open the Strongpoint Connected App](/img/product_docs/platgforsalesforce/integrations/connected_app.webp)
...
7. Click **Manage Consumer Details**.
    ...
    ![Click Manage Consumer Details](/img/product_docs/platgforsalesforce/integrations/manage_consumer_details.webp)
...
1. Open a Jira project.
    ...
    ![Open a project](/img/product_docs/platgforsalesforce/integrations/jira_restrict_access1.webp)
...
3. Select the **Profile Visability Settings** tab. There are two lists:  
   ...
   **Selected Groups** are groups that can see the Platform Governance for Salesforce Jira
   integration. If **Selected Groups** is blank, all groups have access to the integration.
    ...
    ![Profile Visibility Settings](/img/product_docs/platgforsalesforce/integrations/profile_visability1.webp)
...
**Next Step:** [Jira Walkthrough Example](/docs/platgforsalesforce/integrations/jira_walkthrough_example.md)
