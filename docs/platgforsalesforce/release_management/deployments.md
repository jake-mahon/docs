...
2. Click **Deploy** in the tool bar. **Deploy** is only available for approved change requests.
    ...
    ![Deploy Button in Tool Bar](/img/product_docs/platgforsalesforce/release_management/deploy.webp)

3. Select the **Source** (from) environment and **Target** (to) environment.
4. Enter your credentials for both environments.

    ![Deployment Tool](/img/product_docs/platgforsalesforce/release_management/deployment_tool.webp)
...
8. Click **Submit for Approval**
    ...
    ![Submit Deployment Record for Approval](/img/product_docs/platgforsalesforce/release_management/deploy.webp)
