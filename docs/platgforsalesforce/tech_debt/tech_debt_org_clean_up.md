...
[DLU](/docs/platgforsalesforce/clean_up/date_last_used.md) is calculated differently for each Customization type.
...
![DLU Filter](/img/product_docs/platgforsalesforce/tech_debt/tech_debt_2.webp)
...
[Automated Report Clean Up](/docs/platgforsalesforce/tools/automated_report_clean_up.md) for more details.
...
[Specific Clean Up Approaches](/docs/platgforsalesforce/tech_debt/tech_debt_org_specific_clean_up_approaches.md) section contains
examples.
...
**Next Technical Debt Topic:**[ Org Clean Up Example](/docs/platgforsalesforce/tech_debt/tech_debt_org_clean_up_example.md)
