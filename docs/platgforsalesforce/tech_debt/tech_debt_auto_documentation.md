...
> [Running the Scanner](/docs/platgforsalesforce/installing_strongpoint/running_scanner.md) topic or reach out to the
...
The [DRD](/docs/platgforsalesforce/tools/viewing_drd.md) is a graphical presentation of an object to help you visualize
the dependencies.
...
1. The DRD can be launched from both the Home tab and the Tools menu. Open **Netwrix Dashboard** >
   **Tools** > **Dependency Relationship Diagram**, and select an object from the list.
    ...
    ![Opening an item in the DRD](/img/product_docs/platgforsalesforce/tech_debt/tech_debt_10.webp)
    ...
    ![Opening an item in the DRD](/img/product_docs/platgforsalesforce/tech_debt/tech_debt_1.webp)
...
2. Click an attribute to expand the metadata record and view all the dependencies. Drill down for
   details so you can fully understand the downstream dependencies.
    ...
    ![Viewing dependencies in the DRD](/img/product_docs/platgforsalesforce/tech_debt/tech_debt_13.webp)
...
3. The DRD exposes other critical metadata such as the Owner, API Name, Data Type, and Date Last
   ...
   Views or Reports.
    ...
    ![Drilling into a dependency in the DRD](/img/product_docs/platgforsalesforce/tech_debt/tech_debt_11.webp)
...
> **PRO TIPS**
>
> - Read more about the [Customization Record](/docs/platgforsalesforce/customizations/customizations_overview.md).
...
_Enterprise Compliance_ [license](/docs/platgforsalesforce/installing_strongpoint/features_by_license_type.md)). Click
...
[Finder](/docs/platgforsalesforce/tools/finder.md) is another flexible tool for understanding dependencies across objects.
...
further research. Read more on [Exporting Objects](/docs/platgforsalesforce/tools/export_objects.md),
[Exporting Profiles](/docs/platgforsalesforce/tools/export_profiles.md) and [Exporting Users](/docs/platgforsalesforce/tools/export_users.md).
...
**Next Technical Debt Topic:** [Change Monitoring](/docs/platgforsalesforce/tech_debt/tech_debt_change_monitoring.md)
