...
[Old Customization Record](/docs/platgforsalesforce/customizations/old_customization_record.md) for the old style customization record.
...
![Strongpoint Lightning Customization Record](/img/product_docs/platgforsalesforce/customizations/customization_record_lightning.webp)
...
The Dependency Relationship Diagram ([DRD](/docs/platgforsalesforce/tools/viewing_drd.md)) displays objects,
customizations and their relationships and dependencies.

![DRD Example](/img/product_docs/platgforsalesforce/customizations/drd.webp)
