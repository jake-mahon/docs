...
[Understanding the Customization Record](/docs/platgforsalesforce/customizations/understanding_customization_record.md) for the updated
...
![customization_record](/img/product_docs/platgforsalesforce/customizations/customization_record.webp)
...
- **Date Last Used**: date the customization was last used. Refer to
  [DLU](/docs/platgforsalesforce/clean_up/date_last_used.md) for more information.
...
![Example of the PasswordPolicies Health Settings tab](/img/product_docs/platgforsalesforce/customizations/health_settings_tab_example.webp)
...
Dependency Relationship Diagram ([DRD](/docs/platgforsalesforce/tools/viewing_drd.md)) displays objects, customizations
