...
3. Click **Install**
   ![install1](/img/product_docs/platgforsalesforce/installing_strongpoint/install1.webp)
...
7. Set **Selected OAuth Scopes** to **Full access (full)**
    ...
    ![Setting for Connected App](/img/product_docs/platgforsalesforce/integrations/connected_app.webp)
...
9. Click on **Netwrix Platform Governance**.
    ...
    ![configure-1](/img/product_docs/platgforsalesforce/installing_strongpoint/configure-1.webp)
...
**Next Step:** [Using the Getting Started Wizard](/docs/platgforsalesforce/installing_strongpoint/using_getting_started_wizard.md)
