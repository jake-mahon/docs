...
![Configuration and Stats report](/img/product_docs/platgforsalesforce/installing_strongpoint/config_stats_overview.webp)
...
![Configuration and Stats - Documentation Stats](/img/product_docs/platgforsalesforce/installing_strongpoint/config_doc_stats.webp)
...
![Configuration and Stats - Scanner Logs](/img/product_docs/platgforsalesforce/installing_strongpoint/config_scanner_logs.webp)
...
![Configuration and Stas - Scanner Additional Information](/img/product_docs/platgforsalesforce/installing_strongpoint/config_scan_add_info.webp)
...
![Control Change Log Creation in Sandbox](/img/product_docs/platgforsalesforce/installing_strongpoint/config_stats_enable_change_log.webp)
...
- Credentials
- Status Mapping
- [Jira Field Mapping](/docs/platgforsalesforce/integrations/jira_field_map.md) (separate topic)
...
2. Open the **Jira Configuration** tab. It opens on the **Credentials** tab.
    ...
    ![Open the credentials](/img/product_docs/platgforsalesforce/integrations/jira_sp_credentials.webp)
...
3. Open the **Status Mapping** tab.
    ...
    ![Set up the Jira status mappings for Change Request status](/img/product_docs/platgforsalesforce/integrations/jira_status_settings.webp)
...
2. Open the **Orgs** Credentials tab.
    ...
    ![Orgs Credentials](/img/product_docs/platgforsalesforce/installing_strongpoint/orgs_credentials.webp)
...
3. Click **New** to enter new credentials. For existing credentials, you can click **Edit** to
   ...
   credentials.
    ...
    ![New org credentials](/img/product_docs/platgforsalesforce/installing_strongpoint/orgs_credentials_new.webp)
