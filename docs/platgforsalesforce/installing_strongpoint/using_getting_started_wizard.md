...
the [basic installation](/docs/platgforsalesforce/installing_strongpoint/installing_strongpoint.md) and configuration.
...
![getting_started_wizard2](/img/product_docs/platgforsalesforce/installing_strongpoint/getting_started_wizard2.webp)
...
![getting_started_wizard3](/img/product_docs/platgforsalesforce/installing_strongpoint/getting_started_wizard3.webp)
...
![Testing the connection](/img/product_docs/platgforsalesforce/installing_strongpoint/getting_started_wizard10.webp)

1. Open Salesforce **Setup** > **Security** > **Remote Site Settings**.
2. Click **New Remote Site**.

    ![New Remote Site](/img/product_docs/platgforsalesforce/installing_strongpoint/getting_started_new_rss.webp)
...
**Next Step:** [Set Up the Initial Scan](/docs/platgforsalesforce/installing_strongpoint/setting_up_initial_scan.md)
