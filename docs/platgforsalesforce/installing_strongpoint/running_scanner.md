...
3. You can select + beside one or more types to scan or you can scan the whole environment by
   clicking + on the **Name** row to select all the types.
    ...
    ![scanner](/img/product_docs/platgforsalesforce/installing_strongpoint/scanner.webp)
...
5. The batch runs in the background. You receive an email notification when the scan is complete.
    ...
    - Click **Create New View**.  
      ![Set up a Strongpoint scanner view](/img/product_docs/platgforsalesforce/installing_strongpoint/scanner_view.webp)
    ...
    - Click **Save**. You can now see the status of all of the Strongpoint jobs.  
      ![Viewing running Strongpoin jobs](/img/product_docs/platgforsalesforce/installing_strongpoint/scanner_view2.webp)
...
**Next Step:** [Validate the Data ](/docs/platgforsalesforce/installing_strongpoint/validating_data.md)
