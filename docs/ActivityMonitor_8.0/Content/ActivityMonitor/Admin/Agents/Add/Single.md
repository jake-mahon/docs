...
Before deploying the activity agent, ensure all [Activity Agent Server Requirements](../../../Requirements/ActivityAgent "Activity Agent Server Requirements") have been met, including those for NAS devices when applicable. Follow the steps to deploy the activity agent to a single Windows server.
...
![Install New Agent window](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/InstallNew.png)
...
![Specify Agent Port page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/PortDefault.png)
...
![Credentials to Connect to the Server(s) page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/Credentials.png)
...
[![Test Account Connection](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/Single/TestAccountConnection.png "Test Account Connection")](../../../../Resources/Images/ActivityMonitor/ManualInstall/Single/TestAccountConnection.png)
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/AgentInstallLocation.png)
...
![Enable Windows File Activity Monitoring page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/Multiple/EnableWindowsFileActivityMonitoring.png "Enable Windows File Activity Monitoring page")
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWindowsConsole/ConsolewithAgent.png)

When the activity agent installation is complete, the status changes to **Installed** and the activity agent version populates. The next step is to add hosts to be monitored. See the [Monitored Hosts Tab](../../MonitoredHosts/Overview "Monitored Hosts Tab") topic for additional information.