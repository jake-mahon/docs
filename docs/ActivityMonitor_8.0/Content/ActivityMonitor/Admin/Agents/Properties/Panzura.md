...
![Agent Properties - Panzura Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/Properties/AgentProperties/PanzuraTab.png)
...
* Users can protect the port with a username and password. The credentials will be configured in Panzura
  ...
  * User name – Enter a custom user name or click **Generate** to create a random username and password
  * Password – Enter a custom password or use the generated password. Click **Copy** to copy the user name and password to the clipboard.
