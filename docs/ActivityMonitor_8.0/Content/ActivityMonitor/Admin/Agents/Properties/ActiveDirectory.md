...
![Agent Properties - Active Directory Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/Properties/AgentProperties/ADTab/MainImage.png "Agent Properties - Active Directory Tab")
...
* See the [Migrate Active Directory Monitoring to StealthINTERCEPT](#_Migrate_Active_Directory_1 "Migrate Active Directory Monitoring to StealthINTERCEPT") topic for additional information
* See the [Configuring StealthINTERCEPT to Send Active Directory Activity to the Activity Monitor](#_Configuring_StealthINTERCEPT_to "Configuring StealthINTERCEPT to Send Active Directory Activity to the Activity Monitor") topic for additional information
...
**Step 1 –** Configure the File, Syslog, or Threat Manager outputs on the Monitored Domains Tab in the Activity Monitor Console. See the [Output for Monitored Domains](../../MonitoredDomains/Output "Output for Monitored Domains") topic for additional information.
...
**Step 4 –** Enter a description within the General Tab of the New Policy Configuration page to identify the AD Module policy settings. Click the button in front of the policy status to toggle from Disabled to Enabled.
