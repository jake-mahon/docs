...
![AD Monitoring Configuration - Authentication Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/OperationsTab.png "AD Monitoring Configuration - Authentication Tab")
...
![AD Monitoring Configuration - Authentication Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/ForgedPAC.png "AD Monitoring Configuration - Authentication Tab")

Double-click text box to enter specific **RIDs**. Click OK. The AD agent then compares against the PAC and user’s access token for a mismatch to trigger the incident.

**NOTE:** The Forged PAC analytic is monitoring for when the user is not a member of a group that is listed in the PAC section of the user’s Kerberos ticket. This analytic can be scoped to monitor specific groups. To reduce the number of false positives, the AD agent only checks for a mismatch of sensitive groups as selected in the policy Settings tab.
...
![Host (From) Tab in the Authentication Tab](../../../../Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/HostFrom.png "Host (From) Tab in the Authentication Tab")
...
![Host (To) Tab in the Authentication Tab](../../../../Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/HostTo.png "Host (To) Tab in the Authentication Tab")
...
![IP Addresses (From) Tab in the Authenticatoin Tab](../../../../Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/IPAddressesFrom.png "IP Addresses (From) Tab in the Authenticatoin Tab")

Underneath each section, there is an additional Address detail:

* Value – Must be provided in IP address format

Double-click the text box beneath **Value** to enter the desired IP Addresses to include or exclude. Press the Enter or Tab key to add another text box.
...
![IP Addresses (To) Tab in the Authentication Tab](../../../../Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/IPAddressesTo.png "IP Addresses (To) Tab in the Authentication Tab")
...
![Operations Tab in the Authentication Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/OperationsTab.png)

The **Monitor These Attempts** section is where monitoring is set to filter for successful events, failed events, or both:

* Success – Monitors successful events
* Failure – Monitors failed events

The **Monitor These Protocols** section is where authentication protocols to be monitored are selected for the policy. Check the box to select the authentication protocol(s) to be monitored:

* All
* Kerberos
* NTLM

**CAUTION:** If Login Type is enabled, authentication events will be received from Domain Controllers only.
...
![Servers Tab in the Authentication Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/ServersTab.png "Servers Tab in the Authentication Tab")
...
![Users Tab in the Authentication Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/MonitoredDomains/AuthenticationTab/UsersTab.png)
