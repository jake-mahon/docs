...
![FPolicy Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/HostProperties/FPolicyTab/FPolicyTab.png)

On the **FPolicy** tab, the agent can configure and/or enable FPolicy automatically. The recommended setting is dependent on the type of NetApp device being targeted. The permissions required for each option are listed. See the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](../../../../Config/NetApp7Mode/Activity "NetApp Data ONTAP 7-Mode Activity Auditing Configuration") topic or the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](../../../../Config/NetAppCMode/Activity "NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration") topic for additional information.
...
![Privileged Access section in the FPolicy Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/HostProperties/FPolicyTab/PrivilegedAccess.png)

The Privileged Access tab is enabled when the Configure FPolicy checkbox is selected at the top. The Privileged Access tab must be configured if automatic configuration of the FPolicy for NetApp Data ONTAP Cluster-Mode devices is used. See the [Configure Privileged Access](../Add/NetApp#_Configure_Privileged_Access_1 "Navigates to the Configure Privileged Access section") topic for additional information.

## Enable and Connect settings Tab

![Enable and Connect Settings - FPolicy Tab](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/HostProperties/FPolicyTab/EnableorConnectSettings.png)
...
![Add or Edit Cluster Node popup window](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/HostProperties/FPolicyTab/EnableorConnectSettingsAddorEditClusterNode.png)
...
![Connect to Cluster popup window](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/HostProperties/FPolicyTab/EnableorConnectSettingsConnecttoCluster.png)
