...
Prior to adding a Panzura host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Panzura CloudFS Monitoring](../../../../Config/Panzura/Activity "Panzura Activity Auditing Configuration") topic for additional information.
...
![Add Host](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/AddHostPanzura.png "Add Host")

**Step 3 –** On the Add Host page, select the **Panzura** radio button and enter the **Panzura filer name**. Click **Next**.

![Panzura Properties](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/PanzuraOptions.png "Panzura Properties")

**Step 4 –** On the Panzura Options page, enter the **Username**, **Password**, and select the **Protocol** to be used by the Panzura host.
...
![Customize Certifiacte Verification](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/TrustedServerCertificate.png "Customize Certifiacte Verification")
...
![Configure Operations](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/PanzuraConfigureOperations.png "Configure Operations")
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/ConfigureBasicOptionsPanzura.png)
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/FileOutput.png)
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/SyslogOutput.png)
...
![](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/PanzuraHost/ActivityMonitorPanzura.png)

The added Panzura host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](../Output "Output for Monitored Hosts") topic for additional information.
...
* [Panzura Tab](../Properties/Panzura "Panzura Tab")
