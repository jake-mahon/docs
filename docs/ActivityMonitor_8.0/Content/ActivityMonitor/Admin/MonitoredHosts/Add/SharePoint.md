...
Prior to adding a SharePoint host to the Activity Monitor, the prerequisites for the target environment must be met. See the [SharePoint On-Premise Activity Auditing Configuration](../../../../Config/SharePoint/Activity "SharePoint Activity Auditing Configuration") topic for additional information.
...
![Add Host page with SharePoint selected](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/AddHostSharePoint.png "Add Host page with SharePoint selected")

**Step 3 –** On the Add Host page, select the SharePoint radio button. If desired, add a Comment. Click **Next**.

![Add Host - SharePoint Options page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/SharePointOptions.png "Add Host - SharePoint Options page")
...
* Enter valid **User Name** and **Password** for a domain account with local administrative permissions
* Connect – Click Connect to verify the provided credentials

Click **Next**.

![Configure Operations page for SharePoint](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/ConfigureOperationsSharePoint.png "Configure Operations page for SharePoint")
...
![File Output Page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/FileOutputPage.png "File Output Page")
...
![Syslog Output Page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/SyslogOutputPage.png "Syslog Output Page")
...
![Activity Monitor with SharePoint host added](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/SharePointHost/ActivityMonitorSharePoint.png "Activity Monitor with SharePoint host added")

The added SharePoint host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](../Output "Output for Monitored Hosts") topic for additional information.
...
* [SharePoint Tab](../Properties/SharePoint)
