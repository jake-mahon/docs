...
Prior to adding a Nasuni Edge Appliance host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Nasuni Edge Appliance Activity Auditing Configuration](../../../../Config/Nasuni/Activity "Nasuni Edge Appliance Activity Auditing Configuration") topic for additional information.
...
![Add Host page with Nasuni selected](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/AddHostNasuni.png "Add Host page with Nasuni selected")

**Step 3 –** On the Add Host page, select the Nasuni radio button and enter the host name or IP Address of the Nasuni Edge Appliance in the Nasuni Filer textbox. If desired, add a **Comment**. Click **Next**.

![Nasuni Options page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/NasuniOptions.png "Nasuni Options page")

**Step 4 –** On the Nasuni Options page, enter the **API Key Name** and the **API Key Value**. Click Connect to validate the connection with the Nasuni device.
...
![Trusted Server Certificate popup window](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/TrustedServerCertificate.png "Trusted Server Certificate popup window")
...
**Step 5 –** On the Configure Operations page, select the **File Operations, Directory Operations**, and **Link Operations** to be monitored. Additional options include:
...
![Configure Basic Options page for Nasuni](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/ConfigureBasicOptionsNasuni.png "Configure Basic Options page for Nasuni")
...
![File Output Page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/FileOutputPage.png "File Output Page")
...
![Syslog Output page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/SyslogOutputPage.png "Syslog Output page")
...
![Activity Monitor with Nasuni host added](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/NasuniHost/ActivityMonitorNasuni.png "Activity Monitor with Nasuni host added")

The added Nasuni host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](../Output "Output for Monitored Hosts") topic for additional information.
...
* [Nasuni Tab](../Properties/Nasuni "Nasuni Tab")
