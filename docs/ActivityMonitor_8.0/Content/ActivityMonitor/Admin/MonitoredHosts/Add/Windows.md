...
Prior to adding a Windows host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Windows File Server Activity Auditing Configuration](../../../../Config/WindowsFile/Activity "Windows File Server Activity Auditing Configuration") topic for additional information.
...
![Choose Agent](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/ChooseAgent.png "Choose Agent")

**Step 2 –** On the Choose Agent page, select the **Agent** to monitor deployed on the Windows file server. Click **Next**.

![Add Host page with Windows selected](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/AddHostWindows.png "Add Host page with Windows selected")
...
![Protocols page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/ProtocolsPage.png "Protocols page")
...
![Configure Operations page for Windows host](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/ConfigureOperationsWindows.png)
...
![Configure Basic Options page for Windows](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/ConfigureBasicOptionsWindows.png "Configure Basic Options page for Windows")
...
![Where to log activity page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WhereToLogGeneric.png "Where to log activity page")
...
![File Output page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/FileOuputPage.png "File Output page")
...
![Syslog Output page](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/SyslogOutputPage.png "Syslog Output page")
...
![Activity Monitor with Windows Host added](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/AddHost/WindowsHost/ActivityMonitorWindows.png "Activity Monitor with Windows Host added")

The added Windows file server host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](../Output "Output for Monitored Hosts") topic for additional information.
...
* [Windows Tab](../Properties/Windows)
* [Inactivity Alerts Tab](../Properties/InactivityAlerts)
