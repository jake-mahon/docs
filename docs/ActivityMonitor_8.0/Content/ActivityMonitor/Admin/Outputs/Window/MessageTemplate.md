...
![Message Template window](../../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/Outputs/SyslogMessageTemplate.png "Message Template window")
...
* Splunk – Use this template for Splunk integration. See the Configure the [File Activity Monitor App for Splunk](../../../SIEM/Splunk/Overview "Stealthbits File Activity Monitor App for Splunk") topic for additional information.
