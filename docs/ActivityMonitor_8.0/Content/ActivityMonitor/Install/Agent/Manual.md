...
![Activity Monitor Agent Setup Wizard - Welcome Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/Welcome.png "Activity Monitor Agent Setup Wizard - Welcome Page")

**Step 4 –** On the welcome page click **Next**.

![End-User License Agreement Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/EULA.png "End-User License Agreement Page")
...
![Destination Folder Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/DestinationFolder.png "Destination Folder Page")

**Step 6 –** (Optional) On the Destination Folder page, click **Change** to change the installation directory location.

![Change Destination Folder Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/ChangeDestination.png "Change Destination Folder Page")

**Step 7 –** Click **OK** on the Change destination folder page to return to the Destination folder page. Click **Next**.

![Ready to install Netwrix Activity Monitor Agent 64-bit Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/ReadyInstall.png "Ready to install Netwrix Activity Monitor Agent 64-bit Page")
...
![Completion Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWinWizrdConsole/Complete.png "Completion Page")
...
Before deploying the Activity Monitor agent, ensure all [Activity Agent Server Requirements](../../Requirements/ActivityAgent "Activity Agent Server Requirements") have been met, including those for NAS devices when applicable.

**NOTE:** These steps are specific to deploying activity agents for monitoring file systems, SharePoint, SQL Server, Azure and Office 365 environments. See the [Active Directory Agent Deployment](../../Admin/Agents/Add/ActiveDirectory "Active Directory Agent Deployment") section for instruction on deploying the AD agent. See the [Linux Agent Deployment](../../Admin/Agents/Add/Linux "Linux Agent Deployment") topic for instructions on deploying agents to Linux servers.
...
![Install New Agent Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/InstallNew.png "Install New Agent Page")

**Step 3 –** Specify the server name where the agent will be deployed. To add multiple server names, see the [Multiple Activity Agents Deployment](../../Admin/Agents/Add/Multiple "Multiple Activity Agents Deployment") topic for additional information. Click **Next**.

![Agent Port Configuration](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/PortDefault.png "Agent Port Configuration")

**Step 4 –** Specify the port to be used for the agent. Click **Next**.

![Credentials to connect to servers](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/Credentials.png "Credentials to connect to servers")

**Step 5 –** On the Credentials to Connect to the Server(s) page, specify the credentials for the server to which the agent is deployed. See the [Single Activity Agent Deployment](../../Admin/Agents/Add/Single "Single Activity Agent Deployment") topic for additional information on credential options. Click **Connect**.
...
![Agent Install Location](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWindowsConsole/InstallLocation.png "Agent Install Location")

**Step 7 –** Specify the path of the Activity Monitor Agent, that has already been installed. Click **Next**.

![Windows Agent Settings](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWindowsConsole/AgentSettings.png "Windows Agent Settings")
...
![Activity Monitor Agent Installed](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/ADWindowsConsole/ConsolewithAgent.png "Activity Monitor Agent Installed")
