...
![StealthINTERCEPT Windows Agent Setup wizard on the Welcome page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/Welcome.png "StealthINTERCEPT Windows Agent Setup wizard on the Welcome page")

**Step 2 –** On the Welcome page, click **Install**. The Setup Progress page is displayed, followed by another Welcome page.

![Threat Prevention Windows Agent - Welcome Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/Welcome2.png "Threat Prevention Windows Agent - Welcome Page")

**Step 3 –** Click **Next**.

![End-User License Agreement Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/License.png "End-User License Agreement Page")

**Step 4 –** On the End-User License Agreement page, check the **I accept the terms in the License Agreement** box and click **Next**.

![Destination Folder Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/DestinationFolder.png "Destination Folder Page")
...
![Change Destination Folder Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/ChangeDestination.png "Change Destination Folder Page")
...
![CA Certificate Configiration Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/CACertConfig.png "CA Certificate Configiration Page")
...
![Enterprise Manager Location Information Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/WindowsAgentSetup/EnterpriseManagerAM.png "Enterprise Manager Location Information Page")
...
![Select Event Sources Page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/WindowsAgentSetup/EventSourcesAD.png "Select Event Sources Page")
...
![Windows Agent Setup wizard on the Ready page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/ReadytoInstall.png "Windows Agent Setup wizard on the Ready page")
...
![Windows Agent Setup wizard on the Operation successful page](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ThreatPrevention/Install/Agent/Manual/Success.png "Windows Agent Setup wizard on the Operation successful page")
...
![Install New Agent](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/InstallNew.png "Install New Agent")

**Step 3 –** Click the **install agents on Active Directory domain controllers** link.

![Specify Agent Port](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/SpecifyPort.png "Specify Agent Port")

**Step 4 –** Specify the port for the Activity Monitor Agent. Click **Next**.

![Agent Install Location](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/InstallLocation.png "Agent Install Location")

**Step 5 –** Specify the path of the Activity Monitor Agent, that has already been installed. Click **Next**.

![Active Directory Connection](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/ADConnection.png "Active Directory Connection")
...
![Domains to Monitor](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/Domains.png "Domains to Monitor")

**Step 7 –** Select the domain of the domain controller(s) where the agent is installed. Click **Next**.

![Domain Controllers to Deploy Agent](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/DomainController.png "Domain Controllers to Deploy Agent")
...
![Windows Agent Settings](../../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/ActivityMonitor/ManualInstall/WindowsConsole/WindowsAgent.png "Windows Agent Settings")
