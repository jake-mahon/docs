...
![Active Directory Activity DC wizard Category page](../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/EnterpriseAuditor/Admin/DataCollector/ADActivity/CategoryImportFromShare.png "Active Directory Activity DC wizard Category page")

**Step 4 –** On the Category page, choose **Import from Share** option and click **Next**.

![Active Directory Activity DC wizard Share settings page](../../../../../static/images/ActivityMonitor_8.0/Content/Resources/Images/EnterpriseAuditor/Admin/DataCollector/ADActivity/Share.png "Active Directory Activity DC wizard Share settings page")
