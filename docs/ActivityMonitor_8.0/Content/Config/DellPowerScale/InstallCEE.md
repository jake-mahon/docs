...
After installation, open MS-RPC ports between the Dell device and the Dell CEE server. See the [Dell CEE Debug Logs](Validate#EMC "Dell CEE Debug Logs") section for information on troubleshooting issues related to Dell CEE.
