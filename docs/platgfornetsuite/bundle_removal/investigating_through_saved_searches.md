...
- **Date Last Used ([DLU](/docs/platgfornetsuite/clean_up/date_last_used.md))**: to know the last time the customization
  was used.
...
- Forms
- List  
  ![Results columns of Saved Searches](/img/product_docs/platgfornetsuite/bundle_removal/results_saved_searches.webp)

**Next Step:**
[](/docs/platgfornetsuite/bundle_removal/exporting_information_to_excel.md)[Exporting Information to Excel](/docs/platgfornetsuite/bundle_removal/exporting_information_to_excel.md)
