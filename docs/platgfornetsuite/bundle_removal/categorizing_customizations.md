...
6. Click **Preview**.This step takes some time.Troubleshooting:
   [Saved Search Times Out](/docs/platgfornetsuite/troubleshooting/saved_search_times_out.md)

## Export and Import the CSV File

1. Export as a CSV file.

    ![Export to a CSV file](/img/product_docs/platgfornetsuite/bundle_removal/export_csv.webp)
...
**Next Step:**
[](/docs/platgfornetsuite/bundle_removal/creating_four_mass_updates.md)[Creating Four Mass Updates](/docs/platgfornetsuite/bundle_removal/creating_four_mass_updates.md)
