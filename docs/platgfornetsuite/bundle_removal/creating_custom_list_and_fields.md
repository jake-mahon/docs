...
3. On the Values tab add these values:
    ...
    6. In bundle referenced by outside
        ...
        ![Create a Custom List](/img/product_docs/platgfornetsuite/bundle_removal/customlist.webp)
...
**Next Step:** [Categorizing Customizations](/docs/platgfornetsuite/bundle_removal/categorizing_customizations.md)
