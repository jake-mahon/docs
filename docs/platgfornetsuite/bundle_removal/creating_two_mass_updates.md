...
3. Check **Use Expressions** on the **Criteria** tab.
    ...
    ![Select Use Expressions](/img/product_docs/platgfornetsuite/bundle_removal/bundle_removal_use_expressions.webp)
...
![Mass Update Filters](/img/product_docs/platgfornetsuite/bundle_removal/mass_update_filters.webp)
...
3. Enter the **Clean Up Status**: **To Be Cleaned Up**.
    ...
    ![Set Clean Up Status](/img/product_docs/platgfornetsuite/bundle_removal/clean_up_status.webp)
...
![Adding filters](/img/product_docs/platgfornetsuite/bundle_removal/mass_update_filters2.webp)
...
**Next Step:** [Creating a Custom List and Fields](/docs/platgfornetsuite/bundle_removal/creating_custom_list_and_fields.md)
