...
1. Open **Strongpoint** > **Change Management Reports** > **Open NonCompliant Changes**  
   The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/platgfornetsuite/change_management/using_change_logs.md). You
   can filter the report or sort by the column heads.

    ![Non-Compliant Change Report](/img/product_docs/platgfornetsuite/change_management/noncompliantreport.webp)
    ![NonCompliant Flags](/img/product_docs/platgfornetsuite/change_management/noncompliant_flags.webp)
...
2. A noncompliant change means something got changed without the required approvals. **View** each
   ...
   for the change to be compliant.
    ...
    1. Create a New [Change Request](/docs/platgfornetsuite/change_management/creating_change_request.md) or open an existing one.
...
5. Set these filters on the **Criteria** tab:
    ...
    - **Date Created** is [_applicable range_]
        ...
        ![Set the Title of Action and the Filters](/img/product_docs/platgfornetsuite/change_management/mass_update_filters_3.webp)
...
8. Set these Fields:
    ...
    - **Noncompliance**
        ...
        ![Select the Soft By and add Fields to Reults tab](/img/product_docs/platgfornetsuite/change_management/mass_update_filters_4.webp)
...
10. Check these Fields:
    ...
    - **Status** and select **Closed** for the **Value**.
        ...
        ![Add the information on the Mass Update Fields tab](/img/product_docs/platgfornetsuite/change_management/mass_update_filters_5.webp)
