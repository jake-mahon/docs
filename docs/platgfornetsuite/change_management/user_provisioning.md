...
[Using Custom Change Request Forms](/docs/platgfornetsuite/change_management/use_custom_cr_forms.md) for information on implementing your
custom form.
...
2. Open the **Change Management** tab.
    ...
    ![Enabling Enhanced User Provisioning](/img/product_docs/platgfornetsuite/change_management/enhanced_user_provisioning.webp)
...
5. When **Enhanced User Provisioning** is enabled, there are new **Access and Setup** controls added
   to the **Policy Change Controls** tab: **User Offboarding** and **User Onboarding**:
    ...
    ![New provisioning change controls](/img/product_docs/platgfornetsuite/change_management/provisioning_change_controls.webp)

## Onboarding Users

1. Open **Strongpoint** > **Change Management Tools** > **User Provisioning Change Request**.

    ![New User Access Change Request form](/img/product_docs/platgfornetsuite/change_management/user_access_change_request.webp)
...
![A compliant change log is created](/img/product_docs/platgfornetsuite/change_management/provisioning_change_log.webp)
...
5. Enter one or more **Affected Employees**. The **Get Roles for Affected Employees** button is now
   visible.
    ...
    ![Provisioning role reductions](/img/product_docs/platgfornetsuite/change_management/provisioning_role_reductions.webp)

6. Enter one or more **Affected Roles**. Or, click **Get Roles for Affected Employees** to select
   from the current roles.

    ![Select the roles to remove](/img/product_docs/platgfornetsuite/change_management/provisioning_role_reductions_selector.webp)
