...
[Change Request](/docs/platgfornetsuite/change_management/creating_change_request_old_form.md) form. Refer to
[Setting Preferred Forms](/docs/platgfornetsuite/customizations/setting_preferred_forms.md) for information on
...
2. Enter information in the **Main** and **Scope** sections:
    ...
    ![change_request_new](/img/product_docs/platgfornetsuite/change_management/change_request_new.webp)
    ...
    - **Lookup Customization** launches a window where you can search for customizations in the
      current account or a different account:
        - Click **Change Account** to log into another account or sandbox and look up
          ...
          [Comparing Environments](/docs/platgfornetsuite/change_management/comparing_environments.md) to save your credentials for each
          environment you use.
    ...
    - **Do Not ReSpider Automatically**: when unchecked, an Automatic ReSpider occurs when the
      ...
      [Configuration and Stats Change Management](/docs/platgfornetsuite/installing_strongpoint/installation_settings_report.md)
      tab.
...
4. **Save** the Change Request. New sections and tabs are available once you save:
    ...
    1. **Push to Jira** button is available if the
       [Jira integration](/docs/platgfornetsuite/integrations/jira_integration.md) is available, and
       [Allow NS to Push to Jira](/docs/platgfornetsuite/integrations/jira_integration.md) is enabled. When prompted,
    ...
    3. The **Approval** section is visible. Click **Edit to** add **Additional Approvers** or
       **Approver Notes**. Click **Save** if you make changes.
        ...
        ![change_request_new_saved](/img/product_docs/platgfornetsuite/change_management/change_request_new_saved.webp)
...
5. Click **Pending Approval** in the status bar when you are finished with the Change Request. A
   ...
   approvers.
    ...
    ![change_request_new_pendapprove](/img/product_docs/platgfornetsuite/change_management/change_request_new_pendapprove.webp)

6. Approvers approve or reject the Change Request. **Deploy** is available for approved Change
   Requests.

    ![change_request_new_approved](/img/product_docs/platgfornetsuite/change_management/change_request_new_approved.webp)
...
![change_request_bar_not_started](/img/product_docs/platgfornetsuite/change_management/change_request_bar_not_started.webp)

New Change Request. Click **In Progress** to advance the status.

Impact Analysis is run when the Change Request is Saved.

![change_request_bar_inprogress](/img/product_docs/platgfornetsuite/change_management/change_request_bar_inprogress.webp)
...
![change_request_bar_pending](/img/product_docs/platgfornetsuite/change_management/change_request_bar_pending.webp)
...
![change_request_bar_approved](/img/product_docs/platgfornetsuite/change_management/change_request_bar_approved.webp)
...
![change_request_bar_approved_partial](/img/product_docs/platgfornetsuite/change_management/change_request_bar_approved_partial.webp)

Status when Change Request is partially approved. Wait for all approvers to finish.

![change_request_bar_approved_override](/img/product_docs/platgfornetsuite/change_management/change_request_bar_approved_override.webp)
...
![change_request_bar_approved_completed](/img/product_docs/platgfornetsuite/change_management/change_request_bar_approved_completed.webp)
...
![change_request_bar_approved_canceled](/img/product_docs/platgfornetsuite/change_management/change_request_bar_approved_canceled.webp)
...
![change_request_bar_rejected](/img/product_docs/platgfornetsuite/change_management/change_request_bar_rejected.webp)
