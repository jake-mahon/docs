...
11. Click **Push**.
    ![push_change_request](/img/product_docs/platgfornetsuite/change_management/push_change_request.webp)
...
- Attach **customizations created/updated**.
    ...
    ![multi_env_1](/img/product_docs/platgfornetsuite/change_management/multi_env_1.webp)

- **Stage**: **Deployment Record**
- **Set Approval Status**: **Approved** (this is optional)

    ![multi_env_2](/img/product_docs/platgfornetsuite/change_management/multi_env_2.webp)
...
4. Click the **Compare** button.  
   Refer to [Comparing Environments](/docs/platgfornetsuite/change_management/comparing_environments.md) for more details.
...
5. Click **Edit** (deployment record).
    ...
    ![multi_env_3](/img/product_docs/platgfornetsuite/change_management/multi_env_3.webp)
