...
![modifypolicy-cr](/img/product_docs/platgfornetsuite/change_management/modifypolicy-cr.webp)
...
![deactivatepolicy](/img/product_docs/platgfornetsuite/change_management/deactivatepolicy.webp)3.
Get the Change Request **Approved**. 4. Click **Save** 5. Check the **Inactive** box.

![inactivebox](/img/product_docs/platgfornetsuite/change_management/inactivebox.webp)6.
Click **Save**
