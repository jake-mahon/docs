...
[Change Management Reports](/docs/platgfornetsuite/change_management/change_management_reports.md).
...
![values_tab](/img/product_docs/platgfornetsuite/change_management/values_tab.webp)
...
1. Click on a linked **Customization** to open the Customization Record. **Strongpoint Return Jira
   Ticket Info (Suitelet Script)** in this example.
    ...
    ![Change Log Customization link](/img/product_docs/platgfornetsuite/change_management/change_log_customization_link.webp)

2. Click **Go to Record**
3. Open **System Notes**

![systemsnotes](/img/product_docs/platgfornetsuite/change_management/systemsnotes.webp)
