...
2. Administrator only attaches the workflow to the Change Request, forgetting to attach the search
   condition.
    ...
    ![opp_clearance_case4-1](/img/product_docs/platgfornetsuite/change_management/opp_clearance_case4-1.webp).
...
1. The Search change is attached to the related workflow's approved Change Request.
    ...
    ![opp_clearance_case4-2](/img/product_docs/platgfornetsuite/change_management/opp_clearance_case4-2.webp)
