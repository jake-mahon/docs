...
2. Search for **customdeploy_flo_display_cr**
    ...
    ![Search for the script](/img/product_docs/platgfornetsuite/change_management/custom_cr1.webp)
...
5. Select your custom forms from the drop down lists for each type of Change Request
    ...
    ![Select your custom forms](/img/product_docs/platgfornetsuite/change_management/custom_cr2.webp)
