...
1. Developer creates a Change Request and attaches the Suitelet:
    ...
    ![opp_clearance_case1-1](/img/product_docs/platgfornetsuite/change_management/opp_clearance_case1-1.webp)
...
1. The change logs for the Suitelet, the Suitelet library script and deployment are attached to the
   related script approved Change Request.
    ...
    ![opp_clearance_case1-2](/img/product_docs/platgfornetsuite/change_management/opp_clearance_case1-2.webp)

2. The logs are compliant.

    ![opp_clearance_case1-3](/img/product_docs/platgfornetsuite/change_management/opp_clearance_case1-3.webp)
