...
4. Click the **Deployment Validation** tab.
    ...
    ![deployment_validation](/img/product_docs/platgfornetsuite/change_management/deployment_validation.webp)

5. Click **Run Compare Tool**. Validate the changes are what you expected. Refer to
   [Comparing Environments](/docs/platgfornetsuite/change_management/comparing_environments.md) for details.
