...
[Creating a Change Request](/docs/platgfornetsuite/change_management/creating_change_request.md) for the new form. Refer to
...
2. Fill in the following fields in the **Main** section of the change request:
    ...
    ![changerequestmain1](/img/product_docs/platgfornetsuite/change_management/changerequestmain1.webp)
...
3. Fill in the following fields in the **Scope** section of the change request:
    ...
    ![scope-1](/img/product_docs/platgfornetsuite/change_management/scope-1.webp)

    ![scope-3](/img/product_docs/platgfornetsuite/change_management/scope-3.webp)
...
7. Scroll down to the bottom of the page and click on the **Impact Analysis** tab.This shows you
   ...
   impacted customization record(s) that need to be investigated before you make a change.
    ...
    ![impactanalysissubtab](/img/product_docs/platgfornetsuite/change_management/impactanalysissubtab.webp)
