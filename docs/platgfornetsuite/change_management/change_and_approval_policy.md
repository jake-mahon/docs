...
The [Setting Up Policies](/docs/platgfornetsuite/change_management/setting_up_policies.md) topic has details on setting up the Change /
Approval Policies.
...
[Non-Material Changes report](/docs/platgfornetsuite/change_management/change_management_reports.md).
