...
![changeandapprovalpolicy1](/img/product_docs/platgfornetsuite/change_management/changeandapprovalpolicy1.webp)
...
- **Change Controls:**
    ...
    ![Policy Default Change Controls](/img/product_docs/platgfornetsuite/change_management/policy_default_change_controls2.webp)
...
- **User Offboarding**: Available when [Enhanced User Provisioning](/docs/platgfornetsuite/change_management/user_provisioning.md) is
  enabled.
- **User Onboarding**: Available when [Enhanced User Provisioning](/docs/platgfornetsuite/change_management/user_provisioning.md) is enabled.

## Approvals

Approvers initiate the change request and enable it to move to the next stage.

![Policy Approvals tab](/img/product_docs/platgfornetsuite/change_management/policy_approvals_tab.webp)
...
- **Final Approver (Policy Change)**: Specifies the final approver required for a policy change. The
  person who needs to approve after all other approvals have been obtained.
    ...
    **NOTE:** Specifying a **Final Approver** locks the default policy and all child policies. If a
    ...
    ![Record Save Blocked](/img/product_docs/platgfornetsuite/change_management/record_save_blocked.webp)
...
![policy_add_customizations](/img/product_docs/platgfornetsuite/change_management/policy_add_customizations.webp)
