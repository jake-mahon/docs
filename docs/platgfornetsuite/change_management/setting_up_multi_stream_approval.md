...
4. Ctrl-Click to select one or more **Additional Approvers**. NOTE: Select the additional approvers
   in the order you want them to approve.
    ...
    ![multi_stream_new_process](/img/product_docs/platgfornetsuite/change_management/multi_stream_new_process.webp)
...
5. Click **Save**. Note the approvers are listed in the order selected, not the order they appeared
   ...
   the additional approvers.
    ...
    ![multi_stream_new_process_save](/img/product_docs/platgfornetsuite/change_management/multi_stream_new_process_save.webp)
...
6. Click **Save**. Leave the new policy open and continue with the next steps.
    ...
    ![multi_stream_new_policy](/img/product_docs/platgfornetsuite/change_management/multi_stream_new_policy.webp)
...
2. Select the **Process** you created. For this example, it is **Provision Multi-Stream Approval**.
    ...
    ![multi_stream_attach](/img/product_docs/platgfornetsuite/change_management/multi_stream_attach.webp)

3. Click **Attach**. The process is now shown on the **Process Policies** tab.

    ![multi_stream_attach_result](/img/product_docs/platgfornetsuite/change_management/multi_stream_attach_result.webp)
