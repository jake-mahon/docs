...
- Automatically define the change level required for compliance based on the appropriate
  [Change and Approval Policy](/docs/platgfornetsuite/change_management/change_and_approval_policy.md).
- Identify impacts on other customizations.
- Attach and manage test scripts.
- Manage and record Pre and Post-Deployment [Environment Comparisons](/docs/platgfornetsuite/change_management/comparing_environments.md).
- Archive fields.
