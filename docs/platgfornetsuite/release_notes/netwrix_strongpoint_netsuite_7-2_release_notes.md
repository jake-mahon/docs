...
Strongpoint is excited to release an [Integration API](/docs/platgfornetsuite/api/api_overview.md) to enable your
...
- API commands are documented in the [Integration API](/docs/platgfornetsuite/api/api_overview.md) section of this
  guide.
...
3. Set the Filter **Type** to **Suitelet** and the **Bundle ID** to **294336**.
    ...
    ![Find the Suitelet](/img/product_docs/platgfornetsuite/release_notes/scripts.webp)

4. Click **View** by the **Strongpoint Reset Schedule Deployments** suitelet.
5. Open the **Deployments** tab.

    ![Open the Deployment tab](/img/product_docs/platgfornetsuite/release_notes/script_deploy_tab.webp)

6. Click the Suitelet name: **Strongpoint Reset Schedule Deployments**.
7. Click on the Script **URL**.

    ![Click the Script URL](/img/product_docs/platgfornetsuite/release_notes/script_deploy_url.webp)
