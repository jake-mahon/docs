...
supported option. You can use the Strongpoint [Integration API](/docs/platgfornetsuite/api/api_overview.md) to create
...
- Added **Supervisor** column to the Membership Review.
    ...
    ![UAR Membership Review](/img/product_docs/platgfornetsuite/release_notes/uar_review_supervisor.webp)
