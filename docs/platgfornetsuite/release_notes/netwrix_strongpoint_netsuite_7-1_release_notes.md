...
- Bundle updates were enabling **Automatic Synchronization** between Strongpoint and Jira, changing
  ...
  to enabled for new installations. Refer to [Jira](/docs/platgfornetsuite/integrations/jira_integration.md) topic for
  more information.
...
- Added **Refresh Changed By** button to refresh change information on Change Logs. If the **Actual
  ...
  Change Date** and **Change By** fields.
    ...
    ![Refresh Changed By](/img/product_docs/platgfornetsuite/change_management/change_log_refresh.webp)
...
![Run the Saved Search to view changes](/img/product_docs/platgfornetsuite/release_notes/formulahtml.webp)
...
- Added **GL Impact** and **Permission Risk Severity** columns to the Permission Review.
    ...
    ![UAR GL Impact](/img/product_docs/platgfornetsuite/release_notes/uar_gl_impact.webp)
