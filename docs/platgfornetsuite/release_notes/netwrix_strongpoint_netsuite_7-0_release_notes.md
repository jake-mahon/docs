...
- Added a warning on the change request for generic deployment script IDs. Using the generic ID
  fetches all deployment customizations that share this non-unique ID.
    ...
    ![Generic deployment ID warning](/img/product_docs/platgfornetsuite/release_notes/deployment_id_warning.webp)
...
- **Changed By No HTML** and **Diff No HTML** result options are available for customizing your
  ...
  fields in plain text, removing the HTML tags to improve readability.
    ...
    - Click **Add**.
        ...
        ![Add No HTML fields](/img/product_docs/platgfornetsuite/release_notes/no_html_options.webp)
...
![Mass Update can be created as a Proposed Customization](/img/product_docs/platgfornetsuite/release_notes/change_request_mass_update.webp)
...
![Make Copy does not copy the status](/img/product_docs/platgfornetsuite/release_notes/change_request_make_copy.webp)

## Jira 1.2.14

- Added the ability to receive and store images attached in the Jira description by Jira ticket ID.

    ![Strongpoint stores attached Jira images](/img/product_docs/platgfornetsuite/release_notes/jira_images.webp)
...
3. Check **Allow NS to Jira Push** to enable pushing NetSuite change requests into Jira.
    ...
    ![Enable Allow NS to Push to Jira](/img/product_docs/platgfornetsuite/release_notes/jira_example_integration.webp)
...
4. Select your Jira project.  
   ![Select a Jira Project](/img/product_docs/platgfornetsuite/release_notes/jira_ns_jira_push2.webp)
...
6. Open the **Related Change Records** tab. The ticket number is added as an **External Change
   ...
   ![The ticket number is on the Related Change Records tab](/img/product_docs/platgfornetsuite/release_notes/jira_create_cr_related_change.webp)
7. Open Jira.
8. Navigate to **CM-15** ticket.  
   ![Open the ticket in Jira](/img/product_docs/platgfornetsuite/release_notes/jira_ns_jira_push3.webp)
9. Click **Strongpoint NetSuite**. The customizations from the change request are added.  
   ![Customizations are added to the ticket](/img/product_docs/platgfornetsuite/release_notes/jira_ns_jira_push4.webp)
...
[Setting up Token-Based Authentication](/docs/platgfornetsuite/integrations/jira_integration.md).

1. Open **Jira**.
2. Open your **Projects** page:

    ![Open your Jira Projects page to find Add-ons](/img/product_docs/platgfornetsuite/release_notes/jira_projects_menu.webp)

3. Expand **Add-ons**.
4. Select **Strongpoint Settings**.

    ![Jira Strongpoint Settings](/img/product_docs/platgfornetsuite/release_notes/jira_strongpoint_settings.webp)

5. Click **New Token Based Authentication** to add your credentials. This needs to be done once for
   each of your accounts.

    ![Add tokens for Jira](/img/product_docs/platgfornetsuite/release_notes/jira_add_token.webp)
