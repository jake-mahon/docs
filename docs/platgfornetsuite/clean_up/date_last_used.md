...
- For scripts the DLU is the last execution date as determined by audit, error or debug logs in
  ...
  [Script Management](/docs/platgfornetsuite/script_management/script_mgmt_overview.md) for details.
...
![Unused Workflow Customizations Search Results](/img/product_docs/platgfornetsuite/clean_up/unused_workflow_results.webp)
