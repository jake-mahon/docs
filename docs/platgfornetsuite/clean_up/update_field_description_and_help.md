...
[Opportunistic Clearance](/docs/platgfornetsuite/change_management/opportunistic_clearance.md) is on, this object change
...
1. Open **Strongpoint** > **Clean Up** > **Update Field Description and Help**You can filter the
   ...
   heading in the **Field List** to sort the list by the selected column.
    ...
    ![cust_ui_help_update](/img/product_docs/platgfornetsuite/clean_up/cust_ui_help_update.webp)
