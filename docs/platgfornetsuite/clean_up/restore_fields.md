...
4. Click **Select**
    ...
    ![importassistant-2](/img/product_docs/platgfornetsuite/clean_up/importassistant-2.webp)

5. Select your CSV archive file. and click **Open**
6. Click **Next**

    ![importoptions](/img/product_docs/platgfornetsuite/clean_up/importoptions.webp)
...
11. Under **Your Fields**, select the column from your CSV archive file that you want to restore and
    ...
    ![fieldmapping](/img/product_docs/platgfornetsuite/clean_up/fieldmapping.webp)

12. Click **Next**
13. Click **Run**

    ![savemapping](/img/product_docs/platgfornetsuite/clean_up/savemapping.webp)

    A finished screen appears with a confirmation message and a link to the **Import Job Status**.

14. Click **Import Job Status**.

    ![jobstatus](/img/product_docs/platgfornetsuite/clean_up/jobstatus.webp)

15. Click **Refresh** until the import process is completed.

    ![jobstatus-1](/img/product_docs/platgfornetsuite/clean_up/jobstatus-1.webp)
