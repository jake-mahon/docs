...
Review the [Automated Search Clean Up Considerations](/docs/platgfornetsuite/clean_up/automated_search_cleanup_considerations.md)
...
![autocleanup](/img/product_docs/platgfornetsuite/clean_up/autocleanup.webp)
...
![autocleanupscheduler](/img/product_docs/platgfornetsuite/clean_up/autocleanupscheduler.webp)
...
![cleanup_preview](/img/product_docs/platgfornetsuite/clean_up/cleanup_preview.webp)
...
![cleanup_tab](/img/product_docs/platgfornetsuite/clean_up/cleanup_tab.webp)
...
![cleanup_status](/img/product_docs/platgfornetsuite/clean_up/cleanup_status.webp)

Click **Notification Tracker** on the **Notifications** tab to launch the tracker.

![cleanup_notifications_tab](/img/product_docs/platgfornetsuite/clean_up/cleanup_notifications_tab.webp)
...
![cleanup_notification_tracker](/img/product_docs/platgfornetsuite/clean_up/cleanup_notification_tracker.webp)
...
![cleanup_warning](/img/product_docs/platgfornetsuite/clean_up/cleanup_warning.webp)
...
![Provide a reason to retain an individual search](/img/product_docs/platgfornetsuite/clean_up/clean_up_retain_search.webp)
...
![Retain All dialog to provide retention Reason](/img/product_docs/platgfornetsuite/clean_up/clean_up_retain_all.webp)
...
![cleanup_restore](/img/product_docs/platgfornetsuite/clean_up/cleanup_restore.webp)
...
![Search form](/img/product_docs/platgfornetsuite/clean_up/limitation_restoring_searches.webp)
