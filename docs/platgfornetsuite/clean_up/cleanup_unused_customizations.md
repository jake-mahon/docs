...
2. Enter filtering information to streamline your search. Searching on all unused customizations can
   take a long time to load and can time out.
    ...
    ![Enter criteria prior to searching for unused customizations](/img/product_docs/platgfornetsuite/clean_up/customizations_cleanup_unused_filters.webp)

3. Click **Search**.  
    The results are coded with a flag in the first column and the text either blue (Inactive owner)
   or black.  
   ![Cleanup Key](/img/product_docs/platgfornetsuite/clean_up/customizations_cleanup_key.webp)  
   ...
   displayed regardless of the flag color.
    ...
    ![customizations_cleanup_list](/img/product_docs/platgfornetsuite/clean_up/customizations_cleanup_list.webp)
...
4. Click **View** next to each Customization to investigate. You can right-click on **View** and
   select **Open in a new tab or window** to keep your results page available.
    ...
    ![View the Customization Record](/img/product_docs/platgfornetsuite/clean_up/customizations_cleanup_view_record.webp)
...
![cleanupimpactanalysis](/img/product_docs/platgfornetsuite/clean_up/cleanupimpactanalysis.webp)
...
![archive](/img/product_docs/platgfornetsuite/clean_up/archive.webp)
