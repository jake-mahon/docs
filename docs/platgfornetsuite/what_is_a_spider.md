...
process: [Running the Spider](/docs/platgfornetsuite/installing_strongpoint/running_the_spider.md).
...
[Setting Up the AutoSpider and Alerts](/docs/platgfornetsuite/installing_strongpoint/setting_up_auto_spider_alerts.md).
...
![ReSpiderNow](/img/product_docs/platgfornetsuite/respider_now.webp)
