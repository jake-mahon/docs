...
1. Open **Strongpoint** > **Financial Controls** > **Unresolved Control Incidents**
    ...
    ![Viewing Unresolved Control Incidents](/img/product_docs/platgfornetsuite/financial_controls/agent_unresolved_example1.webp)

2. Click View by the record with the **Purchase Limit** and **Purchase Approval Limit** changes to
   open the Change Log.

    ![Open the Change Log](/img/product_docs/platgfornetsuite/financial_controls/agent_unresolved_example2.webp)
