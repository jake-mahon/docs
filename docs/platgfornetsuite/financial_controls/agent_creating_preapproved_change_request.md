...
[Using Custom Change Request Forms](/docs/platgfornetsuite/change_management/use_custom_cr_forms.md) for information on
...
1. Open **Strongpoint** > **Financial Controls** > **New Agent Control Approval**
    ...
    ![agent_pre_app_not_started](/img/product_docs/platgfornetsuite/financial_controls/agent_pre_app_not_started.webp)
...
6. The Approval section is now available. Click **Edit** to add **Additional Approvers** or
   **Approver Notes**. Click **Save**.
    ...
    if you make
    changes.![agent_pre_app_approval_section](/img/product_docs/platgfornetsuite/financial_controls/agent_pre_app_approval_section.webp)
