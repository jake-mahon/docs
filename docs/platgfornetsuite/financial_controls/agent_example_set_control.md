...
5. Add filters on the **Criteria** tab:
    ...
    ![Create the Saved Search for the Example](/img/product_docs/platgfornetsuite/financial_controls/agent_example1.webp)
...
6. Open the **Results** tab. You can Remove all to clear the defaults. Add the following fields:
    ...
    ![Adding the Results columns](/img/product_docs/platgfornetsuite/financial_controls/agent_example2.webp)
...
2. Enter information in the required fields:
    ...
    - **Script ID**: Enter the **ID** from your Saved Search. For example, **customsearch5673**
        ...
        ![Create the Customization for the Example](/img/product_docs/platgfornetsuite/financial_controls/agent_example3.webp)
...
5. **Save** the record.
    ...
    ![Designating the customization as a control](/img/product_docs/platgfornetsuite/financial_controls/agent_example4.webp)
