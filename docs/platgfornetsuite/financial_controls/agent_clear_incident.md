...
3. Click **Edit** on the Incident record to clear/resolve.
    ...
    ![Clearing a Control Incident](/img/product_docs/platgfornetsuite/financial_controls/agent_clear_incident.webp)
...
![Clearing an incident with inline editing](/img/product_docs/platgfornetsuite/financial_controls/agent_clear_incident_inline.webp)
