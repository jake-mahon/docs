...
2. Open the **Schedule** tab and schedule the saved search to run.
    ...
    ![saved_search_timeout1](/img/product_docs/platgfornetsuite/troubleshooting/saved_search_timeout1.webp)
...
- **Check the boxes**: Send emails according to schedule and summarize scheduled emails.
    ...
    ![saved_search_timeout2](/img/product_docs/platgfornetsuite/troubleshooting/saved_search_timeout2.webp)

4. Click on **Customize Message** tab.
5. Select **Send as CSV**.

    ![saved_search_timeout3](/img/product_docs/platgfornetsuite/troubleshooting/saved_search_timeout3.webp)
...
3. Click **Persist (CSV)**.
    ...
    ![saved_search_timeout4](/img/product_docs/platgfornetsuite/troubleshooting/saved_search_timeout4.webp)
