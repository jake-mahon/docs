...
on your [License Type](/docs/platgfornetsuite/installing_strongpoint/features_by_license_type.md). In addition, menu items
can be hidden for each account through [Menu Management](/docs/platgfornetsuite/installing_strongpoint/managing_menus.md).
...
[Setting Tab Access](/docs/platgfornetsuite/installing_strongpoint/setting_strongpoint_tab_access.md).

## Strongpoint Tab Menu

The Strongpoint tab menu provides navigation to all the key tools:

![strongpoint_menu](/img/product_docs/platgfornetsuite/strongpoint_menu.webp)
...
![Strongpoint Overview Dashboard](/img/product_docs/platgfornetsuite/dashboard_overview.webp)
