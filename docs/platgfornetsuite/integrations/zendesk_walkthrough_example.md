...
[install and configure](/docs/platgfornetsuite/integrations/zendesk_integration.md) the Zendesk integration, prior to using this
walkthrough.
...
2. Open your **Views**.
    ...
    ![Open the Zendesk Views](/img/product_docs/platgfornetsuite/integrations/zendesk_views.webp)

3. Click **+ Add** > **Ticket**.

    ![Add a ticket](/img/product_docs/platgfornetsuite/integrations/zendesk_add_ticket.webp)
...
6. Click **Submit as New**.
    ...
    ![New ticket in the Ticket view](/img/product_docs/platgfornetsuite/integrations/zendesk_ticket_view.webp)
...
![Zendesk Apps visibility icon](/img/product_docs/platgfornetsuite/integrations/zendesk_apps_icon.webp)
and verify you are a member of a group or role
[authorized to access the app](/docs/platgfornetsuite/integrations/zendesk_integration.md).

![The Strongpoint app is available after you create the ticket.](/img/product_docs/platgfornetsuite/integrations/zendesk_strongpoint_app_ticket.webp)
...
3. Click + to add the bundle. 232111 in this example. You can remove a bundle using the drop down
   toggle.
    ...
    ![Specify an optional Bundle ID](/img/product_docs/platgfornetsuite/integrations/zendesk_bundleid.webp)
...
![Request Approval button appears when a change has been made.](/img/product_docs/platgfornetsuite/integrations/zendesk_request_approval.webp)
...
1. Click **Look up Customization**.
    ...
    ![Add customizations to the Change Request](/img/product_docs/platgfornetsuite/integrations/zendesk_lookup_customization.webp)
...
4. Select one or more customizations to attach to the change request.
    ...
    ![Select one or more customizations.](/img/product_docs/platgfornetsuite/integrations/zendesk_select_customizations.webp)
...
[Entity Relationship Diagram](/docs/platgfornetsuite/customizations/using_erd.md) for the customization.
...
6. The **Set Customer Credit on Hold (Entity Field)** is displayed. Select it, and click **Add
   ...
   field.
    ...
    ![Add a Customization by Script ID](/img/product_docs/platgfornetsuite/integrations/jira_example_scriptid.webp)
