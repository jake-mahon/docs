...
![Jira Integration Process Flow](/img/product_docs/platgfornetsuite/integrations/strongpointjiraflow.webp)
...
6. Check **Automatic Synchronization** to enable Platform Governance for NetSuite to handle the
   ...
   Change Requests.
    ...
    ![Jira Integration settings with mapped statues](/img/product_docs/platgfornetsuite/release_notes/jira_example_integration.webp)
...
13. Open the **Parameters** tab and enter the domain you use to access Jira.
    ...
    ![Enter your domain on the Parameters tab](/img/product_docs/platgfornetsuite/integrations/jira_parameters.webp)
...
1. From Jira, open **Settings** > **Apps**.
    ...
    ![Open Jira Apps settings](/img/product_docs/platgfornetsuite/integrations/jira_settings_cloud.webp)

2. Search for _Strongpoint for NetSuite_.

    ![Jira Search.](/img/product_docs/platgfornetsuite/integrations/jira_search.webp)
...
**Next Step:** [ Jira Walkthrough Example](/docs/platgfornetsuite/integrations/jira_walkthrough_example.md)
