...
The [ServiceNow integration](/docs/platgfornetsuite/integrations/servicenow_install_configure_netsuite.md) must be installed and
...
4. Click **Change** > **Create New** in the menu to begin a new ticket.
    ...
    ![servicenow_create_new](/img/product_docs/platgfornetsuite/integrations/servicenow_create_new.webp)

5. Open the **Strongpoint NetSuite** tab.
6. Click **Select Account** from the menu bar.

    ![servicenow_menu_bar](/img/product_docs/platgfornetsuite/integrations/servicenow_menu_bar.webp)
...
7. Enter your NetSuite credentials. You must set up Token-based authentication.  
   Check if you are using a **Sandbox Account**. Click **Connect**.
    ...
    ![servicenow_sp_login](/img/product_docs/platgfornetsuite/integrations/servicenow_sp_login.webp)

8. Click **Select Customizations**.

    ![servicenow_select_customizations](/img/product_docs/platgfornetsuite/integrations/servicenow_select_customizations.webp)
...
9. Enter one or more filters and click **Lookup Customization** to bring up a matching list. For
   example, entering **test** brings up the list of customizations containing _test_.
    ...
    ![servicenow_select_customizations_add](/img/product_docs/platgfornetsuite/integrations/servicenow_select_customizations_add.webp)
...
11. Click **Add Proposed Customization** to add a new customization:
    ...
    ![Add a Proposed Customization](/img/product_docs/platgfornetsuite/integrations/servicenow_add_proposed_customization.webp)
...
12. Click **Impact Analysis** in the menu bar. The impact analysis runs and displays any warnings.
    ...
    ![servicenow_impact_analysis](/img/product_docs/platgfornetsuite/integrations/servicenow_impact_analysis.webp)

    Click on the links to open the record in NetSuite for further research.

    ![servicenow_impact_analysis_ns](/img/product_docs/platgfornetsuite/integrations/servicenow_impact_analysis_ns.webp)
...
13. Click **ERD** in the menu bar. The list is populated with the customizations added to the
    ...
    ![servicenow_erd](/img/product_docs/platgfornetsuite/integrations/servicenow_erd.webp)
