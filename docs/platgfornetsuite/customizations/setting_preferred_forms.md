...
2. Select a form from the list. For this example, select **Change Request**.
    ...
    ![Setting the preferred form.](/img/product_docs/platgfornetsuite/customizations/preferred_form1.webp)

3. Open the **Forms** tab.

    ![Setting the preferred form.](/img/product_docs/platgfornetsuite/customizations/preferred_form2.webp)
