...
![customization-list](/img/product_docs/platgfornetsuite/customizations/customization-list.webp)
...
![custquicksearch](/img/product_docs/platgfornetsuite/customizations/custquicksearch.webp)
...
4. Click **Show Record ERD**.
    ...
    ![erd-view](/img/product_docs/platgfornetsuite/customizations/erd-view.webp)
...
5. Click on any item to expand the view. For large lists, click **More** to see the additional
   ...
   External sources headers are highlighted in green.
    ...
    ![ERD with an External Source](/img/product_docs/platgfornetsuite/customizations/celigo_erd.webp)
...
Process Issue or a Change Request. Refer to [Enabling the ERD Search](/docs/platgfornetsuite/customizations/using_erd.md).
...
![erdsearchform-2](/img/product_docs/platgfornetsuite/customizations/erdsearchform-2.webp)

Once you have finished your search, you can create a Process Issue or a Change Request from the
results.

![erdsearchform-3](/img/product_docs/platgfornetsuite/customizations/erdsearchform-3.webp)
...
![impactsearchform](/img/product_docs/platgfornetsuite/customizations/impactsearchform.webp)
