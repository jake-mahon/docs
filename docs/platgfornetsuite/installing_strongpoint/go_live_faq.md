...
[Creating a Change Request](/docs/platgfornetsuite/change_management/creating_change_request.md) for details.
...
3. Select **Approved** from the **Approval Status** list.
    ...
    ![Change Status to Approved](/img/product_docs/platgfornetsuite/installing_strongpoint/golive_approval_override.webp)
...
Refer to [Setting Up the AutoSpider and Alerts](/docs/platgfornetsuite/installing_strongpoint/running_the_spider.md) for details.
...
If your site uses [Opportunistic Clearance](/docs/platgfornetsuite/change_management/opportunistic_clearance.md), the
...
[License Manager](/docs/platgfornetsuite/installing_strongpoint/license_manager.md) topic.
