...
Remember to give your [licensed](/docs/platgfornetsuite/installing_strongpoint/license_manager.md) users access to the
[Strongpoint tab](/docs/platgfornetsuite/installing_strongpoint/setting_strongpoint_tab_access.md).
...
3. Open the **Permissions** tab.
    ...
    ![Setting Permissions for Custom Roles](/img/product_docs/platgfornetsuite/installing_strongpoint/permissions_tab.webp)
...
> Assign a [User License](/docs/platgfornetsuite/installing_strongpoint/license_manager.md)
...
> [Strongpoint License](/docs/platgfornetsuite/installing_strongpoint/license_manager.md) +  
> Account Role: **Edit**  
