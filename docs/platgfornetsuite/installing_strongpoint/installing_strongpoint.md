...
4. Click **Search**
    ...
    ![Search for the Strongpoint Bundle](/img/product_docs/platgfornetsuite/installing_strongpoint/searchandinstallbundles.webp)
...
7. Verify the installation is complete. Open **Customization** > **SuiteBundler** > **Search &
   ...
   **Status** column when the bundle is installed.
    ...
    ![Verify Strongpoint Bundle Installation](/img/product_docs/platgfornetsuite/installing_strongpoint/verify_bundle_install.webp)
...
field, refer to
[Cannot Change the Number of Rows in List Segments](/docs/platgfornetsuite/troubleshooting/list_segments_not_editable)
