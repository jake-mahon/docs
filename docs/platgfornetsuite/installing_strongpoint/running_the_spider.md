...
roles. Refer to [Setting Access and Permissions](/docs/platgfornetsuite/installing_strongpoint/setting_strongpoint_tab_access.md) for more
information.
...
![Review the Spider Status tab of the Installation Settings](/img/product_docs/platgfornetsuite/installing_strongpoint/install_settings_spider_status.webp)
...
**Next Step:** [ Setting Up the AutoSpider and Alerts](/docs/platgfornetsuite/installing_strongpoint/setting_up_auto_spider_alerts.md)
