...
4. Click **Save a Copy**  
   ...
   This example shows **Engineering** as the new **Center**
    ...
    ![Saving to Engineering Center.](/img/product_docs/platgfornetsuite/installing_strongpoint/engineeringexample.webp)
...
5. Create the Category links:
    ...
    1. Open **Customization** > **Centers and Tabs** > **Center Categories** in a new window.  
       ...
       and your selected **Center Type** (**Engineering** in the example).
        ...
        ![Select Category for New Center.](/img/product_docs/platgfornetsuite/installing_strongpoint/copy_categories.webp)
    ...
    3. Add each **Link** and **Label** in your new **Center**, using the **Classic Center** version
       ...
       addition.
        ...
        ![Two category windows open to copy links to your new Center.](/img/product_docs/platgfornetsuite/installing_strongpoint/copy_categories2.webp)
...
5. Click **Save**
    ...
    ![Assigning permissions.](/img/product_docs/platgfornetsuite/installing_strongpoint/engineeringexample2.webp)

**Next Step:** [ Setting Role Permissions](/docs/platgfornetsuite/installing_strongpoint/setting_permissions.md)
