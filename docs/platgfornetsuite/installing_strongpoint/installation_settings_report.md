...
- **Enable Case to Change Request Workflow**: enables the workflow
  [Create Change Request from Case](/docs/platgfornetsuite/change_management/creating_change_request_from_case.md),
  ...
  **Cases**).  
  ...
  ![Example of a Formula in the Case to Change Request Field Mapping](/img/product_docs/platgfornetsuite/installing_strongpoint/casetocrformula.webp)
- **Do Not ReSpider Automatically**: sets the default condition for the **Do Not ReSpider
  Automatically** setting on the
  [ITGC Change Request](/docs/platgfornetsuite/change_management/creating_change_request.md). The default is
  unchecked.  
...
- **Enhanced User Provisioning**: enables access management for onboarding/offboarding and access
  change using the **[User Access Change Request](/docs/platgfornetsuite/change_management/user_provisioning.md)**.
...
- **CR Email Template**: if you customize your **SoD Exemption Approval** or **SoD Rule Change
  ...
  installed. Refer to [Advanced PDF / HTML Templates](/docs/platgfornetsuite/customizations/pdf_html_templates.md).  
  ![CR Email Template section on the Installation Settings Change Management tab](/img/product_docs/platgfornetsuite/installing_strongpoint/change_management_cr_email_template.webp)
...
Refer to [Jira Integration](/docs/platgfornetsuite/integrations/jira_integration.md) for more information.

### ServiceNow Integration

Specifies the ServiceNow credentials to use when ServiceNow and Platform Governance for NetSuite are
integrated. Refer to [ServiceNow Integration](/docs/platgfornetsuite/integrations/servicenow_integration.md) for more
information.

### Menu Management

Enables hiding menu items you do not use, to improve navigation. Refer to
[Managing Menus](/docs/platgfornetsuite/installing_strongpoint/managing_menus.md) for more information.
