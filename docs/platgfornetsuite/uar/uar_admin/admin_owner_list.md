...
from reviews. All changes are captured in the [UAR History](/docs/platgfornetsuite/uar/uar_history.md).

Auditors can view the Owner list and Owner notes, but cannot add or remove owners.

Here is an example of the **Owner List**:

![Administrator Owner list](/img/product_docs/platgfornetsuite/uar/uar_admin/owner_list.webp)
...
2. Click **Add Owner** to add a new role.
    ...
    ![Add Owner](/img/product_docs/platgfornetsuite/uar/uar_admin/add_owner.webp)
...
![Owner notes](/img/product_docs/platgfornetsuite/uar/uar_admin/owner_notes.webp)
