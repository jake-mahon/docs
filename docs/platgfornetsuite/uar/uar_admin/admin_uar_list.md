...
[UAR History](/docs/platgfornetsuite/uar/uar_history.md).

Here is an example of the **Global** review list:

![Administrator UAR list](/img/product_docs/platgfornetsuite/uar/uar_admin/admin_uar.webp)
...
2. Click **Create Review**.
    ...
    ![Create a review](/img/product_docs/platgfornetsuite/uar/uar_admin/create_review1.webp)
...
3. Select **Single Review** to add to an existing review, or **Global Review** to start a new
   review. This example shows the Add to an Existing Review option.
    ...
    ![Create a review](/img/product_docs/platgfornetsuite/uar/uar_admin/create_review2.webp)
...
Owners are assigned on the administrator's [Owner's List](/docs/platgfornetsuite/uar/uar_admin/admin_owner_list.md), available on your
menu.
...
3. Click **Cancel Review**. Any open change requests are canceled.
    ...
    ![Cancel a review](/img/product_docs/platgfornetsuite/uar/uar_admin/cancel_review.webp)
...
![Review List](/img/product_docs/platgfornetsuite/uar/uar_admin/admin_review_list.webp)
...
- **Review Name** is a link to the [Membership](/docs/platgfornetsuite/uar/uar_owner/owner_membership_reviews.md) or
  [Permission ](/docs/platgfornetsuite/uar/uar_owner/owner_permission_reviews.md)**Review** tab. Reviews can also be opened
