...
![Pending role assignments](/img/product_docs/platgfornetsuite/uar/uar_admin/pending_role_assignments.webp)
...
2. Select a Related Review link.
    ...
    ![Related review link](/img/product_docs/platgfornetsuite/uar/uar_admin/related_review_link.webp)

3. Select a single review, or select the box in the table header to select all of the reviews.

    ![Assign due dates for reviews](/img/product_docs/platgfornetsuite/uar/uar_admin/assign_due_date.webp)
