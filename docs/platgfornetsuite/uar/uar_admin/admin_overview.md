...
[User Access Review](/docs/platgfornetsuite/uar/access_app.md) to access the dashboard. UAR administrators can:
...
![Admin Dashboard](/img/product_docs/platgfornetsuite/uar/dashboard_admin.webp)
