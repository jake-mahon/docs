...
[User Access Review](/docs/platgfornetsuite/uar/access_app.md) to access the dashboard.
...
![Auditor Dashboard](/img/product_docs/platgfornetsuite/uar/uar_auditor/dashboard_auditor.webp)
...
- **Owner List** displays all reviews with an assigned owner. Option to view reviews with no
  ...
  Administrator's [Owner List](/docs/platgfornetsuite/uar/uar_admin/admin_owner_list.md).
- **Global Access Reviews History** is the **[User Access Reviews History](/docs/platgfornetsuite/uar/uar_history.md)**.
