...
in the email, or login to NetSuite and open [User Access Review](/docs/platgfornetsuite/uar/access_app.md) to access the
dashboard.
...
![Additional Reviewer Dashboard](/img/product_docs/platgfornetsuite/uar/uar_additional_reviewer/dashboard_add_reviewer.webp)

## Dashboard Controls

- **Home** icon is your dashboard overview, and the default display when you log in.
- **UAR List** is your **[User Access Reviews List](/docs/platgfornetsuite/uar/uar_additional_reviewer/add_reviewer_uar_list.md)**.
