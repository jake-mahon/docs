...
![Permission Review](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review.webp)
...
2. Review the **Permission** and the **Level** are appropriate for the role. If correct, click
   **Mark Completed**. The status is updated. You cannot undo this action.  
   ![Mark the Permission review complete](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review_complete.webp)
...
4. Enter a brief description of why the change is requested when prompted for the **Reason for
   Change**. Click **Accept** when complete.
    ...
    ![Reason for change](/img/product_docs/platgfornetsuite/uar/uar_owner/change_request_reason.webp)
    ...
    ![Change requests for Level changes](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review_cr.webp)
...
1. Click + **Add**.  
   ![Add a permission](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review_add.webp)
...
4. Enter a brief description of why the change is requested when prompted for the **Reason for
   Change**. Click **Accept** when complete.
    ...
    ![Adding a new permission](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review_add2.webp)
...
![Permission review complete when all rows are complete](/img/product_docs/platgfornetsuite/uar/uar_owner/permission_review_complete.webp)

When you click **Complete Review**, the review status is updated to **Complete**, and the review is
added to the [UAR History](/docs/platgfornetsuite/uar/uar_history.md).
...
![Open the Review Notes tab](/img/product_docs/platgfornetsuite/uar/uar_owner/review_notes_tab.webp)
