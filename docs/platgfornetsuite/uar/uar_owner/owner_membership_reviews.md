...
![Membership review](/img/product_docs/platgfornetsuite/uar/uar_owner/membership_review.webp)
...
2. Review their Global Permissions, Other Roles, and SoD Violations. The links all open the specific
   ...
   ![Mark user as reviewed](/img/product_docs/platgfornetsuite/uar/uar_owner/mark_complete.webp)
...
2. Select an additional reviewer from the drop down list.  
   ![Assign an additional reviewer](/img/product_docs/platgfornetsuite/uar/uar_owner/additional_user_assign.webp)  
...
3. Click **Submit** or make additional changes.  
   ![Assigning an additional user](/img/product_docs/platgfornetsuite/uar/uar_owner/additional_user_assign2.webp)  
