...
4. Click **Search**.
    ...
    ![Search for the UAR bundle](/img/product_docs/platgfornetsuite/uar/bundle_uar.webp)

5. Click **Strongpoint UAR**.

    ![Select the bundle](/img/product_docs/platgfornetsuite/uar/bundle_uar2.webp)
...
3. Set the **View** to **Strongpoint Licensed Users**.
    ...
    ![Set View to Strongpoint Licensed Users](/img/product_docs/platgfornetsuite/uar/licensing_uar.webp)

4. Click **New Licensed User**.

    ![UAR Licensed User](/img/product_docs/platgfornetsuite/uar/app_access.webp)
...
4. Click **Edit** beside the User name.
    ...
    ![UAR Licensed User](/img/product_docs/platgfornetsuite/uar/licensing_uar2.webp)
...
1. Open **Setup** > **Users/Roles** > **Manage Roles** to review your roles. The **Center Type** is
   ...
   see the **Center Type** is **Accounting Center**.
    ...
    ![Find the Center Type for each Role](/img/product_docs/platgfornetsuite/uar/role_review.webp)
...
4. Select the **Center**. This example shows the **Accounting Center**.
    ...
    ![Assign the Center](/img/product_docs/platgfornetsuite/uar/center_tab.webp)

5. Open the **Audience** tab.
6. Select the **Role**. This example show the **Controller - Basic** role.

    ![Add the role](/img/product_docs/platgfornetsuite/uar/center_tab_audience.webp)
