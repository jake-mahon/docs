...
The User Access Review bundle must be [installed](/docs/platgfornetsuite/uar/install_app.md), and users must have NetSuite
...
[license](/docs/platgfornetsuite/uar/install_app.md). If it is not on your menu, contact your Netwrix or NetSuite
administrator.

![User Access Review menu](/img/product_docs/platgfornetsuite/uar/uar_menu.webp)

1. Select **User Access Review** > **User Access Review** > **Open** from the NetSuite menu bar.
2. Click your **Role** to log in to the UAR app.

    ![Select your role](/img/product_docs/platgfornetsuite/uar/uar_role.webp)

Here is an example of the UAR Admin dashboard:

![UAR Admin Dashboard](/img/product_docs/platgfornetsuite/uar/dashboard_admin.webp)
