...
1. Open **Strongpoint** > **Tools** > **Standard Field Impact Analysis  
   ![tools_menu](/img/product_docs/platgfornetsuite/tools/tools_menu.webp)**
2. On the **Impact Analysis Fields** screen, fill out the following:  
   ![impactanalysisfieldstool-2](/img/product_docs/platgfornetsuite/tools/impactanalysisfieldstool-2.webp)
...
4. Customizations using standard fields are listed in the results.  
   ![impactanalysisresults](/img/product_docs/platgfornetsuite/tools/impactanalysisresults.webp)
