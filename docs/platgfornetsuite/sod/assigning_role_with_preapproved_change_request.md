...
1. Open **SoD** > **SoD Change Management** > **New SoD Approval**
    ...
    ![sod_new_change_request](/img/product_docs/platgfornetsuite/sod/sod_new_change_request.webp)
...
7. Click **Pending Approval** on the status bar.
    ...
    ![sod_new_change_request_pending](/img/product_docs/platgfornetsuite/sod/sod_new_change_request_pending.webp)
