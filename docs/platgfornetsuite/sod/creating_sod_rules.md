...
1. Open **SoD** > **SoD Rule** > **SoD Rule Library** > **New**
    ...
    ![sod_rule_new](/img/product_docs/platgfornetsuite/sod/sod_rule_new.webp)
...
9. Select the **Access Control Type**:
    ...
    ![SoD Access Controls](/img/product_docs/platgfornetsuite/sod/sod_access_controls.webp)
...
10. Add Restrictions to limit the SoD rule to employees associated in one or more of the categories:
    **Subsidiaries**, **Departments**, **Classes**, and **Locations**.
    ...
    ![SoD Classifications](/img/product_docs/platgfornetsuite/sod/sod_classifications.webp)
...
![SoD Processing Status](/img/product_docs/platgfornetsuite/sod/sod_proc_status_tab.webp)
...
![Updates to SoD Rules report](/img/product_docs/platgfornetsuite/sod/sod_rules_update_report.webp)
