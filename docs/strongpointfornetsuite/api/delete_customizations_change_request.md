...
Request body names are case sensitive and mandatory. For the __actionType__ parameter, it is always a constant value, in this case __deleteCustomization__.
