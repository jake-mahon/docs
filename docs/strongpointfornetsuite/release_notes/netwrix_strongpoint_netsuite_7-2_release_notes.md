...
Strongpoint is excited to release an [Integration API](/docs/strongpointfornetsuite/api/api_overview.md) to enable your
...
- API commands are documented in the [Integration API](/docs/strongpointfornetsuite/api/api_overview.md) section of this
  guide.
