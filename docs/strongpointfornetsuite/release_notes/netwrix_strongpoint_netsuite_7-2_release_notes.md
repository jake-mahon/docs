...
Strongpoint is excited to release an [Integration API](../api/api_overview.md) to enable your
...
- API commands are documented in the [Integration API](../api/api_overview.md) section of this
  guide.
