...
Atlassian is discontinuing support for the Jira On-Prem solution. Jira Cloud will be the only supported option. You can use the Strongpoint [Integration API](/docs/product_docs/strongpointfornetsuite/api/api_overview.md) to create your own integration with your ticketing system.
...
- Added __Supervisor__ column to the Membership Review.
  ...
  ![UAR Membership Review](/static/img/product_docs/strongpointfornetsuite/release_notes/uar_review_supervisor.png)
