...
- Added __GL Impact__ and __Permission Risk Severity__ columns to the Permission Review.
  ...
  ![UAR GL Impact](/static/img/product_docs/strongpointfornetsuite/release_notes/uar_gl_impact.png)
