...
The __Strongpoint__ tab is only available to Administrators unless you specifically add it to other roles. Refer to [Setting Access and Permissions](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/setting_strongpoint_tab_access.md) for more information.
...
![Review the Spider Status tab of the Installation Settings](/static/img/product_docs/strongpointfornetsuite/installing_strongpoint/install_settings_spider_status.png)
...
__Next Step:__ [ Setting Up the AutoSpider and Alerts](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/setting_up_auto_spider_alerts.md)
