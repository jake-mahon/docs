...
4. [Run the spider](running_the_spider). The spider scans your account in a standardized manner. A series of scheduled scripts is run to document the connections between the customizations.
...
__Next Step:__ [Running the Spider](running_the_spider)
