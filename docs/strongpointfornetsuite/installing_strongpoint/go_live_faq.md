...
Customizations can be added to any open Change Request. On the Change Request, click __Lookup Customization__ to launch a window where you can search for customizations, or enter existing customizations in the __Customizations__ field. The __Proposed Customizations__ are for new customizations that do not exist in any account. Refer to [Creating a Change Request](/docs/product_docs/strongpointfornetsuite/change_management/creating_change_request.md) for details.
...
![custquicksearch](/static/img/product_docs/strongpointfornetsuite/customizations/custquicksearch.png)
...
3. Select __Approved__ from the __Approval Status__ list.
   ...
   ![Change Status to Approved](/static/img/product_docs/strongpointfornetsuite/installing_strongpoint/golive_approval_override.png)
...
Refer to [Setting Up the AutoSpider and Alerts](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/running_the_spider.md) for details.
...
If your site uses [Opportunistic Clearance](/docs/product_docs/strongpointfornetsuite/change_management/opportunistic_clearance.md), the deployment record is handled automatically. You should make sure you understand all of the ramifications of Opportunistic Clearance prior to enabling it for your account.
...
If a user sees a License message, you need to grant them a license. Refer to the [License Manager](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/license_manager.md) topic.
