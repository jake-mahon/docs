...
4. Click __Save a Copy__  
   ...
   ![Saving to Engineering Center.](/img/product_docs/strongpointfornetsuite/installing_strongpoint/engineeringexample.png)
5. Create the Category links:
   ...
   1. Open __Customization__ > __Centers and Tabs__ > __Center Categories__ in a new window.  
      ...
      ![Select Category for New Center.](/img/product_docs/strongpointfornetsuite/installing_strongpoint/copy_categories.png)
   ...
   3. Add each __Link__ and __Label__ in your new __Center__, using the __Classic Center__ version as a guide. A drop down completion list is shown as you type. Click __Add__ after each addition.
      ...
      ![Two category windows open to copy links to your new Center.](/img/product_docs/strongpointfornetsuite/installing_strongpoint/copy_categories2.png)
...
5. Click __Save__
   ...
   ![Assigning permissions.](/img/product_docs/strongpointfornetsuite/installing_strongpoint/engineeringexample2.png)
