...
Remember to give your [licensed](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/license_manager.md) users access to the [Strongpoint tab](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/setting_strongpoint_tab_access.md).
...
3. Open the __Permissions__ tab.
   ...
   ![Setting Permissions for Custom Roles](/static/img/product_docs/strongpointfornetsuite/installing_strongpoint/permissions_tab.png)
...
> Assign a [User License](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/license_manager.md)
...
> [Strongpoint License](/docs/product_docs/strongpointfornetsuite/installing_strongpoint/license_manager.md) +  
