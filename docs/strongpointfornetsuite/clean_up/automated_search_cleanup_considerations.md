...
This list describes some of the special cases encountered when using the [Automated Search Clean Up](/docs/product_docs/strongpointfornetsuite/clean_up/automated_search_cleanup.md) tool
