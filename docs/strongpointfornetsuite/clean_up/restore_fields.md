...
4. Click __Select__
   ...
   ![importassistant-2](/static/img/product_docs/strongpointfornetsuite/clean_up/importassistant-2.png)
5. Select your CSV archive file. and click __Open__
6. Click __Next__

   ![importoptions](/static/img/product_docs/strongpointfornetsuite/clean_up/importoptions.png)
...
11. Under __Your Fields__, select the column from your CSV archive file that you want to restore and select the relevant NetSuite Field where you want them restored.
    ...
    ![fieldmapping](/static/img/product_docs/strongpointfornetsuite/clean_up/fieldmapping.png)
12. Click __Next__
13. Click __Run__

    ![savemapping](/static/img/product_docs/strongpointfornetsuite/clean_up/savemapping.png)
...
14. Click __Import Job Status__.
    ...
    ![jobstatus](/static/img/product_docs/strongpointfornetsuite/clean_up/jobstatus.png)
15. Click __Refresh__ until the import process is completed.

    ![jobstatus-1](/static/img/product_docs/strongpointfornetsuite/clean_up/jobstatus-1.png)
