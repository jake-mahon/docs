...
3. Change Request owner [Completes and Validates the Change Request](/docs/strongpointfornetsuite/change_management/completing_validating_change_request.md).
