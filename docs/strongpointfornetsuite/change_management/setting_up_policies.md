...
- __User Offboarding__: Available when [Enhanced User Provisioning](user_provisioning.md) is enabled.
- __User Onboarding__: Available when [Enhanced User Provisioning](user_provisioning.md) is enabled.
