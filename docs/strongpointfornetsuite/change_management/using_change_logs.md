...
Change Logs allow you to see the type of change, who made the change and view the system notes of the NetSuite record. Change Logs are accessed from the [Change Management Reports](change_management_reports.md).
