...
2. Administrator only attaches the workflow to the Change Request, forgetting to attach the search condition.
   ...
   ![opp_clearance_case4-1](/static/img/product_docs/strongpointfornetsuite/change_management/opp_clearance_case4-1.png).
...
1. The Search change is attached to the related workflow's approved Change Request.
   ...
   ![opp_clearance_case4-2](/static/img/product_docs/strongpointfornetsuite/change_management/opp_clearance_case4-2.png)
