...
The [Setting Up Policies](/docs/product_docs/strongpointfornetsuite/change_management/setting_up_policies.md) topic has details on setting up the Change / Approval Policies.
...
You can create a custom change request form for a Policy Approval. Refer to [Using Custom Change Request Forms](/docs/product_docs/strongpointfornetsuite/change_management/use_custom_cr_forms.md) for information on implementing your custom form.

## Non-Material Changes

Non-material changes are changes detected in objects that are not performed by a human and do not have functional impact. You can review these changes on the [Non-Material Changes report](/docs/product_docs/strongpointfornetsuite/change_management/change_management_reports.md#Non-Material-Changes-report).
