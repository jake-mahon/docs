...
You can create a custom change request form for SoD Rule Changes. Refer to [Using Custom Change Request Forms](../change_management/use_custom_cr_forms.md) for information on implementing your custom form.
