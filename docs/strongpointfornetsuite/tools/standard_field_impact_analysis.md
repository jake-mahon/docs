...
You can manually run an impact analysis from the Tools menu. Impact analysis runs automatically from a Change Request. Results can be viewed on the __Impact Analysis__ tab on the Change Request.

To manually run the standard field impact analysis tool:

1. Open __Strongpoint__ > __Tools__ > __Standard Field Impact Analysis  
   ![tools_menu](../../../static/img/product_docs/strongpointfornetsuite/tools/tools_menu.webp)__
2. On the __Impact Analysis Fields__ screen, fill out the following:  
   ![impactanalysisfieldstool-2](../../../static/img/product_docs/strongpointfornetsuite/tools/impactanalysisfieldstool-2.webp)
...
4. Customizations using standard fields are listed in the results.  
   ![impactanalysisresults](../../../static/img/product_docs/strongpointfornetsuite/tools/impactanalysisresults.webp)
