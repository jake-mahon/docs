...
5. Add filters on the __Criteria__ tab:
   ...
   ![Create the Saved Search for the Example](/static/img/product_docs/strongpointfornetsuite/financial_controls/agent_example1.png)
...
6. Open the __Results__ tab. You can Remove all to clear the defaults. Add the following fields:
   ...
   ![Adding the Results columns](/static/img/product_docs/strongpointfornetsuite/financial_controls/agent_example2.png)
...
2. Enter information in the required fields:
   ...
   - __Script ID__: Enter the __ID__ from your Saved Search. For example, __customsearch5673__
     ...
     ![Create the Customization for the Example](/static/img/product_docs/strongpointfornetsuite/financial_controls/agent_example3.png)
...
5. __Save__ the record.
   ...
   ![Designating the customization as a control](/static/img/product_docs/strongpointfornetsuite/financial_controls/agent_example4.png)
