...
This view makes it easy to identify roles without owners, and facilitates adding owners. Access your __Pending Role Assignments__ from your menu bar. All changes are captured in the [UAR History](/docs/product_docs/strongpointfornetsuite/uar/uar_history.md).

Here is an example of the __Pending Role Assignments__:

![Pending role assignments](/static/img/product_docs/strongpointfornetsuite/uar/uar_admin/pending_role_assignments.png)
...
2. Select a Related Review link.
   ...
   ![Related review link](/static/img/product_docs/strongpointfornetsuite/uar/uar_admin/related_review_link.png)
3. Select a single review, or select the box in the table header to select all of the reviews.

   ![Assign due dates for reviews](/static/img/product_docs/strongpointfornetsuite/uar/uar_admin/assign_due_date.png)
