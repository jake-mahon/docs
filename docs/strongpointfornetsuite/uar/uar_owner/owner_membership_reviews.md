...
![Membership review](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/membership_review.png)
...
2. Review their Global Permissions, Other Roles, and SoD Violations. The links all open the specific records for further review. If the user should retain the role, click __Mark Completed__. The status is updated. You cannot undo this action.  
   ![Mark user as reviewed](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/mark_complete.png)
...
4. Enter a brief description of why the change is requested when prompted for the __Reason for Change__. Click __Accept__ when complete.
   ...
   ![Remove a user from a role](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/remove_user_from_role.png)
...
2. Select an additional reviewer from the drop down list.   
   ![Assign an additional reviewer](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/additional_user_assign.png)  
...
3. Click __Submit__ or make additional changes.   
   ![Assigning an additional user](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/additional_user_assign2.png)  
