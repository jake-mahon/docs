...
- __Name__ is a link. For a __global__ review, the link opens the Review list showing all of the associated reviews. For a __single__ review the [Membership](owner_membership_reviews.md) or [Permission ](owner_permission_reviews.md)__Review__ tab is opened. Reviews can also be opened via links in dashboard or email __Notifications__.
...
- __Status__ Current status of the review:
  ...
  - __Additional Reviewer__ Review has been assigned to an [](#)[additional reviewer](owner_membership_reviews.md).
...
- __Review Name__ is a link to the [Membership](owner_membership_reviews.md) or [Permission ](owner_permission_reviews.md)__Review__ tab. Reviews can also be opened via links in dashboard or email __Notifications__.
...
Continue with the procedures to complete your [Membership](owner_membership_reviews.md) or [Permission ](owner_permission_reviews.md)reviews.
