...
![Permission Review](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review.png)
...
2. Review the __Permission__ and the __Level__ are appropriate for the role. If correct, click __Mark Completed__. The status is updated. You cannot undo this action.  
   ![Mark the Permission review complete](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review_complete.png)
...
4. Enter a brief description of why the change is requested when prompted for the __Reason for Change__. Click __Accept__ when complete.
   ...
   ![Reason for change](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/change_request_reason.png)
   ...
   ![Change requests for Level changes](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review_cr.png)
...
1. Click + __Add__.  
   ![Add a permission](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review_add.png)
...
4. Enter a brief description of why the change is requested when prompted for the __Reason for Change__. Click __Accept__ when complete.
   ...
   ![Adding a new permission](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review_add2.png)
...
![Permission review complete when all rows are complete](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/permission_review_complete.png)

When you click __Complete Review__, the review status is updated to __Complete__, and the review is added to the [UAR History](/docs/product_docs/strongpointfornetsuite/uar/uar_history.md).
...
![Open the Review Notes tab](/static/img/product_docs/strongpointfornetsuite/uar/uar_owner/review_notes_tab.png)
