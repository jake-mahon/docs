...
The User Access Review bundle must be [installed](install_app.md), and users must have NetSuite
...
[license](install_app.md). If it is not on your menu, contact your Netwrix or NetSuite
administrator.
