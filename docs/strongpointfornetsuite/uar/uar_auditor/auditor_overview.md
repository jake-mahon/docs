...
[User Access Review](../access_app.md) to access the dashboard.
...
- **Owner List** displays all reviews with an assigned owner. Option to view reviews with no
  ...
  Administrator's [Owner List](../uar_admin/admin_owner_list.md).
- **Global Access Reviews History** is the **[User Access Reviews History](../uar_history.md)**.
