...
[User Access Review](/docs/strongpointfornetsuite/uar/access_app.md) to access the dashboard.
...
- **Owner List** displays all reviews with an assigned owner. Option to view reviews with no
  ...
  Administrator's [Owner List](/docs/strongpointfornetsuite/uar/uar_admin/admin_owner_list.md).
- **Global Access Reviews History** is the **[User Access Reviews History](/docs/strongpointfornetsuite/uar/uar_history.md)**.
