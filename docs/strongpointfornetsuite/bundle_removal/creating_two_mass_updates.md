...
3. Check __Use Expressions__ on the __Criteria__ tab.
   ...
   ![Select Use Expressions](/static/img/product_docs/strongpointfornetsuite/bundle_removal/bundle_removal_use_expressions.png)
...
![Mass Update Filters](/static/img/product_docs/strongpointfornetsuite/bundle_removal/mass_update_filters.png)
...
3. Enter the __Clean Up Status__: __To Be Cleaned Up__.
   ...
   ![Set Clean Up Status](/static/img/product_docs/strongpointfornetsuite/bundle_removal/clean_up_status.png)
4. Click __Save__.
...
![Adding filters](/static/img/product_docs/strongpointfornetsuite/bundle_removal/mass_update_filters2.png)
...
__Next Step:__ [Creating a Custom List and Fields](/docs/product_docs/strongpointfornetsuite/bundle_removal/creating_custom_list_and_fields.md)
