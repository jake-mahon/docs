...
The Mapping Tool menu item is hidden by default. If you do not see the option in your menu, refer to the [Managing Menus](../installing_strongpoint/managing_menus.md) topic for information on making it available.

Open __Strongpoint__ > __Integrations__ > __Mapping Tool__

__![int_mapping_menu](../../../static/img/product_docs/strongpointfornetsuite/integrations/int_mapping_menu.webp)__
