...
- __Affected Bundle ID__ can be added to the ticket. Enter the ID in the __Add Bundle ID__ entry box and click (__+__) to add it. You can delete an Affected Bundle ID with the ![delete](/img/product_docs/strongpointfornetsuite/integrations/delete.webp)icon.
