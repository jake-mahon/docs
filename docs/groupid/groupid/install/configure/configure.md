...
- To configure Directory Managerright after installation, click __Next__ on the __Run Configuration Tool__ page. See the [Installation Tool](/docs/groupid/groupid/install/installer/install.md) topic.
...
![Introduction page](/img/product_docs/groupid/groupid/install/configure/intro.jpg)
