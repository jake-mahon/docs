...
See the [Create a New Workflow](../../admincenter/workflow/implement.md#create-a-new-workflow) section of the [Implement Workflows](../../admincenter/workflow/implement.md) topic for additional information.
