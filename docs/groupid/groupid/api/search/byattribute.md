...
Use this API to search a directory object in an identity store based on the specified attribute. For example, search a group based on the displayname attribute.
