...
See the [Create a Data Source for a Text/CSV File](/docs/product_docs/groupid/groupid/admincenter/datasource/create.md#Create-a-Data-Source-for-a-TextCSV-File) section of the [Create a Data Source](/docs/product_docs/groupid/groupid/admincenter/datasource/create.md) topic to create a Text/CSV data source using Directory Manager.
