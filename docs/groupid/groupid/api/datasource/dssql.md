...
See the [Create a Data Source for SQL Server](../../admincenter/datasource/create.md#create-a-data-source-for-sql-server) section of the [Create a Data Source](../../admincenter/datasource/create.md) topic for creating an SQL data source using Directory Manager.
