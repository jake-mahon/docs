...
See the [Create a Data Source for MS Excel](/docs/product_docs/groupid/groupid/admincenter/datasource/create.md#Create-a-Data-Source-for-MS-Excel) section of the [Create a Data Source](/docs/product_docs/groupid/groupid/admincenter/datasource/create.md) topic for additional information on creating an Excel data source using Directory Manager.
