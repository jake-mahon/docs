...
The Set-SmartGroup commandlet modifies a Smart Group in Directory. Attributes that are common to both Smart Groups and unmanaged groups can also be modified using the [Set-Group](/docs/product_docs/groupid/groupid/managementshell/group/setgroup.md) commandlet.
