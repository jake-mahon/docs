...
This example retrieves the highest priority role of _testingaccount_ user in the connected identity store. If the user has different roles in different Directory Manager clients, only the role having the highest priority is retrieved.
