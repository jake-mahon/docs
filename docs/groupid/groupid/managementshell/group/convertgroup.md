...
![managementshell](/static/img/product_docs/groupid/groupid/managementshell/group/managementshell.png)
...
The following commandlet converts a group _Clay2_ group to a Smart Group using the credentials of current logged-on user.
