...
Click any of the report template from the list to [Generate Reports](generate.md).
...
| Owners and objects they own  Listed in [User Reports](user.md) category as well. | Provides a list of managers and their direct reports. |
