...
| Owners and objects they own  Listed in [Group Reports](group.md) category as well. | Provides a list of owners and their direct reports. |
...
| Users and contacts with a phone number  Listed in [Contact Reports](contact.md) category as well. | Provides a phone list of accounts within an organization. |
