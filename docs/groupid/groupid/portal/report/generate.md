...
You can create a __Scheduled Report job__ on Directory Manager Admin Center. See [Reports Schedule](/docs/product_docs/groupid/groupid/admincenter/schedule/reports.md)
