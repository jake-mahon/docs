...
See the [Directory Search](/docs/groupid/groupid/portal/search/search.md) topic for additional information.
...
See the [Find Dialog Box](/docs/groupid/groupid/portal/search/find.md) topic for additional information.
...
See the [Portal Settings](/docs/groupid/groupid/portal/setting/portal.md) topic for additional information.

## User Account Settings

Users can manage their own profile information and perform various account-related actions through the User Settings.

See the [User Account Settings](/docs/groupid/groupid/portal/setting/user.md) topic for additional information.
...
See the [Toolbar](/docs/groupid/groupid/portal/toolbar.md) topic for additional information.
