...
- A server is added for permission analysis on the __Entitlement__ page in an Active Directory identity store.

  Or
- A SharePoint site is added for permission analysis on the __Entitlement__ page in a Microsoft Entra ID identity store.
...
Entitlement-related permissions for a security role in an identity store are discussed in the [Entitlement](../../../../admincenter/securityrole/permissions.md#entitlement) section.
