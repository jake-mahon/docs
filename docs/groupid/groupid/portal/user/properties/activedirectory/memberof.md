...
Enter a search string to locate the required group, or click __Advance__ to use the [Find Dialog Box](../../../search/find.md) for performing a search.

The selected group(s) get listed in the Member Of grid.

Remove

Select a group in the Member Of list and click __Remove__ to remove the user from the membership of that group.
