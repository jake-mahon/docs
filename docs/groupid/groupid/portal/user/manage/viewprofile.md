...
The profile page has the same tabs as the user properties page. Refer to the information for [User Properties](../properties/overview.md) to manage your profile.
...
- The status, Verification Pending, indicates that you must validate your profile.
  ...
  Click __Validate Your Profile__ on the toolbar. The Validate Profile Properties window is displayed, where you can validate your profile.
