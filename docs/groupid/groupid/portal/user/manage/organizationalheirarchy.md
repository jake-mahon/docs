...
Step 1 – In the Directory Manager portal, go to __My Profile__ or search for the user whose organizational hierarchy you want to view on the [Directory Search](/docs/product_docs/groupid/groupid/portal/search/search.md) dialog box.
...
On the [Find Dialog Box](/docs/product_docs/groupid/groupid/portal/search/find.md), search and select the required user and click __OK__. This displays the organizational hierarchy chart for the selected user.
