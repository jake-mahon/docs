...
![Change Password error message for Entra ID user](../../../../../../static/img/product_docs/groupid/groupid/portal/user/manage/changepasswordentraiduser.webp)
...
Step 1 – In the portal, click your profile info in the top right corner and select __Change password__.
...
- Password Complexity – Displays whether password complexity rules apply. Hover the mouse over _Enabled_ to view the rules.

Step 3 – In the Change Password section, do the following:

- Type the password of your selected account in the __Current Password__ box.
- Type your new password in the __New Password__ box. The new password
  must conform to the rules of the applied password policy for the identity store.
- Type the new password in the __Confirm New Password__ box.
...
Step 5 – On successful change password, the message,"Password has been reset successfully." is displayed. Click __OK__.
