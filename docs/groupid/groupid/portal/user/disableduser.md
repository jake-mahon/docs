...
Step 1 – In Directory Manager portal, click __Users__ on the left navigation bar and select __My Direct Reports__. On the displayed page, select the __Disabled Users__ tab.
...
Refer to the information for user properties to manage the properties of a disabled/expired user. See the [User Properties](/docs/product_docs/groupid/groupid/portal/user/properties/overview.md) topic for additional information.
