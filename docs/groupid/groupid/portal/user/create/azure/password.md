...
Step 1 – Type a password for the user account in the __Password__ and __Confirm password__ boxes.
...
- Account is enabled – This check box is selected by default, indicating that the user account is enabled.
