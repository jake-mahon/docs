...
Step 1 – Click __My Groups History Grid Filter__ to specify a criteria for filtering history data.
...
The option to add a note is available on the My Account History card on Dashboard, and all History pages i.e.[My History](/docs/product_docs/groupid/groupid/portal/history/myhistory.md), [My Direct Reports' History](/docs/product_docs/groupid/groupid/portal/history/mydirectreport.md) and [My Groups' History](#My-Groups-History) pages.
