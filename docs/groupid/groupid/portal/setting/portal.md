...
However, there are a few exceptions to it. See the [Notifications](/docs/product_docs/groupid/groupid/admincenter/notification/overview.md#Notifications) topic for more information.
...
This setting also controls the number of history items displayed on the [My History](/docs/product_docs/groupid/groupid/portal/history/myhistory.md), [My Direct Reports' History](/docs/product_docs/groupid/groupid/portal/history/mydirectreport.md), and [My Groups' History](/docs/product_docs/groupid/groupid/portal/history/mydirectorygroup.md) pages.
