...
To understand how workflows work with Synchronize jobs, see the [Synchronize Jobs and Workflows](/docs/product_docs/groupid/groupid/admincenter/workflow/overview.md#Synchronize-Jobs-and-Workflows) topic.
...
Step 3 – On the [Choose Your Job Template](/docs/product_docs/groupid/groupid/portal/synchronize/job/chooseyourjobtemplate.md) page, enter the job details and select whether to use a job template or create the job from scratch.

Step 4 – Click __Next Step__.

Step 5 – On the [Select Your Source and Destination](/docs/product_docs/groupid/groupid/portal/synchronize/job/sourceanddestination.md) page, specify the source and destination providers.

Step 6 – Click __Next Step__.

Step 7 – On the [Objects, Fields and Mapping
](/docs/product_docs/groupid/groupid/portal/synchronize/job/objectfieldsandmapping.md) page, map the source and destination fields and apply transformations.

Step 8 – On the [Schedule Job and Notifications](/docs/product_docs/groupid/groupid/portal/synchronize/job/scheduleandnotification.md) page, choose a schedule for a job and set up notification settings.
...
Step 13 – Generated workflow request will be displayed in the [Requests](/docs/product_docs/groupid/groupid/portal/request/overview.md) section for the workflow approver(s). If the approver approves the workflow request, the job will execute the results.
