...
Step 2 – On Synchronize portal, click __All Jobs__.

Step 3 – In the __Search Filters__ section, select one of the following attributes from the __Attributes__ list to filter jobs:
...
When you open a job to view or change its settings, the __Edit Job__ wizard opens, which is virtually identical to the [Create a Job](/docs/product_docs/groupid/groupid/portal/synchronize/job/create.md) wizard.
...
Step 3 – In the __Job Details__ wizard, navigate to the page containing the information that you want to review or modify.
...
Step 3 – In the jobs list, click ![option](/static/img/product_docs/groupid/groupid/portal/synchronize/manage/option.png) on the job that you want to run and click __Run__.
...
Step 5 – The __Review Job Run__ dialog box appears, providing access to run statistics, reports, and logs for the last job run.

Step 6 – Click __Run Job in the Background__ to list the job in the __Background__ tasks.
...
Step 2 – On the Synchronize portal, click __All Jobs__.

Step 3 – In the jobs list, click the __three vertical dots__ icon on the job that you want to edit and click __Edit__.

Step 4 – Go through the wizard pages to modify the job as required.

Step 5 – Click __Finish__ twice to close both wizards.
...
Step 3 – Click the __three vertical dots__ icon of the job that has to be deleted and select __Delete__ from
the menu.
...
Step 3 – Click the __three vertical dots__ icon of the job and select __Preview__ from
the menu.
...
It will take you to the __Schedule and Job Notifications__ page of [Create a Job](/docs/product_docs/groupid/groupid/portal/synchronize/job/create.md). Update the schedule and click __Finish__ to save
the changes.

## Pin a Job

To pin a job to the [Dashboard](/docs/product_docs/groupid/groupid/portal/synchronize/dashboard.md) under the pinned job card:
...
Step 4 – The job is displayed on __My Pinned Jobs__ card on the [Dashboard](/docs/product_docs/groupid/groupid/portal/synchronize/dashboard.md).
...
Step 3 – Click the __three vertical dots__ icon of the job and select __Save as Template__ from
the menu.

Step 4 – On __Template Name Description wizard__, update the name and description and click Save.
...
Step 3 – In the __Jobs__ list, click the __three vertical dots__ icon on the job that has to be duplicated and click __Duplicate__.
...
Step 3 – In the __Jobs__ list, click the __three vertical dots__ icon on the job and click __Job Details__.
...
Step 5 – Click __Import Job(s)__. The job gets listed with other jobs.
...
Step 3 – On the __All Job__ page, click the __three vertical dots__ icon on the job in the list
that you want to export and click __Export__.

Step 4 – On the __Export Job(s)__ wizard, enter the password and export the job.
...
Step 4 – Go to __Job Details__ to rename the job.
...
Step 4 – On the __Actions__ menu, click __Rename__.

Step 5 – On the __Rename Job__ dialog box:
