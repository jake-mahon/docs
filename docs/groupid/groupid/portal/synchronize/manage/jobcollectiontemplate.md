...
Step 3 – In the Job Collections view, click ![option](/img/product_docs/groupid/groupid/portal/synchronize/manage/option.webp) on the job collection you want to save as a template and click __Save As Template__.
