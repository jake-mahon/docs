...
This will launch [Create a Job](/docs/groupid/groupid/portal/synchronize/job/create.md) wizard. Proceed to map the settings stored in the template on to the new job.
