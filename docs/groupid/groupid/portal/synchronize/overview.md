...
and destination) built on databases, files and other applications such as Oracle, SQL and so on. To view the list of supported Synchronize providers, see the [Synchronize Providers](/docs/product_docs/groupid/groupid/portal/synchronize/provider.md) topic.
...
- [Dashboard](/docs/product_docs/groupid/groupid/portal/synchronize/dashboard.md)
