...
- To add a new job to the collection, select __Add New Job__ dialog box. Follow the steps from [Create a Job](/docs/groupid/groupid/portal/synchronize/job/create.md).
