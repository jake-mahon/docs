...
Look on the top of the page for __Search__. This element appears on every page. Use it to locate and display information for objects. See the [Directory Search](search/search.md) topic.
