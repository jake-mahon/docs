...
- [My Requests](myrequest.md) lists workflow requests that you have generated. It displays both
  pending and processed requests.
- [Request Inbox](pending.md) lists the workflow requests for which you are the approver. You can
...
- If the object specified as an approver in a workflow route is not available (such as if it is
  ...
  default approver is not specified or disabled, the request is auto approved.
    ...
    See the
    [Specify a Default Approver](../../admincenter/workflow/advancedsettings.md#specify-a-default-approver)
    topic.
