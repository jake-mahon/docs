...
Depending on the inheritance option selected for the parent Dynasty on the [Group properties - Dynasty Options tab](/docs/product_docs/groupid/groupid/portal/group/properties/dynastyoptions.md) in group properties, the modified values of inherited attributes may or may not
persist.
