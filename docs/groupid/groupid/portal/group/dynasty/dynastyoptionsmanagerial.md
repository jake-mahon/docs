...
1. Use the __Top Manager__ field to specify the top-level manager, and thus, the start location for the Dynasty.
   ...
   Click the ellipsis button and use the [Find Dialog Box](../../search/find.md) to select a top manager.
2. Select an option from __Dynasty Type__ to specify the type of managerial Dynasty you want to create.
   ...
   - __Recursive Flat Managerial List__
     ...
     On the [Query Designer](../querydesigner/overview.md) page, you can also specify a criterion to filter the managers for whom you want to create child groups in the Dynasty.
