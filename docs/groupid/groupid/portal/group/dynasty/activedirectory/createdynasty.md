...
[Modify alias and display name templates](../../manage/dynastyfunction.md#modify-alias-and-display-name-templates).
...
3. On the [General page](../../create/activedirectory/general.md), specify basic information about
   the Dynasty.
