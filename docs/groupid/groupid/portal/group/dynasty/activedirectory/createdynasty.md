...
To modify the display name template for child Dynasties, see [Modify alias and display name templates](../../manage/dynastyfunction.md#modify-alias-and-display-name-templates).
...
3. On the [General page](../../create/activedirectory/general.md), specify basic information about the Dynasty.
...
7. On the [Summary Page](../../../user/create/activedirectory/summary.md), review the settings and then click Finish to complete the wizard.
...
5. The [Query Designer](../../querydesigner/overview.md) page displays the default query that Directory Manager will use to determine the Dynasty membership. This query returns all users with Exchange mailboxes, along with users and contacts
