...
Physically deleted groups have Tombstone as type. Physical group deletion refers to manually deleting groups using the __Delete__ option on the __Actions__ menu or shortcut menu. Directory Manager moves a physically deleted it to the Recycle
...
1. In Directory Manager portal, select __Groups > Deleted Groups__ from the left pane.
