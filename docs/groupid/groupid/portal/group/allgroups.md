...
- [Private Groups](/docs/product_docs/groupid/groupid/portal/group/privategroups.md)
- [Semi Private Groups](/docs/product_docs/groupid/groupid/portal/group/semiprivategroups.md)
- [Public Groups](/docs/product_docs/groupid/groupid/portal/group/publicgroups.md)
- [Expired Groups](/docs/product_docs/groupid/groupid/portal/group/allexpiredgroups.md)
- [Expiring Groups](/docs/product_docs/groupid/groupid/portal/group/allexpiringgroups.md)
- [Smart Groups](/docs/product_docs/groupid/groupid/portal/group/allsmartgroups.md)
- [Dynasties](/docs/product_docs/groupid/groupid/portal/group/alldynasties.md)
- [Password Expiry Groups](/docs/product_docs/groupid/groupid/portal/group/passwordexpirygroups.md)
- [Teams](/docs/product_docs/groupid/groupid/portal/group/teams.md) (for Microsoft Entra ID based identity store)
...
- [Expire a group manually ](/docs/product_docs/groupid/groupid/portal/group/manage/groupexpiryfunction.md#Expire-a-group-manually). After expiring the group, it will be listed in __Expired Group__ list.
...
You can also control the number of records to be displayed per page by modifying the __Search results per page__ setting on the [Portal Settings](/docs/product_docs/groupid/groupid/portal/setting/portal.md) panel.
...
Step 7 – To undo the filters, click __Reset Filter.__ It will remove all the criteria set before.
