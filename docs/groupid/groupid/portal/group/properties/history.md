...
History is available if the administrator has enabled history tracking for the identity store. See [History](../../history/overview.md).
...
The option to add a note is available on the My Account History card on Dashboard, and all History pages i.e.[My History](../../history/myhistory.md), [My Direct Reports' History](../../history/mydirectreport.md) and [My Groups' History](../../history/mydirectorygroup.md) pages.
