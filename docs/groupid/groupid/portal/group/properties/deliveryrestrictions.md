...
To add an object to a list, click __Add__ in the respective area. Enter a search string to locate the required object, or click __Advance__ to use the [Find Dialog Box](/docs/product_docs/groupid/groupid/portal/search/find.md) for
performing a search.
