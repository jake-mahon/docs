...
Enter a search string to locate the required group (Group A), or click __Advance__ to use the [Find Dialog Box](../../search/find.md) for performing a search
