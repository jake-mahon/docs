...
- __Members__
  ...
  Click __Add__ and enter a search string to locate the user to add as a member, or click __Advance__ to use the [Find Dialog Box](../../search/find.md) for performing a search.
