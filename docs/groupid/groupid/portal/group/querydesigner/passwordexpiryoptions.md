...
On the __Password Expiry Options__ tab of the Query Designer, you can define the password expiry policy for the group. Based on this policy and the users' PWDLASTSET attribute, Directory Manager creates this group with users whose passwords will
soon expire.
...
to the __Include__ list on the [Query Designer - Include/Exclude tab](includeexclude.md).
