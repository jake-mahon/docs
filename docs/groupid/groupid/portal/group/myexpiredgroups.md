...
The Group Lifecycle job is responsible for logically deleting expired groups, but you can also physically delete a group. See the [ Group Deletion](/docs/groupid/groupid/portal/group/manage/groupdeletion.md) topic for additional information.
