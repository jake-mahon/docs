...
- [My Memberships](/docs/groupid/groupid/portal/group/mymemberships.md)
- [My Expired Groups](/docs/groupid/groupid/portal/group/myexpiredgroups.md)
- [My Expiring Groups](/docs/groupid/groupid/portal/group/myexpiringgroups.md)
- [My Deleted Groups](/docs/groupid/groupid/portal/group/mydeletedgroups.md)
- [My Smart Groups](/docs/groupid/groupid/portal/group/mysmartgroups.md)
- [My Dynasties](/docs/groupid/groupid/portal/group/mydynasties.md)
- [My Teams](/docs/groupid/groupid/portal/group/myteams.md) (for Microsoft Entra ID based identity store)
...
- Manually [ Group Deletion](/docs/groupid/groupid/portal/group/manage/groupdeletion.md) any of your group.
...
You can control the number of records to be displayed per page by modifying the __Search results per page__ setting on the [Portal Settings](/docs/groupid/groupid/portal/setting/portal.md) panel.
