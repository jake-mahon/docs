...
By default, the __My Groups__ tab displays the groups that you are the primary owner for. To include the groups for which you are an additional owner, select the __Display additional group ownership in My Groups__ check box on the [Portal Settings](../setting/portal.md) panel. This tab lists active groups only; expired and deleted groups are not displayed.

You can [Modify Search Directory](allgroups.md#modify-search-directory) to search your groups and add [Filter All Groups](allgroups.md#filter-all-groups)by clicking __My Groups Grid Filters__.
...
- Join / leave a group [Join or leave a group on behalf of a direct report or peer](manage/groupjoinleave.md#join-or-leave-a-group-on-behalf-of-a-direct-report-or-peer)a direct report or peer.
...
You can control the number of records to be displayed per page by modifying the __Search results per page__ setting on the [Portal Settings](../setting/portal.md) panel.
