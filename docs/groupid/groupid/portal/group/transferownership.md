...
1. In Directory Managerportal, from the left pane, select __All Groups__ or __My Groups__ under __Groups__ and select __Transfer Ownership__ option on the top right corner.
