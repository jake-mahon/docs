...
- The __Owner__ box displays your name as the primary owner of the group.
  ...
  To change the primary owner, click __Browse__ next to the __Owner__ box to launch the [Find Dialog Box](/docs/product_docs/groupid/groupid/portal/search/find.md), where you can search and select a primary owner.
...
After specifying group owners, click __Next__.
...
for your role in the identity store requires that the group must have at least x number of additional owners. Do the needful and click __Next__.
