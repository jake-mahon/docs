...
Step 1 – To modify the query, click the __Query Designer__ button. This launches the [Query Designer](../../querydesigner/overview.md) dialog box, where you can modify the query.
