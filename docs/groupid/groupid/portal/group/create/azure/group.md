...
5. On the [Owners page](../activedirectory/owners.md), specify primary and additional owners for the group.
...
2. On the [Group Type page](../grouptype.md) page, select the __Smart Group__ option button and click __Next__.
3. On the [General page](general.md) page, specify basic information about the group.
4. On the [ Smart Group page](../activedirectory/smartgroup.md) page, review and modify the query for updating group membership.
...
6. On the [Summary Page](../../../user/create/activedirectory/summary.md), review the settings and then click __Finish__ to complete the wizard.
