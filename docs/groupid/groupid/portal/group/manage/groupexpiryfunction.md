...
1. On the left navigation bar, click __Groups__ and then select the __My Groups__, __My Memberships__, or __My Expiring Groups__ tab.
   ...
   You can also [Directory Search](/docs/product_docs/groupid/groupid/portal/search/search.md) the group you want to expire.
...
- When you manually expire a group with an expiry policy other than ‘Never Expire’, the group expires and is moved it to the [My Expired Groups](/docs/product_docs/groupid/groupid/portal/group/myexpiredgroups.md) page.
...
Logically deleted groups are moved to the [My Deleted Groups](/docs/product_docs/groupid/groupid/portal/group/mydeletedgroups.md) page with the “Deleted\_” prefix added to their names.
...
The Group Life Cycle job expires groups according to their respective expiry policies and moves them to the [My Expired Groups](/docs/product_docs/groupid/groupid/portal/group/myexpiredgroups.md) page.

1. [Directory Search](/docs/product_docs/groupid/groupid/portal/search/search.md) the group you want to change the expiry policy for.
...
NOTE: If the Directory Manager administrator has specified this action for review, your changes will not take effect until verified by an approver. See [Requests](/docs/product_docs/groupid/groupid/portal/request/overview.md).

## Attest an expiring group

See [Attest an Expiring Group](/docs/product_docs/groupid/groupid/portal/group/manage/attestation.md).
