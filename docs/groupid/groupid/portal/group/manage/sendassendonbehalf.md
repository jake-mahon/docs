...
The administrator can provide the Send As and Send on Behalf features on any tab in [Group Properties](/docs/product_docs/groupid/groupid/portal/group/properties/overview.md). They are displayed as:

![sendassendon](/static/img/product_docs/groupid/groupid/portal/group/manage/sendassendon.png)
