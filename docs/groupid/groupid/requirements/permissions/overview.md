...
- [Service Account for Active Directory and Exchange](/docs/product_docs/groupid/groupid/requirements/permissions/adserviceaccount.md)
- [gMSA for Active Directory](/docs/product_docs/groupid/groupid/requirements/permissions/gmsarequirements.md)
