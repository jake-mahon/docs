...
![App registeration page](/img/product_docs/groupid/groupid/configureentraid/register/app_registeration.png)
...
![Register an application](/img/product_docs/groupid/groupid/configureentraid/register/register_an_application.png)

Step 4 – The __Overview__ page is displayed. Copy the Application (client) ID and keep it safe.

![Overview page](/img/product_docs/groupid/groupid/configureentraid/register/app_registeration_overview.png)

Step 5 – Go to the __Authentication__ node and set it as follows:

![Authenticate node](/img/product_docs/groupid/groupid/configureentraid/register/authenticate_node.png)
...
![Roles and Administration page](/img/product_docs/groupid/groupid/configureentraid/register/roles_and_administration.png)
...
- __Global administrator__: For Global administrator, type global to filter out the Global administrator role. Click __Global administrator__.
  ...
  ![All roles page](/img/product_docs/groupid/groupid/configureentraid/register/all_roles.png)
  ...
  ![Add assignment page](/img/product_docs/groupid/groupid/configureentraid/register/add_assignment.png)
...
![API Permission page](/img/product_docs/groupid/groupid/configureentraid/register/add_a_permission.png)

Step 13 – The Request API permissions page opens. Click the __Microsoft Graph__ API tab.

![Request API permissions page](/img/product_docs/groupid/groupid/configureentraid/register/request_api_permissions.png)

Step 14 – Click the __Application permissions__ tab:

![Application permissions tab](/img/product_docs/groupid/groupid/configureentraid/register/application_permission.png)
...
![Office 365 Exchange Online API](/img/product_docs/groupid/groupid/configureentraid/register/office365_permission.png)
...
![SharePoint API card](/img/product_docs/groupid/groupid/configureentraid/register/sharepoint_api_card.png)
