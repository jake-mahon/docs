...
Step 3 – Enter a search string in the search box and press _Enter_. Data sources that contain the string in their names are displayed.
...
steps for creating the respective data source in the [Create a Data Source](create.md) topic to modify the info.
...
Step 3 – Click __Delete__ for a data source to delete it.
