...
NOTE: For MFA and SFA to work for an identity store, make sure you enable enrollment for it. See the [Enable Enrollment](../../identitystore/configure/authtypes.md#enable-enrollment) topic.
