...
- When a role member performs a search, Directory Manager looks up the localOU container and displays objects with the _Country_ attribute set to _United States_.
...
from the entire directory. See the [Manage Advanced Settings](../../portal/server/advanced.md) topic.
