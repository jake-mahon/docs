...
security roles. See the [Manage Security Roles](manage.md) and [Create a Security Role](create.md)
...
[Configure an Identity Store](../identitystore/configure.md)topic for additional information.
...
criteria. See the [Security Role – Criteria](criteria.md) topic.
...
[Check the Roles of a User](checkrole.md) topic.
