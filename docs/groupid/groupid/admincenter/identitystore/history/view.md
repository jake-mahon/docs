...
3. Click __History__ under __Settings__ in the left pane.
   ...
   Click a history item to view its details. See the [History Item Details](/docs/product_docs/groupid/groupid/admincenter/identitystore/history/details.md) topic.
...
5. On the __History Details__ dialog box, manage notes for the history item. See the [Annotate History Items](/docs/product_docs/groupid/groupid/admincenter/identitystore/history/details.md#Annotate-History-Items) topic.
...
- [Configure History Tracking](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/directoryservice/historytracking.md)
- [History in Directory Manager](/docs/product_docs/groupid/groupid/admincenter/history.md)
- [Event Logging](/docs/product_docs/groupid/groupid/admincenter/identitystore/history/eventlogging.md)
