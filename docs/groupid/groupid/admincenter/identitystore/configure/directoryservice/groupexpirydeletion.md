...
x number of days after group expiry, as specified in the [Auto Delete Expired Groups](grouplifecycle.md#auto-delete-expired-groups) topic.
...
nor a default approver. See the [Specify a Default Approver](../../../workflow/advancedsettings.md#specify-a-default-approver) topic.
