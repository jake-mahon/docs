...
- Enable the __Unique characters__ button to enable the Unique Characters rule.
- Must contain <_number_> or more unique characters – Select the minimum number of unique characters in the number drop-down list the passwords must contain.
