...
A Dynasty retrieves data from the directory on the same pattern as a Smart Group does, but it has its own mechanism of dividing the query results into child groups. To learn more about Dynasties, see the [Dynasties](../../../general/concepts.md#dynasties) topic.
...
__How does Directory Manager update Dynasties?__
...
- Scheduled update - Scheduled updates, powered by a Smart Group Update schedule, auto run at a specified frequency to update the target groups and Dynasties. See the [Smart Group Update Schedule](../../../schedule/smartgroupupdate.md) topic.
