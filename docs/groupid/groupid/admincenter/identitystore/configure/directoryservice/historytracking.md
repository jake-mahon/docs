...
See the [History in Directory Manager](../../../history.md) and [Event Logging](../../history/eventlogging.md) topics for additional information.
...
this data by moving it from the database to CSV files. See the [History Retention Schedule](../../../schedule/historyretention.md) topic.
