...
2. Do the following:
   ...
   - To send the notification to specific recipients, search for the required users and click __Notify All Users__. See the [Search Users](/docs/product_docs/groupid/groupid/admincenter/helpdesk/operation/search.md) topic to perform a search.
