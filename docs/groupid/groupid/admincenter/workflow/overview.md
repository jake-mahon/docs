...
NOTE: Workflows require an SMTP server to be configured for the identity store. See the [Configure an SMTP Server](/docs/groupid/groupid/admincenter/identitystore/configure/smtpserver.md) topic.
