...
- Admin Center - Actions performed in Admin Center, such as creating identity stores, SMS gateway accounts, changes to notification templates, and more. See the [Admin Center History](/docs/product_docs/groupid/groupid/admincenter/general/history.md) topic to view the history.
- Helpdesk - Helpdesk-specific actions, such as account unlock and enrollment. See the [History in Helpdesk](/docs/product_docs/groupid/groupid/admincenter/helpdesk/history.md) topic to view the history.
- Identity store configurations - Changes made to identity store configurations, including changes to security roles and workflows. See the [Identity Store History](/docs/product_docs/groupid/groupid/admincenter/identitystore/history/view.md) topic to view the history.
- Identity store objects - Modifications made to objects in an identity store, such as creating objects, updating attributes for an object, etc. It includes modifications made through:
  ...
  See the [History](/docs/product_docs/groupid/groupid/portal/history/overview.md) topic to view this history.
...
[Configure History Tracking](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/directoryservice/historytracking.md) topic.
...
[Retain Complete History Data](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/directoryservice/historytracking.md#Retain-Complete-History-Data) and
[Retain History for a Specific Period](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/directoryservice/historytracking.md#Retain-History-for-a-Specific-Period) topics. Your desired setting applies to all history tracked for the respective identity store, including that tracked for helpdesk and Admin Center.
...
In addition to history tracking, Directory Manager provides event logging, which includes file logging and Windows logging for Directory Manager clients and services. See the [Event Logging](/docs/product_docs/groupid/groupid/admincenter/identitystore/history/eventlogging.md) topic.
