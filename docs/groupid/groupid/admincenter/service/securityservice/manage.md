...
See
the [Manage Data Service Settings](/docs/product_docs/groupid/groupid/admincenter/service/dataservice/manage.md) topic to manage settings for a Security service, such as deployment and log settings.
...
For details displayed on a service card, see the table in the [View Data Service Details](/docs/product_docs/groupid/groupid/admincenter/service/dataservice/manage.md#View-Data-Service-Details) topic for additional information.
