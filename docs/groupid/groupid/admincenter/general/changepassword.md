...
You can change password according to the password policy the administrator has enabled for the identity store. The administrator can either enable [Directory Manage Password Policy ](../securityrole/policy/password.md) or Netwrix Password Policy Enforcer policies for the identity store.
...
![Admin Center Change Password error message for an Entra ID user](../../../../../static/img/product_docs/groupid/groupid/admincenter/general/changepassword.webp)
