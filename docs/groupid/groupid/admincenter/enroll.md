...
authentication, and vice versa. See the [Authentication Policy](identitystore/configure/authpolicy.md) topic for a list of supported authentication types.
...
You can also launch the __Your Enrollments__ page from Admin Center and the portal. See the [Enroll your Account](general/accessapplications.md#enroll-your-account) topic for additional information.
