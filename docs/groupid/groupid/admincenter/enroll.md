...
authentication, and vice versa. See the [Authentication Policy](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/authpolicy.md) topic for a list of supported authentication types.
...
You can also launch the __Your Enrollments__ page from Admin Center and the portal. See the [Enroll your Account](/docs/product_docs/groupid/groupid/admincenter/general/accessapplications.md#Enroll-your-Account) topic for additional information.
...
- Enroll your account using Security Questions
  ...
  1. Click the __Security Questions__ tab.
  2. From a __Question X__ list, select a security question of your choice (X represents the question number). You can also type a question in the box to create a new question of your choice.
  ...
  5. Click __Enroll Account__. A confirmation message is displayed on successful enrollment.
...
- Enroll your account using Authenticator
  ...
  1. Click the __Authenticator__ tab.
  ...
  3. Enter this code in the box on the __Authenticator__ tab and click __Enroll Account__. A confirmation message is displayed on successful enrollment.
...
- Enroll your account using YubiKey
  ...
  2. Click the __YubiKey__ tab.
  3. Enter a name for your YubiKey device in the box and click __Enroll Account__.
...
- Enroll your account using Windows Hello
  ...
  1. Click the __Windows Hello__ tab.
  2. Enter a name for your authentication device in the box and click __Start Registration__. You will be prompted to provide your biometric information using the configured biometric device.
