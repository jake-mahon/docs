...
See the [Manage the Global Question Pool ](/docs/product_docs/groupid/groupid/admincenter/general/globalpool.md)topic.

## Modify the Local Question Pool

See the [Manage the Local Question Pool](/docs/product_docs/groupid/groupid/admincenter/identitystore/configure/security/securityquestions.md) topic.
...
See the [Define Security Question Settings for a Security Role](/docs/product_docs/groupid/groupid/admincenter/securityrole/policy/password.md#Define-Security-Question-Settings-for-a-Security-Role) topic.
