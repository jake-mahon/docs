...
See the [Manage the Local Question Pool](../identitystore/configure/security/securityquestions.md)
topic.
...
See the
[Define Security Question Settings for a Security Role](../securityrole/policy/password.md#define-security-question-settings-for-a-security-role) topic.
