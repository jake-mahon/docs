...
See the [Manage the Global Question Pool ](../general/globalpool.md)topic.

## Modify the Local Question Pool

See the [Manage the Local Question Pool](../identitystore/configure/security/securityquestions.md) topic.
...
See the [Define Security Question Settings for a Security Role](../securityrole/policy/password.md#define-security-question-settings-for-a-security-role) topic.

See Also

- [Authentication Policy](../identitystore/configure/authpolicy.md)
- [Manage the Local Question Pool](../identitystore/configure/security/securityquestions.md)
