...
7. On the __Edit Design Category__ pane, update the tab details. Refer to step 7 and onwards in the Add a Tab (Category) topic for details.
...
8. On the __Edit Field__ pane, update the field details. Refer to step 8 and onwards in the Add a Field to a Tab topic to update the required details and save the changes.
