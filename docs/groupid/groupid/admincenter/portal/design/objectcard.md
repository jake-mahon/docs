...
![usercard](/static/img/product_docs/groupid/groupid/admincenter/portal/design/usercard.png)

For each object type, you can specify a different set of attributes to display on this card. For a group, the card is as:

![groupcard](/static/img/product_docs/groupid/groupid/admincenter/portal/design/groupcard.png)
...
- [Specify Attributes for Object List View](/docs/product_docs/groupid/groupid/admincenter/portal/design/objectlist.md)
