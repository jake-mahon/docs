...
7. On the __Edit Profile Validation Attribute__ pane, update the required information. Follow steps 7-19 in the Add a Property Validation Field topic for help.
