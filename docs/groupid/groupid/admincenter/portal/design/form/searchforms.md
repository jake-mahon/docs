...
10. In the __Display Type__ drop-down list, select the display type to use to render this field in the portal. The list contains basic display types
    and custom display types defined on the __Custom Display Types__ page. See the [Display Type Categories](/docs/product_docs/groupid/groupid/admincenter/portal/displaytype/categories.md) topic.
...
- [Customize Search Results](/docs/product_docs/groupid/groupid/admincenter/portal/design/form/searchresults.md)
