...
10. In the __Display Type__ drop-down list, select the display type to use to render this field in the portal. Available options are limited to textbox, DN, DNs, and Link, which are basic display Types. See the [Basic Display Types](/docs/product_docs/groupid/groupid/admincenter/portal/displaytype/categories.md#Basic-Display-Types) topic.
...
- [Customize Quick Search](/docs/product_docs/groupid/groupid/admincenter/portal/design/form/quicksearch.md)
