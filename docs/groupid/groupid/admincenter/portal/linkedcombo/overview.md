...
7. Complete the pages of the __Linked Combo Display Type__ wizard.
   ...
   1. On the __Details__ page, provide the source data file. See the [Linked Combo Type - Details](details.md) topic for more info.
   2. On the __Schema__ page, define the parent-child relationship between fields. See the [Linked Combo Type - Schema](schema.md) topic for details.
8. Click __OK__.
