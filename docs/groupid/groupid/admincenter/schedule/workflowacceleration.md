...
A Workflow Acceleration schedule facilitates the workflow approver acceleration process for workflow requests. This schedule is auto created when approver acceleration is enabled for the identity store. See the [Workflow Approver Acceleration](/docs/product_docs/groupid/groupid/admincenter/workflow/approveracceleration.md) topic for additional information.
...
Step 4 – On the Schedules page, click the plus sign next to Workflow Acceleration. Then click the ellipsis button for the schedule and select __Edit__.
