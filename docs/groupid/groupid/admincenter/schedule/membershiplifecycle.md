...
- The Membership Life Cycle schedule executes the Membership Life Cycle policy for the identity store. See the [Manage Membership Life Cycle Policies](../identitystore/configure/directoryservice/membershiplifecycle.md) topic.
- The schedule also removes members when group owners inactivate them during group attestation. See the [Enable Group Attestation](../identitystore/configure/directoryservice/grouplifecycle.md#enable-group-attestation) topic.
...
Directory Manager generates notifications when the Membership Life Cycle schedule adds or removes users from group membership. See the [Manage Membership Life Cycle Notifications](../identitystore/configure/smtpserver.md#manage-membership-life-cycle-notifications) topic.
...
The schedule is displayed under __Membership Life Cycle__. See the [View the Schedules in an Identity Store ](manage.md#view-the-schedules-in-an-identity-store) topic for additional information.
