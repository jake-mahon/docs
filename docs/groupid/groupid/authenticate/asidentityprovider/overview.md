...
[Register an Application (Service Provider) in Directory Manager](register.md)
topic for additional information.

You can also specify default values for the issuer URL and signing certificate, that are used to configure Directory Manager in the service provider. See the [Specify Default Metadata Values](metadata.md) topic for additional information.

To sign in using Directory Manager, see the
[Sign In Using Directory Manager](signin.md) topic.
