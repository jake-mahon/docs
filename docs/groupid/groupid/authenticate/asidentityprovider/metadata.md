...
2. On the Settings page, click __Upload PFX__.
3. On the Import Windows Exported Certificate File dialog box, click __Browse__ to select the exported certificate file. As it is password protected, enter the password and click __Load Certificate File__.
4. Click __Save__.
