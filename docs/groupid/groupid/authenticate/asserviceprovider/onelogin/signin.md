...
3. Enter Leo Ferguson’s login name and password, and click __Login__. The user is successfully logged into the _Wizard_ portal using the OneLogin single sign on option.  
   Only users defined for our app in OneLogin can log in by entering their user names and passwords. See the [Define Users in OneLogin](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/onelogin/configureinonelogin.md#Define-Users-in-OneLogin) topic.
