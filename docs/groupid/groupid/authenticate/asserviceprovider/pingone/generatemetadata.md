...
To generate the consumer URL, see the [Generate URLs](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/adfs/generateurls.md) topic. Replace references to AD FS with PingOne.
