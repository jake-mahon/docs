...
- Generate the consumer URL andDirectory Manager metadata file for the Directory Manager client with
  ...
  [Generate the Consumer URL and Metadata File](generatemetadata.md) topic for additional
  information.
- [Configure Directory Manager In PingOne](configureinpingone.md)
- [Configure the PingOne Provider In Directory Manager](configurepingoneingroupid.md)

That done, you can sign into Directory Manager using PingOne. See the
[Sign In Using PingOne](signin.md) topic for additional information.
