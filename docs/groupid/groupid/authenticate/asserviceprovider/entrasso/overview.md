...
- Generate the consumer URL and audience URL for the Directory Manager client with which you want to configure Microsoft Entra ID SSO. See the[Generate URLs](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/entrasso/generateurls.md) topic for additional information.
...
That done, you can sign into Directory Manager using Microsoft Entra ID SSO. See the [Sign In Using Microsoft Entra ID SSO](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/entrasso/signin.md) topic for additional information.
