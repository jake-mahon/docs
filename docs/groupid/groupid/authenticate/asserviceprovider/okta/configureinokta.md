...
You must define users in Okta. Only these users can authenticate on the Directory Manager portal _Wizard_ using Okta. See the [Sign In Using Okta](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/okta/signin.md) topic.
