...
3. Enter your credentials and click __Sign In__. You will be routed to the main page of the Directory Manager portal _Wizard_.  
   Only users defined for our app in Okta can log in by entering their user names and passwords. See the [Configure Users in Okta](/docs/product_docs/groupid/groupid/authenticate/asserviceprovider/okta/configureinokta.md#Configure-Users-in-Okta) topic.
