...
See the [Directory Manager as a Service Provider](asserviceprovider/overview.md) topic for additional information.
...
[Directory Manager as an Identity Provider](asidentityprovider/overview.md) topic for additional information.
