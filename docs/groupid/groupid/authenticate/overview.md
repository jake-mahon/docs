...
See the [Directory Manager as a Service Provider](/docs/groupid/groupid/authenticate/asserviceprovider/overview.md) topic for additional information.
...
[Directory Manager as an Identity Provider](/docs/groupid/groupid/authenticate/asidentityprovider/overview.md) topic for additional information.
