...
- [ConvertTo-StaticGroup](/versioned_docs/groupid_11.0/groupid/managementshell/smartgroup/converttostaticgroup.md):
  converts a Smart Group or a Dynasty to a static group.
- [Get-SmartGroup](/versioned_docs/groupid_11.0/groupid/managementshell/smartgroup/getsmartgroup.md):
  retrieves Smart Groups and Dynasties that match the given criteria.
- [New-SmartGroup](/versioned_docs/groupid_11.0/groupid/managementshell/smartgroup/newsmartgroup.md):
...
- [Update-Group](/versioned_docs/groupid_11.0/groupid/managementshell/smartgroup/updategroup.md):
  modifies the membership of a Smart Group or Dynasty according to the results returned by the LDAP
  query.
- [Upgrade-Group](/versioned_docs/groupid_11.0/groupid/managementshell/smartgroup/upgradegroup.md):
