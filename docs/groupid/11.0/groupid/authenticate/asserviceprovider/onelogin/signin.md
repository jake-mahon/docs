...
1. Launch the GroupID portal _Wizard_.  
   ...
   [Configure the Provider in GroupID](/versioned_docs/groupid_11.0/groupid/authenticate/asserviceprovider/onelogin/configureoneloginingroupid.md#configure-the-provider-in-groupid)
   topic).
...
3. Enter Leo Ferguson’s login name and password, and click **Login**. The user is successfully
   ...
   See the
   [Define Users in OneLogin](/versioned_docs/groupid_11.0/groupid/authenticate/asserviceprovider/onelogin/configureinonelogin.md#define-users-in-onelogin)
   topic.
