...
1. Launch the GroupID portal _Wizard_.  
   ...
   [Configure the Provider in GroupID](/docs/groupid/11.0/groupid/authenticate/asserviceprovider/entrasso/configureprovideringroupid.md#configure-the-provider-in-groupid)
   topic).
...
3. Enter your credentials and click **Sign In**. You will be routed to the main page of the GroupID
   ...
   [Configure GroupID in Microsoft Entra ID](/docs/groupid/11.0/groupid/authenticate/asserviceprovider/entrasso/configureinentra.md#configure-groupid-in-microsoft-entra-id)
   topic.
