...
1. To launch the Upgrade wizard, click **Next** on the **GroupID Successfully Configured** page of
   the Configuration Tool.
    ...
    ![Welcome page](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/1-welcome.webp)

2. Read the welcome message and click **Next**.

    ![2-select_source_version](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/2-select_source_version.webp)
...
4. Click **Next**.
    ...
    ![Select modules to upgrade](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/3-select_modules.webp)
    ...
    - **Custom** – choose what data you want to upgrade. On selecting it, the following options are
      listed, from where you can choose the data to upgrade.
        ...
        ![3-select_modules-custom](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/3-select_modules-custom.webp)
...
14. Click **Next**.
    ...
    ![Summary page](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/5-summary.webp)
...
15. Review the summary and click **Next**.
    ...
    ![Upgrade Progress page](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/6-upgrade_process_complete.webp)
...
16. Click **Next**.  
    ![Upgrade Completed page](/img/versioned_docs/groupid_11.0/groupid/install/upgrade/7-upgrade_complete.webp)
