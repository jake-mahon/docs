...
1. Select the **Configure a new GroupID server with new or existing database** option on the
   ...
   **Next**.
    ...
    ![Database Settings page](/img/versioned_docs/groupid_11.0/groupid/install/configure/databasesettings.webp)
...
6. Click **Next**.
    ...
    ![Security Settings page](/img/versioned_docs/groupid_11.0/groupid/install/configure/securitysettings.webp)
...
8. Click **Next**.
    ...
    ![License page](/img/versioned_docs/groupid_11.0/groupid/install/configure/license.webp)
...
10. Click **Next**.
    ...
    ![Elasticsearch setting page](/img/versioned_docs/groupid_11.0/groupid/install/configure/elasticsearchsettings.webp)
...
11. GroupID provides the following two options for Elasticsearch configuration. Select the relevant
    ...
    - **Let GroupID install and manage Elasticsearch**: If you select this option, GroupID
      ...
      Elasticsearch cluster it will create:
        ...
        ![Select Elastic Cluster page](/img/versioned_docs/groupid_11.0/groupid/install/configure/selectelasticcluster.webp)
    ...
    - **I will install and manage Elasticsearch myself**: If you select this option, the following
      page is displayed:
        ...
        ![Elasticsearch settings page](/img/versioned_docs/groupid_11.0/groupid/install/configure/elasticsearchsettings-2.webp)
...
12. Click **Next**.
    ...
    ![Services Configuration page](/img/versioned_docs/groupid_11.0/groupid/install/configure/servicesconfiguration.webp)
...
14. Click **Next**.
    ...
    ![Service Account Setting page](/img/versioned_docs/groupid_11.0/groupid/install/configure/serviceaccount.webp)
...
16. You can specify a service accounts for the app pool in any of the following ways:
    ...
    - **Use an existing account**: Click **Browse**.
        ...
        ![Find Service Account page](/img/versioned_docs/groupid_11.0/groupid/install/configure/findserviceaccount.webp)
    ...
    - **Create a new service account**: Click the **Create New** button on the Service Account
      Setting page.
        ...
        ![Create a new service account page](/img/versioned_docs/groupid_11.0/groupid/install/configure/createserviceaccount.webp)
...
19. Click **Configure**.
    ...
    ![Configuring GroupID page](/img/versioned_docs/groupid_11.0/groupid/install/configure/configuring.webp)
    ...
    **We are configuring GroupID** page displays the progress while a GroupID server is configured
    ...
    ![GroupID successfully configured page](/img/versioned_docs/groupid_11.0/groupid/install/configure/configuresuccess.webp)

20. GroupID is configured on your machine.

    Click **Launch GroupID** to start using GroupID. The Sign In page opens:

    ![GroupID Sign In page](/img/versioned_docs/groupid_11.0/groupid/install/configure/launchgid.webp)
