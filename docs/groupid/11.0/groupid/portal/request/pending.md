...
- [Approve a request](/docs/groupid/11.0/groupid/portal/request/allrequest.md#approve-a-request).
- [Deny a request](/docs/groupid/11.0/groupid/portal/request/allrequest.md#deny-a-request).
- [Filter requests](/docs/groupid/11.0/groupid/portal/request/allrequest.md#filter-requests).
