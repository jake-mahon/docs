...
3. On the
   [Choose Your Job Template](/docs/groupid/11.0/groupid/portal/synchronize/job/chooseyourjobtemplate.md)
   page, enter the job details and select whether to use a job template or create the job from
   scratch.
4. Click **Next Step**.
5. On the
   [Select Your Source and Destination](/docs/groupid/11.0/groupid/portal/synchronize/job/sourceanddestination.md)
...
8. On the
   [Schedule Job and Notifications](/docs/groupid/11.0/groupid/portal/synchronize/job/scheduleandnotification.md)
