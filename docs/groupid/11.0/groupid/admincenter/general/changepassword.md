...
![Admin Center Change Password error message for an Entra ID user](/img/versioned_docs/groupid_11.0/groupid/admincenter/general/admincenterchangepassword.webp)
