...
- Inheritance settings for Dynasties. See the
  [Manage Dynasty Settings](/docs/groupid/11.0/groupid/admincenter/identitystore/configure/directoryservice/dynastysettings.md)
  topic.
- Group update and membership settings. See the
  [Manage Group Membership Settings](/docs/groupid/11.0/groupid/admincenter/identitystore/configure/directoryservice/outofbounds.md)
  topic.
...
- A messaging provider so that mail-enabled objects can be created in the identity store. See the
  [Configure a Messaging Provider](/docs/groupid/11.0/groupid/admincenter/identitystore/configure/directoryservice/messagingprovider.md)
  topic.
...
- Circular reference settings for object update. See the
  [Manage Circular Reference ](/docs/groupid/11.0/groupid/admincenter/identitystore/configure/directoryservice/circularreference.md)topic.
...
the [Security Roles](/docs/groupid/11.0/groupid/admincenter/securityrole/overview.md)
topic.
...
[Workflows](/docs/groupid/11.0/groupid/admincenter/workflow/overview.md) topic for
details.
...
[Entitlement](/docs/groupid/11.0/groupid/admincenter/entitlement/overview.md) topic.
...
[Schedules](/docs/groupid/11.0/groupid/admincenter/schedule/overview.md) topic.
