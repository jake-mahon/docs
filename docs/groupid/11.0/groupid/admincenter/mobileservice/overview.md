...
[History in GroupID](/docs/groupid/11.0/groupid/admincenter/history.md) topic.
...
the [Host a Portal](/docs/groupid/11.0/groupid/admincenter/portal/create.md#host-a-portal)
topic.
...
[Install and Configure the GroupID App](/docs/groupid/11.0/groupid/admincenter/mobileservice/phonesetup.md)
topic.
