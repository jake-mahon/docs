...
[Specify Advanced Configurations](configureadfsingroupid.md#specify-advanced-configurations)
topic).  
...
[Provide IDP Login URL](configureadfsingroupid.md#provide-idp-login-url) topic).
