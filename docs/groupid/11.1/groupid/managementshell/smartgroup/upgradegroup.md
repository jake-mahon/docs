...
[Upgrade to Directory Manager 11](/docs/groupid/11.1/groupid/install/upgrade/upgrade.md) topic for additional information
on upgrade.
...
commandlet. See the [Parameters](/docs/groupid/11.1/groupid/managementshell/parameters/parameters.md) topic for additional information on
the supported parameters. See the [Parameters](/docs/groupid/11.1/groupid/managementshell/parameters/parameters.md) topic to get information
