...
See the [Deleting a Job](/docs/groupid/11.1/groupid/portal/synchronize/manage/job.md#deleting-a-job) section of the
[Manage a Job](/docs/groupid/11.1/groupid/portal/synchronize/manage/job.md) topic for additional information.
