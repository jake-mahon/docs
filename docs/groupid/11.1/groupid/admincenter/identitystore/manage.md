...
| History                        | Indicates whether history tracking for the identity store is enabled or disabled. See the [Configure History Tracking](/docs/groupid/11.1/groupid/admincenter/identitystore/configure/directoryservice/historytracking.md) topic to enable or disable history tracking.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
3. On the **Identity Store Details** page, update the required information on the **General** tab.  
   ...
   [Create an Identity Store](/docs/groupid/11.1/groupid/admincenter/identitystore/create.md) topic for more information.
4. Click **Save**.
...
service will not replicate it. See the [Elasticsearch and Replication ](/docs/groupid/11.1/groupid/admincenter/replication/overview.md)
topic.
...
- [Identity Stores](/docs/groupid/11.1/groupid/admincenter/identitystore/overview.md)
