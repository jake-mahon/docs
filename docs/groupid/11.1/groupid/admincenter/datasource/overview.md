...
source to another. See the [Synchronize](/docs/groupid/11.1/groupid/portal/synchronize/overview.md) topic for additional
information.
...
[Query Based Advanced Search](/docs/groupid/11.1/groupid/portal/search/querysearch.md) topic for additional information.
