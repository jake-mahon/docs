...
security roles. See the [Manage Security Roles](/docs/groupid/11.1/groupid/admincenter/securityrole/manage.md) and [Create a Security Role](/docs/groupid/11.1/groupid/admincenter/securityrole/create.md)
...
[Configure an Identity Store](/docs/groupid/11.1/groupid/admincenter/identitystore/configure.md)topic for additional information.
...
criteria. See the [Security Role – Criteria](/docs/groupid/11.1/groupid/admincenter/securityrole/criteria.md) topic.
...
[Check the Roles of a User](/docs/groupid/11.1/groupid/admincenter/securityrole/checkrole.md) topic.
