...
![dashboard](/img/product_docs/groupid/groupid/portal/dashboard.webp)
...
display information for objects. See the [Directory Search](/docs/groupid/11.1/groupid/portal/search/search.md) topic.
