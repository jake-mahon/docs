...
[Modify alias and display name templates](/docs/groupid/11.1/groupid/portal/group/manage/dynastyfunction.md#modify-alias-and-display-name-templates).
...
3. On the [General page](/docs/groupid/11.1/groupid/portal/group/create/activedirectory/general.md), specify basic information about
   the Dynasty.
