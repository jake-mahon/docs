...
[Specify a Default Filter Criteria](/docs/groupid/11.1/groupid/admincenter/securityrole/policy/querydesigner.md#specify-a-default-filter-criteria)
section of the [ Query Designer Policy](/docs/groupid/11.1/groupid/admincenter/securityrole/policy/querydesigner.md)
topic.
