...
Step 3 – On the [Choose Your Job Template](/docs/groupid/11.1/groupid/portal/synchronize/job/chooseyourjobtemplate.md) page, enter the job details and
...
Step 7 – On the [Objects, Fields and Mapping ](/docs/groupid/11.1/groupid/portal/synchronize/job/objectfieldsandmapping.md) page, map the source and
destination fields and apply transformations.

Step 8 – On the [Schedule Job and Notifications](/docs/groupid/11.1/groupid/portal/synchronize/job/scheduleandnotification.md) page, choose a schedule
...
Step 13 – Generated workflow request will be displayed in the [Requests](/docs/groupid/11.1/groupid/portal/request/overview.md)
