...
[Directory Manage Password Policy ](/docs/groupid/11.1/groupid/admincenter/securityrole/policy/password.md) or Netwrix
...
you need to reset. See the [Directory Search](/docs/groupid/11.1/groupid/portal/search/search.md) topic for additional
information.
