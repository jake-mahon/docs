...
See solutions to these disadvantages in the [Moving to SQL Server](/docs/passwordreset/3.3/password-reset/advanced/sql-server-migration.md) topic.
...
[Database](/docs/passwordreset/3.3/password-reset/configuration/general-settings.md#database) topic for more information.
