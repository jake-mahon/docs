...
server. See the [Password Reset Client](/docs/passwordreset/3.3/password-reset/usage/password-reset-client.md) topic for more information.
...
[Configuring the PRC](/docs/passwordreset/3.3/password-reset/usage/password-reset-client.md#configuring-the-prc) topic for more information.
...
[Moving to SQL Server](/docs/passwordreset/3.3/password-reset/advanced/sql-server-migration.md) topic for more information.
