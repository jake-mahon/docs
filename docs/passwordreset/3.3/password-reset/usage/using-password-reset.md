...
See the [Password Reset Client](/docs/passwordreset/3.3/password-reset/usage/password-reset-client.md) topic for more information.
...
[Installing and Using an SSL Certificate](/docs/passwordreset/3.3/password-reset/advanced/securing-password-reset.md#installing-and-using-an-ssl-certificate)
...
[Verification Codes](/docs/passwordreset/3.3/password-reset/configuration/verification-methods.md#verification-codes) and
[Verification Tab](/docs/passwordreset/3.3/password-reset/configuration/verification-methods.md) topics for more information.
...
[Options](/docs/passwordreset/3.3/password-reset/configuration/enrollment-settings.md#options) topic for more information.
...
[Verification Codes](/docs/passwordreset/3.3/password-reset/configuration/verification-methods.md#verification-codes) topic for more information.
...
[Resource Strings](/docs/passwordreset/3.3/password-reset/administration/html-template-customization.md#resource-strings) topic for more information.
