...
[Working with the Database](/docs/passwordreset/3.3/password-reset/administration/database-management.md) topic for additional information.

You can also move the database from SQL Server Compact to SQL Server. See the
[Working with the Database](/docs/passwordreset/3.3/password-reset/administration/database-management.md) topic for more information.
...
[Password Policy Client](/docs/passwordreset/3.3/password-policy-enforcer/configuration/password-policy-client.md)
