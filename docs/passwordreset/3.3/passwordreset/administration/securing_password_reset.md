...
server. See the [Password Reset Client](/docs/passwordreset/3.3/passwordreset/administration/password_reset_client.md) topic for more information.
...
[Moving to SQL Server](/docs/passwordreset/3.3/passwordreset/administration/moving_to_sql_server.md) topic for more information.
