...
from Netwrix Password Policy Enforcer versions older than 9.0. See the [General Tab](/docs/passwordreset/3.3/administrationoverview/configuringpasswordreset/general_tab.md)
...
[General Tab](/docs/passwordreset/3.3/administrationoverview/configuringpasswordreset/general_tab.md) topic for more information.
