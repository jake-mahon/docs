...
from Netwrix Password Policy Enforcer versions older than 9.0. See the [General Tab](/docs/passwordreset/3.3/password-reset/configuration/general-settings.md)
...
[General Tab](/docs/passwordreset/3.3/password-reset/configuration/general-settings.md) topic for more information.
