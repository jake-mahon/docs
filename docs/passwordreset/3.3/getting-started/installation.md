...
it. See the [Working with the Database](/docs/passwordreset/3.3/password-reset/administration/database-management.md) topic for additional
information.
...
[Securing Password Reset](/docs/passwordreset/3.3/password-reset/advanced/securing-password-reset.md) topic for additional information.
...
[Backing up the Database](/docs/passwordreset/3.3/password-reset/administration/database-management.md#backing-up-the-database) topic for additional
information.
...
[Using the Data Console](/docs/passwordreset/3.3/password-reset/administration/data-console.md) topic for additional information.
...
the [Editing the HTML Templates](/docs/passwordreset/3.3/password-reset/administration/html-template-customization.md) topic for additional information.
...
[Password Reset Client](/docs/passwordreset/3.3/password-reset/usage/password-reset-client.md) topic for additional information. Both server
...
the [Securing Password Reset](/docs/passwordreset/3.3/password-reset/advanced/securing-password-reset.md) topic of the Password
