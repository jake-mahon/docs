...
![using_npr_with_password_policy](/static/img/product_docs/passwordreset/passwordreset/evaluation/using_npr_with_password_policy.png)
...
![using_npr_with_password_policy_1](/static/img/product_docs/passwordreset/passwordreset/evaluation/using_npr_with_password_policy_1.png)
...
An Password Reset license does not include a Password Policy Enforcer license. See [Administration](/docs/product_docs/passwordreset/passwordpolicyenforcer/administration/administration_overview.md) in Password Policy Enforcer topic for additional information.
