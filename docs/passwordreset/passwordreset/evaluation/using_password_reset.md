...
You should install an SSL certificate on the web server when using Password Reset on a production network with real passwords. See the [Securing Password Reset](/docs/product_docs/passwordreset/passwordreset/administration/securing_password_reset.md) topic for additional information.
...
![using_npr_1_1](/static/img/product_docs/passwordreset/passwordreset/evaluation/using_npr_1_1.png)
