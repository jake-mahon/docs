...
![using_the_data_console_3](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_3.png)
...
![using_the_data_console_4](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_4.png)
...
![using_the_data_console_5](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_5.png)

Hover the mouse pointer over a column header until a small button appears on the right side of the header.

![using_the_data_console_6](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_6.png)
...
![using_the_data_console_7](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_7.png)
...
![using_the_data_console_8](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_8.png)
...
![using_the_data_console_11](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_11.png)
...
![using_the_data_console_12](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_12.png)

A drop-down button appears to the right of the filter. Click it to select a recently used filter.

![using_the_data_console_13](/img/product_docs/passwordpolicyenforcer/passwordreset/administration/using_the_data_console_13.png)
