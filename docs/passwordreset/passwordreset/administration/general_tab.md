...
__Step 9 –__ Update the backup script to copy from the new folder. See the [Working with the Database](/docs/product_docs/passwordreset/passwordreset/administration/working_with_the_database.md) topic for additional information.

You can also move the database from SQL Server Compact to SQL Server. See the [Working with the Database](/docs/product_docs/passwordreset/passwordreset/administration/working_with_the_database.md#Working-with-the-Database) topic for more information.
...
Queries to the Password Policy Server are sent to UDP port 1333 by default. You may need to create firewall rules to open this port. See the [Password Policy Client](/docs/product_docs/passwordreset/passwordpolicyenforcer/administration/password_policy_client.md#Password-Policy-Client) topic for more information.
