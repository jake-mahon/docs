...
See the [Password Reset Client](/docs/product_docs/passwordreset/passwordreset/administration/password_reset_client.md) topic for more information.
...
![using_npr](/static/img/product_docs/passwordreset/passwordreset/evaluation/using_npr_1.png)
...
![using_npr_1](/static/img/product_docs/passwordreset/passwordreset/evaluation/using_npr_1.png)

__Step 2 –__ Type a __Username__ and __Domain__, and then click __Next__.

![using_npr_2](/static/img/product_docs/passwordreset/passwordreset/administration/using_npr_2.png)
...
![using_npr_4](/static/img/product_docs/passwordreset/passwordreset/administration/using_npr_4.png)
...
__NOTE:__ The Unlock feature unlocks accounts in Active Directory. Users who are locked out of Password Reset should re-enroll to gain access to Password Reset. See the [Verification Codes](/docs/product_docs/passwordreset/passwordreset/administration/verification_tab.md#Verification-Codes) topic for more information.
...
![using_npr_10](/static/img/product_docs/passwordreset/passwordreset/administration/using_npr_10.png)

__Step 2 –__ Type a __Username__ and __Domain__, and then click __Next__.

![using_npr_11](/static/img/product_docs/passwordreset/passwordreset/administration/using_npr_11.png)
...
Validation and critical error messages are stored in the HTML templates. You can modify the default messages by editing the templates. See the [Resource Strings](/docs/product_docs/passwordreset/passwordreset/administration/editing_the_html_templates.md#Resource-Strings) topic for more information.
