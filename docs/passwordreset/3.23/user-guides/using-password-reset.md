...
See the
[Password Reset Client](/docs/passwordreset/3.23/user-guides/password-policy-client.md)
...
![using_apr](/img/versioned_docs/passwordreset_3.23/password_reset/evaluation/using_apr_1.webp)
...
[Installing and Using an SSL Certificate](/docs/passwordreset/3.23/configuration/security-settings.md#installing-and-using-an-ssl-certificate)
topic for more information.
...
[Verification Codes](/docs/passwordreset/3.23/configuration/basic-configuration.md#verification-codes)
and
[Lockout](/docs/passwordreset/3.23/configuration/basic-configuration.md#lockout)
...
[Options](/docs/passwordreset/3.23/configuration/basic-configuration.md#options)
topic for more information.
...
![using_apr_2](/img/versioned_docs/passwordreset_3.23/password_reset/administration/using_apr_2.webp)
...
[Resource Strings](/docs/passwordreset/3.23/configuration/html-templates.md#resource-strings)
topic for more information.
