...
- Random verification codes can be sent to users by e-mail and SMS. Users must enter the code to
  ...
  [Verification Tab](/docs/passwordreset/3.23/administration/configuring_password_reset.md#verification-tab)
...
- Users are automatically deleted from the database approximately one week after they are deleted
  ...
  [Deleting Users](/docs/passwordreset/3.23/administration/using_the_data_console.md#deleting-users)
  topic for more information.
- Can enforce the Active Directory password history and minimum age policies for password resets.
  See the
  [Reset Policies](/docs/passwordreset/3.23/administration/configuring_password_reset.md#reset-policies)
  topic for more information.
...
- E-mail alerts are sent in the user's preferred language if possible. The preferred language is set
  ...
  [Triggers](/docs/passwordreset/3.23/administration/configuring_password_reset.md#triggers)
  topic for more information.
- Can send all Password Policy Enforcer queries to a specific Password Policy Server. See the
  [Netwrix Password Policy Enforcer](/docs/passwordreset/3.23/administration/configuring_password_reset.md#netwrix-password-policy-enforcer)
  topic for more information.
...
- REST API to remind (or require) users to enroll. See the
  [Persuading Users to Enroll](/docs/passwordreset/3.23/administration/persuading_users_to_enroll.md)
  topic for more information.
- Page content and layout changes for small mobile phone screens. See the
  [Responsive Content](/docs/passwordreset/3.23/administration/editing_the_html_templates.md#responsive-content)
  topic for more information.
- Icons are in Scalable Vector Graphics (SVG) format. These look sharper when resized, and make it
  ...
  [Change Icon Colors](/docs/passwordreset/3.23/administration/editing_the_html_templates.md#change-icon-colors)
  topic for more information.
...
- .xlsx and .xml export file formats. See the
  [Exporting Data](/docs/passwordreset/3.23/administration/using_the_data_console.md#exporting-data)
  topic for more information.
- Filter icons shown in column headers. See the
  [The Filter Row](/docs/passwordreset/3.23/administration/using_the_data_console.md#the-filter-row)
  topic for more information.
