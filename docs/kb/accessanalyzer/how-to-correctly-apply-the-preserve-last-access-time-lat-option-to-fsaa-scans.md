...
For more information, please see the following article: /docs/auditor/10.8/addon/admin-guide/datacollector/fsaa/defaultscopingoptions (Scan Settings Tab).

## Related Articles

- /docs/auditor/10.8/addon/admin-guide/datacollector/fsaa/defaultscopingoptions (Scan Settings Tab)
