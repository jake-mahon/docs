...
1. Resolution 1
   ...
   For additional information on how to import previously collected data, refer to the following article: Investigations (/docs/auditor/10.5/auditor/admin-guide/settings).
