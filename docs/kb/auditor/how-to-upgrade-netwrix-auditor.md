...
For the text version of the guide, refer to the following documentation article: /docs/auditor/10.8/install
...
- Upgrade to the Latest Version ⸱ 10.7 — /docs/auditor/10.8/install
