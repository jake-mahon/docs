...
- To manually install SharePoint Core Service, refer to the following article: /docs/auditor/10.8/installation (Installation − Install for SharePoint Core Service · v10.6).
