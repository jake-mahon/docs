...
Verify the firewall settings in your environment. For additional information on ports required for SQL Server monitoring, see SQL Server – SQL Server Ports · v10.7: /docs/auditor/10.8/configuration/sqlserver/overview
...
- SQL Server – SQL Server Ports · v10.7: /docs/auditor/10.8/configuration/sqlserver/overview
