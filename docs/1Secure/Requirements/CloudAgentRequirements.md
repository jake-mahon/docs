...
You must also open the outbound TCP port 443 on the server where the Netwrix Cloud Agent resides. See the [Install Agent](../Install/InstallAgent.md "Install Agent") topic