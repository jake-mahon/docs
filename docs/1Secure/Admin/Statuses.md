...
![](/img/1secure/admin/Statuses_Chart.png)
...
You can also review the agent status while adding the organization. See the [Manage Organizations](Organizations/Overview.md "Manage Organizations") topic for more information.