...
- View the alerts generated for an organization on the Netwrix 1Secure dashboard. See the [1Secure Dashboard](../Dashboard/Overview.md "1Secure Dashboard") topic for additional information.
...
![Alerts List within an alert profile](/img/1secure/admin/AlertsList.png "Alerts List within an alert profile")
...
![New Alert Pane](/img/1secure/admin/AddCustomAlert.png "New Alert Pane")

**Step 4 –** Select a custom report from the Report drop-down menu to trigger the alert when a new record is generated for the report. See the  [Custom Reports](../SearchAndReports/CustomReports.md "Custom Reports") topic for additional information.
...
**Step 4 –** Modify the required information. See the [Add a Custom Alert](#add-a-custom-alert "Add a Custom Alert") topic, starting from Step 4 for additional information.
