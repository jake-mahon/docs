...
![Alert Profiles List](/img/1secure/admin/AlertsProfiles.png "Alert Profiles List")
...
![New Alert Profile pane](/img/1secure/admin/AddAlertProfile.png "New Alert Profile pane")

**Step 3 –** Enter a name for the alert profile in the Name field and click **Save**.

The alert profile is added to the list. You can:

- Assign this profile to an organization. You can do this when creating a new organization or editing an organization. See the [Add Organizations](../Organizations/AddOrganizations.md "Add Organizations") topic for additional information.
...
You may also link to a third-party ticketing system. See the [Third-party systems](../../Integration/Overview.md "Third-party systems") topic for additional information.