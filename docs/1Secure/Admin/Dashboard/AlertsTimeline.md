...
![Alerts Timeline Page](/img/1secure/admin/AlertsTimeline.png "Alerts Timeline Page")
...
- Activity Records – Click the Activity Records link for an alert to navigate to the Activity page, where you can view a detailed report for that alert type. See the [Activity Reports](../SearchAndReports/Activity.md "Activity Reports") topic for additional information.
