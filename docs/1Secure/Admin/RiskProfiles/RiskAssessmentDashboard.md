...
*Remember,* each organization has a risk profile associated with it and the risk analysis of an organization is based on the metrics included in the risk profile. See the [Manage Risk Profiles](RiskProfiles.md "Manage Risk Profiles") topic for additional information.
...
![Risk Assessment Dashboard](/img/1secure/admin/RiskAssessmentDashboard.png "Risk Assessment Dashboard")
...
*Remember,* each risk is basically a metric included in the risk profile associated with the organization. See the [Risk Metrics List](Metrics List.md "Risk Metrics List") topic for details on each of the risk metrics.
...
![Risks List](/img/1secure/admin/Dashboard_RisksList.png "Risks List")
...
![Enumerated Risk Details pane](/img/1secure/admin/Dashboard_RiskDetails.png "Enumerated Risk Details pane")
...
- Open Report – Click this button to navigate to the State In Time Risk Reports page, where you can view a detailed report for that risk metric. See the [State In Time Risks Reports](../SearchAndReports/StateInTime.md "State In Time Risks Reports") topic for additional information.
...
![Boolean Risk Details pane](/img/1secure/admin/BooleanRiskDetails.png "Boolean Risk Details pane")
...
![Exporting Risk Assessment pane](/img/1secure/admin/Export_RiskAssessment.png "Exporting Risk Assessment pane")
...
**Step 2 –** Click **Subscribe** in the upper right corner; the Subscription to ``` Risk Assessment pane is displayed. See the [Add a Subscription](../SearchAndReports/OrganizationGroups.md#add-a-subscription "Add a Subscription") topic for additional information on adding a subscription, starting at Step 6. Remember to select the Include Low Risks check box if you want to include low risks in the report.