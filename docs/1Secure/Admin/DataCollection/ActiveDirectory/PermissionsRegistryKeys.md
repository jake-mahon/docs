---
id: permissionsregistrykeys
title: '[anchor:kanchor6]Assigning Permission To Read the Registry Key'
---

Assigning Permission To Read the Registry Key

# <span id="kanchor6"></span>Assigning Permission To Read the Registry Key
...
**Step 1 –** In the left pane, navigate to *HKEY_LOCAL_MACHINE\SYSTEM\CurrentControl Set\Services\EventLog\Security*.
...
For auditing Logon Activity, you also need to assign the Read permission to the *HKEY_LOCAL_MACHINE\SECURITY\Policy\PolAdtEv* registry key.
