...
![Subscription to Report pane](/img/1secure/admin/Subscriptions.png "Subscription to Report pane")
...
- Variables – Select variable(s) to customize the subject line of the email. To use multiple variables, select them one by one from the drop-down menu. The available options are: Report Name, Export Date, Frequency, Num Records, Managing Organization, and Managed Organization.
  ...
  ![Email Subject](/img/1secure/admin/Subscriptions_2.png "Email Subject")
...
**NOTE:**  If you encounter the message, Integration required, you must first configure your integration for SharePoint Online. See the [SharePoint Online](../../Integration/SharePointOnline.md "SharePoint Online") topic for additional information.
...
![Organization Subscriptions Page](/img/1secure/admin/Subscriptions_3.png "Organization Subscriptions Page")

**Step 5 –**  Click the Edit icon for a subscription to modify it. The Subscription to  pane is displayed.

**Step 6 –** Modify the required information. For details, refer to Steps 6 through 12 in the [Add a Subscription](#add-a-subscription "Add a Subscription") topic.
