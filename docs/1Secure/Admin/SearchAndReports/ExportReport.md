...
![Roports - Export option](/img/1secure/admin/ExportReport.png "Roports - Export option")
...
**Step 3 –** Define a filter criteria, then click **Search** to generate the investigation results based on it. See the [Apply Filters](ApplyFilters.md "Apply Filters") topic for additional information.
