...
![Configure Source Details (Step 2 of 3) pane](/img/1secure/admin/ConfigSourceDetails(Step2of3).png "Configure Source Details (Step 2 of 3) pane")
...
![Choose New Connector (Step 3 of 3) pane](/img/1secure/admin/Computer_ChooseConnector.png "Choose New Connector (Step 3 of 3) pane")

**Step 9 –** The Choose new connector pane (Step 3 of 3) lists one connector for computer. Specify the following:

- File Server Activity – Toggle the **File Server Activity** switch to ON to collect and monitor data for this connector. With this, you can generate activity reports on File Server data. See the [File Server](../../SearchAndReports/Activity.md#file-server "File Server") topic for additional information.
