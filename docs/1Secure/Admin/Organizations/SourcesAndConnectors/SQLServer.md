...
![Configure Source Details (Step 2 of 3) pane](/img/1secure/admin/ConfigureSourceDetails(Step2-3)a.png "Configure Source Details (Step 2 of 3) pane")
...
![Choose New Connector (Step 3 of 3) pane](/img/1secure/admin/ChooseNewConnector(Step3of3).png "Choose New Connector (Step 3 of 3) pane")

**Step 9 –** The Choose new connector (Step 3 of 3) pane lists one connector for SQL Server. Toggle the **SQL Logons** switch to ON to collect and monitor data for this connector. With this, you can generate logon reports on SQL Server data. See the [SQL Database](../../SearchAndReports/Activity.md#sql-database "SQL Database") topic for additional information.
