...
![](/img/1secure/admin/Organization_Adding.png)
...
![](/img/1secure/admin/AddOrganizationsSelectDataSource.png)
...
**NOTE:**  See the [Sources and Connectors](SourcesAndConnectors/Overview.md "Sources and Connectors")  topic for detailed information.

![](/img/1secure/admin/AddOrganizationsSites.png)
...
See the [Add Sites to an Organization](AddSites.md "Add Sites to Organization") topic for additional information.

![](/img/1secure/admin/AddOrganizationsAgent.png)

**Step 5 –** On the Configure source details (Step 3 of 4) window, follow the instructions to install the agent. Please go to the [Install Agent](../../Install/InstallAgent.md "Install Agent")topic of the online help. Click **Next**.
...
![](/img/1secure/admin/AddOrganizationsSourceDetails.png)

![](/img/1secure/admin/AddOrganizationsSourcesAndConnectors.png)

**Step 7 –** On the Choose new connector (Step 4 of 4) window, add the connectors for your sources on. See the [Sources and Connectors](SourcesAndConnectors/Overview.md "Sources and Connectors")  topic for additional information.
