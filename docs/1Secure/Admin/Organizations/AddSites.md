...
**Step 1 –** Add your organization or add a source to the created organization. See the [Add Organizations](AddOrganizations.md "Add Organizations") topic for additional information.

**NOTE:** You can add sites only for on-prem sources - Active Directory and Computer. These sources require an installation of the agent. See the [Add a Source and Connectors for Active Directory](SourcesAndConnectors/ActiveDirectory.md "Add an Active Directory Source and Connectors") or [Add a Source and Connectors for Computer](SourcesAndConnectors/Computer.md "Add a Computer Source and Connectors")topic for additional information.

![](/img/1secure/admin/AddSourcesSite.png)
...
**Step 3 –** Finish adding a source for your organization. See the [Add a Source and Connectors for Active Directory](SourcesAndConnectors/ActiveDirectory.md "Add a Source and Connectors for Active Directory") or [Add a Source and Connectors for Computer](SourcesAndConnectors/Computer.md "Add a Source and Connectors for Computer") topic for additional information.
...
![](/img/1secure/admin/SitesDropdown.png)

**Step 3 –** Finish adding the source. Screens will vary depending on the source added. See the [Add a Source and Connectors for Active Directory](SourcesAndConnectors/ActiveDirectory.md "Add an Active Directory Source and Connectors") or [Add a Source and Connectors for Computer](SourcesAndConnectors/Computer.md "Add a Computer Source and Connectors")topic for additional information.
...
![](/img/1secure/admin/UpdateAgents2.png)

**Step 2 –** View the following details:

- Agent status – Agent status in color. See the [Statuses](../Statuses.md "Statuses") topic for additional information
