...
**Step 4 –**  Complete the [Install the Agent](#install-the-agent "Install the Agent") steps. Ensure you tick Launch Netwrix Cloud Agent Configuration tool and click Finish.

![](/img/1secure/install/Organization_CloudAgent.png)

**Step 5 –** On the displayed Netwrix Cloud Agent Configuration screen, select Configure to configure with Netwrix Cloud Agent.

![](/img/1secure/install/InstallAgent_CopyAgent.png)
...
![](/img/1secure/install/CloudAgent_CopyAgent.png)
...
![](/img/1secure/install/Organization_CloudAgentSetup1.png)

**Step 3 –** Click **Next** to continue.

![](/img/1secure/install/InstallNetwrixCloudAgent.png)

**Step 4 –** Specify the installation folder and click **Next** to continue.

![](/img/1secure/install/InstallAgentNetwrixCloudAgentReady.png)

**Step 5 –** Click **Install**. The agent starts the installation process.

![](/img/1secure/install/InstallAgentNetwrixCloudAgentInstalling.png)

![](/img/1secure/install/InstallAgentNetwrixCloudAgentFinish.png)
