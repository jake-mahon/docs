...
![Edit Notes window showing note entry field](/img/product_docs/accessinformationcenter/access/general/editnotes.png)

__Step 2 –__ Type or edit the note in the textbox.

__Step 3 –__ Click OK when finished. The Edit Notes window closes.
