...
The Cancel Request wizard is opened with the __Cancel__ button on the [Pending Requests Tab](../interface.md#pending-requests-tab) of the Access Requests interface.
