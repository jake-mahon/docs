...
Select the desired request on the [Request History Tab](../interface.md#request-history-tab) of the
...
See the [Data Grid Features](../../../general/datagrid.md) topic for additional information.
