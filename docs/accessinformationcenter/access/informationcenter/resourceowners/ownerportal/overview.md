...
- [Actions Panel](/docs/accessinformationcenter/access/informationcenter/resourceowners/ownerportal/actionspanel.md) — provides access to the Resource Reviews and Self-Service Access Requests workflow features
