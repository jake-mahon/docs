...
[Add New Resource Wizard](wizard/add.md) or the [Update Resource Wizard](wizard/update.md).
...
[Select Group Window](window/selectgroup.md). If no groups are listed that means the Access
...
[Commit Active Directory Changes](../admin/additionalconfig/commitchanges.md) topic for additional
information.
