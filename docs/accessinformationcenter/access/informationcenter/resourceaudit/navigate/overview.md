...
the [Data Grid Features](../../../general/datagrid.md) topic for additional information on table
...
- Highlight Active Permissions – Select to show permissions that are in use. When a user or
  ...
  [Stale Permissions](../filesystem/sharesubfolder/permissions.md#stale-permissions) topic for
