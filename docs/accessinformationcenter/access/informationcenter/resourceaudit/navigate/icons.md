...
| ![File icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/file.png) | File |
| ![Permission Change icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/permissionchange.png) | Permission Change |
| ![Exception icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/exception.png) | Exception |
| ![SharePoint icon](/img/product_docs/activitymonitor/activitymonitor/admin/outputs/sharepoint.png) | SharePoint |
| ![Web Application icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/webapplication.png) | Web Application |
| ![Site Collection icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/sitecollection.png) | Site Collection |
| ![OneDrive icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/onedrive.png) | OneDrive |
| ![Web Application Url icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/webapplicationurl.png) | Web Application Url |
| ![Site icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/site.png) | Site |
...
| ![Office 365 icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/office365.png) | Office 365 |
| ![Salesforce icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/salesforce.png) | Salesforce |
...
| ![User/Schema icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/schemauser.png) | User or Schema |
...
| Icon | Description |
| --- | --- |
| ![Unknown icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/unknowntrustee.png) | Unknown |
| ![Security/Domain Principal icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/principal.png) | Security Principal or Domain Principal |
| ![User icon](/img/product_docs/activitymonitor/activitymonitor/admin/search/query/user.png) | User – Local, Domain, SharePoint, or Unix |
| ![Group icon](/img/product_docs/changetracker/changetracker/integration/splunk/group.png) | Group – Local, Domain, SharePoint, or Unix |
| ![Unsupported icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/unsupported.png) | Unsupported |
| ![Service Account icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/serviceaccount.png) | Service Account |
| ![Computer icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/computer.png) | Computer |
| ![Azure Contact icon](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/navigate/azurecontact.png) | Azure Contact |
