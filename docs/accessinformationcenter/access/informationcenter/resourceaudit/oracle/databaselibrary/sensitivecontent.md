...
![Sensitive Content report at the database and library level](/static/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/postgresql/databasetable/databasesensitivecontent.png)
