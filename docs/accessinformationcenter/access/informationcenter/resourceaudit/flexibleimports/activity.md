...
The Activity report for imported data displays activity on the resource during the selected date range. The __Include Subfolders__ option is active by default until removed. See the [Results Pane](../navigate/overview.md#results-pane) topic for information on changing this option.
