...
![Scan Summary report at the on-premise farm and online instance levels](../../../../../../../static/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/sharepoint/farminstance/instancescansummary.webp)
...
- Web Application
  ...
  - Online instance – Reflects the main nodes in the resource tree. The value is either __Personal__, __Public__, or __SharePoint__.
- Site Collection

  - On-premises farm – Display name of the site collection
  - Online instance – Display types of site collections

    - Personal – Resources found under the __OneDrive for Business__ node
    - Public – Resources found under the __Public__ node
