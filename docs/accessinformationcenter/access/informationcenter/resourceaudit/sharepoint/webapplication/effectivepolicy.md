...
![Effective Policy report at the web application and web application URL levels](/static/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/sharepoint/webapplication/webappeffectivepolicy.png)
...
To view the granular rights granted through SharePoint permission levels (SharePoint Roles), see the __Roles__ column in the [Permissions Report](/docs/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/sharepoint/sitecollections/permissions.md). For additional detail on what permissions each SharePoint Role grants, see the __Permission Mask__ column in the [Site Collection Roles Report](/docs/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/sharepoint/sitecollections/sitecollectionroles.md).
