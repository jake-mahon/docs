...
![Share Activity Summary report at the server level](/static/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/filesystem/server/servershareactivitysummary.png)
