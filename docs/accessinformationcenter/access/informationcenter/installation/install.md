...
![AIC Setup Wizard SQL Server Connection page](/img/product_docs/accessanalyzer/enterpriseauditor/install/application/sqlserver.webp)
...
![AIC Setup Wizard Configure Web Server page](/img/product_docs/accessanalyzer/enterpriseauditor/admin/action/survey/webserver.webp)
