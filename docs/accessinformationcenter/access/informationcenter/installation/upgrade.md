...
To upgrade the Access Information Center application to a newer version, simply run the new ```AccessInformationCenter.msi``` executable. You do not need to uninstall the existing version. See the [Install the Access Information Center](/docs/product_docs/accessinformationcenter/access/informationcenter/installation/install.md) topic for additional information.
