...
![Delegation of Control wizard showing the Users or Groups page](/static/img/product_docs/accessinformationcenter/access/informationcenter/admin/troubleshooting/delegatecontrolwizarduser.png)

__Step 2 –__ Navigate to the Users or Groups page. Click __Add__. Enter the Active Directory service account. Click __Next__.

![Delegation of Control wizard showing the Tasks to Delegate page](/static/img/product_docs/accessinformationcenter/access/informationcenter/admin/troubleshooting/delegatecontrolwizardtask.png)
