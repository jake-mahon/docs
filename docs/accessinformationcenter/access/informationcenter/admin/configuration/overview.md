...
- [Active Directory Page](activedirectory.md) – Configure the Active Directory service account used to add console users. Optionally, enable the Access Information Center to commit changes in Active Directory.
...
- [License Page](license.md) – View license details and upload a new license
- [Notifications Page](notifications.md) – Configure the SMTP server, email security settings, notification options, and owner reminder settings
