...
- Trustee Name — Name of the trustee. If the trustee is a group, click the hyperlink to open the Group Membership window. See the [Group Membership Window](/docs/accessinformationcenter/access/general/groupmembership.md#Group-Membership-Window) topic for additional information.
