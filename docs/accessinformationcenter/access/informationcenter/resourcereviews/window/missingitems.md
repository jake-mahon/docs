...
![Some items could not be found dialog](/img/product_docs/accessinformationcenter/access/informationcenter/resourcereviews/window/missingitemsmessage.png)

Click __Yes__ to open the Missing Items window or click __No__ to complete the import without viewing the missing items.

![Missing items window](/img/product_docs/accessinformationcenter/access/informationcenter/resourcereviews/window/missingitems.png)
