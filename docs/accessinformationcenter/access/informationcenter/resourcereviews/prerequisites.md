...
Sensitive Data reviews of file system data requires the following setting be configured in the __FileSystem__ > __0.Collection__ Job Group in Netwrix Access Analyzer (formerly Enterprise Auditor):
...
In order to view the potentially sensitive data during a review, the following setting must also be configured in the __FileSystem__ > __0.Collection__ Job Group in Netwrix Access Analyzer (formerly Enterprise Auditor):
...
See the [Access Groups](/docs/product_docs/accessinformationcenter/access/informationcenter/resourceowners/accessgroups.md) topic for additional information.
