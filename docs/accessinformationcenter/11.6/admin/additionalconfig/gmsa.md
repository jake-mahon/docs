...
![Netwrix Access Information Center service properties window](/img/product_docs/accessinformationcenter/11.6/admin/additionalconfig/gmsaserviceproperties.webp)
...
![Use the windows account running this service option on Database Configuration page](/img/product_docs/accessinformationcenter/11.6/admin/additionalconfig/gmsadatabaseconfiguration.webp)
