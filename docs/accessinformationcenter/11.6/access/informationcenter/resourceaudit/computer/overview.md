...
[Resource Audit Interface](/docs/accessinformationcenter/11.6/access/informationcenter/resourceaudit/navigate/resource.md) topic
for additional information.
...
- Activity Statistics – Statistics reports show the count of operation events performed for the
  ...
  [Activity Statistics Report](/docs/accessinformationcenter/11.6/access/informationcenter/resourceaudit/computer/activitystatistics.md) topic
  for additional information.
- Activity Details – Details reports show the specific operation events that occurred for the
  ...
  [Activity Details Report](/docs/accessinformationcenter/11.6/access/informationcenter/resourceaudit/computer/activitydetails.md) topic
  for additional information.
