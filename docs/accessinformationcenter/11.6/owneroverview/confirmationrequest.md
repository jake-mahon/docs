...
![Ownership Confirmation Request Email with Yes and No buttons for responding](/img/product_docs/accessinformationcenter/11.6/resourceowners/email/confirmationrequestemail.webp)
...
![Ownership accepted browser message](/img/product_docs/accessinformationcenter/11.6/resourceowners/email/emailresponseconfirmed.webp)
...
![Ownership declined browser message](/img/product_docs/accessinformationcenter/11.6/resourceowners/email/emailresponsedeclined.webp)

Enter your suggestion for possible owners in the textbox, and then click **Submit** to complete the
process.

![emailresponsedeclined2](/img/product_docs/accessinformationcenter/11.6/resourceowners/email/emailresponsedeclined2.webp)
