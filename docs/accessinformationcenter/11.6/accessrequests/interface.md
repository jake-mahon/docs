...
![Access Requests interface Pending Requests tab](/img/product_docs/accessinformationcenter/11.6/accessrequests/interfacepending.webp)
...
![Pending Requests tab buttons](/img/product_docs/accessinformationcenter/11.6/accessrequests/interfacependingbuttons.webp)
...
| Cancel         | Opens the Cancel Request wizard. See the [Cancel Request Wizard](/docs/accessinformationcenter/11.6/accessrequests/wizard/cancel.md) topic for additional information.                |
...
![Access Requests interface Request History tab](/img/product_docs/accessinformationcenter/11.6/accessrequests/interfacehistory.webp)
...
![Request History tab buttons](/img/product_docs/accessinformationcenter/11.6/accessrequests/interfacehistorybuttons.webp)

| Button       | Description                                                                                                                                                                                                                                      |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| View Changes | Opens the Changes window to view all access changes for the selected trustee. See the [Changes Window](/docs/accessinformationcenter/11.6/accessrequests/window/changes.md) topic for additional information. |
| View Notes   | Opens the View Notes window for the selected request. Clicking on the Notes icon in the table will also open the View Notes window. Click **OK** to close the window.                                                                            |
