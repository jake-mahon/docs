...
[User Access Request Email](/docs/accessinformationcenter/11.6/accessrequests/email/request.md)
topic for additional information.

You can also process access requests through the Owner portal.

![Access Requests link in Owners Portal](/img/product_docs/accessinformationcenter/11.6/accessrequests/owners/ownersportal.webp)
...
- Pending Requests – Shows any pending access requests waiting on your approval. See the
  [Pending Access Requests](/docs/accessinformationcenter/11.6/accessrequests/owners/pendingrequests.md)
  topic for additional information.
...
[Access Request Reminder Email](/docs/accessinformationcenter/11.6/accessrequests/email/reminder.md)
topic for additional information.
