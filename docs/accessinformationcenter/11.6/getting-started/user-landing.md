...
[Enable Console Users](/docs/accessinformationcenter/11.6/getting-started/overview.md#enable-console-users)
...
![Administrator user home page](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeadmin.webp)
...
![Home page for Security Team role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homesecurityteam.webp)
...
![Home page for Reader role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homereader.webp)
...
![Home page for Data Privacy role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homedataprivacy.webp)
...
![Home page for User Access Administrator role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeuseraccessadmin.webp)
...
![Home page for Resource Owner with no assigned role](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeresourceowner.webp)
...
![Home page for user with no User Role or Resource Ownership](/img/versioned_docs/accessinformationcenter_11.6/access/informationcenter/admin/homeyouraccess.webp)
