...
![Activity Statistics report at the server level](/img/product_docs/accessinformationcenter/11.6/resourceaudit/filesystem/server/serveractivitystatistics.webp)
