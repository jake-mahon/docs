...
![Sensitive Content report at the database and table levels](/img/product_docs/accessinformationcenter/11.6/resourceaudit/sql/databasetable/databasesensitivecontent.webp)
