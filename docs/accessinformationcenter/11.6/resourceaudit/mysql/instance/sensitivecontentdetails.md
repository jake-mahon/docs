...
![Sensitive Content Details report at the instance level](/img/product_docs/accessinformationcenter/11.6/resourceaudit/mysql/instance/instancesensitivecontentdetails.webp)
