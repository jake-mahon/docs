...
![Select trustee on Effective Access report](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/effectiveaccessreport.webp)
...
![Select Group in Group Membership pane of Effective Access report](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/effectiveaccessreportgroup.webp)
...
![Group Membership pane](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/groupmembershippane.webp)

**Step 4 –** Click the **Change Group Membership** button on the Group Membership pane. The Group
Membership Changes window opens.

![Group Membership Changes window](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/groupmembershipchanges.webp)
...
![Add Membership Change wizard Select Group page](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangeselectgroup.webp)

**Step 6 –** On the Select Group page, the selected group is displayed. You can search to select a
different group. Click **Next**.

![Add Membership Change wizard Change Type page](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangetype.webp)
...
![Add Membership Change wizard Add Members page](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangeaddmembers.webp)
...
![Add Members page User Name table](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangememberadded.webp)
...
![Add Membership Change wizard Remove Members page](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/addmembershipchangeremovemembers.webp)
...
![Members selected for removal window](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/membersforremoval.webp)
...
![Group Membership Changes window with changes to be modeled](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/groupmembershipchangesstaged.webp)
...
![Effective access changes illustration](/img/product_docs/accessinformationcenter/11.6/resourceaudit/changemodeling/modeledchanges.webp)
