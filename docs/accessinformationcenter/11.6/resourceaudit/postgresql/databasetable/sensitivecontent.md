...
![Sensitive Content report at the database and table level](/img/product_docs/accessinformationcenter/11.6/resourceaudit/postgresql/databasetable/databasesensitivecontent.webp)
