...
![Sensitive Data Resource Review Make changes page](/img/product_docs/accessinformationcenter/12.0/resourcereviews/review/reviewpagesensitivedata.webp)
...
- Criteria – Name of the criteria with match hits found within the file. The hyperlink opens the
  Criteria Matches window. See the [Criteria Matches Window](/docs/accessinformationcenter/12.0/resourcereviews/window/criteriamatches.md) topic for
...
![Sensitive Data review Review changes tab](/img/product_docs/accessinformationcenter/12.0/resourcereviews/review/reviewpagesensitivedata2.webp)
