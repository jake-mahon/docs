...
![Membership review Make changes tab](/img/product_docs/accessinformationcenter/12.0/resourcereviews/review/reviewpagemembership.webp)
...
- Trustee Name — Name of the trustee with group membership. If the trustee is a group, click the
  ...
  [Group Membership Window](/docs/accessinformationcenter/12.0/general/groupmembership.md) topic for additional information.
...
![Membership review Review changes tab](/img/product_docs/accessinformationcenter/12.0/resourcereviews/review/reviewpagemembership2.webp)
