...
[Manage Reviews Page](/docs/accessinformationcenter/12.0/resourcereviews/interface.md#manage-reviews-page) topic for additional information.

![Edit Review wizard](/img/product_docs/accessinformationcenter/12.0/resourcereviews/wizard/reviewtype.webp)
...
![Edit Review wizard Review Type page](/img/product_docs/accessinformationcenter/12.0/resourcereviews/wizard/reviewtype.webp)
...
- Notify the review creator when resources are reviewed — When selected, an email is sent to the
  ...
  [Resource Reviewed Email](/docs/accessinformationcenter/12.0/resourcereviews/email/resourcereviewed.md) topic for additional information.
...
- Select the desired resource(s) and click **Add**. The **View Selections** button indicates how
  ...
  [Selected Resources Window](/docs/accessinformationcenter/12.0/resourcereviews/window/selectedresources.md) topic for additional information.
- Alternatively you can import a list of resources from a CSV file. Click the **Import** button and
  ...
  [Missing Items Window](/docs/accessinformationcenter/12.0/resourcereviews/window/missingitems.md) topic for additional information
