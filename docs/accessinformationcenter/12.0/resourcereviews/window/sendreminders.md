...
The Send Reminders window opens from the [Manage Reviews Page](/docs/accessinformationcenter/12.0/resourcereviews/interface.md#manage-reviews-page)
...
![Send Reminders window](/img/product_docs/accessinformationcenter/12.0/resourcereviews/window/sendreminders.webp)
