...
- Active Directory service account – At a minimum, Access Information Center login authentication
  ...
  [Active Directory Page](/docs/accessinformationcenter/12.0/administration/configuration/active-directory.md) topic for additional
  information.
...
See the [Commit Active Directory Changes](/docs/accessinformationcenter/12.0/administration/advanced-configuration/commit-changes.md) topic for
...
See the [Upgrade Procedure](/docs/accessinformationcenter/12.0/installation/upgrade-guide.md) topic for additional information.
