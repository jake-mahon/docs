...
![Sensitive Content Summary report at the instance level](/img/product_docs/accessinformationcenter/12.0/resourceaudit/mysql/instance/instancesensitivecontentsummary.webp)
