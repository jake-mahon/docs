...
![Sensitive Content report at the database and table level](/img/product_docs/accessinformationcenter/12.0/resourceaudit/mysql/databasetables/databasesensitivecontent.webp)
