...
![Sensitive Content report at the database and table levels](/img/product_docs/accessinformationcenter/12.0/resourceaudit/sql/databasetable/databasesensitivecontent.webp)
