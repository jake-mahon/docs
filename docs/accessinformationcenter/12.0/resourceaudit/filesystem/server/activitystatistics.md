...
![Activity Statistics report at the server level](/img/product_docs/accessinformationcenter/12.0/resourceaudit/filesystem/server/serveractivitystatistics.webp)
