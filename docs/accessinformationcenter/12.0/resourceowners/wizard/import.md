...
Owner Ad Hoc changes. See the [Update Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/update.md) topic for additional information.
...
[Update Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/update.md) topic for information on making alterations to the imported
resources.
