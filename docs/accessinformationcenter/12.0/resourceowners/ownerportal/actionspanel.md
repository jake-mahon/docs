...
- Reviews — Opens the Reviews page. If any of your resources have pending reviews, a count of
  ...
  [Owners & Resource Reviews](/docs/accessinformationcenter/12.0/resourcereviews/pendingreviews.md) topic for additional
  information.
...
- Access Requests — Opens the Access Requests page. If any of your resources have pending access
  ...
  [Owners & Access Requests](/docs/accessinformationcenter/12.0/accessrequests/owners/overview.md) topic for additional
  information.
- My Access — Opens the Your Access portal. The Your Access portal allows you to see your existing
  ...
  [Your Access Portal Overview](/docs/accessinformationcenter/12.0/accessrequests/youraccessportal/overview.md) topic for
