...
The Select Group window opens from either the [Add New Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/add.md) or the
[Update Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/update.md).

![Select Group window](/img/product_docs/accessinformationcenter/12.0/resourceowners/window/selectgroup.webp)
