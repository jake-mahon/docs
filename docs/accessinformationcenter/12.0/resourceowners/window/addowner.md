...
The Add Owner window opens from either the [Add New Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/add.md) or the
[Update Resource Wizard](/docs/accessinformationcenter/12.0/resourceowners/wizard/update.md). Choose between:
