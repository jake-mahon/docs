...
![Configuration interface showing the License page](/img/product_docs/accessinformationcenter/12.0/admin/configuration/license.webp)
...
![Complete window confirming new license is uploaded](/img/product_docs/accessinformationcenter/12.0/admin/configuration/licenseupdated.webp)
