...
![Response Server Host Name parameter in config file](/img/product_docs/accessinformationcenter/12.0/admin/additionalconfig/configfileresponseservername.webp)
