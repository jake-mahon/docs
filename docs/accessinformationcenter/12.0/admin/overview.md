...
- [Navigation](/docs/accessinformationcenter/12.0/admin/navigate.md)
...
- Instructions on how different users access the application (see the [URL & Login](/docs/accessinformationcenter/12.0/admin/login.md) topic)
