...
![Desktop Icon](/img/product_docs/accessinformationcenter/12.0/admin/desktopicon.webp)
...
![Change Administrator Password propmt](/img/product_docs/accessinformationcenter/12.0/admin/changeadminpassword.webp)
...
![Home page for the Builtin Admin account on first launch](/img/product_docs/accessinformationcenter/12.0/admin/builtinadminhome.webp)
...
[URL & Login](/docs/accessinformationcenter/12.0/admin/login.md) topic for information on how users will log in and where they are directed
after login.

See the [Navigation](/docs/accessinformationcenter/12.0/admin/navigate.md) topic for information on each of the interfaces and portals
