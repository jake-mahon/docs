...
| Report                                                                                                                  | Description                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/databases/mysql.md)                           | Shows the permissions for the trustee on the selected resource.                                                                                                                                                                                                                                                                                                                                    |
...
- [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/databases/mysql.md)
