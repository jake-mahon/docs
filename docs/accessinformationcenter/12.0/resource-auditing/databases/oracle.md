...
| Report                                                                                                                  | Description                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/databases/oracle.md)                          | Shows the permissions for the trustee on the selected resource.                                                                                                                                                                                                                                                                                                                                    |
...
- [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/databases/oracle.md)
...
![Permissions report at the database and library level](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/postgresql/databasetable/databasepermissions.webp)
