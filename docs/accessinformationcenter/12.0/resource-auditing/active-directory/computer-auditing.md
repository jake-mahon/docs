...
by searching for computer objects on the Home page. See the [Search Features](/docs/accessinformationcenter/12.0/resource-auditing/search-and-filters.md)
...
[Resource Audit Interface](/docs/accessinformationcenter/12.0/resource-auditing/navigation-guide.md) topic for additional information.
...
- Activity Statistics – Statistics reports show the count of operation events performed for the
  ...
  [Activity Statistics Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md) topic for additional information.
- Activity Details – Details reports show the specific operation events that occurred for the
  ...
  [Activity Details Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md) topic for additional information.
...
| Report                                                                                                                   | Description                                                                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Activity Details Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)    | Provides details on every activity event logged by the audited computer during the selected date range. This report includes a Permission Changes table.                                                                                                           |
| [Activity Statistics Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md) | Provides statistical activity event information for the audited computer during the selected date range. This report includes a line graph for Traffic Trend.                                                                                                      |
| [Attribute Changes Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)   | Provides specific details for every attribute change to the audited computer that was logged during the selected date range.                                                                                                                                       |
| [Effective Access Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)    | Provides insight into every resource the audited computer has access to and what level of access has been granted. Effective access is a calculation based on several variables according to the type of resource. This report includes a Permission Source table. |
| [Member Of Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)           | Provides a list of all groups of which the audited computer is a member. This report includes a Membership Paths table.                                                                                                                                            |
| [Object Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)  | Provides details on Active Directory permissions to the object.                                                                                                                                                                                                    |
| [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/computer-auditing.md)         | Provides a list of all resources where the audited computer has been assigned permissions.                                                                                                                                                                         |
...
the Access Information Center user. See the [Results Pane](/docs/accessinformationcenter/12.0/resource-auditing/navigation-guide.md#results-pane)
