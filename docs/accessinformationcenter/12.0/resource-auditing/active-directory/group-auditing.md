...
searching for group objects on the Home page. See the [Search Features](/docs/accessinformationcenter/12.0/resource-auditing/search-and-filters.md) topic
...
group types. See the [Members Report for a Built-in Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md) topic for additional
information.
...
| Report                                                                                                                         | Description                                                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Attribute Changes Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)            | Provides specific details for every attribute change to the audited group during the selected date range.                                                                                                                                                       |
| [Effective Access Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)             | Provides insight into every resource the audited group has access to and what level of access has been granted. Effective access is a calculation based on several variables according to the type of resource. This report includes a Permission Source table. |
| [Member Changes Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)               | Provides specific details for any membership changes to the audited group during the selected date range.                                                                                                                                                       |
| [Member Of Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)                    | Provides a list of all groups of which the audited group is a member. This report includes a Membership Paths table.                                                                                                                                            |
| [Members Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)                      | Provides a list of all trustees, users, and groups with membership in the audited group. This report includes a Membership Paths table.                                                                                                                         |
| [Members Report for a Built-in Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md) | Provides a list of all trustees, users, and groups with membership in the audited built-in group. This report includes a Membership Paths table.                                                                                                                |
| [Object Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)           | Provides details on Active Directory permissions to the object.                                                                                                                                                                                                 |
| [Permissions Report](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)                  | Provides a list of all resources where the audited group has been assigned permissions.                                                                                                                                                                         |
...
| Report                                                                                                                                | Description                                                                                                                                                                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Effective Access Report for Entra ID Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md) | Provides insight into every resource the audited Entra ID group has access to and what level of access has been granted. Effective access is a calculation based on several variables according to the type of resource. This report includes a Permission Source table. |
| [Member Of Report for Entra ID Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)        | Provides a list of all Entra ID groups of which the audited group is a member. This report includes a Membership Paths table.                                                                                                                                            |
| [Members Report for Entra ID Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)          | Provides a list of all trustees, users, and groups with membership in the audited Entra ID group. This report includes a Membership Paths table.                                                                                                                         |
| [Permissions Report for Entra ID Group](/docs/accessinformationcenter/12.0/resource-auditing/active-directory/group-auditing.md)      | Provides a list of all resources where the audited Entra ID group has been assigned permissions.                                                                                                                                                                         |
...
See the [Effective Access Report](/docs/accessinformationcenter/12.0/resource-auditing/file-systems/permissions-analysis.md) topic for File
Systems for additional information on the effective access calculations for file system resources.
See the [Effective Access Report](/docs/accessinformationcenter/12.0/resource-auditing/cloud-storage/sharepoint-online.md) topic for
...
[Scope an Effective Access Report](/docs/accessinformationcenter/12.0/resource-auditing/navigation-guide.md) topic for instructions on
using this feature.
...
![Member Changes report](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/memberchanges.webp)
...
![Member Of report](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/memberof.webp)
...
![Members report for a built-in group](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/membersbuiltin.webp)
...
![Object Permissions report](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/objectpermissions.webp)
...
Information Center user. See the [Results Pane](/docs/accessinformationcenter/12.0/resource-auditing/navigation-guide.md#results-pane) topic for
information on filter options.

![Permissions report](/img/product_docs/threatprevention/threatprevention/admin/policies/permissions.webp)
...
![Member Of report](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/entraid/memberofentraid.webp)
...
![Membership Paths table](/img/product_docs/accessinformationcenter/access/informationcenter/resourceaudit/group/entraid/memberofentraidtable.webp)
...
[Results Pane](/docs/accessinformationcenter/12.0/resource-auditing/navigation-guide.md#results-pane) topic for information on filter options.
