...
[Access Groups](/docs/accessinformationcenter/12.0/access-management/resource-owners/access-groups.md) topic for additional information.
...
See the [Multiple Domains](/docs/accessinformationcenter/12.0/administration/configuration/active-directory.md#multiple-domains) topic for
...
- The **Use the account running this service: [domain]\[username]** option is not a least privilege
  ...
  [Active Directory Page](/docs/accessinformationcenter/12.0/administration/configuration/active-directory.md) topic for additional information.
