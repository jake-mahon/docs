...
- [Actions Panel](actionspanel.md) — provides access to the Resource Reviews and Self-Service Access
...
- [Assigned Resources](assignedresources.md) — A table of assigned resources with action buttons
  below
