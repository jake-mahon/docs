...
username format. See the [Enable Console Users](/docs/accessinformationcenter/12.0/access/informationcenter/admin/gettingstarted.md#enable-console-users) topic for
