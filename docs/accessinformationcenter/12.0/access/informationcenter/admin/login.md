...
[Alias Server Host Name](additionalconfig/aliasserver.md) topic for additional information.
...
upon the assigned role or lack of assigned role. See the [User Landing Page](userlanding.md) topic
...
depends upon the assigned role or lack of assigned role. See the [User Landing Page](userlanding.md)
