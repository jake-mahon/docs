...
is required. See the [SSL Certificate](/docs/accessinformationcenter/12.0/access/informationcenter/installation/overview.md#ssl-certificate) topic for additional
information.
