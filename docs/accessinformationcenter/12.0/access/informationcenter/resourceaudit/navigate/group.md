...
group. See the [Search Features](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/navigate/search.md) topic for additional information. It contains three
...
breadcrumb. See the [Group Reports](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/group/overview.md) topic for additional information.
