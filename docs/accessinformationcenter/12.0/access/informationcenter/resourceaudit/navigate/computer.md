...
[Search Features](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/navigate/search.md) topic for additional information. It contains three panes in all audit
...
breadcrumb. See the [Computer Reports](/docs/accessinformationcenter/12.0/access/informationcenter/resourceaudit/computer/overview.md) topic for additional information.
