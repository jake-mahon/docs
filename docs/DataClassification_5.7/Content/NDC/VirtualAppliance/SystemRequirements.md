...
* [Hardware Configuration](#Hardware "Hardware Configuration")

**NOTE:** The requirements below are sufficient for evaluation purposes only. Refer to the [Requirements to Install Netwrix Data Classification](../Requirements/Overview "Requirements to Install Netwrix Data Classification") topic for complete information on the requirements for installing Netwrix Data Classification in production environments.
