...
1. In the management console, click **Sources** →**Exchange Mailbox**, then Collection Exclusion will be displayed.
2. To create an exclusion, click **Add**.
3. ![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/boxexclusions.png)
