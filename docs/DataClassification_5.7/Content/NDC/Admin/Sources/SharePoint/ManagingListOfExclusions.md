...
1. On the **Filter** tab, in the **Filter** field specify the objects (files or folders) to exclude:
   ...
   ![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Sources/Manage_Managing list of exclusions.png)
