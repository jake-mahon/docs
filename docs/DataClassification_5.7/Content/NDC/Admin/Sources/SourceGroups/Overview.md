...
* *(SharePoint only)* Supply regular expression rules to support automatically assigning sources to a specific group
...
* Set the Re-index period, priority, and credentials for a single source in the group or configure these options for all sources in this group using the "Apply changes to all sources in Source Group" option.
  ...
  **NOTE:** The Apply changes to all sources in Source Group option is available when you have more than one source in a source group.

  ![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Source_Groups_Settings.png)
...
* [Dynamic Source Groups — Exchange](DynamicSourceGroups/Exchange "Dynamic Source Groups — SharePoint Online")
* [Dynamic Source Groups — File Servers](DynamicSourceGroups/File "Dynamic Source Groups — File Servers")
* [Dynamic Source Groups — Google Drive Organization](DynamicSourceGroups/GoogleDrive "Dynamic Source Groups — Exchange")
* [Dynamic Source Groups — SharePoint Online](DynamicSourceGroups/SharePoint "Dynamic Source Groups — Google Drive Organization")