...
1. Ensure that an appropriate license has been loaded to enable document tagging. For that, go to **System Configuration** →**Config → Licensing → Licensing Summary**.
