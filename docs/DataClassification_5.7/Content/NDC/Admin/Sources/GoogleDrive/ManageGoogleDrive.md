...
1. In the management console, click **Sources** →**Google Drive**, then in the left pane click Write Configuration.
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/googledrivewriteconfiguration_thumb_0_0.png)](../../../../Resources/Images/googledrivewriteconfiguration.png)
...
In the management console, click **Sources** →**Google Drive**, then in the left pane click **Collection Exclusions**.

1. Click **Filter** tab and in the **Filter** field specify the file locations to exclude from crawling.

[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Sources/Gdrive_exclusion_Filter_thumb_0_0.png)](../../../../Resources/Images/Sources/Gdrive_exclusion_Filter.png)
