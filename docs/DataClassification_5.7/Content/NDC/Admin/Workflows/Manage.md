...
Authorized users can create, modify or delete automated workflows that apply to the certain content. For that, in the administrative web console select Content from the top menu and go to the **Workflows** tab.

[![](../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/workflows_thumb_0_0.png)](../../../Resources/Images/workflows.png)
...
* [Create a Workflow using Add Workflow Wizard](AddWorkflowWizard)
* [Configure a Workflow using Advanced dialog](AdvancedWindow/CreateWorkflow)

## Modifying or Deleting a Workflow

To modify a workflow, follow the steps described in the [Edit Workflow settings](EditSettings) section.

To delete a workflow, follow the steps described in the [Delete Workflow](Delete)section.
