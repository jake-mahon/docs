...
4. Click **Add**.
   ...
   [![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_advanced_name_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_advanced_name.png)
5. Then you need to configure document processing rules. For each rule, you should set up rule conditions and rule actions. Also, specify how the workflow should be processed with regards to rules.
   ...
   * [Specifying Rule Conditions](#RuleConditions)
   * [Specifying Rule Actions](#RuleActions)
   * [Other Rule Settings](#OtherRuleSettings)

   To apply pre-conditions (they will be used before rule processing starts), see [Specifying Workflow Conditions](#WorkflowScope)
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_rule_conditions_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_rule_conditions.png)
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_rules_list_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_rules_list.png)
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_advanced_details_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_advanced_details.png)
...
2. From the **Action Type** list, select the action you want to apply to the documents that match rule conditions.
   For details, see [Workflow Actions](../Actions/Actions).
3. Click **Save**.

[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_advanced_action_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_advanced_action.png)
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/workflowsreorderactions_thumb_0_0.png)](../../../../Resources/Images/workflowsreorderactions.png)
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/add_workflows_advanced_wf_conditions_thumb_0_0.png)](../../../../Resources/Images/Workflows/add_workflows_advanced_wf_conditions.png)

1. Click **Edit** to open **Edit Workflow Conditions** dialog.
2. Select the option you need from the **Mode** list. The next steps are similar to those described in [Specifying Rule Conditions](#RuleConditions)