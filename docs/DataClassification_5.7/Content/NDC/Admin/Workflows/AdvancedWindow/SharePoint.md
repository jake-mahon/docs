...
* [Migrate Document](../Actions/MigrateDocument#SharePointMigration) including copy and move operations
* Document property field (metadata) update, including:
  ...
  **NOTE:** These actions require Microsoft Office 365 retention labels to be configured. See [this Microsoft article](https://docs.microsoft.com/en-us/microsoft-365/compliance/labels) for details.
...
[![](../../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/Workflows/action_advanced_sp_update_field_thumb_0_0.png)](../../../../Resources/Images/Workflows/action_advanced_sp_update_field.png)