...
![](../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/createsqltaxonomy.png)
...
![](../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/mergesqltaxonomystage1.png)

Custom clues can be retained by selecting the option **Retain custom clues**. When enabled, any clues not defined as Predefined will be retained. The Predefined flag can be viewed by selecting the **i** (information) icon for a clue to display the following dialog:
...
![](../../../../../../static/images/DataClassification_5.7/Content/Resources/Images/taxonomyglobalsettings.png)
