...
* [To browse classification results](#Browse_Classificed_Docs)
* [To review the Document Tagging report](#Doc_Tagging_report)
...
4. Click Filter to start browsing your documents. [See Browse for more information.](../Taxonomies/Browse)
