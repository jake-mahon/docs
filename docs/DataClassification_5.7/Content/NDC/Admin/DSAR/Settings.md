...
**NOTE:** Only users with 'Super User' permissions are able to configure DSAR. [See DSAR Roles for more information.](Roles)
...
**NOTE:** This option is only available when there are queued requests and a search is not currently in progress to prevent conflicting processes.
...
**NOTE:** When forcing a search request run, consider that this operation may lead to performance degrading.
