...
When you open a job to view or change its settings, the **Edit Job** wizard opens, which is virtually identical to the [Create a Job](../Job/Create "Create a Job") wizard.
...
Step 3 – In the jobs list, click ![](../../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Portal/Option.png) on the job that you want to run and click **Run**.
...
Step 3 – Click the **three vertical dots** icon of the job that has to be deleted and select **Delete** from
the menu.
...
Step 3 – Click the **three vertical dots** icon of the job and select **Preview** from
the menu.
...
Step 3 – Click the **three vertical dots** icon of the job and select **Schedule** from
the menu.

It will take you to the **Schedule and Job Notifications** page of [Create a Job](../Job/Create "Create a Job"). Update the schedule and click **Finish** to save
the changes.

## Pin a Job

To pin a job to the [Dashboard](../Dashboard "Synchronize Dashboard") under the pinned job card:
...
Step 4 – The job is displayed on **My Pinned Jobs** card on the [Dashboard](../Dashboard "Synchronize Dashboard").
...
Step 3 – Click the **three vertical dots** icon of the job and select **Save as Template** from
the menu.
...
Step 3 – On the **All Job** page, click the **three vertical dots** icon on the job in the list
