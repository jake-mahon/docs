...
Follow the steps to pin a job to the [Dashboard](../Dashboard "Synchronize Dashboard") under the pinned job card.

Step 1 – On Directory Manager portal, select **Synchronize** on left pane.

Step 2 – On Synchronize portal, click **All Collections**.

Step 3 – Click the three vertical dots icon of the job collection and select **Pin Item** from
the menu.

Step 4 – The job collection is displayed on My Pinned Job Collections section on the [Dashboard](../Dashboard "Synchronize Dashboard").
...
Step 3 – Click the three vertical dots icon of the job collection and select **Save as Template** from
the menu.
