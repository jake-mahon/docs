...
User Reports contains reports for the User objects in the directory. Search a specific report by typing its name in the **Search Reports** box.
...
| Owners and objects they own  Listed in [Group Reports](Group "Group Reports") category as well. | Provides a list of owners and their direct reports. |
...
| Users and contacts with a phone number  Listed in [Contact Reports](Contact "Contact Reports") category as well. | Provides a phone list of accounts within an organization. |
