...
**Scenario 2:** On the next update, 620 objects are fetched to be added to Group A’s membership. Since the count exceeds 500, it breaks the membership into 2 child groups (Group 1 with 500 members and Group 2 with
...
You can add one or more objects to the membership of one or more groups. These objects would be added as permanent members. You will find them listed as members on the Members tab in [Group Properties](../Properties/Overview "Group Properties").
...
1. [Directory Search](../../Search/Search) the required objects.
2. Select these objects on the **Search Results** page and click **Add to Group** on the toolbar.
3. The [Find Dialog Box](../../Search/Find "Find dialog box") is displayed, where you can search and select the group(s) to add the objects to.

### Method 2:

1. [Directory Search](../../Search/Search "Directory Search") the group you want to add members to.
...
4. Enter a search string to locate the objects to add as members, or click **Advanced** to use the [Find Dialog Box](../../Search/Find "Find dialog box") for performing a search.
5. Save the changes.
...
To add a member temporarily to a group, see [Change the membership type of a group member](#Change "Change the membership type of a group member") .
...
1. [Directory Search](../../Search/Search "Directory Search") a group to change the membership type of its member(s).
2. Select this group on the **Search Results** page and click **Properties** on the toolbar.

   The group's [Group Properties](../Properties/Overview "Group Properties") page is displayed, where the **Members** tab lists the
   group members.
3. To change the membership type of a member, click anywhere in the respective row to make it editable, and select one of the following options from the **Membership** list:
...
1. [Directory Search](../../Search/Search "Directory Search") the group you want to remove member(s) from.
2. Select this group on the **Search Results** page and click **Properties** on the toolbar.
...
To remove a member temporarily from a group, see [Change the membership type of a group member](#Change "Change the membership type of a group member") .
...
3. Select the group(s) to add to the membership of another group and click **Add to Group** on the toolbar.
4. On the [Find Dialog Box](../../Search/Find "Find dialog box"), search and select the group to add members to it, and click **OK**.
...
2. Select the group you want to import members to, and click **Properties** on the toolbar.
   ...
   The group's [Group Properties](../Properties/Overview "Group Properties") page is displayed.
3. On the [Group properties - Members tab](../Properties/Members "Group properties - Members tab"), click **Import** to launch the **Import Members** wizard.
4. See [Import Group Members](../Properties/ImportMembers "Import Group Members") for further information and instructions.
5. Save the changes.
...
1. [Directory Search](../../Search/Search "Directory Search") a group to export its members to an external file.
2. Select this group on the **Search Results** page and click **Properties** on the toolbar.
...
1. In Directory Manager portal, click **Groups** in the left navigation pane, select Groups.
   ...
   [Directory Search](../../Search/Search "Directory Search") the group you want to invite a guest user to.
2. Select the required group from the list and click **Properties** on the toolbar. The group's [Group Properties](../Properties/Overview "Group Properties") page is displayed.
...
4. On the **Invite User** dialog box, provide the following information:
   ...
   2. In the **Redirect URL** box, provide the URL of a portal page, such as the My Profile page. On accepting the invite, the guest user will be redirected to this page.
