...
To modify the display name template for child Dynasties, see [Modify alias and display name templates](../../Manage/DynastyFunction#Alias "Modify alias and display name templates").
...
1. In the Directory Managerbportal, click the **Create New** button in the left pane and select **Group**.
...
3. On the [General page](../../Create/ActiveDirectory/General "Create Group wizard – General page"), specify basic information about the Dynasty.
4. On the [Dynasty Options page](../DynastyOptionsOrgGeoCus "Dynasty Options page"), view or change the attributes in the **Attributes** area and click **Next**.
   ...
   Dynasties create Smart Groups for each distinct value of each listed attribute. Depending on the Dynasty template selected, the **Attributes** area displays the list of default attributes for the template; however, you can add and
...
5. The [Query Designer](../../QueryDesigner/Overview "Query Designer") page displays the default query that Directory Manager will use to determine the Dynasty membership. This query returns all users with Exchange mailboxes, along with users and contacts
...
6. On the [Owners page](../../Create/ActiveDirectory/Owners "Create Group wizard – Owners page"), specify primary and additional owners for the Dynasty.
   ...
   owner, the new recipient would be the Dynasty’s primary owner even if the **Set Manager as owner** check box is selected.
7. On the [Summary Page](../../../User/Create/ActiveDirectory/Summary "Create User wizard – Summary page"), review the settings and then click Finish to complete the wizard.