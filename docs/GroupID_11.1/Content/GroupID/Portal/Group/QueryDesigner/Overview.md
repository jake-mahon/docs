...
* **Custom** - Returns all objects regardless of objectClass. Be sure to add an objectClass predicate on the Database tab to avoid unpredictable results.
...
* [Query Designer - General tab](General "Query Designer - General tab")
* [Query Designer - Storage tab](Storage "Query Designer - Storage tab")
* [Query Designer - Filter Criteria tab](FilterCriteria "Query Designer - Filter Criteria tab")
* [Query Designer - Include/Exclude tab](IncludeExclude "Query Designer - Include/Exclude tab")
* [Query Designer - Database tab](Database "Query Designer - Database tab")
* [Query Designer - Script tab](Script "Query Designer - Script tab")
* [Query Designer - Password Expiry Options tab](PasswordExpiryOptions)[Query Designer - Password Expiry Options tab](PasswordExpiryOptions "Query Designer - Password Expiry Options tab") (only available for Smart Groups with a password expiry condition)
