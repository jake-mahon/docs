...
Enter a search string to locate the required group (Group A), or click **Advance** to use the [Find Dialog Box](../../Search/Find "Find dialog box") for performing a search

The selected group(s) get listed in the **Member Of** grid.

**Remove**

Select a group (Group A) from the Member Of list and click **Remove** to remove this group from the membership of Group A.