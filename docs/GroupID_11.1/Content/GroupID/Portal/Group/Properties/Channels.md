...
To add channel(s) to the group, click **Add** on the toolbar. It displays the **Add Channel** dialog box.
...
* **Members**
  ...
  Click **Add** and enter a search string to locate the user to add as a member, or click **Advance** to use the [Find Dialog Box](../../Search/Find "Find dialog box") for performing a search.
...
Select a channel from the **Channels** list and click **Remove** to remove this channel from the membership of Teams group.