...
Click **Switch to Administrative View** to view history data in administrative mode. It displays history data in a tabular form. History items are grouped by date. Each date group displays changes made to directory objects during that
period.
...
The option to add a note is available on the My Account History card on Dashboard, and all History pages i.e.[My History](# "My History"), [My Direct Reports' History](MyDirectReport "My Direct Reports' History") and [My Groups' History](MyDirectoryGroup "My Groups' History") pages.
