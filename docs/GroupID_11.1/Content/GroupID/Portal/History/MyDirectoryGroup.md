...
History page opens with the **My History** tab in view. On the displayed page, click
the **My Groups History** tab.
...
The option to add a note is available on the My Account History card on Dashboard, and all History pages i.e.[My History](MyHistory "My History"), [My Direct Reports' History](MyDirectReport "My Direct Reports' History") and [My Groups' History](# "My Groups' History") pages.
