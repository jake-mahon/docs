...
Click **Switch to Administrative View** to view history data in administrative mode. It displays history data in a tabular form. History items are grouped by date. Each date group displays changes made to your direct reports during that
period.
...
Step 1 – Click **My Direct Reports History Grid Filter** to specify a criteria for filtering history data.

Step 2 – Click **Add Filter** to add the filter criteria.

Step 3 – From the **Select a filter** list, select attributes to filter history data on the basis of the attribute modified.
...
Step 7 – Click **Refresh** to reload history data for the domains selected in the **Search In** list.
...
The option to add a note is available on the My Account History card on Dashboard, and all History pages i.e.[My History](MyHistory "My History"), [My Direct Reports' History](# "My Direct Reports' History") and [My Groups' History](MyDirectoryGroup "My Groups' History") pages.
