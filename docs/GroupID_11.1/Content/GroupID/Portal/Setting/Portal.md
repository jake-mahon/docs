...
However, there are a few exceptions to it. See the [Notifications](../../AdminCenter/Notification/Overview#Localiza "Localization") topic for more information.
...
Step 2 – In the **History items to display on home page** box, set the maximum number of history items to be displayed on the portal's home page.
...
This setting also controls the number of history items displayed on the [My History](../History/MyHistory "My History"), [My Direct Reports' History](../History/MyDirectReport "My Direct Reports' History"), and [My Groups' History](../History/MyDirectoryGroup "My Groups' History") pages.

Step 1 – Click the **Settings** icon at the top of the page.

Step 2 – In the **History items to display** box, set the number of history items to display on the pages that display history data.
...
Step 2 – In the **Most recent objects** box, type the number of recent objects to display on the navigation bar.
...
Step 2 – In the **Domains to search** list, select the domains that you use frequently in your searches.
...
Step 2 – In the **Search results per page** box, type or select the number of search results to display on a page.
...
Step 3 – Selecting this option also displays the history of these groups in the **My Groups History** view.
