...
Step 2 – On the [Account page](Account "Account page"), specify basic account info, such as the user's first name, last name, login ID and the UPN suffix.

Step 3 – On the [Password page](Password "Password page"), provide a password for the user account and set other password-specific options.

Step 4 – Use the [Exchange page](Messaging "Exchange page"), to create the user as mail-enabled.
...
Step 4 – On the [Exchange page](Messaging "Exchange page"), clear the **Mail-Enabled** check box to create the user as non mail-enabled. This disables
