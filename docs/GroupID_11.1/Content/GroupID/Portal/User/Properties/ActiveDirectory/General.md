...
Enter a search string to locate the object to add as an Exchange assistant, or click **Browse** to use the [Find Dialog Box](../../../Search/Find) for performing a search.
...
Click the **Edit** icon to launch the Manage Photo dialog box for uploading a photo. The dialog box also provides many
