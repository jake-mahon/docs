...
* An unenrolled user must enroll his or her identity store account in Directory Manager. See the [Enroll your Identity Store Account](../../../AdminCenter/Enroll "Enroll your identity store account") topic. Enrollment is a one-time process.
* An enrolled user has to authenticate on the Directory Manager portal using the authentication type he or she used to enroll his or her identity store account with. See the [Authenticate your Identity Store Account](../../../AdminCenter/Authenticate "Authenticate your identity store account") topic.
...
* [Security Questions Authentication](#Questions "Security Questions Authentication")
* [SMS Verification](#SMS "SMS Verification")
* [Email Verification](#Email "Email Verification")
* [Authenticator app](#Authenticator "Authenticator app")
* [Link Account authentication](#Link "Link Account authentication")
* [YubiKey authentication](#YubiKey "YubiKey authentication")
* [Windows Hello authentication](#WindowsHello "Windows Hello authentication")
