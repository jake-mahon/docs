...
* Automate user provisioning and deprovisioning in bulk. See the [Synchronize](../Synchronize/Overview "Synchronize") section.
* Establish ownership by defining a clear managerial hierarchy with dotted line management. See the [Dotted line management](Properties/ActiveDirectory/Organization#Dotted "Dotted line management") section of the [Object properties - Organization tab](Properties/ActiveDirectory/Organization "Object properties - Organization tab") topic.
* Delegate user management to end users by enabling them to:

  * Create and manage users, contacts, and mailboxes in the directory. See the  [Create User Objects](Create/Overview "Create User Objects") topic.
  * Manage their direct reports. See the [Update your Direct Reports](Manage/DirectReport "My Direct Reports") topic.
  * Update their profiles in the directory. See the [Validate your profile](Manage/ValidateProfile "Validate Profile") topic.
* Link identical users in different directory services, such as Active Directory and Microsoft Entra ID. See the [Linked Accounts](LinkedAccounts "Linked Accounts") topic.
