...
See the [Create a Data Source for SQL Server](../../AdminCenter/DataSource/Create#Create4 "Create a Data Source for SQL Server") section of the [Create a Data Source](../../AdminCenter/DataSource/Create "Create a Data Source") topic for creating an SQL data source using Directory Manager.
