...
See the [Create a Data Source for MS Excel](../../AdminCenter/DataSource/Create#Create "Create a Data Source for MS Excel") section of the [Create a Data Source](../../AdminCenter/DataSource/Create "Create a Data Source") topic for additional information on creating an Excel data source using Directory Manager.
