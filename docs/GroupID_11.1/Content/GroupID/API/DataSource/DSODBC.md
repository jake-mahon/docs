...
See the [Create a Data Source for ODBC](../../AdminCenter/DataSource/Create#Create6 "Create a Data Source for ODBC") section of the [Create a Data Source](../../AdminCenter/DataSource/Create "Create a Data Source") topic to create an ODBC data source using Directory Manager.
