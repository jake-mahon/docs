...
Using this API you can create a new job collection which is a group of individual jobs that run in a particular order.

See the [Create a Job Collection](../../Portal/Synchronize/Collection/Create "Create a Job Collection")topic for additional information on the Job collection.
