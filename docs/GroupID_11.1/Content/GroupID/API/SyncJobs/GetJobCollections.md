...
Use this API to retrieve information of job collection(s) based on filters provided in the request syntax.

See the [Create a Job Collection](../../Portal/Synchronize/Collection/Create "Create a Job Collection")topic for additional information on job collections.
