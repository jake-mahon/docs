...
* AuditingHistory – Contains history data of all authentication actions performed in Directory Manager, as logged in Helpdek history. See the [History in Helpdesk](../Helpdesk/History "History in Helpdesk") topic for additional information.
* PasswordCenterHistory – Contains history data of all actions tracked in Helpdesk, except the authentication action. See the [History in Helpdesk](../Helpdesk/History "History in Helpdesk") topic for additional information.
* AdminCenterHistory – Contains Admin Center history data. See the [Admin Center History](../General/History "Admin Center History") topic for additional information.
...
![](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Schedule/HistoryRetention.png "History Retension Information ")
...
The default name format is: *HistoryRetention\_\_*.
