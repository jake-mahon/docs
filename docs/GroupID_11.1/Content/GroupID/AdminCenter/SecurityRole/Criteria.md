...
2. Enter a search string in the search field to search for your required group in the directory. You can also click **Advanced** to search the group by display name or email.  
...
2. Click **Add Expression**. A row with three drop-down lists is displayed. Use these to restrict role members to one or more Directory Manager clients (such as Admin Center and a Directory Manager portal).
3. Select an option in the first drop-down list.

   * *Client Name:* selecting this option would populate the names of all Directory Manager clients in the third drop-down list. Clients are:
   ...
   * *Client Type:* selecting this option would populate the different types of Directory Manager clients in the third drop-down list. Client types are:
