...
On signing into Admin Center, you land on the [Dashboard](Dashboard "Dashboard").
...
1. In Admin Center, enter a search string in the Search box at the top of the page.  
   ...
   ![](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/General/Quick search.png)
2. On clicking **Quick Actions** for an identity store, it displays the settings available for the identity store. Click an option to navigate to it.
...
* [Change your Password](ChangePassword "Change your Password")
* [Switch Accounts](SwitchAccount "Switch Accounts")
* [Access your Applications](AccessApplications "Access your Applications")