...
5. On the **Search Results** tab, the search results pages available in the portal are listed under **Name**. To modify a page, click **Edit** for it.
6. On the **Edit Search Results** pane, the **Fields** area lists the fields that display search results on the selected page.  
   Click **Add Field** to add a new field.
7. On the **Add Field** pane, use the **Field** drop-down list to select a schema attribute to link to the field. The field will display the value of this attribute on the search
   results page.
8. In the **Display Name** box, enter a display name for the field. This name is the field’s label on the search results page.
9. In the **Tooltip** box, enter the text to appear when a user hovers the mouse over the field.
10. In the **Display Type** drop-down list, select the display type to use to render this field in the portal. Available options are limited to textbox, DN, DNs, and Link, which are basic display Types. See the [Basic Display Types](../../DisplayType/Categories#Basic "Basic Display Types") topic.
11. Click **OK.** The field is displayed in the **Fields** area on the **Edit Search Results** pane.  
...
6. On the **Edit Search Results** pane, click **Edit** for a field to update it.  
   The **Edit Field** pane is displayed. Follow step 7 and onwards in the [Add a Field to a Search Results Page](#Add "Add a Field to a Search Results Page") topic to update the field.
