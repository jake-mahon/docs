...
NOTE: In the portal, the *Create Group* wizard starts with the *Group Type* page, where users can select the type of group they want to create. Options on this page vary, depending on the permissions assigned to the user in the identity store.
...
* If a user has the *Create Smart Group* permission and is denied the *Create Static Group* permission, all options except *Static Group* are displayed on the *Group Type* page.
![](../../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Application/Group Type.png)
...
* [Add a Page to a Wizard](#Add "Add a Page to a Wizard")
* [Update a Wizard Page](#Update "Update a Wizard Page")
* [Rearrange the Pages on a Wizard](#Rearrange "Rearrange the Pages on a Wizard")
* [Remove a Page from a Wizard](#Remove "Remove a Page from a Wizard")
* [Add a Field to a Wizard Page](#Field "Add a Field to a Wizard Page")
* [Update a Field](#Properties "Update a Field")
* [Rearrange the Fields on a Wizard Page](#RearrangeFields "Rearrange the Fields on a Wizard Page")
* [Remove a Field from a Wizard Page](#RemoveFields "Remove a Field from a Wizard Page")
...
8. In the **Visibility Level** drop-down list, select a security role. The page would be visible to users of this role and roles with a priority value higher than this role. See [Priority](../../SecurityRole/Manage#Priority "Priority").  
   Select *Never* to hide the page from all users.
9. To add fields to the page, see the [Add a Field to a Wizard Page](#Field "Add a Field to a Wizard Page") topic.
10. Click **OK**.
...
7. On the **Edit Category** pane, update the name and visibility level for the page. Follow steps 7-11 in the [Add a Page to a Wizard](#Add "Add a Page to a Wizard") topic for details.
...
11. In the **Visibility Level** drop-down list, select a security role. The field would be visible to users of the selected role and roles with a priority value higher than the selected role. See [Priority](../../SecurityRole/Manage#Priority "Priority").  
...
8. The **Edit Field** pane is displayed. Follow steps 8-22 in the [Add a Field to a Wizard Page](#Field "Add a Field to a Wizard Page") topic to update and save the information.
