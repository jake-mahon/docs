...
Use a linked field drop-down list, for example, when you want the *Office Address, Business Phone Number, Fax Number* and *Email* fields to be auto populated when a user selects
his or her office name from a drop-down list. Here,  is the key value while Office Address, Business Phone Number, Fax Number and Email are its linked (isolated) fields.
...
9. Select a key value in the **Default Selection** list to set it as the default value to be displayed in the drop-down list in the portal.  
   ...
   contains all key values defined in the **Values** area.
10. Click **OK**.
...
![](../../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Application/Linked field message.png)
