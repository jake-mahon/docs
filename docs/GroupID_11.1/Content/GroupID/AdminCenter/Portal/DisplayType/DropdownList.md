...
7. Use the **Values** area to specify the values to be displayed in the drop-down list.
   ...
   3. In the **Visibility** drop-down list, select a security role. The value in the drop-down list will be visible to users of this role and roles with a priority value higher than this role. See [Priority](../../SecurityRole/Manage#Priority "Priority").  
...
9. Select a value in the **Default Selection** list to set it as the default value for the drop-down list in the portal.  
   The **Default Selection** list contains all values
   defined in the **Values** area.
10. Click **OK**.
