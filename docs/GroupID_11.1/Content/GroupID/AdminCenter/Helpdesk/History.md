...
* [View History in Helpdesk](#view "View History in Helpdesk")
  * [Switch History Layouts](#Views "Switch History Layouts")
* [Search History](#Search "Search History")
* [Export History to a File](#export "Export History to a File")
...
2. On the **Helpdesk** page, click the **History** tab.  
   ...
   To search for specific records, see the [Search History](#Search "Search History") topic.
...
Click **Details** for a history item to view its details on the **History Details** dialog box. See the [View History in Helpdesk](#view "View History in Basic Layout") topic for a discussion of the dialog box.
...
3. On the **History** tab, the following search options are available:
   ...
   * **Identity Store list** - To get the history records for one or specific identity stores, click in the **Identity Store** box and select the check boxes for the identity stores you want to view the history for.
   * **Search box to search for records specific to a user** - In the *Search* box, enter a user’s full name or part of a name and press *Enter*. Directory Manager
     displays all history actions that are performed by or performed on the user.
   * **Search filter** - Click **Filter**. On the **Filter(s)** dialog box, you can search the history
...
1. In Admin Center, click **Helpdesk** in the left pane.
2. On the **Helpdesk** page, click the **History** tab.
3. On the **History** tab, you can export all history records in all identity stores to a file or filter the listing to export specific records only. To narrow down records, see the [Search History](#Search "Search History") topic.
...
* [Search Users](Operation/Search "Search Users")
