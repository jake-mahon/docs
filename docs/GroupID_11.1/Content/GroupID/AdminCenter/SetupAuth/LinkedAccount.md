...
* [Enable Linked Account Authentication for an Identity Store](#Enable "Enable Linked Account Authentication for an Identity Store")
* [Enforce Linked Account Authentication for a Security Role](#Enforce "Enforce Linked Account Authentication for a Security Role")

## Enable Linked Account Authentication for an Identity Store

The Linked Account authentication type must be enabled for an identity store before it can be used for multifactor authentication.
