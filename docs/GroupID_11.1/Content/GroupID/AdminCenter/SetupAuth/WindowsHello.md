...
* [Enable Windows Hello on Windows 10](#10 "Enable Windows Hello on Windows 10")
* [Enable Windows Hello Authentication for an Identity Store](#enable "Enable Windows Hello Authentication for an Identity Store")
* [Enforce Windows Hello Authentication for a Role in an Identity Store](#enforce "Enforce Windows Hello Authentication for a Role in an Identity Store")
...
4. In the **Windows Hello** section, click **Set up** under **Face** or **Fingerprint** to add recognition data.
