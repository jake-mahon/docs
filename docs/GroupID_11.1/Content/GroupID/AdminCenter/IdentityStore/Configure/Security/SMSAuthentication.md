...
See the [Manage SMS Gateway Accounts](../../../SMSGateway/Manage "Manage SMS Gateway Accounts") topic for creating and managing SMS gateway accounts.

What do you want to do?

* [Enable SMS Authentication for an Identity Store](#enable "Enable SMS authentication for an identity store")
* [Link an SMS Gateway Account to an Identity Store](#Link "Link an SMS gateway account to an identity store")
* [Enforce SMS Authentication for a Security Role](#enforce "Enforce SMS authentication for a security role")
...
To enable it, see the [Enable Authentication Types](../AuthTypes "Enable Authentication Types") topic.
...
4. In the **SMS gateway account** drop-down list on the **SMS Authentication** page, select an SMS gateway account to link it with the identity store. If a default SMS gateway account is defined before the identity store was created, it is auto selected in this list.
...
To enforce an authentication type, see the [Authentication Policy for Security Roles](../../../SecurityRole/Policy/Authentication "Authentication Policy for Security Roles") topic.
...
* [Manage SMS Gateway Accounts](../../../SMSGateway/Manage "Manage SMS Gateway Accounts")