...
* Physically deleted groups are listed under *Tombstone Groups*.
* Logically deleted groups are listed under *Logically Deleted Groups*. They also have Deleted\_ prefixed to their display names. However, groups in the Recycle Bin are displayed by their names, not their display
  names.
...
x number of days after group expiry, as specified in the [Auto Delete Expired Groups](GroupLifecycle#autodelete "Auto Delete Expired Groups") topic.
...
nor a default approver. See the [Specify a Default Approver](../../../Workflow/AdvancedSettings#Default "Specify a Default Approver") topic.

**See Also**

* [Manage Group Lifecycle Settings](GroupLifecycle "Manage Group Lifecycle Settings")
* [Group Life Cycle Schedule](../../../Schedule/GroupLifecycle "Group Life Cycle Schedule")[Specify a Default Approver](../../../Workflow/AdvancedSettings#Default "Specify a Default Approver")