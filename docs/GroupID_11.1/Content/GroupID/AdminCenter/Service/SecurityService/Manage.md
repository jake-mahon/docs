...
Security services in Directory Manager are displayed on the **Security Service** tab. A card for a service displays information such as its name and status.
...
See
the [Manage Data Service Settings](../DataService/Manage "Manage Data Service Settings") topic to manage settings for a Security service, such as deployment and log settings.
...
For details displayed on a service card, see the table in the [View Data Service Details](../DataService/Manage#View "View Data Service Details") topic for additional information.
...
Step 5 – Enable the **Distributed Cache** toggle button to enable communication among defined Security services.
