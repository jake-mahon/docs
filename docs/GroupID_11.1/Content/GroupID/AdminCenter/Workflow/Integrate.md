...
* As a one-time process, connect your identity store to Microsoft Power Automate .See the [Connect an Identity Store to Power Automate](#connect "Connect an Identity Store to Power Automate") topic.
* Link a workflow to a flow by providing the URL of that flow in the workflow .See the [Link an Identity Store Workflow to a Flow](#link "Link an Identity Store Workflow to a Flow") topic.
...
6. Enter the following information:
   ...
   * **Client ID** - the application ID assigned to the Directory Manager application when you registered it in Microsoft Entra Admin Center.
   ...
   NOTE: The Directory Manager application in Microsoft Entra Admin Center must have the following permissions for Power Automate:  
    ![](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Workflow/PA permissions.png)
...
6. On the **Power Automate Settings** dialog box, provide the username and password of a Microsoft Entra ID account for managing flows in the Microsoft Power Automate portal. This account must have
...
7. Click **Create Template**. Directory Manager creates a basic flow in Power Automate with the same name as the workflow, and displays the following message:
   ...
   ![](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Workflow/PA template message.png)
8. The next step is to copy the flow URL from Power Automate and provide it here. To copy the URL, do the following:
   ...
   3. Expand the **Connections** area.
      ...
      ![](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/AdminCenter/Workflow/Connections area.png)
