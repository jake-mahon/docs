...
Step 1 – Select the **Configure a new GroupID server with new or existing database** option on the Select to create new server or use existing server page of the Configuration Tool and select **Next**.

![Database Settings page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/DatabaseSettings.jpg "Database Settings page")

Step 2 – In the SQL Server list, select the **SQL Server** to use with Directory Manager. If the required server does not appear in the list, make sure that the SQL Server Browser service is running on the SQL Server machine and then click the **Refresh** button.
...
* SQL Server Authentication - To set SQL Server to work with Directory Managerusing an SQL Server account. See SQL Authentication in [Authentication Modes](../../Requirements/SetupAuthentication "Set up Authentication Modes") topic.
* Windows Authentication - To set SQL Server to work with Directory Managerusing a Windows user account. See Windows Authentication in in [Authentication Modes](../../Requirements/SetupAuthentication "Set up Authentication Modes") topic.
...
* For Windows Authentication: provide the credentials of a domain account or a Windows local account that Directory Managerwill use to connect with SQL Server. On clicking **OK**, the system authenticates with that account on SQL Server via Windows authentication.
...
![Security Settings page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/SecuritySettings.jpg "Security Settings page")

Step 7 – On the Security Settings page, enter an encryption key in the **Passphrase** and **Confirm Passphrase** boxes to secure Directory Manager data.
...
![License page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/License.jpg "License page")

Step 9 – On the License page, enter a valid license number and key in the respective boxes. A valid license and key enable the **Next** button. If the **Next** button remains disabled, check your entries for errors.

Step 10 – Click **Next**.

![Elasticsearch setting page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/ElasticsearchSettings.jpg "Elasticsearch setting page")

Step 11 – Directory Manager provides the following two options for Elasticsearch configuration. Select the relevant option:

* **Let GroupID install and manage Elasticsearch**: If you select this option, Directory Manager Configuration Tool will install Elasticsearch. It presents you default configuration of Elasticsearch cluster it will create:

  ![Select Elastic Cluster page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/SelectElasticCluster.jpg "Select Elastic Cluster page")
  ...
  * Elasticsearch Password: password of the Elasticsearch service account.
  ...
  ![Services Configuration page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/ServicesConfiguration.jpg "Services Configuration page")
  ...
  * Scheduler service: This service initiates schedule runs for scheduled jobs defined in Directory Manager. Directory Manager configures this service for each cluster.
  ...
  ![Service Account Setting page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/ServiceAccount.jpg "Service Account Setting page")
...
![Configuring GroupID page](../../../../../../static/images/GroupID_11.1/Content/Resources/Images/GroupID/Install/Configuring.jpg "Configuring GroupID page")
...
Step 20 – Click **Launch GroupID** on the Directory Manager is successfully configured page to start using Directory Manager. The Sign In page opens:
