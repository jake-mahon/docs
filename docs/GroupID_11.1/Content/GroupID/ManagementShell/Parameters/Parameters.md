...
* [All Parameters](#All "All Parameters")
* [Unsupported Parameters](#Unsuppor "Unsupported Parameters")
...
| CriteriaFilters | Same as [RoleCriteriaFilters](#RoleCriteriaFilters "RoleCriteriaFilters") |
| CriteriaScope | Same as [RoleCriteriaScope](#RoleCriteriaScope "RoleCriteriaScope") |
...
| Operator | Same as [RoleCriteriaOperator](#RoleCriteriaOperator "RoleCriteriaOperator") |
...
| Permissions | Same as [RolePermissions](#RolePermissions "RolePermissions") |
...
| RoleCriteriaScope | Specify the scope for a role. This parameter can be used in conjunction with [RoleCriteriaDN](#RoleCriteriaDN "RoleCriteriaDN") to change the role criteria scope from container to group and vice-versa. |
...
See the [about\_CommonParameters](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_commonparameters?view=powershell-7.3&viewFallbackFrom=powershell-6 "about_CommonParameters") Microsoft article for details on these parameters.