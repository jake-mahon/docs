...
![ Endpoint Protector E-mail Server Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/emailserversettings.webp)
...
![System Alerts Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/systemalerts.webp)
...
![Creating a System Alert](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/creatsystemalert.webp)
...
![System Alerts History](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/systemalertshistory.webp)
...
![Device Control Alerts](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/dcalerts.webp)
...
![Creating a Device Control Alert](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/creatingdcalert.webp)
...
![Device Control Alerts History](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/dcalertshistory.webp)
...
![Content Aware Alerts](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/contentawarealerts.webp)
...
![Creating a Content Aware Alert](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/creatingcontentawarealertinfo.webp)

![Creating a Content Aware Alert](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/creatingcontentawarealert.webp)
...
![Content Aware Alerts History](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/contentawarealertshistory.webp)
...
![Enforced Encryption Alert](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/enforcedencryptionalert.webp)
...
![Creating an Enforced Encryption Alert ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/createeealert.webp)
...
![Enforced Encryption Alert History ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/alerts/eealerthistory.webp)
