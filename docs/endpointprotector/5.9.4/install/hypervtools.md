...
![hypervmanager](/img/product_docs/endpointprotector/5.9.4/install/hypervmanager.webp)
...
![Virtual Appliance folder](/img/product_docs/endpointprotector/5.9.4/install/appliancefolder.webp)

![Specifying the Folder containg the VM import](/img/product_docs/endpointprotector/5.9.4/install/locatefolder.webp)
...
![Selecting the Endpoint Protector Virtual Appliance](/img/product_docs/endpointprotector/5.9.4/install/selectvirtualmachine.webp)

**Step 8 –** On the Choose Import Type section, select the **Copy the virtual machine (create a new
unique ID) option**. Click **Next**.

![Choosing Import Type](/img/product_docs/endpointprotector/5.9.4/install/importtype.webp)
...
![ Choosing Folders for Virtual Machine Files ](/img/product_docs/endpointprotector/5.9.4/install/destination.webp)
...
![ Setting the desired path for storing the  imported virtual hard disk](/img/product_docs/endpointprotector/5.9.4/install/storagefolders.webp)
...
![Insuﬃcient memory on the Hyper-V Host](/img/product_docs/endpointprotector/5.9.4/install/configurememory.webp)
...
![Connect network settings](/img/product_docs/endpointprotector/5.9.4/install/connectnetwork.webp)
...
![Connect network settings](/img/product_docs/endpointprotector/5.9.4/install/networkconnect.webp)
