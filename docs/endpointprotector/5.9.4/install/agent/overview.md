...
[Client Software](/docs/endpointprotector/5.9.4/admin/systemconfiguration/overview.md#client-software)
topic.
...
![The Agent enforces the Rights and Settings received from the Endpoint Protector Server on the protected endpoints (Windows, Mac, and Linux)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setupagent.webp)

![The Agent enforces the Rights and Settings received from the Endpoint Protector Server on the protected endpoints (Windows, Mac, and Linux)](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setupagenttwo.webp)
...
![Installation on macOS with Deep Packet Inspection and VPN Traﬃc Intercept Active](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/clientinstallationios.webp)
...
![Grant permission to the Endpoint Protector Client](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/eppagentpermisions.webp)
...
![Activating Deep Packet Inspection](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpion.webp)
...
![Download the Client CA Certiﬁcates](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpicertificate.webp)

**Step 8 –** Open the **Keychain Access** application from your macOS and select **System**.

![Open the Keychain Access application from your macOS and select System](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/keychainaccess.webp)
...
![Select cacert.pem ﬁle and drag and drop it on Keychain Access, System](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/clientcerts.webp)

**Step 11 –** Double-click the **X** on the newly added certiﬁcate and on the Trust section, select
**Always Trust**.

![On the newly added certiﬁcate and on the Trust section, select Always Trust.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/keychainaccesstwo.webp)
...
![Activate Intercept VPN Traﬃc](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/interceptvpntraffic.webp)
...
![System Extension is blocked and needs to be allowed](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/systemextensionblocked.webp)
...
![select the General tab and allow the Endpoint Protector Client Extension](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/generaltabios.webp)

**Step 18 –** **Allow** the Endpoint Protector Proxy Conﬁguration from the pop-up window.

![proxypop-up](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/proxypop-up.webp)
...
![Debian Based Distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/debianbaseddistributions.webp)
...
![RedHat based distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/redhatbaseddistributions.webp)
...
![RedHat based distributions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/redhatbaseddistributionstwo.webp)
...
![Setting the Endpoint Protector Server IP](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setserverip.webp)

![Setting the Endpoint Protector Server IP](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/setserveriptwo.webp)
...
[Denylists and Allowlists](/docs/endpointprotector/5.9.4/admin/denylistsallowlists/overview.md)
