...
![Department Usage](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/departmentusage.webp)
...
![Session Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/sessionsettings.webp)
...
![Endpoint Protector Rights Functionality](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/rightsfunctionality.webp)
...
![Smart Groups](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/smartgroups.webp)
...
![Client Update Mechanism](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/clientupdatemechanism.webp)
...
![Custom Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/customsettings.webp)
...
![Log Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/logsettings.webp)
...
![Content Aware Protection – Ignore Thresholds ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/capignorethresholds.webp)
...
![Virtual Desktop Clones](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/virtualdesktopclones.webp)
...
![Deep Packet Inspection Certiﬁcate ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/dpinspectioncert.webp)
...
![Server Certiﬁcate Stack](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/servercertstack.webp)
...
**NOTE:** See the
[Single Sign On](/docs/endpointprotector/5.9.4/system-configuration/single-sign-on/index.md)
...
![Active Directory Authentication](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/activedirectoryauthentication.webp)

## E-mail Server Settings

![E-mail Server Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/mailserversettings.webp)
...
![E-mail Server Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/mailserversettingstwo.webp)

![E-mail Server Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/mailserversettingsthree.webp)
...
![Proxy Server Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/proxyserversettings.webp)
...
![Main Administrator Contact Details](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/mainadministratorcontact.webp)
...
![EPP Server Display Name](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/systemconfiguration/serverdisplayname.webp)
