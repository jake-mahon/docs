...
![The module is displayed but requires a simple activation by pressing the Enable button](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/ediscovery/activation.webp)
