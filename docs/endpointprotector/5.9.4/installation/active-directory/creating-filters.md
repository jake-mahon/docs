...
![Newly Created Windows Management Instrumentation Filters](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/configuration/activedirectory/createdwmifilters_118x25.webp)
