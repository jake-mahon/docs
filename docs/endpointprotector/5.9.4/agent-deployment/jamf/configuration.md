...
![Creating a New configuration Profile](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/configurationprofile.webp)
...
![Enabling Deep Packet Inspection Certificate and then downloading Client CA Certificate](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/dpicertificate.webp)
...
![Entering the required information on New macOS Configuration Profile](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/macosconfiguration.webp)
...
![Configuring Privacy Peferences Policy Control](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/privacypreferences.webp)
...
![Configuring EPPNotifier Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/eppnotifer.webp)
...
![Configuring Enforced Encryption settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/enforcedencryption.webp)
...
![Allowing System Extensions ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/systemextensions.webp)
...
![Adding a new policy that will allow the removing of system extensions](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/removeableextensions.webp)
...
![First section to configuring VPN settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/vpnsettings.webp)

![Second section to configuring VPN settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/vpnconfiguration.webp)
...
![Optional Notifiaction Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/notificationsettings.webp)
...
![Uploading the new Script.](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/newscript.webp)
...
![Uploading the new Package](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/install/agent/jamf/newpackage.webp)
