...
![Main Components](/images/endpointprotector/5.9.4/requirements/maincomponents.webp)
...
![Architecture Overview](/images/endpointprotector/5.9.4/requirements/networkarchitecture.webp)
