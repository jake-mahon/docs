...
![Content Detection Summary](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/contentdetectionsummary.webp)
...
![Creating new Context Detection Rules ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/contentdetectionrules.webp)
...
![Policy Denylists](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policydenylists.webp)
...
![HIPAA Compliance](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/hipaacompliance.webp)
...
![Policy Allowlists](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyallowlists.webp)
...
![Policy Entities](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/policyentities.webp)
...
![Block and Remediate Policies](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/blockremediateclient.webp)
...
![Configuring Self Remediate ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/selfremediate.webp)
...
![selfremediatetwo](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/selfremediatetwo.webp)
...
![Applying multiple Content Aware Policies](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/capeditpolicy.webp)
...
![HIPAA policies can be created and used on their own or in combination with regular policies](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/contentawareprotection/hipaapolicies.webp)
