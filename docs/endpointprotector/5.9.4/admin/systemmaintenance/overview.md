...
![Retrieve, organize and clean-up ﬁles used by the Endpoint Protector Server](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/filemaintenance.webp)
...
![View the list of exported entities, download or delete them, and view the scheduled export in the system and reschedule them accordingly](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/listofentities.webp)
...
![Initiate the manual generation of the scheduled export from the Device Control](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/listofdevices.webp)

![Manual generation of the scheduled export from the Device Control](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/dcscheduleexport.webp)
...
![The System Snapshots module allows you to save all device control rights and settings in the system and restore them later if needed](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/systemsnapshots.webp)
...
![Restore a previously created snapshot](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/restoresnapshot.webp)
...
![Allows old logs to be saved and exported](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/auditlogbackup.webp)
...
![Audit Log Backup Scheduler](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/scheduledbackup.webp)
...
![Externalize ﬁles generated by Endpoint Protector to a particular storage disk from the network](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/externalstorage.webp)
...
![Conﬁgure an FTP Server](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/ftpserver.webp)
...
![Conﬁgure an SFTP Server](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/sftpserver.webp)
...
![Conﬁgure a Samba / Network Share Server](/img/product_docs/endpointprotector/5.9.4/admin/systemmaintenance/sambastorage.webp)
