...
![Logs Report Settings](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/logsreport.webp)
...
![File Tracing Reports](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/filetracingreports.webp)
...
![Content Aware Reports](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/capreports.webp)
...
![A pop-up window with the list of matched items](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/capmatcheditems.webp)

- Count – the number of matched items

![Count – the number of matched items](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/matcheditemscount.webp)
...
![Content Aware Protection Filters](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/capfilters.webp)
...
![Export Content Aware Reports](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/exportreports.webp)
...
![Creating Export ](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/createexport.webp)
...
![Viewing Export List ](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/viewexportlist.webp)

![Export List Results ](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/exportlistresults.webp)
...
![ An overview of every important action performed in the interface](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/adminactions.webp)
...
![Overview of computers registered on the system](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/onlinecomputers.webp)
...
![An overview of users registered on the system](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/onlineusers.webp)
...
![An overview of devices registered on the system](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/onlinedevices.webp)
...
![View system activity regarding data traﬃc and device connections](/img/product_docs/endpointprotector/5.9.4/admin/reportsanalysis/statistics.webp)
