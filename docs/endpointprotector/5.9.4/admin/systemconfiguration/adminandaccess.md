...
![System Administrators](/images/endpointprotector/5.9.4/admin/systemconfiguration/clientuninstall.webp)
...
![Super Administrator Details](/images/endpointprotector/5.9.4/admin/systemconfiguration/superadministratordetails.webp)
...
![Administrators Groups](/images/endpointprotector/5.9.4/admin/systemconfiguration/administratorsgroups.webp)
...
![User Role Matrix](/images/endpointprotector/5.9.4/admin/systemconfiguration/userrolematrix.webp)
...
![Two Factor Authentication](/images/endpointprotector/5.9.4/admin/systemconfiguration/twofactorauthentication.webp)
...
![Google Authenticator app](/images/endpointprotector/5.9.4/admin/systemconfiguration/googleauthenticator.webp)
...
![System Departments](/images/endpointprotector/5.9.4/admin/systemconfiguration/systemdepartments.webp)
...
![Create a new department click Create and then provide a name, description and unique code](/images/endpointprotector/5.9.4/admin/systemconfiguration/newdepartment.webp)
