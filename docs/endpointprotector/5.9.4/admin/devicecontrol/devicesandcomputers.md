...
![Priority order whech configuring device rights](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/priortyorder.webp)
...
![Manage device rights for speciﬁc computers, groups, or users](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/effectiverights.webp)

![Managing device rights](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/devicerights.webp)
...
![Selecting the Entity and the Device right](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/entintydeviceright.webp)

**Step 2 –** Select the **Entities** (Computers, Groups, or Users).

![Selecting the Entities (Computers, Groups, or Users)](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/entitiesrights.webp)
...
![ Logs Report page ﬁltered for the respective device](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/logsreport.webp)
...
![Filter, create, uninstall or delete a computer ](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/computers.webp)
...
![Specifies which Device Types and Speciﬁc Devices can be accessible](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/computerrights.webp)
...
![Editing the settings for each computer](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/computersettings.webp)
...
![This will display the Logs Report page ﬁltered for the respective computer](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/logsreport.webp)
...
Terminal Server
![Mark as Terminal Server Action](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/terminalserver_19x14.webp)
.
...
![Displays List of computers](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/computers.webp)
...
![ Preserves Global Settings, Allow Access, Deny Access, and Read-Only Access.](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/rdpstorage.webp)
...
![Thin Client Storage (RDP Storage) device type](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/thinclientstorage.webp)
...
![Illustrate tool to create access policies for speciﬁc users](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/thingrouptools.webp)
...
![Client version displays RDP Storage disks shared by one or multiple Thin Clients](/img/product_docs/endpointprotector/5.9.4/admin/devicecontrol/clientversiondc.webp)
