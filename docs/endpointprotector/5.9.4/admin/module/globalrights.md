...
![priortyorder](/images/endpointprotector/5.9.4/admin/devicecontrol/priortyorder.webp)
...
![Standard supported Devices](/images/endpointprotector/5.9.4/admin/devicecontrol/standarddevices.webp)
...
![Bluetooth Device Management on Mac](/images/endpointprotector/5.9.4/admin/devicecontrol/macbluetooth.webp)
...
![Device Type configuration](/images/endpointprotector/5.9.4/admin/devicecontrol/devicetypes.webp)
...
![Manage USB access through the virtual environment.](/images/endpointprotector/5.9.4/admin/devicecontrol/vmusb.webp)
...
![Manage access rights for a speciﬁc device.](/images/endpointprotector/5.9.4/admin/devicecontrol/specificdevices.webp)
...
![Device Wizard - Adding New Device](/images/endpointprotector/5.9.4/admin/devicecontrol/newdevicestep.webp)
...
![Add devices previously connected to protected computers and already in the database.](/images/endpointprotector/5.9.4/admin/devicecontrol/existingdevice.webp)
...
![ Add multiple devices at the same time.](/images/endpointprotector/5.9.4/admin/devicecontrol/multipledevices.webp)
...
![Add up to 1000 devices at the same time](/images/endpointprotector/5.9.4/admin/devicecontrol/bulkdevices.webp)
...
![Deﬁne fallback policies that will apply when outside the network](/images/endpointprotector/5.9.4/admin/devicecontrol/outsidenetwork.webp)
...
![ Deﬁne fallback policies that will apply when outside working hours](/images/endpointprotector/5.9.4/admin/devicecontrol/outsidehours.webp)
