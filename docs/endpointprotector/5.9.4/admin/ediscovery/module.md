...
![eDiscovery Activation](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/activation.webp)
...
![A quick overview in the form of graphics and charts related to the eDiscovery module](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/dashboard.webp)
...
![eDiscovery Automatic Scanning](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/automaticscanning.webp)
...
![Creating an eDiscovery Policy and Scan](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/policiesscans.webp)
...
![Creating a new Policy](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/newpolicy.webp)
...
![eDiscovery Scan Result and Actions](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/scanresults.webp)
...
![eDiscovery Scan Result and Actions](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/ediscoveryscans.webp)
...
![Viewing Scan Results and Taking Actions](/img/product_docs/endpointprotector/5.9.4/admin/ediscovery/ediscoveryactions.webp)
