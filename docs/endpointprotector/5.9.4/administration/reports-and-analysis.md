...
![Logs Report Settings](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/devicecontrol/logsreport.webp)
...
![File Tracing Reports](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/filetracingreports.webp)
...
![Content Aware Reports](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/capreports.webp)
...
![A pop-up window with the list of matched items](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/capmatcheditems.webp)

- Count – the number of matched items

![Count – the number of matched items](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/matcheditemscount.webp)
...
![Content Aware Protection Filters](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/capfilters.webp)
...
![Export Content Aware Reports](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/exportreports.webp)
...
![Creating Export ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/createexport.webp)
...
![Viewing Export List ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/viewexportlist.webp)

![Export List Results ](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/exportlistresults.webp)
...
![ An overview of every important action performed in the interface](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/adminactions.webp)
...
![Overview of computers registered on the system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/onlinecomputers.webp)
...
![An overview of users registered on the system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/onlineusers.webp)
...
![An overview of devices registered on the system](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/onlinedevices.webp)
...
![View system activity regarding data traﬃc and device connections](/img/versioned_docs/endpointprotector_5.9.4/endpointprotector/admin/reportsanalysis/statistics.webp)
