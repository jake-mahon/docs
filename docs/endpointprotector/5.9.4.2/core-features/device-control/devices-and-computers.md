...
[Directory Services](/docs/endpointprotector/5.9.4.2/security-and-access/directory-services.md) topic.
...
[Exported Entities](/docs/endpointprotector/5.9.4.2/administration/system-maintenance/index.md#exported-entities) topic to view the Deep
...
[Directory Services](/docs/endpointprotector/5.9.4.2/security-and-access/directory-services.md) topic. You can also assign the computers to
the following for a better organization:

- Devices and Computers e.g., several computers within the same oﬃce
- [System Configuration](/docs/endpointprotector/5.9.4.2/administration/system-configuration/index.md) an alternative organization to Groups
