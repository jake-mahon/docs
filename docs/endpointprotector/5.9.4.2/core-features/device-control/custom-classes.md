...
![Provides you with the option to create new classes of devices for easier management](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/customclasses.webp)
...
![Add devices previously connected to protected computers](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/existingdevice.webp)
...
![Add multiple devices at the same time, by specifying the ﬁrst and last Serial Number in the range](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/multipledevices.webp)
...
![Allow at Step 2 to add up to 1000 devices at the same time](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/bulkdevices.webp)
...
[System Configuration](/docs/endpointprotector/5.9.4.2/administration/system-configuration/index.md) topic.
...
![Select an option to grant access for clients based on the Department Code](/img/product_docs/endpointprotector/endpointprotector/admin/systemconfiguration/departmentusage.webp)
...
![Modify session timeout settings](/img/product_docs/endpointprotector/endpointprotector/admin/systemconfiguration/sessionsettings.webp)
...
![Rights Functionality ](/img/product_docs/endpointprotector/endpointprotector/admin/systemconfiguration/rightsfunctionality.webp)
...
![Priorities for Device Control Policies](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/prioritiesdevicecontrol.webp)
