...
You can add, delete and edit [Denylists and Allowlists](/docs/endpointprotector/5.9.4.2/security-and-access/deny-allow-lists/index.md) from the
...
[User Remediation](/docs/endpointprotector/5.9.4.2/administration/system-parameters.md#user-remediation) sections.
