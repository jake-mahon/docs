...
[Device Types (Standard)](/docs/endpointprotector/5.9.4.2/endpointprotector/admin/devicecontrol/globalrights.md#device-types-standard) subtopic.
...
![Overview in the form of graphics and charts ](/img/product_docs/endpointprotector/endpointprotector/admin/devicecontrol/dcdashboard.webp)
