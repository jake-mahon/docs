...
![Provides you with the option to create new classes of devices for easier management](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/customclasses.webp)
...
![Multiple ways of adding devices to a Custom Class](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/newdevice.webp)
...
![Add devices previously connected to protected computers](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/existingdevice.webp)
...
![Add multiple devices at the same time, by specifying the ﬁrst and last Serial Number in the range](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/multipledevices.webp)
...
![Allow at Step 2 to add up to 1000 devices at the same time](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/bulkdevices.webp)
...
![Modify session timeout settings](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/sessionsettings.webp)
...
![Priorities for Device Control Policies](/img/product_docs/endpointprotector/5.9.4.2/admin/devicecontrol/prioritiesdevicecontrol.webp)
