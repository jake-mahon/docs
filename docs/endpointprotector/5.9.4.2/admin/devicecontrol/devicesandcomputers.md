...
[Directory Services](/docs/endpointprotector/5.9.4.2/admin/directoryservices/overview.md) topic.
...
[Directory Services](/docs/endpointprotector/5.9.4.2/admin/directoryservices/overview.md) topic. You can also assign the computers to
