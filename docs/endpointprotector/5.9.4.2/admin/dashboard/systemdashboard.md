...
![View general information of the system’s functionality, alerts, and backup status](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/systemstatus.webp)
...
![Enable EPP , as well as just speciﬁc modules](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/systemfunctionality.webp)
...
![Enable the System Backup](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/systembackup.webp)
...
![Management of software updates](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/softwareupdate.webp)
...
![Configuring Live Updates](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/configliveupdate.webp)
...
![Checking for available EPP server Updates](/img/product_docs/endpointprotector/5.9.4.2/admin/dashboard/availableupdates.webp)
