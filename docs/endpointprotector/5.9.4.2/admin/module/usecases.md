...
![Content Aware Edit Policy](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/capeditpolicytwo.webp)
...
![Applying multiple Content Aware Policies](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/policyinformationtwo.webp)
...
![Applying multiple Content Aware Policies](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/policyinformationthree.webp)
