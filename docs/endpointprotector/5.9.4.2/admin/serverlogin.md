...
![ Input your assigned username and password to log in to the Server](/images/endpointprotector/5.9.4.2/admin/serverlogin.webp)
...
![High-level overview of endpoints under management as well as activity](/images/endpointprotector/5.9.4.2/admin/dashboard.webp)
