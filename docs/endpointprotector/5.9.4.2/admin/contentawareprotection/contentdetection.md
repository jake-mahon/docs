...
![Content Detection Summary](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/contentdetectionsummary.webp)
...
![Policy Denylists](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/policydenylists.webp)
...
![Deﬁne the monitored URL categories the Deep Packet Inspection](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/dpimonitored.webp)
...
![Policy Entities](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/policyentities.webp)
...
![Block and Remediate Policies](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/blockremediateclient.webp)
...
![Configuring Self Remediate ](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/selfremediate.webp)
...
![selfremediatetwo](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/selfremediatetwo.webp)
...
![HIPAA policies can be created and used on their own or in combination with regular policies](/img/product_docs/endpointprotector/5.9.4.2/admin/contentawareprotection/hipaapolicies.webp)
