...
You can add, delete and edit [Denylists and Allowlists](/docs/endpointprotector/5.9.4.2/admin/denylistsallowlists/overview.md) from the
...
[User Remediation](/docs/endpointprotector/5.9.4.2/admin/systemparameters/overview.md#user-remediation) sections.
