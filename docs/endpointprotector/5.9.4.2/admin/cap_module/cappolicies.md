...
![Manage the Content Aware Protection policies](/images/endpointprotector/5.9.4.2/admin/contentawareprotection/policies.webp)
...
![Block & Report policies to handle Social Security Numbers (SSN) and phone numbers](/images/endpointprotector/5.9.4.2/admin/contentawareprotection/policyinformation.webp)
...
![Monitor transfers from the following exit points](/images/endpointprotector/5.9.4.2/admin/contentawareprotection/policyexistpoints.webp)
...
![From the storage devices tab, you can select to monitor transfers](/images/endpointprotector/5.9.4.2/admin/contentawareprotection/policyexitstoragedevices.webp)
...
![The Clipboard functionality enables you to monitor all content captured through Copy & Paste or Cut & Paste operations](/images/endpointprotector/5.9.4.2/admin/contentawareprotection/policyexitclipboard.webp)
