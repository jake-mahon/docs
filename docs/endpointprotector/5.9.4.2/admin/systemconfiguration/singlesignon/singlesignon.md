...
![Allows you to log in the Endpoint Protector Server with Azure AD and OKTA](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/singlesignon/singlesignonpage.webp)
