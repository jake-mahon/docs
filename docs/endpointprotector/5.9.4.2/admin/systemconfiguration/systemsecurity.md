...
![System Security Settings](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/systemsecurity.webp)
...
![Security Password for Uninstall Protection](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/uninstallprotectiontwo.webp)
...
![Data Security Privileges](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/datasecurityprivileges.webp)
...
![Additional Security Password for Sensitive Data Protection](/img/product_docs/endpointprotector/5.9.4.2/admin/systemconfiguration/passwordsensitivedataprotectiontwo.webp)
