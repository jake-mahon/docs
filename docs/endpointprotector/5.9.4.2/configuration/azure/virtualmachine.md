...
![Creating the Virtual Machine ](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createvm.webp)
...
![Information tab for creating a new Virtual Machine. ](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/newvm.webp)
...
![Connecting the IP to the Endpoint Protector Image](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/connetctip.webp)
