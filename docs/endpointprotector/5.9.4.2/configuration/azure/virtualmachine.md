...
![Creating the Virtual Machine ](/img/product_docs/endpointprotector/endpointprotector/configuration/azure/createvm.webp)
...
![Information tab for creating a new Virtual Machine. ](/img/product_docs/endpointprotector/endpointprotector/configuration/azure/newvm.webp)
...
![Information tab for creating a public IP](/img/product_docs/endpointprotector/endpointprotector/configuration/azure/publicip.webp)

**Step 4 –** Once the deployment has finished, go to Virtual Machines on the right side and select
the Endpoint Protector image.

![Connecting the IP to the Endpoint Protector Image](/img/product_docs/endpointprotector/endpointprotector/configuration/azure/connetctip.webp)
