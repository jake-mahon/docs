...
![Linking the Windows Management Instrument filters to Group Policy Objects](/img/product_docs/endpointprotector/5.9.4.2/configuration/activedirectory/wmitogpolinking.webp)
