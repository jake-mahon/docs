...
![Creating Virtual Machine instance.](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/createinstance.webp)
...
![Boot disk Configuration](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/bootdisk.webp)

**Step 3 –** On the Firewall section, select Allow HTTP traffic and Allow HTTPS traffic, and then
click Create.

![Firewall configuration](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/firewall.webp)
...
![Requesting a static IP](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/externalip.webp)
...
![Creating firewall rules](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/firewallrules.webp)
...
![Editing firewall rules](/img/product_docs/endpointprotector/5.9.4.2/configuration/googlecloudplatform/editrules.webp)
