...
![Editing the Network Section ](/img/product_docs/endpointprotector/5.9.4.2/configuration/amazonwebservices/editnetwork.webp)
...
![Summary section ](/img/product_docs/endpointprotector/5.9.4.2/configuration/amazonwebservices/summary.webp)
