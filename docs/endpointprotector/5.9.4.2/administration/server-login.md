...
![ Input your assigned username and password to log in to the Server](/img/product_docs/endpointprotector/endpointprotector/admin/serverlogin.webp)
...
![High-level overview of endpoints under management as well as activity](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/dashboard.webp)
