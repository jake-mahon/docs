...
from Device Control, Global Settings, [Device Control](/docs/endpointprotector/5.9.4.2/core-features/device-control/index.md).
...
[Device Control](/docs/endpointprotector/5.9.4.2/core-features/device-control/index.md) topic and then select the **customized notiﬁcation**
...
**Step 4 –** Navigate to [Device Control](/docs/endpointprotector/5.9.4.2/core-features/device-control/index.md), Device Types section and
