...
[Client Software](/docs/endpointprotector/5.9.4.2/administration/system-configuration/index.md#client-software) topic.
...
![RedHat based distributions](/img/product_docs/endpointprotector/endpointprotector/install/agent/redhatbaseddistributions.webp)
...
**Step 1 –** Navigate to the [Denylists and Allowlists](/docs/endpointprotector/5.9.4.2/security-and-access/deny-allow-lists/index.md)
