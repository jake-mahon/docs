...
![Linking the Windows Management Instrument filters to Group Policy Objects](/images/endpointprotector/5.9.4.2/configuration/activedirectory/wmitogpolinking.webp)
