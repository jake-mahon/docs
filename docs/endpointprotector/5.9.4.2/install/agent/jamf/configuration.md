...
![Enabling Deep Packet Inspection Certificate and then downloading Client CA Certificate](/img/product_docs/endpointprotector/5.9.4.2/install/agent/dpicertificate.webp)
