...
![createdisk](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createdisk.webp)

**Step 2 –** Search the marketplace for Managed Disks;

![marketplace](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/marketplace.webp)

**Step 3 –** Go to Managed Disks and select Create;

![manageddisk](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/manageddisk.webp)
...
generated](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createmanageddisk.webp)
...
![createvm](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createvm.webp)
...
Description automatically
generated](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/newvm.webp)
...
Description automatically
generated](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/publicip.webp)

**Step 9 –** Once the deployment has finished, go to Virtual Machines on the right side and select
the Endpoint Protector image.

![connetctip](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/connetctip.webp)
