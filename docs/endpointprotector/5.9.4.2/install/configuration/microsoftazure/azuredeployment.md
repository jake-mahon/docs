...
![ Creating a storage account](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createstorage.webp)
...
![Naming the container ](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/createcontainer.webp)
...
![Configuring the SAS token](/img/product_docs/endpointprotector/5.9.4.2/configuration/azure/accesstokens.webp)
