...
![ Creating a storage account](/images/endpointprotector/5.9.4.2/configuration/azure/createstorage.webp)
...
![Naming the container ](/images/endpointprotector/5.9.4.2/configuration/azure/createcontainer.webp)
...
![Configuring the SAS token](/images/endpointprotector/5.9.4.2/configuration/azure/accesstokens.webp)
