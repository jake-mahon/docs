...
![Allows you to log in the Endpoint Protector Server with Azure AD and OKTA](../../../../../../static/img/product_docs/endpointprotector/endpointprotector/admin/systemconfiguration/singlesignon/singlesignonpage.webp)
