...
Once users have been granted console access, they can login with their domain credentials. Console access is not a requirement for owners to complete Access Reviews. See the [URL & Login](../Login "URL & Login") topic for information on how users will log in and where they are directed after login based on their assigned role or lack of role.

## Add Console Users

Follow the steps to grant domain users or groups console access.

![Console Access Page](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccess.png "Console Access Page")

**Step 1 –** In the Configuration interface on the Console Access page, click Add. The Console Access wizard opens.

![Console Access wizard showing the Select Trustees page](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccessSelectTrustee.png "Console Access wizard showing the Select Trustees page")
...
![Console Access wizard showing the Select Access page](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccessSelectAccess.png "Console Access wizard showing the Select Access page")
...
![Console Access Page displaying users with various assigned roles](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccessAdd.png "Console Access Page displaying users with various assigned roles")
...
![Console Access wizard showing the Select Access page when modifying](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccessModifySelectAccess.png "Console Access wizard showing the Select Access page when modifying")
...
![Console Access Page showing various user accounts, with one selected enabling the Modify and Remove buttons](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Admin/Config/ConsoleAccessRemove.png "Console Access Page showing various user accounts, with one selected enabling the Modify and Remove buttons")
...
![](../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/General/Window/ModifyBuiltinAdministrator.png)
