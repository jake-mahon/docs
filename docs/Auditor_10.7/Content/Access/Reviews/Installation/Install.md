...
![Netwrix Auditor Access Reviews Setup wizard Welcome page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallWelcome.png "Netwrix Auditor Access Reviews Setup wizard Welcome page")

**Step 2 –** On the Welcome page, click **Next** to begin the installation process.

![Netwrix Auditor Access Reviews Setup wizard End-User License Agreement page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallEULA.png "Netwrix Auditor Access Reviews Setup wizard End-User License Agreement page")
...
![Netwrix Auditor Access Reviews Setup wizard Destination Folder page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallDestinationFolder.png "Netwrix Auditor Access Reviews Setup wizard Destination Folder page")
...
![Netwrix Auditor Access Reviews Setup wizard SQL Server Connection page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallSQL.png "Netwrix Auditor Access Reviews Setup wizard SQL Server Connection page")
...
**NOTE:** See the [Database Page](../Admin/Configuration/Database "Database Page") topic for additional information.

![Database does not exist Confirmation Window](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallSQLDatabase.png "Database does not exist Confirmation Window")

**Step 6 –**  If there are no errors, you will be asked to confirm creation of the new database. Click **Yes**.

![Netwrix Auditor Access Reviews Setup wizard Configure Web Server page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallConfigureWebServer.png "Netwrix Auditor Access Reviews Setup wizard Configure Web Server page")
...
![Netwrix Auditor Access Reviews Setup wizard Ready to Install page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallReady.png "Netwrix Auditor Access Reviews Setup wizard Ready to Install page")

**Step 8 –** On the Ready to install page, click **Install** to begin the process.

![Netwrix Auditor Access Reviews Setup wizard Completed page](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Access/Reviews/Install/Wizard/InstallCompleted.png "Netwrix Auditor Access Reviews Setup wizard Completed page")

**Step 9 –** Once the installation has successfully completed, click **Finish** to exit the wizard.

The installation wizard placed a Netwrix Auditor Access Reviews icon on the desktop. Now proceed to the [First Launch](../Admin/FirstLaunch "First Launch") topic for next steps.