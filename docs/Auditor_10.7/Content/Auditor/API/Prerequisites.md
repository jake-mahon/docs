...
Refer to the [Security](Security "Security") topic for detailed instructions on how
...
Refer to the [Audit Database](../Admin/Settings/AuditDatabase "Audit Database") topic for detailed instructions on how to configure SQL Server settings.