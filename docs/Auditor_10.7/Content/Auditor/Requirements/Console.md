...
Auditor supports only Windows OS versions listed in the [Software Requirements](Software "Software Requirements") topic.
...
\* — ARs stands for Activity Records, that is, Netwrix-compatible format for the audit data. See [Activity Records](../API/PostData/ActivityRecords "Activity Records")[Activity Records](../API/PostData/ActivityRecords) for more details.
...
* [Working Folder](WorkingFolder "Working Folder")
...
**NOTE:** In larger environments, SQL Server may become underprovisioned on resources. For troubleshooting such cases, refer to the [Sample Deployment Scenarios](DeploymentScenarios "Sample Deployment Scenarios") topic.
