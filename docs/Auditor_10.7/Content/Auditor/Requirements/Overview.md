...
* [Supported Data Sources](SupportedDataSources "Supported Data Sources")
* [Hardware Requirements](Console "Hardware Requirements")
* [Software Requirements](Software "Software Requirements")
...
[![](../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/DeploymentPlan/AuditorArchitecture_thumb_0_0.jpg)](../../Resources/Images/Auditor/DeploymentPlan/AuditorArchitecture.jpg)
...
* Audit databases — these are Microsoft SQL Server databases used as operational storage. This type of data storage allows you to browse recent data, run search queries, generate reports and alerts.   
...
* Netwrix Auditor collects audit data from the specified data source (application, server, storage system, and so on).
  ...
  * See the [Integration API](../API/Overview " Netwrix Auditor Integration API Overview") topic for additional information on custom data source processing workflow.
