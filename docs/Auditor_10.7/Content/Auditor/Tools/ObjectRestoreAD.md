...
**Step 3 –** Expand the Schema your\_Root\_Domain\_name node. Right-click the CN=Unicode-Pwd attribute and select Properties.

![](../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/AD_Object_Restore_1.png)

**Step 4 –** Double-click the searchFlags attribute and set its value to *"8"*.

![](../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/AD_Object_Restore_2.png)
