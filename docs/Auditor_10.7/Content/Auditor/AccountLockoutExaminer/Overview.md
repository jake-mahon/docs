...
Since the functionality of older and newer versions does not match one-to-one (see [Feature comparison of Netwrix Account Lockout Examiner 4.1 and 5.x](#Feature "Feature comparison of Netwrix Account Lockout Examiner 4.1 and 5.x")), there is no upgrade path for **Netwrix Account Lockout Examiner 4.1**.
...
| Email alerts | Yes | No – check [Netwrix Auditor](https://www.netwrix.com/auditor) for monitoring and alerting capabilities |
| Online monitor on critical account status | Yes | No – check [Netwrix Auditor](https://www.netwrix.com/auditor) for monitoring and alerting capabilities |
