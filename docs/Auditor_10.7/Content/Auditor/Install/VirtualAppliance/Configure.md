...
![](../../../Resources/Images/Auditor/VirtualApplianceIssues/Appliance_Script.PNG)
...
| --- | --- | --- |
| * See a list of audit settings * See a list of rights and permissions required for data collecting account | — | * [Supported Data Sources](../../Requirements/SupportedDataSources "Supported Data Sources") * [Data Collecting Account](../../Admin/MonitoringPlans/DataAccounts "Data Collecting Account") |
| * Create a monitoring plan * Review data collection status * Configure the Long-Term Archive and the Audit Database settings * Assign roles and delegate control | Auditor Client | * [Monitoring Plans](../../Admin/MonitoringPlans/Overview "Monitoring Plans") * [Netwrix Auditor Settings](../../Admin/Settings/Overview "Settings") * [Role-Based Access and Delegation](../../Admin/MonitoringPlans/Delegation "Role-based access and delegation") |
| * Browse data with interactive search * Review diagrams * Generate reports * Configure report subscriptions * Create alerts | Auditor Client | * [Reports](../../Admin/Reports/Overview "Reports and Report Packs") * [Subscriptions](../../Admin/Subscriptions/Overview "Subscriptions") * [Alerts](../../Admin/AlertSettings/Overview "Alerts") |
| See the data collected by Auditor | Auditor Client | * [Access Reviews](../../AccessReviews "Access Reviews") |
