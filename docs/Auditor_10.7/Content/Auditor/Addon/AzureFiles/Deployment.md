...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/AzureFileEULA.png)

**Step 2 –** Select the installation folder and click **Next**.

![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/AzureFileInstFolder.png)
...
**Step 3 –** Provide Auditor Server IP address and port number followed by endpoint for posting Activity Records. See the [API Endpoints](../../API/Endpoints "API Endpoints") topic for more information.
...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/GeneralSettings.png)
...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/ADCredentials.png)

**Step 5 –** Paste Azure Connection String in the corresponded field and click **Next**.

![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/AzureFileConnectionString.png)

**Step 6 –** Enter Tenant ID, App ID and App Secret of the Azure App you registered for the add-on. Click **Next**.

![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/AzureFile/MicrosoftGraphAPI.png)
