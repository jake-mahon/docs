...
* Azure Files environment is configured for auditing. The connection of Azure file share to Windows should be configured with authentication through Active Directory or Entra ID (as opposed to the account key). See the [Deployment Procedure](Deployment "Deployment Procedure")topic for more information.
* Active Directory Domain Services or Microsoft Entra Kerberos is used as an Identity source. See the [Deployment Procedure](Deployment "Deployment Procedure") topic for additional information.
