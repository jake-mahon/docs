...
[![HIW_CyberArch](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/CyberArk/Diagram_thumb_0_0.png "HIW_CyberArch")](../../../Resources/Images/Auditor/Addon/CyberArk/Diagram.png)
...
2. On the CyberArk server, the administrator opens the **dbparam.ini** file and specifies the parameters for syslog message forwarding, including add-on installation server settings, the IDs of events to be monitored, etc.
   ...
   See the [Monitored Events](MonitoredEvents "Monitored Events") topic for additional information on the events supported for monitoring out of the box.
