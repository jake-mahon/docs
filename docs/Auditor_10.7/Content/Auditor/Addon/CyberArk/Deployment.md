...
See the [Prerequisites](../../API/Prerequisites "Prerequisites") topic for additional information.
...
Optionally, you can create a dedicated monitoring plan in Auditor. In this case, data will be written to a database linked to this plan. Target it at Netwrix API data source and enable for monitoring. Add a dedicated item of *Integration* type to the plan for data to be filtered by item name. See the [Integration API](../../API/Overview "Integration API") topic for additional information.

In such scenario, you will need to specify this monitoring plan in the *naplan* and *naplanitem* attributes of the * ® * configuration parameters. See the [Add-On Parameters](Parameters "Add-On Parameters") topic for additional information.
...
* **SyslogTranslatorFile** – relative path to **Netwrix.xsl** file. You will need to create this file manually and copy the content of **SyslogTranslator.sample.xsl** file into it. This sample file is provided by CyberArk. By default, it is located in the *%Program Files (x86) %\PrivateArk\Server\Syslog* folder.   
...
* **SyslogMessageCodeFilter** - IDs of events to forward. The add-on will only collect and process events you specify in this parameter. For the full list of supported events, see [Monitored Events](MonitoredEvents "Monitored Events"). Use comma as a separator.

[![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/CyberArk/dbparamFile_thumb_0_0.png)](../../../Resources/Images/Auditor/Addon/CyberArk/dbparamFile.png)

**Step 4 –** Save the **dbparam.ini** file.

## Download the Add-On

**Step 1 –** Download the distribution package **Netwrix\_Auditor\_Add-on\_for\_CyberArk\_PAS.zip**.
...
**Step 7 –** On the **Destination Folder** step, specify the installation folder (*C:\Program Files (x86)\Netwrix Add-ons\\* by default).
...
![ConfigurationWizard](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/CyberArk/ConfigWizard.png "ConfigurationWizard")
