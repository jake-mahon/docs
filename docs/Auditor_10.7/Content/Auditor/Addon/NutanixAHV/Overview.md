...
[![HIW_diagram_new](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/NutanixAHV/Diagram_thumb_0_0.png "HIW_diagram_new")](../../../Resources/Images/Auditor/Addon/NutanixAHV/Diagram.png)
...
Syslog event data communication is performed using UDP version of Syslog protocol. See the [Monitoring Scope](MonitoredEvents "Appendix. Monitoring Scope") topic for additional information on the default list of events supported out-of-the box.
...
See the [Integration API](../../API/Overview "Integration API") topic for additional information on the Activity Record structure and capabilities of the Integration API.
