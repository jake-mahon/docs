...
PS C:\Users\AddOnUser> C:\Add-ons\Netwrix\_Auditor\_Add-on\_for\_LogRhythm.ps1 - NetwrixAuditorHost 172.28.6.15
...
By default, the Auditor Integration event log size is set to 1GB, and retention is set to "*Overwrite events as needed*". See the [Integration Event Log Fields](IntegrationEventLog "Integration Event Log Fields") topic for additional information.
