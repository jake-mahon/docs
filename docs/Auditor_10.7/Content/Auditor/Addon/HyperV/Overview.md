...
[![HIW](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/HyperV/Diagram_thumb_0_0.png "HIW")](../../../Resources/Images/Auditor/Addon/HyperV/Diagram.png)
...
5. This script creates a Windows scheduled task that will run periodically (every 15 minutes) to collect audit data from VMM server.
   ...
   See the [Monitoring Scope](MonitoredEvents "Appendix A. Monitored SCVMM Events") for additional information on the default list of the events supported out-of-the box.
...
* **Contributor** role in Auditor. See the [Role-Based Access and Delegation](../../Admin/MonitoringPlans/Delegation "Role-based access and delegation") topic for additional information.
