...
In such scenario, you will need to specify this monitoring plan in the *NetwrixAuditorPlan* and *NetwrixAuditorPlanItem* parameters in the **settings.xml** file. See the [Add-On Parameters](Parameters "Add-On Parameters") topic for additional information.
...
See the [Add-On Parameters](Parameters "Appendix B. Add-on Parameters")topic for the full list of configuration parameters.
...
| DataCollectionUserName | (empty) | Specify user account that will be used for data collection from SCVMM server. To use the account currently logged in, leave this parameter empty.s  Make sure the account has administrative rights on that server (see the [Accounts and Rights](Overview#Accounts "Accounts and Rights") topic for additional information). |
...
For the full list of parameters, see the [Add-On Parameters](Parameters "Add-On Parameters") topic for additional information.
