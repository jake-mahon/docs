...
See the [Deployment Scenarios](Deployment "Deployment Scenarios")topic for additional information.
...
For details on remote troubleshooting and authentication issues, see the following Microsoft article: [about\_Remote\_Troubleshooting](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_remote_troubleshooting?view=powershell-6 "about_Remote_Troubleshooting").
