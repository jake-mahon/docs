...
See [CIM Data Model Mapping](DataModelMap "CIM Data Model Mapping") for details.
...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Addon/Splunk/Diagram.png)

To learn more about Netwrix Auditor activity records, see the [Activity Records](../../API/PostData/ActivityRecords "Activity Records") topic for additional information.
