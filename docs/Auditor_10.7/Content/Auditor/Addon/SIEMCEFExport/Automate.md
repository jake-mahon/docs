...
| Add arguments (optional) | Add a path to the add-on in double quotes and specify add-on parameters.  For example:  -file "C:\Add-ons\Netwrix\_Auditor\_CEF\_Export\_Add-on.ps1" -OutputFolder C:\CEF\_Export -NetwrixAuditorHost 172.28.6.15 |
