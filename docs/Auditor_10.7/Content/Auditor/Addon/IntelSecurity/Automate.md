...
| Add arguments (optional) | Add a path to the add-on in double quotes and specify add-on parameters.  For example:  -file "C:\Add-ons\Netwrix\_Auditor\_Add-on\_for\_Intel\_Security.ps1" -NetwrixAuditorHost 172.28.6.15 |
