...
[![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/RiskAssessment/Dashboard_thumb_0_0.png)](../../../Resources/Images/Auditor/RiskAssessment/Dashboard.png)
...
Default threshold values for risk levels are set in accordance with recommendations of Netwrixindustry experts, as described in the [How Risk Levels Are Estimated](Levels "How Risk Levels Are Estimated")  topic. They can be, however, easily customized to reflect your organization's internal security policies and standards. Follow the steps to customize the metrics.
...
[![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/RiskAssessment/Modify_thresholds_thumb_0_0.png)](../../../Resources/Images/Auditor/RiskAssessment/Modify_thresholds.png)
...
You can create a subscription to periodically receive IT risk assessment results by email or using a file share. For that, in the dashboard window click Subscribe and configure the necessary settings. See the [Create Subscriptions](../Subscriptions/Create "Create Subscriptions") topic for additional information.
