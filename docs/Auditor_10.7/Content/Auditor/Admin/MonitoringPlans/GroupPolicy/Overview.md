...
* [Group Policy](../../../Configuration/GroupPolicy/Overview "Group Policy") – Configure data source as required to be monitored
...
| Prerequisites | Netwrix Auditor will automatically look up additional system components and prompt you to install those that are missing. In case all required components have been already installed, this section will be omitted. See the [Other Components](../../../Requirements/Software#Addition "Other Components") topic for additional information. |
