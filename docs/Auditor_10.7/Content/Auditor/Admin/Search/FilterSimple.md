...
| Action | Filter data by action type (Added, Removed, etc.)  Select an action type from the list (Added, Removed, Modified, Read).  For additional actions, navigate to the Advanced mode. See the [Use Filters in Advanced Mode](FilterAdvanced "Use Filters in Advanced Mode") topic for additional information. |
...
![Account specification](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Search/Filter/Add.png "Account specification")
...
![Filter](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Search/Filter/AddSuggestions.png "Filter")
