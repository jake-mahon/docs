...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/AuditIntel/Investigate.png)

To import audit data with the Archive Data Investigation wizard

**NOTE:** You must be assigned the Global administrator role to import investigation data. To view investigation data, you must be assigned the Global administrator or Global reviewer role. See [Assign Roles](../MonitoringPlans/Delegation#Assign "Assign Roles") topic for more information.
