...
In Netwrix Auditor 9.0, Netwrix has updated API schemas. See the [Compatibility Notice](../../API/Compatibility "Compatibility Notice") topic for additional information.

To learn more about Integration API capabilities, refer to the [Integration API](../../API/Overview "Integration API").