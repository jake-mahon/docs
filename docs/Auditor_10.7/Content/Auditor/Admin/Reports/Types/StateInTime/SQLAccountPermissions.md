...
[![](../../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Report/SQLServer/AccountPermissionsSQLServer_thumb_0_0.png)](../../../../../Resources/Images/Auditor/Report/SQLServer/AccountPermissionsSQLServer.png)
...
* **Object path** — monitored object path as formatted by Netwrix Auditor in the activity records (see '*What*' field in the reports, search results and activity summaries). For example, if reporting on the database hosted on selected SQL Server, the path will be as follows: *Databases\database\_name*.
* **Object type** — monitored object type; for the full list of supported object types, refer to [SQL Server](../../../../Configuration/SQLServer/Overview "SQL Server") topic.
...
* Permissions for INFORMATION\_SCHEMA granted via *master db* will not be reported.
...
* Clicking a Object permissions link opens the [Object Permissions in SQL
  Server](SQLObjectPermissions "Object Permissions in SQL Server") report.
* Clicking a Means granted link opens the **[SQL Server Means Granted](SQLMeansGranted "SQL Server Means Granted")** report.
