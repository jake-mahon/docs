...
To instruct Netwrix Auditor to collect data needed for this report, make sure that **Collect data for state-in-time reports** option is selected in the monitoring plan properties. See [Settings for Data Collection](../../../../Solutions/ManagePlans/Accounts "Settings for Data Collection").

[![](../../../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/Report/SQLServer/SQLServerLevelRoles.png)](../../../../../Images/Audit_Intel/Reports/SQL/Server_roles.png)
