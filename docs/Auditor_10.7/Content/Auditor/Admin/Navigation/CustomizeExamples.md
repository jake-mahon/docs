...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/HomeScreen/Scenario_Reports_1.png)
...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/HomeScreen/Scenario_Reports_2.png)
...
**Step 2 –** Specify search filters to narrow your search results. See the [Use Filters in Simple Mode](../Search/FilterSimple "Use Filters in Simple Mode") topic for additional information.
...
**Step 6 –** Specify a name for the new alert. See the [Create Alerts](../AlertSettings/Create "Create Alerts")topic for additional information.
...
**Step 2 –** Review the Risk Assessment Overview dashbord and select the risk you are interested in, such as "*User Accounts with administrative permissions*". See the [IT Risk Assessment Overview](../RiskAssessment/Overview "IT Risk Assessment Overview")  topic for additional information.
...
3. Search the group of risks you want to pin to the home page (in this case, the "*Permissions*" risks group):
   ...
   [![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/HomeScreen/Scenario_Risks_thumb_0_0.png)](../../../Resources/Images/Auditor/HomeScreen/Scenario_Risks.PNG)
...
Personalize the home page of the product depending on your business needs. Review the customization settings and collect only required tiles for quick access on the Auditor home page. See the [Customize Home Screen](CustomizeHome "Customize Home Screen") topic for additional information.