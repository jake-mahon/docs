...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/HomeScreen/Favorites/ReportsFavorites.png)
...
![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/HomeScreen/Favorites/ReportSummary.png)
...
| View | Opens the Preview Report page. There, you can modify report options (such as the timeframe) if desired, and then click View Report to see the resulting report. See the [View Reports](../Reports/View "View Reports") topic for additional information. |
| Subscribe | Opens the Add Subscription to Report page. See the [Create Subscriptions](../Subscriptions/Create "Create Subscriptions") topic for additional information. |
