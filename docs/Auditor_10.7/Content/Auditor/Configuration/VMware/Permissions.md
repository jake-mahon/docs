...
See the following VMware article for additional information: [Add Members to a vCenter Single Sign-On Group](https://docs.vmware.com/en/VMware-vSphere/7.0/com.vmware.vsphere.authentication.doc/GUID-CDEA6F32-7581-4615-8572-E0B44C11D80D.html "Add Members to a vCenter Single Sign-On Group").
...
* [Create a New Monitoring Plan](../../Admin/MonitoringPlans/Create "Settings for Data Collection") step of the monitoring plan wizard