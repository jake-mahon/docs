...
* Configure Data Collecting Account as described in [Permissions for SQL Server Auditing](Permissions "Permissions for SQL Server Auditing")section.
* Configure ports as described in the [SQL Server Ports](Ports "SQL Server Ports") section.