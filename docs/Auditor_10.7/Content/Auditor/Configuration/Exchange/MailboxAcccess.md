...
It is recommended to select **Adjust audit settings automatically** option when setting up Exchange monitoring in Netwrix Auditor. See the [Create a New Monitoring Plan](../../Admin/MonitoringPlans/Create "Settings for Data Collection") topic for additional information.
