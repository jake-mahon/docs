...
You can configure these settings automatically using Netwrix Auditor, as described in the [Active Directory: Automatic Configuration](../ActiveDirectory/Automatic "Active Directory: automatic configuration") topic.
