...
5. Under the Select Events to Log, select the following (minimal requirement, select other events if needed):
   ...
   * VPN Tunneling
   ...
   ![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ManualConfig/Manual_Config_Pulse_1.png)
...
17. Navigate to your monitoring plan for Network Devices. See [Monitoring Plans](../../Admin/MonitoringPlans/Overview "Monitoring Plans")
18. Provide the IP address of the interface you specified on the step 14 as the Computer item for your monitoring plan. See [Active Directory](../../Admin/MonitoringPlans/ActiveDirectory/Overview "Active Directory Plans")
