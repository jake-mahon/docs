...
2. Execute the following commands:
   ...
   `` is the name of the UDP port used to listen to network devices (514 port used by default). [Network Devices](../../Admin/MonitoringPlans/NetworkDevices "Network Devices Plans")
