...
3. Navigate to Configuration → System → Logging and click + to add a new Syslog Server.
   ...
   ![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ManualConfig/NAND_Aruba_Logging.png)
...
9. If the configuration is correct, you will see the following wizard:
   ...
   ![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ManualConfig/NAND_Aruba_Status.png)
