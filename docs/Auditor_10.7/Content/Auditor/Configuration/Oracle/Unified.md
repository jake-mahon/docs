...
Starting with 10.5 version, Netwrix Auditor provides limited support of Oracle Database 11g and trail auditing mode accordingly. See [Considerations for Oracle Database Auditing for more information.](../../Requirements/Supported_Environment#ConsiderationsOracle)
...
The procedure contains basic migration steps. Refer to [Oracle\_Database\_Upgrade\_Guide](https://docs.oracle.com/database/121/UPGRD/toc) for more detailed upgrade scenario.
