...
**Step 6 –** Grant `SELECT` privilege on the required object to that account. See the [For Oracle Database Auditing](#For "For Oracle Database Auditing") topic for the detailed object list. For that, execute: `GRANT SELECT ON  TO ;`  
