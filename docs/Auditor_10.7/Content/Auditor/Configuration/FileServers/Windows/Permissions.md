...
* The **Manage auditing and security log** and Backup files and directories policies must be defined for this account. See the [Permissions for Active Directory Auditing](../../ActiveDirectory/Permissions "Permissions for Active Directory Auditing") and topics for additional more information.
...
* [Use Group Managed Service Account (gMSA)](../../../Requirements/gMSA)")
