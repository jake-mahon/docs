...
* [Configure NetApp Clustered Data ONTAP 8 and ONTAP 9 for Monitoring](#Configur5 "Configure NetApp Clustered Data ONTAP 8 and ONTAP 9 for Monitoring")
* [Configure Audit Settings for CIFS File Shares](CIFS "Configure Audit Settings for CIFS File Shares")
...
* [Prerequisites](#Prerequi "Prerequisites")
* [Configure ONTAPI\RESTAPI Web Access](WebAccess#Configur "Configure ONTAPI\RESTAPI Web Access")
* [Configure System Service Firewall Policies](Ports#Configur2 "Configure System Service Firewall Policies")
* [Configure Service Policy](ServicePolicy#Configur4 "Configure Service Policy")
* [Configure Event Categories and Log](EventCategories#Configur3 "Configure Event Categories and Log")
...
| --- | --- |
| Clustered Data ONTAP 8.2 | * [Clustered Data ONTAP® 8.2 File Access and Protocols Management Guide](https://library.netapp.com/ecm/ecm_download_file/ECMP1196891 "Clustered Data ONTAP® 8.2 File Access and Protocols Management Guide") * [Clustered Data ONTAP® 8.2 System Administration Guide for SVM Administrators](https://library.netapp.com/ecm/ecm_download_file/ECMP1368704 "Clustered Data ONTAP® 8.2 System Administration Guide for SVM Administrators") |
| Clustered Data ONTAP 8.3 | * [Clustered Data ONTAP® 8.3 System Administration Guide for Cluster Administrators](https://library.netapp.com/ecm/ecm_get_file/ECMP1636037 "Clustered Data ONTAP® 8.3 System Administration Guide for Cluster Administrators") * [Clustered Data ONTAP® 8.3 File Access Management Guide for CIFS](https://library.netapp.com/ecm/ecm_download_file/ECMP1610207 "Clustered Data ONTAP® 8.3 File Access Management Guide for CIFS") |
| ONTAP 9.0 - 9.10 | * [ONTAP 9 Documentation Center](http://docs.netapp.com/ontap-9/index.jsp "ONTAP 9 Documentation Center") |
...
**Step 2 –** Configure System Access Control List (SACL) on your file share. See [Configure Audit Settings for CIFS File Shares](CIFS "Configure Audit Settings for CIFS File Shares") topic for additional information.

**Step 3 –** Set the Security Style for Volume or Qtree where the audited file shares are located to the *"ntfs"* or *"mixed"*.

**Step 4 –** Configure audit manually. For 8.3, review the Auditing NAS events on SVMs with FlexVol volumes section in [Clustered Data ONTAP® 8.3 File Access Management Guide for CIFS.](https://library.netapp.com/ecm/ecm_download_file/ECMP1610207 "Clustered Data ONTAP® 8.3 File Access Management Guide for CIFS")
