...
cluster1::> vserver services web show -vserver svm1
```
**Step 4 –** Review the [Permissions for NetApp Auditing](Permissions "For NetApp Auditing") topic for additional information on how to create the role and enable AD user access.
...
```
**Step 7 –** Make sure that the custom role (e.g., netwrix\_role for ONTAPI or netwrix\_rest\_role for RESTAPI) assigned to your account specified for data collection can access ONTAPI or RESTAPI. See [Permissions for NetApp Auditing](Permissions "Permissions for NetApp Auditing") topic for additional information.
