...
* [Normal and Enterprise Modes for Clusters](Normal "Normal and Enterprise Modes for Clusters")
* [Compliance Mode](Compliance "Compliance Mode")
...
**NOTE:** For Dell Isilon/PowerScale storage, auditing of *System* zone is not supported. As stated by Dell, this zone should be reserved for configuration access only. Current data should be stored in other access zones. See the [Dell Upsilon CLI Administration Guide](https://www.dellemc.com/en-us/collaterals/unauth/technical-guides-support-information/2019/09/docu95372.pdf "Dell Isilon CLI Administration Guide") for additional information.
