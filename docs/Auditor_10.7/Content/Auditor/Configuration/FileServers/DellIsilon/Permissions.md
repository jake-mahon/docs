...
See the [Configuring Your Dell Isilon/PowerScale Cluster for Auditing](#Configur "Configuring Your Dell Isilon/PowerScale Cluster for Auditing") section for additional information.
...
* Automatic configuration: you can use a special shell script for configuring an audited Dell Isilon/PowerScale cluster and granting necessary privileges to the account used to collect audit data. See the following topics for additional information:
  * [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode via Shell Script](Normal#Configur "Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode via Shell Script")
  * [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Via Shell Script](Compliance#Configur "Configure Dell Isilon/PowerScale Cluster in Compliance Mode Via Shell Script")
* Manual configuration: you can grant all the necessary permissions to data collecting account manually. See the following topics for additional information:
  * [Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode Manually](Normal#Configur2 "Configure Dell Isilon/PowerScale Cluster in Normal or Enterprise Mode Manually")
  * [Configure Dell Isilon/PowerScale Cluster in Compliance Mode Manually](Compliance#Configur2 "Configure Dell Isilon/PowerScale Cluster in Compliance Mode Manually")
...
**Step 4 –** To connect to Dell Isilon/PowerScale storage cluster, an account must be assigned a custom role (e.g., *netwrix\_audit*) that has the following privileges:
...
See the [Normal and Enterprise Modes for Clusters](Normal "Normal and Enterprise Modes for Clusters") topic for additional information.