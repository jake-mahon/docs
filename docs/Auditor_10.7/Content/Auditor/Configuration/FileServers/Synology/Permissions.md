...
See the [Use Group Managed Service Account (gMSA)](../../../Requirements/gMSA)") topic and the [Group Managed Service Accounts Overview](https://docs.microsoft.com/en-us/windows-server/security/group-managed-service-accounts/group-managed-service-accounts-overview "Group Managed Service Accounts Overview") Microsoft article for additional information.
