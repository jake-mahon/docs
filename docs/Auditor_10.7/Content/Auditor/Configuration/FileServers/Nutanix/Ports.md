...
Later, you can specify any custom TCP port when editing your Nutanix Files monitoring plan. See the [File Servers](../../../Admin/MonitoringPlans/FileServers/Overview "File Servers Plans") (Nutanix section) for more information.