...
See the [Using Modern Authentication with Microsoft Entra ID](ModernAuth "Using Modern Authentication with Microsoft Entra ID") topic for additional information.
