...
| --- | --- | --- | --- | --- |
| 80 | TCP | Netwrix Auditor Server | For a full list of Office 365 URLs, refer to the following Microsoft support article: [Office 365 URLs and IP address ranges](https://support.office.com/en-us/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2 "Office 365 URLs and IP address ranges") | login.windows.net  graph.windows.net  manage.office.com |
