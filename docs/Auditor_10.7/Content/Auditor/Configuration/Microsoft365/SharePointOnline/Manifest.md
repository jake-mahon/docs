...
* For the clear installation of Netwrix Auditor, add roles as described in the [Using Modern Authentication with SharePoint Online](ModernAuth "Access SharePoint Online Using Modern Authentication") topic.
