...
[![Log Properties dialog box](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ManualConfig/ManualConfig_WS_EventViewerPr2016_thumb_0_0.png "Log Properties dialog box")](../../../Resources/Images/Auditor/ManualConfig/ManualConfig_WS_EventViewerPr2016.png)
...
**Step 1 –** Open the Group Policy Management Editor on the domain controller and go to **Computer Configuration > Policies > Administrative Templates > Windows Components > Event Log Service**.

**Step 2 –** Select the log you need.

**Step 3 –** Edit Specify the maximum log file size setting; the value is usually set to *4194240 KB*.
...
HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Services\EventLog\. For example: HKEY\_LOCAL\_MACHINE\SYSTEM\CurrentControlSet\Services\EventLog\Directory Service

**Step 2 –** Set the MaxSize to the required decimal value (in bytes).

[![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ConfigViaGPO/GPO_EventLog_RegEdit_thumb_0_0.png)](../../../Resources/Images/Auditor/ConfigViaGPO/GPO_EventLog_RegEdit.png)
...
**Step 1 –** In Group Policy Management Console on the domain controller go to **Computer > Preferences > Windows Settings > Registry**.
...
* Key Path – browse to MaxSize value at the
  ...
  [![](../../../../../../static/images/Auditor_10.7/Content/Resources/Images/Auditor/ConfigViaGPO/GPO_EventLog_GPMC_thumb_0_0.png)](../../../Resources/Images/Auditor/ConfigViaGPO/GPO_EventLog_GPMC.png)

**Step 4 –** Change the MaxSize REG\_DWORD to the required decimal value (in bytes).
