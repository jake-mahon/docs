...
**NOTE:** For auditing Logon Activity, you also need to assign the Read permission to the *HKEY\_LOCAL\_MACHINE\SECURITY\Policy\PolAdtEv* registry key.
