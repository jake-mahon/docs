---
sidebar_position: 3173
title: 'Endpoint Policy Manager: Use the DesignStudio to manage FireFox''s about:config
  settings'
---

# Endpoint Policy Manager: Use the DesignStudio to manage FireFox's about:config settings

Firefox is easy to manage using Netwrix Endpoint Policy Manager (formerly PolicyPak). Here is the how-to using the Endpoint Policy Manager **DesignStudio** to implement about:config settings within your Paks.
