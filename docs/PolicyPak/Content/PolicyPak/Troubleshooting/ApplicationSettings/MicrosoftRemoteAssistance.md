---
sidebar_position: 3820
title: How to use Scripts Manager to workaround the "PPAppLockdr64.dll is either not
  designed to run on Windows or it contains an error" message when running Microsoft
  Remote Assistance (MSRA.exe) and the Endpoint Policy Manager CSE is installed on
  Windows 10 1903
---
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_1_image-20191015113622-1.png)

**Step 1 –** Create the Scripts Manager policy in PolicyPak.

**Step 2 –** Run the Microsoft Group Policy Management Console (GPMC) as a user with the necessary rights (to create and link GPOs at that level) and then create a new GPO and link the GPO at the OU (User Level) or Domain level depending on who needs to receive these settings.

For example:

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_2_image-20191015113622-4.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_3_image-20191015113622-5.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_4_image-20191015113622-6.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_5_image-20191015113622-7.png)

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/ApplicationSettings/280_6_image-20191015113622-2.png)
