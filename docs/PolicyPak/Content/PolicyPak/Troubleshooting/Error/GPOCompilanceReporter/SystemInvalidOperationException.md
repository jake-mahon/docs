---
sidebar_position: 3926
title: GPCR Snapshot fails with error "System.InvalidOperationException" when using
  a remote SQL server and one is a clone of the other
---
...
![](../../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/Error/GPOCompilanceReporter/794_1_image-20200327171540-1.jpeg)
...
```
To enable diagnostic logging, follow the directions in the article [How do I turn on enhanced logging for Endpoint Policy Manager Group Policy Compliance Reporter if asked to do so?](../../GroupPolicyComplianceReporter/LogEnhanced)g-for-ppgpcr-server-if-asked/
