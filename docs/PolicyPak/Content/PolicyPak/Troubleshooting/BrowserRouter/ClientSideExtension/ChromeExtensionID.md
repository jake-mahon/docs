...
title: What is the Chrome Extension ID for all the published versions of Endpoint
  Policy Manager Browser Router Client Side Extension?
---
...
[Endpoint Policy Manager Browser Router removes other Chrome ‘force installed' extensions. How can I work around this?](../Chrome/ForceInstall)
...
**NOTE:**  Edge Chromium uses the same PPBR Chrome Extension.You can see the extension ID in Edge Chromium by visiting edge://extensions from within Edge Chromium.

![](../../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/BrowserRouter/ClientSideExtension/202_1_image-20220105135628-1.png)
