...
First, to verify and ensure the problem is with the Endpoint Policy Manager Cloud service, and not something on your end, please see the following article [Troubleshoot communication from the Cloud Client and Cloud Service](ServiceCommunication "Troubleshoot communication from the Cloud Client and Cloud Service") (and the sub-KB articles at the end).
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/Cloud/612_1_rt.jpg)
...
Additionally, clients will not disconnect or become un-joined from the Endpoint Policy Manager Cloud server.