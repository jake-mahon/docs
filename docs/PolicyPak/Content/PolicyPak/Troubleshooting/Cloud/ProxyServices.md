---
sidebar_position: 3856
title: 'I always use a proxy and the cloud client cannot seem to make contact with
  the services (see FAQ Item #3 above first.) What else can I try?'
---
...
**Step 3 –** Find the `HKEY_Current_UserSoftwareMicrosoftWindowsCurrentVersionInternet SettingsConnections`

`"DefaultConnectionSettings"`

**Step 4 –** Find the `HKEY_Current_UserSoftwareMicrosoftWindowsCurrentVersionInternet SettingsConnections`

`"SavedLegacySettings"`

**Step 5 –** Copy each one to the path for the .`DEFAULT profile. HKEY_USERS.DEFAULTSoftwareMicrosoftWindowsCurrentVersionInternet SettingsConnectionsDefaultConnectionSettings` and  `SavedLegacySettings.`

You should see the proxy information like what is seen here in the binary value.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/Cloud/373_1_image005sdfggrt.png)