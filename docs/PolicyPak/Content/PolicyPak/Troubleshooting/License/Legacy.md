...
* The Netwrix Endpoint Policy Manager (formerly PolicyPak) CSE (endpoint piece) is hardcoded to stop honoring Legacy licenses on Feb 28, 2023… even if you have a Valid Legacy license hitting the machine.
...
* Video: [Legacy License Retirement Guidance (for Feb 28, 2023)](../../Video/License/Legacy)")
...
* Therefore: You should be able to pick up your existing keys at portal.policypak.com. Example of how to find existing keys:
  ...
  ![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_1_1.png)
...
* Example download of valid dates with both Universal and Legacy keys, but only Universal keys will be honored past Feb 28, 2023:
  ...
  ![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_2_2_950x572.png)
...
* BEST:
  * Import the Universal license and make sure it hits your endpoints. If you do not have a universal license, you may request one by opening a case at [Netwrix support](https://www.netwrix.com/sign_in.html?rf=tickets.html#/open-a-ticket "Netwrix support"). Please do not wait until the last minute to get your license as we could have many requests to field.
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/1231_LicenseADMXSetting.png)
...
* Video: [How to install UNIVERSAL licenses for NEW Customers (via GPO, SCCM or MDM)](../../Video/License/InstallUniversal)

  **NOTE:**   You cannot import both Legacy and Universal licenses into the same GPO. You need separate GPOs for both license types. If you try to put both licenses into the same GPO you will get the error: "Sorry but you can't install GP and Enterprise licenses into the same GPO, please install them to different GPOs or select licenses with the same type."
...
* Example of a machine getting Universal licenses successfully:
  ...
  ![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_3_3_950x610.png)
* FAQ on error conditions: [How can I tell how a machine is licensed (by GPO, MDM, or XML file), and also know for what components it is licensed?](Components).
* **NOTE:** The Latest CSE in the portal (build 3375) will also express Invalid licenses if any are applying to the machine. Example:
  ...
  ![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_4_4_950x675.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_5_image-20230126194031-1.png)

*Remember,*  this is a display bug in 3375 which has been removed in the latest CSE version. This message can safely be ignored.
...
The message in CSE 3375 and earlier says: “The license is valid. WARNING: GP licenses will no longer be accepted after Feb 28th, 2023.”

Example:

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_6_image-20230126194031-2_950x764.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Troubleshooting/License/840_7_image_950x724.png)