---
sidebar_position: 3652
title: Extras Tab
---

# Extras Tab

Video: For a quick overview of how to manage certificates in IE using Endpoint Policy Manager Application Settings Manager see the following video: .
...
**NOTE:**  Endpoint Policy Manager can only deploy binary/DER type certificates. If you need to convert an existing certificate to DER format, please see the section, "Exporting Certificates to the Binary-Encoded DER Format."

Examples of IE certificates are shown in Figure 29.

![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/Preconfigured/InternetExplorer/IE AppSet Tab by Tab_25.png)
...
```
![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/Preconfigured/InternetExplorer/IE AppSet Tab by Tab_26.png)
...
**NOTE:**  Non-elevated users are not allowed to remove certificates from the machine store, so you can use `Machine\{Store Name}` to ensure certificates are delivered to everyone and cannot be removed by users.
...
![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/Preconfigured/InternetExplorer/IE AppSet Tab by Tab_27.png)
...
![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/Preconfigured/InternetExplorer/IE AppSet Tab by Tab_28.png)
...
![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/Preconfigured/InternetExplorer/IE AppSet Tab by Tab_29.png)
