---
sidebar_position: 3261
title: How-to gain access of a remote computer using built-in Windows Remote Assistance
  application?
---
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_1_image-20200330200931-1.png)

**Step 3 –** Give the GPO a descriptive Name then click the OK button.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_3_image-20200330200932-2.png)

**Step 4 –** Right-click on the new GPO you just created, and select Edit option.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_5_image-20200330200932-3.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_7_image-20200330200932-4.png)

**Step 6 –** Right-click on the PAK entry and select the Properties option.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_9_image-20200330200932-5.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_11_image-20200330200932-6.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_13_image-20201016161058-2.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_14_image-20201016162349-4.png)

Or you can combine both policies in one if you prefer:

![](../../../../../static/images/PolicyPak/Content/Resources/Images/ApplicationSettings/686_15_image-20201016162040-3.png)

For more information on Endpoint Policy Manager Scripts Manager please consult the below reference articles.

Reference Article

* [How to use Scripts Manager to workaround the "PPAppLockdr64.dll is either not designed to run on Windows or it contains an error" message when running Microsoft Remote Assistance (MSRA.exe) and the Endpoint Policy Manager CSE is installed on Windows 10 1903](../Troubleshooting/ApplicationSettings/MicrosoftRemoteAssistance.htm "How to use Scripts Manager to workaround the /"PPAppLockdr64.dll is either not designed to run on Windows or it contains an error/" message when running Microsoft Remote Assistance (MSRA.exe) and the Endpoint Policy Manager CSE is installed on Windows 10 1903")
