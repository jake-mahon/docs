...
* Dictate specific versions of Java that should be utilized by specific Java applets (usually housed within specific webpages).
...
**NOTE:** See this video [Use Endpoint Policy Manager Cloud to choose which version of Java for what website](../Video/JavaEnterpriseRules/Cloud "Use Endpoint Policy Manager Cloud to choose which version of Java for what website") for an overview of Endpoint Policy Manager Java Rules Manager.
...
* Export policies or collections as XML files for use with PolicyPak Exporter and PolicyPak Cloud. See [Exporting Collections](ExportCollections "Exporting Collections") for additional information.
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 6 - Java Enterprise Rules Manager Component_manual/About PolicyPak Java Rules.png)
...
* First, create a Microsoft Group Policy Object (GPO) using PolicyPak Java Rules Manager. If you use Group Policy as the delivery mechanism, then that directive is deployed to client machines.
* Alternatively, export the PolicyPak Java Rules Manager rules and deliver them via the following applications:
...
**NOTE:** If you use the PolicyPak Cloud service, you can deliver Group Policy settings even to non-domain-joined machines over the Internet.