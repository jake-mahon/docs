...
![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/GPOCompilanceReporter/GPCR Server with Push Mode_12.png)

Figure 48. Sharing the Auditor folder.

**Step 2 –** Next, in the wizard, specify the UNC path to `PPGPCR.Auditor.exe`, as shown in Figure 49.

![](../../../../../../../../static/images/PolicyPak/Content/Resources/Images/GPOCompilanceReporter/GPCR Server with Push Mode_13.png)

Figure 49. Entering the UNC path for the auditor EXE.

**NOTE:** You may copy the auditor EXE and its related DLLs to another server or get them onto endpoints to run locally. If you choose to do this, update the path accordingly.