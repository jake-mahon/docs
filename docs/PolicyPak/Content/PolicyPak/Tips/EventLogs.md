...
**NOTE:** If you want to learn more about on-prem Event Forwarding, you can see my Walkthrough of that here [Using Windows Event Forwarding to search for interesting events](../Video/LeastPrivilege/WindowsEventForwarding) and [How to forward interesting events for Least Privilege Manager (or anything else) to a centralized location using Windows Event Forwarding.](../LeastPrivilege/WindowsEventForwarding).
...
The official documentation for LA can be found ; but I had a few stumbles. Some tips o' the hat to Travis Roberts' video and blog which also helped give me a leg up. The blog is  and the helpful video series on Azure Log Analytics (though a little old now because of the name and UI changes) can be found at: 
...
**Step 1 –** To get started use the big search thingie to find "Log Analytics workspaces" like what's seen here.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7ec45-img-01.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bb83ef-img-02.png)

**Step 2 –** Then you should be thrown into the Advanced settings like what's seen here. If not, find the Workspace you just created and click Advanced in the left-side menu. It should get you to this place. Note then the "WORKSPACE ID" and "PRIMARY KEY" like what's seen here. Hang on to those, you'll need these in a bit. Then also download the Windows Agent 64-bit or 32-bit to get started for your example machines.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bb8f55-img-03.png)
...
**Step 3 –** Once you have the download, get it over to your test machine. Machine can be real or virtual. Note that you shouldn't do this (nor do you need to) for WVD virtual machines. Those have a magical connector to accept event logs to LA; and you shouldn't need to use this method. (Docs:  and a blog )

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bc2bfc-img-04.png)

**Step 4 –** Then, Up, Up and away. Launch the agent.. which requires admin rights. (Or, pro tip: Use Endpoint Policy Manager Scripts to install it automatically where the script is elevated.[Endpoint Policy ManagerScripts .. Deploy Software via VPN or with Endpoint Policy Manager Cloud](../Video/ScriptsTriggers/Cloud)

**Step 5 –** You'll need to select "Connect the agent to Azure Log Analytics (OMS)" like what's seen here.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bad3be-img-05.png)

**Step 6 –** Then, it's time to chuck in your Workspace ID and Workspace Key. And you'll likely keep the default of Azure Cloud: Azure Commercial. Pull the pulldown if you have something unusual to select here.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bbca1c-img-06.png)

**Step 7 –** Yes, you want to check for updates when MS Update kicks in….

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bc37d5-img-07.png)

**Step 8 –** And.. you're basically done.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570be8938-img-08.png)

**Step 9 –** Now let's make sure we're talking in both directions. The Microsoft Monitoring Agent is found in Control Panel… which is a weird place, but, hey… that's okay.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570be4088-img-09.png)

**Step 10 –** Then click the Azure Log Analytics (OMS) tab and … see you're talking outbound.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bec541-img-10.png)

**Step 11 –** Back in Azure, in the Advanced Settings page, the zero should be one !

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bdece8-img-11.png)

**Step 12 –** Now it's time to add in the actual event logs you want to capture. Note that the more you capture, the more you pay. Strictly speaking for the Endpoint Policy Manager customer I made this blog entry for, he only needed to capture the Endpoint Policy Manager log (which I do last.) But just for completeness and testing, I'll capture some more too, since you might not have the Endpoint Policy Manager Log. (And, why don't you!? Come on over and check out Endpoint Policy Manager for Pete's sake. Really, your sake to be honest.)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bc37d5-img-12.png)

**Step 13 –** So just type Application then +. Then System and + and bingo. Those are "well known" logs which LA knows about and pre-populates this list. But Endpoint Policy Manager? Not as common.. (Yet !) Therefore you could take a guess that our event logs are named Endpoint Policy Manager (they are…). But how would you know?

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570be8938-img-13.png)

**Step 14 –** The trick is to find the log you want to capture in Windows, and go to its properties and get its Full Name like what's seen here. Yeah, this one was easy.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570be4088-img-14.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bec541-img-15.png)

You can see that second log here…

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570bdece8-img-16.png)

**Step 15 –** Once I pasted in all the logs and added them, I clicked Save and got this!

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7ec3c-img-17.png)

## Data.. data? Do we have data ?

**Step 1 –** Click on Logs and close the sample queries. Let's just see what have. All of it (which shouldn't be much.)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7ee5e-img-18.png)

**Step 2 –** In the top box, type SEARCH

**Step 3 –** Then click Run. Bingo.. out should pop all the events that have been captured. You can change the Display Time to make sure that you're getting the right events, right now.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7e690-img-19.png)

**Step 4 –** It took a little while for the non-well-known logs to show up. But maybe it will work faster for you than for me. If you want to give it a shot and try your non-well-known logs, like this, give it a go.
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7ed35-img-20.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/Tips/f5f03570b7e4f0-img-21.png)
