...
**NOTE:** You can also use Microsoft Group Policy Software Installation to deploy the Endpoint Policy Manager CSE. However, software delivery (and removal) by Group Policy Software Installation can be unreliable, and this method is not recommended.

If you do choose to use it, the process can usually done in four steps:

**Step 1 –** Set up a share or DFS point for which all clients have Read access. In our examples, we've set up a share named Endpoint Policy Manager.

**Step 2 –** Copy the Endpoint Policy Manager Client-Side Extension x32.msi for 32-bit systems or Endpoint Policy Manager Client-Side Extension x64.msi for 64-bit systems to that share.

**Step 3 –** Create a Group Policy Object (GPO) and link it to the organizational unit (OU) containing the target computers.

**Step 4 –** Use Group Policy Software Installation to deploy that file to all target computers.

**NOTE:**  To see a demonstration of this section, please watch these two tutorial videos: [Mass Deploy the Endpoint Policy Manager CSE using GPSI](../Archive/MassDeploy "Mass Deploy the Endpoint Policy Manager CSE using GPSI") and [Upgrading the CSE using GPSI](../Archive/Upgrading "Upgrading the CSE using GPSI").
In this example, we've created a GPO named Deploy PP Client and linked it to East Sales Desktops.

![Deploying Client Side](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_350x474.png "Deploying Client Side")

**Step 5 –** Next, right-click the GPO and select **Edit**. Once you're inside the Group Policy Editor, scroll down to **Computer** > **Configuration** > **Software Settings** > **Software Installation**. Right-click, and select **New** > **Package**.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_1_620x359.png)

**Step 6 –** Once this is complete, type in the server and share names you used. In our example, our server is `\\DC-Computer` and our share is Endpoint Policy Manager. Then select the Endpoint Policy Manager CSE Setup x64.msi file, and click **Open**. Next, choose **Assigned**, and select **OK**.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_2_620x389.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_3_550x381.png)

When you're done, the GPO should look like this:.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_4_1200x309.png)

**Step 7 –** Repeat this process until both the x86 and x64 MSIs appear.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/Install/Deploying the Client Side_5_1200x240.png)

**NOTE:** Be sure that the source field is pointing to a network path (e.g., `\\server\share`) and not a local path (e.g., `c:\something\`).
...
For more information on how to perform an upgrade using Group Policy Software Installation. See the [Upgrading the CSE using GPSI](../Archive/Upgrading "Upgrading the CSE using GPSI") topic for additional information.