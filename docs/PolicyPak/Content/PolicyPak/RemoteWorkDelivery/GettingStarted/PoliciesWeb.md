...
**NOTE:** For a video overview of using Endpoint Policy Manager Remote Work Delivery Manager to install software using web-based shares, see [Install software using web-based shares](../../Video/RemoteWorkDelivery/WebBasedShares "Install software using web-based shares").
...
**NOTE:** See [Background Intelligent Transfer Service](https://learn.microsoft.com/en-us/windows/win32/bits/background-intelligent-transfer-service-portal?redirectedfrom=MSDN "Background Intelligent Transfer Service") for additional information on BITS.
...
**Step 1 –** Create a web policy for Endpoint Policy Manager Remote Work Delivery Manager by adding a new policy.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_16.png)

**Step 2 –** Next, on the Specify the copy source page, add the URL of a file that exists on a compatible web service. In the example below we have a movie file on Amazon S3.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_17.png)
...
**Step 3 –** You are asked if the file is a single file (which should be copied as a straight file) or a ZIP archive you want to unpack. For this Quickstart, select **File** and click **Next**.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_18.png)

**Step 4 –** Select your destination directory and replacement file name.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_19.png)

**Step 5 –** Complete the remaining pages of the wizard as described earlier. Then, click **Finish** to see the policy in the editor.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_20.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/Netwrix_Book 13 - Remote Work Delivery Manager_manual/Getting to Know PolicyPak_21.png)
