...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_1_image-20200826125733-1.png)
...
**Step 3 –** Windows Installer policy for WebEx Desktop App (`WebExApp.msi`) Elevated by **Signature** and **Product Info**.

**Step 4 –** Executable policy for `WebexAppLauncher.exe` Elevated by **Signature** and **File Info**.
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_3_image-20200826125733-2.png)

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_5_image-20200826125733-3.png)
...
![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_7_01_321x213.png)

**Step 3 –** Click **View Certificate**.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_8_02_323x239.png)

**Step 4 –** Click the **Certification Path** tab and select the second certificate from the chain. Click **View Certificate**.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_9_03_319x130.png)

**Step 5 –** Click on the **Details** tab and select **Copy to File**.

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_10_04_243x307.png)

**Step 6 –** Click **Next** on the Export Certificate Wizard and select DER encoded binary X.509 (.CER) format.

**Step 7 –** Finish the export and save the cert file somewhere easily accessible for the next steps.

**NOTE:** You can also use Endpoint Policy Manager Remote Work Delivery Manager to deliver the certificate file at the desired location of the remote computer. For more information on this issue, please see  Remote Work Delivery Manager > [Knowledge Base](../../Feature/Overview/KnowledgeBase "Knowledge Base")
...
**Step 1 –**  Create a new Endpoint Policy Manager Scripts Manager GPO and use the following PowerShell command:
...
```
**Step 2 –** Wait for the policy refresh and you should see the certificate in the Intermediate Certification Authorities folder

![](../../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/SecureRun/575_11_05_549x169.png)