---
sidebar_position: 3150
title: How can I change the behavior of "Run as Admin" with Endpoint Privilege Manager
  and how has it changed from previous versions?
---
...
Starting in Endpoint Policy Manager CSE 3425, you can modify the Run As Administrator behavior depending on the goal you would like to accomplish. You can use Endpoint Policy Manager ADMX settings to control it. Use this reference to get familiar with the Endpoint Policy Manager ADMX first: [Troubleshooting with ADMX files](../Video/Troubleshooting/ADMXFiles "Troubleshooting with ADMX files")

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_1_image-20230228200619-1_950x319.png)

**NOTE:** These ADMX settings are also built into Endpoint Policy Manager Cloud and you're welcome to use those as well.  The policy screen shots below in this article were all taken from Endpoint Policy Manager Cloud.

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/1243_2_232bf02612716c9cb1420ae8801dbfd2.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/1243_3_850e299116b6ef01db03df49923a61df.png)
...
In this case, keep the defaults as-is with **Not Configured**. You may also set it to **Disabled**. Optionally, you can set it to **Enabled + Enable and use the default context menu Run as administrator**. All three of these methods will perform default Endpoint Policy Manager behavior.

Below are examples showing this (using Endpoint Policy Manager Cloud).

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_2_image-20230228200619-2.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_3_image-20230228200619-3.png)

OR

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_4_image-20230228200619-4.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_5_image-20230601152059-6.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_6_image-20230228200619-5.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_7_image-20230601150106-3_723x496.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_8_image-20230601145346-1.png)

**NOTE:** Because this method will ALSO turn off NTPRINT.EXE elevations, you can still use the legacy Printer elevation method within “Endpoint Policy Manager Helper Tools” to perform Printer operations in this mode, because it doesn’t rely on the updated functionality to perform elevation directly upon NTPRINT.EXE. To see the Endpoint Policy Manager Helper Tools in action to add printers, please refer to these videos: Least Privilege Manager > [Video Learning Center](Overview/VideoLearningCenter "Video Learning Center").
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_9_image-20230601150335-4_723x495.png)

![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_10_image-20230601151700-5.png)
...
![](../../../../../static/images/PolicyPak/Content/Resources/Images/LeastPrivilege/862_11_image-20230228200619-6_950x146.png)
