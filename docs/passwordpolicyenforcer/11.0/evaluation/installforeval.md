...
- Server Installation: install on each server and domain controller in the domain you are
  ...
  [Install Password Policy Enforcer on a Server](/docs/passwordpolicyenforcer/11.0/install/installationserver.md) or automatically
  with [Install with Group Policy Management](/docs/passwordpolicyenforcer/11.0/install/installationgpm.md) procedure. Installing
...
- Client Installation: install on each workstation you are evaluating. The Password Policy Client is
  ...
  the [Install Password Policy Enforcer Client](/docs/passwordpolicyenforcer/11.0/install/installationclient.md) procedure, or
  [Install with Group Policy Management](/docs/passwordpolicyenforcer/11.0/install/installationgpm.md).
...
[Password Policy Client](/docs/passwordpolicyenforcer/11.0/administration/password_policy_client.md) topic for additional
information.
