...
[Policy Testing vs. Password Changes](/docs/passwordpolicyenforcer/11.0/administration/testpolicy.md#policy-testing-vs-password-changes)
...
[](http://www.anixis.com/products/ppeweb/)[Password Policy Enforcer Web](/docs/passwordpolicyenforcer/11.0/web/web_overview.md)
