...
Enforcer [Compromised Password Check](/docs/passwordpolicyenforcer/11.0/administration/compromised-password-management/overview.md) topic for HIBP database
...
See the [Compromised Rule](/docs/passwordpolicyenforcer/11.0/password-rules/compromised-passwords.md) topic for additional information.
