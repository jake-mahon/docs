...
Check. See the [HIBP Updater](/docs/passwordpolicyenforcer/11.0/administration/compromised-password-management/hibp-updater.md) topic for instructions.
...
only available when **domain** is selected with the [Connected To](/docs/passwordpolicyenforcer/11.0/configuration/configuration-console.md#connected-to)
...
- **Compromised Passwords Base** specify the database to use when checking for compromised
  passwords. Netwrix recommends using the [HIBP Updater](/docs/passwordpolicyenforcer/11.0/administration/compromised-password-management/hibp-updater.md) to create this database.
