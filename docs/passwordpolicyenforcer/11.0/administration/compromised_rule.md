...
![Compromised password rule](/img/product_docs/passwordpolicyenforcer/11.0/administration/compromised.webp)
...
See the [HIBP Updater](/docs/passwordpolicyenforcer/11.0/administration/hibpupdater.md) topic for the information about the Have I Been Pwnd (HIBP)
database usage.
