...
compliance level calculations. See the [Rules](/docs/passwordpolicyenforcer/11.0/password-rules/overview.md) topic for additional information.

When setting the compliance level, consider that some rules may be disabled when a user enters a
passphrase. See the [Passphrase](/docs/passwordpolicyenforcer/11.0/password-rules/passphrases.md) topic for additional information. Password Policy
