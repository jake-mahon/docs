...
- [Manage Policies](/docs/passwordpolicyenforcer/11.0/configuration/managing-policies.md)
- [Compromised Password Check](/docs/passwordpolicyenforcer/11.0/administration/compromised-password-management/overview.md)
- [System Audit and Support](/docs/passwordpolicyenforcer/11.0/configuration/system-audit.md) - Version Tracker, Support Tools, Property Editor
...
- You can copy a local configuration to another computer by exporting the configuration from the
  ...
  [Domain and Local Policies](/docs/passwordpolicyenforcer/11.0/configuration/domain-and-local-policies.md) topic for additional information.
...
- **Enforce policy when password is reset** requires users, administrators and helpdesk operators to
  ...
  - History rule is enforced if this option is selected and the **Enforce this rule when a
    password is reset** option is selected on the [History Rule](/docs/passwordpolicyenforcer/11.0/password-rules/history-and-similarity.md) Properties.
...
- **Accept encrypted client request only** specifies requests from Password Policy Client, Netwrix
  ...
  or password hashes. See the [Password Policy Client](/docs/passwordpolicyenforcer/11.0/configuration/password-client-configuration.md) topic for
...
- **Log event when password rejected by service** adds an entry to the Windows Application Event Log
  ...
  - Client logged events only show the local rules the password violated. For example, the
    Compromised rule is only enforced by the Password Policy Server. See the [Rules](/docs/passwordpolicyenforcer/11.0/password-rules/overview.md)
...
See the [Install the Configuration Console](/docs/passwordpolicyenforcer/11.0/installation/server-installation.md) topic for
...
The [Configuration Console](/docs/passwordpolicyenforcer/11.0/configuration/configuration-console.md) is displayed:
