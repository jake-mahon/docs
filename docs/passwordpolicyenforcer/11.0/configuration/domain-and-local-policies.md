---
title: Domain and Local Password Policies
sidebar_label: Domain and Local Policies
description: Configure Password Policy Enforcer for both domain and local user accounts including Active Directory and registry-based policies.
---
...
using the [Rules](/docs/passwordpolicyenforcer/11.0/password-rules/overview.md), [Password Policy Client](/docs/passwordpolicyenforcer/11.0/configuration/password-client-configuration.md), or other software
(such as
...
- The Minimum Age and Maximum Age rules (you can use the Windows version of these rules with
  Password Policy Enforcer). See the [Rules](/docs/passwordpolicyenforcer/11.0/password-rules/overview.md) topic for additional information.
- Policy assignments by groups and containers. See the
  [Assign Policies to Users & Groups](/docs/passwordpolicyenforcer/11.0/configuration/users-and-groups.md) topic for additional information.
...
[Connected To](/docs/passwordpolicyenforcer/11.0/configuration/configuration-console.md#connected-to) topic for additional information. Changes you make to
