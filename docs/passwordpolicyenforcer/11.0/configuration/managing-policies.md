...
(Organizational Units). See the [Assign Policies to Users & Groups](/docs/passwordpolicyenforcer/11.0/configuration/users-and-groups.md) topic for
...
- Set up [Rules](/docs/passwordpolicyenforcer/11.0/password-rules/overview.md).
- [Assign Policies to Users & Groups](/docs/passwordpolicyenforcer/11.0/configuration/users-and-groups.md).
- Enable the use of an optional [Passphrase](/docs/passwordpolicyenforcer/11.0/password-rules/passphrases.md).
- Set up [Policy Properties](/docs/passwordpolicyenforcer/11.0/configuration/policy-properties.md).
- Set up [Messages](/docs/passwordpolicyenforcer/11.0/configuration/messages-and-notifications.md) for your users.

## Test Policy

Launches the Test policy tool in a separate window. You can test **By user** and by **Password bulk
test**. See the [Test Policy](/docs/passwordpolicyenforcer/11.0/administration/testing-and-validation.md) topic for additional information.
...
[Test Policy](/docs/passwordpolicyenforcer/11.0/administration/testing-and-validation.md) tool to quickly determine which policy Password Policy Enforcer is
