...
it. See the [Working with the Database](/docs/passwordpolicyenforcer/11.0/password-reset/administration/database-management.md) topic for additional
information.
...
[Securing Password Reset](/docs/passwordpolicyenforcer/11.0/password-reset/configuration/security-settings.md) topic for additional information.
...
[Backing up the Database](/docs/passwordpolicyenforcer/11.0/password-reset/administration/database-management.md#backing-up-the-database) topic for additional
information.
...
[Using the Data Console](/docs/passwordpolicyenforcer/11.0/password-reset/administration/data-console.md) topic for additional information.
...
the [Editing the HTML Templates](/docs/passwordpolicyenforcer/11.0/password-reset/customizing-templates.md) topic for additional information.
