...
[Working with the Database](/docs/passwordpolicyenforcer/11.0/password-reset/administration/database-management.md) topic for additional information.

You can also move the database from SQL Server Compact to SQL Server. See the
[Working with the Database](/docs/passwordpolicyenforcer/11.0/password-reset/administration/database-management.md) topic for more information.
