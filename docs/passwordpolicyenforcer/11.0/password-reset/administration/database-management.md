...
See solutions to these disadvantages in the [Moving to SQL Server](/docs/passwordpolicyenforcer/11.0/password-reset/administration/database-management.md) topic.
...
[Database](/docs/passwordpolicyenforcer/11.0/password-reset/configuration/general-settings.md#database) topic for more information.
