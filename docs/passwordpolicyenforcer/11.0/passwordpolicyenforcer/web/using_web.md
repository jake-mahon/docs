...
[Install an SSL Certificate](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/web/securing_web.md#install-an-sslcertificate) topic for additional
information.
...
messages by editing the templates. See the [Edit HTML Templates](/docs/passwordpolicyenforcer/11.0/passwordpolicyenforcer/web/editing_html_templates.md) topic
