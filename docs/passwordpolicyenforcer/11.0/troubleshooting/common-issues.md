...
then install the Password Policy Client. See the [Password Policy Client](/docs/passwordpolicyenforcer/11.0/configuration/password-client-configuration.md)
...
[Configuration Console](/docs/passwordpolicyenforcer/11.0/configuration/configuration-console.md) topic for additional information.

Make sure that the Password Policy Client is enabled. See
[Password Policy Client](/docs/passwordpolicyenforcer/11.0/configuration/password-client-configuration.md) topic for additional information.
...
[Policy Testing vs. Password Changes](/docs/passwordpolicyenforcer/11.0/administration/testing-and-validation.md#policy-testing-vs-password-changes) topic for
...
See the [Policy Testing vs. Password Changes](/docs/passwordpolicyenforcer/11.0/administration/testing-and-validation.md#policy-testing-vs-password-changes)
topic for additional information.
