...
- Server Installation: install on each server and domain controller in the domain you are
  ...
  [Install Password Policy Enforcer on a Server](/docs/passwordpolicyenforcer/11.0/installation/server-installation.md) or automatically
  with [Install with Group Policy Management](/docs/passwordpolicyenforcer/11.0/installation/group-policy-installation.md) procedure. Installing
...
- Client Installation: install on each workstation you are evaluating. The Password Policy Client is
  ...
  the [Install Password Policy Enforcer Client](/docs/passwordpolicyenforcer/11.0/installation/client-installation.md) procedure, or
  [Install with Group Policy Management](/docs/passwordpolicyenforcer/11.0/installation/group-policy-installation.md).
...
[Password Policy Client](/docs/passwordpolicyenforcer/11.0/configuration/password-client-configuration.md) topic for additional
information.
