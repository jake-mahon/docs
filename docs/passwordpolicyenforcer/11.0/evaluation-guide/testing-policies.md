...
[Policy Testing vs. Password Changes](/docs/passwordpolicyenforcer/11.0/administration/testing-and-validation.md#policy-testing-vs-password-changes)
...
[Administration](/docs/passwordpolicyenforcer/11.0/password-reset/overview.md) and
[](http://www.anixis.com/products/ppeweb/)[Password Policy Enforcer Web](/docs/passwordpolicyenforcer/11.0/web-interface/overview.md)
