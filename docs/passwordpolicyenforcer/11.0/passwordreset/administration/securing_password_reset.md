...
[Configuring the PRC](/docs/passwordpolicyenforcer/11.0/passwordreset/administration/password_reset_client.md#configuring-the-prc) topic for more information.
