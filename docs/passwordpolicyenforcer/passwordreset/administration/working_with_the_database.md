...
See solutions to these disadvantages in the [Moving to SQL Server](/docs/passwordpolicyenforcer/passwordreset/administration/moving_to_sql_server.md) topic.
