...
See solutions to these disadvantages in the [Moving to SQL Server](/docs/product_docs/passwordpolicyenforcer/passwordreset/administration/moving_to_sql_server.md#Moving-to-SQL-Server) topic.
...
__Step 4 –__ Start the __Netwrix Password Reset__ service.
...
__NOTE:__ Change the paths above if the database files are in a different folder. See the [Database](/docs/product_docs/passwordpolicyenforcer/passwordreset/administration/general_tab.md#Database) topic for more information.
