...
[Notifications](../administration/configconsole.md#notifications) topic for additional information.
...
Follow the procedure in [Install Password Policy Enforcer on a Server](installationserver.md),
