...
Follow the procedure in [Install Password Policy Enforcer on a Server](installationserver.md), selecting the __Mailer Service__ feature. You can select the other features if appropriate for the server.
