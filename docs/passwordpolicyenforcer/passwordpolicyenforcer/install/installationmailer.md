...
The mailer is a feature package included in the server installation __.msi__ file:
...
Follow the procedure in [Install Password Policy Enforcer on a Server](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/installationserver.md), selecting the __Mailer Service__ feature. You can select the other features if appropriate for the server.
