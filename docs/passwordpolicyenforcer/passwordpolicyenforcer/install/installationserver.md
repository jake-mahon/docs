...
- [Rules](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/rules.md#Rules)
- [Password Policy Client](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/password_policy_client.md)
- [Netwrix Password Reset](https://helpcenter.netwrix.com/category/passwordreset)
- [](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/web/web_overview.md)[Password Policy Enforcer Web](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/web/web_overview.md)
...
![Server Setup](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/serversetup1.png)

__Step 4 –__ Click __Next__.

![Server Setup](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/serversetup2.png)
...
![Server Setup](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/serversetup3.png)
...
![Server Setup](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/serversetup4.png)

__Step 10 –__ Review your selections. Click __Back__ to make any changes. When ready, click __Install__.

![Server Setup](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/install/serversetup5.png)
