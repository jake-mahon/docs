...
[Install an SSL Certificate](securing_web.md#install-an-sslcertificate) topic for additional
information.
...
messages by editing the templates. See the [Edit HTML Templates](editing_html_templates.md) topic
