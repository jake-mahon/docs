...
![Character (Granular) Rule](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranular.png)

All the Character rules work identically, but each has their own default character set. A character set is the collection of characters that each rule searches for when checking a password. You can use the Character rules with their default character sets, or define your own. By default, the Password Policy Enforcer selects the Password Policy Enforcer character on the [Set Priorities](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/manage_policies.md#Set-Priorities) page.
...
![Restricting Characters](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranularrestrict.png)
...
![Require a number in position 2](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranularrestrict2.png)
...
![Set up custom character set](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranularvowel.png)
...
![Require a numeric value](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranularrestrict3.png)

Set __Characters (Granular)__ to not contain numeric values in the first two positions.

![Don't allow numeric values in first two positions](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/chargranularrestrict4.png)
