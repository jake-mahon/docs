...
![Assign policies to Users and Groups](../../../../static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/usersandgroups.webp)
...
![managing_policies_3](../../../../static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/managing_policies_3.webp)
...
![Policy assignments](../../../../static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/usersandgroups2.webp)
...
If a policy assignment conflict still exists, then Password Policy Enforcer checks the priority of each remaining policy, and enforces the policy with the highest priority. See the [Policy Selection Flowchart](manage_policies.md#policy-selection-flowchart) topic for a diagrammatic representation of this algorithm.
...
![Expand View log under Test to see which policy is enforced](../../../../static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/administration/testviewlog.webp)
