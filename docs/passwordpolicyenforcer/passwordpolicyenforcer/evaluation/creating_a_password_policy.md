...
__Step 4 –__ Select a Policy template or __None__ if you are creating your own. For a list of policies see [Policy Templates ](/docs/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/policy_templates.md#Policy-Templates).
...
![Make the policy the default](/static/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evaldefault.png)
