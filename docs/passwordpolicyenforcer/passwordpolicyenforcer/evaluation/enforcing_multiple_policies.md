...
![Return to the dashboard](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evaldashboard.png)
...
![Enter Admins Policy](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evalcopypolicy2.png)

__Step 3 –__ Click __Make copy__.

__Step 4 –__ Open the __Users & Groups__ tab.

![Open the Users & Groups tab](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evalusergroups.png)
...
![Domain Admins added](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evaldomainadmins.png)
...
![Set the length to 9](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evallength9.png)
...
![Admins policy is being tested](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evaladmin.png)
