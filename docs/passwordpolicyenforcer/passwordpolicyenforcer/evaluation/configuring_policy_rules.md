...
![New policy open for settings](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/newpolicysettings.png)
...
![Set the Length](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evallength.png)
...
![Set upper and lower case requirements](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evalchars.png)
...
![set character granularity](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evalcharsgran.png)
...
![Set Similarity rule](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evalsimilarity.png)
...
![Enable the sample dictionary](/img/product_docs/passwordpolicyenforcer/passwordpolicyenforcer/evaluation/evaldict.png)
