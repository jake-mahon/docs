...
[Installing the Mailer](/docs/passwordpolicyenforcer/10.2/messaging-and-notifications/email-configuration.md#installing-the-mailer)
topic for additional information.
...
See the [What's New](/docs/passwordpolicyenforcer/10.2/getting-started/whats-new.md) topic for additional information.
