...
description: Installation guide for Netwrix Password Reset V3.30 on Windows 2008-2019 including system requirements and setup procedures.
---
...
![installing_npr_624x193](/img/versioned_docs/passwordpolicyenforcer_10.2/password_reset/administration/installing_npr_624x193.webp)
...
[Securing Password Reset](/docs/passwordpolicyenforcer/10.2/password-reset/security-settings.md)
topic for additional information.
...
![installing_npr_1](/img/versioned_docs/passwordpolicyenforcer_10.2/password_reset/administration/installing_npr_1.webp)
...
[Backing up the Database](/docs/passwordpolicyenforcer/10.2/password-reset/data-management.md#backing-up-the-database)
topic for additional information.
...
password for the Password Reset Server service account as you will need it during the upgrade.
...
[Using the Data Console](/docs/passwordpolicyenforcer/10.2/password-reset/data-management.md)
topic for additional information.
...
the
[Editing the HTML Templates](/docs/passwordpolicyenforcer/10.2/password-reset/configuration.md)
topic for additional information.
