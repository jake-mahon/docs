...
Role mining aims to reduce the cost of entitlement management by automating entitlement assignments, via the analysis of existing assignments. See the [Automate Assignments](../../user-guide/optimize/assignment-automation/index "Automate Assignments") topic for additional information.

## Overview

After the role catalog is established, the [Compute Role Model Task](../toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index "ComputeRoleModelTask") is able to assign single roles to users according to their attributes which are used as assignment criteria.
...
Now that users received their roles, the role mining tool can analyze these assignments and deduce [Single Role Rule](../toolkit/xml-configuration/provisioning/singlerolerule/index "SingleRoleRule") which will assign single roles to certain users matching given criteria.

![Schema - Role Mining](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_schema.png)

Role mining is a Machine Learning process. It is a statistic tool used to emphasize the [Conforming Assignments](../role-assignment/conformingassignmentcomputation/index)that constitute the key criteria for existing role assignments. It detects the most probable links between identities dimensions and their roles in order to suggest the appropriate entitlement assignment rules.
...
Role mining works through [Mining Rule](../toolkit/xml-configuration/provisioning/miningrule/index "MiningRule") that Identity Manager applies with the [Get Role Mining Task](../toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index "GetRoleMiningTask").
...
2. suggested rules, i.e. rules which don't assign roles directly, but suggest them during an entitlement request for a user.
   ...
   ![Suggested](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_suggested_V602.png)
...
>
> ![Rule Types](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_ruleType.png)
...
![Rule Types - Sensitivity](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_ruleType-sensitivity.png)
...
![Impact Example - Use Case 1](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_impact_usecase1.png)
...
![Impact Example - Use Case 2](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_impact_usecase2.png)
...
![Impact Example - Use Case 3](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_impact_usecase3.png)
...
![Impact Example - Use Case 4](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_impact_usecase4.png)

Starting from the previous example, consider now that, as a result of a reorganization or an access certification for example, some users do not have the role anymore. If the ratio is below the threshold, then role mining will remove the single role rule. If the role (or its policy) is configured with a [Single Role](../toolkit/xml-configuration/provisioning/singlerole/index "SingleRole"), users who need the role will not lose it. Then users' entitlements remain unchanged:

![Impact Example - Use Case 5](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_impact_usecase5.png)

## Perform Role Mining

See the [Perform Role Mining](../../user-guide/optimize/assignment-automation/role-mining/index "Perform Role Mining") for additional information.

### Simulation

Be aware that you can configure the [Get Role Mining Task](../toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index) to generate role assignment rules either directly or in a [Simulation](../simulation/index "Simulation").
...
![Schema - Role Mining](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_simulation.png)

The simulation tool gives another point of view on the role model as it emphasizes the changes.

![Schema - Role Mining](../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_simulationResults.png)
