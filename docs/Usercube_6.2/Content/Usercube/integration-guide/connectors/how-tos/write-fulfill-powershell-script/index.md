...
This guide shows how to write a PowerShell script used by the [PowerShellProv](../../references-connectors/powershellprov/index "PowerShellProv") connector.
...
The [PowerShellProv](../../references-connectors/powershellprov/index) isn't mandatory in the JSON file. If it isn't provided, don't perform this step.
