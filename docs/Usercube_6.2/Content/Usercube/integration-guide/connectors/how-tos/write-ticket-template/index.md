...
The template uses the [Mustache](https://mustache.github.io/mustache.5) syntax.
Several operations are already provided, but you can find more on this [page](https://handlebarsjs.com/guide/builtin-helpers).
