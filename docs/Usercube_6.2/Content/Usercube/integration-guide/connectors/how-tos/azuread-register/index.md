...
5. Click the **+ New Registration** button in the top menu.
   ...
   ![Azure AD Export - Add New Registration](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportRegistration.png)
...
3. Go to **Overview** in the left panel.
   ...
   ![Azure AD Export - New ApplicationId](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportApplicationId.png)
...
7. Confirm the creation with the **Add** button.
   ...
   ![Azure AD Export - New Client Secret](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportSecret.png)
...
4. Click on the **+ Add a permission** button.
   ...
   ![Azure AD Export - Add Permission](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportPermissions.png)
...
If you plan on configuring fulfillment too, you must only check the Directory.ReadWrite.All permission.
   ...
   ![Azure AD Export - Directory Permission](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportDirectoryPermission.png)
...
9. Grant admin consent by clicking on **√ Grant admin consent for** name of the organization.
   ...
   ![Azure AD Export - Grant Admin Consent](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Howtos_azuread_exportAdminConsent.png)
