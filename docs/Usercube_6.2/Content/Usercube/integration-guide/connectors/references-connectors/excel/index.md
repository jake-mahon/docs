...
![Package: File/Microsoft Excel](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Packages_excel_V603.png)
...
This connector is meant to generate to the [Application Settings](../../../network-configuration/agent-configuration/appsettings/index "Application Settings") folder a CSV file per spreadsheet included in the export, named `_.csv` where `` is the spreadsheet's index.
