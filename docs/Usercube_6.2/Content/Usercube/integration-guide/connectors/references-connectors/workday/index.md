...
![Package: ERP/Workday](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Packages_workday_V603.png)
...
> ```
>
> We choose to export only the entity `workers`, so the output is generated to `WorkdayExport_workers.csv` in the directory [Connection](../../../toolkit/xml-configuration/connectors/connection/index "Connection").
>
