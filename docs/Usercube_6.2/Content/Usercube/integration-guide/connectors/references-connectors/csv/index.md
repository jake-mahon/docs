...
This page is about [CSV](../../references-packages/csv/index "CSV").

![Package: File/CSV](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Packages_csv_V603.png)
...
This process is configured through a [[Connection](../../../toolkit/xml-configuration/connectors/connection/index "Connection")](../../../toolkit/xml-configuration/connectors/connection/index) in the UI and/or the XML configuration, and in the `appsettings.agent.json > Connections` section:
...
This connector is meant to generate a CSV file, named `.csv`, to the [Application Settings](../../../network-configuration/agent-configuration/appsettings/index "Application Settings") folder.
...
This connector has no credential attributes, and therefore does not use [[Connection](../../../toolkit/xml-configuration/connectors/connection/index "Connection")](../../../network-configuration/agent-configuration/rsa-encryption/index), nor a [Connection](../../../toolkit/xml-configuration/connectors/connection/index "Connection").
