...
![Package: ITSM/ServiceNow](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Packages_servicenow_V603.png)
...
This section focuses on ServiceNow Entity Management. To learn about how to use this connector to create tickets for other resources, see [ServiceNow Ticket](../../references-packages/servicenow-ticket/index).
...
This connector is meant to generate to the [Connection](../../../toolkit/xml-configuration/connectors/connection/index "Connection") folder one CSV file for each table, named `_.csv`.
