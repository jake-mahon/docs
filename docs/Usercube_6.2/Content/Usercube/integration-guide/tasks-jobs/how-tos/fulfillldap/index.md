...
In the [LDAP](../../../connectors/references-connectors/ldap/index) define this section to add all information to use the AD Fulfillment.
...
```
After defining this settings, encrypt this JSON file with [Usercube-Protect-X509JsonFile](../../../executables/references/protect-x509jsonfile/index "Protect-X509JsonFile").
