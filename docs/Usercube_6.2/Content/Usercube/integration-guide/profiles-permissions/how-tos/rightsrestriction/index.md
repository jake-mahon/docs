...
>
   ...
   >
   > ```
The profile rule context must use a [Profile Rule Context](../../../toolkit/xml-configuration/access-control/profilerulecontext/index)to define the entity type that contains the dimension information.
