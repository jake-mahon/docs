...
When using only a context rule without a record section, the context generation is straightforward: a set of dimension-value pairs is created by computing the value of the [Context Rule](../../toolkit/xml-configuration/provisioning/contextrule/index "ContextRule") on the context rule.
...
![simple-recordsection-identity](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/simple-recordsection-identity.png)

With the given configuration and the identity of `Mark Barn`, the following contexts are generated:

![simple-recordsection-result](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/simple-recordsection-result.png)
...
![recordsection-withvaluecopy-result1](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/recordsection-withvaluecopy-result1.png)
...
```
![positionextension-identity](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/positionextension-identity.png)

Two contexts will be generated.

![positionextension-result](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/positionextension-result.png)
