...
The following how-to assumes that you have already read the topic on [Indirect Permissions](../../indirectpermissions/index "Indirect Permissions").
...
![Group Membership Schema](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/IndirectPermissionsADExample.png)
...
![Single Role Configuration Example](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/SRConf_5.2.1.png)

We will also create a test Composite Role to showcase indirect Composite Roles. We will name it `TestCRoleAB`:

![Composite Role Configuration](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/CRConf_5.2.1.png)
...
![Navigation Rule Example](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NavRule_5.2.1.png)

And finally, we need to add Single Role Rules to link our two previously created Single Roles to the new Composite Role:

![Single Role Rule Example](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/SRRule_5.2.1.png)
...
After running a [Compute Role Model Task](../../../toolkit/xml-configuration/jobs/tasks/server/computerolemodeltask/index "ComputeRoleModelTask"), Indirect Permissions should now appear for your test user.
...
![View Permissions Simplified](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ViewPermissionsSimplified_5.2.1.png)

To display Indirect Permissions, you need to switch over to the `Advanced view`. `TestRoleA` and `TestRoleB` should then appear:

![View Permissions Advanced](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ViewPermissionsAdvanced_5.2.1.png)
...
![AD Assigned Resource Navigations](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ADAssignedNavigations_5.2.1.png)
