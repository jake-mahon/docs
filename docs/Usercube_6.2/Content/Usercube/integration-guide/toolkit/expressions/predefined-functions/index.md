...
Identity Manager provides a set of predefined functions that simplify the configuration of entity property expressions and scalar rules. See the [Entity Type](../../xml-configuration/metadata/entitytype/index "EntityType") and[Resource Type](../../xml-configuration/provisioning/resourcetype/index "Resource Type") topics for additional information.

Unlike C# expressions, Identity Manager's predefined functions do not need any prefix. They can be used as such. See the [C# utility functions](../csharp-utility-functions/index "C# utility functions") topic for additional information.
