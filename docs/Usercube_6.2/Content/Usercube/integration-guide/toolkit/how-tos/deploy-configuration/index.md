...
title: Identity Manager Deploy the Configuration
---
...
* when working on-premise, the configuration must be [Identity Manager Deploy the Configuration](#);
* when working SaaS, the configuration must be[Identity Manager Deploy the Configuration](#).

## Deploy the Configuration Locally

Deploy a local XML configuration by using the  [Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index "Identity Manager-Deploy Configuration") and declaring at least:
...
1. Log in for configuration deployment/export with the [Usercube-Login](../../../executables/references/login/index).
...
Either method will open your default browser to `http://localhost:5005` where you will be redirected to the specified IDP and will be prompted to log in.
   ...
   :::note
Specify --port  if you want the login page to use another local port.
   :::
...
2. Log in to the IDP to be redirected back to this screen:
   ...
   ![Usercube-Login.exe Success Screen](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Usercube-Login_Success_v602.png)
...
4. Deploy the configuration by using the [Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index "Identity Manager-Deploy Configuration") and declaring at least:
