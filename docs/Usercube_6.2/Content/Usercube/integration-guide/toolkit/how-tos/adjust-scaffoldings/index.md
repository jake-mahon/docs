...
1. When working via the UI, start by exporting UI [Usercube-Export-Configuration](../../../executables/references/export-configuration/index) elements.
...
4. [Usercube-Deploy Configuration](../../../executables/references/deploy-configuration/index "Identity Manager-Deploy Configuration") again.