...
* when working on-premise, the configuration must be [Export the Configuration](#);
* when working SaaS, the configuration must be [Export the Configuration](#);
...
Export your configuration by using the [Usercube-Export-Configuration](../../../executables/references/export-configuration/index "Identity Manager-Export-Configuration") executable and declaring at least:
