...
```
All `ResourceType`, `SingleRole`, `CompositeRole` and `Category` must belong to a Policy. This is done by specifying the `Policy` attribute. See the [Resource Type](../resourcetype/index "Resource Type"), [Single Role](../singlerole/index "SingleRole"), [Composite Role](../compositerole/index "CompositeRole") and [Category](../category/index "Category") topics for additional information.
