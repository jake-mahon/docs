...
Represents a conceptual model of a business object, such as a person entity or an organization entity. See the [Connector](../../connectors/connector/index "Connector")topic for additional information on how to configure define an EntityType.

## Properties

| Property | Details |
| --- | --- |
| DisplayName\_L1 optional | **Type**  String  **Description** Display name of the entity type in language 1 (up to 16). |
| Identifier required | **Type**  String  **Description** Unique identifier of the entity type. It must is be unique to the *entity model* scope. Cannot be a [Reserved identifiers](../../../reservedidentifiers/index). |
...
See the [Expressions](../../../expressions/index "Expressions") topic for additional information on how to configure/define an EntityProperty.
...
As long as the property was not used in any workflow, this can be properly handled by `Deploy-Configuration.exe`. If it *was* used in one or more workflows, foreign key conflicts (in UW\_Changes database table) may occur, preventing the configuration from being deployed.
...
| Property | Details |
| --- | --- |
| DisplayName\_L1 optional | **Type**  String  **Description** Display name of the property in language 1 (up to 16).  **Note:** cannot be "Id". |
...
| Identifier required | **Type**  String  **Description** Unique identifier of the property. It must be unique to the parent entity type scope. Cannot be a [Reserved identifiers](../../../reservedidentifiers/index) and can only contain numbers (except the first character) and letters without accents.  **Note:** cannot be "Id". |
