...
The task reads files from the source directory, usually the temp folder >[Application Settings](../../../../../../network-configuration/server-configuration/general-purpose/index) folder.
