...
The Introduction Guide introduced the [Entitlement Management](../../../introduction-guide/overview/entitlement-management/index) and how it influences assigning entitlements to identities. Let's sum up the key principles here.
...
The role model is built iteratively, together with the [Entity Model](../../entity-model/index), as they closely influence one another.
...
* Provisioning rules, such as [resource type](../toolkit/xml-configuration/provisioning/resourcetype/index) rules that decide what resources should be found in the managed systems; and [navigation rules](../toolkit/xml-configuration/provisioning/resourcetype/index) or scalar rules, that identify actual values to be fulfilled from the identity to which the single role is assigned;
...
![Cascading From Dimensions To Roles To Provisioning Orders](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/enforce-assignment-policy-summary.png)
