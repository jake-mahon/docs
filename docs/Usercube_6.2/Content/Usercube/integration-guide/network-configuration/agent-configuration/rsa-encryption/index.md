...
* [Usercube-Protect-X509JsonValue](../../../executables/references/protect-x509jsonvalue/index "Usercube-Protect-X509JsonValue") to encrypt given values;
* [Usercube-Protect-X509JsonFile](../../../executables/references/protect-x509jsonfile/index "Usercube-Protect-X509JsonFile") to encrypt a whole file.
...
:::warning
These methods require an X.509 public key certificate (the same for the encrypted appsettings files and the tools).
:::
...
These files follow the exact same structure as the [Agent Configuration](../index "Agent Configuration").
