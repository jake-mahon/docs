...
![Campaign creation screen with policies](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/creation_5.1.6.png)
...
  
```
It is also possible to add access control filters when creating the permission set so that users can only access certain type of campaigns. See the [Access Control Rule](../../toolkit/xml-configuration/access-control/accesscontrolrule/index "AccessControlRule")
