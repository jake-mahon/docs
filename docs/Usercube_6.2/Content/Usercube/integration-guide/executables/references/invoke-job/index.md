...
![Schematization](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Job_Operation.png)
...
* if the blocked task is a [`GenerateProvisioningOrdersTask`](../../../toolkit/xml-configuration/jobs/tasks/server/generateprovisioningorderstask/index), then the state machine forces the same provisioning on the related connector.
