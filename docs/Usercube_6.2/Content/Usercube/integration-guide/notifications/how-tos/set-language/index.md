...
1. In the XML configuration, create a `Language` with `IndicatorNumber` set to `1`. See the [Language](../../../toolkit/xml-configuration/metadata/language/index "Language") topic for additional information.
...
1. In the XML configuration, configure `MailSetting` with a `LanguageCode`See the [Mail Setting](../../../toolkit/xml-configuration/metadata/settings/mailsetting/index "MailSetting") topic for additional information.
