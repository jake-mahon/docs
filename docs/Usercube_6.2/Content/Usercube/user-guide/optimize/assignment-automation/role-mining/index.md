---
sidebar_position: 1265
title: Perform Role Mining
---

# Perform Role Mining

How to use role mining to suggest role assignment rules based on existing assignments, in order to push the [Automate Assignments](../index) wall further.
...
Now that users received their roles, the role mining tool can analyze these assignments and deduce [Single Role Rule](../../../../integration-guide/toolkit/xml-configuration/provisioning/singlerolerule/index) which will assign single roles to certain users matching given criteria.

![Schema - Role Mining](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_schema.png)

Role mining is a Machine Learning process. It is a statistic tool used to emphasize the [Single Role Rule](../../../../integration-guide/toolkit/xml-configuration/provisioning/singlerolerule/index) that constitute the key criteria for existing role assignments. It detects the most probable links between identities dimensions and their roles in order to suggest the appropriate entitlement assignment rules.
...
Role mining works through [Mining Rule](../../../../integration-guide/toolkit/xml-configuration/provisioning/miningrule/index "Mining Rule") that Identity Manager applies with the [Get Role Mining Task](../../../../integration-guide/toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index).
...
1. On the home page in the **Configuration** section, click on the **Role Mining** button.
   ...
   ![Home page - Connectors](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Home_roleMining_V60.png)
...
2. Click on the addition button at the top right and fill in the fields.
   ...
   ![New Mining Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_miningRule_V602.png)

   * `Policy`: [Create a Policy](../../policy-creation/index) in which the mining rule exists.
   * `Entity Type`: [Create an Entity Type](../../../set-up/connect-system/entity-type-creation/index) on which the mining rule is applied, i.e. the entity type targeted by role mining's entitlement analysis.
   * `Category`: [Create a Category](../../../set-up/single-roles-catalog-creation/category-creation/index) containing the roles targeted by role mining's analysis.
   ...
   * `Rule Policy`: [Create a Policy](../../policy-creation/index) in which the single role rules will be generated.
...
4. Click on **Simulate** to perfom role mining in a simulation. See the[Perform a Simulation](../../simulation/index) topic for additional information.

   ![Role Mining Jobs](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/RoleMining_LaunchJob_V602.png)
...
Netwrix Identity Manager (formerly Usercube) recommends [Remove Redundant Assignments](../remove-redundant-assignments/index) after any assignment rule is created or updated.
