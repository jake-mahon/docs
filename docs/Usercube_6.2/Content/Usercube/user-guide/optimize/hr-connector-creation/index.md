...
![Inbound System=](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ConnectorCreation_inbound.png)
...
2. Declare an HR connector using your local agent. See the [Create the Connector](../../set-up/connect-system/connector-declaration/index) topic for additional information.
   ...
   ![HR Connector Declaration](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/HR_connectorDeclaration_V602.png)
3. Create an Export CSV connection for each HR file to connect. See the [Create a Connection](../../set-up/connect-system/connection-creation/index) topic for additional information.
   ...
   ![HR Connection](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/HR_connection_V602.png)
4. [Create an Entity Type](../../set-up/connect-system/entity-type-creation/index) corresponding to your model. For example:

   ![HR Entity Type - Scalar Properties](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/HR_entityTypeS_V602.png)

   ![HR Entity Type - Navigation Properties](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/HR_entityTypeN_V602.png)
...
3. Check that the entity types have been added to the left menu of the home page.
   ...
   ![Test Entity Type](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/HR_validateMenu_V600.png)
