...
How to define composite roles in order to create sets of single roles easy to assign. See the [Composite Role](../../../integration-guide/toolkit/xml-configuration/provisioning/compositerole/index "Composite Role") and [Create Roles in the Role Catalog](../../set-up/single-roles-catalog-creation/index "Create Roles in the Role Catalog")topics for additional information.

## Overview

A composite role is a set of single roles that are usually assigned together, because they revolve around the same application, or the same job, etc. Composite roles are aggregates of single roles, they can help organize the role catalog. See the [Composite Role](../../../integration-guide/toolkit/xml-configuration/provisioning/compositerole/index "Composite Role") topic for additional information.

![Schema](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/CompositeRoles_applicativeRoles.png)
...
Composite roles can also be created based on the rules provided by Role Mining. Rules link roles to dimensions. See the [Perform Role Mining](../assignment-automation/role-mining/index "Perform Role Mining") topic for additional information.
...
See the [Create Roles in the Role Catalog](../../set-up/single-roles-catalog-creation/index "Create Roles in the Role Catalog") topic for additional information.
...
![](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/SingleRolesCatalog_createCompositeRole_V62.png)
...
Simulations are available in order to anticipate the changes induced by a creation/modification/deletion in roles and single role rules. See the [Perform a Simulation](../simulation/index "Perform a Simulation")topic for additional information.
...
![Access Composite Roles](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/CompositeRoles_testRoles_V602.png)

For rules, follow the instructions about assignment rules. See the [Automate Role Assignments](../assignment-automation/automate-role-assignment/index "Automate Role Assignments")