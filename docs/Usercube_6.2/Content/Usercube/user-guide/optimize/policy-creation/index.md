---
sidebar_position: 1259
title: Create a Policy
---

# Create a Policy

How to define policies to organize roles and rules. See the [Policy](../../../integration-guide/toolkit/xml-configuration/provisioning/policy/index "Policy") topic for additional information.

## Overview

A policy is a subgroup of the role model. It defines an ensemble of roles and assignment rules that apply to specific identities. So policies are used to handle separately several sets of identities, based on dimensions with different permissions and workflows. See the [Create Roles in the Role Catalog](../../set-up/single-roles-catalog-creation/index "Create Roles in the Role Catalog") and [Conforming Assignments](../../../integration-guide/role-assignment/conformingassignmentcomputation/index "Conforming Assignments")topics for additional information.
...
See the [Create a Resource Type](../../set-up/categorization/resource-type-creation/index "Create a Resource Type") topic for additional information.

## Create a Policy

Create a policy by proceeding as follows:

![Home - Access Policies](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Home_accessPolicies_V602.png)

**Step 1 –** Access the policies screen by clicking on **Access Policies** on the home page in the **Configuration** section.

![New Policy](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/PolicyCreation_policies_V602.png)

**Step 2 –** Click on **+ New policy** at the top right corner.

![](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/CreatePolicy.png)
