---
sidebar_position: 1289
title: Define Scalar Properties
---

# Define Scalar Properties

How to define the simple, or scalar, properties of an [Entity Type](../../../../../integration-guide/toolkit/xml-configuration/metadata/entitytype/index)'s resources.
...
>
> ![Scalar Properties](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_scalarEx_V600.png)
...
1. Start by declaring the [Create the Entity Type](../entity-type-declaration/index).
2. In the entity type's **Properties** section, click on **Map scalar properties** to display existing columns from the external source, and select the properties to be used in the entity type.

   ![Map from source](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_scalarPropertiesMap_V602.png)
...
3. Fill in the information fields.
   ...
   ![Scalar properties](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_scalarProperties_V603.png)
...
Entity properties' names and identifiers cannot be "Id".
   ...
   * **EXTERNAL SYSTEM**: fields about the corresponding properties inside the connected system.
   ...
   >
   > ![AD Entity Type - Scalar Properties](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_exampleAD2_V602.png)
4. Click on the Gear symbol to add advanced settings if needed.

   ![Advanced Settings](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_propertiesSettings_V602.png)
   ...
   * **Source Expression**: expression that defines the property based on at least one source object. Can be defined by a property path and/or [Expressions](../../../../../integration-guide/toolkit/expressions/index).

     > For example, `isUnused` is created to spot unused accounts via a combination of `accountExpires` and `lastLogonTimestamp`:
     >
     > ![Advanced Settings](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_SourceExpressionExample_V60.png)
...
![Reload](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_reload_V522.png)
...
Before saving, you must first[Select Primary Keys](../key-selection/index)for the entity type.

## Troubleshooting

If the Format column is not displayed in the External System part, then:

![Scalar properties](../../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/EntityTypeCreation_scalarPropertiesWithoutFormat_V522.png)
