...
How to create role naming rules, which create single roles using existing naming conventions from the managed system. See the [Role Mapping](../../../../integration-guide/toolkit/xml-configuration/provisioning/rolemapping/index) topic for additional information.
...
> For example, consider a naming convention in our organization that states that AD groups have their cn: `SG_APP_`. Then, we can create a naming rule that indicates that for all AD groups starting with `SG_APP_`, we create a role that gives the adequate user the corresponding group membership, with `` as a name. For example, we have the application Contoso and the group `SG_APP_Contoso`.
...
| Input | Output |
| --- | --- |
| [Create a Provisioning Rule](../../provisioning-rule-creation/index) (required) | Role naming rule   Single roles  Navigation rules  Categories |
...
1. On the home page, click on **Access Rules** in the **Configuration** section.
   ...
   ![Home Page - Access Rules](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Home_rules_V602.png)
...
4. Fill in the fields.
   ...
   ![Create a Naming Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_newRule_V602.png)

   * `Policy`: [Policy](../../../../integration-guide/toolkit/xml-configuration/provisioning/policy/index) in which the rule exists.
   ...
   * **Single Role**: single role(s) to be created. See the [Create a Role Manually](../role-manual-creation/index) topic for additional information.

     * `Identifier`: must be unique among roles and without any whitespace. If the defined identifier is already used, then neither the role nor the rule is created. Can be defined by a property path and/or [Expressions](../../../../integration-guide/toolkit/expressions/index) (mandatory).
     * `Name`: will be displayed in the UI to identify the future single role. Can be defined by a property path and/or an [Expressions](../../../../integration-guide/toolkit/expressions/index).
   * **Category**: the [Category](../../../../integration-guide/toolkit/xml-configuration/provisioning/category/index "Category") for the future role(s).
     ...
     * `Parent Identifier`: for a potential parent category. Must match an existing category's identifier. Can be defined by a property path and/or an expression.
   ...
   * `Comment Management on Permission Review`: to change if different from the role policy.
   ...
   >
   > ![Example - Naming Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_example_V602.png)
...
1. to take the changes into account, on the appropriate connector's overview page click on **Jobs** > **Apply Naming Conventions**;
...
![Home Page - Access Roles](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Home_roles_V602.png)

Select single roles and find the role(s) you created inside the right category and with the right parameters.

![Access Single Roles](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_testRoles_V602.png)

> [Our example](#overview) would look like:
>
> ![Example - Generated Role](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_exampleRoleResult_V602.png)
...
![Access Navigation Rules](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_testRules_V602.png)

> Our example would look like:
>
> ![Example - Generated Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/NamingRuleCreation_exampleRuleResult_V523.png)