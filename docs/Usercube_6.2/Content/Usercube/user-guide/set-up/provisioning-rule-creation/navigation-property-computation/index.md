...
Here, we are going to compute the values of navigation properties for the target resources used in entitlement management, based on source resources. See the[Define Navigation Properties](../../connect-system/entity-type-creation/navigation-property-definition/index "Define Navigation Properties") topic for additional information. We are going to provision these properties, i.e. write them to the managed system. See the [Provision](../../../administrate/provisioning/index "Provision") topic for additional information.
...
![Schema - Scalar Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_schemaNavigation.png "Schema - Scalar Rule")
...
> A query rule could compute the value of the `department` navigation property for ServiceNow nominative accounts (entity type `ServiceNow_User`), with a query from among resources from the `ServiceNow_Department` entity type, where the name of the resource would match the display name of the organization specified for the user (owner of the ServiceNow account).
>
...
> Another query rule could compute the `parentdn` attribute for AD nominative accounts, with a query from among AD entries, where the `dn` attribute of the resource would match a complex expression based on the user's (owner of the AD account) presence state, employee type, location, etc.
>
...
* The only reason to have several rules to compute a single property is when changing the property value over time, via time offsets. See the [Resource Type](../../../../integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index "Resource Type") topic for additional information.

## Participants and Artifacts

For a given managed system, integrators may need the help of the application owner who knows the application users, entitlements and data model. See the [Categorize Resources](../../categorization/index "Categorize Resources") topic for additional information.
...
![Home - Access Rules](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/Home_rules_V602.png)

**Step 2 –** In the dropdown menu at the top left, choose the source entity type for the future navigation rule.

![Entity Type Choice](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_entityType_V602.png)

**Step 3 –** Click on the **Navigations** tab and on the addition button at the top right corner.

![Addition Icon](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/iconAdd_V602.png)

**Step 4 –** Fill in the fields.

![Create a Navigation Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/SingleRolesCatalog_createNavRule_V602.png)
...
>
> ![Scalar Rule Example](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_exampleNav_V602.png)
...
![Create Query Rule](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_queryRule_V522.png)

Once the `Resource Type` is provided, more fields appear.

![Query Rule Fields](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_queryRuleFields_V602.png)

* **Target Object** > `Property to fill`: navigation property from the target entity type, whose value is to be impacted.
* **Target Object**: property (or expression of properties) from the entity type pointed by the `Property to fill`, which will be the value of the `Property to fill` if it matches the source object. Can be defined by a property path and/or an expression. See the [Expressions](../../../../integration-guide/toolkit/expressions/index "Expressions") topic for additional information.
* **Source Object**: property (or expression of properties) from the source entity type. Can be defined by a property path and/or an expression. See the [Expressions](../../../../integration-guide/toolkit/expressions/index "Expressions") topic for additional information.
...
* `Confidence Rate`: rate expressing the confidence in this link, and its priority order. See the[Classify Resources](../../categorization/classification/index "Classify Resources") topic for additional information.

> Our examples would look like:
>
> ![Query Rule Example](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_exampleQuery_V602.png)
>
> ![Query Rule Example 2](../../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/ProvRules_exampleQueryBis_V602.png)
...
Simulations are available in order to anticipate the changes induced by a creation/modification/deletion in navigation and query rules. See the [Perform a Simulation](../../../optimize/simulation/index "Perform a Simulation") topic for additional information.
...
See the[Review an Unauthorized Account](../../../administrate/non-conforming-assignment-review/unauthorized-account-review/index "Review an Unauthorized Account") and the[Reconcile a Role](../../../administrate/non-conforming-assignment-review/role-reconciliation/index "Reconcile a Role") topics for additional information.