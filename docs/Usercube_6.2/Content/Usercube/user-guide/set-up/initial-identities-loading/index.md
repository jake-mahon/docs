...
>
> ![Identity Repository Example](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/identityRepository-example.png)

> In Identity Manager, the identity repository can look like the following:
>
> ![Identity Repository Result](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/identityRepository_V602.png)
>
> ![Identity Example](../../../../../../../static/images/Usercube_6.2/Content/Resources/Images/identityRepository-person_V602.png)

See the [Identity Repository](../../../integration-guide/identity-management/identity-repository/index "Identity Repository") topic for additional information..
...
1. [Configure Unique Property Generation](generate-unique-properties/index "Configure Unique Property Generation") for all users, pre-existing and new, who do not have them yet.
2. [Load Identities to Identity Manager](load-identities/index "Load Identities") to Identity Manager based on the recommended attributes from the provided organizational model [Template Description](template-description/index "Template Description").
3. [Adjust the Workforce Data Model](adjust-datamodel/index "Adjust the Workforce Data Model") following Identity Manager's suggestions.
4. Continue with the next steps of this guide, and come back later to fill the organizational model with additional data.

## Next Steps

Once the initial identities are loaded, integrators can start the User Profile configuration. See the [Configure a User Profile](../user-profile-configuration/index "Configure a User Profile") topic for additional information.
