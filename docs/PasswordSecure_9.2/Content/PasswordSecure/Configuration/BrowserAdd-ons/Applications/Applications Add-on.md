...
![registration with and without application](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_142-en.png "registration with and without application")
...
![create application](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_144-en.png "create application")

A modal window now opens. The actual application is now created here.

![modal application window](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_145-en.png "modal application window")

The following options are available:

* **Advanced options** allows you to define a delay separately for each field when entering the data. This is sensible when the process of entering the data would otherwise not run smoothly on sluggish websites.
...
![choosed application field](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_146-en.png "choosed application field")
...
![example for a application](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_147-en.png "example for a application")
