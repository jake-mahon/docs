...
![Header](../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_171-en_679x38.png "Header")
...
The user who is currently logged in can be seen under account. You can log out by clicking on the account. It is also possible to call up the settings in [Account](../../../Advanced view/MainMenu/Account/Account "Account").