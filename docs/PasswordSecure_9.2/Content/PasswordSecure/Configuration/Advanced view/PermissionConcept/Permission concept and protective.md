...
With Netwrix Password Secure version 9 we provide the right solution to all conceivable demands placed on it with regards to permission management. [Roles](../ClientModule/Roles/Roles "Roles") are a great way to efficiently manage multiple users without losing the overview. We've created multiple methods to manually or automatically manage your permissions. More information can be seen in the chapter [Multiple editing of permissions](Manual settings/Multiple editing of permissions/Multiple editing of permissions "Multiple editing of permissions")

Alongside the definition of manual and automatic setting of permissions, the (optional) setting of [Protective mechanisms](Predefining rights/Protective mechanisms/Protective mechanisms "Protective mechanisms") forms part of the authorization concept. The protective mechanisms are thus downstream of the permissions. The interrelationships between all of these elements are illustrated in the following diagram.

![Authorisation concept](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/permission_concept_1-en.png "Authorisation concept")
...
![Permission only for users or roles](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/permission_concept_2-en.png "Permission only for users or roles")
...
![Membership in roles](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/permission_concept_3-en.png "Membership in roles")
...
![Membership vs permissions for roles](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Membership permission.png "Membership vs permissions for roles")
...
Similar to the previous section [Permission concept and protective mechanisms](# "Permission concept and protective mechanisms") for roles, the configuration of a role will be illustrated using two users. The configuration is performed in the [Roles](../ClientModule/Roles/Roles "Roles"). By double-clicking on the role “IT-Consultants” in the [List view](../Operation and Setup/ListView/List view "List view"), you can open their detailed view.

![roles list view](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/permission_concept_5-en.png "roles list view")
...
![explanation of the authorization through a role](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/permission_concept_6-en.png "explanation of the authorization through a role")
