...
![new discovery service task](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/discovered_entries_1-en.png "new discovery service task")
...
NOTE: The **data** is **not kept up-to-date while the task is being executed** and does not always show the latest status. Therefore, the data should be regularly **updated** using the **F5 button**!
...
![discovery service entries](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/discovered_entries_2-en.png "discovery service entries")
...
![Discovery service conversion wizard ](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/discovered_entries_3-en.png "Discovery service conversion wizard ")
...
![Discovery service conversion wizard ](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/discovered_entries_4-en.png "Discovery service conversion wizard ")

For **Active Directory users**, it is possible to assign an existing **password**.

NOTE: The subsequent process is carried out in the same way as when only one **Discovery Service entry** is selected.
...
![Filter for discovered data](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/discovered_entries_5-en.png "Filter for discovered data")
