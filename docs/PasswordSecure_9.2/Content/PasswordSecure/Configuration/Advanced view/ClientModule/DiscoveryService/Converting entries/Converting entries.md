...
![ribbon](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_1-en.png "ribbon")
...
![data selection](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_2-en.png "data selection")
...
NOTE: Logically, **every root node** corresponds to **one user** and all of its associated data (e.g. services). A **Password Reset** is created later for **every user** and its associated data.

The following image shows the options **add new password** or retain **existing password**.

![associated password](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_3-en.png "associated password")
...
![reset setting](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_4-en.png "reset setting")
...
**CAUTION:** After clicking on **Finish**, the **Password Resets** will be **immediately executed** and the **passwords changed!**. This also applies to **Windows passwords!**

If option 1: **Do you also want to add a Password Reset?** is not selected, \*steps 4, 5 and 6 are not displayed for configuration.

![password reset option](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_5-en.png "password reset option")

NOTE: After clicking on **Finish**, one or more **passwords will be created** but **no corresponding Password Resets will be created!**
...
![Assignment (Active Directory user)](../../../../../../Resources/Images/converting_entries_6-en.png "Assignment (Active Directory user)")
...
![Assignment of the form field](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_7-en.png "Assignment of the form field")
...
![New Form](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_8-en.png "New Form")
...
![summary](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_9-en.png "summary")

## Confirmation prompt

An important aspect of Netwrix Password Secure V8 is the **security** of passwords on systems. In the **Discovery Service**, a **security measures** is thus triggered at the **last step** for creating **Password Resets**.
...
![important note](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_10-en.png "important note")
...
![securtiy warning](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/converting_entries_11-en.png "securtiy warning")
