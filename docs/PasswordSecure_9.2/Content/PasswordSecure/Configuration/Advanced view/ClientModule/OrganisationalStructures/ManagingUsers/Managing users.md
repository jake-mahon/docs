...
![create user](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/create-user-wc.png "create user")
...
There are two different types of licenses, **Advanced view** and **Basic view** licenses. In all other editions you can only purchase Advanced view licenses.
...
**CAUTION:** For licensing reasons, it is not intended to switch from a Advanced view user to a Basic view user!
...
In order to display the data to which a user is authorized, you must right-click on the corresponding user in the organisational structure. In the context menu that opens, you will find the following options under **displaying data records**:
