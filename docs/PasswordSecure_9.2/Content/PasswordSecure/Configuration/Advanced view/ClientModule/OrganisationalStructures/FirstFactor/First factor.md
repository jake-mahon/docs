...
![Edit first factor](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/first_factor_1-en.png "Edit first factor")
...
![Smartcard 1st factor](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/first_factor_2-en.png "Smartcard 1st factor")
...
For Fido2 it is mandatory that SMTP ([Advanced settings](../../../../Server Manager/Main menu/Advanced settings "Advanced settings")) is configured. In addition, an e-mail address must be stored for the AD users.

Furthermore, the URL of the Web Application must be stored in the Server Manager:

![Edit WebClient URL](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/first_factor_3-en.png "Edit WebClient URL")

### Configuration

The configuration is done via the user setting **First Factor**.

![FIDO2](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/first_factor_4-en.png "FIDO2")

As soon as an AD user logs on to the Web Application, he gets the following prompt

![prompt](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/first_factor_5-en.png "prompt")
