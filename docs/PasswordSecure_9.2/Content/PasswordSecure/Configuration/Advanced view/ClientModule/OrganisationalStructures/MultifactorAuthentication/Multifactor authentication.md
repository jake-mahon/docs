...
![database settings](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_1-en.png "database settings")

It is possible to separately define in the settings whether it is permitted to use each interface on the database.

![multifactor authentication](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_2-en.png "multifactor authentication")
...
NOTE: In order for a user (administrator) to be able to **configure** multifactor authentication for other users, the user must have the rights **read**, **write**, **delete** and **authorize**. It is important that these rights exist before Multifactor Authentication is set up.

## Configuration of multifactor authentication

In the [Organisational structure](../Organisational structure "Organizational structure") module, you select the user and the interface "Multifactor authentication" in the ribbon.

![TOTP](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_3-en.png "TOTP")
...
![google authenticator](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_4-en.png "google authenticator")
...
![RSA SecurID Token](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_5-en.png "RSA SecurID Token")
...
![Public key infrastructure](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/multifactor_authentication_7-en.png "Public key infrastructure")

Now just select the desired certificate from the list to confirm the process.

## Yubico One Time Password

The configuration of multifactor authentication using Yubico One Time Password is described in[Multifactor Authentication](../../../../Server Manager/Managing databases/Database settings/Multifactor authentication AC "Multifactor Authentication").
