...
![Ribbon notifications](../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/notifications_2-en.png "Ribbon notifications")
...
![filter notifications](../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/notifications_3-en.png "filter notifications")
...
![Manual configuration of notifications](../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/notifications_5-en.png "Manual configuration of notifications")
...
* [Seals](../../PermissionConcept/Predefining rights/Protective mechanisms/Seals/Seals "Seals"): Requests to release sealed records are handled via the notification system
* [System tasks](../../MainMenu/Extras/System tasks/System Tasks "System tasks")s: If reports are automatically created via the system tasks, these are also made available in the form of a notification. If this type of notification is selected, it can be directly opened via the corresponding button that appears on the ribbon.

![Ribbon functions notifications](../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/notifications_6-en.png "Ribbon functions notifications")

## Automatic deletion of old notifications

If desired, notifications can be automatically cleaned up. This option can be configured on the **Server Manager**. Further information can be found in the section [Managing databases](../../../Server Manager/Managing databases/Managing databases "Managing databases").