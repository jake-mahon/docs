...
![Icon/logos in NPS](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_106-en.png "Icon/logos in NPS")
...
In the main menu in [Extras](../Extras "Extras") you can find the image management. Here, you have the possibility to store icons and logos manually.

![Image management](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_107-en.png "Image management")

Click on the + symbol to open the mask for creating images.

![add image](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_108-en.png "add image")

* **Name** Name the picture here.

* **Search** **value** The following priority must be observed:  
  - **Passwords**: first URL in the password (if several URLs are stored) -> attached tags -> password name -> names of connected applications  
  - **Applications**: URL stored in the application -> attached tags -> application name

* ![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/icon open folder.png) This symbol can be used to upload locally saved icons and logos.
