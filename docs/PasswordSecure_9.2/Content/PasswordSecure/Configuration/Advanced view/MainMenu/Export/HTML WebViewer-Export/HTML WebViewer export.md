...
The **WebViewer** is an option inNetwrix Password Secure for exporting passwords in an encrypted **HTML file**. The records are selected using the [Filter](../../../Operation and Setup/Filter/Filter "Filter") function. The passwords for which the user has the corresponding permissions are exported. They are displayed in a current browse that has **JavaScript activated**.
...
![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_65.png)

## Exporting a HTML file

The **HTML file** is created on the user\*s client and started in the **Main menu** under **Export WebViewer**.

![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_66.png)
...
![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_67.png)
...
![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_68.png)

###### Export filter

The export filter works in the same way as the filters for the modules.

![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_69.png)

#### Finish

The information about the exported passwords is displayed in the **Finish** ribbon. Clicking on the **Finish**

button will then create the **HTML** **file** in the export path and close the window.

![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_70.png)

A subsequent note provides you with information about the export process.

![](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/PasswordSecure_Documentation_without_existing_chapters/Installation with parameters_71.png)

## Using the HTML WebViewer file

The **HTML file** is created in the export path and can be copied to a mobile data medium (USB stick, external HDD, …). The **HTML file** can be opened in a standard browser and displays the **Netwrix Password Secure – HTML WebViewer / Login** when started. The **database** and the **user name** are predefined. The user \*password is used for the login.
...
![Login HTML WebViewer](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_72-en.png "Login HTML WebViewer")
...
![Entry in HTML WebViewer](../../../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_73-en.png "Entry in HTML WebViewer")
...
The browser will then show the **Netwrix Password Secure– HTML WebViewer / Login** again and also the reason for being logged out. It is possible to log in again.