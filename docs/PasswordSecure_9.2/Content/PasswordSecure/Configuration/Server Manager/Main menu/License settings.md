...
![License settings](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Installation_with_parameters_262-en.png "License settings")

## Licenses

**CAUTION:** Version 7 licenses cannot be used for Netwrix Password Secure version 9. “Please contact us”: http: //www.passwordsafe.de to obtain a version 9 license.
...
**CAUTION:** The licence is called up in the context of the service user. If you experience connection problems, the firewall and, if relevant, the proxy should be checked.
...
5. Click Upload license file.  
   ...
   ![](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/License file tab.png)
6. Select the file from this email and then click Open.  
     
   ![](../../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/activated license.png)