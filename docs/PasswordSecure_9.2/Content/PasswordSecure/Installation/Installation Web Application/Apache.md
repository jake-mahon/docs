...
![](../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/Apache-en.png)
...
![](../../../../../../static/images/PasswordSecure_9.2/Content/Resources/Images/apache-en-2.png)
...
The file /etc/apache2/sites-available/default-ssl.conf is (for example "nano") opened. Everything between``and``is now deleted and replaced by the configuration from the server. Apache is subsequently restarted via systemctl reload apache.
