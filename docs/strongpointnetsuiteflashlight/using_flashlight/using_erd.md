...
2. Select a __Record Type__
   ...
   ![ERD Filter Options](/static/img/product_docs/strongpointnetsuiteflashlight/using_flashlight/erd_filters_800x231.png)
3. Click __Show Record ERD__ to generate the diagram.

   ![ERD](/static/img/product_docs/strongpointnetsuiteflashlight/using_flashlight/erd_800x517.png)
...
- __Owner__: The current owner of the record.
- __Data Type__: Displays the NetSuite Object Type.
- __Last Modified__: Displays the Date Last Modified if available.
- __Open record__: Opens the customization record.
