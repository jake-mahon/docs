...
Additionally, it is necessary to generate an API Access Key for Nasuni activity monitoring. See the [Nasuni Edge Appliance Activity Auditing Configuration](Activity "Nasuni Edge Appliance Activity Auditing Configuration") topic for instructions.
