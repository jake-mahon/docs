...
**Step 1 –** In the Microsoft Purview compliance portal at [https://purview.microsoft.com](https://purview.microsoft.com/ "Microsoft Purview Portal"), go to **Solutions** > **Audit**. Or, to go directly to the Audit page at [https://purview.microsoft.com/audit/auditsearch](https://purview.microsoft.com/audit/auditsearch "Micorsoft Purview Portal - Audit Log Search").
