...
![Groups tab](../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/Config/Dell/PowerScale/GroupsTab.png "Groups tab")
...
![Edit Group window](../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/Config/Dell/PowerScale/EditGroup.png "Edit Group window")
...
![One FS Dashboard](../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/Config/Dell/PowerScale/RolesTab.png "One FS Dashboard")

**Step 2 –** On the Roles tab, select **View / Edit** for the BackupAdmin role. The View Role Details window opens.

![One FS Role Details Window](../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/Config/Dell/PowerScale/ViewRoleDetails.png "One FS Role Details Window")
...
The Access Analyzer server IP needs to be added to the following fields in each NFS export's settings, in the OneFS UI under **Protocols** > **UNIX sharing (NFS)** > **View/Edit** > **Edit export** (per NFS export):
...
See the [Dell Isilon/PowerScale Activity Auditing Configuration](Activity "Dell Isilon/PowerScale Activity Auditing Configuration") topic for instructions.
