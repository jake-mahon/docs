...
![](../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/Config/Dell/RegistryEditorEndpoint.png)
...
If this is configured correctly, validate that the Dell CEE services are running. See the [Validate Dell CEE Services are Running](#Validate_EMC_CEE_Services_are_Running "Validate Dell CEE Services are Running") topic for additional information.
