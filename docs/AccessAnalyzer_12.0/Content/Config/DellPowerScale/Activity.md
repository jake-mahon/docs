...
* Select method:
  ...
  * [Manually Configure Auditing in OneFS](ManualConfiguration "Manually Configure Auditing in OneFS")
...
```
Another way to check the privileges is to use the **OneFS Web UI** in the **OneFS** > **Membership** > **User Mapping** > **Test User Mapping** section.

Checklist Item 4: Configure Dell CEE to Forward Events to the Activity Agent. See the [Validate Setup](Validate "Validate Setup") topic for additional information.