...
Netwrix Activity Monitor requires an account with the Observers role to monitor a Qumulo cluster. See the [Qumulo Activity Auditing Configuration](Activity "Qumulo Activity Auditing Configuration") topic for instructions.
