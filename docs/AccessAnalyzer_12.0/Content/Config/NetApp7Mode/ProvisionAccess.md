---
sidebar_position: 4865
title: Provision Account
---

# Provision Account

This section describes the steps needed to create a user account with the privileges required to execute Access Auditing (FSAA) and/or Sensitive Data Discovery Auditing scans from Access Analyzer. It is necessary to:

* Create Role
* Create a Group & Assign Role
* Add User to Group

Relevant NetApp Documentation: To learn more about node access controls, please visit the NetApp website and read the [na\_useradmin – Administers node access controls](https://library.netapp.com/ecmdocs/ECMP1511537/html/man1/na_useradmin.1.html "Opens the na_useradmin – Administers node access controls article in a new window") article.
