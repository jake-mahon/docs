...
**NOTE:** See the [Configure Dell Registry Key Settings](../DellUnity/InstallCEE#Configur "Configure Dell Registry Key Settings") topic for information on manually setting the registry key.
