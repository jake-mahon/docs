...
* [ADInventory Data Collector](../../EnterpriseAuditor/Admin/DataCollector/ADInventory/Overview "ADInventory Data Collector")
* [ActiveDirectory Data Collector](../../EnterpriseAuditor/Admin/DataCollector/ActiveDirectory/Overview "ActiveDirectory Data Collector")
* [ADActivity Data Collector](../../EnterpriseAuditor/Admin/DataCollector/ADActivity/Overview "ADActivity Data Collector")
* [GroupPolicy Data Collector](../../EnterpriseAuditor/Admin/DataCollector/GroupPolicy/Overview "GroupPolicy Data Collector")
* [LDAP Data Collector](../../EnterpriseAuditor/Admin/DataCollector/LDAP "LDAP Data Collector")
* [PasswordSecurity Data Collector](../../EnterpriseAuditor/Admin/DataCollector/PasswordSecurity/Overview "PasswordSecurity Data Collector")
* [PowerShell Data Collector](../../EnterpriseAuditor/Admin/DataCollector/PowerShell/Overview "PowerShell Data Collector")
* [Registry Data Collector](../../EnterpriseAuditor/Admin/DataCollector/Registry "Registry Data Collector")
...
***RECOMMENDED:*** Use Domain/Local Administrator privileges to run Access Analyzer against an Active Directory domain controller.

There is a least privilege model for scanning your domain. See the [Least Privilege Model](#Least "Active Directory Least Privilege Model") topic for additional information.
...
See the [Variable Definitions](#Variable "Variable Definitions") for variable definitions.
