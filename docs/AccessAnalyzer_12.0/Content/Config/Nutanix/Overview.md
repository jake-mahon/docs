...
See the [Nutanix Appliance Access & Sensitive Data Auditing Configuration](Access "Nutanix Appliance Access & Sensitive Data Auditing Configuration") topic for additional information.
...
The Netwrix Activity Monitor can be configured to monitor activity on Nutanix devices. See the [Nutanix Files Activity Auditing Configuration](Activity "Nutanix Activity Auditing Configuration") topic for instructions.
