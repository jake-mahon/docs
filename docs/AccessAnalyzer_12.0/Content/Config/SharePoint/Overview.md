...
See the [SharePoint Access & Sensitive Data Auditing Configuration](Access "SharePoint Access & Sensitive Data Auditing Configuration") topic for instructions.
...
See the [SharePoint On-Premise Activity Auditing Configuration](Activity "SharePoint Activity Auditing Configuration") topic for instructions.
