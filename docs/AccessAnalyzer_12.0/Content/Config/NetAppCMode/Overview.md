...
See the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](Activity "NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration") topic for instructions.
