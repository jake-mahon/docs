...
* [AzureADInventory Data Collector](../../EnterpriseAuditor/Admin/DataCollector/AzureADInventory/Overview "AzureADInventory Data Collector")
...
**NOTE:** Additional permissions need to be configured to collect Microsoft Entra roles information. See the [Microsoft Entra Roles Auditing Configuration](../../EnterpriseAuditor/Requirements/Solutions/EntraID/EntraRoles "Microsoft Entra Roles Auditing Configuration") topic for additional information.
...
This Application (client) ID value is needed for the Access Analyzer Connection Profile and the Custom Attributes page of the AzureADInventory Data Collector. See the [Azure Active Directory for User Credentials](../../EnterpriseAuditor/Admin/Settings/Connection/Profile/EntraID "Azure Active Directory for User Credentials") topic and the [AzureADInventory: Custom Attributes](../../EnterpriseAuditor/Admin/DataCollector/AzureADInventory/CustomAttributes "AzureADInventory: Custom Attributes") topic for additional information. Next generate the application’s Client Secret Key.
...
This is needed for the Host List and the Custom Attributes page of the AzureADInventory Data Collector. See the [Microsoft Entra ID Connection Profile & Host List](../../EnterpriseAuditor/Admin/DataCollector/AzureADInventory/ConfigureJob "Microsoft Entra ID Connection Profile & Host List") and [AzureADInventory: Custom Attributes](../../EnterpriseAuditor/Admin/DataCollector/AzureADInventory/CustomAttributes "AzureADInventory: Custom Attributes") topics for additional information.