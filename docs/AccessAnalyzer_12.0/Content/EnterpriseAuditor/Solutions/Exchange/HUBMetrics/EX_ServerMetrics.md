...
View the analysis tasks by navigating to the **Exchange** > **1. HUB Metrics** > **EX\_ServerMetrics** > **Configure** node and select **Analysis**.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the EX_ServerMetrics Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Exchange/HUBMetrics/ServerMetricsAnalysis.png "Analysis Tasks for the EX_ServerMetrics Job")
