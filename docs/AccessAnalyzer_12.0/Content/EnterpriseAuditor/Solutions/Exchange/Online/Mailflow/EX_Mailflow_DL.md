...
View the analysis tasks by navigating to the **Exchange** > **8. Exchange Online** > **EX\_Mailflow\_DL** > **Configure** node and select **Analysis**.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the EX_Mailflow_DL Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Exchange/Online/MailFlowDLAnalysis.png "Analysis Tasks for the EX_Mailflow_DL Job")
