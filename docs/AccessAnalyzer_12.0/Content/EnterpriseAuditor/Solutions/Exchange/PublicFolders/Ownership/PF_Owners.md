...
View the analysis tasks by navigating to the **Exchange** > **5. Public Folders** > **Ownership** > **PF\_Owners** > **Configure** node and select **Analysis**.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the PF_Owners Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Exchange/PublicFolders/Ownership/OwnersAnalysis.png "Analysis Tasks for the PF_Owners Job")
