...
![2.Sharing > Dropbox_Sharing Job in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Dropbox/SharingJobsTree.png "2.Sharing > Dropbox_Sharing Job in the Jobs Tree")

The Dropbox\_Sharing job is located in the 2.Sharing job group.

## Analysis Tasks for the Dropbox\_Sharing Job

View the analysis tasks by navigating to the **Jobs** > **Dropbox** > **2.Sharing** > **Dropbox\_Sharing** > **Configure** node and select **Analysis**.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the Dropbox_Sharing Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Dropbox/SharingAnalysis.png "Analysis Tasks for the Dropbox_Sharing Job")
