...
The AnyID Connectors Solution requires a special Access Analyzer license. It can be installed from the Instant Job Wizard. See the [Instant Job Wizard](../../Admin/Jobs/InstantJobs/Overview "Instant Job Wizard") topic for additional information.

![AnyID Connectors Solution in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/JobsTree.png "AnyID Connectors Solution in the Jobs Tree")
...
![AnyID Connectors Solution Overview page](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/OverviewPage.png "AnyID Connectors Solution Overview page")

The jobs in the AnyID Connectors Solution are:

* [AnyID\_CSV Job](AnyID_CSV "AnyID_CSV Job") – Imports a list of identities and attributes from a CSV file. Use this when a native integration may not be available, or an export is the best option.
* [AnyID\_EpicClarity Job](AnyID_EpicClarity "AnyID_EpicClarity Job") – Collects patient information from Epic including MRNs, SSNs, Subscriber IDs, and Account IDs. An account with read access to the underlying Clarity Oracle database is required in order to run queries.
* [AnyID\_Paycom Job](AnyID_Paycom "AnyID_Paycom Job") – Pulls employee information from Paycom including Name, Address, Date of Birth, and SSN. Contact your Paycom administrator in order to generate the CSV export required for this job.
* [AnyID\_Salesforce Job](AnyID_Salesforce "AnyID_Salesforce Job") – Collects Salesforce Contact details including Phone, Address, Email, and Date of birth. This job requires API access to Salesforce in order to collect this information.
