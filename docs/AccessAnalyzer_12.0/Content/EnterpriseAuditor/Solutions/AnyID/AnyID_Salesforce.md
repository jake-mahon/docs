...
![AnyID_Salesforce Job in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/SalesforceJobLocation.png "AnyID_Salesforce Job in the Jobs Tree")

The AnyID\_Salesforce job is located in the **Jobs** > **AnyID Connectors** job group.
...
Ensure that a connection profile is configured with the required credentials. See the [Prerequisites](#Prerequisites "Prerequisites") topic for additional information.
...
This job contains configurable queries. See the [Configure the AnyID\_Salesforce Query](#Configure_the_AnyID_Salesforce_Query "Configure the AnyID_Salesforce Query") topic for additional information.
...
![Query for the AnyID_Salesforce Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/SalesforceQueries.png "Query for the AnyID_Salesforce Job")

The query is:

* PS Salesforce Import – Imports Salesforce information for analysis. This query has configurable parameters. See the [Configure the AnyID\_Salesforce Query](#Configure_the_AnyID_Salesforce_Query "Configure the AnyID_Salesforce Query") topic for additional information.

### Configure the AnyID\_Salesforce Query

Follow the steps to configure the AnyID\_Salesforce query.

**Step 1 –** Navigate to the **AnyID Connectors** > **AnyID\_Salesforce** > **Configure** node and select **Queries**.

**Step 2 –** In the Query Selection view, select the PS Salesforce Import query and click **Query Properties**. The Query Properties window opens.

**Step 3 –** Select the **Data Source** tab, and click **Configure**. The PowerShell Data Collector Wizard opens.

![Edit Query Page](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/SalesforceQueryEditQuery.png "Edit Query Page")
...
Navigate to the **Jobs** > **AnyID Connectors** > **AnyID\_Salesforce** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AnyID_Salesforce Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AnyID/SalesforceAnalyses.png "Analysis Tasks for the AnyID_Salesforce Job")
