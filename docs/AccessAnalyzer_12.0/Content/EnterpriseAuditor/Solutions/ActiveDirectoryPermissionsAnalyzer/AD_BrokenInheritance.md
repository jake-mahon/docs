...
![6.Broken Inheritance Job Group in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/BrokenInheritanceJobsTree.png "6.Broken Inheritance Job Group in the Jobs Tree")
...
Navigate to the **Active Directory Permissions Analyzer** > **6.BrokenInheritance** > **AD\_BrokenInheritance** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AD_BrokenInheritance Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/BrokenInheritanceAnalysis.png "Analysis Tasks for the AD_BrokenInheritance Job")
