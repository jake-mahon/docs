...
Navigate to the **Active Directory Permissions Analyzer** > **4.Computers** > **AD\_LAPSPermissions** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AD_LAPSPermissions Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/Computers/LAPSPermissionsAnalysis.png "Analysis Tasks for the AD_LAPSPermissions Job")
