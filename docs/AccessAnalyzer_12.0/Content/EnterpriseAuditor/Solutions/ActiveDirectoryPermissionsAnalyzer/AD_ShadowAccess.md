...
The AD\_ShadowAccess Job has special dependencies. See the [Recommended Configurations for AD Permissions Analyzer Solution](Recommended "Recommended Configurations for AD Permissions Analyzer Solution") topic for additional information.

## Analysis Tasks for the AD\_ShadowAccess Job

Navigate to the **Active Directory Permissions Analyzer** > **AD\_ShadowAccess** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks, with the exception of the **Calculate Shadow Access** analysis tasks. The analysis tasks are preconfigured for this job. The **Calculate Shadow Access** analysis task is the only analysis task that has customizable parameters.

![Analysis Tasks for the AD_ShadowAccess Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessAnalysis.png "Analysis Tasks for the AD_ShadowAccess Job")
...
* Calculate Shadow Access – Creates the SA\_ShadowAccess\_Details table accessible under the job’s Results node
  ...
  * This Analysis Task has configurable parameters. See the [Configure the Analysis Tasks for the AD\_ShadowAccess Job](#Configure_the_Analysis "Configure the Analysis Tasks for the AD_ShadowAccess Job") topic for additional information.
...
See the [Report Functions for the AD\_ShadowAccess Job](#Report_Functions_for "Report Functions for the AD_ShadowAccess Job") topic for additional information.
...
See the [Configure the Analysis Tasks for the AD\_ShadowAccess Job](#Configure_the_Analysis "Configure the Analysis Tasks for the AD_ShadowAccess Job") topic for additional information.
...
**Step 1 –**  Navigate to the **Active Directory Permissions Analyzer** > **AD\_ShadowAccess** > **Configure** node and select **Analysis** to view analysis tasks.

![Configure Calculate Shadow Access task from Analysis Selection view](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessAnalysisConfigure.png "Configure Calculate Shadow Access task from Analysis Selection view")

**Step 2 –**  In the Analysis Selection view, select the **Calculate Shadow Access** analysis task, then click **Analysis Configuration**. The SQL Script Editor opens.

![SQL Script Editor](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessSQLScriptEditor.png "SQL Script Editor")
...
![Shadow Access reports in the job's Results node](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessReports.png "Shadow Access reports in the job's Results node")

Navigate to the **Active Directory Permissions Analyzer** > **AD\_ShadowAccess** > **Results** node to view the AD\_ShadowAccess job reports.

**NOTE:** These reports can also be accessed through the Web Console. See the [Viewing Generated Reports](../../Admin/Report/View "Viewing Generated Reports") topic for additional information.

![Exploited Permissions and Vulnerabilities on Shadow Access reports](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessReport1.png "Exploited Permissions and Vulnerabilities on Shadow Access reports")
...
![Report element displaying information on potential attack paths for users found in the targeted domain](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessReport2.png "Report element displaying information on potential attack paths for users found in the targeted domain")
...
![Attack Path window example](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessReport3.png "Attack Path window example")
...
![Attack Path window example](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectoryPermissionsAnalyzer/ShadowAccessReport4.png "Attack Path window example")
