...
![7.Sensitive Data > FS_DLPResults Job in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/FileSystem/SensitiveDataJobsTree.png "7.Sensitive Data > FS_DLPResults Job in the Jobs Tree")

The FS\_DLPResults job is located in the 7.Sensitive Data job group.

## Analysis Tasks for the FS\_DLPResults Job

View the analysis tasks by navigating to the **FileSystem** > **7.Sensitive Data** > **FS\_DLPResults** > **Configure** node and select **Analysis**.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the FS_DLPResults Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/FileSystem/DLPResultsAnalysis.png "Analysis Tasks for the FS_DLPResults Job")
