...
You can add this job from the Access Analyzer Instant Job Library. See the [Instant Job Wizard](../../../Admin/Jobs/InstantJobs/Overview "Instant Job Wizard") topic for additional information.
...
* Custom role created in a resource group with the **Microsoft.Storage/storageAccounts/read** permission
* Role assignment created on the resource group with the custom role and the app registration. The role can be assigned at various resource levels:
  ...
  * Storage Account
    ...
    **NOTE:** The custom role cannot be created at the storage account level via the web UI, but it can be assigned here.

Follow the steps to create the role assignment.

**Step 1 –** Go to [Azure Portal](https://portal.azure.com/ "Azure Portal"), and select **Resource Groups** from the navigation menu.

**Step 2 –** Select the resource level you want to apply the custom role to, and then navigate to the Access control (IAM) tab.
...
![User Credentials for FS_AzureTenantScan job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/FileSystem/AzureFiles/AzureTenantScanUserCredentials.png "User Credentials for FS_AzureTenantScan job")
...
* Password Storage – Application (Uses the configured Profile Security setting as selected at the **Settings** > **Application** node. See the [Application](../../../Admin/Settings/Application/Overview "Application") topic for additional information.)
...
![Query for the FS_AzureTenantScan Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/FileSystem/AzureFiles/AzureTenantScanQuery.png "Query for the FS_AzureTenantScan Job")
