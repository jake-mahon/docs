...
![AD_ActivityCollection Job in the Jobs Tree](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectory/Activity/Collection/JobsTree.png "AD_ActivityCollection Job in the Jobs Tree")
...
This is configured in the query. See the [Queries for the AD\_ActivityCollection Job](#Queries "Queries for the AD_ActivityCollection Job") topic for additional information.
...
![Configuration section on the AD_ActivityCollection job Overview page](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectory/Activity/OverviewConfiguration.png "Configuration section on the AD_ActivityCollection job Overview page")
...
* Enable to import authentication events into the AIC
  ...
  **NOTE:** The import of AD events and authentication events is disabled by default. You must enable these parameters for the activity data to be imported into the Netwrix Access Information Center. See the [(Optional) Configure Import of AD Activity into Netwrix Access Information Center](../../../../Config/ActiveDirectory/Activity#(Optiona "(Optional) Configure Import of AD Activity into Netwrix Access Information Center") topic for instructions.
* List of attributes to track for Object Modified changes
* Number of days to retain activity data in the AIC

See the [Customize Analysis Parameters for the AD\_ActivityCollection Job](#Customiz "Customize Analysis Parameters for the AD_ActivityCollection Job") topic for additional information.
...
**NOTE:** The query can be configured to connect directly to the network share where the archive logs are stored or the API Server.

![Queries for the AD_ActivityCollection Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectory/Activity/Collection/Queries.png "Queries for the AD_ActivityCollection Job")
...
**NOTE:** Ensure the Activity Monitor API Server and the required Connection Profile are successfully set up. See the [Active Directory Activity Auditing Configuration](../../../../Config/ActiveDirectory/Activity "Active Directory Activity Auditing Configuration") topic for additional information.
...
![Active Directory Activity DC wizard Category page](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/DataCollector/ADActivity/CategoryImportFromNAM.png "Active Directory Activity DC wizard Category page")
...
**NOTE:** Ensure the Activity Monitor domain output and the required Connection Profile are successfully set up. See the [File Archive Repository Option](../../../../Config/ActiveDirectory/FileArchive "File Archive Repository Option") topic for additional information.
...
Navigate to the **Jobs** > **Active Directory** > **6.Activity** > **0.Collection** > **AD\_ActivityCollection** Job. Select the **Configure** > **Analysis** node.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AD_ActivityCollection Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectory/Activity/Collection/Analysis.png "Analysis Tasks for the AD_ActivityCollection Job")
