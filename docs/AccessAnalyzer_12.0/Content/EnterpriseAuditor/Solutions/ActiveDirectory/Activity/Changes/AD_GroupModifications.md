...
Navigate to the **Jobs** > **Active Directory** > **6.Activity** > **Changes** > **AD\_GroupModifications** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AD_GroupModifications Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/ActiveDirectory/Activity/Changes/GroupModificationsAnalysis.png "Analysis Tasks for the AD_GroupModifications Job")
