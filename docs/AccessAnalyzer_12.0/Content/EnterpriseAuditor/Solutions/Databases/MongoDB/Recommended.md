...
1. Set a Connection Profile for the 0.Collection Job Group with the permissions listed in the Recommended Configurations section. See the [NoSQL Custom Connection Profile & Host List](../../../Admin/DataCollector/NoSQL/ConfigureJob "NoSQL Custom Connection Profile & Host List") topic for additional information.
2. Set the Host list for the 0.Collection Job Group with the servers containing the target databases. Additionally, the database clusters / instances must be added to the Filter page in the query configuration. See the [NoSQL Custom Connection Profile & Host List](../../../Admin/DataCollector/NoSQL/ConfigureJob "NoSQL Custom Connection Profile & Host List") topic for additional information.
