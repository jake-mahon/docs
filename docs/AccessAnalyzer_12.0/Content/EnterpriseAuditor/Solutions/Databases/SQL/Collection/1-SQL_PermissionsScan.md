...
![Query Selection](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Databases/SQL/SQLJobGroup6.png "Query Selection")

* PermissionsScan – Collects permissions from targeted instances
  * (Optional) This query can be modified to target specific databases/instances. See the [Configure the PermissionsScan Query](#_Configure_the_PermissionsScan "Navigates to the Configure the PermissionsScan Query section") topic for additional information.
...
**Step 1 –** Navigate to the **Databases** > 0.Collection > SQL > 1-SQL\_PermissionsScan > Configure node and select Queries.
...
**Step 4 –** To query for specific databases/instances, navigate to the [SQL Data Collector](../../../../Admin/DataCollector/SQL/Overview "Navigates to the SQL: Filter section") page. The default query target is All databases. The default query scope is Only select database objects and click Retrieve. The Available database objects will be populated. Databases and instances can be added in the following ways:

* Select the desired database objects and click Add.
* Use the Import CSV button to import a list from a CSV file, if desired.
* Optionally, use the Add Custom Filter button to create and apply a custom filter.

**Step 5 –** Navigate to the Summary page, click Finish to save any setting modifications or click Cancel if no changes were made. Then click OK to close the Query Properties window.
...
Navigate to the **Databases** > 0.Collection > SQL > 1-SQL\_PermissionsScan > Configure node and select Analysis to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis task(s). The analysis task(s) are preconfigured for this job.

![Analysis Selection](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Databases/SQL/SQLJobGroup8.png "Analysis Selection")
