...
Navigate to the **Jobs** > **Databases** > **Db2** > **Sensitive Data** > **Db2\_Sensitive Data** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the Db2 _SensitiveData Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Databases/Db2/SensitiveDataAnalysis.png "Analysis Tasks for the Db2 _SensitiveData Job")
