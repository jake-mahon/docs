...
Navigate to the **Jobs** > **SharePoint** > **7.Activity** > **Usage Statistics** > **SP\_MostActiveUsers** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis task. The analysis task is preconfigured for this job.

![Analysis Tasks for the SP_MostActiveUsers Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/Activity/MostActiveUsersAnalysis.png "Analysis Tasks for the SP_MostActiveUsers Job")
