...
Navigate to the **Jobs** > **SharePoint** > **1.Direct Permissions** > **SP\_SiteCollectionPerms** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the SP_SiteCollectionPerms Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/DirectPermissions/SiteCollectionPermsAnalysis.png "Analysis Tasks for the SP_SiteCollectionPerms Job")
