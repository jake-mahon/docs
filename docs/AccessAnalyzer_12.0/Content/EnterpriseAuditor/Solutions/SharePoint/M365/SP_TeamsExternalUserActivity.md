...
Navigate to the **Jobs** > **SharePoint** > **8.M365** > **SP\_TeamsExternalUserActivity** >**Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis task. The analysis task is preconfigured for this job.

![Analysis Tasks for the SP_TeamsExternalUserActivity Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/M365/TeamsExternalUserActivityAnalysis.png "Analysis Tasks for the SP_TeamsExternalUserActivity Job")
