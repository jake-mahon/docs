...
![Query Selection](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/Collection/SPACBulkImportQuery.png "Query Selection")
...
**Step 1 –** Navigate to the **Jobs** > **SharePoint** > **0.Collection** > **2-SPAC\_BulkImport** > **Configure** node and select **Queries**.
...
Navigate to the **Jobs** > **SharePoint** > **0.Collection** > **6-SPAC\_BulkImport** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** The analysis tasks are preconfigured for this job. Never modify or deselect the selected analysis tasks.

![Analysis Selection](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/Collection/SPACBulkImportAnalysis.png "Analysis Selection")
