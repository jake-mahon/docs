...
title: 6.Sensitive Data Job Group
---
...
![6.Sensitve Data > SP_SensitiveData Job in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/SensitiveDataJobsTree.png "6.Sensitve Data > SP_SensitiveData Job in the Jobs Tree")

The SP\_SensitiveData Job is located in the 6.Sensitive Data Job Group.

## Analysis Tasks for the SP\_SensitiveData Job

Navigate to the **Jobs** > **SharePoint** > **6.Sensitive Data** > **SP\_SensitiveData** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the SP_SensitiveData Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/SensitiveDataAnalysis.png "Analysis Tasks for the SP_SensitiveData Job")
