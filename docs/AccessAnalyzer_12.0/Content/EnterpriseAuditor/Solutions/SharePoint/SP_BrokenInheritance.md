...
![3.Broken Inheritance > SP_BrokenInheritance Job in the Jobs Tree](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/BrokenInheritanceJobsTree.png "3.Broken Inheritance > SP_BrokenInheritance Job in the Jobs Tree")
...
Navigate to the **Jobs** > **SharePoint** > **3.Broken Inheritance** > **SP\_BrokenInheritance** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the SP_BrokenInheritance Job](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/SharePoint/BrokenInheritanceAnalysis.png "Analysis Tasks for the SP_BrokenInheritance Job")
