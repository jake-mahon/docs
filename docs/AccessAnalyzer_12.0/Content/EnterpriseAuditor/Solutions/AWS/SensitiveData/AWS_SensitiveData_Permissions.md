...
Navigate to the **AWS** > **8.S3 Sensitive Data** > **AWS\_SensitiveData\_Permissions** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AWS_SensitiveData_Permissions Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AWS/SensitiveData/SensitiveDataPermissionsAnalysis.png "Analysis Tasks for the AWS_SensitiveData_Permissions Job")
