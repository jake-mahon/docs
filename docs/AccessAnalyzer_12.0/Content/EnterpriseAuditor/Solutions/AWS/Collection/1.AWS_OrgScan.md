...
![Queries for the 1.AWS_OrgScan Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AWS/Collection/OrgScanQueries.png "Queries for the 1.AWS_OrgScan Job")
...
**Step 1 –** Navigate to the **AWS** > **0.Collection** > **1.AWS\_OrgScan** > **Configure** node and select the **Queries** node.
