...
See the [Customizable Analysis Tasks for the AWS\_StaleRoles Job](#Customiz "Customizable Analysis Tasks for the AWS_StaleRoles Job") topic for additional information.

## Analysis Tasks for the AWS\_StaleRoles Job

Navigate to the **AWS** > **4.Roles** > **AWS\_StaleRoles** > **Configure** node and select **Analysis** to view the analysis tasks.
...
![Analysis Tasks for the AWS_StaleRoles Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AWS/Roles/StaleRolesAnalysis.png "Analysis Tasks for the AWS_StaleRoles Job")
...
* Stale Role Details – Highlights the roles in AWS that are considered stale. Creates the AWS\_StaleRole\_Details table accessible under the job’s Results node.
  ...
  * The number of days without login to consider an account stale can be customized. By default it is set to 60. See the [Customizable Analysis Tasks for the AWS\_StaleRoles Job](#Customiz "Customizable Analysis Tasks for the AWS_StaleRoles Job") topic for additional information.
