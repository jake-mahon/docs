...
See the [Customizable Analysis Tasks for the AWS\_StaleUsers Job](#Customiz "Customizable Analysis Tasks for the AWS_StaleUsers Job") topic for additional information.

## Analysis Tasks for the AWS\_StaleUsers Job

Navigate to the **AWS** > **2.Users** > **AWS\_StaleUsers** > **Configure** node and select **Analysis** to view the analysis tasks.
...
![Analysis Tasks for the AWS_StaleUsers Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AWS/Users/StaleUsersAnalysis.png "Analysis Tasks for the AWS_StaleUsers Job")
...
* Stale Users – Identifies user accounts that have not been logged in to in the last 60 days. Creates the AWS\_StaleUser\_Details table accessible under the job’s Results node.
  ...
  * The number of days can be customized from the default value of 60. See the [Customizable Analysis Tasks for the AWS\_StaleUsers Job](#Customiz "Customizable Analysis Tasks for the AWS_StaleUsers Job") topic for additional information.
