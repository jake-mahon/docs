...
Navigate to the **AWS** > **2.Users** > **AWS\_RootAccounts** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the AWS_RootAccounts Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/AWS/Users/RootAccountsAnalysis.png "Analysis Tasks for the AWS_RootAccounts Job")
