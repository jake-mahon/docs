...
![Queries for the SG_LSASettings Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Windows/Authentication/LSASettingsQueries.png "Queries for the SG_LSASettings Job")
...
Navigate to the **Windows** > **Authentication** > **SG\_LSASettings** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the SG_LSASettings Job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Windows/Authentication/LSASettingsAnalysis.png "Analysis Tasks for the SG_LSASettings Job")
