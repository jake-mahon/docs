...
Navigate to the **Windows** > **Privileged Accounts** > **Logon Rights** > **SG\_LocalPolicies** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Analysis Tasks for the SG_LocalPolicies Job](../../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Solutions/Windows/PrivilegedAccounts/LogonRights/LocalPoliciesAnalysis.png "Analysis Tasks for the SG_LocalPolicies Job")
