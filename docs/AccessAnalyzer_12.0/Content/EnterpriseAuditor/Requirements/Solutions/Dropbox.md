...
See the [Target Dropbox Requirements, Permissions, and Ports](../Target/Dropbox "Target Dropbox Requirements, Permissions, and Ports") topic for target environment requirements.
