...
* [Target Exchange Servers Requirements, Permissions, and Ports](../Target/Exchange "Target Exchange Servers Requirements, Permissions, and Ports")
* [Target Exchange Online Requirements, Permissions, and Ports](../Target/ExchangeOnline "Target Exchange Online Requirements, Permissions, and Ports")
...
* StealthAUDIT MAPI CDO installed (for MAPI- based data collectors). See the [StealthAUDIT MAPI CDO Installation](../../../StealthAUDIT/Install Guides/MAPI CDO Install/StealthAUDIT MAPI CDO Installation "StealthAUDIT MAPI CDO Installation") topic for additional information.
