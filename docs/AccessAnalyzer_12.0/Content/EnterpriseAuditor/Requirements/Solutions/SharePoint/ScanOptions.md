...
* [SharePoint Agent Permissions](AgentPermissions "SharePoint Agent Permissions")
* [SharePoint Agent Ports](AgentPorts "SharePoint Agent Ports")
...
**NOTE:** Agent-less scans can target both on-premise and online environments. This is the only scan mode that can run Activity Auditing (SPAC) scans.
...
* SharePoint Online
  ...
  * [SharePoint Online Permissions](OnlinePermissions "SharePoint Online Permissions")
  * [SharePoint Online Ports](OnlinePorts "SharePoint Online Ports")
* SharePoint On-Premise

  * [SharePoint Agent-Less Permissions](AgentlessPermissions "SharePoint Agent-Less Permissions")
  * [SharePoint Agent-Less Ports](AgentlessPorts "SharePoint Agent-Less Ports")