...
See the [Active Directory Domain Target Requirements](../../../Config/ActiveDirectory/Overview "Active Directory Domain Target Requirements") topic for target environment requirements.
