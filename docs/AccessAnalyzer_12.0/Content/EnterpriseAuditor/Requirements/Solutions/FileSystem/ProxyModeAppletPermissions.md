...
* If the applet is deployed as a service, the service account requires the Log on as a service privilege
  ...
  * See the [FSAA: Applet Settings](../../../Admin/DataCollector/FSAA/AppletSettings "FSAA: Applet Settings") topic for additional information on the applet launch mechanism
...
See the [Proxy Mode with Applet Port Requirements](ProxyModeAppletPorts "Proxy Mode with Applet Port Requirements") topic for firewall rule information.
