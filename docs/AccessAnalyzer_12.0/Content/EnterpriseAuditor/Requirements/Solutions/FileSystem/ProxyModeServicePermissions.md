...
See the [Proxy Mode as a Service Port Requirements](ProxyModeServicePorts "Proxy Mode as a Service with RPC Port Requirements") topic for firewall rule information.