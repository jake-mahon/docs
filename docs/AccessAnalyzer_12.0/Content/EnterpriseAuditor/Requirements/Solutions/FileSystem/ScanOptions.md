...
![Illustrates the Enterprise Auditor server running the scan against a file server](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Requirements/FileSystem/LocalMode.png "Illustrates the Enterprise Auditor server running the scan against a file server")

The diagram illustrates the Access Analyzer server running the scan against a file server.

See the following topics for additional information:

* [Local Mode Permissions](LocalModePermissions "Local Mode Permissions")
* [Local Mode Port Requirements](LocalModePorts "Local Mode Port Requirements")
...
![Illustrates the Enterprise Auditor server sending an FSAA applet to a targeted Windows file server, which runs the scan against locally, and then returns data to the Enterprise Auditor server](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Requirements/FileSystem/AppletMode.png "Illustrates the Enterprise Auditor server sending an FSAA applet to a targeted Windows file server, which runs the scan against locally, and then returns data to the Enterprise Auditor server")
...
* [Applet Mode Permissions](AppletModePermissions "Applet Mode Permissions")
* [Applet Mode Port Requirements](AppletModePorts "Applet Mode Port Requirements")
...
![Diagram of Enterprise Auditor server sending an FSAA applet to a proxy server](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Requirements/FileSystem/ProxyModeWithApplet.png "Diagram of Enterprise Auditor server sending an FSAA applet to a proxy server")
...
* [Proxy Mode Server Requirements](ProxyModeServer "Proxy Mode Server Requirements")
* [Proxy Mode with Applet Permissions](ProxyModeAppletPermissions "Proxy Mode with Applet Permissions")
* [Proxy Mode with Applet Port Requirements](ProxyModeAppletPorts "Proxy Mode with Applet Port Requirements")
...
![Diagram of Enterprise Auditor server communicating securely with the proxy service on a proxy server](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Requirements/FileSystem/ProxyModeAsServiceWithSecureRPC.png "Diagram of Enterprise Auditor server communicating securely with the proxy service on a proxy server")
...
* [Proxy Mode Server Requirements](ProxyModeServer "Proxy Mode Server Requirements")
* [Proxy Mode as a Service Permissions](ProxyModeServicePermissions "Proxy Mode as a Service Permissions")
* [Proxy Mode as a Service Port Requirements](ProxyModeServicePorts "Proxy Mode as a Service Port Requirements")