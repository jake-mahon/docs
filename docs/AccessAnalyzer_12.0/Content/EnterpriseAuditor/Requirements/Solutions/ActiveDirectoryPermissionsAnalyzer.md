...
See the [Domain Target Requirements, Permissions, and Ports](../Target/ActiveDirectoryPermissionsAnalyzer "Domain Target Requirements, Permissions, and Ports") topic for target environment requirements.
