...
**NOTE:** Sensitive Data Discovery is available with the EWSMailbox, EWSPublicFolder, and ExchangeMailbox data collectors.
...
* [Exchange Mail-Flow Permissions](MailFlow "Exchange Mail-Flow Permissions")

  * ExchangeMetrics Data Collector
  * 1. HUB Metrics Job Group
* [Exchange Remote Connections Permissions](RemoteConnections "Exchange Remote Connections Permissions")

  * SMARTLog Data Collector
  * 2. CAS Metrics Job Group
* [Exchange PowerShell Permissions](PowerShell "Exchange PowerShell Permissions")
...
* [Exchange Web Services API Permissions](WebServicesAPI "Exchange Web Services API Permissions")

  * EWSMailbox Data Collector
  * EWSPublicFolder Data Collector
  * 7. Sensitive Data Job Group
* [MAPI-Based Data Collector Permissions](MAPI "MAPI-Based Data Collector Permissions")
...
**NOTE:** All MAPI-based data collectors require the **Settings** > **Exchange** node configured in the Access Analyzer Console.