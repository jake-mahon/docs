...
* Permissions required by the ExchangePS Data Collector. See the [Exchange PowerShell Permissions](PowerShell "Navigates to the Exchange PowerShell Permissions section") topic for additional information.
