...
https://app0190.train90.local:8082
  ```
* As the Reply URL, enter `https://:/federation`, for example:
...
![Claims configured](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Install/SSO/EntraIDSSOClaims.png "Claims configured")
...
*Remember,* Enabling Entra ID SSO requires SSL to already have been enabled for the web server. See the [Securing the Web Console](Secure "Securing the Web Console") topic for additional information.
...
![Parameters in the web server config file](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Install/Reports/WebServerExeConfigFileEntraSSO.png "Parameters in the web server config file")

**Step 2 –** Locate the **WsFederationMetaData**, **WsFederationRealm**, and **WsFederationReply** Parameters in the config file, and add the required values from your Microsoft Entra ID application:
