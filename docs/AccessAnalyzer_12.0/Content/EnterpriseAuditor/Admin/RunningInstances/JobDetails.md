...
![Current tab](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/RunningInstances/JobDetailsCurrent.png "Current tab")
...
![History tab](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/RunningInstances/JobDetailsHistory.png "History tab")
...
![Custom Filter window](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/RunningInstances/JobDetailsHistoryCustomFilter.png "Custom Filter window")

If you select Custom, you can create a complex filter. See the [Custom Filter](../Navigate/DataGrid#_Custom_Filter "Custom Filter") topic for additional information.

## Queued Jobs Tab

The Queued Jobs tab displays a list of jobs in queue and the order in which they are executed.

![Queued Jobs tab](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/RunningInstances/JobDetailsQueuedJobs.png "Queued Jobs tab")
...
The **Move Up**, **Move Down**, and **Remove** buttons are for changing the order or removing a job from the queue.