...
![FS_MigrateSchema job in the Jobs tree](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Jobs/InstantJobs/FSMigrateSchema/JobsTree.png "FS_MigrateSchema job in the Jobs tree")
...
Navigate to the **Jobs** > **FS\_MigrateSchema** > **Configure** node and select **Analysis** to view the analysis tasks.

**CAUTION:** Do not modify or deselect the selected analysis tasks. The analysis tasks are preconfigured for this job.

![Default Analysis tasks for the job](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Jobs/InstantJobs/FSMigrateSchema/AnalysisTasks.png "Default Analysis tasks for the job")
