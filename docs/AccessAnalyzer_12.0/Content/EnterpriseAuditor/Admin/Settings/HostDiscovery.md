...
![Host Discovery page](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Settings/HostDiscovery.png "Host Discovery page")

In the Host Discovery Options section at the top is a checkbox for the **Perform the first inventory right away for newly discovered hosts** option. This option is selected by default.
...
![Log level options](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Settings/HostDiscoveryLogLevels.png "Log level options")
...
* Debug – Records everything that happens during the host discovery process, most verbose level of logging
  ...
  * Helps [Netwrix Support](https://www.netwrix.com/support.html "Netwrix Support") to assist in diagnosing issues which may be causing host inventories to fail
...
* Error – Records all errors which occur during the host discovery process
  ...
  ***RECOMMENDED:*** Set the Log Level to Error. The default setting is Info, but it is recommended that the setting for daily use be set to Error. The other log levels are designed to assist with troubleshooting host discovery and host inventory issues.
...
![Host Discovery Log under Host Discovery node](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Settings/HostDiscoveryLog.png "Host Discovery Log under Host Discovery node")
