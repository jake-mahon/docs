...
![Search Methods - Data Grid](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality.png "Search Methods - Data Grid")

The different grouping, filtering, and search methods in the Data Grid are:

* [Data Grid Right-Click Menu](#_Data_Grid_Right-Click_1 "Navigates to the Data Grid Right-Click Menu section")
* [Sort](#Sort "Navigates to the Sort section")
* [Group By](#GroupBy "Navigates to the Group By section")
* [Filter](#Filter "Navigates to the Filter section")
...
![Data Grid Functionality](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality1.png "Data Grid Functionality")
...
* Footer – Provides a data grid summation row at the bottom of the data grid (see the [Footer](#Footer "Navigates to the Footer section") section)
* Group Footers – Provides a data grid summation row at the bottom of each group (see the [Footer](#Footer "Navigates to the Footer section") section)
* Remove This Column – Removes selected column from the data grid
* Field Chooser – Opens the Customization window (see the [Customization Window](#Customization_Window "Navigates to the Customization Window section") section)
...
![Customization Window](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality2.png "Customization Window")

To open the Customization window, select Field Chooser from the column header right-click menu.

![Customization Window](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality3.png "Customization Window")
...
![Footer Option](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality4.png "Footer Option")

To enable the footer, right-click in a column header and select Footer from the right-click menu.

![Footer display](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality5.png "Footer display")
...
![Footer options](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality6.png "Footer options")
...
![Sort Order](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality7.png "Sort Order")
...
| Default Group By View | Organized by Column Header |
| --- | --- |
...
![Expand Group View](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality10.png "Expand Group View")

Multiple columns can be dragged into the Group By area to form tiered groupings.

**NOTE:** Sorting by the FQDN column is an easy way to see if there are two entries for the same host.

![Column Header](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality11.png "Column Header")
...
Drag the column header(s) back to the table to remove the grouping or use the Clear Sort option in the [Data Grid Right-Click Menu](#_Data_Grid_Right-Click_1 "Navigates to the Data Grid Right-Click Menu section"). Additionally, the sort will clear when the user navigates to another place in the console.
...
![Filter](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality12.png "Filter")
...
* [Custom Filter](#_Custom_Filter "Navigates to the Custom Filter section") – Click Custom Filter in the header dropdown to open the Custom Filter window
* [Filtration Dialog](#_Filtration_Dialog "Navigates to the Filtration Dialog section") – Click the Magnifying Glass icon in the Filtration Dialog to select a specific filter

### Custom Filter

The Custom option opens a Custom Filter builder for the selected column.

![Custom Filter](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality13.png "Custom Filter")
...
**Step 1 –** Click the dropdown arrow in the column header for the column where the Custom Filter is going to be applied and select (Custom…) from the list. The Custom Filter window opens.

![Creating a Custom Filter](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality14.png "Creating a Custom Filter")

**Step 2 –** Set the desired criteria for the custom filter. Select the logical operator from the drop-down menu on the left and set the criteria in the textbox on the right.

**Step 3 –** Select either AND/OR and set the second criteria field, following the same method as Step 2.

**Step 4 –** Click OK to confirm changes. The custom filter criteria is now applied to the Data Grid.
...
![Filtration Dialog](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality16.png "Filtration Dialog")
...
![Advanced Search](../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Navigate/DataGridFunctionality17.png "Advanced Search")
