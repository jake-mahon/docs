...
![Edit Rules window Applies To tab](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Analysis/BusinessRules/AppliesTo.png "Edit Rules window Applies To tab")
...
* Hosts Filtering – Specify source hosts
  ...
  * Host List – Select any desired hosts to query. If **Apply to All Hosts** is selected, the list is unavailable.