...
![ServiceNow Action Module wizard Description page](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Action/ServiceNow/Description.png "ServiceNow Action Module wizard Description page")
...
* Insert Field – Use the drop-down menu to select a field (column) from the source table
  ...
  * Click the file icon with the magnifying glass to preview the sourced table for values. The default is 1000 rows.
    ...
    ![Sample Source Data window](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Action/ServiceNow/SampleSourceData.png "Sample Source Data window")

* Click the **Clear Template** button to remove content from the Short Description section and Comments section
...
* Load from Template – Displays preconfigured Short Description and Comments section by name of template
  ...
  * Click the **Save to Template** link to preserve the Short Description and Comments sections for later use under a template name.

    ![Save ServiceNow Template window](../../../../../../../static/images/AccessAnalyzer_12.0/Content/Resources/Images/EnterpriseAuditor/Admin/Action/ServiceNow/SaveTemplate.png "Save ServiceNow Template window")
