...
| SA\_AzureADInventory\_Exceptions | Contains information about security issues and concerns  See the [AzureADInventory Exception Types Translated](#Entra "AzureADInventory Exception Types Translated") section for an explanation of Exception Types |
| SA\_AzureADInventory\_ExceptionTypes | Contains more detailed information about each security issues and concerns  See the [AzureADInventory Exception Types Translated](#Entra "AzureADInventory Exception Types Translated") section for an explanation of Exception Types |
