...
The custom host list only needs to include a single NIS server in the targeted NIS domain. Follow the steps in the [Add Hosts](../../HostManagement/Actions/Add "Add Hosts") topic for instructions on how to create a custom static host list.

See the [Recommended Configuration for the .NIS Inventory Solution](../../../Solutions/NISInventory/Recommended "Recommended Configuration for the .NIS Inventory Solution") topic for information on where to assign the Connection Profile and host list.