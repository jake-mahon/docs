...
[Endpoint Policy ManagerCloud: How to deploy Microsoft Group Policy Settings using Endpoint Policy Manager Cloud](/docs/endpointpolicymanager/resources/video-tutorials/cloud/deploy/grouppolicysettings.md) topic
