...
![helper1](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/helper1.webp)
...
![helper2](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/helper2.webp)
...
![helper3](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/helper3.webp)

**Step 2 –** On the Select Disk Devices window, right-click to automatically copy the detail to the
buffer for later pasting.

![helper4](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/helper4.webp)
...
![helper5](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/helper5.webp)
