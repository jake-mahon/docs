...
- [2 Minute Quick Overview for Managers](/docs/endpointpolicymanager/video/gpocompilancereporter/overviewmanager.md)
- [7 Minute Technical Overview for IT Pros](/docs/endpointpolicymanager/video/gpocompilancereporter/overviewtechnical.md)
- [Standalone Mode](/docs/endpointpolicymanager/video/gpocompilancereporter/modestandalone.md)
- [Server Mode](/docs/endpointpolicymanager/video/gpocompilancereporter/modeserver.md)
...
- [Endpoint Policy Manager GP Compliance Reporter: Using an Existing GPO as a test](/docs/endpointpolicymanager/video/gpocompilancereporter/existinggpos.md)
- [Take existing GPOs and quickly bring them into PPGPCR (and keep them updated)](/docs/endpointpolicymanager/video/gpocompilancereporter/importgpos.md)
