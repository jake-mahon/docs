...
- [Integration with Group Policy (Basics: Installation, Backup, Restore and Reporting !)](/docs/endpointpolicymanager/video/grouppolicy/integration.md)

## Tips and Tricks

- [Manual editing Item Level Targeting to affect local Admins and other local accounts](/docs/endpointpolicymanager/video/grouppolicy/itemleveltargeting/editmanual.md)
...
- [Expand Modular View of Endpoint Policy Manager Components in the GPMC back to the Flat Legacy View](/docs/endpointpolicymanager/video/grouppolicy/flatlegacyview.md)
- [Trim the MMC console for OU admins](/docs/endpointpolicymanager/video/grouppolicy/mmcconsole.md)
- [Prevent a Remote Desktop Connection Drop During GP Update](/docs/endpointpolicymanager/video/troubleshooting/grouppolicy/remotedesktopconnection.md)
