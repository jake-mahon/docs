...
[Endpoint Policy Manager Cloud + Azure AD: Better Together for Computer ILT and Computer Policy Targeting](/docs/endpointpolicymanager/resources/video-tutorials/cloud/integration/entraid.md).
