...
![web_interface_and_controls_85_624x118](/img/product_docs/endpointpolicymanager/endpointpolicymanager/cloud/interface/companydetails/companyadministrators/web_interface_and_controls_85_624x118.webp)
...
- Authentication Options Admin: An admin with this role can specify which admins can have which 2FA
  ...
  [Edit Customer-Level Portal Policies](/docs/endpointpolicymanager/cloud-and-remote-management/cloud-management/interface/companydetails/editcustomerlevelportalpolicies.md) section.
...
- Notification & Logging Options Admin: An admin with this role can use the **Notifications Editor**
  ...
  [Edit Notification Configuration](/docs/endpointpolicymanager/cloud-and-remote-management/cloud-management/interface/companydetails/editnotificationconfiguration.md) section).
