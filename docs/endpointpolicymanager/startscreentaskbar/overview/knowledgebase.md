...
- [When does Endpoint Policy Manager Start Screen & Taskbar Manager work on Server 2019, 2016, 2012 R2?](/docs/endpointpolicymanager/requirements/support/startscreentaskbar/windowserver.md)
...
- [Does Endpoint Policy Manager Start Screen Manager support pinning application icons in Windows Start Screen or Taskbar from a network location, i.e. Mapped Drives or UNC Paths?](/docs/endpointpolicymanager/requirements/support/startscreentaskbar/mappeddrives.md)
