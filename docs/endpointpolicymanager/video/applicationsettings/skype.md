...
![50_1_manage-lync-with-group-policy-fig1](/img/product_docs/endpointpolicymanager/endpointpolicymanager/video/applicationsettings/50_1_manage-lync-with-group-policy-fig1.webp)

You can dictate the Inactive and Away times for the Lync Client, like what is seen here.

![50_2_manage-lync-with-group-policy-fig2](/img/product_docs/endpointpolicymanager/endpointpolicymanager/video/applicationsettings/50_2_manage-lync-with-group-policy-fig2.webp)
...
![50_3_manage-lync-with-group-policy-fig3](/img/product_docs/endpointpolicymanager/endpointpolicymanager/video/applicationsettings/50_3_manage-lync-with-group-policy-fig3.webp)
