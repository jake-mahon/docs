---
title: Exclude Processes via ADMX
sidebar_label: Exclude ADMX
description: Learn to use ADMX settings to specify which processes Endpoint Policy Manager should exclude, including antivirus and other system software configurations.
---
