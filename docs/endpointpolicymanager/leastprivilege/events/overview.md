...
**NOTE:** See the [Events](/docs/endpointpolicymanager/resources/video-tutorials/leastprivilege/events.md) video for a demo of the Endpoint
...
**NOTE:** See the
[Use Discovery to know what rules to make as you transition from Local Admin rights](/docs/endpointpolicymanager/resources/video-tutorials/leastprivilege/discovery.md)
...
- You can use Endpoint Policy Manager Cloud to store Endpoint Policy ManagerLeast Privilege Manager
  ...
  [Endpoint Policy Manager Cloud + PPLPM + Events: Collect Events in the Cloud](/docs/endpointpolicymanager/resources/video-tutorials/leastprivilege/cloudevents.md)video
