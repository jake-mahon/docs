...
**NOTE:** See the [Using Email / Long Codes](/docs/endpointpolicymanager/resources/video-tutorials/leastprivilege/longcodes.md) video for
using email for Admin Approval.
...
- Open the message in Notepad instead - Instead of opening an email, it will open in Notepad. This
  ...
  [Endpoint Privilege Manager: Admin Approval Email method (with Notepad instead)](/docs/endpointpolicymanager/resources/video-tutorials/leastprivilege/adminapproval/email.md)
