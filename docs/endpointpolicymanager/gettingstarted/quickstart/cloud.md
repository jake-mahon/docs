...
[Endpoint Policy Manager Cloud: QuickStart](/docs/endpointpolicymanager/resources/video-tutorials/cloud/quickstart.md) video .
...
See the [How to create a DC for editing purposes](/docs/endpointpolicymanager/resources/video-tutorials/cloud/testlab/createdc.md) video for
...
[Endpoint Policy ManagerCloud: How to deploy Microsoft Group Policy Settings using Endpoint Policy Manager Cloud](/docs/endpointpolicymanager/resources/video-tutorials/cloud/deploy/grouppolicysettings.md)video.
