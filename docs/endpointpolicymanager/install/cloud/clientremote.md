...
[Install the PP Cloud client with a PP Least Priv Manager Rule](/docs/endpointpolicymanager/resources/video-tutorials/cloud/install/leastprivilegemanagerrule.md)
