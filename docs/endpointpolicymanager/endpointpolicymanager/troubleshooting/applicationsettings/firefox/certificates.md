...
[Firefox: What versions of the Endpoint Policy Manager CSE support managing certificates in what versions of Firefox?](/docs/endpointpolicymanager/endpointpolicymanager/requirements/support/applicationsettings/firefox/version.md)
