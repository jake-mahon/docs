...
- Authentication Options Admin: An admin with this role can specify which admins can have which 2FA
  ...
  [Edit Customer-Level Portal Policies](/docs/endpointpolicymanager/endpointpolicymanager/cloud/interface/companydetails/editcustomerlevelportalpolicies.md) section.
...
- Notification & Logging Options Admin: An admin with this role can use the **Notifications Editor**
  ...
  [Edit Notification Configuration](/docs/endpointpolicymanager/endpointpolicymanager/cloud/interface/companydetails/editnotificationconfiguration.md) section).
