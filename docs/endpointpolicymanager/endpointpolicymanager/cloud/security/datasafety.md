...
- Events (if the Endpoint Policy Manager Cloud Event Log Collector is turned on for your tenant.)
  ...
  can be seen
  at[Endpoint Policy Manager Cloud + PPLPM + Events: Collect Events in the Cloud](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/cloudevents.md)
