...
[AppSets: What is the official support policy for the pre-configured AppSets?](/docs/endpointpolicymanager/endpointpolicymanager/troubleshooting/applicationsettings/supportpolicy.md)
