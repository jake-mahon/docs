...
See the
[How can I roll out the latest Endpoint Policy Manager CSE with Active Directory in a controlled manner using Rings ?](/docs/endpointpolicymanager/endpointpolicymanager/install/ringsupgrade.md) topic
for additional information.
...
See the
[How do I use Endpoint Policy Manager Remote Work Delivery Manager to update the Client Side Extension?](/docs/endpointpolicymanager/endpointpolicymanager/remoteworkdelivery/updateclientsideextension.md)
and
[Using Remote Work Delivery Manager to Update the Endpoint Policy Manager Client Side Extension](/docs/endpointpolicymanager/endpointpolicymanager/video/remoteworkdelivery/updateclientsideextension.md) topics
for additional information.
