...
[Mass Deploy the Endpoint Policy Manager CSE using GPSI](/docs/endpointpolicymanager/endpointpolicymanager/archive/massdeploy.md) and
[Upgrading the CSE using GPSI](/docs/endpointpolicymanager/endpointpolicymanager/archive/upgrading.md). In this example, we've created a GPO named
Deploy PP Client and linked it to East Sales Desktops.

![Deploying Client Side](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_350x474.webp)
...
![deploying_the_client_side_1_620x359](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_1_620x359.webp)
...
![deploying_the_client_side_2_620x389](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_2_620x389.webp)

![deploying_the_client_side_3_550x381](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_3_550x381.webp)

When you're done, the GPO should look like this:.

![deploying_the_client_side_4_1200x309](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_4_1200x309.webp)

**Step 7 –** Repeat this process until both the x86 and x64 MSIs appear.

![deploying_the_client_side_5_1200x240](/img/product_docs/endpointpolicymanager/endpointpolicymanager/install/deploying_the_client_side_5_1200x240.webp)
...
[Upgrading the CSE using GPSI](/docs/endpointpolicymanager/endpointpolicymanager/archive/upgrading.md) topic for additional information.
