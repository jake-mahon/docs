...
[Endpoint Policy Manager and Microsoft Intune](/docs/endpointpolicymanager/endpointpolicymanager/video/mdm/microsoftintune.md). The installation
steps are below.
...
[How to create a DC for editing purposes](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/testlab/createdc.md) video for details
and how to do this.
...
Follow the [Endpoint Policy Manager and MDM walk before you run](/docs/endpointpolicymanager/endpointpolicymanager/video/mdm/testsample.md)
