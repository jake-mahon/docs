...
In
[Using Item-Level Targeting with Collections and Policies](/docs/endpointpolicymanager/endpointpolicymanager/remotedesktopprotocol/itemleveltargeting/overview.md)
