...
- Optionally, if you don't want to use Group Policy, read the section in Appendix A:
  [Using Endpoint Policy Manager with MDM and UEM Tools](/docs/endpointpolicymanager/endpointpolicymanager/mdm/uemtools.md) on Group Policy and
...
![about_policypak_gpo_export](/img/product_docs/endpointpolicymanager/endpointpolicymanager/preferences/about_endpointpolicymanager_gpo_export.webp)
...
- In conjunction with the Endpoint Policy Manager Cloud service, or your own mobile device
  ...
  [Setup, Download, Install, and Verify](/docs/endpointpolicymanager/endpointpolicymanager/cloud/quickstart.md) and User Guide. For more
...
**NOTE:** See
[Which settings can be managed with the Preferences Manager component?](/docs/endpointpolicymanager/endpointpolicymanager/preferences/settings.md)for additional
...
![about_policypak_gpo_export_1](/img/product_docs/endpointpolicymanager/endpointpolicymanager/preferences/about_endpointpolicymanager_gpo_export_1.webp)
