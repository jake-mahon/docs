...
![appx_policies_and_settings_8](/img/product_docs/endpointpolicymanager/endpointpolicymanager/softwarepackage/appx/appx_policies_and_settings_8.webp)

Then on the endpoint run GPUpdate to acquire the policy change. You should see Skype go from present
to removed.

![appx_policies_and_settings_9](/img/product_docs/endpointpolicymanager/endpointpolicymanager/softwarepackage/appx/appx_policies_and_settings_9.webp)

![appx_policies_and_settings_10](/img/product_docs/endpointpolicymanager/endpointpolicymanager/softwarepackage/appx/appx_policies_and_settings_10.webp)
