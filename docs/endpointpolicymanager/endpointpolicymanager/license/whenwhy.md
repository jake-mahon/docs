...
1. You can use Netwrix Endpoint Policy Manager (formerly PolicyPak) Admin Templates Manager to
   ...
   [Reduce GPOs (and/or export them for use with Endpoint Policy Manager Cloud or with MDM)](/docs/endpointpolicymanager/endpointpolicymanager/video/administrativetemplates/reducegpos.md)
...
3. You can use Endpoint Policy Manager Least Privilege Manager to block items that admins shouldn't
   ...
   applications: [Endpoint Policy Manager Application Control with PP Least Privilege Manager](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/applicationcontrol.md)
4. You can use Endpoint Policy Manager Least Privilege Manager to reduce service account rights:
   [Reduce or specify Service Account Rights](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/bestpractices/serviceaccountrights.md)
5. You can use Endpoint Policy Manager Least Privilege Manager to block PowerShell except for where
   absolutely needed:
   [Block PowerShell in General, Open up for specific items](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/bestpractices/powershellblock.md)
6. You can use Endpoint Policy Manager Least Privilege Manager to reduce the admin rights on
   ...
   others:[Can I use Endpoint Privilege Manager to LOWER / remove admin rights from Administrators from an application or process, like Internet Explorer?](/docs/endpointpolicymanager/endpointpolicymanager/leastprivilege/reduceadminrights.md)
