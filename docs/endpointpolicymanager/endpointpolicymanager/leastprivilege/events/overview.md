...
**NOTE:** See the [Events](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/events.md) video for a demo of the Endpoint
...
**NOTE:** See the
[Use Discovery to know what rules to make as you transition from Local Admin rights](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/discovery.md)
...
- You can also use Netwrix Auditor to capture events from endpoints to bring them to a centralized
  ...
  [How to use Netwrix Auditor to Report on Endpoint Policy Manager events](/docs/endpointpolicymanager/endpointpolicymanager/integration/auditor/reports.md)
...
- You can use Endpoint Policy Manager Cloud to store Endpoint Policy ManagerLeast Privilege Manager
  ...
  [Endpoint Policy Manager Cloud + PPLPM + Events: Collect Events in the Cloud](/docs/endpointpolicymanager/endpointpolicymanager/video/leastprivilege/cloudevents.md)video
