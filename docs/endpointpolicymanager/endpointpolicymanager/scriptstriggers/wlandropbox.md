...
![658_1_img-1](/img/product_docs/endpointpolicymanager/endpointpolicymanager/scriptstriggers/497_1_img-1.webp)

**Step 5 –** At the "Specify policy target screen be sure to use switched mode for the policy.

![658_2_img-2](/img/product_docs/endpointpolicymanager/endpointpolicymanager/scriptstriggers/497_2_img-2.webp)
...
![658_3_img-3_950x601](/img/product_docs/endpointpolicymanager/endpointpolicymanager/scriptstriggers/658_3_img-3_950x601.webp)

**Step 8 –** For the "Policy process mode configuration" screen specify "Once or when forced", then
click save.

![658_4_img-4](/img/product_docs/endpointpolicymanager/endpointpolicymanager/scriptstriggers/658_4_img-4.webp)
