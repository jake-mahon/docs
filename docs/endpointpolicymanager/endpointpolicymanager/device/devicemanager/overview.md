...
[MDM & UEM Tools](/docs/endpointpolicymanager/endpointpolicymanager/mdm/overview.md) topic to deploy directives for additional information.

**NOTE:** For an overview of Endpoint Policy Manager Device Manager see the
[Video Learning Center](/docs/endpointpolicymanager/endpointpolicymanager/device/overview/videolearningcenter.md) topic for additional information.
...
[Instantly Put the smackdown on USB sticks and CD-ROMs](/docs/endpointpolicymanager/endpointpolicymanager/video/device/usbdrive.md) topic for
...
- Microsoft Intune — See the
  [Block and Allow USB and CD-ROMs with your MDM solution](/docs/endpointpolicymanager/endpointpolicymanager/video/device/mdm.md) video overview
  for additional information

- PolicyPak Cloud service — See the
  [Block USB sticks using Endpoint Policy Manager Cloud](/docs/endpointpolicymanager/endpointpolicymanager/video/device/cloud.md) topic for
  additional information
...
![ppcloud](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/ppcloud.webp)
...
The [MDM & UEM Tools](/docs/endpointpolicymanager/endpointpolicymanager/mdm/overview.md) topic explains how to use the Endpoint Policy Manager
...
![device01](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/device01.webp)

The same may be performed using and MDM service like Intune using similar settings.

![device02](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/device02.webp)

The result will be the same where Removable Devices will be stopped.

![device03](/img/product_docs/endpointpolicymanager/endpointpolicymanager/device/devicemanager/device03.webp)
