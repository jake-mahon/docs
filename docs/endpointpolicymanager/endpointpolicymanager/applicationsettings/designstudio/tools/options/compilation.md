...
where they are compiled. You can see the Compilation tab in Figure 166. The default path for saved
...
![using_designstudio_tools_2](/img/product_docs/endpointpolicymanager/endpointpolicymanager/applicationsettings/designstudio/tools/options/using_designstudio_tools_2.webp)
