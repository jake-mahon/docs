...
![getting_started_right_away](/img/product_docs/endpointpolicymanager/endpointpolicymanager/getting_started_right_away.webp)
...
![getting_started_right_away_1](/img/product_docs/endpointpolicymanager/endpointpolicymanager/getting_started_right_away_1.webp)
...
link:[How to install UNIVERSAL licenses for NEW Customers (via GPO, SCCM or MDM)](/docs/endpointpolicymanager/endpointpolicymanager/video/license/installuniversal.md).
...
quick overview: [Endpoint Policy Manager Cloud: QuickStart](/docs/endpointpolicymanager/endpointpolicymanager/video/cloud/quickstart.md).
...
- For video overviews of using Endpoint Policy Manager with an MDM service see: Getting Started with
  MDM > [Video Learning Center](/docs/endpointpolicymanager/endpointpolicymanager/mdm/overview/videolearningcenter.md).
- For video overviews of using Endpoint Policy Manager with a UEM tool like SCCM see: Getting
  ...
  [Knowledge Base](/docs/endpointpolicymanager/endpointpolicymanager/gettingstarted/overview/knowledgebase.md).
