...
In
[Using Item-Level Targeting with Collections and Policies](/docs/endpointpolicymanager/device-and-desktop-management/remote-desktop-protocol/itemleveltargeting/overview.md)
