...
![macfinder01](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder01.webp)

Standard Users also get similar behavior if they attempt to remove an application from the machine.

![macfinder02](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder02.webp)
...
![macfinder03](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder03.webp)
...
![macfinder04](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder04.webp)

This first example policy will allow users to add/remove applications to the `/Applications` folder.

![macfinder05](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder05.webp)
...
![macfinder06](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder06.webp)
...
![macfinder07](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder07.webp)

An example of the results for the first policy which enabled installation are seen below.

![macfinder08](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder08.webp)

And copying a file to `/Users/Test` also succeeds:

![macfinder09](/img/product_docs/endpointpolicymanager/mac/scenarios/macfinder09.webp)
