...
![web_interface_and_controls_104_624x249](/img/product_docs/endpointpolicymanager/cloud/interface/companydetails/web_interface_and_controls_104_624x249.webp)

Next, you are prompted to activate the configuration by entering in your Azure AD credentials.

![web_interface_and_controls_105_623x376](/img/product_docs/endpointpolicymanager/cloud/interface/companydetails/web_interface_and_controls_105_623x376.webp)

After you do this, the connection is complete and successful.

![web_interface_and_controls_106_623x252](/img/product_docs/endpointpolicymanager/cloud/interface/companydetails/web_interface_and_controls_106_623x252.webp)

The results are that Item-Level Targeting evaluations can now be performed directly on specific
users in Azure AD.

![web_interface_and_controls_107_623x361](/img/product_docs/endpointpolicymanager/cloud/interface/companydetails/web_interface_and_controls_107_623x361.webp)
