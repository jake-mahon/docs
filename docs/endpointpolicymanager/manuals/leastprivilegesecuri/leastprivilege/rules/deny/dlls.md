...
[How to Defend against malicious PowerShell attacks (DLLs)?](/docs/endpointpolicymanager/knowledgebase/leastprivilegemanage/knowledgebase/tipsforadminapproval/maliciousattacks.md)
topic.
