...
**NOTE:** See the [Events](/docs/endpointpolicymanager/video/leastprivilege/events.md) video for a demo of the Endpoint
...
- You can also use Netwrix Auditor to capture events from endpoints to bring them to a centralized
  ...
  [How to use Netwrix Auditor to Report on Endpoint Policy Manager events](/docs/endpointpolicymanager/knowledgebase/leastprivilegemanage/knowledgebase/eventing/reports.md)
...
- You can use Endpoint Policy Manager Cloud to store Endpoint Policy ManagerLeast Privilege Manager
  ...
  [Endpoint Policy Manager Cloud + PPLPM + Events: Collect Events in the Cloud](/docs/endpointpolicymanager/video/leastprivilege/cloudevents.md)video
