...
![about_policypak_browser_router_42](/img/product_docs/endpointpolicymanager/endpointpolicymanager/browserrouter/about_endpointpolicymanager_browser_router_42.webp)

Within any collection, each policy is processed in numerical order from lowest to highest.

![about_policypak_browser_router_43](/img/product_docs/endpointpolicymanager/endpointpolicymanager/browserrouter/about_endpointpolicymanager_browser_router_43.webp)
