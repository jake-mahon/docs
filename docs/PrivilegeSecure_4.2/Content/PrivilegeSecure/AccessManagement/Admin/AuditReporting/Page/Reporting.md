...
![Reports Tree](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/AuditReporting/Reporting/ReportsTree.png "Reports Tree")
...
![Reporting Filters Tab](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/AuditReporting/Reporting/FiltersTab.png "Reporting Filters Tab")
...
* Source Drop-down List – Contains data sources that allow the report to look at different data sets related to Privilege Secure administration. See the [Data Sources](#Data "Data Sources") topic for additional information.
...
**NOTE:** The Subscriptions tab will not be enabled until saving the report. See the [Subscriptions Tab](#Subscrip "Subscriptions Tab") topic for additional information.
...
* Download Report – Generates and downloads the report, either as PDF or as CSV. The file name of the downloaded report will indicate the name of the report and the time of download. For example, "All Linux Sessions-24-05-07-164307".
...
![Reporting Subscriptions Tab](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/AuditReporting/Reporting/SubscriptionsTab.png "Reporting Subscriptions Tab")

The report will be emailed to the Email value for the user, which is populated based on Active Directory attributes and can be confirmed for a given user by checking the Users and Groups page. If a new custom schedule is needed for a Subscription, one can be created under the **Policy** > **Platforms** > **Schedule Policies** menu. All Schedule Policies will show up in the list when you Subscribe to a report. See the [Schedule Policies Page](../../Policy/Page/SchedulePolicies "Schedule Policies Page") topic for additional information.
