...
**NOTE:** For managed accounts, ensure that the account has been rotated at least once since being managed. Otherwise, there will be no vaulted password in the Netwrix Privilege Secure database.

### Configure the Activity Connector

Follow the steps to configure an Activity Connector.

**Step 1 –** In the Netwrix Privilege Secure console, navigate to the **Configuration** menu, and the **Integration Connectors** submenu.
...
![BYOV Connector for Privilege Secure](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVConnectorNPS.png "BYOV Connector for Privilege Secure")

**Step 4 –** Copy and paste the following script into the "Checkout Script Block" field. (The "Checkin Script Block" field may be left blank.)
...
See the [Bring Your Own Vault (BYOV) Integration](IntegrationBYOV) Integration") topic for additional information on configuring a BYOV connector.
...
![Select a User to manage account](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVManageUser.png "Select a User to manage account")

**Step 2 –** Search or scroll to find the user you wish to manage. Once identified, check the box next to the account name.

![Select Manual manage account](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVManualManageAccount.png "Select Manual manage account")
...
See the [Credentials Dashboard](../../Dashboard/Credentials "Credentials Dashboard") topic for additional information on creating a managed account.
...
![Managed User Wrench Icon](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVManageUserWrench.png "Managed User Wrench Icon")

**Step 2 –** Click on the **Wrench** icon to set the password.

![Set password for the credential window](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVSetPassword.png "Set password for the credential window")
...
See the [Manage Internal Service Accounts](../../Policy/Window/Credentials/ManageInternalServiceAccount "Manage Internal Service Accounts") topic for additional information on manually managing an account.
...
![BYOV create an Activity](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVConnectorActivity.png "BYOV create an Activity")
...
See the [Add Activity](../../Policy/Add/Activity "Add Activity") topic for additional information on creating an Activity.
...
![Create a new policy for the BYOV Connector](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVConnectorPolicy.png "Create a new policy for the BYOV Connector")

**Step 2 –** Click the **Plus** icon and create a new Policy. See the [Add Access Policy](../../Policy/Add/AccessPolicy "Add Access Policy") topic for additional information.
...
* Users to the Policy. See the [Users Tab for Resource Based Access Policies](../../Policy/Tab/PolicyResource/Users "Users Tab for Resource Based Access Policies") topic for additional information.
* Activity created for the BYOV Connector. See the [Activities Tab for Resource Based Access Policies](../../Policy/Tab/PolicyResource/Activities "Activities Tab for Resource Based Access Policies") topic for additional information.
* Associated resources intended for this Activity. See the [Resources Tab for Resource Based Access Policies](../../Policy/Tab/PolicyResource/Resources "Resources Tab for Resource Based Access Policies") topic for additional information.

See the [Add Access Policy](../../Policy/Add/AccessPolicy "Add Access Policy") topic for additional information on creating an Access Policy.
...
![My Activities BYOV Connector](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Configuration/Integration/BYOVConnectorMyActivities.png "My Activities BYOV Connector")
