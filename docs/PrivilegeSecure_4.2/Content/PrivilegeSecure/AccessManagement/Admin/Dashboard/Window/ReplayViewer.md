...
When recordings are available for a historical session, the expand icon is enabled on the [Historical Dashboard](../Historical "Historical Dashboard").

![Historical dashboard showing available recordings](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Dashboard/RecordingAvailable.png "Historical dashboard showing available recordings")
...
![Replay Viewer window for an RDP session](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Dashboard/ReplayViewerRDP.png "Replay Viewer window for an RDP session")
...
**NOTE:** When a user enters input into a password prompt during an SSH session, the keystrokes will be obscured in the Replay Viewer.

![](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Dashboard/ReplayViewerSSH.png)
...
![Replay Viewer window for a Website host session](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Dashboard/ReplayViewerWebsite.png "Replay Viewer window for a Website host session")
