...
Follow the steps to add a connection profile to the console. See the [Connection Profiles Page](../Page/ConnectionProfiles "Connection Profiles Page") topic for detailed descriptions of the fields.
...
![Add Connection Profile](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Policy/ConnectionProfile/AddConnectionProfile.png "Add Connection Profile")
...
* **NOTE:** If you want to use more than one proxy server, a load balancer must be used in front of the servers.
...
**Step 5 –** The new connection profile is created. To add an Approval Workflow, see the [Add Approval Workflow](ConnectionProfileApproval#_Add_Approval_Workflow "Jump to the Add Approval Workflow section") topic for additional information.
