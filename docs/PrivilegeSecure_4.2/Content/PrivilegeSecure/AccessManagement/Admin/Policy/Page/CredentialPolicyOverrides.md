...
![Credential Policy Overrides Page](../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Policy/Credentials/CredentialPolicyOverridePage.png "Credential Policy Overrides Page")
...
* Blue + button — Create a new credential group. See the [Add Credential Policy Override](../Add/CredentialPolicyOverrides#top "Add Credential Policy Override") topic for additional information.
...
* Search — Searches the table or list for matches to the search string. When matches are found, the table or list is filtered to the matching results.
* Add Credentials — Opens the Add Credentials window. See the [Add Credentials Window](../Window/Credentials/AddCredentials "Add Credentials Window") topic for additional information.
