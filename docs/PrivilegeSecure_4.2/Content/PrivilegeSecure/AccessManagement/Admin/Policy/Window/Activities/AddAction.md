...
![](../../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Policy/Activities/AddActionWindow.png)
...
See the [Action Types](../../ActivityActionTypes) section for detailed descriptions of the fields.
...
**Step 7 –** If desired, it is possible to automatically run any Protection Policies associated with the resource when the session completes. Simply add the *Invoke Protection Policies* action to the Post-Session group. See the [Protection Policies Page](../../Page/ProtectionPolicies "Protection Policies Page") topic for additional information.
