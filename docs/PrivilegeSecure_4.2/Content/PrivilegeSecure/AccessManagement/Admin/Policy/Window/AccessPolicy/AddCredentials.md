...
The Add Credentials window provides a list of Credentials that have been onboarded. Credentials are onboarded in the [Credentials Page](../../Page/Credentials "Credentials Page").

![Add credentials window](../../../../../../../../../static/images/PrivilegeSecure_4.2/Content/Resources/Images/PrivilegeSecure/AccessManagement/Admin/Policy/AccessPolicies/Window/AddCredentials.png "Add credentials window")
...
**Step 5 –** To add a credential to the access policy, click a row in the Available Credentials table and it is immediately moved to the Credentials to Add table.

**Step 6 –** Click Add to add the credential(s) to the access policy.

The new credential(s) are added to the access policy and are shown in the [Credentials Tab for Credential Based Access Policies](../../Tab/PolicyCredentials/Credentials "Credentials Tab for Credential Based Access Policies").