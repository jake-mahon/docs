...
![scheduler](/img/product_docs/strongpointforsalesforce/clean_up/scheduler.png)2. Toggle __Enabled__/__Disabled__by the category. Your selections are automatically saved.
