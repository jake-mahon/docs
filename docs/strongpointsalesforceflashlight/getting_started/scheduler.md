...
1. Open __Flashlight__ > __Support__ > __Scheduler__
![scheduler](../../../static/img/product_docs/strongpointforsalesforce/clean_up/scheduler.webp)2. Toggle __Enabled__/__Disabled__by the category. Your selections are automatically saved.
