...
Flashlight documents over 120 Salesforce metadata types. For display within the Flashlight application, metadata is organized into eight categories.Open the [Documented Metadata Types](/docs/product_docs/strongpointsalesforceflashlight/documented_metadata_types.md) topic for a complete list of Metadata sorted by Type and by Category.
...
![Metadata Categories](/static/img/product_docs/strongpointsalesforceflashlight/metadata_categories_800x511.png)
