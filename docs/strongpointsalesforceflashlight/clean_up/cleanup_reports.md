...
- __Filters__ ![filters_icon](/img/product_docs/strongpointsalesforceflashlight/clean_up/filters_icon.png): Open the filters to see the criteria used for the report. You can modify the unlocked filters to narrow the focus of the results.
