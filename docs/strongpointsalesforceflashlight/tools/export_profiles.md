...
2. Open the __Profiles and Permission Sets__ tab.  
   ![export_profile_ui_800x685](/img/product_docs/strongpointsalesforceflashlight/tools/export_object_profiles_800x685.png)
...
6. Select the __Settings to be exported__.  
   ![export_profile_ui_settings](/img/product_docs/strongpointforsalesforce/tools/export_profile_ui_settings.png)
...
![export_profile_summary](/img/product_docs/strongpointforsalesforce/tools/export_profile_summary.png)

The __Profile__ tabs contain all of the requested information for each profile. ![export_profile_profile_800x728](/img/product_docs/strongpointsalesforceflashlight/tools/export_profile_profile_800x728.png)
