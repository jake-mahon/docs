...
2. Open the __Profiles and Permission Sets__ tab.  
   ![export_profile_ui_800x685](/static/img/product_docs/strongpointsalesforceflashlight/tools/export_object_profiles_800x685.png)
...
The __Profile__ tabs contain all of the requested information for each profile. ![export_profile_profile_800x728](/static/img/product_docs/strongpointsalesforceflashlight/tools/export_profile_profile_800x728.png)
