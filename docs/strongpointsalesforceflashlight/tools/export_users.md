...
2. Open the __Users__ tab.![export_users_800x397](/img/product_docs/strongpointsalesforceflashlight/tools/export_users_800x397.png)
...
The __Summary__ tab shows who created the export, the creation date and time, and the list of selected users.![export_users_summary_800x252](/img/product_docs/strongpointsalesforceflashlight/tools/export_users_summary_800x252.png)

The __User__ tabs contain all of the requested information for each exported user.![export_users_user_800x675](/img/product_docs/strongpointsalesforceflashlight/tools/export_users_user_800x675.png)
