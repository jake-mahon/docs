...
![statusreport_800x419](/img/product_docs/strongpointsalesforceflashlight/tools/statusreport_800x419.webp)
...
1. Open __Flashlight__> __Tools__ > __Dependency Relationship Diagram__.
...
1. Open __Reports/List Views__ > __Customizations__ > __All Customizations__
...
![custquicksearch_800x200](/img/product_docs/strongpointsalesforceflashlight/tools/custquicksearch_800x200.webp)
