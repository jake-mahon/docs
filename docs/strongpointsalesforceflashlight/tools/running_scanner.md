...
![scanner](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/scanner.png)4. Click __Run Scanner__.
...
![rescan_example_800x289](/static/img/product_docs/strongpointsalesforceflashlight/tools/rescan_example_800x289.png)

![topic](/static/img/product_docs/topic.png)__Next Step:__[Validating the Data ](/docs/product_docs/strongpointsalesforceflashlight/tools/validating_data.md)
