...
selecting the threat from the list on the [Threats Page](../threats.md) and clicking View Details.
...
In the Threat Activity Diagram, click the user to view the [User Details Page](user.md) page. Click
the host to view the [Host Details Page](host.md) page.
