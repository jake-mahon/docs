...
subscription, or export the report. See the [Investigation Options](/docs/threatmanager/3.0/threatmanager/administration/investigations/options/overview.md) topic for
