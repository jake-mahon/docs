...
- Save a new one. See the
  [New Investigation Page](/docs/threatmanager/3.0/operations/investigations/creating-investigations.md) for additional
  information.
...
[Fine Tune a Threat](/docs/threatmanager/3.0/administration/threat-management/threat-configuration.md) topic for additional
information.
...
See the [Threat Details Page](/docs/threatmanager/3.0/operations/threat-details/viewing-threats.md) topic for additional
information.
