...
[Integration with Other Netwrix Products](/docs/threatmanager/3.0/administration/integrations/netwrix-products.md) topic for additional
information.
...
- [Custom Threats](/docs/threatmanager/3.0/reference/threat-types/custom-threats.md)
