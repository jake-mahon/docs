...
![Entra ID User Details Page](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraidpage.webp)
...
![Entra ID User ACtivity Summary Tab](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraidactivitysummarytab.webp)
...
![Entra ID User Activity Summary Tab Activity By Host Table](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraidactivitybyhost.webp)
...
![Entra ID User Activity Summary Tab Activity By Client Table](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraiduseractivitybyclient.webp)
...
![Entra ID User Group Membership page](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraidusergroupmembershiptab.webp)
...
![Entra ID User Roles tab Activity Assignments Page](/img/product_docs/threatmanager/3.0/administration/threatdetails/entraiduserrolesactiveassignment.webp)
