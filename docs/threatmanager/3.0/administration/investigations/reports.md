...
See the [Host Details Page](/docs/threatmanager/3.0/administration/threatdetails/host.md) topic and the
[User Details Page](/docs/threatmanager/3.0/administration/threatdetails/user.md) topic for additional information.
...
Click the link to view target details.See the [Host Details Page](/docs/threatmanager/3.0/administration/threatdetails/host.md) topic
