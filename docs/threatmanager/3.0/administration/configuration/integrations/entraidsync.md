...
![Entra ID Sync Page](/img/product_docs/threatmanager/3.0/administration/configuration/integrations/entraidsync.webp)
...
![Add New Integration window with Entra ID Sync type selected](/img/product_docs/threatmanager/3.0/administration/configuration/integrations/addnewinteg.webp)
...
![Tenant Configuration tab](/img/product_docs/threatmanager/3.0/administration/configuration/integrations/entraidsync_tenantconfiguration.webp)
