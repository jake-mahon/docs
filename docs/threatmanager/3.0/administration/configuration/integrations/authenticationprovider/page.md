...
![Integrations interface on the Authentication Provider page](/img/product_docs/threatmanager/3.0/administration/configuration/integrations/authenticationprovider/page.webp)
...
![Integrations interface displaying the details for an Authentication Provider with the type drop-down menu open](/img/product_docs/threatmanager/3.0/administration/configuration/integrations/authenticationprovider/types.webp)

The following authentication provider types are supported; you can configure an authentication
provider for any of these:

- RADIUS – See the [RADIUS Authentication Provider](/docs/threatmanager/3.0/administration/configuration/integrations/authenticationprovider/radius.md) topic for additional information.
- OpenID – See the [OpenID Authentication Provider](/docs/threatmanager/3.0/administration/configuration/integrations/authenticationprovider/openid.md) topic for additional information.
- SAML – See the [SAML Authentication Provider](/docs/threatmanager/3.0/administration/configuration/integrations/authenticationprovider/saml.md) topic for additional information.
