...
investigation. See the [Entra ID Sync Page](/docs/threatmanager/3.0/administration/integrations/entra-id.md) topic for
additional information.
...
See the [Host Details Page](/docs/threatmanager/3.0/operations/threat-details/object-details.md) topic and the
[User Details Page](/docs/threatmanager/3.0/operations/threat-details/object-details.md) topic for additional information.
...
Click the link to view target details.See the [Host Details Page](/docs/threatmanager/3.0/operations/threat-details/object-details.md) topic
