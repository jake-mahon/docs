...
accordance with the [Requirements](/docs/threatmanager/3.0/installation/requirements/system-requirements.md) topic. Additionally, the monitoring
...
- Click PostgreSQL Setup to install the database. See the
  [Install the PostgreSQL Database Application](/docs/threatmanager/3.0/installation/install-guide/database-setup.md) topic for additional information.
- Run the Threat Manager Setup to install the application. See the
  [Install the Threat Manager Application](/docs/threatmanager/3.0/installation/install-guide/application-setup.md) topic for additional information.
...
- Optional: Install the Action Service on additional servers. See the
  [Optionally Install the Action Service on Additional Servers](/docs/threatmanager/3.0/installation/install-guide/action-service-setup.md) topic for
  additional information.
- Configure a remote Action Service to register with Threat Manager.
- Configure a service account to run actions.

**Step 3 –** Log into the console for the first time. See the [First Launch](/docs/threatmanager/3.0/installation/install-guide/first-launch.md) topic
for additional information.

**Step 4 –** Configure integration with one or more Netwrix products to feed the desired type of
data into Threat Manager:

- [Netwrix Activity Monitor Integration](/docs/threatmanager/3.0/administration/integrations/netwrix-products.md) – Configure Netwrix
  Activity Monitor to send file system data and/or Active Directory data and/or Microsoft Entra ID
  data to Threat Manager
- [Netwrix Threat Prevention Integration](/docs/threatmanager/3.0/threatprevention/threatmanager-configuration.md) – Configure Netwrix
