...
See the [What's New](/docs/threatmanager/3.0/getting-started/whats-new.md) topic for details on new and improved features included with
each release.
...
- [Upgrade Threat Manager from 2.8 to 3.0](/docs/threatmanager/3.0/installation/upgrades/upgrade-to-3-0.md)
- [Upgrade Threat Manager from 2.6/2.7 To 2.8](/docs/threatmanager/3.0/installation/upgrades/upgrade-to-2-8.md)
