...
The Level section displays the threat types which can be selected for filtering. Levels are assigned or configured on the [Threat Detection Page](configuration/threatdetection.md).
...
Threats can also be edited from the [Threat Details Page](threatdetails/overview.md).
