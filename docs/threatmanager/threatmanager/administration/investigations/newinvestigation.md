...
the [Filters Section](options/filters.md) topic for additional information.
...
available from the New Investigation page. See the [Export Report](options/export.md) topic for
