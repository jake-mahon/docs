...
The selected tag is added to the user, group, or computer. See the [Tag Management Page](../configuration/integrations/tagmanagement.md) topic for additional information.
