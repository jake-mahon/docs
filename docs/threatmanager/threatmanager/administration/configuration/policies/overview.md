...
- Host – The host on which the policy was applied. If the host exists in the Threat Manager database, click on the host link to go to the [Host Details Page](../../threatdetails/host.md)
...
The Policies page also provides the ability to click on a policy and view information and configuration options for that policy. See [Policy Configuration](policiesconfiguration.md) for additional information.
...
__NOTE:__ When a Honeytoken name is specified and the policy is enabled, this policy becomes immediately valid for Honeytoken threat detection. Please refer to [Configure Honeytoken Threats](honeytoken.md) for Honeytoken naming best practices.
...
- Name – The name for the policy
  ...
  __NOTE:__ See [Configure Honeytoken Threats](honeytoken.md) for best practices for naming a Honeytoken.
