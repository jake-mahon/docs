...
![threatmanagerserver](../../../../static/img/product_docs/threatmanager/threatmanager/requirements/threatmanagerserver.webp)
...
__NOTE:__ These firewall rules are only needed if using a remote PostgreSQL database. That is not recommended or the default.
