...
![First launch showing fields for setting up the builtin Administrator account](/img/product_docs/threatprevention/threatprevention/install/reportingmodule/builtinadminpassword.png)
...
If the Enable MFA option is set to OFF, no additional configuration is required and the Threat Manager Console opens. See the [Getting Started with Threat Manager](/docs/threatmanager/threatmanager/gettingstarted.md) topic for next steps.
...
![registerauthenticator](/img/product_docs/threatprevention/threatprevention/install/reportingmodule/registerauthenticator.png)
...
Once MFA is configured for this account, the Threat Manager Console opens. See the [Getting Started with Threat Manager](/docs/threatmanager/threatmanager/gettingstarted.md) topic for next steps.
