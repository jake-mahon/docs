...
If the Enable MFA option is set to OFF, no additional configuration is required and the Threat Manager Console opens. See the [Getting Started with Threat Manager](/docs/product_docs/threatmanager/threatmanager/gettingstarted.md) topic for next steps.
...
Once MFA is configured for this account, the Threat Manager Console opens. See the [Getting Started with Threat Manager](/docs/product_docs/threatmanager/threatmanager/gettingstarted.md) topic for next steps.
