...
![Netwrix Setup Launcher](../../../../static/img/product_docs/threatprevention/threatprevention/install/reportingmodule/setuplauncher.webp)
...
![Netwrix PostgreSQL Setup wizard on the Folder Location page](../../../../static/img/product_docs/threatprevention/threatprevention/install/reportingmodule/folder.webp)
...
![Netwrix PostgreSQL Setup wizard on the Successfully Installed page](../../../../static/img/product_docs/threatprevention/threatprevention/install/reportingmodule/completed.webp)
...
The PostgreSQL database application is now installed. Now you can install the Threat Manager application. See the [Install the Threat Manager Application](application.md) topic for additional information.
