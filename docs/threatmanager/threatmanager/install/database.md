...
The PostgreSQL database application is now installed. Now you can install the Threat Manager application. See the [Install the Threat Manager Application](/docs/threatmanager/threatmanager/install/application.md) topic for additional information.
