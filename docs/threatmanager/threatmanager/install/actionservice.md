...
![install](/static/img/product_docs/threatprevention/threatprevention/install/upgrade/install.png)
...
![settupprogress](/static/img/product_docs/threatmanager/threatmanager/install/settupprogress.png)
...
![serviceaccountproperties](/static/img/product_docs/threatmanager/threatmanager/install/serviceaccountproperties.png)

__Step 3 –__ Click the Log On tab.

__Step 4 –__ Select the This account: radio button and specify the desired Active Directory account and credentials. If desired, select the Browse button to open the Select User window to select an account.

__Step 5 –__ Click Apply and then OK. This sets the Action Service to “run as” the specified account.

![servicesrestart](/static/img/product_docs/threatmanager/threatmanager/install/servicesrestart.png)
