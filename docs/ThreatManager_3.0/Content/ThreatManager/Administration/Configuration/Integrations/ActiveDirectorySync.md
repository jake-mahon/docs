...
![Integrations interface on the Active Directory Sync page](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/ActiveDirectorySync/Page.png "Integrations interface on the Active Directory Sync page")
...
**NOTE:**  Prior to adding an Active Directory Sync policy, you must first configure a Credential Profile with credentials properly provisioned for running the sync operation for the domain. See the [Application Server Requirements](../../../Requirements/Server "Application Server Requirements") topic for the permissions. See the [Credential Profile Page](CredentialProfile "Credential Profile Page") topic for additional information on creating a profile.
...
![Add New Integration window with Active Directory Sync type selected](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AddNew/ActiveDirectorySync.png "Add New Integration window with Active Directory Sync type selected")
...
![Active Directory Sync details page for a specific domain](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/ActiveDirectorySync/Details.png "Active Directory Sync details page for a specific domain")
...
![Active Directory Sync details page for a specific domain showing the Domain Configuration tab](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/ActiveDirectorySync/DomainConfigurationTab.png "Active Directory Sync details page for a specific domain showing the Domain Configuration tab")
...
![Active Directory Sync details page for a specific domain showing the Sync History tab](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/ActiveDirectorySync/SyncHistoryTab.png "Active Directory Sync details page for a specific domain showing the Sync History tab")
