...
![Integrations interface on the Credential Profile page](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/CredentialProfile/Page.png "Integrations interface on the Credential Profile page")
...
See the [Application Server Requirements](../../../Requirements/Server "Application Server Requirements") topic for information on permission requirements for each type of task.
...
![Add New Integration window with Credential Profile type selected](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AddNew/CredentialProfile.png "Add New Integration window with Credential Profile type selected")
...
**Step 2 –** On the Integrations interface, click **Credential Profile** in the navigation pane to view a list of the already created Credential Profiles, if any.

**Step 3 –** Select a Credential Profile from the table or the navigation pane to view its details.

![Integrations interface displaying the details for a Credenital Profile](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/CredentialProfile/Details.png "Integrations interface displaying the details for a Credenital Profile")
...
* Name and Description – The box at the top displays the name and description of the profile
  ...
  * Edit – The edit button in the upper right corner of the box changes those fields from read-only to editable. See the [Edit Profile](#Edit "Edit Profile") topic for additional information.
...
* Credentials – This section displays the credentials
  ...
  * Edit Credential – The edit button to the right of the credentials opens the Credentials Settings window, where you canupdate the Platform, User Name, or Password. See the [Edit Credential](#Edit2 "Edit Credential") topic for additional information.
  ...
  * Add Credential – This button allows you to add additional credentials to this profile. This maybe applicable for action tasks. See the [Add Additional Credential to a Profile](#Add "Add Additional Credential to a Profile") topic for additional information.
...
![Name and Description box for a Credential Profile in Edit mode](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/CredentialProfile/EditProfile.png "Name and Description box for a Credential Profile in Edit mode")
...
**Step 1 –** On the Integrations interface, click **Credential Profile** in the navigation pane to view a list of the already created Credential Profiles, if any. Select a Credential Profile.

**Step 2 –** In the Credentials box, click the edit button to the right of the credential. The Credential Settings window opens.

![Credential Settings window](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/CredentialProfile/CredentialSettingsWindow.png "Credential Settings window")

**Step 3 –** To edit the platform type, select either SQL or Windows from the **Platform** drop-down menu.

**Step 4 –** To edit the account user name, enter the account user name in the required format of [DOMAIN]\[USERNAME], e.g. NWXTech\svc-netwrix.
...
Multiple credentials can be added to a single profile. Credential stacking is when you add multiple credentials to a single profile. While doing certain actions, these credentials will be enumerated until one is found that is able to execute the task.
...
* Threat Prevention Integration
  ...
  * Enumerate the credentials in order until one is able to connect to theThreat Prevention database successfully
* Actions
...
**Step 1 –** On the Integrations interface, click **Credential Profile** in the navigation pane to view a list of the already created Credential Profiles, if any.

**Step 2 –** Click Add Credential. The Add Credentials window opens.

![Add Credentials window](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/CredentialProfile/AddCredentialsWindow.png "Add Credentials window")
