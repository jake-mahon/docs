...
![](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AppTokens/Page.png)
...
![](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AddNew/AppToken.png)

**Step 2 –** In the Type drop-down menu, select **App Token**.

**Step 3 –** Enter a Name for the token in the Name field, and a Description for the token in the Description field.

***RECOMMENDED:*** Identify the data source for this app in either the Name or Description fields.
...
![](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AppTokens/Details.png)

Ensure that the app token is enabled for sending data to Threat Manager. In the General box, verify that the status is set to **ON**.
