...
![Integrations interface displaying the details for a Radius authneication provider](../../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AuthenticationProvider/Radius.png "Integrations interface displaying the details for a Radius authneication provider")
...
![Configuration tab for a RADIUS authneication provider](../../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AuthenticationProvider/ConfigurationRadius.png "Configuration tab for a RADIUS authneication provider")
...
* Auth Type – The security protocol used by the RADIUS proxy. Use the drop-down menu to select either MSCHAPv2 or PAP.
...
![Customization tab for a Radius authneication provider](../../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AuthenticationProvider/CustomizationTab.png "Customization tab for a Radius authneication provider")
...
* Send Initial Text – If On, the value in the Initial Auto Response Text is automatically sent to the RADIUS proxy without user action. Toggle On or Off as desired.
...
* Prefix for Response Text – This value is added to the start of the responses. The value will vary according to server.
* Send NAS Identifier – When On, NAS identifiers are transmitted to the RADIUS proxy. This is needed for certain RADIUS proxy implementations that require it. Toggle On or Off as desired.
...
![UserGroups tab for an authneication provider](../../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Integrations/AuthenticationProvider/UsersGroupsTab.png "UserGroups tab for an authneication provider")
