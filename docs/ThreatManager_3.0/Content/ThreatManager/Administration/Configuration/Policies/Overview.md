...
![](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Policies/Page.png)
...
* Host – The host on which the policy was applied. If the host exists in the Threat Manager database, click on the host link to go to the [Host Details Page](../../ThreatDetails/Host "Host Details Page")
...
The Policies page also provides the ability to click on a policy and view information and configuration options for that policy. See [Policy Configuration](PoliciesConfiguration "Policy Configuration") for additional information.
...
**NOTE:** When a Honeytoken name is specified and the policy is enabled, this policy becomes immediately valid for Honeytoken threat detection. Please refer to [Configure Honeytoken Threats](Honeytoken "Configure Honeytoken Threats") for Honeytoken naming best practices.

Follow the steps to add a policy.

![](../../../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/Configuration/Policies/AddNewPolicy.png)
...
* Name – The name for the policy
  ...
  **NOTE:** See [Configure Honeytoken Threats](Honeytoken "Configure Honeytoken Threats") for best practices for naming a Honeytoken.
