...
![](../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/ThreatsPage.png)
...
![](../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/HistoricalEvents.png)
...
The list displays threats that have a threat level of Low, Medium, High, or Audit for the selected timeframe. Each threat in the list contains a link which opens the [User Details Page](ThreatDetails/User "User Details Page") or the [Group Details Page](ThreatDetails/Group "Group Details Page") and a host link which opens the [Host Details Page](ThreatDetails/Host "Host Details Page"). In addition, threats have an Edit button which opens the [Edit Threats](#_Edit_Threats_1 "Edit Threats") window. The View Details button opens the [Threat Details Page](ThreatDetails/Overview "Threat Details Page").
...
The Level section displays the threat types which can be selected for filtering. Levels are assigned or configured on the [Threat Detection Page](Configuration/ThreatDetection "Threat Detection Page").
...
![](../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/ThreatSensitiveDataFilter.png)
...
![](../../../../../static/images/ThreatManager_3.0/Content/Resources/Images/ThreatManager/Admin/EditThreats.png)
...
Threats can also be edited from the [Threat Details Page](ThreatDetails/Overview "Threat Details Page").