...
[EntityTypes](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md),
[EntityProperties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
and
[EntityAssociations](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[languages list](/docs/identitymanager/6.1/tools-utilities/toolkit/index.md).
...
[calculation expression syntax](/docs/identitymanager/6.1/tools-utilities/toolkit/expressions.md).
...
[Synchronization](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md))
...
[EntityPropertyMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
using the
[Format attribute](/docs/identitymanager/6.1/connectors-integration/connector-configuration/entity-property-mapping.md)
...
[primary key](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md).
...
[CreateDatabaseViews tool](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md).
...
[here](/docs/identitymanager/6.1/identity-management/index.md).
