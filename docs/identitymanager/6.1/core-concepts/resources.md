...
[copied](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md)
...
3. [Load data from a CSV file](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md).
...
[later](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md).
