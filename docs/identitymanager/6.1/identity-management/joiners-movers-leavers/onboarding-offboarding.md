...
[See more information about entitlement assignment](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md).
...
[See more information about assignment automation](/docs/identitymanager/6.1/index.md).
...
and
[context rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
([role model](/docs/identitymanager/6.1/core-concepts/role-model.md), etc.).
