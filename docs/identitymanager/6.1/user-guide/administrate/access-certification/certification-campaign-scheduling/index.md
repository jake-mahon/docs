...
2.  Click on the addition button at the top right and fill in the fields.
    ...
    ![New Certification Campaign](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_newcertificationcampaign_v602.webp)
    ...
    - `Target Specificities`:
      ...
      fields below.
        ...
        ![Target Specificities](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_targetspecificities_v602.webp)
    ...
    - `Target Owners`:
      ...
      is based on the intersection of all filters. See the detailed fields below.
        ...
        ![Target Owner Filters](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_targetowners_v602.webp)

        According to the target entity type, additional filters can be available.

        ![Target Owner Additional Filters](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_targetownersadditional_v603.webp)
        ...
        - `Active Target`: the identities to be certified will be those for which a given property
          (here from `Directory_UserRecord`) was modified since a given date.
            ...
            >
            > ![Campaign Example](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_example_v602.webp)

3.  Click on **Create** and see a line added on the campaigns page.

    ![Campaigns Page](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_newlycreated_v603.webp)
...
4.  Apply the changes by clicking on **Launch**, thus running the
    ...
    > For example:
    >
    > ![Execute Access Reviews Job](/img/product_docs/identitymanager/6.1/user-guide/administrate/access-certification/certification-campaign-scheduling/certifcampaign_job_v522.webp)
