...
1. Click on **Multiple Updates**, accessible from the directory on the home page.
    ...
    ![Home Page - Multiple Updates](/img/product_docs/identitymanager/6.1/user-guide/maintain/identity-data-modification/multiple-update/home_multipleupdates_v523.webp)

2. Follow the workflow's instructions to perform the change, assign new entitlements if needed, and
   send the request.

    ![Multiple Updates Form](/img/product_docs/identitymanager/6.1/user-guide/maintain/identity-data-modification/multiple-update/datamodif_multipleform_v602.webp)
