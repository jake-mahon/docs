...
1. On the home page in the **Configuration** section, click on the **Role Mining** button.
    ...
    ![Home page - Connectors](/img/product_docs/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/home_rolemining_v60.webp)
...
2. Click on the addition button at the top right and fill in the fields.
    ...
    ![New Mining Rule](/img/product_docs/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/rolemining_miningrule_v602.webp)
...
4. Click on **Simulate** to perfom role mining in a
   [simulation](/docs/identitymanager/6.1/user-guide/optimize/simulation/index.md).
    ...
    ![Role Mining Jobs](/img/product_docs/identitymanager/6.1/user-guide/optimize/assignment-automation/role-mining/rolemining_launchjob_v602.webp)
