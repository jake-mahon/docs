...
1. On the home page in the **Configuration** section, click on **Risks**.
    ...
    ![Home Page - Risks](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/home_risks_v602.webp)
...
3. Fill in the fields.
    ...
    ![New Risk](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/riskmanagement_newrisk_v602.webp)
    ...
    ![Risk Icon](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/riskmanagement_workflowstate_v523.webp)
...
6. Choose a value for this navigation property. The value would be a resource from the unified
   [resource repository](/docs/identitymanager/6.1/introduction-guide/overview/identity-management/index.md).
    ...
    ![Risk Item Example](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/riskmanagement_newriskitem_v602.webp)
...
![Home Page - Identified Risks](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/home_identifiedrisks_v602.webp)

![Identified Risks](/img/product_docs/identitymanager/6.1/user-guide/optimize/risk-management/riskmanagement_identifiedrisks_v522.webp)
