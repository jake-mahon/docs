...
![Schema - Scalar Rule](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_schemanavigation.webp)
...
4. Fill in the fields.
    ...
    - **Criteria**: conditions that, if met, trigger the rule application.
        ...
        >
        > ![Scalar Rule Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_examplenav_v602.webp)
...
4. Fill in the fields.
    ...
    ![Create Query Rule](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_queryrule_v522.webp)

    Once the `Resource Type` is provided, more fields appear.

    ![Query Rule Fields](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_queryrulefields_v602.webp)
    ...
    - `Confidence Rate`: rate expressing the confidence in this link, and its priority order.
      [See the detailed explanation](/docs/identitymanager/6.1/user-guide/set-up/categorization/classification/index.md).
        ...
        >
        > ![Query Rule Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_examplequery_v602.webp)
        >
        > ![Query Rule Example 2](/img/product_docs/identitymanager/6.1/user-guide/set-up/provisioning-rule-creation/navigation-property-computation/provrules_examplequerybis_v602.webp)
