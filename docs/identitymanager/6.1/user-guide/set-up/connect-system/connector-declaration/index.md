...
2. Click on the addition icon and fill in the information fields.
    ...
    ![Connector creation](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-declaration/connectorcreation_declaration_v602.webp)
...
3. Click on **+ Create** to get on the connector's overview page:
    ...
    ![Connector page](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-declaration/connectorcreation_connectorpage_v602.webp)
...
![Test Connector](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-declaration/connectorcreation_test_v602.webp)
