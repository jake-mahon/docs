...
![Schemas' Key](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_key.webp)
...
![User Model](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user.webp)
...
![User Model - Canteen Badges Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-canteen.webp)
...
![User Model - Mailboxes Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_user-mailbox.webp)
...
![User-Group Model](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_usergroup.webp)
...
![User-Group Example - SAB](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_sab.webp)
...
![User-Group Example - RACF](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_racf.webp)
...
![User-Group Example - TSS](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss.webp)
...
![User-Group Example - SDGE](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_sdge.webp)
...
![Account-Profile-Transaction Model](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiletransaction.webp)
...
![Profiles Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_profiles.webp)
...
![User-Group Example - TSS](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_tss-prof-trans.webp)
...
![Star Model](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_star.webp)
...
![Star Model Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_starmodel.webp)
...
![AD Example - Step 1](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad-step1.webp)

**Step 3: define useful data close to your reality.**

We shape these objects with the following attributes:

![AD Example - Step 2](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_ad.webp)
...
>
> ![AD_Entry Example](/img/product_docs/identitymanager/6.1/user-guide/set-up/connect-system/connector-modeling/connectormodel_adentry.webp)
