...
1. Create the appropriate dimensions.
   ...
   [See more details on dimensions](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
2. Write profile rules and profile rule contexts to make the previously created dimensions act as
   ...
   [`SubBinding`](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
   to define the entity type that contains the dimension information.

   [See more details on profile rule contexts](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
...
1. Create at least one property group to gather a set of entity properties together.
   ...
   [See more details on property groups](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
...
[See more details on access control filters](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
