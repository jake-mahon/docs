...
[Indirect Resource Rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
- `IndirectResourceBinding`: the
  [Binding](/docs/identitymanager/6.1/core-concepts/bindings.md) that
...
[How-To: Configure Indirect Permissions in an Active Directory](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md).
...
[Resource Navigation Rule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)**.
