...
[See more details about assignment automation](/docs/identitymanager/6.1/index.md).
...
[See how to perform role mining](/docs/identitymanager/6.1/index.md).

### Simulation

Be aware that you can configure the
[mining task](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
to generate role assignment rules either directly or in a
[simulation](/docs/identitymanager/6.1/tools-utilities/simulation.md).
