...
[access certification campaign](/docs/identitymanager/6.1/governance/access-certification/index.md).

[See more information about how to use the risk management module](/docs/identitymanager/6.1/index.md)
...
[Risks](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
are assigned to resources manually by a knowledgeable user or automatically, by the
[Evaluate Policy](/docs/identitymanager/6.1/access-control-security/role-assignment/assignment-policies.md)
algorithm.
...
[risk rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
