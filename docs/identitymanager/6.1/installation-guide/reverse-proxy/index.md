...
- needing to encrypt the requests from/to end-users on the one hand, and on the other hand to be
  able to monitor plain text requests from/to Usercube's server;
    ...
    ![Proxy Purposes: Encryption](/img/product_docs/identitymanager/6.1/installation-guide/reverse-proxy/proxy_purpose_encryption.webp)
...
- installing Usercube with an integrated agent on a network isolated from the users' browsers, in
  ...
  isolated from the Internet;
    ...
    ![Proxy Installation Example](/img/product_docs/identitymanager/6.1/installation-guide/reverse-proxy/proxy_example.webp)
...
- using several Usercube's server instances for load-balancing purposes.
    ...
    ![Proxy Purposes: Load Balancing](/img/product_docs/identitymanager/6.1/installation-guide/reverse-proxy/proxy_purpose_loadbalancing.webp)
