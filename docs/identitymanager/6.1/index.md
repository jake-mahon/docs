...
- An [Introduction Guide](/docs/identitymanager/6.1/index.md) if you
  are new to Usercube.
- A [User Guide](/docs/identitymanager/6.1/index.md) to configure Usercube
  from scratch via the UI.
- An [Integration Guide](/docs/identitymanager/6.1/getting-started/index.md) to
  complete Usercube's configuration in XML according to your needs.
- An [Installation Guide](/docs/identitymanager/6.1/installation-setup/index.md) to
  install Usercube in a production environment.
- A [Migration Guide](/docs/identitymanager/6.1/index.md) to upgrade to
  a new version of Usercube.
- [Release Notes](/docs/identitymanager/6.1/index.md) to get details about
...
[Read more about display tables](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[Read more about tiles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[Read more about forms](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
- [View template](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md):
  Creates the display table, the default view and access rights to the entity.
- [Entity template:](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md)
...
- [MenuItem](/docs/identitymanager/6.1/index.md)
- [Entity accessControl](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md)
...
[record filter](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[Read more about searchbars](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[criterion](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md):
...
[Create Menu Item for Workflow in Resource Entity List](/docs/identitymanager/6.1/index.md).

# How-Tos

These guides will help you configure various UI settings with practical step-by-step procedures.

- #### [Import Product Translations into Usercube](/docs/identitymanager/6.1/index.md)
  Write the JSON file containing the translations of Usercube's components (buttons, etc.) and
  deploy them.- ####
  [Create Menu Items](/docs/identitymanager/6.1/index.md)
  Create the menu items required to access the workflow in the UI.- ####
  [Customize Display Tables](/docs/identitymanager/6.1/index.md)
  Define a custom way to display entity types' data.- ####
  [Customize Search Bars](/docs/identitymanager/6.1/index.md)
  Define a custom way to search from a list of a given entity type's properties.- ####
  [Customize Forms](/docs/identitymanager/6.1/index.md)
...
[See how to customize Usercube's User Interface](/docs/identitymanager/6.1/index.md).

# Activity Templates

This section describes the activities that constitute and model a
[workflow](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md).
...
A
[homonym entity link](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md)
...
[Homonym entity link filters](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md)
...
A
[display table](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[how to configure display tables](/docs/identitymanager/6.1/index.md).
...
[filter definition](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md).
...
[workflow](/docs/identitymanager/6.1/index.md) through the
XML configuration.
...
1. Declare a new
   ...
   [activity templates](/docs/identitymanager/6.1/index.md).
2. Configure the input
   [form](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
   with the right output type according to the purpose of the workflow.
3. Assign the adequate permissions via an
   [access control rule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
4. Add
   [menu items](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
5. Add
   [aspects](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md),
   according to the purpose of the workflow.
6. Add optional elements if needed:
   [summaries](/docs/identitymanager/6.1/index.md); a
   [homonym detection](/docs/identitymanager/6.1/index.md);
   a
   [display table](/docs/identitymanager/6.1/index.md)
...
- #### [For Resource Creation (Mono Record)](/docs/identitymanager/6.1/index.md)
  How to create a workflow to create a new resource with a unique record.- ####
  [For Resource Creation (Multi Records)](/docs/identitymanager/6.1/index.md)
  How to create a workflow to create a new resource with several records.- ####
  [For Resource Update (No Record)](/docs/identitymanager/6.1/index.md)
  ...
  [For Resource Update (Mono Record)](/docs/identitymanager/6.1/index.md)
  How to create a workflow to schedule the replacement of the unique record of an existing
  resource with a new one.- ####
  [For Resource Update (Multi Records)](/docs/identitymanager/6.1/index.md)
  Create a workflow to update an existing resource through its several records.- ####
  [Configure a Homonym Detection](/docs/identitymanager/6.1/index.md)
...
1. [`ActionWithRefine`](/docs/identitymanager/6.1/index.md#actionwithrefine):
   sends the creation request with a possibility of delegation.
2. [`PersistOnlyResources`](/docs/identitymanager/6.1/index.md#persistonlyresources):
   saves the collected data to the repository without triggering provisioning.
3. [`ReviewWithFeedback`](/docs/identitymanager/6.1/index.md#reviewwithfeedback):
   reviews the creation request with the possibility of getting feedback from another user.
4. [`Persist`](/docs/identitymanager/6.1/index.md#persist):
...
[see more details](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)):
...
[records](/docs/identitymanager/6.1/identity-management/joiners-movers-leavers/position-changes.md)
...
users. Read about
[workflows' permissions](/docs/identitymanager/6.1/index.md).
...
existing
[menu items list](/docs/identitymanager/6.1/index.md):
...
[aspects](/docs/identitymanager/6.1/index.md#aspects)
...
[how to configure a homonym detection](/docs/identitymanager/6.1/index.md).
...
[how to configure a display table](/docs/identitymanager/6.1/index.md).
...
2. [`Persist`](/docs/identitymanager/6.1/index.md#persist):
   saves the collected data and triggers provisioning.
...
2. [`ReviewWithFeedback`](/docs/identitymanager/6.1/index.md#reviewwithfeedback):
   reviews the update request with the possibility of getting feedback from another user.
3. [`Persist`](/docs/identitymanager/6.1/index.md#persist):
   saves the collected data and triggers provisioning.
...
- A workflow is linked to
  one[entity type](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[activity template](/docs/identitymanager/6.1/index.md)
...
Workflows use
[forms](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
to collect input data through the UI.

A form is a set of fields, configured with
[controls](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[profiles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
...
[`Persist`](/docs/identitymanager/6.1/index.md#persist)
and
[`PersistOnlyResources`](/docs/identitymanager/6.1/index.md#persistonlyresources)
do not require any permission. This also means that, in the example of the
[`Action`](/docs/identitymanager/6.1/index.md#action)
...
[access control rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
...
An
[aspect](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md)
definition allows an action to be performed at a specific point in a workflow. Usercube provides a
few
[aspect templates](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md)
...
[Read how to configure a homonym detection](/docs/identitymanager/6.1/index.md).
...
[Read how to configure a display table](/docs/identitymanager/6.1/index.md).
...
Let's learn about
[Usercube's configuration](/docs/identitymanager/6.1/index.md).

## Learn More

[Learn more on Usercube's architecture](/docs/identitymanager/6.1/core-concepts/architecture/index.md).

[Learn more on network configuration](/docs/identitymanager/6.1/configuration-reference/network-configuration/index.md).
...
- the [User Guide](/docs/identitymanager/6.1/index.md) to configure Usercube
  from scratch via the UI, following the step-by-step procedures;
- the [Integration Guide](/docs/identitymanager/6.1/getting-started/index.md) to
  complete Usercube's configuration in XML according to your needs;
- the [Installation Guide](/docs/identitymanager/6.1/installation-setup/index.md) to
  install Usercube in a production environment.

## Learn More

[Learn more on the working directory](/docs/identitymanager/6.1/installation-setup/working-directory-setup.md).

[See how to configure Usercube from scratch via the UI](/docs/identitymanager/6.1/index.md).

[See how to export the UI configuration to XML files](/docs/identitymanager/6.1/tools-utilities/cli-reference/configuration-tools.md).

[See how to (re)deploy the XML configuration](/docs/identitymanager/6.1/tools-utilities/cli-reference/configuration-tools.md).

[Learn more about the XML configuration schema](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).

[Learn more about network configuration](/docs/identitymanager/6.1/configuration-reference/network-configuration/index.md).
...
[Integration Guide](/docs/identitymanager/6.1/getting-started/index.md)'s or the
[User Guide](/docs/identitymanager/6.1/index.md)'s contents.
...
[overview of IGA and Usercube](/docs/identitymanager/6.1/index.md).
...
[governance](/docs/identitymanager/6.1/index.md)
...
[entity-relationship model](/docs/identitymanager/6.1/index.md).
...
[See more details on governance](/docs/identitymanager/6.1/index.md).
...
The
[identity model](/docs/identitymanager/6.1/index.md)
...
[Learn more on the role model](/docs/identitymanager/6.1/core-concepts/role-model.md).

[Learn how to build the single role catalog](/docs/identitymanager/6.1/index.md).

[Learn more on composite roles](/docs/identitymanager/6.1/index.md).

[Learn more on role assignment](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md).

[Learn more on provisioning rules](/docs/identitymanager/6.1/index.md).

[Learn more on assignment rules](/docs/identitymanager/6.1/index.md).

[Learn more on resource categorization rules](/docs/identitymanager/6.1/index.md).
...
Let's read some
[use case stories](/docs/identitymanager/6.1/index.md).

## Learn More

[Learn more on governance](/docs/identitymanager/6.1/governance/index.md).

[Learn more on reporting](/docs/identitymanager/6.1/index.md).

[Learn more on access certification](/docs/identitymanager/6.1/index.md).

[Learn more on risk management](/docs/identitymanager/6.1/index.md).
...
will dig into
[later](/docs/identitymanager/6.1/index.md).
...
[roles and rules, etc.](/docs/identitymanager/6.1/index.md)
...
- the
  [policy's rules](/docs/identitymanager/6.1/index.md)
...
Let's learn about
[entitlement management](/docs/identitymanager/6.1/index.md).

## Learn More

[Learn more on identity management](/docs/identitymanager/6.1/identity-management/index.md).

[See how to create the workforce repository](/docs/identitymanager/6.1/index.md).

[Learn more on connectors](/docs/identitymanager/6.1/connectors-integration/index.md).

[See how to create a connector](/docs/identitymanager/6.1/index.md).

[Learn more on synchronization](/docs/identitymanager/6.1/automation/synchronization/index.md).

[Learn more on workflows](/docs/identitymanager/6.1/index.md).
...
[See more details on identity management and connection between systems](/docs/identitymanager/6.1/index.md).
...
[See more details on entitlement management](/docs/identitymanager/6.1/index.md).
...
[Find use case stories](/docs/identitymanager/6.1/index.md).
...
Let's learn about
[Usercube's architecture](/docs/identitymanager/6.1/index.md).
...
- [Data model: Jobs](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
- [Execute Jobs](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md)
- [information about all Tasks](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
- [Information about Jobs](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
...
- The [RunTask API](/docs/identitymanager/6.1/api-reference/server-api/jobs.md)

#### d. Information system appsettings

All the information of the information system is on this file:
[appsettings.ConnectionInformation.json](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
| Old Name                                  | New Name                                                                                                                                                                                                                                                                                                       |
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Usercube.UpdateDirty                      | [Usercube-Set-RecentlyModifiedFlag](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                        |
| Usercube.RBACMining                       | [Usercube-Get-RoleMining](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                  |
| Usercube.Provisioner.Download             | [Usercube-Fulfill-ToFile](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                  |
| Usercube.Provisioner.LDAP.Job             | [Usercube-Fulfill-LDAP](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                    |
| Usercube.Provisioner.AzureAd              | [Usercube-Fulfill-AzureAd](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                 |
| Usercube.Provisioner.Manual.Job           | Usercube-Update-FulfillmentSates                                                                                                                                                                                                                                                                               |
| Usercube.Provisioner.Workflow             | [Usercube-Fulfill-InternalWorkflows](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                       |
| Usercube.Provisioner.Job                  | Usercube-Fulfill-InternalResources                                                                                                                                                                                                                                                                             |
| Usercube.ProfileAssignment.Job            | [Usercube-Set-InternalUserProfiles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                        |
| Usercube.PreExistingAssignment            | [Usercube-Save-PreExistingAccessRights](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                    |
| Usercube.OpenIdClient.Generator           | [Usercube-New-OpenIDSecret](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md)                                                                                                                                                                                                                  |
| Usercube.UpgradeXml                       | Usercube-Upgrade-ConfigurationVersion                                                                                                                                                                                                                                                                          |
| Usercube.MigrateDatabase                  | Usercube-Upgrade-DatabaseVersion                                                                                                                                                                                                                                                                               |
| Usercube.CreateResourceViews              | [Usercube-Create-DatabaseViews](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                            |
| Usercube.ApiCall                          | [Usercube-Invoke-API](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                      |
| Usercube.Anonymizer                       | Usercube-Anonymize                                                                                                                                                                                                                                                                                             |
| Usercube.ResourceClassification           | [Usercube-Update-Classification](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                           |
| Usercube.EntityProperties.Expressions.Job | [Usercube-Update-EntityPropertyExpressions](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                |
| Usercube.Provisioning.Job                 | [Usercube-Generate-ProvisioningOrders](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                     |
| Usercube.ProvisioningPolicy.Job           | [Usercube-Compute-RoleModel](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                               |
| Usercube.Synchronization.ADDirSync.Job    | [Usercube-Synchronize-ActiveDirectory](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                     |
| Usercube.Synchronization.Change.Job       | [Usercube-Synchronize-Changes](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                             |
| Usercube.Synchronization.Job              | [Usercube-Synchronize](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                                     |
...
| Usercube.SqlCmd                           | [Usercube-Invoke-SqlCommandAgent](https://extranet.usercube.com/5.1/5.1.7.7/Documentation/integration-guide/toolkit/xml-configuration/jobs/tasks/agent/exports/InvokeSqlCommandTask/) / [Usercube-Invoke-SqlCommandServer](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md) |
...
| Usercube.Collectors.Change.Job            | [Usercube-Prepare-SynchronizationChange](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                   |
| Usercube.Collectors.Job                   | [Usercube-Prepare-Synchronization](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)                                                                                                                                                                                         |
...
#### [WsFed](/docs/identitymanager/6.1/access-control-security/authentication/end-user-authentication.md) Authentication
...
#### [OpenId](/docs/identitymanager/6.1/access-control-security/authentication/end-user-authentication.md) Authentication
...
#### [Active Directory](/docs/identitymanager/6.1/access-control-security/authentication/end-user-authentication.md) Authentication
...
#### [Optional Settings](/docs/identitymanager/6.1/installation-setup/server-configuration.md)

All working directories are optional in 5.1.1

## Agent Settings

#### [Optional Settings](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)

All working directories are optional in 5.1.1

## [Logger Settings](/docs/identitymanager/6.1/troubleshooting-support/monitoring/index.md)
...
5. Move File Locations
   ...
   3. Run the move files utility.
      ...
      [generic arguments](/docs/identitymanager/6.1/tools-utilities/cli-reference/security-tools.md)).
...
5. Recompute all property expressions and correlation keys by using the
   [`Update-EntityPropertyExpressions`](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md)
   and
   [`Compute-CorrelationKeys`](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md)
...
- [5.1.0 to 5.1.1](/docs/identitymanager/6.1/index.md)
- [5.0 to 5.1](/docs/identitymanager/6.1/index.md)
- [5.1.1 to 5.1.7](/docs/identitymanager/6.1/index.md)
- [5.1.7 to 5.2.3](/docs/identitymanager/6.1/index.md)
...
For example see the
[ 5.2.X to 6.0 ](/docs/identitymanager/6.1/index.md) topic
...
- [5.2.X to 6.0](/docs/identitymanager/6.1/index.md)
- [5.1.7 to 5.2.3](/docs/identitymanager/6.1/index.md)
- [5.1.1 To 5.1.7](/docs/identitymanager/6.1/index.md)
- [5.1.0 to 5.1.1](/docs/identitymanager/6.1/index.md)
- [5.0.X to 5.1](/docs/identitymanager/6.1/index.md)
...
| Input                                                                             | Output           |
| --------------------------------------------------------------------------------- | ---------------- |
| [Scheduled certification campaign](/docs/identitymanager/6.1/index.md) (required) | Certified access |
...
| Input                                                                                                                                                                                     | Output                              |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Role catalog](/docs/identitymanager/6.1/index.md) (optional) [Risks](/docs/identitymanager/6.1/index.md) (optional) | Scheduled certification campaign(s) |
...
2.  Click on the addition button at the top right and fill in the fields.
    ...
    - `Target Reviewers`: set of identities in charge of the access review. Available target
      ...
      [certification policies](/docs/identitymanager/6.1/governance/access-certification/index.md).
    - `Target Specificities`:
      [data filters](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-certification-config.md)
    ...
    - `Target Owners`:
      [owner filters](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-certification-config.md)
...
4.  Apply the changes by clicking on **Launch**, thus running the
    [access certification job](/docs/identitymanager/6.1/governance/access-certification/index.md).
...
- assignments presenting a certain level of
  [risk](/docs/identitymanager/6.1/index.md).

Certification campaigns can be
[configured with XML](/docs/identitymanager/6.1/governance/access-certification/index.md)
...
| Input                                                                                                                                                                                     | Output           |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Role catalog](/docs/identitymanager/6.1/index.md) (optional) [Risks](/docs/identitymanager/6.1/index.md) (optional) | Certified access |

## Perform Access Certification

Perform access certification by proceeding as follows:

1. [Schedule a certification campaign](/docs/identitymanager/6.1/index.md).
2. [Execute a certification campaign](/docs/identitymanager/6.1/index.md).

# Administrate

- #### [Generate Reports](/docs/identitymanager/6.1/index.md)

  How to use Usercube's reporting modules to produce IGA reports for auditing and governance
  purposes.

- #### [Review Orphaned and Unused Accounts](/docs/identitymanager/6.1/index.md)

  How to remediate license and security issues caused by orphaned and/or unused accounts.

- #### [Provision](/docs/identitymanager/6.1/index.md)

  How to write to a managed system

- #### [Review Provisioning](/docs/identitymanager/6.1/index.md)
  ...
  [Provision Automatically](/docs/identitymanager/6.1/index.md)
  How to make Usercube automatically write to the managed systems.
- #### [Review Non-conforming Assignments](/docs/identitymanager/6.1/index.md)
...
- #### [Reconcile a Role](/docs/identitymanager/6.1/index.md)
  ...
  catalog.- ####
  [Reconcile a Property](/docs/identitymanager/6.1/index.md)
  ...
  rules.- ####
  [Review an Unauthorized Account](/docs/identitymanager/6.1/index.md)
...
- #### [Perform Access Certification](/docs/identitymanager/6.1/index.md)

  How to certify existing access by reviewing a specific range of assigned permissions for
  auditing purposes.

- #### [Schedule a Certification Campaign](/docs/identitymanager/6.1/index.md)
  How to create and schedule access certification campaigns, defining their scope.- ####
  [Execute a Certification Campaign](/docs/identitymanager/6.1/index.md)
  How to execute access certification campaigns, i.e. review specific entitlement assignments and
  deprovision inappropriate access.
- #### [Request Entitlement Assignment](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                                              | Output               |
| ---------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Updated entitlements |
...
[non-conforming assignments](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md).
...
| Input                                                         | Output                |
| ------------------------------------------------------------- | --------------------- |
| [Provisioning](/docs/identitymanager/6.1/index.md) (required) | Complying assignments |
...
- [Review non-conforming roles](/docs/identitymanager/6.1/index.md).
- [Review unreconciled properties](/docs/identitymanager/6.1/index.md).
- [Review unauthorized accounts](/docs/identitymanager/6.1/index.md).

[Risks](/docs/identitymanager/6.1/index.md) can be
...
- If the property is reviewed (approved/declined), then the corresponding role is automatically
  reviewed too, its
  [workflow state](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md)
...
| Input                                                         | Output               |
| ------------------------------------------------------------- | -------------------- |
| [Provisioning](/docs/identitymanager/6.1/index.md) (required) | Complying properties |
...
8. Trigger
   [provisioning](/docs/identitymanager/6.1/index.md)
...
| Input                                                         | Output          |
| ------------------------------------------------------------- | --------------- |
| [Provisioning](/docs/identitymanager/6.1/index.md) (required) | Complying roles |
...
| Input                                                         | Output             |
| ------------------------------------------------------------- | ------------------ |
| [Provisioning](/docs/identitymanager/6.1/index.md) (required) | Complying accounts |
...
5. Click on the line of an account with an owner.
   ...
   but with a
   [confidence rate](/docs/identitymanager/6.1/index.md)
   ...
   [updated](/docs/identitymanager/6.1/index.md)
...
[configured via XML](/docs/identitymanager/6.1/index.md) to
...
[reporting module](/docs/identitymanager/6.1/index.md)
...
filters in the
[query module](/docs/identitymanager/6.1/index.md),
...
| Input                                                           | Output                               |
| --------------------------------------------------------------- | ------------------------------------ |
| [Categorization](/docs/identitymanager/6.1/index.md) (required) | Removed orphaned and unused accounts |
...
5. Answer the following questions in order to understand the situation.
   ...
   [certified](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                   | Output                  |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| [Provisioning orders](/docs/identitymanager/6.1/index.md) (required) automated provisioning [connection](/docs/identitymanager/6.1/index.md) (required) | Updated managed systems |

## Implement Automated Provisioning

automated provisioning is performed through a connection using a
[package](/docs/identitymanager/6.1/connectors-integration/connector-packages/index.md)
for fulfilling external systems (e.g., the
[Active Directory package](/docs/identitymanager/6.1/connectors-integration/connector-packages/active-directory.md)).
...
2. Follow the
   [manual assignment workflow](/docs/identitymanager/6.1/index.md)
...
[ Model the Data ](/docs/identitymanager/6.1/index.md)
and
[ Create a Connection ](/docs/identitymanager/6.1/index.md)
...
[ Provision Manually ](/docs/identitymanager/6.1/index.md)
and
[ Provision Automatically ](/docs/identitymanager/6.1/index.md)topics
...
[ Entitlement Assignment ](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md)
and
[ Review Provisioning ](/docs/identitymanager/6.1/index.md)
topics for additional information.
...
[ Configure a User Profile ](/docs/identitymanager/6.1/index.md)topic
for additional information.
...
[ Classify Resources ](/docs/identitymanager/6.1/index.md)
...
[ Model the Data ](/docs/identitymanager/6.1/index.md),
[ Classify Resources ](/docs/identitymanager/6.1/index.md),
[ Create a Provisioning Rule ](/docs/identitymanager/6.1/index.md),
and
[ Create Roles in the Role Catalog ](/docs/identitymanager/6.1/index.md)
topics for additional information.
...
| Input                                                                                                                                                | Output                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| [Provisioning orders](/docs/identitymanager/6.1/index.md) (required) Manual provisioning [connection](/docs/identitymanager/6.1/index.md) (required) | Updated managed systems |

## Implement Manual Provisioning

Manual provisioning is performed through a connection using the
[manual ticket package](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
...
[the right permissions](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                                             | Output              |
| --------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| [Provisioning rules](/docs/identitymanager/6.1/index.md) (required) [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Provisioning orders |
...
[configuring a resource type](/docs/identitymanager/6.1/index.md).
You can choose to:

- Set the number of required approvals by a
  [role officer](/docs/identitymanager/6.1/index.md),
...
[fulfillment](/docs/identitymanager/6.1/index.md)
error occurs.
...
- `Confidence Rate`: rate expressing the confidence in the corresponding
  [query rule](/docs/identitymanager/6.1/index.md).
...
- `Confidence rate of proposed resource`: rate expressing the confidence in this
  [correlation](/docs/identitymanager/6.1/index.md).
- `Proposed Value`: value proposed by Usercube.
- `Current Value`: value currently in the managed system.
- [`Provisioning State`](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md)
- `Start Date`: date for the beginning of the property value existence.
...
5. The orders using automated provisioning should be
   [automatically handled](/docs/identitymanager/6.1/index.md)
   with their state switching to `Executed`, while those using manual provisioning should appear on
   the
   [**Manual Provisioning**](/docs/identitymanager/6.1/index.md)
...
- the
  [list of orphaned accounts](/docs/identitymanager/6.1/index.md).
...
[profile configuration](/docs/identitymanager/6.1/index.md).
...
and
[specific query grammar](/docs/identitymanager/6.1/api-reference/squery.md).
...
[synchronized](/docs/identitymanager/6.1/index.md) and
[classified](/docs/identitymanager/6.1/index.md).
...
[XML configuration](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md),
...
3. Click on **Fields to Display** and select the appropriate fields from among the database
   [universe](/docs/identitymanager/6.1/configuration-reference/xml-configuration/business-intelligence-config.md)
   ...
   understand the
   [entity instances](/docs/identitymanager/6.1/configuration-reference/xml-configuration/business-intelligence-config.md)
   and
   [association instances](/docs/identitymanager/6.1/configuration-reference/xml-configuration/business-intelligence-config.md)
   that constitute the
   [universe](/docs/identitymanager/6.1/configuration-reference/xml-configuration/business-intelligence-config.md)
...
[See how to analyze Usercube's data with Power BI](/docs/identitymanager/6.1/governance/reporting/index.md).
...
- #### [Plan Change Management](/docs/identitymanager/6.1/index.md)
...
- #### [Install the Production Agent](/docs/identitymanager/6.1/index.md)

  How to install a local agent for production environment.

- #### [Configure the Agent's Settings](/docs/identitymanager/6.1/index.md)
  How to configure the agent's application settings via the `web.config`, `appsettings.json` and
  `appsettings.agent.json` files.- ####
  [Install IIS via Server Manager](/docs/identitymanager/6.1/index.md)
  How to configure the local server to install IIS via Server Manager.- ####
  [Configure the Pool and Site](/docs/identitymanager/6.1/index.md)
  How to configure the application pool and website via IIS.- ####
  [Set the Working Directory's Permissions](/docs/identitymanager/6.1/index.md)
  How to assign to the pool the right permissions on the working directory.- ####
  [Finalize the Installation](/docs/identitymanager/6.1/index.md)
  How to finalize the installation of the agent.
- #### [Set Up User Authentication](/docs/identitymanager/6.1/index.md)

  How to allow end-users to authenticate and use the Usercube application.

- #### [Implement Usercube](/docs/identitymanager/6.1/index.md)
  How to actually implement Usercube solution.
...
To continue,
[finalize the installation in a few steps](/docs/identitymanager/6.1/index.md).
...
1. Install
   ...
   [IIS configuration](/docs/identitymanager/6.1/index.md),
...
2. When using a proxy,
   [adjust the configuration accordingly](/docs/identitymanager/6.1/installation-setup/reverse-proxy-setup.md).

## Next Steps

To continue, follow the instructions to
[verify the agent's installation](/docs/identitymanager/6.1/index.md).
...
To continue,
[set the right permissions on the working directory](/docs/identitymanager/6.1/index.md).
...
To continue,
[configure the application pool and website via IIS](/docs/identitymanager/6.1/index.md).

# Install the Production Agent

This guide shows how to install an
[agent](/docs/identitymanager/6.1/index.md)separated
from the server, for production environment.

## Overview

Like all [agents](/docs/identitymanager/6.1/index.md),
...
[connector declaration](/docs/identitymanager/6.1/index.md).
The appropriate agent has access to the managed system.

## Requirements

Ensure that all
[agent requirements](/docs/identitymanager/6.1/getting-started/system-requirements.md)
...
| Input                                                                                              | Output           |
| -------------------------------------------------------------------------------------------------- | ---------------- |
| [Agent prerequisites](/docs/identitymanager/6.1/getting-started/system-requirements.md) (required) | Production agent |

## Install the Production Agent

Install the production agent by proceeding as follows:

1. [Create the working directory](/docs/identitymanager/6.1/installation-setup/working-directory-setup.md)
   and make sure it contains the folders: `Mails`; `Sources`; `Temp`; `Work`.
2. [Configure the agent's application settings](/docs/identitymanager/6.1/index.md)
   via the `web.config`, `appsettings.json` and `appsettings.agent.json` files.
3. [Configure the local server to install IIS](/docs/identitymanager/6.1/index.md)
   via Server Manager.
4. [Configure the application pool and website](/docs/identitymanager/6.1/index.md)
   via IIS.
5. [Set the right permissions on the working directory](/docs/identitymanager/6.1/index.md).
6. [Finalize the production agent's installation](/docs/identitymanager/6.1/index.md).
...
[`appsettings.json`](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
and
...
4. Open `appsettings.agent.json` and make sure that:
   ...
   - **OpenId** > **AgentIdentifier** specifies the agent's name which must match the XML
     configuration.
     [See more details](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
To continue,
[configure the local server to install IIS via Server Manager](/docs/identitymanager/6.1/index.md).
...
[following the starting process](/docs/identitymanager/6.1/index.md)
and creating the workforce directory, you can come back at any time and complete the directory that
you started,
[updating identity data](/docs/identitymanager/6.1/index.md).
...
[the implementation in production environment](/docs/identitymanager/6.1/index.md),
i.e. a new application in Usercube's scope. With this, you can
[review orphan and unused accounts](/docs/identitymanager/6.1/index.md),
[provision the AD](/docs/identitymanager/6.1/index.md),
[reconcile properties](/docs/identitymanager/6.1/index.md),
and
[generate reports](/docs/identitymanager/6.1/index.md),
...
[reconcile roles](/docs/identitymanager/6.1/index.md),
perform
[access certification](/docs/identitymanager/6.1/index.md)
and
[request entitlement assignment](/docs/identitymanager/6.1/index.md),
and also
[generate reports](/docs/identitymanager/6.1/index.md),
...
1. [Connect Usercube to the system](/docs/identitymanager/6.1/index.md):
   create the appropriate connector with its connections and entity types.
2. [Synchronize the system's data](/docs/identitymanager/6.1/index.md)
   into Usercube.
...
3. [Categorize resources](/docs/identitymanager/6.1/index.md)
   in order to classify them according to their intent, and correlate these resources with their
   owners.
4. [Create provisioning rules](/docs/identitymanager/6.1/index.md)
   to write to the system in order to update the resources' properties directly in the system.
5. [Adjust the rules by reconciling resources](/docs/identitymanager/6.1/index.md),
...
6. [Create roles in the role catalog](/docs/identitymanager/6.1/index.md)
   for applications managed by the system.
7. [Automate role assignments](/docs/identitymanager/6.1/index.md)
...
[identity management](/docs/identitymanager/6.1/index.md),
...
1. [Install the development environment](/docs/identitymanager/6.1/index.md).
2. [Create the workforce directory](/docs/identitymanager/6.1/index.md):
...
3. [Connect Usercube to the system by creating a connector](/docs/identitymanager/6.1/index.md).
4. [Synchronize the system's data](/docs/identitymanager/6.1/index.md)
   into Usercube.
...
5. [Categorize resources](/docs/identitymanager/6.1/index.md)
   in order to classify them according to their intent, and correlate these resources with their
   owners.
6. [Create provisioning rules](/docs/identitymanager/6.1/index.md)
   to write to the system in order to update the resources' properties directly in the system.
7. [Adjust the rules by reconciling resources](/docs/identitymanager/6.1/index.md),
   i.e. analyze the differences spotted between the reality of resources' properties and those
   computed by the previously established rules. Especially, verify that accounts are correlated to
   the right owners and that their properties have the right values.
...
8. [Create roles in the role catalog](/docs/identitymanager/6.1/index.md)
   for applications managed by the system.
9. [Automate role assignments](/docs/identitymanager/6.1/index.md)
   if needed: use Role Mining to create single role rules in bulk; adjust the generated rules
   individually and manually.
...
11. [Define the permissions for your user profiles](/docs/identitymanager/6.1/index.md).
12. Define the authentication mode by configuring `SelectUserByIdentityQueryHandlerSetting` (only in
    XML configuration), and
    [assign profiles to users](/docs/identitymanager/6.1/index.md)
...
- #### [How to Start](/docs/identitymanager/6.1/index.md)
  How to start integrating Usercube with your own needs.- ####
  [How to Maintain the Workforce Directory](/docs/identitymanager/6.1/index.md)
  How to keep the workforce directory up to date.- ####
  [How to Implement a New System](/docs/identitymanager/6.1/index.md)
  How to add a new system to the solution.
...
read the [Introduction Guide](/docs/identitymanager/6.1/index.md) in
...
[Introduction Guide](/docs/identitymanager/6.1/index.md) to fully
...
[Integration Guide](/docs/identitymanager/6.1/getting-started/index.md).
...
[global process](/docs/identitymanager/6.1/index.md).
...
[global process](/docs/identitymanager/6.1/index.md) that
...
| Input                                                                                             | Output                      |
| ------------------------------------------------------------------------------------------------- | --------------------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) New identity data (required) | Updated identity repository |
...
- either
  [update data individually](/docs/identitymanager/6.1/index.md)
  by using predefined workflows in the UI;
- or
  [perform a same change on several identities simultaneously](/docs/identitymanager/6.1/index.md)
  by using Usercube's predefined workflow in the UI;
- or
  [update data on a massive scale](/docs/identitymanager/6.1/index.md)
...
3. Follow the workflow's instructions to fill the form with the user's data, choose the user's
   ...
   [role catalog](/docs/identitymanager/6.1/index.md)
...
9. Back on the connector's page,
   [launch synchronization](/docs/identitymanager/6.1/index.md).

   Be cautious about
   [thresholds](/docs/identitymanager/6.1/index.md).
...
4. Fill only the data to be modified, specify the unique identifier for each entry (for correlation
   ...
   - `Delete` to remove attributes from the datamodel;
     ...
     [scan the data model](/docs/identitymanager/6.1/index.md)
...
- [Create reports](/docs/identitymanager/6.1/index.md)
...
- #### [Update Identity Data](/docs/identitymanager/6.1/index.md)

  How to perform modifications in the identity repository, to manage onboarding, offboarding and
  position changes.

- #### [Update an Individual Identity](/docs/identitymanager/6.1/index.md)
  How to perform changes in data for a single identity, through the UI.- ####
  [Update Multiple Identities](/docs/identitymanager/6.1/index.md)
  How to perform a same change in data for several identities simultaneously, through the
  UI.- ####
  [Update Identities in Bulk](/docs/identitymanager/6.1/index.md)
  How to perform a mass change in identity data, by uploading a complete or incremental version of
  the identity repository.
- #### [Troubleshoot](/docs/identitymanager/6.1/index.md)
...
[See troubleshooting instructions concerning connector jobs](/docs/identitymanager/6.1/troubleshooting-support/common-issues/connector-troubleshooting.md).
...
| Input                                                               | Output              |
| ------------------------------------------------------------------- | ------------------- |
| [Implemented system](/docs/identitymanager/6.1/index.md) (required) | Working environment |
...
[See more details on synchronization thresholds](/docs/identitymanager/6.1/index.md).
...
[roles](/docs/identitymanager/6.1/index.md)
to identities.
...
[single roles](/docs/identitymanager/6.1/index.md)
and
[composite roles](/docs/identitymanager/6.1/index.md)
...
| Input                                                         | Output                |
| ------------------------------------------------------------- | --------------------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Role assignment rules |
...
[Simulations](/docs/identitymanager/6.1/index.md) are
...
NETWRIX recommends
[removing redundant assignments](/docs/identitymanager/6.1/index.md)
...
2. Automation of entitlement assignment through
   ...
   [dimensions](/docs/identitymanager/6.1/access-control-security/role-assignment/conforming-assignments.md#dimensions),
...
[fulfilled](/docs/identitymanager/6.1/index.md)
...
- Errors can happen: human mistakes are expected in role distribution, even though largely mitigated
  by the
  [role review process](/docs/identitymanager/6.1/index.md)
  and
  [certification campaigns](/docs/identitymanager/6.1/index.md).
...
[simulation](/docs/identitymanager/6.1/index.md), or
...
| Input                                                         | Output                       |
| ------------------------------------------------------------- | ---------------------------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Ideally automated role model |

## Automate Entitlement Assignment

The process of assignment automation is the following:

1. [Perform Role Mining](/docs/identitymanager/6.1/index.md)
...
2. Generate and analyze
   [reports](/docs/identitymanager/6.1/index.md) with
   tools like
   [Power BI](/docs/identitymanager/6.1/index.md) to
...
[manual](/docs/identitymanager/6.1/access-control-security/role-assignment/index.md)
...
| Input                                                                                                                                                                                             | Output                |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (required) [Role assignment rules](/docs/identitymanager/6.1/index.md) (required) [Role mining](/docs/identitymanager/6.1/index.md) (optional) | Minimized derogations |
...
push the
[automation wall](/docs/identitymanager/6.1/index.md)
further.

## Overview

After the role catalog is established, the
[Compute-RoleModel](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
...
[mining rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[See more details about role mining](/docs/identitymanager/6.1/governance/role-mining.md).
...
| Input                                                         | Output            |
| ------------------------------------------------------------- | ----------------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Single role rules |
...
2. Click on the addition button at the top right and fill in the fields.
   ...
   - `Policy`:
     [policy](/docs/identitymanager/6.1/index.md)
     in which the mining rule exists.
   - `Entity Type`:
     [entity type](/docs/identitymanager/6.1/index.md)
     on which the mining rule is applied, i.e. the entity type targeted by role mining's
     entitlement analysis.
   - `Category`:
     [category](/docs/identitymanager/6.1/index.md)
...
4. Click on **Simulate** to perfom role mining in a
   [simulation](/docs/identitymanager/6.1/index.md).
...
How to define
[composite roles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
A
[composite role](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
| Input                                                         | Output          |
| ------------------------------------------------------------- | --------------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Composite roles |
...
5. Create at least one
   [single role rule](/docs/identitymanager/6.1/index.md)
...
How to create a
[connector](/docs/identitymanager/6.1/index.md)
dedicated to the automation of identity management (creation, update, deletion), via the
[synchronization](/docs/identitymanager/6.1/index.md)
...
[create the initial identity repository](/docs/identitymanager/6.1/index.md).
...
| Input                                                                | Output       |
| -------------------------------------------------------------------- | ------------ |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) | HR connector |
...
1. Outside Usercube,
   [model your connector](/docs/identitymanager/6.1/index.md).
2. [Declare an HR connector](/docs/identitymanager/6.1/index.md)
...
3. [Create an Export CSV connection](/docs/identitymanager/6.1/index.md)
...
4. [Create the entity types](/docs/identitymanager/6.1/index.md)
...
5. Don't forget to
   [reload](/docs/identitymanager/6.1/index.md)
   and
   [synchronize](/docs/identitymanager/6.1/index.md)
...
- the
  [initial identities loading](/docs/identitymanager/6.1/index.md)
  and the creation of the identity repository;
- [connector modeling](/docs/identitymanager/6.1/index.md)
  which is the analysis phase before connector creation;
- [entity type creation](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                          | Output                      |
| -------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [Initial identities loading](/docs/identitymanager/6.1/index.md) (required) New identity data model (required) | Updated identity data model |
...
[instructions for entity type creation](/docs/identitymanager/6.1/index.md).
...
- #### [Modify the Identity Data Model](/docs/identitymanager/6.1/index.md)

  How to make data model properties evolve according to the organization's needs.

- #### [Create an HR Connector](/docs/identitymanager/6.1/index.md)
...
- #### [Manage Risks](/docs/identitymanager/6.1/index.md)
...
- #### [Create a Policy](/docs/identitymanager/6.1/index.md)

  How to define policies to organize roles and rules.

- #### [Automate the Review of Non-conforming Assignments](/docs/identitymanager/6.1/index.md)

  How to automate the review of non-conforming assignments through automation rules.

- #### [Automate Assignments](/docs/identitymanager/6.1/index.md)

  How to automate entitlement assignment.

- #### [Automate Role Assignments](/docs/identitymanager/6.1/index.md)
  How to manually build rules to automate the assignment of roles to identities.- ####
  [Perform Role Mining](/docs/identitymanager/6.1/index.md)
  ...
  [Remove Redundant Assignments](/docs/identitymanager/6.1/index.md)
  How to remove redundant assignments, i.e. manual assignments of roles and resource types that
  are assigned by a rule too.
- #### [Create a Composite Role](/docs/identitymanager/6.1/index.md)
...
- #### [Perform a Simulation](/docs/identitymanager/6.1/index.md)
...
[ Review Non-conforming Assignments ](/docs/identitymanager/6.1/index.md)
and
[Automation Rule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
topics for additional information.
...
[ Review Non-conforming Assignments ](/docs/identitymanager/6.1/index.md)
and
[ Categorize Resources ](/docs/identitymanager/6.1/index.md)
topics for additional information.
...
a navigation rule.
[See more details on roles and navigation rules](/docs/identitymanager/6.1/index.md).
...
2. In the UI,
   [create a single role](/docs/identitymanager/6.1/index.md#create-a-single-role).
...
3. [Create one navigation rule](/docs/identitymanager/6.1/index.md)
...
In order to verify the process,
[request manually](/docs/identitymanager/6.1/index.md)
...
How to define
[policies](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
| Input                                                          | Output |
| -------------------------------------------------------------- | ------ |
| [Resource type](/docs/identitymanager/6.1/index.md) (optional) | Policy |
...
How to use the
[risk management](/docs/identitymanager/6.1/governance/risks.md)
...
- Compute the corresponding
  [risk score](/docs/identitymanager/6.1/governance/risks.md#risk-score).
- Schedule
  [access certification campaigns](/docs/identitymanager/6.1/index.md)
  accordingly.
...
| Input                                                                                                                              | Output        |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Role catalog](/docs/identitymanager/6.1/index.md) (required) | Risks catalog |
...
3. Fill in the fields.
   ...
   - `Remediation`: potential alternative solutions that will be displayed with the exemption
     policy message.
   - [`Exemption Policy`](/docs/identitymanager/6.1/governance/risks.md)
   - [`Type`](/docs/identitymanager/6.1/governance/risks.md)
   - `Level`: risk level that is used to compute
     [risk scores](/docs/identitymanager/6.1/governance/risks.md).
   - `Rules`: a risk is based on the union of
     [rules](/docs/identitymanager/6.1/governance/risks.md),
   ...
   [**Role Review**](/docs/identitymanager/6.1/index.md)
   ...
   [navigation property](/docs/identitymanager/6.1/index.md),
...
4. Choose the
   [resource type](/docs/identitymanager/6.1/index.md)
...
6. Choose a value for this navigation property. The value would be a resource from the unified
   [resource repository](/docs/identitymanager/6.1/index.md).
...
7. Click on **Create**.
   ...
   the
   [complete job](/docs/identitymanager/6.1/index.md)
...
[role catalog](/docs/identitymanager/6.1/index.md),
[role assignment rules](/docs/identitymanager/6.1/index.md)
and
[resource correlation rules](/docs/identitymanager/6.1/index.md),
using a dedicated
[policy](/docs/identitymanager/6.1/index.md).
...
- [correlation rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  and
  [classification rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md);
- [scalar rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  and
  [navigation rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md);
- [resource type rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md);
- [single roles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  and
  [composite roles](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md);
- [single role rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  and
  [composite role rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).

A simulation can also be created by the
[role mining tool](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                                                                                                                       | Output             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| [Role catalog](/docs/identitymanager/6.1/index.md) (optional) [Role assignment rules](/docs/identitymanager/6.1/index.md) (optional) [Categorized resources](/docs/identitymanager/6.1/index.md) (optional) | Updated role model |
...
[resource types](/docs/identitymanager/6.1/index.md).
...
[Read more about the purpose of classification](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                                                                   | Output               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| [Resource type](/docs/identitymanager/6.1/index.md) (required) [Synchronized data](/docs/identitymanager/6.1/index.md) (required) [Correlation rules](/docs/identitymanager/6.1/index.md) (recommended) | Classification rules |
...
[Read more about the purpose of correlation](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                                                                  | Output            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Resource type](/docs/identitymanager/6.1/index.md) (required) [Synchronized data](/docs/identitymanager/6.1/index.md) (required) | Correlation rules |
...
2. Fill in the fields.
   ...
   - **Source Object**: at least one property from the source system that is going to be linked to
     ...
     [expression](/docs/identitymanager/6.1/tools-utilities/toolkit/expressions.md).
...
[orphaned accounts](/docs/identitymanager/6.1/index.md)
...
[be justified](/docs/identitymanager/6.1/index.md),
...
[**Classification**](/docs/identitymanager/6.1/index.md)
...
below 100%.
[Find more details](/docs/identitymanager/6.1/index.md).
...
[role model](/docs/identitymanager/6.1/index.md).
...
[additional policies can be created](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                                                                                                              | Output                                                          |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) [Connector](/docs/identitymanager/6.1/index.md) (required) [Synchronized data](/docs/identitymanager/6.1/index.md) (required) | Categorized resources Correlated accounts Orphaned account list |
...
2. Create the appropriate
   [correlation rules](/docs/identitymanager/6.1/index.md);
3. Create the appropriate
   [classification rules](/docs/identitymanager/6.1/index.md)
...
[simulations](/docs/identitymanager/6.1/index.md) in
order to previsualize changes.

## Next Steps

Once accounts are categorized, integrators can start
[creating provisioning rules](/docs/identitymanager/6.1/index.md).

Categorization also enables the
[review of orphaned and unused accounts](/docs/identitymanager/6.1/index.md).
...
A
[resource type](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[entity types](/docs/identitymanager/6.1/index.md).
...
[Read more about ownership relationships](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                                                                     | Output        |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (optional) [Target connector](/docs/identitymanager/6.1/index.md) (required) [Synchronized data](/docs/identitymanager/6.1/index.md) (optional) | Resource type |
...
2. Fill in the fields.
   ...
   - `Category`: category assigned to the resource type. It can be chosen from among the existing
     categories or
     [created](/docs/identitymanager/6.1/index.md)
   ...
   - `Arguments Expression`: when using a connection for automatic provisioning, C# expression used
     ...
     [Find examples](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
   ...
   - `Remove If Orphaned`: enables Usercube to automatically deprovision resources when their owner
     ...
     [**Resource Reconciliation**](/docs/identitymanager/6.1/index.md)
   ...
   - `Require Provisioning Review`: forces an additional mandatory review of all
     ...
     [**Provisioning Review**](/docs/identitymanager/6.1/index.md)
     screen).
   ...
   - `Discard Manual Assignments`: allows the provisioning of a new value computed by a
     ...
     >
     > [See a full example](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
   ...
   - `Depends On Resource Type`: potential resource type (other than the one presently created)
     ...
     > [Find a full example](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[workflows](/docs/identitymanager/6.1/index.md).
...
[See how to create a new worker in Usercube](/docs/identitymanager/6.1/index.md).
...
[See more information about homonym detection](/docs/identitymanager/6.1/index.md).
...
| Input                                                                | Output                        |
| -------------------------------------------------------------------- | ----------------------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) | Adjusted Onboarding Workflows |
...
[configuring a connector](/docs/identitymanager/6.1/index.md).

# Create a Connection

How to create a
[connection](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
inside a [connector](/docs/identitymanager/6.1/connectors-integration/index.md)
...
| Input                                                                                                                                 | Output        |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| [Connector container](/docs/identitymanager/6.1/index.md) (required) [Connector model](/docs/identitymanager/6.1/index.md) (required) | Connection(s) |
...
- Do we need
  [incremental or complete](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md)[synchronizations](/docs/identitymanager/6.1/index.md),
  or both?

  [Incremental synchronizations](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md),
  usually launched approximatively every two hours, are to be performed for real-time needs, while
  [complete synchronizations](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md),
...
[secured options](/docs/identitymanager/6.1/connectors-integration/connector-configuration/connections.md#secured-options)
...
1. click on **Check Connection** to ensure that Usercube can reach the managed system;
   ...
   [incremental and complete](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md)
...
[agent](/docs/identitymanager/6.1/index.md). Connectors
...
2. Click on the addition icon and fill in the information fields.
   ...
   - `Agent`:
     [agent](/docs/identitymanager/6.1/index.md) that
     the connector is supposed to use.

     NETWRIX recommends choosing the provided SaaS agent.

   - `Complete Job`:
     [job](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md)
     scheduled to perform a set of tasks, including
     complete[synchronization and/or provisioning](/docs/identitymanager/6.1/index.md)
   ...
   - `Incremental Job`:
     ...
     incremental[synchronization and/or provisioning](/docs/identitymanager/6.1/index.md)
     for all the connectors, for which you selected the corresponding checkbox.
...
[single role catalog creation](/docs/identitymanager/6.1/index.md).
...
5. Ensure the following guidelines' enforcement:
   ...
   **Keep it readable for most users**
   ...
   ([synchronization](/docs/identitymanager/6.1/index.md)/[provisioning](/docs/identitymanager/6.1/index.md)
...
[keys](/docs/identitymanager/6.1/index.md)
...
[resource type](/docs/identitymanager/6.1/index.md) per
account type and map each one to a
[role](/docs/identitymanager/6.1/index.md)
for assignment and
[provisioning](/docs/identitymanager/6.1/index.md).
...
**Roles:** During the
[creation of the role catalog](/docs/identitymanager/6.1/index.md)
...
[navigation rules](/docs/identitymanager/6.1/index.md)
...
1. Start by creating the entity type with its
   [scalar properties](/docs/identitymanager/6.1/index.md)
   and
   [keys](/docs/identitymanager/6.1/index.md).
...
6. Click on **Save & Close**.
   ...
   [`Update-EntityPropertyExpressionsTask`](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
   runs.
...
[display name](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
for resources of an
...
4. In the entity type's **Properties** section, choose a source so that the connection provides the
   ...
   > retrieved when we
   > [refreshed the schemas](/docs/identitymanager/6.1/index.md)
...
To continue,
[define at least one scalar property](/docs/identitymanager/6.1/index.md)
...
- if this is the case, then click on
  [**Refresh all schemas**](/docs/identitymanager/6.1/index.md)
  on the connector page, and verify that there is no error.
- if not, then you must
  [create at least one connection](/docs/identitymanager/6.1/index.md).
...
[resource type](/docs/identitymanager/6.1/index.md)).
It defines a set of
[properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md#properties)
...
([navigation properties](/docs/identitymanager/6.1/index.md)),
both described later.

![Entity Type - Schema](/img/versioned_docs/identitymanager_6.1/identitymanager/user-guide/set-up/connect-system/entity-type-creation/entitytypecreation_schema.webp)

The configuration of entity types depends entirely on the
[previously established model](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                                                                  | Output      |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| [Connection](/docs/identitymanager/6.1/index.md) (required) [Refreshed schemas](/docs/identitymanager/6.1/index.md) (required) [Connector's data model](/docs/identitymanager/6.1/index.md) (required) | Entity type |

## Create an Entity Type

Create an entity type by proceeding as follows:

1. [Create the entity type](/docs/identitymanager/6.1/index.md).
2. [Define the scalar properties](/docs/identitymanager/6.1/index.md)
   to be used in the entity type.
3. [Choose the primary key and key properties](/docs/identitymanager/6.1/index.md)
   which will identify resources.
4. [Define navigation properties](/docs/identitymanager/6.1/index.md)
   if applicable.
5. [Customize the display names](/docs/identitymanager/6.1/index.md)
   for the entity type's resources.
6. [Organize the datasheets](/docs/identitymanager/6.1/index.md)
...
process, follow the
[verification procedure indicated for a synchronization](/docs/identitymanager/6.1/index.md).

# Select Primary Keys

How to choose
[key properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
and a
[mapping key](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
in order to uniquely identify the
[entity type](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)'s
...
> [query rules](/docs/identitymanager/6.1/index.md)
> for `parentdn`.
...
1. Start by
   [defining the entity type's scalar properties](/docs/identitymanager/6.1/index.md).
...
[define navigation properties](/docs/identitymanager/6.1/index.md)
and/or
[set the resources' display name](/docs/identitymanager/6.1/index.md).
...
[See the example for scalar properties](/docs/identitymanager/6.1/index.md).
...
1.  Start by
    [declaring the entity type](/docs/identitymanager/6.1/index.md).
...
5.  Click on the Gear symbol to add advanced settings if needed.
    ...
    - `Flexible Comparison Expression`: expression that inserts adaptable
      [comparison flexibility](/docs/identitymanager/6.1/index.md)
...
can
[set the resources' display names](/docs/identitymanager/6.1/index.md).
...
3. Fill in the information fields.
   ...
   - **APPLICATION METADATA**: fields about the future display of the properties inside Usercube.
     ...
     - `Format`: format used for the property's display in Usercube, for search tools and
       ...
       is not a string.
       [See more details on available formats](/docs/identitymanager/6.1/connectors-integration/connector-configuration/entity-property-mapping.md).
...
[choose the entity type's keys](/docs/identitymanager/6.1/index.md)
...
[agent](/docs/identitymanager/6.1/index.md).

Usercube provides demo applications
([Banking](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
and
[HR](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md))
...
| Input                                                                                                                                                                                                                                      | Output                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------- |
| Administrator account for the [development environment](/docs/identitymanager/6.1/index.md) (required) [Identity repository](/docs/identitymanager/6.1/index.md) (required) [User profiles](/docs/identitymanager/6.1/index.md) (required) | Connector Connected System |
...
1. Outside Usercube,
   [model](/docs/identitymanager/6.1/index.md)
   the system's data structure.
2. [Create a connector](/docs/identitymanager/6.1/index.md)
   for said managed system.
3. Enable the technical transfer of data by
   [creating and configuring connections](/docs/identitymanager/6.1/index.md).
4. [Set up entity types](/docs/identitymanager/6.1/index.md)
...
[configuring synchronization](/docs/identitymanager/6.1/index.md).
...
[installation of the bootstrap version](/docs/identitymanager/6.1/getting-started/quick-start.md).
...
[creating the workforce directory](/docs/identitymanager/6.1/index.md).

# Set Up

- #### [Install the Development Environment](/docs/identitymanager/6.1/index.md)

  How to connect to Usercube's SaaS environment to set up the development environment.

- #### [Create the Workforce Repository](/docs/identitymanager/6.1/index.md)

  How to initiate the repository for workforce identities by loading identities into Usercube with
  the right attributes.

- #### [Configure Unique Property Generation](/docs/identitymanager/6.1/index.md)
  How to configure Usercube to generate unique identifiers, mails and logins for any user who does
  not have them already.- ####
  [Load Identities to Usercube](/docs/identitymanager/6.1/index.md)
  How to load identities into Usercube for the first time using a basic data model in the form of
  a template MS Excel file.- ####
  [Template Description](/docs/identitymanager/6.1/index.md)
  Description of the MS Excel template for the creation of the identities repository.- ####
  [Adjust the Workforce Data Model](/docs/identitymanager/6.1/index.md)
...
- #### [Configure a User Profile](/docs/identitymanager/6.1/index.md)

  How to tweak the permissions for actions within Usercube, for a standard set of basic Usercube
  profiles.

- #### [Configure Onboarding Workflows](/docs/identitymanager/6.1/index.md)

  How to adjust the parameters of onboarding workflows.

- #### [Connect to a Managed System](/docs/identitymanager/6.1/index.md)

  How to create a new connector using the provided SaaS agent.

- #### [Model the Data](/docs/identitymanager/6.1/index.md)
  How to choose the appropriate model for a connector's data.- ####
  [Create the Connector](/docs/identitymanager/6.1/index.md)
  ...
  [Create an Entity Type](/docs/identitymanager/6.1/index.md)
  How to create an entity type that corresponds to the connector model.
- #### [Synchronize Data](/docs/identitymanager/6.1/index.md)
...
- #### [Create a Resource Type](/docs/identitymanager/6.1/index.md)
  How to create the container for future correlation and classification rules inside a given
  managed system.- ####
  [Correlate Resources](/docs/identitymanager/6.1/index.md)
...
- #### [Create Resources](/docs/identitymanager/6.1/index.md)
...
- #### [Create Roles in Bulk](/docs/identitymanager/6.1/index.md)
  How to create role naming rules, which create single roles using existing naming conventions
  from the managed system.- ####
  [Create a Category](/docs/identitymanager/6.1/index.md)
  How to structure roles into categories.- ####
  [Create a Role Manually](/docs/identitymanager/6.1/index.md)
  How to create single roles manually.
- #### [Assign Users a Profile](/docs/identitymanager/6.1/index.md)

  How to assign Usercube's access permissions to users through profiles.

- #### [Manage Role Officers](/docs/identitymanager/6.1/index.md)
...
| Input                                                                                                                                            | Output                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| [Usercube's server](/docs/identitymanager/6.1/index.md) (required) [Initial workforce repository](/docs/identitymanager/6.1/index.md) (required) | Adjusted workforce repository |
...
3. Observe the result and adjust manually the data model if needed, by clicking on the properties.
   ...
   [Modifications can be performed](/docs/identitymanager/6.1/index.md)
...
[loading identities](/docs/identitymanager/6.1/index.md)
...
| Input                                                              | Output                                 |
| ------------------------------------------------------------------ | -------------------------------------- |
| [Usercube's server](/docs/identitymanager/6.1/index.md) (required) | Generation rules for unique properties |
...
[See more information about the identity repository](/docs/identitymanager/6.1/identity-management/identity-repository.md).
...
[enhance it](/docs/identitymanager/6.1/index.md)
...
[Read more about why you should postpone connecting your HR data](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                                                    | Output                       |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| [Usercube's server](/docs/identitymanager/6.1/index.md) (required) Organizational chart (required)) HR data (required) Third-party staff data (optional) | Initial workforce repository |

## Create the Workforce Repository

Create the workforce repository by proceeding as follows:

1. [Configure the generation of unique properties](/docs/identitymanager/6.1/index.md)
   for all users, pre-existing and new, who do not have them yet.
2. [Load identities to Usercube](/docs/identitymanager/6.1/index.md)
   based on the recommended attributes from the provided
   [organizational model template](/docs/identitymanager/6.1/index.md).
3. [Adjust the identity data model](/docs/identitymanager/6.1/index.md)
...
[user profile configuration](/docs/identitymanager/6.1/index.md).

From there you will be able to keep your repository up to date:

- [concerning identity data](/docs/identitymanager/6.1/index.md)
  through workflows;
- [concerning the data model](/docs/identitymanager/6.1/index.md)

The initial identities loading also enables:

- [HR connector creation](/docs/identitymanager/6.1/index.md).
...
| Input                                                                                                                   | Output                       |
| ----------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| [Usercube's server](/docs/identitymanager/6.1/index.md) (required) HR data (required) Third-party staff data (optional) | Initial workforce repository |
...
4. Fill said template with the data you collected.
   ...
   [**more details about the template's description**](/docs/identitymanager/6.1/index.md).
   ...
   **Create your initial workforce repository with only recommended attributes.**
   ...
   2. Connect the AD,
      [synchronize](/docs/identitymanager/6.1/index.md)
      AD data, update
      [correlation and classification](/docs/identitymanager/6.1/index.md).
   3. Follow
      [the usual query procedure](/docs/identitymanager/6.1/index.md)
...
[modify (massively) identity data](/docs/identitymanager/6.1/index.md).

## User - Required

[An identity is split into two parts](/docs/identitymanager/6.1/identity-management/index.md),
...
| Attribute                                                                                | Type       | Description                                                                                                                                                                                                                                                                     |
| ---------------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| RecordIdentifier (recommended)                                                           | String     | Identifier of the [record](/docs/identitymanager/6.1/identity-management/joiners-movers-leavers/position-changes.md). **Note:** it can be the same as `PositionIdentifier` when users can have no more than one contract simultaneously. **Note:** required when using records. |
...
[navigation rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
and/or
[query rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[scalar and navigation properties](/docs/identitymanager/6.1/index.md)
...
[configured to block provisioning](/docs/identitymanager/6.1/index.md),
...
| Input                                                           | Output                                    |
| --------------------------------------------------------------- | ----------------------------------------- |
| [Categorization](/docs/identitymanager/6.1/index.md) (required) | Scalar rules Navigation rules Query rules |

## Create Provisioning Rules

- [Create resource type rules](/docs/identitymanager/6.1/index.md)
  to automatically create resources.
- [Create scalar rules](/docs/identitymanager/6.1/index.md)
  to compute scalar properties;
- [Create navigation and/or query rules](/docs/identitymanager/6.1/index.md)
...
[creating the single role catalog](/docs/identitymanager/6.1/index.md).
...
[single role](/docs/identitymanager/6.1/index.md),
and/or user
[dimensions](/docs/identitymanager/6.1/access-control-security/role-assignment/conforming-assignments.md#dimensions).
...
- the only reason to have several rules to compute a single property is when changing the property
  value over time, via
  [time offsets](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
| Input                                                           | Output                       |
| --------------------------------------------------------------- | ---------------------------- |
| [Categorization](/docs/identitymanager/6.1/index.md) (required) | Navigation rules Query rules |
...
4. Fill in the fields.
   ...
   - `Confidence Rate`: rate expressing the confidence in this link, and its priority order.
     [See the detailed explanation](/docs/identitymanager/6.1/index.md).
...
2. Review
   [unauthorized accounts](/docs/identitymanager/6.1/index.md)
...
| Input                                                           | Output              |
| --------------------------------------------------------------- | ------------------- |
| [Categorization](/docs/identitymanager/6.1/index.md) (required) | Resource type rules |
...
4. See the new account in the user's **View Permissions** tab.
   ...
   related to a
   [navigation rule](/docs/identitymanager/6.1/index.md).
...
| Input                                                           | Output       |
| --------------------------------------------------------------- | ------------ |
| [Categorization](/docs/identitymanager/6.1/index.md) (required) | Scalar rules |
...
4. Fill in the fields.
   ...
   - `Applicable`: `Create & Update` to use this computation to both provision the managed system
     ...
     > [provisioning state](/docs/identitymanager/6.1/index.md)
     > to `Verified` without
     > [synchronization](/docs/identitymanager/6.1/index.md).

   - `Comparison type`:
     [comparison type](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
2. [Review unreconciled properties](/docs/identitymanager/6.1/index.md)
...
[categories](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[validator](/docs/identitymanager/6.1/index.md)
per category.
...
| Input                                                         | Output     |
| ------------------------------------------------------------- | ---------- |
| [Role catalog](/docs/identitymanager/6.1/index.md) (optional) | Categories |
...
2. All existing
   [categories](/docs/identitymanager/6.1/index.md)
...
4. Click on **Create** and see the category added in the menus.
   ...
   [validators](/docs/identitymanager/6.1/index.md)
...
[roles](/docs/identitymanager/6.1/core-concepts/role-model.md#roles) needed by
...
- assign roles to users, by
  [requesting them manually](/docs/identitymanager/6.1/index.md),
  or using
  [rules that assign roles automatically](/docs/identitymanager/6.1/index.md)
...
- a role is part of a policy which is a subgroup of the role model.
  [Read more about the concept of role model](/docs/identitymanager/6.1/index.md).
...
- to be effective, roles must be linked to actual entitlements in the managed systems. Technically
  ...
  must create a
  [navigation rule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
[model established](/docs/identitymanager/6.1/index.md)
...
[manually](/docs/identitymanager/6.1/index.md),
...
| Input                                                                                                                                                                                                       | Output              |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| [Connector's data model](/docs/identitymanager/6.1/index.md) (required) [Provisioning Rules](/docs/identitymanager/6.1/index.md) (required) [Classification](/docs/identitymanager/6.1/index.md) (required) | Single role catalog |
...
2. Complete the role catalog if needed by creating manually additional
   [categories](/docs/identitymanager/6.1/index.md)
   and
   [single roles with their navigation rules](/docs/identitymanager/6.1/index.md).
3. Add
   [composite roles](/docs/identitymanager/6.1/index.md)
...
[role officer management](/docs/identitymanager/6.1/index.md).

The role catalog is also a prerequisite for
[risk management](/docs/identitymanager/6.1/index.md).
...
A
[single role](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
| Input                                                           | Output       |
| --------------------------------------------------------------- | ------------ |
| [Classification](/docs/identitymanager/6.1/index.md) (required) | Single roles |
...
3. Fill in the fields.
   ...
   - `Allow Manual Assignment`: allows the role to be requested manually.
     ...
     [single role rules](/docs/identitymanager/6.1/index.md)
...
How to create
[role naming rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md),
which create single roles using existing naming conventions from the managed system.

## Overview

A
[role naming rule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
| Input                                                               | Output                                                    |
| ------------------------------------------------------------------- | --------------------------------------------------------- |
| [Provisioning Rules](/docs/identitymanager/6.1/index.md) (required) | Role naming rule Single roles Navigation rules Categories |
...
4. Fill in the fields.
   ...
   - **+ New Rule**: a naming rule is based on the union of
     [rules](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md),
     themselves based on the intersection of
     [rule items](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
   ...
   - **Single Role**:
     [single role(s)](/docs/identitymanager/6.1/index.md)
     to be created.
...
A [connector](/docs/identitymanager/6.1/index.md)'s
main purpose is to read and export the data
[previously mapped with entity types](/docs/identitymanager/6.1/index.md)
...
The
[`Prepare Synchronization` task](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
...
The
[`Synchronize` task](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
loads data into Usercube's database.

[**Read more about the synchronization process**](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md).
...
[`Connector` attributes](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md):
...
| Input                                                                            | Output            |
| -------------------------------------------------------------------------------- | ----------------- |
| [Connector with its entity types](/docs/identitymanager/6.1/index.md) (required) | Synchronized data |
...
2. On the relevant connector page, in the **Entity Types** frame, click on **Jobs**.
   ...
   [connection(s) and package(s)](/docs/identitymanager/6.1/index.md),
   all these tasks can be launched either in
   [incremental or complete](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md)
   mode.
...
[jobs](/docs/identitymanager/6.1/automation/jobs-tasks/job-configuration.md) provided by
Usercube:
...
4. Access the relevant entity types (from the menu items on the left of the home page) to check
   ...
   > simple
   > [user-group schema](/docs/identitymanager/6.1/index.md)
...
previously in the
[connector's configuration](/docs/identitymanager/6.1/index.md).
...
[ AssignedProfile ](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
and
[ References: Permissions ](/docs/identitymanager/6.1/access-control-security/profiles-permissions/permissions-reference.md)
topics for additional information.
...
[AccessControlRule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
topic for additional information.
...
How to tweak the
[permissions](/docs/identitymanager/6.1/access-control-security/profiles-permissions/permissions-reference.md)
...
- administration, which gives access to
  [administration](/docs/identitymanager/6.1/index.md) actions,
...
- reports, which gives access to Usercube's
  [predefined reports](/docs/identitymanager/6.1/index.md)
  about workforce.
...
[assigned to power users](/docs/identitymanager/6.1/index.md).
...
| Input                                                                | Output        |
| -------------------------------------------------------------------- | ------------- |
| [Identity repository](/docs/identitymanager/6.1/index.md) (required) | User profiles |
...
[See these instructions for assigning profiles to users](/docs/identitymanager/6.1/index.md).

## Next Steps

Once user profiles are configured, integrators can start
[configuring onboarding workflows](/docs/identitymanager/6.1/index.md).
...
- Connectors and Integrations
  - Some systems using the LDAP protocol require some attributes for creation and/or update
    ...
    [documentation](/docs/identitymanager/6.1/connectors-integration/connector-packages/ldap.md).
...
- UI / UX
  - A new custom menu link feature has been added. It enables the configuration of custom links
    ...
    [documentation](/docs/identitymanager/6.1/configuration-reference/network-configuration/index.md)
...
[Migration](/docs/identitymanager/6.1/index.md) section must therefore
be followed.
...
[MySQL](/docs/identitymanager/6.1/connectors-integration/connector-packages/sql-databases.md)
and
[Oracle](/docs/identitymanager/6.1/connectors-integration/connector-packages/sql-databases.md)
for more information.
...
- Access Control and Workflows
  - Homonym searches are now more customizable. See the
    [documentation](/docs/identitymanager/6.1/index.md)
    for more information.
...
- Connectors and Integrations
  ...
  - Two new connectors are now available for EasyVista in the Usercube marketplace. One allows the
    ...
    [users](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
    and
    [tickets](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
...
- Jobs and Policy
  ...
  - Integrated a new "Literal" expression option, reducing the need for C# code for simple cases.
    ...
    [documentation](/docs/identitymanager/6.1/tools-utilities/toolkit/expressions.md)
    for more information.
...
- Other
  - The configuration can now be deployed remotely via an HTTP post request. See the
    [documentation](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
    for more information.
...
- Logs / Performance / Security
  ...
  - For added security, the file paths used in a connector's connections are now checked against a
    ...
    [documentation](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
  - Added encryption support for appsettings.json agent and server files. More information is
    ...
    [agent](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
    and for the
    [server](/docs/identitymanager/6.1/installation-setup/server-configuration.md).
...
- Other
  ...
  - Two new utility functions for C# expressions: `BuildUsername` and `BuildUsernameWithInitials`.
    See the
    [C# utility functions section](/docs/identitymanager/6.1/tools-utilities/toolkit/csharp-functions.md)
...
- Other
  - Added the possibility to specify a minimum authentication algorithm for SAML configuration
    ...
    [�End User Authentication' section](/docs/identitymanager/6.1/access-control-security/authentication/end-user-authentication.md).
...
- Connectors and Integrations
  ...
  - To prevent password constraint errors, a new configuration setting,
    ...
    documentation's
    [�References' section](/docs/identitymanager/6.1/configuration-reference/network-configuration/index.md).
...
- Jobs and Policy
  ...
  - Indirect permissions can now be displayed on user permission screens. See the
    [documentation](/docs/identitymanager/6.1/access-control-security/role-assignment/indirect-permissions.md)
    for more information.
...
in the documentation's [Migration](/docs/identitymanager/6.1/index.md)
...
This release includes compatibility ruptures. The migration steps in the documentation's
[�Migration' section](/docs/identitymanager/6.1/index.md) must therefore
