...
[the blocked job can be resumed](/docs/identitymanager/6.1/index.md)
(or not).
...
Distinct
[thresholds are configurable for provisioning](/docs/identitymanager/6.1/identity-management/provisioning/provisioning-thresholds.md).
