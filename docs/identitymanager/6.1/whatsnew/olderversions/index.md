...
- Connectors and Integrations
    - Some systems using the LDAP protocol require some attributes for creation and/or update
      ...
      [documentation](/docs/identitymanager/6.1/integration-guide/connectors/references-connectors/ldap/index.md).
...
- UI / UX
    - A new custom menu link feature has been added. It enables the configuration of custom links
      ...
      [documentation](/docs/identitymanager/6.1/integration-guide/network-configuration/settings/index.md)
...
[Migration](/docs/identitymanager/6.1/migration-guide/index.md) section must therefore
be followed.
...
and
[Oracle](/docs/identitymanager/6.1/integration-guide/connectors/references-packages/oracle-database/index.md)
for more information.
...
- Access Control and Workflows
    - Homonym searches are now more customizable. See the
      [documentation](/docs/identitymanager/6.1/integration-guide/workflows/how-to/configure-homonym-test/index.md)
      for more information.
...
- Certifications and Risks
    - The certification campaign page has been simplified to facilitate the review of access items:
      ...
      ![Certification](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.certification.webp)
- Connectors and Integrations
    ...
    - Two new connectors are now available for EasyVista in the Usercube marketplace. One allows the
      ...
      [users](/docs/identitymanager/6.1/integration-guide/connectors/references-connectors/easyvista/index.md)
      and
      [tickets](/docs/identitymanager/6.1/integration-guide/connectors/references-connectors/easyvistaticket/index.md).
    ...
    - For the ServiceNow package and the ServiceNow ticket package, client id and secret have been
      ...
      ![SecureOptions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.servicenowsecureoptions.webp)
...
- Jobs and Policy
    - When a job is blocked due to exceeding a synchronization threshold, a "Synchronization
      ...
      changed resources
      ![DepassedThresholdCounters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.depassedthresholdcounters.webp)![DepassedThresholdChanges](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.depassedthresholdchanges.webp)
    - Integrated a new "Literal" expression option, reducing the need for C# code for simple cases.
      ...
      [documentation](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/index.md)
      for more information.
    - The role model simulation has been redesigned and has more fonctionality.
      ![SimulationAddDelete](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.simulationadddelete.webp)![SimulationResults](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.simulationresults.webp)
    - Resource Types have a new option, "Depends On" which assures that resource types are created
      ...
      Directory account.
      ![ResourceTypeDependsOn](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.resourcetypedependson.webp)
...
- UI / UX
    - The dashboard has been enhanced. Icons are now color-customizable and administration icons are
      ...
      ![Dashboard](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.dashboard.webp)
    ...
    - Entity histories are now available. Browse an entity's history and view all the events related
      ...
      dates.
      ![ViewHistory](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.viewhistory.webp)
    - An entity's data can now be viewed as of a specific date.
      ![DataAsOfDate](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.dataasofdate.webp)
    ...
    - The screen for defining automation rules has been improved for clarity.
      ![AutomationRules](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.3.automationrules.webp)
- Other
...
- Other
    - The configuration can now be deployed remotely via an HTTP post request. See the
      [documentation](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/server/deployconfigurationtask/index.md)
      for more information.
...
- Access Control and Workflows
    ...
    - Workflows that are in process or have been previously saved, can now be aborted. Once aborted,
      ...
      workflow.
      ![WorkflowAbort](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.workflowabort.webp)![WorkflowPurge](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.workflowpurge.webp)
...
- Connectors and Integrations
    - A new button on the connector screen refreshes all the connector's schemas.
      ![ConnectorRefreshAllSchemas](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.connectorrefreshallschemas.webp)
    ...
    - For the Excel connection package, different file paths can now be specified for complete
      ...
      ![ExcelSynchroPaths](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.excelsynchropaths.webp)
    - On the entity mapping screen, a mapped column is no longer removed from the mapping selection
      ...
      ![RemapColumns](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.remapcolumns.webp)
    ...
    - For connection packages that manage an incremental synchronization mode, the jobs button now
      ...
      ![JobCompleteAndIncremental](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.virtualjobcompleteandincremental.webp)
...
- Jobs and Policy
    ...
    - On the provisioning review and resource reconciliation screens, we are now able to postpone
      ...
      ![PostponDecision](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.postponedecision.webp)
    - The permission assignment pop-up has been enhanced.
        ...
        - an item can be deleted with the button on each line
          ![PermissionsPopup](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.permissionpopup.webp)
    - Added ability to see the role requester's comment on the role review screen and in the role
      review notification email.
      ![RoleReviewComment](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.rolereviewcomment.webp)
    - On the provisioning review screen, it is now possible to filter by resource type and by
      specific properties.
      ![ProvisioningReviewWithPropertyView](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.provisioningreviewwithpropertyview.webp)
...
- Logs / Performance / Security
    ...
    - For added security, the file paths used in a connector's connections are now checked against a
      ...
      [documentation](/docs/identitymanager/6.1/integration-guide/network-configuration/agent-configuration/appsettings-agent/index.md).
    - Added encryption support for appsettings.json agent and server files. More information is
      ...
      [agent](/docs/identitymanager/6.1/integration-guide/network-configuration/agent-configuration/rsa-encryption/index.md)
      and for the
      [server](/docs/identitymanager/6.1/integration-guide/network-configuration/server-configuration/rsa-encryption/index.md).
...
- UI / UX
    ...
    - When several records are changed in a workflow, the Workflow Overview screen now gives a
      ...
      ![WorkflowOverviewSeePositions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.workflowoverviewseepositions.webp)
    - In workflows, child component labels are now displayed when using the `LayoutRowSet` component
      ![ChildLabels](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.childlabelsonlayoutrowset.webp)
    ...
    - Automation Rules (formerly Pending Approval Rules) can now be created via the Access Rules
      screen.
      ![AutomationRules](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.automationrules.webp)
    ...
    - An indicator is now displayed in the connection list when the last schema update failed.
      ![RefreshSchemaFailIndicator](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.2.refreshschemafailindicator.webp)
- Other
    ...
    - Two new utility functions for C# expressions: `BuildUsername` and `BuildUsernameWithInitials`.
      See the
      [C# utility functions section](/docs/identitymanager/6.1/integration-guide/toolkit/expressions/csharp-utility-functions/index.md)
    ...
    - InvokeSqlCommands can now be overridden in the agent appsettings file. More information is
      available in the
      [documentation](/docs/identitymanager/6.1/integration-guide/toolkit/xml-configuration/jobs/tasks/agent/invokesqlcommandtask/index.md)
...
- Other
    - Added the possibility to specify a minimum authentication algorithm for SAML configuration
      ...
      [�End User Authentication' section](/docs/identitymanager/6.1/integration-guide/network-configuration/server-configuration/end-users-authentication/index.md).
...
- Connectors and Integrations
    ...
    - To prevent password constraint errors, a new configuration setting,
      ...
      documentation's
      [�References' section](/docs/identitymanager/6.1/integration-guide/network-configuration/settings/index.md).
...
- Connectors and Integrations
    ...
    - Add secured options fields for sensitive data in the PowerShell connection settings.
      ![Secured Options](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.securedoptions.webp)
- Jobs and Policy
    ...
    - Indirect permissions can now be displayed on user permission screens. See the
      [documentation](/docs/identitymanager/6.1/integration-guide/role-assignment/indirectpermissions/index.md)
      for more information.
      ![Indirect Permissions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.indirectpermissions.webp)
- Logs/Performance/Security
...
- UI
    ...
    - Orphan and Uncategorized filters on resource screens have been improved.
      ![Orphan and Uncategorized filters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.orphanuncat.webp)
    ...
    - New links to owners on Reconciliation and Provisioning Review screens.
      ![Links on Reconciliation](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.linksfromresourcerec.webp)![Links on Provisioning Review](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.linksfromprovreview.webp)
    - New fields for existing options are now configurable on the ResourceType creation screens:
        ...
        - Correlate Multiple Resources
          ![New Options Resource Types](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.resourcetypenewoptions.webp)
    ...
    - Improved the workflow state filter on the Role Review page: all "Pending approval" workflow
      ...
      ![Pending Approval Filters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.pendingapprovalsimplification.webp)
- Workflows and Access Control
    - On the "My Tasks" screen, it is now possible to attribute tasks to a member of a review team.
      ![Assign Tasks 1](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.assignedto1.webp)![Assign Tasks 2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.1.assignedto2.webp)
...
in the documentation's [Migration](/docs/identitymanager/6.1/migration-guide/index.md)
...
- Connectors and Integrations
    ...
    - New connector configuration screens
      ![ConnectorHomePage](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.connectorhomepage.webp)
        ...
        - New Connectors
            ...
            - Storage/Home Folders
              ![MarketPlace](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.marketplace.webp)
        - Connector overview page: view information of each connector in a dashboard format.
          ![ADConnectorPage.webp](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.adconnectorpage.webp)
        - Connections: view and edit a connection, specifying the connection package and the agent
          settings.
          ![ConnectorConnection.webp](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.connectorconnection.webp)
        - Connector EntityTypes: manage the meta data of the entity type, its display, its mapping
          ...
          ![ConnectorSABEntityType.webp](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.connectorsabentitytype.webp)![ConnectorSABEntityTypeNav.webp](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.connectorsabentitytypenav.webp)
    - Correlation and classification rules can be created inside the application.
      ![CorrelationClassification](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.connectorcorrelationclassification.webp)
...
- Certifications and Risks
    ...
    - During or at the end of a certification campaign, reviewed items with a "Refused" decision can
      ...
      ![CertificationDecisions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.certificationdecisions.webp)
...
- Jobs and Policy
    ...
    - The Roles, Rules and Risks dialogs now show the author and date of the last change.
      ![RoleModelHistory](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.rolemodelhistory.webp)
    - On the Access Rules page, there is a new filter on the Type for Single/Composite roles and
      Resource Types
      ![RuleFilter](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.rulefilter.webp)
...
- Workflows and Access Control
    ...
    - A new workflow type has been created that allows mass updates:
      `WorkflowUpdateRecordEntitiesForm`![5.2.0.UpdateMultipleUsers](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.2.0.updatemultipleusers.webp)
    ...
    - The risk management module has been improved. When creating a risk, an Exemption Policy must
      be chosen. Available options are:
        ...
        - _Approval Required_: The role creating the risk must be approved before continuing on with
          ...
          ![RiskCreation](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.7.riskcreation.webp)

            On the "Add permissions" page, the "Risk" popup has been reworked to display all risks
            and their exemption policies.

            ![RiskPermissionPopup](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.7.riskpermissionpopup.webp)
            ...
            ![RiskFilterOnProvisioningReview](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.7.riskfilteronprovisioningreview.webp)
...
This release includes compatibility ruptures. The migration steps in the documentation's
[�Migration' section](/docs/identitymanager/6.1/migration-guide/index.md) must therefore
...
- UI
    ...
    - Improved the view for the manual provisioning screen so that it clearly shows the actions to
      be taken.
      ![ManualProvisioning](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.manualprovisioning.webp)
    - Added a filter in Reconciliation Review screen in order to filter by inferred / not-inferred
      ...
      ![InferredFilter](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.inferredfilter.webp)
    - The screen for reviewing assigned resources type has been improved. Now, when a user opens the
      ...
      ![UnauthorizedAccount](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.unauthorizedacct.webp)![UnauthorizedAccountProperties](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.unauthorizedacctproperties.webp)
    - Previously, a user could not add permissions if another, exactly identical permission with the
      ...
      ![ConflictingDates](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.conflictingdates.webp)
    ...
    - Display a minimum amount of information when a resource processed in the workflow has not yet
      ...
      ![ChangeSummaryDeletion](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.6.changesummarydelete.webp)
...
- New display indicators are available to indicate certain resource attributes (for example: VIP,
  ...
  ![DisplayIndicator1](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.displayindicator1.webp)![DisplayIndicator2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.displayindicator2.webp)![DisplayIndicator3](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.displayindicator3.webp)
...
- Role parameters are now suggested based on a user's existing permissions and job specificities.
  ![RoleParamterSuggestions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.roleparamsuggestions.webp)
- Introduction of a new page that lists all identified risks.
  ![IdentifiedRisks](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.identifiedrisks.webp)
- Approval comments can now be set at the access policy level. The default values are:
    ...
    - for keeping a non-conforming permission: Required These access policy comment requirements can
      ...
      ![CommentMgmt.Policy](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.commentmgmt.policy.webp)
      On the role configuration screen:
      ![CommentMgmt.Role](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.commentmgmt.role.webp)
- Secondary categories are now displayed in the role detail dialog.
  ![SecondaryCategory](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.secondarycategory.webp)
- In the role reconciliation list view, a new column with the date of detection has been introduced.
  ...
  ![DetectionDate](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.detectiondate.webp)
- A new refresh button has been added for the following screens:
    ...
    - Access Roles
    - Policies
      ![Refresh](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.refresh.webp)
- On Resource Review and Resource Reconciliation dialogs, an asterisk is now displayed to show if
  ...
  displayed.
  ![Asterisks](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.5.asterisks.webp)
...
- New Account management functionality for changing or re-initializing passwords as well as
  ...
  ![PasswordReset](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.4.passwordreset.webp)
- Role Parameters are now displayed in all views with permissions (lists and dialog).
  ![Parameters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.4.parameters.webp)
- Improvements on manual provisioning screens:
    ...
    - Other general improvements
      ![ManualProvisiong](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.4.manualprovisioning.webp)
...
- On the provisioning review page when the pending orders filter is enabled, a filter now exists for
  the action type.
  ![ProvisioningFilter](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.4.provisioningfilter.webp)
- On screens that show the cancellation of resources, the edit icon is replaced by a cancel icon on
  to avoid confusion.
  ![CancellationIcon](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.4.cancellationicon.webp)
...
- New Query page:
    - Columns can be chosen and rearranged
      ![UnivQuery2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.universequery1.webp)
    - According to type of property selected, the filtered value field is changed correspondingly
      ![UnivQuery2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.universequery2.webp)
    - Display fields are easily searchable
      ![UnivQuery2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.universequery3.webp)
    - Queries can be bookmarked
      ![UnivQuery2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.universequery4.webp)
- New functionality for managing risks.
  ![RiskMgmt1](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.riskmanagement1.webp)![RiskMgmt2](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.riskmanagement2.webp)![RiskMgmt3](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.riskmanagement2.webp)![RiskMgmt4](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.riskmanagement4.webp)![RiskMgmt5](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.riskmanagement5.webp)
- Review Comments can now be configured for each role and for each review type: pending and
  non-conforming role permissions. There are three values to choose from:
    ...
    - Required (set by default on the refusal of a pending role permission and on keep a
      non-conforming role permission)
      ![CommentMgmt](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.commentmgmt.webp)
...
- In the roles catalog, instead of a generic column title, the second column title now displays the
  ...
  ![RolesCatalog](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.rolescatalog.webp)
- Implement two views to display permissions lists:
    - view grouped by categories, with the name column filtering on role and/or category name
      ![PermissionTree](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.permissionstree.webp)
    - view list where all columns can be sorted
      ![PermissionList](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.permissionslist.webp)
- On the workflow overview page, a new list of permissions shows the permissions impacted by the
  ...
  ![OverviewStates](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.overviewstates.webp)
- Allow filter on the workflow overview list by "Completed" or "Pending".
  ![OverviewListFilter](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.overviewlistfilter.webp)
...
- Improve clarity on Provisioning Review and Resource Reconciliation screens.
    - Add action indication (create, update, delete) in the list of assigned resource types to
      review or reconcile
      ![RoleReviewActions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.rolereviewactions.webp)
    - In dialogs, dynamic button labels indicating the action that will be performed based on user
      choices.
      ![DynamicLabels](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.dynamiclabels.webp)
- Added a new filter when running an access certification campaign: it is now possible to target all
  ...
  ![CertificationTargetDate](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.certificationtargetdate.webp)
- New indicators in workflow overview to display records added, modified, or deleted.
  ![WorkflowOverviewIndicators](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.workflowoverviewindicators.webp)
- On the workflow overview page, all translation modifications are now shown as well.
  ![Translations](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.3.overviewlanguage.webp)
...
- New UI for login and logout pages
  ![Login](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.login.webp)
...
- Workflow overview has been improved:
    ...
    - an optional parameter in the activity configuration can hide a workflow from the overview
      ...
      ![WorkflowOverview](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.workflowoverview.27635.webp)
- The title of the bottom section on the Request Summary is no longer hard coded in the product. It
  ...
  ![ImpInfoBlock](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.workflowoverview.impinfo.webp)
...
- In the Jobs UI, the task logs are now colored like they would be if executed from the command
  ...
  ![ColoredErrors](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.colorederrors.webp)
- When running a certification campaign and choosing what to certify, it is now possible to filter
  by specific users.
  ![CertifByOwner](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.certifbyuser.webp)
- Display the type of Approval Workflow in the role catalog and in the list of suggested
  permissions.
  ![ApprovalWorkflowSuggestions](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.approvalworkflowsuggestions.webp)
...
- New filters have been added to resource lists shown in DisplayTables with
  DisplayTableDesignElement="resourcetable":
    ...
    - Filter by resource owner's name
      ![ResourceFilters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.2.resourcefilters.webp)
...
- The dashboard has new icons for task badges.
  ![Dasboard](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.dashboard.webp)
- Role reconciliation icons have been updated to more clearly indicate their use and subsequent
  consequences to the roles.
  ![RoleReconciliationIcons](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.rolereconciliationicons.webp)
- The new image picker allows the possibility for uploading an existing photo or using the webcam to
  take a photo.
  ![TakeAPhoto](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.takephoto.webp)
- All roles are now displayed in the same section including suggested roles.
  ![RolesTogether](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.rolestogether.webp)
- The role details page now displays the request and certification histories.
  ![RoleHistories](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.rolehistories.webp)
- The role catalog displays the type of approval workflow.
  ![ApprovalTypesDisplayed](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.approvaltypesdisplayed.webp)
- A given certification campaign can now filter roles to be certified by their number of approvals
  ...
  ![CertifyCriterion](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.certifycriterion.webp)
- A new certification report linked to each campaign allows the extraction of real-time results to
  an Excel file.
  ![CertificationReportButton](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.certificationreportbutton.webp)
  ![CertificationReportResults](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.1.certificationreportresults.webp)
...
- Certification: Roles, accounts and groups can now be certified. Certfication campaigns can be
  ...
  necessary.
    - Campaign creation
      ![CampaignCreation](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.0.campaigncreation.webp)
    - Campaigns lists
      ![Campaigns](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.0.campaigns.webp)
- Jobs: Jobs can now be executed on the server as well as the agent, with detail of each job step
  ...
  ![Jobs](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.0.jobs.webp)
...
- Suggested roles are now possible. They can be defined with access rules where the type is
  �Suggested'.
  ![SuggestedRoles](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.0.suggestedroles.webp)
- Dashboard counters are now visible indicating actionable tasks since last time.
  ![Counters](/img/product_docs/identitymanager/6.1/whatsnew/olderversions/5.1.0.counters.webp)
