...
3. Configure an OpenIdClient, both on agent side in `appsettings.agent.json` with the non-hashed
   ...
   [`Usercube-New-OpenIDSecret` executable](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md).
   [See more details](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
