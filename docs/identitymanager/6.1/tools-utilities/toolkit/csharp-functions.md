...
[Expression attributes](/docs/identitymanager/6.1/tools-utilities/toolkit/expressions.md))
...
[Simplify](/docs/identitymanager/6.1/tools-utilities/toolkit/predefined-functions.md)
function.
...
[BuildUniqueValue](/docs/identitymanager/6.1/configuration-reference/xml-configuration/workflow-config.md)
