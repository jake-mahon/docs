...
[encryption certificate](/docs/identitymanager/6.1/installation-setup/agent-configuration.md#encryption-certificate)
...
[appsettings.agent.json structure](/docs/identitymanager/6.1/installation-setup/agent-configuration.md):
