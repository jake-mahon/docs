...
- All end-users' **browsers** require accessing the
  [authentication providers](/docs/identitymanager/6.1/installation-setup/server-configuration.md#set-up-end-user-authentication).
...
- The **On-Premise** offering requires the
  ...
  and the
  [Database](/docs/identitymanager/6.1/installation-setup/database-setup.md)
  to be installed.
...
The
[Usercube Server](/docs/identitymanager/6.1/installation-setup/server-configuration.md)
and
[Agents](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
...
[authentication methods](/docs/identitymanager/6.1/installation-setup/server-configuration.md#set-up-end-user-authentication)
are available.
...
[requirements](/docs/identitymanager/6.1/getting-started/system-requirements.md) are
met.
