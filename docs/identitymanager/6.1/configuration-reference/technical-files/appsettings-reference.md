...
[agent's configuration](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
This configuration is stored in the **appsettings.connection.json** file, located inside the
[work folder](/docs/identitymanager/6.1/installation-setup/server-configuration.md).
...
[Merge Priority](/docs/identitymanager/6.1/installation-setup/agent-configuration.md#merge-priority))
.
