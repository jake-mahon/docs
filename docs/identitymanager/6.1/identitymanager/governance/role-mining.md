...
[See more details about assignment automation](/docs/identitymanager/6.1/identitymanager/index.md).
...
configured with a
[grace period](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md),
...
[See how to perform role mining](/docs/identitymanager/6.1/identitymanager/index.md).

### Simulation

Be aware that you can configure the
[mining task](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
to generate role assignment rules either directly or in a
[simulation](/docs/identitymanager/6.1/identitymanager/tools-utilities/simulation.md).
