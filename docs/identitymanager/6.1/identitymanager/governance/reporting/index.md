...
the[ queries ](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)
...
the[ Universe ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/business-intelligence-config.md)topic
...
the[ Scaffoldings ](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)topic
for additional information.
...
the[ Connect Power BI to Usercube ](/docs/identitymanager/6.1/identitymanager/governance/reporting/index.md)
...
model. See
the[ EntityAssociation ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
topic for additional information.
...
- #### [Connect Power BI to Usercube](/docs/identitymanager/6.1/identitymanager/governance/reporting/index.md)
- #### [Analyze Usercube's Data with Power BI](/docs/identitymanager/6.1/identitymanager/governance/reporting/index.md)
...
[SQuery](/docs/identitymanager/6.1/identitymanager/api-reference/squery.md), or advanced
reports using the
[Business Intelligence module](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/business-intelligence-config.md).

[See more information about generating reports](/docs/identitymanager/6.1/identitymanager/index.md).
