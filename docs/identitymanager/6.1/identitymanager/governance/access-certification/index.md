...
[access certification data filters](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-certification-config.md)
and
[access certification owner filters](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-certification-config.md).
...
1. [`Usercube-Update-AccessCertificationCampaign`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
   simply applies the campaign's scope, determines which permissions are to be certified, by
   computing certification orders;
2. [`Usercube-Set-AccessCertificationReviewer`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
...
3. [`Usercube-Send-AccessCertificationNotification`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
   sends notifications to concerned reviewers.
4. [`Usercube-Process-AccessCertificationItems`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
...
[`AccessReviewAdministrationAccessControlRules`](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)
scaffolding.

The administrator profile, created with
[`CreateAdministratorProfile`](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)
...
[access certification campaign policy](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-certification-config.md).
...
[access control filters](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-control-config.md)
