...
- _Read & Execute_ and _List folder contents_ on the
  [`Runtime` directory](/docs/identitymanager/6.1/identitymanager/installation-setup/working-directory-setup.md),
...
- _Read_ and _List folder contents_ on the directory for provisioning orders, whose path depends on
  the
  [`Work` folder's path](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md);
...
> **FAQ**:
> [How to set up directory permissions in Windows Server?](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md)
...
- service accounts with the necessary permissions for the agent to perform _Read_ and/or _Write_
  ...
  [synchronization and/or provisioning](/docs/identitymanager/6.1/identitymanager/connectors-integration/index.md);
- service accounts' credentials.

Managed systems credentials are stored in the
[`appsettings.agent` configuration set](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
and can be [protected](/docs/identitymanager/6.1/identitymanager/core-concepts/index.md).
...
[email notifications](/docs/identitymanager/6.1/identitymanager/installation-setup/email-server-setup.md).
...
[quick start guide](/docs/identitymanager/6.1/identitymanager/getting-started/quick-start.md)
or the
[production-ready installation guide](/docs/identitymanager/6.1/identitymanager/installation-setup/installation-guide.md).
...
- `bulkadmin` which is a
  ...
  [ Install the Server ](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md)
...
[ Server ](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md)
topic for additional information.
...
[network configuration files](/docs/identitymanager/6.1/identitymanager/configuration-reference/network-configuration/index.md).

## What's Next?

Let's move on to the requirements for
[Usercube's database](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md).

# Requirements

This section identifies hardware and software requirements for each Usercube component:

- #### [Integration Device](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md)
- #### [Database](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md)
- #### [Server](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md)
- #### [Agent](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md)
...
[license key](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md)
provided by NETWRIX.
...
[roles](/docs/identitymanager/6.1/identitymanager/getting-started/system-requirements.md),
including necessarily either `sysadmin` or `securityadmin`.

For more information, see the
[server installation procedure](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md).
...
[The on-premise SSL certificate must be set up in IIS](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md).
