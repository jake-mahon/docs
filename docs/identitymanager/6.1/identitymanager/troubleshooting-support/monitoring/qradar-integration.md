...
[Monitoring](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/monitoring/index.md).
...
[see which logs can be sent](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/monitoring/index.md).
...
2. In the **Serilog** section, add a **Using** section to contain the used sink which depends on the
   ...
   [See the list of supported sinks](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/monitoring/index.md).
...
3. Add a **MinimumLevel** section to define which logs are to be sent to the log management system.
   [See more details](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/monitoring/index.md).
   ...
   > the
   > [log references](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/monitoring/index.md)
