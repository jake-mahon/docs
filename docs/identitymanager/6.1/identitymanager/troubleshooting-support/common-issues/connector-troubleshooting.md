...
[See the details of the export executable `Usercube-Export-Configuration`](/docs/identitymanager/6.1/identitymanager/tools-utilities/cli-reference/configuration-tools.md).
...
[See the details of the prepare-synchronization executable `Usercube-Prepare-Synchronization`](/docs/identitymanager/6.1/identitymanager/tools-utilities/cli-reference/index.md).
...
When at least one
[synchronization threshold](/docs/identitymanager/6.1/identitymanager/automation/synchronization/sync-thresholds.md)
