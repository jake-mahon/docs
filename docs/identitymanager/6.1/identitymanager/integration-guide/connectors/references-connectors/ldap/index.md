...
- [Directory/Generic LDAP](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-packages/generic-ldap/index.md);
- [Directory/Oracle LDAP](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-packages/oracle-ldap/index.md);
- [Directory/Apache Directory](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-packages/apache-directory/index.md);
- [Directory/Red Hat Directory Server](/docs/identitymanager/6.1/identitymanager/integration-guide/connectors/references-packages/red-hat-directory-server/index.md).
...
Usercube UI or by
[assignment policy enforcement](/docs/identitymanager/6.1/identitymanager/integration-guide/role-assignment/evaluate-policy/index.md).
