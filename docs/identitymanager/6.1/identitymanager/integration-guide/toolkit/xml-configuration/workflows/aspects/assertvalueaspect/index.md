...
| IfExpression optional      | String | Expression that conditions the aspect execution. See the [ Expressions ](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/expressions/index.md) topic for additional information.                                                                                                                                                |
