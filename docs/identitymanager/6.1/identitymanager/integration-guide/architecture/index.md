...
[See more details on NETWRIX' recommended architecture when working in a SaaS environment](/docs/identitymanager/6.1/identitymanager/integration-guide/architecture/saas/index.md).

[See more details on NETWRIX' recommended architecture when working in an on-premises environment.](/docs/identitymanager/6.1/identitymanager/integration-guide/architecture/on-prem/index.md)

[See how to protect the communication between agent and server](/docs/identitymanager/6.1/identitymanager/integration-guide/architecture/how-tos/protect-agent-server-communication/index.md).
...
[Server settings](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/server-configuration/end-users-authentication/index.md)).
