...
[the blocked job can be resumed](/docs/identitymanager/6.1/identitymanager/user-guide/set-up/synchronization/index.md)
(or not).
...
Distinct
[thresholds are configurable for provisioning](/docs/identitymanager/6.1/identitymanager/integration-guide/provisioning/prov-thresholds/index.md).
