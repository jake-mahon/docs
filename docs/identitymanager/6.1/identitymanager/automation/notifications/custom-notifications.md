...
given activity in a
[workflow](/docs/identitymanager/6.1/identitymanager/index.md).
...
[See more details](/docs/identitymanager/6.1/identitymanager/automation/notifications/native-notifications.md).
...
1. Among the
   [list of all native notifications](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/notification-config.md),
...
1. In the XML configuration, create a `Language` with `IndicatorNumber` set to `1`.
   [See more details on `Language`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).
...
1. In the XML configuration, configure `MailSetting` with a `LanguageCode`.
   [See more details on `MailSetting`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).
