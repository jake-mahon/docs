...
[job scaffoldings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md),
...
>
>
> [See more details about this scaffolding](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md).
> ```
...
[See how to configure a job to be incremental](/docs/identitymanager/6.1/identitymanager/automation/jobs-tasks/incremental-jobs.md).
...
Make sure to
[understand the tasks' logical chain](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/common-issues/connector-troubleshooting.md)
...
> [feedback loop](/docs/identitymanager/6.1/identitymanager/index.md) uses
