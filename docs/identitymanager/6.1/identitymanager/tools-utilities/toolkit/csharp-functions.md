...
[Expression attributes](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md))
...
[Simplify](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/predefined-functions.md)
function.
...
[BuildUniqueValue](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/workflow-config.md)
