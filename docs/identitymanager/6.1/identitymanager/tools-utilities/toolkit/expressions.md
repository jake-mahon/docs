...
> [entity property expressions](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
> and
...
[built-in function](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/predefined-functions.md)
or as a full-fledged `C#` expression. See the list of available
[C# utility functions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/csharp-functions.md)
and
[functions predefined by Usercube](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/predefined-functions.md).
...
[predefined simple transformations](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/predefined-functions.md).
...
[`QueryRule`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
and
...
[`EntityProperty`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)`Type`
...
[`QueryRule`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)`TargetExpression`
