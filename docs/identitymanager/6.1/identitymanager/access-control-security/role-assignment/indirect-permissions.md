...
[Indirect Resource Rules](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).
...
- `Property`: the
  [Entity Property](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
- `IndirectResourceBinding`: the
  [Binding](/docs/identitymanager/6.1/identitymanager/core-concepts/bindings.md) that
...
[How-To: Configure Indirect Permissions in an Active Directory](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/index.md).
...
[Resource Navigation Rule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)**.
