...
See the [ Connectors ](/docs/identitymanager/6.1/identitymanager/connectors-integration/index.md),
[ ComputeRoleModelTask ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md),
and [ Jobs ](/docs/identitymanager/6.1/identitymanager/automation/jobs-tasks/job-configuration.md)
...
- Usercube only selects resources for which a new assignment computation is needed. They are
  ...
  [ Upward Data Synchronization ](/docs/identitymanager/6.1/identitymanager/automation/synchronization/upward-data-sync.md)
  topic for additional information.
...
the
[ EntityType ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)topic
...
[ CompositeRoleRule ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)topic
