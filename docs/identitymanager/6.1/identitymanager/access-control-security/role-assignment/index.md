...
[See more details](/docs/identitymanager/6.1/identitymanager/core-concepts/role-model.md).
...
[evaluating the policy](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/assignment-policies.md),
...
[approval workflow type](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).
...
[See more details on reconciliation](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/assignment-policies.md).
...
The
[Compute Role Model](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
...
[dimension bindings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
on the context rule.
...
As described in
[identity management](/docs/identitymanager/6.1/identitymanager/identity-management/index.md),
...
position
[record section](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).

# Configure Indirect Permissions

The following how-to assumes that you have already read the topic on
[indirect permissions](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/indirect-permissions.md).
...
- #### [Restrict the Assignment](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/index.md)
  Use filters on dimensions and/or roles to restrict the assignment of a role or resource
  type.- ####
  [Infer Single Roles with a Composite Role](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/index.md)
  Assign several single roles via the assignment of one composite role.- ####
  [Configure Indirect Permissions ](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/index.md)
...
[dimensions](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
We will define a
[single role rule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
[SingleRole rule(s)](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
are checked.
...
[documentation about the role model](/docs/identitymanager/6.1/identitymanager/core-concepts/role-model.md).
