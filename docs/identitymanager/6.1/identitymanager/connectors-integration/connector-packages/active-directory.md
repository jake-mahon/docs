...
This page is about
[Directory/Active Directory](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/active-directory.md).
...
> [scalar property](/docs/identitymanager/6.1/identitymanager/core-concepts/entity-model.md):
>
> ```
