...
- [Database/Generic SQL](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md);
- [Database/Microsoft SQL Server](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md);
- [Database/MySQL](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md);
- [Database/ODBC](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md);
- [Database/Oracle](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md);
- [Database/PostgreSQL](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md);
- [Database/SAP ASE](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sap-erp.md).
...
|                                               |                                                                                                                                                                                                                                                                                                                                                                                    |
| ---                                           | ---                                                                                                                                                                                                                                                                                                                                                                                |
| SqlCommand optional                           | **Type** String **Description** SQL request to be executed. **Note:** when not specified and `SqlFile` neither, then all the [entity type mappings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md) of this connector will be exported.                                                                                   |
| SqlFile optional                              | **Type** String **Description** Path of the file containing the SQL request to be executed. **Note:** ignored when `SqlCommand` is specified. **Note:** when not specified and `SqlFile` neither, then all the [entity type mappings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md) of this connector will be exported. |
...
3. Get the value required for `ProviderClassFullName` and `ProviderDllName`:
   ...
   - for a DBMS handled by Usercube's packages, by accessing the
     [package page](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/index.md);
...
[CyberArk](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
...
This page is about
[Database/Microsoft SQL Server Entitlements](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md).
...
[SQL connector using the procedure given in the example](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sql-databases.md).
