...
This page is about
[Cloud/Azure](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This connector is meant to generate to the [ExportOutput](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md) folder the following CSV files:
...
- [RSA encryption](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md), configured in the ```appsettings.encrypted.agent.json``` file;
- an [Azure Key Vault](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md) safe;

- a [CyberArk Vault](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md) able to store Azure's ```ApplicationId``` and ```ApplicationKey```.
````
...
This page is about
[ITSM/EasyVista](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
[enforcing the policy](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/assignment-policies.md).
...
This page is about
[Ticket/EasyVista](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
[see the export capabilities of the EasyVista connector](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
[See the fulfill capabilities of the EasyVista connector](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[File/Microsoft Excel](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Storage/Home Folders](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
| NavigationTargetToSource optional   | String        | Navigation property that makes the link from the target entity type to the source entity type. **NOTE:** Required when using records. For example, it's not required when working with departments or sites. See the[ Position Change via Records ](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/position-changes.md) topic for additional information.[ Position Change via Records ](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/position-changes.md) |
| NavigationToTargetEntity optional   | String        | Navigation property that makes the link from the source entity type to the target entity type. **NOTE:** Required when using records. For example, it's not required when working with departments or sites. See the[ Position Change via Records ](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/position-changes.md) topic for additional information.                                                                                                                                          |
...
[ RSA Encryption ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
and
[ CyberArk's AAM Credential Providers ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
topics for additional information.

Still, data protection can be ensured through an Azure Key Vault safe. See the
[ Azure Key Vault ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)topic
for additional
information.[ Azure Key Vault ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
...
This page is about
[Custom/JSON](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Directory/LDIF](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Custom/OData](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
- an
  [entity type mapping](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md):
...
This page is about
[Custom/PowerShellProv](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
See how to
[write a Powershell script](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-tutorials/index.md)
...
- a
  ...
  [compatible with CyberArk](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md).
...
This page is about
[Custom/PowerShellSync](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[MainFrame/RACF](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Custom/Robot Framework](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
See how to
[write a RobotFramework script](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-tutorials/index.md)
to allow provisioning with this connector.
...
- Reading first the appsettings documentation; See the
  [ appsettings.agent ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md) topic
...
See the
[Application Settings](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
topic for additional information.
...
[ Azure Key Vault ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md),
and
[ CyberArk's AAM Credential Providers ](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)topics
for additional information.
...
This page is about
[ERP/SAP S/4 HANA](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/sap-erp.md).
...
[`RessourceTypeMapping`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md).
...
This page is about
[ITSM/ServiceNow](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/servicenow.md).
...
[ServiceNow Ticket](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
[entity type mappings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)'s
and
[entity association mappings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)'s
connection tables.
...
This page is about
[Ticket/ServiceNow](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/servicenow.md).
...
[ServiceNow Entity Management](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
[see the export capabilities of the ServiceNow connector](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
Some entities cannot be exported.
...
[See the fulfill capabilities of the ServiceNow connector](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Storage/Shared Folders](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
...
This page is about
[Mainframe/Top Secret](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/custom-connectors.md).
