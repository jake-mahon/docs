...
[See more details about the XML configuration of a connection](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md).
...
[See connectors documentation](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/index.md)
for more information about the attributes for each connector.

## Connection Tables

A
[connection table](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)
...
[See how to configure secured options](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-tutorials/index.md).
