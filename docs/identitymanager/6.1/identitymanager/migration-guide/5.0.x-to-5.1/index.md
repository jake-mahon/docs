...
- [Data model: Jobs](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/jobs/index.md)
- [Execute Jobs](/docs/identitymanager/6.1/identitymanager/integration-guide/tasks-jobs/jobs/index.md)
- [information about all Tasks](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/jobs/tasks/index.md)
- [Information about Jobs](/docs/identitymanager/6.1/identitymanager/integration-guide/toolkit/xml-configuration/jobs/job/index.md)
...
- The [RunTask API](/docs/identitymanager/6.1/identitymanager/integration-guide/api/server/job/index.md)

#### d. Information system appsettings

All the information of the information system is on this file:
[appsettings.ConnectionInformation.json](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/agent-configuration/appsettings-agent/index.md).
