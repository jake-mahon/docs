...
To continue,
[configure the application pool and website via IIS](/docs/identitymanager/6.1/identitymanager/user-guide/deploy/production-agent-installation/iis-configuration/index.md).
