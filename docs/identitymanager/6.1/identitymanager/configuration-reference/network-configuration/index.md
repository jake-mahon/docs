...
- #### [Configure Okta for Usercube Authentication](/docs/identitymanager/6.1/identitymanager/connectors-integration/connector-packages/okta.md)
...
- Server configuration, including connection to the database and end-user authentication. See the
  [Server Configuration](/docs/identitymanager/6.1/identitymanager/installation-setup/server-configuration.md)
  topic for additional information.
- Agent configuration, including connection to the managed systems. See the
  [Agent Configuration](/docs/identitymanager/6.1/identitymanager/installation-setup/agent-configuration.md)
  topic for additional information.
...
diagram. See the
[Architecture](/docs/identitymanager/6.1/identitymanager/core-concepts/architecture/index.md) topic
for additional information.
...
See the [Overview](/docs/identitymanager/6.1/identitymanager/getting-started/overview.md) topic
for additional information.
...
[profile](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)
