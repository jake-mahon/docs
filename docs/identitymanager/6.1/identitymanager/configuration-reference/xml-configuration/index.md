...
- #### [Scaffoldings](/docs/identitymanager/6.1/identitymanager/configuration-reference/scaffoldings/scaffolding-reference.md)
...
- #### [Access Control](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-control-config.md)
- #### [Connectors](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)
- #### [Configuration](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [User Interface](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Jobs](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
- #### [Metadata](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Notifications](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/notification-config.md)
- #### [Provisioning](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Reporting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Resources](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Access Certification](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/access-certification-config.md)
- #### [Business Intelligence](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/business-intelligence-config.md)
- #### [Workflows](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/workflow-config.md)
...
[example of a whole connector](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)
...
[C#](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md) or
[literal](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md)
expressions.
...
| Expression optional       | **Type** String **Description** References the C# or literal expression used to compute the result. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). |
...
| Identifier required     | **Type** String **Description** Unique identifier of the entity type. It must is be unique to the _entity model_ scope. Cannot be a [reserved identifier](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md).                          |
...
| Identifier required                   | **Type** String **Description** Unique identifier of the property. It must be unique to the parent entity type scope. Cannot be a [reserved identifier](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md) and can only contain numbers (except the first character) and letters without accents. **Note:** cannot be "Id".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- #### [AccessControlEntityType](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
- #### [Settings](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
- #### [AppDisplaySetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  This setting is used to customize the application display.- ####
  [ConfigurationVersionSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  Used to track the current configuration version.- ####
  [CustomLink1Setting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  Used to display a given static HTML file to a custom URL address.- ####
  [CustomLink2Setting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  Used to display a given static HTML file to a custom URL address.- ####
  [DashboardItemNumberSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  ...
  5.- ####
  [MailSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [PasswordGenerationSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [PasswordTestsSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  This setting enables a check on the passwords set manually by users.- ####
  [SchedulingCleanDataBaseSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  If the default value for the Task CleanDataBase needs to be overridden.- ####
  [SelectAllPerformedByAssociationQueryHandlerSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  This setting enables task delegation to a group of people.- ####
  [SelectPersonasByFilterQueryHandlerSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
  This setting is used to filter the entity type used by authentication mechanism.- ####
  [SelectUserByIdentityQueryHandlerSetting](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
[`PasswordResetSettings`](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/connector-config.md)'s
`StrengthCheck`.
...
[Integrated Windows Authentication](/docs/identitymanager/6.1/identitymanager/access-control-security/authentication/end-user-authentication.md).
...
[Composite Role Rule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).
...
| R0 default value: false                                               | **Type** Boolean **Description** `true` to set the dimension 0 (up to 3V following the [base32hex convention](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md)) as a required parameter when assigning the role.                                                                                                                                                                                                                                                                       |
...
[See more information about context generation](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/position-changes.md).
...
[record sections](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
| Property                                         | Details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B0 optional                                      | **Type** Int64 **Description** Binding of the dimension 0 (up to 3V in [base32hex](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md)). The dimension can then be used in rules to filter the rules' targets.                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| ResourcesEndBinding optional                     | **Type** Int64 **Description** Binding of the date property among those from `ResourcesBinding` which specifies the end of validity for all [properties](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md#properties) of the context. It can also be defined via `ResourcesEndExpression`. **Note:** a context rule's start and end dates are ignored when the related identities are also configured with [record sections](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).                                                                                                                  |
| ResourcesEndExpression optional                  | **Type** String **Description** Expression based on the `ResourcesBinding` entity type that defines the end of validity for all [properties](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md#properties) of the context. It can also be defined via `ResourcesEndBinding`. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). **Note:** a context rule's start and end dates are ignored when the related identities are also configured with [record sections](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).         |
...
| ResourcesStartBinding optional                   | **Type** Int64 **Description** Binding of the date property among those from `ResourcesBinding` which specifies the beginning of validity for all [properties](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md#properties) of the context. It can also be defined via `ResourcesStartExpression`. **Note:** a context rule's start and end dates are ignored when the related identities are also configured with [record sections](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md).                                                                                                          |
| ResourcesStartExpression optional                | **Type** String **Description** Expression based on the `ResourcesBinding` entity type that defines the beginning of validity for all [properties](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md#properties) of the context. It can also be defined via `ResourcesStartBinding`. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). **Note:** a context rule's start and end dates are ignored when the related identities are also configured with [record sections](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md). |
...
- #### [AutomationRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### BulkChange
- #### [Category](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [CompositeRole](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [CompositeRoleRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Context](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [ContextRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [IndirectResourceRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [MiningRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Policy](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [RecordSection](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [ResourceClassificationRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [ResourceCorrelationRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [ResourceType](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Risk](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [RoleMapping](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [SingleRole](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [SingleRoleRule](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
The
[role mining task](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/jobs-config.md)
...
[See more details about identity modeling](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/position-changes.md).
...
[validity period](/docs/identitymanager/6.1/identitymanager/identity-management/joiners-movers-leavers/onboarding-offboarding.md),
...
| TargetExpression optional                                  | **Type** String **Description** Defines the C# expression used to classify the resources. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). |

# ResourceCorrelationRule

A correlation rule is used to
[correlate](/docs/identitymanager/6.1/identitymanager/index.md)
...
A
[list of predefined functions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/predefined-functions.md)
is available.
...
| SourceExpression optional                     | **Type** String **Description** Binding expression based on properties from the source system. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). |
...
| TargetExpression optional                     | **Type** String **Description** Binding expression based on properties from the target system. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md). |
...
| P0 default value: false                                             | Boolean                                        | True to indicate that the resource type is parametrized, i.e. there is at least one type rule configured to assign the resource type based on the dimension 0 (up to 3V following the base32hex convention). See the [ Base32 Parameter Names ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| R0 default value: false                                             | Boolean                                        | True to set the dimension 0 (up to 3V following the base32hex convention) as a required parameter when assigning the resource type. See the [ Base32 Parameter Names ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| SingleRole optional                        | Int64               | Identifier of the single role. The single role must be assigned to the owner so that the file can be provisioned on the resource. See the [ SingleRole ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
roles. See the
[ Configure a Parameterized Role ](/docs/identitymanager/6.1/identitymanager/index.md)topic
...
[ Dimension ](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
and
[ Base32 Parameter Names ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md)topics
for additional information.
...
[ Expressions ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md)
topic for additional information.
...
| SourceExpression optional                     | String              | C# expression to compare with the target binding/expression in order to compute the value of Property with the matching resource. See the [ Expressions ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| TargetExpression optional                     | String              | C# expression to compare with the source binding/expression in order to compute the value of Property with the matching resource.See the [ Expressions ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md) topic for additional information. The TargetExpression must contain at least one target property, it cannot be a literal expression.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
[ Bindings ](/docs/identitymanager/6.1/identitymanager/core-concepts/bindings.md) and
[ Expressions ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md)
...
See the
[Provision](/docs/identitymanager/6.1/identitymanager/index.md)[ Synchronize Data ](/docs/identitymanager/6.1/identitymanager/index.md)
topic for additional information.
...
| Expression optional                        | String              | Expression used to compute the target property specified in Property. See the [ Expressions ](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md) topic for additional information. for C# expressions, Usercube provides an implicit variable called "assignment" that contains basic information about the linked assigned resource type, i.e. StartDate, EndDate and ParametersValues.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| CategoryDisplayNameExpression optional                                | **Type** String **Description** References the C# or literal expression used to compute the category display name. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                                |
| CategoryIdentifierBinding optional                                    | **Type** Int64 **Description** Binding used to compute the category identifier.                                                                                                                                                                                                                                           |
| CategoryIdentifierExpression optional                                 | **Type** String **Description** C# or literal expression used to compute the category identifier. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                                                 |
| CommentActivationOnApproveInReview default value: Inherited           | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a request of the role and deciding to approve it. `0` - Disabled `1` - Optional `2` - Required `3` - Inherited: comment activation in the associated policy.                                                     |
| CommentActivationOnDeclineInReview default value: Inherited           | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a request of the role and deciding to refuse it. `0` - Disabled `1` - Optional `2` - Required `3` - Inherited: comment activation in the associated policy.                                                      |
| CommentActivationOnDeleteGapInReconciliation default value: Inherited | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a non-conforming assignment of the role and deciding to delete it. `0` - Disabled `1` - Optional `2` - Required `3` - Inherited: comment activation in the associated policy.                                    |
| CommentActivationOnKeepGapInReconciliation default value: Inherited   | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a non-conforming assignment of the role and deciding to keep it. `0` - Disabled `1` - Optional `2` - Required `3` - Inherited: comment activation in the associated policy.                                      |
| DisplayNameBinding optional                                           | **Type** Int64 **Description** Defines the binding used to compute the role display name.                                                                                                                                                                                                                                 |
| DisplayNameExpression optional                                        | **Type** String **Description** References the C# or literal expression used to compute the role display name. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                                    |
...
| IdentifierExpression optional                                         | **Type** String **Description** C# or literal expression used to compute the role identifier. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                                                     |
...
| ParentCategoryIdentifierExpression optional                           | **Type** String **Description** References the C# or literal expression used to compute the parent category. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                                      |
| Policy required                                                       | **Type** Int64 **Description** Identifier of the policy that the rule is part of.                                                                                                                                                                                                                                         |
...
| WhereExpression optional                                              | **Type** String **Description** C# expression returning a boolean, used to condition the application of the naming convention. [See more details on C# expressions](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/expressions.md).                                                                    |
...
roles.
[See how to via the UI](/docs/identitymanager/6.1/identitymanager/index.md).
...
[base32hex convention](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md))
...
| CommentActivationOnDeleteGapInReconciliation default value: Inherited | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a non-conforming assignment of the role and deciding to delete it. `0` - Disabled. `1` - Optional. `2` - Required. `3` - Inherited: comment activation in the associated policy.                                                                                                                                                                                                                      |
| CommentActivationOnKeepGapInReconciliation default value: Inherited   | **Type** CommentActivationWithInherited **Description** Indicates if a comment is enabled when reviewing a non-conforming assignment of the role and deciding to keep it. `0` - Disabled. `1` - Optional. `2` - Required. `3` - Inherited: comment activation in the associated policy.                                                                                                                                                                                                                        |
| D0 optional                                                           | **Type** Int64 **Description** Value that will be set for the dimension 0 (up to 3V following the [base32hex convention](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md)) for all users with the role.                                                                                                                                                                                                                                                                             |
| Description_L1 optional                                               | **Type** String **Description** Detailed description of the single role in language 1 (up to 16).                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Property                      | Details                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CompositeRole optional        | **Type** Int64 **Description** Identifier of a [composite role](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md) that users must have to trigger the rule.                                                                                                                                                                                                                                                                                                                                                             |
...
| D0IsActive default value: false     | **Type** Boolean **Description** Is dimension0 active for this entity type (D0IsActive to D3VIsActive following the [base32hex convention](/docs/identitymanager/6.1/identitymanager/tools-utilities/toolkit/index.md).                                                            |
...
- #### [DisplayEntityAssociation](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [DisplayEntityType](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [DisplayPropertyGroup](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
...
- #### [Indicator](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [MenuItem](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [SearchBar](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
- #### [Tile](/docs/identitymanager/6.1/identitymanager/configuration-reference/xml-configuration/index.md)
