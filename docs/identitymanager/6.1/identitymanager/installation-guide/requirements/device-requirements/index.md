...
[network configuration files](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/index.md).

## What's Next?

Let's move on to the requirements for
[Usercube's database](/docs/identitymanager/6.1/identitymanager/installation-guide/requirements/database-requirements/index.md).
