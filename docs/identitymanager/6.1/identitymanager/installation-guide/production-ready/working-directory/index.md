...
- `appsettings.*.json`:
  [technical configuration files](/docs/identitymanager/6.1/identitymanager/integration-guide/network-configuration/index.md).

## What's Next?

Next section shows how to
[install the Usercube Database](/docs/identitymanager/6.1/identitymanager/installation-guide/production-ready/database/index.md).
