...
[database requirements](/docs/identitymanager/6.1/identitymanager/installation-guide/requirements/database-requirements/index.md)
...
The [next step](/docs/identitymanager/6.1/identitymanager/installation-guide/production-ready/server/index.md)
will consist in:
...
[test the Usercube Database connection](/docs/identitymanager/6.1/identitymanager/installation-guide/production-ready/server/index.md).
