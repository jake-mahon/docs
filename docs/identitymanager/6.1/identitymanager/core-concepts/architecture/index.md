...
- #### [Protect Agent/Server Communication](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/how-to-guides/protect-agent-communication.md)
...
[See more details on NETWRIX' recommended architecture when working in a SaaS environment](/docs/identitymanager/6.1/identitymanager/core-concepts/architecture/saas.md).

[See more details on NETWRIX' recommended architecture when working in an on-premises environment.](/docs/identitymanager/6.1/identitymanager/core-concepts/architecture/on-premise.md)

[See how to protect the communication between agent and server](/docs/identitymanager/6.1/identitymanager/troubleshooting-support/how-to-guides/protect-agent-communication.md).
...
[Server settings](/docs/identitymanager/6.1/identitymanager/access-control-security/authentication/end-user-authentication.md)).
