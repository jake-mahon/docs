...
[introduction on entitlement management](/docs/identitymanager/6.1/identitymanager/index.md)
first.

[See more information about role assignments](/docs/identitymanager/6.1/identitymanager/access-control-security/role-assignment/index.md).
...
An
[assignment rule](/docs/identitymanager/6.1/identitymanager/index.md)
...
- helping build a catalog of all available entitlements in the managed systems, see
  [role naming conventions](/docs/identitymanager/6.1/identitymanager/index.md);
...
- detecting assignments in the managed systems that do not comply with the policy, see the
  [review of non-conforming assignments](/docs/identitymanager/6.1/identitymanager/index.md).
