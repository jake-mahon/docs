...
[PowerShell connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
...
- [PowerShell](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
...
required are
[Export Microsoft Exchange](/docs/identitymanager/6.1/connectors-integration/connector-packages/microsoft-exchange.md),
[Fulfill PowerShell](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md),
[Export Active Directory](/docs/identitymanager/6.1/connectors-integration/connector-packages/active-directory.md)
and
[Fulfill Active Directory](/docs/identitymanager/6.1/connectors-integration/connector-packages/active-directory.md).
...
see
[Write a Script for Fulfill-PowerShell](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md).
...
[AuthType](/docs/identitymanager/6.1/connectors-integration/connector-packages/microsoft-exchange.md).
...
[credentials protection](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
...
> `MicrosoftExchange`[connector](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
...
- [ScalarRule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  which specifies the value to be set to an assigned resource scalar property.
- [NavigationRule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
