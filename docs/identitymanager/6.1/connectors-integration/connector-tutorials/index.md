...
- #### [Run the Banking Demo Application](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Set up the Banking demo application in order to test a connector with a web based external
  system.- ####
  [Run the HR Demo Application](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  ...
  external system.- ####
  [Register for Microsoft Entra ID](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/azure-ad-registration.md)
  ...
  [Configure Secured Options](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  ...
  [Write a Template for a Ticket Connector](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a template that will be used by a Ticket connector to complete the title and the
  description of the ticket.- ####
  [Write a PowerShell Script for Synchronization](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a PowerShell script used by a PowerShellSync connector.- ####
  [Write a PowerShell Script for Provisioning](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a PowerShell script used by a PowerShellProv connector.- ####
  [Fulfill Microsoft Exchange via PowerShell](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/powershell-scripts.md)
  Set up a PowerShell connector to fulfill data in a PowerShell-compliant system, here Microsoft
  Exchange Server.- ####
  [Write a Robot Framework Script](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a Robot Framework script that will be used by the Robot Framework connector.- ####
  [Interact with a Web Page via Robot Framework](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a Robot Framework script that interacts with a web based external system.- ####
  [Interact with a GUI Application via Robot Framework](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Write a Robot Framework script which interacts with an external application.- ####
  [Export CyberArk Data via SCIM](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  ...
  [Provision Salesforce Users' Profiles via SCIM](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
  Provision a user's account profile in a Salesforce system with the SCIM connector.- ####
  [Set up SharePoint's Export and Synchronization](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
...
[guide on how to write a Robot Framework script](/docs/identitymanager/6.1/connectors-integration/connector-tutorials/index.md)
explains the basics of Robot Framework. The basic prerequisites can be found on the
[Robot Framework](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
connector page.
...
[SCIM connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/scim.md)
to extract data from your CyberArk instance into CSV source files that will in turn be fed to the
[Synchronization task](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md)
...
[appsettings.agent > Connections](/docs/identitymanager/6.1/connectors-integration/connector-packages/scim.md)
section.
...
[SCIM optional attributes](/docs/identitymanager/6.1/connectors-integration/connector-packages/scim.md).
...
[working directory](/docs/identitymanager/6.1/installation-setup/working-directory-setup.md)`Temp/ExportOutput`
...
[applicative configuration](/docs/identitymanager/6.1/tools-utilities/toolkit/index.md)
and linked to an Agent.

It is strongly recommended that the applicative configuration be stored in the
[working directory](/docs/identitymanager/6.1/installation-setup/working-directory-setup.md)`Conf`
...
- In the `SCIMCyberArk` directory create a `CyberArk Connector.xml` file.
  ...
  [Entity Model](/docs/identitymanager/6.1/core-concepts/entity-model.md).
...
- Use the
  ...
  - **Agent** is the identifier of the Agent that will run this connector's export task. The
    ...
    [`appsettings.agent` > OpenId > AgentIdentifier](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
The [Entity Model](/docs/identitymanager/6.1/core-concepts/entity-model.md)
...
[Entity Types](/docs/identitymanager/6.1/core-concepts/entity-model.md#entity-types)
and
[Entity Associations](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
Eventually, it is up to the integration team to design the
[Entity Model](/docs/identitymanager/6.1/core-concepts/entity-model.md) that
...
Declaring an
[Entity Type](/docs/identitymanager/6.1/core-concepts/entity-model.md) is
...
- **DisplayName_Li, i ? [1..16]** are used in the UI to identify this
  [Entity Type](/docs/identitymanager/6.1/core-concepts/entity-model.md) for
...
[Entity Properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md),
...
- **TargetColumnIndex** defines in which column of the resource table the property is stored. See
  more details at
  [`TargetColumnIndex`](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
[Entity Association](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
elements.
...
[EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md),
and
[EntityPropertyMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
...
- is written to the **Property1** attribute of the
  `CyberArk_Group_Members`[EntityAssociation](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
  element.
- is filled in by values from the `MemberId` column (written to the **Column2** attribute of the
  `CyberArk_Group_Members`[EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
...
[DisplayTable](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
contains a list of
[DisplayTableColumn](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md)
...
elements define
[permissions](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
...
[`CreateConnectorSynchroComplete` scaffolding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md).
...
[scaffolding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md).
...
[Usercube-Invoke-Job tool](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md),
uses:
...
[Open Id Connect ClientId/Secret pair](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md),
linked to a Profile.
...
[Synchronization AccessControlRules scaffolding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
and the
[JobViewAccessControlRules scaffolding](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md).
...
[`<OpenIdClient>` xml element](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
...
Use the Job
[`CronTabExpression`](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md)
attribute.
...
This guide shows how to set up a
[SharePoint connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/sharepoint.md)
...
[Configuration Files](/docs/identitymanager/6.1/core-concepts/architecture/index.md)
method. Remember that settings can also be input through
[Environment Variables](/docs/identitymanager/6.1/core-concepts/architecture/index.md).
...
- Use the
  ...
  - **Agent** is the identifier of the Agent that runs this connector's export task. The Agent's
    ...
    [`appsettings.agent` configuration set > OpenId > AgentIdentifier setting attribute](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
The SharePoint object attributes are modeled by [Entity Properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md), with the ```<Property>``` tags declared as children of the ```<EntityType>```.

Remember that there are [several kinds of properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md): scalar and navigation. [Scalar properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) can be defined to represent scalar attributes such as ```city```, ```country``` or ```companyName```. [Navigation Properties](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) represent associations such as group memberships.
...
- __Type__ defines the type of the property. A [Scalar property](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) type is chosen among ```String```, ```Bytes```, ```Int16```, ```Int32```, ```Int64```, ```DateTime```, ```Bool```, ```Guid```, ```Double```, ```Binary```, ```Byte```, and ```Option```. The navigation property type is ```ForeignKey```.
- __TargetColumnIndex__ defines in which column of the resource table the property is stored. See more details about [```TargetColumnIndex```](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).
...
The exact nature of the IDs are described by the associated [EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md).

Notice the format of the __Property1__ and __Property2__ xml attributes: the name of the entity type is followed by ```:``` and the name of an entity property. It is a [binding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) describing in one expression, the target entity type and property.
...
The [EntityTypeMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md), [EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md), and [EntityPropertyMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md) elements serve this purpose.

#### Entity type mapping

The [EntityTypeMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md) element maps the scalar properties from the CSV source file to an entity type.
...
The [EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md) element maps the navigation properties used in [EntityAssociation](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md).

An [EntityAssociationMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md) element refers to an [EntityAssociation](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) written to the ```Identifier``` xml attribute. Then, like [EntityTypeMapping](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md), it maps column values from a CSV source file to an EntityType property.
...
The scalar properties require no configuration: they are automatically displayed. The only information that the [DisplayEntityType](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) adds here, is that the property ```BasicCollection``` is a navigation property. An eye icon will be displayed to take you directly to the matching page.

#### Display table

[DisplayTable](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) elements describe how a list of resources should be displayed.

The [DisplayTable](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) contains a list of [DisplayTableColumn](/docs/identitymanager/6.1/configuration-reference/xml-configuration/index.md) elements that identify which properties should be included in the list display.
...
The [AccessControlRule](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md) and [AccessControlEntry](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md) elements define [permissions](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md) for end-user profiles to read and write the connector's data (such as resources of a given entity type). It is used by the UI when displaying data such as resources and available roles.
...
Notice the __Agent__ attribute that contains the [name](/docs/identitymanager/6.1/installation-setup/agent-configuration.md) of the Agent which executes the Job. This attribute is mandatory for a Job containing Tasks executed agent-side, even if a unique local Agent exists.

### Components

The Synchronization job includes [three steps](/docs/identitymanager/6.1/automation/synchronization/upward-data-sync.md):

- Export
- Prepare-Synchro
- Synchro

These three steps are all contained in a [scaffolding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md) which allows the generation of the Incremental Synchronization configuration.
...
As the Principle of Least Privilege states, NETWRIX strongly recommends that you create a [Profile](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md) to be used during the Synchronization jobs which will be different from the one used during the Provisioning job. This contributes to separating access rights.
...
For an Agent to launch server-side Tasks from the Job via the [Usercube-Invoke-Job tool](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md), the profile linked to these tasks and used by the tool should be authorized to execute said tasks.
...
Granting access can be done via the [Synchronization AccessControlRules scaffolding](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md) and the [JobViewAccessControlRules scaffolding](/docs/identitymanager/6.1/configuration-reference/scaffoldings/scaffolding-reference.md).
...
An Agent's [Profile](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md) is associated with a ```ClientId/Secret``` pair used by the Agent to authenticate to the Server.

Usable ```ClientId/Secret``` pairs are written to the database from the xml configuration using the [```<OpenIdClient>``` xml element](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md).
...
The following example creates a ```ClientId/Secret``` pair to be used by the Agent to authenticate to the Server and complete Jobs. The secret is hashed with the [Usercube-New-OpenIDSecret](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md) tool.
...
The ```ClientId/Secret``` pairs that the Agent may use are written to the Agent's [appsettings.agent](/docs/identitymanager/6.1/installation-setup/agent-configuration.md) technical configuration set.
...
Use the Job [```CronTabExpression```](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md) attribute.
...
An external scheduler would rely on the [Usercube-Invoke-Job tool](/docs/identitymanager/6.1/tools-utilities/cli-reference/index.md).
...
[PowerShellProv connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
...
The
[`options` parameter](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
...
[Fulfill-RobotFramework](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
...
- `Generate Password`: This keyword expects a file that contains the
  [password reset settings](/docs/identitymanager/6.1/configuration-reference/xml-configuration/connector-config.md)
...
- `Open Telnet Connection`: opens the Telnet connection to the external system using the login and
  ...
  [**Options**](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
...
This guide shows how to write a PowerShell script used by the
[PowerShellSync connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
