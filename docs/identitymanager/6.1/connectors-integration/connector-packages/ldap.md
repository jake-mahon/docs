...
- [Directory/Generic LDAP](/docs/identitymanager/6.1/connectors-integration/connector-packages/ldap.md);
- [Directory/Oracle LDAP](/docs/identitymanager/6.1/connectors-integration/connector-packages/ldap.md);
- [Directory/Apache Directory](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md);
- [Directory/Red Hat Directory Server](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md).
...
Usercube UI or by
[assignment policy enforcement](/docs/identitymanager/6.1/access-control-security/role-assignment/assignment-policies.md).
...
This page is about
[Directory/Open LDAP](/docs/identitymanager/6.1/connectors-integration/connector-packages/ldap.md).
...
- enabling SyncProv Overlay for the OpenLDAP server.
  ...
  [LDAP connector](/docs/identitymanager/6.1/connectors-integration/connector-packages/ldap.md).
