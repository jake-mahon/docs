...
This page is about
[Directory/Active Directory](/docs/identitymanager/6.1/connectors-integration/connector-packages/active-directory.md).
...
- a file named `<connectionIdentifier>_entries.csv`, with one column for each property having a
  ...
  [See more details](/docs/identitymanager/6.1/connectors-integration/connector-configuration/entity-property-mapping.md).
...
[ExportCookies](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
folder.
...
> [scalar property](/docs/identitymanager/6.1/core-concepts/entity-model.md):
>
> ```
