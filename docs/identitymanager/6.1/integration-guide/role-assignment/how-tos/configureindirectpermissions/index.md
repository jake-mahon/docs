...
![Group Membership Schema](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/indirectpermissionsadexample.webp)
...
![Single Role Configuration Example](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/srconf_5.2.1.webp)

We will also create a test Composite Role to showcase indirect Composite Roles. We will name it ```TestCRoleAB```:

![Composite Role Configuration](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/crconf_5.2.1.webp)
...
![Navigation Rule Example](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/navrule_5.2.1.webp)

And finally, we need to add Single Role Rules to link our two previously created Single Roles to the new Composite Role:

![Single Role Rule Example](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/srrule_5.2.1.webp)
...
![View Permissions Simplified](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/viewpermissionssimplified_5.2.1.webp)

To display Indirect Permissions, you need to switch over to the ```Advanced view```. ```TestRoleA``` and ```TestRoleB``` should then appear:

![View Permissions Advanced](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/viewpermissionsadvanced_5.2.1.webp)
...
![AD Assigned Resource Navigations](/img/product_docs/identitymanager/6.1/integration-guide/role-assignment/how-tos/configureindirectpermissions/adassignednavigations_5.2.1.webp)
