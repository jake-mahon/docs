...
[Applicative configuration settings](/docs/identitymanager/6.1/installation-setup/server-configuration.md).
...
[Agent's appsetting](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
file.
