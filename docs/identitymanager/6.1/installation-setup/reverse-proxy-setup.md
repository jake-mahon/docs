...
- [TempFolderPath](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
- [WorkFolderPath](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
