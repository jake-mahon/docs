...
[same steps as for the server](/docs/identitymanager/6.1/installation-setup/server-configuration.md#create-the-service-account):
...
[technical configuration](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
...
[Credentials Protection](/docs/identitymanager/6.1/connectors-integration/index.md)
methods.
...
[EncryptionCertificate](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
**2.**[OpenIdClients](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
and
[DefaultOpenIdClient](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
...
[_OpenIdClient_ tag](/docs/identitymanager/6.1/configuration-reference/xml-configuration/access-control-config.md)
...
should be
[encrypted](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
[Email server](/docs/identitymanager/6.1/installation-setup/email-server-setup.md).
...
| PickupDirectory required**if** FromAddress/Host are empty | **Type** String **Description** Path to the pickup directory. [See more details on the pickup directory feature](/docs/identitymanager/6.1/installation-setup/email-server-setup.md). **Note:** to be used only when `UseSpecifiedPickupDirectory` is set to `true`. **Example**`{     �     "PasswordResetSettings": {       �       "MailSettings": {         "PickupDirectory": "../Mails",         �       }     }   }`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| InvokeSqlCommands default value: null                                 | String                | List of parameter sets used to override InvokeSqlCommandTasks' SQLInputFile and OutputPath parameters from the XML configuration. See the [ InvokeSqlCommandTask ](/docs/identitymanager/6.1/configuration-reference/xml-configuration/jobs-config.md) topic for additional information. For each task to override, the key must be the task's identifier. Example: `appsettings.json    {          "InvokeSqlCommands": {           "InvokeSqlCommandTask_Identifier": {             "SQLInputFile": "YourInputFilePath",             "OutputPath": "YourOutputFilePath"  },           }   }`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| ------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| File (required)     | String | [PKCS #12](https://en.wikipedia.org/wiki/PKCS_12) archive path on the host file system.                                                                                                                                                                                                                                                                                                                                    |
| Password (optional) | String | [PKCS #12](https://en.wikipedia.org/wiki/PKCS_12) archive password. storing a .pfx file's password in plain text in a production environment is strongly discouraged. It should always be encrypted using the Usercube-Protect-CertificatePassword.exe tool. See the [ Usercube-Protect-CertificatePassword ](/docs/identitymanager/6.1/tools-utilities/cli-reference/security-tools.md) topic for additional information. |
...
See examples in
[connectors' credential protection](/docs/identitymanager/6.1/connectors-integration/connector-packages/custom-connectors.md)
sections.
...
[external systems](/docs/identitymanager/6.1/connectors-integration/index.md) with
...
Any [connector](/docs/identitymanager/6.1/connectors-integration/index.md) using
...
1. The
   ...
   [appsettings.json file](/docs/identitymanager/6.1/core-concepts/architecture/index.md)
   or as
...
3. There are two additional files involved in the _Agent_'s configuration to protect sensitive data:
   [appsettings.encrypted.agent.json](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
   and
   [appsettings.cyberark.agent.json](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
...
- A _CyberArk\_\_Vault_ referenced by the
  ...
  file.
- The
  [appsettings.connection.json](/docs/identitymanager/6.1/configuration-reference/technical-files/appsettings-reference.md)
  file.

Each configuration source is loaded one after the other, in the following order:

1. [appsettings.agent.json](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
2. [appsettings.encrypted.agent.json](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
3. _[Azure Key Vault](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)_
   safe
4. _[CyberArk](/docs/identitymanager/6.1/installation-setup/agent-configuration.md)
   Vault_
5. [appsettings.connection.json](/docs/identitymanager/6.1/configuration-reference/technical-files/appsettings-reference.md)
...
[agent's configuration files](/docs/identitymanager/6.1/installation-setup/agent-configuration.md).
