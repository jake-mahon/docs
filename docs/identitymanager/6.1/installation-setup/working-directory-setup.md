...
- `appsettings.*.json`:
  [technical configuration files](/docs/identitymanager/6.1/configuration-reference/network-configuration/index.md).

## What's Next?

Next section shows how to
[install the Usercube Database](/docs/identitymanager/6.1/installation-setup/database-setup.md).
