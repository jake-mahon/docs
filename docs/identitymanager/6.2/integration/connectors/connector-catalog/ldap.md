...
- [ Generic LDAP ](/docs/identitymanager/6.2/integration/connectors/connector-packages.md);
- [ Oracle LDAP ](/docs/identitymanager/6.2/integration/connectors/connector-packages.md);
- [ Apache Directory ](/docs/identitymanager/6.2/integration/connectors/connector-packages.md);
- [ Red Hat Directory Server ](/docs/identitymanager/6.2/integration/connectors/connector-packages.md).
...
[ Connection ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) folder one file
...
Identity Manager UI or by [Evaluate Policy](/docs/identitymanager/6.2/access-governance/role-management/role-assignment.md)
enforcement.
...
- enabling SyncProv Overlay for the OpenLDAP server.
  ...
  [ LDAP ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/ldap.md) connector.
...
the[ Connection ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) folder:
