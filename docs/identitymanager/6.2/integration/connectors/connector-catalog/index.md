...
- [ Azure ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/azure-ad.md)

  Exports Azure resources, role definitions and assignments.

- [ CSV ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/database-connectors.md)

  Exports data from a CSV file.

- [ EasyVista ](/docs/identitymanager/6.2/reference/index.md)

  Exports and fulfills users from/to an EasyVista-compliant system.

- [ EasyVista Ticket ](/docs/identitymanager/6.2/reference/index.md)

  Opens tickets in EasyVista for manual provisioning.

- [ Google Workspace ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/cloud-applications.md)

  Exports and fulfills users and groups from/to a Google Workspace instance.

- [ Home Folder ](/docs/identitymanager/6.2/reference/index.md)
...
- [Internal Resources](/docs/identitymanager/6.2/integration/connectors/index.md)

  Opens manual provisioning tickets in Identity Manager.

- [JSON](/docs/identitymanager/6.2/reference/index.md)

  Generates JSON files for each provisioning order.

- [ LDAP ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/ldap.md)

  Exports and fulfills entries from/to a LDAP-compliant system.

- [LDIF](/docs/identitymanager/6.2/reference/index.md)

  Exports entries from a LDIF file.

- [ Microsoft Entra ID](/docs/identitymanager/6.2/integration/connectors/connector-catalog/azure-ad.md)

  Exports and fulfills user and groups from/to a Microsoft Entra ID instance.

- [ Microsoft Excel ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/database-connectors.md)
...
- [ OData ](/docs/identitymanager/6.2/reference/index.md)

  Exports and fulfills entries from/to an OData instance.

- [Okta](/docs/identitymanager/6.2/integration/connectors/connector-catalog/cloud-applications.md)

  Exports and fulfills entries from/to an Okta instance.

- [ OpenLDAP ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/ldap.md)
...
- [ PowerShellSync ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/custom-connectors.md)

  Exports data from an external system via a Powershell script.

- [ RACF ](/docs/identitymanager/6.2/reference/index.md)
...
- [SAP ERP 6.0 and SAP S4/HANA](/docs/identitymanager/6.2/reference/index.md)

  Exports and fulfills users and roles from/to a SAP ERP 6.0 or SAP S4/HANA instance.

- [ SAP Netweaver ](/docs/identitymanager/6.2/reference/index.md)

  Exports and fulfills users and roles from/to a SAP Netweaver instance.

- [SCIM](/docs/identitymanager/6.2/integration/connectors/connector-catalog/scim.md)

  Exports and fulfills entities from/to a SCIM-compliant application.

- [ ServiceNow ](/docs/identitymanager/6.2/reference/index.md)

  Exports and fulfills any data from/to a ServiceNow CMDB.

- [ ServiceNowTicket ](/docs/identitymanager/6.2/reference/index.md)

  Opens tickets in ServiceNow for manual provisioning.

- [ SharedFolders ](/docs/identitymanager/6.2/reference/index.md)

  Exports users and permissions from Windows shared folders.

- [SharePoint](/docs/identitymanager/6.2/reference/index.md)

  Exports sites, folders, groups and permissions from a SharePoint instance.

- [ Sql ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/database-connectors.md)

  Exports data from one of various Database Management Systems.

- [ Sql Server Entitlements ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/database-connectors.md)

  Exports entitlements from Microsoft SQL Server.

- [ Top Secret ](/docs/identitymanager/6.2/reference/index.md)

  Exports users and profiles from a Top Secret (TSS) instance.

- [ Workday ](/docs/identitymanager/6.2/integration/connectors/connector-catalog/cloud-applications.md)
