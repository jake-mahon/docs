...
![Inbound System=](/img/product_docs/identitymanager/saas/user-guide/optimize/hr-connector-creation/connectorcreation_inbound.webp)
...
3. Check that the entity types have been added to the left menu of the home page.
    ...
    ![Test Entity Type](/img/product_docs/identitymanager/saas/user-guide/optimize/hr-connector-creation/hr_validatemenu_v600.webp)
