...
3. Click on **+ Create** to get on the connector's overview page:
    ...
    ![Connector page](/img/product_docs/identitymanager/saas/user-guide/set-up/connect-system/connector-declaration/connectorcreation_connectorpage_v602.webp)
...
![Test Connector](/img/product_docs/identitymanager/saas/user-guide/set-up/connect-system/connector-declaration/connectorcreation_test_v602.webp)
