...
is written in the [Toolkit for XML Configuration](/docs/identitymanager/6.2/development/configuration-toolkit/index.md) in the form of an
...
[ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) and
...
[](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)[ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
...
An [ Entity Association ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
...
[Languages](/docs/identitymanager/6.2/development/configuration-toolkit/index.md).

#### Computed property

A property can be calculated from other properties. The
[Entity Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) element allows the
...
using the [Expressions](/docs/identitymanager/6.2/development/configuration-toolkit/expressions.md).
...
[Entity Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md). Otherwise, a default value
...
[Entity Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) or
[](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)[Entity Association](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md).
...
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md), their
...
[Upward Data Synchronization](/docs/identitymanager/6.2/identity-management/synchronization/sync-configuration.md)) and entity properties.
This information is provided by the
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md), their
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)and
[Entity Association Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md).

Every [Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)maps
a CSV column to a scalar [Entity Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md).
...
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) using the
...
When writing an
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md), one of
the _scalar properties_ should be chosen as
[Entity Type Mapping](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md). This
...
the [Identity Management](/docs/identitymanager/6.2/identity-management/index.md) topic for additional information.
