...
[OpenIdClient](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) linked to
...
3. Configure an `OpenIdClient`, both on agent side in `appsettings.agent.json` with the non-hashed
   ...
   executable. See the
   [ OpenIdClient ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) for
