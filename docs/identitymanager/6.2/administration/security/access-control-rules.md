...
- The permission's recipient will receive a notification email.
  ...
  **NOTE:** In order to receive the notifications, a profile must have the full permission path.
  ...
  [Access Control Rule](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)topic
...
- /Custom/ResourceFiles/`{entityType_identifier}`/`{property_identifier}`/View
  ...
  [`ViewAccessControlRules`](/docs/identitymanager/6.2/reference/configuration-reference/scaffoldings.md)
  scaffolding.
