...
See the [Tasks](/docs/identitymanager/6.2/administration/jobs-tasks/task-management.md) topic for additional information.

See the [ Jobs ](/docs/identitymanager/6.2/administration/jobs-tasks/job-configuration.md) topic for additional information.

See the [ Tasks ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) topic for additional
information.

Make sure to read how to [Build Efficient Jobs](/docs/identitymanager/6.2/administration/jobs-tasks/job-configuration.md).
...
These building blocks are called [Tasks](/docs/identitymanager/6.2/administration/jobs-tasks/task-management.md), and can be easily organized together and
scheduled in [ Jobs ](/docs/identitymanager/6.2/administration/jobs-tasks/job-configuration.md).
