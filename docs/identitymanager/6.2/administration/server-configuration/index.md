...
to environment variables. See the [ Architecture ](/docs/identitymanager/6.2/getting-started/architecture-overview.md) topic for additional
information.
...
See the[ Connection to the Database ](/docs/identitymanager/6.2/administration/server-configuration/database-connection.md),
[ End-User Authentication](/docs/identitymanager/6.2/administration/server-configuration/authentication.md) and
[Application Settings](/docs/identitymanager/6.2/administration/server-configuration/general-settings.md) topics for additional information.

## Secret and Certificate Management

All the certificates and secrets present in the settings can be loaded with an Azure Key Vault.

See the [Azure Key Vault](/docs/identitymanager/6.2/administration/agent-configuration/credential-providers.md) topic for additional
information.
