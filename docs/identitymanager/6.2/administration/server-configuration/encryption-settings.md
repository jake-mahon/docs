...
- [ Usercube-Protect-X509JsonFile ](/docs/identitymanager/6.2/reference/command-line-tools/utility-tools.md)to
...
This file follows the exact same structure as the [Server Configuration](/docs/identitymanager/6.2/administration/server-configuration/index.md) files.
