...
given activity in a [Workflows](/docs/identitymanager/6.2/integration/workflows/index.md).
...
1. In the XML configuration, create a `Language` with `IndicatorNumber` set to `1`. See the
   [ Language ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) topic for additional
   information.
...
1. In the XML configuration, configure `MailSetting` with a `LanguageCode`See the
   [ Mail Setting ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) topic
