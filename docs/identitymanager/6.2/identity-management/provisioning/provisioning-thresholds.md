...
[Resource Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) to count the
...
Distinct [ Thresholds ](/docs/identitymanager/6.2/identity-management/synchronization/sync-thresholds.md)are configurable for
synchronization.
