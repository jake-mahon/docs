...
Identity Manager's [Entity Model](/docs/identitymanager/6.2/reference/entity-model.md) and translates them into resources
...
- ascertains differences between the real managed system state and the
  [ Assignment Policy ](/docs/identitymanager/6.2/access-governance/role-management/role-rules.md) theoretical state.
...
[ Tasks & Jobs ](/docs/identitymanager/6.2/administration/jobs-tasks/index.md).

A _Sync Up_ is planned for every managed system that interact with Identity Manager.

A _Sync Up_ is associated with a [Connectors](/docs/identitymanager/6.2/integration/connectors/index.md).
...
are written to the
[Application Settings](/docs/identitymanager/6.2/administration/agent-configuration/agent-settings.md) waiting
...
Identity Manager's [Connectors](/docs/identitymanager/6.2/integration/connectors/index.md) provide native _Export_ tasks for the
...
[Connectors](/docs/identitymanager/6.2/integration/connectors/index.md) section together with an exhaustive list of supported source
managed systems.

[Connectors](/docs/identitymanager/6.2/integration/connectors/index.md)are Identity Manager's link to the managed system. They
...
[Application Settings](/docs/identitymanager/6.2/administration/agent-configuration/agent-settings.md). The
whole can be scheduled and orchestrated by a [ Jobs ](/docs/identitymanager/6.2/administration/jobs-tasks/job-configuration.md).
...
format_, described in the [Connectors](/docs/identitymanager/6.2/integration/connectors/index.md) section. Usually, two kinds of
...
[ Export Task ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) task within a
Job.
...
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) elements.

Entity Type Mapping elements map the resources _CSV source files_ columns to [Entity Model](/docs/identitymanager/6.2/reference/entity-model.md) properties. Each mapping also identifies one column as the _primary key_ for this Entity Type. The _primary key_ is used to uniquely identify a resource in the _Sync Up_ process. It's mandatory to be able to perform _incremental__Sync Up_, as it allows to identify a resource on which an _update_ or a _delete_ has to be performed.

[
Entity Association Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) elements translate the _CSV source files_ into [Entity Model](/docs/identitymanager/6.2/reference/entity-model.md). They describe rules identifying associations between resources loaded thanks to the [](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)[
Entity Type Mapping
...
1. Removing columns that are not used in [
   Entity Type Mapping
   ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) or [
   Entity Association Mapping
   ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
...
Entity Type Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) or an[
Entity Association Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) ```<EntityAssociationMapping>``` , a ```.sorted.csv``` file is generated, containing the final, cleaned, sorted result.
...
- [
  ...
  ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) is the standard _prepare-synchronization_ task.
...
Entity Association Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) to translate _CSV source files_ into _Entity Model compliant_ resources and resolve association links.
...
Connector
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md), that are in the database but not in the _CSV source files_ will be deleted. That means no change made to the database from outside of the connectors or the UI are persistent.
...
- [
  Synchronize Task
  ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) i is the standard _synchronization_ task.
...
_Incremental_ mode also offers another optimization that will be described in the [Evaluate Policy](/docs/identitymanager/6.2/access-governance/role-management/role-assignment.md) section. Trade-offs of that optimization can also be counterbalanced by running a daily _complete_ synchronization.
...
Connector
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md), an [
Entity Type Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) and/or an[
Entity Association Mapping
](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md). They are expressed as number of lines (ex: ```MaximumInsertedLines```) or as a rate (ex: ```MaxPercentageDeletedLines```).
...
Assignment Policy
](/docs/identitymanager/6.2/access-governance/role-management/role-rules.md).
````
