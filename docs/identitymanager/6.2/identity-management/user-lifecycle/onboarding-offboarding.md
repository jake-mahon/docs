...
See the [Role Assignment](/docs/identitymanager/6.2/access-governance/role-management/role-assignment.md) topic for additional information on
...
See the [ Automate Assignments ](/docs/identitymanager/6.2/reference/index.md)
...
[ Record Section ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) and
