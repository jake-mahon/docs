...
- the provisioning of identity properties directly to the connected systems, based on the
  computation of the [ Role Model ](/docs/identitymanager/6.2/access-governance/role-management/role-model.md).

See the [Synchronization](/docs/identitymanager/6.2/identity-management/synchronization/index.md) topic for additional information.

See the [Provisioning](/docs/identitymanager/6.2/identity-management/provisioning/index.md) topic for additional information.
...
![Usercube's Repository](/img/product_docs/identitymanager/identitymanager/introduction-guide/overview/identity-management/identities_repository.webp)
...
![quadratic-linear-complexity](/img/product_docs/identitymanager/identitymanager/introduction-guide/overview/identity-management/quadratic-linear-complexity.webp)
...
Let's learn about [ Entitlement Management ](/docs/identitymanager/6.2/reference/index.md).
...
Learn more on [Connectors](/docs/identitymanager/6.2/integration/connectors/index.md).

See how to create a
[ Connect to a Managed System ](/docs/identitymanager/6.2/reference/index.md).

Learn more on [Synchronization](/docs/identitymanager/6.2/identity-management/synchronization/index.md).

Learn more on [Workflows](/docs/identitymanager/6.2/integration/workflows/index.md).
