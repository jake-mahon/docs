...
See the
[ Access Review Administration Access Control Rules ](/docs/identitymanager/6.2/reference/configuration-reference/scaffoldings.md)
topic for additional information.

The administrator profile, created with CreateAdministratorProfile scaffolding, already has these
permissions. See the
[ Create Administrator Profile ](/docs/identitymanager/6.2/reference/configuration-reference/scaffoldings.md)
topic for additional information.
...
UI. See the [Access Certification](/docs/identitymanager/6.2/access-governance/access-certification/index.md) topic for additional information.
