...
[ Automate Assignments ](/docs/identitymanager/6.2/reference/index.md) topic for
...
[Single Role Rule](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) which will
...
[ Conforming Assignments ](/docs/identitymanager/6.2/access-governance/role-management/role-assignment.md)that
...
[ Mining Rule ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) that Identity Manager
applies with the
...
configured with a [ Single Role ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md),
...
[ Get Role Mining Task ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
to generate role assignment rules either directly or in a [Simulation](/docs/identitymanager/6.2/access-governance/role-management/index.md).
...
push the [ Automate Assignments ](/docs/identitymanager/6.2/reference/index.md) wall further.
...
2. Click on the addition button at the top right and fill in the fields.
   ...
   - `Policy`: [Create a Policy](/docs/identitymanager/6.2/reference/index.md) in which the mining rule exists.
   - `Entity Type`:
     [Create an Entity Type](/docs/identitymanager/6.2/reference/index.md) on which
   ...
   - `Rule Policy`: [Create a Policy](/docs/identitymanager/6.2/reference/index.md) in which the single role
...
4. Click on **Simulate** to perfom role mining in a simulation. See
   the[ Perform a Simulation ](/docs/identitymanager/6.2/access-governance/role-management/index.md) topic for additional information.
...
[Remove Redundant Assignments](/docs/identitymanager/6.2/reference/index.md) after any assignment rule
