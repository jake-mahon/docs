...
- [Resource Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) rules;
- [ Single Role ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) and
...
[ Perform Role Mining ](/docs/identitymanager/6.2/access-governance/role-management/role-mining.md) for
...
See the [ Perform a Simulation ](/docs/identitymanager/6.2/access-governance/role-management/index.md) for additional
information.
...
[Create a Policy](/docs/identitymanager/6.2/reference/index.md). See the
[ Create Roles in the Role Catalog ](/docs/identitymanager/6.2/reference/index.md),
[ Automate Role Assignments ](/docs/identitymanager/6.2/access-governance/role-management/role-assignment.md)[ Correlate Resources ](/docs/identitymanager/6.2/reference/index.md),
and [Create a Policy](/docs/identitymanager/6.2/reference/index.md) topics for additional information.
...
See the [ Correlate Resources ](/docs/identitymanager/6.2/reference/index.md)
[ Resource Classification Rule ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md),
and
[Resource Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
...
A simulation can also be created by the
[ Perform Role Mining ](/docs/identitymanager/6.2/access-governance/role-management/role-mining.md) for the automation of role
assignments.
...
[ Categorize Resources ](/docs/identitymanager/6.2/reference/index.md) topics for additional information.
