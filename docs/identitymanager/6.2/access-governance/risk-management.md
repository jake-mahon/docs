...
A [ Risk ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) describes a sensitive
...
scores are the priority of the next [Access Certification](/docs/identitymanager/6.2/access-governance/access-certification/index.md)
campaign.

See the [ Manage Risks ](/docs/identitymanager/6.2/reference/index.md)topic for additional
information on how to use the risk management module to identify entitlement assignments that pose a
security risk.

## Risk Definition

A [ Risk ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) is an object that describes a
...
- part of a [Policy](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md);
- assigned to identities belonging to a specific entity type that was decided during the risk
  creation;
- organized inside a [ Risk Management ](/docs/identitymanager/6.2/access-governance/risk-management.md);
- linked to an [ Risk Management ](/docs/identitymanager/6.2/access-governance/risk-management.md).
...
[ Risk ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) are assigned to resources
...
[ Risk ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) rules. For each new
...
[Resource Type](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) within Identity
Manager.
...
1. Choose an [ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) of which
...
Once [ Risk ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) are assigned to
...
[Access Certification](/docs/identitymanager/6.2/access-governance/access-certification/index.md) campaign. The identity with the highest risk
