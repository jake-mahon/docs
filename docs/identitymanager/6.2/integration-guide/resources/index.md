...
[ Upward Data Synchronization ](/docs/identitymanager/6.2/integration-guide/synchronization/upward-data-sync/index.md) into Identity
...
1. Input data directly from the [Toolkit for XML Configuration](/docs/identitymanager/6.2/integration-guide/toolkit/index.md). This is useful
...
3. [ Upward Data Synchronization ](/docs/identitymanager/6.2/integration-guide/synchronization/upward-data-sync/index.md) from a CSV file.
