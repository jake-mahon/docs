...
See an example on [ For Microsoft Entra ID ](/docs/identitymanager/6.2/integration-guide/connectors/how-tos/setup-incremental-synchronization/azuread/index.md) (formerly Microsoft Azure AD).
...
First read how to [Create a Connector](/docs/identitymanager/6.2/integration-guide/connectors/how-tos/create-connector/index.md).
...
[ Job Execution Access Control Rules ](/docs/identitymanager/6.2/integration-guide/toolkit/xml-configuration/configuration/scaffoldings/templates/jobexecutionaccesscontrolrules/index.md)that
...
1. Deploy the XML configuration to the database, by using
   the[ Deploy Configuration Task ](/docs/identitymanager/6.2/integration-guide/toolkit/xml-configuration/jobs/tasks/server/deployconfigurationtask/index.md).
