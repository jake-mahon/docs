...
**1.\_\_**Before proceeding\_\_, you should go through the [ Overview ](/docs/identitymanager/6.2/getting-started/architecture-overview.md) and
[Requirements](/docs/identitymanager/6.2/getting-started/system-requirements.md) sections to make fundamental decisions about Identity
...
the relevant [Network Configuration](/docs/identitymanager/6.2/administration/index.md)
sections.
...
The first step consists in [ Create a Working Directory ](/docs/identitymanager/6.2/installation/pre-installation/working-directory-setup.md).
