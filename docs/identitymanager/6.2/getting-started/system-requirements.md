...
> [Install the Server](/docs/identitymanager/6.2/installation/server-installation.md) topic for additional information.
...
- Service accounts with the necessary permissions for the agent to perform _Read_ and/or _Write_
  ...
  provisioning; See the [Connectors](/docs/identitymanager/6.2/integration/connectors/index.md) topic for
...
protected. See the
[appsettings.agent](/docs/identitymanager/6.2/administration/agent-configuration/agent-settings.md)
and [ Modules ](/docs/identitymanager/6.2/development/index.md) topics for additional information.
...
[ Send Notifications ](/docs/identitymanager/6.2/installation/pre-installation/email-server-setup.md).
...
To start the installation, follow either the [ Quick Start Guide](/docs/identitymanager/6.2/getting-started/quick-start.md) or the
[Production-Ready Installation](/docs/identitymanager/6.2/installation/pre-installation/index.md).
...
the[Database](/docs/identitymanager/6.2/getting-started/system-requirements.md)topic for additional information.

# Requirements

This section identifies hardware and software requirements for each Identity Manager component:

- [Integration Device](/docs/identitymanager/6.2/getting-started/system-requirements.md)
- [Database](/docs/identitymanager/6.2/getting-started/system-requirements.md)
- [Server](/docs/identitymanager/6.2/getting-started/system-requirements.md)
- [ Agent ](/docs/identitymanager/6.2/getting-started/system-requirements.md)
...
the[ Create a Working Directory ](/docs/identitymanager/6.2/installation/pre-installation/working-directory-setup.md) topic as:
...
See the [Database](/docs/identitymanager/6.2/getting-started/system-requirements.md) and
[Install the Server](/docs/identitymanager/6.2/installation/server-installation.md) topics for additional information.
...
[ Agent ](/docs/identitymanager/6.2/getting-started/system-requirements.md) topic for additional information.
