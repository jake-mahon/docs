...
[Network Configuration](/docs/identitymanager/6.2/administration/index.md) topic for additional
information.
...
- The **On-Premise** offering requires the Agent, the
  [Install the Server](/docs/identitymanager/6.2/installation/server-installation.md), and the
  [ Install the Database ](/docs/identitymanager/6.2/installation/pre-installation/database-setup.md) to be installed.

See the [ Install the Agents](/docs/identitymanager/6.2/installation/agent-installation.md) topics for additional information.
...
[ Install the Agents](/docs/identitymanager/6.2/installation/agent-installation.md) topics for additional information.
...
methods are available. See the [Install the Server](/docs/identitymanager/6.2/installation/server-installation.md) topic for
additional information.

## Email Server

Identity Manager sends notifications to users by email. An email server will have to be set up for
the Agent and the Server. See the [ Send Notifications ](/docs/identitymanager/6.2/installation/pre-installation/email-server-setup.md)
topic for additional information.

Before you check out the installation steps, make sure that all the
[Requirements](/docs/identitymanager/6.2/getting-started/system-requirements.md) are met.
...
See the [ SaaS Environment ](/docs/identitymanager/6.2/reference/architecture-details.md) topic for additional information on Netwrix Identity
Manager (formerly Usercube) recommended architecture when working in a SaaS environment.

See the [ On-Premises Environment ](/docs/identitymanager/6.2/reference/architecture-details.md) topic for additional information on Netwrix
Identity Manager (formerly Usercube)' recommended architecture when working in an on-premises
environment.

See how to
[ Protect Agent/Server Communication ](/docs/identitymanager/6.2/administration/security/index.md).
