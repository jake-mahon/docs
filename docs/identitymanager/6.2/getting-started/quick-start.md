...
- [Database](/docs/identitymanager/6.2/getting-started/system-requirements.md)-related specifications
...
the[ Usercube-Deploy Configuration](/docs/identitymanager/6.2/reference/command-line-tools/deployment-tools.md)
...
[Usercube-Server ](/docs/identitymanager/6.2/reference/command-line-tools/server-executable.md) topic for
...
configuration of your IGA project from scratch. See the [User Guide](/docs/identitymanager/6.2/reference/index.md)
topic for additional information.
