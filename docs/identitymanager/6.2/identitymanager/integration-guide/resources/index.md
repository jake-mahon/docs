...
[ Upward Data Synchronization ](/docs/identitymanager/6.2/identitymanager/integration-guide/synchronization/upward-data-sync/index.md) into Identity
...
1. Input data directly from the [Toolkit for XML Configuration](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/index.md). This is useful
...
3. [ Upward Data Synchronization ](/docs/identitymanager/6.2/identitymanager/integration-guide/synchronization/upward-data-sync/index.md) from a CSV file.
...
[Entitlement Assignment](/docs/identitymanager/6.2/identitymanager/integration-guide/role-assignment/assignments-of-entitlements/index.md) topic for
