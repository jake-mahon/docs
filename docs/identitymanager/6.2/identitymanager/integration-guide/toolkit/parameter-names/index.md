...
The [ Context Rule ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/contextrule/index.md) support _128_ dimension
