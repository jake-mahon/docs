...
[ Workflow ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/workflows/workflow/index.md) to create a new
resource with a unique record.

## Declare a Workflow

This [ Workflow ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/workflows/workflow/index.md) is made of four
activities:
...
[ Position Change via Records ](/docs/identitymanager/6.2/identitymanager/integration-guide/identity-management/joiners-movers-leavers/position-change/index.md)topic
...
users. See the [Workflows](/docs/identitymanager/6.2/identitymanager/integration-guide/workflows/index.md) topic for additional information.
...
[ Menu Item ](/docs/identitymanager/6.2/identitymanager/integration-guide/toolkit/xml-configuration/user-interface/menuitem/index.md)must be defined to
