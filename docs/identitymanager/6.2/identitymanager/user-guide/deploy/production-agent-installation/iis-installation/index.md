...
To continue, [ Configure the Pool and Site ](/docs/identitymanager/6.2/identitymanager/user-guide/deploy/production-agent-installation/iis-configuration/index.md)the application pool and
website via IIS.
