...
[ Role Model ](/docs/identitymanager/6.2/identitymanager/integration-guide/role-model/index.md) needed by the organization. Roles are
...
- to be effective, roles must be linked to actual entitlements in the managed systems. Technically
  ...
  type. See the [ Categorize Resources ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/categorization/index.md) topic for additional
  information.
...
[ Model the Data ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/connect-system/connector-modeling/index.md) established for a given system.
...
[Create a Role Manually](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/single-roles-catalog-creation/role-manual-creation/index.md) topic for additional information.
...
[ Create Roles in Bulk ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/single-roles-catalog-creation/role-naming-rule-creation/index.md) topic for additional information.
...
1. Create as many single roles as possible (with their navigation rules and categories) via the
   [ Create Roles in Bulk ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/single-roles-catalog-creation/role-naming-rule-creation/index.md) naming rules.
2. Complete the role catalog if needed by creating manually additional
   [ Create a Category ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/single-roles-catalog-creation/category-creation/index.md) and single roles with their navigation rules.
3. Add [Create a Composite Role](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/composite-role-creation/index.md) to the single role
...
[ Perform a Simulation ](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/simulation/index.md) are available in order to anticipate
...
[ Manage Risks ](/docs/identitymanager/6.2/identitymanager/user-guide/optimize/risk-management/index.md)management.
