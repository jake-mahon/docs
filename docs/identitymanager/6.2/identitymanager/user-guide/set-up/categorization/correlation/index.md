...
| Input                                                                                                                      | Output            |
| -------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| Identity repository ( (required) Resource types (required) [ Synchronize Data ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/synchronization/index.md) (required) | Correlation rules |
...
[ Create a Resource Type ](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/categorization/resource-type-creation/index.md) topics for additional information.
