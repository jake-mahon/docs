...
[Load Identities to Identity Manager](/docs/identitymanager/6.2/identitymanager/user-guide/set-up/initial-identities-loading/load-identities/index.md) topic for additional
information.  
