...
previously read the [Introduction Guide](/docs/identitymanager/6.2/identitymanager/introduction-guide/index.md) in order to be aware of the
...
[Introduction Guide](/docs/identitymanager/6.2/identitymanager/introduction-guide/index.md) to fully benefit from the User Guide's content.
...
[Integration Guide](/docs/identitymanager/6.2/identitymanager/integration-guide/index.md).
...
[ Global Process ](/docs/identitymanager/6.2/identitymanager/user-guide/global-process/index.md).
...
Start by studying the [ Global Process ](/docs/identitymanager/6.2/identitymanager/user-guide/global-process/index.md). that details every activity in
