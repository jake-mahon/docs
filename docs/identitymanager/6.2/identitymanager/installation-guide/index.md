...
[ Overview ](/docs/identitymanager/6.2/identitymanager/installation-guide/overview/index.md) of the architecture and available configurations will help you make
informed decisions.
