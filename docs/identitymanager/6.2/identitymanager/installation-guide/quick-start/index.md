...
- [Database](/docs/identitymanager/6.2/identitymanager/installation-guide/requirements/database-requirements/index.md)-related specifications
...
the[ Usercube-Deploy Configuration](/docs/identitymanager/6.2/identitymanager/integration-guide/executables/references/deploy-configuration/index.md)
...
[Usercube-Server ](/docs/identitymanager/6.2/identitymanager/integration-guide/executables/references/server/index.md) topic for
...
configuration of your IGA project from scratch. See the [User Guide](/docs/identitymanager/6.2/identitymanager/user-guide/index.md)
topic for additional information.
