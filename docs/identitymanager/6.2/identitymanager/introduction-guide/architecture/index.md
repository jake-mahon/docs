...
Let's learn about Identity Manager [Configuration](/docs/identitymanager/6.2/identitymanager/introduction-guide/configuration/index.md).

## Learn More

Learn more on Identity Manager's Architecture.

See the [Network Configuration](/docs/identitymanager/6.2/identitymanager/integration-guide/network-configuration/index.md) topic for
