...
the [Integration Guide](/docs/identitymanager/6.2/identitymanager/integration-guide/index.md)'s or the
[User Guide](/docs/identitymanager/6.2/identitymanager/user-guide/index.md)'s contents.
...
Let's dive in with an [IGA and Netwrix Identity Manager](/docs/identitymanager/6.2/identitymanager/introduction-guide/overview/index.md) of IGA and Identity
Manager.
