...
can be found in the Data model. See the [ XML Configuration Schema ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
topic for additional information.

For example, the structure of the `<Connector>` element can be found in the
[Connectors](/docs/identitymanager/6.2/integration/connectors/index.md) topic.
...
[Access Control Rule](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) item in the
database.
...
2. Write an XML element whose identifier is the same as the one generated by the scaffolding.
   ...
   [Scaffoldings](/docs/identitymanager/6.2/reference/configuration-reference/scaffoldings.md) topic, in the
...
4. [ Usercube-Deploy Configuration](/docs/identitymanager/6.2/reference/command-line-tools/deployment-tools.md)
   again.

# Toolkit for XML Configuration

The Netwrix Identity Manager (formerly Usercube) configuration is a set of XML files edited
according the Usercube schema. The [ Recommendations ](/docs/identitymanager/6.2/development/configuration-toolkit/index.md) part of this
...
The
[ Deploy Configuration Task ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)tool
is used to **import** a new version of the configuration (from the XML files set).
The[ Usercube-Export-Configuration ](/docs/identitymanager/6.2/reference/command-line-tools/deployment-tools.md) can be
...
_DisplayName_ of an [ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) can be
...
Languages list must be specified by [ Language ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)
elements.
...
The [ Context Rule ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) support _128_ dimension
...
![Auto-complete](/img/product_docs/identitymanager/identitymanager/integration-guide/toolkit/recommendations/autocomplete.webp)
...
![Recommendation](/img/product_docs/identitymanager/identitymanager/integration-guide/toolkit/recommendations/recommendation.webp)

# Reserved identifiers

Identifiers of [ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md) and
[ Entity Type ](/docs/identitymanager/6.2/development/configuration-toolkit/xml-configuration.md)cannot be one of the following
words:
