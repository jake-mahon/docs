...
[Scaffoldings](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
...
2.  Write an XML element whose identifier is the same as the one generated by the scaffolding.
    ...
    [Scaffoldings](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic, in the
