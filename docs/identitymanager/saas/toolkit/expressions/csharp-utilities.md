...
[Expressions](/docs/identitymanager/saas/toolkit/expressions/index.md) topic for additional information.
...
[ Build Unique Value Aspect ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
