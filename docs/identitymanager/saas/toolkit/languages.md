...
_DisplayName_ of an [ Entity Type ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/metadata/entitytype/index.md) can be
...
Languages list must be specified by [ Language ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/metadata/language/index.md)
elements.
