...
Repository**. See the [ Upward Data Synchronization ](/docs/identitymanager/saas/synchronization/upward-data-sync.md)
...
3. Load data from a CSV file. This is how data from managed systems are loaded most of the time. See
   the [ Upward Data Synchronization ](/docs/identitymanager/saas/synchronization/upward-data-sync.md) topic for
