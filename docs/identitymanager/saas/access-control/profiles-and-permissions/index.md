...
How to tweak the
[References: Permissions](/docs/identitymanager/saas/access-control/profiles-and-permissions/permissions.md) for
...
- administration, which gives access to [Administrate](/docs/identitymanager/saas/getting-started/index.md) actions,
...
[Assign Users a Profile](/docs/identitymanager/saas/access-control/profiles-and-permissions/create-assign-profiles.md) topic for additional information.
...
| Input                                                                                                   | Output        |
| ------------------------------------------------------------------------------------------------------- | ------------- |
| [ Create the Workforce Repository ](/docs/identitymanager/saas/identity-management/index.md) (required) | User profiles |
...
See the [Assign Users a Profile](/docs/identitymanager/saas/access-control/profiles-and-permissions/create-assign-profiles.md) topic for additional
information.

## Next Steps

Once user profiles are configured, integrators can start configuring onboarding workflows. See the
[ Create the Workforce Repository ](/docs/identitymanager/saas/identity-management/index.md) topic for additional
information.
