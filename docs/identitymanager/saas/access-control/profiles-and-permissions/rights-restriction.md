...
1. Create the appropriate dimensions.
   ...
   See the [ Dimension ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/metadata/dimension/index.md) topic for
...
2. Create an access control entity type to list all the properties whose visibility must be
   ...
   [ Dimension ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/metadata/dimension/index.md) topic for
   additional information.
