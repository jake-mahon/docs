...
[ Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) topic for additional
information.
...
and [References: Permissions](/docs/identitymanager/saas/access-control/profiles-and-permissions/permissions.md)
topics for additional information.
...
See the [ Configure a User Profile ](/docs/identitymanager/saas/access-control/profiles-and-permissions/index.md) topic for additional
information.
