...
- the intent of resources within the managed system is made clear by categorizing resources into
  [ Create a Resource Type ](/docs/identitymanager/saas/connectors/configuration/index.md). See the
...
[ Create the Workforce Repository ](/docs/identitymanager/saas/identity-management/index.md), and
[ Configure a User Profile ](/docs/identitymanager/saas/access-control/profiles-and-permissions/index.md) topics for additional
information.
...
1. Outside Identity Manager, [ Model the Data ](/docs/identitymanager/saas/connectors/configuration/index.md).
2. [ Create the Connector ](/docs/identitymanager/saas/connectors/how-to/create-connectors/index.md) for said managed system.
...
4. Set up [Create an Entity Type](/docs/identitymanager/saas/identity-management/entity-model.md) to represent the data model decided
   upon in step 1.
