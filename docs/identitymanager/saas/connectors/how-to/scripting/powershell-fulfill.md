...
- [ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md)
- [ Microsoft Exchange ](/docs/identitymanager/saas/connectors/connector-reference/microsoft-exchange.md)
- [Active Directory](/docs/identitymanager/saas/connectors/connector-reference/active-directory.md)
...
[Active Directory](/docs/identitymanager/saas/connectors/connector-reference/active-directory.md) and
[ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) sections.
...
[ Microsoft Exchange ](/docs/identitymanager/saas/connectors/connector-reference/microsoft-exchange.md),
[ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md),
and[Active Directory](/docs/identitymanager/saas/connectors/connector-reference/active-directory.md) topics for additional
information.
...
[ Write a PowerShell Script for Provisioning ](/docs/identitymanager/saas/connectors/how-to/scripting/powershell-fulfill.md) topic
...
[ Microsoft Exchange ](/docs/identitymanager/saas/connectors/connector-reference/microsoft-exchange.md) topic for additional
information.
...
[ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) topic for additional
information.  
...
> `MicrosoftExchange`[ Connector ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
> on the `Local` agent, and the
> [ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) linked to the
...
A [Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) is a
...
A
[Resource Type Mappings](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
A [ Single Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) encapsulates
system entitlements.
...
The
[ View Target Resource Template ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
The [Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
elements describe how a list of resources should be displayed.

The
[](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)[Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
contains a list of
[Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) columns
...
[ AccessControlPermission ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
...
A [ Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) is required and
...
[ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) connector.
