...
This guide shows how to set up a [SCIM](/docs/identitymanager/saas/connectors/connector-reference/scim.md) connector to
extract data from your CyberArk instance into CSV source files that will in turn be fed to the
[ Upward Data Synchronization ](/docs/identitymanager/saas/synchronization/upward-data-sync.md) task and to your
...
[SCIM](/docs/identitymanager/saas/connectors/connector-reference/scim.md) topic for additional information.
...
[SCIM](/docs/identitymanager/saas/connectors/connector-reference/scim.md) optional attributes.
...
](/docs/identitymanager/saas/synchronization/upward-data-sync.md) task.
...
See the [SCIM](/docs/identitymanager/saas/connectors/connector-reference/scim.md)topic for additional information.
...
](/docs/identitymanager/saas/installation/production-setup/working-directory.md) topic for additional information.
...
linked to an Agent. See the [Toolkit for XML Configuration](/docs/identitymanager/saas/toolkit/index.md) topic for
...
[Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md). See the
...
[Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) that best serves the Role Model needs. It will most
likely be refined iteratively throughout the project integration. See the
[ Assignment Policy ](/docs/identitymanager/saas/role-management/role-model-rules.md) topic for additional
information.
...
the [ Assignment Policy ](/docs/identitymanager/saas/role-management/role-model-rules.md) topic for additional
information.

The [Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) for the CyberArk connector is written in the
...
[ Assignment Policy ](/docs/identitymanager/saas/role-management/role-model-rules.md) are associated through their
...
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), and Entity Property Mapping elements serve this purpose.

#### Write the entity type mapping

The [
Entity Type Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) element maps scalar properties from the CSV source file to an entity type.
...
The [
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) element maps navigation properties, used in [
Entity Association
...
An [](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)[
Entity Association Mapping
...
Entity Type Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) element, it maps columns values from a CSV source file to an EntityType property.
...
The following [](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)[
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) describes the mapping for the ```CyberArk_Group_Members``` EntityAssociation:
...
- is filled in by values from the `MemberId` column (written to the **Column2** attribute of the
  ...
  [](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)[ Entity Association Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
The [Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) elements describe how a list of resources should be displayed.

The [Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) contains a list of [Display Table](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) column elements that identify which properties should be included in the list display.
...
The [Access Control Rule](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) and [Access Control Rule](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) elements define the [
AccessControlPermission
](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) for end-user profiles to read and write the connector's data (such as resources of a given entity type). It used by the UI when displaying data such as resources and available roles.
...
Notice the __Identifier__ attribute with the value ```Job``` in the ```OpenIdIdentifier``` tag. It refers to the ```ClientId``` written to the [appsettings.agent](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md) technical configuration. The Tasks will authenticate with the profile associated with this ```ClientId``` in the ```<OpenIdClient>``` xml configuration element.

Incremental synchronization can be configured with the following scaffolding. See the [Create Connector Synchro Incremental](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for additional information.
...
Usercube-Invoke-Job
](/docs/identitymanager/saas/automation/executables/invoke-job.md) uses:

- A [
  Profile
  ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) associated with the Job itself to read/write:
...
OpenIdClient
](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) Connect /Secret pair, linked to a Profile.
...
[ Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) to be used during
...
[ Usercube-Invoke-Job ](/docs/identitymanager/saas/automation/executables/invoke-job.md), the profile linked to
...
scaffolding and
the[ Job View Access Control Rules ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
scaffolding.
...
[ Usercube-Invoke-Job ](/docs/identitymanager/saas/automation/executables/invoke-job.md) tool.
...
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) tool.
