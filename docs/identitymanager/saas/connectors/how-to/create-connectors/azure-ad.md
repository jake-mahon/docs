...
See the[ Microsoft Entra ID](/docs/identitymanager/saas/connectors/connector-reference/microsoft-entra-id.md) topic for
...
See the [Register for Microsoft Entra ID](/docs/identitymanager/saas/connectors/how-to/azure-ad-registration.md) topic for additional
...
See the [ Connect to a Managed System ](/docs/identitymanager/saas/connectors/how-to/index.md)
...
[Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) topic for additional information.
...
See the
[ Organize Resources' Datasheets ](/docs/identitymanager/saas/identity-management/entity-model.md)
