...
See the[ Microsoft Entra ID ](/docs/identitymanager/saas/connectors/packages/azure-active-directory.md)topic for
...
See the[Register for Microsoft Entra ID](/docs/identitymanager/saas/connectors/how-to/azure-ad-registration.md) topic on how to
...
[ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for
additional information.
...
See
the[appsettings.agent](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md)
...
- An [Azure Key Vault](/docs/identitymanager/saas/configuration/network/agent-settings/azure-key-vault.md)
  safe;
