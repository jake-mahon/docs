...
This page is about [ Robot Framework ](/docs/identitymanager/saas/connectors/packages/robot-framework.md)
...
See how
to[ Write a Robot Framework Script ](/docs/identitymanager/saas/connectors/how-to/scripting/robotframework-fulfill.md) to
