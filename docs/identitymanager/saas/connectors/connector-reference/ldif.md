...
This page is about [ LDIF ](/docs/identitymanager/saas/connectors/packages/ldif.md).
...
nor a [ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)Vault.

Still, data protection can be ensured through an
[ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) safe.
