...
- Database/[ Generic SQL ](/docs/identitymanager/saas/connectors/packages/generic-sql.md);
- Database/[ SQL Server ](/docs/identitymanager/saas/connectors/packages/sql-server.md);
- Database/[ MySQL ](/docs/identitymanager/saas/connectors/packages/mysql.md);
- Database/[ ODBC ](/docs/identitymanager/saas/connectors/packages/odbc.md);
- Database[ Oracle Database ](/docs/identitymanager/saas/connectors/packages/oracle-database.md);
- Database/[ PostgreSQL ](/docs/identitymanager/saas/connectors/packages/postgresql.md);
- [ SAP ASE ](/docs/identitymanager/saas/connectors/packages/sap-ase.md).
...
|                                               |                                                                                                                                                                                                                                                                                                                                                        |
| ---                                           | ---                                                                                                                                                                                                                                                                                                                                                    |
| SqlCommand optional                           | **Type** String **Description** SQL request to be executed. **Note:** when not specified and `SqlFile` neither, then all the[ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) of this connector will be exported.                                                                                    |
| SqlFile optional                              | **Type** String **Description** Path of the file containing the SQL request to be executed. **Note:** ignored when `SqlCommand` is specified. **Note:** when not specified and `SqlFile` neither, then all the [ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) of this connector will be exported. |
...
3. Get the value required for `ProviderClassFullName` and `ProviderDllName`:
   ...
   - for a DBMS handled by Identity Manager's packages, by accessing the
     [ References: Packages ](/docs/identitymanager/saas/connectors/packages/index.md);
...
[](/docs/identitymanager/saas/configuration/network/agent-settings/cyberark-credential-providers.md)[ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
