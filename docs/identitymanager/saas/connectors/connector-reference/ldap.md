...
- [ Generic LDAP ](/docs/identitymanager/saas/connectors/packages/generic-ldap.md);
- [ Oracle LDAP ](/docs/identitymanager/saas/connectors/packages/oracle-ldap.md);
- [ Apache Directory ](/docs/identitymanager/saas/connectors/packages/apache-directory.md);
- [ Red Hat Directory Server ](/docs/identitymanager/saas/connectors/packages/red-hat-directory.md).
...
[appsettings.agent](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md)documentation.
...
[Evaluate Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) topic for additional
information.
...
- [ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), configured in
...
- [ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) able to store
