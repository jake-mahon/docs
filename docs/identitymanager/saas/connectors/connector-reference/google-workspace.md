...
This page is about [ Google Workspace ](/docs/identitymanager/saas/connectors/packages/google-workspace.md).
...
[ RSA Encryption ](/docs/identitymanager/saas/configuration/network/agent-settings/rsa-encryption.md), nor
a
[CyberArk's AAM Credential Providers ](/docs/identitymanager/saas/configuration/network/agent-settings/cyberark-credential-providers.md)Vault.

Still, data protection can be ensured through an
[Azure Key Vault](/docs/identitymanager/saas/configuration/network/agent-settings/azure-key-vault.md) safe.
