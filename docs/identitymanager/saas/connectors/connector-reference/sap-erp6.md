...
[Sap Resource Type Mapping](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
topic for additional information.
...
[Azure Key Vault](/docs/identitymanager/saas/configuration/network/agent-settings/azure-key-vault.md), and
