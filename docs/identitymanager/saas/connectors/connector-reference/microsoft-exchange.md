...
This page is about [ Microsoft Exchange ](/docs/identitymanager/saas/connectors/packages/microsoft-exchange.md).
...
As it works via a PowerShell script. See the [ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) topic
for additional information.

Identity Manager's PowerShell script can be found in the SDK in
`Usercube.Demo/Scripts/Fulfill-Exchange.ps1`.

See the [ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) topic for additional information.
...
PowerShellProv connector. See the [ PowerShellProv ](/docs/identitymanager/saas/connectors/connector-reference/powershell-prov.md) topic for
