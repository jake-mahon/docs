...
This page is about [ ServiceNow ](/docs/identitymanager/saas/connectors/packages/servicenow.md).
...
[ ServiceNow Ticket ](/docs/identitymanager/saas/connectors/packages/servicenow-ticket.md).
...
[ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)'s
and
[ Entity Association Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)'s
connection tables.
