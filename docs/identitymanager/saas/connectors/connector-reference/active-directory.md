...
scalar property. See the [Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) topic for additional
information.
...
- An Azure Key Vault safe; See the
  [Azure Key Vault](/docs/identitymanager/saas/configuration/network/agent-settings/azure-key-vault.md)
  topic for additional information.
