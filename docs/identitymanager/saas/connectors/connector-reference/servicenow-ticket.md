...
This page is about [ ServiceNow Ticket ](/docs/identitymanager/saas/connectors/packages/servicenow-ticket.md).
...
[ ServiceNow ](/docs/identitymanager/saas/connectors/connector-reference/servicenow-entity.md)Entity Management.
...
[ ServiceNow ](/docs/identitymanager/saas/connectors/connector-reference/servicenow-entity.md)connector. Some entities cannot be exported.
...
[Entitlement Assignment](/docs/identitymanager/saas/role-management/role-assignment/entitlement-assignments.md) topic for
additional information.

See the fulfill capabilities of the [ ServiceNow ](/docs/identitymanager/saas/connectors/connector-reference/servicenow-entity.md)connector.
...
- A [ Connection ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) able to store
