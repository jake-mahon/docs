...
[Network Configuration](/docs/identitymanager/saas/configuration/network/index.md) topic for additional
information.
...
- The **On-Premise** offering requires the Agent, the
  [Install the Server](/docs/identitymanager/saas/installation/production-setup/server.md), and the
  [ Install the Database ](/docs/identitymanager/saas/installation/production-setup/database.md) to be installed.

See the [ Install the Agents](/docs/identitymanager/saas/installation/production-setup/agent.md) topics for additional information.
...
[ Install the Agents](/docs/identitymanager/saas/installation/production-setup/agent.md) topics for additional information.
...
methods are available. See the [Install the Server](/docs/identitymanager/saas/installation/production-setup/server.md) topic for
additional information.

## Email Server

Identity Manager sends notifications to users by email. An email server will have to be set up for
the Agent and the Server. See the [ Send Notifications ](/docs/identitymanager/saas/installation/production-setup/email-server.md)
topic for additional information.

Before you check out the installation steps, make sure that all the
[Requirements](/docs/identitymanager/saas/getting-started/requirements.md) are met.
