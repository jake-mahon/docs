...
**1.\_\_**Before proceeding\_\_, you should go through the [ Overview ](/docs/identitymanager/saas/installation/overview.md) and
[Requirements](/docs/identitymanager/saas/getting-started/requirements.md) sections to make fundamental decisions about Identity
...
the relevant [Network Configuration](/docs/identitymanager/saas/configuration/network/index.md)
sections.
...
The first step consists in [ Create a Working Directory ](/docs/identitymanager/saas/installation/production-setup/working-directory.md).
