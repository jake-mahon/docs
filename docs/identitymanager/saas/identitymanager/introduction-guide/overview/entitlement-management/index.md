...
The role model is a subset of a policy that also includes [Governance](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/governance/index.md) data
...
[ Identity Management ](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/identity-management/index.md) entity-relationship model. So Identity
...
The [ Identity Management ](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/identity-management/index.md) model can be refined by configuring
...
See the [Governance](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/governance/index.md) topic for additional information.
