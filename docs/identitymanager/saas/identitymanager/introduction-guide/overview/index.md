...
See more details on [ Identity Management ](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/identity-management/index.md) and connection between
systems.
...
Let's read some [ Use Case Stories ](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/use-cases/index.md).
