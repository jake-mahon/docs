...
Let's dive in with an [IGA and Netwrix Identity Manager](/docs/identitymanager/saas/identitymanager/introduction-guide/overview/index.md) of IGA and Identity
Manager.
