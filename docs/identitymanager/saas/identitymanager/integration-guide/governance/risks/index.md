...
A [ Risk ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/risk/index.md) describes a sensitive
...
scores are the priority of the next [Access Certification](/docs/identitymanager/saas/identitymanager/integration-guide/governance/accesscertification/index.md)
campaign.

See the [ Manage Risks ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/risk-management/index.md)topic for additional
information on how to use the risk management module to identify entitlement assignments that pose a
security risk.

## Risk Definition

A [ Risk ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/risk/index.md) is an object that describes a
...
- part of a [Policy](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/policy/index.md);
...
[ Risk ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/risk/index.md) are assigned to resources
...
[ Risk ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/risk/index.md) rules. For each new
...
[Resource Type](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/resourcetype/index.md) topic for
...
Once [ Risk ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/provisioning/risk/index.md) are assigned to
...
[Access Certification](/docs/identitymanager/saas/identitymanager/integration-guide/governance/accesscertification/index.md) campaign. The identity with the highest risk
