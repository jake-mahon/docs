...
1. Remove columns that are not used in
   [ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) or
...
[Application Settings](/docs/identitymanager/saas/configuration/network/server-settings/general-purpose.md)directory
as three files:

- For every entity type of the relevant _Connector_ involved in an
  [ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)> or an
  [ Entity Association Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), a
