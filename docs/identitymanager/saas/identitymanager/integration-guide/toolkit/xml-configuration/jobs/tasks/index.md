...
- [ Server Tasks ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)

- [ Build Role Model Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Compute Risk Scores Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Fulfill Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Maintain Indexes Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)

  Index maintenance and statistics update for all database tables.

- [ Manage Configuration Indexes Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)

  Manage indexes for items from configuration.

- [ Process Access Certification Items Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)

  Process decisions on access certification items.

- [ Reset Valid From Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Send Access Certification Notification Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Send Role Model Notifications Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
- [ Update Access Certification Campaign Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
