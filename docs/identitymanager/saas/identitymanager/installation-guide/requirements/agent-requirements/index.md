...
[ Create a Working Directory ](/docs/identitymanager/saas/identitymanager/installation-guide/production-ready/working-directory/index.md) topic as:
...
- Service accounts with the necessary permissions for the agent to perform _Read_ and/or _Write_
  ...
  provisioning; See the [Connectors](/docs/identitymanager/saas/identitymanager/integration-guide/connectors/index.md) topic for
...
protected. See the
[appsettings.agent](/docs/identitymanager/saas/identitymanager/integration-guide/network-configuration/agent-configuration/appsettings-agent/index.md)
and [ Modules ](/docs/identitymanager/saas/identitymanager/integration-guide/modules/index.md) topics for additional information.
...
To start the installation, follow either the [ Quick Start Guide](/docs/identitymanager/saas/identitymanager/installation-guide/quick-start/index.md) or the
[Production-Ready Installation](/docs/identitymanager/saas/identitymanager/installation-guide/production-ready/index.md).
