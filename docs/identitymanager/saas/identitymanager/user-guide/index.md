...
previously read the [Introduction Guide](/docs/identitymanager/saas/identitymanager/introduction-guide/index.md) in order to be aware of the
...
[Introduction Guide](/docs/identitymanager/saas/identitymanager/introduction-guide/index.md) to fully benefit from the User Guide's content.
