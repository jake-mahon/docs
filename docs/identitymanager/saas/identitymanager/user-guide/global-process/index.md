...
- [ How to Start ](/docs/identitymanager/saas/identitymanager/user-guide/global-process/howto-start/index.md)

    How to start integrating Identity Manager with your own needs.

- [ How to Maintain the Workforce Directory ](/docs/identitymanager/saas/identitymanager/user-guide/global-process/howto-maintaindirectory/index.md)

    How to keep the workforce directory up to date.

- [ How to Implement a New System ](/docs/identitymanager/saas/identitymanager/user-guide/global-process/howto-newsystem/index.md)
