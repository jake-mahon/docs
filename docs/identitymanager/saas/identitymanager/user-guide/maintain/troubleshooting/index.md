...
See the
[ Troubleshoot Connector Jobs ](/docs/identitymanager/saas/identitymanager/integration-guide/tasks-jobs/how-tos/troubleshoot-connector-jobs/index.md)
...
| Input                                                                         | Output              |
| ----------------------------------------------------------------------------- | ------------------- |
| [Implement Identity Manager](/docs/identitymanager/saas/identitymanager/user-guide/deploy/implementation/index.md) (required) | Working environment |
...
See more details on [ Synchronize Data ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/synchronization/index.md) thresholds.
