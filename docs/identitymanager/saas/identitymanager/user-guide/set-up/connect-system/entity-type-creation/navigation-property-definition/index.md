...
See the [Define Scalar Properties](/docs/identitymanager/saas/identitymanager/user-guide/set-up/connect-system/entity-type-creation/scalar-property-definition/index.md) topic for additional
information.
...
1. Start by declaring an [Entity Type](/docs/identitymanager/saas/identitymanager/user-guide/set-up/connect-system/entity-type-creation/entity-type-declaration/index.md).
...
5. Click the gear icon to access advanced settings:
    ...
    - **Source Expression**: Define using a property path or
      [expression](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/expressions/index.md)
