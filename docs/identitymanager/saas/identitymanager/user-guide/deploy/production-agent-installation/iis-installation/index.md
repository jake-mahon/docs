...
To continue,[ Configure the Pool and Site ](/docs/identitymanager/saas/identitymanager/user-guide/deploy/production-agent-installation/iis-configuration/index.md)and website via IIS.
