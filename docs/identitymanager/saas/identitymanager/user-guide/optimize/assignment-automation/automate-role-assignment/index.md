...
[ Perform a Simulation ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/simulation/index.md) is available in order to anticipate the changes
