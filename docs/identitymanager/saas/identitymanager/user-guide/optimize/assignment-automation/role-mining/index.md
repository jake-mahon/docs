...
push the [ Automate Assignments ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/assignment-automation/index.md) wall further.
...
Catalog. See
the[ Create Roles in the Role Catalog ](/docs/identitymanager/saas/identitymanager/user-guide/set-up/single-roles-catalog-creation/index.md)
...
[ Get Role Mining Task ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/jobs/tasks/server/getroleminingtask/index.md).
...
2. Click on the addition button at the top right and fill in the fields.
    ...
    - `Policy`: [Create a Policy](/docs/identitymanager/saas/identitymanager/user-guide/optimize/policy-creation/index.md) in which the mining rule exists.
    - `Entity Type`:
      [Create an Entity Type](/docs/identitymanager/saas/identitymanager/user-guide/set-up/connect-system/entity-type-creation/index.md) on which
    ...
    - `Rule Policy`: [Create a Policy](/docs/identitymanager/saas/identitymanager/user-guide/optimize/policy-creation/index.md) in which the single role
...
4. Click on **Simulate** to perfom role mining in a simulation. See
   the[ Perform a Simulation ](/docs/identitymanager/saas/identitymanager/user-guide/optimize/simulation/index.md) topic for additional information.
...
[Remove Redundant Assignments](/docs/identitymanager/saas/identitymanager/user-guide/optimize/assignment-automation/remove-redundant-assignments/index.md) after any assignment rule
