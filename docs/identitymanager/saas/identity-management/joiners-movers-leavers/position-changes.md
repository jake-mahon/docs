...
The model is supposed to facilitate the [Provisioning](/docs/identitymanager/saas/provisioning/index.md) provisioning
...
[ Record Section ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md):
