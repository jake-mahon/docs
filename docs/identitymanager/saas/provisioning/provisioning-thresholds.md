...
[Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) to count the
...
Distinct [ Thresholds ](/docs/identitymanager/saas/synchronization/synchronization-thresholds.md) are configurable for
synchronization.
