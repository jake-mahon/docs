...
- [ Manual Provisioning ](/docs/identitymanager/saas/notifications/native-notifications/manual-provisioning.md), provisioning review and role review to the
...
See the [References: Permissions](/docs/identitymanager/saas/access-control/profiles-and-permissions/permissions.md) topic for
additional information.

Each permission can be configured in an
[Access Control Rule](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) so
...
See the [ Customize a Native Notification ](/docs/identitymanager/saas/notifications/customize-native-notifications.md) for
