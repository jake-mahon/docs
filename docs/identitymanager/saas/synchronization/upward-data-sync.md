...
Entity Model. See the [Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) topic for additional information.
...
- ascertains differences between the real managed system state and the
  [ Assignment Policy ](/docs/identitymanager/saas/role-management/role-model-rules.md) theoretical state.
...
[ Tasks & Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/index.md).

A _Sync Up_ is planned for every managed system that interact with Identity Manager.

A _Sync Up_ is associated with a [Connectors](/docs/identitymanager/saas/connectors/index.md).
...
are written to the
[Application Settings](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md) export
...
Identity Manager's [Connectors](/docs/identitymanager/saas/connectors/index.md) provide native _Export_ tasks for the
...
[Connectors](/docs/identitymanager/saas/connectors/index.md) section together with an exhaustive list of supported source
managed systems.

[Connectors](/docs/identitymanager/saas/connectors/index.md)are Identity Manager's link to the managed system. They
...
[ Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/jobs.md).
...
[ Invoke Expression Task ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/jobs/tasks/agent/invokeexpressiontask/index.md)
or an
[ Invoke Sql Command Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
See the
[ Invoke Expression Task ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/jobs/tasks/agent/invokeexpressiontask/index.md)
...
format_, described in the [Connectors](/docs/identitymanager/saas/connectors/index.md) section. Usually, two kinds of
...
The [Application Settings](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md)
...
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) elements.

Entity Type Mapping elements map the resources _CSV source files_ columns to [Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md) properties. Each mapping also identifies one column as the _primary key_ for this Entity Type. The _primary key_ is used to uniquely identify a resource in the _Sync Up_ process. It's mandatory to be able to perform _incremental__Sync Up_, as it allows to identify a resource on which an _update_ or a _delete_ has to be performed.

[
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) elements translate the _CSV source files_ into [Entity Model](/docs/identitymanager/saas/identity-management/entity-model.md). They describe rules identifying associations between resources loaded thanks to the [](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)[
Entity Type Mapping
...
1. Removing columns that are not used in [
   Entity Type Mapping
   ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) or [
   Entity Association Mapping
   ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
The result of the _Prepare-Synchronization_ is stored in the [Application Settings](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md) export directory as three files:

For every entity type of the relevant _Connector_ involved in an[
Entity Type Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) or an[
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) ```<EntityAssociationMapping>``` , a ```.sorted.csv``` file is generated, containing the final, cleaned, sorted result.
...
If the export step has provided a full extract of the managed systems, the _prepare-synchronization_ step computes changes. This computation is based on the result of the last data cleansing, generated by the previous _prepare-synchronization_, and stored in the ```previous``` folder in the [Application Settings](/docs/identitymanager/saas/configuration/network/agent-settings/appsettings.md) export directory.
...
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) to translate _CSV source files_ into _Entity Model compliant_ resources and resolve association links.
...
Connector
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), that are in the database but not in the _CSV source files_ will be deleted. That means no change made to the database from outside of the connectors or the UI are persistent.
...
- [
  Synchronize Task
  ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) is the standard _synchronization_ task.
...
_Incremental_ mode also offers another optimization that will be described in the [Evaluate Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) section. Trade-offs of that optimization can also be counterbalanced by running a daily _complete_ synchronization.
...
Connector
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), an [
Entity Type Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) and/or an[
Entity Association Mapping
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md). They are expressed as number of lines (ex: ```MaximumInsertedLines```) or as a rate (ex: ```MaxPercentageDeletedLines```).
