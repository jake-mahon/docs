...
[ Synchronize Data ](/docs/identitymanager/saas/synchronization/index.md) topic for additional
information.
...
- [ Entity Type Mapping ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) to
...
- [ Connector ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) to count the number
...
Distinct [ Thresholds ](/docs/identitymanager/saas/provisioning/provisioning-thresholds.md) are configurable for
provisioning.
