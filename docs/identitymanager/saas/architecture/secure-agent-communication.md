...
[ OpenIdClient ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) linked to
...
3. Configure an OpenIdClient, both on agent side in `appsettings.agent.json` with the non-hashed
   ...
   [ Usercube-New-OpenIDSecret ](/docs/identitymanager/saas/automation/executables/new-openid-secret.md)
   executable. See the
   [ OpenIdClient ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) for
