...
See the [ SaaS Environment ](/docs/identitymanager/saas/architecture/saas.md) topic for additional information on Netwrix Identity
Manager (formerly Usercube) recommended architecture when working in a SaaS environment.

See the [ On-Premises Environment ](/docs/identitymanager/saas/architecture/on-premise.md) topic for additional information on Netwrix
Identity Manager (formerly Usercube)' recommended architecture when working in an on-premises
environment.

See how to
[ Protect Agent/Server Communication ](/docs/identitymanager/saas/architecture/secure-agent-communication.md).
