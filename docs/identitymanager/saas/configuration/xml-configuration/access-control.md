...
| CompositeRole default value: false | Boolean                     | True to compare the value specified by the binding to the composite roles of the current user's assigned profiles. See the [ Assigned Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) topic for additional information.                                                                                                                                                          |
...
| Dimension optional                 | Int64                       | Identifier of the dimension whose value(s), from the user's assigned profiles, are to be compared to the value specified by the binding. See [ Dimension ](/docs/identitymanager/saas/identitymanager/integration-guide/toolkit/xml-configuration/metadata/dimension/index.md) and [ Assigned Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) topics for additional information. |
...
| ResourceType default value: false  | Boolean                     | True to compare the value specified by the binding to the resource types of the current user's assigned profiles. See the [ Assigned Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) topic for additional information.                                                                                                                                                           |
| SingleRole default value: false    | Boolean                     | True to compare the value specified by the binding to the single roles of the current user's assigned profiles. See the [ Assigned Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md) topic for additional information.                                                                                                                                                             |
...
- [ AccessControlPropertyGroup ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [Access Control Rule](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [ Assigned Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [ OpenIdClient ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [ Profile ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [ Profile Context ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
- [Profile Rule Context](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)
...
[ Usercube-New-OpenIDSecret ](/docs/identitymanager/saas/automation/executables/new-openid-secret.md) can be
...
| Property                      | Type    | Description                                                                                                                                                                                                                                                                                                  |
| ----------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| B0 optional                   | Int64   | Represents the first dimension binding definition. The 127 other dimension bindings can be referred to by 127 more parameters from B1 to B3V following the base32hex convention. See the [ Base32 Parameter Names ](/docs/identitymanager/saas/toolkit/parameter-names.md) topic for additional information. |
...
| RootExpression optional       | String  | C# expression to apply on the source entity type of the context resource type. See the [Expressions](/docs/identitymanager/saas/toolkit/expressions/index.md) topic for additional information.                                                                                                              |
| SubExpression optional        | String  | C# expression to apply on the target entity type of the context resource type. See the [Expressions](/docs/identitymanager/saas/toolkit/expressions/index.md) topic for additional information.                                                                                                              |
