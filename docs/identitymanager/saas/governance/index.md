...
See the [Access Certification](/docs/identitymanager/saas/governance/access-certification.md) topic to learn how to configure
...
See the [ Risk Management ](/docs/identitymanager/saas/governance/risks.md) topic to learn how to configure risks.
