...
[API query grammar](/docs/identitymanager/saas/api-reference/squery.md), or advanced reports using the
[ Business Intelligence ](/docs/identitymanager/saas/configuration/xml-configuration/business-intelligence.md) module.

See the [ Generate Reports ](/docs/identitymanager/saas/governance/reporting/index.md) topic for
...
- the list of [Review Orphaned and Unused Accounts](/docs/identitymanager/saas/governance/access-certification.md).
...
[API query grammar](/docs/identitymanager/saas/api-reference/squery.md) topic for additional
information.
...
[ Synchronize Data ](/docs/identitymanager/saas/synchronization/index.md) and
[ Classify Resources ](/docs/identitymanager/saas/connectors/configuration/index.md) topics for additional
...
See the
[Connect Power BI to Identity Manager](/docs/identitymanager/saas/governance/reporting/connect-powerbi.md)
