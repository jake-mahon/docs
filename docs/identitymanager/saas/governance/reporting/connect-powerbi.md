...
5. In the opening window, enter the
   [ OpenIdClient ](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)of
...
6. You can now access in the left panel the
   [ Universe ](/docs/identitymanager/saas/configuration/xml-configuration/business-intelligence.md)from
