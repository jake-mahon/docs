...
[ Queries ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic
...
[ Universe ](/docs/identitymanager/saas/configuration/xml-configuration/business-intelligence.md) topic
for additional information.  
...
the[Scaffoldings](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic
for additional information.
...
[Connect Power BI to Identity Manager](/docs/identitymanager/saas/governance/reporting/connect-powerbi.md) topic for additional
information.
