...
See the [Tasks](/docs/identitymanager/saas/automation/tasks-and-jobs/tasks.md) topic for additional information.

See the [ Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/jobs.md) topic for additional information.
...
Make sure to read how to [Build Efficient Jobs](/docs/identitymanager/saas/automation/tasks-and-jobs/build-efficient-jobs.md).
...
These building blocks are called [Tasks](/docs/identitymanager/saas/automation/tasks-and-jobs/tasks.md), and can be easily organized together and
scheduled in [ Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/jobs.md).
