...
fragments. See the
[Scaffoldings](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for
...
[ Jobs ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for
additional information.
...
See
the[Create Connector Synchro Complete](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)for
additional information.
...
[ Configure an Incremental Job ](/docs/identitymanager/saas/automation/tasks-and-jobs/configure-incremental-jobs.md) topic for additional
information.
...
[ Troubleshoot Connector Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/troubleshoot-connector-jobs.md) topic for additional
information.
