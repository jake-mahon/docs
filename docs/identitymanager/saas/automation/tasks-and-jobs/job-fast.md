...
[ Compute Correlation Keys Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
[Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) which have
...
[Generate Provisioning Orders Task](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
...
[ Update Classification Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
...
[Profile Rule Context](/docs/identitymanager/saas/configuration/xml-configuration/access-control.md)are
configured.
...
[ Set Internal User Profiles Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
