...
[ Deploy the Configuration ](/docs/identitymanager/saas/toolkit/deploy-configuration.md) topic for
...
| --product-translation optional            | No Value       | Path of the JSON file that contains the application's translations. See the [Import Product Translations into Identity Manager](/docs/identitymanager/saas/toolkit/languages.md) topic for more details on how to import the product's translations. |
