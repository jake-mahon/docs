...
[ Context Rule ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) or the
combination of a context rule and the
[ Record Section ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) if record
...
As described in the [Identity Management](/docs/identitymanager/saas/identity-management/index.md), identities are
complex to model. Records were introduced to tackle this complexity by allowing multiple positions
for the same identity.

[ Record Section ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) go further
...
the [Evaluate Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) algorithm.
...
position [ Record Section ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
