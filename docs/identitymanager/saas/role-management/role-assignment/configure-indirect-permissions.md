...
[ Indirect Permissions ](/docs/identitymanager/saas/role-management/role-assignment/indirect-permissions.md).
...
](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), Indirect Permissions should now appear for your test user.
