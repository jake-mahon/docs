...
[ Indirect Resource Rule ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
...
- `ResourceType`—The
  [Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) to which the
...
- `IndirectResourceBinding`— The [ Bindings ](/docs/identitymanager/saas/toolkit/bindings.md) that is used to
...
[ Configure Indirect Permissions ](/docs/identitymanager/saas/role-management/role-assignment/configure-indirect-permissions.md) in an Active
Directory.
...
If a [ Single Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) is associated
...
[ Composite Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md), then the
