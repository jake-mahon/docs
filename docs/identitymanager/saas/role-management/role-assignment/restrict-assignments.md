...
[ Single Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) which will
...
We will define a
[Single Role Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) on the
...
[Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md). This implies
that the ResourceType will only apply if the
[Single Role Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) are
checked.
...
A [Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) in addition
