...
[Entitlement Assignment](/docs/identitymanager/saas/role-management/role-assignment/entitlement-assignments.md) topic for additional information.
...
[ Context Rule ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)defined for the
identities.
