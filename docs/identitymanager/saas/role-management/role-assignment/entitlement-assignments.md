...
assignment is simply role assignment. See the [ Role Model ](/docs/identitymanager/saas/role-management/role-model.md)topic for
...
[Evaluate Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) topic for additional information. Automatic
assignments can:
...
[ Single Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for
additional information.
...
**Resource Reconciliation** screens. See the [Evaluate Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) topic
...
- The categorization of the created resource, which means both the correlation of the resource to an
  ...
  [ Categorize Resources ](/docs/identitymanager/saas/connectors/configuration/index.md) topic for additional
  information.
