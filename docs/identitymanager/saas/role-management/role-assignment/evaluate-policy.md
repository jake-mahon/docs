...
[ Assignment Policy ](/docs/identitymanager/saas/role-management/role-model-rules.md) topic for additional information.
...
See the [ Risk Management ](/docs/identitymanager/saas/governance/risks.md) topic for additional information.
...
See the [Connectors](/docs/identitymanager/saas/connectors/index.md),
[ Compute Role Model Task ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md),
and [ Jobs ](/docs/identitymanager/saas/automation/tasks-and-jobs/jobs.md) topics for additional information.
...
- Identity Manager only selects resources for which a new assignment computation is needed. They are
  ...
  [ Upward Data Synchronization ](/docs/identitymanager/saas/synchronization/upward-data-sync.md) topic for
...
- Assignments updated by an automation rule. See the
  [Automation Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic for
  additional information.
...
[Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topics for
...
[Composite Role Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)topic
...
user. See the [Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)
topic for additional information.
...
[Policy](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) topic
for additional information.
...
[ Create Roles in the Role Catalog ](/docs/identitymanager/saas/role-management/index.md) and
[ Conforming Assignments ](/docs/identitymanager/saas/role-management/role-assignment/conforming-assignments.md)topics
for additional information.
...
See the [ Create a Resource Type ](/docs/identitymanager/saas/connectors/configuration/index.md)
topic for additional information.
