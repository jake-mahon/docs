...
- [Resource Type](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) rules;
- [ Single Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md) and
  [ Composite Role ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md);
- [Single Role Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md)and
  [Composite Role Rule](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md).
...
See the [ Perform a Simulation ](/docs/identitymanager/saas/role-management/simulation.md) for additional
information.
...
[Create a Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md). See the
[ Create Roles in the Role Catalog ](/docs/identitymanager/saas/role-management/index.md),
[ Automate Role Assignments ](/docs/identitymanager/saas/role-management/role-assignment/index.md)[ Correlate Resources ](/docs/identitymanager/saas/connectors/configuration/index.md),
and [Create a Policy](/docs/identitymanager/saas/role-management/role-assignment/evaluate-policy.md) topics for additional information.
...
See the [ Correlate Resources ](/docs/identitymanager/saas/connectors/configuration/index.md)
[ Resource Classification Rule ](/docs/identitymanager/saas/configuration/xml-configuration/scaffoldings.md),
and
...
[ Perform Role Mining ](/docs/identitymanager/saas/role-management/role-mining.md) for the automation of role
assignments.
...
[ Categorize Resources ](/docs/identitymanager/saas/connectors/configuration/index.md) topics for additional information.
