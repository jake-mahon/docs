...
[ Perform Access Certification ](/docs/identitymanager/saas/user-guide/administrate/access-certification/index.md)access
certification and
...
4. [ Create a Provisioning Rule ](/docs/identitymanager/saas/user-guide/set-up/provisioning-rule-creation/index.md) to write to the
