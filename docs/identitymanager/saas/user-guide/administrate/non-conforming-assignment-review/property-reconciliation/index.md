...
3. Select `Unreconciled properties` as a `Workflow State`.
    ...
    ![Unreconciled Property](/img/product_docs/identitymanager/saas/user-guide/administrate/non-conforming-assignment-review/property-reconciliation/reviewprop_unreconciled_v522.webp)
...
5. Select a property to review.
    ...
    >
    > ![Unreconciled Property Example](/img/product_docs/identitymanager/saas/user-guide/administrate/non-conforming-assignment-review/property-reconciliation/reviewprop_example_v602.webp)
