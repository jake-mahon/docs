...
The __Kerberos Weak Encryption__ analytic type identifies Kerberos tickets with RC4_HMAC_MD5 encryption by detecting the use of weak encryption. Various attack methods utilize weak Kerberos encryption cyphers, including Overpass-the-Hash.
...
See the Kerberos Weak Encryption Analytic Data Grid topic for information on event data collected per incident.
