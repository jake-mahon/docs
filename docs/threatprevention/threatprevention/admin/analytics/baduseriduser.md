...
See the Bad User ID (by User) Analytic Data Grid topic for information on event data collected per incident.
...
![Bad User ID (by User) Analytic Type - Settings tab](../../../../../static/img/product_docs/threatprevention/threatprevention/admin/analytics/baduseridsettings.webp)
...
![Bad User ID (by User) Analytic Type - Policy tab](../../../../../static/img/product_docs/threatprevention/threatprevention/admin/analytics/policytab.webp)
...
![Bad User ID (by User) Analytic Type  window](../../../../../static/img/product_docs/threatprevention/threatprevention/admin/analytics/baduseriduser.webp)
