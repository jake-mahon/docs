...
![Bad User ID (by User) Analytic Type - Settings tab](/static/img/product_docs/threatprevention/threatprevention/admin/analytics/baduseridsettings.png)
...
![Bad User ID (by User) Analytic Type - Policy tab](/static/img/product_docs/threatprevention/threatprevention/admin/analytics/policytab.png)
...
![Bad User ID (by User) Analytic Type  window](/static/img/product_docs/threatprevention/threatprevention/admin/analytics/baduseriduser.png)
