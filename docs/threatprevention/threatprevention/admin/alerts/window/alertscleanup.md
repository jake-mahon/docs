...
You can clear alert data displayed on the [Alerts Interface](/docs/product_docs/threatprevention/threatprevention/admin/alerts/overview.md) as well as schedule cleanups for this data.

___RECOMMENDED:___ Export alert data before using the Clear option. See the [Alerts Export Window](/docs/product_docs/threatprevention/threatprevention/admin/alerts/window/alertsexport.md) topic for additional information.
...
![Alerts Cleanup window](/static/img/product_docs/threatprevention/threatprevention/admin/alerts/window/alertscleanup.png)
...
- Log Level – Deletes alerts that have the log levels that are checked. The log levels are equivalent to the alert severity levels in the data grid on the [Alerts Interface](/docs/product_docs/threatprevention/threatprevention/admin/alerts/overview.md).
