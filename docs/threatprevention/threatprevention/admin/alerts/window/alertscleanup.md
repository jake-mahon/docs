...
You can clear alert data displayed on the [Alerts Interface](../overview.md) as well as schedule cleanups for this data.

___RECOMMENDED:___ Export alert data before using the Clear option. See the [Alerts Export Window](alertsexport.md) topic for additional information.
...
- Log Level – Deletes alerts that have the log levels that are checked. The log levels are equivalent to the alert severity levels in the data grid on the [Alerts Interface](../overview.md).
