...
- If opened via the keyboard shortcut (Alt+X) on the [Policies Interface](../policies/overview.md)
  or [Templates Interface](../templates/overview.md), it exports only what is within the selection.
- To export only a single policy or template, use the Export option on the right-click menu. See the
  [Export Policies and Templates Window](../policies/exportpoliciestemplates.md) topic for
...
- Event Consumers and Alerts
    ...
    - Export Only Event Consumers and Alerts Used in Policies and Templates – Exports only event
      ...
      [Actions Tab](../policies/actions/overview.md) of enabled policies
- Options:
...
settings. See the [Import Window](import.md) topic to import this file.
