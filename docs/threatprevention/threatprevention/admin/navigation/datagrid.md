...
- Clicking the Export button from the Alerts interface opens the Alerts Export window. See the
  [Alerts Export Window](../alerts/window/alertsexport.md) topic for additional information.
...
[Email Tab](../configuration/systemalerting/email.md) of the System Alerting window.
