...
See the [Default PowerShell 4.0 Script](/docs/product_docs/threatprevention/threatprevention/admin/policies/actions/powershell.md#Default-PowerShell-40-Script) topic for the full example script.
