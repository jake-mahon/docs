...
![Policy window - Exchange Lockdown Event Type](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/exchangelockdown.png)
...
After enabling an Exchange login blocking policy, mail clients with existing connections to Outlook, OWA, PowerShell, EWS, ECP, and ActiveSync will not be blocked while the existing connection remains. See the [Exchange Lockdown Considerations](/docs/product_docs/threatprevention/threatprevention/troubleshooting/exchangelockdown.md) topic for information on resolving this.

__NOTE:__ There are additional factors to consider in order to block delegations through Outlook. See the [Troubleshooting FAQs](/docs/product_docs/threatprevention/threatprevention/troubleshooting/overview.md#Troubleshooting-FAQs) topic for additional information.
...
![Policy window - Exchange Event filter for lockdown](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/exchangeeventlockdown.png)
...
![Policy window - Exchange Trustees filter for lockdown](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/exchangetrusteeslockdown.png)
...
![Policy window - Exchange Perpetrator filter for lockdown](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/exchangeperpetratorlockdown.png)
