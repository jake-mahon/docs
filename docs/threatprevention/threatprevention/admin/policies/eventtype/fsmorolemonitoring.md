...
![Policy window - FSMO Role Monitoring Event Type](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/fsmorolemonitoring.png)
...
![Policy window - FSMO Operations filter](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/fsmooperations.png)
...
![Policy window - FSMO Roles filter](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/fsmoroles.png)
