...
![Selection Window - Connect to Agent/Server option](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/window/selectagent.png)
...
![Selection Window - Browse mode](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/window/adperpetrators.png)
...
![Selection Window - Search Mode](/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/window/searchmode.png)
