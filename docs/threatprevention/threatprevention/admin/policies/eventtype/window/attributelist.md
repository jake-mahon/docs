...
![Attribute List Window](../../../../../../../static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/window/attributelist.webp)
...
Select the desired attributes and click __OK__. The selection is displayed in the appropriate box of the AD Attributes filter or the LDAP Attributes filter.
