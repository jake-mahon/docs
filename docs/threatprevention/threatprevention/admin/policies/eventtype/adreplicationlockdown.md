...
![Policy window - AD Replication Lockdown Event Type](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/adreplicationlockdown.png)
...
![Policy window - Hosts (from) filter for the AD Replication Lockdown event type](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/adreplicationhostsfrom.png)
