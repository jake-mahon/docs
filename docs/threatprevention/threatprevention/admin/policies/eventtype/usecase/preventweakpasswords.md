...
__NOTE:__ The Threat Prevention Enterprise Password Enforcement solution includes an EPE User Feedback module. See the [ Enterprise Password Enforcer](/docs/product_docs/threatprevention/threatprevention/solutions/epe.md) topic for additional information.
...
__NOTE:__ It is a best practice to create and enable a monitoring policy prior to creating and enabling a blocking policy. See the [Monitor Weak Passwords Use Case](/docs/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/monitorweakpasswords.md) topic for additional information.
...
![New Prevent Weak Passwords Policy - General tab](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/newblockepepolicy.png)
...
![Policy - Event Type tab with the Password Enforcement event selected](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/passwordrulesblock.png)
...
On the Recent Events tab of the blocking policy, set the Show options as desired and click the Refresh button to view blocked events. See the [Recent Events Tab](/docs/product_docs/threatprevention/threatprevention/admin/policies/recentevents/overview.md) topic for additional information.

![Recent Events Tab for weak password prevent](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/recenteventsprevent.png)

## View Events in Investigate Interface

![Investigate Interface](/static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/invesitgatenodeblock.png)
...
Click the Refresh button to view blocked events. See the [Investigate Interface](/docs/product_docs/threatprevention/threatprevention/admin/investigate/overview.md) topic for additional information.
