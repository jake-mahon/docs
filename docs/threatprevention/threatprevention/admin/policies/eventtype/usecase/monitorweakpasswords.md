...
__NOTE:__ See the [Prevent Weak Passwords Use Case](/docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/preventweakpasswords.md) topic for instructions on creating a policy to block weak passwords, which requires the Threat Prevention for[ Enterprise Password Enforcer](/docs/threatprevention/threatprevention/solutions/epe.md) solution.
...
Click the Refresh button to view monitored events. See the [Investigate Interface](/docs/threatprevention/threatprevention/admin/investigate/overview.md) topic for additional information.
