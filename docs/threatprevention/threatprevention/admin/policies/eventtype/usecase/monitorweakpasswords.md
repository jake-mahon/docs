...
**NOTE:** See the [Prevent Weak Passwords Use Case](preventweakpasswords.md) topic for instructions
on creating a policy to block weak passwords, which requires the Threat Prevention
for[ Enterprise Password Enforcer](../../../../solutions/epe.md) solution.
...
to view monitored events. See the [Recent Events Tab](../../recentevents/overview.md) topic for
additional information.
