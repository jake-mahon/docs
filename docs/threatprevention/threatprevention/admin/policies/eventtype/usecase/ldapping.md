...
When you create a policy with the [LDAP Monitoring Event Type](../ldapmonitoring.md) or the [LDAP Lockdown Event Type](../ldaplockdown.md), the LDAP filter allows you to enable the LDAP Ping option.

![LDAP filter for the LDAP Monitoring and LDAP Lockdown event types](../../../../../../../static/img/product_docs/threatprevention/threatprevention/admin/policies/eventtype/usecase/ldapping.webp)
