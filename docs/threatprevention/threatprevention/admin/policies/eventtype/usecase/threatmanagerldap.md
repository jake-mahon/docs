...
_Remember,_ the Honeytoken tab of the [Netwrix Threat Manager Configuration Window](../../../configuration/threatmanagerconfiguration.md) must be configured in order to successfully send LDAP monitoring data to Threat Manager.
