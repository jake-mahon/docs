...
The [Recent Events Tab](recentevents/overview.md) provides information on the events that have been
...
[PowerShell API Integration](../../api/overview.md) topic for additional information.
