...
The following C# script sends an email notification to the specified user when an Active Directory account is locked and/or unlocked.
...
In the Templates > Actions folder in the Navigation pane, the _AD Changes: Notify Admin that account was locked/unlocked_ template is preconfigured to use this action script.
