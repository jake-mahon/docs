...
The following C# script sends an email notification to the specified perpetrator when their Active Directory password is rejected by the active [Password Rules Filter](../../../policies/eventtype/passwordenforcement.md#password-rules-filter) criteria.
