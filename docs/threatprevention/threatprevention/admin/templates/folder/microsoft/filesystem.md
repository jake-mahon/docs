...
The __Templates__ > __Microsoft__ > __File System__ folder in the Navigation pane contains the following templates:

__CAUTION:__ ‘Reads’ are left out due to the potential high volume of data that could be gathered; recommended only for highly sensitive content.
