...
![Configure Auto Deploy window](../../../../../../static/img/product_docs/threatprevention/threatprevention/admin/agents/window/autodeploy.webp)
...
- Agent Deploy Destination Options – Configure the following settings:
  ...
  - Safe Mode – If selected, the Agent checks LSASS versions on start up. Any changes in LSASS since the previous start prevents the Windows AD Events monitoring module from loading. See the [Agent Safe Mode](../safemode.md) topic for additional information.
