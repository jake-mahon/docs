...
- If installing the Agent manually, the enrollment secret must be entered in the Certificates window of the Agent Setup wizard during installation. See the [Manual Agent Deployment](/docs/product_docs/threatprevention/threatprevention/install/agent/manual.md) topic for additional information.
...
![Enrollment Secret Configuration window](/static/img/product_docs/threatprevention/threatprevention/admin/agents/window/enrollmentsecret.png)
