...
__Step 3 –__ On the Access Verification window, the system performs a prerequisites or verification check that can fail or succeed.
...
__Step 4 –__ The Harden Agent window displays the task in progress and then its status as either:
