...
__Step 3 –__ Add or remove the RIDs of groups to be monitored on the Settings tab. See the [Forged PAC Analytic Type](../analytics/forgedpac.md) topic for additional information.
