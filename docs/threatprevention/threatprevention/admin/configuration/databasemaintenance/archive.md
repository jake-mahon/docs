...
To query archived event data, use the Investigate interface. See the [Investigate Interface](/docs/threatprevention/threatprevention/admin/investigate/overview.md) topic for additional information.
