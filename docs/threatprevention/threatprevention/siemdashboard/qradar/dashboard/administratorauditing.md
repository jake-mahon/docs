...
Admin Activity. See the [SIEM Folder Templates](../../../admin/templates/folder/siem.md) topic for
...
- All Administrator Activity – Tabular format of all events that have been recorded in the specified
  timeframe. See the [Table Card Features](../navigate.md#table-card-features) topic for additional
  information.
