...
![Settings interface](../../../../../static/img/product_docs/activitymonitor/config/dellpowerscale/settings.webp)
...
Authentication activity by a honey account will generate an INTERCEPT: Honey Accounts Offense. See the [INTERCEPT Offenses in QRadar](offenses.md) topic for additional information.
