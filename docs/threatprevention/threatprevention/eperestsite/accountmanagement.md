...
![GET api/account/users](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/users.png)
...
![POST api/account/create](/static/img/product_docs/threatprevention/threatprevention/eperestsite/create.png)
...
![GET api/account/user/<userId>](/static/img/product_docs/threatprevention/threatprevention/eperestsite/userid.png)
...
![GET api/account/user/<userName>](/static/img/product_docs/threatprevention/threatprevention/eperestsite/username.png)
...
![DELETE api/account/delete?userName=<username>](/static/img/product_docs/strongpointfornetsuite/integrations/delete.png)
