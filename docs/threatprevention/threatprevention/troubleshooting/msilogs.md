...
When performing remote Agent deployment using the Administration Console, log files can be found in the ```C:\Windows\Temp``` folder on the target Agent machine. See the [Agents Interface](../admin/agents/overview.md) topic for additional information.
