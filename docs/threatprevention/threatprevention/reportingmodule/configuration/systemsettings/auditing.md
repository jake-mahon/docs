...
![System Settings interface on the Auditing page](/static/img/product_docs/threatprevention/threatprevention/reportingmodule/interface.png)
...
- Click on __Today__ to open the calendar along with several other options to filter the data for a specific time period. For example:

  - Click _Last 7 Days_ to view the audit data for the last week
  - Click _Custom Range_ and then use the calendar to specify a time range to view audit data for that period

  Click __Apply__ after making a selection.
