...
See the [Reporting Module Server Requirements](/docs/product_docs/threatprevention/threatprevention/requirements/reportingserver.md) topic for a list of permission requirements for each type of task.
