...
![Group Details page - Members tab](/static/img/product_docs/threatprevention/threatprevention/reportingmodule/investigations/groupdetails.png)
...
![Group Membership Tab](/static/img/product_docs/threatprevention/threatprevention/reportingmodule/investigations/groupmembershiptab.png)

The Group Membership tab displays the groups that _the group_ is a member of. Here, 'the group' refers to the group whose details you are viewing.
