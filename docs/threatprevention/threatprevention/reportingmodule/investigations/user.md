...
In an investigation report, user names appear as links under the Perpetrator column in the Event Details and Top Resources sections (see the [Investigation Reports](reports.md) topic). Click a link to land on the User Details page.
