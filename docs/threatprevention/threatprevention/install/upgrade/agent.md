...
- Add the path or names of the files listed under Agent Server in the [Installation](../overview.md) topic in the EDR.
...
__Step 2 –__ On the [Agents Interface](../../admin/agents/overview.md), select the desired server/Agent in the grid and on the top toolbar, select __Update Agent Installer__. The [Agent Installer Update Window](../../admin/agents/window/agentinstallerupdate.md) opens.
