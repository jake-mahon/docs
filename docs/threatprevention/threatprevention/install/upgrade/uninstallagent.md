...
___RECOMMENDED:___ Deploy the Agent to a server using the Deploy Agents wizard. See the [Deploy Agents](/docs/product_docs/threatprevention/threatprevention/admin/agents/deploy/overview.md) topic for additional information.
