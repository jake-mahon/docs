...
The Threat PreventionAgent must be installed to the appropriate systems for monitoring. See the [Agent Information](/docs/threatprevention/threatprevention/install/agent/overview.md) topic for specifics on where to deploy.
...
See the [Agents Interface](/docs/threatprevention/threatprevention/admin/agents/overview.md) topic and the [Deploy Agents](/docs/threatprevention/threatprevention/admin/agents/deploy/overview.md) topic for additional information to deploy the Agent through the Administration Console.
...
- Approve certificates – Select this checkbox to approve the thumbprint, which will then enable the Enrollment Secret box. Enter the enrollment secret obtained from the [Enrollment Secret Configuration Window](/docs/threatprevention/threatprevention/admin/agents/window/enrollmentsecretconfiguration.md).
...
If the certificates are managed by Threat Prevention, Agent deployment is completed. If the custom-managed certificate option was selected, see the [Create Custom Managed Certificates for Each Agent](/docs/threatprevention/threatprevention/install/agent/customcert.md) topic for additional information.
