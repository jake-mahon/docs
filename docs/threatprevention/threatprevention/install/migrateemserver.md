...
__Step 1 –__ Install the Enterprise Manager to the new machine. See the [Application Server Install](application.md) topic for additional information.
...
1. Click __Agents__ in the left pane to open the [Agents Interface](../admin/agents/overview.md).
