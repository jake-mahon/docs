...
[Pre-Created Templates](/docs/threatprevention/7.4/threatprevention/admin/templates/folder/overview.md)
topic for additional information.

- Click a template to open it and view its configurations. See the
  [Template Configuration](/docs/threatprevention/7.4/threatprevention/admin/templates/configuration.md)
  topic for additional information.
...
- You can also drag a template into a folder under the Policies node. This would be a Copy action,
  ...
  [Use a Template to Create a Policy](/docs/threatprevention/7.4/threatprevention/admin/templates/createpolicy.md)
  topic for additional information.
...
| Export               | Exports the selected template’s configuration to an XML file through the [Export Policies and Templates Window](/docs/threatprevention/7.4/threatprevention/admin/policies/exportpoliciestemplates.md) |
