...
[Agent Compatibility with Non-Netwrix Security Products](/versioned_docs/threatprevention_7.4/threatprevention/requirements/agent.md#agent-compatibility-with-non-netwrix-security-products)
list.
...
[Getting Data from NTP for AD Activity Reporting](/versioned_docs/threatprevention_7.4/config/activedirectory/threatprevention.md)
