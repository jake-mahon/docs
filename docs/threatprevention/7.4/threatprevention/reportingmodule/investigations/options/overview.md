...
- Edit – The Edit option opens the Save Investigation window in edit mode. You can modify the name,
  ...
  [Edit or Duplicate an Investigation](/docs/threatprevention/7.4/threatprevention/reportingmodule/investigations/options/edit.md)
...
- Filters – The Filters section provides options to build a filter statement by selecting the
  ...
  [Filters Section](/docs/threatprevention/7.4/threatprevention/reportingmodule/investigations/options/filters.md)
  topic for additional information.
