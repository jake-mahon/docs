...
- Integrations – Allows you to configure integrations with a variety of Netwrix products and
  ...
  [Integrations Interface](/docs/threatprevention/7.4/threatprevention/reportingmodule/configuration/integrations/overview.md)
...
- System Health – Provides access to the Services page, displays the services associated with the
  ...
  [System Health Interface](/docs/threatprevention/7.4/threatprevention/reportingmodule/configuration/systemhealth.md)
  topic for additional information.
- System Settings – Provides access to system logs, user access controls, licensing, and more. See
  the
  [System Settings Interface](/docs/threatprevention/7.4/threatprevention/reportingmodule/configuration/systemsettings/interface.md)
  topic for additional information.
