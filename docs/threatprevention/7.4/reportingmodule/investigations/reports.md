...
sidebar_label: Investigation Reports
description: A report generated by an investigation query displays the following information: - Event Details – Provides a view of all events matching the criteria specif...
...
![Events Detaisl section of an investigation report](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/investigations/eventdetails.webp)
...
See the
[Host Details Page](/docs/threatprevention/7.4/reportingmodule/investigations/host.md)
and
[User Details Page](/docs/threatprevention/7.4/reportingmodule/investigations/user.md)
...
![Events Over Time section of an Investigations report](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/investigations/eventsovertime.webp)
...
![Top Resources section of an Investigations report](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/investigations/topresources.webp)
