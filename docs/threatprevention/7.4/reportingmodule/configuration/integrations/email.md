...
![Integrations interface on the Email page showing details](/img/product_docs/threatprevention/7.4/reportingmodule/configuration/integrations/details.webp)
