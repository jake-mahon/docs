...
![Integrations interface on the Authentication Provider page](/img/product_docs/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/page.webp)
...
![Integrations interface displaying the details for an Authentication Provider with the type drop-down menu open](/img/product_docs/threatprevention/7.4/reportingmodule/configuration/integrations/authenticationprovider/type.webp)
