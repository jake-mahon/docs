...
![Delegates window](/img/product_docs/threatprevention/7.4/troubleshooting/delegates.webp)
...
![Inbox Properties window](/img/product_docs/threatprevention/7.4/troubleshooting/inboxproperties.webp)

A message will appear as follows:

![permissionnotsaved](/img/product_docs/threatprevention/7.4/troubleshooting/permissionnotsaved.webp)
