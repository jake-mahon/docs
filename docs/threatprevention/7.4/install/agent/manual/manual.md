...
![Threat Prevention Windows Agent Setup wizard - Welcome page](/img/product_docs/threatprevention/7.4/install/agent/welcome_1.webp)

**Step 2 –** On the Welcome page, click **Install**. The Setup Progress page is displayed, followed
by another Welcome page.

![welcome2](/img/product_docs/threatprevention/7.4/install/agent/welcome2.webp)

**Step 3 –** Click **Next**.

![Threat Prevention Windows Agent Setup wizard - End-User License Agreement page](/img/product_docs/threatprevention/7.4/install/agent/license.webp)

**Step 4 –** On the End-User License Agreement page, check the **I accept the terms in the License
Agreement** box and click **Next**.

![Threat Prevention Windows Agent Setup wizard - Destination Folder page](/img/product_docs/threatprevention/7.4/install/agent/destinationfolder.webp)
...
![Change Destination Folder Page](/img/product_docs/threatprevention/7.4/install/agent/changedestination.webp)
...
![Threat Prevention Windows Agent Setup wizard - CA Certificate Configuration page](/img/product_docs/threatprevention/7.4/install/agent/cacertconfig.webp)
...
![Threat Prevention Windows Agent Setup wizard - Enterprise Manager Location Information page](/img/product_docs/threatprevention/7.4/install/agent/enterprisemanager.webp)
...
![StealthINTERCEPT Windows Agent Setup wizard on the Certificates page](/img/product_docs/threatprevention/7.4/install/agent/certificates.webp)
...
![Threat Prevention Windows Agent Setup wizard - Select Event Sources page](/img/product_docs/threatprevention/7.4/install/agent/eventsources.webp)
...
![Threat Prevention Windows Agent Setup wizard – Ready page](/img/product_docs/threatprevention/7.4/install/agent/readytoinstall.webp)
...
![Threat Prevention Windows Agent Setup wizard – Operation Successful page](/img/product_docs/threatprevention/7.4/install/agent/success.webp)
