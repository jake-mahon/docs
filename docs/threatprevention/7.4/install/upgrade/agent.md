...
[Agent Installer Update Window](/docs/threatprevention/7.4/admin/agents/window/agentinstallerupdate.md)
opens.
...
![Access Verification window](/img/versioned_docs/threatprevention_7.4/threatprevention/install/upgrade/accessverification.webp)
...
![Upgrade Agent window](/img/versioned_docs/threatprevention_7.4/threatprevention/install/upgrade/upgradeagent.webp)
