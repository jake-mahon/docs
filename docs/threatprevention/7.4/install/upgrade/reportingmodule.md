...
![Netwrix Threat Manager Setup window](/img/product_docs/threatprevention/7.4/install/upgrade/tm3installation.webp)
...
![Threat Manager Reporting - Upgrade DB Confirmation dialog box](/img/product_docs/threatprevention/7.4/install/upgrade/upgradedbprompt.webp)

**Step 3 –** Click **OK** to upgrade. The Netwrix PostgreSQL Setup wizard opens.

![Netwrix PostgreSQL Setup wizard](/img/product_docs/threatprevention/7.4/install/upgrade/install.webp)

**Step 4 –** Click **Install**.

![Netwrix PostgreSQL Setup wizard on the EULA page](/img/product_docs/threatprevention/7.4/install/upgrade/eula.webp)
...
![Threat Manager Reporting - Upgrade Application Confirmation dialog box](/img/product_docs/threatprevention/7.4/install/upgrade/upgradeappprompt.webp)
