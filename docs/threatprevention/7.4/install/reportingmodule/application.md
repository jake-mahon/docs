...
![Warning message that the database does not exist, Create?](/img/product_docs/threatprevention/7.4/install/reportingmodule/databasecreatemessage.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Database page showing Ready for installation message](/img/product_docs/threatprevention/7.4/install/reportingmodule/databaseready.webp)
...
![Netwrix Threat Mannager Reporting Setup wizard on the Firewall Rules page](/img/product_docs/threatprevention/7.4/install/reportingmodule/firewallrules.webp)
...
![Netwrix Setup Launcher showingThreat Manager Reporting Setup completed](/img/product_docs/threatprevention/7.4/install/reportingmodule/applicationcheck.webp)
