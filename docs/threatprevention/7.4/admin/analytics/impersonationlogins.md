...
![Impersonation Logins Analytic Type - Settings tab](/img/product_docs/threatprevention/7.4/admin/analytics/concurrentloginssettings.webp)
...
![Impersonation Logins Analytic Type - Policy tab](/img/product_docs/threatprevention/7.4/admin/analytics/policytab.webp)
...
![Impersonation Logins Analytic Type window](/img/product_docs/threatprevention/7.4/admin/analytics/impersonationlogins.webp)
