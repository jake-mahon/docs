...
![Bad User ID (by User) Analytic Type - Settings tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/baduseridsettings.webp)
...
![Bad User ID (by User) Analytic Type - Policy tab](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/policytab.webp)
...
![Bad User ID (by User) Analytic Type  window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/analytics/baduseriduser.webp)
