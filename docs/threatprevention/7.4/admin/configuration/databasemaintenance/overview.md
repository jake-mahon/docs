...
![Threat Prevention WinConsole Warning window](/img/product_docs/threatprevention/7.4/admin/configuration/databasemaintenance/warning.webp)
...
![Database Maintenance window](/img/product_docs/threatprevention/7.4/admin/configuration/databasemaintenance/databasemaintenance.webp)
...
![Database Maintenance window - Event Type tab](/img/product_docs/threatprevention/7.4/admin/configuration/databasemaintenance/eventtype.webp)
...
![Database Maintenance window - Analytics tab](/img/product_docs/threatprevention/7.4/admin/configuration/databasemaintenance/analytics.webp)
...
![Database Maintenance window - Policy tab](/img/product_docs/threatprevention/7.4/admin/configuration/databasemaintenance/policy.webp)
