...
![Netwrix Threat Manager Configuration window - Event Sink tab](/img/product_docs/threatprevention/7.4/admin/configuration/threatmanagerconfiguration.webp)
...
![Netwrix Threat Manager Configuration Window - Honey Tokem tab](/img/product_docs/threatprevention/7.4/admin/configuration/honeytoken.webp)
...
![Netwrix Threat Manager Configuration Window - Forged PAC tab](/img/product_docs/threatprevention/7.4/admin/configuration/forgedpac.webp)
