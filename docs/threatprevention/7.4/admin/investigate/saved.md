...
description: You can apply filters on the Investigate Interface to filter event data as desired. Filters settings can be saved. Follow the steps to save a filtered
---
...
![Investigate Interface - Save a Filtered View](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/investigate/saveview.webp)
...
![Filter Set Name window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/investigate/filtersetname.webp)

**Step 3 –** Type a name for this filtered view and click **OK**.

![Saved filter view in the navigation pane](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/investigate/savedview.webp)
