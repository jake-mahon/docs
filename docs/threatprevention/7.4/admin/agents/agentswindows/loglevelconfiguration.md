...
![Log Level Configuration Window](/img/product_docs/threatprevention/7.4/admin/agents/window/loglevelconfiguration.webp)
...
![Get Agent Log icon](/img/product_docs/threatprevention/7.4/admin/agents/window/getagentlog.webp)

**Step 1 –** Click **Agents** in the left pane to launch the Agents interface. Select a server/Agent
and click **Get Agent Log** .

![Save As window for Agent logs](/img/product_docs/threatprevention/7.4/admin/agents/window/saveaswindow.webp)
