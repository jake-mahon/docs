...
![Policy window - Password Enforcement Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/passwordenforcement.webp)
...
![Policy window - AD Account filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/adaccount.webp)
