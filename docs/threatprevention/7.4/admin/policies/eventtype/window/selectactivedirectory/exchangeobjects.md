...
![Select Exchange Objects from Active Directory Window](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/window/selectactivedirectory/exchangeobjectsfromad.webp)
