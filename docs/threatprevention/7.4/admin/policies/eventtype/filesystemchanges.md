...
![Policy window - File System Changes Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/filesystemchanges.webp)
...
![Policy window - File System filter for monitoring](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/filesystem.webp)
...
![Policy window - Paths filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/paths.webp)
...
![Policy window - Additional Agents filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/additionalagents.webp)
