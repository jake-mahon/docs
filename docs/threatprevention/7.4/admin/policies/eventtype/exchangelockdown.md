...
![Policy window - Exchange Lockdown Event Type](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/exchangelockdown.webp)
...
![Policy window - Exchange Event filter for lockdown](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/exchangeeventlockdown.webp)
...
- The **Add** (+) button opens the
  [Select Exchange Objects from Active Directory Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/selectactivedirectory/exchangeobjects.md).
...
![Policy window - Exchange Trustees filter for lockdown](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/exchangetrusteeslockdown.webp)
...
- The Trustees **Add** (+) button opens the
  [Select Active Directory Trustees Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/selectactivedirectory/trustees.md).
- The Collection button opens the
  [List of Collections Window](/docs/threatprevention/7.4/admin/configuration/collectionmanager/listcollections.md)
  to the appropriate Collection category.
- The Remove (x) button deletes the selected item(s) from that box.
...
![Policy window - Exchange Perpetrator filter for lockdown](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/exchangeperpetratorlockdown.webp)
