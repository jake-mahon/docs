...
[Monitor Weak Passwords Use Case](/docs/threatprevention/7.4/admin/policies/eventtype/usecase/monitorweakpasswords.md)
topic for additional information.
...
![New Prevent Weak Passwords Policy - General tab](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/newblockepepolicy.webp)
...
- On the Event Type tab, click the **Add** (+) button and select Password Enforcement on the
  [Event Selection Window](/docs/threatprevention/7.4/admin/policies/eventtype/overview.md#event-selection-window).

![Policy - Event Type tab with the Password Enforcement event selected](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/passwordrulesblock.webp)
...
![Recent Events Tab for weak password prevent](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/recenteventsprevent.webp)

## View Events in Investigate Interface

![Investigate Interface](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/invesitgatenodeblock.webp)
