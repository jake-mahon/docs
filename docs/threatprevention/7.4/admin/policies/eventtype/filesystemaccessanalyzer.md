...
![Policy window - File System Enterprise Auditor Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/filesystemaccessanalyzer.webp)
...
![Policy window - File System Agents filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/filesystemagents.webp)
...
![Policy window - Processes and Configuration filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/processesandconfiguration.webp)
...
![Policy window - Perpetrators to Exclude filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/perpetratorstoexclude.webp)
