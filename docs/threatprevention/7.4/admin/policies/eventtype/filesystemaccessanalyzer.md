...
sidebar_label: File System Enterprise Auditor
description: The File System Enterprise Auditor event type is used to send File System activity to Netwrix Access Analyzer (formerly Enterprise Auditor).
---
...
![Policy window - File System Enterprise Auditor Event Type](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/filesystemaccessanalyzer.webp)
...
![Policy window - File System Enterprise Auditor filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/filesystemaccessanalyzer.webp)
...
- The Path **Add** (+) button opens the
  [Select File System Objects Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/selectfilesystemobjects.md).
...
![Policy window - File System Agents filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/filesystemagents.webp)
...
![Policy window - Processes and Configuration filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/processesandconfiguration.webp)
...
![Policy window - Perpetrators to Exclude filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/perpetratorstoexclude.webp)
