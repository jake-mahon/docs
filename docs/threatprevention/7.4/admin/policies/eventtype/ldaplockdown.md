...
![Policy window - LDAP Lockdown Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/ldaplockdown.webp)
...
![Policy window - LDAP Query filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/ldapquerylockdown.webp)
