...
![Policy window - Active Directory Changes Event Type](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adchanges.webp)
...
![Policy window - AD Event filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adevent.webp)
...
![Policy window - AD Context filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adcontext.webp)
...
![Policy window - AD Classes filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adclasses.webp)

Use the buttons in the Include and Exclude areas to edit the lists.

- The Add (+) buttons open the
  [Class List Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/classlist.md).
- The Collection button opens the
  [List of Collections Window](/docs/threatprevention/7.4/admin/configuration/collectionmanager/listcollections.md)
  to the appropriate Collection category.
- The Remove (x) button deletes the selected item(s) from that box.
...
![Policy window - AD Attributes filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adattributes.webp)
...
dropdown opens the
[User Account Control Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/useraccountcontrol.md)
...
![Policy window - AD Objects filter](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/eventtype/adobjects.webp)
...
![Event Type – IP Addresses (from) filter](/img/versioned_docs/activitymonitor_7.1/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/ipaddressesfrom.webp)
...
- The IP Addresses Add (+) button opens the
  [Add IP Address Window](/docs/threatprevention/7.4/admin/policies/eventtype/window/addipaddress.md).
- The Collection button opens the
  [List of Collections Window](/docs/threatprevention/7.4/admin/configuration/collectionmanager/listcollections.md)
  to the appropriate Collection category.
- The Remove (x) button deletes the selected item(s) from that box.
