...
![Policy window - Active Directory Lockdown Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/adlockdown.webp)
...
![Policy window - AD Objects and Containers filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/adobjectsandcontainers.webp)
...
![Policy window - AD Classes And Attributes filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/adclassesattributes.webp)
...
![Policy window - Hosts (from) filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/hostsfromlockdown.webp)
...
![Policy window - User Account Control (UAC) filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/useraccountcontrol.webp)
