...
![Policy > Actions tab > Add Actions window for .Net Script](/img/product_docs/threatprevention/7.4/admin/policies/actions/addactionwindowfornetscript.webp)
...
![Script Editor for .Net Scripts](/img/product_docs/threatprevention/7.4/admin/policies/actions/scripteditorfornet.webp)
...
![Actions tab - .Net Script Action Created](/img/product_docs/threatprevention/7.4/admin/policies/actions/netscriptaction.webp)
...
![Tools Menu in the Script Editor](/img/product_docs/threatprevention/7.4/admin/policies/actions/toolsmenu.webp)
