...
![honeytoken](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/honeytoken.webp)
...
![ldapfiltercopiedtoclipboard](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/ldapfiltercopiedtoclipboard.webp)
...
![Netwrix Threat Manager for AD LDAP template – Event Type tab with LDAP Query filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/usecase/ldapmonitoringfortm.webp)
