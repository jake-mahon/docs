...
![AD Attributes filter - serAccountControl attribute selected](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/window/useraccountcontrolattribute.webp)
...
![User Account Control Window](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/window/useraccountcotrol.webp)
