...
![Policy window - LSASS Guardian – Monitor Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/lsassmonitor.webp)
...
![Processes Monitoring filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/processesmonitoring.webp)
