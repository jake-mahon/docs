...
![Policy window - FSMO Role Monitoring Event Type](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/fsmorolemonitoring.webp)
...
![Policy window - FSMO Operations filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/fsmooperations.webp)
...
![Policy window - FSMO Roles filter](/img/product_docs/threatprevention/7.4/admin/policies/eventtype/fsmoroles.webp)
