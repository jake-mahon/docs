...
![Policy > Actions tab > Add Actions window](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/actions/addactionwindow.webp)
...
![Actions tab - File action created](/img/versioned_docs/threatprevention_7.4/threatprevention/admin/policies/actions/fileaction.webp)
