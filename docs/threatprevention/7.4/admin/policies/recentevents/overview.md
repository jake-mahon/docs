...
![Policy - Recent Events tab](/img/product_docs/threatprevention/7.4/admin/policies/recentevents/recenteventstab.webp)
...
![Recent Events tab - Additional Information for an event](/img/product_docs/threatprevention/7.4/admin/policies/recentevents/recenteventdetails.webp)
...
- Event Tracker – Opens the
  [Event Tracker Window](/docs/threatprevention/7.4/admin/policies/recentevents/eventtracker.md)
  for the selected event/data row
- [Execute PS Script](/docs/threatprevention/7.4/admin/policies/recentevents/executepsscript.md)
