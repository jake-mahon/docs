...
- The Add (+) button opens the [Select AD Groups Window](/docs/threatprevention/7.5/threatprevention/admin/policies/eventtype/window/selectactivedirectory/groups.md).
