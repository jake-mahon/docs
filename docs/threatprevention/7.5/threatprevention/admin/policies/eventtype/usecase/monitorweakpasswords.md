...
**NOTE:** See the [Prevent Weak Passwords Use Case](/docs/threatprevention/7.5/threatprevention/admin/policies/eventtype/usecase/preventweakpasswords.md) topic for instructions
on creating a policy to block weak passwords, which requires the Threat Prevention
for[ Enterprise Password Enforcer](/docs/threatprevention/7.5/threatprevention/solutions/epe.md) solution.
...
to view monitored events. See the [Recent Events Tab](/docs/threatprevention/7.5/threatprevention/admin/policies/recentevents/overview.md) topic for
additional information.
