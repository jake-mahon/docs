...
Feedback module. See the [ Enterprise Password Enforcer](../../../../solutions/epe.md) topic for
...
enabling a blocking policy. See the [Monitor Weak Passwords Use Case](monitorweakpasswords.md) topic
...
- Download the latest copy of the HaveIBeenPwned dictionary file. See the
  [Download and Configure the Have I Been Pwnd Hash List](../../../configuration/epesettings.md#download-and-configure-the-have-i-been-pwnd-hash-list)
...
- Determine whether you want to deploy the dictionary to each domain controller or keep it locally
  ...
  [Considerations When Deploying the HIBP Database](../../../configuration/epesettings.md#considerations-when-deploying-the-hibp-database)
  topic for additional information.
- Modify the global password rules to customize the password dictionary, word list dictionary and
  character substitution map. See the [Rules](../../../configuration/epesettings.md#rules) topic for
  additional information.
...
- On the Event Type tab, click the **Add** (+) button and select Password Enforcement on the
  [Event Selection Window](../overview.md#event-selection-window).
...
Refresh button to view blocked events. See the [Recent Events Tab](../../recentevents/overview.md)
topic for additional information.
...
See the [Investigations Interface](../../../../reportingmodule/investigations/overview.md) topic for
additional information.
