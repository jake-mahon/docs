...
[LDAP Lockdown Event Type](/docs/threatprevention/7.5/threatprevention/admin/policies/eventtype/ldaplockdown.md), the LDAP filter allows you to enable the LDAP Ping
option.
