...
disable the policy. On the [Policies Interface](overview.md), an enabled policy is represented with
...
[Policies Interface](overview.md). Event data can be filtered by policy; therefore, a descriptive
...
displayed for a policy in the list on the [Policies Interface](overview.md).
...
[Policies Interface](overview.md). Active at Specified Times is represented by a clock icon, and
