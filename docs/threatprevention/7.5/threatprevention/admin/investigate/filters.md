...
On the [Investigate Interface](overview.md), there are six filter categories that can be applied to
...
[Saved Investigations](saved.md) topic for additional information.
