...
See the [Manual Agent Deployment](/docs/threatprevention/7.5/threatprevention/install/agent/manual.md) topic for additional
information.
...
[Agent Server Requirements](/docs/threatprevention/7.5/threatprevention/requirements/agent.md) topic for additional information.
...
tabs on the window. See the [Select Computers Window](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/selectcomputers.md) topic for additional
information. Click **Next**.

If you open this window through the [Right-Click Menu](/docs/threatprevention/7.5/threatprevention/admin/agents/overview.md#right-click-menu) action, the
...
the [Set Options Window ](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/setoptions.md)topic for additional information.
...
prerequisite check for the Agent. See the [Prerequisites Check Window](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/prerequisitescheck.md) topic
...
was successful. See the [Installing Window ](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/installing.md) topic for additional information.
...
Manager. See the [Bind To](/docs/threatprevention/7.5/threatprevention/troubleshooting/agentcommunication.md#bind-to) topic for
...
[Right-Click Menu](/docs/threatprevention/7.5/threatprevention/admin/agents/overview.md#right-click-menu). The Select Computers window opens.
...
[Select Computers Window](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/selectcomputers.md) topic for additional information. Click **Next**.
...
[Set Options Window ](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/setoptions.md) topic for additional information.
...
[Prerequisites Check Window](/docs/threatprevention/7.5/threatprevention/admin/agents/deploy/prerequisitescheck.md) topic for additional information. Click
**Next**.
