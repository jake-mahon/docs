...
See the [Manual Agent Deployment](../../../install/agent/manual.md) topic for additional
information.
...
[Agent Server Requirements](../../../requirements/agent.md) topic for additional information.
...
tabs on the window. See the [Select Computers Window](selectcomputers.md) topic for additional
information. Click **Next**.

If you open this window through the [Right-Click Menu](../overview.md#right-click-menu) action, the
...
the [Set Options Window ](setoptions.md)topic for additional information.
...
prerequisite check for the Agent. See the [Prerequisites Check Window](prerequisitescheck.md) topic
...
was successful. See the [Installing Window ](installing.md) topic for additional information.
...
Manager. See the [Bind To](../../../troubleshooting/agentcommunication.md#bind-to) topic for
...
[Right-Click Menu](../overview.md#right-click-menu). The Select Computers window opens.
...
[Select Computers Window](selectcomputers.md) topic for additional information. Click **Next**.
...
[Set Options Window ](setoptions.md) topic for additional information.
...
[Prerequisites Check Window](prerequisitescheck.md) topic for additional information. Click
**Next**.
