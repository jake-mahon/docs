...
Agent instrumentation. See the [Agent Information](/docs/threatprevention/7.5/threatprevention/install/agent/overview.md) topic for
...
![Agent Installer Update window](/img/product_docs/threatprevention/threatprevention/admin/agents/window/checkfornewversion.webp)
...
![Agent Installer Update window showing that Agent Installer is up-to-date](/img/product_docs/threatprevention/threatprevention/admin/agents/window/uptodate.webp)
...
![Agent Installer Update window showing that Agent version is outdated](/img/product_docs/threatprevention/threatprevention/admin/agents/window/agentversionmismatch.webp)
