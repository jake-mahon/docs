...
- If opened via the keyboard shortcut (Alt+X) on the [Policies Interface](/docs/threatprevention/7.5/threatprevention/admin/policies/overview.md)
  or [Templates Interface](/docs/threatprevention/7.5/threatprevention/admin/templates/overview.md), it exports only what is within the selection.
- To export only a single policy or template, use the Export option on the right-click menu. See the
  [Export Policies and Templates Window](/docs/threatprevention/7.5/threatprevention/admin/policies/exportpoliciestemplates.md) topic for
...
- Event Consumers and Alerts
    ...
    - Export Only Event Consumers and Alerts Used in Policies and Templates – Exports only event
      ...
      [Actions Tab](/docs/threatprevention/7.5/threatprevention/admin/policies/actions/overview.md) of enabled policies
- Options:
...
settings. See the [Import Window](/docs/threatprevention/7.5/threatprevention/admin/tools/import.md) topic to import this file.
