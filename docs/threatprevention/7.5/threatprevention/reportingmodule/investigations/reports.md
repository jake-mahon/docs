...
See the [Host Details Page](host.md) and [User Details Page](user.md) topics for additional
information.
...
Click the link to view perpetrator details. See the [User Details Page](user.md) topic for
additional information.
...
Click the link to view target details. See the [Host Details Page](host.md) topic for additional
information.
