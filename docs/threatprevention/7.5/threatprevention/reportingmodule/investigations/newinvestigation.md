...
the [Filters Section](/docs/threatprevention/7.5/threatprevention/reportingmodule/investigations/options/filters.md) topic for additional information.
...
available from the New Investigation page. See the [Export Report](/docs/threatprevention/7.5/threatprevention/reportingmodule/investigations/options/export.md) topic for
...
See the [Investigation Options](/docs/threatprevention/7.5/threatprevention/reportingmodule/investigations/options/overview.md) topic for additional information.
