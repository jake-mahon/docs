...
subscription, or export the report. See the [Investigation Options](/docs/threatprevention/7.5/threatprevention/reportingmodule/investigations/options/overview.md) topic for
