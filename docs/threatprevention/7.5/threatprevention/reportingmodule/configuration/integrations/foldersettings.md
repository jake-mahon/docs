...
access to the shared folder. See the [Credential Profile Page](/docs/threatprevention/7.5/threatprevention/reportingmodule/configuration/integrations/credentialprofile.md) topic for
creating a profile.
