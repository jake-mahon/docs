...
- Latest Events – Tabular format of all events associated with the host that occurred over the
  specified time interval. See the [Table Card Features](/docs/threatprevention/7.5/threatprevention/siemdashboard/qradar/navigate.md#table-card-features) topic
