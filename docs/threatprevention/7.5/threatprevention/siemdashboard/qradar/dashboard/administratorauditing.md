...
Admin Activity. See the [SIEM Folder Templates](/docs/threatprevention/7.5/threatprevention/admin/templates/folder/siem.md) topic for
...
- All Administrator Activity – Tabular format of all events that have been recorded in the specified
  timeframe. See the [Table Card Features](/docs/threatprevention/7.5/threatprevention/siemdashboard/qradar/navigate.md#table-card-features) topic for additional
  information.
