...
While the [Authentication Attacks Dashboard](/docs/threatprevention/7.5/threatprevention/siemdashboard/qradar/dashboard/authenticationattacks.md) reports on
