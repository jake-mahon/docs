...
[System Alerting Window](../admin/configuration/systemalerting/overview.md).
...
[Agent Safe Mode](../admin/agents/safemode.md) topic for additional information.
...
[Configure SMTP Host Information](../admin/configuration/systemalerting/email.md#configure-smtp-host-information)
...
[Create Message Profiles](../admin/configuration/systemalerting/email.md#create-message-profiles)
topic for additional information.
...
from the drop-down menu. See the [Email Tab](../admin/configuration/systemalerting/email.md) topic
