...
[Configure SMTP Host Information](/docs/threatprevention/7.5/threatprevention/admin/configuration/systemalerting/email.md#configure-smtp-host-information)
...
[Create Message Profiles](/docs/threatprevention/7.5/threatprevention/admin/configuration/systemalerting/email.md#create-message-profiles)
topic for additional information.

![System Alerting window - LSASS Process Terminated alert](/img/product_docs/threatprevention/threatprevention/troubleshooting/lsassprocessterminated.webp)
...
from the drop-down menu. See the [Email Tab](/docs/threatprevention/7.5/threatprevention/admin/configuration/systemalerting/email.md) topic
