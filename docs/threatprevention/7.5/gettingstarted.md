...
- Create a new policy and template configuration. See the
  [Policy Configuration](/docs/threatprevention/7.5/admin/policies/configuration.md) and
  [Template Configuration](/docs/threatprevention/7.5/admin/templates/configuration.md) topics for additional information.
...
[Recent Events Tab](/docs/threatprevention/7.5/admin/policies/recentevents/overview.md) in the policy's configuration or to the
...
- Administration Console – Navigate to either the Recent Events tab in the policy's configuration or
  ...
  [Recent Events Tab](/docs/threatprevention/7.5/admin/policies/recentevents/overview.md) and
