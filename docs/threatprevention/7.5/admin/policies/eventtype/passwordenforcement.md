...
- Containers – The Containers Add (+) button opens the
  [Select Active Directory Contexts Window](/docs/threatprevention/7.5/admin/policies/eventtype/window/selectactivedirectory/context.md). All user
  objects in the selected organizational unit(s) are subject to the applied rule.
- Groups – The Groups Add (+) button opens the
  [Select AD Groups Window](/docs/threatprevention/7.5/admin/policies/eventtype/window/selectactivedirectory/groups.md).
...
[Test Passwords Window](/docs/threatprevention/7.5/admin/policies/eventtype/window/testpasswords.md), where you can test your set of rules.
