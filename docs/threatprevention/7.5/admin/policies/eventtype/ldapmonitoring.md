...
![Policy window - LDAP Monitoring Event Type](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/ldapmonitoring.webp)
...
![Policy window - LDAP Runtime filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/ldapruntime.webp)
...
![Policy window - LDAP Query filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/ldapquery.webp)
...
![Policy window - LDAP Result filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/queryresult.webp)
...
![Policcy window - LDAP Attributes filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/ldapattributes.webp)
