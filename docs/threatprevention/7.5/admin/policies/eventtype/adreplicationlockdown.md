...
![Policy window - AD Replication Lockdown Event Type](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/adreplicationlockdown.webp)
...
![Policy window - Permissions  filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/permissions.webp)
...
![Policy window - Hosts (from) filter for the AD Replication Lockdown event type](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/adreplicationhostsfrom.webp)
