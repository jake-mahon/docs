...
![Policy window - Active Directory Read Monitoring Event Type](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/adreadmonitoring.webp)
...
![Policy window - AD Attributes Monitoring filter](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/adattributesmonitor.webp)
