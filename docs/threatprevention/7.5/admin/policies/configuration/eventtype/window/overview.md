...
![Selection Window - Connect to Agent/Server option](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/window/selectagent.webp)
...
![Selection Window - Browse mode](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/window/adperpetrators.webp)
...
![Selection Window - Search Mode](/img/product_docs/threatprevention/7.5/admin/policies/eventtype/window/searchmode.webp)
