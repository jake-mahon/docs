...
![Policies - Actions tab](/img/product_docs/threatprevention/7.5/admin/policies/actions/actionstab.webp)
...
![Actions tab - Email Notifications section](/img/product_docs/threatprevention/7.5/admin/policies/actions/emailnotificationssetup.webp)
...
emails. See the [Custom Scripts](/docs/threatprevention/7.5/admin/templates/folder/actions.md#custom-scripts) topic for
