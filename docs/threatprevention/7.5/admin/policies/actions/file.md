...
![Policy > Actions tab > Add Actions window](/img/product_docs/threatprevention/7.5/admin/policies/actions/addactionwindow.webp)
...
![Actions tab - File action created](/img/product_docs/threatprevention/7.5/admin/policies/actions/fileaction.webp)
