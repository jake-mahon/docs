...
![Policy folder - Permissions page](/img/product_docs/threatprevention/7.5/admin/policies/permissions.webp)
...
![Select User window](/img/product_docs/threatprevention/7.5/admin/policies/selectuser.webp)
