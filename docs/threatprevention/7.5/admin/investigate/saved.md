...
![Investigate Interface - Save a Filtered View](/img/product_docs/threatprevention/7.5/admin/investigate/saveview.webp)
...
![Filter Set Name window](/img/product_docs/threatprevention/7.5/admin/investigate/filtersetname.webp)

**Step 3 –** Type a name for this filtered view and click **OK**.

![Saved filter view in the navigation pane](/img/product_docs/threatprevention/7.5/admin/investigate/savedview.webp)
