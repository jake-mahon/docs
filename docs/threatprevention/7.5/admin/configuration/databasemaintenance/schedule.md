...
![Database Maintenance window - Schedule tab](/img/product_docs/threatprevention/7.5/admin/configuration/databasemaintenance/schedule.webp)
...
![Database Maintenance job in Microsoft SQL Server Management Studio](/img/product_docs/threatprevention/7.5/admin/configuration/databasemaintenance/dbmaintenancejob.webp)
