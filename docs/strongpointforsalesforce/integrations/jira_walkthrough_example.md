...
3. Click __Create__ (__+__).
   ...
   ![Create a Jira ticket](/img/product_docs/strongpointfornetsuite/integrations/jira_example_create_issue.png)
...
1. Open the __Comments__ tab and select __Strongpoint Salesforce__.
   ...
   ![Accessing the Strongpoint Salesforce app](/img/product_docs/strongpointforsalesforce/integrations/jira_comments_open_app.png)
2. There are two ways to connect: __Login User__ or __Connected App__ tabs.

   ![Connection options](/img/product_docs/strongpointforsalesforce/integrations/connection_options.png)
...
1. Open the __Connected App__ tab.
   ...
   ![Using the connected app](/img/product_docs/strongpointforsalesforce/integrations/connection_options_app.png)
...
![Enter your Jira credentials](/img/product_docs/strongpointforsalesforce/integrations/jira_credentials.png)
...
2. Open __View Profile__ > __Settings__.  
   ![Open your Salesforce Profile settings](/img/product_docs/strongpointforsalesforce/integrations/jira_example_settings.png)
...
![Connection details for the ticket](/img/product_docs/strongpointforsalesforce/integrations/jira_connection.png)
...
2. Click __+__ to search for matching Customizations. Hover over __View__ to display the __Type__ and __API Name__ for a Customization.
   ...
   ![Add an existing customization](/img/product_docs/strongpointforsalesforce/integrations/jira_customization_add.png)
...
4. Click __Add Selected Customizations__. The selected Customization is added to the __Existing Customizations__ list.
   ...
   ![Add an existing customization](/img/product_docs/strongpointforsalesforce/integrations/jira_example_add_existing.png)
...
6. The __API Name__ is displayed. Select it, and click __Add Selected Customizations__. The selected Customization is added to the __Existing Customizations__ list. This example shows __UpsellOpportunities (ApexClass)__, an API in the _Strongpoint Demo Org_.
   ...
   ![Add an existing customization by API Name](/img/product_docs/strongpointforsalesforce/integrations/jira_example_add_existing_api.png)
...
2. Click (__+__) to add it. If the API Name is valid, and does not match an existing API Name, the new Customization is added to the __Proposed Customizations__ list.
   ...
   ![Add a proposed customization](/img/product_docs/strongpointforsalesforce/integrations/jira_example_proposed.png)
...
![Policy and Change Level Req have been updated](/img/product_docs/strongpointforsalesforce/integrations/jira_example_policy.png)
...
![Impact analysis report](/img/product_docs/strongpointfornetsuite/integrations/jira_example_impact_analysis.png)
...
The [Dependency Relationship Diagram](/docs/strongpointforsalesforce/tools/viewing_drd.md) (DRD) tool graphically displays your Customizations and all dependencies.
...
![Use the DRD to explore dependencies](/img/product_docs/strongpointforsalesforce/integrations/jira_example_drd.png)
...
4. Click the __Go To Record__ link to view the Change Request.
   ...
   ![Change Request is In Progress / Pending Approval](/img/product_docs/strongpointforsalesforce/integrations/jira_example_pending_approval_change_request.png)
...
- __External last Modified by__: is the last user who modified the Jira ticket.
  ...
  ![user_guide_example](/img/product_docs/strongpointforsalesforce/integrations/user_guide_example.png)
