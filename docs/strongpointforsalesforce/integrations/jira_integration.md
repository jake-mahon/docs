...
You can map custom fields between Change Requests and Jira. Refer to [Jira Field Mapping](/docs/product_docs/strongpointforsalesforce/integrations/jira_field_map.md) for details.
...
3. Search for __Strongpoint__.
   ...
   ![Strongpoint apps in the Jira Marketplace](/static/img/product_docs/strongpointforsalesforce/integrations/jira_marketplace.png)
...
2. Open the Connected App:  
   ...
   ![Open the Strongpoint Connected App](/static/img/product_docs/strongpointforsalesforce/integrations/connected_app.png)
...
7. Click __Manage Consumer Details__.
   ...
   ![Click Manage Consumer Details](/static/img/product_docs/strongpointforsalesforce/integrations/manage_consumer_details.png)
...
1. Open a Jira project.
   ...
   ![Open a project](/static/img/product_docs/strongpointforsalesforce/integrations/jira_restrict_access1.png)
...
3. Select the __Profile Visability Settings__ tab. There are two lists:   
   ...
   ![Profile Visibility Settings](/static/img/product_docs/strongpointforsalesforce/integrations/profile_visability1.png)
...
__Next Step:__ [Jira Walkthrough Example](/docs/product_docs/strongpointforsalesforce/integrations/jira_walkthrough_example.md)
