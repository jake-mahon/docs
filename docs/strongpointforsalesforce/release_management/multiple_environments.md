...
1. Open __Change Requests__ and locate the completed change request to push/pull.
   ...
   ![Open Completed Change Request](/static/img/product_docs/strongpointforsalesforce/release_management/push_pullcr-1.png)
2. Edit the change request and add all necessary details.

   ![Edit the Change Request](/static/img/product_docs/strongpointforsalesforce/release_management/push_pull_cr.png)
...
5. Add your __Credentials__.
   ...
   ![Enter Credentials](/static/img/product_docs/strongpointforsalesforce/release_management/push_pull_popup.png)
...
2. Click on __Get Change Requests__
   ...
   ![pullcr](/static/img/product_docs/strongpointforsalesforce/release_management/pullcr.png)
3. Add the change requests you want to pull from the selected environment.

   ![pullchangerequest](/static/img/product_docs/strongpointforsalesforce/release_management/pullchangerequest.png)
