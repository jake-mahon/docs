...
These guidelines assume you set up your List Views the same way as described [Step 1: Identify and Prioritize Targets](/docs/product_docs/strongpointforsalesforce/tech_debt/tech_debt_org_clean_up_example.md).
...
__Next Technical Debt Topic:__ [Ongoing Monitoring ](/docs/product_docs/strongpointforsalesforce/tech_debt/tech_debt_org_ongoing_monitoring.md)
