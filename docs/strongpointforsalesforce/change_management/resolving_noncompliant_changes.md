...
The Non-Compliant Changes Report gives you a list of the [Change Logs](/docs/strongpointforsalesforce/change_management/using_change_logs.md). You
...
1. Create a New [Change Request](/docs/strongpointforsalesforce/change_management/creating_change_request.md) or open an existing one.
