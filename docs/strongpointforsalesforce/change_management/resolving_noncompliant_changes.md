...
The Non-Compliant Changes Report gives you a list of the [Change Logs](using_change_logs.md). You can filter the report or sort by the column heads.

![Non-Compliant Change Management Report](../../../static/img/product_docs/strongpointfornetsuite/change_management/changelog-1.webp)
