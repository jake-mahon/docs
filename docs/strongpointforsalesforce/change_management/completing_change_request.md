...
4. Run __Netwrix Dashboard__ > __Tools__ > __Environment Comparison__. Validate the changes are what you expected. Refer to [Comparing Environments](/docs/strongpointforsalesforce/tools/environment_comparison.md) for details.
