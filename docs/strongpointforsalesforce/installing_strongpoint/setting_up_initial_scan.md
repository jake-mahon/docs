...
[Configuration and Stats](/docs/strongpointforsalesforce/installing_strongpoint/config_and_stats.md) page for the sandbox.
...
**Next Step:** [Run the Scanner](/docs/strongpointforsalesforce/installing_strongpoint/running_scanner.md)
