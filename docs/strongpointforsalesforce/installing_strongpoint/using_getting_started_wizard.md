...
The Getting Started Wizard helps you set up Platform Governance for Salesforce after you have done the [basic installation](/docs/product_docs/strongpointforsalesforce/installing_strongpoint/installing_strongpoint.md) and configuration.
...
![getting_started_wizard2](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/getting_started_wizard2.png)
...
![getting_started_wizard3](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/getting_started_wizard3.png)
...
![Testing the connection](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/getting_started_wizard10.png)

1. Open Salesforce __Setup__ > __Security__ > __Remote Site Settings__.
2. Click __New Remote Site__.

   ![New Remote Site](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/getting_started_new_rss.png)
...
__Next Step:__ [Set Up the Initial Scan](/docs/product_docs/strongpointforsalesforce/installing_strongpoint/setting_up_initial_scan.md)
