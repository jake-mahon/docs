...
![Configuration and Stats report](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/config_stats_overview.png)
...
![Configuration and Stats - Documentation Stats](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/config_doc_stats.png)
...
![Configuration and Stats - Scanner Logs](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/config_scanner_logs.png)
...
![Configuration and Stas - Scanner Additional Information](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/config_scan_add_info.png)
...
![Control Change Log Creation in Sandbox](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/config_stats_enable_change_log.png)
...
- [Jira Field Mapping](/docs/product_docs/strongpointforsalesforce/integrations/jira_field_map.md) (separate topic)
...
2. Open the __Jira Configuration__ tab. It opens on the __Credentials__ tab.
   ...
   ![Open the credentials](/static/img/product_docs/strongpointforsalesforce/integrations/jira_sp_credentials.png)
...
3. Open the __Status Mapping__ tab.
   ...
   ![Set up the Jira status mappings for Change Request status](/static/img/product_docs/strongpointforsalesforce/integrations/jira_status_settings.png)
...
2. Open the __Orgs__ Credentials tab.
   ...
   ![Orgs Credentials](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/orgs_credentials.png)
3. Click __New__ to enter new credentials. For existing credentials, you can click __Edit__ to modify the credential, __Delete__ to remove it, or the __credential name__ to sync your credentials.
   ...
   ![New org credentials](/static/img/product_docs/strongpointforsalesforce/installing_strongpoint/orgs_credentials_new.png)
4. Click __Save__.
