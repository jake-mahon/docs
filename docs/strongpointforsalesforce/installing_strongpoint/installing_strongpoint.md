...
3. Click __Install__
![install1](/img/product_docs/strongpointforsalesforce/installing_strongpoint/install1.jpg)
...
__Next Step:__ [Using the Getting Started Wizard](/docs/strongpointforsalesforce/installing_strongpoint/using_getting_started_wizard.md)
