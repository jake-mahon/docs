...
![improvementtab](/static/img/product_docs/strongpointforsalesforce/clean_up/improvementtab.png)
...
5. Select fields to display:
   ...
   ![createlist_view_for_cleanup](/static/img/product_docs/strongpointforsalesforce/clean_up/createlist_view_for_cleanup.png)
...
8. Once your list view has been created, you can multi-select customizations for clean up by checking the box beside __Action__.
   ...
   ![multi_select_cleanup](/static/img/product_docs/strongpointforsalesforce/clean_up/multi_select_cleanup.png)
...
13. Click __Save__.
    ...
    ![flagging_mass_customizations](/static/img/product_docs/strongpointforsalesforce/clean_up/flagging_mass_customizations.png)
