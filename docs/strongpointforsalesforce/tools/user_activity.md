...
The User Login Activity feature is available with the Intelligent Change Enablement and Enterprise Compliance [licenses](../installing_strongpoint/features_by_license_type.md).
...
There is a collapsible menu pane available. Click the u arrow on the left to expand/collapse the menu. Refer to [Package Usage](package_usage.md) for details on the Package Usage tool.
