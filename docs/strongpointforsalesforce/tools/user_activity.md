...
Compliance [licenses](/docs/strongpointforsalesforce/installing_strongpoint/features_by_license_type.md).
...
menu. Refer to [Package Usage](/docs/strongpointforsalesforce/tools/package_usage.md) for details on the Package Usage tool.
