...
accounts. An [Environment Compare Log](../reports/deployment_logs_environment_compare.md) is
...
1. Open the **Export Attachments** tab. Change the Export Attachments from **Recently Viewed** to
   **All** if necessary to see your report. Refer to
   [Export Object Attachment](export_object_attachment_records.md) for details on adding the tab to
