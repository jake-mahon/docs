...
2. Open the **Users** tab.
    ...
    ![export_users](/img/product_docs/strongpointforsalesforce/tools/export_users.webp)
...
![export_users_summary](/img/product_docs/strongpointforsalesforce/tools/export_users_summary.webp)

The **User** tabs contain all of the requested information for each exported user.

![export_users_user](/img/product_docs/strongpointforsalesforce/tools/export_users_user.webp)
