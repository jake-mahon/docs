...
When an [Environment Comparison](/docs/strongpointforsalesforce/tools/environment_comparison.md) is run, or [Object](/docs/strongpointforsalesforce/tools/export_objects.md),
[Profile](/docs/strongpointforsalesforce/tools/export_profiles.md) or [User](/docs/strongpointforsalesforce/tools/export_profiles.md) information is exported, an **Export
