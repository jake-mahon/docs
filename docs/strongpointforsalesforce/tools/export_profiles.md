...
2. Open the __Profiles & Permission Sets__ tab.
   ...
   ![export_profile_ui](/img/product_docs/strongpointforsalesforce/tools/export_profile_ui.png)
...
![export_profile_profile](/img/product_docs/strongpointforsalesforce/tools/export_profile_profile.png)
