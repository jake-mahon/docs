...
The Package Usage tool provides administrators real-time insights into the usage and allocation of additional product licenses across the organization. This tool enables them to identify potential cost savings. Used in conjunction with the existing [User Activity](/docs/product_docs/strongpointforsalesforce/tools/user_activity.md) tool, it provides a comprehensive overview of who is accessing the environment and for what purpose.

The Package Usage tool is available with the Intelligent Change Enablement and Enterprise Compliance [licenses](/docs/product_docs/strongpointforsalesforce/installing_strongpoint/features_by_license_type.md).
...
3. Click __Package Usage Tool__ in the menu.
   ...
   ![Package Usage tool](/static/img/product_docs/strongpointforsalesforce/tools/package_usage.png)
