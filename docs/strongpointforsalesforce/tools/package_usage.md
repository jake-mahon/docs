...
cost savings. Used in conjunction with the existing [User Activity](/docs/strongpointforsalesforce/tools/user_activity.md) tool, it
...
[licenses](/docs/strongpointforsalesforce/installing_strongpoint/features_by_license_type.md).
