...
Checklist Item 2: [Provision ONTAP Account](/docs/product_docs/activitymonitor/config/netappcmode/provisionactivity.md)
...
Checklist Item 3: [Configure Network](/docs/product_docs/activitymonitor/config/netappcmode/configurefirewall.md)
...
Checklist Item 4: [Configure FPolicy](/docs/product_docs/activitymonitor/config/netappcmode/configurefpolicy.md)
