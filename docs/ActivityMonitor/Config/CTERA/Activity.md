...
![Monitoring Process -CTERA Portal](/img/activitymonitor/config/ctera/CteraSyslogMsg.png "Monitoring Process -CTERA Portal")
...
Ensure the [Enable the Messaging Service](#enable-the-messaging-service "Enable the Messaging Service") section is completed before proceeding to enable the Syslog Service.
