...
- See the [Install & Configure Dell CEE](InstallCEE.md "Install & Configure EMC CEE") topic for instructions.

Checklist Item 3: Dell Device Configuration

- Configure the `cepp.conf` file on the Celerra VNX Cluster
- See the [Connect Data Movers to the Dell CEE Server](InstallCEE.md#connect-data-movers-to-the-dell-cee-server "Connect Data Movers to the EMC CEE Server") topic for instructions.
