...
- See the [Install & Configure Dell CEE](/docs/product_docs/activitymonitor/config/dellcelerravnx/installcee.md) topic for instructions.

Checklist Item 3: Dell Device Configuration

- Configure the ```cepp.conf``` file on the Celerra VNX Cluster
- See the [Connect Data Movers to the Dell CEE Server](/docs/product_docs/activitymonitor/config/dellcelerravnx/installcee.md#Connect-Data-Movers-to-the-Dell-CEE-Server) topic for instructions.
