...
Checklist Item 1: [Configure Audit Logs on HNAS](ConfigureLogs.md "Configure Audit Logs on HNAS")

Checklist Item 2: [Configure Access to HNAS Audit Logs on Activity Agent Server](ConfigureAccessToLogs.md "Configure Access to HNAS Audit Logs on Activity Agent Server")
