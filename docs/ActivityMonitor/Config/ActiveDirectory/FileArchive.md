...
Access Analyzer requires additional configurations in order to collect domain activity data. Follow the steps to configure the **`AD_ActivityCollection`** Job.
...
![Active Directory Activity DC wizard Category page](/img/activitymonitor/config/activedirectory/CategoryImportFromShare.png "Active Directory Activity DC wizard Category page")
