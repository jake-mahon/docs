...
See the [File Archive Repository Option](/docs/product_docs/activitymonitor/config/activedirectory/filearchive.md) topic for additional information on that option.
