...
See the [File Archive Repository Option](FileArchive.md "File Archive Repository Option") topic for additional information on that option.
...
**Step 1 –** Navigate to the **Jobs** \> **Active Directory** \> **6.Activity** \> **0.Collection** \> **`AD_ActivityCollection`** Job. Select the **Configure** \> **Queries** node.
...
![Active Directory Activity DC wizard Category page](/img/activitymonitor/config/activedirectory/CategoryImportFromNAM.png "Active Directory Activity DC wizard Category page")
...
![Active Directory Activity DC wizard Scoping and Retention page](/img/activitymonitor/config/activedirectory/Scope.png "Active Directory Activity DC wizard Scoping and Retention page")
...
**Step 1 –** Navigate to the **Jobs** \> **Active Directory** \> **6.Activity** \> **0.Collection** \> **`AD_ActivityCollection`** Job.
