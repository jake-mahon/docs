...
![](/img/activitymonitor/config/dellcelerravnx/RegistryEditorEndpoint.png)
...
If this is configured correctly, validate that the Dell CEE services are running. See the [Validate Dell CEE Services are Running](#validate-dell-cee-services-are-running "Validate Dell CEE Services are Running") topic for additional information.
