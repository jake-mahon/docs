...
After installation, open MS-RPC ports between the Dell device and the Dell CEE server. See the [Dell CEE Debug Logs](Validate.md#dell-cee-debug-logs "Dell CEE Debug Logs") section for information on troubleshooting issues related to Dell CEE.
