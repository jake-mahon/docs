...
See the [Enable Auditing for Exchange Online](#enable-auditing-for-exchange-online "Enable Auditing for Exchange Online") topic for additional information.
...
This is needed for adding a Exchange Online host in the Activity Monitor. See the [Exchange Online](/Admin/MonitoredHosts/Add/ExchangeOnline.md "Exchange Online") topic for additional information. Next identify the Tenant ID.
...
This is needed for adding a Exchange Online host in the Activity Monitor. See the [Exchange Online](/Admin/MonitoredHosts/Add/ExchangeOnline.md "Exchange Online") topic for additional information. Next identify the Tenant ID. Next generate the application’s Client Secret Key.
...
This is needed for adding a Exchange Online host in the Activity Monitor. See the [Exchange Online](/Admin/MonitoredHosts/Add/ExchangeOnline.md "Exchange Online") topic for additional information.
