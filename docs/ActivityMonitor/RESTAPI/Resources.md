...
- Agent –
  ...
  See the [Agent](Agent.md "Agent") topic for additional information.
...
- Host
  ...
  Children: Output  
  See the [Host](Host.md "Host") topic for additional information.

- Domain –
  Children: Output, Agent  
  See the [Domain](Domain.md "Domain") topic for additional information.
...
- Output
  ...
  See the [Output](Output.md "Output") topic for additional information.
