...
![Activity Monitor with location of trace logs](/img/activitymonitor/troubleshooting/TraceLogs.png "Activity Monitor with location of trace logs")
...
**NOTE:** Trace level can be adjusted in the Agent Properties for the selected agent. See the [Archiving Tab](/Admin/Agents/Properties/Archiving.md "Archiving Tab") topic for additional information.

![Collect Logs button](/img/activitymonitor/troubleshooting/CollectLogsbutton.png "Collect Logs button")
...
![Copying the log files popup window](/img/activitymonitor/troubleshooting/CollectLogswindow.png "Copying the log files popup window")
