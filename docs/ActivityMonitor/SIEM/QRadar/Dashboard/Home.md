...
![](/img/activitymonitor/siem/HomeDashboard.png "Home Dashboard for Stealthbits Activivty Monitor App for QRadar")
...
- Open Offenses – Number of ransomware offenses detected within QRadar from the file activity event data
  ...
  - The value for this card is a hyperlink to the [Ransomware Dashboard](Ransomware.md "Ransomware Dashboard").
