...
The purpose of this chapter is to provide the basic steps needed for upgrading Activity Monitor. Netwrix provides an updated Activity Monitor Console and agents through the Support site. Updates are issued as needed for improvements and to correct problems. See the [Software Compatibility & Versions](/ActivityMonitor/Install/Overview#software-compatibility--versions) section for information on integration with other Netwrix products.
...
**Step 1 –** Install the Activity Monitor 8.0 on the same machine where the V7.1 console resides following the instructions in the [Install Application](Application.md "Install Application") section.
