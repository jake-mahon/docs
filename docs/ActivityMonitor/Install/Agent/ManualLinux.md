...
![pscp Command](/img/activitymonitor/install/Screen1.png "pscp Command")
...
![Generate the Activity Monitor Agent Client Certificate](/img/activitymonitor/install/Screen3.png "Generate the Activity Monitor Agent Client Certificate")
...
Before deploying the Activity agent in a Linux environment, ensure all Prerequisites have been met. To effectively monitor activity on a Linux host, it is necessary to deploy an agent to the host. Follow the steps to deploy the agent to the Linux host. See the [Linux Agent Server Requirements](/Requirements/LinuxAgent.md "Linux Agent Server Requirements") topic for additional information.
...
![Install New Agent](/img/activitymonitor/install/InstallNew_1.png "Install New Agent")
...
![Specify Agent Port](/img/activitymonitor/install/SpecifyAgentPort.png "Specify Agent Port")

**Step 4 –** Specify the port to be used for the agent. Click **Next**.

![Credentials to Connect to Server.](/img/activitymonitor/install/Credentials.png "Credentials to Connect to Server.")
...
![Linux Agent Options](/img/activitymonitor/install/LinuxAgentOptions.png "Linux Agent Options")
...
![Server Properties](/img/activitymonitor/install/properties.png "Server Properties")