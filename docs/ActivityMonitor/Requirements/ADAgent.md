...
![](/img/activitymonitor/requirements/NAM_ADModule.png)
...
![](/img/activitymonitor/requirements/NTP.png)
...
See the [Active Directory Activity Auditing Configuration](/Config/ActiveDirectory/Activity.md "Active Directory Activity Auditing Configuration") topic for target environment requirements.
