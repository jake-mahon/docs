...
![Overview Dashboard for Stealthbits Activivty Monitor App for Splunk](/static/img/product_docs/activitymonitor/activitymonitor/siem/splunk/dashboard/overviewdashboard.png)
