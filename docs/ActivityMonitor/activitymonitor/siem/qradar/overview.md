...
The File Activity Monitor tab will appear within QRadar. It is necessary for the QRadar SEC token to be saved to the Settings interface of the __File Activity Monitor__ App. See the [Settings](/docs/product_docs/activitymonitor/activitymonitor/siem/qradar/settings.md) topic for additional information.
