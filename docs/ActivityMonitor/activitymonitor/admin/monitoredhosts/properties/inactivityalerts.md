...
![inactivityalertstab](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/inactivityalertstab.png)
...
![Syslog Alerts Tab](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/syslogalertstab.png)
...
- Syslog message template – Click the ellipsis (…) to open the Syslog Message Template window. The following Syslog templates have been provided:
  ...
  - Splunk – Use this template for Splunk integration. See the [File Activity Monitor App for Splunk](/docs/product_docs/activitymonitor/activitymonitor/siem/splunk/overview.md) section for additional information.
...
![Email Alerts Tab](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/emailalertstab.png)
