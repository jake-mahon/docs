...
Prior to adding a NetApp Data ONTAP host to the Activity Monitor, the prerequisites for the target environment must be met. See the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](/docs/product_docs/activitymonitor/config/netappcmode/activity.md) topic or the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/docs/product_docs/activitymonitor/config/netapp7mode/activity.md) topic in the for additional information.
...
![Add New Host - Choose Agent page](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/chooseagent.png)

__Step 2 –__ On the Choose Agent page, select the Agent to monitor the storage device. Click __Next__.

![Add New Host - Add Host page with NetApp selected](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/addhostnetapp.png)
...
![NetApp Host Connection Page](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/netappconnection.png)
...
![Trusted Server Certificate popup window](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/trustedservercertificate.png)
...
![NetApp FPolicy Configuration page](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/netappfpolicyconfiguration.png)
...
![NetApp FPolicy Enable and Connect window](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/netappfpolicyenableconnect.png)
...
![protocolspage](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/protocolspage.png)
...
![Configure Operations window for NetApp](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/configureoperationsnetapp.png)
...
![Configure Basic Options page for NetApp](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/configurebasicoptionsnetapp.png)
...
![Activity Monitor with NetApp Host added](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/activitymonitornetapp.png)

The added NetApp host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/docs/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/output.md) topic for additional information.
...
![NetApp Host Properties FPolicy Tab](/static/img/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/add/netappfpolicytab.png)
...
For information on the other options for this tab, see the [FPolicy Tab](/docs/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/fpolicy.md) section.
...
- [NetApp Tab](/docs/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/netapp.md)
- [FPolicy Tab](/docs/product_docs/activitymonitor/activitymonitor/admin/monitoredhosts/properties/fpolicy.md)
