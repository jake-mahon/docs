...
Select a Syslog output from either the Monitored Domains tab or the Monitored Hosts tab and click __Edit__ to open the output Properties window. The tab varies based on the type of domain/host selected.

## For Active Directory Domains

The tab contains the following settings:

![syslogactivedirectory](/static/img/product_docs/activitymonitor/activitymonitor/admin/outputs/syslogactivedirectory.png)
...
- Syslog message template – Template that controls what data is sent in the event stream. The ellipsis (…) button opens the Syslog Message Template window. See the [Message Template Window](/docs/product_docs/activitymonitor/activitymonitor/admin/outputs/window/messagetemplate.md) topic for additional information.
...
![sysloglinux](/static/img/product_docs/activitymonitor/activitymonitor/admin/outputs/sysloglinux.png)
...
![syslogentraid](/static/img/product_docs/activitymonitor/activitymonitor/admin/outputs/syslogentraid.png)
...
![syslognas](/static/img/product_docs/activitymonitor/activitymonitor/admin/outputs/syslognas.png)
...
![syslogwindows](/static/img/product_docs/activitymonitor/activitymonitor/admin/outputs/syslogwindows.png)
