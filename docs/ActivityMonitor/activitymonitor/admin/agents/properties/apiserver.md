...
![API Server Tab for Agent Properties](/static/img/product_docs/activitymonitor/activitymonitor/admin/agents/properties/apiservertab.png)
...
![Add or Edit API Client popup window](/static/img/product_docs/activitymonitor/activitymonitor/admin/agents/properties/addoreditapiclient.png)
