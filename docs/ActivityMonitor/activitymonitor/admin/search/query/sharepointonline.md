...
![SharePoint Online - Search Quary Bar](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/sharepointonlinesearchquerybar.png)
...
![SharePoint Online Search - General Filters](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/generalfilters.png)
...
![SharePoint Online Search - User Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/user.png)
...
![SharePoint Online Search - Location Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/location.png)
...
![SharePoint Online Search - Item Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/item.png)
...
![SharePoint Online Search - Sharing Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/sharing.png)
...
![SharePoint Online Search - DLP Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/dlp.png)
...
![SharePoint Online Search - Custom Filter](/static/img/product_docs/activitymonitor/activitymonitor/admin/search/query/custom.png)
