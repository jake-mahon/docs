...
| SourceName | The name of the application that caused the event | |
| RawEventData | A String that holds XML markup providing data that is specific to the type of event that the entry object represents. | `06C49477-0498-4858-900C-45B595337462 MyDocs/myfile.zip </RelatedItem>` |
