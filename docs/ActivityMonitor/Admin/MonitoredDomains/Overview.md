...
![Monitored Domains Tab in the Activiy Monitor](/img/activitymonitor/admin/ActivtyMonitorBlank.png "Monitored Domains Tab in the Activiy Monitor")

- Add Output – Select an output from the Add Output dropdown. The outputs are: File, Syslog, and StealthDEFEND. See the [Output for Monitored Domains](Output.md "Output for Monitored Domains")
...
![Monitored Domains Tab with Domain Outputs added](/img/activitymonitor/admin/ActiivtyMonitorDomainOutputsAdded.png)
...
![Error Propagation](/img/activitymonitor/admin/ErrorPropagation.png "Error Propagation")
