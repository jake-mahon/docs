...
![AD Monitoring Configuration - Authentication Tab](/img/activitymonitor/admin/OperationsTab.png "AD Monitoring Configuration - Authentication Tab")
...
![AD Monitoring Configuration - Authentication Tab](/img/activitymonitor/admin/ForgedPAC.png "AD Monitoring Configuration - Authentication Tab")
...
![Host (From) Tab in the Authentication Tab](/img/activitymonitor/admin/HostFrom.png "Host (From) Tab in the Authentication Tab")
...
![Host (To) Tab in the Authentication Tab](/img/activitymonitor/admin/HostTo.png "Host (To) Tab in the Authentication Tab")
...
![IP Addresses (From) Tab in the Authenticatoin Tab](/img/activitymonitor/admin/IPAddressesFrom.png "IP Addresses (From) Tab in the Authenticatoin Tab")
...
![IP Addresses (To) Tab in the Authentication Tab](/img/activitymonitor/admin/IPAddressesTo.png "IP Addresses (To) Tab in the Authentication Tab")
...
![Operations Tab in the Authentication Tab](/img/activitymonitor/admin/OperationsTab.png)
...
![Servers Tab in the Authentication Tab](/img/activitymonitor/admin/ServersTab.png "Servers Tab in the Authentication Tab")
...
![Users Tab in the Authentication Tab](/img/activitymonitor/admin/UsersTab.png)
