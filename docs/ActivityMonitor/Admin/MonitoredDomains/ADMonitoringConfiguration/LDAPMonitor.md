...
![Operations Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/Operations.png "Operations Tab in the LDAP Monitor Tab")
...
![Host (From) Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/HostFrom_2.png "Host (From) Tab in the LDAP Monitor Tab")
...
![LDAP Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/LDAP.png "LDAP Tab in the LDAP Monitor Tab")
...
![Operations Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/Operations.png)
...
![Servers Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/Servers.png "Servers Tab in the LDAP Monitor Tab")
...
![Users Tab in the LDAP Monitor Tab](/img/activitymonitor/admin/Users.png "Users Tab in the LDAP Monitor Tab")
