...
![Servers Tab in the Replication Tab](/img/activitymonitor/admin/ServersTab_2.png)
...
![Host (From) Tab in the Replication Tab](/img/activitymonitor/admin/HostFrom_3.png)
...
![Users Tab in the Replication Tab](/img/activitymonitor/admin/UsersTab_3.png)
