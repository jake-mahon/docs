...
![SharePoint New Search Tab](/img/activitymonitor/admin/SharePointNewSearchTab.png "SharePoint New Search Tab")
...
![General Category - SharePoint](/img/activitymonitor/admin/GeneralFilters_2.png "General Category - SharePoint")
...
![SharePoint Search - Audit filter section](/img/activitymonitor/admin/AuditMask.png "SharePoint Search - Audit filter section")
...
![SharePoint Search Query - Move/Delete/Copy/Checkin Filters](/img/activitymonitor/admin/MoveDeleteCopyCheckinFilters.png "SharePoint Search Query - Move/Delete/Copy/Checkin Filters")
...
![SharePoint Search Query - Delete FIlters](/img/activitymonitor/admin/Delete.png "SharePoint Search Query - Delete FIlters")
...
![SharePoint Search Query - Search Filters](/img/activitymonitor/admin/SearchFilters.png "SharePoint Search Query - Search Filters")
...
![SharePoint Search Query - Permissions Filters](/img/activitymonitor/admin/PermissionsFilters.png "SharePoint Search Query - Permissions Filters")
