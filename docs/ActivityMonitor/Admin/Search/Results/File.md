...
![File Search Results UI](/img/activitymonitor/admin/FileSearchResults.png)
...
![Search Results with Permissions listed in the Operations Column](/img/activitymonitor/admin/FileSearchResultsPermissionsImage.png)
...
![File Search Results Permissions link popup window](/img/activitymonitor/admin/PermissionsLPopupWindow.png)
