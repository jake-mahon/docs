...
- Dell Unity
- Hitachi
- Linux – Configuration of a Linux host is done during agent deployment. See the [Linux Agent Deployment](/Admin/Agents/Add/Linux.md "Linux Agent Deployment") topic for additional information.
- Nasuni
- NetApp
- Nutanix
- Panzura
...
See the [Add New Host Window](Add/Overview.md "Add New Host Window") topic for additional information.
...
![Activity Monitor with Monitored Hosts tab identified](/img/activitymonitor/admin/MonitoredHostsTab.png)
...
![](/img/activitymonitor/admin/ErrorPropogationPopulated.png)
