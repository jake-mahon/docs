...
Prior to adding a Panzura host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Panzura CloudFS Monitoring](/Config/Panzura/Activity.md "Panzura Activity Auditing Configuration") topic for additional information.
...
![Add Host](/img/activitymonitor/admin/AddHostPanzura.png "Add Host")

**Step 3 –** On the Add Host page, select the **Panzura** radio button and enter the **Panzura filer name**. Click **Next**.

![Panzura Properties](/img/activitymonitor/admin/PanzuraOptions.png "Panzura Properties")
...
![Customize Certifiacte Verification](/img/activitymonitor/admin/TrustedServerCertificate.png "Customize Certifiacte Verification")
...
![Configure Operations](/img/activitymonitor/admin/PanzuraConfigureOperations.png "Configure Operations")
...
![](/img/activitymonitor/admin/ConfigureBasicOptionsPanzura.png)
...
![](/img/activitymonitor/admin/FileOutput_2.png)
...
![](/img/activitymonitor/admin/ActivityMonitorPanzura.png)

The added Panzura host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.

## Host Properties for Panzura

- [Panzura Tab](/Admin/MonitoredHosts/Properties/Panzura.md "Panzura Tab")
