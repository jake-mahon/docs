...
Prior to adding aMicrosoft Entra ID host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Microsoft Entra ID Activity Auditing Configuration](/Config/EntraID/Activity.md "Entra ID Activity Auditing Configuration") topic for additional information.
...
![Add Host page](/img/activitymonitor/admin/AddHostEntraID.png "Add Host page")
...
![](/img/activitymonitor/admin/EntraIDConnection.png)
...
![Add Host - Azure AD Operations page](/img/activitymonitor/admin/EntraIDOperations.png)
...
![](/img/activitymonitor/admin/FileOutputPage_1.png)
...
![Azure Active Directory in Activity Monitor](/img/activitymonitor/admin/EntraIDadded.png "Azure Active Directory in Activity Monitor")

The added Microsoft Entra ID host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.
