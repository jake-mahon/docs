...
![Add Dell VNX or Celerra Host](/img/activitymonitor/admin/AddHostEMCVNXCelerra.png "Add Dell VNX or Celerra Host")
...
![Protocol Monitoring Options](/img/activitymonitor/admin/IsilonProtocols.png "Protocol Monitoring Options")
...
![](/img/activitymonitor/admin/ActivityMonitorEMCVNXCelerra.png)

The added Dell Celerra or VNX host is displayed in the Monitored Hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.
