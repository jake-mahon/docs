...
Prior to adding a Windows host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Windows File Server Activity Auditing Configuration](/Config/WindowsFile/Activity.md "Windows File Server Activity Auditing Configuration") topic for additional information.
...
![Add Host page with Windows selected](/img/activitymonitor/admin/AddHostWindows.png "Add Host page with Windows selected")
...
![Protocols page](/img/activitymonitor/admin/ProtocolsPage_1.png "Protocols page")
...
![Configure Operations page for Windows host](/img/activitymonitor/admin/ConfigureOperationsWindows.png)
...
![Configure Basic Options page for Windows](/img/activitymonitor/admin/ConfigureBasicOptionsWindows.png "Configure Basic Options page for Windows")
...
![Where to log activity page](/img/activitymonitor/admin/WhereToLogGeneric.png "Where to log activity page")
...
![File Output page](/img/activitymonitor/admin/FileOuputPage.png "File Output page")
...
![Activity Monitor with Windows Host added](/img/activitymonitor/admin/ActivityMonitorWindows.png "Activity Monitor with Windows Host added")

The added Windows file server host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.

## Host Properties for Windows File Server

- [Windows Tab](/Admin/MonitoredHosts/Properties/Windows.md)
