...
Prior to adding a Dell Unity host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Dell Unity Activity Auditing Configuration](/Config/DellUnity/Activity.md "Dell Unity Activity Auditing Configuration") topic for additional information.
...
![Choose Agent window](/img/activitymonitor/admin/ChooseAgent.png)

**Step 2 –** On the Choose Agent page, select the **Agent** to monitor the storage device.

![Add Host window with Dell Unity selected](/img/activitymonitor/admin/AddNewHostEMCUnity.png "Add Host window with Dell Unity selected")
...
![Protocol Monitoring Page](/img/activitymonitor/admin/IsilonProtocols.png "Protocol Monitoring Page")
...
![Configure Basic Options Page](/img/activitymonitor/admin/ConfigureBasicOptions.png "Configure Basic Options Page")
...
![Activity Monitor with Dell Unity host added](/img/activitymonitor/admin/ActivityMonitorEMCUnity.png "Activity Monitor with Dell Unity host added")

The added Dell Unity host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.
