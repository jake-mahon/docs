...
Prior to adding a Dell Isilon/PowerScale host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Dell Isilon/PowerScale Activity Auditing Configuration](/Config/DellPowerScale/Activity.md "Dell Isilon/PowerScale Activity Auditing Configuration") topic for additional information.
...
![Add Host page with Dell Isilon selected](/img/activitymonitor/admin/AddHostEMCIsilon.png "Add Host page with Dell Isilon selected")
...
![Isilon Options page](/img/activitymonitor/admin/IsilonOptions.png "Isilon Options page")
...
![Protocols selection page](/img/activitymonitor/admin/IsilonProtocols.png "Protocols selection page")
...
![Configure Operations page](/img/activitymonitor/admin/ConfigureOperationsforEMCIsilon.png "Configure Operations page")
...
![Configure Basic Options](/img/activitymonitor/admin/ConfigureBasicOptions.png "Configure Basic Options")
...
![Where to Log the Activity Page Generic](/img/activitymonitor/admin/WhereToLogGeneric.png "Where to Log the Activity Page Generic")
...
![File Output Page](/img/activitymonitor/admin/FileOutputPage.png "File Output Page")
...
![Activity Monitor with Dell Isilon added](/img/activitymonitor/admin/ActivityMonitorEMCIsilon.png "Activity Monitor with Dell Isilon added")

The added Dell Isilon/PowerScale host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.

## Host Properties for Dell Isilon/PowerScale

- [Dell Tab](/Admin/MonitoredHosts/Properties/Dell.md "Dell Tab")
- [Auditing Tab](/Admin/MonitoredHosts/Properties/Auditing.md "Auditing Tab")
