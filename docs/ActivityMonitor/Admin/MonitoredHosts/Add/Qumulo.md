...
Prior to adding a Qumulo host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Qumulo Activity Auditing Configuration](/Config/Qumulo/Activity.md "Qumulo Activity Auditing Configuration") topic for additional information.
...
![](/img/activitymonitor/admin/NutanixOptions_07.png)
...
![](/img/activitymonitor/admin/AddHostQumulo04.png)
...
![](/img/activitymonitor/admin/NutanixOptions_09.png)
...
![](/img/activitymonitor/admin/AddHostQumulo06.png)

The added Qumulo host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.

## Host Properties for Qumulo

- [Qumulo Tab](/Admin/MonitoredHosts/Properties/Qumulo.md "Qumulo Tab")
