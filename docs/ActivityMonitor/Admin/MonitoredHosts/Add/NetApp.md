...
Prior to adding a NetApp Data ONTAP host to the Activity Monitor, the prerequisites for the target environment must be met. See the [NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration](/Config/NetAppCMode/Activity.md "NetApp Data ONTAP Cluster-Mode Activity Auditing Configuration") topic or the [NetApp Data ONTAP 7-Mode Activity Auditing Configuration](/Config/NetApp7Mode/Activity.md "NetApp Data ONTAP 7-Mode Activity Auditing Configuration") topic in the for additional information.
...
![Add New Host - Choose Agent page](/img/activitymonitor/admin/ChooseAgent.png)

**Step 2 –** On the Choose Agent page, select the Agent to monitor the storage device. Click **Next**.

![Add New Host - Add Host page with NetApp selected](/img/activitymonitor/admin/AddHostNetApp.png)
...
![NetApp Host Connection Page](/img/activitymonitor/admin/NetAppConnection.png "NetApp Host Connection Page")
...
![Trusted Server Certificate popup window](/img/activitymonitor/admin/TrustedServerCertificate.png)
...
![NetApp FPolicy Configuration page](/img/activitymonitor/admin/NetAppFPolicyConfiguration.png)
...
If automatic configuration is selected, proceed to the [Configure Privileged Access](#configure-privileged-access "Navigates to the Configure Privileged Access section") section after successfully adding the host.

![NetApp FPolicy Enable and Connect window](/img/activitymonitor/admin/NetAppFPolicyEnableConnect.png)
...
![](/img/activitymonitor/admin/ProtocolsPage.png)
...
![Configure Operations window for NetApp](/img/activitymonitor/admin/ConfigureOperationsNetApp.png)
...
![Configure Basic Options page for NetApp](/img/activitymonitor/admin/ConfigureBasicOptionsNetApp.png)
...
![](/img/activitymonitor/admin/WhereToLogGeneric.png)
...
![](/img/activitymonitor/admin/FileOutput_1.png)
...
![Activity Monitor with NetApp Host added](/img/activitymonitor/admin/ActivityMonitorNetApp.png)

The added NetApp host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.
...
![NetApp Host Properties FPolicy Tab](/img/activitymonitor/admin/NetAppFPolicyTab.png)
...
For information on the other options for this tab, see the [FPolicy Tab](/Admin/MonitoredHosts/Properties/FPolicy.md "Navigates to the FPolicy Tab") section.

## Host Properties for NetApp

- [NetApp Tab](/Admin/MonitoredHosts/Properties/NetApp.md "NetApp Tab")
- [FPolicy Tab](/Admin/MonitoredHosts/Properties/FPolicy.md "FPolicy Tab")
- [Unix IDs Tab](/Admin/MonitoredHosts/Properties/UnixIDs.md "Unix IDs Tab")
