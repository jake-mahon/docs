...
Prior to adding a Nasuni Edge Appliance host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Nasuni Edge Appliance Activity Auditing Configuration](/Config/Nasuni/Activity.md "Nasuni Edge Appliance Activity Auditing Configuration") topic for additional information.
...
![Add Host page with Nasuni selected](/img/activitymonitor/admin/AddHostNasuni.png "Add Host page with Nasuni selected")
...
![Nasuni Options page](/img/activitymonitor/admin/NasuniOptions.png "Nasuni Options page")
...
![Trusted Server Certificate popup window](/img/activitymonitor/admin/TrustedServerCertificate.png "Trusted Server Certificate popup window")
...
![Configure Basic Options page for Nasuni](/img/activitymonitor/admin/ConfigureBasicOptionsNasuni.png "Configure Basic Options page for Nasuni")
...
![File Output Page](/img/activitymonitor/admin/FileOutputPage_3.png "File Output Page")
...
![Activity Monitor with Nasuni host added](/img/activitymonitor/admin/ActivityMonitorNasuni.png "Activity Monitor with Nasuni host added")

The added Nasuni host is displayed in the monitored hosts table. Once a host has been added for monitoring, configure the desired ouptuts. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.

## Host Properties for Nasuni

- [Nasuni Tab](/Admin/MonitoredHosts/Properties/Nasuni.md "Nasuni Tab")
