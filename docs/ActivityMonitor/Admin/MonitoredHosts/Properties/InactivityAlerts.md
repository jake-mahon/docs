...
![](/img/activitymonitor/admin/InactivityAlertsTab.png)
...
![Syslog Alerts Tab](/img/activitymonitor/admin/SyslogAlertsTab.png "Syslog Alerts Tab")
...
- Syslog message template – Click the ellipsis (…) to open the Syslog Message Template window. The following Syslog templates have been provided:
  ...
  - Splunk – Use this template for Splunk integration. See the [File Activity Monitor App for Splunk](/SIEM/Splunk/Overview.md "Stealthbits File Activity Monitor App for Splunk") section for additional information.
...
![Email Alerts Tab](/img/activitymonitor/admin/EmailAlertsTab.png "Email Alerts Tab")
