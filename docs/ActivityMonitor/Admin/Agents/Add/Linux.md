...
Prior to adding a Windows host to the Activity Monitor, the prerequisites for the target environment must be met. See the [Linux Agent Server Requirements](/Requirements/LinuxAgent.md "Linux Agent Server Requirements") topic for additional information.
...
![Install New Agent page of the Add New Agent(s) Wizard](/img/activitymonitor/admin/InstallNew.png "Install New Agent")
...
![Credentials to Connect](/img/activitymonitor/admin/CredentialsServers.png "Credentials to Connect")
...
![Public Key Credentials](/img/activitymonitor/admin/PublicKey.png "Public Key Credentials")
...
![Client Certificate Credentials](/img/activitymonitor/admin/ClientCertificate.png "Client Certificate Credentials")
...
![Linux Agent Options](/img/activitymonitor/admin/LinuxAgentOptions.png "Linux Agent Options")
...
![Linux Agent Installed](/img/activitymonitor/admin/ActivityMonitorwithLinuxAgentInstalled.png "Linux Agent Installed")

When the Linux agent installation is complete, the status changes to **Installed**. The Monitored Host is also configured, and the added Linux host is displayed in the monitored hosts table. See the [Monitored Hosts Tab](/Admin/MonitoredHosts/Overview.md "Monitored Hosts Tab") topic for additional information.

Once a host has been added for monitoring, configure the desired outputs. See the [Output for Monitored Hosts](/Admin/MonitoredHosts/Output.md "Output for Monitored Hosts") topic for additional information.
