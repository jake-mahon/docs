...
![API Server Tab for Agent Properties](/img/activitymonitor/admin/APIServerTab.png)
...
![Add or Edit API Client popup window](/img/activitymonitor/admin/AddorEditAPIClient.png)
