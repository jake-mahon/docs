...
![Archiving Tab for Agent Properties](/img/activitymonitor/admin/Archiving Tab.png)
...
![Popup window for Configure a network share on this computer option](/img/activitymonitor/admin/ArchivingTabConfigure.png)
