...
Flashlight™ by Strongpoint is Salesforce Documentation for Everybody! Easy to install, easy to understand, and based on the award-winning *Strongpoint Documentation Engine*, Flashlight automatically documents everything and maintains the core documentation describing each customization. It helps you make better and faster decisions, keeping your systems clean and optimized.

Flashlight provides your organization these key benefits:

#### Reduce Risk

* Flashlight documents your entire Salesforce org. Answer the question “If I change this, what will break?”
...
* Use the Flashlight [Dashboard](Getting Started/dashboard) and the Dependency Relationship Diagrams to spot problems before they happen and respond to your users more quickly.
...
4. Click on the link. An email is sent to enable you to update your subscription preferences:  
   ![](../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/stylesheet/reSubscribe.png "Resubscribe to receive Release Note notifications.")
