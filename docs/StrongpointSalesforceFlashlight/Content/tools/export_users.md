...
2. Open the **Users** tab.![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/export_users_800x397.png)
...
6. Select the **Settings to be exported**.  
   ![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/export_users_settings.png)
...
The **Summary** tab shows who created the export, the creation date and time, and the list of selected users.![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/export_users_summary_800x252.png)

The **User** tabs contain all of the requested information for each exported user.![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/export_users_user_800x675.png)