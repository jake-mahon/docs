...
Click on the **Customizations** tab to display all the customizations found by the Strongpoint scanner. You can change the view to focus the results. Click the **Customization Name** to open the customization record.
...
The joins between customizations are critical to determine the IT risk of making changes to the system. For example, they warn you if changing a search could break a workflow or a script.![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/drd_800x155.png)
...
![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/stylesheet/topic.png)**Next Step:**[Understanding the Customization Record](understanding_customization_record "Open the Understanding the Customization Record topic")