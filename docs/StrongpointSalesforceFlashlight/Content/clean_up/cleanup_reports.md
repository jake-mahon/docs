...
Strongpoint provides predefined reports to help you clean up your Salesforce Instance. The reports are available by opening **Flashlight** > **Reports/List Views** > **Clean Up** and selecting a report:
...
* **Filters** ![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/filters_icon.png): Open the filters to see the criteria used for the report. You can modify the unlocked filters to narrow the focus of the results.
