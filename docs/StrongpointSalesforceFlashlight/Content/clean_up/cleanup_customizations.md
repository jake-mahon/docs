...
Use these processes to [Clean up Individual Customization](#Clean2) or [Clean Up Multiple Customizations](#Clean).
...
![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/improvementtab_800x415.png)
...
4. Specify the filter criteria:
   ...
   * **Filter By Additional Fields**: choose Salesforce Type equals Report and Record Type equals Report.
...
![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/createlist_view_for_cleanup_800x403.png)6. Restrict Visibility. You can choose to have the list view:
...
![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/multi_select_cleanup_800x382.png)9. You can now choose what you want to edit for the multiple customizations selected.  
...
13. Click **Save**.
![](../../../../static/images/StrongpointSalesforceFlashlight/Content/Resources/Images/flagging_mass_customizations_800x374.png)