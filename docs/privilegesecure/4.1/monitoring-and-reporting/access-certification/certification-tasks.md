...
![addtask](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/auditreporting/add/addtask.webp)
...
- Users – Add users or groups to the access certification task. See the
  [Add Users to Review](/docs/privilegesecure/4.1/monitoring-and-reporting/access-certification/user-certifications.md#add-users-to-review)
