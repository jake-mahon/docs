...
- Blue + button — Create a new role. See the
  [Add Custom Role](/docs/privilegesecure/4.1/administration/users-and-groups/custom-roles.md)
...
[Default Role Details Page](/docs/privilegesecure/4.1/administration/users-and-groups/role-management.md)
and the
...
- Add User — The Add options change based on the selected role:
  ...
  - Administrator — Opens the Add Administrators window. See the
    [Add Administrators Window](/docs/privilegesecure/4.1/administration/users-and-groups/role-management.md)
  ...
  - Users — Opens a list of available user types to add
    ...
    - New Application User — Opens the Add Application page. See the
      [Add Application](/docs/privilegesecure/4.1/administration/applications/application-management.md)
      for additional information.
    - New Local User — Opens the Add Local User page. See
      [Add Local User](/docs/privilegesecure/4.1/administration/users-and-groups/local-users.md)
      topic for additional information.

  - Reviewers — Opens the Add Reviewers window. See the
    [Add Reviewers Window](/docs/privilegesecure/4.1/administration/users-and-groups/role-management.md)
    topic for additional information.
...
![Add Administrators Window](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/window/usersgroups/addadministrators.webp)
...
![Add Role Users Window](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/window/usersgroups/addroleusers.webp)
