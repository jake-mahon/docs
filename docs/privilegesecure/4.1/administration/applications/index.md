...
- Reset MFA — Click the button to force the user to reset MFA for Privilege Secure login. Resetting
  ...
  [Reset User MFA](/docs/privilegesecure/4.1/administration/users-and-groups/multi-factor-authentication.md)
...
- User Details:
  ...
  - [Sessions Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
  - [Policies Tab](/docs/privilegesecure/4.1/administration/users-and-groups/permissions.md)
  - [Local Rights Tab](/docs/privilegesecure/4.1/administration/users-and-groups/permissions.md)
  - [History Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
  - [Authentication Connector Tab](/docs/privilegesecure/4.1/administration/users-and-groups/authentication.md)
  - [User Roles Tab](/docs/privilegesecure/4.1/administration/users-and-groups/role-management.md)

- Group Details:

  - [Sessions Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
  - [Members Tab](/docs/privilegesecure/4.1/administration/users-and-groups/group-management.md)
  - [Policies Tab](/docs/privilegesecure/4.1/administration/users-and-groups/permissions.md)
  - [History Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
  - [Authentication Connector Tab](/docs/privilegesecure/4.1/administration/users-and-groups/authentication.md)
  - [Group Roles Tab](/docs/privilegesecure/4.1/administration/users-and-groups/group-management.md)
...
- Application Details:
  ...
  - [Policies Tab](/docs/privilegesecure/4.1/administration/users-and-groups/permissions.md)
  - [History Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
  - [Authentication Tab](/docs/privilegesecure/4.1/administration/users-and-groups/authentication.md)
  - [Properties Tab](/docs/privilegesecure/4.1/administration/users-and-groups/user-management.md)
