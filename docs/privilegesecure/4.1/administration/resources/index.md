...
[Resources Dashboard](/docs/privilegesecure/4.1/administration/dashboard/resources.md).
...
- Add — Opens a list of available resources to add. The Add list contains the following options:
  ...
  - New Website — Opens the Website Details page for a new website. See the
    [Add New Website](/docs/privilegesecure/4.1/administration/resources/resource-details/websites.md)
    topic for additional information.
  - New Microsoft Entra ID (formerly Azure AD) Tenant — Opens the Microsoft Entra ID Tenant
    Details page for a new tenant. See the
    [Add New Microsoft Entra ID Tenant](/docs/privilegesecure/4.1/administration/resources/resource-details/entraid-tenants.md)
    topic for additional information.
  - New Secret Vault — Opens the Secret Vault Details page for a new vault. See the
    [Add Secret Vault](/docs/privilegesecure/4.1/administration/resources/resource-details/secret-vaults.md)
    topic for additional information.
  - New Database — Opens the Databse Details page for a new database. See the
    [Add New Database](/docs/privilegesecure/4.1/administration/resources/resource-details/databases.md)topic
