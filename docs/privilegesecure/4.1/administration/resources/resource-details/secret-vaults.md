...
- [Accounts Tab for Secret Vault](/docs/privilegesecure/4.1/administration/resources/platforms/secret-vaults.md)
- [Sessions Tab for Secret Vault](/docs/privilegesecure/4.1/administration/resources/platforms/secret-vaults.md)
- [History Tab for Secret Vault](/docs/privilegesecure/4.1/administration/resources/platforms/secret-vaults.md)
