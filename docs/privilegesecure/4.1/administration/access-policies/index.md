...
![Access Policy Page](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/configuration/systemsettings/page.webp)
...
- Credential Based Policy:
  ...
  - [Activities Tab for Credential Based Access Policies](/docs/privilegesecure/4.1/administration/credentials/credential-management.md)
