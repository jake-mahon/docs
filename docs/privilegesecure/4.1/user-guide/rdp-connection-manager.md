...
![appendices_stealthbits_privileged](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged.webp)
...
![MobaXterm SSH configuration](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_1.webp)
...
| ![appendices_stealthbits_privileged_2](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_2.webp) | ![appendices_stealthbits_privileged_3](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_3.webp) |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![MobaXtermRDP configuration](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_5.webp)
...
![appendices_stealthbits_privileged_6](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_6.webp)
...
![appendices_stealthbits_privileged_4](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_4.webp)
...
![Configure Remote Desktop Connection to Prompt for Password](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_9.webp)

**Step 3 –** Right click on Prompt for credentials on the client computer and select Edit from the
context menu.

![appendices_stealthbits_privileged_10](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/configure/appendices_stealthbits_privileged_10.webp)
