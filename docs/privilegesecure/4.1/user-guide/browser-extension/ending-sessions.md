...
![Browser Extension Start Web Session](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/browserextension/browserextensionstartsession.webp)
...
![Browser Extension End Session Message](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/enduser/browserextension/browserextensionendsession.webp)
...
Activity. See the
[Settings Tab for Browser Extension](/docs/privilegesecure/4.1/user-guide/browser-extension/installation.md#settings-tab-for-browser-extension)
...
[Activities Tab for the Browser Extension](/docs/privilegesecure/4.1/user-guide/browser-extension/installation.md#activities-tab-for-the-browser-extension)
topic for additional information.
