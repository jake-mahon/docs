...
![Netwrix Setup Launcher showing the Prequisites Setup with a green checkmark](/img/product_docs/privilegesecure/4.1/accessmanagement/install/launcherstep2.webp)
...
![Stealthbits PostgreSQL v12 Setup Wizard on the Install and Data Folder page](/img/product_docs/privilegesecure/4.1/accessmanagement/install/installfolder.webp)
...
![Netwrix Setup Launcher showing the PostgreSQL Setup with a green checkmark](/img/product_docs/privilegesecure/4.1/accessmanagement/install/launcherstep3.webp)
...
![Netwrix Privilege Secure Setup wizard on the Setup Options page](/img/product_docs/privilegesecure/4.1/accessmanagement/install/setupoptions.webp)
...
port. See the
[First Launch](/docs/privilegesecure/4.1/accessmanagement/install/firstlaunch.md)
