...
| Size                                                                | Browse for required sizes and VM features. See the [Requirements](/docs/privilegesecure/4.1/accessmanagement/virtualappliance/requirments.md) topic for additional information.                                                                                                                                                                                                                                                                                                                              |
