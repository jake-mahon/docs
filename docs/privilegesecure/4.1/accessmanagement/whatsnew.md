...
Privilege Secure version v4.1 release.
...
[Upgrade Procedure](/docs/privilegesecure/4.1/accessmanagement/install/upgrade.md)
...
[AWS Key Management Service](/docs/privilegesecure/4.1/accessmanagement/requirements/awskey.md)
topic for additional information.
...
[Add Local User](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/localuser.md)
topic for additional information.
