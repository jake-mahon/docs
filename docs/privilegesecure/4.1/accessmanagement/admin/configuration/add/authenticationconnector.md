...
![addauthentication](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/configuration/add/addauthentication.webp)
...
- For OpenID Connect, open the
  [OpenID Connect Configuration Wizard](/docs/privilegesecure/4.1/accessmanagement/admin/configuration/wizard/openidconnectconfiguration.md)
- For SAML, open the
  [SAML Configuration Wizard](/docs/privilegesecure/4.1/accessmanagement/admin/configuration/wizard/samlconfiguration.md)

See the
[OpenID Connect Authentication](/docs/privilegesecure/4.1/accessmanagement/admin/configuration/integrationdetails/openidconnectauthentication.md)
