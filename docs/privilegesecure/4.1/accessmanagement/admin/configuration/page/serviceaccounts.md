...
- Green + button — Create a new service account. See the
  [Add Service Account](/docs/privilegesecure/4.1/accessmanagement/admin/configuration/add/serviceaccount.md)
...
- App ID — Displays the globally unique identifier for the targeted app registered in the Active
  ...
  [Microsoft Entra ID App Registration](/docs/privilegesecure/4.1/accessmanagement/admin/configuration/integrationdetails/entraidappregistration.md)
