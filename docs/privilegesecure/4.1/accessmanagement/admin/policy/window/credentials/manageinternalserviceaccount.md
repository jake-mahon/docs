...
![Manage internal service account](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/manageinternalserviceaccount.webp)
...
![No matching user found](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/matchinguserfalse.webp)
...
![Set password for credential window](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/setpasswordcredential.webp)
...
![Manually Managed Account](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/credentialsmanuallymanageaccount.webp)
...
- Information icon — Opens the View Password window to view the password and copy it to the
  ...
  [View Password Window](/docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/viewpassword.md)
  topic for additional information.
