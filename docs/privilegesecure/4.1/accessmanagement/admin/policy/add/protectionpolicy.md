...
![Add Protection Policy](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/add/addprotectionpolicy.webp)
...
- [Resources Tab for Protection Policies](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/policyprotection/resources.md)
- [Allowed Members Tab for Protection Policies](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/policyprotection/allowedmembers.md)
- [Schedule Tab for Protection Policies](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/policyprotection/schedule.md)
