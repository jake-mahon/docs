...
- Blue + button — Create a new connection profile. See the
  [Add Connection Profile](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/connectionprofile.md)
...
- Approval Workflow settings:
    ...
    - Tiered – Approval is required for the session. See the
      [Add Approval Workflow](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/connectionprofileapproval.md)
      topic for additional information.
