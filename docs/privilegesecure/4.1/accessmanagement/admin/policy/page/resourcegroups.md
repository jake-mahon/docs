...
![Resource Groups Details Page](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/page/resourcegroupspage.webp)
...
- Blue + button — Create a resource group. See the
  [Add a Resource Group](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/resourcegroup.md)
...
- Add — Opens the Add Resources window. See the
  [Add Resources Window for Resource Group](/docs/privilegesecure/4.1/accessmanagement/admin/policy/window/resources/addresourcestogroup.md)
  topic for additional information.
