...
- Add User — The Add options change based on the selected role:
    ...
    - Administrator — Opens the Add Administrators window. See the
      [Add Administrators Window](/docs/privilegesecure/4.1/accessmanagement/admin/policy/window/usersgroups/addadministrators.md)
    ...
    - Users — Opens a list of available user types to add
        ...
        - New Application User — Opens the Add Application page. See the
          [Add Application](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/application.md)
    ...
    - Reviewers — Opens the Add Reviewers window. See the
      [Add Reviewers Window](/docs/privilegesecure/4.1/accessmanagement/admin/policy/window/usersgroups/addreviewers.md)
      topic for additional information.
