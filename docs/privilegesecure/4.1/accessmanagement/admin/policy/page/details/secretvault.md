...
![Secrete Vault Details Page](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/page/details/seretvaultdetailspage.webp)
...
- [Accounts Tab for Secret Vault](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/resources/accountssecretvault.md)
- [Sessions Tab for Secret Vault](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/resources/sessionssecretvault.md)
- [History Tab for Secret Vault](/docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/resources/historysecretvault.md)
