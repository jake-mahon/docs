...
![Administrative Credential Group Page](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/page/credentialgroupspage.webp)
...
- Blue + button — Create a new credential group. See the
  [Add Credential Group](/docs/privilegesecure/4.1/accessmanagement/admin/policy/add/credentialgroup.md)
  topic for additional information.
...
- Add Credential — Opens the Add Credentials window. See the
  [Add Credentials Window for Credential Group](/docs/privilegesecure/4.1/accessmanagement/admin/policy/window/credentials/addcredentials.md)
  topic for additional information.
