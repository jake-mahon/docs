...
![appendices_stealthbits_privileged](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged.webp)
...
![MobaXterm SSH configuration](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_1.webp)
...
| ![appendices_stealthbits_privileged_2](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_2.webp) | ![appendices_stealthbits_privileged_3](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_3.webp) |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![MobaXtermRDP configuration](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_5.webp)
...
![appendices_stealthbits_privileged_6](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_6.webp)
...
![appendices_stealthbits_privileged_4](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_4.webp)
...
| ![appendices_stealthbits_privileged_7](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_7.webp) | ![appendices_stealthbits_privileged_8](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_8.webp) |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![Configure Remote Desktop Connection to Prompt for Password](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_9.webp)

**Step 3 –** Right click on Prompt for credentials on the client computer and select Edit from the
context menu.

![appendices_stealthbits_privileged_10](/img/product_docs/privilegesecure/4.1/accessmanagement/enduser/configure/appendices_stealthbits_privileged_10.webp)
