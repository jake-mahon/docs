...
![Authentication Tab for Application User](/img/product_docs/privilegesecure/4.1/accessmanagement/admin/policy/tab/usersgroups/applicationauthenticationtab.webp)
