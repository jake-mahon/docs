...
- The Extras folder – Contains additional standalone installers:
  ...
  - Enablement Toolkit.exe – Installs a utility that offers a GUI for common testing scenarios
    ...
    [Troubleshooting](/docs/privilegesecure/4.1/troubleshooting/index.md)
  ...
  - NPS.ActionService.exe – Installs the NPS Action Service nodes. By default, this service is
    ...
    the service. See the
    [Action Service Install](/docs/privilegesecure/4.1/installation/components/action-service.md)
    topic for additional information.
  ...
  - NPS.exe – Installs the Privilege Secure application. By default, this installer is run as part
    ...
    **NOTE:** Use this installer if you are not using the Netwrix Setup Launcher. Run the
    ...
    [Install Application](/docs/privilegesecure/4.1/installation/setup/setup-launcher.md#install-application)
  ...
  - NPS.SchedulerService.exe – Installs the NPS Scheduler Service nodes. By default, this service
    ...
    [Scheduler Service Install](/docs/privilegesecure/4.1/installation/components/scheduler-service.md)
    topic for additional information.
  ...
  - SbPostgreSQL12.exe – Installs the PostgreSQL v12 database. By default, this installer is run
    ...
    **NOTE:** Use this installer if you are not using the Netwrix Setup Launcher. Run the
    installer as an administrator and follow the
    [Install PostgreSQL Database](/docs/privilegesecure/4.1/installation/setup/setup-launcher.md#install-postgresql-database)
    instructions, starting with Step 2.
...
[Netwrix Setup Launcher](/docs/privilegesecure/4.1/installation/setup/setup-launcher.md)
...
[Application Silent Installer Option](/docs/privilegesecure/4.1/installation/setup/silent-installation.md)
topic for additional information.
