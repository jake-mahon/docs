...
| Size                                                                | Browse for required sizes and VM features. See the [Requirements](/docs/privilegesecure/4.1/installation/virtual-appliance/requirements.md) topic for additional information.                                                                                                                                                                                                                                                                                                                                                          |
