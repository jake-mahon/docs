...
- - button — Create a new connector. See the
    [Add Authentication Connector](/docs/privilegesecure/4.1/configuration/authentication/authentication-connectors.md)
    topic for additional information.
...
- Configuration Wizard button — Opens the Configuration Wizard for the selected type of connector.
  See the
  [OpenID Connect Configuration Wizard](/docs/privilegesecure/4.1/configuration/authentication/openid-connect.md)
  topic for additional information.
...
- Configuration Wizard button — Opens the Configuration Wizard for the selected type of connector.
  See the
  [SAML Configuration Wizard](/docs/privilegesecure/4.1/configuration/authentication/saml.md)
  topic for additional information.
- Show / Hide Data link — Click the link to view or hide additional details
