...
See the
[Manage Internal Service Accounts](/docs/privilegesecure/4.1/administration/credentials/service-account-credentials.md)
...
See the
[Add Activity](/docs/privilegesecure/4.1/administration/activities/activity-management.md)
...
- Users to the Policy. See the
  [Users Tab for Resource Based Access Policies](/docs/privilegesecure/4.1/administration/access-policies/policy-assignments.md)
  topic for additional information.
