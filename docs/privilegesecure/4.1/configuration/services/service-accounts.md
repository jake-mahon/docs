...
![Add Service Account](/img/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/configuration/add/addserviceaccount.webp)
...
- Green + button — Create a new service account. See the
  [Add Service Account](/docs/privilegesecure/4.1/configuration/services/service-accounts.md)
  topic for additional information.
...
- App ID — Displays the globally unique identifier for the targeted app registered in the Active
  ...
  [Microsoft Entra ID App Registration](/docs/privilegesecure/4.1/configuration/authentication/entra-id-registration.md)
