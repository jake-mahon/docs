...
- [Activity Log Page](/docs/privilegesecure/4.1/privilegesecure/accessmanagement/admin/auditreporting/page/activitylog.md)
  — View activity logs for users and resources
- [DB Change History Page](/docs/privilegesecure/4.1/privilegesecure/accessmanagement/admin/auditreporting/page/dbchangehistory.md)
  — View records of database additions, updates, and deletions
- [Events Page](/docs/privilegesecure/4.1/privilegesecure/accessmanagement/admin/auditreporting/page/events.md)
...
- [Reporting](/docs/privilegesecure/4.1/privilegesecure/accessmanagement/admin/auditreporting/page/reporting.md)
