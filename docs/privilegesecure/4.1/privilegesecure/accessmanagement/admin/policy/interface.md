...
![Admin Policy Interface](/img/versioned_docs/threatprevention_7.4/threatprevention/reportingmodule/interface.webp)
...
- [Platforms Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/platforms/overview.md)
  — Add or modify the platforms used
    ...
    - [Password Complexity Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/passwordcomplexity.md)
...
- [Users & Groups Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/usersgroups.md)
  — Add or modify users, groups, and applications
    ...
    - [User and Group Collections Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/usergroupcollections.md)
...
- [Resources Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/resources.md)
  — Add or modify resources
    ...
    - [Resource Groups Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/resourcegroups.md)
...
- [Credentials Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/credentials.md)
  — Add or modify credentials
    ...
    - [Credential Groups Page](/versioned_docs/privilegesecure_4.1/privilegesecure/accessmanagement/admin/policy/page/credentialgroups.md)
