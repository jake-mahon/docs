...
The Action service also needs to communicate with Active Directory on a variety of different ports. See the [Ports](/docs/privilegesecure/privilegesecure/accessmanagement/requirements/ports.md) topic for additional information.
