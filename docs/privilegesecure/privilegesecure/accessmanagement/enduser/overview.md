...
There is also a Browser Extension that can be installed for Privilege Secure users. See the [Browser Extension App](browserextension/browserextension.md) topic for additional information.
