...
If the extension has been configured to not end the Activity sessions on web session closure, the Activity can be closed by clicking on the red icon. See the [Activities Tab for the Browser Extension](/docs/privilegesecure/privilegesecure/accessmanagement/enduser/browserextension/interface.md#Activities-Tab-for-the-Browser-Extension) topic for additional information.
