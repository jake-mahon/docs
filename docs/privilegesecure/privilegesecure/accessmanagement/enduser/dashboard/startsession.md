...
![Connecto to remote session](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/enduser/dashboard/remotesessionlaunch.png)
...
See the [Configure DirectConnect for Remote Desktop Connection](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/enduser/configure/rdcmanager.md) topic for additional information.
