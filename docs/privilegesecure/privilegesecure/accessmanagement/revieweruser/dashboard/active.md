...
![Active Dashboard](../../../../../../static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/revieweruser/dashboard/reviweractivedashboard.webp)
...
- Status — Shows status information for the session:
  ...
  - Available — The activity session is ready. Click the icon to begin the session, or log in through a client. See the [Start Activity Session](startsession.md) topic for additional information.
