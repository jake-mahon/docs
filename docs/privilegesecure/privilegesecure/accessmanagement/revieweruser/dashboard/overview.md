...
- Active Dashboard – Shows all currently active sessions. See the
  [Active Dashboard](../../enduser/dashboard/active.md) topic for additional information.
- Scheduled Dashboard – Shows all scheduled sessions. See the
  [Scheduled Dashboard](../../enduser/dashboard/scheduled.md) topic for additional information.
- Approvals Dashboard – Shows sessions waiting for approval. See the
  [Approvals Dashboard](../../enduser/dashboard/approvals.md) topic for additional information.
- Historical Dashboard – Shows previous sessions. See the
  [Historical Dashboard](../../enduser/dashboard/historical.md) topic for additional information.
