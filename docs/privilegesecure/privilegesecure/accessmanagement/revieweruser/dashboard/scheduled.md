...
- Create Session — Open the Activity Request window. See the [Create Activity Session](/docs/privilegesecure/privilegesecure/accessmanagement/revieweruser/dashboard/createsession.md) topic for additional information.
