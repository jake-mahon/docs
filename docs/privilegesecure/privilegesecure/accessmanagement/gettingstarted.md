...
- Configure multi-factor authentication (MFA). See the [First Launch](install/firstlaunch.md) topic
  for additional information.
- Login to the Privilege Secure Console. See the
  [Log Into the Privilege Secure Console](admin/login.md) topic for additional information.
...
- Import the license file. See the [Import the License File](admin/importlicense.md) topic for
...
- [Service Accounts Page](admin/configuration/page/serviceaccounts.md) — Add the account credentials
  that will grant access to the required resources
- [Add New Domain](admin/policy/add/domain.md) — Add the Active Directory domains that contain the
...
- [Users & Groups Page](admin/policy/page/usersgroups.md) — Add the Users and Groups from AD that
  will use the Privilege Secure Console
- [Resources Page](admin/policy/page/resources.md) — Add the resources such as Windows or Linux
  servers that the users will access via the Privilege Secure Console
- [Activities Page](admin/policy/page/activities.md) — Add the actions that Privilege Secure will
...
- [Connection Profiles Page](admin/policy/page/connectionprofiles.md) — Add the connection profile
  that will be used with the access policy
- [Access Policy Page](admin/policy/page/accesspolicy.md) — Create the access policies to control
...
- [Create My Activity Session](enduser/access/createsession.md) — Create a session to grant
  temporary privileges and gain access to the resources defined by the previously created access
  policy
- [Browser Extension Interface](enduser/browserextension/interface.md) — Conveniently access all of
