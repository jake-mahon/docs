...
The SAML Configuration wizard is opened with the __Configuration Wizard__ button in the Configuration > [Authentication Page](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/page/authentication.md) for an SAML Authentication Connector Type.

![configureclient](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/configureclient.png)
...
![SAML Configuration wizard, Test Login page](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigtestlogin.png)
...
![SAML Configuration Wizard, Retrieved Data](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigidmapping.png)
...
![SAML Configuration wizard, Map Id](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigidmapping2.png)
...
![SAML Configuration wizard, Test Logout page](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigtestlogout.png)
...
![SAML Configuration updating connector settings](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/wizard/samlconfigupdateconnector.png)
