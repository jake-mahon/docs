...
- Service Nodes:
  ...
  - [Service Nodes Page](page/servicenodes.md) — View the status and details of Privilege Secure Services
...
- [Integration Connectors Page](page/integrationconnectors.md) — Configure settings for integration with other applications
- SIEM:
