...
The Toolkit is available to download as a .zip file from the Privilege Secure installer's Extras folder. See the [Install Components & Methods](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/install/components.md) topic for additional information.
...
![SbPAM Enablement Toolkit - EULA Agreement window](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/sbpamenablementtoolkit_-_1_-_eula_agreement.png)
...
![SbPAM Enablement Toolkit - Default Interface](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/sbpamenablementtoolkit_-_2_-_main_interface.png)
...
![Stealthbits Enablement Toolkit - Help Menu](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/sbpamenablementtoolkit_-_3_-_help_window.png)
...
![Stealthbits Enablement Toolkit - Execution Complete](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/sbpamenablementtoolkit_-_4_-_execution_complete.png)
...
__Step 7 –__ Paste the thumbprint in the Certificate Thumbprint field of the Netwrix Privilege Secure console. See the [Global Settings Page](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/page/globalsettings.md) topic for additional information.
...
![Troubleshooting - GPO Settings](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/troubleshootinggposettings.png)
...
![Troubleshooting - SHA1](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/troubleshootingsha1.png)
