...
See the [Start Activity Session](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/dashboard/startsession.md) topic for additional information.
