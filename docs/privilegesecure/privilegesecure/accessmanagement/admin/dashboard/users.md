...
- Add Application — Opens the Add Application page. See the [Add Application](/docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/application.md) topic for additional information.
