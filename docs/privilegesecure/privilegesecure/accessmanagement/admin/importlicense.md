...
![Dashboard interface showing an expiration banner and pointint to the User Options menu with the About page](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/expirationbanner.webp)
...
![About page showing trial license details](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/triallicensedetails.webp)
...
![About page showing successful upload of a license](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/licenseimportsuccess.webp)
