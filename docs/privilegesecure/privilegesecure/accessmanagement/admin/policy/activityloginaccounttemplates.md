...
__NOTE:__ The value of each mask can be customized on the [Properties Tab](tab/usersgroups/properties.md) of the Application details page. See the [User, Group, & Application Details Page](page/details/usergroupapplication.md) topic for additional information.
