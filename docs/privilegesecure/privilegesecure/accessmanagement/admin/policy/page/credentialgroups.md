...
- Blue + button — Create a new credential group. See the [Add Credential Groups](/docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/credentialgroup.md) topic for additional information.
