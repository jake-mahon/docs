...
- Green + button — Create a new activity group. See the [Add Activity Groups](/docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/activitygroup.md) topic for additional information.
...
- Name — Displays the name of the activity. Click the link to view additional details. See the [Activities Page](/docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/page/activities.md) topic for additional details.
