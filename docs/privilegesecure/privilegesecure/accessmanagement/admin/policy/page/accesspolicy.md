...
- Green + button — Create a new access policy. See the [Add Access Policy](../add/accesspolicy.md) topic for additional information.
...
- Connection Profile — Displays the name of the connection profile associated to the access policy. The green arrow will open the [Connection Profiles Page](connectionprofiles.md) to add or edit connection profiles.
- User icon — Shows extra group of users who can manage this access policy. The icon appears only if a custom role has been assigned to a policy. See the [Custom Role Details Page](details/rolemanagementcustom.md) for additional information.
