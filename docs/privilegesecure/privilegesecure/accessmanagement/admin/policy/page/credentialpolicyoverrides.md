...
- Blue + button — Create a new credential group. See the [Add Credential Policy Override](../add/credentialpolicyoverrides.md) topic for additional information.
...
- Search — Searches the table or list for matches to the search string. When matches are found, the table or list is filtered to the matching results.
- Add Credentials — Opens the Add Credentials window. See the [Add Credentials Window](../window/credentials/addcredentials.md) topic for additional information.
