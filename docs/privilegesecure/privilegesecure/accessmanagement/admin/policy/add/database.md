...
- See the [Service Accounts Page](../../configuration/page/serviceaccounts.md) topic for additional information.
...
The new database is now added. See the [Database Details Page](../page/details/databases.md) for additional details.
