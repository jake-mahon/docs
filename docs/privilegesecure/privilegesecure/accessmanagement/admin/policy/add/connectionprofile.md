...
Follow the steps to add a connection profile to the console. See the [Connection Profiles Page](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/page/connectionprofiles.md) topic for detailed descriptions of the fields.
...
__Step 5 –__ The new connection profile is created. To add an Approval Workflow, see the [Add Approval Workflow](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/connectionprofileapproval.md#Add-Approval-Workflow) topic for additional information.
