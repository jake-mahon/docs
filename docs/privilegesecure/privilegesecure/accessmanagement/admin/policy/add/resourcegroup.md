...
- Add resources to the resource group. See the [Add Resources Window for Resource Group](../window/resources/addresourcestogroup.md) topic for additional information.
