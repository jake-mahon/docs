...
![addapprovalworkflow](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/addapprovalworkflow.png)

__Step 3 –__ In the Approval Workflow section, select Tiered and click Save.

![Add approval teir to workflow](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/addapprovalteirtoworkflow.png)

__Step 4 –__ Once the policy has been created, click the Add Tier icon to add an Approval Tier.

![Tier 1 Escalation Options](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/tier1escalationoptions.png)
...
![tierescalation](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/tierescalation.png)
...
![Tier 1 Escalation Example](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/tier1escalationexample.png)

__Step 8 –__ Click the Add Approvers icon to open the Add Users and Groups as Approvers window.

![Add Users and Groups as Approvers](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/addusersandgroupsasapprovers.png)
...
![Tier 1 Example](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/tier1example.png)
