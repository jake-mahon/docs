...
![Add an Activity](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/add/addactivity.png)
...
__Step 6 –__ With the new activity selected, configure the following settings. See the [Add Action Window](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/window/activities/addaction.md) topic for additional information:
