...
![Credential based policy credential tab](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/policycredentials/accesspolicycredentialstab.png)

The Credentials table has the following features:

- Add — Opens the Add Credentials window. See the [Add Credentials Window](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/window/accesspolicy/addcredentials.md) topic for additional information.
