...
![History Tab for Domain Resource](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/historydomain.png)
...
- Type — Provides options to filter results based on a chosen criterion:
  ...
  - Event Type — Filter by event type: Unspecified, Status, Service Start, Password Rotation, Host Scan, AD Sync, and Activity Session
  - Service Type — Filter by service type: Unspecified, Web UI, Action Service, Proxy Service, Schedule Service, and Email Service
