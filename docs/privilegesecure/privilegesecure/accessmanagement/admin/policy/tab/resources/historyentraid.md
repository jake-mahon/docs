...
![History Tab Entra ID](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/historyazuread.png)
...
- User — User who requested the session. See the [User, Group, & Application Details Page](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/page/details/usergroupapplication.md) topic for additional information.
