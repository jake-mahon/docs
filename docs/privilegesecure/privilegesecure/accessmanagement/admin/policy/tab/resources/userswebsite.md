...
![Users Tab for Website Resource](../../../../../../../../static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/websitedetailsuserstab.webp)

The Users tab has the following features:

- Search — Searches the table or list for matches to the search string. When matches are found, the table or list is filtered to the matching results.
- Add — Opens the Add a Managed User window. See the [Add a Managed User Window](../../window/resources/addamanageduser.md) topic for additional information.
...
- User Name — Displays the account name in the exact format specified in the “Login Account Template” field of the Activity, e.g. ```domain\user``` or ```user@domain.com```. See the [Activities Page](../../page/activities.md) topic for additional information.
