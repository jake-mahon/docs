...
![Domain Resource Computers Tab](/static/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/computersdomain.png)
...
- Add as NPS Managed Resource — Opens the Enroll Hosts in Management window to onboards the selected resource. See [Enroll Hosts in Management Window](/docs/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/window/resources/enrollhostsinmanagement.md) for additional information.
