...
- Password Reset Options — Customize password rotation options. This option is only available for managed accounts. See [Password Reset Options Window](../../window/resources/passwordresetoptions.md) for additional information.
