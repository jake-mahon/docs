...
- Add — Opens the Add Resources window. See the [Add Resources Window for Protected Policy](/docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/window/protectionpolicies/addresources.md) topic for additional information.
