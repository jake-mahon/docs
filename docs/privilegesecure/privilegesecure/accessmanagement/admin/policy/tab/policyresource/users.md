...
![Resource based policy users tab](../../../../../../../../static/img/product_docs/activitymonitor/activitymonitor/admin/monitoreddomains/admonitoringconfiguration/userstab.webp)
...
- Name — Displays the name of the account. See the [User, Group, & Application Details Page](../../page/details/usergroupapplication.md) topic for additional information.
