...
- Host — Resource that the user will run the activity on. The details vary based on the type of resource. See the [Resources Page](../../page/resources.md) topic for additional information.
