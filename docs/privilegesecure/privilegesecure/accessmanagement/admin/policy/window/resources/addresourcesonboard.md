...
- Service Account — Provides a list of available Service Accounts. See the [Service Accounts Page](../../../configuration/page/serviceaccounts.md) topic for additional information.
...
- Download CSV Template — Downloads the ```nps-resource-import-template.csv``` file with required columns. See the [Create Resource Import CSV File](../../resourceimportcsv.md) topic for additional information.
