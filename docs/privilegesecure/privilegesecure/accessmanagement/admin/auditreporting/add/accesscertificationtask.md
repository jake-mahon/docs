...
- Reviewer – Select a reviewer from the drop-down menu. Only users with the Reviewer role can be
  assigned as reviewer. See the [Role Management Page](../../policy/page/rolemanagement.md) topic
...
- Users – Add users or groups to the access certification task. See the
  [Add Users to Review](../tab/users.md#add-users-to-review) section for more information.
