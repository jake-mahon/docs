...
![Search for KMS Service](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/searchkms.png)

__Step 4 –__ On the Specify permissions page, navigate to the Select a service box and search for the ‘KMS’ service.

![Select KMS option](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectkms.png)

__Step 5 –__ Select the __KMS__ option.

![Select Decrypt permission checkbox](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectdecryptioncheckbox.png)

__Step 6 –__ Under the Write dropdown menu, locate and select the __Decrypt permission__ checkbox.

![Select Any In This Account](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectanyinthisaccount.png)
...
![Review and Create the Policy](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/reviewandcreate.png)
...
![Create User Name](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/enterusername.png)
...
![Select Attach Policies Directly](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectattachpoliciesdirectly.png)
...
![Review and Create the User Cofiguration](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/reviewandcreate.png)

__Step 6 –__ On the Review and create window, review the policy configuration and click __Create now__.

![User Security Credentials Tab](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/usersecuritycredentialstab.png)
...
![Select Application Running Outside AWS](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectapplicationrunningoutsideaws.png)

__Step 9 –__ Once the creation window opens, select the __Application running outside of AWS__ option.

![Set Tag and Create Key](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/settagcreatekey.png)

__Step 10 –__ Set an optional description tag if required, and then select __Create access key__.

![Copy Access Key](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/copyaccesskey.png)
...
![Select Create Key](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/selectcreatekey.png)

__Step 3 –__ Select __Create Key__.

![Configure Key Window](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/configurekeywindow.png)

__Step 4 –__ For Key Type, Select __Symmetric__. For Key Usage, select __Encrypt and decrypt__. Click __Next__ to continue.

![Add Alias Key Name](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/addaliaskeyname.png)

__Step 5 –__ Add an Alias for the key. The Description and Tags are optional. Click __Next__ to continue.

![Add Key Admin](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/addkeyadmin.png)
...
![Add Key User](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/addkeyuser.png)
...
![ANR Key Completed](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/arnkeycomplete.png)
...
![AIM Policy Permissions Tab](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/aimpolicypermissionstab.png)

__Step 2 –__ Select the __Permissions__ tab.

__Step 3 –__ Click the __Edit__ button.

![Policy Editor Window](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/policyeditorwindow.png)

__Step 4 –__ Once the policy editor window opens, switch to the Visual display mode and expand the KMS item dropdown.

![Expand Resources Item](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/expandresourcesitem.png)
...
![Add ARN KMS Policy Key](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/addarn.png)

__Step 7 –__ Paste the copied ARN for the NPS key into the bottom box then

__Step 8 –__ Click __Add ARNs__.

![Review and Save Policy Changes](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/requirements/reviewandsavepolicychanges.png)
