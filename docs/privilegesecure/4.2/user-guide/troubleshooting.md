...
folder. See the [Install Components & Methods](/docs/privilegesecure/4.2/installation/installation-guide/components-overview.md) topic for additional
information.
...
Secure console. See the [Global Settings Page](/docs/privilegesecure/4.2/administration/configuration/system-settings/global-settings.md) topic for
