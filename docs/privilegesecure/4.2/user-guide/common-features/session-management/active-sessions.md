...
Policy. See the [Access Policy Page](/docs/privilegesecure/4.2/administration/policies/access-policies/policy-details.md) topic for additional
information.
...
- Filter — Provides options to filter results based on a chosen criterion:
  ...
  - Recording data — Filter by keystroke data and, when enabled, RDP Windows event activity. See
    the [Install Remote Desktop Monitor Service on Target RDP Hosts](/docs/privilegesecure/4.2/installation/installation-guide/rdp-monitor.md)
    topic for additional information.

- Create Session — Open the Activity Request window. See the
  [Create Activity Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/create-session.md) topic for additional
  information.
...
- View Logs — Opens the Session Logs window to view the action log for the selected session. See the
  [Session Logs Window](/docs/privilegesecure/4.2/user-guide/common-features/session-management/session-logs.md) topic for additional information.
- Lock Activity — Opens the Lock Session window to prevent the user from interacting with the host
  but keeps the session active. See the [Lock Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/lock-session.md) topic for additional
  information.
...
- Expand icon — Click the expand () icon to show additional information for the session:
  ...
  - The live session viewer allows an admin to watch a remote session that is in progress for
    another user. See the [Live Session Viewer Window](/docs/privilegesecure/4.2/user-guide/common-features/session-management/live-viewer.md) topic for additional
    information.
  - If the user has logged into the remote session more than once, multiple session recordings
    ...
    watch a replay of the remote session. See the [Replay Viewer Window](/docs/privilegesecure/4.2/user-guide/common-features/session-management/replay-viewer.md)
    topic for additional information.
...
- Status — Shows status information for the session:
  ...
  - Locked — The session has been locked by an Privilege Secure administrator. See the
    [Lock Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/lock-session.md) topic for additional information.
...
- Requested By — User who requested the session. Click the link to view additional details. See the
  [User, Group, & Application Details Page](/docs/privilegesecure/4.2/administration/users-and-groups/user-tabs/properties.md) topic
...
- Host — Resource that the user will run the activity on. Click the link to view additional
  ...
  - [Host Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/windows.md)
  - [Domain Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/active-directory.md)
  - [Website Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/websites.md)
  - [Microsoft Entra ID Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/entra-id.md)
  - [Secret Vault Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/secret-vaults.md)
  - [Database Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/databases/mssql.md)
...
- Search — Searches the table or list for matches to the search string. When matches are found, the
  table or list is filtered to the matching results.
- Create Session — Open the Activity Request window. See the
  [Create My Activity Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/create-session.md) topic for additional information.
- End Session — Cancel the selected session(s)
- View Logs — Opens the Session Logs window to view the action log for the selected session. See the
  [Session Logs Window](/docs/privilegesecure/4.2/user-guide/common-features/session-management/session-logs.md) topic for additional information.
- Refresh — Reload the information displayed
...
- Status — Shows status information for the session:
  ...
  - Waiting for Approval — The session requires approval to begin. See the
    [Approvals Dashboard](/docs/privilegesecure/4.2/user-guide/common-features/access-management/approvals.md) topic for additional information.
  - Available — The activity session is ready. Click the icon to begin the session, or log in
    through a client. See the [Start Activity Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/start-session.md) topic for additional
    information.
  - Failed — Pre-Session stage of the Activity has encountered an error
  - Logged In — User is successfully logged in to the Resource either directly or via the Proxy.
    Direct log-in is detected by polling the Resource at regular intervals and may not update
...
![Active Dashboard](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/revieweruser/dashboard/reviweractivedashboard.webp)
