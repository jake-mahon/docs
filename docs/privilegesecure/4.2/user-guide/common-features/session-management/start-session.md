...
![Connecto to remote session](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/dashboard/startsession.webp)
...
See the [Proxy Service Install](/docs/privilegesecure/4.2/installation/installation-guide/proxy-service.md) topic for additional information.
...
![Direct Connect password prompt](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/dashboard/directconnect.webp)
...
See the [Configure DirectConnect for Remote Desktop Connection](/docs/privilegesecure/4.2/user-guide/common-features/rdc-manager.md) topic
...
![Connecto to remote session](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/revieweruser/dashboard/startactivitysession.webp)
