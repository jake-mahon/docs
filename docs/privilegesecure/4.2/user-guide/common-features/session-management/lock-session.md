...
observed, either from the [Active Dashboard](/docs/privilegesecure/4.2/user-guide/common-features/session-management/active-sessions.md), or the
[Live Session Viewer Window](/docs/privilegesecure/4.2/user-guide/common-features/session-management/live-viewer.md).
