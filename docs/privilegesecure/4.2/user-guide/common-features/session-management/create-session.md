...
See the [Start Activity Session](/docs/privilegesecure/4.2/user-guide/common-features/session-management/start-session.md) topic for additional information.
