...
Activity. See the
[Settings Tab for Browser Extension](/docs/privilegesecure/4.2/user-guide/common-features/browser-extension/interface.md#settings-tab-for-browser-extension) topic for
...
[Activities Tab for the Browser Extension](/docs/privilegesecure/4.2/user-guide/common-features/browser-extension/interface.md#activities-tab-for-the-browser-extension)
