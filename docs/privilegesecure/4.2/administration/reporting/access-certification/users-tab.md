...
review process. See the [Entitlements Tab for Access Certification](/docs/privilegesecure/4.2/administration/reporting/access-certification/entitlements-tab.md) topic for
