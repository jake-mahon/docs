...
- Add Access Cert. Task icon – Add an access certification task to the list. See the
  [Add Access Certification Task](/docs/privilegesecure/4.2/administration/reporting/access-certification/create-certification-task.md) topic for additional
  information.
...
- Reviewer – The reviewer that the access certification task is assigned to. Only users with the
  ...
  [Role Management Page](/docs/privilegesecure/4.2/administration/users-and-groups/roles-and-permissions/default-roles.md) topic for additional information
- Status – Shows status information for the task
...
- [Users Tab for Access Certification](/docs/privilegesecure/4.2/administration/reporting/access-certification/users-tab.md)
- [Entitlements Tab for Access Certification](/docs/privilegesecure/4.2/administration/reporting/access-certification/entitlements-tab.md)
