...
- Add activities to the activity group. See the
  [Add Activities Window](/docs/privilegesecure/4.2/administration/activities/activity-management/add-activity.md) topic for additional information.
...
- Green + button — Create a new activity group. See the
  [Add Activity Groups](/docs/privilegesecure/4.2/administration/activities/activity-management/activity-groups.md) topic for additional information.
...
- Name — Displays the name of the activity. Click the link to view additional details. See the
  [Activities Page](/docs/privilegesecure/4.2/administration/activities/index.md) topic for additional details.
