...
See the [Action Types](/docs/privilegesecure/4.2/administration/activities/activity-management/activity-types.md) section for detailed descriptions of the
fields.
...
Post-Session group. See the [Protection Policies Page](/docs/privilegesecure/4.2/administration/policies/protection-policies/add-protection-policy.md) topic for
