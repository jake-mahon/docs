...
- Add — Opens the Add Credentials window. See the
  [Add Credentials Window](/docs/privilegesecure/4.2/administration/policies/access-policies/add-credentials-to-policy.md) topic for additional
  information.
...
onboarded in the [Credentials Page](/docs/privilegesecure/4.2/administration/credentials/index.md).
