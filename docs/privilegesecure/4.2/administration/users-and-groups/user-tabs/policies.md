...
![Policies Tab for Application Users](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/usersgroups/userpoliciestab.webp)
...
- Add — Opens the Add Account to Policies window. See
  [Add Account to Policies Window](/docs/privilegesecure/4.2/administration/users-and-groups/user-tabs/policies.md) topic for
...
created in the [ Policy Interface](/docs/privilegesecure/4.2/administration/policies/index.md).

![usersgroupsaddaccounttopoliciespage](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/window/usersgroups/usersgroupsaddaccounttopoliciespage.webp)
...
the [ Policy Interface](/docs/privilegesecure/4.2/administration/policies/index.md).
