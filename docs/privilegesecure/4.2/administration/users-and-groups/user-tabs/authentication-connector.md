...
sidebar_label: authentication connector
...
Authentications page. See the [Authentication Page](/docs/privilegesecure/4.2/administration/configuration/authentication/authentication-settings.md)
