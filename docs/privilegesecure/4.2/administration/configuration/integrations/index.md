...
- Connector Type — Indicates the type of integration:
  ...
  - CyberArk — Configure integration with CyberArk. See the
    [CyberArk Integration](/docs/privilegesecure/4.2/administration/configuration/integrations/cyberark.md) topic for additional information.
  - HashiCorp — Configure integration with HashiCorp. See the
    [HashiCorp Integration](/docs/privilegesecure/4.2/administration/configuration/integrations/hashicorp.md) topic for additional information.
  - LAPS — Configure integration with LAPS. See the [LAPS Integration](/docs/privilegesecure/4.2/administration/configuration/integrations/laps.md)
    topic for additional information.
  - StealthAUDIT — Configure integration with Netwrix Access Analyzer (formerly Enterprise
    Auditor). See the [Enterprise Auditor Integration](/docs/privilegesecure/4.2/administration/configuration/integrations/access-analyzer.md)
    topic for additional information.
