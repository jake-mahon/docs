...
sidebar_label: secret vault config
...
[Secret Vault Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/secret-vaults.md) topic for additional
information.
...
time on the [Connection Profiles Page](/docs/privilegesecure/4.2/administration/policies/connection-profiles/add-connection-profile.md) page or use the
...
[Users Tab for Credential Based Access Policies](/docs/privilegesecure/4.2/administration/policies/access-policies/policy-details.md) for
