...
![Add Enterprise Auditor Integration Connector](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/add/addaccessanalyzer.webp)
...
![enterpriseauditorconnector](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/configuration/add/accessanalyzerconnector.webp)
...
[Action Service](/docs/privilegesecure/4.2/administration/configuration/services/action-service-settings.md) topic for additional information.
