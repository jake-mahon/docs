...
[Authentication Connector Tab](/docs/privilegesecure/4.2/administration/users-and-groups/user-tabs/authentication-connector.md) topic for
...
- - button — Create a new connector. See the
    [Add Authentication Connector](/docs/privilegesecure/4.2/administration/configuration/authentication/authentication-connectors.md) topic for additional
    information.
...
- Configuration Wizard button — Opens the Configuration Wizard for the selected type of connector.
  See the [OpenID Connect Configuration Wizard](/docs/privilegesecure/4.2/administration/configuration/authentication/openid-connect.md) topic for
  additional information.
...
- Configuration Wizard button — Opens the Configuration Wizard for the selected type of connector.
  See the [SAML Configuration Wizard](/docs/privilegesecure/4.2/administration/configuration/authentication/saml-configuration.md) topic for additional
  information.
- Show / Hide Data link — Click the link to view or hide additional details
