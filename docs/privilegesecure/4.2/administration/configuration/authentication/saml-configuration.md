...
Configuration > [Authentication Page](/docs/privilegesecure/4.2/administration/configuration/authentication/authentication-settings.md) for an SAML Authentication
Connector Type.
