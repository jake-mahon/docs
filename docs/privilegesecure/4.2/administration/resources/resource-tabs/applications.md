...
- Name — Displays the name of the policy. See the [Access Policy Page](/docs/privilegesecure/4.2/administration/policies/access-policies/policy-details.md)
...
![Applications Tab Entra ID](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/applicationsazuread.webp)
