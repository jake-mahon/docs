...
![Sessions Tab Entra ID](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/sessionsazuread.webp)
...
- Activity — Displays the name of the activity. See the [Activities Page](/docs/privilegesecure/4.2/administration/activities/index.md)
...
![Sessions Tab for Host Resource](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/sessionshost.webp)
...
![Sessions Tab for Website Resource](/img/product_docs/privilegesecure/privilegesecure/accessmanagement/admin/policy/tab/resources/websitedetailssessionstab.webp)
