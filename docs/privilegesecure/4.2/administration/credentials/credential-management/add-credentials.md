...
[Credentials Page](/docs/privilegesecure/4.2/administration/credentials/index.md).
...
- Method — Indicates how the account is managed:
  ...
  - Automatic — Credential rotation is managed by Privilege Secure according to the change policy
    for that platform type. See the [Platforms Page](/docs/privilegesecure/4.2/administration/resources/platforms/index.md) topic for
  ...
  - Manual — Credential rotation must be initiated manually with the Rotate Service Account
    ...
    Secure. See the [Service Accounts Page](/docs/privilegesecure/4.2/administration/configuration/services/service-accounts.md)
...
[Manage Internal Service Accounts](/docs/privilegesecure/4.2/administration/credentials/credential-management/internal-service-account.md) topic for additional
information.
