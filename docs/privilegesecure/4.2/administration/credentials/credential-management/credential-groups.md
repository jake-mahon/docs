...
[Add Credentials to a Credential Group](/docs/privilegesecure/4.2/administration/credentials/credential-management/add-credentials.md#add-credentials-to-a-credential-group)
...
- Blue + button — Create a new credential group. See the
  [Add Credential Groups](/docs/privilegesecure/4.2/administration/credentials/credential-management/credential-groups.md) topic for additional information.
...
- Method — Indicates how the account is managed:
  ...
  - Manual — Credential rotation must be initiated manually with the Rotate Service Account
    ...
    Secure. See the [Service Accounts Page](/docs/privilegesecure/4.2/administration/configuration/services/service-accounts.md) topic for
