...
[API Key Management](/docs/privilegesecure/4.2/discovery/integrations/api/api-key-management.md)
...
![blobid0.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid0_379x236.webp)

**Step 2 –** Then click **Edit** to the left, on the ‘Globals’ line:

![blobid1.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid1_760x393.webp)
...
![blobid2.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid2.webp)
...
![blobid3.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid3.webp)

**Step 6 –** Click on **Body** and copy-and-paste the userId that is authorized on the API key
entered in the global Variables.

![blobid4.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid4.webp)

**NOTE:** The \{\{api_key\}\} will pull the value from the global variable.

**Step 7 –** Click on **Tests**.

![blobid5.webp](/img/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/integrations/api/360047844814_blobid5_657x168.webp)
