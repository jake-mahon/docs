...
[SSO Configuration](/docs/privilegesecure/4.2/discovery/admin/configuration/ssoconfiguration.md)
...
[Configure ADFS (Active Directory Federation Services) SSO](/docs/privilegesecure/4.2/discovery/admin/configuration/configureadfs.md)
