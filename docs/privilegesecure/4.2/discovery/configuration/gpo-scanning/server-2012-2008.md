...
sidebar_label: server 2012 2008
...
article:  [Scan GPO Guide (Server 2016+ Domain Controllers)](/docs/privilegesecure/4.2/discovery/configuration/gpo-scanning/server-2016-plus.md)
