...
[SSO Configuration](/docs/privilegesecure/4.2/discovery/admin-guide/authentication-sso/sso-configuration.md)
...
[Configure ADFS (Active Directory Federation Services) SSO](/docs/privilegesecure/4.2/discovery/admin-guide/authentication-sso/adfs-configuration.md)
