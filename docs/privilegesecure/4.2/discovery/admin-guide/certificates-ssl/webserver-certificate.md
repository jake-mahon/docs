...
See the
[Add a Certificate Authority to the Ubuntu Trusted Authorities Repository](/docs/privilegesecure/4.2/discovery/admin-guide/configuration-settings/certificate-authority.md)
