...
([Freeze Mode](/docs/privilegesecure/4.2/discovery/requirements/technicalpreparation/freeze_mode.md)),
...
([](https://remediant.zendesk.com/hc/en-us/articles/4995338773655-Applying-a-Service-Account-from-an-existing-AD-group-Directly-to-a-Machine)[Apply a Service Account from an existing AD group Directly to a Machine](/docs/privilegesecure/4.2/discovery/administration/configuration/applyserviceaccount.md)).
