...
- Adding a sudo user:
    ...
    - [Linux: Add Sudo User to Ubuntu System](/docs/privilegesecure/4.2/discovery/administration/systemmanagement/linuxaddsudouser.md)
...
- Postman program (used for individual system registration) -
  [Postman Linux Registration](/docs/privilegesecure/4.2/discovery/requirements/technicalpreparation/postmanlinuxregistration.md)
