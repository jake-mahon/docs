...
Linux registration
prerequisites: [Linux Registrations Prerequisites](/docs/privilegesecure/4.2/discovery/requirements/technicalpreparation/linuxregistrationsprerequisites.md)
