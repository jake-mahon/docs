...
- [Architectue Overview](/docs/privilegesecure/4.2/discovery/requirements/architecture-overview.md)
...
[Service Accounts](/docs/privilegesecure/4.2/discovery/configuration/service-accounts.md)
...
- 2016+ Domain Controllers –
  [Scan GPO Guide (Server 2016+ Domain Controllers)](/docs/privilegesecure/4.2/discovery/configuration/gpo-scanning/server-2016-plus.md)
...
- More information and instruction can be found here:
  [Bulk Actions](/docs/privilegesecure/4.2/discovery/admin-guide/system-management/bulk-actions.md)
...
- The Privilege Secure API documentation can be found here:
  ...
  [API Key Revocation](/docs/privilegesecure/4.2/discovery/integrations/api/api-key-revocation.md).
  Additional information on the Advanced API is available
  here:[Advanced API Reference](/docs/privilegesecure/4.2/discovery/integrations/api/advanced-api-reference.md)
...
- [Carbon Black](/docs/privilegesecure/4.2/discovery/integrations/edr/carbon-black.md)
...
- [Architectue Overview](/docs/privilegesecure/4.2/discovery/requirements/architecture-overview.md)
- [Port, Firewall, and Datacenter Requirements](/docs/privilegesecure/4.2/discovery/requirements/ports-and-firewalls.md)
- [High Availability (HA) and Disaster Recovery (DR) Options](/docs/privilegesecure/4.2/discovery/requirements/ha-and-dr.md)
