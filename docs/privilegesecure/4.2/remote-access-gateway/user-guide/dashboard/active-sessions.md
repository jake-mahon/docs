...
- Create Session — Open the Activity Request window. See the
  [Create My Activity Session](/docs/privilegesecure/4.2/remote-access-gateway/user-guide/access-management/create-session.md) topic for additional information.
...
- Status — Shows status information for the session:
  ...
  - Available — The activity session is ready. Click the icon to begin the session, or log in
    through a client. See the [Sessions Interface](/docs/privilegesecure/4.2/remote-access-gateway/user-guide/dashboard/overview.md) topic for additional information.
