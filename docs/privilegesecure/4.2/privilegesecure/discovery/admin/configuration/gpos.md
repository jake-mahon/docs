...
- Example of how to use GPO to add the Privilege Secure service account (the "Protect Mode"
  account).
  [Add Privilege Secure Protect Mode Account to Windows Endpoints via GPO](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/productmodeaccount.md)
