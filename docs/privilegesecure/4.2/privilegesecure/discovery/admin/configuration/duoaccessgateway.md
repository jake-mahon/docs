...
[SSO Configuration](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/configuration/ssoconfiguration.md)
...
[Configure ADFS (Active Directory Federation Services) SSO](/docs/privilegesecure/4.2/privilegesecure/discovery/admin/configuration/configureadfs.md)
