...
[Virtual Machines](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/requirements/virtualmachines.md)  
Allow
...
[Dashboard Guide](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/admin/reporting/dashboardguide.md)
...
[Add a User or Group to a Systems' Administrator Account Inventory](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/admin/systemmanagement/adduserorgroup.md)  
Before
...
[Linux Registrations Prerequisites](/versioned_docs/privilegesecurefordiscovery_2.21/privilegesecure/discovery/linuxregistrationsprerequisites.md)
