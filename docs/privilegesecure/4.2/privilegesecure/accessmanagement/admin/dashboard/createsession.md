...
See the [Start Activity Session](/docs/privilegesecure/4.2/privilegesecure/accessmanagement/admin/dashboard/startsession.md) topic for additional information.
