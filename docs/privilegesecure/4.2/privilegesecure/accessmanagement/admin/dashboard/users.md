...
same information as the [Users & Groups Page](/docs/privilegesecure/4.2/privilegesecure/accessmanagement/admin/policy/page/usersgroups.md).
...
- Add Application — Opens the Add Application page. See the
  [Add Application](/docs/privilegesecure/4.2/privilegesecure/accessmanagement/admin/policy/add/application.md) topic for additional information.
