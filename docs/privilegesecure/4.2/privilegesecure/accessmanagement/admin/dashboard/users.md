...
same information as the [Users & Groups Page](../policy/page/usersgroups.md).
...
- Add User — Opens the Add Users and Groups window. See the
  [Add Users & Groups Window](../policy/window/usersgroups/addusersandgroups.md) topic for
  additional information.
- Add Application — Opens the Add Application page. See the
  [Add Application](../policy/add/application.md) topic for additional information.
