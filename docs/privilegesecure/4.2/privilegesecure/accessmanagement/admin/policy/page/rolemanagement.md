...
- Blue + button — Create a new role. See the [Add Custom Role](../add/customrole.md) for additional
  information.
...
[Default Role Details Page](details/rolemanagementdefault.md) and the
[Custom Role Details Page](details/rolemanagementcustom.md) topics for additional information.
