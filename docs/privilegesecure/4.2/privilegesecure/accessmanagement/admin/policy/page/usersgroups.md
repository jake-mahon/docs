...
displays the same information as the [Users Dashboard](../../dashboard/users.md).
...
- Add User — Opens the Add Users and Groups window. See the
  ...
  information.
- Add Application — Opens the Add Application page. See the [Add Application](../add/application.md)
  for additional information.
- Add Local User — Opens the Add Local User page. See [Add Local User](../add/localuser.md) topic
  for additional information.
