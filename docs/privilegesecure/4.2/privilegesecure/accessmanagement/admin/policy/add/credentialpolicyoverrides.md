...
- Scheduled Change Policy — Select a previously added schedule policy from the drop-down list. How
  ...
  [Credentials Dashboard](../../dashboard/credentials.md) and
  [Schedule Policies Page](../page/schedulepolicies.md) topic for additional information.
- Verification Schedule — How often to verify the credentials for managed accounts on the resources
  defined by the selected platform. See the [Credentials Dashboard](../../dashboard/credentials.md)
...
[Add Credentials to a Policy Override](../window/credentials/addcredentials.md#add-credentials-to-a-policy-override)
...
[Manage Internal Service Accounts](../window/credentials/manageinternalserviceaccount.md) topic for
