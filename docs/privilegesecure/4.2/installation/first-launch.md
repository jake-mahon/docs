...
- Click **Next**, while the code is still active.
  ...
  **NOTE:** MFA for this account can be done at a later time through the User details page. If
  ...
  [User, Group, & Application Details Page](/docs/privilegesecure/4.2/administration/users-and-groups/user-tabs/properties.md)
...
Take a [Product Tour](/docs/privilegesecure/4.2/getting-started/product-tour.md) of the console or onboard more users and resources.
See the [Getting Started](/docs/privilegesecure/4.2/getting-started/index.md) topic for additional information.
...
[Domain Details Page](/docs/privilegesecure/4.2/administration/resources/platforms/active-directory.md) topic for additional information.
