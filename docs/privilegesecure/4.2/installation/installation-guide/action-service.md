...
Customer portal. See the [Install Components & Methods](/docs/privilegesecure/4.2/installation/installation-guide/components-overview.md) topic for additional
information.
...
[Proxy Service Install](/docs/privilegesecure/4.2/installation/installation-guide/proxy-service.md) topic for installation instructions.
