...
met. See the [Requirements](/docs/privilegesecure/4.2/installation/system-requirements/index.md) topic for additional information.
...
- Remote Desktop Monitor Service – The Privilege Secure Remote Desktop Monitor service monitors the
  ...
  See the [Install Remote Desktop Monitor Service on Target RDP Hosts](/docs/privilegesecure/4.2/installation/installation-guide/rdp-monitor.md) topic for
...
See the [Ports](/docs/privilegesecure/4.2/installation/system-requirements/ports-and-firewall.md) topic for additional information.
