...
- The Extras folder – Contains additional standalone installers:
  ...
  - Enablement Toolkit.exe – Installs a utility that offers a GUI for common testing scenarios
    ...
    [Troubleshooting](/docs/privilegesecure/4.2/user-guide/troubleshooting.md) topic for additional information.
  - NPS.ActionService.exe – Installs the NPS Action Service nodes. By default, this service is
    ...
    the service. See the [Action Service Install](/docs/privilegesecure/4.2/installation/installation-guide/action-service.md) topic for additional
    information.
  ...
  - NPS.exe – Installs the Privilege Secure application. By default, this installer is run as part
    ...
    **NOTE:** Use this installer if you are not using the Netwrix Setup Launcher. Run the
    ...
    [Install Application](/docs/privilegesecure/4.2/installation/installation-guide/setup-launcher.md#install-application) instructions, starting with
    Step 2.
  ...
  - NPS.ProxyService – Installs the NPS Proxy Service nodes. It is available as both an EXE and
    ...
    deployment tool. See the [Proxy Service Install](/docs/privilegesecure/4.2/installation/installation-guide/proxy-service.md) topic for additional
    information.
  - NPS.SchedulerService.exe – Installs the NPS Scheduler Service nodes. By default, this service
    ...
    install the service. See the [Scheduler Service Install](/docs/privilegesecure/4.2/installation/installation-guide/scheduler-service.md) topic for
  ...
  - NPS.TSMon.exe – Installs the Netwrix Privilege Secure Remote Desktop Service. This service is
    ...
    [Install Remote Desktop Monitor Service on Target RDP Hosts](/docs/privilegesecure/4.2/installation/installation-guide/rdp-monitor.md) topic for
    additional information.
  ...
  - SbPostgreSQL16.exe – Installs the PostgreSQL v16 database. By default, this installer is run
    ...
    **NOTE:** Use this installer if you are not using the Netwrix Setup Launcher. Run the
    installer as an administrator and follow the
    [Install PostgreSQL Database](/docs/privilegesecure/4.2/installation/installation-guide/setup-launcher.md#install-postgresql-database) instructions,
...
on the sames server. See the [Netwrix Setup Launcher](/docs/privilegesecure/4.2/installation/installation-guide/setup-launcher.md) topic for instructions. If
...
[Application Silent Installer Option](/docs/privilegesecure/4.2/installation/installation-guide/silent-installation.md) topic for additional information.

There is also a Browser Extension that can be installed for Privilege Secure users. See the
[Browser Extension App](/docs/privilegesecure/4.2/user-guide/common-features/browser-extension/overview.md) topic for additional
information.
