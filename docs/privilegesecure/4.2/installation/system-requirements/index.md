...
- [Application Server](/docs/privilegesecure/4.2/installation/system-requirements/application-server.md)
- [Client](/docs/privilegesecure/4.2/installation/system-requirements/client-requirements.md)
- [Remote Service Node](/docs/privilegesecure/4.2/installation/system-requirements/proxy-server.md)
- [Target Environments](/docs/privilegesecure/4.2/installation/system-requirements/target-requirements.md)
