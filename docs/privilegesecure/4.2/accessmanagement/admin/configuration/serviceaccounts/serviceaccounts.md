...
![serviceaccountpage](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/page/serviceaccountpage.webp)
...
- Green + button — Create a new service account. See the
  [Add Service Account](/docs/privilegesecure/4.2/accessmanagement/admin/configuration/serviceaccounts/serviceaccount.md) topic for additional information.
...
- App ID — Displays the globally unique identifier for the targeted app registered in the Active
  ...
  [Microsoft Entra ID App Registration](/docs/privilegesecure/4.2/accessmanagement/admin/configuration/serviceaccounts/entraidappregistration.md) for
...
managed by the application. See the [Credentials Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/credentials/credentials.md) topic for
additional information.
