...
- App ID — Displays the globally unique identifier for the targeted app registered in the Active
  ...
  [Microsoft Entra ID App Registration](/docs/privilegesecure/4.2/accessmanagement/admin/configuration/integrationdetails/entraidappregistration.md) for
...
managed by the application. See the [Credentials Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/credentials.md) topic for
additional information.
