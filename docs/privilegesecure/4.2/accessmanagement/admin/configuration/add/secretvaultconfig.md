...
[Secret Vault Details Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/details/secretvault.md) topic for additional
information.
...
time on the [Connection Profiles Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/connectionprofiles.md) page or use the
...
[Users Tab for Credential Based Access Policies](/docs/privilegesecure/4.2/accessmanagement/admin/policy/tab/policycredentials/users.md) for
