...
![Dashboard interface showing an expiration banner and pointint to the User Options menu with the About page](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/expirationbanner.webp)
...
![About page showing trial license details](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/triallicensedetails.webp)
...
![About page showing successful upload of a license](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/licenseimportsuccess.webp)
...
[About Page](/docs/privilegesecure/4.2/accessmanagement/admin/navigation/aboutpage.md) topic for additional details available on this page.
