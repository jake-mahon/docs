...
observed, either from the [Active Dashboard](/docs/privilegesecure/4.2/accessmanagement/admin/dashboard/active.md), or the
[Live Session Viewer Window](/docs/privilegesecure/4.2/accessmanagement/admin/dashboard/window/liveviewer.md).
