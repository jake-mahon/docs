...
Subscribe to a report. See the [Schedule Policies Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/platforms/schedulepolicies/schedulepolicies.md) topic
