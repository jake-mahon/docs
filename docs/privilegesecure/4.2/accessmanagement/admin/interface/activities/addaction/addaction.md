...
See the [Action Types](/docs/privilegesecure/4.2/accessmanagement/admin/interface/activities/addaction/activityactiontypes.md) section for detailed descriptions of the
fields.
...
Post-Session group. See the [Protection Policies Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/protectionpolicies.md) topic for
