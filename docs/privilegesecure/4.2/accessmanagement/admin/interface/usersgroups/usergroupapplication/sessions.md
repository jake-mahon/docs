...
![Sessions Tab for Application Users](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/tab/usersgroups/usersessionstab.webp)
...
- Host — Resource that the user will run the activity on. The details vary based on the type of
  resource. See the [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/resources/resources.md) topic for additional information.
