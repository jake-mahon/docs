...
![Policies Tab for Application Users](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/tab/usersgroups/userpoliciestab.webp)
...
- Add — Opens the Add Account to Policies window. See
  [Add Account to Policies Window](/docs/privilegesecure/4.2/accessmanagement/admin/interface/usersgroups/usergroupapplication/policies/addaccounttopolicies.md) topic for
