...
console, users or groups have to be added in the top level [Users & Groups Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/usersgroups/usersgroups.md).
...
![Users and Group Collections Page](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/page/userandgroupcollectionspage.webp)
