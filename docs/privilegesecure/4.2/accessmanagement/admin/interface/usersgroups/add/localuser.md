...
![addlocalusers](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/add/addlocalusers.webp)
...
Once saved, users can view the new Local User on the [Users & Groups Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/usersgroups/usersgroups.md).
