...
in the [Users & Groups Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/usersgroups/usersgroups.md).

![Add Administrators Window](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/window/usersgroups/addadministrators.webp)
...
[Role Management Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/usersgroups/rolemanagement/rolemanagement.md) section for a list of roles and their
functions.
