...
cannot be determined. See the [Platforms Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/platforms/overview.md) topic for additional
information.
...
- Blue + button — Create a new password complexity policy. See the
  [Add Password Complexity Policy](/docs/privilegesecure/4.2/accessmanagement/admin/interface/platforms/passwordcomplexity/passwordcomplexity_1.md) topic for additional information.
