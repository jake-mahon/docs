...
- Protection Policy Schedule — How often the Protection Policy is run. See the
  [Protection Policies Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/protectionpolicies.md) topic for additional information.
...
- Scan Schedule — How often to perform a host scan on the resources defined by the selected platform
  ...
  the [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/resources/resources.md).
