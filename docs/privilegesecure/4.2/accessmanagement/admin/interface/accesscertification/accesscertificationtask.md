...
- Users – Add users or groups to the access certification task. See the
  [Add Users to Review](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesscertification/users.md#add-users-to-review) section for more information.
