...
- [Users Tab for Access Certification](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesscertification/users.md)
- [Entitlements Tab for Access Certification](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesscertification/entitlements.md)
