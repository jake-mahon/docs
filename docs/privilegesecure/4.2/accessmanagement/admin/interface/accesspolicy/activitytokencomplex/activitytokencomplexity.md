...
![Activity Token Complexity Page](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/page/page_1.webp)
...
- Green + button — Create a new activity token complexity policy. See the
  [Add Activity Token Complexity Policy](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesspolicy/activitytokencomplex/activitytokencomplexity_1.md) topic for additional
  information.
