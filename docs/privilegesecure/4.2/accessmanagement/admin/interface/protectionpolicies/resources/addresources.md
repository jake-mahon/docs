...
onboarded in the [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/resources/resources.md).

![Protection policy add resource window](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addresources.webp)
...
- Name — Displays the name of the resource. Click the link to view additional details. See the
  [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/resources/resources.md) topic for addition information.
