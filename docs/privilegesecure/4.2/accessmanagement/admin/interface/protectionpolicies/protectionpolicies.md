...
[Allowed Members Tab for Protection Policies](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/allowedmembers.md) are removed
from the resource.
...
- [Resources Tab for Protection Policies](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/resources/resources.md)
- [Allowed Members Tab for Protection Policies](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/allowedmembers.md)
- [Schedule Tab for Protection Policies](/docs/privilegesecure/4.2/accessmanagement/admin/interface/protectionpolicies/schedule.md)
