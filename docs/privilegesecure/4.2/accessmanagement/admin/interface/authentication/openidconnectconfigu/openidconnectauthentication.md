...
![Okta Menu](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/integrationdetails/oktamenu.webp)
...
![Add person to Okta](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/integrationdetails/oktaaddperson.webp)
...
![Okta login format](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/integrationdetails/oktaloginformat.webp)
...
![Assign Apps top users](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/integrationdetails/oktaassignapps.webp)
