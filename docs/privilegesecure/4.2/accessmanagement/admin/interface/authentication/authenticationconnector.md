...
[Authentication Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/authentication/authentication.md) section for detailed descriptions of the fields.

- For OpenID Connect, open the
  [OpenID Connect Configuration Wizard](/docs/privilegesecure/4.2/accessmanagement/admin/interface/authentication/openidconnectconfigu/openidconnectconfiguration.md)
- For SAML, open the [SAML Configuration Wizard](/docs/privilegesecure/4.2/accessmanagement/admin/interface/authentication/samlconfiguration.md)

See the [OpenID Connect Authentication](/docs/privilegesecure/4.2/accessmanagement/admin/interface/authentication/openidconnectconfigu/openidconnectauthentication.md)
