...
- Name — Displays the name of the policy. See the [Access Policy Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesspolicy/accesspolicy.md)
