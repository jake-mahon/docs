...
time on the [Connection Profiles Page](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesspolicy/connectionprofiles/connectionprofiles.md) page or use the
...
[Users Tab for Credential Based Access Policies](/docs/privilegesecure/4.2/accessmanagement/admin/interface/accesspolicy/credentialbasedpolic/users.md) for
