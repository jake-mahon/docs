...
![globalsettingspage](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/configuration/page/globalsettingspage.webp)
...
- Certificate Thumbprint — The hexadecimal certificate (or thumbprint) value. See the
  [Sign RDP Files to Prevent Publisher Warning](/docs/privilegesecure/4.2/accessmanagement/admin/troubleshooting.md#sign-rdpfiles-to-prevent-publisher-warning)
