...
- Blue + button — Create a resource group. See the [Add a Resource Group](/docs/privilegesecure/4.2/accessmanagement/admin/policy/add/resourcegroup.md)
...
- Manage Local Administrator Accounts — Indicates whether or not local Administrator accounts on
  ...
  See the [Platforms Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/platforms/overview.md) topic for additional information.
...
- Add — Opens the Add Resources window. See the
  [Add Resources Window for Resource Group](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addresourcestogroup.md) topic for
