...
page displays the same information as the [Credentials Dashboard](/docs/privilegesecure/4.2/accessmanagement/admin/dashboard/credentials.md).

![Credentials page](/img/product_docs/activitymonitor/8.0/install/agent/credentials.webp)
...
- Manage — Set the selected account to be managed by Privilege Secure. This button is only available
  ...
  [Manage Internal Service Accounts](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/credentials/manageinternalserviceaccount.md) section
...
- Rotate Service Account — Opens the Account Dependencies window. This button is only available when
  ...
  [Account Dependencies Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/credentials/accountdependencies.md) topic for additional
  information.
- Schedule Rotation — Add the credential rotation task to the queue. This button is only available
  ...
  [Scheduled Tasks Page](/docs/privilegesecure/4.2/accessmanagement/admin/configuration/page/scheduledtasks.md) topic for additional
  information.
...
- View History — Opens the Password History window to displays the password history for the account.
  See the [Password History Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/credentials/passwordhistory.md) topic for additional
  information.
...
- Account — Name of the account. The following icons may also appear in this column:
    ...
    - Information icon — Opens the View Password window to view the password and copy it to the
      ...
      [View Password Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/credentials/viewpassword.md) topic for additional
      information.
...
- Method — Indicates how the account is managed:
    ...
    - Automatic — Credential rotation is managed by Privilege Secure according to the change policy
      for that platform type. See the [Platforms Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/platforms/overview.md) topic for additional
      information.
    - Manual — Credential rotation must be initiated manually with the Rotate Service Account
      ...
      Secure. See the [Service Accounts Page](/docs/privilegesecure/4.2/accessmanagement/admin/configuration/page/serviceaccounts.md) section
    ...
    **NOTE:** See the [Rotation Methods](/docs/privilegesecure/4.2/accessmanagement/admin/policy/credentialrotationmethod.md) topic for additional
    information.
...
- Status — Indicates if the account credentials have been verified by Privilege Secure. See the
  [Platforms Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/platforms/overview.md) topic for additional information on configuring a
