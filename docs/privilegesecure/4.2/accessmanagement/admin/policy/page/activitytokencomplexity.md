...
![Activity Token Complexity Page](/img/product_docs/threatprevention/7.5/reportingmodule/configuration/systemsettings/page.webp)
...
- Green + button — Create a new activity token complexity policy. See the
  [Add Activity Token Complexity Policy](/docs/privilegesecure/4.2/accessmanagement/admin/policy/add/activitytokencomplexity.md) topic for additional
  information.
