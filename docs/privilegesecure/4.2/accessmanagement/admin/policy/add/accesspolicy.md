...
time on the [Connection Profiles Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/connectionprofiles.md) page or use the arrow button
...
- Resource Based Policy
    ...
    - [Users Tab for Resource Based Access Policies](/docs/privilegesecure/4.2/accessmanagement/admin/policy/tab/policyresource/users.md)
