...
![Add New Website Resource](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/add/addnewwebsite.webp)
...
The new website has been onboarded. See the [Website Details Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/details/website.md) topic
