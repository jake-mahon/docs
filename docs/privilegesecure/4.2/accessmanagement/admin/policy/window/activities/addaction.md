...
See the [Action Types](/docs/privilegesecure/4.2/accessmanagement/admin/policy/activityactiontypes.md) section for detailed descriptions of the
fields.
...
Post-Session group. See the [Protection Policies Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/protectionpolicies.md) topic for
