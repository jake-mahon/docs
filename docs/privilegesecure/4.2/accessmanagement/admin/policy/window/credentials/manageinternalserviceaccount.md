...
- Check the user is added to the Privilege Secure console. See the
  [Users & Groups Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/usersgroups.md) topic for additional information.
...
- Information icon — Opens the View Password window to view the password and copy it to the
  clipboard. The window stays open for 20 seconds. See the [View Password Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/credentials/viewpassword.md)
