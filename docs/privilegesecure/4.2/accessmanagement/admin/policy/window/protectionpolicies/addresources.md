...
onboarded in the [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/resources.md).
...
- Name — Displays the name of the resource. Click the link to view additional details. See the
  [Resources Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/resources.md) topic for addition information.
