...
- Add — Opens the Add Activities and Activity Groups window. See the
  [Add Activities and Activity Groups Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/accesspolicy/addactivitiesandactivitygroups.md)
