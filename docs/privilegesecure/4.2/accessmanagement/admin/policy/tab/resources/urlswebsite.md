...
![URLs tab for Website Resource](/img/product_docs/privilegesecure/4.2/accessmanagement/admin/policy/tab/resources/websitedetailsurlstab.webp)
...
- Add — Opens the Add Website URL window. See the
  [Add Website URL Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addwebsiteurl.md) topic for additional
  information.
