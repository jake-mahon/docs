...
- Password Reset Options — Customize password rotation options. This option is only available for
  ...
  [Password Reset Options Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/passwordresetoptions.md) for additional
  information.
...
- Managed — Indicates if the account is managed by Privilege Secure. See the
  [Credentials Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/credentials.md) topic for additional information.
...
- Schedule — Shows the schedule policy used to change the password of a manged account, the
  credential rotation. See the [Schedule Policies Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/schedulepolicies.md) topic for
