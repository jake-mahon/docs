...
- Requested By — User who requested the session. See the
  [User, Group, & Application Details Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/details/usergroupapplication.md) topic for
  additional information.
- Login Account — Displays the account used to log onto the resource
- Activity — Displays the name of the activity. See the [Activities Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/activities.md)
