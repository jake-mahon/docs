...
- Add — Opens the Add a Managed Account window. See the
  [Add a Managed Account Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/addamanagedaccount.md) topic for additional
  information.
- Edit — Opens the Edit a Managed Account window. See the
  [Edit a Managed Account Window](/docs/privilegesecure/4.2/accessmanagement/admin/policy/window/resources/editamanagedaccount.md) topic for
