...
within the [Live Session Viewer Window](/docs/privilegesecure/4.2/accessmanagement/admin/dashboard/window/liveviewer.md) and the
[Replay Viewer Window](/docs/privilegesecure/4.2/accessmanagement/admin/dashboard/window/replayviewer.md) with keystroke details, which are
...
[Connection Profiles Page](/docs/privilegesecure/4.2/accessmanagement/admin/policy/page/connectionprofiles.md) topic for additional
information.
