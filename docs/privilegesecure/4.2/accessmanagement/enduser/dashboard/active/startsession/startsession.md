...
![Connecto to remote session](/img/product_docs/privilegesecure/4.2/accessmanagement/enduser/dashboard/remotesessionlaunch.webp)
...
See the [Configure DirectConnect for Remote Desktop Connection](/docs/privilegesecure/4.2/accessmanagement/enduser/dashboard/active/startsession/rdcmanager.md) topic
