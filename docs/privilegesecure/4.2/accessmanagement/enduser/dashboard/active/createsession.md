...
See the [Start Activity Session](/docs/privilegesecure/4.2/accessmanagement/enduser/dashboard/active/startsession/startsession.md) topic for additional information.
