...
![about_policypak_security_settings](../../../../static/img/product_docs/policypak/policypak/securitysettings/about_policypak_security_settings.webp)
...
- A management station — To start, create a standard Group Policy Object (GPO), editing it with the security settings you want (__Computer Configuration__ __>__ __Policies | Security__). Then use the __Endpoint Policy Manager__ __>__ __Endpoint Policy Manager Security Settings Manager__ node.
