...
![gpcr_server_with_push_mode_21](/static/img/product_docs/policypak/policypak/grouppolicycompliancereporter/mode/push/gpcr_server_with_push_mode_21.png)

Figure 57. Viewing the results for computers within a specific set.

__NOTE:__  You do not need to manually run a snapshot of any set when using push mode, since the data is always flowing from the endpoint to the server. You can manually pull data from a set, however, if you wish.
