...
![gpcr_concepts_and_quickstart_3](/static/img/product_docs/policypak/policypak/grouppolicycompliancereporter/prepare/gpcr_concepts_and_quickstart_3.png)

Figure 4. The word "computer" must appear within the name for the test machine.

__CAUTION:__  The word "computer" must be in the middle of the name, and not the end of the name. Win10Computer64 is a valid name but Win7Computer is not.

__CAUTION:__  It is expressly forbidden by the EULA to have more than 99 machines in trial mode.
