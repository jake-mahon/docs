...
__NOTE:__ For a video demonstrating how neither Endpoint Policy Manager File Associations Manager nor Microsoft's method can affect a user until the second login, see the [Endpoint Policy Manager File Associations Manager: Understanding the First Login](/docs/product_docs/policypak/policypak/video/fileassociations/firstlogin.md) topic for additional information..
