...
__NOTE:__ For a video overview demonstrating how to use the Endpoint Policy Manager File Associations Manager Helper utility, watch this video: [Endpoint Policy Manager File Associations Manager: Helper Application](/docs/product_docs/policypak/policypak/video/fileassociations/helperapplication.md).
