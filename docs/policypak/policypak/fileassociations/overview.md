...
Optionally, if you don't want to use Group Policy, read the section on Advanced Concepts on Group Policy and non–Group Policy methods (MEMCM, KACE, and MDM service or Netwrix Endpoint Policy Manager (formerly PolicyPak) Cloud), located in the [Endpoint Privilege Manager Implementation QuickStart Guide](../leastprivilege/pplpmimplementationguide.md) to deploy your directives.
...
__NOTE:__ For an overview of Endpoint Policy Manager File Associations Manager, see [https://www.policypak.com/products/policypak-file-associations-manager.html](https://www.policypak.com/products/policypak-file-associations-manager.html).
...
__NOTE:__ If you use the Endpoint Policy Manager Cloud service, you can even deliver Group Policy settings to non-domain-joined machines over the Internet.
