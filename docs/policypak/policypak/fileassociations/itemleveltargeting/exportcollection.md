...
__NOTE:__ For a video demonstrating the use of Endpoint Policy Manager Cloud with domain-joined machines. See the [Endpoint Policy ManagerCloud and Endpoint Policy Manager OnPremise – Together using PPCloud Licenses](/docs/policypak/policypak/video/cloud/integration/onpremise.md) topic for additional information.
...
![using_item_level_targeting_9](/img/product_docs/policypak/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_9.png)

![using_item_level_targeting_10](/img/product_docs/policypak/policypak/fileassociations/itemleveltargeting/using_item_level_targeting_10.png)
