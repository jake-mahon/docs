...
![device07](/static/img/product_docs/policypak/policypak/device/devicemanager/device07.png)
...
![device08](/static/img/product_docs/policypak/policypak/device/devicemanager/device08.png)
...
![usb1](/static/img/product_docs/policypak/policypak/device/devicemanager/usb1.png)
...
![device09](/static/img/product_docs/policypak/policypak/device/devicemanager/device09.png)
...
![device10](/static/img/product_docs/policypak/policypak/device/devicemanager/device10.png)
...
![device11](/static/img/product_docs/policypak/policypak/device/devicemanager/device11.png)
...
__NOTE:__ To get an overview of how to acquire SIDs with your MDM service and then use them with Endpoint Policy Manager Device Manager, see the [How do I get Azure AD SIDs and use them with Item Level Targeting?](/docs/product_docs/policypak/policypak/itemleveltargeting/entraidsids.md) and [Block and Allow USB and CD-ROMs with your MDM solution](/docs/product_docs/policypak/policypak/video/device/mdm.md) topics for additional information.

![usb2](/static/img/product_docs/policypak/policypak/device/devicemanager/usb2.png)

In this way you're specifying which user gets what permission. For this example, select __Read Only__.

The next screen lets you give this policy a name, set the state to __Enabled__ or __Disabled__, and/or use __Item Level Targeting__.

The final screen shows the writing of the policy. You can click __Finish__.

![usb3](/static/img/product_docs/policypak/policypak/device/devicemanager/usb3.png)
...
![usb4](/static/img/product_docs/policypak/policypak/device/devicemanager/usb4.png)
...
- Allow specific user(s) to use all devices. This is useful if you want some people to have blanked access to all devices. Not usually advised. See the [Allow ONE user (or group) access to USB and/or CD-ROM and DVDs](/docs/product_docs/policypak/policypak/video/device/usbdriveallowuser.md) topic for additional information.
- Allow specific devices based upon Serial Number(s). See the [Permit specific devices by serial number](/docs/product_docs/policypak/policypak/video/device/serialnumber.md) topic for additional information.
- Allow specific devices based upon BitLocker Key ID (restricts a specific BitLocker device) or Allow ANY BitLocker encrypted volume (useful if you just want to make sure users are using Bitlocker to keep data always encrypted). See the [Restrict access only to Bitlocker drives](/docs/product_docs/policypak/policypak/video/device/bitlockerdrives.md) topic for additional information.
...
__NOTE:__ Not every kind of Phone or WPD device may be immediately supported because they sometimes use protocols which are unexpected. You may open a support case to investigate if we can attempt to support your unique Phone/WPD device.
...
![upd1](/static/img/product_docs/policypak/policypak/device/devicemanager/upd1.png)
...
![wpd3](/static/img/product_docs/policypak/policypak/device/devicemanager/wpd3.png)
