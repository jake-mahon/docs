...
![device04](/img/product_docs/policypak/policypak/device/devicemanager/device04.png)
...
![device05](/img/product_docs/policypak/policypak/device/devicemanager/device05.png)

Your Global policy is now set in the GPO.

![device06](/img/product_docs/policypak/policypak/device/devicemanager/device06.png)
...
![global1](/img/product_docs/policypak/policypak/device/devicemanager/global1.png)
...
![read1](/img/product_docs/policypak/policypak/device/devicemanager/read1.png)

![execute](/img/product_docs/policypak/policypak/device/devicemanager/execute.png)

![writeattemppt](/img/product_docs/policypak/policypak/device/devicemanager/writeattemppt.png)
