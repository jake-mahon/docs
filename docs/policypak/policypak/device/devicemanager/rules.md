...
See the [Device Manager Admin Approval and Automatic Rules Creation](/docs/product_docs/policypak/policypak/video/device/dmapprovalautorules.md) topic for additional information on Admin Approval & Branding and Customization.
...
![aa15](/static/img/product_docs/policypak/policypak/device/devicemanager/aa15.png)

Admin Approval has four tabs:

- General

  - Admin Approval State — __Enable__ or __Disable__ Admin approval
...
- Secret Key
  ...
  - Key — Here is where you can create a secret key by choosing either __Derive from Password__ or __Generate Random__. Then, click __Copy__, and, for now, paste the secret key into Notepad.

- Email

  - Use of Email — __Enabled__ or __Disabled__. When Enabled you can provide an email address. When Disabled you will only get short over the phone codes.
...
![aa14](/static/img/product_docs/policypak/policypak/device/devicemanager/aa14.png)
...
![aa4](/static/img/product_docs/policypak/policypak/device/devicemanager/aa4.png)
...
![aa3](/static/img/product_docs/policypak/policypak/device/devicemanager/aa3.png)
...
![aa5](/static/img/product_docs/policypak/policypak/device/devicemanager/aa5.png)
...
![aa6](/static/img/product_docs/policypak/policypak/device/devicemanager/aa6.png)
...
![aa7](/static/img/product_docs/policypak/policypak/device/devicemanager/aa7.png)
...
![aa8](/static/img/product_docs/policypak/policypak/device/devicemanager/aa8.png)
...
- Or on a single machine you may erase the value for the device you granted Permanent access to. See the [What are the registry settings for Device Manager (and how do I reset Device Manager Admin Approval)?](/docs/product_docs/policypak/policypak/device/registry.md) topic for additional information.

## Admin Approval Using Email Method

You can use Admin Approval requests to go through your service desk as email requests. See the [Endpoint Policy Device Manager and End-User Emails to Support](/docs/product_docs/policypak/policypak/video/device/enduser.md) topic for additional information.
...
## ![aa9](/static/img/product_docs/policypak/policypak/device/devicemanager/aa9.png)
...
![aa10](/static/img/product_docs/policypak/policypak/device/devicemanager/aa10.png)
...
![aa11](/static/img/product_docs/policypak/policypak/device/devicemanager/aa11.png)
...
![aa12](/static/img/product_docs/policypak/policypak/device/devicemanager/aa12.png)
...
Copy the code and then select __New Policy from Audit Event or Admin Approval Code__.

Paste in the Request code and follow the Wizard to generate the rule which you need.

![aa13](/static/img/product_docs/policypak/policypak/device/devicemanager/aa13.png)
...
![event1](/static/img/product_docs/policypak/policypak/device/devicemanager/event1.png)

# ![event2](/static/img/product_docs/policypak/policypak/device/devicemanager/event2.png)
