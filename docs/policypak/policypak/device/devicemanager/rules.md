...
See the
[Device Manager Admin Approval and Automatic Rules Creation](../../video/device/dmapprovalautorules.md)
...
- Or on a single machine you may erase the value for the device you granted Permanent access to. See
  the
  [What are the registry settings for Device Manager (and how do I reset Device Manager Admin Approval)?](../registry.md)
...
[Endpoint Policy Device Manager and End-User Emails to Support](../../video/device/enduser.md) topic
