...
First know that Windows 7 is not officially supported by Netwrix Endpoint Policy Manager (formerly PolicyPak) and may or may not work for all functions.
...
Then to adjust on these computers, all pre-Windows 10 machines must be upgraded to use TLS 1.2 on the client. The
how-to from Microsoft is here:[https://docs.microsoft.com/en-us/mem/configmgr/core/plan-design/security/enable-tls-1-2-client](https://docs.microsoft.com/en-us/mem/configmgr/core/plan-design/security/enable-tls-1-2-client)The
...
If you wish to script the installation of the KB3140245 hotfix and the Registry with the "Easy fix" you
...
requires TLS 1.2; and the machine you're trying to update doesn't support that yet.  Note also that
