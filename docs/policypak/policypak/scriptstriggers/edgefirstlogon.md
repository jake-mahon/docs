...
__Step 1 –__ Create a new Scripts and Triggers Policy on the Computer side that runs in Switched Mode or on the User side.

__Step 2 –__ Use the script below and be sure to check the option to run the script interactively and as the user.

![868_1_image-20220225024809-1_950x457](/static/img/product_docs/policypak/policypak/scriptstriggers/868_1_image-20220225024809-1_950x457.png)
...
![868_2_image-20220225024809-2](/static/img/product_docs/policypak/policypak/scriptstriggers/868_2_image-20220225024809-2.png)

__Step 4 –__ At the Trigger settings" screen set a delay if desired otherwise click "Next" the skip this option.

__Step 5 –__ At the "Policy settings" screen give the policy a descriptive name then click "Finish".
...
![868_3_image-20220225024809-3_900x490](/static/img/product_docs/policypak/policypak/scriptstriggers/868_3_image-20220225024809-3_900x490.png)
