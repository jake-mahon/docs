...
[Endpoint Policy Manager Cloud: Immutable Log](../../../video/cloud/security/immutablelog.md).
...
[Endpoint Policy Manager Cloud Logs and Automatically Pushing via Email](../../../video/cloud/security/emaillogs.md).
