...
[Endpoint Policy Manager Cloud: Security Features](/docs/policypak/policypak/video/cloud/security/features.md).
...
[Endpoint Policy Manager Cloud: Strict vs. Loose Computer Registration Mode](/docs/policypak/policypak/video/cloud/registrationmode.md).
