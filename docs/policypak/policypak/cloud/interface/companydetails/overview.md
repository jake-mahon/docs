...
[Endpoint Policy Manager Cloud: Security Features](../../../video/cloud/security/features.md).
...
[Endpoint Policy Manager Cloud: Strict vs. Loose Computer Registration Mode](../../../video/cloud/registrationmode.md).
