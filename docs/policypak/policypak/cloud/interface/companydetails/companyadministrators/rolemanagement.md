...
![web_interface_and_controls_85_624x118](../../../../../../../static/img/product_docs/policypak/policypak/cloud/interface/companydetails/companyadministrators/web_interface_and_controls_85_624x118.webp)
...
- Authentication Options Admin: An admin with this role can specify which admins can have which 2FA
  ...
  [Edit Customer-Level Portal Policies](../editcustomerlevelportalpolicies.md) section.
...
- Notification & Logging Options Admin: An admin with this role can use the **Notifications Editor**
  ...
  [Edit Notification Configuration](../editnotificationconfiguration.md) section).
