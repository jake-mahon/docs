...
Then export using PP Settings Manager to an XML. [Endpoint Policy ManagerCloud: How to deploy Microsoft Group Policy Settings using Endpoint Policy Manager Cloud](/docs/product_docs/policypak/policypak/video/cloud/deploy/grouppolicysettings.md)
