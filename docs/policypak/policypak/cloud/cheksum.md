...
__NOTE:__  This is only for BUILD ISO/ ZIPs and not available for other items such as XML guidance or scripts.

After you download the software, use the build-in windows command line to validate the SHA256 checksum.

![912_1_image001_950x439](/static/img/product_docs/policypak/policypak/cloud/912_1_image001_950x439.png)
...
![912_2_image002_950x217](/static/img/product_docs/policypak/policypak/cloud/912_2_image002_950x217.png)
