...
__Step 5 –__ You can select the drop-down option to select the __Event IDs__. See the [List of Endpoint Policy Manager Event Categories and IDs](../../tips/eventcategories.md) topic for additional information on the event categories and IDs.
