...
![Restoring the Right-Click Context Menu](../../../../../../static/img/product_docs/policypak/policypak/troubleshooting/log/leastprivilege/restorecontextmenu.webp)

Use Endpoint Policy Manager Scripts Manager to perform this action, one time, on the computer side.

__NOTE:__ There are two PowerShell scripts. Select the script to use according to the Endpoint Policy Manager configuration that is implemented. It is recommended to perform a small-scale test before rolling this update out to the entire organization.
