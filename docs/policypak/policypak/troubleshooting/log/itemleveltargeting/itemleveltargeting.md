...
![itemleveltargeting1](/static/img/product_docs/policypak/policypak/troubleshooting/log/itemleveltargeting/itemleveltargeting1.png)
...
__Step 1 –__ Make your policy and get the ILT as close as possible using “Computer in Group” instead of “User in Group.”

__Step 2 –__ Drop the XML to Notepad. Hand edit the policy to ```userContext="1"``` (0=Computer is in Group).

__Step 3 –__ Delete the original policy.

__Step 4 –__ Drop in the modified policy.

__NOTE:__ The modified policy will process correctly, but the editor still wont magically show “User in group.”

![itemleveltargeting2](/static/img/product_docs/policypak/policypak/troubleshooting/log/itemleveltargeting/itemleveltargeting2.png)
