...
__Step 4 –__ After that, reproduce the problem, and run``` PPLOGS``` as seen in Step 3 [What must I send to Endpoint Policy Manager support in order to get the FASTEST support?](../fastsupport.md) and attach to your support case.
