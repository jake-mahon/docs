...
- Unlink the old and expiring license after verifying that the new license will cover the same
  ...
  [I just installed new license files / new GPOs. Should I keep or delete the old license files / GPOs?](../../license/unlicense/fileold.md)

**NOTE:** You can use the LT tool to search through and find OLD licenses so you can be sure you
only have one license remaining. [Using LT for license cleanup](../../video/license/cleanup.md)/
