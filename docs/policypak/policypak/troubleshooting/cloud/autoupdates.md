...
__Step 1 –__ DO NOT UNINSTALL the previous Endpoint Policy Manager Cloud Client MSI or Endpoint Policy Manager Client Side Extension.

__Step 2 –__ Just install the latest-downloaded Cloud Client MSI from the Endpoint Policy Manager Portal (COMPANY DETAILS) tab…

__Step 3 –__ On top of your existing endpoint computer that is not getting policies or licenses.
