...
__Step 1 –__ Endpoint Policy Manager Cloud data is processed first.

__Step 2 –__ XML data files are processed next in the following order:

1. Group
2. User
3. Computer

__Step 3 –__ Group Policy is processed next in the following order:
