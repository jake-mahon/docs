...
For more information [How must I configure my Anti-virus or system-level software to work with Endpoint Policy Manager CSE?](../../../install/antivirus.md).

Example of error and results in Event log:

![97_1_carbonblack1](../../../../../../static/img/product_docs/policypak/policypak/troubleshooting/error/install/97_1_carbonblack1.webp)
