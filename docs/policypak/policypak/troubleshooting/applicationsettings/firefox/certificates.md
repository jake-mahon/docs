...
[Firefox: What versions of the Endpoint Policy Manager CSE support managing certificates in what versions of Firefox?](/docs/product_docs/policypak/policypak/requirements/support/applicationsettings/firefox/version.md)

__Step 2 –__ Watch the Netwrix Endpoint Policy Manager (formerly PolicyPak) and Firefox cert video for a how-to

__Step 3 –__ The most common reason certificates fail to import is because they are the WRONG FORMAT.
...
__Step 4 –__ Look at the Endpoint Policy Manager ppSwitched.log file
...
__Step 5 –__ Is the Endpoint Policy Manager Firefox Plug in working?
