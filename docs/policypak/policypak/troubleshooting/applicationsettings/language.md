...
__Step 1 –__ Netwrix Endpoint Policy Manager (formerly PolicyPak) Application Manager itself (the software) is only localized to English.

__Step 2 –__ Endpoint Policy Manager manuals are only in English.

__Step 3 –__ Endpoint Policy Manager support is only performed in English.

__Step 4 –__ Endpoint Policy Manager Application Manager Paks are performed on the US English version of applications. Here is what that means:
...
__NOTE:__ Endpoint Policy Manager (the company) will not be able to do this for you; but you are welcome to use the Endpoint Policy Manager DesignStudio for this purpose.
