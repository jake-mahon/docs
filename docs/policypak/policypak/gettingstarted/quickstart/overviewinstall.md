...
__NOTE:__ This guide provides you with the most basic steps to get Endpoint Policy Manager unpacked and installed and ready to use. See the other topics in the parent publication, as well as the [Knowledge Base](/docs/product_docs/policypak/policypak/install/overview/knowledgebase.md) > All Things Installation & Upkeep and the All Things Installation & Upkeep [Video Learning Center](/docs/product_docs/policypak/policypak/install/overview/videolearningcenter.md) topics for additional information.

If you are unfamiliar with what Endpoint Policy Manager even does, consider watching this two minute overview: [Endpoint Policy Manager Explained: In about two minutes](/docs/product_docs/policypak/policypak/video/grouppolicy/explained.md).
