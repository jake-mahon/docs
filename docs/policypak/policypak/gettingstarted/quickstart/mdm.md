...
[Endpoint Policy Manager and Microsoft Intune](/docs/policypak/policypak/video/mdm/microsoftintune.md). The installation
steps are below.
...
[How to create a DC for editing purposes](/docs/policypak/policypak/video/cloud/testlab/createdc.md) video for details
and how to do this.
...
Follow the [Endpoint Policy Manager and MDM walk before you run](/docs/policypak/policypak/video/mdm/testsample.md)
