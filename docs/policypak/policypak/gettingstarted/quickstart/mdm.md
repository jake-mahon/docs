...
For a video overview of MDM delivery via Intune, see the [Endpoint Policy Manager and Microsoft Intune](/docs/policypak/policypak/video/mdm/microsoftintune.md). The installation steps are below.
...
Follow the [Endpoint Policy Manager and MDM walk before you run](/docs/policypak/policypak/video/mdm/testsample.md) video to install an MDM license file.

Check the [What is the fastest way to get started in an Endpoint Policy Manager trial, without running the License Request Tool?](/docs/policypak/policypak/license/trial.md) topic to see how to rename a computer or perform alternative licensing.
