...
For a video overview of MDM delivery via Intune, see the [Endpoint Policy Manager and Microsoft Intune](../../video/mdm/microsoftintune.md). The installation steps are below.
...
Follow the [Endpoint Policy Manager and MDM walk before you run](../../video/mdm/testsample.md) video to install an MDM license file.
