...
[Endpoint Policy Manager and Microsoft Intune](../../video/mdm/microsoftintune.md). The installation
steps are below.
...
[How to create a DC for editing purposes](../../video/cloud/testlab/createdc.md) video for details
and how to do this.
...
Follow the [Endpoint Policy Manager and MDM walk before you run](../../video/mdm/testsample.md)
video to install an MDM license file.

Check the
[What is the fastest way to get started in an Endpoint Policy Manager trial, without running the License Request Tool?](../../license/trial.md)
