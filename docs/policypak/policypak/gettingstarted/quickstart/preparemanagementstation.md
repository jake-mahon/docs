...
![preparemanagementstation1](/static/img/product_docs/policypak/policypak/gettingstarted/quickstart/preparemanagementstation1.png)
...
__TIP__: Use the instructions in the [What are the two ways that can I install the GPMC on my Admin Station (Server or Windows 10) machine?](/docs/product_docs/policypak/policypak/install/methods.md) topic if you do not yet have the GPMC on your management station.

__NOTE:__ The Endpoint Policy Manager MMC Group Policy Snap-In does NOT require installation on a Domain Controller, it is simply an option. See the [Does Endpoint Policy Manager admin console need to be installed on Domain Controller (DC)?](/docs/product_docs/policypak/policypak/install/adminconsole.md) topic for details.
...
![preparemanagementstation2](/static/img/product_docs/policypak/policypak/gettingstarted/quickstart/preparemanagementstation2.png)
...
![preparemanagementstation3](/static/img/product_docs/policypak/policypak/gettingstarted/quickstart/preparemanagementstation3.png)

Additional resources you may be interested in:

- [How to create a DC for editing purposes](/docs/product_docs/policypak/policypak/video/cloud/testlab/createdc.md)
- [Admin Console And CSE Installation](/docs/product_docs/policypak/policypak/video/grouppolicy/install.md)
