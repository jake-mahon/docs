...
__NOTE:__ See the [Endpoint Policy Manager Cloud and SUDO support](/docs/policypak/policypak/video/leastprivilege/mac/sudosupport.md) video and the [Endpoint Policy Manager Cloud Mac + SUDO Using Wildcard Example](/docs/policypak/policypak/video/leastprivilege/mac/wildcards.md) video for an overview of this section.
