...
__NOTE:__ See [Endpoint Policy Manager MacOS: Mac Finder Policies](/docs/policypak/policypak/video/leastprivilege/mac/finder.md) video for an overview of this section.
...
![macfinder01](/img/product_docs/policypak/policypak/mac/scenarios/macfinder01.png)

Standard Users also get similar behavior if they attempt to remove an application from the machine.

![macfinder02](/img/product_docs/policypak/policypak/mac/scenarios/macfinder02.png)
...
![macfinder03](/img/product_docs/policypak/policypak/mac/scenarios/macfinder03.png)
...
![macfinder04](/img/product_docs/policypak/policypak/mac/scenarios/macfinder04.png)

This first example policy will allow users to add/remove applications to the ```/Applications``` folder.

![macfinder05](/img/product_docs/policypak/policypak/mac/scenarios/macfinder05.png)
...
![macfinder06](/img/product_docs/policypak/policypak/mac/scenarios/macfinder06.png)

## Testing your Policies

First synchronize your policies with Endpoint Policy Manager Cloud using the ```policypak cloud-sync``` command.

![macfinder07](/img/product_docs/policypak/policypak/mac/scenarios/macfinder07.png)

An example of the results for the first policy which enabled installation are seen below.

![macfinder08](/img/product_docs/policypak/policypak/mac/scenarios/macfinder08.png)

And copying a file to ```/Users/Test``` also succeeds:

![macfinder09](/img/product_docs/policypak/policypak/mac/scenarios/macfinder09.png)
...
See the [Endpoint Policy Manager MacOS: Mac Finder Policies](/docs/policypak/policypak/video/leastprivilege/mac/finder.md) video for examples of Action types with Finder policies
