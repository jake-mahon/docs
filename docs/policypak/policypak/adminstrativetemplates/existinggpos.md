...
__NOTE:__ See the [Reduce GPOs (and/or export them for use with Endpoint Policy Manager Cloud or with MDM)](/docs/product_docs/policypak/policypak/video/mdm/exportgpos.md) topic for more information.
...
![merging_and_reducing_existing](/static/img/product_docs/policypak/policypak/adminstrativetemplates/merging_and_reducing_existing.png)

To run the tool, locate the downloadable ISO file in the Endpoint Policy Manager Extras folder, as seen below.

![merging_and_reducing_existing_1](/static/img/product_docs/policypak/policypak/adminstrativetemplates/merging_and_reducing_existing_1.png)
