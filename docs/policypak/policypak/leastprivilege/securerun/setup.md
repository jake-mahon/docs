...
[Stop Ransomware and other unknown zero day attacks with Endpoint Policy Manager SecureRun(TM)](/docs/policypak/policypak/video/leastprivilege/securerun/stopransomware.md).
