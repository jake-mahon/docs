...
- See the [Installing applications-and-Preconfigured-Rules](/docs/policypak/policypak/video/leastprivilege/installapplications.md) video for an overview of how to use preconfigured Endpoint Policy ManagerLeast Privilege Manager XML examples.
- A common request is to overcome the Print dialog. As such we have a preconfigured rule to help with that. See the [Endpoint Privilege Manager: Install Printers via Native NTPRINT Dialog](/docs/policypak/policypak/video/leastprivilege/ntprintdialog.md) video for an example.
- Another common request is to overcome the Windows Ethernet & IP address GUI. As such we have a preconfigured rule to help with that. See the [Endpoint Privilege Manager: Edit IP SETTINGS EDIT VIA WIN GUI](/docs/policypak/policypak/video/leastprivilege/wingui.md) video for an example.
