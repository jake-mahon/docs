...
see [SecureRun to block User AND System executables](../../video/leastprivilege/bestpractices/securerun/usersystemexecutables.md)
...
video
3: [Elevate apps as standard user, BLOCK other Admins](../../video/leastprivilege/bestpractices/appblock.md)
