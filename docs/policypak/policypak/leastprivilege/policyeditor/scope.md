...
see [SecureRun to block User AND System executables](/docs/policypak/policypak/video/leastprivilege/bestpractices/securerun/usersystemexecutables.md)
...
video
3: [Elevate apps as standard user, BLOCK other Admins](/docs/policypak/policypak/video/leastprivilege/bestpractices/appblock.md)
