...
**NOTE:** See the
[Endpoint Privilege Manager and Wildcards](/docs/policypak/policypak/video/leastprivilege/bestpractices/wildcards.md) video
...
discussed in the [Best Practices](/docs/policypak/policypak/leastprivilege/bestpractices/overview.md) section), those automatic rules can go
out of date quickly.
...
generated](/img/product_docs/policypak/policypak/leastprivilege/using_wildcards_with_policypak.webp)
...
Description automatically
generated](/img/product_docs/policypak/policypak/leastprivilege/using_wildcards_with_policypak_1.webp)
