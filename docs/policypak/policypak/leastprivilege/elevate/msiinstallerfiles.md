...
Description automatically generated](/static/img/product_docs/policypak/policypak/leastprivilege/elevate/elevating_msi_installer_files.png)
...
__NOTE:__ We realize that hash values often change for installers, but using Hash is only for the Quick Start. To learn how to authorize users to keep applications up to do date, learn about Combo rules in [Best Practices and Miscellaneous Topics](/docs/product_docs/policypak/policypak/leastprivilege/bestpractices/overviewmisc.md).

On the next page, click __Select windows installer__ and select the SkypeSetup.MSI package (previously downloaded).

![A screenshot of a computer

Description automatically generated](/static/img/product_docs/policypak/policypak/leastprivilege/elevate/elevating_msi_installer_files_1.png)
...
Description automatically generated](/static/img/product_docs/policypak/policypak/leastprivilege/elevate/elevating_msi_installer_files_2.png)

Now you will see an entry in the Endpoint Policy Manager (formerly PolicyPak) Least Privilege Manager MMC.

![A screenshot of a computer

Description automatically generated](/static/img/product_docs/policypak/policypak/leastprivilege/elevate/elevating_msi_installer_files_3.png)
