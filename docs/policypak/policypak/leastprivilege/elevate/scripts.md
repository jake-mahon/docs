...
__NOTE:__ For an overview on elevating scripts and preventing scripts from running, which could need admin rights, see the [Elevate (or smack down) scripts and Java JAR files](/docs/policypak/policypak/video/leastprivilege/elevate/scripts.md) video.
