...
You can extend this list by enabling the Endpoint Policy Manager ADMX setting and entering required keywords. If you don't know how to enable Endpoint Policy Manager ADMX settings then see this link: [Troubleshooting with ADMX files](/docs/policypak/policypak/video/troubleshooting/admxfiles.md)
