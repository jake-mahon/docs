...
__NOTE:__ See the [Security and Child Processes](../../video/leastprivilege/bestpractices/securitychildprocesses.md) video for an overview of using Endpoint Policy Manager (formerly PolicyPak) Least Privilege Manager and Child Processes rules.
...
If, however, you need to keep __Apply to Child Processes__ on, you have some additional security mechanisms to prevent application to child processes in all circumstances.
