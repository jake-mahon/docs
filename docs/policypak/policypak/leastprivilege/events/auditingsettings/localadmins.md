...
An example can be seen here with TreeSize Free (Administrator). When you run the app as an administrator, you are prompted with a UAC prompt. When you click __Yes__", the Event 6200 occurs, as shown here.

![A screenshot of a computer

Description automatically generated](../../../../../../static/img/product_docs/policypak/policypak/leastprivilege/events/auditingsettings/discovery_for_elevated_apps.webp)
