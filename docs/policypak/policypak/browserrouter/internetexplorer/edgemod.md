...
Mode, please see:
[Endpoint Policy Manager Browser Router: Internet Explorer in Edge mode](../../video/browserrouter/ieedgemode.md).
...
Create a rule for
[www.policypak.com](http://www.policypak.com/video/policypak-browser-router-and-ports.html) and
...
[https://docs.microsoft.com/en-us/microsoft-edge/deploy/emie-to-improve-compatibility](http://www.policypak.com/video/policypak-troubleshooting-with-admx-files.html).
From the first time a user accesses
[www.policypak.com](http://www.policypak.com/knowledge-base/browser-router-troubleshooting/how-to-quickly-troubleshoot-policypak-browser-router.html),
