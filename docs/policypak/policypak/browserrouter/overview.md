...
[Installation Quick Start](../gettingstarted/quickstart/overviewinstall.md), which explain how to:
...
in[Using Endpoint Policy Manager with MDM and UEM Tools](../mdm/uemtools.md). This information on
how to deploy your directives.

**NOTE:** Watch this video for an overview of Endpoint Policy Manager Browser Router:
[](http://www.policypak.com/video/policypak-browser-router-ensure-users-utilize-the-right-browser-for-the-right-website.html)[Ensure users utilize the RIGHT browser for the right website !](../video/browserrouter/rightbrowser.md).
...
- Export policies or collections as XML files (which can be used with Endpoint Policy Manager
  ...
  [Using Endpoint Policy Manager with MDM and UEM Tools](../mdm/uemtools.md) for more details.
...
[Using PP Browser Router on Citrix or RDS servers with published browser applications](../video/browserrouter/citrix.md).
