...
you a formal quote.
See [How to Request Licenses from Endpoint Policy Manager by Creating a "License Request Key"](/docs/policypak/policypak/video/license/licenserequestkey.md)
...
reacts:[Testing and Troubleshooting By Renaming an endpoint Computer](/docs/policypak/policypak/video/cloud/testlab/renameendpoint.md)
...
- Follow these directions to get started with on-Prem Active Directory/ Group Policy: Getting
  Started with Group Policy > [Knowledge Base](/docs/policypak/policypak/grouppolicy/overview/knowledgebase.md) and/or
- Follow these directions to get started with Endpoint Policy Manager and Intune or another MDM
  ...
  [Video Learning Center](/docs/policypak/policypak/mdm/overview/videolearningcenter.md)
...
Cloud > [Video Learning Center](/docs/policypak/policypak/cloud/overview/videolearningcenter.md).
...
Portal.[How to install UNIVERSAL licenses for NEW Customers (via GPO, SCCM or MDM)](/docs/policypak/policypak/video/license/installuniversal.md)Then
follow these directions to get started with on-Prem Active Directory/ Group Policy: Group
Policy > [Knowledge Base](/docs/policypak/policypak/grouppolicy/overview/knowledgebase.md)
...
here: [How to install UNIVERSAL licenses for NEW Customers (via GPO, SCCM or MDM)](/docs/policypak/policypak/video/license/installuniversal.md)
