...
A: We do it for you. For Windows, Office and Endpoint Policy Manager ADMX settings. See [Endpoint Policy ManagerCloud: Use in-cloud ADMX settings maintained by Endpoint Policy Manager for Windows, Office, Chrome and more](/docs/product_docs/policypak/policypak/video/cloud/admxsettings.md)
...
A: Yes. See [Endpoint Policy ManagerCloud: Upload and use your own ADMX files to Endpoint Policy Manager Cloud](/docs/product_docs/policypak/policypak/video/cloud/admxfiles.md)
