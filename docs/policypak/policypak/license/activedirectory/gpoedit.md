...
After a GPO is created (not by you), and you edit it, see [The License Tool (LT) isn't permitting me to install License Files (or I am using AGPM, GPA, or GPOAdmin.) What should I try?](/docs/product_docs/policypak/policypak/license/activedirectory/wizard.md) for additional information. You will import the license files while editing the GPO.
...
See[Using Shares to Store Your Paks (Share-Based Storage)](/docs/product_docs/policypak/policypak/video/applicationsettings/shares.md) for additional information on using shares with Endpoint Policy Manager Admin Templates Manager.
