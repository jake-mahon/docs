...
See [How to Un-License any Endpoint Policy ManagerComponent via ADMX or Endpoint Policy Manager Cloud](../../video/license/unlicense.md) for additional information on this topic.

__NOTE:__ You need to first install the Endpoint Policy Manager ADMX files as seen in [Troubleshooting with ADMX files](../../video/troubleshooting/admxfiles.md).
