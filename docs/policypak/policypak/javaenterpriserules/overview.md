...
__NOTE:__ See this video [Use Endpoint Policy Manager Cloud to choose which version of Java for what website](/docs/product_docs/policypak/policypak/video/javaenterpriserules/cloud.md) for an overview of Endpoint Policy Manager Java Rules Manager.
...
- Export policies or collections as XML files for use with PolicyPak Exporter and PolicyPak Cloud. See [Exporting Collections](/docs/product_docs/policypak/policypak/javaenterpriserules/exportcollections.md) for additional information.
...
![about_policypak_java_rules](/static/img/product_docs/policypak/policypak/javaenterpriserules/about_policypak_java_rules.png)
...
__NOTE:__ If you use the PolicyPak Cloud service, you can deliver Group Policy settings even to non-domain-joined machines over the Internet.
