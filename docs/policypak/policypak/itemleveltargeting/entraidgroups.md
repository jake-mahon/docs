...
We have videos for each scenario, which can be found here: Getting Started with MDM > [Video Learning Center](/docs/product_docs/policypak/policypak/mdm/overview/videolearningcenter.md) We recommend you watch all three videos
...
__NOTE:__  Scripts are available in the Advice section of the Portal.
