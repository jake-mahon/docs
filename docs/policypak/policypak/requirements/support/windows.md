...
Clients: [https://learn.microsoft.com/en-us/windows/release-health/supported-versions-windows-client](https://learn.microsoft.com/en-us/windows/release-health/supported-versions-windows-client)
...
__NOTE:__   For complete clarity, Endpoint Policy Manager is not supported on Server 2012 R2, Windows 7, and so on. The final build with best effort support is 23.8, and no more builds will be produced after that.
