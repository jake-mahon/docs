...
![crafting_the_user_interface_18_624x507](../../../../../../static/img/product_docs/policypak/policypak/applicationsettings/designstudio/userinterface/crafting_the_user_interface_18_624x507.webp)
...
__CAUTION:__ Elements that are manually added are not eligible for Endpoint Policy Manager AppLock™. That is, if these elements were not captured by the Capture Wizard, they cannot be locked out. Therefore, manually added elements are underlined, demonstrating that they cannot be locked out using Endpoint Policy Manager AppLock™.
