...
![using_designstudio_tools_2](/static/img/product_docs/policypak/policypak/applicationsettings/designstudio/tools/options/using_designstudio_tools_2.png)

Figure 166. The Compilation tab.

__NOTE:__  that only administrators can compile AppSets directly to this location. If you are running Endpoint Policy Manager DesignStudio as a standard user (non-administrator) you are prompted for an alternate (writable) location. After compiling, you can use an administrator account to copy the AppSet DLL file to ```c:\Program Files\PolicyPak\Extensions``` to use it within the Group Policy Editor.
