...
__Step 1 –__ Install the Java Access Bridge (free software from Java/Oracle).

__Step 2 –__ Fully turn off user account control (during the user interface [UI] capture).
