...
Video: To see an overview of how to use Endpoint Policy Manager DesignStudio, watch this video: [Creating Your First Pak using Endpoint Policy Manager Design Studio](/docs/product_docs/policypak/policypak/video/applicationsettings/designstudio/firstpak.md).

__NOTE:__  The Endpoint Policy Manager format is properly called "pXML" format. You most likely will never need to edit any pXML files by hand, but you're welcome to open up and explore the files that are produced by the wizard.
