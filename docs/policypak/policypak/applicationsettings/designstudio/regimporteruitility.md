...
__NOTE:__  For an overview of this section, see this video: [Use the DesignStudio to import existing registry keys](/docs/product_docs/policypak/policypak/video/applicationsettings/designstudio/importregistry.md).
...
![using_the_reg_importer_utility](/static/img/product_docs/policypak/policypak/applicationsettings/designstudio/using_the_reg_importer_utility.png)
...
![using_the_reg_importer_utility_1](/static/img/product_docs/policypak/policypak/applicationsettings/designstudio/using_the_reg_importer_utility_1.png)

Figure 163. The .reg importer utility interface.

For a full end-to-end example on this mini-utility, please watch the video here: [Use the DesignStudio to import existing registry keys](/docs/product_docs/policypak/policypak/video/applicationsettings/designstudio/importregistry.md).
