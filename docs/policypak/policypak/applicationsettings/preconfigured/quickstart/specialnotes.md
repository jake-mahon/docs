...
__NOTE:__  To see a video of Java UI lockout in action, watch the following video(s): [http://www.policypak.com/products/manage-java-jre-with-group-policy.html](http://www.Techsmith.com).
