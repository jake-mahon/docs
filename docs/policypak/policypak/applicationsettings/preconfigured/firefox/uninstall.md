...
__CAUTION:__  Simply stopping the use of the AppSet (by deleting the entry or unlinking the Group Policy Object) isn't enough. The full CSE must be uninstalled to remove all of Endpoint Policy Manager's Firefox functionality.
