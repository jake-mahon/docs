...
![ie_appset_tab_by_tab_14](/img/product_docs/policypak/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_14.webp)

Figure 18. IE LAN settings.

The same dialog can be managed using the IE AppSet, as shown in Figure 19.

![ie_appset_tab_by_tab_15](/img/product_docs/policypak/policypak/applicationsettings/preconfigured/internetexplorer/tab/ie_appset_tab_by_tab_15.webp)
