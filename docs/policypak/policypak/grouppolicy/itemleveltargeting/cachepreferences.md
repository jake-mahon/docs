...
__NOTE:__ If the ILT evaluation takes more than 2 minutes for any reason, it is assumed the ILT is true.

__NOTE:__ Cached values are stored permanently until we know they are changed. In other words, until Group Policy or policy updates occur and ILT re-evaluation succeeds.
