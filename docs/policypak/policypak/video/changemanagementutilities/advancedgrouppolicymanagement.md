...
AGPM is a great utility to handle the workflow around Group Policy management. But, to be super clear, AGPM doesn't add any "super powers" to your Group Policy infrastructure. You don't suddenly get more [https://dev.policypak.com/lockdown-recordings-portal/](https://dev.policypak.com/lockdown-recordings-portal/) capability on your Windows client machines.
...
That being said, however, Endpoint Policy Manager does work with Microsoft AGPM – superbly. So, if you've got Microsoft's AGPM, Endpoint Policy Manager just fits right in, right at [https://dev.policypak.com/](https://dev.policypak.com/) like the Group Policy items in the box.
