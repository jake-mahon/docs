...
We'll go ahead and click on this guy right here, "Mozilla Firefox." We'll change the [https://dev.policypak.com/](https://dev.policypak.com/) from "about:blank" to "www.web1.com," just something like that. So we've changed the homepage to "www.web1.com," and we'll go ahead and click "OK." That's it.
