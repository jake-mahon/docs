...
See the [What must I send to Endpoint Policy Manager support in order to get the FASTEST support?](/docs/product_docs/policypak/policypak/troubleshooting/fastsupport.md) topic for additional information on current support policies and how to get the fastest support.
