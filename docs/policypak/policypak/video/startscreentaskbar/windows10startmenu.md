...
You can see, we already have three groups that are here in the [https://www.policypak.com/pp-blog/windows-10-start-screen](https://www.policypak.com/pp-blog/windows-10-start-screen). We're going to create our own called Our Important Apps. What are we're going to add there? We're going to add maybe "Adobe Reader," maybe add the "Calculator" and also add and Edge tile. We'll see how to do that.
...
Then the last thing I'll do is I'll "Add/New Edge Tile." My Edge tile will let me give it a name. I'll call this "Get Endpoint Policy Manager Help," and then the "URL" can be [https://www.policypak.com](https://www.policypak.com); There we go, and click "Next" and I can make this a "Wide" tile.
...
Endpoint Policy Manager Start Screen Manager is a real game changer. Continue to watch the other videos, like how to change [Endpoint Policy Manager File Associations Manager: Manage Windows 10 & 11 File Associations](../fileassociations/windows10.md) settings, to see how you can easily open PDFs, MAILTO and MP4s with the programs you want.
