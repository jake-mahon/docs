...
- You want to deliver user-side-only Microsoft's GPPreferences items to computers, that is, [Deploying Endpoint Policy Managerdirectives without Group Policy (Endpoint Policy Manager Exporter Utility)](../video/methods/exporterutility.md)
