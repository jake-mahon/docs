...
![quickstart_using_policypak_9](/static/img/product_docs/policypak/policypak/preferences/quickstart_using_policypak_9.png)
...
__NOTE:__ In the real world, your software delivery tool would provide credentials and elevate the install, and the MSI would install silently in the background.
...
![quickstart_using_policypak_10](/static/img/product_docs/policypak/policypak/preferences/quickstart_using_policypak_10.png)

__NOTE:__ This demonstration will only work successfully when the computer is in Licensed or Trial mode (with "computer" in the name) and the Endpoint Policy Manager Preferences Manager client-side extension (CSE) is installed on the machine.
