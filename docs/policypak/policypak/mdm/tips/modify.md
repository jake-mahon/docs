...
![policypak_exporter_tips_tricks_2](../../../../../static/img/product_docs/policypak/policypak/mdm/tips/policypak_exporter_tips_tricks_2.webp)
...
__NOTE:__  You can learn more about how the product version attribute is used within MSI files in this technical note from Microsoft: [http://msdn.microsoft.com/en-us/library/windows/desktop/aa370579(v=vs.85).aspx](http://msdn.microsoft.com/en-us/library/windows/desktop/aa370579(v=vs.85).aspx).
