...
**NOTE:** See [Endpoint Policy Manager and Microsoft Intune](/docs/policypak/policypak/video/mdm/microsoftintune.md) for
...
[Troubleshooting](/docs/policypak/policypak/troubleshooting/mdm/overview.md) section.
