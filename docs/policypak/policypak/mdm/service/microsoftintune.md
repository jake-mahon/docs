...
__NOTE:__ See [Endpoint Policy Manager and Microsoft Intune](/docs/policypak/policypak/video/mdm/microsoftintune.md) for an overview video of Endpoint Policy Manager and Microsoft Intune MDM.
...
Once you select the group, you can change the Deployment Action to Required Install. Be sure the computer is MDM-joined and in the correct group. If the MSIs do not download as expected, see the [Troubleshooting](/docs/policypak/policypak/troubleshooting/mdm/overview.md) section.
