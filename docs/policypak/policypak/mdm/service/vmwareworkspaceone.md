...
__NOTE:__ See [Endpoint Policy Managerand Workspace One (Airwatch) MDM: Deploy Group Policy and Endpoint Policy Manager superpowers today](/docs/product_docs/policypak/policypak/video/mdm/workspaceone.md) for a video overview of Endpoint Policy Manager and VMware Workspace ONE MDM
...
![using_policypak_with_mdm_and_4](/static/img/product_docs/policypak/policypak/mdm/service/using_policypak_with_mdm_and_4.png)

__Step 2 –__ Choose the designated MSI file. In the example below we are installing the Endpoint Policy Manager CSE.

![using_policypak_with_mdm_and_5](/static/img/product_docs/policypak/policypak/mdm/service/using_policypak_with_mdm_and_5.png)
...
![using_policypak_with_mdm_and_6](/static/img/product_docs/policypak/policypak/mdm/service/using_policypak_with_mdm_and_6.png)

![using_policypak_with_mdm_and_7](/static/img/product_docs/policypak/policypak/mdm/service/using_policypak_with_mdm_and_7.png)

This is the final result in VMware Workspace ONE:

![using_policypak_with_mdm_and_8](/static/img/product_docs/policypak/policypak/mdm/service/using_policypak_with_mdm_and_8.png)
