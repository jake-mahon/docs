...
- MEMCM (formerly known as SCCM) (video: [Perform Desktop Lockdown using Microsoft SCCM and Endpoint Policy Manager ](/docs/policypak/policypak/video/applicationsettings/integration/sccmsoftwarecenter.md))
- Microsoft Intune (video: [Endpoint Policy Manager and Microsoft Intune](/docs/policypak/policypak/video/mdm/microsoftintune.md))
- Symantec Altiris
- Dell KACE
- LabTech
- PDQ Deploy (videos: [Deploy and Manage Firefox with PDQ Deploy and Endpoint Policy Manager ](/docs/policypak/policypak/video/applicationsettings/integration/pdqdeployfirefox.md) and [Deploy and Manage WinZip with PDQ Deploy and Endpoint Policy Manager ](/docs/policypak/policypak/video/applicationsettings/integration/pdqdeploy.md))
- Specops Deploy
...
- [Deploy Real Group Policy using SCCM or Other Management System!](/docs/policypak/policypak/video/methods/sccmgrouppolicy.md)
...
Then, you can learn more about how to use Endpoint Policy Manager with your own MDM tool on this page: Getting Started with MDM > [Video Learning Center](/docs/policypak/policypak/mdm/overview/videolearningcenter.md).
