...
__Step 1 –__ Start out on your GPMC management station to create a group policy object (GPO) and link it to your users. In this example, we have a GPO created and linked it to the East Sales Users organizational unit (OU).
...
![appx_policies_and_settings](/static/img/product_docs/policypak/policypak/softwarepackage/appx/appx_policies_and_settings.png)
...
![appx_policies_and_settings_1](/static/img/product_docs/policypak/policypak/softwarepackage/appx/appx_policies_and_settings_1.png)
