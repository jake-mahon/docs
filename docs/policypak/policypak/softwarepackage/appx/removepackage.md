...
![appx_policies_and_settings_8](/img/product_docs/policypak/policypak/softwarepackage/appx/appx_policies_and_settings_8.png)

Then on the endpoint run GPUpdate to acquire the policy change. You should see Skype go from present to removed.

![appx_policies_and_settings_9](/img/product_docs/policypak/policypak/softwarepackage/appx/appx_policies_and_settings_9.png)

![appx_policies_and_settings_10](/img/product_docs/policypak/policypak/softwarepackage/appx/appx_policies_and_settings_10.png)
