...
__NOTE:__ For a video showing how to create and use Endpoint Policy Manager Cloud Lite policies with Endpoint Policy Manager Remote Work Delivery Manager, watch: [Deploy software with Endpoint Policy Manager Cloud](../video/remoteworkdelivery/cloud.md).
...
__NOTE:__  See [Copy files and keep them up to date with your MDM service](../video/remoteworkdelivery/mdm.md)for additional information on how to use Endpoint Policy Manager Remote Work Delivery Manager and your MDM service to keep files up to date
