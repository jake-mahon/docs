...
- Endpoints — In order to use these, they must be licensed for Endpoint Policy Manager Remote Work Delivery Manager using one of the licensing methods, which are described in Book 1: [Introduction and Basic Concepts](/docs/policypak/policypak/basicconcepts.md).
