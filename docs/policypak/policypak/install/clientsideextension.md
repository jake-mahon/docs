...
__NOTE:__  To see a demonstration of this section, please watch these two tutorial videos: [Mass Deploy the Endpoint Policy Manager CSE using GPSI](../archive/massdeploy.md) and [Upgrading the CSE using GPSI](../archive/upgrading.md).
...
For more information on how to perform an upgrade using Group Policy Software Installation. See the [Upgrading the CSE using GPSI](../archive/upgrading.md) topic for additional information.
