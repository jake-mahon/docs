...
Please familiarize yourself with this article before continuing: [Using Rings to Test and Update the Endpoint Policy Manager Client-Side Extension and/or Cloud Client (And How to Stay Supported)](/docs/product_docs/policypak/policypak/install/rings.md)
...
![640_1_hfkb-1128-img-01](/static/img/product_docs/policypak/policypak/install/640_1_hfkb-1128-img-01.png)
...
__CAUTION:__ You must pick ONE style and NOT mix the styles.
...
__NOTE:__ The ReportsRoot value should be set if GenerateReports is enabled (true).

__NOTE:__  ReportsRoot and MSIROOT parameters supports environment variables, such as %LogonServer% and so on, if you care to use them.
...
![640_2_hfkb-1128-img-02](/static/img/product_docs/policypak/policypak/install/640_2_hfkb-1128-img-02.png)

NTFS permissions should be set up as shown below, where Domain Computers has all rights, except Full Control.

![640_3_hfkb-1128-img-03_950x424](/static/img/product_docs/policypak/policypak/install/640_3_hfkb-1128-img-03_950x424.png)
...
![640_4_hfkb-1128-img-04](/static/img/product_docs/policypak/policypak/install/640_4_hfkb-1128-img-04.png)
...
1. Endpoint Policy Manager MSI logs are generated in ```%programdata%\PolicyPak\ppInstall-<build>.log```.
