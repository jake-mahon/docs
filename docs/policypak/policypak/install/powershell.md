...
At a Powershell prompt run the command `>Import-Module PolicyPak.psd1.` If you add the
...
[Why does License Tool ask Who am I and Where do I want to use Endpoint Policy Manager?](../license/activedirectory/scope.md).
...
generated](../../../../static/img/product_docs/policypak/policypak/install/policypak_and_powershell_9_850x594.webp)
