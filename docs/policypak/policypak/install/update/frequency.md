...
There are several parts to Netwrix Endpoint Policy Manager (formerly PolicyPak) [What items and components are licensed, and what components are free?](/docs/product_docs/policypak/policypak/license/components.md)
...
The Paks are updated as needed. See [AppSets: What is the official support policy for the pre-configured AppSets?](/docs/product_docs/policypak/policypak/troubleshooting/applicationsettings/supportpolicy.md)
