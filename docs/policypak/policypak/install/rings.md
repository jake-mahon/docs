...
- When the update occurs, we notify all customers (primary and secondary technical contacts).
  ...
  [Netwrix PolicyPak Community](https://community.netwrix.com/c/policypak/28) for additional
  information.
...
series[PolicyPak and PDQ](https://www.policypak.com/integration/policypak-and-pdq.html).
