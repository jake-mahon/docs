...
__NOTE:__ For a video overview of Taskbar Manager, see [](https://www.policypak.com/products/policypak-start-screen-manager.html)[Endpoint Policy Taskbar Manager: Quick Demo](/docs/policypak/policypak/video/startscreentaskbar/demotaskbar.md).
