...
- Use the Flashlight [Dashboard](/docs/platgovnetsuiteflashlight/user-guide/dashboard.md) and the
  [Entity Relationship Diagrams](/docs/platgovnetsuiteflashlight/user-guide/data-visualization/entity-relationship-diagrams.md) to spot problems before they happen
