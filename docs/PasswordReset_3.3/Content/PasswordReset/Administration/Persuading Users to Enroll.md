...
title: Persuading Users to Enroll
---
...
![](../../../../../static/images/PasswordReset_3.3/Content/Resources/Images/NPR Admin Guide/Persuading Users to Enroll.jpg)
...
**NOTE:** You may get a **user is enrolled** response after deleting an enrolled user when testing the API. Clearing the browser cache may fix this, but not if other HTTP caches have cached the response.

[Open topic with navigation](../../../Default#PasswordReset/Administration/Persuading Users to Enroll)